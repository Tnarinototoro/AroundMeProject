...
public:	
	...
	*/
	...
	void Grab_Weapon(FName grabbed_bone, bool simulate_physics=true, bool use_gravity = false);

	UFUNCTION(BlueprintCallable,Server,Reliable,WithValidation, Category = DragonIK, meta = (DisplayName =  "z[Server] Grab Weapon"))
	void Server_Grab_Weapon(FName grabbed_bone, bool simulate_physics=true, bool use_gravity = false);

	UFUNCTION(NetMulticast,Reliable,WithValidation, Category = DragonIK)
	void Multicast_Grab_Weapon(FName grabbed_bone, bool simulate_physics=true, bool use_gravity = false);
