...
using System.IO;
public class DIYPlatformService : ModuleRules
{
    public DIYPlatformService(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Android)
        {
            ...
            AdditionalPropertiesForReceipt.Add("AndroidPlugin", System.IO.Path.Combine(PluginPath, "DIYPlatformService_Android_UPL.xml"));
        ...
        //here only added for preparation of iOS
        if (Target.Platform == UnrealTargetPlatform.IOS)
        {
            //PrivateIncludePaths.Add(Path.Combine(ModuleDirectory, "Private/IOS"));
            PrivateDependencyModuleNames.Add("Launch");

            AdditionalPropertiesForReceipt.Add("IOSPlugin", Path.Combine(PluginPath, "DIYPlatformService_IOS_UPL.xml"));
