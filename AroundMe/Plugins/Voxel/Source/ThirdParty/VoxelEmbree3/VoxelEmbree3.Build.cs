...
public class VoxelEmbree3 : ModuleRules
{
    public VoxelEmbree3(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            ...
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/VoxelEmbree3/Win64/lib/embree3.dll");
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/VoxelEmbree3/Win64/lib/tbb.dll");
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/VoxelEmbree3/Win64/lib/tbbmalloc.dll");
        ...
        else if (Target.Platform == UnrealTargetPlatform.Mac)
        {
            ...
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/VoxelEmbree3/MacOSX/lib/libembree3.3.dylib");
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/VoxelEmbree3/MacOSX/lib/libtbb.dylib");
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/VoxelEmbree3/MacOSX/lib/libtbbmalloc.dylib");
