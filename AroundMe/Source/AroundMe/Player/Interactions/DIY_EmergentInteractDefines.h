...
struct FDIY_TemperatureAndMoistureAttr
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite)
    float self_emissive_AddonTemperature_config{3000.f};

    // self emissive temperature , lasting duration config type
    UPROPERTY(EditAnywhere, BlueprintReadWrite)
    float self_emissive_AddonTemperature_LastingDuration_config{15.0f};

    UPROPERTY(EditAnywhere, BlueprintReadWrite)
    float self_combustible_temperature{2000.0f};
