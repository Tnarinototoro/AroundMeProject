#include "DIY_PlayerStateWidget.h"
...
void UDIY_PlayerStateWidget::NativeConstruct()
{
    Super::NativeConstruct();
}

void UDIY_PlayerStateWidget::NativeOnInitialized()
{
...
void UDIY_PlayerStateWidget::UpdateText(const FString &NewText)
{
    if (InfoTextBlock)
    {
