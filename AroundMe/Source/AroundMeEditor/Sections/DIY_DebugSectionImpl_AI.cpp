...
void FAroundMeEditorModule::OpenPetMemoryDebugPanel()
{
    FGlobalTabmanager::Get()->TryInvokeTab(PetMemoryDebugTabName);
}

TSharedRef<SDockTab> FAroundMeEditorModule::OnSpawnPetMemoryDebugTab(const FSpawnTabArgs &SpawnTabArgs)
{
    return SNew(SDockTab)
        .TabRole(ETabRole::NomadTab)
            [SNew(SDIY_PetMemoryDebugPanel)];
}
