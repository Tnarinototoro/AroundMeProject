...
//DIY_ENGINE_CE START
			...
			bool bUseAnisotropy = Material.GetShadingModels().HasAnyShadingModel({ MSM_DefaultLit, MSM_ClearCoat, MSM_DIYToonHair }) && Material.MaterialUsesAnisotropy_RenderThread();
//DIY_ENGINE_CE END
