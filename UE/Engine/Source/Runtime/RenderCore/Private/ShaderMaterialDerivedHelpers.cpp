	...
	ERHIFeatureLevel::Type FEATURE_LEVEL)
{
	...
	Dst.WRITES_CUSTOMDATA_TO_GBUFFER = 
		(Dst.USES_GBUFFER && 
		...
		|| Mat.MATERIAL_SHADINGMODEL_DIY_TOON_DEFAULT || Mat.MATERIAL_SHADINGMODEL_DIY_TOON_HAIR || Mat.MATERIAL_SHADINGMODEL_DIY_TOON_SKIN
