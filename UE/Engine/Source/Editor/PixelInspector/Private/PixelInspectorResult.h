...
#define PIXEL_INSPECTOR_SHADINGMODELID_DIY_TOON_DEFAULT 13  
#define PIXEL_INSPECTOR_SHADINGMODELID_DIY_TOON_SKIN 14  
#define PIXEL_INSPECTOR_SHADINGMODELID_DIY_TOON_HAIR 15
