...
template<> HTTPBLUEPRINT_API UScriptStruct* StaticStruct<FHttpHeader>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FHttpHeader_Statics::NewProp_Headers_ValueProp = { "Headers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FHttpHeader_Statics::NewProp_Headers_Key_KeyProp = { "Headers_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHttpHeader_Statics::NewProp_Headers_MetaData[] = {
		{ "Comment", "/** Header key/value pairs. */" },
		{ "ModuleRelativePath", "Public/HttpHeader.h" },
		{ "ToolTip", "Header key/value pairs." },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FHttpHeader_Statics::NewProp_Headers = { "Headers", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHttpHeader, Headers), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHttpHeader_Statics::NewProp_Headers_MetaData), Z_Construct_UScriptStruct_FHttpHeader_Statics::NewProp_Headers_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHttpHeader_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHttpHeader_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FHttpHeader_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHttpHeader_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Web_HttpBlueprint_Source_HttpBlueprint_Public_HttpHeader_h_Statics::ScriptStructInfo[] = {
		{ FHttpHeader::StaticStruct, Z_Construct_UScriptStruct_FHttpHeader_Statics::NewStructOps, TEXT("HttpHeader"), &Z_Registration_Info_UScriptStruct_HttpHeader, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHttpHeader), 2327076576U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Web_HttpBlueprint_Source_HttpBlueprint_Public_HttpHeader_h_3281791294(TEXT("/Script/HttpBlueprint"),
		nullptr, 0,
