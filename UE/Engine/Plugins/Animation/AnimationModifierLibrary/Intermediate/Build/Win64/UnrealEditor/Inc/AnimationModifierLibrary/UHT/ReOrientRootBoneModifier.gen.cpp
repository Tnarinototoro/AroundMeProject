...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UReOrientRootBoneModifier_Statics::NewProp_Rotator = { "Rotator", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UReOrientRootBoneModifier, Rotator), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReOrientRootBoneModifier_Statics::NewProp_Rotator_MetaData), Z_Construct_UClass_UReOrientRootBoneModifier_Statics::NewProp_Rotator_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationModifierLibrary_Source_AnimationModifierLibrary_Public_ReOrientRootBoneModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReOrientRootBoneModifier, UReOrientRootBoneModifier::StaticClass, TEXT("UReOrientRootBoneModifier"), &Z_Registration_Info_UClass_UReOrientRootBoneModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReOrientRootBoneModifier), 60117910U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationModifierLibrary_Source_AnimationModifierLibrary_Public_ReOrientRootBoneModifier_h_2597253971(TEXT("/Script/AnimationModifierLibrary"),
