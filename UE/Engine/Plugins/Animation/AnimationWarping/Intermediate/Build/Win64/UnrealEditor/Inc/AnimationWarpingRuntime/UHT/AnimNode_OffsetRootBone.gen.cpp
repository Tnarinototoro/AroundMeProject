...
template<> ANIMATIONWARPINGRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_OffsetRootBone>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_EvaluationMode = { "EvaluationMode", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAnimNode_OffsetRootBone, EvaluationMode), Z_Construct_UEnum_AnimGraphRuntime_EWarpingEvaluationMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_EvaluationMode_MetaData), Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_EvaluationMode_MetaData) }; // 2501188153
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_TranslationHalflife = { "TranslationHalflife", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAnimNode_OffsetRootBone, TranslationHalflife), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_TranslationHalflife_MetaData), Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_TranslationHalflife_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_MaxTranslationError = { "MaxTranslationError", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAnimNode_OffsetRootBone, MaxTranslationError), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_MaxTranslationError_MetaData), Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_MaxTranslationError_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_MaxRotationError = { "MaxRotationError", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAnimNode_OffsetRootBone, MaxRotationError), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_MaxRotationError_MetaData), Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_MaxRotationError_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_bClampToTranslationVelocity = { "bClampToTranslationVelocity", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAnimNode_OffsetRootBone), &Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_bClampToTranslationVelocity_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_bClampToTranslationVelocity_MetaData), Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_bClampToTranslationVelocity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_TranslationSpeedRatio = { "TranslationSpeedRatio", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAnimNode_OffsetRootBone, TranslationSpeedRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_TranslationSpeedRatio_MetaData), Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_TranslationSpeedRatio_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_RotationSpeedRatio = { "RotationSpeedRatio", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAnimNode_OffsetRootBone, RotationSpeedRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_RotationSpeedRatio_MetaData), Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewProp_RotationSpeedRatio_MetaData) };
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationWarping_Source_Runtime_Public_BoneControllers_AnimNode_OffsetRootBone_h_Statics::EnumInfo[] = {
		{ EOffsetRootBoneMode_StaticEnum, TEXT("EOffsetRootBoneMode"), &Z_Registration_Info_UEnum_EOffsetRootBoneMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 754866776U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationWarping_Source_Runtime_Public_BoneControllers_AnimNode_OffsetRootBone_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_OffsetRootBone::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_OffsetRootBone_Statics::NewStructOps, TEXT("AnimNode_OffsetRootBone"), &Z_Registration_Info_UScriptStruct_AnimNode_OffsetRootBone, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_OffsetRootBone), 1960361756U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationWarping_Source_Runtime_Public_BoneControllers_AnimNode_OffsetRootBone_h_3803322020(TEXT("/Script/AnimationWarpingRuntime"),
		nullptr, 0,
