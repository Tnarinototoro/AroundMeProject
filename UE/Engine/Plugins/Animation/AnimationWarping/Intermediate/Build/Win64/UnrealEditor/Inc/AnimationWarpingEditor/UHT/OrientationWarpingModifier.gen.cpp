...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_EnableWarpingCurveName = { "EnableWarpingCurveName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOrientationWarpingModifier, EnableWarpingCurveName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_EnableWarpingCurveName_MetaData), Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_EnableWarpingCurveName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_EnableOffsetCurveName = { "EnableOffsetCurveName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOrientationWarpingModifier, EnableOffsetCurveName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_EnableOffsetCurveName_MetaData), Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_EnableOffsetCurveName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_BlendInTime = { "BlendInTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOrientationWarpingModifier, BlendInTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_BlendInTime_MetaData), Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_BlendInTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_BlendOutTime = { "BlendOutTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOrientationWarpingModifier, BlendOutTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_BlendOutTime_MetaData), Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_BlendOutTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_StopSpeedThreshold = { "StopSpeedThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOrientationWarpingModifier, StopSpeedThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_StopSpeedThreshold_MetaData), Z_Construct_UClass_UOrientationWarpingModifier_Statics::NewProp_StopSpeedThreshold_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationWarping_Source_Editor_Public_AnimationModifiers_OrientationWarpingModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOrientationWarpingModifier, UOrientationWarpingModifier::StaticClass, TEXT("UOrientationWarpingModifier"), &Z_Registration_Info_UClass_UOrientationWarpingModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOrientationWarpingModifier), 3578666851U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationWarping_Source_Editor_Public_AnimationModifiers_OrientationWarpingModifier_h_3893492234(TEXT("/Script/AnimationWarpingEditor"),
