...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigEffectorGoal, BoneName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_BoneName_MetaData), Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_BoneName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_PositionAlpha = { "PositionAlpha", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigEffectorGoal, PositionAlpha), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_PositionAlpha_MetaData), Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_PositionAlpha_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_RotationAlpha = { "RotationAlpha", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigEffectorGoal, RotationAlpha), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_RotationAlpha_MetaData), Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_RotationAlpha_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_CurrentTransform = { "CurrentTransform", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigEffectorGoal, CurrentTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_CurrentTransform_MetaData), Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_CurrentTransform_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_InitialTransform = { "InitialTransform", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigEffectorGoal, InitialTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_InitialTransform_MetaData), Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_InitialTransform_MetaData) };
#if WITH_EDITORONLY_DATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_SizeMultiplier = { "SizeMultiplier", nullptr, (EPropertyFlags)0x0010000800000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigEffectorGoal, SizeMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_SizeMultiplier_MetaData), Z_Construct_UClass_UIKRigEffectorGoal_Statics::NewProp_SizeMultiplier_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBoneChain_Statics::NewProp_IKGoalName = { "IKGoalName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBoneChain, IKGoalName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBoneChain_Statics::NewProp_IKGoalName_MetaData), Z_Construct_UScriptStruct_FBoneChain_Statics::NewProp_IKGoalName_MetaData) };
...
template<> IKRIG_API UScriptStruct* StaticStruct<FRetargetDefinition>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRetargetDefinition_Statics::NewProp_RootBone = { "RootBone", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRetargetDefinition, RootBone), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRetargetDefinition_Statics::NewProp_RootBone_MetaData), Z_Construct_UScriptStruct_FRetargetDefinition_Statics::NewProp_RootBone_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRetargetDefinition_Statics::NewProp_BoneChains = { "BoneChains", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRetargetDefinition, BoneChains), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRetargetDefinition_Statics::NewProp_BoneChains_MetaData), Z_Construct_UScriptStruct_FRetargetDefinition_Statics::NewProp_BoneChains_MetaData) }; // 2603479903
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_PreviewSkeletalMesh = { "PreviewSkeletalMesh", nullptr, (EPropertyFlags)0x0014010000000001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigDefinition, PreviewSkeletalMesh), Z_Construct_UClass_USkeletalMesh_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_PreviewSkeletalMesh_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_PreviewSkeletalMesh_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_BoneSize = { "BoneSize", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigDefinition, BoneSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_BoneSize_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_BoneSize_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_GoalSize = { "GoalSize", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigDefinition, GoalSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_GoalSize_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_GoalSize_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0014000c00202000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigDefinition, Controller), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Controller_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Controller_MetaData) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Goals = { "Goals", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigDefinition, Goals), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Goals_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Goals_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Solvers_Inner = { "Solvers", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UIKRigSolver_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Solvers_Inner_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Solvers_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Solvers = { "Solvers", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigDefinition, Solvers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Solvers_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_Solvers_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_RetargetDefinition = { "RetargetDefinition", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigDefinition, RetargetDefinition), Z_Construct_UScriptStruct_FRetargetDefinition, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_RetargetDefinition_MetaData), Z_Construct_UClass_UIKRigDefinition_Statics::NewProp_RetargetDefinition_MetaData) }; // 4205221441
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UIKRigDefinition_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UIKRigDefinition_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UInterface_PreviewMeshProvider_NoRegister, (int32)VTABLE_OFFSET(UIKRigDefinition, IInterface_PreviewMeshProvider), false },  // 539613644
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigDefinition_Statics::InterfaceParams) < 64);
...
#if WITH_EDITORONLY_DATA
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_IKRigDefinition_h_Statics::EnumInfo[] = {
		{ EIKRigGoalPreviewMode_StaticEnum, TEXT("EIKRigGoalPreviewMode"), &Z_Registration_Info_UEnum_EIKRigGoalPreviewMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 690536508U) },
	};
#endif
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_IKRigDefinition_h_Statics::ScriptStructInfo[] = {
		{ FBoneChain::StaticStruct, Z_Construct_UScriptStruct_FBoneChain_Statics::NewStructOps, TEXT("BoneChain"), &Z_Registration_Info_UScriptStruct_BoneChain, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBoneChain), 2603479903U) },
		{ FRetargetDefinition::StaticStruct, Z_Construct_UScriptStruct_FRetargetDefinition_Statics::NewStructOps, TEXT("RetargetDefinition"), &Z_Registration_Info_UScriptStruct_RetargetDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRetargetDefinition), 4205221441U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_IKRigDefinition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIKRigEffectorGoal, UIKRigEffectorGoal::StaticClass, TEXT("UIKRigEffectorGoal"), &Z_Registration_Info_UClass_UIKRigEffectorGoal, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRigEffectorGoal), 1514281654U) },
		{ Z_Construct_UClass_UIKRigDefinition, UIKRigDefinition::StaticClass, TEXT("UIKRigDefinition"), &Z_Registration_Info_UClass_UIKRigDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRigDefinition), 918154504U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_IKRigDefinition_h_2744416280(TEXT("/Script/IKRig"),
