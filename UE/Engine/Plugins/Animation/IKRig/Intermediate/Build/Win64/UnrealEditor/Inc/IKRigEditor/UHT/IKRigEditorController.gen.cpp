...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_SelectedBone = { "SelectedBone", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigBoneDetails, SelectedBone), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_SelectedBone_MetaData), Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_SelectedBone_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_CurrentTransform = { "CurrentTransform", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigBoneDetails, CurrentTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_CurrentTransform_MetaData), Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_CurrentTransform_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_ReferenceTransform = { "ReferenceTransform", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigBoneDetails, ReferenceTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_ReferenceTransform_MetaData), Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_ReferenceTransform_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AnimInstancePtr_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigEditor/IKRigEditorController.h" },
	};
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AnimInstancePtr = { "AnimInstancePtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigBoneDetails, AnimInstancePtr), Z_Construct_UClass_UAnimInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AnimInstancePtr_MetaData), Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AnimInstancePtr_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AssetPtr_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigEditor/IKRigEditorController.h" },
	};
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AssetPtr = { "AssetPtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRigBoneDetails, AssetPtr), Z_Construct_UClass_UIKRigDefinition_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AssetPtr_MetaData), Z_Construct_UClass_UIKRigBoneDetails_Statics::NewProp_AssetPtr_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RigEditor_IKRigEditorController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIKRigBoneDetails, UIKRigBoneDetails::StaticClass, TEXT("UIKRigBoneDetails"), &Z_Registration_Info_UClass_UIKRigBoneDetails, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRigBoneDetails), 1607854809U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RigEditor_IKRigEditorController_h_2424843786(TEXT("/Script/IKRigEditor"),
