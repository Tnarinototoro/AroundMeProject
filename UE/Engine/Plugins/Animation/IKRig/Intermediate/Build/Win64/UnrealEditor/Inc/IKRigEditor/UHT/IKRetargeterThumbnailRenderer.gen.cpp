...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UIKRetargeterThumbnailRenderer);
	UClass* Z_Construct_UClass_UIKRetargeterThumbnailRenderer_NoRegister()
	{
		return UIKRetargeterThumbnailRenderer::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UIKRetargeterThumbnailRenderer_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UIKRetargeterThumbnailRenderer_Statics::StaticCppClassTypeInfo = {
	...
	template<> IKRIGEDITOR_API UClass* StaticClass<UIKRetargeterThumbnailRenderer>()
	{
		return UIKRetargeterThumbnailRenderer::StaticClass();
	}
	...
	DEFINE_VTABLE_PTR_HELPER_CTOR(UIKRetargeterThumbnailRenderer);
	UIKRetargeterThumbnailRenderer::~UIKRetargeterThumbnailRenderer() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RetargetEditor_IKRetargeterThumbnailRenderer_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RetargetEditor_IKRetargeterThumbnailRenderer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIKRetargeterThumbnailRenderer, UIKRetargeterThumbnailRenderer::StaticClass, TEXT("UIKRetargeterThumbnailRenderer"), &Z_Registration_Info_UClass_UIKRetargeterThumbnailRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRetargeterThumbnailRenderer), 4067600168U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RetargetEditor_IKRetargeterThumbnailRenderer_h_2808723357(TEXT("/Script/IKRigEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RetargetEditor_IKRetargeterThumbnailRenderer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RetargetEditor_IKRetargeterThumbnailRenderer_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
