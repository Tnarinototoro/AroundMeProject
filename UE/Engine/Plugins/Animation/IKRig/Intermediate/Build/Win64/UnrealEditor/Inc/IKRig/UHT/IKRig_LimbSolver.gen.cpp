...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_RootName = { "RootName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRig_LimbSolver, RootName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_RootName_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_RootName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_ReachPrecision = { "ReachPrecision", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRig_LimbSolver, ReachPrecision), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_ReachPrecision_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_ReachPrecision_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableLimit = { "bEnableLimit", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UIKRig_LimbSolver), &Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableLimit_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableLimit_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableLimit_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_MinRotationAngle = { "MinRotationAngle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRig_LimbSolver, MinRotationAngle), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_MinRotationAngle_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_MinRotationAngle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_PullDistribution = { "PullDistribution", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRig_LimbSolver, PullDistribution), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_PullDistribution_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_PullDistribution_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_ReachStepAlpha = { "ReachStepAlpha", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRig_LimbSolver, ReachStepAlpha), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_ReachStepAlpha_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_ReachStepAlpha_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableTwistCorrection = { "bEnableTwistCorrection", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UIKRig_LimbSolver), &Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableTwistCorrection_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableTwistCorrection_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_bEnableTwistCorrection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_EndBoneForwardAxis = { "EndBoneForwardAxis", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRig_LimbSolver, EndBoneForwardAxis), Z_Construct_UEnum_CoreUObject_EAxis, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_EndBoneForwardAxis_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_EndBoneForwardAxis_MetaData) }; // 1662690994
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_Effector_MetaData[] = {
		{ "ModuleRelativePath", "Public/Rig/Solvers/IKRig_LimbSolver.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_Effector = { "Effector", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIKRig_LimbSolver, Effector), Z_Construct_UClass_UIKRig_LimbEffector_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_Effector_MetaData), Z_Construct_UClass_UIKRig_LimbSolver_Statics::NewProp_Effector_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_Solvers_IKRig_LimbSolver_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIKRig_LimbEffector, UIKRig_LimbEffector::StaticClass, TEXT("UIKRig_LimbEffector"), &Z_Registration_Info_UClass_UIKRig_LimbEffector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRig_LimbEffector), 3191367144U) },
		{ Z_Construct_UClass_UIKRig_LimbSolver, UIKRig_LimbSolver::StaticClass, TEXT("UIKRig_LimbSolver"), &Z_Registration_Info_UClass_UIKRig_LimbSolver, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRig_LimbSolver), 3844654890U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_Solvers_IKRig_LimbSolver_h_1486075268(TEXT("/Script/IKRig"),
