...
template<> IKRIG_API UScriptStruct* StaticStruct<FIKRigSkeleton>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FIKRigSkeleton_Statics::NewProp_BoneNames = { "BoneNames", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FIKRigSkeleton, BoneNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FIKRigSkeleton_Statics::NewProp_BoneNames_MetaData), Z_Construct_UScriptStruct_FIKRigSkeleton_Statics::NewProp_BoneNames_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FIKRigSkeleton_Statics::NewProp_RefPoseGlobal = { "RefPoseGlobal", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FIKRigSkeleton, RefPoseGlobal), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FIKRigSkeleton_Statics::NewProp_RefPoseGlobal_MetaData), Z_Construct_UScriptStruct_FIKRigSkeleton_Statics::NewProp_RefPoseGlobal_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_IKRigSkeleton_h_Statics::ScriptStructInfo[] = {
		{ FIKRigInputSkeleton::StaticStruct, Z_Construct_UScriptStruct_FIKRigInputSkeleton_Statics::NewStructOps, TEXT("IKRigInputSkeleton"), &Z_Registration_Info_UScriptStruct_IKRigInputSkeleton, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FIKRigInputSkeleton), 3399398460U) },
		{ FIKRigSkeleton::StaticStruct, Z_Construct_UScriptStruct_FIKRigSkeleton_Statics::NewStructOps, TEXT("IKRigSkeleton"), &Z_Registration_Info_UScriptStruct_IKRigSkeleton, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FIKRigSkeleton), 1834062795U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Rig_IKRigSkeleton_h_1774694305(TEXT("/Script/IKRig"),
		nullptr, 0,
