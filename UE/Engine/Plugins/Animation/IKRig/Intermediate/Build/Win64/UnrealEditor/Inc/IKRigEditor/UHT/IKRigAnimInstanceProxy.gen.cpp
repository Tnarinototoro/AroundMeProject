...
template<> IKRIGEDITOR_API UScriptStruct* StaticStruct<FIKRigAnimInstanceProxy>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RigEditor_IKRigAnimInstanceProxy_h_Statics::ScriptStructInfo[] = {
		{ FIKRigAnimInstanceProxy::StaticStruct, Z_Construct_UScriptStruct_FIKRigAnimInstanceProxy_Statics::NewStructOps, TEXT("IKRigAnimInstanceProxy"), &Z_Registration_Info_UScriptStruct_IKRigAnimInstanceProxy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FIKRigAnimInstanceProxy), 1821323899U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRigEditor_Public_RigEditor_IKRigAnimInstanceProxy_h_409030916(TEXT("/Script/IKRigEditor"),
		nullptr, 0,
