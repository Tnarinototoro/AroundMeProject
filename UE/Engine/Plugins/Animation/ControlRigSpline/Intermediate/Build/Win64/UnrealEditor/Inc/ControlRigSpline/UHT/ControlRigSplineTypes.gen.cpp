...
template<> CONTROLRIGSPLINE_API UScriptStruct* StaticStruct<FControlRigSpline>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRigSpline_Source_ControlRigSpline_Public_ControlRigSplineTypes_h_Statics::EnumInfo[] = {
		{ ESplineType_StaticEnum, TEXT("ESplineType"), &Z_Registration_Info_UEnum_ESplineType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 221040211U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRigSpline_Source_ControlRigSpline_Public_ControlRigSplineTypes_h_Statics::ScriptStructInfo[] = {
		{ FControlRigSplineImpl::StaticStruct, Z_Construct_UScriptStruct_FControlRigSplineImpl_Statics::NewStructOps, TEXT("ControlRigSplineImpl"), &Z_Registration_Info_UScriptStruct_ControlRigSplineImpl, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FControlRigSplineImpl), 3911141214U) },
		{ FControlRigSpline::StaticStruct, Z_Construct_UScriptStruct_FControlRigSpline_Statics::NewStructOps, TEXT("ControlRigSpline"), &Z_Registration_Info_UScriptStruct_ControlRigSpline, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FControlRigSpline), 1041138491U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRigSpline_Source_ControlRigSpline_Public_ControlRigSplineTypes_h_2771195529(TEXT("/Script/ControlRigSpline"),
		nullptr, 0,
