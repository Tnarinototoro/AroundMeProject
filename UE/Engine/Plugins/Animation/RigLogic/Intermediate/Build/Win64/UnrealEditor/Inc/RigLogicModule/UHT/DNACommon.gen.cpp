...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCoordinateSystem_Statics::NewProp_YAxis = { "YAxis", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCoordinateSystem, YAxis), Z_Construct_UEnum_RigLogicModule_EDirection, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCoordinateSystem_Statics::NewProp_YAxis_MetaData), Z_Construct_UScriptStruct_FCoordinateSystem_Statics::NewProp_YAxis_MetaData) }; // 4293480275
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCoordinateSystem_Statics::NewProp_ZAxis = { "ZAxis", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCoordinateSystem, ZAxis), Z_Construct_UEnum_RigLogicModule_EDirection, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCoordinateSystem_Statics::NewProp_ZAxis_MetaData), Z_Construct_UScriptStruct_FCoordinateSystem_Statics::NewProp_ZAxis_MetaData) }; // 4293480275
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMeshBlendShapeChannelMapping_Statics::NewProp_MeshIndex = { "MeshIndex", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMeshBlendShapeChannelMapping, MeshIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshBlendShapeChannelMapping_Statics::NewProp_MeshIndex_MetaData), Z_Construct_UScriptStruct_FMeshBlendShapeChannelMapping_Statics::NewProp_MeshIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMeshBlendShapeChannelMapping_Statics::NewProp_BlendShapeChannelIndex = { "BlendShapeChannelIndex", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMeshBlendShapeChannelMapping, BlendShapeChannelIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshBlendShapeChannelMapping_Statics::NewProp_BlendShapeChannelIndex_MetaData), Z_Construct_UScriptStruct_FMeshBlendShapeChannelMapping_Statics::NewProp_BlendShapeChannelIndex_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextureCoordinate_Statics::NewProp_U = { "U", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTextureCoordinate, U), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextureCoordinate_Statics::NewProp_U_MetaData), Z_Construct_UScriptStruct_FTextureCoordinate_Statics::NewProp_U_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextureCoordinate_Statics::NewProp_V = { "V", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTextureCoordinate, V), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextureCoordinate_Statics::NewProp_V_MetaData), Z_Construct_UScriptStruct_FTextureCoordinate_Statics::NewProp_V_MetaData) };
...
template<> RIGLOGICMODULE_API UScriptStruct* StaticStruct<FVertexLayout>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_RigLogic_Source_RigLogicModule_Public_DNACommon_h_Statics::EnumInfo[] = {
		{ EArchetype_StaticEnum, TEXT("EArchetype"), &Z_Registration_Info_UEnum_EArchetype, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2541443701U) },
		{ EGender_StaticEnum, TEXT("EGender"), &Z_Registration_Info_UEnum_EGender, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 486840406U) },
		{ ETranslationUnit_StaticEnum, TEXT("ETranslationUnit"), &Z_Registration_Info_UEnum_ETranslationUnit, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 94793125U) },
		{ ERotationUnit_StaticEnum, TEXT("ERotationUnit"), &Z_Registration_Info_UEnum_ERotationUnit, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3610060797U) },
		{ EDirection_StaticEnum, TEXT("EDirection"), &Z_Registration_Info_UEnum_EDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4293480275U) },
		{ EDNADataLayer_StaticEnum, TEXT("EDNADataLayer"), &Z_Registration_Info_UEnum_EDNADataLayer, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 594636363U) },
		{ EActivationFunction_StaticEnum, TEXT("EActivationFunction"), &Z_Registration_Info_UEnum_EActivationFunction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3152444473U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_RigLogic_Source_RigLogicModule_Public_DNACommon_h_Statics::ScriptStructInfo[] = {
		{ FCoordinateSystem::StaticStruct, Z_Construct_UScriptStruct_FCoordinateSystem_Statics::NewStructOps, TEXT("CoordinateSystem"), &Z_Registration_Info_UScriptStruct_CoordinateSystem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCoordinateSystem), 2499724692U) },
		...
		{ FTextureCoordinate::StaticStruct, Z_Construct_UScriptStruct_FTextureCoordinate_Statics::NewStructOps, TEXT("TextureCoordinate"), &Z_Registration_Info_UScriptStruct_TextureCoordinate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTextureCoordinate), 775568030U) },
		{ FVertexLayout::StaticStruct, Z_Construct_UScriptStruct_FVertexLayout_Statics::NewStructOps, TEXT("VertexLayout"), &Z_Registration_Info_UScriptStruct_VertexLayout, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVertexLayout), 3460625411U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_RigLogic_Source_RigLogicModule_Public_DNACommon_h_3073545881(TEXT("/Script/RigLogicModule"),
		nullptr, 0,
