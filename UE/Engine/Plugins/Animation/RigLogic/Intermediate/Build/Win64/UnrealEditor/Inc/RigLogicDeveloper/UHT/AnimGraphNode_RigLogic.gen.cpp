...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimGraphNode_RigLogic, Node), Z_Construct_UScriptStruct_FAnimNode_RigLogic, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::NewProp_Node_MetaData), Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::NewProp_Node_MetaData) }; // 2105512061
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::Class_MetaDataParams), Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimGraphNode_RigLogic_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_RigLogic_Source_RigLogicDeveloper_Public_AnimGraphNode_RigLogic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimGraphNode_RigLogic, UAnimGraphNode_RigLogic::StaticClass, TEXT("UAnimGraphNode_RigLogic"), &Z_Registration_Info_UClass_UAnimGraphNode_RigLogic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimGraphNode_RigLogic), 2640157049U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_RigLogic_Source_RigLogicDeveloper_Public_AnimGraphNode_RigLogic_h_525263599(TEXT("/Script/RigLogicDeveloper"),
