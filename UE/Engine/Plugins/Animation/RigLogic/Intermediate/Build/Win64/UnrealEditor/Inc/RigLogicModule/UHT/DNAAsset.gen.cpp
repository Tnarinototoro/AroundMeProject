...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDNAAsset_Statics::NewProp_AssetImportData = { "AssetImportData", nullptr, (EPropertyFlags)0x00160008000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDNAAsset, AssetImportData), Z_Construct_UClass_UAssetImportData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDNAAsset_Statics::NewProp_AssetImportData_MetaData), Z_Construct_UClass_UDNAAsset_Statics::NewProp_AssetImportData_MetaData) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDNAAsset_Statics::NewProp_DnaFileName = { "DnaFileName", nullptr, (EPropertyFlags)0x0010010000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDNAAsset, DnaFileName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDNAAsset_Statics::NewProp_DnaFileName_MetaData), Z_Construct_UClass_UDNAAsset_Statics::NewProp_DnaFileName_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_RigLogic_Source_RigLogicModule_Public_DNAAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDNAAsset, UDNAAsset::StaticClass, TEXT("UDNAAsset"), &Z_Registration_Info_UClass_UDNAAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDNAAsset), 1129393021U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_RigLogic_Source_RigLogicModule_Public_DNAAsset_h_2406720550(TEXT("/Script/RigLogicModule"),
