...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, Space), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Space_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Space_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Transform_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Transform_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedBone = { "CachedBone", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, CachedBone), Z_Construct_UScriptStruct_FCachedRigElement, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedBone_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedBone_MetaData) }; // 968212372
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedSpace = { "CachedSpace", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, CachedSpace), Z_Construct_UScriptStruct_FCachedRigElement, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedSpace_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedSpace_MetaData) }; // 968212372
...
void FRigUnit_GetRelativeBoneTransform::Execute(const FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetRelativeBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetRelativeBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewStructOps, TEXT("RigUnit_GetRelativeBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetRelativeBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetRelativeBoneTransform), 148426210U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetRelativeBoneTransform_h_3432569817(TEXT("/Script/ControlRig"),
		nullptr, 0,
