...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_GetCurveValue>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Curve = { "Curve", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetCurveValue, Curve), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Curve_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Curve_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Valid = { "Valid", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FRigUnit_GetCurveValue), &Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Valid_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Valid_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Valid_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetCurveValue, Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Value_MetaData) };
#if WITH_METADATA
...
void FRigUnit_GetCurveValue::Execute(const FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetCurveValue_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetCurveValue::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewStructOps, TEXT("RigUnit_GetCurveValue"), &Z_Registration_Info_UScriptStruct_RigUnit_GetCurveValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetCurveValue), 2476808564U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetCurveValue_h_1310785423(TEXT("/Script/ControlRig"),
		nullptr, 0,
