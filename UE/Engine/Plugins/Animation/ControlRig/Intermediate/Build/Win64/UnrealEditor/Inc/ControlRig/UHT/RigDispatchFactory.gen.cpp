...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigDispatchFactory>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigDispatchFactory_h_Statics::ScriptStructInfo[] = {
		{ FRigDispatchFactory::StaticStruct, Z_Construct_UScriptStruct_FRigDispatchFactory_Statics::NewStructOps, TEXT("RigDispatchFactory"), &Z_Registration_Info_UScriptStruct_RigDispatchFactory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigDispatchFactory), 1721206138U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigDispatchFactory_h_2283955606(TEXT("/Script/ControlRig"),
		nullptr, 0,
