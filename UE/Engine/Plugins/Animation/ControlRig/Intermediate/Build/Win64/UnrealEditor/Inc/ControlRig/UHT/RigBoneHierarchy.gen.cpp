...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_ParentName = { "ParentName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigBone, ParentName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_ParentName_MetaData), Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_ParentName_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_ParentIndex_MetaData[] = {
		{ "ModuleRelativePath", "Public/Rigs/RigBoneHierarchy.h" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_ParentIndex = { "ParentIndex", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigBone, ParentIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_ParentIndex_MetaData), Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_ParentIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_GlobalTransform = { "GlobalTransform", nullptr, (EPropertyFlags)0x0010000000002015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigBone, GlobalTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_GlobalTransform_MetaData), Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_GlobalTransform_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_LocalTransform = { "LocalTransform", nullptr, (EPropertyFlags)0x0010000000002015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigBone, LocalTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_LocalTransform_MetaData), Z_Construct_UScriptStruct_FRigBone_Statics::NewProp_LocalTransform_MetaData) };
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigBoneHierarchy>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigBoneHierarchy_h_Statics::ScriptStructInfo[] = {
		{ FRigBone::StaticStruct, Z_Construct_UScriptStruct_FRigBone_Statics::NewStructOps, TEXT("RigBone"), &Z_Registration_Info_UScriptStruct_RigBone, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigBone), 1043462515U) },
		{ FRigBoneHierarchy::StaticStruct, Z_Construct_UScriptStruct_FRigBoneHierarchy_Statics::NewStructOps, TEXT("RigBoneHierarchy"), &Z_Registration_Info_UScriptStruct_RigBoneHierarchy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigBoneHierarchy), 3534388010U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigBoneHierarchy_h_3453371347(TEXT("/Script/ControlRig"),
		nullptr, 0,
