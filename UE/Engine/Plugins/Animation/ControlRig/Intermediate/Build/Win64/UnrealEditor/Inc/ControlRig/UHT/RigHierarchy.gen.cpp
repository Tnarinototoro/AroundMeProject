...
// End Cross Module References
	...
	UFunction* Z_Construct_UDelegateFunction_ControlRig_RigHierarchyModifiedDynamicEvent__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_ControlRig_RigHierarchyModifiedDynamicEvent__DelegateSignature_Statics::FuncParams);
		}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigTransformStackEntry>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FRigTransformStackEntry_Statics::NewProp_TransformType = { "TransformType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigTransformStackEntry, TransformType), Z_Construct_UEnum_ControlRig_ERigTransformType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigTransformStackEntry_Statics::NewProp_TransformType_MetaData), Z_Construct_UScriptStruct_FRigTransformStackEntry_Statics::NewProp_TransformType_MetaData) }; // 3026035071
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigTransformStackEntry_Statics::NewProp_OldTransform = { "OldTransform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigTransformStackEntry, OldTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigTransformStackEntry_Statics::NewProp_OldTransform_MetaData), Z_Construct_UScriptStruct_FRigTransformStackEntry_Statics::NewProp_OldTransform_MetaData) };
#if WITH_METADATA
	...
	void URigHierarchy::StaticRegisterNativesURigHierarchy()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetControlPreferredEulerAngles", &URigHierarchy::execGetControlPreferredEulerAngles },
			{ "GetControlPreferredEulerAnglesByIndex", &URigHierarchy::execGetControlPreferredEulerAnglesByIndex },
			{ "GetControlPreferredEulerRotationOrder", &URigHierarchy::execGetControlPreferredEulerRotationOrder },
			{ "GetControlPreferredEulerRotationOrderByIndex", &URigHierarchy::execGetControlPreferredEulerRotationOrderByIndex },
			...
			{ "SetControlPreferredEulerAngles", &URigHierarchy::execSetControlPreferredEulerAngles },
			{ "SetControlPreferredEulerAnglesByIndex", &URigHierarchy::execSetControlPreferredEulerAnglesByIndex },
			{ "SetControlPreferredRotationOrder", &URigHierarchy::execSetControlPreferredRotationOrder },
			{ "SetControlPreferredRotationOrderByIndex", &URigHierarchy::execSetControlPreferredRotationOrderByIndex },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_CopyHierarchy_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "CopyHierarchy", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_CopyHierarchy_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_CopyHierarchy_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_CopyHierarchy_Statics::RigHierarchy_eventCopyHierarchy_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_CopyHierarchy_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_CopyHierarchy_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_CopyPose_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "CopyPose", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_CopyPose_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_CopyPose_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_CopyPose_Statics::RigHierarchy_eventCopyPose_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_CopyPose_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_CopyPose_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_FindNull_ForBlueprintOnly_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventFindNull_ForBlueprintOnly_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_FindNull_ForBlueprintOnly_Statics::NewProp_InKey_MetaData), Z_Construct_UFunction_URigHierarchy_FindNull_ForBlueprintOnly_Statics::NewProp_InKey_MetaData) }; // 422817336
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_FindNull_ForBlueprintOnly_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventFindNull_ForBlueprintOnly_Parms, ReturnValue), Z_Construct_UScriptStruct_FRigNullElement, METADATA_PARAMS(0, nullptr) }; // 2457817806
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetAllKeys_ForBlueprint_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetAllKeys_ForBlueprint", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetAllKeys_ForBlueprint_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetAllKeys_ForBlueprint_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetAllKeys_ForBlueprint_Statics::RigHierarchy_eventGetAllKeys_ForBlueprint_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetAllKeys_ForBlueprint_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetAllKeys_ForBlueprint_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetBoolArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetBoolArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetBoolArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetBoolArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetBoolArrayMetadata_Statics::RigHierarchy_eventGetBoolArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetBoolArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetBoolArrayMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetBoolMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetBoolMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetBoolMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetBoolMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetBoolMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetBoolMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetBoolMetadata_Statics::RigHierarchy_eventGetBoolMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetBoolMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetBoolMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetChildren_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetChildren", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetChildren_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetChildren_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetChildren_Statics::RigHierarchy_eventGetChildren_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetChildren_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetChildren_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetController_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetController", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetController_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetController_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetController_Statics::RigHierarchy_eventGetController_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetController_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetController_Statics::Function_MetaDataParams) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetControlPreferredEulerAngles", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles_Statics::RigHierarchy_eventGetControlPreferredEulerAngles_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles_Statics::Function_MetaDataParams) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAnglesByIndex_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetControlPreferredEulerRotationOrder_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetControlPreferredEulerRotationOrder", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::RigHierarchy_eventGetControlPreferredEulerRotationOrder_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder_Statics::Function_MetaDataParams) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrderByIndex_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
		{ "Comment", "/**\n\x09 * Returns a control's preferred euler rotation order\n\x09 * @param InElementIndex The element index to look up\n\x09 * @param bFromSettings If true the rotation order will be looked up from the control's settings, otherwise from the currently set animation value\n\x09 * @return Returns the current preferred euler rotation order\n\x09 */" },
		{ "CPP_Default_bFromSettings", "true" },
		{ "ModuleRelativePath", "Public/Rigs/RigHierarchy.h" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotatorByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetControlPreferredRotatorByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotatorByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotatorByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotatorByIndex_Statics::RigHierarchy_eventGetControlPreferredRotatorByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotatorByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotatorByIndex_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetControlValue_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetControlValue_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URigHierarchy_GetControlValue_Statics::NewProp_InValueType = { "InValueType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetControlValue_Parms, InValueType), Z_Construct_UEnum_ControlRig_ERigControlValueType, METADATA_PARAMS(0, nullptr) }; // 2049173526
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetCurveKeys_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetCurveKeys", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetCurveKeys_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetCurveKeys_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetCurveKeys_Statics::RigHierarchy_eventGetCurveKeys_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetCurveKeys_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetCurveKeys_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetCurveValue_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetCurveValue_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetCurveValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetCurveValue", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetCurveValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetCurveValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetCurveValue_Statics::RigHierarchy_eventGetCurveValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetCurveValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetCurveValue_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetCurveValueByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetCurveValueByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetCurveValueByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetCurveValueByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetCurveValueByIndex_Statics::RigHierarchy_eventGetCurveValueByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetCurveValueByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetCurveValueByIndex_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetDefaultParent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetDefaultParent", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetDefaultParent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetDefaultParent_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetDefaultParent_Statics::RigHierarchy_eventGetDefaultParent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetDefaultParent_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetDefaultParent_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetFirstParent_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetFirstParent_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetFirstParent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetFirstParent", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetFirstParent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetFirstParent_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetFirstParent_Statics::RigHierarchy_eventGetFirstParent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetFirstParent_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetFirstParent_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetGlobalControlShapeTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetGlobalControlShapeTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetGlobalTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetGlobalTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetGlobalTransform_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetGlobalTransform", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetGlobalTransform_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetGlobalTransform_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetGlobalTransform_Statics::RigHierarchy_eventGetGlobalTransform_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetGlobalTransform_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetGlobalTransform_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetGlobalTransformByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetGlobalTransformByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetGlobalTransformByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetGlobalTransformByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetGlobalTransformByIndex_Statics::RigHierarchy_eventGetGlobalTransformByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetGlobalTransformByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetGlobalTransformByIndex_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetIndex_ForBlueprint_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetIndex_ForBlueprint_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetInt32ArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetInt32ArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URigHierarchy_GetKeys_Statics::NewProp_InElementIndices = { "InElementIndices", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetKeys_Parms, InElementIndices), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetKeys_Statics::NewProp_InElementIndices_MetaData), Z_Construct_UFunction_URigHierarchy_GetKeys_Statics::NewProp_InElementIndices_MetaData) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetLocalControlShapeTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetLocalControlShapeTransform", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform_Statics::RigHierarchy_eventGetLocalControlShapeTransform_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetLocalIndex_ForBlueprint_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetLocalIndex_ForBlueprint_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetLocalTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetLocalTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetLocalTransform_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetLocalTransform", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetLocalTransform_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetLocalTransform_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetLocalTransform_Statics::RigHierarchy_eventGetLocalTransform_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetLocalTransform_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetLocalTransform_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetLocalTransformByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetLocalTransformByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetLocalTransformByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetLocalTransformByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetLocalTransformByIndex_Statics::RigHierarchy_eventGetLocalTransformByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetLocalTransformByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetLocalTransformByIndex_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetMetadataNames_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetMetadataNames_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetMetadataNames_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetMetadataNames", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetMetadataNames_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetMetadataNames_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetMetadataNames_Statics::RigHierarchy_eventGetMetadataNames_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetMetadataNames_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetMetadataNames_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetMetadataType_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetMetadataType_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetNameArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetNameArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetNameMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetNameMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetNameMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetNameMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetNameMetadata_Statics::RigHierarchy_eventGetNameMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetNameMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetNameMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetNullKeys_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetNullKeys", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetNullKeys_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetNullKeys_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetNullKeys_Statics::RigHierarchy_eventGetNullKeys_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetNullKeys_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetNullKeys_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetNumberOfParents_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetNumberOfParents", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetNumberOfParents_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetNumberOfParents_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetNumberOfParents_Statics::RigHierarchy_eventGetNumberOfParents_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetNumberOfParents_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetNumberOfParents_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetParents_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetParents_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetParents_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetParents", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetParents_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetParents_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetParents_Statics::RigHierarchy_eventGetParents_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetParents_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetParents_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetParentTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetParentTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetParentWeightArray_Statics::NewProp_InChild = { "InChild", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetParentWeightArray_Parms, InChild), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetPose_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetPose_Parms, ReturnValue), Z_Construct_UScriptStruct_FRigPose, METADATA_PARAMS(0, nullptr) }; // 3752599536
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetPose_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetPose", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetPose_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetPose_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetPose_Statics::RigHierarchy_eventGetPose_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetPose_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetPose_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetPreviousName_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::NewProp_InKey_MetaData), Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::NewProp_InKey_MetaData) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetPreviousName", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::RigHierarchy_eventGetPreviousName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetPreviousName_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetPreviousParent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetPreviousParent", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetPreviousParent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetPreviousParent_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetPreviousParent_Statics::RigHierarchy_eventGetPreviousParent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetPreviousParent_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetPreviousParent_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetQuatArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetQuatArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata_Statics::RigHierarchy_eventGetQuatArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetQuatMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetQuatMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetQuatMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetQuatMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetQuatMetadata_Statics::RigHierarchy_eventGetQuatMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetQuatMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetQuatMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetRigElementKeyArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetRigElementKeyArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetRigElementKeyArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetRigElementKeyArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetRigElementKeyArrayMetadata_Statics::RigHierarchy_eventGetRigElementKeyArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetRigElementKeyArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetRigElementKeyArrayMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetRigElementKeyMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetRigElementKeyMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetRigElementKeyMetadata_Statics::NewProp_DefaultValue = { "DefaultValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetRigElementKeyMetadata_Parms, DefaultValue), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::NewProp_bTraverse = { "bTraverse", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(RigHierarchy_eventGetRigidBodyKeys_Parms), &Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::NewProp_bTraverse_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetRigidBodyKeys_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetRigidBodyKeys", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::RigHierarchy_eventGetRigidBodyKeys_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys_Statics::RigHierarchy_eventGetRigidBodyKeys_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetRotatorArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetRotatorArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetRotatorArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetRotatorArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetRotatorArrayMetadata_Statics::RigHierarchy_eventGetRotatorArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetRotatorArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetRotatorArrayMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetRotatorMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetRotatorMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URigHierarchy_GetSelectedKeys_Statics::NewProp_InTypeFilter = { "InTypeFilter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetSelectedKeys_Parms, InTypeFilter), Z_Construct_UEnum_ControlRig_ERigElementType, METADATA_PARAMS(0, nullptr) }; // 3046126351
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetSelectedKeys_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetSelectedKeys", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetSelectedKeys_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetSelectedKeys_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetSelectedKeys_Statics::RigHierarchy_eventGetSelectedKeys_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetSelectedKeys_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetSelectedKeys_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetTransformArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetTransformArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetTransformMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetTransformMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetTransformMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetTransformMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetTransformMetadata_Statics::RigHierarchy_eventGetTransformMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetTransformMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetTransformMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventGetVectorArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "GetVectorArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata_Statics::RigHierarchy_eventGetVectorArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_HasTag_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventHasTag_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_HasTag_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "HasTag", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_HasTag_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_HasTag_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_HasTag_Statics::RigHierarchy_eventHasTag_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_HasTag_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_HasTag_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_IsCurveValueSet_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventIsCurveValueSet_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_IsParentedTo_Statics::NewProp_InChild = { "InChild", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventIsParentedTo_Parms, InChild), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_IsParentedTo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "IsParentedTo", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_IsParentedTo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_IsParentedTo_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_IsParentedTo_Statics::RigHierarchy_eventIsParentedTo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_IsParentedTo_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_IsParentedTo_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventIsProcedural_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::NewProp_InKey_MetaData), Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::NewProp_InKey_MetaData) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "IsProcedural", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::RigHierarchy_eventIsProcedural_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_IsProcedural_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_IsSelected_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventIsSelected_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_MakeControlValueFromInt_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "MakeControlValueFromInt", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_MakeControlValueFromInt_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromInt_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromInt_Statics::RigHierarchy_eventMakeControlValueFromInt_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromInt_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_MakeControlValueFromInt_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventMakeControlValueFromTransformNoScale_Parms, InValue), Z_Construct_UScriptStruct_FTransformNoScale, METADATA_PARAMS(0, nullptr) }; // 1064209631
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "MakeControlValueFromTransformNoScale", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale_Statics::RigHierarchy_eventMakeControlValueFromTransformNoScale_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "MakeControlValueFromVector", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector_Statics::RigHierarchy_eventMakeControlValueFromVector_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_Num_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "Num", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_Num_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_Num_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_Num_Statics::RigHierarchy_eventNum_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_Num_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_Num_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventRemoveAllMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "RemoveAllMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata_Statics::RigHierarchy_eventRemoveAllMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_RemoveMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventRemoveMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_RemoveMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "RemoveMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_RemoveMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_RemoveMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_RemoveMetadata_Statics::RigHierarchy_eventRemoveMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_RemoveMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_RemoveMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_Reset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "Reset", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_Reset_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_Reset_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_ResetCurveValues_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "ResetCurveValues", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_ResetCurveValues_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_ResetCurveValues_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_ResetPoseToInitial_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "ResetPoseToInitial", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_ResetPoseToInitial_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_ResetPoseToInitial_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_ResetPoseToInitial_Statics::RigHierarchy_eventResetPoseToInitial_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_ResetPoseToInitial_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_ResetPoseToInitial_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_ResetToDefault_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "ResetToDefault", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_ResetToDefault_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_ResetToDefault_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SendAutoKeyEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SendAutoKeyEvent", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SendAutoKeyEvent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SendAutoKeyEvent_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SendAutoKeyEvent_Statics::RigHierarchy_eventSendAutoKeyEvent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SendAutoKeyEvent_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SendAutoKeyEvent_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetBoolMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetBoolMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetBoolMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetBoolMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetBoolMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetBoolMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetBoolMetadata_Statics::RigHierarchy_eventSetBoolMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetBoolMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetBoolMetadata_Statics::Function_MetaDataParams) };
	...
	struct Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics
	{
		...
		static const UECodeGen_Private::FStructPropertyParams NewProp_InKey;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_InEulerAngles_MetaData[];
#endif
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlPreferredEulerAngles_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::NewProp_InEulerAngles_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::NewProp_InEulerAngles = { "InEulerAngles", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlPreferredEulerAngles_Parms, InEulerAngles), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::NewProp_InEulerAngles_MetaData), Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::NewProp_InEulerAngles_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetControlPreferredEulerAngles", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::RigHierarchy_eventSetControlPreferredEulerAngles_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C20401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles_Statics::Function_MetaDataParams) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAnglesByIndex_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
		{ "Comment", "/**\n\x09 * Sets a control's preferred euler angles (local transform rotation)\n\x09 * @param InElementIndex The element index to look up\n\x09 * @param InEulerAngles The new preferred euler angles to set\n\x09 * @param InRotationOrder The rotation order to use when setting the euler angles\n\x09 * @param bInitial If true we'll return the preferred euler angles for the initial - otherwise current transform\n\x09 * @param bFixEulerFlips If true the new euler angles value will use the shortest path\n\x09 */" },
		{ "CPP_Default_bFixEulerFlips", "false" },
		{ "CPP_Default_bInitial", "false" },
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotationOrder_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlPreferredRotationOrder_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotationOrder_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotationOrderByIndex_Statics::Function_MetaDataParams[] = {
		{ "Category", "URigHierarchy" },
		{ "Comment", "/**\n\x09 * Sets a control's preferred euler rotation order\n\x09 * @param InElementIndex The element index to look up\n\x09 * @param InRotationOrder The rotation order to use when setting the euler angles\n\x09 */" },
		{ "ModuleRelativePath", "Public/Rigs/RigHierarchy.h" },
		{ "ToolTip", "Sets a control's preferred euler rotation order\n@param InElementIndex The element index to look up\n@param InRotationOrder The rotation order to use when setting the euler angles" },
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotator_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlPreferredRotator_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotator_Statics::NewProp_InRotator_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotator_Statics::NewProp_InRotator = { "InRotator", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlPreferredRotator_Parms, InRotator), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotator_Statics::NewProp_InRotator_MetaData), Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotator_Statics::NewProp_InRotator_MetaData) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlSettings_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlSettings_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlSettings_Parms, InSettings), Z_Construct_UScriptStruct_FRigControlSettings, METADATA_PARAMS(0, nullptr) }; // 1696908835
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlSettingsByIndex_Parms, InSettings), Z_Construct_UScriptStruct_FRigControlSettings, METADATA_PARAMS(0, nullptr) }; // 1696908835
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetControlSettingsByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex_Statics::RigHierarchy_eventSetControlSettingsByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlShapeTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlShapeTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetControlShapeTransformByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetControlShapeTransformByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetControlShapeTransformByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlShapeTransformByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetControlShapeTransformByIndex_Statics::RigHierarchy_eventSetControlShapeTransformByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlShapeTransformByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetControlShapeTransformByIndex_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlValue_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::NewProp_InValueType = { "InValueType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlValue_Parms, InValueType), Z_Construct_UEnum_ControlRig_ERigControlValueType, METADATA_PARAMS(0, nullptr) }; // 2049173526
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetControlValue", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::RigHierarchy_eventSetControlValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetControlValue_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex_Statics::NewProp_InValueType = { "InValueType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetControlValueByIndex_Parms, InValueType), Z_Construct_UEnum_ControlRig_ERigControlValueType, METADATA_PARAMS(0, nullptr) }; // 2049173526
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetControlValueByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex_Statics::RigHierarchy_eventSetControlValueByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetControlVisibility_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetControlVisibility", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetControlVisibility_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlVisibility_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetControlVisibility_Statics::RigHierarchy_eventSetControlVisibility_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetControlVisibility_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetControlVisibility_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetCurveValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetCurveValue", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetCurveValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetCurveValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetCurveValue_Statics::RigHierarchy_eventSetCurveValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetCurveValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetCurveValue_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetCurveValueByIndex_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetCurveValueByIndex", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetCurveValueByIndex_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetCurveValueByIndex_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetCurveValueByIndex_Statics::RigHierarchy_eventSetCurveValueByIndex_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetCurveValueByIndex_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetCurveValueByIndex_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetFloatArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetFloatArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetFloatArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetFloatArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetFloatArrayMetadata_Statics::RigHierarchy_eventSetFloatArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetFloatArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetFloatArrayMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetFloatMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetFloatMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetFloatMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetFloatMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetFloatMetadata_Statics::RigHierarchy_eventSetFloatMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetFloatMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetFloatMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetGlobalTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetGlobalTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetInt32ArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetInt32ArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetInt32ArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetInt32ArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetInt32ArrayMetadata_Statics::RigHierarchy_eventSetInt32ArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetInt32ArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetInt32ArrayMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetInt32Metadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetInt32Metadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetInt32Metadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetInt32Metadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetInt32Metadata_Statics::RigHierarchy_eventSetInt32Metadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetInt32Metadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetInt32Metadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetLocalTransform_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetLocalTransform_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetNameArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetNameArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetNameMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetNameMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetParentWeight_Statics::NewProp_InChild = { "InChild", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetParentWeight_Parms, InChild), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetParentWeight_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetParentWeight", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetParentWeight_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetParentWeight_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetParentWeight_Statics::RigHierarchy_eventSetParentWeight_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetParentWeight_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetParentWeight_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetParentWeightArray_Statics::NewProp_InChild = { "InChild", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetParentWeightArray_Parms, InChild), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetParentWeightArray_Statics::NewProp_InWeights_Inner = { "InWeights", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRigElementWeight, METADATA_PARAMS(0, nullptr) }; // 3264220926
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URigHierarchy_SetParentWeightArray_Statics::NewProp_InWeights = { "InWeights", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetParentWeightArray_Parms, InWeights), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 3264220926
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetPose_ForBlueprint_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetPose_ForBlueprint", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetPose_ForBlueprint_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetPose_ForBlueprint_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetPose_ForBlueprint_Statics::RigHierarchy_eventSetPose_ForBlueprint_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetPose_ForBlueprint_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetPose_ForBlueprint_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetQuatArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetQuatArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetQuatMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetQuatMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetRigElementKeyArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetRigElementKeyArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URigHierarchy_SetRigElementKeyArrayMetadata_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetRigElementKeyArrayMetadata_Parms, InValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetRigElementKeyMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetRigElementKeyMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetRigElementKeyMetadata_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetRigElementKeyMetadata_Parms, InValue), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetTag_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetTag", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetTag_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetTag_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetTag_Statics::RigHierarchy_eventSetTag_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetTag_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetTag_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetTransformArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetTransformArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata_Statics::NewProp_InItem = { "InItem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSetVectorArrayMetadata_Parms, InItem), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetVectorArrayMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata_Statics::RigHierarchy_eventSetVectorArrayMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SetVectorMetadata_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SetVectorMetadata", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SetVectorMetadata_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetVectorMetadata_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SetVectorMetadata_Statics::RigHierarchy_eventSetVectorMetadata_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SetVectorMetadata_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SetVectorMetadata_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent_Statics::NewProp_InChild = { "InChild", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSwitchToDefaultParent_Parms, InChild), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SwitchToDefaultParent", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent_Statics::RigHierarchy_eventSwitchToDefaultParent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SwitchToParent_Statics::NewProp_InChild = { "InChild", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSwitchToParent_Parms, InChild), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace_Statics::NewProp_InChild = { "InChild", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventSwitchToWorldSpace_Parms, InChild), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigHierarchy, nullptr, "SwitchToWorldSpace", nullptr, nullptr, Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace_Statics::RigHierarchy_eventSwitchToWorldSpace_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URigHierarchy_UnsetCurveValue_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RigHierarchy_eventUnsetCurveValue_Parms, InKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
...
#endif
		static const UECodeGen_Private::FUInt16PropertyParams NewProp_TopologyVersion;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MetadataVersion_MetaData[];
#endif
		static const UECodeGen_Private::FUInt16PropertyParams NewProp_MetadataVersion;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URigHierarchy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URigHierarchy_Contains_ForBlueprint, "Contains_ForBlueprint" }, // 2861849011
		{ &Z_Construct_UFunction_URigHierarchy_CopyHierarchy, "CopyHierarchy" }, // 1335038612
		{ &Z_Construct_UFunction_URigHierarchy_CopyPose, "CopyPose" }, // 1441258761
		{ &Z_Construct_UFunction_URigHierarchy_FindBone_ForBlueprintOnly, "FindBone_ForBlueprintOnly" }, // 2730710304
		{ &Z_Construct_UFunction_URigHierarchy_FindControl_ForBlueprintOnly, "FindControl_ForBlueprintOnly" }, // 1618453870
		{ &Z_Construct_UFunction_URigHierarchy_FindNull_ForBlueprintOnly, "FindNull_ForBlueprintOnly" }, // 3705120776
		{ &Z_Construct_UFunction_URigHierarchy_GetAllKeys_ForBlueprint, "GetAllKeys_ForBlueprint" }, // 3055888732
		{ &Z_Construct_UFunction_URigHierarchy_GetBoneKeys, "GetBoneKeys" }, // 2276196445
		{ &Z_Construct_UFunction_URigHierarchy_GetBoolArrayMetadata, "GetBoolArrayMetadata" }, // 2465121930
		{ &Z_Construct_UFunction_URigHierarchy_GetBoolMetadata, "GetBoolMetadata" }, // 3431298440
		{ &Z_Construct_UFunction_URigHierarchy_GetChildren, "GetChildren" }, // 3761393263
		{ &Z_Construct_UFunction_URigHierarchy_GetControlKeys, "GetControlKeys" }, // 526062131
		{ &Z_Construct_UFunction_URigHierarchy_GetController, "GetController" }, // 165378599
		{ &Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAngles, "GetControlPreferredEulerAngles" }, // 562213952
		{ &Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerAnglesByIndex, "GetControlPreferredEulerAnglesByIndex" }, // 212655293
		{ &Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrder, "GetControlPreferredEulerRotationOrder" }, // 279788270
		{ &Z_Construct_UFunction_URigHierarchy_GetControlPreferredEulerRotationOrderByIndex, "GetControlPreferredEulerRotationOrderByIndex" }, // 876007570
		{ &Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotator, "GetControlPreferredRotator" }, // 2461443892
		{ &Z_Construct_UFunction_URigHierarchy_GetControlPreferredRotatorByIndex, "GetControlPreferredRotatorByIndex" }, // 2560946651
		{ &Z_Construct_UFunction_URigHierarchy_GetControlValue, "GetControlValue" }, // 138186887
		{ &Z_Construct_UFunction_URigHierarchy_GetControlValueByIndex, "GetControlValueByIndex" }, // 2072392523
		{ &Z_Construct_UFunction_URigHierarchy_GetCurveKeys, "GetCurveKeys" }, // 3953041558
		{ &Z_Construct_UFunction_URigHierarchy_GetCurveValue, "GetCurveValue" }, // 1102920240
		{ &Z_Construct_UFunction_URigHierarchy_GetCurveValueByIndex, "GetCurveValueByIndex" }, // 3270928385
		{ &Z_Construct_UFunction_URigHierarchy_GetDefaultParent, "GetDefaultParent" }, // 1770213954
		{ &Z_Construct_UFunction_URigHierarchy_GetEulerTransformFromControlValue, "GetEulerTransformFromControlValue" }, // 3135356105
		{ &Z_Construct_UFunction_URigHierarchy_GetFirstParent, "GetFirstParent" }, // 4274349625
		{ &Z_Construct_UFunction_URigHierarchy_GetFloatArrayMetadata, "GetFloatArrayMetadata" }, // 1577631019
		{ &Z_Construct_UFunction_URigHierarchy_GetFloatFromControlValue, "GetFloatFromControlValue" }, // 2426629236
		{ &Z_Construct_UFunction_URigHierarchy_GetFloatMetadata, "GetFloatMetadata" }, // 4274747221
		{ &Z_Construct_UFunction_URigHierarchy_GetGlobalControlOffsetTransform, "GetGlobalControlOffsetTransform" }, // 4231723826
		{ &Z_Construct_UFunction_URigHierarchy_GetGlobalControlOffsetTransformByIndex, "GetGlobalControlOffsetTransformByIndex" }, // 845426173
		{ &Z_Construct_UFunction_URigHierarchy_GetGlobalControlShapeTransform, "GetGlobalControlShapeTransform" }, // 4125500712
		{ &Z_Construct_UFunction_URigHierarchy_GetGlobalControlShapeTransformByIndex, "GetGlobalControlShapeTransformByIndex" }, // 4103348550
		{ &Z_Construct_UFunction_URigHierarchy_GetGlobalTransform, "GetGlobalTransform" }, // 301925681
		{ &Z_Construct_UFunction_URigHierarchy_GetGlobalTransformByIndex, "GetGlobalTransformByIndex" }, // 1375521
		{ &Z_Construct_UFunction_URigHierarchy_GetIndex_ForBlueprint, "GetIndex_ForBlueprint" }, // 1957403975
		{ &Z_Construct_UFunction_URigHierarchy_GetInt32ArrayMetadata, "GetInt32ArrayMetadata" }, // 1383264280
		{ &Z_Construct_UFunction_URigHierarchy_GetInt32Metadata, "GetInt32Metadata" }, // 3514764640
		{ &Z_Construct_UFunction_URigHierarchy_GetIntFromControlValue, "GetIntFromControlValue" }, // 4109538692
		{ &Z_Construct_UFunction_URigHierarchy_GetKey, "GetKey" }, // 1155148850
		{ &Z_Construct_UFunction_URigHierarchy_GetKeys, "GetKeys" }, // 4069417600
		{ &Z_Construct_UFunction_URigHierarchy_GetLinearColorArrayMetadata, "GetLinearColorArrayMetadata" }, // 632719747
		{ &Z_Construct_UFunction_URigHierarchy_GetLinearColorMetadata, "GetLinearColorMetadata" }, // 1696607552
		{ &Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransform, "GetLocalControlShapeTransform" }, // 1871323234
		{ &Z_Construct_UFunction_URigHierarchy_GetLocalControlShapeTransformByIndex, "GetLocalControlShapeTransformByIndex" }, // 3979424173
		{ &Z_Construct_UFunction_URigHierarchy_GetLocalIndex_ForBlueprint, "GetLocalIndex_ForBlueprint" }, // 789289756
		{ &Z_Construct_UFunction_URigHierarchy_GetLocalTransform, "GetLocalTransform" }, // 2585564701
		{ &Z_Construct_UFunction_URigHierarchy_GetLocalTransformByIndex, "GetLocalTransformByIndex" }, // 768096342
		{ &Z_Construct_UFunction_URigHierarchy_GetMetadataNames, "GetMetadataNames" }, // 2839642656
		{ &Z_Construct_UFunction_URigHierarchy_GetMetadataType, "GetMetadataType" }, // 3439964533
		{ &Z_Construct_UFunction_URigHierarchy_GetNameArrayMetadata, "GetNameArrayMetadata" }, // 3793692362
		{ &Z_Construct_UFunction_URigHierarchy_GetNameMetadata, "GetNameMetadata" }, // 222365389
		{ &Z_Construct_UFunction_URigHierarchy_GetNullKeys, "GetNullKeys" }, // 2928815468
		{ &Z_Construct_UFunction_URigHierarchy_GetNumberOfParents, "GetNumberOfParents" }, // 3939484977
		{ &Z_Construct_UFunction_URigHierarchy_GetParents, "GetParents" }, // 842164889
		{ &Z_Construct_UFunction_URigHierarchy_GetParentTransform, "GetParentTransform" }, // 1940368939
		{ &Z_Construct_UFunction_URigHierarchy_GetParentTransformByIndex, "GetParentTransformByIndex" }, // 249381741
		{ &Z_Construct_UFunction_URigHierarchy_GetParentWeight, "GetParentWeight" }, // 859556548
		{ &Z_Construct_UFunction_URigHierarchy_GetParentWeightArray, "GetParentWeightArray" }, // 20302149
		{ &Z_Construct_UFunction_URigHierarchy_GetPose, "GetPose" }, // 1465983562
		{ &Z_Construct_UFunction_URigHierarchy_GetPreviousName, "GetPreviousName" }, // 270910583
		{ &Z_Construct_UFunction_URigHierarchy_GetPreviousParent, "GetPreviousParent" }, // 249332887
		{ &Z_Construct_UFunction_URigHierarchy_GetQuatArrayMetadata, "GetQuatArrayMetadata" }, // 4179858774
		{ &Z_Construct_UFunction_URigHierarchy_GetQuatMetadata, "GetQuatMetadata" }, // 3452017030
		{ &Z_Construct_UFunction_URigHierarchy_GetReferenceKeys, "GetReferenceKeys" }, // 1224141075
		{ &Z_Construct_UFunction_URigHierarchy_GetRigElementKeyArrayMetadata, "GetRigElementKeyArrayMetadata" }, // 1943910148
		{ &Z_Construct_UFunction_URigHierarchy_GetRigElementKeyMetadata, "GetRigElementKeyMetadata" }, // 2136395685
		{ &Z_Construct_UFunction_URigHierarchy_GetRigidBodyKeys, "GetRigidBodyKeys" }, // 3512021482
		{ &Z_Construct_UFunction_URigHierarchy_GetRootElementKeys, "GetRootElementKeys" }, // 3297074485
		{ &Z_Construct_UFunction_URigHierarchy_GetRotatorArrayMetadata, "GetRotatorArrayMetadata" }, // 108819670
		{ &Z_Construct_UFunction_URigHierarchy_GetRotatorFromControlValue, "GetRotatorFromControlValue" }, // 1579104162
		{ &Z_Construct_UFunction_URigHierarchy_GetRotatorMetadata, "GetRotatorMetadata" }, // 4027909865
		{ &Z_Construct_UFunction_URigHierarchy_GetSelectedKeys, "GetSelectedKeys" }, // 3506081994
		{ &Z_Construct_UFunction_URigHierarchy_GetTags, "GetTags" }, // 2470921228
		{ &Z_Construct_UFunction_URigHierarchy_GetTransformArrayMetadata, "GetTransformArrayMetadata" }, // 235389645
		{ &Z_Construct_UFunction_URigHierarchy_GetTransformFromControlValue, "GetTransformFromControlValue" }, // 619517187
		{ &Z_Construct_UFunction_URigHierarchy_GetTransformMetadata, "GetTransformMetadata" }, // 3937813869
		{ &Z_Construct_UFunction_URigHierarchy_GetTransformNoScaleFromControlValue, "GetTransformNoScaleFromControlValue" }, // 215877061
		{ &Z_Construct_UFunction_URigHierarchy_GetVector2DFromControlValue, "GetVector2DFromControlValue" }, // 1776223089
		{ &Z_Construct_UFunction_URigHierarchy_GetVectorArrayMetadata, "GetVectorArrayMetadata" }, // 2426747566
		{ &Z_Construct_UFunction_URigHierarchy_GetVectorFromControlValue, "GetVectorFromControlValue" }, // 2928779808
		{ &Z_Construct_UFunction_URigHierarchy_GetVectorMetadata, "GetVectorMetadata" }, // 1217743644
		{ &Z_Construct_UFunction_URigHierarchy_HasTag, "HasTag" }, // 130732855
		{ &Z_Construct_UFunction_URigHierarchy_IsControllerAvailable, "IsControllerAvailable" }, // 908367660
		{ &Z_Construct_UFunction_URigHierarchy_IsCurveValueSet, "IsCurveValueSet" }, // 4116333481
		{ &Z_Construct_UFunction_URigHierarchy_IsCurveValueSetByIndex, "IsCurveValueSetByIndex" }, // 3094947028
		{ &Z_Construct_UFunction_URigHierarchy_IsParentedTo, "IsParentedTo" }, // 3487121651
		{ &Z_Construct_UFunction_URigHierarchy_IsProcedural, "IsProcedural" }, // 1344407984
		{ &Z_Construct_UFunction_URigHierarchy_IsSelected, "IsSelected" }, // 2936147411
		{ &Z_Construct_UFunction_URigHierarchy_IsSelectedByIndex, "IsSelectedByIndex" }, // 2108105167
		{ &Z_Construct_UFunction_URigHierarchy_IsValidIndex, "IsValidIndex" }, // 3592010875
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromBool, "MakeControlValueFromBool" }, // 3295979379
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromEulerTransform, "MakeControlValueFromEulerTransform" }, // 626587307
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromFloat, "MakeControlValueFromFloat" }, // 2956047863
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromInt, "MakeControlValueFromInt" }, // 1936820230
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromRotator, "MakeControlValueFromRotator" }, // 2354396034
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransform, "MakeControlValueFromTransform" }, // 1692455506
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromTransformNoScale, "MakeControlValueFromTransformNoScale" }, // 2126571810
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector, "MakeControlValueFromVector" }, // 1887636262
		{ &Z_Construct_UFunction_URigHierarchy_MakeControlValueFromVector2D, "MakeControlValueFromVector2D" }, // 1646460394
		{ &Z_Construct_UFunction_URigHierarchy_Num, "Num" }, // 3467981730
		{ &Z_Construct_UFunction_URigHierarchy_RemoveAllMetadata, "RemoveAllMetadata" }, // 3710205958
		{ &Z_Construct_UFunction_URigHierarchy_RemoveMetadata, "RemoveMetadata" }, // 3816640580
		{ &Z_Construct_UFunction_URigHierarchy_Reset, "Reset" }, // 2649549675
		{ &Z_Construct_UFunction_URigHierarchy_ResetCurveValues, "ResetCurveValues" }, // 1156936448
		{ &Z_Construct_UFunction_URigHierarchy_ResetPoseToInitial, "ResetPoseToInitial" }, // 238504404
		{ &Z_Construct_UFunction_URigHierarchy_ResetToDefault, "ResetToDefault" }, // 3384988638
		{ &Z_Construct_UFunction_URigHierarchy_SendAutoKeyEvent, "SendAutoKeyEvent" }, // 492825560
		{ &Z_Construct_UFunction_URigHierarchy_SetBoolArrayMetadata, "SetBoolArrayMetadata" }, // 2615427199
		{ &Z_Construct_UFunction_URigHierarchy_SetBoolMetadata, "SetBoolMetadata" }, // 3900197069
		{ &Z_Construct_UFunction_URigHierarchy_SetControlOffsetTransform, "SetControlOffsetTransform" }, // 3663336694
		{ &Z_Construct_UFunction_URigHierarchy_SetControlOffsetTransformByIndex, "SetControlOffsetTransformByIndex" }, // 386935255
		{ &Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAngles, "SetControlPreferredEulerAngles" }, // 2642619474
		{ &Z_Construct_UFunction_URigHierarchy_SetControlPreferredEulerAnglesByIndex, "SetControlPreferredEulerAnglesByIndex" }, // 675618525
		{ &Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotationOrder, "SetControlPreferredRotationOrder" }, // 233632292
		{ &Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotationOrderByIndex, "SetControlPreferredRotationOrderByIndex" }, // 1154343096
		{ &Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotator, "SetControlPreferredRotator" }, // 3150452885
		{ &Z_Construct_UFunction_URigHierarchy_SetControlPreferredRotatorByIndex, "SetControlPreferredRotatorByIndex" }, // 2408449430
		{ &Z_Construct_UFunction_URigHierarchy_SetControlSettings, "SetControlSettings" }, // 3348066170
		{ &Z_Construct_UFunction_URigHierarchy_SetControlSettingsByIndex, "SetControlSettingsByIndex" }, // 627904830
		{ &Z_Construct_UFunction_URigHierarchy_SetControlShapeTransform, "SetControlShapeTransform" }, // 2247611246
		{ &Z_Construct_UFunction_URigHierarchy_SetControlShapeTransformByIndex, "SetControlShapeTransformByIndex" }, // 1785562299
		{ &Z_Construct_UFunction_URigHierarchy_SetControlValue, "SetControlValue" }, // 412337403
		{ &Z_Construct_UFunction_URigHierarchy_SetControlValueByIndex, "SetControlValueByIndex" }, // 3075271609
		{ &Z_Construct_UFunction_URigHierarchy_SetControlVisibility, "SetControlVisibility" }, // 1999678839
		{ &Z_Construct_UFunction_URigHierarchy_SetControlVisibilityByIndex, "SetControlVisibilityByIndex" }, // 2341866341
		{ &Z_Construct_UFunction_URigHierarchy_SetCurveValue, "SetCurveValue" }, // 3309581889
		{ &Z_Construct_UFunction_URigHierarchy_SetCurveValueByIndex, "SetCurveValueByIndex" }, // 1627116976
		{ &Z_Construct_UFunction_URigHierarchy_SetFloatArrayMetadata, "SetFloatArrayMetadata" }, // 4229887516
		{ &Z_Construct_UFunction_URigHierarchy_SetFloatMetadata, "SetFloatMetadata" }, // 2370690212
		{ &Z_Construct_UFunction_URigHierarchy_SetGlobalTransform, "SetGlobalTransform" }, // 3267658613
		{ &Z_Construct_UFunction_URigHierarchy_SetGlobalTransformByIndex, "SetGlobalTransformByIndex" }, // 2813312762
		{ &Z_Construct_UFunction_URigHierarchy_SetInt32ArrayMetadata, "SetInt32ArrayMetadata" }, // 1482012137
		{ &Z_Construct_UFunction_URigHierarchy_SetInt32Metadata, "SetInt32Metadata" }, // 981468263
		{ &Z_Construct_UFunction_URigHierarchy_SetLinearColorArrayMetadata, "SetLinearColorArrayMetadata" }, // 186069653
		{ &Z_Construct_UFunction_URigHierarchy_SetLinearColorMetadata, "SetLinearColorMetadata" }, // 622804599
		{ &Z_Construct_UFunction_URigHierarchy_SetLocalTransform, "SetLocalTransform" }, // 1124698083
		{ &Z_Construct_UFunction_URigHierarchy_SetLocalTransformByIndex, "SetLocalTransformByIndex" }, // 3788957524
		{ &Z_Construct_UFunction_URigHierarchy_SetNameArrayMetadata, "SetNameArrayMetadata" }, // 780770643
		{ &Z_Construct_UFunction_URigHierarchy_SetNameMetadata, "SetNameMetadata" }, // 4268554807
		{ &Z_Construct_UFunction_URigHierarchy_SetParentWeight, "SetParentWeight" }, // 380862239
		{ &Z_Construct_UFunction_URigHierarchy_SetParentWeightArray, "SetParentWeightArray" }, // 2352707900
		{ &Z_Construct_UFunction_URigHierarchy_SetPose_ForBlueprint, "SetPose_ForBlueprint" }, // 1444772924
		{ &Z_Construct_UFunction_URigHierarchy_SetQuatArrayMetadata, "SetQuatArrayMetadata" }, // 1266247168
		{ &Z_Construct_UFunction_URigHierarchy_SetQuatMetadata, "SetQuatMetadata" }, // 3642951474
		{ &Z_Construct_UFunction_URigHierarchy_SetRigElementKeyArrayMetadata, "SetRigElementKeyArrayMetadata" }, // 4061549631
		{ &Z_Construct_UFunction_URigHierarchy_SetRigElementKeyMetadata, "SetRigElementKeyMetadata" }, // 3140126490
		{ &Z_Construct_UFunction_URigHierarchy_SetRotatorArrayMetadata, "SetRotatorArrayMetadata" }, // 2532505993
		{ &Z_Construct_UFunction_URigHierarchy_SetRotatorMetadata, "SetRotatorMetadata" }, // 793942332
		{ &Z_Construct_UFunction_URigHierarchy_SetTag, "SetTag" }, // 417607071
		{ &Z_Construct_UFunction_URigHierarchy_SetTransformArrayMetadata, "SetTransformArrayMetadata" }, // 2192582682
		{ &Z_Construct_UFunction_URigHierarchy_SetTransformMetadata, "SetTransformMetadata" }, // 2811252103
		{ &Z_Construct_UFunction_URigHierarchy_SetVectorArrayMetadata, "SetVectorArrayMetadata" }, // 3562964090
		{ &Z_Construct_UFunction_URigHierarchy_SetVectorMetadata, "SetVectorMetadata" }, // 4136060084
		{ &Z_Construct_UFunction_URigHierarchy_SortKeys, "SortKeys" }, // 3958756078
		{ &Z_Construct_UFunction_URigHierarchy_SwitchToDefaultParent, "SwitchToDefaultParent" }, // 442023265
		{ &Z_Construct_UFunction_URigHierarchy_SwitchToParent, "SwitchToParent" }, // 3784032924
		{ &Z_Construct_UFunction_URigHierarchy_SwitchToWorldSpace, "SwitchToWorldSpace" }, // 1139118159
		{ &Z_Construct_UFunction_URigHierarchy_UnsetCurveValue, "UnsetCurveValue" }, // 672916054
		{ &Z_Construct_UFunction_URigHierarchy_UnsetCurveValueByIndex, "UnsetCurveValueByIndex" }, // 2209502663
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URigHierarchy_Statics::NewProp_ModifiedEventDynamic_MetaData[] = {
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_TopologyVersion = { "TopologyVersion", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigHierarchy, TopologyVersion), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_TopologyVersion_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_TopologyVersion_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_MetadataVersion = { "MetadataVersion", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigHierarchy, MetadataVersion), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_MetadataVersion_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_MetadataVersion_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_MetadataTagVersion = { "MetadataTagVersion", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigHierarchy, MetadataTagVersion), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_MetadataTagVersion_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_MetadataTagVersion_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_bEnableDirtyPropagation = { "bEnableDirtyPropagation", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URigHierarchy), &Z_Construct_UClass_URigHierarchy_Statics::NewProp_bEnableDirtyPropagation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_bEnableDirtyPropagation_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_bEnableDirtyPropagation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_TransformStackIndex = { "TransformStackIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigHierarchy, TransformStackIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_TransformStackIndex_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_TransformStackIndex_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URigHierarchy_Statics::NewProp_HierarchyController_MetaData[] = {
		{ "ModuleRelativePath", "Public/Rigs/RigHierarchy.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_HierarchyController = { "HierarchyController", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigHierarchy, HierarchyController), Z_Construct_UClass_URigHierarchyController_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_HierarchyController_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_HierarchyController_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_PreviousNameMap_ValueProp = { "PreviousNameMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_PreviousNameMap_Key_KeyProp = { "PreviousNameMap_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(0, nullptr) }; // 422817336
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_PreviousNameMap = { "PreviousNameMap", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigHierarchy, PreviousNameMap), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_PreviousNameMap_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_PreviousNameMap_MetaData) }; // 422817336 422817336
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URigHierarchy_Statics::NewProp_HierarchyForCacheValidation = { "HierarchyForCacheValidation", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigHierarchy, HierarchyForCacheValidation), Z_Construct_UClass_URigHierarchy_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigHierarchy_Statics::NewProp_HierarchyForCacheValidation_MetaData), Z_Construct_UClass_URigHierarchy_Statics::NewProp_HierarchyForCacheValidation_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchy_h_Statics::EnumInfo[] = {
		{ ERigTransformStackEntryType_StaticEnum, TEXT("ERigTransformStackEntryType"), &Z_Registration_Info_UEnum_ERigTransformStackEntryType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2538613307U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchy_h_Statics::ScriptStructInfo[] = {
		{ FRigTransformStackEntry::StaticStruct, Z_Construct_UScriptStruct_FRigTransformStackEntry_Statics::NewStructOps, TEXT("RigTransformStackEntry"), &Z_Registration_Info_UScriptStruct_RigTransformStackEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigTransformStackEntry), 1901214166U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URigHierarchy, URigHierarchy::StaticClass, TEXT("URigHierarchy"), &Z_Registration_Info_UClass_URigHierarchy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URigHierarchy), 2586412537U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchy_h_3964379082(TEXT("/Script/ControlRig"),
