...
#include "../Private/Units/Debug/RigUnit_DebugBase.h"
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_DebugBaseMutable>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Debug_RigUnit_DebugBase_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_DebugBase::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_DebugBase_Statics::NewStructOps, TEXT("RigUnit_DebugBase"), &Z_Registration_Info_UScriptStruct_RigUnit_DebugBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_DebugBase), 2603657887U) },
		{ FRigUnit_DebugBaseMutable::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_DebugBaseMutable_Statics::NewStructOps, TEXT("RigUnit_DebugBaseMutable"), &Z_Registration_Info_UScriptStruct_RigUnit_DebugBaseMutable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_DebugBaseMutable), 760256544U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Debug_RigUnit_DebugBase_h_516249085(TEXT("/Script/ControlRig"),
		nullptr, 0,
