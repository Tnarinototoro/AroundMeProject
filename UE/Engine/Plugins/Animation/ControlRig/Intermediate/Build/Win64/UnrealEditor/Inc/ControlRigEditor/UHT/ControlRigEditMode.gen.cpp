...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UControlRigEditModeDelegateHelper_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UControlRigEditModeDelegateHelper_OnPoseInitialized, "OnPoseInitialized" }, // 4033224991
		{ &Z_Construct_UFunction_UControlRigEditModeDelegateHelper_PostPoseUpdate, "PostPoseUpdate" }, // 2491427083
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigEditModeDelegateHelper_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_EditMode_ControlRigEditMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_EditMode_ControlRigEditMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigEditModeDelegateHelper, UControlRigEditModeDelegateHelper::StaticClass, TEXT("UControlRigEditModeDelegateHelper"), &Z_Registration_Info_UClass_UControlRigEditModeDelegateHelper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigEditModeDelegateHelper), 2831949974U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_EditMode_ControlRigEditMode_h_1318680505(TEXT("/Script/ControlRigEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_EditMode_ControlRigEditMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_EditMode_ControlRigEditMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
