...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetInitialBoneTransform, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Transform_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Transform_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_CachedBone = { "CachedBone", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetInitialBoneTransform, CachedBone), Z_Construct_UScriptStruct_FCachedRigElement, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_CachedBone_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_CachedBone_MetaData) }; // 968212372
...
void FRigUnit_GetInitialBoneTransform::Execute(const FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetInitialBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetInitialBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewStructOps, TEXT("RigUnit_GetInitialBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetInitialBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetInitialBoneTransform), 3056189709U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetInitialBoneTransform_h_836332329(TEXT("/Script/ControlRig"),
		nullptr, 0,
