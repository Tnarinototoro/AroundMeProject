...
#define FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Core_RigUnit_UserData_h_14_GENERATED_BODY \
...
#define FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Core_RigUnit_UserData_h_46_GENERATED_BODY \
	...
	{ \
		...
		const bool ReplaceExisting = *(bool*)RigVMMemoryHandles[3].GetData(false); \
		const bool LogShapeLibraries = *(bool*)RigVMMemoryHandles[4].GetData(false); \
		 \
		StaticExecute( \
...
#define FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Core_RigUnit_UserData_h_98_GENERATED_BODY \
...
#define CURRENT_FILE_ID FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Core_RigUnit_UserData_h
