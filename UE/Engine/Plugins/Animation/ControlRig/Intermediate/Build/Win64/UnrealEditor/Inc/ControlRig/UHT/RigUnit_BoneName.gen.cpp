...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_SpaceName_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SpaceName, Space), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SpaceName_Statics::NewProp_Space_MetaData), Z_Construct_UScriptStruct_FRigUnit_SpaceName_Statics::NewProp_Space_MetaData) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_ControlName_Statics::NewProp_Control = { "Control", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_ControlName, Control), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ControlName_Statics::NewProp_Control_MetaData), Z_Construct_UScriptStruct_FRigUnit_ControlName_Statics::NewProp_Control_MetaData) };
...
void FRigUnit_ControlName::Execute(const FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_BoneName_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_Item::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_Item_Statics::NewStructOps, TEXT("RigUnit_Item"), &Z_Registration_Info_UScriptStruct_RigUnit_Item, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_Item), 1614690239U) },
		{ FRigUnit_ItemArray::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ItemArray_Statics::NewStructOps, TEXT("RigUnit_ItemArray"), &Z_Registration_Info_UScriptStruct_RigUnit_ItemArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ItemArray), 2857712446U) },
		{ FRigUnit_BoneName::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_BoneName_Statics::NewStructOps, TEXT("RigUnit_BoneName"), &Z_Registration_Info_UScriptStruct_RigUnit_BoneName, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_BoneName), 1134980780U) },
		{ FRigUnit_SpaceName::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SpaceName_Statics::NewStructOps, TEXT("RigUnit_SpaceName"), &Z_Registration_Info_UScriptStruct_RigUnit_SpaceName, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SpaceName), 3887746264U) },
		{ FRigUnit_ControlName::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ControlName_Statics::NewStructOps, TEXT("RigUnit_ControlName"), &Z_Registration_Info_UScriptStruct_RigUnit_ControlName, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ControlName), 1590382847U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_BoneName_h_1696455963(TEXT("/Script/ControlRig"),
		nullptr, 0,
