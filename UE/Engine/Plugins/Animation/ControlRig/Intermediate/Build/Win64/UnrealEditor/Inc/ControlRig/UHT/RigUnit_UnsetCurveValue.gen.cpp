...
void FRigUnit_UnsetCurveValue::Execute(FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_UnsetCurveValue_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_UnsetCurveValue::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_UnsetCurveValue_Statics::NewStructOps, TEXT("RigUnit_UnsetCurveValue"), &Z_Registration_Info_UScriptStruct_RigUnit_UnsetCurveValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_UnsetCurveValue), 3509796982U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_UnsetCurveValue_h_1291073043(TEXT("/Script/ControlRig"),
		nullptr, 0,
