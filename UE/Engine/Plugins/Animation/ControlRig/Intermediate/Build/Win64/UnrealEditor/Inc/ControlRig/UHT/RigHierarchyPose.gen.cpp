...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigPose>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigPose_Statics::NewProp_HierarchyTopologyVersion = { "HierarchyTopologyVersion", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigPose, HierarchyTopologyVersion), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigPose_Statics::NewProp_HierarchyTopologyVersion_MetaData), Z_Construct_UScriptStruct_FRigPose_Statics::NewProp_HierarchyTopologyVersion_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigPose_Statics::NewProp_PoseHash_MetaData[] = {
		{ "ModuleRelativePath", "Public/Rigs/RigHierarchyPose.h" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigPose_Statics::NewProp_PoseHash = { "PoseHash", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigPose, PoseHash), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigPose_Statics::NewProp_PoseHash_MetaData), Z_Construct_UScriptStruct_FRigPose_Statics::NewProp_PoseHash_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyPose_h_Statics::ScriptStructInfo[] = {
		{ FRigPoseElement::StaticStruct, Z_Construct_UScriptStruct_FRigPoseElement_Statics::NewStructOps, TEXT("RigPoseElement"), &Z_Registration_Info_UScriptStruct_RigPoseElement, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigPoseElement), 1084981828U) },
		{ FRigPose::StaticStruct, Z_Construct_UScriptStruct_FRigPose_Statics::NewStructOps, TEXT("RigPose"), &Z_Registration_Info_UScriptStruct_RigPose, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigPose), 3752599536U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyPose_h_3451360858(TEXT("/Script/ControlRig"),
		nullptr, 0,
