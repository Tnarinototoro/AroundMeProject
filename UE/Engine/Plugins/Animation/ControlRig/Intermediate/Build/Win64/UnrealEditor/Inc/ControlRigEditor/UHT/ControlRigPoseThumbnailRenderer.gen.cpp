...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UControlRigPoseThumbnailRenderer);
	UClass* Z_Construct_UClass_UControlRigPoseThumbnailRenderer_NoRegister()
	{
		return UControlRigPoseThumbnailRenderer::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UControlRigPoseThumbnailRenderer_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Tools/ControlRigPoseThumbnailRenderer.h" },
		{ "ModuleRelativePath", "Public/Tools/ControlRigPoseThumbnailRenderer.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UControlRigPoseThumbnailRenderer_Statics::StaticCppClassTypeInfo = {
	...
	template<> CONTROLRIGEDITOR_API UClass* StaticClass<UControlRigPoseThumbnailRenderer>()
	{
		return UControlRigPoseThumbnailRenderer::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UControlRigPoseThumbnailRenderer);
	UControlRigPoseThumbnailRenderer::~UControlRigPoseThumbnailRenderer() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_Tools_ControlRigPoseThumbnailRenderer_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_Tools_ControlRigPoseThumbnailRenderer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigPoseThumbnailRenderer, UControlRigPoseThumbnailRenderer::StaticClass, TEXT("UControlRigPoseThumbnailRenderer"), &Z_Registration_Info_UClass_UControlRigPoseThumbnailRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigPoseThumbnailRenderer), 4279105724U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_Tools_ControlRigPoseThumbnailRenderer_h_2782009485(TEXT("/Script/ControlRigEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_Tools_ControlRigPoseThumbnailRenderer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRigEditor_Public_Tools_ControlRigPoseThumbnailRenderer_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
