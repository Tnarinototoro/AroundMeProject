...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Event = { "Event", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SendEvent, Event), Z_Construct_UEnum_ControlRig_ERigEvent, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Event_MetaData), Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Event_MetaData) }; // 3607484423
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SendEvent, Item), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Item_MetaData), Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Item_MetaData) }; // 422817336
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_OffsetInSeconds = { "OffsetInSeconds", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SendEvent, OffsetInSeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_OffsetInSeconds_MetaData), Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_OffsetInSeconds_MetaData) };
#if WITH_METADATA
...
void FRigUnit_SendEvent::Execute(FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SendEvent_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SendEvent::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewStructOps, TEXT("RigUnit_SendEvent"), &Z_Registration_Info_UScriptStruct_RigUnit_SendEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SendEvent), 3681018254U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SendEvent_h_803288819(TEXT("/Script/ControlRig"),
		nullptr, 0,
