...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_GetControlColor_Statics::NewProp_Control = { "Control", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetControlColor, Control), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetControlColor_Statics::NewProp_Control_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetControlColor_Statics::NewProp_Control_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_SetControlColor_Statics::NewProp_Control = { "Control", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SetControlColor, Control), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetControlColor_Statics::NewProp_Control_MetaData), Z_Construct_UScriptStruct_FRigUnit_SetControlColor_Statics::NewProp_Control_MetaData) };
#if WITH_METADATA
...
void FRigUnit_SetControlColor::Execute(FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlColor_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetControlColor::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlColor_Statics::NewStructOps, TEXT("RigUnit_GetControlColor"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlColor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlColor), 2749948499U) },
		{ FRigUnit_SetControlColor::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetControlColor_Statics::NewStructOps, TEXT("RigUnit_SetControlColor"), &Z_Registration_Info_UScriptStruct_RigUnit_SetControlColor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetControlColor), 2558494262U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlColor_h_739059399(TEXT("/Script/ControlRig"),
		nullptr, 0,
