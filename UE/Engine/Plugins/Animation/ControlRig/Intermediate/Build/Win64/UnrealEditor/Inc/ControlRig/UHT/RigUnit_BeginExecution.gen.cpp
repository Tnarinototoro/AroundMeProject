...
void FRigUnit_BeginExecution::Execute(FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_BeginExecution_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_BeginExecution::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_BeginExecution_Statics::NewStructOps, TEXT("RigUnit_BeginExecution"), &Z_Registration_Info_UScriptStruct_RigUnit_BeginExecution, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_BeginExecution), 3484414173U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_BeginExecution_h_912725575(TEXT("/Script/ControlRig"),
		nullptr, 0,
