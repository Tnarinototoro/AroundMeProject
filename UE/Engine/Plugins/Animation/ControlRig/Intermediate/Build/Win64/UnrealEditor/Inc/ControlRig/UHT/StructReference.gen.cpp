...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FStructReference>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_StructReference_h_Statics::ScriptStructInfo[] = {
		{ FStructReference::StaticStruct, Z_Construct_UScriptStruct_FStructReference_Statics::NewStructOps, TEXT("StructReference"), &Z_Registration_Info_UScriptStruct_StructReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStructReference), 3554551598U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_StructReference_h_687895178(TEXT("/Script/ControlRig"),
		nullptr, 0,
