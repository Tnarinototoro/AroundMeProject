...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_HighlevelBaseMutable>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Highlevel_RigUnit_HighlevelBase_h_Statics::EnumInfo[] = {
		{ EControlRigVectorKind_StaticEnum, TEXT("EControlRigVectorKind"), &Z_Registration_Info_UEnum_EControlRigVectorKind, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 33207075U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Highlevel_RigUnit_HighlevelBase_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_HighlevelBase::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_HighlevelBase_Statics::NewStructOps, TEXT("RigUnit_HighlevelBase"), &Z_Registration_Info_UScriptStruct_RigUnit_HighlevelBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_HighlevelBase), 870525471U) },
		{ FRigUnit_HighlevelBaseMutable::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_HighlevelBaseMutable_Statics::NewStructOps, TEXT("RigUnit_HighlevelBaseMutable"), &Z_Registration_Info_UScriptStruct_RigUnit_HighlevelBaseMutable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_HighlevelBaseMutable), 1853953143U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Highlevel_RigUnit_HighlevelBase_h_1854298520(TEXT("/Script/ControlRig"),
		nullptr, 0,
