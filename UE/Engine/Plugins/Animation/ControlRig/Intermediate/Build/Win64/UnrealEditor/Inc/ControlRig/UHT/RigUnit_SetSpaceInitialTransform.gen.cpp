...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_SetSpaceInitialTransform_Statics::NewProp_SpaceName = { "SpaceName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SetSpaceInitialTransform, SpaceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetSpaceInitialTransform_Statics::NewProp_SpaceName_MetaData), Z_Construct_UScriptStruct_FRigUnit_SetSpaceInitialTransform_Statics::NewProp_SpaceName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetSpaceInitialTransform_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SetSpaceInitialTransform, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetSpaceInitialTransform_Statics::NewProp_Transform_MetaData), Z_Construct_UScriptStruct_FRigUnit_SetSpaceInitialTransform_Statics::NewProp_Transform_MetaData) };
#if WITH_METADATA
...
void FRigUnit_SetSpaceInitialTransform::Execute(FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetSpaceInitialTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetSpaceInitialTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetSpaceInitialTransform_Statics::NewStructOps, TEXT("RigUnit_SetSpaceInitialTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_SetSpaceInitialTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetSpaceInitialTransform), 1775215641U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetSpaceInitialTransform_h_4186927005(TEXT("/Script/ControlRig"),
		nullptr, 0,
