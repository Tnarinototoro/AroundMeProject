...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigExecuteContext>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnitContext_h_Statics::EnumInfo[] = {
		{ EControlRigInteractionType_StaticEnum, TEXT("EControlRigInteractionType"), &Z_Registration_Info_UEnum_EControlRigInteractionType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2875741628U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnitContext_h_Statics::ScriptStructInfo[] = {
		{ FRigHierarchySettings::StaticStruct, Z_Construct_UScriptStruct_FRigHierarchySettings_Statics::NewStructOps, TEXT("RigHierarchySettings"), &Z_Registration_Info_UScriptStruct_RigHierarchySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigHierarchySettings), 285177512U) },
		{ FControlRigExecuteContext::StaticStruct, Z_Construct_UScriptStruct_FControlRigExecuteContext_Statics::NewStructOps, TEXT("ControlRigExecuteContext"), &Z_Registration_Info_UScriptStruct_ControlRigExecuteContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FControlRigExecuteContext), 2827650700U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnitContext_h_3151215636(TEXT("/Script/ControlRig"),
		nullptr, 0,
