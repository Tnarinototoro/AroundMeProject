...
void FRigUnit_Control::Execute(const FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Control_RigUnit_Control_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_Control::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_Control_Statics::NewStructOps, TEXT("RigUnit_Control"), &Z_Registration_Info_UScriptStruct_RigUnit_Control, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_Control), 1717333972U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Control_RigUnit_Control_h_4121224291(TEXT("/Script/ControlRig"),
		nullptr, 0,
