...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_SetRelativeBoneTransform>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren = { "bPropagateToChildren", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FRigUnit_SetRelativeBoneTransform), &Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren_MetaData), Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren_MetaData) };
#if WITH_METADATA
...
void FRigUnit_SetRelativeBoneTransform::Execute(FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetRelativeBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetRelativeBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewStructOps, TEXT("RigUnit_SetRelativeBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetRelativeBoneTransform), 4191641495U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetRelativeBoneTransform_h_2366080112(TEXT("/Script/ControlRig"),
		nullptr, 0,
