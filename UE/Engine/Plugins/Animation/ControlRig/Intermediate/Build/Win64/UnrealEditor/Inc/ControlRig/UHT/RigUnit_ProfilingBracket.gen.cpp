...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FRigUnit_EndProfilingTimer_Statics::NewProp_Prefix = { "Prefix", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_EndProfilingTimer, Prefix), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_EndProfilingTimer_Statics::NewProp_Prefix_MetaData), Z_Construct_UScriptStruct_FRigUnit_EndProfilingTimer_Statics::NewProp_Prefix_MetaData) };
#if WITH_METADATA
...
void FRigUnit_EndProfilingTimer::Execute(FRigVMExecuteContext& InExecuteContext)
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Debug_RigUnit_ProfilingBracket_h_921850989(TEXT("/Script/ControlRig"),
		nullptr, 0,
