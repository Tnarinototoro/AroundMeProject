...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigCurve_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigCurve, Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigCurve_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FRigCurve_Statics::NewProp_Value_MetaData) };
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigCurveContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves_Inner = { "Curves", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRigCurve, METADATA_PARAMS(0, nullptr) }; // 2888704554
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves = { "Curves", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigCurveContainer, Curves), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves_MetaData), Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves_MetaData) }; // 2888704554
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigCurveContainer_h_Statics::ScriptStructInfo[] = {
		{ FRigCurve::StaticStruct, Z_Construct_UScriptStruct_FRigCurve_Statics::NewStructOps, TEXT("RigCurve"), &Z_Registration_Info_UScriptStruct_RigCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigCurve), 2888704554U) },
		{ FRigCurveContainer::StaticStruct, Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewStructOps, TEXT("RigCurveContainer"), &Z_Registration_Info_UScriptStruct_RigCurveContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigCurveContainer), 4198802198U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigCurveContainer_h_1824899609(TEXT("/Script/ControlRig"),
		nullptr, 0,
