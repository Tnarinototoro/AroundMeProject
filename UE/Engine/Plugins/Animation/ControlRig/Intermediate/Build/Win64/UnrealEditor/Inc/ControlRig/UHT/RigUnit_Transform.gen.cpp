...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_BinaryTransformOp, Result), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Result_MetaData), Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Result_MetaData) };
...
void FRigUnit_GetRelativeTransform::Execute(const FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_Math_RigUnit_Transform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_BinaryTransformOp::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewStructOps, TEXT("RigUnit_BinaryTransformOp"), &Z_Registration_Info_UScriptStruct_RigUnit_BinaryTransformOp, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_BinaryTransformOp), 1064808490U) },
		...
		{ FRigUnit_GetRelativeTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetRelativeTransform_Statics::NewStructOps, TEXT("RigUnit_GetRelativeTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetRelativeTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetRelativeTransform), 3521204461U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_Math_RigUnit_Transform_h_1499697821(TEXT("/Script/ControlRig"),
		nullptr, 0,
