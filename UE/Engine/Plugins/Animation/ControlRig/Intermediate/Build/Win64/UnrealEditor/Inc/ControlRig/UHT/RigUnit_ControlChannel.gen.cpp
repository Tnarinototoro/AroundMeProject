...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_Control = { "Control", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetAnimationChannelBase, Control), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_Control_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_Control_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_CachedChannelKey = { "CachedChannelKey", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetAnimationChannelBase, CachedChannelKey), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_CachedChannelKey_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_CachedChannelKey_MetaData) }; // 422817336
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_CachedChannelHash = { "CachedChannelHash", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetAnimationChannelBase, CachedChannelHash), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_CachedChannelHash_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewProp_CachedChannelHash_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetFloatAnimationChannel_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetFloatAnimationChannel, Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetFloatAnimationChannel_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetFloatAnimationChannel_Statics::NewProp_Value_MetaData) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetIntAnimationChannel_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_GetIntAnimationChannel, Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetIntAnimationChannel_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FRigUnit_GetIntAnimationChannel_Statics::NewProp_Value_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetAnimationChannelBase_Statics::NewProp_ExecuteContext = { "ExecuteContext", nullptr, (EPropertyFlags)0x0010000000002005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SetAnimationChannelBase, ExecuteContext), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetAnimationChannelBase_Statics::NewProp_ExecuteContext_MetaData), Z_Construct_UScriptStruct_FRigUnit_SetAnimationChannelBase_Statics::NewProp_ExecuteContext_MetaData) }; // 2827650700
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetFloatAnimationChannel_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_SetFloatAnimationChannel, Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetFloatAnimationChannel_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FRigUnit_SetFloatAnimationChannel_Statics::NewProp_Value_MetaData) };
...
void FRigUnit_SetTransformAnimationChannel::Execute(FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_ControlChannel_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetAnimationChannelBase::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetAnimationChannelBase_Statics::NewStructOps, TEXT("RigUnit_GetAnimationChannelBase"), &Z_Registration_Info_UScriptStruct_RigUnit_GetAnimationChannelBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetAnimationChannelBase), 4016310761U) },
