...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FCachedRigElement>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCachedRigElement, Key), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_Key_MetaData), Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_Key_MetaData) }; // 422817336
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_Index_MetaData[] = {
		{ "ModuleRelativePath", "Public/Rigs/RigHierarchyCache.h" },
	};
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCachedRigElement, Index), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_Index_MetaData), Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_Index_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_ContainerVersion = { "ContainerVersion", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCachedRigElement, ContainerVersion), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_ContainerVersion_MetaData), Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewProp_ContainerVersion_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyCache_h_Statics::ScriptStructInfo[] = {
		{ FCachedRigElement::StaticStruct, Z_Construct_UScriptStruct_FCachedRigElement_Statics::NewStructOps, TEXT("CachedRigElement"), &Z_Registration_Info_UScriptStruct_CachedRigElement, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedRigElement), 968212372U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyCache_h_3744785779(TEXT("/Script/ControlRig"),
		nullptr, 0,
