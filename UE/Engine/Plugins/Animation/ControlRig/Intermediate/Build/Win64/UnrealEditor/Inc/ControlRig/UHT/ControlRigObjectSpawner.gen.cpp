...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigObjectHolder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UControlRigObjectHolder_Statics::NewProp_Objects = { "Objects", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UControlRigObjectHolder, Objects), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigObjectHolder_Statics::NewProp_Objects_MetaData), Z_Construct_UClass_UControlRigObjectHolder_Statics::NewProp_Objects_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UControlRigObjectHolder_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigObjectHolder_Statics::Class_MetaDataParams), Z_Construct_UClass_UControlRigObjectHolder_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigObjectHolder_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_ControlRigObjectSpawner_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigObjectHolder, UControlRigObjectHolder::StaticClass, TEXT("UControlRigObjectHolder"), &Z_Registration_Info_UClass_UControlRigObjectHolder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigObjectHolder), 3542086614U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_ControlRigObjectSpawner_h_2066881001(TEXT("/Script/ControlRig"),
