...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_BoneHierarchy = { "BoneHierarchy", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigHierarchyContainer, BoneHierarchy), Z_Construct_UScriptStruct_FRigBoneHierarchy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_BoneHierarchy_MetaData), Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_BoneHierarchy_MetaData) }; // 3534388010
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_SpaceHierarchy = { "SpaceHierarchy", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigHierarchyContainer, SpaceHierarchy), Z_Construct_UScriptStruct_FRigSpaceHierarchy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_SpaceHierarchy_MetaData), Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_SpaceHierarchy_MetaData) }; // 967998975
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_CurveContainer = { "CurveContainer", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigHierarchyContainer, CurveContainer), Z_Construct_UScriptStruct_FRigCurveContainer, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_CurveContainer_MetaData), Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_CurveContainer_MetaData) }; // 4198802198
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigHierarchyRef>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyContainer_h_Statics::ScriptStructInfo[] = {
		{ FRigHierarchyContainer::StaticStruct, Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewStructOps, TEXT("RigHierarchyContainer"), &Z_Registration_Info_UScriptStruct_RigHierarchyContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigHierarchyContainer), 2983478275U) },
		{ FRigHierarchyRef::StaticStruct, Z_Construct_UScriptStruct_FRigHierarchyRef_Statics::NewStructOps, TEXT("RigHierarchyRef"), &Z_Registration_Info_UScriptStruct_RigHierarchyRef, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigHierarchyRef), 3305580653U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyContainer_h_1183423808(TEXT("/Script/ControlRig"),
		nullptr, 0,
