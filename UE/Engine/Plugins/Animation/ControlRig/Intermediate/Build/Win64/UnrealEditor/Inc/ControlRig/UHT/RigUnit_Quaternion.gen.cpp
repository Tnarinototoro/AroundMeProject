...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BinaryQuaternionOp_Statics::NewProp_Argument1 = { "Argument1", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_BinaryQuaternionOp, Argument1), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BinaryQuaternionOp_Statics::NewProp_Argument1_MetaData), Z_Construct_UScriptStruct_FRigUnit_BinaryQuaternionOp_Statics::NewProp_Argument1_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BinaryQuaternionOp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_BinaryQuaternionOp, Result), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BinaryQuaternionOp_Statics::NewProp_Result_MetaData), Z_Construct_UScriptStruct_FRigUnit_BinaryQuaternionOp_Statics::NewProp_Result_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_UnaryQuaternionOp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_UnaryQuaternionOp, Result), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_UnaryQuaternionOp_Statics::NewProp_Result_MetaData), Z_Construct_UScriptStruct_FRigUnit_UnaryQuaternionOp_Statics::NewProp_Result_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_QuaternionFromAxisAndAngle_Statics::NewProp_Angle = { "Angle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_QuaternionFromAxisAndAngle, Angle), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_QuaternionFromAxisAndAngle_Statics::NewProp_Angle_MetaData), Z_Construct_UScriptStruct_FRigUnit_QuaternionFromAxisAndAngle_Statics::NewProp_Angle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_QuaternionFromAxisAndAngle_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigUnit_QuaternionFromAxisAndAngle, Result), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_QuaternionFromAxisAndAngle_Statics::NewProp_Result_MetaData), Z_Construct_UScriptStruct_FRigUnit_QuaternionFromAxisAndAngle_Statics::NewProp_Result_MetaData) };
...
void FRigUnit_QuaternionToAngle::Execute(const FControlRigExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_Math_RigUnit_Quaternion_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_MultiplyQuaternion::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MultiplyQuaternion_Statics::NewStructOps, TEXT("RigUnit_MultiplyQuaternion"), &Z_Registration_Info_UScriptStruct_RigUnit_MultiplyQuaternion, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MultiplyQuaternion), 3153352526U) },
		{ FRigUnit_UnaryQuaternionOp::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_UnaryQuaternionOp_Statics::NewStructOps, TEXT("RigUnit_UnaryQuaternionOp"), &Z_Registration_Info_UScriptStruct_RigUnit_UnaryQuaternionOp, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_UnaryQuaternionOp), 1119343911U) },
		{ FRigUnit_InverseQuaterion::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_InverseQuaterion_Statics::NewStructOps, TEXT("RigUnit_InverseQuaterion"), &Z_Registration_Info_UScriptStruct_RigUnit_InverseQuaterion, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_InverseQuaterion), 549069800U) },
		{ FRigUnit_QuaternionToAxisAndAngle::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_QuaternionToAxisAndAngle_Statics::NewStructOps, TEXT("RigUnit_QuaternionToAxisAndAngle"), &Z_Registration_Info_UScriptStruct_RigUnit_QuaternionToAxisAndAngle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_QuaternionToAxisAndAngle), 2822843076U) },
		...
		{ FRigUnit_QuaternionToAngle::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_QuaternionToAngle_Statics::NewStructOps, TEXT("RigUnit_QuaternionToAngle"), &Z_Registration_Info_UScriptStruct_RigUnit_QuaternionToAngle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_QuaternionToAngle), 3152757690U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_Math_RigUnit_Quaternion_h_1776157888(TEXT("/Script/ControlRig"),
		nullptr, 0,
