...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULiveLinkTimecodeProvider_Statics::NewProp_OverrideFrameRate = { "OverrideFrameRate", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkTimecodeProvider, OverrideFrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkTimecodeProvider_Statics::NewProp_OverrideFrameRate_MetaData), Z_Construct_UClass_ULiveLinkTimecodeProvider_Statics::NewProp_OverrideFrameRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULiveLinkTimecodeProvider_Statics::NewProp_BufferSize = { "BufferSize", nullptr, (EPropertyFlags)0x0040040000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkTimecodeProvider, BufferSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkTimecodeProvider_Statics::NewProp_BufferSize_MetaData), Z_Construct_UClass_ULiveLinkTimecodeProvider_Statics::NewProp_BufferSize_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLink_Public_LiveLinkTimecodeProvider_h_Statics::EnumInfo[] = {
		{ ELiveLinkTimecodeProviderEvaluationType_StaticEnum, TEXT("ELiveLinkTimecodeProviderEvaluationType"), &Z_Registration_Info_UEnum_ELiveLinkTimecodeProviderEvaluationType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2152871160U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLink_Public_LiveLinkTimecodeProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkTimecodeProvider, ULiveLinkTimecodeProvider::StaticClass, TEXT("ULiveLinkTimecodeProvider"), &Z_Registration_Info_UClass_ULiveLinkTimecodeProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkTimecodeProvider), 1371054827U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLink_Public_LiveLinkTimecodeProvider_h_2151328974(TEXT("/Script/LiveLink"),
