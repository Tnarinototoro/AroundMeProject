...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::NewProp_ControllerRecorders_Inner = { "ControllerRecorders", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::NewProp_ControllerRecorders = { "ControllerRecorders", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneLiveLinkControllerMapTrackRecorder, ControllerRecorders), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::NewProp_ControllerRecorders_MetaData), Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::NewProp_ControllerRecorders_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkSequencer_Public_MovieSceneLiveLinkControllerMapTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder, UMovieSceneLiveLinkControllerMapTrackRecorder::StaticClass, TEXT("UMovieSceneLiveLinkControllerMapTrackRecorder"), &Z_Registration_Info_UClass_UMovieSceneLiveLinkControllerMapTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneLiveLinkControllerMapTrackRecorder), 1450399828U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkSequencer_Public_MovieSceneLiveLinkControllerMapTrackRecorder_h_259190158(TEXT("/Script/LiveLinkSequencer"),
