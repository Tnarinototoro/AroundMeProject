...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::NewProp_DefaultTrackRecordersForController = { "DefaultTrackRecordersForController", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSequencerSettings, DefaultTrackRecordersForController), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::NewProp_DefaultTrackRecordersForController_MetaData), Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::NewProp_DefaultTrackRecordersForController_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSequencerSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkSequencer_Public_LiveLinkSequencerSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkSequencerSettings, ULiveLinkSequencerSettings::StaticClass, TEXT("ULiveLinkSequencerSettings"), &Z_Registration_Info_UClass_ULiveLinkSequencerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkSequencerSettings), 3334206289U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkSequencer_Public_LiveLinkSequencerSettings_h_683766968(TEXT("/Script/LiveLinkSequencer"),
