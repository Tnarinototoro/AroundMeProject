...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULiveLinkLightController_Statics::NewProp_ComponentToControl = { "ComponentToControl", nullptr, (EPropertyFlags)0x0010000820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkLightController, ComponentToControl_DEPRECATED), Z_Construct_UScriptStruct_FComponentReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLightController_Statics::NewProp_ComponentToControl_MetaData), Z_Construct_UClass_ULiveLinkLightController_Statics::NewProp_ComponentToControl_MetaData) }; // 834145860
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULiveLinkLightController_Statics::NewProp_TransformData = { "TransformData", nullptr, (EPropertyFlags)0x0010000820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkLightController, TransformData_DEPRECATED), Z_Construct_UScriptStruct_FLiveLinkTransformControllerData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLightController_Statics::NewProp_TransformData_MetaData), Z_Construct_UClass_ULiveLinkLightController_Statics::NewProp_TransformData_MetaData) }; // 1446422577
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkComponents_Public_Controllers_LiveLinkLightController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkLightController, ULiveLinkLightController::StaticClass, TEXT("ULiveLinkLightController"), &Z_Registration_Info_UClass_ULiveLinkLightController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkLightController), 2810834798U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkComponents_Public_Controllers_LiveLinkLightController_h_2609360588(TEXT("/Script/LiveLinkComponents"),
