...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULiveLinkBlueprintVirtualSubject_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULiveLinkBlueprintVirtualSubject_OnInitialize, "OnInitialize" }, // 985442865
		{ &Z_Construct_UFunction_ULiveLinkBlueprintVirtualSubject_OnUpdate, "OnUpdate" }, // 3812598296
		{ &Z_Construct_UFunction_ULiveLinkBlueprintVirtualSubject_UpdateVirtualSubjectFrameData_Internal, "UpdateVirtualSubjectFrameData_Internal" }, // 4290916616
		{ &Z_Construct_UFunction_ULiveLinkBlueprintVirtualSubject_UpdateVirtualSubjectStaticData_Internal, "UpdateVirtualSubjectStaticData_Internal" }, // 381184266
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkBlueprintVirtualSubject_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLink_Public_VirtualSubjects_LiveLinkBlueprintVirtualSubject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkBlueprintVirtualSubject, ULiveLinkBlueprintVirtualSubject::StaticClass, TEXT("ULiveLinkBlueprintVirtualSubject"), &Z_Registration_Info_UClass_ULiveLinkBlueprintVirtualSubject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkBlueprintVirtualSubject), 1329898648U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLink_Public_VirtualSubjects_LiveLinkBlueprintVirtualSubject_h_2866382915(TEXT("/Script/LiveLink"),
