...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::NewProp_LiveLinkControllerToRecord = { "LiveLinkControllerToRecord", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneLiveLinkControllerTrackRecorder, LiveLinkControllerToRecord), Z_Construct_UClass_ULiveLinkControllerBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::NewProp_LiveLinkControllerToRecord_MetaData), Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::NewProp_LiveLinkControllerToRecord_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A9u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkSequencer_Public_MovieSceneLiveLinkControllerTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneLiveLinkControllerTrackRecorder, UMovieSceneLiveLinkControllerTrackRecorder::StaticClass, TEXT("UMovieSceneLiveLinkControllerTrackRecorder"), &Z_Registration_Info_UClass_UMovieSceneLiveLinkControllerTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneLiveLinkControllerTrackRecorder), 2312612371U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkSequencer_Public_MovieSceneLiveLinkControllerTrackRecorder_h_2172029938(TEXT("/Script/LiveLinkSequencer"),
