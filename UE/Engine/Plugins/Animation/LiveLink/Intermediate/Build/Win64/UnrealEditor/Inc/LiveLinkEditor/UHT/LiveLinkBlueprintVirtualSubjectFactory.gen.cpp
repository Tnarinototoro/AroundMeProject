...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::NewProp_Role = { "Role", nullptr, (EPropertyFlags)0x0014000000000004, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkBlueprintVirtualSubjectFactory, Role), Z_Construct_UClass_UClass, Z_Construct_UClass_ULiveLinkRole_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::NewProp_Role_MetaData), Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::NewProp_Role_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::ClassParams = {
		...
		0,
		0x001020A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkEditor_Public_VirtualSubjects_LiveLinkBlueprintVirtualSubjectFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkBlueprintVirtualSubjectFactory, ULiveLinkBlueprintVirtualSubjectFactory::StaticClass, TEXT("ULiveLinkBlueprintVirtualSubjectFactory"), &Z_Registration_Info_UClass_ULiveLinkBlueprintVirtualSubjectFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkBlueprintVirtualSubjectFactory), 1066730877U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLinkEditor_Public_VirtualSubjects_LiveLinkBlueprintVirtualSubjectFactory_h_3701686555(TEXT("/Script/LiveLinkEditor"),
