...
template<> LIVELINK_API UScriptStruct* StaticStruct<FLiveLinkRoleProjectSetting>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULiveLinkUserSettings_Statics::NewProp_PresetSaveDir = { "PresetSaveDir", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkUserSettings, PresetSaveDir), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkUserSettings_Statics::NewProp_PresetSaveDir_MetaData), Z_Construct_UClass_ULiveLinkUserSettings_Statics::NewProp_PresetSaveDir_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_ClockOffsetCorrectionStep = { "ClockOffsetCorrectionStep", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSettings, ClockOffsetCorrectionStep), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_ClockOffsetCorrectionStep_MetaData), Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_ClockOffsetCorrectionStep_MetaData) };
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusPingRequestFrequency = { "MessageBusPingRequestFrequency", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSettings, MessageBusPingRequestFrequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusPingRequestFrequency_MetaData), Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusPingRequestFrequency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusHeartbeatFrequency = { "MessageBusHeartbeatFrequency", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSettings, MessageBusHeartbeatFrequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusHeartbeatFrequency_MetaData), Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusHeartbeatFrequency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusHeartbeatTimeout = { "MessageBusHeartbeatTimeout", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSettings, MessageBusHeartbeatTimeout), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusHeartbeatTimeout_MetaData), Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_MessageBusHeartbeatTimeout_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_TimeWithoutFrameToBeConsiderAsInvalid = { "TimeWithoutFrameToBeConsiderAsInvalid", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSettings, TimeWithoutFrameToBeConsiderAsInvalid), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_TimeWithoutFrameToBeConsiderAsInvalid_MetaData), Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_TimeWithoutFrameToBeConsiderAsInvalid_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_InvalidColor = { "InvalidColor", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSettings, InvalidColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_InvalidColor_MetaData), Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_InvalidColor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_TextSizeSubject = { "TextSizeSubject", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkSettings, TextSizeSubject), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_TextSizeSubject_MetaData), Z_Construct_UClass_ULiveLinkSettings_Statics::NewProp_TextSizeSubject_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLink_Public_LiveLinkSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkUserSettings, ULiveLinkUserSettings::StaticClass, TEXT("ULiveLinkUserSettings"), &Z_Registration_Info_UClass_ULiveLinkUserSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkUserSettings), 2060628354U) },
		{ Z_Construct_UClass_ULiveLinkSettings, ULiveLinkSettings::StaticClass, TEXT("ULiveLinkSettings"), &Z_Registration_Info_UClass_ULiveLinkSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkSettings), 3890291719U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_LiveLink_Source_LiveLink_Public_LiveLinkSettings_h_73609603(TEXT("/Script/LiveLink"),
