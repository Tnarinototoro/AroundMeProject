...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AnimationLocomotionLibraryEditor_EDistanceCurve_Axis_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AnimationLocomotionLibraryEditor_EDistanceCurve_Axis_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AnimationLocomotionLibraryEditor_EDistanceCurve_Axis_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_SampleRate = { "SampleRate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDistanceCurveModifier, SampleRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_SampleRate_MetaData), Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_SampleRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_CurveName = { "CurveName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDistanceCurveModifier, CurveName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_CurveName_MetaData), Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_CurveName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_StopSpeedThreshold = { "StopSpeedThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDistanceCurveModifier, StopSpeedThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_StopSpeedThreshold_MetaData), Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_StopSpeedThreshold_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_Axis = { "Axis", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDistanceCurveModifier, Axis), Z_Construct_UEnum_AnimationLocomotionLibraryEditor_EDistanceCurve_Axis, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_Axis_MetaData), Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_Axis_MetaData) }; // 751560825
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_bStopAtEnd = { "bStopAtEnd", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDistanceCurveModifier), &Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_bStopAtEnd_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_bStopAtEnd_MetaData), Z_Construct_UClass_UDistanceCurveModifier_Statics::NewProp_bStopAtEnd_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDistanceCurveModifier_Statics::ClassParams = {
		...
		0,
		0x000000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::Class_MetaDataParams), Z_Construct_UClass_UDistanceCurveModifier_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDistanceCurveModifier_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationLocomotionLibrary_Source_Editor_Public_DistanceCurveModifier_h_Statics::EnumInfo[] = {
		{ EDistanceCurve_Axis_StaticEnum, TEXT("EDistanceCurve_Axis"), &Z_Registration_Info_UEnum_EDistanceCurve_Axis, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 751560825U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationLocomotionLibrary_Source_Editor_Public_DistanceCurveModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDistanceCurveModifier, UDistanceCurveModifier::StaticClass, TEXT("UDistanceCurveModifier"), &Z_Registration_Info_UClass_UDistanceCurveModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDistanceCurveModifier), 4167178361U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationLocomotionLibrary_Source_Editor_Public_DistanceCurveModifier_h_2885808446(TEXT("/Script/AnimationLocomotionLibraryEditor"),
