...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequencerController_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UAnimSequencerController_Statics::NewProp_Model = { "Model", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSequencerController, Model), Z_Construct_UClass_UAnimationSequencerDataModel_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequencerController_Statics::NewProp_Model_MetaData), Z_Construct_UClass_UAnimSequencerController_Statics::NewProp_Model_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInterfacePropertyParams Z_Construct_UClass_UAnimSequencerController_Statics::NewProp_ModelInterface = { "ModelInterface", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSequencerController, ModelInterface), Z_Construct_UClass_UAnimationDataModel_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequencerController_Statics::NewProp_ModelInterface_MetaData), Z_Construct_UClass_UAnimSequencerController_Statics::NewProp_ModelInterface_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimSequencerController_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UAnimSequencerController_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UAnimationDataController_NoRegister, (int32)VTABLE_OFFSET(UAnimSequencerController, IAnimationDataController), false },  // 811546488
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequencerController_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimSequencerController_Statics::ClassParams = {
		...
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequencerController_Statics::Class_MetaDataParams), Z_Construct_UClass_UAnimSequencerController_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequencerController_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationData_Source_AnimationData_Private_AnimSequencerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimSequencerController, UAnimSequencerController::StaticClass, TEXT("UAnimSequencerController"), &Z_Registration_Info_UClass_UAnimSequencerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimSequencerController), 3670057619U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_AnimationData_Source_AnimationData_Private_AnimSequencerController_h_2419709488(TEXT("/Script/AnimationData"),
