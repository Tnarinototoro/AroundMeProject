...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSkeletonWithQuatsDataInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptimusSkeletonWithQuatsDataInterface_Statics::ClassParams = {
		...
		0,
		0x001100A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSkeletonWithQuatsDataInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UOptimusSkeletonWithQuatsDataInterface_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::NewProp_SkinnedMesh = { "SkinnedMesh", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusSkeletonWithQuatsDataProvider, SkinnedMesh), Z_Construct_UClass_USkinnedMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::NewProp_SkinnedMesh_MetaData), Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::NewProp_SkinnedMesh_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::ClassParams = {
		...
		0,
		0x008010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::Class_MetaDataParams), Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSkeletonWithQuatsDataProvider_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_NearestNeighborModel_Source_NearestNeighborModel_Private_OptimusDataInterfaceSkeletonWithQuats_h_3577957330(TEXT("/Script/NearestNeighborModel"),
