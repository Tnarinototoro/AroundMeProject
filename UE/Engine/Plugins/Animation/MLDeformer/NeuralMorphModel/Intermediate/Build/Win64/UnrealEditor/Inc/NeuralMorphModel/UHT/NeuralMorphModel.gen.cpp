...
// End Cross Module References
	...
	struct Z_Construct_UClass_UNeuralMorphModel_Statics
	{
		...
		static const UECodeGen_Private::FStructPropertyParams NewProp_BoneMaskInfos_ValueProp;
		static const UECodeGen_Private::FNamePropertyParams NewProp_BoneMaskInfos_Key_KeyProp;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BoneMaskInfos_MetaData[];
#endif
		static const UECodeGen_Private::FMapPropertyParams NewProp_BoneMaskInfos;
		static const UECodeGen_Private::FStructPropertyParams NewProp_BoneGroupMaskInfos_ValueProp;
		static const UECodeGen_Private::FNamePropertyParams NewProp_BoneGroupMaskInfos_Key_KeyProp;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BoneGroupMaskInfos_MetaData[];
#endif
		static const UECodeGen_Private::FMapPropertyParams NewProp_BoneGroupMaskInfos;
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bEnableBoneMasks_MetaData[];
#endif
		static void NewProp_bEnableBoneMasks_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bEnableBoneMasks;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SmoothLossBeta_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_SmoothLossBeta;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroups_Inner = { "BoneGroups", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNeuralMorphBoneGroup, METADATA_PARAMS(0, nullptr) }; // 725389796
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroups = { "BoneGroups", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, BoneGroups), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroups_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroups_MetaData) }; // 725389796
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_CurveGroups_Inner = { "CurveGroups", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNeuralMorphCurveGroup, METADATA_PARAMS(0, nullptr) }; // 683888895
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_CurveGroups = { "CurveGroups", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, CurveGroups), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_CurveGroups_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_CurveGroups_MetaData) }; // 683888895
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos_ValueProp = { "BoneMaskInfos", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FNeuralMorphMaskInfo, METADATA_PARAMS(0, nullptr) }; // 4053489752
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos_Key_KeyProp = { "BoneMaskInfos_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos_MetaData[] = {
		{ "Comment", "/**\n\x09 * Information needed to generate a mask for each bone.\n\x09 * Each mask info object contains a list of bones who's skinning influence regions should be included in the final mask for the specific bone.\n\x09 * This information (and bone masking in general) is used inside the ENeuralMorphMode::Local mode.\n\x09 * The FName map key represents the bone name.\n\x09 */" },
		{ "ModuleRelativePath", "Public/NeuralMorphModel.h" },
		{ "ToolTip", "Information needed to generate a mask for each bone.\nEach mask info object contains a list of bones who's skinning influence regions should be included in the final mask for the specific bone.\nThis information (and bone masking in general) is used inside the ENeuralMorphMode::Local mode.\nThe FName map key represents the bone name." },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos = { "BoneMaskInfos", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, BoneMaskInfos), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos_MetaData) }; // 4053489752
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos_ValueProp = { "BoneGroupMaskInfos", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FNeuralMorphMaskInfo, METADATA_PARAMS(0, nullptr) }; // 4053489752
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos_Key_KeyProp = { "BoneGroupMaskInfos_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos_MetaData[] = {
		{ "Comment", "/**\n\x09 * Information needed to generate a mask for each bone group.\n\x09 * So the size of the array is NumGroupsInInputInfo.\n\x09 * Each mask info object contains a list of bones who's skinning influence regions should be included in the final mask for the specific bone.\n\x09 * This information (and bone masking in general) is used inside the ENeuralMorphMode::Local mode.\n\x09 */" },
		{ "ModuleRelativePath", "Public/NeuralMorphModel.h" },
		{ "ToolTip", "Information needed to generate a mask for each bone group.\nSo the size of the array is NumGroupsInInputInfo.\nEach mask info object contains a list of bones who's skinning influence regions should be included in the final mask for the specific bone.\nThis information (and bone masking in general) is used inside the ENeuralMorphMode::Local mode." },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos = { "BoneGroupMaskInfos", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, BoneGroupMaskInfos), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos_MetaData) }; // 4053489752
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, Mode), Z_Construct_UEnum_NeuralMorphModel_ENeuralMorphMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_Mode_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_Mode_MetaData) }; // 2601490130
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumMorphTargets = { "GlobalNumMorphTargets", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, GlobalNumMorphTargets), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumMorphTargets_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumMorphTargets_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_NumIterations = { "NumIterations", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, NumIterations), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_NumIterations_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_NumIterations_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LocalNumHiddenLayers = { "LocalNumHiddenLayers", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, LocalNumHiddenLayers), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LocalNumHiddenLayers_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LocalNumHiddenLayers_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LocalNumNeuronsPerLayer = { "LocalNumNeuronsPerLayer", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, LocalNumNeuronsPerLayer), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LocalNumNeuronsPerLayer_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LocalNumNeuronsPerLayer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumHiddenLayers = { "GlobalNumHiddenLayers", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, GlobalNumHiddenLayers), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumHiddenLayers_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumHiddenLayers_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumNeuronsPerLayer = { "GlobalNumNeuronsPerLayer", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, GlobalNumNeuronsPerLayer), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumNeuronsPerLayer_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_GlobalNumNeuronsPerLayer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BatchSize = { "BatchSize", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, BatchSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BatchSize_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BatchSize_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LearningRate = { "LearningRate", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, LearningRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LearningRate_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_LearningRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_RegularizationFactor = { "RegularizationFactor", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, RegularizationFactor), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_RegularizationFactor_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_RegularizationFactor_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_bEnableBoneMasks_MetaData[] = {
		{ "Category", "Training Settings" },
		{ "Comment", "/** \n\x09 * Enable the use of per bone and bone group masks.\n\x09 * When enabled, an influence mask is generated per bone based on skinning info. This will enforce deformations localized to the area around the joint.\n\x09 * The benefit of enabling this can be reduced GPU memory footprint, faster GPU performance and more localized deformations.\n\x09 * If deformations do not happen near the joint then this enabling this setting can lead to those deformations possibly not being captured.\n\x09 */" },
		{ "EditCondition", "Mode == ENeuralMorphMode::Local" },
		{ "ModuleRelativePath", "Public/NeuralMorphModel.h" },
		{ "ToolTip", "Enable the use of per bone and bone group masks.\nWhen enabled, an influence mask is generated per bone based on skinning info. This will enforce deformations localized to the area around the joint.\nThe benefit of enabling this can be reduced GPU memory footprint, faster GPU performance and more localized deformations.\nIf deformations do not happen near the joint then this enabling this setting can lead to those deformations possibly not being captured." },
	};
#endif
	void Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_bEnableBoneMasks_SetBit(void* Obj)
	{
		((UNeuralMorphModel*)Obj)->bEnableBoneMasks = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_bEnableBoneMasks = { "bEnableBoneMasks", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNeuralMorphModel), &Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_bEnableBoneMasks_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_bEnableBoneMasks_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_bEnableBoneMasks_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_SmoothLossBeta_MetaData[] = {
		{ "Category", "Training Settings" },
		{ "ClampMax", "10.0" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/**\n\x09 * The beta parameter in the smooth L1 loss function, which describes below which absolute error to use a squared term. If the error is above or equal to this beta value, it will use the L1 loss.\n\x09 * This is a non-negative value, where 0 makes it behave exactly the same as an L1 loss.\n\x09 * The value entered represents how many cm of error to allow before an L1 loss is used. Typically higher values give smoother results.\n\x09 * If you see some noise in the trained results, even with large amount of samples and iterations, try increasing this value.\n\x09 */" },
		{ "ModuleRelativePath", "Public/NeuralMorphModel.h" },
		{ "ToolTip", "The beta parameter in the smooth L1 loss function, which describes below which absolute error to use a squared term. If the error is above or equal to this beta value, it will use the L1 loss.\nThis is a non-negative value, where 0 makes it behave exactly the same as an L1 loss.\nThe value entered represents how many cm of error to allow before an L1 loss is used. Typically higher values give smoother results.\nIf you see some noise in the trained results, even with large amount of samples and iterations, try increasing this value." },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_SmoothLossBeta = { "SmoothLossBeta", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, SmoothLossBeta), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_SmoothLossBeta_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_SmoothLossBeta_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_NeuralMorphNetwork = { "NeuralMorphNetwork", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNeuralMorphModel, NeuralMorphNetwork), Z_Construct_UClass_UNeuralMorphNetwork_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_NeuralMorphNetwork_MetaData), Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_NeuralMorphNetwork_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNeuralMorphModel_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneMaskInfos,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_BoneGroupMaskInfos,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_bEnableBoneMasks,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNeuralMorphModel_Statics::NewProp_SmoothLossBeta,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNeuralMorphModel_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UNeuralMorphModel_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNeuralMorphModel_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_NeuralMorphModel_Source_NeuralMorphModel_Public_NeuralMorphModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNeuralMorphModel, UNeuralMorphModel::StaticClass, TEXT("UNeuralMorphModel"), &Z_Registration_Info_UClass_UNeuralMorphModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNeuralMorphModel), 1574090590U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_NeuralMorphModel_Source_NeuralMorphModel_Public_NeuralMorphModel_h_66600809(TEXT("/Script/NeuralMorphModel"),
