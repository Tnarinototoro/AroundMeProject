...
template<> MLDEFORMERFRAMEWORK_API UScriptStruct* StaticStruct<FMLDeformerCurveReference>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::NewProp_CurveName = { "CurveName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMLDeformerCurveReference, CurveName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::NewProp_CurveName_MetaData), Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::NewProp_CurveName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerCurveReference_h_Statics::ScriptStructInfo[] = {
		{ FMLDeformerCurveReference::StaticStruct, Z_Construct_UScriptStruct_FMLDeformerCurveReference_Statics::NewStructOps, TEXT("MLDeformerCurveReference"), &Z_Registration_Info_UScriptStruct_MLDeformerCurveReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMLDeformerCurveReference), 511511731U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerCurveReference_h_1893838365(TEXT("/Script/MLDeformerFramework"),
		nullptr, 0,
