...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModelInstance_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLDeformerModelInstance_Statics::NewProp_Model = { "Model", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModelInstance, Model), Z_Construct_UClass_UMLDeformerModel_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModelInstance_Statics::NewProp_Model_MetaData), Z_Construct_UClass_UMLDeformerModelInstance_Statics::NewProp_Model_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLDeformerModelInstance_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModelInstance_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLDeformerModelInstance_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModelInstance_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerModelInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLDeformerModelInstance, UMLDeformerModelInstance::StaticClass, TEXT("UMLDeformerModelInstance"), &Z_Registration_Info_UClass_UMLDeformerModelInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLDeformerModelInstance), 3112403682U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerModelInstance_h_3794102461(TEXT("/Script/MLDeformerFramework"),
