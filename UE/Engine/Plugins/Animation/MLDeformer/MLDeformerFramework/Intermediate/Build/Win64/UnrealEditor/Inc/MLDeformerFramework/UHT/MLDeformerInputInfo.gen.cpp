...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_SkeletalMesh = { "SkeletalMesh", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerInputInfo, SkeletalMesh), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_SkeletalMesh_MetaData), Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_SkeletalMesh_MetaData) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNameStrings_Inner = { "BoneNameStrings", nullptr, (EPropertyFlags)0x0000000820000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNameStrings = { "BoneNameStrings", nullptr, (EPropertyFlags)0x0020080820000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerInputInfo, BoneNameStrings_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNameStrings_MetaData), Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNameStrings_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNameStrings_Inner = { "CurveNameStrings", nullptr, (EPropertyFlags)0x0000000820000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNameStrings = { "CurveNameStrings", nullptr, (EPropertyFlags)0x0020080820000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerInputInfo, CurveNameStrings_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNameStrings_MetaData), Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNameStrings_MetaData) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNames_Inner = { "BoneNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNames = { "BoneNames", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerInputInfo, BoneNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNames_MetaData), Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_BoneNames_MetaData) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNames_Inner = { "CurveNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNames = { "CurveNames", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerInputInfo, CurveNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNames_MetaData), Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_CurveNames_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_NumBaseMeshVertices = { "NumBaseMeshVertices", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerInputInfo, NumBaseMeshVertices), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_NumBaseMeshVertices_MetaData), Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_NumBaseMeshVertices_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_NumTargetMeshVertices = { "NumTargetMeshVertices", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerInputInfo, NumTargetMeshVertices), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_NumTargetMeshVertices_MetaData), Z_Construct_UClass_UMLDeformerInputInfo_Statics::NewProp_NumTargetMeshVertices_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLDeformerInputInfo_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLDeformerInputInfo_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerInputInfo_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerInputInfo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLDeformerInputInfo, UMLDeformerInputInfo::StaticClass, TEXT("UMLDeformerInputInfo"), &Z_Registration_Info_UClass_UMLDeformerInputInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLDeformerInputInfo), 3789261502U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerInputInfo_h_446376113(TEXT("/Script/MLDeformerFramework"),
