...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MLDeformerFramework_EMLDeformerMaskChannel_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MLDeformerFramework_EMLDeformerMaskChannel_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MLDeformerFramework_EMLDeformerMaskChannel_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_NumBaseMeshVerts = { "NumBaseMeshVerts", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, NumBaseMeshVerts), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_NumBaseMeshVerts_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_NumBaseMeshVerts_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_NumTargetMeshVerts = { "NumTargetMeshVerts", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, NumTargetMeshVerts), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_NumTargetMeshVerts_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_NumTargetMeshVerts_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_InputInfo = { "InputInfo", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, InputInfo), Z_Construct_UClass_UMLDeformerInputInfo_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_InputInfo_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_InputInfo_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_VertexMap_Inner = { "VertexMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_VertexMap = { "VertexMap", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, VertexMap), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_VertexMap_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_VertexMap_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_SkeletalMesh = { "SkeletalMesh", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, SkeletalMesh), Z_Construct_UClass_USkeletalMesh_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_SkeletalMesh_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_SkeletalMesh_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_VizSettings = { "VizSettings", nullptr, (EPropertyFlags)0x0044000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, VizSettings), Z_Construct_UClass_UMLDeformerVizSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_VizSettings_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_VizSettings_MetaData) };
#if WITH_METADATA
	...
	{
		((UMLDeformerModel*)Obj)->bIncludeBones_DEPRECATED = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeBones = { "bIncludeBones", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMLDeformerModel), &Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeBones_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeBones_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeBones_MetaData) };
#if WITH_METADATA
	...
	{
		((UMLDeformerModel*)Obj)->bIncludeCurves_DEPRECATED = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeCurves = { "bIncludeCurves", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMLDeformerModel), &Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeCurves_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeCurves_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_bIncludeCurves_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_AnimSequence = { "AnimSequence", nullptr, (EPropertyFlags)0x0044000800000001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, AnimSequence), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_AnimSequence_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_AnimSequence_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_AlignmentTransform = { "AlignmentTransform", nullptr, (EPropertyFlags)0x0040000800000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, AlignmentTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_AlignmentTransform_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_AlignmentTransform_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_BoneIncludeList_Inner = { "BoneIncludeList", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(0, nullptr) }; // 1286936164
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_BoneIncludeList = { "BoneIncludeList", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, BoneIncludeList), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_BoneIncludeList_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_BoneIncludeList_MetaData) }; // 1286936164
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_CurveIncludeList_Inner = { "CurveIncludeList", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FMLDeformerCurveReference, METADATA_PARAMS(0, nullptr) }; // 511511731
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_CurveIncludeList = { "CurveIncludeList", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, CurveIncludeList), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_CurveIncludeList_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_CurveIncludeList_MetaData) }; // 511511731
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_MaxTrainingFrames = { "MaxTrainingFrames", nullptr, (EPropertyFlags)0x0040000800000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, MaxTrainingFrames), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_MaxTrainingFrames_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_MaxTrainingFrames_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_DeltaCutoffLength = { "DeltaCutoffLength", nullptr, (EPropertyFlags)0x0040000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLDeformerModel, DeltaCutoffLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_DeltaCutoffLength_MetaData), Z_Construct_UClass_UMLDeformerModel_Statics::NewProp_DeltaCutoffLength_MetaData) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMLDeformerModel_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMLDeformerModel_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBoneReferenceSkeletonProvider_NoRegister, (int32)VTABLE_OFFSET(UMLDeformerModel, IBoneReferenceSkeletonProvider), false },  // 307433809
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLDeformerModel_Statics::ClassParams = {
		...
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLDeformerModel_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLDeformerModel_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerModel_h_Statics::EnumInfo[] = {
		{ EMLDeformerMaskChannel_StaticEnum, TEXT("EMLDeformerMaskChannel"), &Z_Registration_Info_UEnum_EMLDeformerMaskChannel, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3752457964U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLDeformerModel, UMLDeformerModel::StaticClass, TEXT("UMLDeformerModel"), &Z_Registration_Info_UClass_UMLDeformerModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLDeformerModel), 3072086165U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_MLDeformerFramework_Source_MLDeformerFramework_Public_MLDeformerModel_h_3859644263(TEXT("/Script/MLDeformerFramework"),
