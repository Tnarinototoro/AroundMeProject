...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModelVizSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVertexDeltaModelVizSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModelVizSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UVertexDeltaModelVizSettings_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaModelVizSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVertexDeltaModelVizSettings, UVertexDeltaModelVizSettings::StaticClass, TEXT("UVertexDeltaModelVizSettings"), &Z_Registration_Info_UClass_UVertexDeltaModelVizSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVertexDeltaModelVizSettings), 2137070458U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaModelVizSettings_h_494183330(TEXT("/Script/VertexDeltaModel"),
