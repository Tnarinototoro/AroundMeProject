...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataInterface_Statics::ClassParams = {
		...
		0,
		0x021102A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataInterface_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::NewProp_DeformerComponent = { "DeformerComponent", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_VertexDeltaGraphDebugDataProvider, DeformerComponent), Z_Construct_UClass_UMLDeformerComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::NewProp_DeformerComponent_MetaData), Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::NewProp_DeformerComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::NewProp_DeformerAsset = { "DeformerAsset", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_VertexDeltaGraphDebugDataProvider, DeformerAsset), Z_Construct_UClass_UMLDeformerAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::NewProp_DeformerAsset_MetaData), Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::NewProp_DeformerAsset_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::ClassParams = {
		...
		0,
		0x029012A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaGraphDebugDataInterface_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider, UDEPRECATED_VertexDeltaGraphDebugDataProvider::StaticClass, TEXT("UDEPRECATED_VertexDeltaGraphDebugDataProvider"), &Z_Registration_Info_UClass_UDEPRECATED_VertexDeltaGraphDebugDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_VertexDeltaGraphDebugDataProvider), 3668660788U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaGraphDebugDataInterface_h_2385132772(TEXT("/Script/VertexDeltaModel"),
