...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_NNEModel_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_NNEModel;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NNEModel_MetaData[] = {
		{ "Comment", "/** The NNE neural network model. */" },
		{ "ModuleRelativePath", "Public/VertexDeltaModel.h" },
		{ "ToolTip", "The NNE neural network model." },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NNEModel = { "NNEModel", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVertexDeltaModel, NNEModel), Z_Construct_UClass_UNNEModelData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NNEModel_MetaData), Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NNEModel_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumHiddenLayers = { "NumHiddenLayers", nullptr, (EPropertyFlags)0x0010000800000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVertexDeltaModel, NumHiddenLayers), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumHiddenLayers_MetaData), Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumHiddenLayers_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumNeuronsPerLayer = { "NumNeuronsPerLayer", nullptr, (EPropertyFlags)0x0010000800000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVertexDeltaModel, NumNeuronsPerLayer), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumNeuronsPerLayer_MetaData), Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumNeuronsPerLayer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumIterations = { "NumIterations", nullptr, (EPropertyFlags)0x0010000800000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVertexDeltaModel, NumIterations), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumIterations_MetaData), Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NumIterations_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_BatchSize = { "BatchSize", nullptr, (EPropertyFlags)0x0010000800000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVertexDeltaModel, BatchSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_BatchSize_MetaData), Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_BatchSize_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_LearningRate = { "LearningRate", nullptr, (EPropertyFlags)0x0010000800000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVertexDeltaModel, LearningRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_LearningRate_MetaData), Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_LearningRate_MetaData) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UVertexDeltaModel_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UVertexDeltaModel_Statics::NewProp_NNEModel,
#if WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVertexDeltaModel_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UVertexDeltaModel_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaModel_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVertexDeltaModel, UVertexDeltaModel::StaticClass, TEXT("UVertexDeltaModel"), &Z_Registration_Info_UClass_UVertexDeltaModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVertexDeltaModel), 2414544738U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaModel_h_3340016235(TEXT("/Script/VertexDeltaModel"),
