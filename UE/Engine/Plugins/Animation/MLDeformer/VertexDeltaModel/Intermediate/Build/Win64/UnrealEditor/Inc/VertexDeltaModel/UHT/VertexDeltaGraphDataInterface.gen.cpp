...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaGraphDataInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVertexDeltaGraphDataInterface_Statics::ClassParams = {
		...
		0,
		0x001100A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaGraphDataInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UVertexDeltaGraphDataInterface_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::NewProp_DeformerComponent = { "DeformerComponent", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVertexDeltaGraphDataProvider, DeformerComponent), Z_Construct_UClass_UMLDeformerComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::NewProp_DeformerComponent_MetaData), Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::NewProp_DeformerComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::Class_MetaDataParams), Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaGraphDataProvider_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaGraphDataInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVertexDeltaGraphDataInterface, UVertexDeltaGraphDataInterface::StaticClass, TEXT("UVertexDeltaGraphDataInterface"), &Z_Registration_Info_UClass_UVertexDeltaGraphDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVertexDeltaGraphDataInterface), 3198867152U) },
		{ Z_Construct_UClass_UVertexDeltaGraphDataProvider, UVertexDeltaGraphDataProvider::StaticClass, TEXT("UVertexDeltaGraphDataProvider"), &Z_Registration_Info_UClass_UVertexDeltaGraphDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVertexDeltaGraphDataProvider), 4131752461U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModel_Public_VertexDeltaGraphDataInterface_h_1216096734(TEXT("/Script/VertexDeltaModel"),
