...
// End Cross Module References
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UVertexDeltaTrainingModel_Train_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VertexDeltaTrainingModel_eventTrain_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVertexDeltaTrainingModel_Train_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVertexDeltaTrainingModel, nullptr, "Train", nullptr, nullptr, Z_Construct_UFunction_UVertexDeltaTrainingModel_Train_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVertexDeltaTrainingModel_Train_Statics::PropPointers), sizeof(VertexDeltaTrainingModel_eventTrain_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x48020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVertexDeltaTrainingModel_Train_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVertexDeltaTrainingModel_Train_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVertexDeltaTrainingModel_Train_Statics::PropPointers) < 2048);
	static_assert(sizeof(VertexDeltaTrainingModel_eventTrain_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaTrainingModel_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVertexDeltaTrainingModel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVertexDeltaTrainingModel_Train, "Train" }, // 98847005
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaTrainingModel_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVertexDeltaTrainingModel_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVertexDeltaTrainingModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UVertexDeltaTrainingModel_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModelEditor_Public_VertexDeltaTrainingModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVertexDeltaTrainingModel, UVertexDeltaTrainingModel::StaticClass, TEXT("UVertexDeltaTrainingModel"), &Z_Registration_Info_UClass_UVertexDeltaTrainingModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVertexDeltaTrainingModel), 1171291776U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_MLDeformer_VertexDeltaModel_Source_VertexDeltaModelEditor_Public_VertexDeltaTrainingModel_h_2310415354(TEXT("/Script/VertexDeltaModelEditor"),
