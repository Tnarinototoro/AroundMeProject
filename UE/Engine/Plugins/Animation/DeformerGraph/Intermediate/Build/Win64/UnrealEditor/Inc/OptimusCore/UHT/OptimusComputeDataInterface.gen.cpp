...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOptimusComputeDataInterface_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "OptimusComputeDataInterface.h" },
		{ "ModuleRelativePath", "Public/OptimusComputeDataInterface.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UOptimusComputeDataInterface_Statics::StaticCppClassTypeInfo = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusComputeDataInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusComputeDataInterface, UOptimusComputeDataInterface::StaticClass, TEXT("UOptimusComputeDataInterface"), &Z_Registration_Info_UClass_UOptimusComputeDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusComputeDataInterface), 1810538962U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusComputeDataInterface_h_2399785856(TEXT("/Script/OptimusCore"),
