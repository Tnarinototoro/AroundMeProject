...
template<> OPTIMUSCORE_API UScriptStruct* StaticStruct<FOptimusCompoundAction>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusAction_h_Statics::ScriptStructInfo[] = {
		{ FOptimusAction::StaticStruct, Z_Construct_UScriptStruct_FOptimusAction_Statics::NewStructOps, TEXT("OptimusAction"), &Z_Registration_Info_UScriptStruct_OptimusAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusAction), 2547226377U) },
		{ FOptimusCompoundAction::StaticStruct, Z_Construct_UScriptStruct_FOptimusCompoundAction_Statics::NewStructOps, TEXT("OptimusCompoundAction"), &Z_Registration_Info_UScriptStruct_OptimusCompoundAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusCompoundAction), 2385986433U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusAction_h_3621216915(TEXT("/Script/OptimusCore"),
		nullptr, 0,
