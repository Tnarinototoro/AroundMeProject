...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusNodePin_h_Statics::EnumInfo[] = {
		{ EOptimusNodePinStorageType_StaticEnum, TEXT("EOptimusNodePinStorageType"), &Z_Registration_Info_UEnum_EOptimusNodePinStorageType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1168503649U) },
		{ EOptimusNodePinDirection_StaticEnum, TEXT("EOptimusNodePinDirection"), &Z_Registration_Info_UEnum_EOptimusNodePinDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3866082399U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusNodePin_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusNodePin, UOptimusNodePin::StaticClass, TEXT("UOptimusNodePin"), &Z_Registration_Info_UClass_UOptimusNodePin, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusNodePin), 917180384U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusNodePin_h_1465202439(TEXT("/Script/OptimusCore"),
