...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UOptimusSettings_Statics::NewProp_DefaultMode = { "DefaultMode", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusSettings, DefaultMode), Z_Construct_UEnum_OptimusSettings_EOptimusDefaultDeformerMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSettings_Statics::NewProp_DefaultMode_MetaData), Z_Construct_UClass_UOptimusSettings_Statics::NewProp_DefaultMode_MetaData) }; // 2326535006
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UOptimusSettings_Statics::NewProp_DefaultDeformer = { "DefaultDeformer", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusSettings, DefaultDeformer), Z_Construct_UClass_UMeshDeformer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSettings_Statics::NewProp_DefaultDeformer_MetaData), Z_Construct_UClass_UOptimusSettings_Statics::NewProp_DefaultDeformer_MetaData) };
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusSettings_Public_OptimusSettings_h_Statics::EnumInfo[] = {
		{ EOptimusDefaultDeformerMode_StaticEnum, TEXT("EOptimusDefaultDeformerMode"), &Z_Registration_Info_UEnum_EOptimusDefaultDeformerMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2326535006U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusSettings_Public_OptimusSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusSettings, UOptimusSettings::StaticClass, TEXT("UOptimusSettings"), &Z_Registration_Info_UClass_UOptimusSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSettings), 4177907804U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusSettings_Public_OptimusSettings_h_761600564(TEXT("/Script/OptimusSettings"),
