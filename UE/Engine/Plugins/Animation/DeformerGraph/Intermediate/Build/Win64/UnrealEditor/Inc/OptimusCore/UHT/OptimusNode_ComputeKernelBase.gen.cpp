...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOptimusNode_ComputeKernelBase_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UOptimusNode_ComputeKernelBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UOptimusComputeKernelProvider_NoRegister, (int32)VTABLE_OFFSET(UOptimusNode_ComputeKernelBase, IOptimusComputeKernelProvider), false },  // 2861599580
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusNode_ComputeKernelBase_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Nodes_OptimusNode_ComputeKernelBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusNode_ComputeKernelBase, UOptimusNode_ComputeKernelBase::StaticClass, TEXT("UOptimusNode_ComputeKernelBase"), &Z_Registration_Info_UClass_UOptimusNode_ComputeKernelBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusNode_ComputeKernelBase), 4008868896U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Nodes_OptimusNode_ComputeKernelBase_h_3627336595(TEXT("/Script/OptimusCore"),
