...
template<> OPTIMUSCORE_API UScriptStruct* StaticStruct<FOptimusNodeAction_MovePin>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusNodeActions_h_Statics::ScriptStructInfo[] = {
		{ FOptimusNodeAction_RenameNode::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeAction_RenameNode_Statics::NewStructOps, TEXT("OptimusNodeAction_RenameNode"), &Z_Registration_Info_UScriptStruct_OptimusNodeAction_RenameNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeAction_RenameNode), 482989233U) },
		{ FOptimusNodeAction_MoveNode::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeAction_MoveNode_Statics::NewStructOps, TEXT("OptimusNodeAction_MoveNode"), &Z_Registration_Info_UScriptStruct_OptimusNodeAction_MoveNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeAction_MoveNode), 795938758U) },
		...
		{ FOptimusNodeAction_AddPin::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeAction_AddPin_Statics::NewStructOps, TEXT("OptimusNodeAction_AddPin"), &Z_Registration_Info_UScriptStruct_OptimusNodeAction_AddPin, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeAction_AddPin), 3714104595U) },
		...
		{ FOptimusNodeAction_RemovePin::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeAction_RemovePin_Statics::NewStructOps, TEXT("OptimusNodeAction_RemovePin"), &Z_Registration_Info_UScriptStruct_OptimusNodeAction_RemovePin, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeAction_RemovePin), 2052426496U) },
		{ FOptimusNodeAction_MovePin::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeAction_MovePin_Statics::NewStructOps, TEXT("OptimusNodeAction_MovePin"), &Z_Registration_Info_UScriptStruct_OptimusNodeAction_MovePin, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeAction_MovePin), 2231699845U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusNodeActions_h_1821392196(TEXT("/Script/OptimusCore"),
		nullptr, 0,
