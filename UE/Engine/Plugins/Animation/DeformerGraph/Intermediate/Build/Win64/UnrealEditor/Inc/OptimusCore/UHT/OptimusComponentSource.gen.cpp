...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_BindingName = { "BindingName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusComponentSourceBinding, BindingName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_BindingName_MetaData), Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_BindingName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_ComponentType = { "ComponentType", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusComponentSourceBinding, ComponentType), Z_Construct_UClass_UClass, Z_Construct_UClass_UOptimusComponentSource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_ComponentType_MetaData), Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_ComponentType_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_ComponentTags = { "ComponentTags", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusComponentSourceBinding, ComponentTags), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_ComponentTags_MetaData), Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_ComponentTags_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_bIsPrimaryBinding = { "bIsPrimaryBinding", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOptimusComponentSourceBinding), &Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_bIsPrimaryBinding_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_bIsPrimaryBinding_MetaData), Z_Construct_UClass_UOptimusComponentSourceBinding_Statics::NewProp_bIsPrimaryBinding_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusComponentSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusComponentSource, UOptimusComponentSource::StaticClass, TEXT("UOptimusComponentSource"), &Z_Registration_Info_UClass_UOptimusComponentSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusComponentSource), 637020559U) },
		{ Z_Construct_UClass_UOptimusComponentSourceBinding, UOptimusComponentSourceBinding::StaticClass, TEXT("UOptimusComponentSourceBinding"), &Z_Registration_Info_UClass_UOptimusComponentSourceBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusComponentSourceBinding), 68626084U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusComponentSource_h_3105975401(TEXT("/Script/OptimusCore"),
