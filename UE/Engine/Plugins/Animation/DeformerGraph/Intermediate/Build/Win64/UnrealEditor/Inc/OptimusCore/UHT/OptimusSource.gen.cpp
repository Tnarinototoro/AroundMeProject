...
// End Cross Module References
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOptimusSource_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UOptimusSource_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UOptimusShaderTextProvider_NoRegister, (int32)VTABLE_OFFSET(UOptimusSource, IOptimusShaderTextProvider), false },  // 1107076429
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSource_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusSource, UOptimusSource::StaticClass, TEXT("UOptimusSource"), &Z_Registration_Info_UClass_UOptimusSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSource), 1364204069U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusSource_h_2215695529(TEXT("/Script/OptimusCore"),
