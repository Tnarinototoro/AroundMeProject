...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOptimusHalfEdgeDataProvider_Statics::NewProp_SkinnedMesh = { "SkinnedMesh", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusHalfEdgeDataProvider, SkinnedMesh), Z_Construct_UClass_USkinnedMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusHalfEdgeDataProvider_Statics::NewProp_SkinnedMesh_MetaData), Z_Construct_UClass_UOptimusHalfEdgeDataProvider_Statics::NewProp_SkinnedMesh_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceHalfEdge_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusHalfEdgeDataInterface, UOptimusHalfEdgeDataInterface::StaticClass, TEXT("UOptimusHalfEdgeDataInterface"), &Z_Registration_Info_UClass_UOptimusHalfEdgeDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusHalfEdgeDataInterface), 1919902420U) },
		{ Z_Construct_UClass_UOptimusHalfEdgeDataProvider, UOptimusHalfEdgeDataProvider::StaticClass, TEXT("UOptimusHalfEdgeDataProvider"), &Z_Registration_Info_UClass_UOptimusHalfEdgeDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusHalfEdgeDataProvider), 3809882369U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceHalfEdge_h_1754976230(TEXT("/Script/OptimusCore"),
