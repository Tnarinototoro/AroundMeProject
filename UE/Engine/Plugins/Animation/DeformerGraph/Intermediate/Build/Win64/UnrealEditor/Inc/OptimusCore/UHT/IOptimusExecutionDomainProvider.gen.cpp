...
template<> OPTIMUSCORE_API UScriptStruct* StaticStruct<FOptimusExecutionDomain>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FOptimusExecutionDomain_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOptimusExecutionDomain, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOptimusExecutionDomain_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FOptimusExecutionDomain_Statics::NewProp_Name_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusExecutionDomainProvider_h_Statics::ScriptStructInfo[] = {
		{ FOptimusExecutionDomain::StaticStruct, Z_Construct_UScriptStruct_FOptimusExecutionDomain_Statics::NewStructOps, TEXT("OptimusExecutionDomain"), &Z_Registration_Info_UScriptStruct_OptimusExecutionDomain, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusExecutionDomain), 3467753761U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusExecutionDomainProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusExecutionDomainProvider, UOptimusExecutionDomainProvider::StaticClass, TEXT("UOptimusExecutionDomainProvider"), &Z_Registration_Info_UClass_UOptimusExecutionDomainProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusExecutionDomainProvider), 961086182U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusExecutionDomainProvider_h_566924693(TEXT("/Script/OptimusCore"),
