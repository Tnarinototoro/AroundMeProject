...
template<> OPTIMUSCORE_API UScriptStruct* StaticStruct<FOptimusNode_GetVariable_DuplicationInfo>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FOptimusNode_GetVariable_DuplicationInfo_Statics::NewProp_VariableName = { "VariableName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOptimusNode_GetVariable_DuplicationInfo, VariableName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOptimusNode_GetVariable_DuplicationInfo_Statics::NewProp_VariableName_MetaData), Z_Construct_UScriptStruct_FOptimusNode_GetVariable_DuplicationInfo_Statics::NewProp_VariableName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOptimusNode_GetVariable_DuplicationInfo_Statics::NewProp_DataType = { "DataType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOptimusNode_GetVariable_DuplicationInfo, DataType), Z_Construct_UScriptStruct_FOptimusDataTypeRef, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOptimusNode_GetVariable_DuplicationInfo_Statics::NewProp_DataType_MetaData), Z_Construct_UScriptStruct_FOptimusNode_GetVariable_DuplicationInfo_Statics::NewProp_DataType_MetaData) }; // 4267076562
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UOptimusNode_GetVariable_Statics::NewProp_VariableDesc = { "VariableDesc", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusNode_GetVariable, VariableDesc), Z_Construct_UClass_UOptimusVariableDescription_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusNode_GetVariable_Statics::NewProp_VariableDesc_MetaData), Z_Construct_UClass_UOptimusNode_GetVariable_Statics::NewProp_VariableDesc_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOptimusNode_GetVariable_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UOptimusNode_GetVariable_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UOptimusValueProvider_NoRegister, (int32)VTABLE_OFFSET(UOptimusNode_GetVariable, IOptimusValueProvider), false },  // 230468455
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusNode_GetVariable_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Nodes_OptimusNode_GetVariable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusNode_GetVariable, UOptimusNode_GetVariable::StaticClass, TEXT("UOptimusNode_GetVariable"), &Z_Registration_Info_UClass_UOptimusNode_GetVariable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusNode_GetVariable), 629400710U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Nodes_OptimusNode_GetVariable_h_672026147(TEXT("/Script/OptimusCore"),
