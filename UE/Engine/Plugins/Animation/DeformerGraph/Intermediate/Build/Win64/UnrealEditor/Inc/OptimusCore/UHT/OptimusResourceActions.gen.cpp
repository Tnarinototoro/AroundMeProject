...
template<> OPTIMUSCORE_API UScriptStruct* StaticStruct<FOptimusResourceAction_SetDataDomain>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusResourceActions_h_Statics::ScriptStructInfo[] = {
		{ FOptimusResourceAction_AddResource::StaticStruct, Z_Construct_UScriptStruct_FOptimusResourceAction_AddResource_Statics::NewStructOps, TEXT("OptimusResourceAction_AddResource"), &Z_Registration_Info_UScriptStruct_OptimusResourceAction_AddResource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusResourceAction_AddResource), 2118758183U) },
		{ FOptimusResourceAction_RemoveResource::StaticStruct, Z_Construct_UScriptStruct_FOptimusResourceAction_RemoveResource_Statics::NewStructOps, TEXT("OptimusResourceAction_RemoveResource"), &Z_Registration_Info_UScriptStruct_OptimusResourceAction_RemoveResource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusResourceAction_RemoveResource), 2685044708U) },
		{ FOptimusResourceAction_RenameResource::StaticStruct, Z_Construct_UScriptStruct_FOptimusResourceAction_RenameResource_Statics::NewStructOps, TEXT("OptimusResourceAction_RenameResource"), &Z_Registration_Info_UScriptStruct_OptimusResourceAction_RenameResource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusResourceAction_RenameResource), 2746930482U) },
		{ FOptimusResourceAction_SetDataType::StaticStruct, Z_Construct_UScriptStruct_FOptimusResourceAction_SetDataType_Statics::NewStructOps, TEXT("OptimusResourceAction_SetDataType"), &Z_Registration_Info_UScriptStruct_OptimusResourceAction_SetDataType, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusResourceAction_SetDataType), 3081024726U) },
		{ FOptimusResourceAction_SetDataDomain::StaticStruct, Z_Construct_UScriptStruct_FOptimusResourceAction_SetDataDomain_Statics::NewStructOps, TEXT("OptimusResourceAction_SetDataDomain"), &Z_Registration_Info_UScriptStruct_OptimusResourceAction_SetDataDomain, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusResourceAction_SetDataDomain), 2492688309U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusResourceActions_h_1856917455(TEXT("/Script/OptimusCore"),
		nullptr, 0,
