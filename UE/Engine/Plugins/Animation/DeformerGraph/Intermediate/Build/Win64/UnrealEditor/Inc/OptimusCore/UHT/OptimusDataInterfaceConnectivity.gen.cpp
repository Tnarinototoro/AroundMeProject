...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOptimusConnectivityDataProvider_Statics::NewProp_SkinnedMesh = { "SkinnedMesh", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusConnectivityDataProvider, SkinnedMesh), Z_Construct_UClass_USkinnedMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusConnectivityDataProvider_Statics::NewProp_SkinnedMesh_MetaData), Z_Construct_UClass_UOptimusConnectivityDataProvider_Statics::NewProp_SkinnedMesh_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceConnectivity_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UOptimusConnectivityDataProvider, UOptimusConnectivityDataProvider::StaticClass, TEXT("UOptimusConnectivityDataProvider"), &Z_Registration_Info_UClass_UOptimusConnectivityDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusConnectivityDataProvider), 95394050U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceConnectivity_h_445075170(TEXT("/Script/OptimusCore"),
