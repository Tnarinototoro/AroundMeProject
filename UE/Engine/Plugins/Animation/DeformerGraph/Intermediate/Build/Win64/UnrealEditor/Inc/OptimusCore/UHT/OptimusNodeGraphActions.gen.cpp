...
template<> OPTIMUSCORE_API UScriptStruct* StaticStruct<FOptimusNodeGraphAction_ConnectAdderPin>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FOptimusNodeGraphAction_ConnectAdderPin_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Private/Actions/OptimusNodeGraphActions.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FOptimusNodeGraphAction_ConnectAdderPin_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FOptimusNodeGraphAction_ConnectAdderPin>();
	}
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOptimusNodeGraphAction_ConnectAdderPin_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_OptimusCore,
		Z_Construct_UScriptStruct_FOptimusNodeGraphAction_AddRemoveLink,
		&NewStructOps,
	...
	UScriptStruct* Z_Construct_UScriptStruct_FOptimusNodeGraphAction_ConnectAdderPin()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OptimusNodeGraphAction_ConnectAdderPin.InnerSingleton, Z_Construct_UScriptStruct_FOptimusNodeGraphAction_ConnectAdderPin_Statics::ReturnStructParams);
		}
...
template<> OPTIMUSCORE_API UScriptStruct* StaticStruct<FOptimusNodeGraphAction_UnpackageKernelFunction>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusNodeGraphActions_h_Statics::ScriptStructInfo[] = {
		{ FOptimusNodeGraphAction_AddGraph::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeGraphAction_AddGraph_Statics::NewStructOps, TEXT("OptimusNodeGraphAction_AddGraph"), &Z_Registration_Info_UScriptStruct_OptimusNodeGraphAction_AddGraph, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeGraphAction_AddGraph), 151340560U) },
		{ FOptimusNodeGraphAction_RemoveGraph::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeGraphAction_RemoveGraph_Statics::NewStructOps, TEXT("OptimusNodeGraphAction_RemoveGraph"), &Z_Registration_Info_UScriptStruct_OptimusNodeGraphAction_RemoveGraph, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeGraphAction_RemoveGraph), 3378264974U) },
		{ FOptimusNodeGraphAction_RenameGraph::StaticStruct, Z_Construct_UScriptStruct_FOptimusNodeGraphAction_RenameGraph_Statics::NewStructOps, TEXT("OptimusNodeGraphAction_RenameGraph"), &Z_Registration_Info_UScriptStruct_OptimusNodeGraphAction_RenameGraph, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOptimusNodeGraphAction_RenameGraph), 3142401578U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_Actions_OptimusNodeGraphActions_h_1722695826(TEXT("/Script/OptimusCore"),
		nullptr, 0,
