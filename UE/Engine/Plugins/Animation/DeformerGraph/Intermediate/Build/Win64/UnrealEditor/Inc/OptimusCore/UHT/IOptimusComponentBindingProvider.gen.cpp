...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOptimusComponentBindingProvider_Statics::Class_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/IOptimusComponentBindingProvider.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UOptimusComponentBindingProvider_Statics::StaticCppClassTypeInfo = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusComponentBindingProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusComponentBindingProvider, UOptimusComponentBindingProvider::StaticClass, TEXT("UOptimusComponentBindingProvider"), &Z_Registration_Info_UClass_UOptimusComponentBindingProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusComponentBindingProvider), 3427681112U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_IOptimusComponentBindingProvider_h_2520598569(TEXT("/Script/OptimusCore"),
