...
#include "../Private/ComponentSources/OptimusSceneComponentSource.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOptimusSceneComponentSource_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UOptimusSceneComponentSource_Statics::StaticCppClassTypeInfo = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_ComponentSources_OptimusSceneComponentSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusSceneComponentSource, UOptimusSceneComponentSource::StaticClass, TEXT("UOptimusSceneComponentSource"), &Z_Registration_Info_UClass_UOptimusSceneComponentSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSceneComponentSource), 1279414274U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_ComponentSources_OptimusSceneComponentSource_h_3809162489(TEXT("/Script/OptimusCore"),
