...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOptimusSceneDataProvider_Statics::NewProp_SceneComponent = { "SceneComponent", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusSceneDataProvider, SceneComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSceneDataProvider_Statics::NewProp_SceneComponent_MetaData), Z_Construct_UClass_UOptimusSceneDataProvider_Statics::NewProp_SceneComponent_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceScene_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusSceneDataInterface, UOptimusSceneDataInterface::StaticClass, TEXT("UOptimusSceneDataInterface"), &Z_Registration_Info_UClass_UOptimusSceneDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSceneDataInterface), 1295006068U) },
		{ Z_Construct_UClass_UOptimusSceneDataProvider, UOptimusSceneDataProvider::StaticClass, TEXT("UOptimusSceneDataProvider"), &Z_Registration_Info_UClass_UOptimusSceneDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSceneDataProvider), 3547428256U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceScene_h_2002147768(TEXT("/Script/OptimusCore"),
