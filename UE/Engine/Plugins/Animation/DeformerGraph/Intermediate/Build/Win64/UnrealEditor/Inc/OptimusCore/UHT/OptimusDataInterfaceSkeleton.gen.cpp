...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOptimusSkeletonDataProvider_Statics::NewProp_SkinnedMesh = { "SkinnedMesh", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusSkeletonDataProvider, SkinnedMesh), Z_Construct_UClass_USkinnedMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusSkeletonDataProvider_Statics::NewProp_SkinnedMesh_MetaData), Z_Construct_UClass_UOptimusSkeletonDataProvider_Statics::NewProp_SkinnedMesh_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceSkeleton_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusSkeletonDataInterface, UOptimusSkeletonDataInterface::StaticClass, TEXT("UOptimusSkeletonDataInterface"), &Z_Registration_Info_UClass_UOptimusSkeletonDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSkeletonDataInterface), 3137807168U) },
		{ Z_Construct_UClass_UOptimusSkeletonDataProvider, UOptimusSkeletonDataProvider::StaticClass, TEXT("UOptimusSkeletonDataProvider"), &Z_Registration_Info_UClass_UOptimusSkeletonDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusSkeletonDataProvider), 1670049459U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Private_DataInterfaces_OptimusDataInterfaceSkeleton_h_247924189(TEXT("/Script/OptimusCore"),
