...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UOptimusKernelSource_Statics::NewProp_Source = { "Source", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusKernelSource, Source), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusKernelSource_Statics::NewProp_Source_MetaData), Z_Construct_UClass_UOptimusKernelSource_Statics::NewProp_Source_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusKernelSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusKernelSource, UOptimusKernelSource::StaticClass, TEXT("UOptimusKernelSource"), &Z_Registration_Info_UClass_UOptimusKernelSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusKernelSource), 2240880195U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusKernelSource_h_4131563668(TEXT("/Script/OptimusCore"),
