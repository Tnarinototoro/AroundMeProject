...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOptimusValueContainerGeneratorClass_Statics::NewProp_DataType = { "DataType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusValueContainerGeneratorClass, DataType), Z_Construct_UScriptStruct_FOptimusDataTypeRef, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusValueContainerGeneratorClass_Statics::NewProp_DataType_MetaData), Z_Construct_UClass_UOptimusValueContainerGeneratorClass_Statics::NewProp_DataType_MetaData) }; // 4267076562
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusValueContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusValueContainerGeneratorClass, UOptimusValueContainerGeneratorClass::StaticClass, TEXT("UOptimusValueContainerGeneratorClass"), &Z_Registration_Info_UClass_UOptimusValueContainerGeneratorClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusValueContainerGeneratorClass), 2763687572U) },
		{ Z_Construct_UClass_UOptimusValueContainer, UOptimusValueContainer::StaticClass, TEXT("UOptimusValueContainer"), &Z_Registration_Info_UClass_UOptimusValueContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusValueContainer), 2781699764U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusValueContainer_h_1358866082(TEXT("/Script/OptimusCore"),
