...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOptimusNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOptimusNode_GetDisplayName, "GetDisplayName" }, // 3006337297
		{ &Z_Construct_UFunction_UOptimusNode_GetGraphPosition, "GetGraphPosition" }, // 3735778979
		{ &Z_Construct_UFunction_UOptimusNode_GetNodeCategory, "GetNodeCategory" }, // 2927284045
		{ &Z_Construct_UFunction_UOptimusNode_GetNodeName, "GetNodeName" }, // 311655949
		{ &Z_Construct_UFunction_UOptimusNode_SetGraphPosition, "SetGraphPosition" }, // 1069384854
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UOptimusNode_Statics::NewProp_Pins = { "Pins", nullptr, (EPropertyFlags)0x0044000400000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusNode, Pins), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusNode_Statics::NewProp_Pins_MetaData), Z_Construct_UClass_UOptimusNode_Statics::NewProp_Pins_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusNode, UOptimusNode::StaticClass, TEXT("UOptimusNode"), &Z_Registration_Info_UClass_UOptimusNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusNode), 4201450158U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_DeformerGraph_Source_OptimusCore_Public_OptimusNode_h_756711267(TEXT("/Script/OptimusCore"),
