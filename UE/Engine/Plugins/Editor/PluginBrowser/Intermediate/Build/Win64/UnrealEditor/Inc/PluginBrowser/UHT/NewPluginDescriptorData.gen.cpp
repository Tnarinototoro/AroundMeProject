...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNewPluginDescriptorData_Statics::NewProp_CreatedBy = { "CreatedBy", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNewPluginDescriptorData, CreatedBy), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNewPluginDescriptorData_Statics::NewProp_CreatedBy_MetaData), Z_Construct_UClass_UNewPluginDescriptorData_Statics::NewProp_CreatedBy_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNewPluginDescriptorData_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNewPluginDescriptorData, Description), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNewPluginDescriptorData_Statics::NewProp_Description_MetaData), Z_Construct_UClass_UNewPluginDescriptorData_Statics::NewProp_Description_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_PluginBrowser_Source_PluginBrowser_Private_NewPluginDescriptorData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNewPluginDescriptorData, UNewPluginDescriptorData::StaticClass, TEXT("UNewPluginDescriptorData"), &Z_Registration_Info_UClass_UNewPluginDescriptorData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNewPluginDescriptorData), 836183782U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_PluginBrowser_Source_PluginBrowser_Private_NewPluginDescriptorData_h_516628187(TEXT("/Script/PluginBrowser"),
