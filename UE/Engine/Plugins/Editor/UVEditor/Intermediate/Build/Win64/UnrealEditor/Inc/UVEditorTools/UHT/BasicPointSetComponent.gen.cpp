...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_PointMaterial = { "PointMaterial", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBasicPointSetComponentBase, PointMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_PointMaterial_MetaData), Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_PointMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_Bounds = { "Bounds", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBasicPointSetComponentBase, Bounds), Z_Construct_UScriptStruct_FBoxSphereBounds, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_Bounds_MetaData), Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_Bounds_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_DepthBias = { "DepthBias", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBasicPointSetComponentBase, DepthBias), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_DepthBias_MetaData), Z_Construct_UClass_UBasicPointSetComponentBase_Statics::NewProp_DepthBias_MetaData) };
	...
	UBasic3DPointSetComponent::~UBasic3DPointSetComponent() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_Drawing_BasicPointSetComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_Drawing_BasicPointSetComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBasicPointSetComponentBase, UBasicPointSetComponentBase::StaticClass, TEXT("UBasicPointSetComponentBase"), &Z_Registration_Info_UClass_UBasicPointSetComponentBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBasicPointSetComponentBase), 1134904887U) },
		{ Z_Construct_UClass_UBasic2DPointSetComponent, UBasic2DPointSetComponent::StaticClass, TEXT("UBasic2DPointSetComponent"), &Z_Registration_Info_UClass_UBasic2DPointSetComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBasic2DPointSetComponent), 1817657067U) },
		{ Z_Construct_UClass_UBasic3DPointSetComponent, UBasic3DPointSetComponent::StaticClass, TEXT("UBasic3DPointSetComponent"), &Z_Registration_Info_UClass_UBasic3DPointSetComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBasic3DPointSetComponent), 1137407928U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_Drawing_BasicPointSetComponent_h_3359686046(TEXT("/Script/UVEditorTools"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_Drawing_BasicPointSetComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_Drawing_BasicPointSetComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
