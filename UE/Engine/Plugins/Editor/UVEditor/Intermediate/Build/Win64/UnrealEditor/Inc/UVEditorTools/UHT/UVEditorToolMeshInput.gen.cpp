...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bEnableTriangleVertexColors_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_UnwrapPreview = { "UnwrapPreview", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorToolMeshInput, UnwrapPreview), Z_Construct_UClass_UMeshOpPreviewWithBackgroundCompute_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_UnwrapPreview_MetaData), Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_UnwrapPreview_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_AppliedPreview = { "AppliedPreview", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorToolMeshInput, AppliedPreview), Z_Construct_UClass_UMeshOpPreviewWithBackgroundCompute_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_AppliedPreview_MetaData), Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_AppliedPreview_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_WireframeDisplay = { "WireframeDisplay", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorToolMeshInput, WireframeDisplay), Z_Construct_UClass_UMeshElementsVisualizer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_WireframeDisplay_MetaData), Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_WireframeDisplay_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_bEnableTriangleVertexColors_MetaData[] = {
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_bEnableTriangleVertexColors = { "bEnableTriangleVertexColors", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUVEditorToolMeshInput), &Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_bEnableTriangleVertexColors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_bEnableTriangleVertexColors_MetaData), Z_Construct_UClass_UUVEditorToolMeshInput_Statics::NewProp_bEnableTriangleVertexColors_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ToolTargets_UVEditorToolMeshInput_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ToolTargets_UVEditorToolMeshInput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUVEditorToolMeshInput, UUVEditorToolMeshInput::StaticClass, TEXT("UUVEditorToolMeshInput"), &Z_Registration_Info_UClass_UUVEditorToolMeshInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVEditorToolMeshInput), 4147622547U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ToolTargets_UVEditorToolMeshInput_h_2660251425(TEXT("/Script/UVEditorTools"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ToolTargets_UVEditorToolMeshInput_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ToolTargets_UVEditorToolMeshInput_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
