...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorBackgroundPreview, Settings), Z_Construct_UClass_UUVEditorBackgroundPreviewProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_Settings_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_BackgroundComponent = { "BackgroundComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorBackgroundPreview, BackgroundComponent), Z_Construct_UClass_UTriangleSetComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_BackgroundComponent_MetaData), Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_BackgroundComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_BackgroundMaterial = { "BackgroundMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorBackgroundPreview, BackgroundMaterial), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_BackgroundMaterial_MetaData), Z_Construct_UClass_UUVEditorBackgroundPreview_Statics::NewProp_BackgroundMaterial_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_Statics::EnumInfo[] = {
		{ EUVEditorBackgroundSourceType_StaticEnum, TEXT("EUVEditorBackgroundSourceType"), &Z_Registration_Info_UEnum_EUVEditorBackgroundSourceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3557028499U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UUVEditorBackgroundPreview, UUVEditorBackgroundPreview::StaticClass, TEXT("UUVEditorBackgroundPreview"), &Z_Registration_Info_UClass_UUVEditorBackgroundPreview, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVEditorBackgroundPreview), 3399955334U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_3355550354(TEXT("/Script/UVEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorBackgroundPreview_h_Statics::EnumInfo));
