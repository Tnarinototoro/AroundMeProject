...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorSubsystem_Statics::NewProp_ToolTargetManager = { "ToolTargetManager", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorSubsystem, ToolTargetManager), Z_Construct_UClass_UToolTargetManager_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorSubsystem_Statics::NewProp_ToolTargetManager_MetaData), Z_Construct_UClass_UUVEditorSubsystem_Statics::NewProp_ToolTargetManager_MetaData) };
	...
	UUVEditorSubsystem::~UUVEditorSubsystem() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUVEditorSubsystem, UUVEditorSubsystem::StaticClass, TEXT("UUVEditorSubsystem"), &Z_Registration_Info_UClass_UUVEditorSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVEditorSubsystem), 3975848597U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorSubsystem_h_1429079540(TEXT("/Script/UVEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditorSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
