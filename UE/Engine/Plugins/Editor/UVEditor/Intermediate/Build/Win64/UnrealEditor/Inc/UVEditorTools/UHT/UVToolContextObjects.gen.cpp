...
template<> UVEDITORTOOLS_API UScriptStruct* StaticStruct<FUDIMBlock>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewProp_UDIM = { "UDIM", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUDIMBlock, UDIM), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewProp_UDIM_MetaData), Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewProp_UDIM_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewProp_TextureResolution_MetaData[] = {
		{ "ModuleRelativePath", "Public/ContextObjects/UVToolContextObjects.h" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewProp_TextureResolution = { "TextureResolution", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUDIMBlock, TextureResolution), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewProp_TextureResolution_MetaData), Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewProp_TextureResolution_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_UDIMBlocks_Inner = { "UDIMBlocks", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FUDIMBlock, METADATA_PARAMS(0, nullptr) }; // 2335854874
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_UDIMBlocks_MetaData[] = {
		{ "ModuleRelativePath", "Public/ContextObjects/UVToolContextObjects.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_UDIMBlocks = { "UDIMBlocks", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVTool2DViewportAPI, UDIMBlocks), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_UDIMBlocks_MetaData), Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_UDIMBlocks_MetaData) }; // 2335854874
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawGrid = { "bDrawGrid", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUVTool2DViewportAPI), &Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawGrid_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawGrid_MetaData), Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawGrid_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawRulers = { "bDrawRulers", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUVTool2DViewportAPI), &Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawRulers_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawRulers_MetaData), Z_Construct_UClass_UUVTool2DViewportAPI_Statics::NewProp_bDrawRulers_MetaData) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUVEditorToolPropertiesAPI_Statics::NewProp_ToolDisplayProperties = { "ToolDisplayProperties", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditorToolPropertiesAPI, ToolDisplayProperties), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditorToolPropertiesAPI_Statics::NewProp_ToolDisplayProperties_MetaData), Z_Construct_UClass_UUVEditorToolPropertiesAPI_Statics::NewProp_ToolDisplayProperties_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_Statics::ScriptStructInfo[] = {
		{ FUDIMBlock::StaticStruct, Z_Construct_UScriptStruct_FUDIMBlock_Statics::NewStructOps, TEXT("UDIMBlock"), &Z_Registration_Info_UScriptStruct_UDIMBlock, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUDIMBlock), 2335854874U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUVToolContextObject, UUVToolContextObject::StaticClass, TEXT("UUVToolContextObject"), &Z_Registration_Info_UClass_UUVToolContextObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVToolContextObject), 1952338960U) },
		{ Z_Construct_UClass_UUVToolEmitChangeAPI, UUVToolEmitChangeAPI::StaticClass, TEXT("UUVToolEmitChangeAPI"), &Z_Registration_Info_UClass_UUVToolEmitChangeAPI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVToolEmitChangeAPI), 3660649296U) },
		{ Z_Construct_UClass_UUVToolLivePreviewAPI, UUVToolLivePreviewAPI::StaticClass, TEXT("UUVToolLivePreviewAPI"), &Z_Registration_Info_UClass_UUVToolLivePreviewAPI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVToolLivePreviewAPI), 2517917863U) },
		{ Z_Construct_UClass_UUVTool2DViewportAPI, UUVTool2DViewportAPI::StaticClass, TEXT("UUVTool2DViewportAPI"), &Z_Registration_Info_UClass_UUVTool2DViewportAPI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVTool2DViewportAPI), 3555013031U) },
		{ Z_Construct_UClass_UUVToolAssetAndChannelAPI, UUVToolAssetAndChannelAPI::StaticClass, TEXT("UUVToolAssetAndChannelAPI"), &Z_Registration_Info_UClass_UUVToolAssetAndChannelAPI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVToolAssetAndChannelAPI), 4043868198U) },
		{ Z_Construct_UClass_UUVToolAABBTreeStorage, UUVToolAABBTreeStorage::StaticClass, TEXT("UUVToolAABBTreeStorage"), &Z_Registration_Info_UClass_UUVToolAABBTreeStorage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVToolAABBTreeStorage), 3987955741U) },
		{ Z_Construct_UClass_UUVEditorToolPropertiesAPI, UUVEditorToolPropertiesAPI::StaticClass, TEXT("UUVEditorToolPropertiesAPI"), &Z_Registration_Info_UClass_UUVEditorToolPropertiesAPI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVEditorToolPropertiesAPI), 2565895980U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_904613865(TEXT("/Script/UVEditorTools"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditorTools_Public_ContextObjects_UVToolContextObjects_h_Statics::ScriptStructInfo),
		nullptr, 0);
