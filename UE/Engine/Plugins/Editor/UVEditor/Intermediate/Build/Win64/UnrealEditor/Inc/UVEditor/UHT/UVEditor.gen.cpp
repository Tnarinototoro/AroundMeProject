...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUVEditor_Statics::NewProp_OriginalObjectsToEdit = { "OriginalObjectsToEdit", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUVEditor, OriginalObjectsToEdit), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVEditor_Statics::NewProp_OriginalObjectsToEdit_MetaData), Z_Construct_UClass_UUVEditor_Statics::NewProp_OriginalObjectsToEdit_MetaData) };
	...
	UUVEditor::~UUVEditor() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUVEditor, UUVEditor::StaticClass, TEXT("UUVEditor"), &Z_Registration_Info_UClass_UUVEditor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVEditor), 3529349324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditor_h_4121854642(TEXT("/Script/UVEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_UVEditor_Source_UVEditor_Public_UVEditor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
