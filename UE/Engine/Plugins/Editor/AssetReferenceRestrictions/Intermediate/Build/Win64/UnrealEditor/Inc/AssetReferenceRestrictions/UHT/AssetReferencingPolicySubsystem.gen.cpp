...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetReferencingPolicySubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetReferencingPolicySubsystem_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/AssetReferencingPolicySubsystem.h" },
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetReferencingPolicySubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetReferencingPolicySubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetReferencingPolicySubsystem_Statics::Class_MetaDataParams)
	};
	...
	UAssetReferencingPolicySubsystem::~UAssetReferencingPolicySubsystem() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_AssetReferenceRestrictions_Source_AssetReferenceRestrictions_Public_AssetReferencingPolicySubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_AssetReferenceRestrictions_Source_AssetReferenceRestrictions_Public_AssetReferencingPolicySubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetReferencingPolicySubsystem, UAssetReferencingPolicySubsystem::StaticClass, TEXT("UAssetReferencingPolicySubsystem"), &Z_Registration_Info_UClass_UAssetReferencingPolicySubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetReferencingPolicySubsystem), 493731746U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_AssetReferenceRestrictions_Source_AssetReferenceRestrictions_Public_AssetReferencingPolicySubsystem_h_144702761(TEXT("/Script/AssetReferenceRestrictions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_AssetReferenceRestrictions_Source_AssetReferenceRestrictions_Public_AssetReferencingPolicySubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_AssetReferenceRestrictions_Source_AssetReferenceRestrictions_Public_AssetReferencingPolicySubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
