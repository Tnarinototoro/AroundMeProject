...
#undef ASSETREFERENCERESTRICTIONS_API
...
#define UE_MODULE_NAME "AssetReferenceRestrictions"
#define UE_PLUGIN_NAME "AssetReferenceRestrictions"
#define DATAVALIDATION_API DLLIMPORT
#define ASSETREFERENCERESTRICTIONS_API DLLEXPORT
