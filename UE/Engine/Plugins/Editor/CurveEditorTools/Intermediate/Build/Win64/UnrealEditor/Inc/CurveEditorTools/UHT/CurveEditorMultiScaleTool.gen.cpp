...
template<> CURVEEDITORTOOLS_API UScriptStruct* StaticStruct<FMultiScaleToolOptions>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_CurveEditorTools_Source_CurveEditorTools_Private_Tools_CurveEditorMultiScaleTool_h_Statics::EnumInfo[] = {
		{ EMultiScalePivotType_StaticEnum, TEXT("EMultiScalePivotType"), &Z_Registration_Info_UEnum_EMultiScalePivotType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 205641399U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_CurveEditorTools_Source_CurveEditorTools_Private_Tools_CurveEditorMultiScaleTool_h_Statics::ScriptStructInfo[] = {
		{ FMultiScaleToolOptions::StaticStruct, Z_Construct_UScriptStruct_FMultiScaleToolOptions_Statics::NewStructOps, TEXT("MultiScaleToolOptions"), &Z_Registration_Info_UScriptStruct_MultiScaleToolOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMultiScaleToolOptions), 3371615736U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_CurveEditorTools_Source_CurveEditorTools_Private_Tools_CurveEditorMultiScaleTool_h_2614956659(TEXT("/Script/CurveEditorTools"),
		nullptr, 0,
