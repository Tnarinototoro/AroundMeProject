...
template<> CURVEEDITORTOOLS_API UScriptStruct* StaticStruct<FCurveEditorRetimeAnchor>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCurveEditorRetimeAnchor_Statics::NewProp_bIsSelected = { "bIsSelected", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FCurveEditorRetimeAnchor), &Z_Construct_UScriptStruct_FCurveEditorRetimeAnchor_Statics::NewProp_bIsSelected_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveEditorRetimeAnchor_Statics::NewProp_bIsSelected_MetaData), Z_Construct_UScriptStruct_FCurveEditorRetimeAnchor_Statics::NewProp_bIsSelected_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_CurveEditorTools_Source_CurveEditorTools_Private_Tools_CurveEditorRetimeTool_h_Statics::ScriptStructInfo[] = {
		{ FCurveEditorRetimeAnchor::StaticStruct, Z_Construct_UScriptStruct_FCurveEditorRetimeAnchor_Statics::NewStructOps, TEXT("CurveEditorRetimeAnchor"), &Z_Registration_Info_UScriptStruct_CurveEditorRetimeAnchor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCurveEditorRetimeAnchor), 666026610U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_CurveEditorTools_Source_CurveEditorTools_Private_Tools_CurveEditorRetimeTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCurveEditorRetimeToolData, UCurveEditorRetimeToolData::StaticClass, TEXT("UCurveEditorRetimeToolData"), &Z_Registration_Info_UClass_UCurveEditorRetimeToolData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCurveEditorRetimeToolData), 3288853695U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_CurveEditorTools_Source_CurveEditorTools_Private_Tools_CurveEditorRetimeTool_h_2392725404(TEXT("/Script/CurveEditorTools"),
