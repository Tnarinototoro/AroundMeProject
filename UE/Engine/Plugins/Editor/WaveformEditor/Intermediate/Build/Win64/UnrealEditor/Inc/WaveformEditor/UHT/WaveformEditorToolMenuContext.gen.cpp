...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformEditorToolMenuContext_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaveformEditorToolMenuContext_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformEditorToolMenuContext_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaveformEditorToolMenuContext_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformEditor_Public_WaveformEditorToolMenuContext_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaveformEditorToolMenuContext, UWaveformEditorToolMenuContext::StaticClass, TEXT("UWaveformEditorToolMenuContext"), &Z_Registration_Info_UClass_UWaveformEditorToolMenuContext, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaveformEditorToolMenuContext), 2168294748U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformEditor_Public_WaveformEditorToolMenuContext_h_1873193705(TEXT("/Script/WaveformEditor"),
