...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_EffectChain = { "EffectChain", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationEffectChain, EffectChain), Z_Construct_UClass_USoundEffectSourcePresetChain_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_EffectChain_MetaData), Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_EffectChain_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_InlineEffects_Inner = { "InlineEffects", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_USoundEffectSourcePreset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_InlineEffects_Inner_MetaData), Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_InlineEffects_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_InlineEffects = { "InlineEffects", nullptr, (EPropertyFlags)0x0044008000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationEffectChain, InlineEffects), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_InlineEffects_MetaData), Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::NewProp_InlineEffects_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::ClassParams = {
		...
		0,
		0x019010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationEffectChain_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformTransformations_Public_WaveformTransformationEffectChain_h_2304404123(TEXT("/Script/WaveformTransformations"),
