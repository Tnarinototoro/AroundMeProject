...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartTime = { "StartTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationTrimFade, StartTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartTime_MetaData), Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartFadeTime = { "StartFadeTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationTrimFade, StartFadeTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartFadeTime_MetaData), Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartFadeTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartFadeCurve = { "StartFadeCurve", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationTrimFade, StartFadeCurve), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartFadeCurve_MetaData), Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_StartFadeCurve_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_EndFadeTime = { "EndFadeTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationTrimFade, EndFadeTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_EndFadeTime_MetaData), Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_EndFadeTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_EndFadeCurve = { "EndFadeCurve", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationTrimFade, EndFadeCurve), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_EndFadeCurve_MetaData), Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::NewProp_EndFadeCurve_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationTrimFade_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformTransformations_Public_WaveformTransformationTrimFade_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaveformTransformationTrimFade, UWaveformTransformationTrimFade::StaticClass, TEXT("UWaveformTransformationTrimFade"), &Z_Registration_Info_UClass_UWaveformTransformationTrimFade, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaveformTransformationTrimFade), 3689170951U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformTransformations_Public_WaveformTransformationTrimFade_h_292762178(TEXT("/Script/WaveformTransformations"),
