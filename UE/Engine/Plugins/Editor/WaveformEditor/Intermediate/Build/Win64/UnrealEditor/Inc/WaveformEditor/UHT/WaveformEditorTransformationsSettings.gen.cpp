...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::NewProp_LaunchTransformations_Inner = { "LaunchTransformations", nullptr, (EPropertyFlags)0x0004000000004000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UClass, Z_Construct_UClass_UWaveformTransformationBase_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::NewProp_LaunchTransformations = { "LaunchTransformations", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformEditorTransformationsSettings, LaunchTransformations), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::NewProp_LaunchTransformations_MetaData), Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::NewProp_LaunchTransformations_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::ClassParams = {
		...
		0,
		0x000000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformEditorTransformationsSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformEditor_Private_WaveformEditorTransformationsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaveformEditorTransformationsSettings, UWaveformEditorTransformationsSettings::StaticClass, TEXT("UWaveformEditorTransformationsSettings"), &Z_Registration_Info_UClass_UWaveformEditorTransformationsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaveformEditorTransformationsSettings), 1542415036U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformEditor_Private_WaveformEditorTransformationsSettings_h_506508220(TEXT("/Script/WaveformEditor"),
