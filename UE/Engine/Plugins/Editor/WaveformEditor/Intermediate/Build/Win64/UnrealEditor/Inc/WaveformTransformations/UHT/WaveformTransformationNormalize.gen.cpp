...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_WaveformTransformations_ENormalizationMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_WaveformTransformations_ENormalizationMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_WaveformTransformations_ENormalizationMode_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationNormalize_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationNormalize, Target), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_Target_MetaData), Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_Target_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_MaxGain = { "MaxGain", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationNormalize, MaxGain), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_MaxGain_MetaData), Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_MaxGain_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveformTransformationNormalize, Mode), Z_Construct_UEnum_WaveformTransformations_ENormalizationMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_Mode_MetaData), Z_Construct_UClass_UWaveformTransformationNormalize_Statics::NewProp_Mode_MetaData) }; // 4193282538
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaveformTransformationNormalize_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationNormalize_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaveformTransformationNormalize_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveformTransformationNormalize_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformTransformations_Public_WaveformTransformationNormalize_h_Statics::EnumInfo[] = {
		{ ENormalizationMode_StaticEnum, TEXT("ENormalizationMode"), &Z_Registration_Info_UEnum_ENormalizationMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4193282538U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformTransformations_Public_WaveformTransformationNormalize_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaveformTransformationNormalize, UWaveformTransformationNormalize::StaticClass, TEXT("UWaveformTransformationNormalize"), &Z_Registration_Info_UClass_UWaveformTransformationNormalize, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaveformTransformationNormalize), 3836042485U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WaveformEditor_Source_WaveformTransformations_Public_WaveformTransformationNormalize_h_3605258512(TEXT("/Script/WaveformTransformations"),
