...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_TransformProxy = { "TransformProxy", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotionTrailTool, TransformProxy), Z_Construct_UClass_UTransformProxy_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_TransformProxy_MetaData), Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_TransformProxy_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_TransformGizmo_MetaData[] = {
		{ "ModuleRelativePath", "Public/MotionTrailTool.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_TransformGizmo = { "TransformGizmo", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotionTrailTool, TransformGizmo), Z_Construct_UClass_UCombinedTransformGizmo_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_TransformGizmo_MetaData), Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_TransformGizmo_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_LeftClickBehavior = { "LeftClickBehavior", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotionTrailTool, LeftClickBehavior), Z_Construct_UClass_USingleClickInputBehavior_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_LeftClickBehavior_MetaData), Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_LeftClickBehavior_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_RightClickBehavior = { "RightClickBehavior", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotionTrailTool, RightClickBehavior), Z_Construct_UClass_USingleClickInputBehavior_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_RightClickBehavior_MetaData), Z_Construct_UClass_UMotionTrailTool_Statics::NewProp_RightClickBehavior_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMotionTrailTool_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMotionTrailTool_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBaseSequencerAnimTool_NoRegister, (int32)VTABLE_OFFSET(UMotionTrailTool, IBaseSequencerAnimTool), false },  // 745496209
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMotionTrailTool_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_SequencerAnimTools_Source_SequencerAnimTools_Public_MotionTrailTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMotionTrailToolBuilder, UMotionTrailToolBuilder::StaticClass, TEXT("UMotionTrailToolBuilder"), &Z_Registration_Info_UClass_UMotionTrailToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMotionTrailToolBuilder), 1573682695U) },
		{ Z_Construct_UClass_UMotionTrailTool, UMotionTrailTool::StaticClass, TEXT("UMotionTrailTool"), &Z_Registration_Info_UClass_UMotionTrailTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMotionTrailTool), 1768749472U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_SequencerAnimTools_Source_SequencerAnimTools_Public_MotionTrailTool_h_1184532797(TEXT("/Script/SequencerAnimTools"),
