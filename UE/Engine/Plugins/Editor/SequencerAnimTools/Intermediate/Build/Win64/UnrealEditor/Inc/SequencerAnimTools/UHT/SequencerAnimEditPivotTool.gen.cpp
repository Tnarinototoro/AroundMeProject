...
// End Cross Module References
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USequencerPivotTool_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_USequencerPivotTool_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBaseSequencerAnimTool_NoRegister, (int32)VTABLE_OFFSET(USequencerPivotTool, IBaseSequencerAnimTool), false },  // 745496209
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPivotTool_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_SequencerAnimTools_Source_SequencerAnimTools_Public_SequencerAnimEditPivotTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USequencerPivotToolBuilder, USequencerPivotToolBuilder::StaticClass, TEXT("USequencerPivotToolBuilder"), &Z_Registration_Info_UClass_USequencerPivotToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USequencerPivotToolBuilder), 3167836044U) },
		{ Z_Construct_UClass_USequencerPivotTool, USequencerPivotTool::StaticClass, TEXT("USequencerPivotTool"), &Z_Registration_Info_UClass_USequencerPivotTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USequencerPivotTool), 2622490940U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_SequencerAnimTools_Source_SequencerAnimTools_Public_SequencerAnimEditPivotTool_h_2826987631(TEXT("/Script/SequencerAnimTools"),
