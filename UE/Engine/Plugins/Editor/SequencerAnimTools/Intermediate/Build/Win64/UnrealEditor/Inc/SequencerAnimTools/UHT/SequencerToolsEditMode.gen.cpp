...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerToolsEditMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USequencerToolsEditMode_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerToolsEditMode_Statics::Class_MetaDataParams), Z_Construct_UClass_USequencerToolsEditMode_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_SequencerAnimTools_Source_SequencerAnimTools_Public_SequencerToolsEditMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USequencerToolsEditMode, USequencerToolsEditMode::StaticClass, TEXT("USequencerToolsEditMode"), &Z_Registration_Info_UClass_USequencerToolsEditMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USequencerToolsEditMode), 2368514331U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_SequencerAnimTools_Source_SequencerAnimTools_Public_SequencerToolsEditMode_h_1187805679(TEXT("/Script/SequencerAnimTools"),
