...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHLODBuilderMeshApproximateSettings_Statics::NewProp_MeshApproximationSettings = { "MeshApproximationSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHLODBuilderMeshApproximateSettings, MeshApproximationSettings), Z_Construct_UScriptStruct_FMeshApproximationSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHLODBuilderMeshApproximateSettings_Statics::NewProp_MeshApproximationSettings_MetaData), Z_Construct_UClass_UHLODBuilderMeshApproximateSettings_Statics::NewProp_MeshApproximationSettings_MetaData) }; // 1448366287
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshApproximate_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshApproximate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHLODBuilderMeshApproximateSettings, UHLODBuilderMeshApproximateSettings::StaticClass, TEXT("UHLODBuilderMeshApproximateSettings"), &Z_Registration_Info_UClass_UHLODBuilderMeshApproximateSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHLODBuilderMeshApproximateSettings), 2872344136U) },
		{ Z_Construct_UClass_UHLODBuilderMeshApproximate, UHLODBuilderMeshApproximate::StaticClass, TEXT("UHLODBuilderMeshApproximate"), &Z_Registration_Info_UClass_UHLODBuilderMeshApproximate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHLODBuilderMeshApproximate), 4267426303U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshApproximate_h_557295837(TEXT("/Script/WorldPartitionHLODUtilities"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshApproximate_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshApproximate_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
