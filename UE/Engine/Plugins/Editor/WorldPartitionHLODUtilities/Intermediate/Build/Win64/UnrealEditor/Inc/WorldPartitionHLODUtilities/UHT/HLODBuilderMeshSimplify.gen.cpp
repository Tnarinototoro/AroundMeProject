...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHLODBuilderMeshSimplifySettings_Statics::NewProp_MeshSimplifySettings = { "MeshSimplifySettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHLODBuilderMeshSimplifySettings, MeshSimplifySettings), Z_Construct_UScriptStruct_FMeshProxySettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHLODBuilderMeshSimplifySettings_Statics::NewProp_MeshSimplifySettings_MetaData), Z_Construct_UClass_UHLODBuilderMeshSimplifySettings_Statics::NewProp_MeshSimplifySettings_MetaData) }; // 1737584759
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshSimplify_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshSimplify_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHLODBuilderMeshSimplifySettings, UHLODBuilderMeshSimplifySettings::StaticClass, TEXT("UHLODBuilderMeshSimplifySettings"), &Z_Registration_Info_UClass_UHLODBuilderMeshSimplifySettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHLODBuilderMeshSimplifySettings), 4252151956U) },
		{ Z_Construct_UClass_UHLODBuilderMeshSimplify, UHLODBuilderMeshSimplify::StaticClass, TEXT("UHLODBuilderMeshSimplify"), &Z_Registration_Info_UClass_UHLODBuilderMeshSimplify, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHLODBuilderMeshSimplify), 3364906877U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshSimplify_h_1846502123(TEXT("/Script/WorldPartitionHLODUtilities"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshSimplify_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Builders_HLODBuilderMeshSimplify_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
