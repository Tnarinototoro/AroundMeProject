...
#include "../Modifiers/HLODModifierMeshDestruction.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UWorldPartitionHLODModifierMeshDestruction);
	UClass* Z_Construct_UClass_UWorldPartitionHLODModifierMeshDestruction_NoRegister()
	{
		return UWorldPartitionHLODModifierMeshDestruction::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWorldPartitionHLODModifierMeshDestruction_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UWorldPartitionHLODModifierMeshDestruction_Statics::StaticCppClassTypeInfo = {
	...
	template<> WORLDPARTITIONHLODUTILITIES_API UClass* StaticClass<UWorldPartitionHLODModifierMeshDestruction>()
	{
		return UWorldPartitionHLODModifierMeshDestruction::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UWorldPartitionHLODModifierMeshDestruction);
	UWorldPartitionHLODModifierMeshDestruction::~UWorldPartitionHLODModifierMeshDestruction() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Modifiers_HLODModifierMeshDestruction_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Modifiers_HLODModifierMeshDestruction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWorldPartitionHLODModifierMeshDestruction, UWorldPartitionHLODModifierMeshDestruction::StaticClass, TEXT("UWorldPartitionHLODModifierMeshDestruction"), &Z_Registration_Info_UClass_UWorldPartitionHLODModifierMeshDestruction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWorldPartitionHLODModifierMeshDestruction), 517056411U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Modifiers_HLODModifierMeshDestruction_h_1530143713(TEXT("/Script/WorldPartitionHLODUtilities"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Modifiers_HLODModifierMeshDestruction_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_WorldPartitionHLODUtilities_Source_Public_WorldPartition_HLOD_Modifiers_HLODModifierMeshDestruction_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
