...
// Cross Module References
	...
	DATAVALIDATION_API UScriptStruct* Z_Construct_UScriptStruct_FValidateAssetsDetails();
...
// End Cross Module References
	static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_ValidateAssetsDetails;
class UScriptStruct* FValidateAssetsDetails::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_ValidateAssetsDetails.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_ValidateAssetsDetails.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FValidateAssetsDetails, (UObject*)Z_Construct_UPackage__Script_DataValidation(), TEXT("ValidateAssetsDetails"));
	}
	return Z_Registration_Info_UScriptStruct_ValidateAssetsDetails.OuterSingleton;
}
template<> DATAVALIDATION_API UScriptStruct* StaticStruct<FValidateAssetsDetails>()
{
	return FValidateAssetsDetails::StaticStruct();
}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FValidateAssetsDetails_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/EditorValidatorSubsystem.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FValidateAssetsDetails_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FValidateAssetsDetails>();
	}
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FValidateAssetsDetails_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_DataValidation,
		nullptr,
		&NewStructOps,
		"ValidateAssetsDetails",
		nullptr,
		0,
		sizeof(FValidateAssetsDetails),
		alignof(FValidateAssetsDetails),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsDetails_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FValidateAssetsDetails_Statics::Struct_MetaDataParams)
	};
	UScriptStruct* Z_Construct_UScriptStruct_FValidateAssetsDetails()
	{
		if (!Z_Registration_Info_UScriptStruct_ValidateAssetsDetails.InnerSingleton)
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_ValidateAssetsDetails.InnerSingleton, Z_Construct_UScriptStruct_FValidateAssetsDetails_Statics::ReturnStructParams);
		}
		return Z_Registration_Info_UScriptStruct_ValidateAssetsDetails.InnerSingleton;
	}
...
template<> DATAVALIDATION_API UScriptStruct* StaticStruct<FValidateAssetsResults>()
{
...
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_NumChecked;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_NumValid_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_NumValid;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_NumInvalid_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_NumInvalid;
#if WITH_METADATA
...
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_NumWarnings;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_NumUnableToValidate_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_NumUnableToValidate;
		static const UECodeGen_Private::FStructPropertyParams NewProp_AssetsDetails_ValueProp;
		static const UECodeGen_Private::FStrPropertyParams NewProp_AssetsDetails_Key_KeyProp;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_AssetsDetails_MetaData[];
#endif
		static const UECodeGen_Private::FMapPropertyParams NewProp_AssetsDetails;
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumChecked = { "NumChecked", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsResults, NumChecked), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumChecked_MetaData), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumChecked_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumValid = { "NumValid", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsResults, NumValid), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumValid_MetaData), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumValid_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumInvalid = { "NumInvalid", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsResults, NumInvalid), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumInvalid_MetaData), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumInvalid_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumSkipped = { "NumSkipped", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsResults, NumSkipped), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumSkipped_MetaData), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumSkipped_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumWarnings = { "NumWarnings", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsResults, NumWarnings), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumWarnings_MetaData), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumWarnings_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumUnableToValidate = { "NumUnableToValidate", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsResults, NumUnableToValidate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumUnableToValidate_MetaData), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_NumUnableToValidate_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails_ValueProp = { "AssetsDetails", nullptr, (EPropertyFlags)0x0000000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FValidateAssetsDetails, METADATA_PARAMS(0, nullptr) }; // 2465671177
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails_Key_KeyProp = { "AssetsDetails_Key", nullptr, (EPropertyFlags)0x0000000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails_MetaData[] = {
		{ "Category", "Validation" },
		{ "Comment", "/** \n\x09 * Per asset details\n\x09 * Indexed by object path\n\x09 * Only returned if FValidateAssetsSettings::bCollectPerAssetDetails is true.\n\x09 */" },
		{ "ModuleRelativePath", "Public/EditorValidatorSubsystem.h" },
		{ "ToolTip", "Per asset details\nIndexed by object path\nOnly returned if FValidateAssetsSettings::bCollectPerAssetDetails is true." },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails = { "AssetsDetails", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsResults, AssetsDetails), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails_MetaData), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails_MetaData) }; // 2465671177
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails_ValueProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails_Key_KeyProp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewProp_AssetsDetails,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::PropPointers) < 2048);
...
template<> DATAVALIDATION_API UScriptStruct* StaticStruct<FValidateAssetsSettings>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bCollectPerAssetDetails_MetaData[];
#endif
		static void NewProp_bCollectPerAssetDetails_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bCollectPerAssetDetails;
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bSkipExcludedDirectories = { "bSkipExcludedDirectories", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FValidateAssetsSettings), &Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bSkipExcludedDirectories_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bSkipExcludedDirectories_MetaData), Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bSkipExcludedDirectories_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bShowIfNoFailures = { "bShowIfNoFailures", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FValidateAssetsSettings), &Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bShowIfNoFailures_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bShowIfNoFailures_MetaData), Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bShowIfNoFailures_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bCollectPerAssetDetails_MetaData[] = {
		{ "Category", "Validation" },
		{ "Comment", "/** If true, will add an FValidateAssetsDetails for each asset to the results */" },
		{ "ModuleRelativePath", "Public/EditorValidatorSubsystem.h" },
		{ "ToolTip", "If true, will add an FValidateAssetsDetails for each asset to the results" },
	};
#endif
	void Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bCollectPerAssetDetails_SetBit(void* Obj)
	{
		((FValidateAssetsSettings*)Obj)->bCollectPerAssetDetails = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bCollectPerAssetDetails = { "bCollectPerAssetDetails", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FValidateAssetsSettings), &Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bCollectPerAssetDetails_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bCollectPerAssetDetails_MetaData), Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bCollectPerAssetDetails_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_ValidationUsecase = { "ValidationUsecase", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FValidateAssetsSettings, ValidationUsecase), Z_Construct_UEnum_DataValidation_EDataValidationUsecase, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_ValidationUsecase_MetaData), Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_ValidationUsecase_MetaData) }; // 4129375106
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewProp_bCollectPerAssetDetails,
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::NewProp_InValidator = { "InValidator", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventAddValidator_Parms, InValidator), Z_Construct_UClass_UEditorValidatorBase_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEditorValidatorSubsystem, nullptr, "AddValidator", nullptr, nullptr, Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::PropPointers), sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::EditorValidatorSubsystem_eventAddValidator_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator_Statics::EditorValidatorSubsystem_eventAddValidator_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_AssetData = { "AssetData", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsAssetValid_Parms, AssetData), Z_Construct_UScriptStruct_FAssetData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_AssetData_MetaData), Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_AssetData_MetaData) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_ValidationErrors_Inner = { "ValidationErrors", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_ValidationErrors = { "ValidationErrors", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsAssetValid_Parms, ValidationErrors), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_ValidationWarnings_Inner = { "ValidationWarnings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_ValidationWarnings = { "ValidationWarnings", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsAssetValid_Parms, ValidationWarnings), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_InValidationUsecase_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_InValidationUsecase = { "InValidationUsecase", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsAssetValid_Parms, InValidationUsecase), Z_Construct_UEnum_DataValidation_EDataValidationUsecase, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_InValidationUsecase_MetaData), Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_InValidationUsecase_MetaData) }; // 4129375106
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsAssetValid_Parms, ReturnValue), Z_Construct_UEnum_CoreUObject_EDataValidationResult, METADATA_PARAMS(0, nullptr) }; // 3163830312
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEditorValidatorSubsystem, nullptr, "IsAssetValid", nullptr, nullptr, Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::PropPointers), sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::EditorValidatorSubsystem_eventIsAssetValid_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54C20400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid_Statics::EditorValidatorSubsystem_eventIsAssetValid_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_InObject = { "InObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsObjectValid_Parms, InObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_ValidationErrors_Inner = { "ValidationErrors", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_ValidationErrors = { "ValidationErrors", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsObjectValid_Parms, ValidationErrors), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_ValidationWarnings_Inner = { "ValidationWarnings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_ValidationWarnings = { "ValidationWarnings", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsObjectValid_Parms, ValidationWarnings), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_InValidationUsecase = { "InValidationUsecase", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsObjectValid_Parms, InValidationUsecase), Z_Construct_UEnum_DataValidation_EDataValidationUsecase, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_InValidationUsecase_MetaData), Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_InValidationUsecase_MetaData) }; // 4129375106
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventIsObjectValid_Parms, ReturnValue), Z_Construct_UEnum_CoreUObject_EDataValidationResult, METADATA_PARAMS(0, nullptr) }; // 3163830312
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEditorValidatorSubsystem, nullptr, "IsObjectValid", nullptr, nullptr, Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::PropPointers), sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::EditorValidatorSubsystem_eventIsObjectValid_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid_Statics::EditorValidatorSubsystem_eventIsObjectValid_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::NewProp_AssetDataList = { "AssetDataList", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventValidateAssets_Parms, AssetDataList), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::NewProp_bSkipExcludedDirectories = { "bSkipExcludedDirectories", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(EditorValidatorSubsystem_eventValidateAssets_Parms), &Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::NewProp_bSkipExcludedDirectories_SetBit, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::NewProp_bShowIfNoFailures = { "bShowIfNoFailures", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(EditorValidatorSubsystem_eventValidateAssets_Parms), &Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::NewProp_bShowIfNoFailures_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventValidateAssets_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEditorValidatorSubsystem, nullptr, "ValidateAssets", nullptr, nullptr, Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::PropPointers), sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::EditorValidatorSubsystem_eventValidateAssets_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets_Statics::EditorValidatorSubsystem_eventValidateAssets_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_AssetDataList = { "AssetDataList", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventValidateAssetsWithSettings_Parms, AssetDataList), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_AssetDataList_MetaData), Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_AssetDataList_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventValidateAssetsWithSettings_Parms, InSettings), Z_Construct_UScriptStruct_FValidateAssetsSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_InSettings_MetaData), Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_InSettings_MetaData) }; // 2420366167
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_OutResults = { "OutResults", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventValidateAssetsWithSettings_Parms, OutResults), Z_Construct_UScriptStruct_FValidateAssetsResults, METADATA_PARAMS(0, nullptr) }; // 2088732655
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EditorValidatorSubsystem_eventValidateAssetsWithSettings_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEditorValidatorSubsystem, nullptr, "ValidateAssetsWithSettings", nullptr, nullptr, Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::EditorValidatorSubsystem_eventValidateAssetsWithSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings_Statics::EditorValidatorSubsystem_eventValidateAssetsWithSettings_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UEditorValidatorSubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UEditorValidatorSubsystem_AddValidator, "AddValidator" }, // 1722110586
		{ &Z_Construct_UFunction_UEditorValidatorSubsystem_IsAssetValid, "IsAssetValid" }, // 3095019798
		{ &Z_Construct_UFunction_UEditorValidatorSubsystem_IsObjectValid, "IsObjectValid" }, // 406380578
		{ &Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssets, "ValidateAssets" }, // 1093346639
		{ &Z_Construct_UFunction_UEditorValidatorSubsystem_ValidateAssetsWithSettings, "ValidateAssetsWithSettings" }, // 1466302168
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_ExcludedDirectories_Inner = { "ExcludedDirectories", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_ExcludedDirectories = { "ExcludedDirectories", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEditorValidatorSubsystem, ExcludedDirectories), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_ExcludedDirectories_MetaData), Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_ExcludedDirectories_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateOnSave = { "bValidateOnSave", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UEditorValidatorSubsystem), &Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateOnSave_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateOnSave_MetaData), Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateOnSave_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_Validators_ValueProp = { "Validators", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UClass_UEditorValidatorBase_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_Validators_Key_KeyProp = { "Validators_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_Validators = { "Validators", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEditorValidatorSubsystem, Validators), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_Validators_MetaData), Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_Validators_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateAssetsWhileSavingForCook = { "bValidateAssetsWhileSavingForCook", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UEditorValidatorSubsystem), &Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateAssetsWhileSavingForCook_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateAssetsWhileSavingForCook_MetaData), Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bValidateAssetsWhileSavingForCook_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bAllowBlueprintValidators = { "bAllowBlueprintValidators", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UEditorValidatorSubsystem), &Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bAllowBlueprintValidators_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bAllowBlueprintValidators_MetaData), Z_Construct_UClass_UEditorValidatorSubsystem_Statics::NewProp_bAllowBlueprintValidators_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEditorValidatorSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UEditorValidatorSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorValidatorSubsystem_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_DataValidation_Source_DataValidation_Public_EditorValidatorSubsystem_h_Statics::ScriptStructInfo[] = {
		{ FValidateAssetsDetails::StaticStruct, Z_Construct_UScriptStruct_FValidateAssetsDetails_Statics::NewStructOps, TEXT("ValidateAssetsDetails"), &Z_Registration_Info_UScriptStruct_ValidateAssetsDetails, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FValidateAssetsDetails), 2465671177U) },
		{ FValidateAssetsResults::StaticStruct, Z_Construct_UScriptStruct_FValidateAssetsResults_Statics::NewStructOps, TEXT("ValidateAssetsResults"), &Z_Registration_Info_UScriptStruct_ValidateAssetsResults, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FValidateAssetsResults), 2088732655U) },
		{ FValidateAssetsSettings::StaticStruct, Z_Construct_UScriptStruct_FValidateAssetsSettings_Statics::NewStructOps, TEXT("ValidateAssetsSettings"), &Z_Registration_Info_UScriptStruct_ValidateAssetsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FValidateAssetsSettings), 2420366167U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_DataValidation_Source_DataValidation_Public_EditorValidatorSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataValidationSettings, UDataValidationSettings::StaticClass, TEXT("UDataValidationSettings"), &Z_Registration_Info_UClass_UDataValidationSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataValidationSettings), 2691831277U) },
		{ Z_Construct_UClass_UEditorValidatorSubsystem, UEditorValidatorSubsystem::StaticClass, TEXT("UEditorValidatorSubsystem"), &Z_Registration_Info_UClass_UEditorValidatorSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEditorValidatorSubsystem), 2617010111U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_DataValidation_Source_DataValidation_Public_EditorValidatorSubsystem_h_408929790(TEXT("/Script/DataValidation"),
