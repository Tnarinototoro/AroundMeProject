...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UStylusInputSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UStylusInputSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStylusInputSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UStylusInputSubsystem_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_StylusInput_Source_StylusInput_Public_IStylusInputModule_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStylusInputSubsystem, UStylusInputSubsystem::StaticClass, TEXT("UStylusInputSubsystem"), &Z_Registration_Info_UClass_UStylusInputSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStylusInputSubsystem), 2607383983U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_StylusInput_Source_StylusInput_Public_IStylusInputModule_h_456485095(TEXT("/Script/StylusInput"),
