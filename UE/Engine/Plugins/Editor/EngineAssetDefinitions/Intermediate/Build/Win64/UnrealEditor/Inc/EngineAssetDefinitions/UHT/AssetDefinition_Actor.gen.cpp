...
#include "../Private/AssetDefinition_Actor.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_Actor);
	UClass* Z_Construct_UClass_UAssetDefinition_Actor_NoRegister()
	{
		return UAssetDefinition_Actor::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_Actor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AssetDefinition_Actor.h" },
		{ "ModuleRelativePath", "Private/AssetDefinition_Actor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_Actor_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_Actor>()
	{
		return UAssetDefinition_Actor::StaticClass();
	}
	UAssetDefinition_Actor::UAssetDefinition_Actor() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_Actor);
	UAssetDefinition_Actor::~UAssetDefinition_Actor() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Actor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Actor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_Actor, UAssetDefinition_Actor::StaticClass, TEXT("UAssetDefinition_Actor"), &Z_Registration_Info_UClass_UAssetDefinition_Actor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_Actor), 2542116790U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Actor_h_3590528910(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Actor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Actor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
