...
#include "../Private/AssetDefinition_HapticFeedbackEffectCurve.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_HapticFeedbackEffectCurve);
	UClass* Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectCurve_NoRegister()
	{
		return UAssetDefinition_HapticFeedbackEffectCurve::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectCurve_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectCurve_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_HapticFeedbackEffectCurve>()
	{
		return UAssetDefinition_HapticFeedbackEffectCurve::StaticClass();
	}
	UAssetDefinition_HapticFeedbackEffectCurve::UAssetDefinition_HapticFeedbackEffectCurve() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_HapticFeedbackEffectCurve);
	UAssetDefinition_HapticFeedbackEffectCurve::~UAssetDefinition_HapticFeedbackEffectCurve() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectCurve_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectCurve_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectCurve, UAssetDefinition_HapticFeedbackEffectCurve::StaticClass, TEXT("UAssetDefinition_HapticFeedbackEffectCurve"), &Z_Registration_Info_UClass_UAssetDefinition_HapticFeedbackEffectCurve, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_HapticFeedbackEffectCurve), 2508036469U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectCurve_h_195123267(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectCurve_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectCurve_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
