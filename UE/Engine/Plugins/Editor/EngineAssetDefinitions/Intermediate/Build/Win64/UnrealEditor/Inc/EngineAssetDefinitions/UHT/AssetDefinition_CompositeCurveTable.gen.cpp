...
#include "../Private/Table/AssetDefinition_CompositeCurveTable.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_CompositeCurveTable);
	UClass* Z_Construct_UClass_UAssetDefinition_CompositeCurveTable_NoRegister()
	{
		return UAssetDefinition_CompositeCurveTable::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_CompositeCurveTable_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_CompositeCurveTable_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_CompositeCurveTable>()
	{
		return UAssetDefinition_CompositeCurveTable::StaticClass();
	}
	UAssetDefinition_CompositeCurveTable::UAssetDefinition_CompositeCurveTable() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_CompositeCurveTable);
	UAssetDefinition_CompositeCurveTable::~UAssetDefinition_CompositeCurveTable() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Table_AssetDefinition_CompositeCurveTable_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Table_AssetDefinition_CompositeCurveTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_CompositeCurveTable, UAssetDefinition_CompositeCurveTable::StaticClass, TEXT("UAssetDefinition_CompositeCurveTable"), &Z_Registration_Info_UClass_UAssetDefinition_CompositeCurveTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_CompositeCurveTable), 2624809919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Table_AssetDefinition_CompositeCurveTable_h_660942213(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Table_AssetDefinition_CompositeCurveTable_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Table_AssetDefinition_CompositeCurveTable_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
