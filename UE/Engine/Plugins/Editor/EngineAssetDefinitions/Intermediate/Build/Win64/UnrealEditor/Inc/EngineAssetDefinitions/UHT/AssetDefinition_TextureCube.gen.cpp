...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureCube_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_TextureCube_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureCube_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_TextureCube_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureCube_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_TextureCube, UAssetDefinition_TextureCube::StaticClass, TEXT("UAssetDefinition_TextureCube"), &Z_Registration_Info_UClass_UAssetDefinition_TextureCube, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_TextureCube), 2244455339U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureCube_h_3766441539(TEXT("/Script/EngineAssetDefinitions"),
