...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_UserDefinedEnum_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_UserDefinedEnum_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_UserDefinedEnum_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_UserDefinedEnum_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_UserDefinedEnum_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_UserDefinedEnum, UAssetDefinition_UserDefinedEnum::StaticClass, TEXT("UAssetDefinition_UserDefinedEnum"), &Z_Registration_Info_UClass_UAssetDefinition_UserDefinedEnum, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_UserDefinedEnum), 3921364127U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_UserDefinedEnum_h_3750137823(TEXT("/Script/EngineAssetDefinitions"),
