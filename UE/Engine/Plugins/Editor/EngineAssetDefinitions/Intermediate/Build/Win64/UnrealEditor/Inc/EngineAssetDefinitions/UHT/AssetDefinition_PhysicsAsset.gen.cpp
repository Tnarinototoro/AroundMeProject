...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_PhysicsAsset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_PhysicsAsset_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_PhysicsAsset_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_PhysicsAsset_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_PhysicsAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_PhysicsAsset, UAssetDefinition_PhysicsAsset::StaticClass, TEXT("UAssetDefinition_PhysicsAsset"), &Z_Registration_Info_UClass_UAssetDefinition_PhysicsAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_PhysicsAsset), 3406560140U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_PhysicsAsset_h_1275112712(TEXT("/Script/EngineAssetDefinitions"),
