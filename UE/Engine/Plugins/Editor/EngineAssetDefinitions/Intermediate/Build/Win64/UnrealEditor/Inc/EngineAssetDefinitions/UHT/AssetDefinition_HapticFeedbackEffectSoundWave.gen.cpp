...
#include "../Private/AssetDefinition_HapticFeedbackEffectSoundWave.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_HapticFeedbackEffectSoundWave);
	UClass* Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectSoundWave_NoRegister()
	{
		return UAssetDefinition_HapticFeedbackEffectSoundWave::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectSoundWave_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectSoundWave_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_HapticFeedbackEffectSoundWave>()
	{
		return UAssetDefinition_HapticFeedbackEffectSoundWave::StaticClass();
	}
	UAssetDefinition_HapticFeedbackEffectSoundWave::UAssetDefinition_HapticFeedbackEffectSoundWave() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_HapticFeedbackEffectSoundWave);
	UAssetDefinition_HapticFeedbackEffectSoundWave::~UAssetDefinition_HapticFeedbackEffectSoundWave() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectSoundWave_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectSoundWave_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_HapticFeedbackEffectSoundWave, UAssetDefinition_HapticFeedbackEffectSoundWave::StaticClass, TEXT("UAssetDefinition_HapticFeedbackEffectSoundWave"), &Z_Registration_Info_UClass_UAssetDefinition_HapticFeedbackEffectSoundWave, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_HapticFeedbackEffectSoundWave), 1434839695U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectSoundWave_h_1694832859(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectSoundWave_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_HapticFeedbackEffectSoundWave_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
