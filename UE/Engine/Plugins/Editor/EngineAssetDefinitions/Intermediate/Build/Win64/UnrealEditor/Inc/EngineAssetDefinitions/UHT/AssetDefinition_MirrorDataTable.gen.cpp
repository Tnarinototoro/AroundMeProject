...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_MirrorDataTable_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_MirrorDataTable_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_MirrorDataTable_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_MirrorDataTable_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Table_AssetDefinition_MirrorDataTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_MirrorDataTable, UAssetDefinition_MirrorDataTable::StaticClass, TEXT("UAssetDefinition_MirrorDataTable"), &Z_Registration_Info_UClass_UAssetDefinition_MirrorDataTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_MirrorDataTable), 1254810545U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Table_AssetDefinition_MirrorDataTable_h_1166641826(TEXT("/Script/EngineAssetDefinitions"),
