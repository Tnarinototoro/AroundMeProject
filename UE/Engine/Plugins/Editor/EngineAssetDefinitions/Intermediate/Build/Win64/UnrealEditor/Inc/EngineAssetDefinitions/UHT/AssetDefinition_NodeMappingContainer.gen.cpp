...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_NodeMappingContainer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_NodeMappingContainer_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_NodeMappingContainer_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_NodeMappingContainer_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_NodeMappingContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_NodeMappingContainer, UAssetDefinition_NodeMappingContainer::StaticClass, TEXT("UAssetDefinition_NodeMappingContainer"), &Z_Registration_Info_UClass_UAssetDefinition_NodeMappingContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_NodeMappingContainer), 1350251340U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_NodeMappingContainer_h_2567995429(TEXT("/Script/EngineAssetDefinitions"),
