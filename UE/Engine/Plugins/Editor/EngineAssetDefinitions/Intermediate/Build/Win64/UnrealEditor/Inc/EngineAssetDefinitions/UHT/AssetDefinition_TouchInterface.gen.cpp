...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TouchInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_TouchInterface_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TouchInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_TouchInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TouchInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_TouchInterface, UAssetDefinition_TouchInterface::StaticClass, TEXT("UAssetDefinition_TouchInterface"), &Z_Registration_Info_UClass_UAssetDefinition_TouchInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_TouchInterface), 1476646180U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TouchInterface_h_2182601280(TEXT("/Script/EngineAssetDefinitions"),
