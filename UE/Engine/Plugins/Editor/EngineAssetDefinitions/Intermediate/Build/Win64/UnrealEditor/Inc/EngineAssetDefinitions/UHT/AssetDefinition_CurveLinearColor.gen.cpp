...
#include "../Private/AssetDefinition_CurveLinearColor.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_CurveLinearColor);
	UClass* Z_Construct_UClass_UAssetDefinition_CurveLinearColor_NoRegister()
	{
		return UAssetDefinition_CurveLinearColor::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_CurveLinearColor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AssetDefinition_CurveLinearColor.h" },
		{ "ModuleRelativePath", "Private/AssetDefinition_CurveLinearColor.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_CurveLinearColor_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_CurveLinearColor>()
	{
		return UAssetDefinition_CurveLinearColor::StaticClass();
	}
	UAssetDefinition_CurveLinearColor::UAssetDefinition_CurveLinearColor() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_CurveLinearColor);
	UAssetDefinition_CurveLinearColor::~UAssetDefinition_CurveLinearColor() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_CurveLinearColor, UAssetDefinition_CurveLinearColor::StaticClass, TEXT("UAssetDefinition_CurveLinearColor"), &Z_Registration_Info_UClass_UAssetDefinition_CurveLinearColor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_CurveLinearColor), 3325428145U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColor_h_3696362614(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
