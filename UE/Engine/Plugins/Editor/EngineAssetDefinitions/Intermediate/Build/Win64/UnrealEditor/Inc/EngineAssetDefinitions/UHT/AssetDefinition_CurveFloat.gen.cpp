...
#include "../Private/AssetDefinition_CurveFloat.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_CurveFloat);
	UClass* Z_Construct_UClass_UAssetDefinition_CurveFloat_NoRegister()
	{
		return UAssetDefinition_CurveFloat::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_CurveFloat_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AssetDefinition_CurveFloat.h" },
		{ "ModuleRelativePath", "Private/AssetDefinition_CurveFloat.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_CurveFloat_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_CurveFloat>()
	{
		return UAssetDefinition_CurveFloat::StaticClass();
	}
	UAssetDefinition_CurveFloat::UAssetDefinition_CurveFloat() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_CurveFloat);
	UAssetDefinition_CurveFloat::~UAssetDefinition_CurveFloat() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveFloat_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveFloat_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_CurveFloat, UAssetDefinition_CurveFloat::StaticClass, TEXT("UAssetDefinition_CurveFloat"), &Z_Registration_Info_UClass_UAssetDefinition_CurveFloat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_CurveFloat), 587326904U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveFloat_h_1023807111(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveFloat_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveFloat_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
