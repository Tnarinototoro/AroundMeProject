...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_ObjectLibrary_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_ObjectLibrary_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_ObjectLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_ObjectLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_ObjectLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_ObjectLibrary, UAssetDefinition_ObjectLibrary::StaticClass, TEXT("UAssetDefinition_ObjectLibrary"), &Z_Registration_Info_UClass_UAssetDefinition_ObjectLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_ObjectLibrary), 3997713768U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_ObjectLibrary_h_2868302413(TEXT("/Script/EngineAssetDefinitions"),
