...
#include "../Private/AssetDefinition_LandscapeGrassType.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_LandscapeGrassType);
	UClass* Z_Construct_UClass_UAssetDefinition_LandscapeGrassType_NoRegister()
	{
		return UAssetDefinition_LandscapeGrassType::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_LandscapeGrassType_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AssetDefinition_LandscapeGrassType.h" },
		{ "ModuleRelativePath", "Private/AssetDefinition_LandscapeGrassType.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_LandscapeGrassType_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_LandscapeGrassType>()
	{
		return UAssetDefinition_LandscapeGrassType::StaticClass();
	}
	UAssetDefinition_LandscapeGrassType::UAssetDefinition_LandscapeGrassType() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_LandscapeGrassType);
	UAssetDefinition_LandscapeGrassType::~UAssetDefinition_LandscapeGrassType() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_LandscapeGrassType_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_LandscapeGrassType_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_LandscapeGrassType, UAssetDefinition_LandscapeGrassType::StaticClass, TEXT("UAssetDefinition_LandscapeGrassType"), &Z_Registration_Info_UClass_UAssetDefinition_LandscapeGrassType, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_LandscapeGrassType), 321166922U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_LandscapeGrassType_h_3675111418(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_LandscapeGrassType_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_LandscapeGrassType_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
