...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Skeleton_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_Skeleton_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Skeleton_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_Skeleton_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_Skeleton_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_Skeleton, UAssetDefinition_Skeleton::StaticClass, TEXT("UAssetDefinition_Skeleton"), &Z_Registration_Info_UClass_UAssetDefinition_Skeleton, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_Skeleton), 3300779241U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_Skeleton_h_741829924(TEXT("/Script/EngineAssetDefinitions"),
