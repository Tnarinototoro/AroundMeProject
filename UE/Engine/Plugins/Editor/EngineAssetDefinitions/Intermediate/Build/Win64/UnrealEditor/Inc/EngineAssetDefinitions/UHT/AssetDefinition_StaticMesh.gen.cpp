...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_StaticMesh_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_StaticMesh_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_StaticMesh_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_StaticMesh_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_StaticMesh_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_StaticMesh, UAssetDefinition_StaticMesh::StaticClass, TEXT("UAssetDefinition_StaticMesh"), &Z_Registration_Info_UClass_UAssetDefinition_StaticMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_StaticMesh), 2758860857U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_StaticMesh_h_1836414754(TEXT("/Script/EngineAssetDefinitions"),
