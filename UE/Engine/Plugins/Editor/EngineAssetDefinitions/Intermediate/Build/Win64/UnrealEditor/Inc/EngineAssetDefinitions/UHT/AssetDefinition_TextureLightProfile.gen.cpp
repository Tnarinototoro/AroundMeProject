...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureLightProfile_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_TextureLightProfile_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureLightProfile_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_TextureLightProfile_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureLightProfile_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_TextureLightProfile, UAssetDefinition_TextureLightProfile::StaticClass, TEXT("UAssetDefinition_TextureLightProfile"), &Z_Registration_Info_UClass_UAssetDefinition_TextureLightProfile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_TextureLightProfile), 608455685U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureLightProfile_h_1537090246(TEXT("/Script/EngineAssetDefinitions"),
