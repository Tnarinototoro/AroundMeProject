...
#include "../Private/Animation/AssetDefinition_BlendSpace1D.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_BlendSpace1D);
	UClass* Z_Construct_UClass_UAssetDefinition_BlendSpace1D_NoRegister()
	{
		return UAssetDefinition_BlendSpace1D::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_BlendSpace1D_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Animation/AssetDefinition_BlendSpace1D.h" },
		{ "ModuleRelativePath", "Private/Animation/AssetDefinition_BlendSpace1D.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_BlendSpace1D_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_BlendSpace1D>()
	{
		return UAssetDefinition_BlendSpace1D::StaticClass();
	}
	UAssetDefinition_BlendSpace1D::UAssetDefinition_BlendSpace1D() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_BlendSpace1D);
	UAssetDefinition_BlendSpace1D::~UAssetDefinition_BlendSpace1D() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace1D_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace1D_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_BlendSpace1D, UAssetDefinition_BlendSpace1D::StaticClass, TEXT("UAssetDefinition_BlendSpace1D"), &Z_Registration_Info_UClass_UAssetDefinition_BlendSpace1D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_BlendSpace1D), 832539967U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace1D_h_88529284(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace1D_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace1D_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
