...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_VectorFieldStatic_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_VectorFieldStatic_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_VectorFieldStatic_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_VectorFieldStatic_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_VectorFieldStatic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_VectorFieldStatic, UAssetDefinition_VectorFieldStatic::StaticClass, TEXT("UAssetDefinition_VectorFieldStatic"), &Z_Registration_Info_UClass_UAssetDefinition_VectorFieldStatic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_VectorFieldStatic), 452283697U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_VectorFieldStatic_h_274673161(TEXT("/Script/EngineAssetDefinitions"),
