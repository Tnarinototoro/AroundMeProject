...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureCubeArray_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_TextureCubeArray_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureCubeArray_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_TextureCubeArray_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureCubeArray_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_TextureCubeArray, UAssetDefinition_TextureCubeArray::StaticClass, TEXT("UAssetDefinition_TextureCubeArray"), &Z_Registration_Info_UClass_UAssetDefinition_TextureCubeArray, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_TextureCubeArray), 3725128363U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureCubeArray_h_2847850088(TEXT("/Script/EngineAssetDefinitions"),
