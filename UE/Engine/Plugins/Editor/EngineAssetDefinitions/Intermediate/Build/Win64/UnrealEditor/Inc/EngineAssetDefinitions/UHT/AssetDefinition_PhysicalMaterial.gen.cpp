...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_PhysicalMaterial_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_PhysicalMaterial_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_PhysicalMaterial_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_PhysicalMaterial_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_PhysicalMaterial_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_PhysicalMaterial, UAssetDefinition_PhysicalMaterial::StaticClass, TEXT("UAssetDefinition_PhysicalMaterial"), &Z_Registration_Info_UClass_UAssetDefinition_PhysicalMaterial, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_PhysicalMaterial), 822214745U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_PhysicalMaterial_h_807680917(TEXT("/Script/EngineAssetDefinitions"),
