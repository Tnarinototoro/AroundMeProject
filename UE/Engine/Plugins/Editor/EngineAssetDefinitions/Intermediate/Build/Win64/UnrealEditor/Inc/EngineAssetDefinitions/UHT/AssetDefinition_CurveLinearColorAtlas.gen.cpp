...
#include "../Private/AssetDefinition_CurveLinearColorAtlas.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_CurveLinearColorAtlas);
	UClass* Z_Construct_UClass_UAssetDefinition_CurveLinearColorAtlas_NoRegister()
	{
		return UAssetDefinition_CurveLinearColorAtlas::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_CurveLinearColorAtlas_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AssetDefinition_CurveLinearColorAtlas.h" },
		{ "ModuleRelativePath", "Private/AssetDefinition_CurveLinearColorAtlas.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_CurveLinearColorAtlas_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_CurveLinearColorAtlas>()
	{
		return UAssetDefinition_CurveLinearColorAtlas::StaticClass();
	}
	UAssetDefinition_CurveLinearColorAtlas::UAssetDefinition_CurveLinearColorAtlas() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_CurveLinearColorAtlas);
	UAssetDefinition_CurveLinearColorAtlas::~UAssetDefinition_CurveLinearColorAtlas() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColorAtlas_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColorAtlas_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_CurveLinearColorAtlas, UAssetDefinition_CurveLinearColorAtlas::StaticClass, TEXT("UAssetDefinition_CurveLinearColorAtlas"), &Z_Registration_Info_UClass_UAssetDefinition_CurveLinearColorAtlas, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_CurveLinearColorAtlas), 2222118178U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColorAtlas_h_1918179805(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColorAtlas_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_CurveLinearColorAtlas_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
