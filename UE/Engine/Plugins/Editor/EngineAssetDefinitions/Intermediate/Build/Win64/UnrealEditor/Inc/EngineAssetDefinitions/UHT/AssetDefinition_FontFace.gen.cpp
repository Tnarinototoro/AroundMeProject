...
#include "../Private/AssetDefinition_FontFace.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_FontFace);
	UClass* Z_Construct_UClass_UAssetDefinition_FontFace_NoRegister()
	{
		return UAssetDefinition_FontFace::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_FontFace_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AssetDefinition_FontFace.h" },
		{ "ModuleRelativePath", "Private/AssetDefinition_FontFace.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_FontFace_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_FontFace>()
	{
		return UAssetDefinition_FontFace::StaticClass();
	}
	UAssetDefinition_FontFace::UAssetDefinition_FontFace() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_FontFace);
	UAssetDefinition_FontFace::~UAssetDefinition_FontFace() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_FontFace_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_FontFace_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_FontFace, UAssetDefinition_FontFace::StaticClass, TEXT("UAssetDefinition_FontFace"), &Z_Registration_Info_UClass_UAssetDefinition_FontFace, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_FontFace), 3121894346U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_FontFace_h_743323637(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_FontFace_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_FontFace_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
