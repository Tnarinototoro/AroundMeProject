...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_SlateBrush_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_SlateBrush_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_SlateBrush_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_SlateBrush_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_SlateBrush_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_SlateBrush, UAssetDefinition_SlateBrush::StaticClass, TEXT("UAssetDefinition_SlateBrush"), &Z_Registration_Info_UClass_UAssetDefinition_SlateBrush, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_SlateBrush), 3835906603U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_SlateBrush_h_2331864495(TEXT("/Script/EngineAssetDefinitions"),
