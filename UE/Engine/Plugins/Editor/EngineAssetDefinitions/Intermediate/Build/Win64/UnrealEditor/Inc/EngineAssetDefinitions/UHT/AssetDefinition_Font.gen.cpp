...
#include "../Private/AssetDefinition_Font.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_Font);
	UClass* Z_Construct_UClass_UAssetDefinition_Font_NoRegister()
	{
		return UAssetDefinition_Font::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_Font_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AssetDefinition_Font.h" },
		{ "ModuleRelativePath", "Private/AssetDefinition_Font.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_Font_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_Font>()
	{
		return UAssetDefinition_Font::StaticClass();
	}
	UAssetDefinition_Font::UAssetDefinition_Font() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_Font);
	UAssetDefinition_Font::~UAssetDefinition_Font() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Font_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Font_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_Font, UAssetDefinition_Font::StaticClass, TEXT("UAssetDefinition_Font"), &Z_Registration_Info_UClass_UAssetDefinition_Font, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_Font), 2544636475U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Font_h_319617123(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Font_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Font_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
