...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Redirector_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_Redirector_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Redirector_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_Redirector_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Public_AssetDefinition_Redirector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_Redirector, UAssetDefinition_Redirector::StaticClass, TEXT("UAssetDefinition_Redirector"), &Z_Registration_Info_UClass_UAssetDefinition_Redirector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_Redirector), 376919514U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Public_AssetDefinition_Redirector_h_654716482(TEXT("/Script/EngineAssetDefinitions"),
