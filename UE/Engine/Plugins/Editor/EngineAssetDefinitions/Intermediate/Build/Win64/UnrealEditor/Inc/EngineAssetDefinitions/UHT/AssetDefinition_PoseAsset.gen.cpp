...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_PoseAsset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_PoseAsset_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_PoseAsset_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_PoseAsset_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_PoseAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_PoseAsset, UAssetDefinition_PoseAsset::StaticClass, TEXT("UAssetDefinition_PoseAsset"), &Z_Registration_Info_UClass_UAssetDefinition_PoseAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_PoseAsset), 3150837883U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_PoseAsset_h_2919404103(TEXT("/Script/EngineAssetDefinitions"),
