...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureRenderTarget_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_TextureRenderTarget_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_TextureRenderTarget_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_TextureRenderTarget_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureRenderTarget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_TextureRenderTarget, UAssetDefinition_TextureRenderTarget::StaticClass, TEXT("UAssetDefinition_TextureRenderTarget"), &Z_Registration_Info_UClass_UAssetDefinition_TextureRenderTarget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_TextureRenderTarget), 903804889U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_TextureRenderTarget_h_2423179363(TEXT("/Script/EngineAssetDefinitions"),
