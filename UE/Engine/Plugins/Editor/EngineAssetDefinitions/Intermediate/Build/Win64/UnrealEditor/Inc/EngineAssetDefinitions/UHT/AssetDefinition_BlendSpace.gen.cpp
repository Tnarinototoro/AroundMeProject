...
#include "../Private/Animation/AssetDefinition_BlendSpace.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_BlendSpace);
	UClass* Z_Construct_UClass_UAssetDefinition_BlendSpace_NoRegister()
	{
		return UAssetDefinition_BlendSpace::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_BlendSpace_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Animation/AssetDefinition_BlendSpace.h" },
		{ "ModuleRelativePath", "Private/Animation/AssetDefinition_BlendSpace.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_BlendSpace_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_BlendSpace>()
	{
		return UAssetDefinition_BlendSpace::StaticClass();
	}
	UAssetDefinition_BlendSpace::UAssetDefinition_BlendSpace() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_BlendSpace);
	UAssetDefinition_BlendSpace::~UAssetDefinition_BlendSpace() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_BlendSpace, UAssetDefinition_BlendSpace::StaticClass, TEXT("UAssetDefinition_BlendSpace"), &Z_Registration_Info_UClass_UAssetDefinition_BlendSpace, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_BlendSpace), 1523204022U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace_h_911444946(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_BlendSpace_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
