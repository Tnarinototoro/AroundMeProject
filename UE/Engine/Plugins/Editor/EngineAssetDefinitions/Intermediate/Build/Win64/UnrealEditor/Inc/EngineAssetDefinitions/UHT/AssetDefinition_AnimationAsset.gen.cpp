...
#include "../Private/Animation/AssetDefinition_AnimationAsset.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_AnimationAsset);
	UClass* Z_Construct_UClass_UAssetDefinition_AnimationAsset_NoRegister()
	{
		return UAssetDefinition_AnimationAsset::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_AnimationAsset_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_AnimationAsset_Statics::StaticCppClassTypeInfo = {
	...
	template<> ENGINEASSETDEFINITIONS_API UClass* StaticClass<UAssetDefinition_AnimationAsset>()
	{
		return UAssetDefinition_AnimationAsset::StaticClass();
	}
	UAssetDefinition_AnimationAsset::UAssetDefinition_AnimationAsset() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_AnimationAsset);
	UAssetDefinition_AnimationAsset::~UAssetDefinition_AnimationAsset() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_AnimationAsset_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_AnimationAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_AnimationAsset, UAssetDefinition_AnimationAsset::StaticClass, TEXT("UAssetDefinition_AnimationAsset"), &Z_Registration_Info_UClass_UAssetDefinition_AnimationAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_AnimationAsset), 2857782169U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_AnimationAsset_h_4008718785(TEXT("/Script/EngineAssetDefinitions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_AnimationAsset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Animation_AssetDefinition_AnimationAsset_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
