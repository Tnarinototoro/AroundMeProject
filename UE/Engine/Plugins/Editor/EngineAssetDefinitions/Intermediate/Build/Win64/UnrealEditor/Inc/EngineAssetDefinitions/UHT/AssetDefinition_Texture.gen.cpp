...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Texture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_Texture_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Texture_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_Texture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Texture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_Texture, UAssetDefinition_Texture::StaticClass, TEXT("UAssetDefinition_Texture"), &Z_Registration_Info_UClass_UAssetDefinition_Texture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_Texture), 3224947632U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Texture_h_3284608679(TEXT("/Script/EngineAssetDefinitions"),
