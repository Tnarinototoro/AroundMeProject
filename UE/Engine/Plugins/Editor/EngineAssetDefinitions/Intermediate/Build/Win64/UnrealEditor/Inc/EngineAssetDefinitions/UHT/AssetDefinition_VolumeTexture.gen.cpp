...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_VolumeTexture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_VolumeTexture_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_VolumeTexture_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_VolumeTexture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_VolumeTexture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_VolumeTexture, UAssetDefinition_VolumeTexture::StaticClass, TEXT("UAssetDefinition_VolumeTexture"), &Z_Registration_Info_UClass_UAssetDefinition_VolumeTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_VolumeTexture), 2360071681U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_VolumeTexture_h_3485234001(TEXT("/Script/EngineAssetDefinitions"),
