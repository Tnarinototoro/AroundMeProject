...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_MaterialInstanceDynamic_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_MaterialInstanceDynamic_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_MaterialInstanceDynamic_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_MaterialInstanceDynamic_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Material_AssetDefinition_MaterialInstanceDynamic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_MaterialInstanceDynamic, UAssetDefinition_MaterialInstanceDynamic::StaticClass, TEXT("UAssetDefinition_MaterialInstanceDynamic"), &Z_Registration_Info_UClass_UAssetDefinition_MaterialInstanceDynamic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_MaterialInstanceDynamic), 1062985680U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_Material_AssetDefinition_MaterialInstanceDynamic_h_3160006997(TEXT("/Script/EngineAssetDefinitions"),
