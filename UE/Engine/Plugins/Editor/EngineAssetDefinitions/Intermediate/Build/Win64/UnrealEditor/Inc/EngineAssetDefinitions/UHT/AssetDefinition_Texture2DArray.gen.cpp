...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Texture2DArray_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_Texture2DArray_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_Texture2DArray_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_Texture2DArray_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Texture2DArray_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_Texture2DArray, UAssetDefinition_Texture2DArray::StaticClass, TEXT("UAssetDefinition_Texture2DArray"), &Z_Registration_Info_UClass_UAssetDefinition_Texture2DArray, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_Texture2DArray), 551503917U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_EngineAssetDefinitions_Source_Private_AssetDefinition_Texture2DArray_h_1180478017(TEXT("/Script/EngineAssetDefinitions"),
