...
template<> OPENCVLENSDISTORTION_API UScriptStruct* StaticStruct<FOpenCVCameraViewInfo>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_HorizontalFOV = { "HorizontalFOV", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOpenCVCameraViewInfo, HorizontalFOV), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_HorizontalFOV_MetaData), Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_HorizontalFOV_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_VerticalFOV = { "VerticalFOV", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOpenCVCameraViewInfo, VerticalFOV), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_VerticalFOV_MetaData), Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_VerticalFOV_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_FocalLengthRatio = { "FocalLengthRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOpenCVCameraViewInfo, FocalLengthRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_FocalLengthRatio_MetaData), Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewProp_FocalLengthRatio_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::PropPointers) < 2048);
...
template<> OPENCVLENSDISTORTION_API UScriptStruct* StaticStruct<FOpenCVLensDistortionParameters>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOpenCVLensDistortionParameters_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOpenCVLensDistortionParameters_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOpenCVLensDistortionParameters_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_OpenCVLensDistortion_Source_OpenCVLensDistortion_Public_OpenCVLensDistortionParameters_h_Statics::ScriptStructInfo[] = {
		{ FOpenCVCameraViewInfo::StaticStruct, Z_Construct_UScriptStruct_FOpenCVCameraViewInfo_Statics::NewStructOps, TEXT("OpenCVCameraViewInfo"), &Z_Registration_Info_UScriptStruct_OpenCVCameraViewInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOpenCVCameraViewInfo), 1278104245U) },
		{ FOpenCVLensDistortionParameters::StaticStruct, Z_Construct_UScriptStruct_FOpenCVLensDistortionParameters_Statics::NewStructOps, TEXT("OpenCVLensDistortionParameters"), &Z_Registration_Info_UScriptStruct_OpenCVLensDistortionParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOpenCVLensDistortionParameters), 345244221U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_OpenCVLensDistortion_Source_OpenCVLensDistortion_Public_OpenCVLensDistortionParameters_h_3249724989(TEXT("/Script/OpenCVLensDistortion"),
		nullptr, 0,
