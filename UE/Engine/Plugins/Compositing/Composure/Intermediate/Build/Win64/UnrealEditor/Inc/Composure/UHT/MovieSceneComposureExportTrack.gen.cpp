...
template<> COMPOSURE_API UScriptStruct* StaticStruct<FMovieSceneComposureExportPass>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::NewProp_TransformPassName = { "TransformPassName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneComposureExportPass, TransformPassName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::NewProp_TransformPassName_MetaData), Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::NewProp_TransformPassName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::NewProp_ExportedAs = { "ExportedAs", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneComposureExportPass, ExportedAs), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::NewProp_ExportedAs_MetaData), Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::NewProp_ExportedAs_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComposureExportPass_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::NewProp_Pass = { "Pass", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneComposureExportTrack, Pass), Z_Construct_UScriptStruct_FMovieSceneComposureExportPass, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::NewProp_Pass_MetaData), Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::NewProp_Pass_MetaData) }; // 1605833956
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::NewProp_Sections = { "Sections", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneComposureExportTrack, Sections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::NewProp_Sections_MetaData), Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::NewProp_Sections_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneComposureExportTrack, IMovieSceneTrackTemplateProducer), false },  // 3839488910
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::ClassParams = {
		...
		0x00A800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportTrack_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportSection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneComposureExportSection_Statics::ClassParams = {
		...
		0,
		0x002800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportSection_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneComposureExportSection_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_MovieSceneComposureExportTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneComposureExportTrack, UMovieSceneComposureExportTrack::StaticClass, TEXT("UMovieSceneComposureExportTrack"), &Z_Registration_Info_UClass_UMovieSceneComposureExportTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneComposureExportTrack), 677350286U) },
		{ Z_Construct_UClass_UMovieSceneComposureExportSection, UMovieSceneComposureExportSection::StaticClass, TEXT("UMovieSceneComposureExportSection"), &Z_Registration_Info_UClass_UMovieSceneComposureExportSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneComposureExportSection), 3338756125U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_MovieSceneComposureExportTrack_h_268307883(TEXT("/Script/Composure"),
