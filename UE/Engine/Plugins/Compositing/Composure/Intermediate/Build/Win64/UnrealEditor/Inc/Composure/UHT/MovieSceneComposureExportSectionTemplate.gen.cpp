...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::NewProp_CompShotElement = { "CompShotElement", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneComposureExportInitializer_eventExportSceneCaptureBuffers_Parms, CompShotElement), Z_Construct_UClass_ACompositingElement_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::NewProp_SceneCapture = { "SceneCapture", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneComposureExportInitializer_eventExportSceneCaptureBuffers_Parms, SceneCapture), Z_Construct_UClass_USceneCaptureComponent2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::NewProp_SceneCapture_MetaData), Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::NewProp_SceneCapture_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::NewProp_BuffersToExport = { "BuffersToExport", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneComposureExportInitializer_eventExportSceneCaptureBuffers_Parms, BuffersToExport), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::NewProp_BuffersToExport_MetaData), Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::NewProp_BuffersToExport_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMovieSceneComposureExportInitializer, nullptr, "ExportSceneCaptureBuffers", nullptr, nullptr, Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::MovieSceneComposureExportInitializer_eventExportSceneCaptureBuffers_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers_Statics::MovieSceneComposureExportInitializer_eventExportSceneCaptureBuffers_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportInitializer_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneComposureExportInitializer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneComposureExportInitializer_ExportSceneCaptureBuffers, "ExportSceneCaptureBuffers" }, // 57062271
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportInitializer_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneComposureExportInitializer_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportInitializer_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneComposureExportInitializer_Statics::Class_MetaDataParams)
	};
...
template<> COMPOSURE_API UScriptStruct* StaticStruct<FMovieSceneComposureExportSectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneComposureExportSectionTemplate_Statics::NewProp_Pass = { "Pass", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneComposureExportSectionTemplate, Pass), Z_Construct_UScriptStruct_FMovieSceneComposureExportPass, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComposureExportSectionTemplate_Statics::NewProp_Pass_MetaData), Z_Construct_UScriptStruct_FMovieSceneComposureExportSectionTemplate_Statics::NewProp_Pass_MetaData) }; // 1605833956
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneComposureExportSectionTemplate_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComposureExportSectionTemplate_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMovieSceneComposureExportSectionTemplate_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneComposureExportSectionTemplate_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Private_MovieScene_MovieSceneComposureExportSectionTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneComposureExportInitializer, UMovieSceneComposureExportInitializer::StaticClass, TEXT("UMovieSceneComposureExportInitializer"), &Z_Registration_Info_UClass_UMovieSceneComposureExportInitializer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneComposureExportInitializer), 430009715U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Private_MovieScene_MovieSceneComposureExportSectionTemplate_h_3672917194(TEXT("/Script/Composure"),
