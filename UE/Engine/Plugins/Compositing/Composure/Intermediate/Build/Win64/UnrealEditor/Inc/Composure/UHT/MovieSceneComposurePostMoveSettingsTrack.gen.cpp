...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneComposurePostMoveSettingsTrack, IMovieSceneTrackTemplateProducer), false },  // 3839488910
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack_Statics::ClassParams = {
		...
		0x00A800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_MovieSceneComposurePostMoveSettingsTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsTrack, UMovieSceneComposurePostMoveSettingsTrack::StaticClass, TEXT("UMovieSceneComposurePostMoveSettingsTrack"), &Z_Registration_Info_UClass_UMovieSceneComposurePostMoveSettingsTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneComposurePostMoveSettingsTrack), 3908611236U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_MovieSceneComposurePostMoveSettingsTrack_h_671229904(TEXT("/Script/Composure"),
