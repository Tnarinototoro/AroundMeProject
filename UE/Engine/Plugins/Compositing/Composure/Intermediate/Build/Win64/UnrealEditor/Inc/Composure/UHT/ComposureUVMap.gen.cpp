...
template<> COMPOSURE_API UScriptStruct* StaticStruct<FComposureUVMapSettings>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_PreUVDisplacementMatrix = { "PreUVDisplacementMatrix", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FComposureUVMapSettings, PreUVDisplacementMatrix), Z_Construct_UScriptStruct_FMatrix, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_PreUVDisplacementMatrix_MetaData), Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_PreUVDisplacementMatrix_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_PostUVDisplacementMatrix = { "PostUVDisplacementMatrix", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FComposureUVMapSettings, PostUVDisplacementMatrix), Z_Construct_UScriptStruct_FMatrix, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_PostUVDisplacementMatrix_MetaData), Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_PostUVDisplacementMatrix_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_DisplacementDecodeParameters = { "DisplacementDecodeParameters", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FComposureUVMapSettings, DisplacementDecodeParameters), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_DisplacementDecodeParameters_MetaData), Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_DisplacementDecodeParameters_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_DisplacementTexture = { "DisplacementTexture", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FComposureUVMapSettings, DisplacementTexture), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_DisplacementTexture_MetaData), Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_DisplacementTexture_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_bUseDisplacementBlueAndAlphaChannels = { "bUseDisplacementBlueAndAlphaChannels", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FComposureUVMapSettings), &Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_bUseDisplacementBlueAndAlphaChannels_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_bUseDisplacementBlueAndAlphaChannels_MetaData), Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewProp_bUseDisplacementBlueAndAlphaChannels_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_ComposureUVMap_h_Statics::ScriptStructInfo[] = {
		{ FComposureUVMapSettings::StaticStruct, Z_Construct_UScriptStruct_FComposureUVMapSettings_Statics::NewStructOps, TEXT("ComposureUVMapSettings"), &Z_Registration_Info_UScriptStruct_ComposureUVMapSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComposureUVMapSettings), 397637268U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_ComposureUVMap_h_1286699485(TEXT("/Script/Composure"),
		nullptr, 0,
