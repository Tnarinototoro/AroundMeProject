...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorCompElementContainer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEditorCompElementContainer_Statics::NewProp_CompElements = { "CompElements", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEditorCompElementContainer, CompElements), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorCompElementContainer_Statics::NewProp_CompElements_MetaData), Z_Construct_UClass_UEditorCompElementContainer_Statics::NewProp_CompElements_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEditorCompElementContainer_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorCompElementContainer_Statics::Class_MetaDataParams), Z_Construct_UClass_UEditorCompElementContainer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorCompElementContainer_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_ComposureLayersEditor_Private_EditorCompElementContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEditorCompElementContainer, UEditorCompElementContainer::StaticClass, TEXT("UEditorCompElementContainer"), &Z_Registration_Info_UClass_UEditorCompElementContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEditorCompElementContainer), 3546470183U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_ComposureLayersEditor_Private_EditorCompElementContainer_h_3026354717(TEXT("/Script/ComposureLayersEditor"),
