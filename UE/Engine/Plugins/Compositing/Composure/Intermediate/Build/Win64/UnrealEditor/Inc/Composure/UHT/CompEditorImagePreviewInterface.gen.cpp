...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompEditorImagePreviewInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompEditorImagePreviewInterface_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompEditorImagePreviewInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompEditorImagePreviewInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_EditorSupport_CompEditorImagePreviewInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompEditorImagePreviewInterface, UCompEditorImagePreviewInterface::StaticClass, TEXT("UCompEditorImagePreviewInterface"), &Z_Registration_Info_UClass_UCompEditorImagePreviewInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompEditorImagePreviewInterface), 3565475293U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_EditorSupport_CompEditorImagePreviewInterface_h_2547746234(TEXT("/Script/Composure"),
