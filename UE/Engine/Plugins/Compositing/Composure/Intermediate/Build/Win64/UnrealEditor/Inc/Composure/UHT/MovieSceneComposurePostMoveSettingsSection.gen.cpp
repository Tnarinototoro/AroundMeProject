...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Pivot = { "Pivot", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(Pivot, UMovieSceneComposurePostMoveSettingsSection), STRUCT_OFFSET(UMovieSceneComposurePostMoveSettingsSection, Pivot), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Pivot_MetaData), Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Pivot_MetaData) }; // 3861024830
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Translation = { "Translation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(Translation, UMovieSceneComposurePostMoveSettingsSection), STRUCT_OFFSET(UMovieSceneComposurePostMoveSettingsSection, Translation), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Translation_MetaData), Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Translation_MetaData) }; // 3861024830
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_RotationAngle = { "RotationAngle", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneComposurePostMoveSettingsSection, RotationAngle), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_RotationAngle_MetaData), Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_RotationAngle_MetaData) }; // 3861024830
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneComposurePostMoveSettingsSection, Scale), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Scale_MetaData), Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::NewProp_Scale_MetaData) }; // 3861024830
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::ClassParams = {
		...
		0,
		0x002800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_MovieSceneComposurePostMoveSettingsSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneComposurePostMoveSettingsSection, UMovieSceneComposurePostMoveSettingsSection::StaticClass, TEXT("UMovieSceneComposurePostMoveSettingsSection"), &Z_Registration_Info_UClass_UMovieSceneComposurePostMoveSettingsSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneComposurePostMoveSettingsSection), 2521740889U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_MovieSceneComposurePostMoveSettingsSection_h_934977416(TEXT("/Script/Composure"),
