...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposureGameSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_StaticVideoPlateDebugImage = { "StaticVideoPlateDebugImage", nullptr, (EPropertyFlags)0x0010000000004014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UComposureGameSettings, StaticVideoPlateDebugImage), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_StaticVideoPlateDebugImage_MetaData), Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_StaticVideoPlateDebugImage_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_bSceneCapWarnOfMissingCam = { "bSceneCapWarnOfMissingCam", nullptr, (EPropertyFlags)0x0010000000004014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UComposureGameSettings), &Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_bSceneCapWarnOfMissingCam_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_bSceneCapWarnOfMissingCam_MetaData), Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_bSceneCapWarnOfMissingCam_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_FallbackCompositingTexture = { "FallbackCompositingTexture", nullptr, (EPropertyFlags)0x0010000000004014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UComposureGameSettings, FallbackCompositingTexture), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_FallbackCompositingTexture_MetaData), Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_FallbackCompositingTexture_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_FallbackCompositingTextureObj = { "FallbackCompositingTextureObj", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UComposureGameSettings, FallbackCompositingTextureObj), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_FallbackCompositingTextureObj_MetaData), Z_Construct_UClass_UComposureGameSettings_Statics::NewProp_FallbackCompositingTextureObj_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UComposureGameSettings_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposureGameSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UComposureGameSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposureGameSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Private_ComposureConfigSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComposureGameSettings, UComposureGameSettings::StaticClass, TEXT("UComposureGameSettings"), &Z_Registration_Info_UClass_UComposureGameSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComposureGameSettings), 380856036U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Private_ComposureConfigSettings_h_2080294908(TEXT("/Script/Composure"),
