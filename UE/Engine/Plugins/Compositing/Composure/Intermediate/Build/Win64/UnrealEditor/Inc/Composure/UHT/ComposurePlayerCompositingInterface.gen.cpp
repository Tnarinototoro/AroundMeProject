...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePlayerCompositingInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UComposurePlayerCompositingInterface_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePlayerCompositingInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UComposurePlayerCompositingInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_ComposurePlayerCompositingInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComposurePlayerCompositingInterface, UComposurePlayerCompositingInterface::StaticClass, TEXT("UComposurePlayerCompositingInterface"), &Z_Registration_Info_UClass_UComposurePlayerCompositingInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComposurePlayerCompositingInterface), 2604318404U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_ComposurePlayerCompositingInterface_h_666589190(TEXT("/Script/Composure"),
