...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompImageColorPickerInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompImageColorPickerInterface_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompImageColorPickerInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompImageColorPickerInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_EditorSupport_CompImageColorPickerInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompImageColorPickerInterface, UCompImageColorPickerInterface::StaticClass, TEXT("UCompImageColorPickerInterface"), &Z_Registration_Info_UClass_UCompImageColorPickerInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompImageColorPickerInterface), 2103277727U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_EditorSupport_CompImageColorPickerInterface_h_1048461862(TEXT("/Script/Composure"),
