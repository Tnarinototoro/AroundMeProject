...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingPostProcessPass_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCompositingPostProcessPass_Statics::NewProp_PostProcessPasses_Inner = { "PostProcessPasses", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UComposurePostProcessPassPolicy_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingPostProcessPass_Statics::NewProp_PostProcessPasses_Inner_MetaData), Z_Construct_UClass_UCompositingPostProcessPass_Statics::NewProp_PostProcessPasses_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCompositingPostProcessPass_Statics::NewProp_PostProcessPasses = { "PostProcessPasses", nullptr, (EPropertyFlags)0x001400800000001d, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCompositingPostProcessPass, PostProcessPasses), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingPostProcessPass_Statics::NewProp_PostProcessPasses_MetaData), Z_Construct_UClass_UCompositingPostProcessPass_Statics::NewProp_PostProcessPasses_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompositingPostProcessPass_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingPostProcessPass_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompositingPostProcessPass_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingPostProcessPass_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams_Statics::NewProp_MID = { "MID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CompositingElementMaterialPass_eventApplyMaterialParams_Parms, MID), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCompositingElementMaterialPass, nullptr, "ApplyMaterialParams", nullptr, nullptr, Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams_Statics::PropPointers), sizeof(CompositingElementMaterialPass_eventApplyMaterialParams_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams_Statics::PropPointers) < 2048);
	static_assert(sizeof(CompositingElementMaterialPass_eventApplyMaterialParams_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCompositingElementMaterialPass, nullptr, "SetMaterialInterface", nullptr, nullptr, Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::CompositingElementMaterialPass_eventSetMaterialInterface_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface_Statics::CompositingElementMaterialPass_eventSetMaterialInterface_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::NewProp_TextureParamName = { "TextureParamName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CompositingElementMaterialPass_eventSetParameterMapping_Parms, TextureParamName), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::NewProp_ComposureLayerName = { "ComposureLayerName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CompositingElementMaterialPass_eventSetParameterMapping_Parms, ComposureLayerName), METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(CompositingElementMaterialPass_eventSetParameterMapping_Parms), &Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCompositingElementMaterialPass, nullptr, "SetParameterMapping", nullptr, nullptr, Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::CompositingElementMaterialPass_eventSetParameterMapping_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping_Statics::CompositingElementMaterialPass_eventSetParameterMapping_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingElementMaterialPass_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UCompositingElementMaterialPass_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCompositingElementMaterialPass_ApplyMaterialParams, "ApplyMaterialParams" }, // 2679702135
		{ &Z_Construct_UFunction_UCompositingElementMaterialPass_SetMaterialInterface, "SetMaterialInterface" }, // 2929281074
		{ &Z_Construct_UFunction_UCompositingElementMaterialPass_SetParameterMapping, "SetParameterMapping" }, // 2159080601
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingElementMaterialPass_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCompositingElementMaterialPass_Statics::NewProp_Material = { "Material", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCompositingElementMaterialPass, Material), Z_Construct_UScriptStruct_FCompositingMaterial, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingElementMaterialPass_Statics::NewProp_Material_MetaData), Z_Construct_UClass_UCompositingElementMaterialPass_Statics::NewProp_Material_MetaData) }; // 1004454039
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompositingElementMaterialPass_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingElementMaterialPass_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompositingElementMaterialPass_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingElementMaterialPass_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingTonemapPass_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_ColorGradingSettings = { "ColorGradingSettings", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCompositingTonemapPass, ColorGradingSettings), Z_Construct_UScriptStruct_FColorGradingSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_ColorGradingSettings_MetaData), Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_ColorGradingSettings_MetaData) }; // 2907138834
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_FilmStockSettings = { "FilmStockSettings", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCompositingTonemapPass, FilmStockSettings), Z_Construct_UScriptStruct_FFilmStockSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_FilmStockSettings_MetaData), Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_FilmStockSettings_MetaData) }; // 1915476821
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_ChromaticAberration = { "ChromaticAberration", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCompositingTonemapPass, ChromaticAberration), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_ChromaticAberration_MetaData), Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_ChromaticAberration_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_TonemapPolicy = { "TonemapPolicy", nullptr, (EPropertyFlags)0x00c4000000202000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCompositingTonemapPass, TonemapPolicy), Z_Construct_UClass_UComposureTonemapperPassPolicy_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_TonemapPolicy_MetaData), Z_Construct_UClass_UCompositingTonemapPass_Statics::NewProp_TonemapPolicy_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompositingTonemapPass_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingTonemapPass_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompositingTonemapPass_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingTonemapPass_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassChromaKeyer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_KeyColors_Inner = { "KeyColors", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_KeyColors = { "KeyColors", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMultiPassChromaKeyer, KeyColors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_KeyColors_MetaData), Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_KeyColors_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_KeyerMaterial = { "KeyerMaterial", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMultiPassChromaKeyer, KeyerMaterial), Z_Construct_UScriptStruct_FCompositingMaterial, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_KeyerMaterial_MetaData), Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_KeyerMaterial_MetaData) }; // 1004454039
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_DefaultWhiteTexture = { "DefaultWhiteTexture", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMultiPassChromaKeyer, DefaultWhiteTexture), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_DefaultWhiteTexture_MetaData), Z_Construct_UClass_UMultiPassChromaKeyer_Statics::NewProp_DefaultWhiteTexture_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMultiPassChromaKeyer_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassChromaKeyer_Statics::Class_MetaDataParams), Z_Construct_UClass_UMultiPassChromaKeyer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassChromaKeyer_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassDespill_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_KeyColors = { "KeyColors", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMultiPassDespill, KeyColors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_KeyColors_MetaData), Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_KeyColors_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_KeyerMaterial = { "KeyerMaterial", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMultiPassDespill, KeyerMaterial), Z_Construct_UScriptStruct_FCompositingMaterial, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_KeyerMaterial_MetaData), Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_KeyerMaterial_MetaData) }; // 1004454039
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_DefaultWhiteTexture = { "DefaultWhiteTexture", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMultiPassDespill, DefaultWhiteTexture), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_DefaultWhiteTexture_MetaData), Z_Construct_UClass_UMultiPassDespill_Statics::NewProp_DefaultWhiteTexture_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMultiPassDespill_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassDespill_Statics::Class_MetaDataParams), Z_Construct_UClass_UMultiPassDespill_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiPassDespill_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAlphaTransformPass_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_AlphaScale = { "AlphaScale", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAlphaTransformPass, AlphaScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_AlphaScale_MetaData), Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_AlphaScale_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_DefaultMaterial = { "DefaultMaterial", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAlphaTransformPass, DefaultMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_DefaultMaterial_MetaData), Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_DefaultMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_AlphaTransformMID = { "AlphaTransformMID", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAlphaTransformPass, AlphaTransformMID), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_AlphaTransformMID_MetaData), Z_Construct_UClass_UAlphaTransformPass_Statics::NewProp_AlphaTransformMID_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAlphaTransformPass_Statics::ClassParams = {
		...
		0,
		0x041000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAlphaTransformPass_Statics::Class_MetaDataParams), Z_Construct_UClass_UAlphaTransformPass_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAlphaTransformPass_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::NewProp_ColorConversionSettings = { "ColorConversionSettings", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCompositingOpenColorIOPass, ColorConversionSettings), Z_Construct_UScriptStruct_FOpenColorIOColorConversionSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::NewProp_ColorConversionSettings_MetaData), Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::NewProp_ColorConversionSettings_MetaData) }; // 1425686863
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositingOpenColorIOPass_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Classes_CompositingElements_CompositingElementTransforms_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompositingPostProcessPass, UCompositingPostProcessPass::StaticClass, TEXT("UCompositingPostProcessPass"), &Z_Registration_Info_UClass_UCompositingPostProcessPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositingPostProcessPass), 3606724780U) },
		{ Z_Construct_UClass_UCompositingElementMaterialPass, UCompositingElementMaterialPass::StaticClass, TEXT("UCompositingElementMaterialPass"), &Z_Registration_Info_UClass_UCompositingElementMaterialPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositingElementMaterialPass), 2090052363U) },
		{ Z_Construct_UClass_UCompositingTonemapPass, UCompositingTonemapPass::StaticClass, TEXT("UCompositingTonemapPass"), &Z_Registration_Info_UClass_UCompositingTonemapPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositingTonemapPass), 621789952U) },
		{ Z_Construct_UClass_UMultiPassChromaKeyer, UMultiPassChromaKeyer::StaticClass, TEXT("UMultiPassChromaKeyer"), &Z_Registration_Info_UClass_UMultiPassChromaKeyer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiPassChromaKeyer), 2131442902U) },
		{ Z_Construct_UClass_UMultiPassDespill, UMultiPassDespill::StaticClass, TEXT("UMultiPassDespill"), &Z_Registration_Info_UClass_UMultiPassDespill, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiPassDespill), 1949648379U) },
		{ Z_Construct_UClass_UAlphaTransformPass, UAlphaTransformPass::StaticClass, TEXT("UAlphaTransformPass"), &Z_Registration_Info_UClass_UAlphaTransformPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAlphaTransformPass), 2973241579U) },
		{ Z_Construct_UClass_UCompositingOpenColorIOPass, UCompositingOpenColorIOPass::StaticClass, TEXT("UCompositingOpenColorIOPass"), &Z_Registration_Info_UClass_UCompositingOpenColorIOPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositingOpenColorIOPass), 1701205067U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Classes_CompositingElements_CompositingElementTransforms_h_4185539193(TEXT("/Script/Composure"),
