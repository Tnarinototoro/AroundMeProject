...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport_Statics::NewProp_ExportInitializer = { "ExportInitializer", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneComposureExportClient_eventInitializeForExport_Parms, ExportInitializer), Z_Construct_UClass_UMovieSceneComposureExportInitializer_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMovieSceneComposureExportClient, nullptr, "InitializeForExport", nullptr, nullptr, Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport_Statics::PropPointers), sizeof(MovieSceneComposureExportClient_eventInitializeForExport_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport_Statics::PropPointers) < 2048);
	static_assert(sizeof(MovieSceneComposureExportClient_eventInitializeForExport_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportClient_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneComposureExportClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneComposureExportClient_InitializeForExport, "InitializeForExport" }, // 1909956105
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportClient_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneComposureExportClient_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneComposureExportClient_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneComposureExportClient_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_IMovieSceneComposureExportClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneComposureExportClient, UMovieSceneComposureExportClient::StaticClass, TEXT("UMovieSceneComposureExportClient"), &Z_Registration_Info_UClass_UMovieSceneComposureExportClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneComposureExportClient), 485810625U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Public_MovieScene_IMovieSceneComposureExportClient_h_3633458881(TEXT("/Script/Composure"),
