...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_ACompositingCaptureBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACompositingCaptureBase_UpdateDistortion, "UpdateDistortion" }, // 4216822290
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_SceneCaptureComponent2D = { "SceneCaptureComponent2D", nullptr, (EPropertyFlags)0x00140000000b001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACompositingCaptureBase, SceneCaptureComponent2D), Z_Construct_UClass_USceneCaptureComponent2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_SceneCaptureComponent2D_MetaData), Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_SceneCaptureComponent2D_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_bApplyDistortion = { "bApplyDistortion", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ACompositingCaptureBase), &Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_bApplyDistortion_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_bApplyDistortion_MetaData), Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_bApplyDistortion_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_LensComponentPicker = { "LensComponentPicker", nullptr, (EPropertyFlags)0x0020080000000801, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACompositingCaptureBase, LensComponentPicker), Z_Construct_UScriptStruct_FComponentReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_LensComponentPicker_MetaData), Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_LensComponentPicker_MetaData) }; // 834145860
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_OverscanFactor = { "OverscanFactor", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACompositingCaptureBase, OverscanFactor), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_OverscanFactor_MetaData), Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_OverscanFactor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_OriginalFocalLength = { "OriginalFocalLength", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACompositingCaptureBase, OriginalFocalLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_OriginalFocalLength_MetaData), Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_OriginalFocalLength_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_LastDistortionMID = { "LastDistortionMID", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACompositingCaptureBase, LastDistortionMID), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_LastDistortionMID_MetaData), Z_Construct_UClass_ACompositingCaptureBase_Statics::NewProp_LastDistortionMID_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ACompositingCaptureBase_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::Class_MetaDataParams), Z_Construct_UClass_ACompositingCaptureBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ACompositingCaptureBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Classes_CompositingCaptureBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACompositingCaptureBase, ACompositingCaptureBase::StaticClass, TEXT("ACompositingCaptureBase"), &Z_Registration_Info_UClass_ACompositingCaptureBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACompositingCaptureBase), 4090057937U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Classes_CompositingCaptureBase_h_572712361(TEXT("/Script/Composure"),
