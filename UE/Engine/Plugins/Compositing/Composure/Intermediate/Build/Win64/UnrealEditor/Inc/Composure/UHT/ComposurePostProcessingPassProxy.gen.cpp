...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::NewProp_SceneCapture = { "SceneCapture", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ComposurePostProcessPassPolicy_eventSetupPostProcess_Parms, SceneCapture), Z_Construct_UClass_USceneCaptureComponent2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::NewProp_SceneCapture_MetaData), Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::NewProp_SceneCapture_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::NewProp_TonemapperOverride = { "TonemapperOverride", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ComposurePostProcessPassPolicy_eventSetupPostProcess_Parms, TonemapperOverride), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UComposurePostProcessPassPolicy, nullptr, "SetupPostProcess", nullptr, nullptr, Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::PropPointers), sizeof(ComposurePostProcessPassPolicy_eventSetupPostProcess_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08420C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::Function_MetaDataParams), Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess_Statics::PropPointers) < 2048);
	static_assert(sizeof(ComposurePostProcessPassPolicy_eventSetupPostProcess_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessPassPolicy_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UComposurePostProcessPassPolicy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UComposurePostProcessPassPolicy_SetupPostProcess, "SetupPostProcess" }, // 2737219324
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessPassPolicy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UComposurePostProcessPassPolicy_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessPassPolicy_Statics::Class_MetaDataParams), Z_Construct_UClass_UComposurePostProcessPassPolicy_Statics::Class_MetaDataParams)
	};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::NewProp_PrePassInput = { "PrePassInput", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ComposurePostProcessingPassProxy_eventExecute_Parms, PrePassInput), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::NewProp_PostProcessPass = { "PostProcessPass", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ComposurePostProcessingPassProxy_eventExecute_Parms, PostProcessPass), Z_Construct_UClass_UComposurePostProcessPassPolicy_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UComposurePostProcessingPassProxy, nullptr, "Execute", nullptr, nullptr, Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::PropPointers), sizeof(Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::ComposurePostProcessingPassProxy_eventExecute_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::Function_MetaDataParams), Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute_Statics::ComposurePostProcessingPassProxy_eventExecute_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UComposurePostProcessingPassProxy_Execute, "Execute" }, // 3326352179
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::NewProp_SetupMID = { "SetupMID", nullptr, (EPropertyFlags)0x00c4000000202000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UComposurePostProcessingPassProxy, SetupMID), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::NewProp_SetupMID_MetaData), Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::NewProp_SetupMID_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::ClassParams = {
		...
		0,
		0x00B010A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComposurePostProcessingPassProxy_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Classes_ComposurePostProcessingPassProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComposurePostProcessPassPolicy, UComposurePostProcessPassPolicy::StaticClass, TEXT("UComposurePostProcessPassPolicy"), &Z_Registration_Info_UClass_UComposurePostProcessPassPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComposurePostProcessPassPolicy), 3217068031U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_Composure_Source_Composure_Classes_ComposurePostProcessingPassProxy_h_4254958389(TEXT("/Script/Composure"),
