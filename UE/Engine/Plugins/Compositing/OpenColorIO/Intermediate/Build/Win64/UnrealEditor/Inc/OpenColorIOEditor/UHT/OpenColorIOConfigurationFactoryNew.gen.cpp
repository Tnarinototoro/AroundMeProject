...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOConfigurationFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOpenColorIOConfigurationFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOConfigurationFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UOpenColorIOConfigurationFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_OpenColorIO_Source_OpenColorIOEditor_Private_Factories_OpenColorIOConfigurationFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenColorIOConfigurationFactoryNew, UOpenColorIOConfigurationFactoryNew::StaticClass, TEXT("UOpenColorIOConfigurationFactoryNew"), &Z_Registration_Info_UClass_UOpenColorIOConfigurationFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenColorIOConfigurationFactoryNew), 360703092U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_OpenColorIO_Source_OpenColorIOEditor_Private_Factories_OpenColorIOConfigurationFactoryNew_h_656637174(TEXT("/Script/OpenColorIOEditor"),
