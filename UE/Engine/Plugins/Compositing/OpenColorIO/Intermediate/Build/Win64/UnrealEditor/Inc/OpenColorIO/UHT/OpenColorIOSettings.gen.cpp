...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUseLegacyProcessor = { "bUseLegacyProcessor", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UOpenColorIOSettings), &Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUseLegacyProcessor_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUseLegacyProcessor_MetaData), Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUseLegacyProcessor_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUse32fLUT = { "bUse32fLUT", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UOpenColorIOSettings), &Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUse32fLUT_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUse32fLUT_MetaData), Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bUse32fLUT_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bSupportInverseViewTransforms = { "bSupportInverseViewTransforms", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UOpenColorIOSettings), &Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bSupportInverseViewTransforms_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bSupportInverseViewTransforms_MetaData), Z_Construct_UClass_UOpenColorIOSettings_Statics::NewProp_bSupportInverseViewTransforms_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOpenColorIOSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UOpenColorIOSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenColorIOSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_OpenColorIO_Source_OpenColorIO_Public_OpenColorIOSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenColorIOSettings, UOpenColorIOSettings::StaticClass, TEXT("UOpenColorIOSettings"), &Z_Registration_Info_UClass_UOpenColorIOSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenColorIOSettings), 3043110759U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Compositing_OpenColorIO_Source_OpenColorIO_Public_OpenColorIOSettings_h_2664466859(TEXT("/Script/OpenColorIO"),
