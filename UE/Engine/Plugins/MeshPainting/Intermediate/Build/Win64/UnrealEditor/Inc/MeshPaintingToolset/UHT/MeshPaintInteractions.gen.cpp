...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMeshPaintSelectionMechanic_Statics::NewProp_CachedClickedComponents_Inner = { "CachedClickedComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMeshComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMeshPaintSelectionMechanic_Statics::NewProp_CachedClickedComponents = { "CachedClickedComponents", nullptr, (EPropertyFlags)0x0024088000002008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeshPaintSelectionMechanic, CachedClickedComponents), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshPaintSelectionMechanic_Statics::NewProp_CachedClickedComponents_MetaData), Z_Construct_UClass_UMeshPaintSelectionMechanic_Statics::NewProp_CachedClickedComponents_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMeshPaintSelectionMechanic_Statics::NewProp_CachedClickedActors = { "CachedClickedActors", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeshPaintSelectionMechanic, CachedClickedActors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshPaintSelectionMechanic_Statics::NewProp_CachedClickedActors_MetaData), Z_Construct_UClass_UMeshPaintSelectionMechanic_Statics::NewProp_CachedClickedActors_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MeshPainting_Source_MeshPaintingToolset_Public_MeshPaintInteractions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMeshPaintSelectionInterface, UMeshPaintSelectionInterface::StaticClass, TEXT("UMeshPaintSelectionInterface"), &Z_Registration_Info_UClass_UMeshPaintSelectionInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeshPaintSelectionInterface), 61859339U) },
		{ Z_Construct_UClass_UMeshPaintSelectionMechanic, UMeshPaintSelectionMechanic::StaticClass, TEXT("UMeshPaintSelectionMechanic"), &Z_Registration_Info_UClass_UMeshPaintSelectionMechanic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeshPaintSelectionMechanic), 1996990568U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MeshPainting_Source_MeshPaintingToolset_Public_MeshPaintInteractions_h_476754306(TEXT("/Script/MeshPaintingToolset"),
