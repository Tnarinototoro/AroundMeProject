...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureAdapterClickToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTextureAdapterClickToolBuilder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureAdapterClickToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UTextureAdapterClickToolBuilder_Statics::Class_MetaDataParams)
	};
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMeshClickTool_Statics::NewProp_SelectionMechanic = { "SelectionMechanic", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeshClickTool, SelectionMechanic), Z_Construct_UClass_UMeshPaintSelectionMechanic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshClickTool_Statics::NewProp_SelectionMechanic_MetaData), Z_Construct_UClass_UMeshClickTool_Statics::NewProp_SelectionMechanic_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMeshClickTool_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMeshClickTool_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMeshPaintSelectionInterface_NoRegister, (int32)VTABLE_OFFSET(UMeshClickTool, IMeshPaintSelectionInterface), false },  // 61859339
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshClickTool_Statics::InterfaceParams) < 64);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureAdapterClickTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTextureAdapterClickTool_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureAdapterClickTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UTextureAdapterClickTool_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MeshPainting_Source_MeshPaintingToolset_Public_MeshSelect_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVertexAdapterClickToolBuilder, UVertexAdapterClickToolBuilder::StaticClass, TEXT("UVertexAdapterClickToolBuilder"), &Z_Registration_Info_UClass_UVertexAdapterClickToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVertexAdapterClickToolBuilder), 1817054353U) },
		{ Z_Construct_UClass_UTextureAdapterClickToolBuilder, UTextureAdapterClickToolBuilder::StaticClass, TEXT("UTextureAdapterClickToolBuilder"), &Z_Registration_Info_UClass_UTextureAdapterClickToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextureAdapterClickToolBuilder), 3077401435U) },
		{ Z_Construct_UClass_UMeshClickTool, UMeshClickTool::StaticClass, TEXT("UMeshClickTool"), &Z_Registration_Info_UClass_UMeshClickTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeshClickTool), 3874657165U) },
		{ Z_Construct_UClass_UVertexAdapterClickTool, UVertexAdapterClickTool::StaticClass, TEXT("UVertexAdapterClickTool"), &Z_Registration_Info_UClass_UVertexAdapterClickTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVertexAdapterClickTool), 2091597771U) },
		{ Z_Construct_UClass_UTextureAdapterClickTool, UTextureAdapterClickTool::StaticClass, TEXT("UTextureAdapterClickTool"), &Z_Registration_Info_UClass_UTextureAdapterClickTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextureAdapterClickTool), 2933506700U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MeshPainting_Source_MeshPaintingToolset_Public_MeshSelect_h_1805792180(TEXT("/Script/MeshPaintingToolset"),
