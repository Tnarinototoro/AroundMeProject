...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMockHTNComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMockHTNComponent_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMockHTNComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UMockHTNComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_HTNPlanner_Source_HTNTestSuite_Private_MockHTN_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMockHTNComponent, UMockHTNComponent::StaticClass, TEXT("UMockHTNComponent"), &Z_Registration_Info_UClass_UMockHTNComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMockHTNComponent), 4279917161U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_HTNPlanner_Source_HTNTestSuite_Private_MockHTN_h_3833966615(TEXT("/Script/HTNTestSuite"),
