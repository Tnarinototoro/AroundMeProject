...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UHTNBrainComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UHTNBrainComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHTNBrainComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UHTNBrainComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_HTNPlanner_Source_HTNPlanner_Public_AI_HTNBrainComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHTNBrainComponent, UHTNBrainComponent::StaticClass, TEXT("UHTNBrainComponent"), &Z_Registration_Info_UClass_UHTNBrainComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHTNBrainComponent), 3228272535U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_HTNPlanner_Source_HTNPlanner_Public_AI_HTNBrainComponent_h_429756256(TEXT("/Script/HTNPlanner"),
