...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FReplicatedCrowdAgent>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::NewProp_Path = { "Path", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FReplicatedCrowdAgent, Path), Z_Construct_UScriptStruct_FReplicatedAgentPathData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::NewProp_Path_MetaData), Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::NewProp_Path_MetaData) }; // 1708399495
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::NewProp_PositionYaw = { "PositionYaw", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FReplicatedCrowdAgent, PositionYaw), Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::NewProp_PositionYaw_MetaData), Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::NewProp_PositionYaw_MetaData) }; // 1548753052
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::PropPointers) < 2048);
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FCrowdFastArrayItem>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::NewProp_Agent = { "Agent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCrowdFastArrayItem, Agent), Z_Construct_UScriptStruct_FReplicatedCrowdAgent, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::NewProp_Agent_MetaData), Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::NewProp_Agent_MetaData) }; // 2917128457
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdReplicatedAgent_h_Statics::ScriptStructInfo[] = {
		{ FReplicatedCrowdAgent::StaticStruct, Z_Construct_UScriptStruct_FReplicatedCrowdAgent_Statics::NewStructOps, TEXT("ReplicatedCrowdAgent"), &Z_Registration_Info_UScriptStruct_ReplicatedCrowdAgent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FReplicatedCrowdAgent), 2917128457U) },
		{ FCrowdFastArrayItem::StaticStruct, Z_Construct_UScriptStruct_FCrowdFastArrayItem_Statics::NewStructOps, TEXT("CrowdFastArrayItem"), &Z_Registration_Info_UScriptStruct_CrowdFastArrayItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdFastArrayItem), 1211495757U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdReplicatedAgent_h_3724922907(TEXT("/Script/MassCrowd"),
		nullptr, 0,
