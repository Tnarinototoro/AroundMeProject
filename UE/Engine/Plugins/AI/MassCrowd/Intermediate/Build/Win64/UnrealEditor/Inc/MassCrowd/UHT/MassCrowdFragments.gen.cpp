...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FMassCrowdTag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassCrowdTag_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassCrowdTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassCrowdTag_Statics::Struct_MetaDataParams)
	};
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FMassCrowdLaneTrackingFragment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassCrowdLaneTrackingFragment_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassCrowdLaneTrackingFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassCrowdLaneTrackingFragment_Statics::Struct_MetaDataParams)
	};
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FMassCrowdObstacleFragment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassCrowdObstacleFragment_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassCrowdObstacleFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassCrowdObstacleFragment_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdFragments_h_Statics::ScriptStructInfo[] = {
		{ FMassCrowdTag::StaticStruct, Z_Construct_UScriptStruct_FMassCrowdTag_Statics::NewStructOps, TEXT("MassCrowdTag"), &Z_Registration_Info_UScriptStruct_MassCrowdTag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassCrowdTag), 1821311485U) },
		...
		{ FMassCrowdObstacleFragment::StaticStruct, Z_Construct_UScriptStruct_FMassCrowdObstacleFragment_Statics::NewStructOps, TEXT("MassCrowdObstacleFragment"), &Z_Registration_Info_UScriptStruct_MassCrowdObstacleFragment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassCrowdObstacleFragment), 644171290U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdFragments_h_3123695208(TEXT("/Script/MassCrowd"),
		nullptr, 0,
