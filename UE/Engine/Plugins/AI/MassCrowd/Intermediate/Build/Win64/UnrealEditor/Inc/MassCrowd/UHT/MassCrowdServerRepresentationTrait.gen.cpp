...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::NewProp_TemplateActor = { "TemplateActor", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassCrowdServerRepresentationTrait, TemplateActor), Z_Construct_UClass_UClass, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::NewProp_TemplateActor_MetaData), Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::NewProp_TemplateActor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::NewProp_Params = { "Params", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassCrowdServerRepresentationTrait, Params), Z_Construct_UScriptStruct_FMassRepresentationParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::NewProp_Params_MetaData), Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::NewProp_Params_MetaData) }; // 1606144726
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationTrait_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdServerRepresentationTrait_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassCrowdServerRepresentationTrait, UMassCrowdServerRepresentationTrait::StaticClass, TEXT("UMassCrowdServerRepresentationTrait"), &Z_Registration_Info_UClass_UMassCrowdServerRepresentationTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassCrowdServerRepresentationTrait), 4017630899U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdServerRepresentationTrait_h_2723822156(TEXT("/Script/MassCrowd"),
