...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MassCrowd_ECrowdLaneState_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MassCrowd_ECrowdLaneState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MassCrowd_ECrowdLaneState_Statics::Enum_MetaDataParams)
	};
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FCrowdTrackingLaneData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdTrackingLaneData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdTrackingLaneData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCrowdTrackingLaneData_Statics::Struct_MetaDataParams)
	};
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FCrowdWaitSlot>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdWaitSlot_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdWaitSlot_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCrowdWaitSlot_Statics::Struct_MetaDataParams)
	};
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FCrowdWaitAreaData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdWaitAreaData_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdWaitAreaData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCrowdWaitAreaData_Statics::Struct_MetaDataParams)
	};
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FCrowdBranchingLaneData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCrowdBranchingLaneData_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdBranchingLaneData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCrowdBranchingLaneData_Statics::Struct_MetaDataParams)
	};
...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FZoneGraphCrowdLaneData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FZoneGraphCrowdLaneData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FZoneGraphCrowdLaneData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FZoneGraphCrowdLaneData_Statics::Struct_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdTypes_h_Statics::EnumInfo[] = {
		{ ECrowdLaneState_StaticEnum, TEXT("ECrowdLaneState"), &Z_Registration_Info_UEnum_ECrowdLaneState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2734903077U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdTypes_h_Statics::ScriptStructInfo[] = {
		{ FCrowdTrackingLaneData::StaticStruct, Z_Construct_UScriptStruct_FCrowdTrackingLaneData_Statics::NewStructOps, TEXT("CrowdTrackingLaneData"), &Z_Registration_Info_UScriptStruct_CrowdTrackingLaneData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdTrackingLaneData), 1983565814U) },
		{ FCrowdWaitSlot::StaticStruct, Z_Construct_UScriptStruct_FCrowdWaitSlot_Statics::NewStructOps, TEXT("CrowdWaitSlot"), &Z_Registration_Info_UScriptStruct_CrowdWaitSlot, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdWaitSlot), 2269663827U) },
		{ FCrowdWaitAreaData::StaticStruct, Z_Construct_UScriptStruct_FCrowdWaitAreaData_Statics::NewStructOps, TEXT("CrowdWaitAreaData"), &Z_Registration_Info_UScriptStruct_CrowdWaitAreaData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdWaitAreaData), 1987877895U) },
		{ FCrowdBranchingLaneData::StaticStruct, Z_Construct_UScriptStruct_FCrowdBranchingLaneData_Statics::NewStructOps, TEXT("CrowdBranchingLaneData"), &Z_Registration_Info_UScriptStruct_CrowdBranchingLaneData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCrowdBranchingLaneData), 4266032869U) },
		{ FZoneGraphCrowdLaneData::StaticStruct, Z_Construct_UScriptStruct_FZoneGraphCrowdLaneData_Statics::NewStructOps, TEXT("ZoneGraphCrowdLaneData"), &Z_Registration_Info_UScriptStruct_ZoneGraphCrowdLaneData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FZoneGraphCrowdLaneData), 3300582500U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdTypes_h_1676584008(TEXT("/Script/MassCrowd"),
		nullptr, 0,
