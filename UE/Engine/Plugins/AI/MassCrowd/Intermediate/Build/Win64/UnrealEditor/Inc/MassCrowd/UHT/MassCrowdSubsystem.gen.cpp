...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_ZoneGraphSubsystem = { "ZoneGraphSubsystem", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassCrowdSubsystem, ZoneGraphSubsystem), Z_Construct_UClass_UZoneGraphSubsystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_ZoneGraphSubsystem_MetaData), Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_ZoneGraphSubsystem_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_ZoneGraphAnnotationSubsystem = { "ZoneGraphAnnotationSubsystem", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassCrowdSubsystem, ZoneGraphAnnotationSubsystem), Z_Construct_UClass_UZoneGraphAnnotationSubsystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_ZoneGraphAnnotationSubsystem_MetaData), Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_ZoneGraphAnnotationSubsystem_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_MassCrowdSettings = { "MassCrowdSettings", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassCrowdSubsystem, MassCrowdSettings), Z_Construct_UClass_UMassCrowdSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_MassCrowdSettings_MetaData), Z_Construct_UClass_UMassCrowdSubsystem_Statics::NewProp_MassCrowdSettings_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassCrowdSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassCrowdSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdSubsystem_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassCrowdSubsystem, UMassCrowdSubsystem::StaticClass, TEXT("UMassCrowdSubsystem"), &Z_Registration_Info_UClass_UMassCrowdSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassCrowdSubsystem), 2003403392U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdSubsystem_h_899513529(TEXT("/Script/MassCrowd"),
