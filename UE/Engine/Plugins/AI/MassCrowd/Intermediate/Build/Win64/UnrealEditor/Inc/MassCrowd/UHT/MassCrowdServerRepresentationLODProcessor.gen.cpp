...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_LODDistance = { "LODDistance", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(LODDistance, UMassCrowdServerRepresentationLODProcessor), STRUCT_OFFSET(UMassCrowdServerRepresentationLODProcessor, LODDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_LODDistance_MetaData), Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_LODDistance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_BufferHysteresisOnDistancePercentage = { "BufferHysteresisOnDistancePercentage", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassCrowdServerRepresentationLODProcessor, BufferHysteresisOnDistancePercentage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_BufferHysteresisOnDistancePercentage_MetaData), Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_BufferHysteresisOnDistancePercentage_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_LODMaxCount = { "LODMaxCount", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(LODMaxCount, UMassCrowdServerRepresentationLODProcessor), STRUCT_OFFSET(UMassCrowdServerRepresentationLODProcessor, LODMaxCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_LODMaxCount_MetaData), Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::NewProp_LODMaxCount_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::ClassParams = {
		...
		0,
		0x401030A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdServerRepresentationLODProcessor_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdServerRepresentationLODProcessor_h_3471118381(TEXT("/Script/MassCrowd"),
