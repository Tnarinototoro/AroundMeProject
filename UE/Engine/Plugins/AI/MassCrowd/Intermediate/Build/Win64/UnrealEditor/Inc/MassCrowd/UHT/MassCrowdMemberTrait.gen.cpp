...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdMemberTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassCrowdMemberTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCrowdMemberTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassCrowdMemberTrait_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdMemberTrait_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassCrowdMemberTrait, UMassCrowdMemberTrait::StaticClass, TEXT("UMassCrowdMemberTrait"), &Z_Registration_Info_UClass_UMassCrowdMemberTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassCrowdMemberTrait), 3893768613U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_MassCrowdMemberTrait_h_554343541(TEXT("/Script/MassCrowd"),
