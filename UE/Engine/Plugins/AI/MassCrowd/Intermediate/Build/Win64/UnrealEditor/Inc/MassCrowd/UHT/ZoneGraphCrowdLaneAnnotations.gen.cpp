...
template<> MASSCROWD_API UScriptStruct* StaticStruct<FZoneGraphCrowdLaneStateChangeEvent>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::NewProp_Lane = { "Lane", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FZoneGraphCrowdLaneStateChangeEvent, Lane), Z_Construct_UScriptStruct_FZoneGraphLaneHandle, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::NewProp_Lane_MetaData), Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::NewProp_Lane_MetaData) }; // 2434965409
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::NewProp_State = { "State", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FZoneGraphCrowdLaneStateChangeEvent, State), Z_Construct_UEnum_MassCrowd_ECrowdLaneState, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::NewProp_State_MetaData), Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::NewProp_State_MetaData) }; // 2734903077
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_CloseLaneTag = { "CloseLaneTag", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphCrowdLaneAnnotations, CloseLaneTag), Z_Construct_UScriptStruct_FZoneGraphTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_CloseLaneTag_MetaData), Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_CloseLaneTag_MetaData) }; // 2776536726
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_bDisplayTags = { "bDisplayTags", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UZoneGraphCrowdLaneAnnotations), &Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_bDisplayTags_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_bDisplayTags_MetaData), Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_bDisplayTags_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_CrowdSubsystem = { "CrowdSubsystem", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphCrowdLaneAnnotations, CrowdSubsystem), Z_Construct_UClass_UMassCrowdSubsystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_CrowdSubsystem_MetaData), Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::NewProp_CrowdSubsystem_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_ZoneGraphCrowdLaneAnnotations_h_Statics::ScriptStructInfo[] = {
		{ FZoneGraphCrowdLaneStateChangeEvent::StaticStruct, Z_Construct_UScriptStruct_FZoneGraphCrowdLaneStateChangeEvent_Statics::NewStructOps, TEXT("ZoneGraphCrowdLaneStateChangeEvent"), &Z_Registration_Info_UScriptStruct_ZoneGraphCrowdLaneStateChangeEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FZoneGraphCrowdLaneStateChangeEvent), 857151000U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_ZoneGraphCrowdLaneAnnotations_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneGraphCrowdLaneAnnotations, UZoneGraphCrowdLaneAnnotations::StaticClass, TEXT("UZoneGraphCrowdLaneAnnotations"), &Z_Registration_Info_UClass_UZoneGraphCrowdLaneAnnotations, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphCrowdLaneAnnotations), 3847101633U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MassCrowd_Source_MassCrowd_Public_ZoneGraphCrowdLaneAnnotations_h_962493178(TEXT("/Script/MassCrowd"),
