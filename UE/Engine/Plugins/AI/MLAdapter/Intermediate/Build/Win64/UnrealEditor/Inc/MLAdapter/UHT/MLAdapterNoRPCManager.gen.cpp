...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterNoRPCManager_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterNoRPCManager_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterNoRPCManager_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterNoRPCManager_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Managers_MLAdapterNoRPCManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterNoRPCManager, UMLAdapterNoRPCManager::StaticClass, TEXT("UMLAdapterNoRPCManager"), &Z_Registration_Info_UClass_UMLAdapterNoRPCManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterNoRPCManager), 3591647475U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Managers_MLAdapterNoRPCManager_h_975702068(TEXT("/Script/MLAdapter"),
