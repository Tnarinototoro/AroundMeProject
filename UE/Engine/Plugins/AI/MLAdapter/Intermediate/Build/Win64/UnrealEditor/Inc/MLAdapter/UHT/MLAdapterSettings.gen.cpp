...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FUInt16PropertyParams NewProp_DefaultRPCServerPort;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_ManagerClass = { "ManagerClass", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSettings, ManagerClass), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_ManagerClass_MetaData), Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_ManagerClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_SessionClass = { "SessionClass", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSettings, SessionClass), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_SessionClass_MetaData), Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_SessionClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_DefaultAgentClass = { "DefaultAgentClass", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSettings, DefaultAgentClass), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_DefaultAgentClass_MetaData), Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_DefaultAgentClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_DefaultRPCServerPort = { "DefaultRPCServerPort", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSettings, DefaultRPCServerPort), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_DefaultRPCServerPort_MetaData), Z_Construct_UClass_UMLAdapterSettings_Statics::NewProp_DefaultRPCServerPort_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_MLAdapterSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterSettings, UMLAdapterSettings::StaticClass, TEXT("UMLAdapterSettings"), &Z_Registration_Info_UClass_UMLAdapterSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterSettings), 234934690U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_MLAdapterSettings_h_2053035003(TEXT("/Script/MLAdapter"),
