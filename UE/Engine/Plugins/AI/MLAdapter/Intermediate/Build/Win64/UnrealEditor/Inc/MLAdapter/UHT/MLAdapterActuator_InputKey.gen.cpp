...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_InputKey_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterActuator_InputKey_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_InputKey_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterActuator_InputKey_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Actuators_MLAdapterActuator_InputKey_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterActuator_InputKey, UMLAdapterActuator_InputKey::StaticClass, TEXT("UMLAdapterActuator_InputKey"), &Z_Registration_Info_UClass_UMLAdapterActuator_InputKey, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterActuator_InputKey), 801956067U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Actuators_MLAdapterActuator_InputKey_h_1793885200(TEXT("/Script/MLAdapter"),
