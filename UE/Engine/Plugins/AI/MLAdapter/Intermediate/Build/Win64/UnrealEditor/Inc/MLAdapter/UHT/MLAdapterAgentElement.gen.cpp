...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterAgentElement_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UMLAdapterAgentElement_Statics::NewProp_ElementID = { "ElementID", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterAgentElement, ElementID), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterAgentElement_Statics::NewProp_ElementID_MetaData), Z_Construct_UClass_UMLAdapterAgentElement_Statics::NewProp_ElementID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMLAdapterAgentElement_Statics::NewProp_Nickname = { "Nickname", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterAgentElement, Nickname), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterAgentElement_Statics::NewProp_Nickname_MetaData), Z_Construct_UClass_UMLAdapterAgentElement_Statics::NewProp_Nickname_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterAgentElement_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterAgentElement_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterAgentElement_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterAgentElement_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Agents_MLAdapterAgentElement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterAgentElement, UMLAdapterAgentElement::StaticClass, TEXT("UMLAdapterAgentElement"), &Z_Registration_Info_UClass_UMLAdapterAgentElement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterAgentElement), 3473622916U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Agents_MLAdapterAgentElement_h_580290447(TEXT("/Script/MLAdapter"),
