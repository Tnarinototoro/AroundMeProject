...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MLAdapter_EMLAdapterServerMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MLAdapter_EMLAdapterServerMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MLAdapter_EMLAdapterServerMode_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterManager_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_Session = { "Session", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterManager, Session), Z_Construct_UClass_UMLAdapterSession_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_Session_MetaData), Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_Session_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_LastActiveWorld_MetaData[] = {
		{ "ModuleRelativePath", "Public/Managers/MLAdapterManager.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_LastActiveWorld = { "LastActiveWorld", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterManager, LastActiveWorld), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_LastActiveWorld_MetaData), Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_LastActiveWorld_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_Librarian_MetaData[] = {
		{ "ModuleRelativePath", "Public/Managers/MLAdapterManager.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_Librarian = { "Librarian", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterManager, Librarian), Z_Construct_UScriptStruct_FMLAdapterLibrarian, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_Librarian_MetaData), Z_Construct_UClass_UMLAdapterManager_Statics::NewProp_Librarian_MetaData) }; // 3768668385
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterManager_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterManager_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterManager_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterManager_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Managers_MLAdapterManager_h_Statics::EnumInfo[] = {
		{ EMLAdapterServerMode_StaticEnum, TEXT("EMLAdapterServerMode"), &Z_Registration_Info_UEnum_EMLAdapterServerMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2144554276U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Managers_MLAdapterManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterManager, UMLAdapterManager::StaticClass, TEXT("UMLAdapterManager"), &Z_Registration_Info_UClass_UMLAdapterManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterManager), 3401495351U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Managers_MLAdapterManager_h_1914204159(TEXT("/Script/MLAdapter"),
