...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_HeadingRotator = { "HeadingRotator", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterActuator_Camera, HeadingRotator), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_HeadingRotator_MetaData), Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_HeadingRotator_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_HeadingVector = { "HeadingVector", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterActuator_Camera, HeadingVector), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_HeadingVector_MetaData), Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_HeadingVector_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bConsumeData = { "bConsumeData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UMLAdapterActuator_Camera), &Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bConsumeData_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bConsumeData_MetaData), Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bConsumeData_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bVectorMode = { "bVectorMode", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UMLAdapterActuator_Camera), &Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bVectorMode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bVectorMode_MetaData), Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::NewProp_bVectorMode_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterActuator_Camera_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Actuators_MLAdapterActuator_Camera_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterActuator_Camera, UMLAdapterActuator_Camera::StaticClass, TEXT("UMLAdapterActuator_Camera"), &Z_Registration_Info_UClass_UMLAdapterActuator_Camera, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterActuator_Camera), 1294716213U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Actuators_MLAdapterActuator_Camera_h_1098812718(TEXT("/Script/MLAdapter"),
