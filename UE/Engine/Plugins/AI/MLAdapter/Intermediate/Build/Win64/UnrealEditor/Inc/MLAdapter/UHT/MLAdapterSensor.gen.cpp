...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MLAdapter_EMLAdapterTickPolicy_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MLAdapter_EMLAdapterTickPolicy_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MLAdapter_EMLAdapterTickPolicy_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bRequiresPawn = { "bRequiresPawn", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UMLAdapterSensor), &Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bRequiresPawn_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bRequiresPawn_MetaData), Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bRequiresPawn_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bIsPolling = { "bIsPolling", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UMLAdapterSensor), &Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bIsPolling_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bIsPolling_MetaData), Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_bIsPolling_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_TickPolicy = { "TickPolicy", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSensor, TickPolicy), Z_Construct_UEnum_MLAdapter_EMLAdapterTickPolicy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_TickPolicy_MetaData), Z_Construct_UClass_UMLAdapterSensor_Statics::NewProp_TickPolicy_MetaData) }; // 1972376621
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterSensor_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterSensor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_h_Statics::EnumInfo[] = {
		{ EMLAdapterTickPolicy_StaticEnum, TEXT("EMLAdapterTickPolicy"), &Z_Registration_Info_UEnum_EMLAdapterTickPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1972376621U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterSensor, UMLAdapterSensor::StaticClass, TEXT("UMLAdapterSensor"), &Z_Registration_Info_UClass_UMLAdapterSensor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterSensor), 836695916U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_h_688226344(TEXT("/Script/MLAdapter"),
