...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteLocation = { "bAbsoluteLocation", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UMLAdapterSensor_Movement), &Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteLocation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteLocation_MetaData), Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteLocation_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteVelocity = { "bAbsoluteVelocity", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UMLAdapterSensor_Movement), &Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteVelocity_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteVelocity_MetaData), Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_bAbsoluteVelocity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_RefLocation = { "RefLocation", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSensor_Movement, RefLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_RefLocation_MetaData), Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_RefLocation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_RefVelocity = { "RefVelocity", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSensor_Movement, RefVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_RefVelocity_MetaData), Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_RefVelocity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_CurrentLocation = { "CurrentLocation", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSensor_Movement, CurrentLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_CurrentLocation_MetaData), Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_CurrentLocation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_CurrentVelocity = { "CurrentVelocity", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSensor_Movement, CurrentVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_CurrentVelocity_MetaData), Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::NewProp_CurrentVelocity_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Movement_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_Movement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterSensor_Movement, UMLAdapterSensor_Movement::StaticClass, TEXT("UMLAdapterSensor_Movement"), &Z_Registration_Info_UClass_UMLAdapterSensor_Movement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterSensor_Movement), 3070347845U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_Movement_h_288505913(TEXT("/Script/MLAdapter"),
