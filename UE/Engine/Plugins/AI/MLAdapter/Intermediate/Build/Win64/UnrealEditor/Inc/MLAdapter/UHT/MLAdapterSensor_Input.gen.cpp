...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Input_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLAdapterSensor_Input_Statics::NewProp_GameViewport = { "GameViewport", nullptr, (EPropertyFlags)0x0024080000010001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSensor_Input, GameViewport), Z_Construct_UClass_UGameViewportClient_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Input_Statics::NewProp_GameViewport_MetaData), Z_Construct_UClass_UMLAdapterSensor_Input_Statics::NewProp_GameViewport_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterSensor_Input_Statics::NewProp_bRecordKeyRelease = { "bRecordKeyRelease", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UMLAdapterSensor_Input), &Z_Construct_UClass_UMLAdapterSensor_Input_Statics::NewProp_bRecordKeyRelease_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Input_Statics::NewProp_bRecordKeyRelease_MetaData), Z_Construct_UClass_UMLAdapterSensor_Input_Statics::NewProp_bRecordKeyRelease_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterSensor_Input_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Input_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterSensor_Input_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_Input_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_Input_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterSensor_Input, UMLAdapterSensor_Input::StaticClass, TEXT("UMLAdapterSensor_Input"), &Z_Registration_Info_UClass_UMLAdapterSensor_Input, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterSensor_Input), 4253433843U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_Input_h_2875275745(TEXT("/Script/MLAdapter"),
