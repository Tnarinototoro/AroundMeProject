...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::NewProp_PerceptionComponent = { "PerceptionComponent", nullptr, (EPropertyFlags)0x0024080000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMLAdapterSensor_AIPerception, PerceptionComponent), Z_Construct_UClass_UAIPerceptionComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::NewProp_PerceptionComponent_MetaData), Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::NewProp_PerceptionComponent_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::NewProp_bSenseOnlyChanges = { "bSenseOnlyChanges", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMLAdapterSensor_AIPerception), &Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::NewProp_bSenseOnlyChanges_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::NewProp_bSenseOnlyChanges_MetaData), Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::NewProp_bSenseOnlyChanges_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::Class_MetaDataParams), Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMLAdapterSensor_AIPerception_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_AIPerception_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMLAdapterSensor_AIPerception, UMLAdapterSensor_AIPerception::StaticClass, TEXT("UMLAdapterSensor_AIPerception"), &Z_Registration_Info_UClass_UMLAdapterSensor_AIPerception, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMLAdapterSensor_AIPerception), 4090302432U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AI_MLAdapter_Source_MLAdapter_Public_Sensors_MLAdapterSensor_AIPerception_h_3655772063(TEXT("/Script/MLAdapter"),
