...
template<> GAMEPLAYCAMERAS_API UScriptStruct* StaticStruct<FPerlinNoiseShaker>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPerlinNoiseShaker_Statics::NewProp_Amplitude = { "Amplitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPerlinNoiseShaker, Amplitude), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerlinNoiseShaker_Statics::NewProp_Amplitude_MetaData), Z_Construct_UScriptStruct_FPerlinNoiseShaker_Statics::NewProp_Amplitude_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_LocationAmplitudeMultiplier = { "LocationAmplitudeMultiplier", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPerlinNoiseCameraShakePattern, LocationAmplitudeMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_LocationAmplitudeMultiplier_MetaData), Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_LocationAmplitudeMultiplier_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_Y = { "Y", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPerlinNoiseCameraShakePattern, Y), Z_Construct_UScriptStruct_FPerlinNoiseShaker, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_Y_MetaData), Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_Y_MetaData) }; // 613132629
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_RotationAmplitudeMultiplier = { "RotationAmplitudeMultiplier", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPerlinNoiseCameraShakePattern, RotationAmplitudeMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_RotationAmplitudeMultiplier_MetaData), Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_RotationAmplitudeMultiplier_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_RotationFrequencyMultiplier = { "RotationFrequencyMultiplier", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPerlinNoiseCameraShakePattern, RotationFrequencyMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_RotationFrequencyMultiplier_MetaData), Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_RotationFrequencyMultiplier_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_Pitch = { "Pitch", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPerlinNoiseCameraShakePattern, Pitch), Z_Construct_UScriptStruct_FPerlinNoiseShaker, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_Pitch_MetaData), Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_Pitch_MetaData) }; // 613132629
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_FOV = { "FOV", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPerlinNoiseCameraShakePattern, FOV), Z_Construct_UScriptStruct_FPerlinNoiseShaker, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_FOV_MetaData), Z_Construct_UClass_UPerlinNoiseCameraShakePattern_Statics::NewProp_FOV_MetaData) }; // 613132629
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_PerlinNoiseCameraShakePattern_h_Statics::ScriptStructInfo[] = {
		{ FPerlinNoiseShaker::StaticStruct, Z_Construct_UScriptStruct_FPerlinNoiseShaker_Statics::NewStructOps, TEXT("PerlinNoiseShaker"), &Z_Registration_Info_UScriptStruct_PerlinNoiseShaker, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerlinNoiseShaker), 613132629U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_PerlinNoiseCameraShakePattern_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPerlinNoiseCameraShakePattern, UPerlinNoiseCameraShakePattern::StaticClass, TEXT("UPerlinNoiseCameraShakePattern"), &Z_Registration_Info_UClass_UPerlinNoiseCameraShakePattern, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPerlinNoiseCameraShakePattern), 3906814607U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_PerlinNoiseCameraShakePattern_h_925189745(TEXT("/Script/GameplayCameras"),
