...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FNiagaraInputExposureOptions>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bExposed_MetaData[] = {
		{ "Category", "Exposure" },
		{ "Comment", "/** If true then this is exposed as an input to it's caller - turning this off makes sense when the input is defined in a function script and should not be visible to the caller. */" },
		{ "DisplayName", "Expose Input" },
		{ "ModuleRelativePath", "Public/NiagaraNodeInput.h" },
		{ "ToolTip", "If true then this is exposed as an input to it's caller - turning this off makes sense when the input is defined in a function script and should not be visible to the caller." },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bExposed = { "bExposed", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FNiagaraInputExposureOptions), &Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bExposed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bExposed_MetaData), Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bExposed_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bRequired_MetaData[] = {
		{ "Category", "Exposure" },
		{ "Comment", "/** If true then this input is required to be set by the caller. For optional values (e.g. values behind an edit condition) this can be set to false, so the translator uses the default value instead. */" },
		{ "DisplayName", "Suppress Default Value" },
		{ "editcondition", "bExposed" },
		{ "ModuleRelativePath", "Public/NiagaraNodeInput.h" },
		{ "ToolTip", "If true then this input is required to be set by the caller. For optional values (e.g. values behind an edit condition) this can be set to false, so the translator uses the default value instead." },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bRequired = { "bRequired", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FNiagaraInputExposureOptions), &Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bRequired_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bRequired_MetaData), Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bRequired_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bCanAutoBind = { "bCanAutoBind", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FNiagaraInputExposureOptions), &Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bCanAutoBind_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bCanAutoBind_MetaData), Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bCanAutoBind_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bHidden_MetaData[] = {
		{ "Category", "Exposure" },
		{ "Comment", "/** If true then this input will be shown in the advanced pin section of the caller node. Only works in function scripts, does nothing in dynamic inputs or module scripts. */" },
		{ "DisplayName", "Advanced Display" },
		{ "editcondition", "bExposed" },
		{ "ModuleRelativePath", "Public/NiagaraNodeInput.h" },
		{ "ToolTip", "If true then this input will be shown in the advanced pin section of the caller node. Only works in function scripts, does nothing in dynamic inputs or module scripts." },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bHidden = { "bHidden", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FNiagaraInputExposureOptions), &Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bHidden_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bHidden_MetaData), Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::NewProp_bHidden_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraInputExposureOptions_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_Input = { "Input", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeInput, Input), Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_Input_MetaData), Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_Input_MetaData) }; // 2677688088
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_Usage = { "Usage", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeInput, Usage), Z_Construct_UEnum_Niagara_ENiagaraInputNodeUsage, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_Usage_MetaData), Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_Usage_MetaData) }; // 4228149925
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_CallSortPriority = { "CallSortPriority", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeInput, CallSortPriority), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_CallSortPriority_MetaData), Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_CallSortPriority_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ExposureOptions_MetaData[] = {
		...
		{ "EditCondition", "Usage == ENiagaraInputNodeUsage::Parameter" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/NiagaraNodeInput.h" },
		{ "ToolTip", "Controls this inputs exposure to callers." },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ExposureOptions = { "ExposureOptions", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeInput, ExposureOptions), Z_Construct_UScriptStruct_FNiagaraInputExposureOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ExposureOptions_MetaData), Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ExposureOptions_MetaData) }; // 3010103985
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_DataInterface = { "DataInterface", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeInput, DataInterface), Z_Construct_UClass_UNiagaraDataInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_DataInterface_MetaData), Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_DataInterface_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ObjectAsset_MetaData[] = {
		{ "CompileHashObjectPath", "true" },
		{ "ModuleRelativePath", "Public/NiagaraNodeInput.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ObjectAsset = { "ObjectAsset", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeInput, ObjectAsset), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ObjectAsset_MetaData), Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ObjectAsset_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNiagaraNodeInput_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraNodeInput_Statics::NewProp_ObjectAsset,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeInput_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeInput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeInput_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeInput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeInput, UNiagaraNodeInput::StaticClass, TEXT("UNiagaraNodeInput"), &Z_Registration_Info_UClass_UNiagaraNodeInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeInput), 849709312U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeInput_h_1237298185(TEXT("/Script/NiagaraEditor"),
