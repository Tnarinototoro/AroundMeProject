...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_FunctionName = { "FunctionName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNDIDataChannelFunctionInfo, FunctionName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_FunctionName_MetaData), Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_FunctionName_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_Inputs = { "Inputs", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNDIDataChannelFunctionInfo, Inputs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_Inputs_MetaData), Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_Inputs_MetaData) }; // 1312662782
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_Outputs = { "Outputs", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNDIDataChannelFunctionInfo, Outputs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_Outputs_MetaData), Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewProp_Outputs_MetaData) }; // 1312662782
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNDIDataChannel_GPUScriptParameterAccessInfo_Statics::NewProp_SortedParameters = { "SortedParameters", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNDIDataChannel_GPUScriptParameterAccessInfo, SortedParameters), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNDIDataChannel_GPUScriptParameterAccessInfo_Statics::NewProp_SortedParameters_MetaData), Z_Construct_UScriptStruct_FNDIDataChannel_GPUScriptParameterAccessInfo_Statics::NewProp_SortedParameters_MetaData) }; // 1312662782
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNDIDataChannelCompiledData>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceDataChannelCommon_h_Statics::EnumInfo[] = {
		{ ENiagaraDataChannelAllocationMode_StaticEnum, TEXT("ENiagaraDataChannelAllocationMode"), &Z_Registration_Info_UEnum_ENiagaraDataChannelAllocationMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2080219462U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceDataChannelCommon_h_Statics::ScriptStructInfo[] = {
		{ FNDIDataChannelFunctionInfo::StaticStruct, Z_Construct_UScriptStruct_FNDIDataChannelFunctionInfo_Statics::NewStructOps, TEXT("NDIDataChannelFunctionInfo"), &Z_Registration_Info_UScriptStruct_NDIDataChannelFunctionInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNDIDataChannelFunctionInfo), 2630297590U) },
		{ FNDIDataChannel_GPUScriptParameterAccessInfo::StaticStruct, Z_Construct_UScriptStruct_FNDIDataChannel_GPUScriptParameterAccessInfo_Statics::NewStructOps, TEXT("NDIDataChannel_GPUScriptParameterAccessInfo"), &Z_Registration_Info_UScriptStruct_NDIDataChannel_GPUScriptParameterAccessInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNDIDataChannel_GPUScriptParameterAccessInfo), 3854798652U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceDataChannelCommon_h_3284173885(TEXT("/Script/Niagara"),
		nullptr, 0,
