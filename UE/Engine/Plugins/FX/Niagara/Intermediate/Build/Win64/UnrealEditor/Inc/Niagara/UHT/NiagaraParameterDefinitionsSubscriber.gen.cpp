...
template<> NIAGARA_API UScriptStruct* StaticStruct<FParameterDefinitionsSubscription>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_Definitions = { "Definitions", nullptr, (EPropertyFlags)0x0014000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FParameterDefinitionsSubscription, Definitions), Z_Construct_UClass_UNiagaraParameterDefinitionsBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_Definitions_MetaData), Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_Definitions_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_CachedChangeIdHash = { "CachedChangeIdHash", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FParameterDefinitionsSubscription, CachedChangeIdHash), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_CachedChangeIdHash_MetaData), Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_CachedChangeIdHash_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraParameterDefinitionsSubscriber_h_Statics::ScriptStructInfo[] = {
		{ FParameterDefinitionsSubscription::StaticStruct, Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewStructOps, TEXT("ParameterDefinitionsSubscription"), &Z_Registration_Info_UScriptStruct_ParameterDefinitionsSubscription, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FParameterDefinitionsSubscription), 2003788831U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraParameterDefinitionsSubscriber_h_3951526447(TEXT("/Script/Niagara"),
		nullptr, 0,
