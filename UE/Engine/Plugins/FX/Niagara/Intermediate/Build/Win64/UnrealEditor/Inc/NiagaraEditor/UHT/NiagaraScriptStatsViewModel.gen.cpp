...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::NewProp_EnabledPlatforms_Inner = { "EnabledPlatforms", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::NewProp_EnabledPlatforms = { "EnabledPlatforms", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraScripStatsViewModelSettings, EnabledPlatforms), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::NewProp_EnabledPlatforms_MetaData), Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::NewProp_EnabledPlatforms_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScripStatsViewModelSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_ViewModels_NiagaraScriptStatsViewModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraScripStatsViewModelSettings, UNiagaraScripStatsViewModelSettings::StaticClass, TEXT("UNiagaraScripStatsViewModelSettings"), &Z_Registration_Info_UClass_UNiagaraScripStatsViewModelSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraScripStatsViewModelSettings), 1431904492U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_ViewModels_NiagaraScriptStatsViewModel_h_4189150230(TEXT("/Script/NiagaraEditor"),
