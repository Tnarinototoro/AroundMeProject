...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FNiagaraAction_NewNode>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraAction_NewNode_Statics::NewProp_NodeTemplate = { "NodeTemplate", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraAction_NewNode, NodeTemplate), Z_Construct_UClass_UEdGraphNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraAction_NewNode_Statics::NewProp_NodeTemplate_MetaData), Z_Construct_UScriptStruct_FNiagaraAction_NewNode_Statics::NewProp_NodeTemplate_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraActions_h_Statics::EnumInfo[] = {
		{ ENiagaraMenuSections_StaticEnum, TEXT("ENiagaraMenuSections"), &Z_Registration_Info_UEnum_ENiagaraMenuSections, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 687610061U) },
		{ EScriptSource_StaticEnum, TEXT("EScriptSource"), &Z_Registration_Info_UEnum_EScriptSource, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1088827401U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraActions_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraActionSourceData::StaticStruct, Z_Construct_UScriptStruct_FNiagaraActionSourceData_Statics::NewStructOps, TEXT("NiagaraActionSourceData"), &Z_Registration_Info_UScriptStruct_NiagaraActionSourceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraActionSourceData), 653301685U) },
		{ FNiagaraMenuAction::StaticStruct, Z_Construct_UScriptStruct_FNiagaraMenuAction_Statics::NewStructOps, TEXT("NiagaraMenuAction"), &Z_Registration_Info_UScriptStruct_NiagaraMenuAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraMenuAction), 274968203U) },
		{ FNiagaraMenuAction_Base::StaticStruct, Z_Construct_UScriptStruct_FNiagaraMenuAction_Base_Statics::NewStructOps, TEXT("NiagaraMenuAction_Base"), &Z_Registration_Info_UScriptStruct_NiagaraMenuAction_Base, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraMenuAction_Base), 3535310522U) },
		{ FNiagaraMenuAction_Generic::StaticStruct, Z_Construct_UScriptStruct_FNiagaraMenuAction_Generic_Statics::NewStructOps, TEXT("NiagaraMenuAction_Generic"), &Z_Registration_Info_UScriptStruct_NiagaraMenuAction_Generic, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraMenuAction_Generic), 511897872U) },
		{ FNiagaraAction_NewNode::StaticStruct, Z_Construct_UScriptStruct_FNiagaraAction_NewNode_Statics::NewStructOps, TEXT("NiagaraAction_NewNode"), &Z_Registration_Info_UScriptStruct_NiagaraAction_NewNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraAction_NewNode), 594120992U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraActions_h_2505849421(TEXT("/Script/NiagaraEditor"),
		nullptr, 0,
