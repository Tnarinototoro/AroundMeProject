...
void UAsyncNiagaraCaptureSimCache::FOnCaptureComplete_DelegateWrapper(const FMulticastScriptDelegate& OnCaptureComplete, bool bSuccess)
{
	...
	DEFINE_FUNCTION(UAsyncNiagaraCaptureSimCache::execCaptureNiagaraSimCache)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(UAsyncNiagaraCaptureSimCache**)Z_Param__Result=UAsyncNiagaraCaptureSimCache::CaptureNiagaraSimCache(Z_Param_SimCache,Z_Param_CreateParameters,Z_Param_NiagaraComponent,Z_Param_CaptureParameters,Z_Param_Out_OutSimCache);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache_Statics::NewProp_CreateParameters = { "CreateParameters", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AsyncNiagaraCaptureSimCache_eventCaptureNiagaraSimCache_Parms, CreateParameters), Z_Construct_UScriptStruct_FNiagaraSimCacheCreateParameters, METADATA_PARAMS(0, nullptr) }; // 2326604867
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache_Statics::NewProp_NiagaraComponent_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache_Statics::NewProp_NiagaraComponent = { "NiagaraComponent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AsyncNiagaraCaptureSimCache_eventCaptureNiagaraSimCache_Parms, NiagaraComponent), Z_Construct_UClass_UNiagaraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache_Statics::NewProp_NiagaraComponent_MetaData), Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache_Statics::NewProp_NiagaraComponent_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache_Statics::NewProp_CaptureParameters = { "CaptureParameters", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AsyncNiagaraCaptureSimCache_eventCaptureNiagaraSimCache_Parms, CaptureParameters), Z_Construct_UScriptStruct_FNiagaraSimCacheCaptureParameters, METADATA_PARAMS(0, nullptr) }; // 2396275706
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache_Statics::Function_MetaDataParams[] = {
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCacheUntilComplete_Statics::NewProp_CreateParameters = { "CreateParameters", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AsyncNiagaraCaptureSimCache_eventCaptureNiagaraSimCacheUntilComplete_Parms, CreateParameters), Z_Construct_UScriptStruct_FNiagaraSimCacheCreateParameters, METADATA_PARAMS(0, nullptr) }; // 2326604867
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCache, "CaptureNiagaraSimCache" }, // 2857175935
		{ &Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCacheMultiFrame, "CaptureNiagaraSimCacheMultiFrame" }, // 3340007271
		{ &Z_Construct_UFunction_UAsyncNiagaraCaptureSimCache_CaptureNiagaraSimCacheUntilComplete, "CaptureNiagaraSimCacheUntilComplete" }, // 2076564975
		{ &Z_Construct_UDelegateFunction_UAsyncNiagaraCaptureSimCache_OnCaptureComplete__DelegateSignature, "OnCaptureComplete__DelegateSignature" }, // 2052790267
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureSimCache = { "CaptureSimCache", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAsyncNiagaraCaptureSimCache, CaptureSimCache), Z_Construct_UClass_UNiagaraSimCache_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureSimCache_MetaData), Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureSimCache_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureComponent = { "CaptureComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAsyncNiagaraCaptureSimCache, CaptureComponent), Z_Construct_UClass_UNiagaraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureComponent_MetaData), Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureComplete = { "CaptureComplete", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAsyncNiagaraCaptureSimCache, CaptureComplete), Z_Construct_UDelegateFunction_UAsyncNiagaraCaptureSimCache_OnCaptureComplete__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureComplete_MetaData), Z_Construct_UClass_UAsyncNiagaraCaptureSimCache_Statics::NewProp_CaptureComplete_MetaData) }; // 2052790267
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNiagaraSimCacheFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNiagaraSimCacheFunctionLibrary_CaptureNiagaraSimCacheImmediate, "CaptureNiagaraSimCacheImmediate" }, // 4197993030
		{ &Z_Construct_UFunction_UNiagaraSimCacheFunctionLibrary_CreateNiagaraSimCache, "CreateNiagaraSimCache" }, // 655912931
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSimCacheFunctionLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSimCacheFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAsyncNiagaraCaptureSimCache, UAsyncNiagaraCaptureSimCache::StaticClass, TEXT("UAsyncNiagaraCaptureSimCache"), &Z_Registration_Info_UClass_UAsyncNiagaraCaptureSimCache, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAsyncNiagaraCaptureSimCache), 3403772475U) },
		{ Z_Construct_UClass_UNiagaraSimCacheFunctionLibrary, UNiagaraSimCacheFunctionLibrary::StaticClass, TEXT("UNiagaraSimCacheFunctionLibrary"), &Z_Registration_Info_UClass_UNiagaraSimCacheFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSimCacheFunctionLibrary), 890380984U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSimCacheFunctionLibrary_h_2692001503(TEXT("/Script/Niagara"),
