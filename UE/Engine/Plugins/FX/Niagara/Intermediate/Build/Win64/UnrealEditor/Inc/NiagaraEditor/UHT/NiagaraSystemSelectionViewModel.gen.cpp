...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::NewProp_StackSelection = { "StackSelection", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraSystemSelectionViewModel, StackSelection), Z_Construct_UClass_UNiagaraStackSelection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::NewProp_StackSelection_MetaData), Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::NewProp_StackSelection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::NewProp_SelectionStackViewModel = { "SelectionStackViewModel", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraSystemSelectionViewModel, SelectionStackViewModel), Z_Construct_UClass_UNiagaraStackViewModel_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::NewProp_SelectionStackViewModel_MetaData), Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::NewProp_SelectionStackViewModel_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemSelectionViewModel_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraSystemSelectionViewModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystemSelectionViewModel, UNiagaraSystemSelectionViewModel::StaticClass, TEXT("UNiagaraSystemSelectionViewModel"), &Z_Registration_Info_UClass_UNiagaraSystemSelectionViewModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemSelectionViewModel), 3415119605U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraSystemSelectionViewModel_h_2332100575(TEXT("/Script/NiagaraEditor"),
