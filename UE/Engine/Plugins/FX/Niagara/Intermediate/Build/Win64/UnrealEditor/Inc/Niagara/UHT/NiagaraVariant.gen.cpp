...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraVariant>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Object = { "Object", nullptr, (EPropertyFlags)0x0046000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraVariant, Object), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Object_MetaData), Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Object_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface = { "DataInterface", nullptr, (EPropertyFlags)0x0046000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraVariant, DataInterface), Z_Construct_UClass_UNiagaraDataInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface_MetaData), Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Bytes = { "Bytes", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraVariant, Bytes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Bytes_MetaData), Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Bytes_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_CurrentMode = { "CurrentMode", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraVariant, CurrentMode), Z_Construct_UEnum_Niagara_ENiagaraVariantMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_CurrentMode_MetaData), Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_CurrentMode_MetaData) }; // 1388789414
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraVariant_h_Statics::EnumInfo[] = {
		{ ENiagaraVariantMode_StaticEnum, TEXT("ENiagaraVariantMode"), &Z_Registration_Info_UEnum_ENiagaraVariantMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1388789414U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraVariant_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraVariant::StaticStruct, Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewStructOps, TEXT("NiagaraVariant"), &Z_Registration_Info_UScriptStruct_NiagaraVariant, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraVariant), 2622846434U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraVariant_h_804717774(TEXT("/Script/Niagara"),
		nullptr, 0,
