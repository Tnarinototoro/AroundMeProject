...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FNiagaraStackMessage>()
{
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UNiagaraMessageDataText_Statics::NewProp_MessageText = { "MessageText", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraMessageDataText, MessageText), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraMessageDataText_Statics::NewProp_MessageText_MetaData), Z_Construct_UClass_UNiagaraMessageDataText_Statics::NewProp_MessageText_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UNiagaraMessageDataText_Statics::NewProp_ShortDescription = { "ShortDescription", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraMessageDataText, ShortDescription), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraMessageDataText_Statics::NewProp_ShortDescription_MetaData), Z_Construct_UClass_UNiagaraMessageDataText_Statics::NewProp_ShortDescription_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraMessages_h_Statics::EnumInfo[] = {
		{ ENiagaraMessageSeverity_StaticEnum, TEXT("ENiagaraMessageSeverity"), &Z_Registration_Info_UEnum_ENiagaraMessageSeverity, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2470507072U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraMessages_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraStackMessage::StaticStruct, Z_Construct_UScriptStruct_FNiagaraStackMessage_Statics::NewStructOps, TEXT("NiagaraStackMessage"), &Z_Registration_Info_UScriptStruct_NiagaraStackMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraStackMessage), 385442413U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraMessages_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraMessageData, UNiagaraMessageData::StaticClass, TEXT("UNiagaraMessageData"), &Z_Registration_Info_UClass_UNiagaraMessageData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraMessageData), 460443184U) },
		{ Z_Construct_UClass_UNiagaraMessageDataText, UNiagaraMessageDataText::StaticClass, TEXT("UNiagaraMessageDataText"), &Z_Registration_Info_UClass_UNiagaraMessageDataText, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraMessageDataText), 2402583021U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraMessages_h_2189164725(TEXT("/Script/NiagaraEditor"),
