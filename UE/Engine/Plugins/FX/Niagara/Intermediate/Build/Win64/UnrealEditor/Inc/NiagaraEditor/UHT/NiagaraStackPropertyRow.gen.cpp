...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::NewProp_CategorySpacer = { "CategorySpacer", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackPropertyRow, CategorySpacer), Z_Construct_UClass_UNiagaraStackSpacer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::NewProp_CategorySpacer_MetaData), Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::NewProp_CategorySpacer_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackPropertyRow_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackPropertyRow_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackPropertyRow, UNiagaraStackPropertyRow::StaticClass, TEXT("UNiagaraStackPropertyRow"), &Z_Registration_Info_UClass_UNiagaraStackPropertyRow, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackPropertyRow), 1689833809U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackPropertyRow_h_3473737520(TEXT("/Script/NiagaraEditor"),
