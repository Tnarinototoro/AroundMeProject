...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackItemGroup_Statics::NewProp_GroupFooter = { "GroupFooter", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackItemGroup, GroupFooter), Z_Construct_UClass_UNiagaraStackItemGroupFooter_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemGroup_Statics::NewProp_GroupFooter_MetaData), Z_Construct_UClass_UNiagaraStackItemGroup_Statics::NewProp_GroupFooter_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackItemGroup_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackItemGroup_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemGroup_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemGroupFooter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackItemGroupFooter_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemGroupFooter_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackItemGroupFooter_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackItemGroup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackItemGroup, UNiagaraStackItemGroup::StaticClass, TEXT("UNiagaraStackItemGroup"), &Z_Registration_Info_UClass_UNiagaraStackItemGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackItemGroup), 3724611493U) },
		{ Z_Construct_UClass_UNiagaraStackItemGroupFooter, UNiagaraStackItemGroupFooter::StaticClass, TEXT("UNiagaraStackItemGroupFooter"), &Z_Registration_Info_UClass_UNiagaraStackItemGroupFooter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackItemGroupFooter), 749305066U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackItemGroup_h_1091294656(TEXT("/Script/NiagaraEditor"),
