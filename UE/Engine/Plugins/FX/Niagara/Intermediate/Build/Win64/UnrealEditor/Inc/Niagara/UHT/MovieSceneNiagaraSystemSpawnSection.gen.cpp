...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability = { "bAllowScalability", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMovieSceneNiagaraSystemSpawnSection), &Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability_MetaData), Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_MovieScene_MovieSceneNiagaraSystemSpawnSection_h_Statics::EnumInfo[] = {
		{ ENiagaraSystemSpawnSectionStartBehavior_StaticEnum, TEXT("ENiagaraSystemSpawnSectionStartBehavior"), &Z_Registration_Info_UEnum_ENiagaraSystemSpawnSectionStartBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3438191853U) },
		{ ENiagaraSystemSpawnSectionEvaluateBehavior_StaticEnum, TEXT("ENiagaraSystemSpawnSectionEvaluateBehavior"), &Z_Registration_Info_UEnum_ENiagaraSystemSpawnSectionEvaluateBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2582673011U) },
		{ ENiagaraSystemSpawnSectionEndBehavior_StaticEnum, TEXT("ENiagaraSystemSpawnSectionEndBehavior"), &Z_Registration_Info_UEnum_ENiagaraSystemSpawnSectionEndBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2811910407U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_MovieScene_MovieSceneNiagaraSystemSpawnSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection, UMovieSceneNiagaraSystemSpawnSection::StaticClass, TEXT("UMovieSceneNiagaraSystemSpawnSection"), &Z_Registration_Info_UClass_UMovieSceneNiagaraSystemSpawnSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneNiagaraSystemSpawnSection), 64582006U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_MovieScene_MovieSceneNiagaraSystemSpawnSection_h_1375964593(TEXT("/Script/Niagara"),
