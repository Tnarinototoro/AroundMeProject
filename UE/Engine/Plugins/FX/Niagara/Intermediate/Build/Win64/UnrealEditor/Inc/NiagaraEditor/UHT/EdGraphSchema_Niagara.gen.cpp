...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraSchemaAction_NewNode_Statics::NewProp_NodeTemplate = { "NodeTemplate", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraSchemaAction_NewNode, NodeTemplate), Z_Construct_UClass_UEdGraphNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraSchemaAction_NewNode_Statics::NewProp_NodeTemplate_MetaData), Z_Construct_UScriptStruct_FNiagaraSchemaAction_NewNode_Statics::NewProp_NodeTemplate_MetaData) };
#if WITH_METADATA
...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FNiagaraSchemaAction_NewComment>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_EdGraphSchema_Niagara_h_Statics::ScriptStructInfo[] = {
		...
		{ FNiagaraSchemaAction_NewComment::StaticStruct, Z_Construct_UScriptStruct_FNiagaraSchemaAction_NewComment_Statics::NewStructOps, TEXT("NiagaraSchemaAction_NewComment"), &Z_Registration_Info_UScriptStruct_NiagaraSchemaAction_NewComment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraSchemaAction_NewComment), 1250058376U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_EdGraphSchema_Niagara_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEdGraphSchema_Niagara, UEdGraphSchema_Niagara::StaticClass, TEXT("UEdGraphSchema_Niagara"), &Z_Registration_Info_UClass_UEdGraphSchema_Niagara, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEdGraphSchema_Niagara), 148805553U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_EdGraphSchema_Niagara_h_51119338(TEXT("/Script/NiagaraEditor"),
