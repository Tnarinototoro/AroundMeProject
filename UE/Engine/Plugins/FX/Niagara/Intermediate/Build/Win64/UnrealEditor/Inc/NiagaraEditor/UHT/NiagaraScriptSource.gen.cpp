...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptSource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraScriptSource_Statics::NewProp_NodeGraph = { "NodeGraph", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraScriptSource, NodeGraph), Z_Construct_UClass_UNiagaraGraph_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptSource_Statics::NewProp_NodeGraph_MetaData), Z_Construct_UClass_UNiagaraScriptSource_Statics::NewProp_NodeGraph_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraScriptSource_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptSource_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraScriptSource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptSource_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraScriptSource, UNiagaraScriptSource::StaticClass, TEXT("UNiagaraScriptSource"), &Z_Registration_Info_UClass_UNiagaraScriptSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraScriptSource), 1133141957U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptSource_h_3954940549(TEXT("/Script/NiagaraEditor"),
