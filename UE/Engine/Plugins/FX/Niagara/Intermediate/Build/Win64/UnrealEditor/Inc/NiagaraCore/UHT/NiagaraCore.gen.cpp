...
template<> NIAGARACORE_API UScriptStruct* StaticStruct<FNiagaraVariableCommonReference>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraVariableCommonReference_Statics::NewProp_UnderlyingType = { "UnderlyingType", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraVariableCommonReference, UnderlyingType), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariableCommonReference_Statics::NewProp_UnderlyingType_MetaData), Z_Construct_UScriptStruct_FNiagaraVariableCommonReference_Statics::NewProp_UnderlyingType_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraCore_Public_NiagaraCore_h_Statics::EnumInfo[] = {
		{ ENiagaraIterationSource_StaticEnum, TEXT("ENiagaraIterationSource"), &Z_Registration_Info_UEnum_ENiagaraIterationSource, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 516783190U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraCore_Public_NiagaraCore_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraVariableCommonReference::StaticStruct, Z_Construct_UScriptStruct_FNiagaraVariableCommonReference_Statics::NewStructOps, TEXT("NiagaraVariableCommonReference"), &Z_Registration_Info_UScriptStruct_NiagaraVariableCommonReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraVariableCommonReference), 473126246U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraCore_Public_NiagaraCore_h_522075408(TEXT("/Script/NiagaraCore"),
		nullptr, 0,
