...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSystemFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSystemFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraSystemFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystemFactoryNew, UNiagaraSystemFactoryNew::StaticClass, TEXT("UNiagaraSystemFactoryNew"), &Z_Registration_Info_UClass_UNiagaraSystemFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemFactoryNew), 118566340U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraSystemFactoryNew_h_741233798(TEXT("/Script/NiagaraEditor"),
