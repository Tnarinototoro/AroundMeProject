...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FNiagaraVariableMetaDataContainer>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::NewProp_MetaData = { "MetaData", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraVariableMetaDataContainer, MetaData), Z_Construct_UScriptStruct_FNiagaraVariableMetaData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::NewProp_MetaData_MetaData), Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::NewProp_MetaData_MetaData) }; // 3048711213
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Customizations_NiagaraMetaDataCustomNodeBuilder_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraVariableMetaDataContainer::StaticStruct, Z_Construct_UScriptStruct_FNiagaraVariableMetaDataContainer_Statics::NewStructOps, TEXT("NiagaraVariableMetaDataContainer"), &Z_Registration_Info_UScriptStruct_NiagaraVariableMetaDataContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraVariableMetaDataContainer), 3302929928U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Customizations_NiagaraMetaDataCustomNodeBuilder_h_1573403853(TEXT("/Script/NiagaraEditor"),
		nullptr, 0,
