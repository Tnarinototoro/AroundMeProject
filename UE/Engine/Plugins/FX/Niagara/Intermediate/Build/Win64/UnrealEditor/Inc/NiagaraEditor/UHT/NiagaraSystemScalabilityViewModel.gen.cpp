...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemScalabilityViewModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSystemScalabilityViewModel_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemScalabilityViewModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSystemScalabilityViewModel_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraSystemScalabilityViewModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystemScalabilityViewModel, UNiagaraSystemScalabilityViewModel::StaticClass, TEXT("UNiagaraSystemScalabilityViewModel"), &Z_Registration_Info_UClass_UNiagaraSystemScalabilityViewModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemScalabilityViewModel), 3758447077U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraSystemScalabilityViewModel_h_2487251295(TEXT("/Script/NiagaraEditor"),
