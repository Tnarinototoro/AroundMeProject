...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceLandscape_h_Statics::EnumInfo[] = {
		{ ENDILandscape_SourceMode_StaticEnum, TEXT("ENDILandscape_SourceMode"), &Z_Registration_Info_UEnum_ENDILandscape_SourceMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3538765614U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceLandscape_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceLandscape, UNiagaraDataInterfaceLandscape::StaticClass, TEXT("UNiagaraDataInterfaceLandscape"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceLandscape, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceLandscape), 856872428U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceLandscape_h_831762558(TEXT("/Script/Niagara"),
