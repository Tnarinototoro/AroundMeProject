...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackItem_Statics::NewProp_ItemFooter = { "ItemFooter", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackItem, ItemFooter), Z_Construct_UClass_UNiagaraStackItemFooter_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItem_Statics::NewProp_ItemFooter_MetaData), Z_Construct_UClass_UNiagaraStackItem_Statics::NewProp_ItemFooter_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackItem_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItem_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackItem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItem_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemContent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackItemContent_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemContent_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackItemContent_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemTextContent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackItemTextContent_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemTextContent_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackItemTextContent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackItem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackItem, UNiagaraStackItem::StaticClass, TEXT("UNiagaraStackItem"), &Z_Registration_Info_UClass_UNiagaraStackItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackItem), 558287474U) },
		{ Z_Construct_UClass_UNiagaraStackItemContent, UNiagaraStackItemContent::StaticClass, TEXT("UNiagaraStackItemContent"), &Z_Registration_Info_UClass_UNiagaraStackItemContent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackItemContent), 1490381309U) },
		{ Z_Construct_UClass_UNiagaraStackItemTextContent, UNiagaraStackItemTextContent::StaticClass, TEXT("UNiagaraStackItemTextContent"), &Z_Registration_Info_UClass_UNiagaraStackItemTextContent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackItemTextContent), 1227730893U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackItem_h_1192821669(TEXT("/Script/NiagaraEditor"),
