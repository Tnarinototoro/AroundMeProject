...
#include "../Private/NiagaraAsyncCompile.h"
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FEmitterCompiledScriptPair>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_NiagaraAsyncCompile_h_Statics::EnumInfo[] = {
		{ ENiagaraCompilationState_StaticEnum, TEXT("ENiagaraCompilationState"), &Z_Registration_Info_UEnum_ENiagaraCompilationState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 945075720U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_NiagaraAsyncCompile_h_Statics::ScriptStructInfo[] = {
		{ FEmitterCompiledScriptPair::StaticStruct, Z_Construct_UScriptStruct_FEmitterCompiledScriptPair_Statics::NewStructOps, TEXT("EmitterCompiledScriptPair"), &Z_Registration_Info_UScriptStruct_EmitterCompiledScriptPair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEmitterCompiledScriptPair), 2616810995U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_NiagaraAsyncCompile_h_445321088(TEXT("/Script/Niagara"),
		nullptr, 0,
