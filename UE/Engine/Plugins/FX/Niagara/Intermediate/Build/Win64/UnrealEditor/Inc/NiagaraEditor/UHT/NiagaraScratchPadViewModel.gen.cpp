...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScratchPadViewModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraScratchPadViewModel_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScratchPadViewModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraScratchPadViewModel_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraScratchPadViewModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraScratchPadViewModel, UNiagaraScratchPadViewModel::StaticClass, TEXT("UNiagaraScratchPadViewModel"), &Z_Registration_Info_UClass_UNiagaraScratchPadViewModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraScratchPadViewModel), 467430991U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraScratchPadViewModel_h_614462343(TEXT("/Script/NiagaraEditor"),
