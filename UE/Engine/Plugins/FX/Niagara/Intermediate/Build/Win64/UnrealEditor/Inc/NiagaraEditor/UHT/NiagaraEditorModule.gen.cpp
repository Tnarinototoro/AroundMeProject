...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FReservedParameter_Statics::NewProp_Parameter = { "Parameter", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FReservedParameter, Parameter), Z_Construct_UScriptStruct_FNiagaraVariableBase, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReservedParameter_Statics::NewProp_Parameter_MetaData), Z_Construct_UScriptStruct_FReservedParameter_Statics::NewProp_Parameter_MetaData) }; // 1312662782
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FReservedParameter_Statics::NewProp_ReservingDefinitionsAsset = { "ReservingDefinitionsAsset", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FReservedParameter, ReservingDefinitionsAsset), Z_Construct_UClass_UNiagaraParameterDefinitions_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReservedParameter_Statics::NewProp_ReservingDefinitionsAsset_MetaData), Z_Construct_UScriptStruct_FReservedParameter_Statics::NewProp_ReservingDefinitionsAsset_MetaData) };
...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FNiagaraRendererCreationInfo>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraEditorModule_h_Statics::ScriptStructInfo[] = {
		{ FReservedParameter::StaticStruct, Z_Construct_UScriptStruct_FReservedParameter_Statics::NewStructOps, TEXT("ReservedParameter"), &Z_Registration_Info_UScriptStruct_ReservedParameter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FReservedParameter), 4130533177U) },
		{ FNiagaraRendererCreationInfo::StaticStruct, Z_Construct_UScriptStruct_FNiagaraRendererCreationInfo_Statics::NewStructOps, TEXT("NiagaraRendererCreationInfo"), &Z_Registration_Info_UScriptStruct_NiagaraRendererCreationInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraRendererCreationInfo), 3230031629U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraEditorModule_h_2566023592(TEXT("/Script/NiagaraEditor"),
		nullptr, 0,
