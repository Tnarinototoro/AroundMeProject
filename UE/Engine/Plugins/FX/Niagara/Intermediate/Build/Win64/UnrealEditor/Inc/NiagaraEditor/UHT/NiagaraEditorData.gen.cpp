...
// End Cross Module References
...
#endif
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraEditorParametersAdapter_Statics::NewProp_EditorOnlyScriptVars_Inner = { "EditorOnlyScriptVars", nullptr, (EPropertyFlags)0x0004000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNiagaraScriptVariable_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraEditorParametersAdapter_Statics::NewProp_EditorOnlyScriptVars = { "EditorOnlyScriptVars", nullptr, (EPropertyFlags)0x0044000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraEditorParametersAdapter, EditorOnlyScriptVars), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEditorParametersAdapter_Statics::NewProp_EditorOnlyScriptVars_MetaData), Z_Construct_UClass_UNiagaraEditorParametersAdapter_Statics::NewProp_EditorOnlyScriptVars_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraEditorData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraEditorParametersAdapter, UNiagaraEditorParametersAdapter::StaticClass, TEXT("UNiagaraEditorParametersAdapter"), &Z_Registration_Info_UClass_UNiagaraEditorParametersAdapter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraEditorParametersAdapter), 1631965407U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraEditorData_h_1028278351(TEXT("/Script/NiagaraEditor"),
