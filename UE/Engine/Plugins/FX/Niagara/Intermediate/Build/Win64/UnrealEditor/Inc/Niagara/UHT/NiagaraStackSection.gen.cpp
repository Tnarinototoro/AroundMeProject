...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraStackSection>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraStackSection_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraStackSection::StaticStruct, Z_Construct_UScriptStruct_FNiagaraStackSection_Statics::NewStructOps, TEXT("NiagaraStackSection"), &Z_Registration_Info_UScriptStruct_NiagaraStackSection, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraStackSection), 1637905884U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraStackSection_h_1188886575(TEXT("/Script/Niagara"),
		nullptr, 0,
