...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeSelect_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeSelect_Statics::NewProp_SelectorPinType = { "SelectorPinType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeSelect, SelectorPinType), Z_Construct_UScriptStruct_FNiagaraTypeDefinition, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeSelect_Statics::NewProp_SelectorPinType_MetaData), Z_Construct_UClass_UNiagaraNodeSelect_Statics::NewProp_SelectorPinType_MetaData) }; // 649372411
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeSelect_Statics::NewProp_SelectorPinGuid = { "SelectorPinGuid", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeSelect, SelectorPinGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeSelect_Statics::NewProp_SelectorPinGuid_MetaData), Z_Construct_UClass_UNiagaraNodeSelect_Statics::NewProp_SelectorPinGuid_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeSelect_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeSelect_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeSelect_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeSelect_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeSelect_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeSelect, UNiagaraNodeSelect::StaticClass, TEXT("UNiagaraNodeSelect"), &Z_Registration_Info_UClass_UNiagaraNodeSelect, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeSelect), 2157492378U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeSelect_h_146618875(TEXT("/Script/NiagaraEditor"),
