...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::NewProp_SimulationStageObject = { "SimulationStageObject", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackSimulationStagePropertiesItem, SimulationStageObject), Z_Construct_UClass_UNiagaraStackObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::NewProp_SimulationStageObject_MetaData), Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::NewProp_SimulationStageObject_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::NewProp_SimulationStageProperties = { "SimulationStageProperties", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackSimulationStageGroup, SimulationStageProperties), Z_Construct_UClass_UNiagaraStackSimulationStagePropertiesItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::NewProp_SimulationStageProperties_MetaData), Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::NewProp_SimulationStageProperties_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSimulationStageGroup_Statics::PropPointers) < 2048);
