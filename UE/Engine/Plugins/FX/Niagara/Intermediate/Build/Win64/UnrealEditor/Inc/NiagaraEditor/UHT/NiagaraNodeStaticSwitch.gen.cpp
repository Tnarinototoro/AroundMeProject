...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NiagaraEditor_ENiagaraStaticSwitchType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NiagaraEditor_ENiagaraStaticSwitchType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NiagaraEditor_ENiagaraStaticSwitchType_Statics::Enum_MetaDataParams)
	};
...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FStaticSwitchTypeData>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_SwitchType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_SwitchType = { "SwitchType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStaticSwitchTypeData, SwitchType), Z_Construct_UEnum_NiagaraEditor_ENiagaraStaticSwitchType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_SwitchType_MetaData), Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_SwitchType_MetaData) }; // 1968212016
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_Enum = { "Enum", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStaticSwitchTypeData, Enum), Z_Construct_UClass_UEnum, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_Enum_MetaData), Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_Enum_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_SwitchConstant = { "SwitchConstant", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStaticSwitchTypeData, SwitchConstant), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_SwitchConstant_MetaData), Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_SwitchConstant_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bAutoRefreshEnabled = { "bAutoRefreshEnabled", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FStaticSwitchTypeData), &Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bAutoRefreshEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bAutoRefreshEnabled_MetaData), Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bAutoRefreshEnabled_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bExposeAsPin = { "bExposeAsPin", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FStaticSwitchTypeData), &Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bExposeAsPin_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bExposeAsPin_MetaData), Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewProp_bExposeAsPin_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::NewProp_InputParameterName = { "InputParameterName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeStaticSwitch, InputParameterName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::NewProp_InputParameterName_MetaData), Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::NewProp_InputParameterName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::NewProp_SwitchTypeData = { "SwitchTypeData", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeStaticSwitch, SwitchTypeData), Z_Construct_UScriptStruct_FStaticSwitchTypeData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::NewProp_SwitchTypeData_MetaData), Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::NewProp_SwitchTypeData_MetaData) }; // 3901667500
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeStaticSwitch_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeStaticSwitch_h_Statics::EnumInfo[] = {
		{ ENiagaraStaticSwitchType_StaticEnum, TEXT("ENiagaraStaticSwitchType"), &Z_Registration_Info_UEnum_ENiagaraStaticSwitchType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1968212016U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeStaticSwitch_h_Statics::ScriptStructInfo[] = {
		{ FStaticSwitchTypeData::StaticStruct, Z_Construct_UScriptStruct_FStaticSwitchTypeData_Statics::NewStructOps, TEXT("StaticSwitchTypeData"), &Z_Registration_Info_UScriptStruct_StaticSwitchTypeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStaticSwitchTypeData), 3901667500U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeStaticSwitch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeStaticSwitch, UNiagaraNodeStaticSwitch::StaticClass, TEXT("UNiagaraNodeStaticSwitch"), &Z_Registration_Info_UClass_UNiagaraNodeStaticSwitch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeStaticSwitch), 2229579774U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeStaticSwitch_h_2565590396(TEXT("/Script/NiagaraEditor"),
