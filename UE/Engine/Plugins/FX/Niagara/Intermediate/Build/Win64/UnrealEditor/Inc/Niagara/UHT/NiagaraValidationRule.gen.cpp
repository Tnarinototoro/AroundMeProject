...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraValidationRule_h_Statics::EnumInfo[] = {
		{ ENiagaraValidationSeverity_StaticEnum, TEXT("ENiagaraValidationSeverity"), &Z_Registration_Info_UEnum_ENiagaraValidationSeverity, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 380690410U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraValidationRule_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraValidationRule, UNiagaraValidationRule::StaticClass, TEXT("UNiagaraValidationRule"), &Z_Registration_Info_UClass_UNiagaraValidationRule, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraValidationRule), 2198165716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraValidationRule_h_191521840(TEXT("/Script/Niagara"),
