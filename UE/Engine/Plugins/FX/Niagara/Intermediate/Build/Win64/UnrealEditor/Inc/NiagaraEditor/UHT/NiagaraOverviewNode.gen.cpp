...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraOverviewNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraOverviewNode_Statics::NewProp_OwningSystem = { "OwningSystem", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraOverviewNode, OwningSystem), Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraOverviewNode_Statics::NewProp_OwningSystem_MetaData), Z_Construct_UClass_UNiagaraOverviewNode_Statics::NewProp_OwningSystem_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraOverviewNode_Statics::NewProp_EmitterHandleGuid = { "EmitterHandleGuid", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraOverviewNode, EmitterHandleGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraOverviewNode_Statics::NewProp_EmitterHandleGuid_MetaData), Z_Construct_UClass_UNiagaraOverviewNode_Statics::NewProp_EmitterHandleGuid_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraOverviewNode_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraOverviewNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraOverviewNode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraOverviewNode_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraOverviewNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraOverviewNode, UNiagaraOverviewNode::StaticClass, TEXT("UNiagaraOverviewNode"), &Z_Registration_Info_UClass_UNiagaraOverviewNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraOverviewNode), 2957913323U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraOverviewNode_h_3492801000(TEXT("/Script/NiagaraEditor"),
