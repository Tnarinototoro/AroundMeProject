...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayerSettings_Statics::NewProp_Concurrency = { "Concurrency", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceAudioPlayerSettings, Concurrency), Z_Construct_UClass_USoundConcurrency_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayerSettings_Statics::NewProp_Concurrency_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayerSettings_Statics::NewProp_Concurrency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_Attenuation = { "Attenuation", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceAudioPlayer, Attenuation), Z_Construct_UClass_USoundAttenuation_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_Attenuation_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_Attenuation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_Concurrency = { "Concurrency", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceAudioPlayer, Concurrency), Z_Construct_UClass_USoundConcurrency_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_Concurrency_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_Concurrency_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_ConfigurationUserParameter = { "ConfigurationUserParameter", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceAudioPlayer, ConfigurationUserParameter), Z_Construct_UScriptStruct_FNiagaraUserParameterBinding, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_ConfigurationUserParameter_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer_Statics::NewProp_ConfigurationUserParameter_MetaData) }; // 4146958699
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceAudioPlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayerSettings, UNiagaraDataInterfaceAudioPlayerSettings::StaticClass, TEXT("UNiagaraDataInterfaceAudioPlayerSettings"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceAudioPlayerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceAudioPlayerSettings), 3034060175U) },
		{ Z_Construct_UClass_UNiagaraDataInterfaceAudioPlayer, UNiagaraDataInterfaceAudioPlayer::StaticClass, TEXT("UNiagaraDataInterfaceAudioPlayer"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceAudioPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceAudioPlayer), 1481252462U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceAudioPlayer_h_853668615(TEXT("/Script/Niagara"),
