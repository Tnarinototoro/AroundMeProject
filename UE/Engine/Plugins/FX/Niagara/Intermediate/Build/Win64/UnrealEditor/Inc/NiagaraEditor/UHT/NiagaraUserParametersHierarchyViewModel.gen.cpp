...
// Cross Module References
	...
	NIAGARAEDITOR_API UClass* Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext();
	NIAGARAEDITOR_API UClass* Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_NoRegister();
...
// End Cross Module References
	void UNiagaraHierarchyUserParameterRefreshContext::StaticRegisterNativesUNiagaraHierarchyUserParameterRefreshContext()
	{
	}
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UNiagaraHierarchyUserParameterRefreshContext);
	UClass* Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_NoRegister()
	{
		return UNiagaraHierarchyUserParameterRefreshContext::StaticClass();
	}
	struct Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UNiagaraHierarchyDataRefreshContext,
		(UObject* (*)())Z_Construct_UPackage__Script_NiagaraEditor,
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::NewProp_System_MetaData[] = {
		{ "ModuleRelativePath", "Public/ViewModels/HierarchyEditor/NiagaraUserParametersHierarchyViewModel.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::NewProp_System = { "System", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraHierarchyUserParameterRefreshContext, System), Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::NewProp_System_MetaData), Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::NewProp_System_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::NewProp_System,
	};
	const FCppClassTypeInfoStatic Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UNiagaraHierarchyUserParameterRefreshContext>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::ClassParams = {
		&UNiagaraHierarchyUserParameterRefreshContext::StaticClass,
		nullptr,
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::PropPointers),
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::PropPointers) < 2048);
	UClass* Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext()
	{
		if (!Z_Registration_Info_UClass_UNiagaraHierarchyUserParameterRefreshContext.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UNiagaraHierarchyUserParameterRefreshContext.OuterSingleton, Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UNiagaraHierarchyUserParameterRefreshContext.OuterSingleton;
	}
	template<> NIAGARAEDITOR_API UClass* StaticClass<UNiagaraHierarchyUserParameterRefreshContext>()
	{
		return UNiagaraHierarchyUserParameterRefreshContext::StaticClass();
	}
	UNiagaraHierarchyUserParameterRefreshContext::UNiagaraHierarchyUserParameterRefreshContext(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UNiagaraHierarchyUserParameterRefreshContext);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::NewProp_UserParameterScriptVariable = { "UserParameterScriptVariable", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraHierarchyUserParameter, UserParameterScriptVariable), Z_Construct_UClass_UNiagaraScriptVariable_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::NewProp_UserParameterScriptVariable_MetaData), Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::NewProp_UserParameterScriptVariable_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraHierarchyUserParameter_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraUserParametersHierarchyViewModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraUserParametersHierarchyViewModel_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraUserParametersHierarchyViewModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraUserParametersHierarchyViewModel_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_HierarchyEditor_NiagaraUserParametersHierarchyViewModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraHierarchyUserParameterRefreshContext, UNiagaraHierarchyUserParameterRefreshContext::StaticClass, TEXT("UNiagaraHierarchyUserParameterRefreshContext"), &Z_Registration_Info_UClass_UNiagaraHierarchyUserParameterRefreshContext, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraHierarchyUserParameterRefreshContext), 1725371384U) },
		{ Z_Construct_UClass_UNiagaraHierarchyUserParameter, UNiagaraHierarchyUserParameter::StaticClass, TEXT("UNiagaraHierarchyUserParameter"), &Z_Registration_Info_UClass_UNiagaraHierarchyUserParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraHierarchyUserParameter), 2695350304U) },
		{ Z_Construct_UClass_UNiagaraUserParametersHierarchyViewModel, UNiagaraUserParametersHierarchyViewModel::StaticClass, TEXT("UNiagaraUserParametersHierarchyViewModel"), &Z_Registration_Info_UClass_UNiagaraUserParametersHierarchyViewModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraUserParametersHierarchyViewModel), 1574482222U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_HierarchyEditor_NiagaraUserParametersHierarchyViewModel_h_1980615488(TEXT("/Script/NiagaraEditor"),
