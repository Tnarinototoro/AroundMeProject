...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapFor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeParameterMapFor_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapFor_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeParameterMapFor_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapForWithContinue_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeParameterMapForWithContinue_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapForWithContinue_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeParameterMapForWithContinue_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapForIndex_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeParameterMapForIndex_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapForIndex_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeParameterMapForIndex_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeParameterMapFor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeParameterMapFor, UNiagaraNodeParameterMapFor::StaticClass, TEXT("UNiagaraNodeParameterMapFor"), &Z_Registration_Info_UClass_UNiagaraNodeParameterMapFor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeParameterMapFor), 2225758677U) },
		{ Z_Construct_UClass_UNiagaraNodeParameterMapForWithContinue, UNiagaraNodeParameterMapForWithContinue::StaticClass, TEXT("UNiagaraNodeParameterMapForWithContinue"), &Z_Registration_Info_UClass_UNiagaraNodeParameterMapForWithContinue, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeParameterMapForWithContinue), 124160660U) },
		{ Z_Construct_UClass_UNiagaraNodeParameterMapForIndex, UNiagaraNodeParameterMapForIndex::StaticClass, TEXT("UNiagaraNodeParameterMapForIndex"), &Z_Registration_Info_UClass_UNiagaraNodeParameterMapForIndex, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeParameterMapForIndex), 148883457U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeParameterMapFor_h_2687653678(TEXT("/Script/NiagaraEditor"),
