...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FPinGuidsForPath>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeIf_Statics::NewProp_OutputVars_Inner = { "OutputVars", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(0, nullptr) }; // 2677688088
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraNodeIf_Statics::NewProp_OutputVars = { "OutputVars", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeIf, OutputVars), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeIf_Statics::NewProp_OutputVars_MetaData), Z_Construct_UClass_UNiagaraNodeIf_Statics::NewProp_OutputVars_MetaData) }; // 2677688088
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeIf_Statics::NewProp_PathAssociatedPinGuids_Inner = { "PathAssociatedPinGuids", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPinGuidsForPath, METADATA_PARAMS(0, nullptr) }; // 4150423005
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeIf_h_Statics::ScriptStructInfo[] = {
		{ FPinGuidsForPath::StaticStruct, Z_Construct_UScriptStruct_FPinGuidsForPath_Statics::NewStructOps, TEXT("PinGuidsForPath"), &Z_Registration_Info_UScriptStruct_PinGuidsForPath, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPinGuidsForPath), 4150423005U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeIf_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeIf, UNiagaraNodeIf::StaticClass, TEXT("UNiagaraNodeIf"), &Z_Registration_Info_UClass_UNiagaraNodeIf, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeIf), 1179351497U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeIf_h_2050033255(TEXT("/Script/NiagaraEditor"),
