...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::NewProp_EventName = { "EventName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeWriteDataSet, EventName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::NewProp_EventName_MetaData), Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::NewProp_EventName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeWriteDataSet_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeWriteDataSet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeWriteDataSet, UNiagaraNodeWriteDataSet::StaticClass, TEXT("UNiagaraNodeWriteDataSet"), &Z_Registration_Info_UClass_UNiagaraNodeWriteDataSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeWriteDataSet), 380421520U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeWriteDataSet_h_1596413679(TEXT("/Script/NiagaraEditor"),
