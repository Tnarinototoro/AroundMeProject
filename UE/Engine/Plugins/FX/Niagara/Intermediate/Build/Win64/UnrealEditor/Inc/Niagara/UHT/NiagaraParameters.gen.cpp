...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraParameters>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraParameters_Statics::NewProp_Parameters_Inner = { "Parameters", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(0, nullptr) }; // 2677688088
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraParameters_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraParameters::StaticStruct, Z_Construct_UScriptStruct_FNiagaraParameters_Statics::NewStructOps, TEXT("NiagaraParameters"), &Z_Registration_Info_UScriptStruct_NiagaraParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraParameters), 2974299324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraParameters_h_3860149969(TEXT("/Script/Niagara"),
		nullptr, 0,
