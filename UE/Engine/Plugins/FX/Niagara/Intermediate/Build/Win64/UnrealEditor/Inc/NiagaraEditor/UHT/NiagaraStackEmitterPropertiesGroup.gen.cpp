...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::NewProp_PropertiesItem = { "PropertiesItem", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackEmitterPropertiesGroup, PropertiesItem), Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::NewProp_PropertiesItem_MetaData), Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::NewProp_PropertiesItem_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackEmitterPropertiesGroup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackEmitterPropertiesGroup, UNiagaraStackEmitterPropertiesGroup::StaticClass, TEXT("UNiagaraStackEmitterPropertiesGroup"), &Z_Registration_Info_UClass_UNiagaraStackEmitterPropertiesGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackEmitterPropertiesGroup), 1013300469U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackEmitterPropertiesGroup_h_703752992(TEXT("/Script/NiagaraEditor"),
