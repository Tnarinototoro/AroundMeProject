...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeReroute_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeReroute_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeReroute_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeReroute_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeReroute_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeReroute, UNiagaraNodeReroute::StaticClass, TEXT("UNiagaraNodeReroute"), &Z_Registration_Info_UClass_UNiagaraNodeReroute, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeReroute), 1419518285U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeReroute_h_2657761425(TEXT("/Script/NiagaraEditor"),
