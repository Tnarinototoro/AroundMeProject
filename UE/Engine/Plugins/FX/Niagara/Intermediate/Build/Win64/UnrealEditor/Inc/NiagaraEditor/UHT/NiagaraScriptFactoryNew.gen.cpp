...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraScriptFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraScriptFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraModuleScriptFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraModuleScriptFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraModuleScriptFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraModuleScriptFactory_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraFunctionScriptFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraFunctionScriptFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraFunctionScriptFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraFunctionScriptFactory_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDynamicInputScriptFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraDynamicInputScriptFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDynamicInputScriptFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraDynamicInputScriptFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraScriptFactoryNew, UNiagaraScriptFactoryNew::StaticClass, TEXT("UNiagaraScriptFactoryNew"), &Z_Registration_Info_UClass_UNiagaraScriptFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraScriptFactoryNew), 1266965358U) },
		{ Z_Construct_UClass_UNiagaraModuleScriptFactory, UNiagaraModuleScriptFactory::StaticClass, TEXT("UNiagaraModuleScriptFactory"), &Z_Registration_Info_UClass_UNiagaraModuleScriptFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraModuleScriptFactory), 3860922377U) },
		{ Z_Construct_UClass_UNiagaraFunctionScriptFactory, UNiagaraFunctionScriptFactory::StaticClass, TEXT("UNiagaraFunctionScriptFactory"), &Z_Registration_Info_UClass_UNiagaraFunctionScriptFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraFunctionScriptFactory), 2981164479U) },
		{ Z_Construct_UClass_UNiagaraDynamicInputScriptFactory, UNiagaraDynamicInputScriptFactory::StaticClass, TEXT("UNiagaraDynamicInputScriptFactory"), &Z_Registration_Info_UClass_UNiagaraDynamicInputScriptFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDynamicInputScriptFactory), 225601043U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraScriptFactoryNew_h_3565801599(TEXT("/Script/NiagaraEditor"),
