...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptSourceBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraScriptSourceBase_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraScriptSourceBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraScriptSourceBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraScriptSourceBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraScriptSourceBase, UNiagaraScriptSourceBase::StaticClass, TEXT("UNiagaraScriptSourceBase"), &Z_Registration_Info_UClass_UNiagaraScriptSourceBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraScriptSourceBase), 3595348160U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraScriptSourceBase_h_348048401(TEXT("/Script/Niagara"),
