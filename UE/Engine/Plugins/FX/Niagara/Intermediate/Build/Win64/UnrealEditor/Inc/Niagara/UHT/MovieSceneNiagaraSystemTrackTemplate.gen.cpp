...
#include "../Private/MovieScene/MovieSceneNiagaraSystemTrackTemplate.h"
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMovieSceneNiagaraSystemTrackImplementation>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Statics::NewProp_SpawnSectionStartFrame = { "SpawnSectionStartFrame", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneNiagaraSystemTrackImplementation, SpawnSectionStartFrame), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Statics::NewProp_SpawnSectionStartFrame_MetaData), Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Statics::NewProp_SpawnSectionStartFrame_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Statics::NewProp_SpawnSectionEndFrame = { "SpawnSectionEndFrame", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneNiagaraSystemTrackImplementation, SpawnSectionEndFrame), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Statics::NewProp_SpawnSectionEndFrame_MetaData), Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Statics::NewProp_SpawnSectionEndFrame_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_MovieSceneNiagaraSystemTrackTemplate_h_Statics::ScriptStructInfo[] = {
		...
		{ FMovieSceneNiagaraSystemTrackImplementation::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Statics::NewStructOps, TEXT("MovieSceneNiagaraSystemTrackImplementation"), &Z_Registration_Info_UScriptStruct_MovieSceneNiagaraSystemTrackImplementation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneNiagaraSystemTrackImplementation), 1351644798U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_MovieSceneNiagaraSystemTrackTemplate_h_2640702630(TEXT("/Script/Niagara"),
		nullptr, 0,
