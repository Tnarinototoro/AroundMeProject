...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::NewProp_SystemObject = { "SystemObject", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackSystemPropertiesItem, SystemObject), Z_Construct_UClass_UNiagaraStackObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::NewProp_SystemObject_MetaData), Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::NewProp_SystemObject_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemPropertiesItem_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackSystemPropertiesItem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackSystemPropertiesItem, UNiagaraStackSystemPropertiesItem::StaticClass, TEXT("UNiagaraStackSystemPropertiesItem"), &Z_Registration_Info_UClass_UNiagaraStackSystemPropertiesItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackSystemPropertiesItem), 4072829142U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackSystemPropertiesItem_h_3013678783(TEXT("/Script/NiagaraEditor"),
