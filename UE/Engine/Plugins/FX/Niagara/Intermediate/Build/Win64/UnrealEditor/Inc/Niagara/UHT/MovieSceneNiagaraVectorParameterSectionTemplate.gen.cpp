...
#include "../Private/MovieScene/Parameters/MovieSceneNiagaraVectorParameterSectionTemplate.h"
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMovieSceneNiagaraVectorParameterSectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraVectorParameterSectionTemplate_Statics::NewProp_VectorChannels = { "VectorChannels", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(VectorChannels, FMovieSceneNiagaraVectorParameterSectionTemplate), STRUCT_OFFSET(FMovieSceneNiagaraVectorParameterSectionTemplate, VectorChannels), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraVectorParameterSectionTemplate_Statics::NewProp_VectorChannels_MetaData), Z_Construct_UScriptStruct_FMovieSceneNiagaraVectorParameterSectionTemplate_Statics::NewProp_VectorChannels_MetaData) }; // 3861024830
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraVectorParameterSectionTemplate_Statics::NewProp_ChannelsUsed = { "ChannelsUsed", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneNiagaraVectorParameterSectionTemplate, ChannelsUsed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraVectorParameterSectionTemplate_Statics::NewProp_ChannelsUsed_MetaData), Z_Construct_UScriptStruct_FMovieSceneNiagaraVectorParameterSectionTemplate_Statics::NewProp_ChannelsUsed_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraVectorParameterSectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneNiagaraVectorParameterSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneNiagaraVectorParameterSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneNiagaraVectorParameterSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneNiagaraVectorParameterSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneNiagaraVectorParameterSectionTemplate), 3238356998U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraVectorParameterSectionTemplate_h_3678974891(TEXT("/Script/Niagara"),
		nullptr, 0,
