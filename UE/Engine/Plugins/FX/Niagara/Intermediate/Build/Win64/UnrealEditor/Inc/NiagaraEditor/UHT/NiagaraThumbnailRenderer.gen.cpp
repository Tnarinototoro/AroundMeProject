...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraThumbnailRendererBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraThumbnailRendererBase_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraThumbnailRendererBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraThumbnailRendererBase_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitterThumbnailRenderer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraEmitterThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitterThumbnailRenderer_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraEmitterThumbnailRenderer_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemThumbnailRenderer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSystemThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemThumbnailRenderer_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSystemThumbnailRenderer_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraThumbnailRenderer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraThumbnailRendererBase, UNiagaraThumbnailRendererBase::StaticClass, TEXT("UNiagaraThumbnailRendererBase"), &Z_Registration_Info_UClass_UNiagaraThumbnailRendererBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraThumbnailRendererBase), 885467105U) },
		{ Z_Construct_UClass_UNiagaraEmitterThumbnailRenderer, UNiagaraEmitterThumbnailRenderer::StaticClass, TEXT("UNiagaraEmitterThumbnailRenderer"), &Z_Registration_Info_UClass_UNiagaraEmitterThumbnailRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraEmitterThumbnailRenderer), 2376723246U) },
		{ Z_Construct_UClass_UNiagaraSystemThumbnailRenderer, UNiagaraSystemThumbnailRenderer::StaticClass, TEXT("UNiagaraSystemThumbnailRenderer"), &Z_Registration_Info_UClass_UNiagaraSystemThumbnailRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemThumbnailRenderer), 3714875314U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraThumbnailRenderer_h_6101540(TEXT("/Script/NiagaraEditor"),
