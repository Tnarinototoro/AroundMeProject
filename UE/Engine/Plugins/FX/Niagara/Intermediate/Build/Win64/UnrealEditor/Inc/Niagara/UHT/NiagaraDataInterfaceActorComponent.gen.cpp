...
#include "../Internal/DataInterface/NiagaraDataInterfaceActorComponent.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_SourceMode = { "SourceMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceActorComponent, SourceMode), Z_Construct_UEnum_Niagara_ENDIActorComponentSourceMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_SourceMode_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_SourceMode_MetaData) }; // 2846683735
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_LocalPlayerIndex = { "LocalPlayerIndex", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceActorComponent, LocalPlayerIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_LocalPlayerIndex_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_LocalPlayerIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FLazyObjectPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_SourceActor = { "SourceActor", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::LazyObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceActorComponent, SourceActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_SourceActor_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceActorComponent_Statics::NewProp_SourceActor_MetaData) };
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceActorComponent_h_Statics::EnumInfo[] = {
		{ ENDIActorComponentSourceMode_StaticEnum, TEXT("ENDIActorComponentSourceMode"), &Z_Registration_Info_UEnum_ENDIActorComponentSourceMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2846683735U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceActorComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceActorComponent, UNiagaraDataInterfaceActorComponent::StaticClass, TEXT("UNiagaraDataInterfaceActorComponent"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceActorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceActorComponent), 2184089343U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceActorComponent_h_3136600558(TEXT("/Script/Niagara"),
