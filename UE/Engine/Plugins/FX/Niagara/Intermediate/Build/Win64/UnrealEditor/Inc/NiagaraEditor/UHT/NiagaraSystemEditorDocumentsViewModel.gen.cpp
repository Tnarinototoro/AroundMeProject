...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemEditorDocumentsViewModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSystemEditorDocumentsViewModel_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemEditorDocumentsViewModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSystemEditorDocumentsViewModel_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraSystemEditorDocumentsViewModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystemEditorDocumentsViewModel, UNiagaraSystemEditorDocumentsViewModel::StaticClass, TEXT("UNiagaraSystemEditorDocumentsViewModel"), &Z_Registration_Info_UClass_UNiagaraSystemEditorDocumentsViewModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemEditorDocumentsViewModel), 3007776058U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_NiagaraSystemEditorDocumentsViewModel_h_3860829473(TEXT("/Script/NiagaraEditor"),
