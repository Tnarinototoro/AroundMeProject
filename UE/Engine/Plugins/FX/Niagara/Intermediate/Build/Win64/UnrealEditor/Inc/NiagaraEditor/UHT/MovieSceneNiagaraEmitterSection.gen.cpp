...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraEmitterSectionKey_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraEmitterSectionKey, Value), Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraEmitterSectionKey_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FNiagaraEmitterSectionKey_Statics::NewProp_Value_MetaData) }; // 2677688088
...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FMovieSceneNiagaraEmitterChannel>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMovieSceneNiagaraEmitterSection_Statics::NewProp_NumLoops = { "NumLoops", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneNiagaraEmitterSection, NumLoops), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraEmitterSection_Statics::NewProp_NumLoops_MetaData), Z_Construct_UClass_UMovieSceneNiagaraEmitterSection_Statics::NewProp_NumLoops_MetaData) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Sequencer_NiagaraSequence_Sections_MovieSceneNiagaraEmitterSection_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraEmitterSectionKey::StaticStruct, Z_Construct_UScriptStruct_FNiagaraEmitterSectionKey_Statics::NewStructOps, TEXT("NiagaraEmitterSectionKey"), &Z_Registration_Info_UScriptStruct_NiagaraEmitterSectionKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraEmitterSectionKey), 927552466U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Sequencer_NiagaraSequence_Sections_MovieSceneNiagaraEmitterSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneNiagaraEmitterSection, UMovieSceneNiagaraEmitterSection::StaticClass, TEXT("UMovieSceneNiagaraEmitterSection"), &Z_Registration_Info_UClass_UMovieSceneNiagaraEmitterSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneNiagaraEmitterSection), 584568694U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Sequencer_NiagaraSequence_Sections_MovieSceneNiagaraEmitterSection_h_1575448851(TEXT("/Script/NiagaraEditor"),
