...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraParameterDefinitionsFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraParameterDefinitionsFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraParameterDefinitionsFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraParameterDefinitionsFactory_Statics::Class_MetaDataParams)
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraParameterDefinitionsFactory_h_2515601825(TEXT("/Script/NiagaraEditor"),
