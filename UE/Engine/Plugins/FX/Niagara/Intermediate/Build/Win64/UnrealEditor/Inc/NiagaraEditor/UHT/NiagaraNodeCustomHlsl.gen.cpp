...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_ScriptUsage = { "ScriptUsage", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeCustomHlsl, ScriptUsage), Z_Construct_UEnum_Niagara_ENiagaraScriptUsage, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_ScriptUsage_MetaData), Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_ScriptUsage_MetaData) }; // 2528249320
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_CustomHlsl = { "CustomHlsl", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeCustomHlsl, CustomHlsl), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_CustomHlsl_MetaData), Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_CustomHlsl_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_AbsoluteIncludeFilePaths = { "AbsoluteIncludeFilePaths", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeCustomHlsl, AbsoluteIncludeFilePaths), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_AbsoluteIncludeFilePaths_MetaData), Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_AbsoluteIncludeFilePaths_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_bIsShaderCodeShown = { "bIsShaderCodeShown", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNiagaraNodeCustomHlsl), &Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_bIsShaderCodeShown_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_bIsShaderCodeShown_MetaData), Z_Construct_UClass_UNiagaraNodeCustomHlsl_Statics::NewProp_bIsShaderCodeShown_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeCustomHlsl_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeCustomHlsl, UNiagaraNodeCustomHlsl::StaticClass, TEXT("UNiagaraNodeCustomHlsl"), &Z_Registration_Info_UClass_UNiagaraNodeCustomHlsl, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeCustomHlsl), 3700997047U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeCustomHlsl_h_3904396613(TEXT("/Script/NiagaraEditor"),
