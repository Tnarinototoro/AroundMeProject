...
#include "../Internal/DataInterface/NiagaraDataInterfaceDataChannelWrite.h"
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNDIDataChannelWriteCompiledData>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bUpdateDestinationDataEveryTick_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_AllocationCount = { "AllocationCount", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceDataChannelWrite, AllocationCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_AllocationCount_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_AllocationCount_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_bPublishToCPU = { "bPublishToCPU", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNiagaraDataInterfaceDataChannelWrite), &Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_bPublishToCPU_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_bPublishToCPU_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_bPublishToCPU_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_Channel = { "Channel", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceDataChannelWrite, Channel), Z_Construct_UClass_UNiagaraDataChannelAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_Channel_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_Channel_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_CompiledData = { "CompiledData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataInterfaceDataChannelWrite, CompiledData), Z_Construct_UScriptStruct_FNDIDataChannelWriteCompiledData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_CompiledData_MetaData), Z_Construct_UClass_UNiagaraDataInterfaceDataChannelWrite_Statics::NewProp_CompiledData_MetaData) }; // 2871777464
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceDataChannelWrite_h_Statics::ScriptStructInfo[] = {
		{ FNDIDataChannelWriteCompiledData::StaticStruct, Z_Construct_UScriptStruct_FNDIDataChannelWriteCompiledData_Statics::NewStructOps, TEXT("NDIDataChannelWriteCompiledData"), &Z_Registration_Info_UScriptStruct_NDIDataChannelWriteCompiledData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNDIDataChannelWriteCompiledData), 2871777464U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceDataChannelWrite_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Internal_DataInterface_NiagaraDataInterfaceDataChannelWrite_h_1473088030(TEXT("/Script/Niagara"),
