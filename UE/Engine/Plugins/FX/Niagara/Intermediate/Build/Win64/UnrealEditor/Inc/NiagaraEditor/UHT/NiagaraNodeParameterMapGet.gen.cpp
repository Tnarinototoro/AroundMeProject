...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::NewProp_PinOutputToPinDefaultPersistentId = { "PinOutputToPinDefaultPersistentId", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeParameterMapGet, PinOutputToPinDefaultPersistentId), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::NewProp_PinOutputToPinDefaultPersistentId_MetaData), Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::NewProp_PinOutputToPinDefaultPersistentId_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeParameterMapGet_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeParameterMapGet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeParameterMapGet, UNiagaraNodeParameterMapGet::StaticClass, TEXT("UNiagaraNodeParameterMapGet"), &Z_Registration_Info_UClass_UNiagaraNodeParameterMapGet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeParameterMapGet), 4041380014U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeParameterMapGet_h_711276441(TEXT("/Script/NiagaraEditor"),
