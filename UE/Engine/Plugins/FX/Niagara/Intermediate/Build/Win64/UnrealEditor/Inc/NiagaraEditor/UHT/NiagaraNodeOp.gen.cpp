...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FAddedPinData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAddedPinData_Statics::NewProp_PinType = { "PinType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAddedPinData, PinType), Z_Construct_UScriptStruct_FEdGraphPinType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAddedPinData_Statics::NewProp_PinType_MetaData), Z_Construct_UScriptStruct_FAddedPinData_Statics::NewProp_PinType_MetaData) }; // 1759667379
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAddedPinData_Statics::NewProp_PinName = { "PinName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAddedPinData, PinName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAddedPinData_Statics::NewProp_PinName_MetaData), Z_Construct_UScriptStruct_FAddedPinData_Statics::NewProp_PinName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAddedPinData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAddedPinData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAddedPinData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAddedPinData_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOp_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_OpName = { "OpName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeOp, OpName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_OpName_MetaData), Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_OpName_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_AddedPins_Inner = { "AddedPins", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FAddedPinData, METADATA_PARAMS(0, nullptr) }; // 64325860
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_AddedPins = { "AddedPins", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeOp, AddedPins), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_AddedPins_MetaData), Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_AddedPins_MetaData) }; // 64325860
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_bAllStatic = { "bAllStatic", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNiagaraNodeOp), &Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_bAllStatic_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_bAllStatic_MetaData), Z_Construct_UClass_UNiagaraNodeOp_Statics::NewProp_bAllStatic_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeOp_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOp_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeOp_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOp_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeOp_h_Statics::ScriptStructInfo[] = {
		{ FAddedPinData::StaticStruct, Z_Construct_UScriptStruct_FAddedPinData_Statics::NewStructOps, TEXT("AddedPinData"), &Z_Registration_Info_UScriptStruct_AddedPinData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAddedPinData), 64325860U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeOp_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeOp, UNiagaraNodeOp::StaticClass, TEXT("UNiagaraNodeOp"), &Z_Registration_Info_UClass_UNiagaraNodeOp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeOp), 4141526112U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeOp_h_939616977(TEXT("/Script/NiagaraEditor"),
