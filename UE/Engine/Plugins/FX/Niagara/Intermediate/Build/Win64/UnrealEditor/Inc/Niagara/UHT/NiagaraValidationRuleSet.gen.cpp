...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraValidationRuleSet_Statics::NewProp_ValidationRules_Inner = { "ValidationRules", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNiagaraValidationRule_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraValidationRuleSet_Statics::NewProp_ValidationRules_Inner_MetaData), Z_Construct_UClass_UNiagaraValidationRuleSet_Statics::NewProp_ValidationRules_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraValidationRuleSet_Statics::NewProp_ValidationRules = { "ValidationRules", nullptr, (EPropertyFlags)0x0014008000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraValidationRuleSet, ValidationRules), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraValidationRuleSet_Statics::NewProp_ValidationRules_MetaData), Z_Construct_UClass_UNiagaraValidationRuleSet_Statics::NewProp_ValidationRules_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraValidationRuleSet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraValidationRuleSet, UNiagaraValidationRuleSet::StaticClass, TEXT("UNiagaraValidationRuleSet"), &Z_Registration_Info_UClass_UNiagaraValidationRuleSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraValidationRuleSet), 2040122282U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraValidationRuleSet_h_1869942150(TEXT("/Script/Niagara"),
