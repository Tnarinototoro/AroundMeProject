...
template<> NIAGARAEDITOR_API UScriptStruct* StaticStruct<FNiagaraSpawnShortcut>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraSpawnShortcut, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::NewProp_Input = { "Input", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNiagaraSpawnShortcut, Input), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::NewProp_Input_MetaData), Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::NewProp_Input_MetaData) }; // 3669273635
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraSpawnShortcut_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraSpawnShortcut::StaticStruct, Z_Construct_UScriptStruct_FNiagaraSpawnShortcut_Statics::NewStructOps, TEXT("NiagaraSpawnShortcut"), &Z_Registration_Info_UScriptStruct_NiagaraSpawnShortcut, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraSpawnShortcut), 3916258335U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraSpawnShortcut_h_1502633314(TEXT("/Script/NiagaraEditor"),
		nullptr, 0,
