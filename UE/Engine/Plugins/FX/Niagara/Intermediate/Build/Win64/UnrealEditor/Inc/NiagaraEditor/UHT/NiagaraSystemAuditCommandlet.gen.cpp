...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::NewProp_PackagesToSave_Inner = { "PackagesToSave", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UPackage, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::NewProp_PackagesToSave = { "PackagesToSave", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraSystemAuditCommandlet, PackagesToSave), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::NewProp_PackagesToSave_MetaData), Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::NewProp_PackagesToSave_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSystemAuditCommandlet_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_Commandlets_NiagaraSystemAuditCommandlet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystemAuditCommandlet, UNiagaraSystemAuditCommandlet::StaticClass, TEXT("UNiagaraSystemAuditCommandlet"), &Z_Registration_Info_UClass_UNiagaraSystemAuditCommandlet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemAuditCommandlet), 3382444424U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_Commandlets_NiagaraSystemAuditCommandlet_h_3377187453(TEXT("/Script/NiagaraEditor"),
