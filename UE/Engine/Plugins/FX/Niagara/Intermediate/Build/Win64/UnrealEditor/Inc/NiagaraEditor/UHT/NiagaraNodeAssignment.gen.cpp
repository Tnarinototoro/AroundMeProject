...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_AssignmentDefaultValue = { "AssignmentDefaultValue", nullptr, (EPropertyFlags)0x0020080020000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeAssignment, AssignmentDefaultValue_DEPRECATED), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_AssignmentDefaultValue_MetaData), Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_AssignmentDefaultValue_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_AssignmentTargets_Inner = { "AssignmentTargets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(0, nullptr) }; // 2677688088
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_AssignmentDefaultValues = { "AssignmentDefaultValues", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeAssignment, AssignmentDefaultValues), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_AssignmentDefaultValues_MetaData), Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_AssignmentDefaultValues_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_OldFunctionCallName = { "OldFunctionCallName", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeAssignment, OldFunctionCallName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_OldFunctionCallName_MetaData), Z_Construct_UClass_UNiagaraNodeAssignment_Statics::NewProp_OldFunctionCallName_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeAssignment_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeAssignment, UNiagaraNodeAssignment::StaticClass, TEXT("UNiagaraNodeAssignment"), &Z_Registration_Info_UClass_UNiagaraNodeAssignment, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeAssignment), 642173798U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeAssignment_h_1259944321(TEXT("/Script/NiagaraEditor"),
