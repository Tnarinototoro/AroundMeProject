...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bEditorOnly_MetaData[];
#endif
		static void NewProp_bEditorOnly_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bEditorOnly;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEditorOnly_MetaData[] = {
		{ "Category", "Tag" },
		{ "ModuleRelativePath", "Private/NiagaraNodeOutputTag.h" },
	};
#endif
	void Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEditorOnly_SetBit(void* Obj)
	{
		((UNiagaraNodeOutputTag*)Obj)->bEditorOnly = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEditorOnly = { "bEditorOnly", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNiagaraNodeOutputTag), &Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEditorOnly_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEditorOnly_MetaData), Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEditorOnly_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEmitMessageOnFailure = { "bEmitMessageOnFailure", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNiagaraNodeOutputTag), &Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEmitMessageOnFailure_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEmitMessageOnFailure_MetaData), Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEmitMessageOnFailure_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_FailureSeverity = { "FailureSeverity", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeOutputTag, FailureSeverity), Z_Construct_UEnum_NiagaraShader_FNiagaraCompileEventSeverity, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_FailureSeverity_MetaData), Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_FailureSeverity_MetaData) }; // 3775501792
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::NewProp_bEditorOnly,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeOutputTag_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeOutputTag_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeOutputTag, UNiagaraNodeOutputTag::StaticClass, TEXT("UNiagaraNodeOutputTag"), &Z_Registration_Info_UClass_UNiagaraNodeOutputTag, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeOutputTag), 1963453104U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeOutputTag_h_2086590247(TEXT("/Script/NiagaraEditor"),
