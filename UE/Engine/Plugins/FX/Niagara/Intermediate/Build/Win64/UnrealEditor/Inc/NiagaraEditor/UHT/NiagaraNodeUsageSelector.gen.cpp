...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVars_Inner = { "OutputVars", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(0, nullptr) }; // 2677688088
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVars = { "OutputVars", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeUsageSelector, OutputVars), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVars_MetaData), Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVars_MetaData) }; // 2677688088
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVarGuids_Inner = { "OutputVarGuids", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVarGuids = { "OutputVarGuids", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeUsageSelector, OutputVarGuids), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVarGuids_MetaData), Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_OutputVarGuids_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_SelectorGuid = { "SelectorGuid", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeUsageSelector, SelectorGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_SelectorGuid_MetaData), Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_SelectorGuid_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_NumOptionsPerVariable_MetaData[] = {
		{ "Comment", "/** Primarily used for integer options where the number of entries is not derivable from something else (i.e. enum or bool which clearly define entries) */" },
		{ "ModuleRelativePath", "Private/NiagaraNodeUsageSelector.h" },
		{ "ToolTip", "Primarily used for integer options where the number of entries is not derivable from something else (i.e. enum or bool which clearly define entries)" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_NumOptionsPerVariable = { "NumOptionsPerVariable", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraNodeUsageSelector, NumOptionsPerVariable), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_NumOptionsPerVariable_MetaData), Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::NewProp_NumOptionsPerVariable_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeUsageSelector_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeUsageSelector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeUsageSelector, UNiagaraNodeUsageSelector::StaticClass, TEXT("UNiagaraNodeUsageSelector"), &Z_Registration_Info_UClass_UNiagaraNodeUsageSelector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeUsageSelector), 2429300423U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraNodeUsageSelector_h_2504767615(TEXT("/Script/NiagaraEditor"),
