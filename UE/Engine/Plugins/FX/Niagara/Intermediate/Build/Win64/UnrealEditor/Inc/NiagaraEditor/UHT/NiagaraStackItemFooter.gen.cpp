...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemFooter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackItemFooter_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackItemFooter_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackItemFooter_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackItemFooter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackItemFooter, UNiagaraStackItemFooter::StaticClass, TEXT("UNiagaraStackItemFooter"), &Z_Registration_Info_UClass_UNiagaraStackItemFooter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackItemFooter), 2458661548U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackItemFooter_h_3985699799(TEXT("/Script/NiagaraEditor"),
