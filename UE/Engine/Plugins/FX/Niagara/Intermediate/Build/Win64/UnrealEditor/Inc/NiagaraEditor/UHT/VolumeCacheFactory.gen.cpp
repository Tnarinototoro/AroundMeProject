...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVolumeCacheFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVolumeCacheFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVolumeCacheFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UVolumeCacheFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_VolumeCacheFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVolumeCacheFactory, UVolumeCacheFactory::StaticClass, TEXT("UVolumeCacheFactory"), &Z_Registration_Info_UClass_UVolumeCacheFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVolumeCacheFactory), 569027166U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_VolumeCacheFactory_h_3687466616(TEXT("/Script/NiagaraEditor"),
