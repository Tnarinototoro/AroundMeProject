...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemPropertiesGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackSystemPropertiesGroup_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemPropertiesGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackSystemPropertiesGroup_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemUserParametersGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackSystemUserParametersGroup_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSystemUserParametersGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackSystemUserParametersGroup_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackSystemSettingsGroup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackSystemPropertiesGroup, UNiagaraStackSystemPropertiesGroup::StaticClass, TEXT("UNiagaraStackSystemPropertiesGroup"), &Z_Registration_Info_UClass_UNiagaraStackSystemPropertiesGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackSystemPropertiesGroup), 2783788717U) },
		{ Z_Construct_UClass_UNiagaraStackSystemUserParametersGroup, UNiagaraStackSystemUserParametersGroup::StaticClass, TEXT("UNiagaraStackSystemUserParametersGroup"), &Z_Registration_Info_UClass_UNiagaraStackSystemUserParametersGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackSystemUserParametersGroup), 2397751196U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackSystemSettingsGroup_h_1007616700(TEXT("/Script/NiagaraEditor"),
