...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::NewProp_EmitterObject = { "EmitterObject", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackEmitterPropertiesItem, EmitterObject), Z_Construct_UClass_UNiagaraStackObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::NewProp_EmitterObject_MetaData), Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::NewProp_EmitterObject_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterPropertiesItem_Statics::PropPointers) < 2048);
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SummaryViewCollection_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_SummaryViewCollection;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UECodeGen_Private::FClassParams ClassParams;
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::NewProp_SummaryViewCollection_MetaData[] = {
		{ "ModuleRelativePath", "Public/ViewModels/Stack/NiagaraStackEmitterSettingsGroup.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::NewProp_SummaryViewCollection = { "SummaryViewCollection", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackEmitterSummaryItem, SummaryViewCollection), Z_Construct_UClass_UNiagaraStackSummaryViewCollection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::NewProp_SummaryViewCollection_MetaData), Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::NewProp_SummaryViewCollection_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::NewProp_SummaryViewCollection,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::NewProp_SummaryItem = { "SummaryItem", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraStackEmitterSummaryGroup, SummaryItem), Z_Construct_UClass_UNiagaraStackEmitterSummaryItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::NewProp_SummaryItem_MetaData), Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::NewProp_SummaryItem_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSummaryViewCollapseButton_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackSummaryViewCollapseButton_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackSummaryViewCollapseButton_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackSummaryViewCollapseButton_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackEmitterSettingsGroup_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UNiagaraStackEmitterSummaryItem, UNiagaraStackEmitterSummaryItem::StaticClass, TEXT("UNiagaraStackEmitterSummaryItem"), &Z_Registration_Info_UClass_UNiagaraStackEmitterSummaryItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackEmitterSummaryItem), 2581959760U) },
		{ Z_Construct_UClass_UNiagaraStackEmitterSummaryGroup, UNiagaraStackEmitterSummaryGroup::StaticClass, TEXT("UNiagaraStackEmitterSummaryGroup"), &Z_Registration_Info_UClass_UNiagaraStackEmitterSummaryGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackEmitterSummaryGroup), 1729663423U) },
		{ Z_Construct_UClass_UNiagaraStackSummaryViewCollapseButton, UNiagaraStackSummaryViewCollapseButton::StaticClass, TEXT("UNiagaraStackSummaryViewCollapseButton"), &Z_Registration_Info_UClass_UNiagaraStackSummaryViewCollapseButton, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackSummaryViewCollapseButton), 3434727749U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackEmitterSettingsGroup_h_2859717328(TEXT("/Script/NiagaraEditor"),
