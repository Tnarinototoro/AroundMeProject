...
#include "../Public/NiagaraDataChannelAccessor.h"
...
// End Cross Module References
	DEFINE_FUNCTION(UNiagaraDataChannelReader::execReadPosition)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FVector*)Z_Param__Result=P_THIS->ReadPosition(Z_Param_VarName,Z_Param_Index);
		P_NATIVE_END;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNiagaraDataChannelReader_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_InitAccess, "InitAccess" }, // 1824972090
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_Num, "Num" }, // 1131560406
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadBool, "ReadBool" }, // 3603329719
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadFloat, "ReadFloat" }, // 2074686081
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadInt, "ReadInt" }, // 4020207278
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadLinearColor, "ReadLinearColor" }, // 197193432
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadPosition, "ReadPosition" }, // 2468439441
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadQuat, "ReadQuat" }, // 2799441394
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadVector, "ReadVector" }, // 789557475
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadVector2D, "ReadVector2D" }, // 1377421176
		{ &Z_Construct_UFunction_UNiagaraDataChannelReader_ReadVector4, "ReadVector4" }, // 306066011
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataChannelReader_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDataChannelReader_Statics::NewProp_Owner = { "Owner", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataChannelReader, Owner), Z_Construct_UClass_UNiagaraDataChannelHandler_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataChannelReader_Statics::NewProp_Owner_MetaData), Z_Construct_UClass_UNiagaraDataChannelReader_Statics::NewProp_Owner_MetaData) };
	...
	DEFINE_FUNCTION(UNiagaraDataChannelWriter::execInitWrite)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->InitWrite(Z_Param_SearchParams,Z_Param_Count,Z_Param_bVisibleToGame,Z_Param_bVisibleToCPU,Z_Param_bVisibleToGPU);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNiagaraDataChannelWriter_InitWrite_Statics::NewProp_SearchParams = { "SearchParams", nullptr, (EPropertyFlags)0x0010008000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NiagaraDataChannelWriter_eventInitWrite_Parms, SearchParams), Z_Construct_UScriptStruct_FNiagaraDataChannelSearchParameters, METADATA_PARAMS(0, nullptr) }; // 1608528227
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNiagaraDataChannelWriter_WritePosition_Statics::Function_MetaDataParams[] = {
		{ "Category", "NiagaraDataChannel" },
		{ "Keywords", "niagara DataChannel" },
		{ "ModuleRelativePath", "Public/NiagaraDataChannelAccessor.h" },
	};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNiagaraDataChannelWriter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_InitWrite, "InitWrite" }, // 815125214
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_Num, "Num" }, // 186467906
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteBool, "WriteBool" }, // 3547086031
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteFloat, "WriteFloat" }, // 1581944531
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteInt, "WriteInt" }, // 533885809
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteLinearColor, "WriteLinearColor" }, // 1741054839
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WritePosition, "WritePosition" }, // 1475550660
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteQuat, "WriteQuat" }, // 1743179683
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteSpawnInfo, "WriteSpawnInfo" }, // 1021018730
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteVector, "WriteVector" }, // 2967709919
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteVector2D, "WriteVector2D" }, // 637186129
		{ &Z_Construct_UFunction_UNiagaraDataChannelWriter_WriteVector4, "WriteVector4" }, // 2320255465
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataChannelWriter_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDataChannelWriter_Statics::NewProp_Owner = { "Owner", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDataChannelWriter, Owner), Z_Construct_UClass_UNiagaraDataChannelHandler_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataChannelWriter_Statics::NewProp_Owner_MetaData), Z_Construct_UClass_UNiagaraDataChannelWriter_Statics::NewProp_Owner_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDataChannelAccessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataChannelReader, UNiagaraDataChannelReader::StaticClass, TEXT("UNiagaraDataChannelReader"), &Z_Registration_Info_UClass_UNiagaraDataChannelReader, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataChannelReader), 601061613U) },
		{ Z_Construct_UClass_UNiagaraDataChannelWriter, UNiagaraDataChannelWriter::StaticClass, TEXT("UNiagaraDataChannelWriter"), &Z_Registration_Info_UClass_UNiagaraDataChannelWriter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataChannelWriter), 1727135927U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDataChannelAccessor_h_2769185376(TEXT("/Script/Niagara"),
