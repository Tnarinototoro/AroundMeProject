...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANiagaraActor_GetDestroyOnSystemFinish_Statics::Function_MetaDataParams[] = {
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ANiagaraActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ANiagaraActor_GetDestroyOnSystemFinish, "GetDestroyOnSystemFinish" }, // 2066266652
		{ &Z_Construct_UFunction_ANiagaraActor_OnNiagaraSystemFinished, "OnNiagaraSystemFinished" }, // 4100704918
		{ &Z_Construct_UFunction_ANiagaraActor_SetDestroyOnSystemFinish, "SetDestroyOnSystemFinish" }, // 1003404752
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANiagaraActor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ANiagaraActor_Statics::NewProp_NiagaraComponent = { "NiagaraComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANiagaraActor, NiagaraComponent), Z_Construct_UClass_UNiagaraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANiagaraActor_Statics::NewProp_NiagaraComponent_MetaData), Z_Construct_UClass_ANiagaraActor_Statics::NewProp_NiagaraComponent_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ANiagaraActor_Statics::NewProp_SpriteComponent = { "SpriteComponent", nullptr, (EPropertyFlags)0x0044000800080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANiagaraActor, SpriteComponent), Z_Construct_UClass_UBillboardComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANiagaraActor_Statics::NewProp_SpriteComponent_MetaData), Z_Construct_UClass_ANiagaraActor_Statics::NewProp_SpriteComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ANiagaraActor_Statics::NewProp_ArrowComponent = { "ArrowComponent", nullptr, (EPropertyFlags)0x0044000800080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANiagaraActor, ArrowComponent), Z_Construct_UClass_UArrowComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANiagaraActor_Statics::NewProp_ArrowComponent_MetaData), Z_Construct_UClass_ANiagaraActor_Statics::NewProp_ArrowComponent_MetaData) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANiagaraActor, ANiagaraActor::StaticClass, TEXT("ANiagaraActor"), &Z_Registration_Info_UClass_ANiagaraActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANiagaraActor), 1375150325U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraActor_h_292954653(TEXT("/Script/Niagara"),
