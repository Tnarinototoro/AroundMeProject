...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSimCacheFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSimCacheFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSimCacheFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSimCacheFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraSimCacheFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSimCacheFactoryNew, UNiagaraSimCacheFactoryNew::StaticClass, TEXT("UNiagaraSimCacheFactoryNew"), &Z_Registration_Info_UClass_UNiagaraSimCacheFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSimCacheFactoryNew), 3765124435U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraSimCacheFactoryNew_h_2385528069(TEXT("/Script/NiagaraEditor"),
