...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NiagaraEditor_ENiagaraLibrarySynchronizedDefaultMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NiagaraEditor_ENiagaraLibrarySynchronizedDefaultMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NiagaraEditor_ENiagaraLibrarySynchronizedDefaultMode_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NiagaraEditor_ENiagaraLibrarySourceDefaultMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NiagaraEditor_ENiagaraLibrarySourceDefaultMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NiagaraEditor_ENiagaraLibrarySourceDefaultMode_Statics::Enum_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Customizations_NiagaraScriptVariableCustomization_h_Statics::EnumInfo[] = {
		{ ENiagaraLibrarySynchronizedDefaultMode_StaticEnum, TEXT("ENiagaraLibrarySynchronizedDefaultMode"), &Z_Registration_Info_UEnum_ENiagaraLibrarySynchronizedDefaultMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1410221119U) },
		{ ENiagaraLibrarySourceDefaultMode_StaticEnum, TEXT("ENiagaraLibrarySourceDefaultMode"), &Z_Registration_Info_UEnum_ENiagaraLibrarySourceDefaultMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 58885380U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Customizations_NiagaraScriptVariableCustomization_h_4174060288(TEXT("/Script/NiagaraEditor"),
		nullptr, 0,
		nullptr, 0,
