...
#include "../Private/MovieScene/Parameters/MovieSceneNiagaraColorParameterSectionTemplate.h"
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMovieSceneNiagaraColorParameterSectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_BlueChannel = { "BlueChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneNiagaraColorParameterSectionTemplate, BlueChannel), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_BlueChannel_MetaData), Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_BlueChannel_MetaData) }; // 3861024830
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_AlphaChannel = { "AlphaChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneNiagaraColorParameterSectionTemplate, AlphaChannel), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_AlphaChannel_MetaData), Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_AlphaChannel_MetaData) }; // 3861024830
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraColorParameterSectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneNiagaraColorParameterSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneNiagaraColorParameterSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneNiagaraColorParameterSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneNiagaraColorParameterSectionTemplate), 953754029U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraColorParameterSectionTemplate_h_4252183045(TEXT("/Script/Niagara"),
		nullptr, 0,
