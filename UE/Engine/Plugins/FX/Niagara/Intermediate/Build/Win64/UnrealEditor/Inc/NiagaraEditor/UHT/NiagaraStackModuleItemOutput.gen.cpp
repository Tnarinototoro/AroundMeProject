...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackModuleItemOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackModuleItemOutput_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackModuleItemOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackModuleItemOutput_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackModuleItemOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackModuleItemOutput, UNiagaraStackModuleItemOutput::StaticClass, TEXT("UNiagaraStackModuleItemOutput"), &Z_Registration_Info_UClass_UNiagaraStackModuleItemOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackModuleItemOutput), 656850165U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackModuleItemOutput_h_2457645227(TEXT("/Script/NiagaraEditor"),
