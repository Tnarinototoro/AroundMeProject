...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_MICMaterial = { "MICMaterial", nullptr, (EPropertyFlags)0x0014000800002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDecalRendererProperties, MICMaterial), Z_Construct_UClass_UMaterialInstanceConstant_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_MICMaterial_MetaData), Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_MICMaterial_MetaData) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_MaterialParameterBinding = { "MaterialParameterBinding", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDecalRendererProperties, MaterialParameterBinding), Z_Construct_UScriptStruct_FNiagaraParameterBinding, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_MaterialParameterBinding_MetaData), Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_MaterialParameterBinding_MetaData) }; // 3491511441
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_DecalScreenSizeFade = { "DecalScreenSizeFade", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraDecalRendererProperties, DecalScreenSizeFade), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_DecalScreenSizeFade_MetaData), Z_Construct_UClass_UNiagaraDecalRendererProperties_Statics::NewProp_DecalScreenSizeFade_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDecalRendererProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDecalRendererProperties, UNiagaraDecalRendererProperties::StaticClass, TEXT("UNiagaraDecalRendererProperties"), &Z_Registration_Info_UClass_UNiagaraDecalRendererProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDecalRendererProperties), 1504243820U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDecalRendererProperties_h_545159620(TEXT("/Script/Niagara"),
