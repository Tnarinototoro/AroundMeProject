...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeWithDynamicPins_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraNodeWithDynamicPins_Statics::ClassParams = {
		...
		0,
		0x000000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraNodeWithDynamicPins_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraNodeWithDynamicPins_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeWithDynamicPins_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraNodeWithDynamicPins, UNiagaraNodeWithDynamicPins::StaticClass, TEXT("UNiagaraNodeWithDynamicPins"), &Z_Registration_Info_UClass_UNiagaraNodeWithDynamicPins, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraNodeWithDynamicPins), 2097049441U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_NiagaraNodeWithDynamicPins_h_2018764135(TEXT("/Script/NiagaraEditor"),
