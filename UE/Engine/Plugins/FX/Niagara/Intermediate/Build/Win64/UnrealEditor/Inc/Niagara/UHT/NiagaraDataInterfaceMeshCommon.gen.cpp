...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMeshTriCoordinate>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewProp_Tri = { "Tri", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMeshTriCoordinate, Tri), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewProp_Tri_MetaData), Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewProp_Tri_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewProp_BaryCoord = { "BaryCoord", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMeshTriCoordinate, BaryCoord), Z_Construct_UScriptStruct_FVector3f, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewProp_BaryCoord_MetaData), Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewProp_BaryCoord_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceMeshCommon_h_Statics::ScriptStructInfo[] = {
		{ FMeshTriCoordinate::StaticStruct, Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewStructOps, TEXT("MeshTriCoordinate"), &Z_Registration_Info_UScriptStruct_MeshTriCoordinate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshTriCoordinate), 420755732U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceMeshCommon_h_1070581362(TEXT("/Script/Niagara"),
		nullptr, 0,
