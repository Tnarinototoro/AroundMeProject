...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackScriptItemGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraStackScriptItemGroup_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraStackScriptItemGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraStackScriptItemGroup_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackScriptItemGroup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraStackScriptItemGroup, UNiagaraStackScriptItemGroup::StaticClass, TEXT("UNiagaraStackScriptItemGroup"), &Z_Registration_Info_UClass_UNiagaraStackScriptItemGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraStackScriptItemGroup), 3371051760U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Public_ViewModels_Stack_NiagaraStackScriptItemGroup_h_1124028581(TEXT("/Script/NiagaraEditor"),
