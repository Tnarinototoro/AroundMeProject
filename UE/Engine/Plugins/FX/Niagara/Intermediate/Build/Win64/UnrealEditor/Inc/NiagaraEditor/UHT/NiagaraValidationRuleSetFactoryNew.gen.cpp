...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraValidationRuleSetFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraValidationRuleSetFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraValidationRuleSetFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraValidationRuleSetFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraValidationRuleSetFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraValidationRuleSetFactoryNew, UNiagaraValidationRuleSetFactoryNew::StaticClass, TEXT("UNiagaraValidationRuleSetFactoryNew"), &Z_Registration_Info_UClass_UNiagaraValidationRuleSetFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraValidationRuleSetFactoryNew), 1284595716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_NiagaraValidationRuleSetFactoryNew_h_995284334(TEXT("/Script/NiagaraEditor"),
