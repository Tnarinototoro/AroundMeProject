...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraBakerTextureSource>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNiagaraBakerOutput_Statics::NewProp_OutputName = { "OutputName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNiagaraBakerOutput, OutputName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraBakerOutput_Statics::NewProp_OutputName_MetaData), Z_Construct_UClass_UNiagaraBakerOutput_Statics::NewProp_OutputName_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraBakerOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraBakerOutput, UNiagaraBakerOutput::StaticClass, TEXT("UNiagaraBakerOutput"), &Z_Registration_Info_UClass_UNiagaraBakerOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraBakerOutput), 440575489U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraBakerOutput_h_609892200(TEXT("/Script/Niagara"),
