...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSequencerTrackFilter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraSequencerTrackFilter_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraSequencerTrackFilter_Statics::Class_MetaDataParams), Z_Construct_UClass_UNiagaraSequencerTrackFilter_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Sequencer_NiagaraSequence_NiagaraSequencerFilters_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSequencerTrackFilter, UNiagaraSequencerTrackFilter::StaticClass, TEXT("UNiagaraSequencerTrackFilter"), &Z_Registration_Info_UClass_UNiagaraSequencerTrackFilter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSequencerTrackFilter), 959253181U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraEditor_Private_Sequencer_NiagaraSequence_NiagaraSequencerFilters_h_3677349348(TEXT("/Script/NiagaraEditor"),
