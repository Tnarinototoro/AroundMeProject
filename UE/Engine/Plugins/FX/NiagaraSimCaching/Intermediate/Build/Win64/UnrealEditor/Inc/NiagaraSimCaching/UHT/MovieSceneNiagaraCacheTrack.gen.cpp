...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::NewProp_AnimationSections = { "AnimationSections", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneNiagaraCacheTrack, AnimationSections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::NewProp_AnimationSections_MetaData), Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::NewProp_AnimationSections_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::NewProp_bCacheRecordingEnabled = { "bCacheRecordingEnabled", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMovieSceneNiagaraCacheTrack), &Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::NewProp_bCacheRecordingEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::NewProp_bCacheRecordingEnabled_MetaData), Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::NewProp_bCacheRecordingEnabled_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneNiagaraCacheTrack, IMovieSceneTrackTemplateProducer), false },  // 3839488910
			{ Z_Construct_UClass_UMovieSceneCachedTrack_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneNiagaraCacheTrack, IMovieSceneCachedTrack), false },  // 1507987047
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraCacheTrack_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_NiagaraSimCaching_Source_NiagaraSimCaching_Public_Niagara_Sequencer_MovieSceneNiagaraCacheTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneNiagaraCacheTrack, UMovieSceneNiagaraCacheTrack::StaticClass, TEXT("UMovieSceneNiagaraCacheTrack"), &Z_Registration_Info_UClass_UMovieSceneNiagaraCacheTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneNiagaraCacheTrack), 855803491U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_NiagaraSimCaching_Source_NiagaraSimCaching_Public_Niagara_Sequencer_MovieSceneNiagaraCacheTrack_h_974775890(TEXT("/Script/NiagaraSimCaching"),
