...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneNiagaraTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneNiagaraTrackRecorder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_NiagaraSimCaching_Source_NiagaraSimCachingEditor_Public_Sequencer_MovieSceneNiagaraTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneNiagaraTrackRecorder, UMovieSceneNiagaraTrackRecorder::StaticClass, TEXT("UMovieSceneNiagaraTrackRecorder"), &Z_Registration_Info_UClass_UMovieSceneNiagaraTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneNiagaraTrackRecorder), 958664281U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_NiagaraSimCaching_Source_NiagaraSimCachingEditor_Public_Sequencer_MovieSceneNiagaraTrackRecorder_h_329062778(TEXT("/Script/NiagaraSimCachingEditor"),
