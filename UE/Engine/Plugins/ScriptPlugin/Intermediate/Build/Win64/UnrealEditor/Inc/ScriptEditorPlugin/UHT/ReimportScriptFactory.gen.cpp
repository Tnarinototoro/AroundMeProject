...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UReimportScriptFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UReimportScriptFactory_Statics::NewProp_OriginalScript = { "OriginalScript", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UReimportScriptFactory, OriginalScript), Z_Construct_UClass_UScriptBlueprint_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReimportScriptFactory_Statics::NewProp_OriginalScript_MetaData), Z_Construct_UClass_UReimportScriptFactory_Statics::NewProp_OriginalScript_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UReimportScriptFactory_Statics::ClassParams = {
		...
		0,
		0x000820A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReimportScriptFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UReimportScriptFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UReimportScriptFactory_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_ScriptPlugin_Source_ScriptEditorPlugin_Classes_ReimportScriptFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReimportScriptFactory, UReimportScriptFactory::StaticClass, TEXT("UReimportScriptFactory"), &Z_Registration_Info_UClass_UReimportScriptFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReimportScriptFactory), 2009459647U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_ScriptPlugin_Source_ScriptEditorPlugin_Classes_ReimportScriptFactory_h_2691653533(TEXT("/Script/ScriptEditorPlugin"),
