...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioGameplayVolumeProxy_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAudioGameplayVolumeProxy_Statics::ClassParams = {
		...
		0,
		0x041010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioGameplayVolumeProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UAudioGameplayVolumeProxy_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAGVPrimitiveComponentProxy_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAGVPrimitiveComponentProxy_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAGVPrimitiveComponentProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UAGVPrimitiveComponentProxy_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAGVConditionProxy_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAGVConditionProxy_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAGVConditionProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UAGVConditionProxy_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplayVolume_Source_AudioGameplayVolume_Public_AudioGameplayVolumeProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioGameplayVolumeProxy, UAudioGameplayVolumeProxy::StaticClass, TEXT("UAudioGameplayVolumeProxy"), &Z_Registration_Info_UClass_UAudioGameplayVolumeProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioGameplayVolumeProxy), 2057614594U) },
		{ Z_Construct_UClass_UAGVPrimitiveComponentProxy, UAGVPrimitiveComponentProxy::StaticClass, TEXT("UAGVPrimitiveComponentProxy"), &Z_Registration_Info_UClass_UAGVPrimitiveComponentProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAGVPrimitiveComponentProxy), 1515963222U) },
		{ Z_Construct_UClass_UAGVConditionProxy, UAGVConditionProxy::StaticClass, TEXT("UAGVConditionProxy"), &Z_Registration_Info_UClass_UAGVConditionProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAGVConditionProxy), 1162425078U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplayVolume_Source_AudioGameplayVolume_Public_AudioGameplayVolumeProxy_h_4021978146(TEXT("/Script/AudioGameplayVolume"),
