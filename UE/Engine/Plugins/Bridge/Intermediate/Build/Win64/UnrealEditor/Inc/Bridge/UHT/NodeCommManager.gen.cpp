...
template<> BRIDGE_API UScriptStruct* StaticStruct<FBifrostNodeInfo>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FBifrostNodeInfo_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBifrostNodeInfo, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBifrostNodeInfo_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FBifrostNodeInfo_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FBifrostNodeInfo_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBifrostNodeInfo, Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBifrostNodeInfo_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FBifrostNodeInfo_Statics::NewProp_Value_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Bridge_Source_Bridge_Private_NodeCommManager_h_Statics::ScriptStructInfo[] = {
		{ FBifrostNodeInfo::StaticStruct, Z_Construct_UScriptStruct_FBifrostNodeInfo_Statics::NewStructOps, TEXT("BifrostNodeInfo"), &Z_Registration_Info_UScriptStruct_BifrostNodeInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBifrostNodeInfo), 2927407074U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Bridge_Source_Bridge_Private_NodeCommManager_h_2329775790(TEXT("/Script/Bridge"),
		nullptr, 0,
