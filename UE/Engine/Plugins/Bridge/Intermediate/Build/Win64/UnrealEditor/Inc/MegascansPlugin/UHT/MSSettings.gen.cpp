...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMegascansSettings_Statics::NewProp_bCreateFoliage = { "bCreateFoliage", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMegascansSettings), &Z_Construct_UClass_UMegascansSettings_Statics::NewProp_bCreateFoliage_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMegascansSettings_Statics::NewProp_bCreateFoliage_MetaData), Z_Construct_UClass_UMegascansSettings_Statics::NewProp_bCreateFoliage_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMaterialBlendSettings_Statics::NewProp_BlendedMaterialName = { "BlendedMaterialName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialBlendSettings, BlendedMaterialName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialBlendSettings_Statics::NewProp_BlendedMaterialName_MetaData), Z_Construct_UClass_UMaterialBlendSettings_Statics::NewProp_BlendedMaterialName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialBlendSettings_Statics::NewProp_BlendedMaterialPath = { "BlendedMaterialPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialBlendSettings, BlendedMaterialPath), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialBlendSettings_Statics::NewProp_BlendedMaterialPath_MetaData), Z_Construct_UClass_UMaterialBlendSettings_Statics::NewProp_BlendedMaterialPath_MetaData) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterial3d = { "MasterMaterial3d", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialAssetSettings, MasterMaterial3d), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterial3d_MetaData), Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterial3d_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterialSurface = { "MasterMaterialSurface", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialAssetSettings, MasterMaterialSurface), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterialSurface_MetaData), Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterialSurface_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterialPlant = { "MasterMaterialPlant", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialAssetSettings, MasterMaterialPlant), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterialPlant_MetaData), Z_Construct_UClass_UMaterialAssetSettings_Statics::NewProp_MasterMaterialPlant_MetaData) };
...
#endif
	const UECodeGen_Private::FLazyObjectPropertyParams Z_Construct_UClass_UMaterialPresetsSettings_Statics::NewProp_MasterMaterialSurface = { "MasterMaterialSurface", nullptr, (EPropertyFlags)0x0014000000002001, UECodeGen_Private::EPropertyGenFlags::LazyObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialPresetsSettings, MasterMaterialSurface), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialPresetsSettings_Statics::NewProp_MasterMaterialSurface_MetaData), Z_Construct_UClass_UMaterialPresetsSettings_Statics::NewProp_MasterMaterialSurface_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FLazyObjectPropertyParams Z_Construct_UClass_UMaterialPresetsSettings_Statics::NewProp_MasterMaterialPlant = { "MasterMaterialPlant", nullptr, (EPropertyFlags)0x0014000000002001, UECodeGen_Private::EPropertyGenFlags::LazyObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialPresetsSettings, MasterMaterialPlant), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialPresetsSettings_Statics::NewProp_MasterMaterialPlant_MetaData), Z_Construct_UClass_UMaterialPresetsSettings_Statics::NewProp_MasterMaterialPlant_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Bridge_Source_MegascansPlugin_Public_MSSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMegascansSettings, UMegascansSettings::StaticClass, TEXT("UMegascansSettings"), &Z_Registration_Info_UClass_UMegascansSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMegascansSettings), 1309538869U) },
		{ Z_Construct_UClass_UMaterialBlendSettings, UMaterialBlendSettings::StaticClass, TEXT("UMaterialBlendSettings"), &Z_Registration_Info_UClass_UMaterialBlendSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialBlendSettings), 3117495422U) },
		{ Z_Construct_UClass_UMaterialAssetSettings, UMaterialAssetSettings::StaticClass, TEXT("UMaterialAssetSettings"), &Z_Registration_Info_UClass_UMaterialAssetSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialAssetSettings), 3781970402U) },
		{ Z_Construct_UClass_UMaterialPresetsSettings, UMaterialPresetsSettings::StaticClass, TEXT("UMaterialPresetsSettings"), &Z_Registration_Info_UClass_UMaterialPresetsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialPresetsSettings), 440599171U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Bridge_Source_MegascansPlugin_Public_MSSettings_h_1779476873(TEXT("/Script/MegascansPlugin"),
