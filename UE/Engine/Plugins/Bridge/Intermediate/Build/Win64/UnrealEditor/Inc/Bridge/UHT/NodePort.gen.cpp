...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNodePort_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNodePort_GetNodePort, "GetNodePort" }, // 2347857107
		{ &Z_Construct_UFunction_UNodePort_IsNodeRunning, "IsNodeRunning" }, // 3426150948
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNodePort_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Bridge_Source_Bridge_Private_NodePort_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNodePort, UNodePort::StaticClass, TEXT("UNodePort"), &Z_Registration_Info_UClass_UNodePort, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNodePort), 2157135309U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Bridge_Source_Bridge_Private_NodePort_h_1567157416(TEXT("/Script/Bridge"),
