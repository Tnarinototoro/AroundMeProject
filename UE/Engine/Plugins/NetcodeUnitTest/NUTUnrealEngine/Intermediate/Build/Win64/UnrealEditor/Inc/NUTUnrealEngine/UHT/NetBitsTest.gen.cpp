...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNetBitsTest_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNetBitsTest_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetBitsTest_Statics::Class_MetaDataParams), Z_Construct_UClass_UNetBitsTest_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NUTUnrealEngine_Source_NUTUnrealEngine_Classes_UnitTests_NetBitsTest_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetBitsTest, UNetBitsTest::StaticClass, TEXT("UNetBitsTest"), &Z_Registration_Info_UClass_UNetBitsTest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetBitsTest), 713138771U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NUTUnrealEngine_Source_NUTUnrealEngine_Classes_UnitTests_NetBitsTest_h_797595362(TEXT("/Script/NUTUnrealEngine"),
