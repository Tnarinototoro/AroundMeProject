...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFTextCrash_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UFTextCrash_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFTextCrash_Statics::Class_MetaDataParams), Z_Construct_UClass_UFTextCrash_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NUTUnrealEngine_Source_NUTUnrealEngine_Classes_UnitTests_FTextCrash_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFTextCrash, UFTextCrash::StaticClass, TEXT("UFTextCrash"), &Z_Registration_Info_UClass_UFTextCrash, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFTextCrash), 114108908U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NUTUnrealEngine_Source_NUTUnrealEngine_Classes_UnitTests_FTextCrash_h_262443743(TEXT("/Script/NUTUnrealEngine"),
