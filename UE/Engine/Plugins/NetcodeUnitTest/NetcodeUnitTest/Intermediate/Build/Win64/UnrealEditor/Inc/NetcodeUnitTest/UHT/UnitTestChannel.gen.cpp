...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestChannel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUnitTestChannel_Statics::NewProp_MinClient = { "MinClient", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUnitTestChannel, MinClient), Z_Construct_UClass_UMinimalClient_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestChannel_Statics::NewProp_MinClient_MetaData), Z_Construct_UClass_UUnitTestChannel_Statics::NewProp_MinClient_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUnitTestChannel_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestChannel_Statics::Class_MetaDataParams), Z_Construct_UClass_UUnitTestChannel_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestChannel_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_Net_UnitTestChannel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUnitTestChannel, UUnitTestChannel::StaticClass, TEXT("UUnitTestChannel"), &Z_Registration_Info_UClass_UUnitTestChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUnitTestChannel), 1979674541U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_Net_UnitTestChannel_h_671486732(TEXT("/Script/NetcodeUnitTest"),
