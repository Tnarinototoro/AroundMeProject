...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketClient_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebSocketClient_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketClient_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebSocketClient_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTests_Engine_WebSocketClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebSocketClient, UWebSocketClient::StaticClass, TEXT("UWebSocketClient"), &Z_Registration_Info_UClass_UWebSocketClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebSocketClient), 4055745229U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTests_Engine_WebSocketClient_h_1124456154(TEXT("/Script/NetcodeUnitTest"),
