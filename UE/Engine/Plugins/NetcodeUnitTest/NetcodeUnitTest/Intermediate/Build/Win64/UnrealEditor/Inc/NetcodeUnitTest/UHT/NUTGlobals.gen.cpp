...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_EventWatcher = { "EventWatcher", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNUTGlobals, EventWatcher), Z_Construct_UClass_UNetConnection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::NewProp_EventWatcher_MetaData), Z_Construct_UClass_UNUTGlobals_Statics::NewProp_EventWatcher_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_ServerPortOffset = { "ServerPortOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNUTGlobals, ServerPortOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::NewProp_ServerPortOffset_MetaData), Z_Construct_UClass_UNUTGlobals_Statics::NewProp_ServerPortOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnitTestNetDriverCount = { "UnitTestNetDriverCount", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNUTGlobals, UnitTestNetDriverCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnitTestNetDriverCount_MetaData), Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnitTestNetDriverCount_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_DumpRPCMatches_Inner = { "DumpRPCMatches", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_DumpRPCMatches = { "DumpRPCMatches", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNUTGlobals, DumpRPCMatches), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::NewProp_DumpRPCMatches_MetaData), Z_Construct_UClass_UNUTGlobals_Statics::NewProp_DumpRPCMatches_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnitTestModules_Inner = { "UnitTestModules", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnitTestModules = { "UnitTestModules", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNUTGlobals, UnitTestModules), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnitTestModules_MetaData), Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnitTestModules_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnloadedModules_Inner = { "UnloadedModules", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnloadedModules = { "UnloadedModules", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNUTGlobals, UnloadedModules), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnloadedModules_MetaData), Z_Construct_UClass_UNUTGlobals_Statics::NewProp_UnloadedModules_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNUTGlobals_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::Class_MetaDataParams), Z_Construct_UClass_UNUTGlobals_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNUTGlobals_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_NUTGlobals_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNUTGlobals, UNUTGlobals::StaticClass, TEXT("UNUTGlobals"), &Z_Registration_Info_UClass_UNUTGlobals, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNUTGlobals), 135744692U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_NUTGlobals_h_750616765(TEXT("/Script/NetcodeUnitTest"),
