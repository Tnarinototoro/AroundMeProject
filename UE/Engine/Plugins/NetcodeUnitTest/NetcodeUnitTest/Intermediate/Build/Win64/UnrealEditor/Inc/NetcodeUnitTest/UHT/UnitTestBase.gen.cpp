...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUnitTestBase_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UUnitTestBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTestBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUnitTestBase, UUnitTestBase::StaticClass, TEXT("UUnitTestBase"), &Z_Registration_Info_UClass_UUnitTestBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUnitTestBase), 2470887734U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTestBase_h_3424259868(TEXT("/Script/NetcodeUnitTest"),
