...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::NewProp_InNUTActor = { "InNUTActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NetcodeUnitTest_eventExecuteOnServer_Parms, InNUTActor), Z_Construct_UClass_ANUTActor_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NetcodeUnitTest, nullptr, "ExecuteOnServer__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::_Script_NetcodeUnitTest_eventExecuteOnServer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature_Statics::_Script_NetcodeUnitTest_eventExecuteOnServer_Parms) < MAX_uint16);
...
void FExecuteOnServer_DelegateWrapper(const FScriptDelegate& ExecuteOnServer, ANUTActor* InNUTActor)
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ANUTActor_Admin_Statics::NewProp_Command = { "Command", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NUTActor_eventAdmin_Parms, Command), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_Admin_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "Admin", nullptr, nullptr, Z_Construct_UFunction_ANUTActor_Admin_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_Admin_Statics::PropPointers), sizeof(Z_Construct_UFunction_ANUTActor_Admin_Statics::NUTActor_eventAdmin_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020601, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_Admin_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_Admin_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_Admin_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ANUTActor_Admin_Statics::NUTActor_eventAdmin_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_NetFlush_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "NetFlush", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020601, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_NetFlush_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_NetFlush_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_NetMulticastPing_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "NetMulticastPing", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00024CC2, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_NetMulticastPing_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_NetMulticastPing_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::NewProp_Command = { "Command", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NUTActor_eventServerAdmin_Parms, Command), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::NewProp_Command_MetaData), Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::NewProp_Command_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "ServerAdmin", nullptr, nullptr, Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::PropPointers), sizeof(NUTActor_eventServerAdmin_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x80220CC0, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerAdmin_Statics::PropPointers) < 2048);
	static_assert(sizeof(NUTActor_eventServerAdmin_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_ServerClientPing_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "ServerClientPing", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x80220CC2, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerClientPing_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_ServerClientPing_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_ServerClientStillAlive_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "ServerClientStillAlive", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x80220CC0, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerClientStillAlive_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_ServerClientStillAlive_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::NewProp_InDelegate = { "InDelegate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NUTActor_eventServerExecute_Parms, InDelegate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::NewProp_InDelegate_MetaData), Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::NewProp_InDelegate_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "ServerExecute", nullptr, nullptr, Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::PropPointers), sizeof(NUTActor_eventServerExecute_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x80220CC0, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerExecute_Statics::PropPointers) < 2048);
	static_assert(sizeof(NUTActor_eventServerExecute_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::NewProp_InText = { "InText", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NUTActor_eventServerReceiveText_Parms, InText), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::NewProp_InText_MetaData), Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::NewProp_InText_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "ServerReceiveText", nullptr, nullptr, Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::PropPointers), sizeof(NUTActor_eventServerReceiveText_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x80220CC2, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_ServerReceiveText_Statics::PropPointers) < 2048);
	static_assert(sizeof(NUTActor_eventServerReceiveText_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::NewProp_Dest = { "Dest", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NUTActor_eventUnitSeamlessTravel_Parms, Dest), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "UnitSeamlessTravel", nullptr, nullptr, Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::PropPointers), sizeof(Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::NUTActor_eventUnitSeamlessTravel_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020601, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel_Statics::NUTActor_eventUnitSeamlessTravel_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::NewProp_Dest = { "Dest", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NUTActor_eventUnitTravel_Parms, Dest), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "UnitTravel", nullptr, nullptr, Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::PropPointers), sizeof(Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::NUTActor_eventUnitTravel_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020601, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ANUTActor_UnitTravel_Statics::NUTActor_eventUnitTravel_Parms) < MAX_uint16);
	...
	struct Z_Construct_UFunction_ANUTActor_Wait_Statics
	{
		...
		static const UECodeGen_Private::FUInt16PropertyParams NewProp_Seconds;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UFunction_ANUTActor_Wait_Statics::NewProp_Seconds = { "Seconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NUTActor_eventWait_Parms, Seconds), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANUTActor_Wait_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANUTActor, nullptr, "Wait", nullptr, nullptr, Z_Construct_UFunction_ANUTActor_Wait_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_Wait_Statics::PropPointers), sizeof(Z_Construct_UFunction_ANUTActor_Wait_Statics::NUTActor_eventWait_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020601, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_Wait_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANUTActor_Wait_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANUTActor_Wait_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ANUTActor_Wait_Statics::NUTActor_eventWait_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANUTActor_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_ANUTActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ANUTActor_Admin, "Admin" }, // 3481615405
		{ &Z_Construct_UFunction_ANUTActor_NetFlush, "NetFlush" }, // 295813786
		{ &Z_Construct_UFunction_ANUTActor_NetMulticastPing, "NetMulticastPing" }, // 2096715467
		{ &Z_Construct_UFunction_ANUTActor_ServerAdmin, "ServerAdmin" }, // 1145508306
		{ &Z_Construct_UFunction_ANUTActor_ServerClientPing, "ServerClientPing" }, // 10489143
		{ &Z_Construct_UFunction_ANUTActor_ServerClientStillAlive, "ServerClientStillAlive" }, // 2586761027
		{ &Z_Construct_UFunction_ANUTActor_ServerExecute, "ServerExecute" }, // 2608681339
		{ &Z_Construct_UFunction_ANUTActor_ServerReceiveText, "ServerReceiveText" }, // 808477833
		{ &Z_Construct_UFunction_ANUTActor_UnitSeamlessTravel, "UnitSeamlessTravel" }, // 1901164744
		{ &Z_Construct_UFunction_ANUTActor_UnitTravel, "UnitTravel" }, // 2018254650
		{ &Z_Construct_UFunction_ANUTActor_Wait, "Wait" }, // 1965247391
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANUTActor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_ANUTActor_Statics::NewProp_TempDelegate = { "TempDelegate", nullptr, (EPropertyFlags)0x0010000000080000, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANUTActor, TempDelegate), Z_Construct_UDelegateFunction_NetcodeUnitTest_ExecuteOnServer__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANUTActor_Statics::NewProp_TempDelegate_MetaData), Z_Construct_UClass_ANUTActor_Statics::NewProp_TempDelegate_MetaData) }; // 929636688
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ANUTActor_Statics::ClassParams = {
		...
		0,
		0x008000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANUTActor_Statics::Class_MetaDataParams), Z_Construct_UClass_ANUTActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANUTActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_NUTActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANUTActor, ANUTActor::StaticClass, TEXT("ANUTActor"), &Z_Registration_Info_UClass_ANUTActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANUTActor), 836820839U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_NUTActor_h_877649599(TEXT("/Script/NetcodeUnitTest"),
