...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestCommandlet_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUnitTestCommandlet_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTestCommandlet_Statics::Class_MetaDataParams), Z_Construct_UClass_UUnitTestCommandlet_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTestCommandlet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUnitTestCommandlet, UUnitTestCommandlet::StaticClass, TEXT("UUnitTestCommandlet"), &Z_Registration_Info_UClass_UUnitTestCommandlet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUnitTestCommandlet), 1943759443U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTestCommandlet_h_3219916458(TEXT("/Script/NetcodeUnitTest"),
