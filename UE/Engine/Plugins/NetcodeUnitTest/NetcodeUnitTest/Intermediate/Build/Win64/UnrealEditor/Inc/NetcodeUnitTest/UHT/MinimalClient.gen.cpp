...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMinimalClient_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitWorld = { "UnitWorld", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMinimalClient, UnitWorld), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitWorld_MetaData), Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitWorld_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitNetDriver = { "UnitNetDriver", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMinimalClient, UnitNetDriver), Z_Construct_UClass_UNetDriver_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitNetDriver_MetaData), Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitNetDriver_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitConn = { "UnitConn", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMinimalClient, UnitConn), Z_Construct_UClass_UNetConnection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitConn_MetaData), Z_Construct_UClass_UMinimalClient_Statics::NewProp_UnitConn_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMinimalClient_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMinimalClient_Statics::Class_MetaDataParams), Z_Construct_UClass_UMinimalClient_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMinimalClient_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_MinimalClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMinimalClient, UMinimalClient::StaticClass, TEXT("UMinimalClient"), &Z_Registration_Info_UClass_UMinimalClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMinimalClient), 946395692U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_MinimalClient_h_1703162099(TEXT("/Script/NetcodeUnitTest"),
