...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPackedVectorTest_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPackedVectorTest_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPackedVectorTest_Statics::Class_MetaDataParams), Z_Construct_UClass_UPackedVectorTest_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTests_Engine_PackedVectorTest_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPackedVectorTest, UPackedVectorTest::StaticClass, TEXT("UPackedVectorTest"), &Z_Registration_Info_UClass_UPackedVectorTest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPackedVectorTest), 2053895095U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTests_Engine_PackedVectorTest_h_427001936(TEXT("/Script/NetcodeUnitTest"),
