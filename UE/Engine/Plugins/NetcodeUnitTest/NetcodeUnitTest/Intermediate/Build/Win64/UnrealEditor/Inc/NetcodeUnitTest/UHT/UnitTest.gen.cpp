...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NetcodeUnitTest_EUnitTestVerification_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NetcodeUnitTest_EUnitTestVerification_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NetcodeUnitTest_EUnitTestVerification_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NetcodeUnitTest_EUnitTestResetStage_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NetcodeUnitTest_EUnitTestResetStage_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NetcodeUnitTest_EUnitTestResetStage_Statics::Enum_MetaDataParams)
	};
...
#endif
		static const UECodeGen_Private::FUInt64PropertyParams NewProp_PeakMemoryUsage;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt64PropertyParams Z_Construct_UClass_UUnitTest_Statics::NewProp_PeakMemoryUsage = { "PeakMemoryUsage", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUnitTest, PeakMemoryUsage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::NewProp_PeakMemoryUsage_MetaData), Z_Construct_UClass_UUnitTest_Statics::NewProp_PeakMemoryUsage_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UUnitTest_Statics::NewProp_TimeToPeakMem = { "TimeToPeakMem", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUnitTest, TimeToPeakMem), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::NewProp_TimeToPeakMem_MetaData), Z_Construct_UClass_UUnitTest_Statics::NewProp_TimeToPeakMem_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UUnitTest_Statics::NewProp_LastExecutionTime = { "LastExecutionTime", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUnitTest, LastExecutionTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::NewProp_LastExecutionTime_MetaData), Z_Construct_UClass_UUnitTest_Statics::NewProp_LastExecutionTime_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUnitTest_Statics::NewProp_UnitTasks_Inner = { "UnitTasks", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UUnitTask_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUnitTest_Statics::NewProp_UnitTasks = { "UnitTasks", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUnitTest, UnitTasks), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::NewProp_UnitTasks_MetaData), Z_Construct_UClass_UUnitTest_Statics::NewProp_UnitTasks_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UUnitTest_Statics::NewProp_VerificationState = { "VerificationState", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUnitTest, VerificationState), Z_Construct_UEnum_NetcodeUnitTest_EUnitTestVerification, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::NewProp_VerificationState_MetaData), Z_Construct_UClass_UUnitTest_Statics::NewProp_VerificationState_MetaData) }; // 59948002
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUnitTest_Statics::ClassParams = {
		...
		0,
		0x001000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::Class_MetaDataParams), Z_Construct_UClass_UUnitTest_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUnitTest_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTest_h_Statics::EnumInfo[] = {
		{ EUnitTestVerification_StaticEnum, TEXT("EUnitTestVerification"), &Z_Registration_Info_UEnum_EUnitTestVerification, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 59948002U) },
		{ EUnitTestResetStage_StaticEnum, TEXT("EUnitTestResetStage"), &Z_Registration_Info_UEnum_EUnitTestResetStage, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1852727635U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTest_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUnitTest, UUnitTest::StaticClass, TEXT("UUnitTest"), &Z_Registration_Info_UClass_UUnitTest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUnitTest), 2678786693U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_NetcodeUnitTest_NetcodeUnitTest_Source_NetcodeUnitTest_Classes_UnitTest_h_3312842904(TEXT("/Script/NetcodeUnitTest"),
