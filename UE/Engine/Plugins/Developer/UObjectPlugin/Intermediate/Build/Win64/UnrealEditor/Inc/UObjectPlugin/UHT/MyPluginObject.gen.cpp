...
template<> UOBJECTPLUGIN_API UScriptStruct* StaticStruct<FMyPluginStruct>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_UObjectPlugin_Source_UObjectPlugin_Classes_MyPluginObject_h_Statics::ScriptStructInfo[] = {
		{ FMyPluginStruct::StaticStruct, Z_Construct_UScriptStruct_FMyPluginStruct_Statics::NewStructOps, TEXT("MyPluginStruct"), &Z_Registration_Info_UScriptStruct_MyPluginStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMyPluginStruct), 3250744599U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_UObjectPlugin_Source_UObjectPlugin_Classes_MyPluginObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMyPluginObject, UMyPluginObject::StaticClass, TEXT("UMyPluginObject"), &Z_Registration_Info_UClass_UMyPluginObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyPluginObject), 2696437714U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_UObjectPlugin_Source_UObjectPlugin_Classes_MyPluginObject_h_1530339478(TEXT("/Script/UObjectPlugin"),
