...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::NewProp_CookedSourceFilterClasses = { "CookedSourceFilterClasses", nullptr, (EPropertyFlags)0x0014040000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTraceSourceFilteringProjectSettings, CookedSourceFilterClasses), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::NewProp_CookedSourceFilterClasses_MetaData), Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::NewProp_CookedSourceFilterClasses_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::NewProp_DefaultFilterPreset = { "DefaultFilterPreset", nullptr, (EPropertyFlags)0x0014040000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTraceSourceFilteringProjectSettings, DefaultFilterPreset), Z_Construct_UClass_USourceFilterCollection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::NewProp_DefaultFilterPreset_MetaData), Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::NewProp_DefaultFilterPreset_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringProjectSettings_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_TraceSourceFiltering_Source_SourceFilteringTrace_Public_TraceSourceFilteringProjectSettings_h_679794749(TEXT("/Script/SourceFilteringTrace"),
