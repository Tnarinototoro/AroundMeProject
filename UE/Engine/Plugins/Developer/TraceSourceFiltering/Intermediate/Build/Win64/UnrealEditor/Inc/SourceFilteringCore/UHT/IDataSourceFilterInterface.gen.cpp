...
template<> SOURCEFILTERINGCORE_API UScriptStruct* StaticStruct<FDataSourceFilterConfiguration>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bOnlyApplyDuringActorSpawn = { "bOnlyApplyDuringActorSpawn", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FDataSourceFilterConfiguration), &Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bOnlyApplyDuringActorSpawn_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bOnlyApplyDuringActorSpawn_MetaData), Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bOnlyApplyDuringActorSpawn_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bCanRunAsynchronously = { "bCanRunAsynchronously", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FDataSourceFilterConfiguration), &Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bCanRunAsynchronously_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bCanRunAsynchronously_MetaData), Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_bCanRunAsynchronously_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_FilterApplyingTickInterval = { "FilterApplyingTickInterval", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDataSourceFilterConfiguration, FilterApplyingTickInterval), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_FilterApplyingTickInterval_MetaData), Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::NewProp_FilterApplyingTickInterval_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataSourceFilterConfiguration_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText_Statics::NewProp_OutDisplayText = { "OutDisplayText", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DataSourceFilterInterface_eventGetDisplayText_Parms, OutDisplayText), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDataSourceFilterInterface, nullptr, "GetDisplayText", nullptr, nullptr, Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText_Statics::PropPointers), sizeof(DataSourceFilterInterface_eventGetDisplayText_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x48420C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText_Statics::PropPointers) < 2048);
	static_assert(sizeof(DataSourceFilterInterface_eventGetDisplayText_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText_Statics::NewProp_OutDisplayText = { "OutDisplayText", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DataSourceFilterInterface_eventGetToolTipText_Parms, OutDisplayText), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDataSourceFilterInterface, nullptr, "GetToolTipText", nullptr, nullptr, Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText_Statics::PropPointers), sizeof(DataSourceFilterInterface_eventGetToolTipText_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x48420C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText_Statics::PropPointers) < 2048);
	static_assert(sizeof(DataSourceFilterInterface_eventGetToolTipText_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataSourceFilterInterface_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDataSourceFilterInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDataSourceFilterInterface_GetDisplayText, "GetDisplayText" }, // 250831796
		{ &Z_Construct_UFunction_UDataSourceFilterInterface_GetToolTipText, "GetToolTipText" }, // 1059254177
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataSourceFilterInterface_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataSourceFilterInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataSourceFilterInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataSourceFilterInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_TraceSourceFiltering_Source_SourceFilteringCore_Public_IDataSourceFilterInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataSourceFilterInterface, UDataSourceFilterInterface::StaticClass, TEXT("UDataSourceFilterInterface"), &Z_Registration_Info_UClass_UDataSourceFilterInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataSourceFilterInterface), 95162568U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_TraceSourceFiltering_Source_SourceFilteringCore_Public_IDataSourceFilterInterface_h_294610763(TEXT("/Script/SourceFilteringCore"),
