...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilteringStates = { "bDrawFilteringStates", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTraceSourceFilteringSettings), &Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilteringStates_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilteringStates_MetaData), Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilteringStates_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawOnlyPassingActors = { "bDrawOnlyPassingActors", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTraceSourceFilteringSettings), &Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawOnlyPassingActors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawOnlyPassingActors_MetaData), Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawOnlyPassingActors_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilterDescriptionForRejectedActors = { "bDrawFilterDescriptionForRejectedActors", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTraceSourceFilteringSettings), &Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilterDescriptionForRejectedActors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilterDescriptionForRejectedActors_MetaData), Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bDrawFilterDescriptionForRejectedActors_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bOutputOptimizedFilterState = { "bOutputOptimizedFilterState", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTraceSourceFilteringSettings), &Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bOutputOptimizedFilterState_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bOutputOptimizedFilterState_MetaData), Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::NewProp_bOutputOptimizedFilterState_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTraceSourceFilteringSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_TraceSourceFiltering_Source_SourceFilteringCore_Public_TraceSourceFilteringSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTraceSourceFilteringSettings, UTraceSourceFilteringSettings::StaticClass, TEXT("UTraceSourceFilteringSettings"), &Z_Registration_Info_UClass_UTraceSourceFilteringSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTraceSourceFilteringSettings), 1003746687U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_TraceSourceFiltering_Source_SourceFilteringCore_Public_TraceSourceFilteringSettings_h_3955834150(TEXT("/Script/SourceFilteringCore"),
