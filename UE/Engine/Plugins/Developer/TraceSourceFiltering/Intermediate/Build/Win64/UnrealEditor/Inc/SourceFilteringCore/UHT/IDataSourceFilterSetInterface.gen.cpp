...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataSourceFilterSetInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataSourceFilterSetInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataSourceFilterSetInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataSourceFilterSetInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_TraceSourceFiltering_Source_SourceFilteringCore_Public_IDataSourceFilterSetInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataSourceFilterSetInterface, UDataSourceFilterSetInterface::StaticClass, TEXT("UDataSourceFilterSetInterface"), &Z_Registration_Info_UClass_UDataSourceFilterSetInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataSourceFilterSetInterface), 397396354U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_TraceSourceFiltering_Source_SourceFilteringCore_Public_IDataSourceFilterSetInterface_h_1384331647(TEXT("/Script/SourceFilteringCore"),
