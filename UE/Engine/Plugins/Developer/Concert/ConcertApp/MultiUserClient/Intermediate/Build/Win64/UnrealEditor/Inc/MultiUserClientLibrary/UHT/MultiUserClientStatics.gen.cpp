...
// Cross Module References
	...
	MULTIUSERCLIENTLIBRARY_API UScriptStruct* Z_Construct_UScriptStruct_FMultiUserSessionInfo();
...
// End Cross Module References
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::NewProp_PackageName = { "PackageName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MultiUserClientLibrary_eventOnPackageSavedSignature_Parms, PackageName), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_MultiUserClientLibrary, nullptr, "OnPackageSavedSignature__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::_Script_MultiUserClientLibrary_eventOnPackageSavedSignature_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature_Statics::_Script_MultiUserClientLibrary_eventOnPackageSavedSignature_Parms) < MAX_uint16);
...
template<> MULTIUSERCLIENTLIBRARY_API UScriptStruct* StaticStruct<FMultiUserClientInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_ClientEndpointId = { "ClientEndpointId", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientInfo, ClientEndpointId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_ClientEndpointId_MetaData), Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_ClientEndpointId_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientInfo, DisplayName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_DisplayName_MetaData), Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_DisplayName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_AvatarColor = { "AvatarColor", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientInfo, AvatarColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_AvatarColor_MetaData), Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_AvatarColor_MetaData) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_Tags_Inner = { "Tags", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_Tags = { "Tags", nullptr, (EPropertyFlags)0x0010040000020015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientInfo, Tags), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_Tags_MetaData), Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewProp_Tags_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::PropPointers) < 2048);
	...
	static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_MultiUserSessionInfo;
class UScriptStruct* FMultiUserSessionInfo::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_MultiUserSessionInfo.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_MultiUserSessionInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMultiUserSessionInfo, (UObject*)Z_Construct_UPackage__Script_MultiUserClientLibrary(), TEXT("MultiUserSessionInfo"));
	}
	return Z_Registration_Info_UScriptStruct_MultiUserSessionInfo.OuterSingleton;
}
template<> MULTIUSERCLIENTLIBRARY_API UScriptStruct* StaticStruct<FMultiUserSessionInfo>()
{
	return FMultiUserSessionInfo::StaticStruct();
}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_EndpointName_MetaData[];
#endif
		static const UECodeGen_Private::FStrPropertyParams NewProp_EndpointName;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "/**\n * BP copy of FConcertSessionInfo\n * Holds info on a connected session.\n */" },
		{ "ModuleRelativePath", "Public/MultiUserClientStatics.h" },
		{ "ToolTip", "BP copy of FConcertSessionInfo\nHolds info on a connected session." },
	};
#endif
	void* Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FMultiUserSessionInfo>();
	}
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerEndpointId_MetaData[] = {
		{ "Category", "Session Info" },
		{ "Comment", "/** Holds the server endpoint id for this session. */" },
		{ "ModuleRelativePath", "Public/MultiUserClientStatics.h" },
		{ "ToolTip", "Holds the server endpoint id for this session." },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerEndpointId = { "ServerEndpointId", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserSessionInfo, ServerEndpointId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerEndpointId_MetaData), Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerEndpointId_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_SessionName_MetaData[] = {
		{ "Category", "Session Info" },
		{ "Comment", "/** Holds the session name current connected. */" },
		{ "ModuleRelativePath", "Public/MultiUserClientStatics.h" },
		{ "ToolTip", "Holds the session name current connected." },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_SessionName = { "SessionName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserSessionInfo, SessionName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_SessionName_MetaData), Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_SessionName_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerName_MetaData[] = {
		{ "Category", "Session Info" },
		{ "Comment", "/** Holds the server name for the connected session. */" },
		{ "ModuleRelativePath", "Public/MultiUserClientStatics.h" },
		{ "ToolTip", "Holds the server name for the connected session." },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerName = { "ServerName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserSessionInfo, ServerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerName_MetaData), Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerName_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_EndpointName_MetaData[] = {
		{ "Category", "Session Info" },
		{ "Comment", "/** Holds the resolved endpoint name (HostPC) for the connected session. */" },
		{ "ModuleRelativePath", "Public/MultiUserClientStatics.h" },
		{ "ToolTip", "Holds the resolved endpoint name (HostPC) for the connected session." },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_EndpointName = { "EndpointName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserSessionInfo, EndpointName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_EndpointName_MetaData), Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_EndpointName_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_bValid_MetaData[] = {
		{ "Category", "Session Info" },
		{ "Comment", "/** Indicates if the current session info is valid. If we are connected to a session this is true, otherwise false. */" },
		{ "ModuleRelativePath", "Public/MultiUserClientStatics.h" },
		{ "ToolTip", "Indicates if the current session info is valid. If we are connected to a session this is true, otherwise false." },
	};
#endif
	void Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_bValid_SetBit(void* Obj)
	{
		((FMultiUserSessionInfo*)Obj)->bValid = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_bValid = { "bValid", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMultiUserSessionInfo), &Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_bValid_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_bValid_MetaData), Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_bValid_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerEndpointId,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_SessionName,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_ServerName,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_EndpointName,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewProp_bValid,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_MultiUserClientLibrary,
		nullptr,
		&NewStructOps,
		"MultiUserSessionInfo",
		Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::PropPointers),
		sizeof(FMultiUserSessionInfo),
		alignof(FMultiUserSessionInfo),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::PropPointers) < 2048);
	UScriptStruct* Z_Construct_UScriptStruct_FMultiUserSessionInfo()
	{
		if (!Z_Registration_Info_UScriptStruct_MultiUserSessionInfo.InnerSingleton)
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MultiUserSessionInfo.InnerSingleton, Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::ReturnStructParams);
		}
		return Z_Registration_Info_UScriptStruct_MultiUserSessionInfo.InnerSingleton;
	}
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::NewProp_OnPackageSaved = { "OnPackageSaved", nullptr, (EPropertyFlags)0x00100000100a0001, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMultiUserClientSyncDatabase, OnPackageSaved), Z_Construct_UDelegateFunction_MultiUserClientLibrary_OnPackageSavedSignature__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::NewProp_OnPackageSaved_MetaData), Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::NewProp_OnPackageSaved_MetaData) }; // 4041623327
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::ClassParams = {
		...
		0,
		0x008000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::Class_MetaDataParams), Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserClientSyncDatabase_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionError_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionError_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionError_Statics::Enum_MetaDataParams)
	};
...
template<> MULTIUSERCLIENTLIBRARY_API UScriptStruct* StaticStruct<FMultiUserConnectionError>()
{
...
#endif
		static void* NewStructOps();
		static const UECodeGen_Private::FIntPropertyParams NewProp_ErrorCode_Underlying;
#if WITH_METADATA
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewProp_ErrorCode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewProp_ErrorCode = { "ErrorCode", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserConnectionError, ErrorCode), Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionError, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewProp_ErrorCode_MetaData), Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewProp_ErrorCode_MetaData) }; // 2154569439
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewProp_ErrorMessage = { "ErrorMessage", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserConnectionError, ErrorMessage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewProp_ErrorMessage_MetaData), Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewProp_ErrorMessage_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserSourceValidationMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserSourceValidationMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserSourceValidationMode_Statics::Enum_MetaDataParams)
	};
...
template<> MULTIUSERCLIENTLIBRARY_API UScriptStruct* StaticStruct<FMultiUserClientConfig>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultServerURL = { "DefaultServerURL", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientConfig, DefaultServerURL), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultServerURL_MetaData), Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultServerURL_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultSessionName = { "DefaultSessionName", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientConfig, DefaultSessionName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultSessionName_MetaData), Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultSessionName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultSessionToRestore = { "DefaultSessionToRestore", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientConfig, DefaultSessionToRestore), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultSessionToRestore_MetaData), Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_DefaultSessionToRestore_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_ValidationMode = { "ValidationMode", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMultiUserClientConfig, ValidationMode), Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserSourceValidationMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_ValidationMode_MetaData), Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewProp_ValidationMode_MetaData) }; // 1582347893
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionStatus_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionStatus_Statics::Enum_MetaDataParams)
	};
	...
	DEFINE_FUNCTION(UMultiUserClientStatics::execGetMultiUserSessionInfo)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FMultiUserSessionInfo*)Z_Param__Result=UMultiUserClientStatics::GetMultiUserSessionInfo();
		P_NATIVE_END;
	}
	...
	void UMultiUserClientStatics::StaticRegisterNativesUMultiUserClientStatics()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetMultiUserSessionInfo", &UMultiUserClientStatics::execGetMultiUserSessionInfo },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::NewProp_ClientConfig = { "ClientConfig", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventConfigureMultiUserClient_Parms, ClientConfig), Z_Construct_UScriptStruct_FMultiUserClientConfig, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::NewProp_ClientConfig_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::NewProp_ClientConfig_MetaData) }; // 1204742878
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventConfigureMultiUserClient_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "ConfigureMultiUserClient", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::MultiUserClientStatics_eventConfigureMultiUserClient_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient_Statics::MultiUserClientStatics_eventConfigureMultiUserClient_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::NewProp_IgnorePersisted = { "IgnorePersisted", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventGatherSessionChanges_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::NewProp_IgnorePersisted_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGatherSessionChanges_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GatherSessionChanges", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::MultiUserClientStatics_eventGatherSessionChanges_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges_Statics::MultiUserClientStatics_eventGatherSessionChanges_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetConcertSyncDatabase_Parms, ReturnValue), Z_Construct_UClass_UMultiUserClientSyncDatabase_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetConcertSyncDatabase", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::MultiUserClientStatics_eventGetConcertSyncDatabase_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase_Statics::MultiUserClientStatics_eventGetConcertSyncDatabase_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetLastMultiUserConnectionError_Parms, ReturnValue), Z_Construct_UScriptStruct_FMultiUserConnectionError, METADATA_PARAMS(0, nullptr) }; // 2940263546
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetLastMultiUserConnectionError", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::MultiUserClientStatics_eventGetLastMultiUserConnectionError_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError_Statics::MultiUserClientStatics_eventGetLastMultiUserConnectionError_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetLocalMultiUserClientInfo_Parms, ReturnValue), Z_Construct_UScriptStruct_FMultiUserClientInfo, METADATA_PARAMS(0, nullptr) }; // 2069460948
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetLocalMultiUserClientInfo", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::MultiUserClientStatics_eventGetLocalMultiUserClientInfo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo_Statics::MultiUserClientStatics_eventGetLocalMultiUserClientInfo_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::NewProp_ClientName = { "ClientName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetMultiUserClientInfoByName_Parms, ClientName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::NewProp_ClientName_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::NewProp_ClientName_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::NewProp_ClientInfo = { "ClientInfo", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetMultiUserClientInfoByName_Parms, ClientInfo), Z_Construct_UScriptStruct_FMultiUserClientInfo, METADATA_PARAMS(0, nullptr) }; // 2069460948
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventGetMultiUserClientInfoByName_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetMultiUserClientInfoByName", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::MultiUserClientStatics_eventGetMultiUserClientInfoByName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName_Statics::MultiUserClientStatics_eventGetMultiUserClientInfoByName_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventGetMultiUserConnectionStatus_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetMultiUserConnectionStatus", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::MultiUserClientStatics_eventGetMultiUserConnectionStatus_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus_Statics::MultiUserClientStatics_eventGetMultiUserConnectionStatus_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetMultiUserConnectionStatusDetail_Parms, ReturnValue), Z_Construct_UEnum_MultiUserClientLibrary_EMultiUserConnectionStatus, METADATA_PARAMS(0, nullptr) }; // 1259890079
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetMultiUserConnectionStatusDetail", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::MultiUserClientStatics_eventGetMultiUserConnectionStatusDetail_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail_Statics::MultiUserClientStatics_eventGetMultiUserConnectionStatusDetail_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::NewProp_ClientEndpointId = { "ClientEndpointId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetMultiUserPresenceTransform_Parms, ClientEndpointId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::NewProp_ClientEndpointId_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::NewProp_ClientEndpointId_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetMultiUserPresenceTransform_Parms, ReturnValue), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetMultiUserPresenceTransform", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::MultiUserClientStatics_eventGetMultiUserPresenceTransform_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C22401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform_Statics::MultiUserClientStatics_eventGetMultiUserPresenceTransform_Parms) < MAX_uint16);
	...
	struct Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics
	{
		struct MultiUserClientStatics_eventGetMultiUserSessionInfo_Parms
		{
			FMultiUserSessionInfo ReturnValue;
		};
		static const UECodeGen_Private::FStructPropertyParams NewProp_ReturnValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetMultiUserSessionInfo_Parms, ReturnValue), Z_Construct_UScriptStruct_FMultiUserSessionInfo, METADATA_PARAMS(0, nullptr) }; // 2791656945
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::Function_MetaDataParams[] = {
		{ "Category", "Multi-User Client" },
		{ "Comment", "/** Get the current SessionInfo. Works when not connected to a session, but returns an empty session info. */" },
		{ "DevelopmentOnly", "" },
		{ "DisplayName", "Get Multi-User Session Info" },
		{ "ModuleRelativePath", "Public/MultiUserClientStatics.h" },
		{ "ToolTip", "Get the current SessionInfo. Works when not connected to a session, but returns an empty session info." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetMultiUserSessionInfo", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::MultiUserClientStatics_eventGetMultiUserSessionInfo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::MultiUserClientStatics_eventGetMultiUserSessionInfo_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::NewProp_ClientInfos_Inner = { "ClientInfos", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FMultiUserClientInfo, METADATA_PARAMS(0, nullptr) }; // 2069460948
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::NewProp_ClientInfos = { "ClientInfos", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventGetRemoteMultiUserClientInfos_Parms, ClientInfos), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 2069460948
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventGetRemoteMultiUserClientInfos_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "GetRemoteMultiUserClientInfos", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::MultiUserClientStatics_eventGetRemoteMultiUserClientInfos_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos_Statics::MultiUserClientStatics_eventGetRemoteMultiUserClientInfos_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::NewProp_OtherUserName = { "OtherUserName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventJumpToMultiUserPresence_Parms, OtherUserName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::NewProp_OtherUserName_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::NewProp_OtherUserName_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::NewProp_TransformOffset = { "TransformOffset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventJumpToMultiUserPresence_Parms, TransformOffset), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "JumpToMultiUserPresence", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::MultiUserClientStatics_eventJumpToMultiUserPresence_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence_Statics::MultiUserClientStatics_eventJumpToMultiUserPresence_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_PersistMultiUserSessionChanges_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "PersistMultiUserSessionChanges", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_PersistMultiUserSessionChanges_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_PersistMultiUserSessionChanges_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::NewProp_PackagesToPersist_Inner = { "PackagesToPersist", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::NewProp_PackagesToPersist = { "PackagesToPersist", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventPersistSpecifiedPackages_Parms, PackagesToPersist), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::NewProp_PackagesToPersist_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::NewProp_PackagesToPersist_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "PersistSpecifiedPackages", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::MultiUserClientStatics_eventPersistSpecifiedPackages_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages_Statics::MultiUserClientStatics_eventPersistSpecifiedPackages_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::NewProp_IsEnabled = { "IsEnabled", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventSetMultiUserPresenceEnabled_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::NewProp_IsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::NewProp_IsEnabled_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::NewProp_IsEnabled_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "SetMultiUserPresenceEnabled", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::MultiUserClientStatics_eventSetMultiUserPresenceEnabled_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled_Statics::MultiUserClientStatics_eventSetMultiUserPresenceEnabled_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventSetMultiUserPresenceVisibility_Parms, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::NewProp_Name_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::NewProp_Name_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::NewProp_Visibility = { "Visibility", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventSetMultiUserPresenceVisibility_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::NewProp_Visibility_SetBit, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::NewProp_PropagateToAll = { "PropagateToAll", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventSetMultiUserPresenceVisibility_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::NewProp_PropagateToAll_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "SetMultiUserPresenceVisibility", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::MultiUserClientStatics_eventSetMultiUserPresenceVisibility_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility_Statics::MultiUserClientStatics_eventSetMultiUserPresenceVisibility_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::NewProp_ClientEndpointId = { "ClientEndpointId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MultiUserClientStatics_eventSetMultiUserPresenceVisibilityById_Parms, ClientEndpointId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::NewProp_ClientEndpointId_MetaData), Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::NewProp_ClientEndpointId_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::NewProp_Visibility = { "Visibility", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventSetMultiUserPresenceVisibilityById_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::NewProp_Visibility_SetBit, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::NewProp_PropagateToAll = { "PropagateToAll", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventSetMultiUserPresenceVisibilityById_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::NewProp_PropagateToAll_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "SetMultiUserPresenceVisibilityById", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::MultiUserClientStatics_eventSetMultiUserPresenceVisibilityById_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C22401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById_Statics::MultiUserClientStatics_eventSetMultiUserPresenceVisibilityById_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MultiUserClientStatics_eventStartMultiUserDefaultConnection_Parms), &Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "StartMultiUserDefaultConnection", nullptr, nullptr, Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::MultiUserClientStatics_eventStartMultiUserDefaultConnection_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection_Statics::MultiUserClientStatics_eventStartMultiUserDefaultConnection_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMultiUserClientStatics_UpdateWorkspaceModifiedPackages_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMultiUserClientStatics, nullptr, "UpdateWorkspaceModifiedPackages", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMultiUserClientStatics_UpdateWorkspaceModifiedPackages_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMultiUserClientStatics_UpdateWorkspaceModifiedPackages_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserClientStatics_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMultiUserClientStatics_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMultiUserClientStatics_ConfigureMultiUserClient, "ConfigureMultiUserClient" }, // 2624621142
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GatherSessionChanges, "GatherSessionChanges" }, // 341495912
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetConcertSyncDatabase, "GetConcertSyncDatabase" }, // 2389926063
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetLastMultiUserConnectionError, "GetLastMultiUserConnectionError" }, // 2267905925
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetLocalMultiUserClientInfo, "GetLocalMultiUserClientInfo" }, // 1530396254
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserClientInfoByName, "GetMultiUserClientInfoByName" }, // 2911173958
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatus, "GetMultiUserConnectionStatus" }, // 3862025725
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserConnectionStatusDetail, "GetMultiUserConnectionStatusDetail" }, // 1759295198
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserPresenceTransform, "GetMultiUserPresenceTransform" }, // 2614382111
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetMultiUserSessionInfo, "GetMultiUserSessionInfo" }, // 111816278
		{ &Z_Construct_UFunction_UMultiUserClientStatics_GetRemoteMultiUserClientInfos, "GetRemoteMultiUserClientInfos" }, // 1229609137
		{ &Z_Construct_UFunction_UMultiUserClientStatics_JumpToMultiUserPresence, "JumpToMultiUserPresence" }, // 4102124175
		{ &Z_Construct_UFunction_UMultiUserClientStatics_PersistMultiUserSessionChanges, "PersistMultiUserSessionChanges" }, // 4076614525
		{ &Z_Construct_UFunction_UMultiUserClientStatics_PersistSpecifiedPackages, "PersistSpecifiedPackages" }, // 731776038
		{ &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceEnabled, "SetMultiUserPresenceEnabled" }, // 1980127190
		{ &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibility, "SetMultiUserPresenceVisibility" }, // 1992269413
		{ &Z_Construct_UFunction_UMultiUserClientStatics_SetMultiUserPresenceVisibilityById, "SetMultiUserPresenceVisibilityById" }, // 2270044679
		{ &Z_Construct_UFunction_UMultiUserClientStatics_StartMultiUserDefaultConnection, "StartMultiUserDefaultConnection" }, // 199551725
		{ &Z_Construct_UFunction_UMultiUserClientStatics_UpdateWorkspaceModifiedPackages, "UpdateWorkspaceModifiedPackages" }, // 2791801443
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserClientStatics_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMultiUserClientStatics_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserClientStatics_Statics::Class_MetaDataParams), Z_Construct_UClass_UMultiUserClientStatics_Statics::Class_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserClient_Source_MultiUserClientLibrary_Public_MultiUserClientStatics_h_Statics::EnumInfo[] = {
		{ EMultiUserConnectionError_StaticEnum, TEXT("EMultiUserConnectionError"), &Z_Registration_Info_UEnum_EMultiUserConnectionError, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2154569439U) },
		{ EMultiUserSourceValidationMode_StaticEnum, TEXT("EMultiUserSourceValidationMode"), &Z_Registration_Info_UEnum_EMultiUserSourceValidationMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1582347893U) },
		{ EMultiUserConnectionStatus_StaticEnum, TEXT("EMultiUserConnectionStatus"), &Z_Registration_Info_UEnum_EMultiUserConnectionStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1259890079U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserClient_Source_MultiUserClientLibrary_Public_MultiUserClientStatics_h_Statics::ScriptStructInfo[] = {
		{ FMultiUserClientInfo::StaticStruct, Z_Construct_UScriptStruct_FMultiUserClientInfo_Statics::NewStructOps, TEXT("MultiUserClientInfo"), &Z_Registration_Info_UScriptStruct_MultiUserClientInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMultiUserClientInfo), 2069460948U) },
		{ FMultiUserSessionInfo::StaticStruct, Z_Construct_UScriptStruct_FMultiUserSessionInfo_Statics::NewStructOps, TEXT("MultiUserSessionInfo"), &Z_Registration_Info_UScriptStruct_MultiUserSessionInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMultiUserSessionInfo), 2791656945U) },
		{ FMultiUserConnectionError::StaticStruct, Z_Construct_UScriptStruct_FMultiUserConnectionError_Statics::NewStructOps, TEXT("MultiUserConnectionError"), &Z_Registration_Info_UScriptStruct_MultiUserConnectionError, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMultiUserConnectionError), 2940263546U) },
		{ FMultiUserClientConfig::StaticStruct, Z_Construct_UScriptStruct_FMultiUserClientConfig_Statics::NewStructOps, TEXT("MultiUserClientConfig"), &Z_Registration_Info_UScriptStruct_MultiUserClientConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMultiUserClientConfig), 1204742878U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserClient_Source_MultiUserClientLibrary_Public_MultiUserClientStatics_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMultiUserClientSyncDatabase, UMultiUserClientSyncDatabase::StaticClass, TEXT("UMultiUserClientSyncDatabase"), &Z_Registration_Info_UClass_UMultiUserClientSyncDatabase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiUserClientSyncDatabase), 3522572905U) },
		{ Z_Construct_UClass_UMultiUserClientStatics, UMultiUserClientStatics::StaticClass, TEXT("UMultiUserClientStatics"), &Z_Registration_Info_UClass_UMultiUserClientStatics, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiUserClientStatics), 264781865U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserClient_Source_MultiUserClientLibrary_Public_MultiUserClientStatics_h_2199518165(TEXT("/Script/MultiUserClientLibrary"),
