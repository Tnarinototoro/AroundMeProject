...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_bIsEnabled = { "bIsEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDisasterRecoverClientConfig), &Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_bIsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_bIsEnabled_MetaData), Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_bIsEnabled_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_RecoverySessionDir = { "RecoverySessionDir", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDisasterRecoverClientConfig, RecoverySessionDir), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_RecoverySessionDir_MetaData), Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_RecoverySessionDir_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_RecentSessionMaxCount = { "RecentSessionMaxCount", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDisasterRecoverClientConfig, RecentSessionMaxCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_RecentSessionMaxCount_MetaData), Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_RecentSessionMaxCount_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_ImportedSessionMaxCount = { "ImportedSessionMaxCount", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDisasterRecoverClientConfig, ImportedSessionMaxCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_ImportedSessionMaxCount_MetaData), Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::NewProp_ImportedSessionMaxCount_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::Class_MetaDataParams), Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisasterRecoverClientConfig_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_DisasterRecoveryClient_Source_DisasterRecoveryClient_Private_DisasterRecoverySettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDisasterRecoverClientConfig, UDisasterRecoverClientConfig::StaticClass, TEXT("UDisasterRecoverClientConfig"), &Z_Registration_Info_UClass_UDisasterRecoverClientConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDisasterRecoverClientConfig), 405439395U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_DisasterRecoveryClient_Source_DisasterRecoveryClient_Private_DisasterRecoverySettings_h_2333876870(TEXT("/Script/DisasterRecoveryClient"),
