...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutMuting = { "bWarnUserAboutMuting", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMultiUserServerUserPreferences), &Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutMuting_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutMuting_MetaData), Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutMuting_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutUnmuting = { "bWarnUserAboutUnmuting", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMultiUserServerUserPreferences), &Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutUnmuting_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutUnmuting_MetaData), Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::NewProp_bWarnUserAboutUnmuting_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::Class_MetaDataParams), Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMultiUserServerUserPreferences_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserServer_Source_MultiUserServer_Private_Settings_MultiUserServerUserPreferences_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMultiUserServerUserPreferences, UMultiUserServerUserPreferences::StaticClass, TEXT("UMultiUserServerUserPreferences"), &Z_Registration_Info_UClass_UMultiUserServerUserPreferences, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiUserServerUserPreferences), 1729865995U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserServer_Source_MultiUserServer_Private_Settings_MultiUserServerUserPreferences_h_2658810967(TEXT("/Script/MultiUserServer"),
