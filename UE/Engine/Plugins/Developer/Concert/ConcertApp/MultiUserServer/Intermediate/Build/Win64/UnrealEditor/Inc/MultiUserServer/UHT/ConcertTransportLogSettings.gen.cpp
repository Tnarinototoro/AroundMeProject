...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_TimestampTimeFormat_Underlying;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertTransportLogSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UConcertTransportLogSettings_Statics::NewProp_TimestampTimeFormat_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UConcertTransportLogSettings_Statics::NewProp_TimestampTimeFormat = { "TimestampTimeFormat", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConcertTransportLogSettings, TimestampTimeFormat), Z_Construct_UEnum_ConcertSharedSlate_ETimeFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertTransportLogSettings_Statics::NewProp_TimestampTimeFormat_MetaData), Z_Construct_UClass_UConcertTransportLogSettings_Statics::NewProp_TimestampTimeFormat_MetaData) }; // 2648101578
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UConcertTransportLogSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertTransportLogSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UConcertTransportLogSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertTransportLogSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserServer_Source_MultiUserServer_Private_Settings_ConcertTransportLogSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConcertTransportLogSettings, UConcertTransportLogSettings::StaticClass, TEXT("UConcertTransportLogSettings"), &Z_Registration_Info_UClass_UConcertTransportLogSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConcertTransportLogSettings), 1017662044U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertApp_MultiUserServer_Source_MultiUserServer_Private_Settings_ConcertTransportLogSettings_h_2990808061(TEXT("/Script/MultiUserServer"),
