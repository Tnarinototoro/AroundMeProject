...
template<> CONCERTTRANSPORT_API UScriptStruct* StaticStruct<FConcertEndpointSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_bEnableLogging = { "bEnableLogging", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FConcertEndpointSettings), &Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_bEnableLogging_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_bEnableLogging_MetaData), Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_bEnableLogging_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_PurgeProcessedMessageDelaySeconds = { "PurgeProcessedMessageDelaySeconds", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertEndpointSettings, PurgeProcessedMessageDelaySeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_PurgeProcessedMessageDelaySeconds_MetaData), Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_PurgeProcessedMessageDelaySeconds_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_RemoteEndpointTimeoutSeconds = { "RemoteEndpointTimeoutSeconds", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertEndpointSettings, RemoteEndpointTimeoutSeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_RemoteEndpointTimeoutSeconds_MetaData), Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewProp_RemoteEndpointTimeoutSeconds_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertEndpointConfig_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UConcertEndpointConfig_Statics::NewProp_EndpointSettings = { "EndpointSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConcertEndpointConfig, EndpointSettings), Z_Construct_UScriptStruct_FConcertEndpointSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertEndpointConfig_Statics::NewProp_EndpointSettings_MetaData), Z_Construct_UClass_UConcertEndpointConfig_Statics::NewProp_EndpointSettings_MetaData) }; // 3138915870
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UConcertEndpointConfig_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertEndpointConfig_Statics::Class_MetaDataParams), Z_Construct_UClass_UConcertEndpointConfig_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConcertEndpointConfig_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertMain_Source_ConcertTransport_Public_ConcertTransportSettings_h_Statics::ScriptStructInfo[] = {
		{ FConcertEndpointSettings::StaticStruct, Z_Construct_UScriptStruct_FConcertEndpointSettings_Statics::NewStructOps, TEXT("ConcertEndpointSettings"), &Z_Registration_Info_UScriptStruct_ConcertEndpointSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConcertEndpointSettings), 3138915870U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertMain_Source_ConcertTransport_Public_ConcertTransportSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConcertEndpointConfig, UConcertEndpointConfig::StaticClass, TEXT("UConcertEndpointConfig"), &Z_Registration_Info_UClass_UConcertEndpointConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConcertEndpointConfig), 1351115256U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertMain_Source_ConcertTransport_Public_ConcertTransportSettings_h_3313086284(TEXT("/Script/ConcertTransport"),
