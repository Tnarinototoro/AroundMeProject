...
template<> CONCERT_API UScriptStruct* StaticStruct<FConcertSessionSettings>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_ProjectName = { "ProjectName", nullptr, (EPropertyFlags)0x0010000000024001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertSessionSettings, ProjectName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_ProjectName_MetaData), Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_ProjectName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_BaseRevision = { "BaseRevision", nullptr, (EPropertyFlags)0x0010000000024001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertSessionSettings, BaseRevision), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_BaseRevision_MetaData), Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_BaseRevision_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_ArchiveNameOverride = { "ArchiveNameOverride", nullptr, (EPropertyFlags)0x0010000000024001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertSessionSettings, ArchiveNameOverride), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_ArchiveNameOverride_MetaData), Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewProp_ArchiveNameOverride_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertMain_Source_Concert_Public_ConcertSettings_h_Statics::ScriptStructInfo[] = {
		{ FConcertSessionSettings::StaticStruct, Z_Construct_UScriptStruct_FConcertSessionSettings_Statics::NewStructOps, TEXT("ConcertSessionSettings"), &Z_Registration_Info_UScriptStruct_ConcertSessionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConcertSessionSettings), 3842272229U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertMain_Source_Concert_Public_ConcertSettings_h_3403950404(TEXT("/Script/Concert"),
		nullptr, 0,
