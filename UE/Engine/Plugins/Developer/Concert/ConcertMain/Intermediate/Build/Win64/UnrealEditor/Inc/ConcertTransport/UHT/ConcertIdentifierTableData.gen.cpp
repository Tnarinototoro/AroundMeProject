...
template<> CONCERTTRANSPORT_API UScriptStruct* StaticStruct<FConcertLocalIdentifierState>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::NewProp_MappedNames_Inner = { "MappedNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::NewProp_MappedNames = { "MappedNames", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertLocalIdentifierState, MappedNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::NewProp_MappedNames_MetaData), Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::NewProp_MappedNames_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertMain_Source_ConcertTransport_Public_IdentifierTable_ConcertIdentifierTableData_h_Statics::ScriptStructInfo[] = {
		{ FConcertLocalIdentifierState::StaticStruct, Z_Construct_UScriptStruct_FConcertLocalIdentifierState_Statics::NewStructOps, TEXT("ConcertLocalIdentifierState"), &Z_Registration_Info_UScriptStruct_ConcertLocalIdentifierState, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConcertLocalIdentifierState), 1106330508U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertMain_Source_ConcertTransport_Public_IdentifierTable_ConcertIdentifierTableData_h_2118762457(TEXT("/Script/ConcertTransport"),
		nullptr, 0,
