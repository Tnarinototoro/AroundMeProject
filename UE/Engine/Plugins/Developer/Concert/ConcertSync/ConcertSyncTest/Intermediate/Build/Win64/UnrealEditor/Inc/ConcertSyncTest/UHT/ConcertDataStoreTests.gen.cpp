...
template<> CONCERTSYNCTEST_API UScriptStruct* StaticStruct<FConcertDataStore_CustomTypeTest>()
{
...
#endif
	const UECodeGen_Private::FInt8PropertyParams Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_Int8Value = { "Int8Value", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int8, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertDataStore_CustomTypeTest, Int8Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_Int8Value_MetaData), Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_Int8Value_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInt64PropertyParams Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_Int64Value = { "Int64Value", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertDataStore_CustomTypeTest, Int64Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_Int64Value_MetaData), Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_Int64Value_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_FloatValue = { "FloatValue", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertDataStore_CustomTypeTest, FloatValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_FloatValue_MetaData), Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_FloatValue_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_IntArray = { "IntArray", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertDataStore_CustomTypeTest, IntArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_IntArray_MetaData), Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewProp_IntArray_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertSync_ConcertSyncTest_Source_ConcertSyncTest_Private_ConcertDataStoreTests_h_Statics::ScriptStructInfo[] = {
		{ FConcertDataStore_CustomTypeTest::StaticStruct, Z_Construct_UScriptStruct_FConcertDataStore_CustomTypeTest_Statics::NewStructOps, TEXT("ConcertDataStore_CustomTypeTest"), &Z_Registration_Info_UScriptStruct_ConcertDataStore_CustomTypeTest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConcertDataStore_CustomTypeTest), 1668814296U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertSync_ConcertSyncTest_Source_ConcertSyncTest_Private_ConcertDataStoreTests_h_344871735(TEXT("/Script/ConcertSyncTest"),
		nullptr, 0,
