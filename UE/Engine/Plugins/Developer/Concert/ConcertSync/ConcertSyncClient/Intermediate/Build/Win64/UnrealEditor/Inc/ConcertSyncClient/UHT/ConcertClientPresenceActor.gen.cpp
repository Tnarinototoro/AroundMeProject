...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AConcertClientPresenceActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceDeviceType = { "PresenceDeviceType", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AConcertClientPresenceActor, PresenceDeviceType), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceDeviceType_MetaData), Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceDeviceType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceMeshComponent = { "PresenceMeshComponent", nullptr, (EPropertyFlags)0x00240800000a000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AConcertClientPresenceActor, PresenceMeshComponent), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceMeshComponent_MetaData), Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceMeshComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceTextComponent = { "PresenceTextComponent", nullptr, (EPropertyFlags)0x00240800000a000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AConcertClientPresenceActor, PresenceTextComponent), Z_Construct_UClass_UTextRenderComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceTextComponent_MetaData), Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceTextComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceMID = { "PresenceMID", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AConcertClientPresenceActor, PresenceMID), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceMID_MetaData), Z_Construct_UClass_AConcertClientPresenceActor_Statics::NewProp_PresenceMID_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AConcertClientPresenceActor_Statics::ClassParams = {
		...
		0,
		0x008002ADu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AConcertClientPresenceActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AConcertClientPresenceActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AConcertClientPresenceActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertSync_ConcertSyncClient_Source_ConcertSyncClient_Public_ConcertClientPresenceActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AConcertClientPresenceActor, AConcertClientPresenceActor::StaticClass, TEXT("AConcertClientPresenceActor"), &Z_Registration_Info_UClass_AConcertClientPresenceActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AConcertClientPresenceActor), 743560559U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_Concert_ConcertSync_ConcertSyncClient_Source_ConcertSyncClient_Public_ConcertClientPresenceActor_h_1981588649(TEXT("/Script/ConcertSyncClient"),
