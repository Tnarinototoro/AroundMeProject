...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimSharingStateInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimSharingStateInstance_GetInstancedActors, "GetInstancedActors" }, // 1252053714
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingStateInstance_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_AnimationToPlay = { "AnimationToPlay", nullptr, (EPropertyFlags)0x0024080000012015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingStateInstance, AnimationToPlay), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_AnimationToPlay_MetaData), Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_AnimationToPlay_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_PermutationTimeOffset = { "PermutationTimeOffset", nullptr, (EPropertyFlags)0x0020080000012015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingStateInstance, PermutationTimeOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_PermutationTimeOffset_MetaData), Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_PermutationTimeOffset_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_bStateBool = { "bStateBool", nullptr, (EPropertyFlags)0x0020080000012015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAnimSharingStateInstance), &Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_bStateBool_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_bStateBool_MetaData), Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_bStateBool_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_Instance = { "Instance", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingStateInstance, Instance), Z_Construct_UClass_UAnimSharingInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_Instance_MetaData), Z_Construct_UClass_UAnimSharingStateInstance_Statics::NewProp_Instance_MetaData) };
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UAnimSharingTransitionInstance_Statics::NewProp_FromComponent = { "FromComponent", nullptr, (EPropertyFlags)0x002408000009201d, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingTransitionInstance, FromComponent), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingTransitionInstance_Statics::NewProp_FromComponent_MetaData), Z_Construct_UClass_UAnimSharingTransitionInstance_Statics::NewProp_FromComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimSharingTransitionInstance_Statics::NewProp_BlendTime = { "BlendTime", nullptr, (EPropertyFlags)0x0020080000012015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingTransitionInstance, BlendTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingTransitionInstance_Statics::NewProp_BlendTime_MetaData), Z_Construct_UClass_UAnimSharingTransitionInstance_Statics::NewProp_BlendTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_BaseComponent = { "BaseComponent", nullptr, (EPropertyFlags)0x002408000009201d, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingAdditiveInstance, BaseComponent), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_BaseComponent_MetaData), Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_BaseComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_AdditiveAnimation = { "AdditiveAnimation", nullptr, (EPropertyFlags)0x0024080000012015, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingAdditiveInstance, AdditiveAnimation), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_AdditiveAnimation_MetaData), Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_AdditiveAnimation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_Alpha = { "Alpha", nullptr, (EPropertyFlags)0x0020080000012015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSharingAdditiveInstance, Alpha), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_Alpha_MetaData), Z_Construct_UClass_UAnimSharingAdditiveInstance_Statics::NewProp_Alpha_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_AnimationSharing_Source_AnimationSharing_Public_AnimationSharingInstances_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimSharingStateInstance, UAnimSharingStateInstance::StaticClass, TEXT("UAnimSharingStateInstance"), &Z_Registration_Info_UClass_UAnimSharingStateInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimSharingStateInstance), 4129624327U) },
		{ Z_Construct_UClass_UAnimSharingTransitionInstance, UAnimSharingTransitionInstance::StaticClass, TEXT("UAnimSharingTransitionInstance"), &Z_Registration_Info_UClass_UAnimSharingTransitionInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimSharingTransitionInstance), 2312379338U) },
		{ Z_Construct_UClass_UAnimSharingAdditiveInstance, UAnimSharingAdditiveInstance::StaticClass, TEXT("UAnimSharingAdditiveInstance"), &Z_Registration_Info_UClass_UAnimSharingAdditiveInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimSharingAdditiveInstance), 3674041956U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_AnimationSharing_Source_AnimationSharing_Public_AnimationSharingInstances_h_2088678825(TEXT("/Script/AnimationSharing"),
