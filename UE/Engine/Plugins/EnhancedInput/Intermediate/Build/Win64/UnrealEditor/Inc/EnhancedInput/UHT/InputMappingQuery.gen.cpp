...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FMappingQueryIssue>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingContext = { "BlockingContext", nullptr, (EPropertyFlags)0x0014000000000014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMappingQueryIssue, BlockingContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingContext_MetaData), Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingContext_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingAction = { "BlockingAction", nullptr, (EPropertyFlags)0x0014000000000014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMappingQueryIssue, BlockingAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingAction_MetaData), Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewProp_BlockingAction_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::EnumInfo[] = {
		{ EMappingQueryResult_StaticEnum, TEXT("EMappingQueryResult"), &Z_Registration_Info_UEnum_EMappingQueryResult, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1365196678U) },
		{ EMappingQueryIssue_StaticEnum, TEXT("EMappingQueryIssue"), &Z_Registration_Info_UEnum_EMappingQueryIssue, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2199299656U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_Statics::ScriptStructInfo[] = {
		{ FMappingQueryIssue::StaticStruct, Z_Construct_UScriptStruct_FMappingQueryIssue_Statics::NewStructOps, TEXT("MappingQueryIssue"), &Z_Registration_Info_UScriptStruct_MappingQueryIssue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMappingQueryIssue), 1715210507U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputMappingQuery_h_972644840(TEXT("/Script/EnhancedInput"),
		nullptr, 0,
