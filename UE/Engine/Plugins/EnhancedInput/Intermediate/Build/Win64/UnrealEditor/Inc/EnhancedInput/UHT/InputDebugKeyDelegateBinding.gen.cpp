...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FBlueprintInputDebugKeyDelegateBinding>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputChord = { "InputChord", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBlueprintInputDebugKeyDelegateBinding, InputChord), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputChord_MetaData), Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputChord_MetaData) }; // 3669273635
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputKeyEvent = { "InputKeyEvent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBlueprintInputDebugKeyDelegateBinding, InputKeyEvent), Z_Construct_UEnum_Engine_EInputEvent, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputKeyEvent_MetaData), Z_Construct_UScriptStruct_FBlueprintInputDebugKeyDelegateBinding_Statics::NewProp_InputKeyEvent_MetaData) }; // 4378987
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInputDebugKeyDelegateBinding_Statics::NewProp_InputDebugKeyDelegateBindings = { "InputDebugKeyDelegateBindings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputDebugKeyDelegateBinding, InputDebugKeyDelegateBindings), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputDebugKeyDelegateBinding_Statics::NewProp_InputDebugKeyDelegateBindings_MetaData), Z_Construct_UClass_UInputDebugKeyDelegateBinding_Statics::NewProp_InputDebugKeyDelegateBindings_MetaData) }; // 3706683239
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputDebugKeyDelegateBinding, UInputDebugKeyDelegateBinding::StaticClass, TEXT("UInputDebugKeyDelegateBinding"), &Z_Registration_Info_UClass_UInputDebugKeyDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputDebugKeyDelegateBinding), 3104175736U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputDebugKeyDelegateBinding_h_68297879(TEXT("/Script/EnhancedInput"),
