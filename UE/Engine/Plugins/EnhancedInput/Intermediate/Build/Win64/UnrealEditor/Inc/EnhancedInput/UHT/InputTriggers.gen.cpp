...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UInputTrigger_GetTriggerType_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InputTrigger_eventGetTriggerType_Parms, ReturnValue), Z_Construct_UEnum_EnhancedInput_ETriggerType, METADATA_PARAMS(0, nullptr) }; // 4195129214
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UInputTrigger_IsActuated_Statics::NewProp_ForValue = { "ForValue", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InputTrigger_eventIsActuated_Parms, ForValue), Z_Construct_UScriptStruct_FInputActionValue, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UInputTrigger_IsActuated_Statics::NewProp_ForValue_MetaData), Z_Construct_UFunction_UInputTrigger_IsActuated_Statics::NewProp_ForValue_MetaData) }; // 1693336646
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInputTrigger_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInputTrigger_GetTriggerType, "GetTriggerType" }, // 538112643
		{ &Z_Construct_UFunction_UInputTrigger_IsActuated, "IsActuated" }, // 427427178
		{ &Z_Construct_UFunction_UInputTrigger_UpdateState, "UpdateState" }, // 1841923237
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTrigger_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInputTrigger_Statics::NewProp_LastValue = { "LastValue", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputTrigger, LastValue), Z_Construct_UScriptStruct_FInputActionValue, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTrigger_Statics::NewProp_LastValue_MetaData), Z_Construct_UClass_UInputTrigger_Statics::NewProp_LastValue_MetaData) }; // 1693336646
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInputTriggerTimedBase_Statics::NewProp_bAffectedByTimeDilation = { "bAffectedByTimeDilation", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UInputTriggerTimedBase), &Z_Construct_UClass_UInputTriggerTimedBase_Statics::NewProp_bAffectedByTimeDilation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerTimedBase_Statics::NewProp_bAffectedByTimeDilation_MetaData), Z_Construct_UClass_UInputTriggerTimedBase_Statics::NewProp_bAffectedByTimeDilation_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UInputTriggerHold_Statics::NewProp_HoldTimeThreshold = { "HoldTimeThreshold", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputTriggerHold, HoldTimeThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerHold_Statics::NewProp_HoldTimeThreshold_MetaData), Z_Construct_UClass_UInputTriggerHold_Statics::NewProp_HoldTimeThreshold_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInputTriggerHold_Statics::NewProp_bIsOneShot = { "bIsOneShot", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UInputTriggerHold), &Z_Construct_UClass_UInputTriggerHold_Statics::NewProp_bIsOneShot_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerHold_Statics::NewProp_bIsOneShot_MetaData), Z_Construct_UClass_UInputTriggerHold_Statics::NewProp_bIsOneShot_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UInputTriggerHoldAndRelease_Statics::NewProp_HoldTimeThreshold = { "HoldTimeThreshold", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputTriggerHoldAndRelease, HoldTimeThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerHoldAndRelease_Statics::NewProp_HoldTimeThreshold_MetaData), Z_Construct_UClass_UInputTriggerHoldAndRelease_Statics::NewProp_HoldTimeThreshold_MetaData) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UInputTriggerChordAction_Statics::NewProp_ChordAction = { "ChordAction", nullptr, (EPropertyFlags)0x0014000000000805, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputTriggerChordAction, ChordAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerChordAction_Statics::NewProp_ChordAction_MetaData), Z_Construct_UClass_UInputTriggerChordAction_Statics::NewProp_ChordAction_MetaData) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_ComboStepAction = { "ComboStepAction", nullptr, (EPropertyFlags)0x0014000000000805, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInputComboStepData, ComboStepAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_ComboStepAction_MetaData), Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_ComboStepAction_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_ComboStepCompletionStates = { "ComboStepCompletionStates", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInputComboStepData, ComboStepCompletionStates), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_ComboStepCompletionStates_MetaData), Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_ComboStepCompletionStates_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_TimeToPressKey = { "TimeToPressKey", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInputComboStepData, TimeToPressKey), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_TimeToPressKey_MetaData), Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_TimeToPressKey_MetaData) };
...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FInputCancelAction>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FInputCancelAction_Statics::NewProp_CancelAction = { "CancelAction", nullptr, (EPropertyFlags)0x0014000000000805, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInputCancelAction, CancelAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInputCancelAction_Statics::NewProp_CancelAction_MetaData), Z_Construct_UScriptStruct_FInputCancelAction_Statics::NewProp_CancelAction_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CurrentComboStepIndex = { "CurrentComboStepIndex", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputTriggerCombo, CurrentComboStepIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CurrentComboStepIndex_MetaData), Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CurrentComboStepIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CurrentTimeBetweenComboSteps = { "CurrentTimeBetweenComboSteps", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputTriggerCombo, CurrentTimeBetweenComboSteps), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CurrentTimeBetweenComboSteps_MetaData), Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CurrentTimeBetweenComboSteps_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions_Inner = { "ComboActions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FInputComboStepData, METADATA_PARAMS(0, nullptr) }; // 2640413010
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions = { "ComboActions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInputTriggerCombo, ComboActions), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions_MetaData), Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions_MetaData) }; // 2640413010
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_Statics::EnumInfo[] = {
		{ ETriggerState_StaticEnum, TEXT("ETriggerState"), &Z_Registration_Info_UEnum_ETriggerState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 741655322U) },
		{ ETriggerEvent_StaticEnum, TEXT("ETriggerEvent"), &Z_Registration_Info_UEnum_ETriggerEvent, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1611578188U) },
		{ ETriggerType_StaticEnum, TEXT("ETriggerType"), &Z_Registration_Info_UEnum_ETriggerType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4195129214U) },
		{ ETriggerEventsSupported_StaticEnum, TEXT("ETriggerEventsSupported"), &Z_Registration_Info_UEnum_ETriggerEventsSupported, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3817215873U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_Statics::ScriptStructInfo[] = {
		{ FInputComboStepData::StaticStruct, Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewStructOps, TEXT("InputComboStepData"), &Z_Registration_Info_UScriptStruct_InputComboStepData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputComboStepData), 2640413010U) },
		{ FInputCancelAction::StaticStruct, Z_Construct_UScriptStruct_FInputCancelAction_Statics::NewStructOps, TEXT("InputCancelAction"), &Z_Registration_Info_UScriptStruct_InputCancelAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputCancelAction), 1716846416U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputTrigger, UInputTrigger::StaticClass, TEXT("UInputTrigger"), &Z_Registration_Info_UClass_UInputTrigger, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTrigger), 4013304626U) },
		{ Z_Construct_UClass_UInputTriggerTimedBase, UInputTriggerTimedBase::StaticClass, TEXT("UInputTriggerTimedBase"), &Z_Registration_Info_UClass_UInputTriggerTimedBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerTimedBase), 917091164U) },
		{ Z_Construct_UClass_UInputTriggerDown, UInputTriggerDown::StaticClass, TEXT("UInputTriggerDown"), &Z_Registration_Info_UClass_UInputTriggerDown, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerDown), 2746270528U) },
		{ Z_Construct_UClass_UInputTriggerPressed, UInputTriggerPressed::StaticClass, TEXT("UInputTriggerPressed"), &Z_Registration_Info_UClass_UInputTriggerPressed, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerPressed), 1823220394U) },
		{ Z_Construct_UClass_UInputTriggerReleased, UInputTriggerReleased::StaticClass, TEXT("UInputTriggerReleased"), &Z_Registration_Info_UClass_UInputTriggerReleased, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerReleased), 3030009338U) },
		{ Z_Construct_UClass_UInputTriggerHold, UInputTriggerHold::StaticClass, TEXT("UInputTriggerHold"), &Z_Registration_Info_UClass_UInputTriggerHold, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerHold), 722824026U) },
		{ Z_Construct_UClass_UInputTriggerHoldAndRelease, UInputTriggerHoldAndRelease::StaticClass, TEXT("UInputTriggerHoldAndRelease"), &Z_Registration_Info_UClass_UInputTriggerHoldAndRelease, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerHoldAndRelease), 3657238081U) },
		{ Z_Construct_UClass_UInputTriggerTap, UInputTriggerTap::StaticClass, TEXT("UInputTriggerTap"), &Z_Registration_Info_UClass_UInputTriggerTap, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerTap), 449891923U) },
		{ Z_Construct_UClass_UInputTriggerPulse, UInputTriggerPulse::StaticClass, TEXT("UInputTriggerPulse"), &Z_Registration_Info_UClass_UInputTriggerPulse, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerPulse), 613969412U) },
		{ Z_Construct_UClass_UInputTriggerChordAction, UInputTriggerChordAction::StaticClass, TEXT("UInputTriggerChordAction"), &Z_Registration_Info_UClass_UInputTriggerChordAction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerChordAction), 4060227026U) },
		{ Z_Construct_UClass_UInputTriggerChordBlocker, UInputTriggerChordBlocker::StaticClass, TEXT("UInputTriggerChordBlocker"), &Z_Registration_Info_UClass_UInputTriggerChordBlocker, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerChordBlocker), 1624911970U) },
		{ Z_Construct_UClass_UInputTriggerCombo, UInputTriggerCombo::StaticClass, TEXT("UInputTriggerCombo"), &Z_Registration_Info_UClass_UInputTriggerCombo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerCombo), 1227089338U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_1740497941(TEXT("/Script/EnhancedInput"),
