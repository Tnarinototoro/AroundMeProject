...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FInputActionValue>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputActionValue_h_Statics::EnumInfo[] = {
		{ EInputActionValueType_StaticEnum, TEXT("EInputActionValueType"), &Z_Registration_Info_UEnum_EInputActionValueType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2955373329U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputActionValue_h_Statics::ScriptStructInfo[] = {
		{ FInputActionValue::StaticStruct, Z_Construct_UScriptStruct_FInputActionValue_Statics::NewStructOps, TEXT("InputActionValue"), &Z_Registration_Info_UScriptStruct_InputActionValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputActionValue), 1693336646U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputActionValue_h_1850912720(TEXT("/Script/EnhancedInput"),
		nullptr, 0,
