...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResMediaSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAppleProResMediaSettings_Statics::NewProp_NumberOfCPUDecodingThreads = { "NumberOfCPUDecodingThreads", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAppleProResMediaSettings, NumberOfCPUDecodingThreads), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResMediaSettings_Statics::NewProp_NumberOfCPUDecodingThreads_MetaData), Z_Construct_UClass_UAppleProResMediaSettings_Statics::NewProp_NumberOfCPUDecodingThreads_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAppleProResMediaSettings_Statics::ClassParams = {
		...
		0,
		0x000000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResMediaSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UAppleProResMediaSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResMediaSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Private_AppleProResMediaSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAppleProResMediaSettings, UAppleProResMediaSettings::StaticClass, TEXT("UAppleProResMediaSettings"), &Z_Registration_Info_UClass_UAppleProResMediaSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAppleProResMediaSettings), 3654061649U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Private_AppleProResMediaSettings_h_2104820599(TEXT("/Script/AppleProResMedia"),
