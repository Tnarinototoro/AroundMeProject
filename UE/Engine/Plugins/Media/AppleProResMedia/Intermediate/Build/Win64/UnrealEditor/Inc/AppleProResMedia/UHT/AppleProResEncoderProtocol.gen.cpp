...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderFormats_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderFormats_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderFormats_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderColorDescription_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderColorDescription_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderColorDescription_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderScanType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderScanType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderScanType_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_EncodingFormat = { "EncodingFormat", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAppleProResEncoderProtocol, EncodingFormat), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderFormats, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_EncodingFormat_MetaData), Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_EncodingFormat_MetaData) }; // 530577718
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_ColorDescription_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_ColorDescription = { "ColorDescription", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAppleProResEncoderProtocol, ColorDescription), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderColorDescription, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_ColorDescription_MetaData), Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_ColorDescription_MetaData) }; // 3458002191
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_ScanType = { "ScanType", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAppleProResEncoderProtocol, ScanType), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderScanType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_ScanType_MetaData), Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_ScanType_MetaData) }; // 3770848212
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_NumberOfEncodingThreads = { "NumberOfEncodingThreads", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAppleProResEncoderProtocol, NumberOfEncodingThreads), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_NumberOfEncodingThreads_MetaData), Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_NumberOfEncodingThreads_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bEmbedTimecodeTrack = { "bEmbedTimecodeTrack", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAppleProResEncoderProtocol), &Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bEmbedTimecodeTrack_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bEmbedTimecodeTrack_MetaData), Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bEmbedTimecodeTrack_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bDropFrameTimecode = { "bDropFrameTimecode", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAppleProResEncoderProtocol), &Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bDropFrameTimecode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bDropFrameTimecode_MetaData), Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::NewProp_bDropFrameTimecode_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::ClassParams = {
		...
		0,
		0x001004A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::Class_MetaDataParams), Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleProResEncoderProtocol_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Private_AppleProResEncoderProtocol_h_Statics::EnumInfo[] = {
		{ EAppleProResEncoderFormats_StaticEnum, TEXT("EAppleProResEncoderFormats"), &Z_Registration_Info_UEnum_EAppleProResEncoderFormats, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 530577718U) },
		{ EAppleProResEncoderColorDescription_StaticEnum, TEXT("EAppleProResEncoderColorDescription"), &Z_Registration_Info_UEnum_EAppleProResEncoderColorDescription, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3458002191U) },
		{ EAppleProResEncoderScanType_StaticEnum, TEXT("EAppleProResEncoderScanType"), &Z_Registration_Info_UEnum_EAppleProResEncoderScanType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3770848212U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Private_AppleProResEncoderProtocol_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAppleProResEncoderProtocol, UAppleProResEncoderProtocol::StaticClass, TEXT("UAppleProResEncoderProtocol"), &Z_Registration_Info_UClass_UAppleProResEncoderProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAppleProResEncoderProtocol), 1097660794U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Private_AppleProResEncoderProtocol_h_3492581149(TEXT("/Script/AppleProResMedia"),
