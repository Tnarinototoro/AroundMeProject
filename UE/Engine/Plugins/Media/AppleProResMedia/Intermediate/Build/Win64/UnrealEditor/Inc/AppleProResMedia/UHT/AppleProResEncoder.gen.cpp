...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderCodec_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderCodec_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderCodec_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderColorPrimaries_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderColorPrimaries_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderColorPrimaries_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderScanMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderScanMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderScanMode_Statics::Enum_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Public_AppleProResEncoder_AppleProResEncoder_h_Statics::EnumInfo[] = {
		{ EAppleProResEncoderCodec_StaticEnum, TEXT("EAppleProResEncoderCodec"), &Z_Registration_Info_UEnum_EAppleProResEncoderCodec, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2741618030U) },
		{ EAppleProResEncoderColorPrimaries_StaticEnum, TEXT("EAppleProResEncoderColorPrimaries"), &Z_Registration_Info_UEnum_EAppleProResEncoderColorPrimaries, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4123303098U) },
		{ EAppleProResEncoderScanMode_StaticEnum, TEXT("EAppleProResEncoderScanMode"), &Z_Registration_Info_UEnum_EAppleProResEncoderScanMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2104776629U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Public_AppleProResEncoder_AppleProResEncoder_h_667516617(TEXT("/Script/AppleProResMedia"),
		nullptr, 0,
		nullptr, 0,
