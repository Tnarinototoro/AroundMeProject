...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_Codec = { "Codec", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineAppleProResOutput, Codec), Z_Construct_UEnum_AppleProResMedia_EAppleProResEncoderCodec, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_Codec_MetaData), Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_Codec_MetaData) }; // 2741618030
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bDropFrameTimecode = { "bDropFrameTimecode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMoviePipelineAppleProResOutput), &Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bDropFrameTimecode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bDropFrameTimecode_MetaData), Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bDropFrameTimecode_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bOverrideMaximumEncodingThreads = { "bOverrideMaximumEncodingThreads", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMoviePipelineAppleProResOutput), &Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bOverrideMaximumEncodingThreads_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bOverrideMaximumEncodingThreads_MetaData), Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_bOverrideMaximumEncodingThreads_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_MaxNumberOfEncodingThreads = { "MaxNumberOfEncodingThreads", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineAppleProResOutput, MaxNumberOfEncodingThreads), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_MaxNumberOfEncodingThreads_MetaData), Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::NewProp_MaxNumberOfEncodingThreads_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAppleProResOutput_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Private_MoviePipelineAppleProResOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineAppleProResOutput, UMoviePipelineAppleProResOutput::StaticClass, TEXT("UMoviePipelineAppleProResOutput"), &Z_Registration_Info_UClass_UMoviePipelineAppleProResOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineAppleProResOutput), 1183125159U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AppleProResMedia_Source_AppleProResMedia_Private_MoviePipelineAppleProResOutput_h_4015957822(TEXT("/Script/AppleProResMedia"),
