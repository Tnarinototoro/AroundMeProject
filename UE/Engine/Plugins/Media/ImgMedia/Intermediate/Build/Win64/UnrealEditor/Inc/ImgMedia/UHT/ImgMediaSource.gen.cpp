...
template<> IMGMEDIA_API UScriptStruct* StaticStruct<FImgMediaSourceCustomizationSequenceProxy>()
{
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::NewProp_InActor = { "InActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ImgMediaSource_eventAddGlobalCamera_Parms, InActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UImgMediaSource, nullptr, "AddGlobalCamera", nullptr, nullptr, Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::PropPointers), sizeof(Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::ImgMediaSource_eventAddGlobalCamera_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::Function_MetaDataParams), Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera_Statics::ImgMediaSource_eventAddGlobalCamera_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::NewProp_InActor = { "InActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ImgMediaSource_eventRemoveGlobalCamera_Parms, InActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UImgMediaSource, nullptr, "RemoveGlobalCamera", nullptr, nullptr, Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::PropPointers), sizeof(Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::ImgMediaSource_eventRemoveGlobalCamera_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::Function_MetaDataParams), Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera_Statics::ImgMediaSource_eventRemoveGlobalCamera_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::NewProp_Distance = { "Distance", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ImgMediaSource_eventSetMipLevelDistance_Parms, Distance), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UImgMediaSource, nullptr, "SetMipLevelDistance", nullptr, nullptr, Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::PropPointers), sizeof(Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::ImgMediaSource_eventSetMipLevelDistance_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::Function_MetaDataParams), Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance_Statics::ImgMediaSource_eventSetMipLevelDistance_Parms) < MAX_uint16);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UImgMediaSource_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UImgMediaSource_AddGlobalCamera, "AddGlobalCamera" }, // 4036168391
		{ &Z_Construct_UFunction_UImgMediaSource_AddTargetObject, "AddTargetObject" }, // 536898704
		{ &Z_Construct_UFunction_UImgMediaSource_GetProxies, "GetProxies" }, // 1568729825
		{ &Z_Construct_UFunction_UImgMediaSource_GetSequencePath, "GetSequencePath" }, // 2103051157
		{ &Z_Construct_UFunction_UImgMediaSource_RemoveGlobalCamera, "RemoveGlobalCamera" }, // 2070485286
		{ &Z_Construct_UFunction_UImgMediaSource_RemoveTargetObject, "RemoveTargetObject" }, // 2212427646
		{ &Z_Construct_UFunction_UImgMediaSource_SetMipLevelDistance, "SetMipLevelDistance" }, // 3011038007
		{ &Z_Construct_UFunction_UImgMediaSource_SetSequencePath, "SetSequencePath" }, // 46559971
		{ &Z_Construct_UFunction_UImgMediaSource_SetTokenizedSequencePath, "SetTokenizedSequencePath" }, // 3529891134
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImgMediaSource_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_ImgMedia_Source_ImgMedia_Public_ImgMediaSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UImgMediaSource, UImgMediaSource::StaticClass, TEXT("UImgMediaSource"), &Z_Registration_Info_UClass_UImgMediaSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImgMediaSource), 722619871U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_ImgMedia_Source_ImgMedia_Public_ImgMediaSource_h_834807050(TEXT("/Script/ImgMedia"),
