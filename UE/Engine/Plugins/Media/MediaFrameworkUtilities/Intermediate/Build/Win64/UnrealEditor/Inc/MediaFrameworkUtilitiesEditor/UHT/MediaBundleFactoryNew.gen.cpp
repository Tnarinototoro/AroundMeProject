...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaBundleFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaBundleFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaBundleFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaBundleFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryMediaBundle_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryMediaBundle_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryMediaBundle_Statics::Class_MetaDataParams), Z_Construct_UClass_UActorFactoryMediaBundle_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_MediaBundleFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaBundleFactoryNew, UMediaBundleFactoryNew::StaticClass, TEXT("UMediaBundleFactoryNew"), &Z_Registration_Info_UClass_UMediaBundleFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaBundleFactoryNew), 2866826647U) },
		{ Z_Construct_UClass_UActorFactoryMediaBundle, UActorFactoryMediaBundle::StaticClass, TEXT("UActorFactoryMediaBundle"), &Z_Registration_Info_UClass_UActorFactoryMediaBundle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorFactoryMediaBundle), 2790085376U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_MediaBundleFactoryNew_h_4021682001(TEXT("/Script/MediaFrameworkUtilitiesEditor"),
