...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::NewProp_MediaSource = { "MediaSource", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaPlayerTimeSynchronizationSource, MediaSource), Z_Construct_UClass_UMediaSource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::NewProp_MediaSource_MetaData), Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::NewProp_MediaSource_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerTimeSynchronizationSource_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilities_Public_MediaPlayerTimeSynchronizationSource_h_610687765(TEXT("/Script/MediaFrameworkUtilities"),
