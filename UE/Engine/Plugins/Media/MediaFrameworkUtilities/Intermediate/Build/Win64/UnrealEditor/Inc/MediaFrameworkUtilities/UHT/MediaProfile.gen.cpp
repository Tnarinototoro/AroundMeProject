...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaSources_Inner = { "MediaSources", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMediaSource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaSources_Inner_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaSources_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaSources = { "MediaSources", nullptr, (EPropertyFlags)0x0024088000000049, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, MediaSources), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaSources_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaSources_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaOutputs_Inner = { "MediaOutputs", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMediaOutput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaOutputs_Inner_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaOutputs_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaOutputs = { "MediaOutputs", nullptr, (EPropertyFlags)0x0024088000000049, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, MediaOutputs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaOutputs_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_MediaOutputs_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideTimecodeProvider = { "bOverrideTimecodeProvider", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMediaProfile), &Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideTimecodeProvider_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideTimecodeProvider_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideTimecodeProvider_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_TimecodeProvider = { "TimecodeProvider", nullptr, (EPropertyFlags)0x0026080000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, TimecodeProvider), Z_Construct_UClass_UTimecodeProvider_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_TimecodeProvider_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_TimecodeProvider_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideCustomTimeStep = { "bOverrideCustomTimeStep", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMediaProfile), &Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideCustomTimeStep_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideCustomTimeStep_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_bOverrideCustomTimeStep_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_CustomTimeStep = { "CustomTimeStep", nullptr, (EPropertyFlags)0x0026080000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, CustomTimeStep), Z_Construct_UClass_UEngineCustomTimeStep_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_CustomTimeStep_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_CustomTimeStep_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_AppliedTimecodeProvider = { "AppliedTimecodeProvider", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, AppliedTimecodeProvider), Z_Construct_UClass_UTimecodeProvider_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_AppliedTimecodeProvider_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_AppliedTimecodeProvider_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_PreviousTimecodeProvider = { "PreviousTimecodeProvider", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, PreviousTimecodeProvider), Z_Construct_UClass_UTimecodeProvider_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_PreviousTimecodeProvider_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_PreviousTimecodeProvider_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_AppliedCustomTimeStep = { "AppliedCustomTimeStep", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, AppliedCustomTimeStep), Z_Construct_UClass_UEngineCustomTimeStep_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_AppliedCustomTimeStep_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_AppliedCustomTimeStep_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaProfile_Statics::NewProp_PreviousCustomTimeStep = { "PreviousCustomTimeStep", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaProfile, PreviousCustomTimeStep), Z_Construct_UClass_UEngineCustomTimeStep_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::NewProp_PreviousCustomTimeStep_MetaData), Z_Construct_UClass_UMediaProfile_Statics::NewProp_PreviousCustomTimeStep_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaProfile_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaProfile_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfile_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilities_Public_Profile_MediaProfile_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaProfile, UMediaProfile::StaticClass, TEXT("UMediaProfile"), &Z_Registration_Info_UClass_UMediaProfile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaProfile), 3362344681U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilities_Public_Profile_MediaProfile_h_4246080827(TEXT("/Script/MediaFrameworkUtilities"),
