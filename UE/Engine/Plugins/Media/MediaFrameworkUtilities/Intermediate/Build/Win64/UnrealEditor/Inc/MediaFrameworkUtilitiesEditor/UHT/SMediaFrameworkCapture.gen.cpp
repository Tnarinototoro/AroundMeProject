...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::NewProp_bIsVerticalSplitterOrientation = { "bIsVerticalSplitterOrientation", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMediaFrameworkMediaCaptureSettings), &Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::NewProp_bIsVerticalSplitterOrientation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::NewProp_bIsVerticalSplitterOrientation_MetaData), Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::NewProp_bIsVerticalSplitterOrientation_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bSaveCaptureSetingsInWorld = { "bSaveCaptureSetingsInWorld", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMediaFrameworkEditorCaptureSettings), &Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bSaveCaptureSetingsInWorld_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bSaveCaptureSetingsInWorld_MetaData), Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bSaveCaptureSetingsInWorld_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bAutoRestartCaptureOnChange = { "bAutoRestartCaptureOnChange", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMediaFrameworkEditorCaptureSettings), &Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bAutoRestartCaptureOnChange_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bAutoRestartCaptureOnChange_MetaData), Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::NewProp_bAutoRestartCaptureOnChange_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::ClassParams = {
		...
		0,
		0x002810A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_CaptureTab_SMediaFrameworkCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaFrameworkMediaCaptureSettings, UMediaFrameworkMediaCaptureSettings::StaticClass, TEXT("UMediaFrameworkMediaCaptureSettings"), &Z_Registration_Info_UClass_UMediaFrameworkMediaCaptureSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaFrameworkMediaCaptureSettings), 878775870U) },
		{ Z_Construct_UClass_UMediaFrameworkEditorCaptureSettings, UMediaFrameworkEditorCaptureSettings::StaticClass, TEXT("UMediaFrameworkEditorCaptureSettings"), &Z_Registration_Info_UClass_UMediaFrameworkEditorCaptureSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaFrameworkEditorCaptureSettings), 2220467055U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_CaptureTab_SMediaFrameworkCapture_h_2336049254(TEXT("/Script/MediaFrameworkUtilitiesEditor"),
