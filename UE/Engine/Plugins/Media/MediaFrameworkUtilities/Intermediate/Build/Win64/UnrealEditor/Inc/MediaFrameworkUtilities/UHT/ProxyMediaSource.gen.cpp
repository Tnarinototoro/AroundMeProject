...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ProxyMediaSource_eventIsProxyValid_Parms), &Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UProxyMediaSource, nullptr, "IsProxyValid", nullptr, nullptr, Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::PropPointers), sizeof(Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::ProxyMediaSource_eventIsProxyValid_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::Function_MetaDataParams), Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UProxyMediaSource_IsProxyValid_Statics::ProxyMediaSource_eventIsProxyValid_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaSource_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UProxyMediaSource_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UProxyMediaSource_IsProxyValid, "IsProxyValid" }, // 2913838127
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaSource_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UProxyMediaSource_Statics::NewProp_DynamicProxy = { "DynamicProxy", nullptr, (EPropertyFlags)0x0044000000202000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UProxyMediaSource, DynamicProxy), Z_Construct_UClass_UMediaSource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaSource_Statics::NewProp_DynamicProxy_MetaData), Z_Construct_UClass_UProxyMediaSource_Statics::NewProp_DynamicProxy_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UProxyMediaSource_Statics::NewProp_Proxy = { "Proxy", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UProxyMediaSource, Proxy), Z_Construct_UClass_UMediaSource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaSource_Statics::NewProp_Proxy_MetaData), Z_Construct_UClass_UProxyMediaSource_Statics::NewProp_Proxy_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UProxyMediaSource_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaSource_Statics::Class_MetaDataParams), Z_Construct_UClass_UProxyMediaSource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaSource_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilities_Public_MediaAssets_ProxyMediaSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UProxyMediaSource, UProxyMediaSource::StaticClass, TEXT("UProxyMediaSource"), &Z_Registration_Info_UClass_UProxyMediaSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProxyMediaSource), 1268491022U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilities_Public_MediaAssets_ProxyMediaSource_h_193949874(TEXT("/Script/MediaFrameworkUtilities"),
