...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaOutputFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UProxyMediaOutputFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UProxyMediaOutputFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UProxyMediaOutputFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_Factories_ProxyMediaOutputFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UProxyMediaOutputFactoryNew, UProxyMediaOutputFactoryNew::StaticClass, TEXT("UProxyMediaOutputFactoryNew"), &Z_Registration_Info_UClass_UProxyMediaOutputFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProxyMediaOutputFactoryNew), 3926477046U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_Factories_ProxyMediaOutputFactoryNew_h_1597840923(TEXT("/Script/MediaFrameworkUtilitiesEditor"),
