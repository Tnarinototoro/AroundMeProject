...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfileFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaProfileFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaProfileFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaProfileFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_Factories_MediaProfileFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaProfileFactoryNew, UMediaProfileFactoryNew::StaticClass, TEXT("UMediaProfileFactoryNew"), &Z_Registration_Info_UClass_UMediaProfileFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaProfileFactoryNew), 1158777334U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaFrameworkUtilities_Source_MediaFrameworkUtilitiesEditor_Private_Factories_MediaProfileFactoryNew_h_4061097800(TEXT("/Script/MediaFrameworkUtilitiesEditor"),
