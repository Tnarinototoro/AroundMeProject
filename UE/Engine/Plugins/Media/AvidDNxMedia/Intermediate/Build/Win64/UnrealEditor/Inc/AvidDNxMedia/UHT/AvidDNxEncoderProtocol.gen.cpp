...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::NewProp_bUncompressed = { "bUncompressed", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAvidDNxEncoderProtocol), &Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::NewProp_bUncompressed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::NewProp_bUncompressed_MetaData), Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::NewProp_bUncompressed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::NewProp_NumberOfEncodingThreads = { "NumberOfEncodingThreads", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAvidDNxEncoderProtocol, NumberOfEncodingThreads), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::NewProp_NumberOfEncodingThreads_MetaData), Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::NewProp_NumberOfEncodingThreads_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::ClassParams = {
		...
		0,
		0x001004A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::Class_MetaDataParams), Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAvidDNxEncoderProtocol_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AvidDNxMedia_Source_Source_Private_AvidDNxEncoderProtocol_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAvidDNxEncoderProtocol, UAvidDNxEncoderProtocol::StaticClass, TEXT("UAvidDNxEncoderProtocol"), &Z_Registration_Info_UClass_UAvidDNxEncoderProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAvidDNxEncoderProtocol), 4118200509U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AvidDNxMedia_Source_Source_Private_AvidDNxEncoderProtocol_h_3601651675(TEXT("/Script/AvidDNxMedia"),
