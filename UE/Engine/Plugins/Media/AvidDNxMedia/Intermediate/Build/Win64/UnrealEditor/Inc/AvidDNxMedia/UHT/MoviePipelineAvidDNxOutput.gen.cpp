...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::NewProp_bUseCompression = { "bUseCompression", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMoviePipelineAvidDNxOutput), &Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::NewProp_bUseCompression_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::NewProp_bUseCompression_MetaData), Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::NewProp_bUseCompression_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::NewProp_NumberOfEncodingThreads = { "NumberOfEncodingThreads", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineAvidDNxOutput, NumberOfEncodingThreads), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::NewProp_NumberOfEncodingThreads_MetaData), Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::NewProp_NumberOfEncodingThreads_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAvidDNxOutput_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AvidDNxMedia_Source_Source_Private_MoviePipelineAvidDNxOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineAvidDNxOutput, UMoviePipelineAvidDNxOutput::StaticClass, TEXT("UMoviePipelineAvidDNxOutput"), &Z_Registration_Info_UClass_UMoviePipelineAvidDNxOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineAvidDNxOutput), 2789618404U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AvidDNxMedia_Source_Source_Private_MoviePipelineAvidDNxOutput_h_3047384843(TEXT("/Script/AvidDNxMedia"),
