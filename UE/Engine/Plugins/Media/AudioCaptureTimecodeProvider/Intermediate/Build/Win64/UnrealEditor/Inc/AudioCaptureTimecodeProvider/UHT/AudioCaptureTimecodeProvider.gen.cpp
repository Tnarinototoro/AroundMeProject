...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bDetectFrameRate = { "bDetectFrameRate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAudioCaptureTimecodeProvider), &Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bDetectFrameRate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bDetectFrameRate_MetaData), Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bDetectFrameRate_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bAssumeDropFrameFormat = { "bAssumeDropFrameFormat", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAudioCaptureTimecodeProvider), &Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bAssumeDropFrameFormat_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bAssumeDropFrameFormat_MetaData), Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_bAssumeDropFrameFormat_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAudioCaptureTimecodeProvider, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_FrameRate_MetaData), Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_FrameRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_AudioChannel = { "AudioChannel", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAudioCaptureTimecodeProvider, AudioChannel), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_AudioChannel_MetaData), Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::NewProp_AudioChannel_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::Class_MetaDataParams), Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCaptureTimecodeProvider_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AudioCaptureTimecodeProvider_Source_AudioCaptureTimecodeProvider_Public_AudioCaptureTimecodeProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioCaptureTimecodeProvider, UAudioCaptureTimecodeProvider::StaticClass, TEXT("UAudioCaptureTimecodeProvider"), &Z_Registration_Info_UClass_UAudioCaptureTimecodeProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioCaptureTimecodeProvider), 738256473U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AudioCaptureTimecodeProvider_Source_AudioCaptureTimecodeProvider_Public_AudioCaptureTimecodeProvider_h_2858467471(TEXT("/Script/AudioCaptureTimecodeProvider"),
