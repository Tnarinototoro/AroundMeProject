...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOTransportType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOTransportType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOTransportType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOQuadLinkTransportType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOQuadLinkTransportType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOQuadLinkTransportType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOStandardType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOStandardType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOStandardType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOTimecodeFormat_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOTimecodeFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOTimecodeFormat_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOAutoDetectableTimecodeFormat_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOAutoDetectableTimecodeFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOAutoDetectableTimecodeFormat_Statics::Enum_MetaDataParams)
	};
	...
	static FEnumRegistrationInfo Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder;
	static UEnum* EMediaIOInterlaceFieldOrder_StaticEnum()
	{
		if (!Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder.OuterSingleton)
		{
			Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder, (UObject*)Z_Construct_UPackage__Script_MediaIOCore(), TEXT("EMediaIOInterlaceFieldOrder"));
		}
		return Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder.OuterSingleton;
	}
	template<> MEDIAIOCORE_API UEnum* StaticEnum<EMediaIOInterlaceFieldOrder>()
	{
		return EMediaIOInterlaceFieldOrder_StaticEnum();
	}
	struct Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::Enumerators[] = {
		{ "EMediaIOInterlaceFieldOrder::TopFieldFirst", (int64)EMediaIOInterlaceFieldOrder::TopFieldFirst },
		{ "EMediaIOInterlaceFieldOrder::BottomFieldFirst", (int64)EMediaIOInterlaceFieldOrder::BottomFieldFirst },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::Enum_MetaDataParams[] = {
		{ "BottomFieldFirst.Name", "EMediaIOInterlaceFieldOrder::BottomFieldFirst" },
		{ "Comment", "/**\n * Which interlace field should be set first in the buffer.\n */" },
		{ "ModuleRelativePath", "Public/MediaIOCoreDefinitions.h" },
		{ "ToolTip", "Which interlace field should be set first in the buffer." },
		{ "TopFieldFirst.Name", "EMediaIOInterlaceFieldOrder::TopFieldFirst" },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_MediaIOCore,
		nullptr,
		"EMediaIOInterlaceFieldOrder",
		"EMediaIOInterlaceFieldOrder",
		Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::Enumerators,
		RF_Public|RF_Transient|RF_MarkAsNative,
		UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::Enumerators),
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::Enum_MetaDataParams)
	};
	UEnum* Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder()
	{
		if (!Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder.InnerSingleton, Z_Construct_UEnum_MediaIOCore_EMediaIOInterlaceFieldOrder_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder.InnerSingleton;
	}
	static FEnumRegistrationInfo Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType;
	static UEnum* EMediaIOSampleEvaluationType_StaticEnum()
	{
		if (!Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType.OuterSingleton)
		{
			Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType, (UObject*)Z_Construct_UPackage__Script_MediaIOCore(), TEXT("EMediaIOSampleEvaluationType"));
		}
		return Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType.OuterSingleton;
	}
	template<> MEDIAIOCORE_API UEnum* StaticEnum<EMediaIOSampleEvaluationType>()
	{
		return EMediaIOSampleEvaluationType_StaticEnum();
	}
	struct Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::Enumerators[] = {
		{ "EMediaIOSampleEvaluationType::Latest", (int64)EMediaIOSampleEvaluationType::Latest },
		{ "EMediaIOSampleEvaluationType::PlatformTime", (int64)EMediaIOSampleEvaluationType::PlatformTime },
		{ "EMediaIOSampleEvaluationType::Timecode", (int64)EMediaIOSampleEvaluationType::Timecode },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::Enum_MetaDataParams[] = {
		{ "Comment", "/**\n * Various sample evaluation types availalbe in MediaIO.\n */" },
		{ "Latest.Name", "EMediaIOSampleEvaluationType::Latest" },
		{ "ModuleRelativePath", "Public/MediaIOCoreDefinitions.h" },
		{ "PlatformTime.Name", "EMediaIOSampleEvaluationType::PlatformTime" },
		{ "Timecode.Name", "EMediaIOSampleEvaluationType::Timecode" },
		{ "ToolTip", "Various sample evaluation types availalbe in MediaIO." },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_MediaIOCore,
		nullptr,
		"EMediaIOSampleEvaluationType",
		"EMediaIOSampleEvaluationType",
		Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::Enumerators,
		RF_Public|RF_Transient|RF_MarkAsNative,
		UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::Enumerators),
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::Enum_MetaDataParams)
	};
	UEnum* Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType()
	{
		if (!Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType.InnerSingleton, Z_Construct_UEnum_MediaIOCore_EMediaIOSampleEvaluationType_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType.InnerSingleton;
	}
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIOAutoDetectableTimecodeFormat_Backup>()
{
	...
	struct Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics
	{
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_TimecodeFormat_Underlying;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewProp_TimecodeFormat = { "TimecodeFormat", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOAutoDetectableTimecodeFormat_Backup, TimecodeFormat), Z_Construct_UEnum_MediaIOCore_EMediaIOTimecodeFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewProp_TimecodeFormat_MetaData), Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewProp_TimecodeFormat_MetaData) }; // 3127170546
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewProp_bAutoDetect = { "bAutoDetect", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaIOAutoDetectableTimecodeFormat_Backup), &Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewProp_bAutoDetect_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewProp_bAutoDetect_MetaData), Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewProp_bAutoDetect_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOInputType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOInputType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOInputType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOOutputType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOOutputType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOOutputType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaIOReferenceType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaIOReferenceType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaIOReferenceType_Statics::Enum_MetaDataParams)
	};
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIODevice>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMediaIODevice_Statics::NewProp_DeviceName = { "DeviceName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIODevice, DeviceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIODevice_Statics::NewProp_DeviceName_MetaData), Z_Construct_UScriptStruct_FMediaIODevice_Statics::NewProp_DeviceName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIODevice_Statics::NewProp_DeviceIdentifier = { "DeviceIdentifier", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIODevice, DeviceIdentifier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIODevice_Statics::NewProp_DeviceIdentifier_MetaData), Z_Construct_UScriptStruct_FMediaIODevice_Statics::NewProp_DeviceIdentifier_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIODevice_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIODevice_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIODevice_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIODevice_Statics::PropPointers) < 2048);
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIOConnection>()
{
	...
	struct Z_Construct_UScriptStruct_FMediaIOConnection_Statics
	{
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_TransportType_Underlying;
#if WITH_METADATA
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_QuadTransportType_Underlying;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_Device = { "Device", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOConnection, Device), Z_Construct_UScriptStruct_FMediaIODevice, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_Device_MetaData), Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_Device_MetaData) }; // 698513138
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_Protocol = { "Protocol", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOConnection, Protocol), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_Protocol_MetaData), Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_Protocol_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_TransportType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_TransportType = { "TransportType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOConnection, TransportType), Z_Construct_UEnum_MediaIOCore_EMediaIOTransportType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_TransportType_MetaData), Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_TransportType_MetaData) }; // 2163551518
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_QuadTransportType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_QuadTransportType = { "QuadTransportType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOConnection, QuadTransportType), Z_Construct_UEnum_MediaIOCore_EMediaIOQuadLinkTransportType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_QuadTransportType_MetaData), Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_QuadTransportType_MetaData) }; // 3108154378
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_PortIdentifier = { "PortIdentifier", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOConnection, PortIdentifier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_PortIdentifier_MetaData), Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewProp_PortIdentifier_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIOConnection_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConnection_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIOConnection_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConnection_Statics::PropPointers) < 2048);
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIOMode>()
{
	...
	struct Z_Construct_UScriptStruct_FMediaIOMode_Statics
	{
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_Standard_Underlying;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOMode, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_FrameRate_MetaData), Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_FrameRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_Resolution = { "Resolution", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOMode, Resolution), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_Resolution_MetaData), Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_Resolution_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_Standard_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_Standard = { "Standard", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOMode, Standard), Z_Construct_UEnum_MediaIOCore_EMediaIOStandardType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_Standard_MetaData), Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_Standard_MetaData) }; // 1400760934
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_DeviceModeIdentifier = { "DeviceModeIdentifier", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOMode, DeviceModeIdentifier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_DeviceModeIdentifier_MetaData), Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewProp_DeviceModeIdentifier_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIOMode_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOMode_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIOMode_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOMode_Statics::PropPointers) < 2048);
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIOConfiguration>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_bIsInput = { "bIsInput", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaIOConfiguration), &Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_bIsInput_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_bIsInput_MetaData), Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_bIsInput_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_MediaConnection = { "MediaConnection", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOConfiguration, MediaConnection), Z_Construct_UScriptStruct_FMediaIOConnection, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_MediaConnection_MetaData), Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_MediaConnection_MetaData) }; // 371345835
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_MediaMode = { "MediaMode", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOConfiguration, MediaMode), Z_Construct_UScriptStruct_FMediaIOMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_MediaMode_MetaData), Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewProp_MediaMode_MetaData) }; // 2658912603
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::PropPointers) < 2048);
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIOInputConfiguration>()
{
	...
	struct Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics
	{
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_InputType_Underlying;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_MediaConfiguration = { "MediaConfiguration", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOInputConfiguration, MediaConfiguration), Z_Construct_UScriptStruct_FMediaIOConfiguration, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_MediaConfiguration_MetaData), Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_MediaConfiguration_MetaData) }; // 3258197183
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_InputType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_InputType = { "InputType", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOInputConfiguration, InputType), Z_Construct_UEnum_MediaIOCore_EMediaIOInputType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_InputType_MetaData), Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_InputType_MetaData) }; // 4041285756
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_KeyPortIdentifier = { "KeyPortIdentifier", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOInputConfiguration, KeyPortIdentifier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_KeyPortIdentifier_MetaData), Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::NewProp_KeyPortIdentifier_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOInputConfiguration_Statics::PropPointers) < 2048);
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIOOutputConfiguration>()
{
...
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_KeyPortIdentifier;
		static const UECodeGen_Private::FIntPropertyParams NewProp_OutputReference_Underlying;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_MediaConfiguration = { "MediaConfiguration", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOOutputConfiguration, MediaConfiguration), Z_Construct_UScriptStruct_FMediaIOConfiguration, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_MediaConfiguration_MetaData), Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_MediaConfiguration_MetaData) }; // 3258197183
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_OutputType = { "OutputType", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOOutputConfiguration, OutputType), Z_Construct_UEnum_MediaIOCore_EMediaIOOutputType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_OutputType_MetaData), Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_OutputType_MetaData) }; // 1021860220
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_KeyPortIdentifier = { "KeyPortIdentifier", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOOutputConfiguration, KeyPortIdentifier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_KeyPortIdentifier_MetaData), Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_KeyPortIdentifier_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_OutputReference = { "OutputReference", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOOutputConfiguration, OutputReference), Z_Construct_UEnum_MediaIOCore_EMediaIOReferenceType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_OutputReference_MetaData), Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_OutputReference_MetaData) }; // 3453900673
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_ReferencePortIdentifier = { "ReferencePortIdentifier", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOOutputConfiguration, ReferencePortIdentifier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_ReferencePortIdentifier_MetaData), Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::NewProp_ReferencePortIdentifier_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOOutputConfiguration_Statics::PropPointers) < 2048);
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaIOVideoTimecodeConfiguration>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::NewProp_MediaConfiguration = { "MediaConfiguration", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOVideoTimecodeConfiguration, MediaConfiguration), Z_Construct_UScriptStruct_FMediaIOConfiguration, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::NewProp_MediaConfiguration_MetaData), Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::NewProp_MediaConfiguration_MetaData) }; // 3258197183
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::NewProp_TimecodeFormat = { "TimecodeFormat", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaIOVideoTimecodeConfiguration, TimecodeFormat), Z_Construct_UEnum_MediaIOCore_EMediaIOAutoDetectableTimecodeFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::NewProp_TimecodeFormat_MetaData), Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::NewProp_TimecodeFormat_MetaData) }; // 1714338957
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaIOCoreDefinitions_h_Statics::EnumInfo[] = {
		{ EMediaIOTransportType_StaticEnum, TEXT("EMediaIOTransportType"), &Z_Registration_Info_UEnum_EMediaIOTransportType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2163551518U) },
		{ EMediaIOQuadLinkTransportType_StaticEnum, TEXT("EMediaIOQuadLinkTransportType"), &Z_Registration_Info_UEnum_EMediaIOQuadLinkTransportType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3108154378U) },
		{ EMediaIOStandardType_StaticEnum, TEXT("EMediaIOStandardType"), &Z_Registration_Info_UEnum_EMediaIOStandardType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1400760934U) },
		{ EMediaIOTimecodeFormat_StaticEnum, TEXT("EMediaIOTimecodeFormat"), &Z_Registration_Info_UEnum_EMediaIOTimecodeFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3127170546U) },
		{ EMediaIOAutoDetectableTimecodeFormat_StaticEnum, TEXT("EMediaIOAutoDetectableTimecodeFormat"), &Z_Registration_Info_UEnum_EMediaIOAutoDetectableTimecodeFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1714338957U) },
		{ EMediaIOInterlaceFieldOrder_StaticEnum, TEXT("EMediaIOInterlaceFieldOrder"), &Z_Registration_Info_UEnum_EMediaIOInterlaceFieldOrder, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 307156117U) },
		{ EMediaIOSampleEvaluationType_StaticEnum, TEXT("EMediaIOSampleEvaluationType"), &Z_Registration_Info_UEnum_EMediaIOSampleEvaluationType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 67963019U) },
		{ EMediaIOInputType_StaticEnum, TEXT("EMediaIOInputType"), &Z_Registration_Info_UEnum_EMediaIOInputType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4041285756U) },
		{ EMediaIOOutputType_StaticEnum, TEXT("EMediaIOOutputType"), &Z_Registration_Info_UEnum_EMediaIOOutputType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1021860220U) },
		{ EMediaIOReferenceType_StaticEnum, TEXT("EMediaIOReferenceType"), &Z_Registration_Info_UEnum_EMediaIOReferenceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3453900673U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaIOCoreDefinitions_h_Statics::ScriptStructInfo[] = {
		{ FMediaIOAutoDetectableTimecodeFormat_Backup::StaticStruct, Z_Construct_UScriptStruct_FMediaIOAutoDetectableTimecodeFormat_Backup_Statics::NewStructOps, TEXT("MediaIOAutoDetectableTimecodeFormat_Backup"), &Z_Registration_Info_UScriptStruct_MediaIOAutoDetectableTimecodeFormat_Backup, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaIOAutoDetectableTimecodeFormat_Backup), 2624521157U) },
		{ FMediaIODevice::StaticStruct, Z_Construct_UScriptStruct_FMediaIODevice_Statics::NewStructOps, TEXT("MediaIODevice"), &Z_Registration_Info_UScriptStruct_MediaIODevice, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaIODevice), 698513138U) },
		{ FMediaIOConnection::StaticStruct, Z_Construct_UScriptStruct_FMediaIOConnection_Statics::NewStructOps, TEXT("MediaIOConnection"), &Z_Registration_Info_UScriptStruct_MediaIOConnection, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaIOConnection), 371345835U) },
		{ FMediaIOMode::StaticStruct, Z_Construct_UScriptStruct_FMediaIOMode_Statics::NewStructOps, TEXT("MediaIOMode"), &Z_Registration_Info_UScriptStruct_MediaIOMode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaIOMode), 2658912603U) },
		{ FMediaIOConfiguration::StaticStruct, Z_Construct_UScriptStruct_FMediaIOConfiguration_Statics::NewStructOps, TEXT("MediaIOConfiguration"), &Z_Registration_Info_UScriptStruct_MediaIOConfiguration, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaIOConfiguration), 3258197183U) },
		...
		{ FMediaIOVideoTimecodeConfiguration::StaticStruct, Z_Construct_UScriptStruct_FMediaIOVideoTimecodeConfiguration_Statics::NewStructOps, TEXT("MediaIOVideoTimecodeConfiguration"), &Z_Registration_Info_UScriptStruct_MediaIOVideoTimecodeConfiguration, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaIOVideoTimecodeConfiguration), 3820488978U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaIOCoreDefinitions_h_4078515223(TEXT("/Script/MediaIOCore"),
		nullptr, 0,
