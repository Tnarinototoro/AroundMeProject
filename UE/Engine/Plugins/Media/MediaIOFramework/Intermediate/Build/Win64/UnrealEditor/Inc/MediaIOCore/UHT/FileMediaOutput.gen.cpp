...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EFileMediaOutputPixelFormat_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EFileMediaOutputPixelFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EFileMediaOutputPixelFormat_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_WriteOptions = { "WriteOptions", nullptr, (EPropertyFlags)0x0010008000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFileMediaOutput, WriteOptions), Z_Construct_UScriptStruct_FImageWriteOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_WriteOptions_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_WriteOptions_MetaData) }; // 1359266701
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_FilePath = { "FilePath", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFileMediaOutput, FilePath), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_FilePath_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_FilePath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_BaseFileName = { "BaseFileName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFileMediaOutput, BaseFileName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_BaseFileName_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_BaseFileName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverrideDesiredSize = { "bOverrideDesiredSize", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UFileMediaOutput), &Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverrideDesiredSize_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverrideDesiredSize_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverrideDesiredSize_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_DesiredSize = { "DesiredSize", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFileMediaOutput, DesiredSize), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_DesiredSize_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_DesiredSize_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverridePixelFormat = { "bOverridePixelFormat", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UFileMediaOutput), &Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverridePixelFormat_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverridePixelFormat_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bOverridePixelFormat_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_DesiredPixelFormat_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_DesiredPixelFormat = { "DesiredPixelFormat", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFileMediaOutput, DesiredPixelFormat), Z_Construct_UEnum_MediaIOCore_EFileMediaOutputPixelFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_DesiredPixelFormat_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_DesiredPixelFormat_MetaData) }; // 3447372426
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bInvertAlpha = { "bInvertAlpha", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UFileMediaOutput), &Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bInvertAlpha_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bInvertAlpha_MetaData), Z_Construct_UClass_UFileMediaOutput_Statics::NewProp_bInvertAlpha_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UFileMediaOutput_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UFileMediaOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaOutput_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_FileMediaOutput_h_Statics::EnumInfo[] = {
		{ EFileMediaOutputPixelFormat_StaticEnum, TEXT("EFileMediaOutputPixelFormat"), &Z_Registration_Info_UEnum_EFileMediaOutputPixelFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3447372426U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_FileMediaOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFileMediaOutput, UFileMediaOutput::StaticClass, TEXT("UFileMediaOutput"), &Z_Registration_Info_UClass_UFileMediaOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFileMediaOutput), 3729090627U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_FileMediaOutput_h_407829570(TEXT("/Script/MediaIOCore"),
