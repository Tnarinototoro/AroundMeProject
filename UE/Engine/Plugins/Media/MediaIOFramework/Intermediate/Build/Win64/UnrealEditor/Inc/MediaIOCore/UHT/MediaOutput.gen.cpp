...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaCaptureSourceType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCaptureSourceType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaCaptureSourceType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaOutput_eventCreateMediaCapture_Parms, ReturnValue), Z_Construct_UClass_UMediaCapture_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaOutput, nullptr, "CreateMediaCapture", nullptr, nullptr, Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::MediaOutput_eventCreateMediaCapture_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaOutput_CreateMediaCapture_Statics::MediaOutput_eventCreateMediaCapture_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMediaOutput_Validate_Statics::NewProp_OutFailureReason = { "OutFailureReason", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaOutput_eventValidate_Parms, OutFailureReason), METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaOutput_Validate_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MediaOutput_eventValidate_Parms), &Z_Construct_UFunction_UMediaOutput_Validate_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaOutput_Validate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaOutput, nullptr, "Validate", nullptr, nullptr, Z_Construct_UFunction_UMediaOutput_Validate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaOutput_Validate_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaOutput_Validate_Statics::MediaOutput_eventValidate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaOutput_Validate_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaOutput_Validate_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaOutput_Validate_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaOutput_Validate_Statics::MediaOutput_eventValidate_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaOutput_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMediaOutput_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMediaOutput_CreateMediaCapture, "CreateMediaCapture" }, // 1585750372
		{ &Z_Construct_UFunction_UMediaOutput_Validate, "Validate" }, // 120835471
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaOutput_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMediaOutput_Statics::NewProp_NumberOfTextureBuffers = { "NumberOfTextureBuffers", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaOutput, NumberOfTextureBuffers), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaOutput_Statics::NewProp_NumberOfTextureBuffers_MetaData), Z_Construct_UClass_UMediaOutput_Statics::NewProp_NumberOfTextureBuffers_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaOutput_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaOutput_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaOutput_h_Statics::EnumInfo[] = {
		{ EMediaCaptureSourceType_StaticEnum, TEXT("EMediaCaptureSourceType"), &Z_Registration_Info_UEnum_EMediaCaptureSourceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4182098310U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaOutput, UMediaOutput::StaticClass, TEXT("UMediaOutput"), &Z_Registration_Info_UClass_UMediaOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaOutput), 507967102U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaOutput_h_3423037162(TEXT("/Script/MediaIOCore"),
