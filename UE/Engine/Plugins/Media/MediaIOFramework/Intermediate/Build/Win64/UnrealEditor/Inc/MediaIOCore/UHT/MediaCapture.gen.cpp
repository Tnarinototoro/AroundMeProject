...
// Cross Module References
	...
	MEDIAIOCORE_API UEnum* Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod();
...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaCaptureState_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCaptureState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaCaptureState_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaCaptureResourceType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCaptureResourceType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaCaptureResourceType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaCaptureCroppingType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCaptureCroppingType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaCaptureCroppingType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaCaptureOverrunAction_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCaptureOverrunAction_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaCaptureOverrunAction_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaCapturePhase_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCapturePhase_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaCapturePhase_Statics::Enum_MetaDataParams)
	};
	...
	static FEnumRegistrationInfo Z_Registration_Info_UEnum_EMediaCaptureResizeMethod;
	static UEnum* EMediaCaptureResizeMethod_StaticEnum()
	{
		if (!Z_Registration_Info_UEnum_EMediaCaptureResizeMethod.OuterSingleton)
		{
			Z_Registration_Info_UEnum_EMediaCaptureResizeMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod, (UObject*)Z_Construct_UPackage__Script_MediaIOCore(), TEXT("EMediaCaptureResizeMethod"));
		}
		return Z_Registration_Info_UEnum_EMediaCaptureResizeMethod.OuterSingleton;
	}
	template<> MEDIAIOCORE_API UEnum* StaticEnum<EMediaCaptureResizeMethod>()
	{
		return EMediaCaptureResizeMethod_StaticEnum();
	}
	struct Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::Enumerators[] = {
		{ "EMediaCaptureResizeMethod::None", (int64)EMediaCaptureResizeMethod::None },
		{ "EMediaCaptureResizeMethod::ResizeSource", (int64)EMediaCaptureResizeMethod::ResizeSource },
		{ "EMediaCaptureResizeMethod::ResizeInRenderPass", (int64)EMediaCaptureResizeMethod::ResizeInRenderPass },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/MediaCapture.h" },
		{ "None.Comment", "/** Leaves the source texture as is, which might be incompatible with the output size, causing an error. */" },
		{ "None.Name", "EMediaCaptureResizeMethod::None" },
		{ "None.ToolTip", "Leaves the source texture as is, which might be incompatible with the output size, causing an error." },
		{ "ResizeInRenderPass.Comment", "/** Leaves the source as is, but will add a render pass where we resize the captured texture, leaving the source intact. This is useful when the output size is smaller than the captured source. */" },
		{ "ResizeInRenderPass.Name", "EMediaCaptureResizeMethod::ResizeInRenderPass" },
		{ "ResizeInRenderPass.ToolTip", "Leaves the source as is, but will add a render pass where we resize the captured texture, leaving the source intact. This is useful when the output size is smaller than the captured source." },
		{ "ResizeSource.Comment", "/** Resize the source that is being captured. This will resize the viewport when doing a viewport capture and will resize the render target when capturing a render target. Not valid for immediate capture of RHI resource */" },
		{ "ResizeSource.Name", "EMediaCaptureResizeMethod::ResizeSource" },
		{ "ResizeSource.ToolTip", "Resize the source that is being captured. This will resize the viewport when doing a viewport capture and will resize the render target when capturing a render target. Not valid for immediate capture of RHI resource" },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_MediaIOCore,
		nullptr,
		"EMediaCaptureResizeMethod",
		"EMediaCaptureResizeMethod",
		Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::Enumerators,
		RF_Public|RF_Transient|RF_MarkAsNative,
		UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::Enumerators),
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::Enum_MetaDataParams)
	};
	UEnum* Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod()
	{
		if (!Z_Registration_Info_UEnum_EMediaCaptureResizeMethod.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EMediaCaptureResizeMethod.InnerSingleton, Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_EMediaCaptureResizeMethod.InnerSingleton;
	}
...
template<> MEDIAIOCORE_API UScriptStruct* StaticStruct<FMediaCaptureOptions>()
{
	...
	struct Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics
	{
		...
		static const UECodeGen_Private::FBytePropertyParams NewProp_ResizeMethod_Underlying;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ResizeMethod_MetaData[];
#endif
		static const UECodeGen_Private::FEnumPropertyParams NewProp_ResizeMethod;
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutoRestartOnSourceSizeChange = { "bAutoRestartOnSourceSizeChange", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaCaptureOptions), &Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutoRestartOnSourceSizeChange_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutoRestartOnSourceSizeChange_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutoRestartOnSourceSizeChange_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_OverrunAction = { "OverrunAction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaCaptureOptions, OverrunAction), Z_Construct_UEnum_MediaIOCore_EMediaCaptureOverrunAction, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_OverrunAction_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_OverrunAction_MetaData) }; // 2945708736
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_Crop_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_Crop = { "Crop", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaCaptureOptions, Crop), Z_Construct_UEnum_MediaIOCore_EMediaCaptureCroppingType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_Crop_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_Crop_MetaData) }; // 3472153647
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ColorConversionSettings_MetaData[] = {
		{ "Category", "MediaCapture" },
		{ "Comment", "/** Color conversion settings used by the OCIO conversion pass. */" },
		{ "ModuleRelativePath", "Public/MediaCapture.h" },
		{ "ToolTip", "Color conversion settings used by the OCIO conversion pass." },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ColorConversionSettings = { "ColorConversionSettings", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaCaptureOptions, ColorConversionSettings), Z_Construct_UScriptStruct_FOpenColorIOColorConversionSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ColorConversionSettings_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ColorConversionSettings_MetaData) }; // 1425686863
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_CustomCapturePoint = { "CustomCapturePoint", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaCaptureOptions, CustomCapturePoint), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_CustomCapturePoint_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_CustomCapturePoint_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ResizeMethod_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ResizeMethod_MetaData[] = {
		{ "Category", "MediaCapture" },
		{ "Comment", "/**\n\x09 * When the capture start, control if and how the source buffer should be resized to the desired size.\n\x09 * @note Only valid when a size is specified by the MediaOutput.\n\x09 */" },
		{ "ModuleRelativePath", "Public/MediaCapture.h" },
		{ "ToolTip", "When the capture start, control if and how the source buffer should be resized to the desired size.\n@note Only valid when a size is specified by the MediaOutput." },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ResizeMethod = { "ResizeMethod", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaCaptureOptions, ResizeMethod), Z_Construct_UEnum_MediaIOCore_EMediaCaptureResizeMethod, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ResizeMethod_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ResizeMethod_MetaData) }; // 137877851
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bSkipFrameWhenRunningExpensiveTasks = { "bSkipFrameWhenRunningExpensiveTasks", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaCaptureOptions), &Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bSkipFrameWhenRunningExpensiveTasks_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bSkipFrameWhenRunningExpensiveTasks_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bSkipFrameWhenRunningExpensiveTasks_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bConvertToDesiredPixelFormat = { "bConvertToDesiredPixelFormat", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaCaptureOptions), &Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bConvertToDesiredPixelFormat_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bConvertToDesiredPixelFormat_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bConvertToDesiredPixelFormat_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bForceAlphaToOneOnConversion = { "bForceAlphaToOneOnConversion", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaCaptureOptions), &Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bForceAlphaToOneOnConversion_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bForceAlphaToOneOnConversion_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bForceAlphaToOneOnConversion_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bApplyLinearToSRGBConversion = { "bApplyLinearToSRGBConversion", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaCaptureOptions), &Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bApplyLinearToSRGBConversion_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bApplyLinearToSRGBConversion_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bApplyLinearToSRGBConversion_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutostopOnCapture = { "bAutostopOnCapture", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaCaptureOptions), &Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutostopOnCapture_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutostopOnCapture_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bAutostopOnCapture_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_NumberOfFramesToCapture = { "NumberOfFramesToCapture", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaCaptureOptions, NumberOfFramesToCapture), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_NumberOfFramesToCapture_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_NumberOfFramesToCapture_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_CapturePhase_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_CapturePhase = { "CapturePhase", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMediaCaptureOptions, CapturePhase), Z_Construct_UEnum_MediaIOCore_EMediaCapturePhase, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_CapturePhase_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_CapturePhase_MetaData) }; // 451561677
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bResizeSourceBuffer_MetaData[] = {
		{ "DeprecatedProperty", "" },
		{ "DeprecationMessage", "bResizeSourceBuffer, please use ResizeMethod instead." },
		{ "ModuleRelativePath", "Public/MediaCapture.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bResizeSourceBuffer_SetBit(void* Obj)
	{
		((FMediaCaptureOptions*)Obj)->bResizeSourceBuffer_DEPRECATED = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bResizeSourceBuffer = { "bResizeSourceBuffer", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMediaCaptureOptions), &Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bResizeSourceBuffer_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bResizeSourceBuffer_MetaData), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_bResizeSourceBuffer_MetaData) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ColorConversionSettings,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ResizeMethod_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewProp_ResizeMethod,
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::PropPointers) < 2048);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_MediaIOCore_MediaCaptureStateChangedSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_MediaIOCore, nullptr, "MediaCaptureStateChangedSignature__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MediaIOCore_MediaCaptureStateChangedSignature__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_MediaIOCore_MediaCaptureStateChangedSignature__DelegateSignature_Statics::Function_MetaDataParams) };
...
void FMediaCaptureStateChangedSignature_DelegateWrapper(const FMulticastScriptDelegate& MediaCaptureStateChangedSignature)
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::NewProp_CaptureOptions = { "CaptureOptions", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventCaptureActiveSceneViewport_Parms, CaptureOptions), Z_Construct_UScriptStruct_FMediaCaptureOptions, METADATA_PARAMS(0, nullptr) }; // 2670309160
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MediaCapture_eventCaptureActiveSceneViewport_Parms), &Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "CaptureActiveSceneViewport", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::MediaCapture_eventCaptureActiveSceneViewport_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport_Statics::MediaCapture_eventCaptureActiveSceneViewport_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::NewProp_RenderTarget = { "RenderTarget", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventCaptureTextureRenderTarget2D_Parms, RenderTarget), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::NewProp_CaptureOptions = { "CaptureOptions", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventCaptureTextureRenderTarget2D_Parms, CaptureOptions), Z_Construct_UScriptStruct_FMediaCaptureOptions, METADATA_PARAMS(0, nullptr) }; // 2670309160
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MediaCapture_eventCaptureTextureRenderTarget2D_Parms), &Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "CaptureTextureRenderTarget2D", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::MediaCapture_eventCaptureTextureRenderTarget2D_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D_Statics::MediaCapture_eventCaptureTextureRenderTarget2D_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventGetDesiredPixelFormat_Parms, ReturnValue), Z_Construct_UEnum_CoreUObject_EPixelFormat, METADATA_PARAMS(0, nullptr) }; // 3006825266
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "GetDesiredPixelFormat", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::MediaCapture_eventGetDesiredPixelFormat_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat_Statics::MediaCapture_eventGetDesiredPixelFormat_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventGetDesiredSize_Parms, ReturnValue), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "GetDesiredSize", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::MediaCapture_eventGetDesiredSize_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_GetDesiredSize_Statics::MediaCapture_eventGetDesiredSize_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMediaCapture_GetState_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventGetState_Parms, ReturnValue), Z_Construct_UEnum_MediaIOCore_EMediaCaptureState, METADATA_PARAMS(0, nullptr) }; // 1034454903
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_GetState_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "GetState", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_GetState_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetState_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_GetState_Statics::MediaCapture_eventGetState_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetState_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_GetState_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_GetState_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_GetState_Statics::MediaCapture_eventGetState_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::NewProp_InMediaOutput = { "InMediaOutput", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventSetMediaOutput_Parms, InMediaOutput), Z_Construct_UClass_UMediaOutput_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "SetMediaOutput", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::MediaCapture_eventSetMediaOutput_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_SetMediaOutput_Statics::MediaCapture_eventSetMediaOutput_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::NewProp_bAllowPendingFrameToBeProcess = { "bAllowPendingFrameToBeProcess", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MediaCapture_eventStopCapture_Parms), &Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::NewProp_bAllowPendingFrameToBeProcess_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "StopCapture", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::MediaCapture_eventStopCapture_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_StopCapture_Statics::MediaCapture_eventStopCapture_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::NewProp_RenderTarget = { "RenderTarget", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MediaCapture_eventUpdateTextureRenderTarget2D_Parms, RenderTarget), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MediaCapture_eventUpdateTextureRenderTarget2D_Parms), &Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaCapture, nullptr, "UpdateTextureRenderTarget2D", nullptr, nullptr, Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::MediaCapture_eventUpdateTextureRenderTarget2D_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D_Statics::MediaCapture_eventUpdateTextureRenderTarget2D_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaCapture_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMediaCapture_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMediaCapture_CaptureActiveSceneViewport, "CaptureActiveSceneViewport" }, // 3313883474
		{ &Z_Construct_UFunction_UMediaCapture_CaptureTextureRenderTarget2D, "CaptureTextureRenderTarget2D" }, // 1991505719
		{ &Z_Construct_UFunction_UMediaCapture_GetDesiredPixelFormat, "GetDesiredPixelFormat" }, // 2214852950
		{ &Z_Construct_UFunction_UMediaCapture_GetDesiredSize, "GetDesiredSize" }, // 4041370356
		{ &Z_Construct_UFunction_UMediaCapture_GetState, "GetState" }, // 2896182486
		{ &Z_Construct_UFunction_UMediaCapture_SetMediaOutput, "SetMediaOutput" }, // 1097958898
		{ &Z_Construct_UFunction_UMediaCapture_StopCapture, "StopCapture" }, // 2213181875
		{ &Z_Construct_UFunction_UMediaCapture_UpdateTextureRenderTarget2D, "UpdateTextureRenderTarget2D" }, // 3089513180
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaCapture_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMediaCapture_Statics::NewProp_OnStateChanged = { "OnStateChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaCapture, OnStateChanged), Z_Construct_UDelegateFunction_MediaIOCore_MediaCaptureStateChangedSignature__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaCapture_Statics::NewProp_OnStateChanged_MetaData), Z_Construct_UClass_UMediaCapture_Statics::NewProp_OnStateChanged_MetaData) }; // 1695033788
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaCapture_Statics::NewProp_MediaOutput = { "MediaOutput", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaCapture, MediaOutput), Z_Construct_UClass_UMediaOutput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaCapture_Statics::NewProp_MediaOutput_MetaData), Z_Construct_UClass_UMediaCapture_Statics::NewProp_MediaOutput_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaCapture_Statics::ClassParams = {
		...
		0,
		0x009010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaCapture_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaCapture_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaCapture_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaCapture_h_Statics::EnumInfo[] = {
		{ EMediaCaptureState_StaticEnum, TEXT("EMediaCaptureState"), &Z_Registration_Info_UEnum_EMediaCaptureState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1034454903U) },
		{ EMediaCaptureResourceType_StaticEnum, TEXT("EMediaCaptureResourceType"), &Z_Registration_Info_UEnum_EMediaCaptureResourceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2719745099U) },
		{ EMediaCaptureCroppingType_StaticEnum, TEXT("EMediaCaptureCroppingType"), &Z_Registration_Info_UEnum_EMediaCaptureCroppingType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3472153647U) },
		{ EMediaCaptureOverrunAction_StaticEnum, TEXT("EMediaCaptureOverrunAction"), &Z_Registration_Info_UEnum_EMediaCaptureOverrunAction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2945708736U) },
		{ EMediaCapturePhase_StaticEnum, TEXT("EMediaCapturePhase"), &Z_Registration_Info_UEnum_EMediaCapturePhase, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 451561677U) },
		{ EMediaCaptureResizeMethod_StaticEnum, TEXT("EMediaCaptureResizeMethod"), &Z_Registration_Info_UEnum_EMediaCaptureResizeMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 137877851U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaCapture_h_Statics::ScriptStructInfo[] = {
		{ FMediaCaptureOptions::StaticStruct, Z_Construct_UScriptStruct_FMediaCaptureOptions_Statics::NewStructOps, TEXT("MediaCaptureOptions"), &Z_Registration_Info_UScriptStruct_MediaCaptureOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaCaptureOptions), 2670309160U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaCapture, UMediaCapture::StaticClass, TEXT("UMediaCapture"), &Z_Registration_Info_UClass_UMediaCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaCapture), 3495921389U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaCapture_h_317425670(TEXT("/Script/MediaIOCore"),
