...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaCapture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UFileMediaCapture_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFileMediaCapture_Statics::Class_MetaDataParams), Z_Construct_UClass_UFileMediaCapture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_FileMediaCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFileMediaCapture, UFileMediaCapture::StaticClass, TEXT("UFileMediaCapture"), &Z_Registration_Info_UClass_UFileMediaCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFileMediaCapture), 2654069739U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_FileMediaCapture_h_3690310949(TEXT("/Script/MediaIOCore"),
