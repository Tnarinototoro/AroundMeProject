...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaIOCoreSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaIOCoreSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaIOCoreSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaIOCoreSubsystem_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaIOCoreSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaIOCoreSubsystem, UMediaIOCoreSubsystem::StaticClass, TEXT("UMediaIOCoreSubsystem"), &Z_Registration_Info_UClass_UMediaIOCoreSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaIOCoreSubsystem), 3135547149U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaIOFramework_Source_MediaIOCore_Public_MediaIOCoreSubsystem_h_1665522368(TEXT("/Script/MediaIOCore"),
