...
template<> LINEARTIMECODE_API UScriptStruct* StaticStruct<FDropTimecode>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_Timecode = { "Timecode", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDropTimecode, Timecode), Z_Construct_UScriptStruct_FTimecode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_Timecode_MetaData), Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_Timecode_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDropTimecode, FrameRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_FrameRate_MetaData), Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_FrameRate_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bColorFraming = { "bColorFraming", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FDropTimecode), &Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bColorFraming_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bColorFraming_MetaData), Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bColorFraming_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bRunningForward = { "bRunningForward", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FDropTimecode), &Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bRunningForward_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bRunningForward_MetaData), Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bRunningForward_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bNewFrame = { "bNewFrame", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FDropTimecode), &Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bNewFrame_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bNewFrame_MetaData), Z_Construct_UScriptStruct_FDropTimecode_Statics::NewProp_bNewFrame_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDropTimecode_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDropTimecode_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDropTimecode_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDropTimecode_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_LinearTimecode_Source_LinearTimecode_Public_DropTimecode_h_Statics::ScriptStructInfo[] = {
		{ FDropTimecode::StaticStruct, Z_Construct_UScriptStruct_FDropTimecode_Statics::NewStructOps, TEXT("DropTimecode"), &Z_Registration_Info_UScriptStruct_DropTimecode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDropTimecode), 1870586961U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_LinearTimecode_Source_LinearTimecode_Public_DropTimecode_h_1735228900(TEXT("/Script/LinearTimecode"),
		nullptr, 0,
