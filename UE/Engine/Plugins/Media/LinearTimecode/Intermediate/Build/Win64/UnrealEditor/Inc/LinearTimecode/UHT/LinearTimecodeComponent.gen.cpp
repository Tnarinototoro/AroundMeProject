...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::NewProp_Timecode = { "Timecode", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_LinearTimecode_eventOnTimecodeChange_Parms, Timecode), Z_Construct_UScriptStruct_FDropTimecode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::NewProp_Timecode_MetaData), Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::NewProp_Timecode_MetaData) }; // 1870586961
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_LinearTimecode, nullptr, "OnTimecodeChange__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::_Script_LinearTimecode_eventOnTimecodeChange_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature_Statics::_Script_LinearTimecode_eventOnTimecodeChange_Parms) < MAX_uint16);
...
void FOnTimecodeChange_DelegateWrapper(const FMulticastScriptDelegate& OnTimecodeChange, FDropTimecode const& Timecode)
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LinearTimecodeComponent_eventGetDropFrameNumber_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULinearTimecodeComponent, nullptr, "GetDropFrameNumber", nullptr, nullptr, Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::LinearTimecodeComponent_eventGetDropFrameNumber_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber_Statics::LinearTimecodeComponent_eventGetDropFrameNumber_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::NewProp_Timecode = { "Timecode", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LinearTimecodeComponent_eventGetDropTimeCodeFrameNumber_Parms, Timecode), Z_Construct_UScriptStruct_FDropTimecode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::NewProp_Timecode_MetaData), Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::NewProp_Timecode_MetaData) }; // 1870586961
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::NewProp_FrameNumber = { "FrameNumber", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LinearTimecodeComponent_eventGetDropTimeCodeFrameNumber_Parms, FrameNumber), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULinearTimecodeComponent, nullptr, "GetDropTimeCodeFrameNumber", nullptr, nullptr, Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::LinearTimecodeComponent_eventGetDropTimeCodeFrameNumber_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber_Statics::LinearTimecodeComponent_eventGetDropTimeCodeFrameNumber_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::NewProp_Timecode = { "Timecode", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LinearTimecodeComponent_eventSetDropTimecodeFrameNumber_Parms, Timecode), Z_Construct_UScriptStruct_FDropTimecode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::NewProp_Timecode_MetaData), Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::NewProp_Timecode_MetaData) }; // 1870586961
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::NewProp_FrameNumber = { "FrameNumber", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LinearTimecodeComponent_eventSetDropTimecodeFrameNumber_Parms, FrameNumber), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::NewProp_OutTimecode = { "OutTimecode", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LinearTimecodeComponent_eventSetDropTimecodeFrameNumber_Parms, OutTimecode), Z_Construct_UScriptStruct_FDropTimecode, METADATA_PARAMS(0, nullptr) }; // 1870586961
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULinearTimecodeComponent, nullptr, "SetDropTimecodeFrameNumber", nullptr, nullptr, Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::LinearTimecodeComponent_eventSetDropTimecodeFrameNumber_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber_Statics::LinearTimecodeComponent_eventSetDropTimecodeFrameNumber_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULinearTimecodeComponent_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_ULinearTimecodeComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULinearTimecodeComponent_GetDropFrameNumber, "GetDropFrameNumber" }, // 3379072974
		{ &Z_Construct_UFunction_ULinearTimecodeComponent_GetDropTimeCodeFrameNumber, "GetDropTimeCodeFrameNumber" }, // 3620381175
		{ &Z_Construct_UFunction_ULinearTimecodeComponent_SetDropTimecodeFrameNumber, "SetDropTimecodeFrameNumber" }, // 3564484144
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULinearTimecodeComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_MediaPlayer = { "MediaPlayer", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULinearTimecodeComponent, MediaPlayer), Z_Construct_UClass_UMediaPlayer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_MediaPlayer_MetaData), Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_MediaPlayer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_DropTimecode = { "DropTimecode", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULinearTimecodeComponent, DropTimecode), Z_Construct_UScriptStruct_FDropTimecode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_DropTimecode_MetaData), Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_DropTimecode_MetaData) }; // 1870586961
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_OnTimecodeChange = { "OnTimecodeChange", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULinearTimecodeComponent, OnTimecodeChange), Z_Construct_UDelegateFunction_LinearTimecode_OnTimecodeChange__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_OnTimecodeChange_MetaData), Z_Construct_UClass_ULinearTimecodeComponent_Statics::NewProp_OnTimecodeChange_MetaData) }; // 751877120
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULinearTimecodeComponent_Statics::ClassParams = {
		...
		0,
		0x00B010A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULinearTimecodeComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_ULinearTimecodeComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULinearTimecodeComponent_Statics::PropPointers) < 2048);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::NewProp_InTimecode = { "InTimecode", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DropTimecodeToStringConversion_eventConv_DropTimecodeToString_Parms, InTimecode), Z_Construct_UScriptStruct_FDropTimecode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::NewProp_InTimecode_MetaData), Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::NewProp_InTimecode_MetaData) }; // 1870586961
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DropTimecodeToStringConversion_eventConv_DropTimecodeToString_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDropTimecodeToStringConversion, nullptr, "Conv_DropTimecodeToString", nullptr, nullptr, Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::DropTimecodeToStringConversion_eventConv_DropTimecodeToString_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14442401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString_Statics::DropTimecodeToStringConversion_eventConv_DropTimecodeToString_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDropTimecodeToStringConversion_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDropTimecodeToStringConversion_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDropTimecodeToStringConversion_Conv_DropTimecodeToString, "Conv_DropTimecodeToString" }, // 535798964
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDropTimecodeToStringConversion_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDropTimecodeToStringConversion_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDropTimecodeToStringConversion_Statics::Class_MetaDataParams), Z_Construct_UClass_UDropTimecodeToStringConversion_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_LinearTimecode_Source_LinearTimecode_Public_LinearTimecodeComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULinearTimecodeComponent, ULinearTimecodeComponent::StaticClass, TEXT("ULinearTimecodeComponent"), &Z_Registration_Info_UClass_ULinearTimecodeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULinearTimecodeComponent), 1092797791U) },
		{ Z_Construct_UClass_UDropTimecodeToStringConversion, UDropTimecodeToStringConversion::StaticClass, TEXT("UDropTimecodeToStringConversion"), &Z_Registration_Info_UClass_UDropTimecodeToStringConversion, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDropTimecodeToStringConversion), 2460186971U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_LinearTimecode_Source_LinearTimecode_Public_LinearTimecodeComponent_h_2725019993(TEXT("/Script/LinearTimecode"),
