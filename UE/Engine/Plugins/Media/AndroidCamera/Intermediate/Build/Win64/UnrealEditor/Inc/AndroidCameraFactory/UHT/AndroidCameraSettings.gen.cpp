...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidCameraSettings_Statics::NewProp_CacheableVideoSampleBuffers = { "CacheableVideoSampleBuffers", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAndroidCameraSettings), &Z_Construct_UClass_UAndroidCameraSettings_Statics::NewProp_CacheableVideoSampleBuffers_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraSettings_Statics::NewProp_CacheableVideoSampleBuffers_MetaData), Z_Construct_UClass_UAndroidCameraSettings_Statics::NewProp_CacheableVideoSampleBuffers_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAndroidCameraSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UAndroidCameraSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AndroidCamera_Source_AndroidCameraFactory_Public_AndroidCameraSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAndroidCameraSettings, UAndroidCameraSettings::StaticClass, TEXT("UAndroidCameraSettings"), &Z_Registration_Info_UClass_UAndroidCameraSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAndroidCameraSettings), 637670657U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AndroidCamera_Source_AndroidCameraFactory_Public_AndroidCameraSettings_h_63934179(TEXT("/Script/AndroidCameraFactory"),
