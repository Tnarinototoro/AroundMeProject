...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bEnablePermission = { "bEnablePermission", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAndroidCameraRuntimeSettings), &Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bEnablePermission_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bEnablePermission_MetaData), Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bEnablePermission_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresAnyCamera = { "bRequiresAnyCamera", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAndroidCameraRuntimeSettings), &Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresAnyCamera_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresAnyCamera_MetaData), Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresAnyCamera_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresBackFacingCamera = { "bRequiresBackFacingCamera", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAndroidCameraRuntimeSettings), &Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresBackFacingCamera_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresBackFacingCamera_MetaData), Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresBackFacingCamera_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresFrontFacingCamera = { "bRequiresFrontFacingCamera", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAndroidCameraRuntimeSettings), &Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresFrontFacingCamera_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresFrontFacingCamera_MetaData), Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::NewProp_bRequiresFrontFacingCamera_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::ClassParams = {
		...
		0,
		0x000000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidCameraRuntimeSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AndroidCamera_Source_AndroidCameraEditor_Public_AndroidCameraRuntimeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAndroidCameraRuntimeSettings, UAndroidCameraRuntimeSettings::StaticClass, TEXT("UAndroidCameraRuntimeSettings"), &Z_Registration_Info_UClass_UAndroidCameraRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAndroidCameraRuntimeSettings), 1640487407U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AndroidCamera_Source_AndroidCameraEditor_Public_AndroidCameraRuntimeSettings_h_4115457147(TEXT("/Script/AndroidCameraEditor"),
