...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::NewProp_MediaConfiguration = { "MediaConfiguration", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBlackmagicCustomTimeStep, MediaConfiguration), Z_Construct_UScriptStruct_FMediaIOConfiguration, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::NewProp_MediaConfiguration_MetaData), Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::NewProp_MediaConfiguration_MetaData) }; // 3258197183
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::NewProp_bEnableOverrunDetection = { "bEnableOverrunDetection", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UBlackmagicCustomTimeStep), &Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::NewProp_bEnableOverrunDetection_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::NewProp_bEnableOverrunDetection_MetaData), Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::NewProp_bEnableOverrunDetection_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::Class_MetaDataParams), Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicCustomTimeStep_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMedia_Public_BlackmagicCustomTimeStep_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBlackmagicCustomTimeStep, UBlackmagicCustomTimeStep::StaticClass, TEXT("UBlackmagicCustomTimeStep"), &Z_Registration_Info_UClass_UBlackmagicCustomTimeStep, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlackmagicCustomTimeStep), 4157710782U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMedia_Public_BlackmagicCustomTimeStep_h_2274892949(TEXT("/Script/BlackmagicMedia"),
