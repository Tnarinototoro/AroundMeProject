...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_BlackmagicMedia_EBlackmagicMediaTimecodeFormat_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_BlackmagicMedia_EBlackmagicMediaTimecodeFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_BlackmagicMedia_EBlackmagicMediaTimecodeFormat_Statics::Enum_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMedia_Public_BlackmagicDeviceProvider_h_Statics::EnumInfo[] = {
		{ EBlackmagicMediaTimecodeFormat_StaticEnum, TEXT("EBlackmagicMediaTimecodeFormat"), &Z_Registration_Info_UEnum_EBlackmagicMediaTimecodeFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2506621321U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMedia_Public_BlackmagicDeviceProvider_h_1139068723(TEXT("/Script/BlackmagicMedia"),
		nullptr, 0,
		nullptr, 0,
