...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicMediaOutputFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBlackmagicMediaOutputFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicMediaOutputFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UBlackmagicMediaOutputFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMediaEditor_Private_Factories_BlackmagicMediaOutputFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBlackmagicMediaOutputFactoryNew, UBlackmagicMediaOutputFactoryNew::StaticClass, TEXT("UBlackmagicMediaOutputFactoryNew"), &Z_Registration_Info_UClass_UBlackmagicMediaOutputFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlackmagicMediaOutputFactoryNew), 4078350806U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMediaEditor_Private_Factories_BlackmagicMediaOutputFactoryNew_h_2587607062(TEXT("/Script/BlackmagicMediaEditor"),
