...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicMediaCapture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBlackmagicMediaCapture_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackmagicMediaCapture_Statics::Class_MetaDataParams), Z_Construct_UClass_UBlackmagicMediaCapture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMediaOutput_Public_BlackmagicMediaCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBlackmagicMediaCapture, UBlackmagicMediaCapture::StaticClass, TEXT("UBlackmagicMediaCapture"), &Z_Registration_Info_UClass_UBlackmagicMediaCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlackmagicMediaCapture), 1531588175U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BlackmagicMedia_Source_BlackmagicMediaOutput_Public_BlackmagicMediaCapture_h_3737090187(TEXT("/Script/BlackmagicMediaOutput"),
