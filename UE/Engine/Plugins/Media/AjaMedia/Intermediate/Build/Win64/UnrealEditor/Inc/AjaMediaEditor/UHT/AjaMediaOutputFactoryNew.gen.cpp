...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaMediaOutputFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAjaMediaOutputFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaMediaOutputFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_UAjaMediaOutputFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMediaEditor_Private_Factories_AjaMediaOutputFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAjaMediaOutputFactoryNew, UAjaMediaOutputFactoryNew::StaticClass, TEXT("UAjaMediaOutputFactoryNew"), &Z_Registration_Info_UClass_UAjaMediaOutputFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAjaMediaOutputFactoryNew), 271350140U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMediaEditor_Private_Factories_AjaMediaOutputFactoryNew_h_3018340449(TEXT("/Script/AjaMediaEditor"),
