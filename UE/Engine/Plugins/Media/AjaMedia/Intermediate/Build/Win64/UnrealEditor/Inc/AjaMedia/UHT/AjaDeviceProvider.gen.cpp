...
template<> AJAMEDIA_API UScriptStruct* StaticStruct<FAjaMediaTimecodeConfiguration>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::NewProp_MediaConfiguration = { "MediaConfiguration", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAjaMediaTimecodeConfiguration, MediaConfiguration), Z_Construct_UScriptStruct_FMediaIOConfiguration, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::NewProp_MediaConfiguration_MetaData), Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::NewProp_MediaConfiguration_MetaData) }; // 3258197183
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::NewProp_TimecodeFormat = { "TimecodeFormat", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAjaMediaTimecodeConfiguration, TimecodeFormat), Z_Construct_UEnum_MediaIOCore_EMediaIOTimecodeFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::NewProp_TimecodeFormat_MetaData), Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::NewProp_TimecodeFormat_MetaData) }; // 3127170546
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeConfiguration_Statics::PropPointers) < 2048);
...
template<> AJAMEDIA_API UScriptStruct* StaticStruct<FAjaMediaTimecodeReference>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_Device = { "Device", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAjaMediaTimecodeReference, Device), Z_Construct_UScriptStruct_FMediaIODevice, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_Device_MetaData), Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_Device_MetaData) }; // 698513138
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_LtcIndex = { "LtcIndex", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAjaMediaTimecodeReference, LtcIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_LtcIndex_MetaData), Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_LtcIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_LtcFrameRate = { "LtcFrameRate", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAjaMediaTimecodeReference, LtcFrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_LtcFrameRate_MetaData), Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::NewProp_LtcFrameRate_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAjaMediaTimecodeReference_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMedia_Public_AjaDeviceProvider_h_2455740552(TEXT("/Script/AjaMedia"),
		nullptr, 0,
