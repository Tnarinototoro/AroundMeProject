...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_MediaOutput = { "MediaOutput", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAjaFrameGrabberProtocol, MediaOutput), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_MediaOutput_MetaData), Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_MediaOutput_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_Information = { "Information", nullptr, (EPropertyFlags)0x0010000000022001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAjaFrameGrabberProtocol, Information), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_Information_MetaData), Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_Information_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_TransientMediaOutputPtr = { "TransientMediaOutputPtr", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAjaFrameGrabberProtocol, TransientMediaOutputPtr), Z_Construct_UClass_UAjaMediaOutput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_TransientMediaOutputPtr_MetaData), Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_TransientMediaOutputPtr_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_TransientMediaCapturePtr = { "TransientMediaCapturePtr", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAjaFrameGrabberProtocol, TransientMediaCapturePtr), Z_Construct_UClass_UAjaMediaCapture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_TransientMediaCapturePtr_MetaData), Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::NewProp_TransientMediaCapturePtr_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::ClassParams = {
		...
		0,
		0x001004A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::Class_MetaDataParams), Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaFrameGrabberProtocol_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMediaOutput_Public_AjaMediaFrameGrabberProtocol_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAjaFrameGrabberProtocol, UAjaFrameGrabberProtocol::StaticClass, TEXT("UAjaFrameGrabberProtocol"), &Z_Registration_Info_UClass_UAjaFrameGrabberProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAjaFrameGrabberProtocol), 1224870839U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMediaOutput_Public_AjaMediaFrameGrabberProtocol_h_3671236594(TEXT("/Script/AjaMediaOutput"),
