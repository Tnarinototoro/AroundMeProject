...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaMediaSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAjaMediaSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaMediaSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UAjaMediaSettings_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMedia_Public_AjaMediaSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAjaMediaSettings, UAjaMediaSettings::StaticClass, TEXT("UAjaMediaSettings"), &Z_Registration_Info_UClass_UAjaMediaSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAjaMediaSettings), 4095753425U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMedia_Public_AjaMediaSettings_h_3788799881(TEXT("/Script/AjaMedia"),
