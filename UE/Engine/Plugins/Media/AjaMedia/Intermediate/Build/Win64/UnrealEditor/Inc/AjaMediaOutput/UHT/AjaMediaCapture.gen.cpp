...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaMediaCapture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAjaMediaCapture_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAjaMediaCapture_Statics::Class_MetaDataParams), Z_Construct_UClass_UAjaMediaCapture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMediaOutput_Public_AjaMediaCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAjaMediaCapture, UAjaMediaCapture::StaticClass, TEXT("UAjaMediaCapture"), &Z_Registration_Info_UClass_UAjaMediaCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAjaMediaCapture), 1583948606U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AjaMedia_Source_AjaMediaOutput_Public_AjaMediaCapture_h_2457630590(TEXT("/Script/AjaMediaOutput"),
