...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMediaPlayerEditorSettings_Statics::NewProp_DesiredPlayerName = { "DesiredPlayerName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaPlayerEditorSettings, DesiredPlayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerEditorSettings_Statics::NewProp_DesiredPlayerName_MetaData), Z_Construct_UClass_UMediaPlayerEditorSettings_Statics::NewProp_DesiredPlayerName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMediaPlayerEditorSettings_Statics::NewProp_ShowTextOverlays = { "ShowTextOverlays", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMediaPlayerEditorSettings), &Z_Construct_UClass_UMediaPlayerEditorSettings_Statics::NewProp_ShowTextOverlays_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerEditorSettings_Statics::NewProp_ShowTextOverlays_MetaData), Z_Construct_UClass_UMediaPlayerEditorSettings_Statics::NewProp_ShowTextOverlays_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaPlayerEditor_Source_MediaPlayerEditor_Private_Shared_MediaPlayerEditorSettings_h_Statics::EnumInfo[] = {
		{ EMediaPlayerEditorScale_StaticEnum, TEXT("EMediaPlayerEditorScale"), &Z_Registration_Info_UEnum_EMediaPlayerEditorScale, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1163089162U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaPlayerEditor_Source_MediaPlayerEditor_Private_Shared_MediaPlayerEditorSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaPlayerEditorSettings, UMediaPlayerEditorSettings::StaticClass, TEXT("UMediaPlayerEditorSettings"), &Z_Registration_Info_UClass_UMediaPlayerEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaPlayerEditorSettings), 4292468129U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaPlayerEditor_Source_MediaPlayerEditor_Private_Shared_MediaPlayerEditorSettings_h_2095700577(TEXT("/Script/MediaPlayerEditor"),
