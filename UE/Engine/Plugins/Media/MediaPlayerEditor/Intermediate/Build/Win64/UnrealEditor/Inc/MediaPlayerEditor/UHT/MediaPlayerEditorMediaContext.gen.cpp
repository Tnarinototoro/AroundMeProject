...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaPlayerEditorMediaContext_Statics::NewProp_SelectedAsset = { "SelectedAsset", nullptr, (EPropertyFlags)0x0014000000000004, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaPlayerEditorMediaContext, SelectedAsset), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerEditorMediaContext_Statics::NewProp_SelectedAsset_MetaData), Z_Construct_UClass_UMediaPlayerEditorMediaContext_Statics::NewProp_SelectedAsset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMediaPlayerEditorMediaContext_Statics::NewProp_StyleSetName = { "StyleSetName", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaPlayerEditorMediaContext, StyleSetName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaPlayerEditorMediaContext_Statics::NewProp_StyleSetName_MetaData), Z_Construct_UClass_UMediaPlayerEditorMediaContext_Statics::NewProp_StyleSetName_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaPlayerEditor_Source_MediaPlayerEditor_Private_Shared_MediaPlayerEditorMediaContext_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaPlayerEditorMediaContext, UMediaPlayerEditorMediaContext::StaticClass, TEXT("UMediaPlayerEditorMediaContext"), &Z_Registration_Info_UClass_UMediaPlayerEditorMediaContext, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaPlayerEditorMediaContext), 2522482799U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaPlayerEditor_Source_MediaPlayerEditor_Private_Shared_MediaPlayerEditorMediaContext_h_2405322360(TEXT("/Script/MediaPlayerEditor"),
