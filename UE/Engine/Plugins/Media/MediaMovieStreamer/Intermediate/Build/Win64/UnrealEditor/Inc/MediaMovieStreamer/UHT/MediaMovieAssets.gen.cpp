...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaMovieAssets_OnMediaEnd_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMediaMovieAssets, nullptr, "OnMediaEnd", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaMovieAssets_OnMediaEnd_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaMovieAssets_OnMediaEnd_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMediaMovieAssets_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMediaMovieAssets_OnMediaEnd, "OnMediaEnd" }, // 4234328940
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaPlayer = { "MediaPlayer", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaMovieAssets, MediaPlayer), Z_Construct_UClass_UMediaPlayer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaPlayer_MetaData), Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaPlayer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaSoundComponent = { "MediaSoundComponent", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaMovieAssets, MediaSoundComponent), Z_Construct_UClass_UMediaSoundComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaSoundComponent_MetaData), Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaSoundComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaSource = { "MediaSource", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaMovieAssets, MediaSource), Z_Construct_UClass_UMediaSource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaSource_MetaData), Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaSource_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaTexture = { "MediaTexture", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMediaMovieAssets, MediaTexture), Z_Construct_UClass_UMediaTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaTexture_MetaData), Z_Construct_UClass_UMediaMovieAssets_Statics::NewProp_MediaTexture_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMediaMovieAssets_Statics::ClassParams = {
		...
		0,
		0x008000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::Class_MetaDataParams), Z_Construct_UClass_UMediaMovieAssets_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMediaMovieAssets_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaMovieStreamer_Source_MediaMovieStreamer_Private_MediaMovieAssets_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaMovieAssets, UMediaMovieAssets::StaticClass, TEXT("UMediaMovieAssets"), &Z_Registration_Info_UClass_UMediaMovieAssets, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaMovieAssets), 3862238954U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaMovieStreamer_Source_MediaMovieStreamer_Private_MediaMovieAssets_h_3785936980(TEXT("/Script/MediaMovieStreamer"),
