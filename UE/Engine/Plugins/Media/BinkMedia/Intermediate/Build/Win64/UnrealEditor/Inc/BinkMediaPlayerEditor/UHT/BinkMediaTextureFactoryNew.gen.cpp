...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBinkMediaTextureFactoryNew_Statics::NewProp_InitialMediaPlayer = { "InitialMediaPlayer", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBinkMediaTextureFactoryNew, InitialMediaPlayer), Z_Construct_UClass_UBinkMediaPlayer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBinkMediaTextureFactoryNew_Statics::NewProp_InitialMediaPlayer_MetaData), Z_Construct_UClass_UBinkMediaTextureFactoryNew_Statics::NewProp_InitialMediaPlayer_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BinkMedia_Source_BinkMediaPlayerEditor_Private_Factories_BinkMediaTextureFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBinkMediaTextureFactoryNew, UBinkMediaTextureFactoryNew::StaticClass, TEXT("UBinkMediaTextureFactoryNew"), &Z_Registration_Info_UClass_UBinkMediaTextureFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBinkMediaTextureFactoryNew), 2415698833U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BinkMedia_Source_BinkMediaPlayerEditor_Private_Factories_BinkMediaTextureFactoryNew_h_1993923523(TEXT("/Script/BinkMediaPlayerEditor"),
