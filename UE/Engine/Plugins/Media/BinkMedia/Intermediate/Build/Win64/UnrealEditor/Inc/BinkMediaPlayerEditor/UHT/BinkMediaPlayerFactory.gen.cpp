...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UBinkMediaPlayerFactory);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBinkMediaPlayerFactory_Statics::Class_MetaDataParams[] = {
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BinkMedia_Source_BinkMediaPlayerEditor_Private_Factories_BinkMediaPlayerFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BinkMedia_Source_BinkMediaPlayerEditor_Private_Factories_BinkMediaPlayerFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBinkMediaPlayerFactory, UBinkMediaPlayerFactory::StaticClass, TEXT("UBinkMediaPlayerFactory"), &Z_Registration_Info_UClass_UBinkMediaPlayerFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBinkMediaPlayerFactory), 1912378170U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BinkMedia_Source_BinkMediaPlayerEditor_Private_Factories_BinkMediaPlayerFactory_h_345845128(TEXT("/Script/BinkMediaPlayerEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BinkMedia_Source_BinkMediaPlayerEditor_Private_Factories_BinkMediaPlayerFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Media_BinkMedia_Source_BinkMediaPlayerEditor_Private_Factories_BinkMediaPlayerFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
