...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMfFileMediaSourceFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMfFileMediaSourceFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMfFileMediaSourceFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UMfFileMediaSourceFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MfMedia_Source_MfMediaEditor_Private_MfFileMediaSourceFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMfFileMediaSourceFactory, UMfFileMediaSourceFactory::StaticClass, TEXT("UMfFileMediaSourceFactory"), &Z_Registration_Info_UClass_UMfFileMediaSourceFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMfFileMediaSourceFactory), 1548680408U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MfMedia_Source_MfMediaEditor_Private_MfFileMediaSourceFactory_h_2686341896(TEXT("/Script/MfMediaEditor"),
