...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingStreamerVideoInputBackBuffer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPixelStreamingStreamerVideoInputBackBuffer_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingStreamerVideoInputBackBuffer_Statics::Class_MetaDataParams), Z_Construct_UClass_UPixelStreamingStreamerVideoInputBackBuffer_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_PixelStreaming_Source_PixelStreamingBlueprint_Public_PixelStreamingStreamerVideoInputBackBuffer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPixelStreamingStreamerVideoInputBackBuffer, UPixelStreamingStreamerVideoInputBackBuffer::StaticClass, TEXT("UPixelStreamingStreamerVideoInputBackBuffer"), &Z_Registration_Info_UClass_UPixelStreamingStreamerVideoInputBackBuffer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPixelStreamingStreamerVideoInputBackBuffer), 2928944826U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_PixelStreaming_Source_PixelStreamingBlueprint_Public_PixelStreamingStreamerVideoInputBackBuffer_h_4181714866(TEXT("/Script/PixelStreamingBlueprint"),
