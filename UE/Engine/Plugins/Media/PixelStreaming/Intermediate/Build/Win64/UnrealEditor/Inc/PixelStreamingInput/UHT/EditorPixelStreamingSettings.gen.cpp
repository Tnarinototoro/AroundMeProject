...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_DefaultCursorClassName = { "DefaultCursorClassName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPixelStreamingSettings, DefaultCursorClassName), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_DefaultCursorClassName_MetaData), Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_DefaultCursorClassName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_TextEditBeamCursorClassName = { "TextEditBeamCursorClassName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPixelStreamingSettings, TextEditBeamCursorClassName), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_TextEditBeamCursorClassName_MetaData), Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_TextEditBeamCursorClassName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_HiddenCursorClassName = { "HiddenCursorClassName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPixelStreamingSettings, HiddenCursorClassName), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_HiddenCursorClassName_MetaData), Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_HiddenCursorClassName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_bMouseAlwaysAttached = { "bMouseAlwaysAttached", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPixelStreamingSettings), &Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_bMouseAlwaysAttached_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_bMouseAlwaysAttached_MetaData), Z_Construct_UClass_UPixelStreamingSettings_Statics::NewProp_bMouseAlwaysAttached_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPixelStreamingSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPixelStreamingSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_PixelStreaming_Source_PixelStreamingInput_Public_EditorPixelStreamingSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPixelStreamingSettings, UPixelStreamingSettings::StaticClass, TEXT("UPixelStreamingSettings"), &Z_Registration_Info_UClass_UPixelStreamingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPixelStreamingSettings), 317648647U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_PixelStreaming_Source_PixelStreamingInput_Public_EditorPixelStreamingSettings_h_2030670909(TEXT("/Script/PixelStreamingInput"),
