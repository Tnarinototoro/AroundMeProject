...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::NewProp_bDisplayInToolbar = { "bDisplayInToolbar", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTimecodeSynchronizerProjectSettings), &Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::NewProp_bDisplayInToolbar_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::NewProp_bDisplayInToolbar_MetaData), Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::NewProp_bDisplayInToolbar_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::NewProp_DefaultTimecodeSynchronizer = { "DefaultTimecodeSynchronizer", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTimecodeSynchronizerProjectSettings, DefaultTimecodeSynchronizer), Z_Construct_UClass_UTimecodeSynchronizer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::NewProp_DefaultTimecodeSynchronizer_MetaData), Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::NewProp_DefaultTimecodeSynchronizer_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerProjectSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::NewProp_UserTimecodeSynchronizer = { "UserTimecodeSynchronizer", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTimecodeSynchronizerEditorSettings, UserTimecodeSynchronizer), Z_Construct_UClass_UTimecodeSynchronizer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::NewProp_UserTimecodeSynchronizer_MetaData), Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::NewProp_UserTimecodeSynchronizer_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTimecodeSynchronizerEditorSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_TimecodeSynchronizer_Source_TimecodeSynchronizer_Public_TimecodeSynchronizerProjectSettings_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UTimecodeSynchronizerEditorSettings, UTimecodeSynchronizerEditorSettings::StaticClass, TEXT("UTimecodeSynchronizerEditorSettings"), &Z_Registration_Info_UClass_UTimecodeSynchronizerEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTimecodeSynchronizerEditorSettings), 2256165291U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_TimecodeSynchronizer_Source_TimecodeSynchronizer_Public_TimecodeSynchronizerProjectSettings_h_553626500(TEXT("/Script/TimecodeSynchronizer"),
