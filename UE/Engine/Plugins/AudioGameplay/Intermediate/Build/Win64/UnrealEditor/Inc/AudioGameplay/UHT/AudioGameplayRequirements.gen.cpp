...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioRequirementPreset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAudioRequirementPreset_Statics::NewProp_Query = { "Query", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAudioRequirementPreset, Query), Z_Construct_UScriptStruct_FGameplayTagQuery, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioRequirementPreset_Statics::NewProp_Query_MetaData), Z_Construct_UClass_UAudioRequirementPreset_Statics::NewProp_Query_MetaData) }; // 1191468383
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAudioRequirementPreset_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioRequirementPreset_Statics::Class_MetaDataParams), Z_Construct_UClass_UAudioRequirementPreset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioRequirementPreset_Statics::PropPointers) < 2048);
...
template<> AUDIOGAMEPLAY_API UScriptStruct* StaticStruct<FAudioGameplayRequirements>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::NewProp_Preset = { "Preset", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAudioGameplayRequirements, Preset), Z_Construct_UClass_UAudioRequirementPreset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::NewProp_Preset_MetaData), Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::NewProp_Preset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::NewProp_Custom = { "Custom", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAudioGameplayRequirements, Custom), Z_Construct_UScriptStruct_FGameplayTagQuery, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::NewProp_Custom_MetaData), Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::NewProp_Custom_MetaData) }; // 1191468383
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioGameplayRequirements_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplay_Source_AudioGameplay_Public_AudioGameplayRequirements_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioRequirementPreset, UAudioRequirementPreset::StaticClass, TEXT("UAudioRequirementPreset"), &Z_Registration_Info_UClass_UAudioRequirementPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioRequirementPreset), 3058493275U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplay_Source_AudioGameplay_Public_AudioGameplayRequirements_h_3181231025(TEXT("/Script/AudioGameplay"),
