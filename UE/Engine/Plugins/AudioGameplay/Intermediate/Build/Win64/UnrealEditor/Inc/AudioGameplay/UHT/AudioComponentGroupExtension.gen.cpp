...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioComponentGroupExtension_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAudioComponentGroupExtension_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioComponentGroupExtension_Statics::Class_MetaDataParams), Z_Construct_UClass_UAudioComponentGroupExtension_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplay_Source_AudioGameplay_Public_AudioComponentGroupExtension_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioComponentGroupExtension, UAudioComponentGroupExtension::StaticClass, TEXT("UAudioComponentGroupExtension"), &Z_Registration_Info_UClass_UAudioComponentGroupExtension, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioComponentGroupExtension), 2012082733U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplay_Source_AudioGameplay_Public_AudioComponentGroupExtension_h_2556751347(TEXT("/Script/AudioGameplay"),
