...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioGameplayComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAudioGameplayComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioGameplayComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UAudioGameplayComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplay_Source_AudioGameplay_Public_AudioGameplayComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioGameplayComponent, UAudioGameplayComponent::StaticClass, TEXT("UAudioGameplayComponent"), &Z_Registration_Info_UClass_UAudioGameplayComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioGameplayComponent), 4012307183U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_AudioGameplay_Source_AudioGameplay_Public_AudioGameplayComponent_h_2390889324(TEXT("/Script/AudioGameplay"),
