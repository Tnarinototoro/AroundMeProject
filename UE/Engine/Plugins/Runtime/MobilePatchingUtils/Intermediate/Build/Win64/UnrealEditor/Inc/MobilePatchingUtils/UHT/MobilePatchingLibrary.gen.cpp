...
void FOnContentInstallFailed_DelegateWrapper(const FScriptDelegate& OnContentInstallFailed, const FText& ErrorText, int32 ErrorCode)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMobileInstalledContent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMobileInstalledContent_GetDiskFreeSpace, "GetDiskFreeSpace" }, // 4230276490
		{ &Z_Construct_UFunction_UMobileInstalledContent_GetInstalledContentSize, "GetInstalledContentSize" }, // 1075239767
		{ &Z_Construct_UFunction_UMobileInstalledContent_Mount, "Mount" }, // 1372750439
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMobileInstalledContent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMobilePendingContent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMobilePendingContent_GetDownloadSize, "GetDownloadSize" }, // 2458524033
		{ &Z_Construct_UFunction_UMobilePendingContent_GetDownloadSpeed, "GetDownloadSpeed" }, // 2961599969
		{ &Z_Construct_UFunction_UMobilePendingContent_GetDownloadStatusText, "GetDownloadStatusText" }, // 660611877
		{ &Z_Construct_UFunction_UMobilePendingContent_GetInstallProgress, "GetInstallProgress" }, // 1462179787
		{ &Z_Construct_UFunction_UMobilePendingContent_GetRequiredDiskSpace, "GetRequiredDiskSpace" }, // 811149874
		{ &Z_Construct_UFunction_UMobilePendingContent_GetTotalDownloadedSize, "GetTotalDownloadedSize" }, // 2827331090
		{ &Z_Construct_UFunction_UMobilePendingContent_StartInstall, "StartInstall" }, // 1499232401
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMobilePendingContent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
void FOnRequestContentFailed_DelegateWrapper(const FScriptDelegate& OnRequestContentFailed, const FText& ErrorText, int32 ErrorCode)
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMobilePatchingLibrary_GetInstalledContent_Statics::NewProp_InstallDirectory = { "InstallDirectory", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MobilePatchingLibrary_eventGetInstalledContent_Parms, InstallDirectory), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMobilePatchingLibrary_GetInstalledContent_Statics::NewProp_InstallDirectory_MetaData), Z_Construct_UFunction_UMobilePatchingLibrary_GetInstalledContent_Statics::NewProp_InstallDirectory_MetaData) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent_Statics::NewProp_RemoteManifestURL = { "RemoteManifestURL", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MobilePatchingLibrary_eventRequestContent_Parms, RemoteManifestURL), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent_Statics::NewProp_RemoteManifestURL_MetaData), Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent_Statics::NewProp_RemoteManifestURL_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent_Statics::NewProp_CloudURL = { "CloudURL", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MobilePatchingLibrary_eventRequestContent_Parms, CloudURL), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent_Statics::NewProp_CloudURL_MetaData), Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent_Statics::NewProp_CloudURL_MetaData) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMobilePatchingLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_GetActiveDeviceProfileName, "GetActiveDeviceProfileName" }, // 2851233683
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_GetInstalledContent, "GetInstalledContent" }, // 2280639173
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_GetSupportedPlatformNames, "GetSupportedPlatformNames" }, // 3335110591
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_HasActiveWiFiConnection, "HasActiveWiFiConnection" }, // 3017326307
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent, "RequestContent" }, // 1614423316
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMobilePatchingLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MobilePatchingUtils_Source_MobilePatchingUtils_Private_MobilePatchingLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMobileInstalledContent, UMobileInstalledContent::StaticClass, TEXT("UMobileInstalledContent"), &Z_Registration_Info_UClass_UMobileInstalledContent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMobileInstalledContent), 3808845526U) },
		{ Z_Construct_UClass_UMobilePendingContent, UMobilePendingContent::StaticClass, TEXT("UMobilePendingContent"), &Z_Registration_Info_UClass_UMobilePendingContent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMobilePendingContent), 407546286U) },
		{ Z_Construct_UClass_UMobilePatchingLibrary, UMobilePatchingLibrary::StaticClass, TEXT("UMobilePatchingLibrary"), &Z_Registration_Info_UClass_UMobilePatchingLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMobilePatchingLibrary), 1856733296U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MobilePatchingUtils_Source_MobilePatchingUtils_Private_MobilePatchingLibrary_h_2661831434(TEXT("/Script/MobilePatchingUtils"),
