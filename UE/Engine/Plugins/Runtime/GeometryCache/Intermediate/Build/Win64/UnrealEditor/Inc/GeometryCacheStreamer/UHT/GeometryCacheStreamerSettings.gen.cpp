...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGeometryCacheStreamerSettings_Statics::NewProp_LookAheadBuffer = { "LookAheadBuffer", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGeometryCacheStreamerSettings, LookAheadBuffer), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheStreamerSettings_Statics::NewProp_LookAheadBuffer_MetaData), Z_Construct_UClass_UGeometryCacheStreamerSettings_Statics::NewProp_LookAheadBuffer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGeometryCacheStreamerSettings_Statics::NewProp_MaxMemoryAllowed = { "MaxMemoryAllowed", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGeometryCacheStreamerSettings, MaxMemoryAllowed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheStreamerSettings_Statics::NewProp_MaxMemoryAllowed_MetaData), Z_Construct_UClass_UGeometryCacheStreamerSettings_Statics::NewProp_MaxMemoryAllowed_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCacheStreamer_Public_GeometryCacheStreamerSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheStreamerSettings, UGeometryCacheStreamerSettings::StaticClass, TEXT("UGeometryCacheStreamerSettings"), &Z_Registration_Info_UClass_UGeometryCacheStreamerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheStreamerSettings), 3976870105U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCacheStreamer_Public_GeometryCacheStreamerSettings_h_3638746168(TEXT("/Script/GeometryCacheStreamer"),
