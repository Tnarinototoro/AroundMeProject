...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGeometryCacheCodecBase_Statics::NewProp_TopologyRanges = { "TopologyRanges", nullptr, (EPropertyFlags)0x0020080000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGeometryCacheCodecBase, TopologyRanges), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheCodecBase_Statics::NewProp_TopologyRanges_MetaData), Z_Construct_UClass_UGeometryCacheCodecBase_Statics::NewProp_TopologyRanges_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheCodecBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheCodecBase, UGeometryCacheCodecBase::StaticClass, TEXT("UGeometryCacheCodecBase"), &Z_Registration_Info_UClass_UGeometryCacheCodecBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheCodecBase), 3704833692U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheCodecBase_h_4030867952(TEXT("/Script/GeometryCache"),
