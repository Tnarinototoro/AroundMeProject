...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UAudioSynesthesiaSettingsFactory_Statics::NewProp_AudioSynesthesiaSettingsClass = { "AudioSynesthesiaSettingsClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAudioSynesthesiaSettingsFactory, AudioSynesthesiaSettingsClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UAudioSynesthesiaSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioSynesthesiaSettingsFactory_Statics::NewProp_AudioSynesthesiaSettingsClass_MetaData), Z_Construct_UClass_UAudioSynesthesiaSettingsFactory_Statics::NewProp_AudioSynesthesiaSettingsClass_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesiaEditor_Classes_AudioSynesthesiaSettingsFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioSynesthesiaSettingsFactory, UAudioSynesthesiaSettingsFactory::StaticClass, TEXT("UAudioSynesthesiaSettingsFactory"), &Z_Registration_Info_UClass_UAudioSynesthesiaSettingsFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioSynesthesiaSettingsFactory), 3632041636U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesiaEditor_Classes_AudioSynesthesiaSettingsFactory_h_735070548(TEXT("/Script/AudioSynesthesiaEditor"),
