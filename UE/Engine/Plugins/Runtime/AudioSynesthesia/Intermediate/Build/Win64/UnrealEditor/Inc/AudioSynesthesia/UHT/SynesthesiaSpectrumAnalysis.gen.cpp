...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings_Statics::NewProp_AnalysisPeriod = { "AnalysisPeriod", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynesthesiaSpectrumAnalysisSettings, AnalysisPeriod), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings_Statics::NewProp_AnalysisPeriod_MetaData), Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings_Statics::NewProp_AnalysisPeriod_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings_Statics::NewProp_WindowType = { "WindowType", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynesthesiaSpectrumAnalysisSettings, WindowType), Z_Construct_UEnum_Engine_EFFTWindowType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings_Statics::NewProp_WindowType_MetaData), Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings_Statics::NewProp_WindowType_MetaData) }; // 2743791172
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSynesthesiaSpectrumResults_Statics::NewProp_TimeSeconds = { "TimeSeconds", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSynesthesiaSpectrumResults, TimeSeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynesthesiaSpectrumResults_Statics::NewProp_TimeSeconds_MetaData), Z_Construct_UScriptStruct_FSynesthesiaSpectrumResults_Statics::NewProp_TimeSeconds_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_AudioSynesthesia_OnLatestSpectrumResults__DelegateSignature_Statics::NewProp_LatestSpectrumResults = { "LatestSpectrumResults", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_AudioSynesthesia_eventOnLatestSpectrumResults_Parms, LatestSpectrumResults), Z_Construct_UScriptStruct_FSynesthesiaSpectrumResults, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioSynesthesia_OnLatestSpectrumResults__DelegateSignature_Statics::NewProp_LatestSpectrumResults_MetaData), Z_Construct_UDelegateFunction_AudioSynesthesia_OnLatestSpectrumResults__DelegateSignature_Statics::NewProp_LatestSpectrumResults_MetaData) }; // 1126557331
...
void FOnLatestSpectrumResults_DelegateWrapper(const FMulticastScriptDelegate& OnLatestSpectrumResults, int32 ChannelIndex, FSynesthesiaSpectrumResults const& LatestSpectrumResults)
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetCenterFrequencies_Statics::NewProp_InSampleRate = { "InSampleRate", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynesthesiaSpectrumAnalyzer_eventGetCenterFrequencies_Parms, InSampleRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetCenterFrequencies_Statics::NewProp_InSampleRate_MetaData), Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetCenterFrequencies_Statics::NewProp_InSampleRate_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetCenterFrequencies_Statics::NewProp_OutCenterFrequencies = { "OutCenterFrequencies", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynesthesiaSpectrumAnalyzer_eventGetCenterFrequencies_Parms, OutCenterFrequencies), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetCenterFrequencies_Statics::NewProp_OutCenterFrequencies_MetaData), Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetCenterFrequencies_Statics::NewProp_OutCenterFrequencies_MetaData) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetNumCenterFrequencies_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000582, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynesthesiaSpectrumAnalyzer_eventGetNumCenterFrequencies_Parms, ReturnValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetNumCenterFrequencies_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetNumCenterFrequencies_Statics::NewProp_ReturnValue_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USynesthesiaSpectrumAnalyzer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetCenterFrequencies, "GetCenterFrequencies" }, // 3594501772
		{ &Z_Construct_UFunction_USynesthesiaSpectrumAnalyzer_GetNumCenterFrequencies, "GetNumCenterFrequencies" }, // 1609659478
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USynesthesiaSpectrumAnalyzer_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USynesthesiaSpectrumAnalyzer_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynesthesiaSpectrumAnalyzer, Settings), Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynesthesiaSpectrumAnalyzer_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_USynesthesiaSpectrumAnalyzer_Statics::NewProp_Settings_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_SynesthesiaSpectrumAnalysis_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USynesthesiaSpectrumAnalysisSettings, USynesthesiaSpectrumAnalysisSettings::StaticClass, TEXT("USynesthesiaSpectrumAnalysisSettings"), &Z_Registration_Info_UClass_USynesthesiaSpectrumAnalysisSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynesthesiaSpectrumAnalysisSettings), 4162700536U) },
		{ Z_Construct_UClass_USynesthesiaSpectrumAnalyzer, USynesthesiaSpectrumAnalyzer::StaticClass, TEXT("USynesthesiaSpectrumAnalyzer"), &Z_Registration_Info_UClass_USynesthesiaSpectrumAnalyzer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynesthesiaSpectrumAnalyzer), 1689174480U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_SynesthesiaSpectrumAnalysis_h_739403646(TEXT("/Script/AudioSynesthesia"),
