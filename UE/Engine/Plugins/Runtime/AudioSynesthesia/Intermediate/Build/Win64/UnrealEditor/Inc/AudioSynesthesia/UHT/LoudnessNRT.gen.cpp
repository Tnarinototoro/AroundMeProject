...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_AnalysisPeriod = { "AnalysisPeriod", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULoudnessNRTSettings, AnalysisPeriod), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_AnalysisPeriod_MetaData), Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_AnalysisPeriod_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_MinimumFrequency = { "MinimumFrequency", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULoudnessNRTSettings, MinimumFrequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_MinimumFrequency_MetaData), Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_MinimumFrequency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_MaximumFrequency = { "MaximumFrequency", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULoudnessNRTSettings, MaximumFrequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_MaximumFrequency_MetaData), Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_MaximumFrequency_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_NoiseFloorDb = { "NoiseFloorDb", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULoudnessNRTSettings, NoiseFloorDb), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_NoiseFloorDb_MetaData), Z_Construct_UClass_ULoudnessNRTSettings_Statics::NewProp_NoiseFloorDb_MetaData) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ULoudnessNRT_GetNormalizedChannelLoudnessAtTime_Statics::NewProp_InChannel = { "InChannel", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LoudnessNRT_eventGetNormalizedChannelLoudnessAtTime_Parms, InChannel), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULoudnessNRT_GetNormalizedChannelLoudnessAtTime_Statics::NewProp_InChannel_MetaData), Z_Construct_UFunction_ULoudnessNRT_GetNormalizedChannelLoudnessAtTime_Statics::NewProp_InChannel_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ULoudnessNRT_GetNormalizedLoudnessAtTime_Statics::NewProp_InSeconds = { "InSeconds", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LoudnessNRT_eventGetNormalizedLoudnessAtTime_Parms, InSeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULoudnessNRT_GetNormalizedLoudnessAtTime_Statics::NewProp_InSeconds_MetaData), Z_Construct_UFunction_ULoudnessNRT_GetNormalizedLoudnessAtTime_Statics::NewProp_InSeconds_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULoudnessNRT_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULoudnessNRT_GetChannelLoudnessAtTime, "GetChannelLoudnessAtTime" }, // 793153392
		{ &Z_Construct_UFunction_ULoudnessNRT_GetLoudnessAtTime, "GetLoudnessAtTime" }, // 124063360
		{ &Z_Construct_UFunction_ULoudnessNRT_GetNormalizedChannelLoudnessAtTime, "GetNormalizedChannelLoudnessAtTime" }, // 1786160736
		{ &Z_Construct_UFunction_ULoudnessNRT_GetNormalizedLoudnessAtTime, "GetNormalizedLoudnessAtTime" }, // 617577711
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULoudnessNRT_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULoudnessNRT_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULoudnessNRT, Settings), Z_Construct_UClass_ULoudnessNRTSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULoudnessNRT_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_ULoudnessNRT_Statics::NewProp_Settings_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_LoudnessNRT_h_Statics::EnumInfo[] = {
		{ ELoudnessNRTCurveTypeEnum_StaticEnum, TEXT("ELoudnessNRTCurveTypeEnum"), &Z_Registration_Info_UEnum_ELoudnessNRTCurveTypeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4065860474U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_LoudnessNRT_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULoudnessNRTSettings, ULoudnessNRTSettings::StaticClass, TEXT("ULoudnessNRTSettings"), &Z_Registration_Info_UClass_ULoudnessNRTSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULoudnessNRTSettings), 3263772271U) },
		{ Z_Construct_UClass_ULoudnessNRT, ULoudnessNRT::StaticClass, TEXT("ULoudnessNRT"), &Z_Registration_Info_UClass_ULoudnessNRT, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULoudnessNRT), 1657773506U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_LoudnessNRT_h_4282867553(TEXT("/Script/AudioSynesthesia"),
