...
template<> GEOREFERENCING_API UScriptStruct* StaticStruct<FEllipsoid>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FEllipsoid_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEllipsoid_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FEllipsoid_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeoReferencing_Source_GeoReferencing_Public_Ellipsoid_h_Statics::ScriptStructInfo[] = {
		{ FEllipsoid::StaticStruct, Z_Construct_UScriptStruct_FEllipsoid_Statics::NewStructOps, TEXT("Ellipsoid"), &Z_Registration_Info_UScriptStruct_Ellipsoid, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEllipsoid), 2040377696U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeoReferencing_Source_GeoReferencing_Public_Ellipsoid_h_3202174785(TEXT("/Script/GeoReferencing"),
		nullptr, 0,
