...
template<> MASSENTITY_API UScriptStruct* StaticStruct<FMassEntityQuery>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassEntityQuery_h_Statics::ScriptStructInfo[] = {
		{ FMassEntityQuery::StaticStruct, Z_Construct_UScriptStruct_FMassEntityQuery_Statics::NewStructOps, TEXT("MassEntityQuery"), &Z_Registration_Info_UScriptStruct_MassEntityQuery, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassEntityQuery), 3187592891U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassEntityQuery_h_4192978220(TEXT("/Script/MassEntity"),
		nullptr, 0,
