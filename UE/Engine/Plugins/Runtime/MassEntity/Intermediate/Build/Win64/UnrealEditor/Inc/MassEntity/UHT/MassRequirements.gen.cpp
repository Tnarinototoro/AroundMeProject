...
template<> MASSENTITY_API UScriptStruct* StaticStruct<FMassFragmentRequirements>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassRequirements_h_Statics::EnumInfo[] = {
		{ EMassFragmentAccess_StaticEnum, TEXT("EMassFragmentAccess"), &Z_Registration_Info_UEnum_EMassFragmentAccess, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3708812383U) },
		{ EMassFragmentPresence_StaticEnum, TEXT("EMassFragmentPresence"), &Z_Registration_Info_UEnum_EMassFragmentPresence, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1168230334U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassRequirements_h_Statics::ScriptStructInfo[] = {
		{ FMassSubsystemRequirements::StaticStruct, Z_Construct_UScriptStruct_FMassSubsystemRequirements_Statics::NewStructOps, TEXT("MassSubsystemRequirements"), &Z_Registration_Info_UScriptStruct_MassSubsystemRequirements, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassSubsystemRequirements), 3482958972U) },
		{ FMassFragmentRequirements::StaticStruct, Z_Construct_UScriptStruct_FMassFragmentRequirements_Statics::NewStructOps, TEXT("MassFragmentRequirements"), &Z_Registration_Info_UScriptStruct_MassFragmentRequirements, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassFragmentRequirements), 165952267U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassRequirements_h_1629865691(TEXT("/Script/MassEntity"),
		nullptr, 0,
