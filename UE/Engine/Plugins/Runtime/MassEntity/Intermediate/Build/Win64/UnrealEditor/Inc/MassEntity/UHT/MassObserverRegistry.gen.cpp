...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMassProcessorClassCollection_Statics::NewProp_ClassCollection = { "ClassCollection", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassProcessorClassCollection, ClassCollection), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassProcessorClassCollection_Statics::NewProp_ClassCollection_MetaData), Z_Construct_UScriptStruct_FMassProcessorClassCollection_Statics::NewProp_ClassCollection_MetaData) };
...
template<> MASSENTITY_API UScriptStruct* StaticStruct<FMassEntityObserverClassesMap>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMassEntityObserverClassesMap_Statics::NewProp_Container_ValueProp = { "Container", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FMassProcessorClassCollection, METADATA_PARAMS(0, nullptr) }; // 2048302303
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassObserverRegistry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassObserverRegistry, UMassObserverRegistry::StaticClass, TEXT("UMassObserverRegistry"), &Z_Registration_Info_UClass_UMassObserverRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassObserverRegistry), 685540765U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassObserverRegistry_h_3135439955(TEXT("/Script/MassEntity"),
