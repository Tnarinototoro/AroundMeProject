...
template<> MASSENTITY_API UScriptStruct* StaticStruct<FMassEntityHandle>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMassEntityHandle_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000022001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassEntityHandle, Index), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityHandle_Statics::NewProp_Index_MetaData), Z_Construct_UScriptStruct_FMassEntityHandle_Statics::NewProp_Index_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMassEntityHandle_Statics::NewProp_SerialNumber = { "SerialNumber", nullptr, (EPropertyFlags)0x0010000000022001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassEntityHandle, SerialNumber), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityHandle_Statics::NewProp_SerialNumber_MetaData), Z_Construct_UScriptStruct_FMassEntityHandle_Statics::NewProp_SerialNumber_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassEntityTypes_h_Statics::EnumInfo[] = {
		{ EMassObservedOperation_StaticEnum, TEXT("EMassObservedOperation"), &Z_Registration_Info_UEnum_EMassObservedOperation, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2077982672U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassEntityTypes_h_Statics::ScriptStructInfo[] = {
		{ FMassFragment::StaticStruct, Z_Construct_UScriptStruct_FMassFragment_Statics::NewStructOps, TEXT("MassFragment"), &Z_Registration_Info_UScriptStruct_MassFragment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassFragment), 2415039288U) },
		{ FMassTag::StaticStruct, Z_Construct_UScriptStruct_FMassTag_Statics::NewStructOps, TEXT("MassTag"), &Z_Registration_Info_UScriptStruct_MassTag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassTag), 955922758U) },
		{ FMassChunkFragment::StaticStruct, Z_Construct_UScriptStruct_FMassChunkFragment_Statics::NewStructOps, TEXT("MassChunkFragment"), &Z_Registration_Info_UScriptStruct_MassChunkFragment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassChunkFragment), 2978232259U) },
		{ FMassSharedFragment::StaticStruct, Z_Construct_UScriptStruct_FMassSharedFragment_Statics::NewStructOps, TEXT("MassSharedFragment"), &Z_Registration_Info_UScriptStruct_MassSharedFragment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassSharedFragment), 1312640502U) },
		{ FMassEntityHandle::StaticStruct, Z_Construct_UScriptStruct_FMassEntityHandle_Statics::NewStructOps, TEXT("MassEntityHandle"), &Z_Registration_Info_UScriptStruct_MassEntityHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassEntityHandle), 966791987U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassEntityTypes_h_2367378806(TEXT("/Script/MassEntity"),
		nullptr, 0,
