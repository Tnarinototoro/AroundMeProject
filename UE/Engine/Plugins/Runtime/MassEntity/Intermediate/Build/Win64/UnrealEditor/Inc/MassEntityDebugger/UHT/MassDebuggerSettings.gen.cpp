...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebuggerSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMassDebuggerSettings_Statics::NewProp_bStripMassPrefix = { "bStripMassPrefix", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMassDebuggerSettings), &Z_Construct_UClass_UMassDebuggerSettings_Statics::NewProp_bStripMassPrefix_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebuggerSettings_Statics::NewProp_bStripMassPrefix_MetaData), Z_Construct_UClass_UMassDebuggerSettings_Statics::NewProp_bStripMassPrefix_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassDebuggerSettings_Statics::ClassParams = {
		...
		0,
		0x001020A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebuggerSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassDebuggerSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebuggerSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntityDebugger_Public_MassDebuggerSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassDebuggerSettings, UMassDebuggerSettings::StaticClass, TEXT("UMassDebuggerSettings"), &Z_Registration_Info_UClass_UMassDebuggerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassDebuggerSettings), 2189107794U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntityDebugger_Public_MassDebuggerSettings_h_1648642995(TEXT("/Script/MassEntityDebugger"),
