...
template<> MASSENTITY_API UScriptStruct* StaticStruct<FMassProcessingPhaseConfig>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_PhaseName = { "PhaseName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassProcessingPhaseConfig, PhaseName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_PhaseName_MetaData), Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_PhaseName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_ProcessorCDOs = { "ProcessorCDOs", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassProcessingPhaseConfig, ProcessorCDOs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_ProcessorCDOs_MetaData), Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_ProcessorCDOs_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_PhaseProcessor = { "PhaseProcessor", nullptr, (EPropertyFlags)0x0014000800002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassProcessingPhaseConfig, PhaseProcessor), Z_Construct_UClass_UMassCompositeProcessor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_PhaseProcessor_MetaData), Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_PhaseProcessor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010000800022001, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassProcessingPhaseConfig, Description), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_Description_MetaData), Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewProp_Description_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassProcessingPhaseManager_h_Statics::ScriptStructInfo[] = {
		{ FMassProcessingPhaseConfig::StaticStruct, Z_Construct_UScriptStruct_FMassProcessingPhaseConfig_Statics::NewStructOps, TEXT("MassProcessingPhaseConfig"), &Z_Registration_Info_UScriptStruct_MassProcessingPhaseConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassProcessingPhaseConfig), 2137212602U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassProcessingPhaseManager_h_479305977(TEXT("/Script/MassEntity"),
		nullptr, 0,
