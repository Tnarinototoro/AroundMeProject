...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bAutoRegisterWithObserverRegistry_MetaData[];
#endif
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMassObserverProcessor_Statics::NewProp_bAutoRegisterWithObserverRegistry_MetaData[] = {
		{ "Category", "Processor" },
		{ "ModuleRelativePath", "Public/MassObserverProcessor.h" },
	};
#endif
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMassObserverProcessor_Statics::NewProp_ObservedType = { "ObservedType", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassObserverProcessor, ObservedType), Z_Construct_UClass_UScriptStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassObserverProcessor_Statics::NewProp_ObservedType_MetaData), Z_Construct_UClass_UMassObserverProcessor_Statics::NewProp_ObservedType_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassObserverProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassObserverProcessor, UMassObserverProcessor::StaticClass, TEXT("UMassObserverProcessor"), &Z_Registration_Info_UClass_UMassObserverProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassObserverProcessor), 1194802990U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassObserverProcessor_h_423234705(TEXT("/Script/MassEntity"),
