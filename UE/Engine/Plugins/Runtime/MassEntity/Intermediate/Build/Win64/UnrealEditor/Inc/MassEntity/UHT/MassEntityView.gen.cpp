...
template<> MASSENTITY_API UScriptStruct* StaticStruct<FMassEntityView>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassEntityView_h_Statics::ScriptStructInfo[] = {
		{ FMassEntityView::StaticStruct, Z_Construct_UScriptStruct_FMassEntityView_Statics::NewStructOps, TEXT("MassEntityView"), &Z_Registration_Info_UScriptStruct_MassEntityView, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassEntityView), 2191576901U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassEntity_Source_MassEntity_Public_MassEntityView_h_4121351930(TEXT("/Script/MassEntity"),
		nullptr, 0,
