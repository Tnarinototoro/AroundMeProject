...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesIOSSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_ULocationServicesIOSSettings_Statics::NewProp_LocationAlwaysUsageDescription = { "LocationAlwaysUsageDescription", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULocationServicesIOSSettings, LocationAlwaysUsageDescription), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesIOSSettings_Statics::NewProp_LocationAlwaysUsageDescription_MetaData), Z_Construct_UClass_ULocationServicesIOSSettings_Statics::NewProp_LocationAlwaysUsageDescription_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_ULocationServicesIOSSettings_Statics::NewProp_LocationWhenInUseDescription = { "LocationWhenInUseDescription", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULocationServicesIOSSettings, LocationWhenInUseDescription), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesIOSSettings_Statics::NewProp_LocationWhenInUseDescription_MetaData), Z_Construct_UClass_ULocationServicesIOSSettings_Statics::NewProp_LocationWhenInUseDescription_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULocationServicesIOSSettings_Statics::ClassParams = {
		...
		0,
		0x000000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesIOSSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULocationServicesIOSSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesIOSSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesIOSImpl_Source_LocationServicesIOSEditor_Classes_LocationServicesIOSSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULocationServicesIOSSettings, ULocationServicesIOSSettings::StaticClass, TEXT("ULocationServicesIOSSettings"), &Z_Registration_Info_UClass_ULocationServicesIOSSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULocationServicesIOSSettings), 16640954U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesIOSImpl_Source_LocationServicesIOSEditor_Classes_LocationServicesIOSSettings_h_1064966908(TEXT("/Script/LocationServicesIOSEditor"),
