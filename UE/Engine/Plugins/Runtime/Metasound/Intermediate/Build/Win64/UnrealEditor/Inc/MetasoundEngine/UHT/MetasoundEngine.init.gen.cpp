...
void EmptyLinkFunctionForGeneratedCodeMetasoundEngine_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MetasoundEngine()
	{
		if (!Z_Registration_Info_UPackage__Script_MetasoundEngine.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UMetasoundGeneratorHandle_OnOutputValueChangedMulticast__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_MetasoundEngine(Z_Construct_UPackage__Script_MetasoundEngine, TEXT("/Script/MetasoundEngine"), Z_Registration_Info_UPackage__Script_MetasoundEngine, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x4D49EB22, 0x887736E2));
