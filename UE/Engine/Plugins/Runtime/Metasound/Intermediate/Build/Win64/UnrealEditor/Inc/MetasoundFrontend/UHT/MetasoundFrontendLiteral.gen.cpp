...
template<> METASOUNDFRONTEND_API UScriptStruct* StaticStruct<FMetasoundFrontendLiteral>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMetasoundFrontendLiteral, Type), Z_Construct_UEnum_MetasoundFrontend_EMetasoundFrontendLiteralType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_Type_MetaData), Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_Type_MetaData) }; // 2069137461
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsNumDefault = { "AsNumDefault", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMetasoundFrontendLiteral, AsNumDefault), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsNumDefault_MetaData), Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsNumDefault_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsBoolean = { "AsBoolean", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMetasoundFrontendLiteral, AsBoolean), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsBoolean_MetaData), Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsBoolean_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsInteger = { "AsInteger", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMetasoundFrontendLiteral, AsInteger), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsInteger_MetaData), Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsInteger_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsFloat = { "AsFloat", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMetasoundFrontendLiteral, AsFloat), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsFloat_MetaData), Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsFloat_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsString = { "AsString", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMetasoundFrontendLiteral, AsString), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsString_MetaData), Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsString_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsUObject = { "AsUObject", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMetasoundFrontendLiteral, AsUObject), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsUObject_MetaData), Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewProp_AsUObject_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundFrontend_Public_MetasoundFrontendLiteral_h_Statics::EnumInfo[] = {
		{ EMetasoundFrontendLiteralType_StaticEnum, TEXT("EMetasoundFrontendLiteralType"), &Z_Registration_Info_UEnum_EMetasoundFrontendLiteralType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2069137461U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundFrontend_Public_MetasoundFrontendLiteral_h_Statics::ScriptStructInfo[] = {
		{ FMetasoundFrontendLiteral::StaticStruct, Z_Construct_UScriptStruct_FMetasoundFrontendLiteral_Statics::NewStructOps, TEXT("MetasoundFrontendLiteral"), &Z_Registration_Info_UScriptStruct_MetasoundFrontendLiteral, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMetasoundFrontendLiteral), 214376013U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundFrontend_Public_MetasoundFrontendLiteral_h_2056091608(TEXT("/Script/MetasoundFrontend"),
		nullptr, 0,
