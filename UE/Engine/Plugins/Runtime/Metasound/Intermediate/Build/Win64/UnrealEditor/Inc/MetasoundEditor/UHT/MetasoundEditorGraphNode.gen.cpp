...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMetasoundEditorGraphOutputNode_Statics::NewProp_Output = { "Output", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetasoundEditorGraphOutputNode, Output), Z_Construct_UClass_UMetasoundEditorGraphOutput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetasoundEditorGraphOutputNode_Statics::NewProp_Output_MetaData), Z_Construct_UClass_UMetasoundEditorGraphOutputNode_Statics::NewProp_Output_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMetasoundEditorGraphExternalNode_Statics::NewProp_ClassName = { "ClassName", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetasoundEditorGraphExternalNode, ClassName), Z_Construct_UScriptStruct_FMetasoundFrontendClassName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetasoundEditorGraphExternalNode_Statics::NewProp_ClassName_MetaData), Z_Construct_UClass_UMetasoundEditorGraphExternalNode_Statics::NewProp_ClassName_MetaData) }; // 3516130125
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMetasoundEditorGraphVariableNode_Statics::NewProp_Variable = { "Variable", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetasoundEditorGraphVariableNode, Variable), Z_Construct_UClass_UMetasoundEditorGraphVariable_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetasoundEditorGraphVariableNode_Statics::NewProp_Variable_MetaData), Z_Construct_UClass_UMetasoundEditorGraphVariableNode_Statics::NewProp_Variable_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundEditor_Public_MetasoundEditorGraphNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMetasoundEditorGraphNode, UMetasoundEditorGraphNode::StaticClass, TEXT("UMetasoundEditorGraphNode"), &Z_Registration_Info_UClass_UMetasoundEditorGraphNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetasoundEditorGraphNode), 3137273972U) },
		{ Z_Construct_UClass_UMetasoundEditorGraphMemberNode, UMetasoundEditorGraphMemberNode::StaticClass, TEXT("UMetasoundEditorGraphMemberNode"), &Z_Registration_Info_UClass_UMetasoundEditorGraphMemberNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetasoundEditorGraphMemberNode), 3345723867U) },
		{ Z_Construct_UClass_UMetasoundEditorGraphOutputNode, UMetasoundEditorGraphOutputNode::StaticClass, TEXT("UMetasoundEditorGraphOutputNode"), &Z_Registration_Info_UClass_UMetasoundEditorGraphOutputNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetasoundEditorGraphOutputNode), 261079421U) },
		{ Z_Construct_UClass_UMetasoundEditorGraphExternalNode, UMetasoundEditorGraphExternalNode::StaticClass, TEXT("UMetasoundEditorGraphExternalNode"), &Z_Registration_Info_UClass_UMetasoundEditorGraphExternalNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetasoundEditorGraphExternalNode), 1605366060U) },
		{ Z_Construct_UClass_UMetasoundEditorGraphVariableNode, UMetasoundEditorGraphVariableNode::StaticClass, TEXT("UMetasoundEditorGraphVariableNode"), &Z_Registration_Info_UClass_UMetasoundEditorGraphVariableNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetasoundEditorGraphVariableNode), 1448464074U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundEditor_Public_MetasoundEditorGraphNode_h_3391689165(TEXT("/Script/MetasoundEditor"),
