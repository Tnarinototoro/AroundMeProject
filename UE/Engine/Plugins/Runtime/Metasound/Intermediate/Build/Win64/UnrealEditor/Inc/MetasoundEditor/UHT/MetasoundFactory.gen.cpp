...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMetaSoundBaseFactory_Statics::NewProp_ReferencedMetaSoundObject = { "ReferencedMetaSoundObject", nullptr, (EPropertyFlags)0x0014000000002001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetaSoundBaseFactory, ReferencedMetaSoundObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetaSoundBaseFactory_Statics::NewProp_ReferencedMetaSoundObject_MetaData), Z_Construct_UClass_UMetaSoundBaseFactory_Statics::NewProp_ReferencedMetaSoundObject_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundEditor_Public_MetasoundFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMetaSoundBaseFactory, UMetaSoundBaseFactory::StaticClass, TEXT("UMetaSoundBaseFactory"), &Z_Registration_Info_UClass_UMetaSoundBaseFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetaSoundBaseFactory), 821290004U) },
		{ Z_Construct_UClass_UMetaSoundFactory, UMetaSoundFactory::StaticClass, TEXT("UMetaSoundFactory"), &Z_Registration_Info_UClass_UMetaSoundFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetaSoundFactory), 996139472U) },
		{ Z_Construct_UClass_UMetaSoundSourceFactory, UMetaSoundSourceFactory::StaticClass, TEXT("UMetaSoundSourceFactory"), &Z_Registration_Info_UClass_UMetaSoundSourceFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetaSoundSourceFactory), 531699361U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundEditor_Public_MetasoundFactory_h_3214019409(TEXT("/Script/MetasoundEditor"),
