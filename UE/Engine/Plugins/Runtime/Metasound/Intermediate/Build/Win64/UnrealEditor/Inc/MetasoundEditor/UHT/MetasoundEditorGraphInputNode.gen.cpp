...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMetasoundEditorGraphInputNode_Statics::NewProp_Input = { "Input", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetasoundEditorGraphInputNode, Input), Z_Construct_UClass_UMetasoundEditorGraphInput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetasoundEditorGraphInputNode_Statics::NewProp_Input_MetaData), Z_Construct_UClass_UMetasoundEditorGraphInputNode_Statics::NewProp_Input_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundEditor_Public_MetasoundEditorGraphInputNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMetasoundEditorGraphInputNode, UMetasoundEditorGraphInputNode::StaticClass, TEXT("UMetasoundEditorGraphInputNode"), &Z_Registration_Info_UClass_UMetasoundEditorGraphInputNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetasoundEditorGraphInputNode), 746565904U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Metasound_Source_MetasoundEditor_Public_MetasoundEditorGraphInputNode_h_2604138902(TEXT("/Script/MetasoundEditor"),
