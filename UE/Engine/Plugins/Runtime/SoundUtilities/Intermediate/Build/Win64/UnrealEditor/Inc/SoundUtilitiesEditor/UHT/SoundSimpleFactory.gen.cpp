...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundSimpleFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundSimpleFactory_Statics::NewProp_SoundWaves = { "SoundWaves", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundSimpleFactory, SoundWaves), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundSimpleFactory_Statics::NewProp_SoundWaves_MetaData), Z_Construct_UClass_USoundSimpleFactory_Statics::NewProp_SoundWaves_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundSimpleFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundSimpleFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundSimpleFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundSimpleFactory_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundUtilities_Source_SoundUtilitiesEditor_Private_SoundSimpleFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundSimpleFactory, USoundSimpleFactory::StaticClass, TEXT("USoundSimpleFactory"), &Z_Registration_Info_UClass_USoundSimpleFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundSimpleFactory), 2081217226U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundUtilities_Source_SoundUtilitiesEditor_Private_SoundSimpleFactory_h_3606716279(TEXT("/Script/SoundUtilitiesEditor"),
