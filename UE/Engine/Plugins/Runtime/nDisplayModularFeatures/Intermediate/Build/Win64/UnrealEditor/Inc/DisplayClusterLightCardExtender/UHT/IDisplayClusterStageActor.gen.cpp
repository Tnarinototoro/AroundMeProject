...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDisplayClusterStageActor_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageActor_Statics::Class_MetaDataParams), Z_Construct_UClass_UDisplayClusterStageActor_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplayModularFeatures_Source_DisplayClusterLightCardExtender_Public_StageActor_IDisplayClusterStageActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDisplayClusterStageActor, UDisplayClusterStageActor::StaticClass, TEXT("UDisplayClusterStageActor"), &Z_Registration_Info_UClass_UDisplayClusterStageActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDisplayClusterStageActor), 83437430U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplayModularFeatures_Source_DisplayClusterLightCardExtender_Public_StageActor_IDisplayClusterStageActor_h_635379015(TEXT("/Script/DisplayClusterLightCardExtender"),
