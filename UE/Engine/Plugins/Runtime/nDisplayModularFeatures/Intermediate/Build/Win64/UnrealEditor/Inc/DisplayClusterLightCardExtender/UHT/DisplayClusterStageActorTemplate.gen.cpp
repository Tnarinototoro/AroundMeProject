...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::NewProp_bIsFavorite = { "bIsFavorite", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDisplayClusterStageActorTemplate), &Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::NewProp_bIsFavorite_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::NewProp_bIsFavorite_MetaData), Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::NewProp_bIsFavorite_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::ClassParams = {
		...
		0,
		0x001004A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::Class_MetaDataParams), Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageActorTemplate_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplayModularFeatures_Source_DisplayClusterLightCardExtender_Public_StageActor_DisplayClusterStageActorTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDisplayClusterStageActorTemplate, UDisplayClusterStageActorTemplate::StaticClass, TEXT("UDisplayClusterStageActorTemplate"), &Z_Registration_Info_UClass_UDisplayClusterStageActorTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDisplayClusterStageActorTemplate), 2353216278U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplayModularFeatures_Source_DisplayClusterLightCardExtender_Public_StageActor_DisplayClusterStageActorTemplate_h_4025589157(TEXT("/Script/DisplayClusterLightCardExtender"),
