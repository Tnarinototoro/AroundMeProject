...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UResonanceAudioSoundfieldSettings_Statics::NewProp_RenderMode = { "RenderMode", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UResonanceAudioSoundfieldSettings, RenderMode), Z_Construct_UEnum_ResonanceAudio_EResonanceRenderMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioSoundfieldSettings_Statics::NewProp_RenderMode_MetaData), Z_Construct_UClass_UResonanceAudioSoundfieldSettings_Statics::NewProp_RenderMode_MetaData) }; // 1780408352
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioAmbisonicsSettings_h_Statics::EnumInfo[] = {
		{ EResonanceRenderMode_StaticEnum, TEXT("EResonanceRenderMode"), &Z_Registration_Info_UEnum_EResonanceRenderMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1780408352U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioAmbisonicsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UResonanceAudioSoundfieldSettings, UResonanceAudioSoundfieldSettings::StaticClass, TEXT("UResonanceAudioSoundfieldSettings"), &Z_Registration_Info_UClass_UResonanceAudioSoundfieldSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UResonanceAudioSoundfieldSettings), 1260670970U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioAmbisonicsSettings_h_2165884399(TEXT("/Script/ResonanceAudio"),
