...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UResonanceAudioBlueprintFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UResonanceAudioBlueprintFunctionLibrary_GetGlobalReverbPreset, "GetGlobalReverbPreset" }, // 788701916
		{ &Z_Construct_UFunction_UResonanceAudioBlueprintFunctionLibrary_SetGlobalReverbPreset, "SetGlobalReverbPreset" }, // 3995013734
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioBlueprintFunctionLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioBlueprintFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UResonanceAudioBlueprintFunctionLibrary, UResonanceAudioBlueprintFunctionLibrary::StaticClass, TEXT("UResonanceAudioBlueprintFunctionLibrary"), &Z_Registration_Info_UClass_UResonanceAudioBlueprintFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UResonanceAudioBlueprintFunctionLibrary), 6960956U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioBlueprintFunctionLibrary_h_2023499879(TEXT("/Script/ResonanceAudio"),
