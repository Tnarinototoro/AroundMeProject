...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioReverbPluginPresetFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UResonanceAudioReverbPluginPresetFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioReverbPluginPresetFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UResonanceAudioReverbPluginPresetFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudioEditor_Private_ResonanceAudioReverbPluginPresetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UResonanceAudioReverbPluginPresetFactory, UResonanceAudioReverbPluginPresetFactory::StaticClass, TEXT("UResonanceAudioReverbPluginPresetFactory"), &Z_Registration_Info_UClass_UResonanceAudioReverbPluginPresetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UResonanceAudioReverbPluginPresetFactory), 1875869222U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudioEditor_Private_ResonanceAudioReverbPluginPresetFactory_h_1651666916(TEXT("/Script/ResonanceAudioEditor"),
