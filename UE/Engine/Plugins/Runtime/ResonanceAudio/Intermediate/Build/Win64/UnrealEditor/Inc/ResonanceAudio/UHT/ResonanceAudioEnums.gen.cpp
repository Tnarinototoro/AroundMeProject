...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioEnums_h_Statics::EnumInfo[] = {
		{ ERaQualityMode_StaticEnum, TEXT("ERaQualityMode"), &Z_Registration_Info_UEnum_ERaQualityMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4174676955U) },
		{ ERaSpatializationMethod_StaticEnum, TEXT("ERaSpatializationMethod"), &Z_Registration_Info_UEnum_ERaSpatializationMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1578031818U) },
		{ ERaDistanceRolloffModel_StaticEnum, TEXT("ERaDistanceRolloffModel"), &Z_Registration_Info_UEnum_ERaDistanceRolloffModel, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 507453006U) },
		{ ERaMaterialName_StaticEnum, TEXT("ERaMaterialName"), &Z_Registration_Info_UEnum_ERaMaterialName, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3613565081U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioEnums_h_2813080122(TEXT("/Script/ResonanceAudio"),
		nullptr, 0,
		nullptr, 0,
