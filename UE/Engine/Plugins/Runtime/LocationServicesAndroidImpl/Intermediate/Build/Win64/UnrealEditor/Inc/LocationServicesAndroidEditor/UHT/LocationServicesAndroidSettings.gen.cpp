...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bCoarseLocationEnabled = { "bCoarseLocationEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULocationServicesAndroidSettings), &Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bCoarseLocationEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bCoarseLocationEnabled_MetaData), Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bCoarseLocationEnabled_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bFineLocationEnabled = { "bFineLocationEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULocationServicesAndroidSettings), &Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bFineLocationEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bFineLocationEnabled_MetaData), Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bFineLocationEnabled_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bLocationUpdatesEnabled = { "bLocationUpdatesEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULocationServicesAndroidSettings), &Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bLocationUpdatesEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bLocationUpdatesEnabled_MetaData), Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::NewProp_bLocationUpdatesEnabled_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::ClassParams = {
		...
		0,
		0x000000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServicesAndroidSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesAndroidImpl_Source_LocationServicesAndroidEditor_Classes_LocationServicesAndroidSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULocationServicesAndroidSettings, ULocationServicesAndroidSettings::StaticClass, TEXT("ULocationServicesAndroidSettings"), &Z_Registration_Info_UClass_ULocationServicesAndroidSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULocationServicesAndroidSettings), 903032894U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesAndroidImpl_Source_LocationServicesAndroidEditor_Classes_LocationServicesAndroidSettings_h_314496199(TEXT("/Script/LocationServicesAndroidEditor"),
