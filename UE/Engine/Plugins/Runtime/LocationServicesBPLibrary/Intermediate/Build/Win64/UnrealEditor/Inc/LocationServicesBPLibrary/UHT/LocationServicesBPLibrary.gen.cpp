...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Latitude = { "Latitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLocationServicesData, Latitude), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Latitude_MetaData), Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Latitude_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Altitude = { "Altitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLocationServicesData, Altitude), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Altitude_MetaData), Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Altitude_MetaData) };
...
void FLocationServicesData_OnLocationChanged_DelegateWrapper(const FMulticastScriptDelegate& LocationServicesData_OnLocationChanged, FLocationServicesData LocationData)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULocationServices_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULocationServices_AreLocationServicesEnabled, "AreLocationServicesEnabled" }, // 3722191360
		{ &Z_Construct_UFunction_ULocationServices_GetLastKnownLocation, "GetLastKnownLocation" }, // 774169636
		{ &Z_Construct_UFunction_ULocationServices_GetLocationServicesImpl, "GetLocationServicesImpl" }, // 3564278463
		{ &Z_Construct_UFunction_ULocationServices_InitLocationServices, "InitLocationServices" }, // 502057495
		{ &Z_Construct_UFunction_ULocationServices_IsLocationAccuracyAvailable, "IsLocationAccuracyAvailable" }, // 52603698
		{ &Z_Construct_UFunction_ULocationServices_StartLocationServices, "StartLocationServices" }, // 4045605919
		{ &Z_Construct_UFunction_ULocationServices_StopLocationServices, "StopLocationServices" }, // 3195208742
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULocationServices_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesBPLibrary_Source_LocationServicesBPLibrary_Classes_LocationServicesBPLibrary_h_Statics::EnumInfo[] = {
		{ ELocationAccuracy_StaticEnum, TEXT("ELocationAccuracy"), &Z_Registration_Info_UEnum_ELocationAccuracy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2480423924U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesBPLibrary_Source_LocationServicesBPLibrary_Classes_LocationServicesBPLibrary_h_Statics::ScriptStructInfo[] = {
		{ FLocationServicesData::StaticStruct, Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewStructOps, TEXT("LocationServicesData"), &Z_Registration_Info_UScriptStruct_LocationServicesData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLocationServicesData), 3264505318U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesBPLibrary_Source_LocationServicesBPLibrary_Classes_LocationServicesBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULocationServices, ULocationServices::StaticClass, TEXT("ULocationServices"), &Z_Registration_Info_UClass_ULocationServices, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULocationServices), 4150312230U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesBPLibrary_Source_LocationServicesBPLibrary_Classes_LocationServicesBPLibrary_h_2734048424(TEXT("/Script/LocationServicesBPLibrary"),
