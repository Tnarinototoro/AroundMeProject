...
template<> GAMEPLAYINTERACTIONSMODULE_API UScriptStruct* StaticStruct<FGameplayInteractionContext>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_StateTreeInstanceData = { "StateTreeInstanceData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayInteractionContext, StateTreeInstanceData), Z_Construct_UScriptStruct_FStateTreeInstanceData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_StateTreeInstanceData_MetaData), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_StateTreeInstanceData_MetaData) }; // 2107645396
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_ClaimedHandle = { "ClaimedHandle", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayInteractionContext, ClaimedHandle), Z_Construct_UScriptStruct_FSmartObjectClaimHandle, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_ClaimedHandle_MetaData), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_ClaimedHandle_MetaData) }; // 2747113422
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SlotEntranceHandle_MetaData[] = {
		{ "ModuleRelativePath", "Public/GameplayInteractionContext.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SlotEntranceHandle = { "SlotEntranceHandle", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayInteractionContext, SlotEntranceHandle), Z_Construct_UScriptStruct_FSmartObjectSlotEntranceHandle, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SlotEntranceHandle_MetaData), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SlotEntranceHandle_MetaData) }; // 449887908
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_AbortContext = { "AbortContext", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayInteractionContext, AbortContext), Z_Construct_UScriptStruct_FGameplayInteractionAbortContext, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_AbortContext_MetaData), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_AbortContext_MetaData) }; // 3272225570
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_ContextActor = { "ContextActor", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayInteractionContext, ContextActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_ContextActor_MetaData), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_ContextActor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SmartObjectActor = { "SmartObjectActor", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayInteractionContext, SmartObjectActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SmartObjectActor_MetaData), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SmartObjectActor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_Definition = { "Definition", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayInteractionContext, Definition), Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_Definition_MetaData), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_Definition_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewProp_SlotEntranceHandle,
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayInteractions_Source_GameplayInteractionsModule_Public_GameplayInteractionContext_h_Statics::ScriptStructInfo[] = {
		{ FGameplayInteractionContext::StaticStruct, Z_Construct_UScriptStruct_FGameplayInteractionContext_Statics::NewStructOps, TEXT("GameplayInteractionContext"), &Z_Registration_Info_UScriptStruct_GameplayInteractionContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayInteractionContext), 1720620792U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayInteractions_Source_GameplayInteractionsModule_Public_GameplayInteractionContext_h_2744159120(TEXT("/Script/GameplayInteractionsModule"),
		nullptr, 0,
