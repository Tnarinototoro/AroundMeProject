...
template<> GAMEPLAYINTERACTIONSMODULE_API UScriptStruct* StaticStruct<FPlayMontageStateTreeTaskInstanceData>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_Actor = { "Actor", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPlayMontageStateTreeTaskInstanceData, Actor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_Actor_MetaData), Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_Actor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_ComputedDuration = { "ComputedDuration", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPlayMontageStateTreeTaskInstanceData, ComputedDuration), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_ComputedDuration_MetaData), Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_ComputedDuration_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPlayMontageStateTreeTaskInstanceData, Time), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_Time_MetaData), Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::NewProp_Time_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTaskInstanceData_Statics::PropPointers) < 2048);
...
template<> GAMEPLAYINTERACTIONSMODULE_API UScriptStruct* StaticStruct<FPlayMontageStateTreeTask>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::NewProp_Montage = { "Montage", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPlayMontageStateTreeTask, Montage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::NewProp_Montage_MetaData), Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::NewProp_Montage_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayInteractions_Source_GameplayInteractionsModule_Private_StateTree_PlayMontageStateTreeTask_h_Statics::ScriptStructInfo[] = {
		...
		{ FPlayMontageStateTreeTask::StaticStruct, Z_Construct_UScriptStruct_FPlayMontageStateTreeTask_Statics::NewStructOps, TEXT("PlayMontageStateTreeTask"), &Z_Registration_Info_UScriptStruct_PlayMontageStateTreeTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayMontageStateTreeTask), 862301260U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayInteractions_Source_GameplayInteractionsModule_Private_StateTree_PlayMontageStateTreeTask_h_1677859583(TEXT("/Script/GameplayInteractionsModule"),
		nullptr, 0,
