...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::NewProp_StateTreeReference = { "StateTreeReference", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameplayInteractionSmartObjectBehaviorDefinition, StateTreeReference), Z_Construct_UScriptStruct_FStateTreeReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::NewProp_StateTreeReference_MetaData), Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::NewProp_StateTreeReference_MetaData) }; // 2056096566
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayInteractionSmartObjectBehaviorDefinition_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayInteractions_Source_GameplayInteractionsModule_Public_GameplayInteractionSmartObjectBehaviorDefinition_h_2144018054(TEXT("/Script/GameplayInteractionsModule"),
