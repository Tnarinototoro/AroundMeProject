...
template<> MODELVIEWVIEWMODEL_API UScriptStruct* StaticStruct<FMVVMViewModelContextInstance>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMViewModelContextInstance, Context), Z_Construct_UScriptStruct_FMVVMViewModelContext, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::NewProp_Context_MetaData), Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::NewProp_Context_MetaData) }; // 3526783708
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::NewProp_Instance = { "Instance", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMViewModelContextInstance, Instance), Z_Construct_UClass_UMVVMViewModelBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::NewProp_Instance_MetaData), Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::NewProp_Instance_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMViewModelContextInstance_h_Statics::ScriptStructInfo[] = {
		{ FMVVMViewModelContextInstance::StaticStruct, Z_Construct_UScriptStruct_FMVVMViewModelContextInstance_Statics::NewStructOps, TEXT("MVVMViewModelContextInstance"), &Z_Registration_Info_UScriptStruct_MVVMViewModelContextInstance, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMVVMViewModelContextInstance), 2580651032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMViewModelContextInstance_h_48725828(TEXT("/Script/ModelViewViewModel"),
		nullptr, 0,
