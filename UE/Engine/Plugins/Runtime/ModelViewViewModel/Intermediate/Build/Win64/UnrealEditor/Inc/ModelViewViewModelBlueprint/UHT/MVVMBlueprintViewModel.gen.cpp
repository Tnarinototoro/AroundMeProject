...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMVVMBlueprintViewModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMVVMBlueprintViewModel_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMVVMBlueprintViewModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UMVVMBlueprintViewModel_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModelBlueprint_Public_MVVMBlueprintViewModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMVVMBlueprintViewModel, UMVVMBlueprintViewModel::StaticClass, TEXT("UMVVMBlueprintViewModel"), &Z_Registration_Info_UClass_UMVVMBlueprintViewModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMVVMBlueprintViewModel), 927241429U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModelBlueprint_Public_MVVMBlueprintViewModel_h_1720155327(TEXT("/Script/ModelViewViewModelBlueprint"),
