...
template<> MODELVIEWVIEWMODELBLUEPRINT_API UScriptStruct* StaticStruct<FMVVMBlueprintFieldPath>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewProp_BindingReference = { "BindingReference", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBlueprintFieldPath, BindingReference), Z_Construct_UScriptStruct_FMemberReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewProp_BindingReference_MetaData), Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewProp_BindingReference_MetaData) }; // 544905968
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewProp_BindingKind_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewProp_BindingKind = { "BindingKind", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBlueprintFieldPath, BindingKind), Z_Construct_UEnum_UMG_EBindingKind, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewProp_BindingKind_MetaData), Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewProp_BindingKind_MetaData) }; // 1268172989
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::PropPointers) < 2048);
...
template<> MODELVIEWVIEWMODELBLUEPRINT_API UScriptStruct* StaticStruct<FMVVMBlueprintPropertyPath>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_Paths_Inner = { "Paths", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath, METADATA_PARAMS(0, nullptr) }; // 2505393548
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_Paths = { "Paths", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBlueprintPropertyPath, Paths), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_Paths_MetaData), Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_Paths_MetaData) }; // 2505393548
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_WidgetName = { "WidgetName", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBlueprintPropertyPath, WidgetName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_WidgetName_MetaData), Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_WidgetName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_ContextId = { "ContextId", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBlueprintPropertyPath, ContextId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_ContextId_MetaData), Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_ContextId_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_BindingReference = { "BindingReference", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBlueprintPropertyPath, BindingReference_DEPRECATED), Z_Construct_UScriptStruct_FMemberReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_BindingReference_MetaData), Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_BindingReference_MetaData) }; // 544905968
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_BindingKind = { "BindingKind", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBlueprintPropertyPath, BindingKind_DEPRECATED), Z_Construct_UEnum_UMG_EBindingKind, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_BindingKind_MetaData), Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewProp_BindingKind_MetaData) }; // 1268172989
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModelBlueprint_Public_MVVMPropertyPath_h_Statics::ScriptStructInfo[] = {
		{ FMVVMBlueprintFieldPath::StaticStruct, Z_Construct_UScriptStruct_FMVVMBlueprintFieldPath_Statics::NewStructOps, TEXT("MVVMBlueprintFieldPath"), &Z_Registration_Info_UScriptStruct_MVVMBlueprintFieldPath, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMVVMBlueprintFieldPath), 2505393548U) },
		{ FMVVMBlueprintPropertyPath::StaticStruct, Z_Construct_UScriptStruct_FMVVMBlueprintPropertyPath_Statics::NewStructOps, TEXT("MVVMBlueprintPropertyPath"), &Z_Registration_Info_UScriptStruct_MVVMBlueprintPropertyPath, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMVVMBlueprintPropertyPath), 2041684757U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModelBlueprint_Public_MVVMPropertyPath_h_1420128564(TEXT("/Script/ModelViewViewModelBlueprint"),
		nullptr, 0,
