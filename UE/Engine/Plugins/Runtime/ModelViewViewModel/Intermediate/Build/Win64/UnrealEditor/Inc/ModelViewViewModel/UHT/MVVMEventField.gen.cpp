...
template<> MODELVIEWVIEWMODEL_API UScriptStruct* StaticStruct<FMVVMEventField>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMVVMEventField_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMEventField_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMVVMEventField_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMEventField_h_Statics::ScriptStructInfo[] = {
		{ FMVVMEventField::StaticStruct, Z_Construct_UScriptStruct_FMVVMEventField_Statics::NewStructOps, TEXT("MVVMEventField"), &Z_Registration_Info_UScriptStruct_MVVMEventField, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMVVMEventField), 222892281U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMEventField_h_209252180(TEXT("/Script/ModelViewViewModel"),
		nullptr, 0,
