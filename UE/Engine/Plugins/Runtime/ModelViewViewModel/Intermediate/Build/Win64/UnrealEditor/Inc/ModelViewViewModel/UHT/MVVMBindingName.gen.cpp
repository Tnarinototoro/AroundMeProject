...
template<> MODELVIEWVIEWMODEL_API UScriptStruct* StaticStruct<FMVVMBindingName>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMVVMBindingName_Statics::NewProp_BindingName = { "BindingName", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMBindingName, BindingName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBindingName_Statics::NewProp_BindingName_MetaData), Z_Construct_UScriptStruct_FMVVMBindingName_Statics::NewProp_BindingName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMVVMBindingName_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBindingName_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMVVMBindingName_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMBindingName_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMBindingName_h_Statics::ScriptStructInfo[] = {
		{ FMVVMBindingName::StaticStruct, Z_Construct_UScriptStruct_FMVVMBindingName_Statics::NewStructOps, TEXT("MVVMBindingName"), &Z_Registration_Info_UScriptStruct_MVVMBindingName, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMVVMBindingName), 2257288326U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMBindingName_h_1396095301(TEXT("/Script/ModelViewViewModel"),
		nullptr, 0,
