...
template<> MODELVIEWVIEWMODEL_API UScriptStruct* StaticStruct<FMVVMViewModelContext>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::NewProp_ContextClass = { "ContextClass", nullptr, (EPropertyFlags)0x0014000000010005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMViewModelContext, ContextClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UMVVMViewModelBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::NewProp_ContextClass_MetaData), Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::NewProp_ContextClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::NewProp_ContextName = { "ContextName", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMVVMViewModelContext, ContextName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::NewProp_ContextName_MetaData), Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::NewProp_ContextName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMViewModelContext_h_Statics::ScriptStructInfo[] = {
		{ FMVVMViewModelContext::StaticStruct, Z_Construct_UScriptStruct_FMVVMViewModelContext_Statics::NewStructOps, TEXT("MVVMViewModelContext"), &Z_Registration_Info_UScriptStruct_MVVMViewModelContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMVVMViewModelContext), 3526783708U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ModelViewViewModel_Source_ModelViewViewModel_Public_Types_MVVMViewModelContext_h_398352813(TEXT("/Script/ModelViewViewModel"),
		nullptr, 0,
