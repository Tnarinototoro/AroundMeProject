...
template<> STATETREEMODULE_API UScriptStruct* StaticStruct<FStateTreeEvaluatorCommonBase>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeEvaluatorBase_h_Statics::ScriptStructInfo[] = {
		{ FStateTreeEvaluatorBase::StaticStruct, Z_Construct_UScriptStruct_FStateTreeEvaluatorBase_Statics::NewStructOps, TEXT("StateTreeEvaluatorBase"), &Z_Registration_Info_UScriptStruct_StateTreeEvaluatorBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeEvaluatorBase), 4181496776U) },
		{ FStateTreeEvaluatorCommonBase::StaticStruct, Z_Construct_UScriptStruct_FStateTreeEvaluatorCommonBase_Statics::NewStructOps, TEXT("StateTreeEvaluatorCommonBase"), &Z_Registration_Info_UScriptStruct_StateTreeEvaluatorCommonBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeEvaluatorCommonBase), 1014724877U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeEvaluatorBase_h_1605690194(TEXT("/Script/StateTreeModule"),
		nullptr, 0,
