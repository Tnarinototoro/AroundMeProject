...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UStateTreeTestSchema_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UStateTreeTestSchema_Statics::ClassParams = {
		...
		0,
		0x040000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStateTreeTestSchema_Statics::Class_MetaDataParams), Z_Construct_UClass_UStateTreeTestSchema_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeTestSuite_Private_StateTreeTest_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStateTreeTestSchema, UStateTreeTestSchema::StaticClass, TEXT("UStateTreeTestSchema"), &Z_Registration_Info_UClass_UStateTreeTestSchema, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStateTreeTestSchema), 112146803U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeTestSuite_Private_StateTreeTest_h_2838148695(TEXT("/Script/StateTreeTestSuite"),
