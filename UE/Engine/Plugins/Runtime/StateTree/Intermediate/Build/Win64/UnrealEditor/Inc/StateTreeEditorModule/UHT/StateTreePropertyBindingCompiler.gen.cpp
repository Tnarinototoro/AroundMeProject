...
template<> STATETREEEDITORMODULE_API UScriptStruct* StaticStruct<FStateTreePropertyBindingCompiler>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeEditorModule_Public_StateTreePropertyBindingCompiler_h_Statics::ScriptStructInfo[] = {
		{ FStateTreePropertyBindingCompiler::StaticStruct, Z_Construct_UScriptStruct_FStateTreePropertyBindingCompiler_Statics::NewStructOps, TEXT("StateTreePropertyBindingCompiler"), &Z_Registration_Info_UScriptStruct_StateTreePropertyBindingCompiler, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreePropertyBindingCompiler), 2877523107U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeEditorModule_Public_StateTreePropertyBindingCompiler_h_458292668(TEXT("/Script/StateTreeEditorModule"),
		nullptr, 0,
