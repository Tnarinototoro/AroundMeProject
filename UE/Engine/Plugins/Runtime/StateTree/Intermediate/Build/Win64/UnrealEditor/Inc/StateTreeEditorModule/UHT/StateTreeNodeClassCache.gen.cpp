...
template<> STATETREEEDITORMODULE_API UScriptStruct* StaticStruct<FStateTreeNodeClassData>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeEditorModule_Public_StateTreeNodeClassCache_h_Statics::ScriptStructInfo[] = {
		{ FStateTreeNodeClassData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeNodeClassData_Statics::NewStructOps, TEXT("StateTreeNodeClassData"), &Z_Registration_Info_UScriptStruct_StateTreeNodeClassData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeNodeClassData), 902234268U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeEditorModule_Public_StateTreeNodeClassCache_h_3167956688(TEXT("/Script/StateTreeEditorModule"),
		nullptr, 0,
