...
template<> STATETREEMODULE_API UScriptStruct* StaticStruct<FStateTreeNodeBase>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeNodeBase, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_BindingsBatch = { "BindingsBatch", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeNodeBase, BindingsBatch), Z_Construct_UScriptStruct_FStateTreeIndex16, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_BindingsBatch_MetaData), Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_BindingsBatch_MetaData) }; // 1063223217
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_DataViewIndex = { "DataViewIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeNodeBase, DataViewIndex), Z_Construct_UScriptStruct_FStateTreeIndex16, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_DataViewIndex_MetaData), Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_DataViewIndex_MetaData) }; // 1063223217
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_InstanceIndex = { "InstanceIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeNodeBase, InstanceIndex), Z_Construct_UScriptStruct_FStateTreeIndex16, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_InstanceIndex_MetaData), Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_InstanceIndex_MetaData) }; // 1063223217
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_bInstanceIsObject = { "bInstanceIsObject", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FStateTreeNodeBase), &Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_bInstanceIsObject_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_bInstanceIsObject_MetaData), Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewProp_bInstanceIsObject_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeNodeBase_h_Statics::ScriptStructInfo[] = {
		{ FStateTreeNodeBase::StaticStruct, Z_Construct_UScriptStruct_FStateTreeNodeBase_Statics::NewStructOps, TEXT("StateTreeNodeBase"), &Z_Registration_Info_UScriptStruct_StateTreeNodeBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeNodeBase), 2948708518U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeNodeBase_h_4159292434(TEXT("/Script/StateTreeModule"),
		nullptr, 0,
