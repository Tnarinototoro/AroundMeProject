...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeEvent, Tag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Tag_MetaData), Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Tag_MetaData) }; // 2083603574
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Payload = { "Payload", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeEvent, Payload), Z_Construct_UScriptStruct_FInstancedStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Payload_MetaData), Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Payload_MetaData) }; // 2114042832
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Origin = { "Origin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeEvent, Origin), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Origin_MetaData), Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewProp_Origin_MetaData) };
...
template<> STATETREEMODULE_API UScriptStruct* StaticStruct<FStateTreeEventQueue>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStateTreeEventQueue_Statics::NewProp_Events_Inner = { "Events", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FStateTreeEvent, METADATA_PARAMS(0, nullptr) }; // 1478531048
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FStateTreeEventQueue_Statics::NewProp_Events = { "Events", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeEventQueue, Events), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeEventQueue_Statics::NewProp_Events_MetaData), Z_Construct_UScriptStruct_FStateTreeEventQueue_Statics::NewProp_Events_MetaData) }; // 1478531048
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeEvents_h_Statics::EnumInfo[] = {
		{ EStateTreeLoopEvents_StaticEnum, TEXT("EStateTreeLoopEvents"), &Z_Registration_Info_UEnum_EStateTreeLoopEvents, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4025818571U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeEvents_h_Statics::ScriptStructInfo[] = {
		{ FStateTreeEvent::StaticStruct, Z_Construct_UScriptStruct_FStateTreeEvent_Statics::NewStructOps, TEXT("StateTreeEvent"), &Z_Registration_Info_UScriptStruct_StateTreeEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeEvent), 1478531048U) },
		{ FStateTreeEventQueue::StaticStruct, Z_Construct_UScriptStruct_FStateTreeEventQueue_Statics::NewStructOps, TEXT("StateTreeEventQueue"), &Z_Registration_Info_UScriptStruct_StateTreeEventQueue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeEventQueue), 3340420240U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeEvents_h_192130156(TEXT("/Script/StateTreeModule"),
		nullptr, 0,
