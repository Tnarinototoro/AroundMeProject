...
template<> STATETREEMODULE_API UScriptStruct* StaticStruct<FStateTreeReference>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FStateTreeReference_Statics::NewProp_StateTree = { "StateTree", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FStateTreeReference, StateTree), Z_Construct_UClass_UStateTree_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateTreeReference_Statics::NewProp_StateTree_MetaData), Z_Construct_UScriptStruct_FStateTreeReference_Statics::NewProp_StateTree_MetaData) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeReference_h_Statics::ScriptStructInfo[] = {
		{ FStateTreeReference::StaticStruct, Z_Construct_UScriptStruct_FStateTreeReference_Statics::NewStructOps, TEXT("StateTreeReference"), &Z_Registration_Info_UScriptStruct_StateTreeReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeReference), 2056096566U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_StateTree_Source_StateTreeModule_Public_StateTreeReference_h_3388055661(TEXT("/Script/StateTreeModule"),
		nullptr, 0,
