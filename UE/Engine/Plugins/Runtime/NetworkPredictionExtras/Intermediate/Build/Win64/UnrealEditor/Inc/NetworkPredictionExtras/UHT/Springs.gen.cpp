...
template<> NETWORKPREDICTIONEXTRAS_API UScriptStruct* StaticStruct<FSpring>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpring_Statics::NewProp_LocalPosition = { "LocalPosition", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpring, LocalPosition), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::NewProp_LocalPosition_MetaData), Z_Construct_UScriptStruct_FSpring_Statics::NewProp_LocalPosition_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpring_Statics::NewProp_LocalDirection = { "LocalDirection", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpring, LocalDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::NewProp_LocalDirection_MetaData), Z_Construct_UScriptStruct_FSpring_Statics::NewProp_LocalDirection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSpring_Statics::NewProp_TraceChannel = { "TraceChannel", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpring, TraceChannel), Z_Construct_UEnum_Engine_ECollisionChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::NewProp_TraceChannel_MetaData), Z_Construct_UScriptStruct_FSpring_Statics::NewProp_TraceChannel_MetaData) }; // 1822723181
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSpring_Statics::NewProp_Stiffness = { "Stiffness", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpring, Stiffness), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::NewProp_Stiffness_MetaData), Z_Construct_UScriptStruct_FSpring_Statics::NewProp_Stiffness_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSpring_Statics::NewProp_DampingStrength = { "DampingStrength", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpring, DampingStrength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::NewProp_DampingStrength_MetaData), Z_Construct_UScriptStruct_FSpring_Statics::NewProp_DampingStrength_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSpring_Statics::NewProp_RaycastLength = { "RaycastLength", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpring, RaycastLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::NewProp_RaycastLength_MetaData), Z_Construct_UScriptStruct_FSpring_Statics::NewProp_RaycastLength_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSpring_Statics::NewProp_NaturalLength = { "NaturalLength", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpring, NaturalLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::NewProp_NaturalLength_MetaData), Z_Construct_UScriptStruct_FSpring_Statics::NewProp_NaturalLength_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSpring_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSpring_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpring_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_Springs_h_Statics::ScriptStructInfo[] = {
		{ FSpring::StaticStruct, Z_Construct_UScriptStruct_FSpring_Statics::NewStructOps, TEXT("Spring"), &Z_Registration_Info_UScriptStruct_Spring, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpring), 1449649680U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_Springs_h_176165053(TEXT("/Script/NetworkPredictionExtras"),
		nullptr, 0,
