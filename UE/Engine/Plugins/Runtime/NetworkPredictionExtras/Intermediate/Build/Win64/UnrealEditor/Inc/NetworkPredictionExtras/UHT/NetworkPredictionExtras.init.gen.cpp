...
void EmptyLinkFunctionForGeneratedCodeNetworkPredictionExtras_init() {}
	...
	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_NetworkPredictionExtras;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_NetworkPredictionExtras()
	{
		if (!Z_Registration_Info_UPackage__Script_NetworkPredictionExtras.OuterSingleton)
		{
			...
			UECodeGen_Private::ConstructUPackage(Z_Registration_Info_UPackage__Script_NetworkPredictionExtras.OuterSingleton, PackageParams);
		}
		return Z_Registration_Info_UPackage__Script_NetworkPredictionExtras.OuterSingleton;
	}
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_NetworkPredictionExtras(Z_Construct_UPackage__Script_NetworkPredictionExtras, TEXT("/Script/NetworkPredictionExtras"), Z_Registration_Info_UPackage__Script_NetworkPredictionExtras, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x68C1E75D, 0xC4E96EE8));
