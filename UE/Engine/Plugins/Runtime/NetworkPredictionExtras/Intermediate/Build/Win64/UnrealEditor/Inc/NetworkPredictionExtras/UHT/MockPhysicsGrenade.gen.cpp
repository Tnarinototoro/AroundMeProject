...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_UMockPhysicsGrenadeComponent_MockGrenadeOnExplode__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMockPhysicsGrenadeComponent, nullptr, "MockGrenadeOnExplode__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UMockPhysicsGrenadeComponent_MockGrenadeOnExplode__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_UMockPhysicsGrenadeComponent_MockGrenadeOnExplode__DelegateSignature_Statics::Function_MetaDataParams) };
...
void UMockPhysicsGrenadeComponent::FMockGrenadeOnExplode_DelegateWrapper(const FMulticastScriptDelegate& MockGrenadeOnExplode)
{
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::DependentSingletons) < 16);
#if WITH_EDITOR
	const FClassFunctionLinkInfo Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_UMockPhysicsGrenadeComponent_MockGrenadeOnExplode__DelegateSignature, "MockGrenadeOnExplode__DelegateSignature" }, // 156943551
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::FuncInfo) < 2048);
#endif //WITH_EDITOR
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_OnExplode = { "OnExplode", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMockPhysicsGrenadeComponent, OnExplode), Z_Construct_UDelegateFunction_UMockPhysicsGrenadeComponent_MockGrenadeOnExplode__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_OnExplode_MetaData), Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_OnExplode_MetaData) }; // 156943551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_FuseTimeSeconds = { "FuseTimeSeconds", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMockPhysicsGrenadeComponent, FuseTimeSeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_FuseTimeSeconds_MetaData), Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_FuseTimeSeconds_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMockPhysicsGrenadeComponent, Radius), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_Radius_MetaData), Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_Radius_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_Magnitude = { "Magnitude", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMockPhysicsGrenadeComponent, Magnitude), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_Magnitude_MetaData), Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::NewProp_Magnitude_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMockPhysicsGrenadeComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_MockPhysicsGrenade_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMockPhysicsGrenadeComponent, UMockPhysicsGrenadeComponent::StaticClass, TEXT("UMockPhysicsGrenadeComponent"), &Z_Registration_Info_UClass_UMockPhysicsGrenadeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMockPhysicsGrenadeComponent), 424541716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_MockPhysicsGrenade_h_4032223542(TEXT("/Script/NetworkPredictionExtras"),
