...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANetworkPredictionExtrasGameState_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ANetworkPredictionExtrasGameState_Statics::ClassParams = {
		...
		0,
		0x009002A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetworkPredictionExtrasGameState_Statics::Class_MetaDataParams), Z_Construct_UClass_ANetworkPredictionExtrasGameState_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_NetworkPredictionExtrasGameState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANetworkPredictionExtrasGameState, ANetworkPredictionExtrasGameState::StaticClass, TEXT("ANetworkPredictionExtrasGameState"), &Z_Registration_Info_UClass_ANetworkPredictionExtrasGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANetworkPredictionExtrasGameState), 3766975725U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_NetworkPredictionExtrasGameState_h_99869388(TEXT("/Script/NetworkPredictionExtras"),
