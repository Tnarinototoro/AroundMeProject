...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMockNetworkSimulationComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMockNetworkSimulationComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMockNetworkSimulationComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UMockNetworkSimulationComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_MockNetworkSimulation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMockNetworkSimulationComponent, UMockNetworkSimulationComponent::StaticClass, TEXT("UMockNetworkSimulationComponent"), &Z_Registration_Info_UClass_UMockNetworkSimulationComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMockNetworkSimulationComponent), 2027010245U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_MockNetworkSimulation_h_2061040121(TEXT("/Script/NetworkPredictionExtras"),
