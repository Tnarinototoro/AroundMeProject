...
template<> NETWORKPREDICTIONEXTRAS_API UScriptStruct* StaticStruct<FMockPhysicsInputCmd>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_MovementInput = { "MovementInput", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMockPhysicsInputCmd, MovementInput), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_MovementInput_MetaData), Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_MovementInput_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bJumpedPressed = { "bJumpedPressed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMockPhysicsInputCmd), &Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bJumpedPressed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bJumpedPressed_MetaData), Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bJumpedPressed_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bChargePressed = { "bChargePressed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMockPhysicsInputCmd), &Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bChargePressed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bChargePressed_MetaData), Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewProp_bChargePressed_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_MockPhysicsSimulation_h_Statics::ScriptStructInfo[] = {
		{ FMockPhysicsInputCmd::StaticStruct, Z_Construct_UScriptStruct_FMockPhysicsInputCmd_Statics::NewStructOps, TEXT("MockPhysicsInputCmd"), &Z_Registration_Info_UScriptStruct_MockPhysicsInputCmd, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMockPhysicsInputCmd), 2529831519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPredictionExtras_Source_NetworkPredictionExtras_Public_MockPhysicsSimulation_h_3353809026(TEXT("/Script/NetworkPredictionExtras"),
		nullptr, 0,
