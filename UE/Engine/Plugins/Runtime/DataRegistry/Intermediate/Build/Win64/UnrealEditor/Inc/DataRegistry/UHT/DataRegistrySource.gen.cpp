...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataRegistrySource_Statics::NewProp_ParentSource = { "ParentSource", nullptr, (EPropertyFlags)0x0024080000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistrySource, ParentSource), Z_Construct_UClass_UDataRegistrySource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySource_Statics::NewProp_ParentSource_MetaData), Z_Construct_UClass_UDataRegistrySource_Statics::NewProp_ParentSource_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataRegistrySource_Statics::ClassParams = {
		...
		0,
		0x00B030A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySource_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataRegistrySource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySource_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DataRegistry_EMetaDataRegistrySourceAssetUsage_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DataRegistry_EMetaDataRegistrySourceAssetUsage_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DataRegistry_EMetaDataRegistrySourceAssetUsage_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMetaDataRegistrySource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_AssetUsage_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_AssetUsage = { "AssetUsage", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetaDataRegistrySource, AssetUsage), Z_Construct_UEnum_DataRegistry_EMetaDataRegistrySourceAssetUsage, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_AssetUsage_MetaData), Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_AssetUsage_MetaData) }; // 1431063904
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_SearchRules = { "SearchRules", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetaDataRegistrySource, SearchRules), Z_Construct_UScriptStruct_FAssetManagerSearchRules, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_SearchRules_MetaData), Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_SearchRules_MetaData) }; // 4168486028
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_RuntimeChildren_ValueProp = { "RuntimeChildren", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UClass_UDataRegistrySource_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_RuntimeChildren_Key_KeyProp = { "RuntimeChildren_Key", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_RuntimeChildren = { "RuntimeChildren", nullptr, (EPropertyFlags)0x0024088000002008, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMetaDataRegistrySource, RuntimeChildren), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_RuntimeChildren_MetaData), Z_Construct_UClass_UMetaDataRegistrySource_Statics::NewProp_RuntimeChildren_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMetaDataRegistrySource_Statics::ClassParams = {
		...
		0,
		0x00B030A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMetaDataRegistrySource_Statics::Class_MetaDataParams), Z_Construct_UClass_UMetaDataRegistrySource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMetaDataRegistrySource_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistrySource_h_Statics::EnumInfo[] = {
		{ EMetaDataRegistrySourceAssetUsage_StaticEnum, TEXT("EMetaDataRegistrySourceAssetUsage"), &Z_Registration_Info_UEnum_EMetaDataRegistrySourceAssetUsage, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1431063904U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistrySource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataRegistrySource, UDataRegistrySource::StaticClass, TEXT("UDataRegistrySource"), &Z_Registration_Info_UClass_UDataRegistrySource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataRegistrySource), 1496146651U) },
		{ Z_Construct_UClass_UMetaDataRegistrySource, UMetaDataRegistrySource::StaticClass, TEXT("UMetaDataRegistrySource"), &Z_Registration_Info_UClass_UMetaDataRegistrySource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetaDataRegistrySource), 3828901411U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistrySource_h_3181460338(TEXT("/Script/DataRegistry"),
