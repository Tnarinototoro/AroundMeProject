...
template<> DATAREGISTRYEDITOR_API UScriptStruct* StaticStruct<FDataRegistryIdEditWrapper>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::NewProp_RegistryId = { "RegistryId", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDataRegistryIdEditWrapper, RegistryId), Z_Construct_UScriptStruct_FDataRegistryId, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::NewProp_RegistryId_MetaData), Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::NewProp_RegistryId_MetaData) }; // 991925281
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistryEditor_Private_DataRegistryIdCustomization_h_Statics::ScriptStructInfo[] = {
		{ FDataRegistryIdEditWrapper::StaticStruct, Z_Construct_UScriptStruct_FDataRegistryIdEditWrapper_Statics::NewStructOps, TEXT("DataRegistryIdEditWrapper"), &Z_Registration_Info_UScriptStruct_DataRegistryIdEditWrapper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDataRegistryIdEditWrapper), 1191744368U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistryEditor_Private_DataRegistryIdCustomization_h_152584116(TEXT("/Script/DataRegistryEditor"),
		nullptr, 0,
