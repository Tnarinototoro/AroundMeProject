...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_DirectoriesToScan_Inner = { "DirectoriesToScan", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_DirectoriesToScan = { "DirectoriesToScan", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistrySettings, DirectoriesToScan), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_DirectoriesToScan_MetaData), Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_DirectoriesToScan_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bInitializeAllLoadedRegistries = { "bInitializeAllLoadedRegistries", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDataRegistrySettings), &Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bInitializeAllLoadedRegistries_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bInitializeAllLoadedRegistries_MetaData), Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bInitializeAllLoadedRegistries_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bIgnoreMissingCookedAssetRegistryData = { "bIgnoreMissingCookedAssetRegistryData", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDataRegistrySettings), &Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bIgnoreMissingCookedAssetRegistryData_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bIgnoreMissingCookedAssetRegistryData_MetaData), Z_Construct_UClass_UDataRegistrySettings_Statics::NewProp_bIgnoreMissingCookedAssetRegistryData_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataRegistrySettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataRegistrySettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistrySettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistrySettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataRegistrySettings, UDataRegistrySettings::StaticClass, TEXT("UDataRegistrySettings"), &Z_Registration_Info_UClass_UDataRegistrySettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataRegistrySettings), 938893U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistrySettings_h_1513908751(TEXT("/Script/DataRegistry"),
