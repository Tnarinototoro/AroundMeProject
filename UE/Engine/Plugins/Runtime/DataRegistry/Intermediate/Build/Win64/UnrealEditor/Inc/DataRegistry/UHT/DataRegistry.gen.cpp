...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_RegistryType = { "RegistryType", nullptr, (EPropertyFlags)0x0020090000010001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistry, RegistryType), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_RegistryType_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_RegistryType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_IdFormat = { "IdFormat", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistry, IdFormat), Z_Construct_UScriptStruct_FDataRegistryIdFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_IdFormat_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_IdFormat_MetaData) }; // 4104722801
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_ItemStruct = { "ItemStruct", nullptr, (EPropertyFlags)0x0024090000010001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistry, ItemStruct), Z_Construct_UClass_UScriptStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_ItemStruct_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_ItemStruct_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_DataSources_Inner = { "DataSources", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UDataRegistrySource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_DataSources_Inner_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_DataSources_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_DataSources = { "DataSources", nullptr, (EPropertyFlags)0x0024088000010009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistry, DataSources), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_DataSources_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_DataSources_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_RuntimeSources_Inner = { "RuntimeSources", nullptr, (EPropertyFlags)0x00060000000a0008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UDataRegistrySource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_RuntimeSources_Inner_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_RuntimeSources_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_RuntimeSources = { "RuntimeSources", nullptr, (EPropertyFlags)0x0024088000032009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistry, RuntimeSources), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_RuntimeSources_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_RuntimeSources_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_TimerUpdateFrequency = { "TimerUpdateFrequency", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistry, TimerUpdateFrequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_TimerUpdateFrequency_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_TimerUpdateFrequency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDataRegistry_Statics::NewProp_DefaultCachePolicy = { "DefaultCachePolicy", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistry, DefaultCachePolicy), Z_Construct_UScriptStruct_FDataRegistryCachePolicy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::NewProp_DefaultCachePolicy_MetaData), Z_Construct_UClass_UDataRegistry_Statics::NewProp_DefaultCachePolicy_MetaData) }; // 1358297362
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataRegistry_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataRegistry_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistry_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataRegistry, UDataRegistry::StaticClass, TEXT("UDataRegistry"), &Z_Registration_Info_UClass_UDataRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataRegistry), 3189993070U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistry_h_2396779764(TEXT("/Script/DataRegistry"),
