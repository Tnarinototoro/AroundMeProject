...
template<> DATAREGISTRY_API UScriptStruct* StaticStruct<FDataRegistryType>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FDataRegistryType_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0020080001000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDataRegistryType, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryType_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FDataRegistryType_Statics::NewProp_Name_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDataRegistryType_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryType_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDataRegistryType_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryType_Statics::PropPointers) < 2048);
...
template<> DATAREGISTRY_API UScriptStruct* StaticStruct<FDataRegistryId>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDataRegistryId_Statics::NewProp_RegistryType = { "RegistryType", nullptr, (EPropertyFlags)0x0010000001000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDataRegistryId, RegistryType), Z_Construct_UScriptStruct_FDataRegistryType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryId_Statics::NewProp_RegistryType_MetaData), Z_Construct_UScriptStruct_FDataRegistryId_Statics::NewProp_RegistryType_MetaData) }; // 1153425427
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FDataRegistryId_Statics::NewProp_ItemName = { "ItemName", nullptr, (EPropertyFlags)0x0010000001000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDataRegistryId, ItemName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryId_Statics::NewProp_ItemName_MetaData), Z_Construct_UScriptStruct_FDataRegistryId_Statics::NewProp_ItemName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDataRegistryId_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryId_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDataRegistryId_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataRegistryId_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistryId_h_Statics::ScriptStructInfo[] = {
		{ FDataRegistryType::StaticStruct, Z_Construct_UScriptStruct_FDataRegistryType_Statics::NewStructOps, TEXT("DataRegistryType"), &Z_Registration_Info_UScriptStruct_DataRegistryType, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDataRegistryType), 1153425427U) },
		{ FDataRegistryId::StaticStruct, Z_Construct_UScriptStruct_FDataRegistryId_Statics::NewStructOps, TEXT("DataRegistryId"), &Z_Registration_Info_UScriptStruct_DataRegistryId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDataRegistryId), 991925281U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistry_Public_DataRegistryId_h_216293219(TEXT("/Script/DataRegistry"),
		nullptr, 0,
