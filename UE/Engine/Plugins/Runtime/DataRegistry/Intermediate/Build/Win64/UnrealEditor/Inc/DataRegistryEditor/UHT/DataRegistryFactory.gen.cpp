...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistryFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UDataRegistryFactory_Statics::NewProp_DataRegistryClass = { "DataRegistryClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataRegistryFactory, DataRegistryClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UDataRegistry_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistryFactory_Statics::NewProp_DataRegistryClass_MetaData), Z_Construct_UClass_UDataRegistryFactory_Statics::NewProp_DataRegistryClass_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataRegistryFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistryFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataRegistryFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataRegistryFactory_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistryEditor_Private_DataRegistryFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataRegistryFactory, UDataRegistryFactory::StaticClass, TEXT("UDataRegistryFactory"), &Z_Registration_Info_UClass_UDataRegistryFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataRegistryFactory), 2402092188U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_DataRegistry_Source_DataRegistryEditor_Private_DataRegistryFactory_h_2938578606(TEXT("/Script/DataRegistryEditor"),
