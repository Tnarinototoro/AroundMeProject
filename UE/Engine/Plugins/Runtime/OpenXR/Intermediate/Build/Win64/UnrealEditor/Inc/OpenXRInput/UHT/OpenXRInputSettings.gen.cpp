...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRInputSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOpenXRInputSettings_Statics::NewProp_MappableInputConfig = { "MappableInputConfig", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOpenXRInputSettings, MappableInputConfig), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRInputSettings_Statics::NewProp_MappableInputConfig_MetaData), Z_Construct_UClass_UOpenXRInputSettings_Statics::NewProp_MappableInputConfig_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOpenXRInputSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRInputSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UOpenXRInputSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRInputSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OpenXR_Source_OpenXRInput_Public_OpenXRInputSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenXRInputSettings, UOpenXRInputSettings::StaticClass, TEXT("UOpenXRInputSettings"), &Z_Registration_Info_UClass_UOpenXRInputSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenXRInputSettings), 1706352794U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OpenXR_Source_OpenXRInput_Public_OpenXRInputSettings_h_4078212454(TEXT("/Script/OpenXRInput"),
