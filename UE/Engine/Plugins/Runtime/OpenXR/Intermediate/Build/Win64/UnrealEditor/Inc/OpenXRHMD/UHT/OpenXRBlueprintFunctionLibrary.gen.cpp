...
// End Cross Module References
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::NewProp_NewBlendMode = { "NewBlendMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OpenXRBlueprintFunctionLibrary_eventSetEnvironmentBlendMode_Parms, NewBlendMode), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary, nullptr, "SetEnvironmentBlendMode", nullptr, nullptr, Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::OpenXRBlueprintFunctionLibrary_eventSetEnvironmentBlendMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode_Statics::OpenXRBlueprintFunctionLibrary_eventSetEnvironmentBlendMode_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOpenXRBlueprintFunctionLibrary_SetEnvironmentBlendMode, "SetEnvironmentBlendMode" }, // 4005278300
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OpenXR_Source_OpenXRHMD_Public_OpenXRBlueprintFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenXRBlueprintFunctionLibrary, UOpenXRBlueprintFunctionLibrary::StaticClass, TEXT("UOpenXRBlueprintFunctionLibrary"), &Z_Registration_Info_UClass_UOpenXRBlueprintFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenXRBlueprintFunctionLibrary), 2891918384U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OpenXR_Source_OpenXRHMD_Public_OpenXRBlueprintFunctionLibrary_h_1267892847(TEXT("/Script/OpenXRHMD"),
