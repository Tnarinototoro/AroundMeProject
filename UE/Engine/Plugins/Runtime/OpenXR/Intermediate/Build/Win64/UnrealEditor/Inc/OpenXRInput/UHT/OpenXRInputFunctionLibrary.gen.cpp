...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::NewProp_InputConfig = { "InputConfig", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OpenXRInputFunctionLibrary_eventBeginXRSession_Parms, InputConfig), Z_Construct_UClass_UPlayerMappableInputConfig_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(OpenXRInputFunctionLibrary_eventBeginXRSession_Parms), &Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOpenXRInputFunctionLibrary, nullptr, "BeginXRSession", nullptr, nullptr, Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::OpenXRInputFunctionLibrary_eventBeginXRSession_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession_Statics::OpenXRInputFunctionLibrary_eventBeginXRSession_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOpenXRInputFunctionLibrary_EndXRSession_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOpenXRInputFunctionLibrary, nullptr, "EndXRSession", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOpenXRInputFunctionLibrary_EndXRSession_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOpenXRInputFunctionLibrary_EndXRSession_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRInputFunctionLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UOpenXRInputFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOpenXRInputFunctionLibrary_BeginXRSession, "BeginXRSession" }, // 2720133203
		{ &Z_Construct_UFunction_UOpenXRInputFunctionLibrary_EndXRSession, "EndXRSession" }, // 3444170029
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRInputFunctionLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOpenXRInputFunctionLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOpenXRInputFunctionLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UOpenXRInputFunctionLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OpenXR_Source_OpenXRInput_Public_OpenXRInputFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOpenXRInputFunctionLibrary, UOpenXRInputFunctionLibrary::StaticClass, TEXT("UOpenXRInputFunctionLibrary"), &Z_Registration_Info_UClass_UOpenXRInputFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOpenXRInputFunctionLibrary), 2959443010U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OpenXR_Source_OpenXRInput_Public_OpenXRInputFunctionLibrary_h_1754237395(TEXT("/Script/OpenXRInput"),
