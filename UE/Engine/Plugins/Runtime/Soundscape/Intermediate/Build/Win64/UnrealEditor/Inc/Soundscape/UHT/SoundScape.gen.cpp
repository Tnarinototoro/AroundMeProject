...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USoundscapeBPFunctionLibrary_SpawnSoundscapeColor_Statics::Function_MetaDataParams[] = {
		{ "Category", "Soundscape" },
		{ "Comment", "/** Spawns, but does not play, a new Soundscape Elemental Agent. Returns true if spawn was successful. \"Play\" can be called on the resulting Active Soundscape Color*/" },
		{ "ModuleRelativePath", "Public/SoundScape.h" },
		{ "ToolTip", "Spawns, but does not play, a new Soundscape Elemental Agent. Returns true if spawn was successful. \"Play\" can be called on the resulting Active Soundscape Color" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USoundscapeBPFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USoundscapeBPFunctionLibrary_SpawnSoundscapeColor, "SpawnSoundscapeColor" }, // 2435412514
		{ &Z_Construct_UFunction_USoundscapeBPFunctionLibrary_SpawnSoundscapePalette, "SpawnSoundscapePalette" }, // 547187906
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Soundscape_Source_SoundScape_Public_SoundScape_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Soundscape_Source_SoundScape_Public_SoundScape_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundscapeBPFunctionLibrary, USoundscapeBPFunctionLibrary::StaticClass, TEXT("USoundscapeBPFunctionLibrary"), &Z_Registration_Info_UClass_USoundscapeBPFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundscapeBPFunctionLibrary), 3869856710U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Soundscape_Source_SoundScape_Public_SoundScape_h_2812255581(TEXT("/Script/Soundscape"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Soundscape_Source_SoundScape_Public_SoundScape_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Soundscape_Source_SoundScape_Public_SoundScape_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
