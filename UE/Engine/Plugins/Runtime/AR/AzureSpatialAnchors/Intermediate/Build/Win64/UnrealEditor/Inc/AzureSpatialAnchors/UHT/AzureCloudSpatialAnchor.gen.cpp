...
// End Cross Module References
	...
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AzureCloudSpatialAnchor_eventGetAppProperties_Parms, ReturnValue), EMapPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAzureCloudSpatialAnchor, nullptr, "GetAppProperties", nullptr, nullptr, Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::AzureCloudSpatialAnchor_eventGetAppProperties_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties_Statics::AzureCloudSpatialAnchor_eventGetAppProperties_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AzureCloudSpatialAnchor_eventGetAzureCloudIdentifier_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAzureCloudSpatialAnchor, nullptr, "GetAzureCloudIdentifier", nullptr, nullptr, Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::AzureCloudSpatialAnchor_eventGetAzureCloudIdentifier_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier_Statics::AzureCloudSpatialAnchor_eventGetAzureCloudIdentifier_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AzureCloudSpatialAnchor_eventGetExpiration_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAzureCloudSpatialAnchor, nullptr, "GetExpiration", nullptr, nullptr, Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::AzureCloudSpatialAnchor_eventGetExpiration_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration_Statics::AzureCloudSpatialAnchor_eventGetExpiration_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::NewProp_InAppProperties_Key_KeyProp = { "InAppProperties_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::NewProp_InAppProperties = { "InAppProperties", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AzureCloudSpatialAnchor_eventSetAppProperties_Parms, InAppProperties), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::NewProp_InAppProperties_MetaData), Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::NewProp_InAppProperties_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAzureCloudSpatialAnchor, nullptr, "SetAppProperties", nullptr, nullptr, Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::AzureCloudSpatialAnchor_eventSetAppProperties_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties_Statics::AzureCloudSpatialAnchor_eventSetAppProperties_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::NewProp_Lifetime = { "Lifetime", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AzureCloudSpatialAnchor_eventSetExpiration_Parms, Lifetime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::NewProp_Lifetime_MetaData), Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::NewProp_Lifetime_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAzureCloudSpatialAnchor, nullptr, "SetExpiration", nullptr, nullptr, Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::AzureCloudSpatialAnchor_eventSetExpiration_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration_Statics::AzureCloudSpatialAnchor_eventSetExpiration_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAppProperties, "GetAppProperties" }, // 2275265245
		{ &Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetAzureCloudIdentifier, "GetAzureCloudIdentifier" }, // 303720831
		{ &Z_Construct_UFunction_UAzureCloudSpatialAnchor_GetExpiration, "GetExpiration" }, // 964691665
		{ &Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetAppProperties, "SetAppProperties" }, // 2918327781
		{ &Z_Construct_UFunction_UAzureCloudSpatialAnchor_SetExpiration, "SetExpiration" }, // 4225295190
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::NewProp_ARPin = { "ARPin", nullptr, (EPropertyFlags)0x0014000000002014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAzureCloudSpatialAnchor, ARPin), Z_Construct_UClass_UARPin_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::NewProp_ARPin_MetaData), Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::NewProp_ARPin_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::Class_MetaDataParams), Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAzureCloudSpatialAnchor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AzureSpatialAnchors_Source_AzureSpatialAnchors_Public_AzureCloudSpatialAnchor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAzureCloudSpatialAnchor, UAzureCloudSpatialAnchor::StaticClass, TEXT("UAzureCloudSpatialAnchor"), &Z_Registration_Info_UClass_UAzureCloudSpatialAnchor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAzureCloudSpatialAnchor), 381391919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AzureSpatialAnchors_Source_AzureSpatialAnchors_Public_AzureCloudSpatialAnchor_h_3735808535(TEXT("/Script/AzureSpatialAnchors"),
