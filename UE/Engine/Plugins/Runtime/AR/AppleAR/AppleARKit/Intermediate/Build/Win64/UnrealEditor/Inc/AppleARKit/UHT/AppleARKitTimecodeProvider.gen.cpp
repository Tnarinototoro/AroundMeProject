...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleARKitTimecodeProvider_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAppleARKitTimecodeProvider_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleARKitTimecodeProvider_Statics::Class_MetaDataParams), Z_Construct_UClass_UAppleARKitTimecodeProvider_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_AppleARKitTimecodeProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAppleARKitTimecodeProvider, UAppleARKitTimecodeProvider::StaticClass, TEXT("UAppleARKitTimecodeProvider"), &Z_Registration_Info_UClass_UAppleARKitTimecodeProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAppleARKitTimecodeProvider), 3632712143U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_AppleARKitTimecodeProvider_h_138063329(TEXT("/Script/AppleARKit"),
