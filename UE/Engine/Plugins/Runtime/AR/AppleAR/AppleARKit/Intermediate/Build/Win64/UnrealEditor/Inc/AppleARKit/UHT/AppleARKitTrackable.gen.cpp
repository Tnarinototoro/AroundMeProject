...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::NewProp_ARKitEnvironmentTexture = { "ARKitEnvironmentTexture", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAppleARKitEnvironmentCaptureProbe, ARKitEnvironmentTexture), Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbeTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::NewProp_ARKitEnvironmentTexture_MetaData), Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::NewProp_ARKitEnvironmentTexture_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::Class_MetaDataParams), Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleARKitEnvironmentCaptureProbe_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_AppleARKitTrackable_h_3788575492(TEXT("/Script/AppleARKit"),
