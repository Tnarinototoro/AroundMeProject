...
template<> APPLEARKIT_API UScriptStruct* StaticStruct<FAppleARKitFrame>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAppleARKitFrame_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleARKitFrame_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAppleARKitFrame_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_AppleARKitFrame_h_Statics::ScriptStructInfo[] = {
		{ FAppleARKitFrame::StaticStruct, Z_Construct_UScriptStruct_FAppleARKitFrame_Statics::NewStructOps, TEXT("AppleARKitFrame"), &Z_Registration_Info_UScriptStruct_AppleARKitFrame, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAppleARKitFrame), 1482436469U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_AppleARKitFrame_h_1566096671(TEXT("/Script/AppleARKit"),
		nullptr, 0,
