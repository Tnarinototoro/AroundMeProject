...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UARKitGeoTrackingSupport_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UARKitGeoTrackingSupport_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UARKitGeoTrackingSupport_Statics::Class_MetaDataParams), Z_Construct_UClass_UARKitGeoTrackingSupport_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_ARKitGeoTrackingSupport_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARKitGeoTrackingSupport, UARKitGeoTrackingSupport::StaticClass, TEXT("UARKitGeoTrackingSupport"), &Z_Registration_Info_UClass_UARKitGeoTrackingSupport, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARKitGeoTrackingSupport), 1042552978U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_ARKitGeoTrackingSupport_h_1022235339(TEXT("/Script/AppleARKit"),
