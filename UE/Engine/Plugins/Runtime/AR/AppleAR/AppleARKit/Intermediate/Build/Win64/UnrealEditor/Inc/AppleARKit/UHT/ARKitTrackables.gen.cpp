...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UARKitMeshGeometry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UARKitMeshGeometry_Statics::ClassParams = {
		...
		0,
		0x008000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UARKitMeshGeometry_Statics::Class_MetaDataParams), Z_Construct_UClass_UARKitMeshGeometry_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_ARKitTrackables_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARKitMeshGeometry, UARKitMeshGeometry::StaticClass, TEXT("UARKitMeshGeometry"), &Z_Registration_Info_UClass_UARKitMeshGeometry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARKitMeshGeometry), 3868910901U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_ARKitTrackables_h_1849130887(TEXT("/Script/AppleARKit"),
