...
template<> APPLEARKIT_API UScriptStruct* StaticStruct<FAppleARKitLightEstimate>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_bIsValid = { "bIsValid", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAppleARKitLightEstimate), &Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_bIsValid_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_bIsValid_MetaData), Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_bIsValid_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_AmbientIntensity = { "AmbientIntensity", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAppleARKitLightEstimate, AmbientIntensity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_AmbientIntensity_MetaData), Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_AmbientIntensity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_AmbientColorTemperatureKelvin = { "AmbientColorTemperatureKelvin", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAppleARKitLightEstimate, AmbientColorTemperatureKelvin), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_AmbientColorTemperatureKelvin_MetaData), Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewProp_AmbientColorTemperatureKelvin_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_AppleARKitLightEstimate_h_Statics::ScriptStructInfo[] = {
		{ FAppleARKitLightEstimate::StaticStruct, Z_Construct_UScriptStruct_FAppleARKitLightEstimate_Statics::NewStructOps, TEXT("AppleARKitLightEstimate"), &Z_Registration_Info_UScriptStruct_AppleARKitLightEstimate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAppleARKitLightEstimate), 29957430U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_AppleAR_AppleARKit_Source_AppleARKit_Private_AppleARKitLightEstimate_h_484947032(TEXT("/Script/AppleARKit"),
		nullptr, 0,
