...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Permissions_Inner = { "Permissions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Permissions = { "Permissions", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARCoreAndroidPermissionHandler_eventOnPermissionsGranted_Parms, Permissions), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Permissions_MetaData), Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Permissions_MetaData) };
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Granted_Inner = { "Granted", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Granted = { "Granted", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARCoreAndroidPermissionHandler_eventOnPermissionsGranted_Parms, Granted), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Granted_MetaData), Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::NewProp_Granted_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UARCoreAndroidPermissionHandler, nullptr, "OnPermissionsGranted", nullptr, nullptr, Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::PropPointers), sizeof(Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::ARCoreAndroidPermissionHandler_eventOnPermissionsGranted_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::Function_MetaDataParams), Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted_Statics::ARCoreAndroidPermissionHandler_eventOnPermissionsGranted_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UARCoreAndroidPermissionHandler_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UARCoreAndroidPermissionHandler_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UARCoreAndroidPermissionHandler_OnPermissionsGranted, "OnPermissionsGranted" }, // 3444310341
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UARCoreAndroidPermissionHandler_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UARCoreAndroidPermissionHandler_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UARCoreAndroidPermissionHandler_Statics::Class_MetaDataParams), Z_Construct_UClass_UARCoreAndroidPermissionHandler_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Private_GoogleARCorePermissionHandler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARCoreAndroidPermissionHandler, UARCoreAndroidPermissionHandler::StaticClass, TEXT("UARCoreAndroidPermissionHandler"), &Z_Registration_Info_UClass_UARCoreAndroidPermissionHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARCoreAndroidPermissionHandler), 3366828614U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Private_GoogleARCorePermissionHandler_h_979980063(TEXT("/Script/GoogleARCoreBase"),
