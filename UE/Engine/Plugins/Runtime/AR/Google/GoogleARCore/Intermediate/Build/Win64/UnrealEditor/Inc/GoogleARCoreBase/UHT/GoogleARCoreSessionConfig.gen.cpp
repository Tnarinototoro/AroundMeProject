...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreSessionConfig_eventGetAugmentedImageDatabase_Parms, ReturnValue), Z_Construct_UClass_UGoogleARCoreAugmentedImageDatabase_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreSessionConfig, nullptr, "GetAugmentedImageDatabase", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::GoogleARCoreSessionConfig_eventGetAugmentedImageDatabase_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase_Statics::GoogleARCoreSessionConfig_eventGetAugmentedImageDatabase_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::NewProp_NewImageDatabase = { "NewImageDatabase", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreSessionConfig_eventSetAugmentedImageDatabase_Parms, NewImageDatabase), Z_Construct_UClass_UGoogleARCoreAugmentedImageDatabase_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreSessionConfig, nullptr, "SetAugmentedImageDatabase", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::GoogleARCoreSessionConfig_eventSetAugmentedImageDatabase_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase_Statics::GoogleARCoreSessionConfig_eventSetAugmentedImageDatabase_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGoogleARCoreSessionConfig_GetAugmentedImageDatabase, "GetAugmentedImageDatabase" }, // 1849318081
		{ &Z_Construct_UFunction_UGoogleARCoreSessionConfig_SetAugmentedImageDatabase, "SetAugmentedImageDatabase" }, // 1851471601
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_AugmentedImageDatabase = { "AugmentedImageDatabase", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGoogleARCoreSessionConfig, AugmentedImageDatabase), Z_Construct_UClass_UGoogleARCoreAugmentedImageDatabase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_AugmentedImageDatabase_MetaData), Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_AugmentedImageDatabase_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_CameraFacing_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_CameraFacing = { "CameraFacing", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGoogleARCoreSessionConfig, CameraFacing), Z_Construct_UEnum_GoogleARCoreBase_EGoogleARCoreCameraFacing, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_CameraFacing_MetaData), Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_CameraFacing_MetaData) }; // 3451354653
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::NewProp_AugmentedFaceMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::Class_MetaDataParams), Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreSessionConfig_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreSessionConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGoogleARCoreSessionConfig, UGoogleARCoreSessionConfig::StaticClass, TEXT("UGoogleARCoreSessionConfig"), &Z_Registration_Info_UClass_UGoogleARCoreSessionConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGoogleARCoreSessionConfig), 647774018U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreSessionConfig_h_664566793(TEXT("/Script/GoogleARCoreBase"),
