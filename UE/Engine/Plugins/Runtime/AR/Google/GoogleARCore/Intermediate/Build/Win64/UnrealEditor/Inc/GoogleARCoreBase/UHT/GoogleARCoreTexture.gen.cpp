...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UARCoreCameraTexture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UARCoreCameraTexture_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UARCoreCameraTexture_Statics::Class_MetaDataParams), Z_Construct_UClass_UARCoreCameraTexture_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UARCoreDepthTexture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UARCoreDepthTexture_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UARCoreDepthTexture_Statics::Class_MetaDataParams), Z_Construct_UClass_UARCoreDepthTexture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Private_GoogleARCoreTexture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARCoreCameraTexture, UARCoreCameraTexture::StaticClass, TEXT("UARCoreCameraTexture"), &Z_Registration_Info_UClass_UARCoreCameraTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARCoreCameraTexture), 306286128U) },
		{ Z_Construct_UClass_UARCoreDepthTexture, UARCoreDepthTexture::StaticClass, TEXT("UARCoreDepthTexture"), &Z_Registration_Info_UClass_UARCoreDepthTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARCoreDepthTexture), 2013665669U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Private_GoogleARCoreTexture_h_4061271719(TEXT("/Script/GoogleARCoreBase"),
