...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_RegularOverlayMaterial = { "RegularOverlayMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGoogleARCoreCameraOverlayMaterialLoader, RegularOverlayMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_RegularOverlayMaterial_MetaData), Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_RegularOverlayMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DebugOverlayMaterial = { "DebugOverlayMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGoogleARCoreCameraOverlayMaterialLoader, DebugOverlayMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DebugOverlayMaterial_MetaData), Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DebugOverlayMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DepthOcclusionMaterial = { "DepthOcclusionMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGoogleARCoreCameraOverlayMaterialLoader, DepthOcclusionMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DepthOcclusionMaterial_MetaData), Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DepthOcclusionMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DepthColorationMaterial = { "DepthColorationMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGoogleARCoreCameraOverlayMaterialLoader, DepthColorationMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DepthColorationMaterial_MetaData), Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::NewProp_DepthColorationMaterial_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::Class_MetaDataParams), Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreRendering_Public_GoogleARCorePassthroughCameraRenderer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGoogleARCoreCameraOverlayMaterialLoader, UGoogleARCoreCameraOverlayMaterialLoader::StaticClass, TEXT("UGoogleARCoreCameraOverlayMaterialLoader"), &Z_Registration_Info_UClass_UGoogleARCoreCameraOverlayMaterialLoader, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGoogleARCoreCameraOverlayMaterialLoader), 419692581U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreRendering_Public_GoogleARCorePassthroughCameraRenderer_h_371370979(TEXT("/Script/GoogleARCoreRendering"),
