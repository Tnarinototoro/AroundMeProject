...
// End Cross Module References
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::NewProp_OutFX = { "OutFX", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraIntrinsics_eventGetFocalLength_Parms, OutFX), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::NewProp_OutFY = { "OutFY", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraIntrinsics_eventGetFocalLength_Parms, OutFY), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreCameraIntrinsics, nullptr, "GetFocalLength", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::GoogleARCoreCameraIntrinsics_eventGetFocalLength_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength_Statics::GoogleARCoreCameraIntrinsics_eventGetFocalLength_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::NewProp_OutWidth = { "OutWidth", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraIntrinsics_eventGetImageDimensions_Parms, OutWidth), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::NewProp_OutHeight = { "OutHeight", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraIntrinsics_eventGetImageDimensions_Parms, OutHeight), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreCameraIntrinsics, nullptr, "GetImageDimensions", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::GoogleARCoreCameraIntrinsics_eventGetImageDimensions_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions_Statics::GoogleARCoreCameraIntrinsics_eventGetImageDimensions_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::NewProp_OutCX = { "OutCX", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraIntrinsics_eventGetPrincipalPoint_Parms, OutCX), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::NewProp_OutCY = { "OutCY", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraIntrinsics_eventGetPrincipalPoint_Parms, OutCY), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreCameraIntrinsics, nullptr, "GetPrincipalPoint", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::GoogleARCoreCameraIntrinsics_eventGetPrincipalPoint_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint_Statics::GoogleARCoreCameraIntrinsics_eventGetPrincipalPoint_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraIntrinsics_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UGoogleARCoreCameraIntrinsics_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetFocalLength, "GetFocalLength" }, // 3776779725
		{ &Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetImageDimensions, "GetImageDimensions" }, // 780188723
		{ &Z_Construct_UFunction_UGoogleARCoreCameraIntrinsics_GetPrincipalPoint, "GetPrincipalPoint" }, // 270428497
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraIntrinsics_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGoogleARCoreCameraIntrinsics_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraIntrinsics_Statics::Class_MetaDataParams), Z_Construct_UClass_UGoogleARCoreCameraIntrinsics_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreCameraIntrinsics_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGoogleARCoreCameraIntrinsics, UGoogleARCoreCameraIntrinsics::StaticClass, TEXT("UGoogleARCoreCameraIntrinsics"), &Z_Registration_Info_UClass_UGoogleARCoreCameraIntrinsics, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGoogleARCoreCameraIntrinsics), 2436022044U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreCameraIntrinsics_h_1653258587(TEXT("/Script/GoogleARCoreBase"),
