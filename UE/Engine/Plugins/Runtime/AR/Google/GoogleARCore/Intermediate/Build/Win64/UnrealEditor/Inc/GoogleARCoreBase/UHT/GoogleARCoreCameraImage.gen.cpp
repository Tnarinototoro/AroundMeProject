...
// End Cross Module References
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraImage_eventGetHeight_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreCameraImage, nullptr, "GetHeight", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::GoogleARCoreCameraImage_eventGetHeight_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight_Statics::GoogleARCoreCameraImage_eventGetHeight_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraImage_eventGetPlaneCount_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreCameraImage, nullptr, "GetPlaneCount", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::GoogleARCoreCameraImage_eventGetPlaneCount_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount_Statics::GoogleARCoreCameraImage_eventGetPlaneCount_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GoogleARCoreCameraImage_eventGetWidth_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreCameraImage, nullptr, "GetWidth", nullptr, nullptr, Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::GoogleARCoreCameraImage_eventGetWidth_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth_Statics::GoogleARCoreCameraImage_eventGetWidth_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGoogleARCoreCameraImage_Release_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGoogleARCoreCameraImage, nullptr, "Release", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGoogleARCoreCameraImage_Release_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGoogleARCoreCameraImage_Release_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraImage_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UGoogleARCoreCameraImage_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGoogleARCoreCameraImage_GetHeight, "GetHeight" }, // 3524712131
		{ &Z_Construct_UFunction_UGoogleARCoreCameraImage_GetPlaneCount, "GetPlaneCount" }, // 3740892217
		{ &Z_Construct_UFunction_UGoogleARCoreCameraImage_GetWidth, "GetWidth" }, // 956992313
		{ &Z_Construct_UFunction_UGoogleARCoreCameraImage_Release, "Release" }, // 2808755427
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraImage_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGoogleARCoreCameraImage_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreCameraImage_Statics::Class_MetaDataParams), Z_Construct_UClass_UGoogleARCoreCameraImage_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreCameraImage_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGoogleARCoreCameraImage, UGoogleARCoreCameraImage::StaticClass, TEXT("UGoogleARCoreCameraImage"), &Z_Registration_Info_UClass_UGoogleARCoreCameraImage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGoogleARCoreCameraImage), 1216861889U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Public_GoogleARCoreCameraImage_h_2014310971(TEXT("/Script/GoogleARCoreBase"),
