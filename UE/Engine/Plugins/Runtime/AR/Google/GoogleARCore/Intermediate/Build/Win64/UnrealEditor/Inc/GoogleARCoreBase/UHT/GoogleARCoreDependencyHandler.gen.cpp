...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreDependencyHandler_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGoogleARCoreDependencyHandler_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGoogleARCoreDependencyHandler_Statics::Class_MetaDataParams), Z_Construct_UClass_UGoogleARCoreDependencyHandler_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Private_GoogleARCoreDependencyHandler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGoogleARCoreDependencyHandler, UGoogleARCoreDependencyHandler::StaticClass, TEXT("UGoogleARCoreDependencyHandler"), &Z_Registration_Info_UClass_UGoogleARCoreDependencyHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGoogleARCoreDependencyHandler), 185759284U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AR_Google_GoogleARCore_Source_GoogleARCoreBase_Private_GoogleARCoreDependencyHandler_h_1428403926(TEXT("/Script/GoogleARCoreBase"),
