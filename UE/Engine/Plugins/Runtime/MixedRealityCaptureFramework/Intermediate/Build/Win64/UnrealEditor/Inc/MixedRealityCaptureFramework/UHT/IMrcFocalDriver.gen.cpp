...
// End Cross Module References
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MrcFocalDriver_eventGetHorizontalFieldOfView_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMrcFocalDriver, nullptr, "GetHorizontalFieldOfView", nullptr, nullptr, Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView_Statics::PropPointers), sizeof(MrcFocalDriver_eventGetHorizontalFieldOfView_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView_Statics::PropPointers) < 2048);
	static_assert(sizeof(MrcFocalDriver_eventGetHorizontalFieldOfView_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMrcFocalDriver_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMrcFocalDriver_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMrcFocalDriver_GetHorizontalFieldOfView, "GetHorizontalFieldOfView" }, // 921190483
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMrcFocalDriver_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMrcFocalDriver_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMrcFocalDriver_Statics::Class_MetaDataParams), Z_Construct_UClass_UMrcFocalDriver_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Public_IMrcFocalDriver_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMrcFocalDriver, UMrcFocalDriver::StaticClass, TEXT("UMrcFocalDriver"), &Z_Registration_Info_UClass_UMrcFocalDriver, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMrcFocalDriver), 3257804944U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Public_IMrcFocalDriver_h_3060887197(TEXT("/Script/MixedRealityCaptureFramework"),
