...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MrcUtilLibrary_eventGetMixedRealityCaptureTexture_Parms, ReturnValue), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMrcUtilLibrary, nullptr, "GetMixedRealityCaptureTexture", nullptr, nullptr, Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::MrcUtilLibrary_eventGetMixedRealityCaptureTexture_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture_Statics::MrcUtilLibrary_eventGetMixedRealityCaptureTexture_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MrcUtilLibrary_eventIsMixedRealityCaptureBroadcasting_Parms), &Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMrcUtilLibrary, nullptr, "IsMixedRealityCaptureBroadcasting", nullptr, nullptr, Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::MrcUtilLibrary_eventIsMixedRealityCaptureBroadcasting_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting_Statics::MrcUtilLibrary_eventIsMixedRealityCaptureBroadcasting_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::NewProp_bEnable = { "bEnable", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MrcUtilLibrary_eventSetMixedRealityCaptureBroadcasting_Parms), &Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::NewProp_bEnable_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMrcUtilLibrary, nullptr, "SetMixedRealityCaptureBroadcasting", nullptr, nullptr, Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::MrcUtilLibrary_eventSetMixedRealityCaptureBroadcasting_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting_Statics::MrcUtilLibrary_eventSetMixedRealityCaptureBroadcasting_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMrcUtilLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMrcUtilLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMrcUtilLibrary_GetMixedRealityCaptureTexture, "GetMixedRealityCaptureTexture" }, // 3507432276
		{ &Z_Construct_UFunction_UMrcUtilLibrary_IsMixedRealityCaptureBroadcasting, "IsMixedRealityCaptureBroadcasting" }, // 3100602274
		{ &Z_Construct_UFunction_UMrcUtilLibrary_SetMixedRealityCaptureBroadcasting, "SetMixedRealityCaptureBroadcasting" }, // 1453304280
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMrcUtilLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMrcUtilLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMrcUtilLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UMrcUtilLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Public_MrcUtilLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMrcUtilLibrary, UMrcUtilLibrary::StaticClass, TEXT("UMrcUtilLibrary"), &Z_Registration_Info_UClass_UMrcUtilLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMrcUtilLibrary), 1987952624U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Public_MrcUtilLibrary_h_2223147484(TEXT("/Script/MixedRealityCaptureFramework"),
