...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMixedRealityCaptureBillboard_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMixedRealityCaptureBillboard_Statics::ClassParams = {
		...
		0,
		0x00A030A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMixedRealityCaptureBillboard_Statics::Class_MetaDataParams), Z_Construct_UClass_UMixedRealityCaptureBillboard_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AMrcProjectionActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AMrcProjectionActor_Statics::NewProp_ProjectionComponent = { "ProjectionComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMrcProjectionActor, ProjectionComponent), Z_Construct_UClass_UMixedRealityCaptureBillboard_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMrcProjectionActor_Statics::NewProp_ProjectionComponent_MetaData), Z_Construct_UClass_AMrcProjectionActor_Statics::NewProp_ProjectionComponent_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMrcProjectionActor_Statics::NewProp_AttachTarget_MetaData[] = {
		{ "ModuleRelativePath", "Private/MrcProjectionBillboard.h" },
	};
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_AMrcProjectionActor_Statics::NewProp_AttachTarget = { "AttachTarget", nullptr, (EPropertyFlags)0x0044000000082008, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMrcProjectionActor, AttachTarget), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMrcProjectionActor_Statics::NewProp_AttachTarget_MetaData), Z_Construct_UClass_AMrcProjectionActor_Statics::NewProp_AttachTarget_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AMrcProjectionActor_Statics::ClassParams = {
		...
		0,
		0x008002A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMrcProjectionActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AMrcProjectionActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AMrcProjectionActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Private_MrcProjectionBillboard_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMixedRealityCaptureBillboard, UMixedRealityCaptureBillboard::StaticClass, TEXT("UMixedRealityCaptureBillboard"), &Z_Registration_Info_UClass_UMixedRealityCaptureBillboard, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMixedRealityCaptureBillboard), 1735513035U) },
		{ Z_Construct_UClass_AMrcProjectionActor, AMrcProjectionActor::StaticClass, TEXT("AMrcProjectionActor"), &Z_Registration_Info_UClass_AMrcProjectionActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMrcProjectionActor), 1223661625U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MixedRealityCaptureFramework_Source_MixedRealityCaptureFramework_Private_MrcProjectionBillboard_h_3101150472(TEXT("/Script/MixedRealityCaptureFramework"),
