...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::NewProp_ReplicatedManager = { "ReplicatedManager", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNetworkPredictionWorldManager, ReplicatedManager), Z_Construct_UClass_ANetworkPredictionReplicatedManager_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::NewProp_ReplicatedManager_MetaData), Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::NewProp_ReplicatedManager_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::Class_MetaDataParams), Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionWorldManager_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionWorldManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetworkPredictionWorldManager, UNetworkPredictionWorldManager::StaticClass, TEXT("UNetworkPredictionWorldManager"), &Z_Registration_Info_UClass_UNetworkPredictionWorldManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetworkPredictionWorldManager), 1859438901U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionWorldManager_h_4205914143(TEXT("/Script/NetworkPrediction"),
