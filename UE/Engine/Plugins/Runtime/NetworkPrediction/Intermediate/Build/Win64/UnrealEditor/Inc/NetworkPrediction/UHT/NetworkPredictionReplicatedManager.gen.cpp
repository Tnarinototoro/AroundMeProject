...
template<> NETWORKPREDICTION_API UScriptStruct* StaticStruct<FSharedPackageMapItem>()
{
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::NewProp_SoftPtr = { "SoftPtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSharedPackageMapItem, SoftPtr), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::NewProp_SoftPtr_MetaData), Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::NewProp_SoftPtr_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::PropPointers) < 2048);
...
template<> NETWORKPREDICTION_API UScriptStruct* StaticStruct<FSharedPackageMap>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSharedPackageMap_Statics::NewProp_Items_Inner = { "Items", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSharedPackageMapItem, METADATA_PARAMS(0, nullptr) }; // 2306018672
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSharedPackageMap_Statics::NewProp_Items_MetaData[] = {
		{ "ModuleRelativePath", "Public/NetworkPredictionReplicatedManager.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSharedPackageMap_Statics::NewProp_Items = { "Items", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSharedPackageMap, Items), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSharedPackageMap_Statics::NewProp_Items_MetaData), Z_Construct_UScriptStruct_FSharedPackageMap_Statics::NewProp_Items_MetaData) }; // 2306018672
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSharedPackageMap_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSharedPackageMap_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSharedPackageMap_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSharedPackageMap_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::NewProp_SharedPackageMap = { "SharedPackageMap", nullptr, (EPropertyFlags)0x0040000000000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANetworkPredictionReplicatedManager, SharedPackageMap), Z_Construct_UScriptStruct_FSharedPackageMap, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::NewProp_SharedPackageMap_MetaData), Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::NewProp_SharedPackageMap_MetaData) }; // 1045361777
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::Class_MetaDataParams), Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANetworkPredictionReplicatedManager_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionReplicatedManager_h_Statics::ScriptStructInfo[] = {
		{ FSharedPackageMapItem::StaticStruct, Z_Construct_UScriptStruct_FSharedPackageMapItem_Statics::NewStructOps, TEXT("SharedPackageMapItem"), &Z_Registration_Info_UScriptStruct_SharedPackageMapItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSharedPackageMapItem), 2306018672U) },
		{ FSharedPackageMap::StaticStruct, Z_Construct_UScriptStruct_FSharedPackageMap_Statics::NewStructOps, TEXT("SharedPackageMap"), &Z_Registration_Info_UScriptStruct_SharedPackageMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSharedPackageMap), 1045361777U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionReplicatedManager_h_85434642(TEXT("/Script/NetworkPrediction"),
