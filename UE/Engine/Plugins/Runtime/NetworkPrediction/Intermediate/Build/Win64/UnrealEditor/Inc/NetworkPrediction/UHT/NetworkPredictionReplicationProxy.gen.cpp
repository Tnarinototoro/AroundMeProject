...
template<> NETWORKPREDICTION_API UScriptStruct* StaticStruct<FReplicationProxy>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FReplicationProxy_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicationProxy_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FReplicationProxy_Statics::Struct_MetaDataParams)
	};
...
template<> NETWORKPREDICTION_API UScriptStruct* StaticStruct<FServerReplicationRPCParameter>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FServerReplicationRPCParameter_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FServerReplicationRPCParameter_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FServerReplicationRPCParameter_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionReplicationProxy_h_Statics::ScriptStructInfo[] = {
		{ FReplicationProxy::StaticStruct, Z_Construct_UScriptStruct_FReplicationProxy_Statics::NewStructOps, TEXT("ReplicationProxy"), &Z_Registration_Info_UScriptStruct_ReplicationProxy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FReplicationProxy), 2527953193U) },
		{ FServerReplicationRPCParameter::StaticStruct, Z_Construct_UScriptStruct_FServerReplicationRPCParameter_Statics::NewStructOps, TEXT("ServerReplicationRPCParameter"), &Z_Registration_Info_UScriptStruct_ServerReplicationRPCParameter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FServerReplicationRPCParameter), 90287900U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionReplicationProxy_h_3866725281(TEXT("/Script/NetworkPrediction"),
		nullptr, 0,
