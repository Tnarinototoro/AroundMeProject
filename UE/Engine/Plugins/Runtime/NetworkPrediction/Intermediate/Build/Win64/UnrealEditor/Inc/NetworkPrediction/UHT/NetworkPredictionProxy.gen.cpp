...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NetworkPrediction_ENetworkPredictionStateRead_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NetworkPrediction_ENetworkPredictionStateRead_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NetworkPrediction_ENetworkPredictionStateRead_Statics::Enum_MetaDataParams)
	};
...
template<> NETWORKPREDICTION_API UScriptStruct* StaticStruct<FNetworkPredictionProxy>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::NewProp_WorldManager = { "WorldManager", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNetworkPredictionProxy, WorldManager), Z_Construct_UClass_UNetworkPredictionWorldManager_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::NewProp_WorldManager_MetaData), Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::NewProp_WorldManager_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionProxy_h_Statics::EnumInfo[] = {
		{ ENetworkPredictionStateRead_StaticEnum, TEXT("ENetworkPredictionStateRead"), &Z_Registration_Info_UEnum_ENetworkPredictionStateRead, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1642627295U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionProxy_h_Statics::ScriptStructInfo[] = {
		{ FNetworkPredictionProxy::StaticStruct, Z_Construct_UScriptStruct_FNetworkPredictionProxy_Statics::NewStructOps, TEXT("NetworkPredictionProxy"), &Z_Registration_Info_UScriptStruct_NetworkPredictionProxy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNetworkPredictionProxy), 3264581219U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionProxy_h_2106405649(TEXT("/Script/NetworkPrediction"),
		nullptr, 0,
