...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_NetworkPredictionProxy = { "NetworkPredictionProxy", nullptr, (EPropertyFlags)0x0020080000002020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNetworkPredictionPhysicsComponent, NetworkPredictionProxy), Z_Construct_UScriptStruct_FNetworkPredictionProxy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_NetworkPredictionProxy_MetaData), Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_NetworkPredictionProxy_MetaData) }; // 3264581219
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_UpdatedPrimitive = { "UpdatedPrimitive", nullptr, (EPropertyFlags)0x0024080000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNetworkPredictionPhysicsComponent, UpdatedPrimitive), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_UpdatedPrimitive_MetaData), Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_UpdatedPrimitive_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_ReplicationProxy = { "ReplicationProxy", nullptr, (EPropertyFlags)0x0020080000002020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNetworkPredictionPhysicsComponent, ReplicationProxy), Z_Construct_UScriptStruct_FReplicationProxy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_ReplicationProxy_MetaData), Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::NewProp_ReplicationProxy_MetaData) }; // 2527953193
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkPredictionPhysicsComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionPhysicsComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetworkPredictionPhysicsComponent, UNetworkPredictionPhysicsComponent::StaticClass, TEXT("UNetworkPredictionPhysicsComponent"), &Z_Registration_Info_UClass_UNetworkPredictionPhysicsComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetworkPredictionPhysicsComponent), 3933637249U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_NetworkPrediction_Source_NetworkPrediction_Public_NetworkPredictionPhysicsComponent_h_117306050(TEXT("/Script/NetworkPrediction"),
