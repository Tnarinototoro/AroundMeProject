...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMFunction_DebugBaseMutable>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Debug_RigVMFunction_DebugBase_h_Statics::ScriptStructInfo[] = {
		{ FRigVMFunction_DebugBase::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_DebugBase_Statics::NewStructOps, TEXT("RigVMFunction_DebugBase"), &Z_Registration_Info_UScriptStruct_RigVMFunction_DebugBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_DebugBase), 1911096534U) },
		{ FRigVMFunction_DebugBaseMutable::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_DebugBaseMutable_Statics::NewStructOps, TEXT("RigVMFunction_DebugBaseMutable"), &Z_Registration_Info_UScriptStruct_RigVMFunction_DebugBaseMutable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_DebugBaseMutable), 457933990U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Debug_RigVMFunction_DebugBase_h_1712489891(TEXT("/Script/RigVM"),
		nullptr, 0,
