...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDebugInfo>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDebugInfo_h_Statics::EnumInfo[] = {
		{ ERigVMBreakpointAction_StaticEnum, TEXT("ERigVMBreakpointAction"), &Z_Registration_Info_UEnum_ERigVMBreakpointAction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3555775715U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDebugInfo_h_Statics::ScriptStructInfo[] = {
		{ FRigVMBreakpoint::StaticStruct, Z_Construct_UScriptStruct_FRigVMBreakpoint_Statics::NewStructOps, TEXT("RigVMBreakpoint"), &Z_Registration_Info_UScriptStruct_RigVMBreakpoint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMBreakpoint), 2565903501U) },
		{ FRigVMDebugInfo::StaticStruct, Z_Construct_UScriptStruct_FRigVMDebugInfo_Statics::NewStructOps, TEXT("RigVMDebugInfo"), &Z_Registration_Info_UScriptStruct_RigVMDebugInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDebugInfo), 1386710640U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDebugInfo_h_1479401396(TEXT("/Script/RigVM"),
		nullptr, 0,
