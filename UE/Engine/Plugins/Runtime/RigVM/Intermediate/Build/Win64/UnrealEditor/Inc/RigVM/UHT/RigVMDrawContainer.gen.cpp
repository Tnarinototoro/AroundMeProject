...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDrawContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMDrawContainer_Statics::NewProp_Instructions_Inner = { "Instructions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRigVMDrawInstruction, METADATA_PARAMS(0, nullptr) }; // 1976085132
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRigVMDrawContainer_Statics::NewProp_Instructions = { "Instructions", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMDrawContainer, Instructions), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMDrawContainer_Statics::NewProp_Instructions_MetaData), Z_Construct_UScriptStruct_FRigVMDrawContainer_Statics::NewProp_Instructions_MetaData) }; // 1976085132
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDrawContainer_h_Statics::ScriptStructInfo[] = {
		{ FRigVMDrawContainer::StaticStruct, Z_Construct_UScriptStruct_FRigVMDrawContainer_Statics::NewStructOps, TEXT("RigVMDrawContainer"), &Z_Registration_Info_UScriptStruct_RigVMDrawContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDrawContainer), 677735076U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDrawContainer_h_2708047500(TEXT("/Script/RigVM"),
		nullptr, 0,
