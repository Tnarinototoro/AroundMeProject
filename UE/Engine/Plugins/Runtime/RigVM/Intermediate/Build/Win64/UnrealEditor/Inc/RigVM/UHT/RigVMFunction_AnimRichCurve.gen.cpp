...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_AnimRichCurve_Statics::NewProp_Curve = { "Curve", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_AnimRichCurve, Curve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_AnimRichCurve_Statics::NewProp_Curve_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_AnimRichCurve_Statics::NewProp_Curve_MetaData) }; // 3321759441
...
void FRigVMFunction_AnimRichCurve::Execute(const FRigVMExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_AnimRichCurve_h_Statics::ScriptStructInfo[] = {
		{ FRigVMFunction_AnimRichCurve::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_AnimRichCurve_Statics::NewStructOps, TEXT("RigVMFunction_AnimRichCurve"), &Z_Registration_Info_UScriptStruct_RigVMFunction_AnimRichCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_AnimRichCurve), 4150132704U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_AnimRichCurve_h_3260240717(TEXT("/Script/RigVM"),
		nullptr, 0,
