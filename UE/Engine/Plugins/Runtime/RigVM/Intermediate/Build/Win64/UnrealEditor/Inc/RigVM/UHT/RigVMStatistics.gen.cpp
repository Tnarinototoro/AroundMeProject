...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_RegisterCount = { "RegisterCount", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMMemoryStatistics, RegisterCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_RegisterCount_MetaData), Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_RegisterCount_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_DataBytes = { "DataBytes", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMMemoryStatistics, DataBytes), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_DataBytes_MetaData), Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_DataBytes_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_TotalBytes = { "TotalBytes", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMMemoryStatistics, TotalBytes), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_TotalBytes_MetaData), Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewProp_TotalBytes_MetaData) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMByteCodeStatistics_Statics::NewProp_InstructionCount = { "InstructionCount", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMByteCodeStatistics, InstructionCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMByteCodeStatistics_Statics::NewProp_InstructionCount_MetaData), Z_Construct_UScriptStruct_FRigVMByteCodeStatistics_Statics::NewProp_InstructionCount_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMByteCodeStatistics_Statics::NewProp_DataBytes = { "DataBytes", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMByteCodeStatistics, DataBytes), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMByteCodeStatistics_Statics::NewProp_DataBytes_MetaData), Z_Construct_UScriptStruct_FRigVMByteCodeStatistics_Statics::NewProp_DataBytes_MetaData) };
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMStatistics>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesForCDO = { "BytesForCDO", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMStatistics, BytesForCDO), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesForCDO_MetaData), Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesForCDO_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesPerInstance = { "BytesPerInstance", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMStatistics, BytesPerInstance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesPerInstance_MetaData), Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesPerInstance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_LiteralMemory = { "LiteralMemory", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMStatistics, LiteralMemory), Z_Construct_UScriptStruct_FRigVMMemoryStatistics, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_LiteralMemory_MetaData), Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_LiteralMemory_MetaData) }; // 786143717
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_WorkMemory = { "WorkMemory", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMStatistics, WorkMemory), Z_Construct_UScriptStruct_FRigVMMemoryStatistics, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_WorkMemory_MetaData), Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_WorkMemory_MetaData) }; // 786143717
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_DebugMemory = { "DebugMemory", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMStatistics, DebugMemory), Z_Construct_UScriptStruct_FRigVMMemoryStatistics, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_DebugMemory_MetaData), Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_DebugMemory_MetaData) }; // 786143717
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesForCaching = { "BytesForCaching", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMStatistics, BytesForCaching), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesForCaching_MetaData), Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewProp_BytesForCaching_MetaData) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMStatistics_h_Statics::ScriptStructInfo[] = {
		{ FRigVMMemoryStatistics::StaticStruct, Z_Construct_UScriptStruct_FRigVMMemoryStatistics_Statics::NewStructOps, TEXT("RigVMMemoryStatistics"), &Z_Registration_Info_UScriptStruct_RigVMMemoryStatistics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMMemoryStatistics), 786143717U) },
		{ FRigVMByteCodeStatistics::StaticStruct, Z_Construct_UScriptStruct_FRigVMByteCodeStatistics_Statics::NewStructOps, TEXT("RigVMByteCodeStatistics"), &Z_Registration_Info_UScriptStruct_RigVMByteCodeStatistics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMByteCodeStatistics), 3210861018U) },
		{ FRigVMStatistics::StaticStruct, Z_Construct_UScriptStruct_FRigVMStatistics_Statics::NewStructOps, TEXT("RigVMStatistics"), &Z_Registration_Info_UScriptStruct_RigVMStatistics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMStatistics), 676819673U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMStatistics_h_633193614(TEXT("/Script/RigVM"),
		nullptr, 0,
