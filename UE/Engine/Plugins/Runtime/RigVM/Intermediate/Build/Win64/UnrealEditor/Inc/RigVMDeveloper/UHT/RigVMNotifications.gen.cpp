...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_RigVMDeveloper_RigVMGraphModifiedDynamicEvent__DelegateSignature_Statics::NewProp_NotifType = { "NotifType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_RigVMDeveloper_eventRigVMGraphModifiedDynamicEvent_Parms, NotifType), Z_Construct_UEnum_RigVMDeveloper_ERigVMGraphNotifType, METADATA_PARAMS(0, nullptr) }; // 1894223741
...
void FRigVMGraphModifiedDynamicEvent_DelegateWrapper(const FMulticastScriptDelegate& RigVMGraphModifiedDynamicEvent, ERigVMGraphNotifType NotifType, URigVMGraph* Graph, UObject* Subject)
{
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_RigVMNotifications_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_RigVMNotifications_h_Statics::EnumInfo[] = {
		{ ERigVMGraphNotifType_StaticEnum, TEXT("ERigVMGraphNotifType"), &Z_Registration_Info_UEnum_ERigVMGraphNotifType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1894223741U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_RigVMNotifications_h_2882597346(TEXT("/Script/RigVMDeveloper"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_RigVMNotifications_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_RigVMNotifications_h_Statics::EnumInfo));
