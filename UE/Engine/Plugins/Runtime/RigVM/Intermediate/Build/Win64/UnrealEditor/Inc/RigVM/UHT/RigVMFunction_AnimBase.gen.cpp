...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMFunction_AnimBase>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_AnimBase_h_Statics::ScriptStructInfo[] = {
		{ FRigVMFunction_AnimBase::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_AnimBase_Statics::NewStructOps, TEXT("RigVMFunction_AnimBase"), &Z_Registration_Info_UScriptStruct_RigVMFunction_AnimBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_AnimBase), 886056270U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_AnimBase_h_1531769194(TEXT("/Script/RigVM"),
		nullptr, 0,
