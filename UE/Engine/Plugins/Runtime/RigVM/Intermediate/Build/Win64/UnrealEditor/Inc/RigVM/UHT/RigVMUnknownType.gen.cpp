...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMUnknownType>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMUnknownType_h_Statics::ScriptStructInfo[] = {
		{ FRigVMUnknownType::StaticStruct, Z_Construct_UScriptStruct_FRigVMUnknownType_Statics::NewStructOps, TEXT("RigVMUnknownType"), &Z_Registration_Info_UScriptStruct_RigVMUnknownType, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMUnknownType), 3096024257U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMUnknownType_h_646208597(TEXT("/Script/RigVM"),
		nullptr, 0,
