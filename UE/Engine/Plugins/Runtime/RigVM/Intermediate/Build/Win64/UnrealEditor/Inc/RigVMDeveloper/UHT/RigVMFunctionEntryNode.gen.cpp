...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(URigVMFunctionEntryNode);
	UClass* Z_Construct_UClass_URigVMFunctionEntryNode_NoRegister()
	{
		return URigVMFunctionEntryNode::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URigVMFunctionEntryNode_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_URigVMFunctionEntryNode_Statics::StaticCppClassTypeInfo = {
	...
	template<> RIGVMDEVELOPER_API UClass* StaticClass<URigVMFunctionEntryNode>()
	{
		return URigVMFunctionEntryNode::StaticClass();
	}
	URigVMFunctionEntryNode::URigVMFunctionEntryNode() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(URigVMFunctionEntryNode);
	URigVMFunctionEntryNode::~URigVMFunctionEntryNode() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMFunctionEntryNode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMFunctionEntryNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URigVMFunctionEntryNode, URigVMFunctionEntryNode::StaticClass, TEXT("URigVMFunctionEntryNode"), &Z_Registration_Info_UClass_URigVMFunctionEntryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URigVMFunctionEntryNode), 2895606092U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMFunctionEntryNode_h_2617305192(TEXT("/Script/RigVMDeveloper"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMFunctionEntryNode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMFunctionEntryNode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
