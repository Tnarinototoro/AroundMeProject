...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMTemplateArgumentType>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigVMTemplateArgumentType_Statics::NewProp_CPPType = { "CPPType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMTemplateArgumentType, CPPType), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMTemplateArgumentType_Statics::NewProp_CPPType_MetaData), Z_Construct_UScriptStruct_FRigVMTemplateArgumentType_Statics::NewProp_CPPType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRigVMTemplateArgumentType_Statics::NewProp_CPPTypeObject = { "CPPTypeObject", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMTemplateArgumentType, CPPTypeObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMTemplateArgumentType_Statics::NewProp_CPPTypeObject_MetaData), Z_Construct_UScriptStruct_FRigVMTemplateArgumentType_Statics::NewProp_CPPTypeObject_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMTemplate_h_Statics::ScriptStructInfo[] = {
		{ FRigVMTemplateArgumentType::StaticStruct, Z_Construct_UScriptStruct_FRigVMTemplateArgumentType_Statics::NewStructOps, TEXT("RigVMTemplateArgumentType"), &Z_Registration_Info_UScriptStruct_RigVMTemplateArgumentType, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMTemplateArgumentType), 970970598U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMTemplate_h_3099446636(TEXT("/Script/RigVM"),
		nullptr, 0,
