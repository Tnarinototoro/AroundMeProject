...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_GetDeltaTime_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_GetDeltaTime, Result), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_GetDeltaTime_Statics::NewProp_Result_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_GetDeltaTime_Statics::NewProp_Result_MetaData) };
...
void FRigVMFunction_GetDeltaTime::Execute(const FRigVMExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_GetDeltaTime_h_Statics::ScriptStructInfo[] = {
		{ FRigVMFunction_GetDeltaTime::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_GetDeltaTime_Statics::NewStructOps, TEXT("RigVMFunction_GetDeltaTime"), &Z_Registration_Info_UScriptStruct_RigVMFunction_GetDeltaTime, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_GetDeltaTime), 2025387029U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_GetDeltaTime_h_3363167076(TEXT("/Script/RigVM"),
		nullptr, 0,
