...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMFunction_MathMutableBase>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Math_RigVMFunction_MathBase_h_Statics::ScriptStructInfo[] = {
		{ FRigVMFunction_MathBase::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_MathBase_Statics::NewStructOps, TEXT("RigVMFunction_MathBase"), &Z_Registration_Info_UScriptStruct_RigVMFunction_MathBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_MathBase), 2042834990U) },
		{ FRigVMFunction_MathMutableBase::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_MathMutableBase_Statics::NewStructOps, TEXT("RigVMFunction_MathMutableBase"), &Z_Registration_Info_UScriptStruct_RigVMFunction_MathMutableBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_MathMutableBase), 1729784380U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Math_RigVMFunction_MathBase_h_2560811642(TEXT("/Script/RigVM"),
		nullptr, 0,
