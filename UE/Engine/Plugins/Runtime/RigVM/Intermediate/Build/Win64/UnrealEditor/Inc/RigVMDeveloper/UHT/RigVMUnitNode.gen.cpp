...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigVMUnitNode_GetMethodName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigVMUnitNode, nullptr, "GetMethodName", nullptr, nullptr, Z_Construct_UFunction_URigVMUnitNode_GetMethodName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigVMUnitNode_GetMethodName_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigVMUnitNode_GetMethodName_Statics::RigVMUnitNode_eventGetMethodName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigVMUnitNode_GetMethodName_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigVMUnitNode_GetMethodName_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URigVMUnitNode_GetStructDefaultValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URigVMUnitNode, nullptr, "GetStructDefaultValue", nullptr, nullptr, Z_Construct_UFunction_URigVMUnitNode_GetStructDefaultValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URigVMUnitNode_GetStructDefaultValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_URigVMUnitNode_GetStructDefaultValue_Statics::RigVMUnitNode_eventGetStructDefaultValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URigVMUnitNode_GetStructDefaultValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_URigVMUnitNode_GetStructDefaultValue_Statics::Function_MetaDataParams) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URigVMUnitNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URigVMUnitNode_GetMethodName, "GetMethodName" }, // 1947315122
		{ &Z_Construct_UFunction_URigVMUnitNode_GetStructDefaultValue, "GetStructDefaultValue" }, // 3530779411
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URigVMUnitNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URigVMUnitNode_Statics::NewProp_ScriptStruct = { "ScriptStruct", nullptr, (EPropertyFlags)0x0044000820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigVMUnitNode, ScriptStruct_DEPRECATED), Z_Construct_UClass_UScriptStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigVMUnitNode_Statics::NewProp_ScriptStruct_MetaData), Z_Construct_UClass_URigVMUnitNode_Statics::NewProp_ScriptStruct_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URigVMUnitNode_Statics::NewProp_MethodName_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigVMModel/Nodes/RigVMUnitNode.h" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_URigVMUnitNode_Statics::NewProp_MethodName = { "MethodName", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigVMUnitNode, MethodName_DEPRECATED), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigVMUnitNode_Statics::NewProp_MethodName_MetaData), Z_Construct_UClass_URigVMUnitNode_Statics::NewProp_MethodName_MetaData) };
	...
	URigVMUnitNode::~URigVMUnitNode() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMUnitNode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMUnitNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URigVMUnitNode, URigVMUnitNode::StaticClass, TEXT("URigVMUnitNode"), &Z_Registration_Info_UClass_URigVMUnitNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URigVMUnitNode), 772938683U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMUnitNode_h_1325623167(TEXT("/Script/RigVMDeveloper"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMUnitNode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMUnitNode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
