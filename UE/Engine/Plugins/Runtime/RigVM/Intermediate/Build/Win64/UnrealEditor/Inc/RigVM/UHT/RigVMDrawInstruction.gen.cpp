...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDrawInstruction>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigVMDrawInstruction_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMDrawInstruction, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMDrawInstruction_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FRigVMDrawInstruction_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMDrawInstruction_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMDrawInstruction, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMDrawInstruction_Statics::NewProp_Transform_MetaData), Z_Construct_UScriptStruct_FRigVMDrawInstruction_Statics::NewProp_Transform_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDrawInstruction_h_Statics::EnumInfo[] = {
		{ ERigVMDrawSettings_StaticEnum, TEXT("ERigVMDrawSettings"), &Z_Registration_Info_UEnum_ERigVMDrawSettings, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 787790297U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDrawInstruction_h_Statics::ScriptStructInfo[] = {
		{ FRigVMDrawInstruction::StaticStruct, Z_Construct_UScriptStruct_FRigVMDrawInstruction_Statics::NewStructOps, TEXT("RigVMDrawInstruction"), &Z_Registration_Info_UScriptStruct_RigVMDrawInstruction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDrawInstruction), 1976085132U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDrawInstruction_h_2163916637(TEXT("/Script/RigVM"),
		nullptr, 0,
