...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_FramesToSeconds_Statics::NewProp_Frames = { "Frames", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_FramesToSeconds, Frames), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_FramesToSeconds_Statics::NewProp_Frames_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_FramesToSeconds_Statics::NewProp_Frames_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_FramesToSeconds_Statics::NewProp_Seconds = { "Seconds", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_FramesToSeconds, Seconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_FramesToSeconds_Statics::NewProp_Seconds_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_FramesToSeconds_Statics::NewProp_Seconds_MetaData) };
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_SecondsToFrames_Statics::NewProp_Frames = { "Frames", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_SecondsToFrames, Frames), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_SecondsToFrames_Statics::NewProp_Frames_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_SecondsToFrames_Statics::NewProp_Frames_MetaData) };
...
void FRigVMFunction_SecondsToFrames::Execute(const FRigVMExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_TimeConversion_h_Statics::ScriptStructInfo[] = {
		{ FRigVMFunction_FramesToSeconds::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_FramesToSeconds_Statics::NewStructOps, TEXT("RigVMFunction_FramesToSeconds"), &Z_Registration_Info_UScriptStruct_RigVMFunction_FramesToSeconds, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_FramesToSeconds), 3368759597U) },
		{ FRigVMFunction_SecondsToFrames::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_SecondsToFrames_Statics::NewStructOps, TEXT("RigVMFunction_SecondsToFrames"), &Z_Registration_Info_UScriptStruct_RigVMFunction_SecondsToFrames, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_SecondsToFrames), 699105779U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_TimeConversion_h_1004731025(TEXT("/Script/RigVM"),
		nullptr, 0,
