...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDispatch_If>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_RigVMDispatch_If_h_Statics::ScriptStructInfo[] = {
		{ FRigVMDispatch_If::StaticStruct, Z_Construct_UScriptStruct_FRigVMDispatch_If_Statics::NewStructOps, TEXT("RigVMDispatch_If"), &Z_Registration_Info_UScriptStruct_RigVMDispatch_If, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDispatch_If), 1525112378U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_RigVMDispatch_If_h_4270621885(TEXT("/Script/RigVM"),
		nullptr, 0,
