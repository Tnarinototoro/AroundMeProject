...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMExternalVariableDef>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigVMExternalVariableDef_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	void* Z_Construct_UScriptStruct_FRigVMExternalVariableDef_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FRigVMExternalVariableDef>();
	}
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRigVMExternalVariableDef_Statics::ReturnStructParams = {
	...
	UScriptStruct* Z_Construct_UScriptStruct_FRigVMExternalVariableDef()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_RigVMExternalVariableDef.InnerSingleton, Z_Construct_UScriptStruct_FRigVMExternalVariableDef_Statics::ReturnStructParams);
		}
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMExternalVariable>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMExternalVariable_h_Statics::ScriptStructInfo[] = {
		{ FRigVMExternalVariableDef::StaticStruct, Z_Construct_UScriptStruct_FRigVMExternalVariableDef_Statics::NewStructOps, TEXT("RigVMExternalVariableDef"), &Z_Registration_Info_UScriptStruct_RigVMExternalVariableDef, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMExternalVariableDef), 1142405576U) },
		{ FRigVMExternalVariable::StaticStruct, Z_Construct_UScriptStruct_FRigVMExternalVariable_Statics::NewStructOps, TEXT("RigVMExternalVariable"), &Z_Registration_Info_UScriptStruct_RigVMExternalVariable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMExternalVariable), 3106735322U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMExternalVariable_h_2598477634(TEXT("/Script/RigVM"),
		nullptr, 0,
