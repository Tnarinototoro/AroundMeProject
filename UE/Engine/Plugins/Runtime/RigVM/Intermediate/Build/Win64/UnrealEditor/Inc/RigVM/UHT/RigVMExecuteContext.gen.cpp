...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMExtendedExecuteContext>()
{
	...
	struct Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics
	{
		...
		static void* NewStructOps();
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_VMHash_MetaData[];
#endif
		static const UECodeGen_Private::FUInt32PropertyParams NewProp_VMHash;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_VMHash_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigVMCore/RigVMExecuteContext.h" },
	};
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_VMHash = { "VMHash", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMExtendedExecuteContext, VMHash), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_VMHash_MetaData), Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_VMHash_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_NumExecutions_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigVMCore/RigVMExecuteContext.h" },
	};
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_NumExecutions = { "NumExecutions", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMExtendedExecuteContext, NumExecutions), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_NumExecutions_MetaData), Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_NumExecutions_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_DeferredVMToCopy_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigVMCore/RigVMExecuteContext.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_DeferredVMToCopy = { "DeferredVMToCopy", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMExtendedExecuteContext, DeferredVMToCopy), Z_Construct_UClass_URigVM_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_DeferredVMToCopy_MetaData), Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_DeferredVMToCopy_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_VMHash,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_NumExecutions,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewProp_DeferredVMToCopy,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::ReturnStructParams = {
		...
		Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::PropPointers),
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMExecuteContext_h_Statics::ScriptStructInfo[] = {
		{ FRigVMSlice::StaticStruct, Z_Construct_UScriptStruct_FRigVMSlice_Statics::NewStructOps, TEXT("RigVMSlice"), &Z_Registration_Info_UScriptStruct_RigVMSlice, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMSlice), 2595805800U) },
		{ FRigVMRuntimeSettings::StaticStruct, Z_Construct_UScriptStruct_FRigVMRuntimeSettings_Statics::NewStructOps, TEXT("RigVMRuntimeSettings"), &Z_Registration_Info_UScriptStruct_RigVMRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMRuntimeSettings), 2055583755U) },
		{ FRigVMExecuteContext::StaticStruct, Z_Construct_UScriptStruct_FRigVMExecuteContext_Statics::NewStructOps, TEXT("RigVMExecuteContext"), &Z_Registration_Info_UScriptStruct_RigVMExecuteContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMExecuteContext), 2528636812U) },
		{ FRigVMExtendedExecuteContext::StaticStruct, Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext_Statics::NewStructOps, TEXT("RigVMExtendedExecuteContext"), &Z_Registration_Info_UScriptStruct_RigVMExtendedExecuteContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMExtendedExecuteContext), 1449618519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMExecuteContext_h_1430085699(TEXT("/Script/RigVM"),
		nullptr, 0,
