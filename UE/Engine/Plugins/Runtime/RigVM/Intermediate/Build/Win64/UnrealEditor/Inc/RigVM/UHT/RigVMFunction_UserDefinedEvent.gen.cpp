...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigVMFunction_UserDefinedEvent_Statics::NewProp_EventName = { "EventName", nullptr, (EPropertyFlags)0x0010000000022005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_UserDefinedEvent, EventName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_UserDefinedEvent_Statics::NewProp_EventName_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_UserDefinedEvent_Statics::NewProp_EventName_MetaData) };
...
void FRigVMFunction_UserDefinedEvent::Execute(FRigVMExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Execution_RigVMFunction_UserDefinedEvent_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Execution_RigVMFunction_UserDefinedEvent_h_4266356316(TEXT("/Script/RigVM"),
		nullptr, 0,
