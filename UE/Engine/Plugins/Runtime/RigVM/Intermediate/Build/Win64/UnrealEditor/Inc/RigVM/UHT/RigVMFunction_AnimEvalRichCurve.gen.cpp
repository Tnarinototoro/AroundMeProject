...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_AnimEvalRichCurve, Value), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Value_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Value_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Curve = { "Curve", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_AnimEvalRichCurve, Curve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Curve_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Curve_MetaData) }; // 3321759441
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_SourceMaximum = { "SourceMaximum", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_AnimEvalRichCurve, SourceMaximum), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_SourceMaximum_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_SourceMaximum_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_TargetMinimum = { "TargetMinimum", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_AnimEvalRichCurve, TargetMinimum), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_TargetMinimum_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_TargetMinimum_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_TargetMaximum = { "TargetMaximum", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_AnimEvalRichCurve, TargetMaximum), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_TargetMaximum_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_TargetMaximum_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMFunction_AnimEvalRichCurve, Result), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Result_MetaData), Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewProp_Result_MetaData) };
...
void FRigVMFunction_AnimEvalRichCurve::Execute(const FRigVMExecuteContext& InExecuteContext)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_AnimEvalRichCurve_h_Statics::ScriptStructInfo[] = {
		{ FRigVMFunction_AnimEvalRichCurve::StaticStruct, Z_Construct_UScriptStruct_FRigVMFunction_AnimEvalRichCurve_Statics::NewStructOps, TEXT("RigVMFunction_AnimEvalRichCurve"), &Z_Registration_Info_UScriptStruct_RigVMFunction_AnimEvalRichCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMFunction_AnimEvalRichCurve), 4247395945U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_Animation_RigVMFunction_AnimEvalRichCurve_h_1242804018(TEXT("/Script/RigVM"),
		nullptr, 0,
