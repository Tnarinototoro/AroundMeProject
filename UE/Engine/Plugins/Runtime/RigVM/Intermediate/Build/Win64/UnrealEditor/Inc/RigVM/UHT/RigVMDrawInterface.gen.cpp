...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDrawInterface>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDrawInterface_h_Statics::ScriptStructInfo[] = {
		{ FRigVMDrawInterface::StaticStruct, Z_Construct_UScriptStruct_FRigVMDrawInterface_Statics::NewStructOps, TEXT("RigVMDrawInterface"), &Z_Registration_Info_UScriptStruct_RigVMDrawInterface, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDrawInterface), 3036691759U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDrawInterface_h_2582066226(TEXT("/Script/RigVM"),
		nullptr, 0,
