...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDispatch_Print>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_RigVMDispatch_Print_h_Statics::ScriptStructInfo[] = {
		{ FRigVMDispatch_Print::StaticStruct, Z_Construct_UScriptStruct_FRigVMDispatch_Print_Statics::NewStructOps, TEXT("RigVMDispatch_Print"), &Z_Registration_Info_UScriptStruct_RigVMDispatch_Print, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDispatch_Print), 2208470375U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMFunctions_RigVMDispatch_Print_h_3093373629(TEXT("/Script/RigVM"),
		nullptr, 0,
