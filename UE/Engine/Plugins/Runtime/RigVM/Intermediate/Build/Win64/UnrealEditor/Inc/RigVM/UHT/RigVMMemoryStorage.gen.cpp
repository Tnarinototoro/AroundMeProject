...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMBranchInfo>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMBranchInfo, Index), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_Index_MetaData), Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_Index_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_Label_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigVMCore/RigVMMemoryStorage.h" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_Label = { "Label", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMBranchInfo, Label), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_Label_MetaData), Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_Label_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_InstructionIndex = { "InstructionIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMBranchInfo, InstructionIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_InstructionIndex_MetaData), Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_InstructionIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_LastInstruction = { "LastInstruction", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMBranchInfo, LastInstruction), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_LastInstruction_MetaData), Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewProp_LastInstruction_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMMemoryStorage_h_Statics::ScriptStructInfo[] = {
		{ FRigVMBranchInfo::StaticStruct, Z_Construct_UScriptStruct_FRigVMBranchInfo_Statics::NewStructOps, TEXT("RigVMBranchInfo"), &Z_Registration_Info_UScriptStruct_RigVMBranchInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMBranchInfo), 321147316U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMMemoryStorage_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URigVMMemoryStorageGeneratorClass, URigVMMemoryStorageGeneratorClass::StaticClass, TEXT("URigVMMemoryStorageGeneratorClass"), &Z_Registration_Info_UClass_URigVMMemoryStorageGeneratorClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URigVMMemoryStorageGeneratorClass), 1393095679U) },
		{ Z_Construct_UClass_URigVMMemoryStorage, URigVMMemoryStorage::StaticClass, TEXT("URigVMMemoryStorage"), &Z_Registration_Info_UClass_URigVMMemoryStorage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URigVMMemoryStorage), 2709092286U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMMemoryStorage_h_681018178(TEXT("/Script/RigVM"),
