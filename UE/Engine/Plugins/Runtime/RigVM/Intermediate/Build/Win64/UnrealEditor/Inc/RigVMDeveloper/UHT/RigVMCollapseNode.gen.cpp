...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_URigVMCollapseNode_Statics::NewProp_NodeDescription = { "NodeDescription", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URigVMCollapseNode, NodeDescription), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URigVMCollapseNode_Statics::NewProp_NodeDescription_MetaData), Z_Construct_UClass_URigVMCollapseNode_Statics::NewProp_NodeDescription_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMCollapseNode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMCollapseNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URigVMCollapseNode, URigVMCollapseNode::StaticClass, TEXT("URigVMCollapseNode"), &Z_Registration_Info_UClass_URigVMCollapseNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URigVMCollapseNode), 2426261993U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMCollapseNode_h_434526420(TEXT("/Script/RigVMDeveloper"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMCollapseNode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVMDeveloper_Public_RigVMModel_Nodes_RigVMCollapseNode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
