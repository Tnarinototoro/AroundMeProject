...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMOperand>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType = { "MemoryType", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMOperand, MemoryType), Z_Construct_UEnum_RigVM_ERigVMMemoryType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType_MetaData), Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType_MetaData) }; // 1648368299
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterIndex = { "RegisterIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMOperand, RegisterIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterIndex_MetaData), Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterOffset = { "RegisterOffset", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRigVMOperand, RegisterOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterOffset_MetaData), Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterOffset_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMMemoryCommon_h_Statics::EnumInfo[] = {
		{ ERigVMMemoryType_StaticEnum, TEXT("ERigVMMemoryType"), &Z_Registration_Info_UEnum_ERigVMMemoryType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1648368299U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMMemoryCommon_h_Statics::ScriptStructInfo[] = {
		{ FRigVMOperand::StaticStruct, Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewStructOps, TEXT("RigVMOperand"), &Z_Registration_Info_UScriptStruct_RigVMOperand, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMOperand), 3848891530U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMMemoryCommon_h_4174834883(TEXT("/Script/RigVM"),
		nullptr, 0,
