...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDispatchFactory>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDispatchFactory_h_Statics::ScriptStructInfo[] = {
		{ FRigVMDispatchFactory::StaticStruct, Z_Construct_UScriptStruct_FRigVMDispatchFactory_Statics::NewStructOps, TEXT("RigVMDispatchFactory"), &Z_Registration_Info_UScriptStruct_RigVMDispatchFactory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDispatchFactory), 183652528U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RigVM_Source_RigVM_Public_RigVMCore_RigVMDispatchFactory_h_4278296228(TEXT("/Script/RigVM"),
		nullptr, 0,
