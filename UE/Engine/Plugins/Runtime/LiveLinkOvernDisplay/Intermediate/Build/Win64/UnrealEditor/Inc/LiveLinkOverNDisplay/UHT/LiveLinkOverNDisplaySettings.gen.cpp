...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::NewProp_bIsEnabled = { "bIsEnabled", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULiveLinkOverNDisplaySettings), &Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::NewProp_bIsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::NewProp_bIsEnabled_MetaData), Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::NewProp_bIsEnabled_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkOverNDisplaySettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LiveLinkOvernDisplay_Source_LiveLinkOverNDisplay_Public_LiveLinkOverNDisplaySettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkOverNDisplaySettings, ULiveLinkOverNDisplaySettings::StaticClass, TEXT("ULiveLinkOverNDisplaySettings"), &Z_Registration_Info_UClass_ULiveLinkOverNDisplaySettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkOverNDisplaySettings), 846128955U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LiveLinkOvernDisplay_Source_LiveLinkOverNDisplay_Public_LiveLinkOverNDisplaySettings_h_2137420669(TEXT("/Script/LiveLinkOverNDisplay"),
