...
template<> ZONEGRAPHANNOTATIONS_API UScriptStruct* StaticStruct<FZoneGraphAnnotationEventBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FZoneGraphAnnotationEventBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FZoneGraphAnnotationEventBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FZoneGraphAnnotationEventBase_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationTypes_h_Statics::ScriptStructInfo[] = {
		{ FZoneGraphAnnotationEventBase::StaticStruct, Z_Construct_UScriptStruct_FZoneGraphAnnotationEventBase_Statics::NewStructOps, TEXT("ZoneGraphAnnotationEventBase"), &Z_Registration_Info_UScriptStruct_ZoneGraphAnnotationEventBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FZoneGraphAnnotationEventBase), 3915650399U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationTypes_h_1019853958(TEXT("/Script/ZoneGraphAnnotations"),
		nullptr, 0,
