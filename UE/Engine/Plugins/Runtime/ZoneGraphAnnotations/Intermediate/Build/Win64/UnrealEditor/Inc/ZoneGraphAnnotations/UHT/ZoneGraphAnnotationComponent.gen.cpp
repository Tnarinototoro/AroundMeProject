...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::NewProp_bEnableDebugDrawing = { "bEnableDebugDrawing", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UZoneGraphAnnotationComponent), &Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::NewProp_bEnableDebugDrawing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::NewProp_bEnableDebugDrawing_MetaData), Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::NewProp_bEnableDebugDrawing_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneGraphAnnotationComponent, UZoneGraphAnnotationComponent::StaticClass, TEXT("UZoneGraphAnnotationComponent"), &Z_Registration_Info_UClass_UZoneGraphAnnotationComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphAnnotationComponent), 2910691964U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationComponent_h_3320333595(TEXT("/Script/ZoneGraphAnnotations"),
