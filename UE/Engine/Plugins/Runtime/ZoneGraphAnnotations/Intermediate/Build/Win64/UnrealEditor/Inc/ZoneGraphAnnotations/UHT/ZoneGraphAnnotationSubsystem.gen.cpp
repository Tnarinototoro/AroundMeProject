...
template<> ZONEGRAPHANNOTATIONS_API UScriptStruct* StaticStruct<FRegisteredZoneGraphAnnotation>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRegisteredZoneGraphAnnotation_Statics::NewProp_AnnotationComponent = { "AnnotationComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRegisteredZoneGraphAnnotation, AnnotationComponent), Z_Construct_UClass_UZoneGraphAnnotationComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredZoneGraphAnnotation_Statics::NewProp_AnnotationComponent_MetaData), Z_Construct_UScriptStruct_FRegisteredZoneGraphAnnotation_Statics::NewProp_AnnotationComponent_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRegisteredZoneGraphAnnotation_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredZoneGraphAnnotation_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRegisteredZoneGraphAnnotation_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredZoneGraphAnnotation_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_RegisteredComponents = { "RegisteredComponents", nullptr, (EPropertyFlags)0x0020088000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphAnnotationSubsystem, RegisteredComponents), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_RegisteredComponents_MetaData), Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_RegisteredComponents_MetaData) }; // 1949614583
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_Events = { "Events", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(Events, UZoneGraphAnnotationSubsystem), STRUCT_OFFSET(UZoneGraphAnnotationSubsystem, Events), Z_Construct_UScriptStruct_FInstancedStructContainer, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_Events_MetaData), Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_Events_MetaData) }; // 388454796
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_TagToAnnotationLookup_Inner = { "TagToAnnotationLookup", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UZoneGraphAnnotationComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_TagToAnnotationLookup = { "TagToAnnotationLookup", nullptr, (EPropertyFlags)0x0024088000002008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphAnnotationSubsystem, TagToAnnotationLookup), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_TagToAnnotationLookup_MetaData), Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::NewProp_TagToAnnotationLookup_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationSubsystem_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneGraphAnnotationSubsystem, UZoneGraphAnnotationSubsystem::StaticClass, TEXT("UZoneGraphAnnotationSubsystem"), &Z_Registration_Info_UClass_UZoneGraphAnnotationSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphAnnotationSubsystem), 4155097368U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationSubsystem_h_701223066(TEXT("/Script/ZoneGraphAnnotations"),
