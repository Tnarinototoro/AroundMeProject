...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::NewProp_OwnerComponent = { "OwnerComponent", nullptr, (EPropertyFlags)0x0024080000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphAnnotationTest, OwnerComponent), Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::NewProp_OwnerComponent_MetaData), Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::NewProp_OwnerComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::ClassParams = {
		...
		0,
		0x009010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTest_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::NewProp_Tests_Inner = { "Tests", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UZoneGraphAnnotationTest_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::NewProp_Tests_Inner_MetaData), Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::NewProp_Tests_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::NewProp_Tests = { "Tests", nullptr, (EPropertyFlags)0x0024088000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphAnnotationTestingComponent, Tests), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::NewProp_Tests_MetaData), Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::NewProp_Tests_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_Statics::PropPointers) < 2048);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AZoneGraphAnnotationTestingActor_Trigger_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AZoneGraphAnnotationTestingActor, nullptr, "Trigger", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AZoneGraphAnnotationTestingActor_Trigger_Statics::Function_MetaDataParams), Z_Construct_UFunction_AZoneGraphAnnotationTestingActor_Trigger_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AZoneGraphAnnotationTestingActor_Trigger, "Trigger" }, // 529607680
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::NewProp_TestingComp = { "TestingComp", nullptr, (EPropertyFlags)0x00240800000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AZoneGraphAnnotationTestingActor, TestingComp), Z_Construct_UClass_UZoneGraphAnnotationTestingComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::NewProp_TestingComp_MetaData), Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::NewProp_TestingComp_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphAnnotationTestingActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationTestingActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneGraphAnnotationTest, UZoneGraphAnnotationTest::StaticClass, TEXT("UZoneGraphAnnotationTest"), &Z_Registration_Info_UClass_UZoneGraphAnnotationTest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphAnnotationTest), 3164635928U) },
		{ Z_Construct_UClass_UZoneGraphAnnotationTestingComponent, UZoneGraphAnnotationTestingComponent::StaticClass, TEXT("UZoneGraphAnnotationTestingComponent"), &Z_Registration_Info_UClass_UZoneGraphAnnotationTestingComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphAnnotationTestingComponent), 3186788990U) },
		{ Z_Construct_UClass_AZoneGraphAnnotationTestingActor, AZoneGraphAnnotationTestingActor::StaticClass, TEXT("AZoneGraphAnnotationTestingActor"), &Z_Registration_Info_UClass_AZoneGraphAnnotationTestingActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AZoneGraphAnnotationTestingActor), 1363546426U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraphAnnotations_Source_ZoneGraphAnnotations_Public_ZoneGraphAnnotationTestingActor_h_3759345105(TEXT("/Script/ZoneGraphAnnotations"),
