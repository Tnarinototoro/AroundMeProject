...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::NewProp_IPAddress = { "IPAddress", nullptr, (EPropertyFlags)0x0010000008000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OSCClient_eventGetSendIPAddress_Parms, IPAddress), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::NewProp_Port = { "Port", nullptr, (EPropertyFlags)0x0010000008000180, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OSCClient_eventGetSendIPAddress_Parms, Port), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOSCClient, nullptr, "GetSendIPAddress", nullptr, nullptr, Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::OSCClient_eventGetSendIPAddress_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOSCClient_GetSendIPAddress_Statics::OSCClient_eventGetSendIPAddress_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::NewProp_Bundle = { "Bundle", nullptr, (EPropertyFlags)0x0010000008000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OSCClient_eventSendOSCBundle_Parms, Bundle), Z_Construct_UScriptStruct_FOSCBundle, METADATA_PARAMS(0, nullptr) }; // 3480562473
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOSCClient, nullptr, "SendOSCBundle", nullptr, nullptr, Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::OSCClient_eventSendOSCBundle_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOSCClient_SendOSCBundle_Statics::OSCClient_eventSendOSCBundle_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000008000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OSCClient_eventSendOSCMessage_Parms, Message), Z_Construct_UScriptStruct_FOSCMessage, METADATA_PARAMS(0, nullptr) }; // 1834276727
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOSCClient, nullptr, "SendOSCMessage", nullptr, nullptr, Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::OSCClient_eventSendOSCMessage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOSCClient_SendOSCMessage_Statics::OSCClient_eventSendOSCMessage_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_IPAddress = { "IPAddress", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OSCClient_eventSetSendIPAddress_Parms, IPAddress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_IPAddress_MetaData), Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_IPAddress_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_Port = { "Port", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OSCClient_eventSetSendIPAddress_Parms, Port), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_Port_MetaData), Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_Port_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(OSCClient_eventSetSendIPAddress_Parms), &Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOSCClient, nullptr, "SetSendIPAddress", nullptr, nullptr, Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::OSCClient_eventSetSendIPAddress_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOSCClient_SetSendIPAddress_Statics::OSCClient_eventSetSendIPAddress_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOSCClient_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UOSCClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOSCClient_GetSendIPAddress, "GetSendIPAddress" }, // 3084526809
		{ &Z_Construct_UFunction_UOSCClient_SendOSCBundle, "SendOSCBundle" }, // 58515418
		{ &Z_Construct_UFunction_UOSCClient_SendOSCMessage, "SendOSCMessage" }, // 3032787140
		{ &Z_Construct_UFunction_UOSCClient_SetSendIPAddress, "SetSendIPAddress" }, // 128258561
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOSCClient_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOSCClient_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOSCClient_Statics::Class_MetaDataParams), Z_Construct_UClass_UOSCClient_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OSC_Source_OSC_Public_OSCClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOSCClient, UOSCClient::StaticClass, TEXT("UOSCClient"), &Z_Registration_Info_UClass_UOSCClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOSCClient), 273096718U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OSC_Source_OSC_Public_OSCClient_h_3985976211(TEXT("/Script/OSC"),
