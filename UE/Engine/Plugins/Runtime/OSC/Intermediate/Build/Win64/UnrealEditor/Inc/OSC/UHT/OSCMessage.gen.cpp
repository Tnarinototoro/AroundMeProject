...
template<> OSC_API UScriptStruct* StaticStruct<FOSCMessage>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOSCMessage_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOSCMessage_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOSCMessage_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OSC_Source_OSC_Public_OSCMessage_h_Statics::ScriptStructInfo[] = {
		{ FOSCMessage::StaticStruct, Z_Construct_UScriptStruct_FOSCMessage_Statics::NewStructOps, TEXT("OSCMessage"), &Z_Registration_Info_UScriptStruct_OSCMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOSCMessage), 1834276727U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OSC_Source_OSC_Public_OSCMessage_h_294636233(TEXT("/Script/OSC"),
		nullptr, 0,
