...
template<> OSC_API UScriptStruct* StaticStruct<FOSCBundle>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOSCBundle_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOSCBundle_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOSCBundle_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OSC_Source_OSC_Public_OSCBundle_h_Statics::ScriptStructInfo[] = {
		{ FOSCBundle::StaticStruct, Z_Construct_UScriptStruct_FOSCBundle_Statics::NewStructOps, TEXT("OSCBundle"), &Z_Registration_Info_UScriptStruct_OSCBundle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOSCBundle), 3480562473U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OSC_Source_OSC_Public_OSCBundle_h_4141995192(TEXT("/Script/OSC"),
		nullptr, 0,
