...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceControllerBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMIDIDeviceControllerBase_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceControllerBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UMIDIDeviceControllerBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MIDIDevice_Source_MIDIDevice_Public_MIDIDeviceControllerBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMIDIDeviceControllerBase, UMIDIDeviceControllerBase::StaticClass, TEXT("UMIDIDeviceControllerBase"), &Z_Registration_Info_UClass_UMIDIDeviceControllerBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMIDIDeviceControllerBase), 4143928911U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MIDIDevice_Source_MIDIDevice_Public_MIDIDeviceControllerBase_h_3320980677(TEXT("/Script/MIDIDevice"),
