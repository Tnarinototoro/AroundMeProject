...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MIDIDevice_EMIDIEventType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MIDIDevice_EMIDIEventType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MIDIDevice_EMIDIEventType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_MIDIDeviceController = { "MIDIDeviceController", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MIDIDevice_eventOnMIDIEvent_Parms, MIDIDeviceController), Z_Construct_UClass_UMIDIDeviceController_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_Timestamp = { "Timestamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MIDIDevice_eventOnMIDIEvent_Parms, Timestamp), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_EventType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_EventType = { "EventType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MIDIDevice_eventOnMIDIEvent_Parms, EventType), Z_Construct_UEnum_MIDIDevice_EMIDIEventType, METADATA_PARAMS(0, nullptr) }; // 2165262085
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_Channel = { "Channel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MIDIDevice_eventOnMIDIEvent_Parms, Channel), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_ControlID = { "ControlID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MIDIDevice_eventOnMIDIEvent_Parms, ControlID), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_Velocity = { "Velocity", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MIDIDevice_eventOnMIDIEvent_Parms, Velocity), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::NewProp_RawEventType = { "RawEventType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_MIDIDevice_eventOnMIDIEvent_Parms, RawEventType), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_MIDIDevice, nullptr, "OnMIDIEvent__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::_Script_MIDIDevice_eventOnMIDIEvent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature_Statics::_Script_MIDIDevice_eventOnMIDIEvent_Parms) < MAX_uint16);
...
void FOnMIDIEvent_DelegateWrapper(const FMulticastScriptDelegate& OnMIDIEvent, UMIDIDeviceController* MIDIDeviceController, int32 Timestamp, EMIDIEventType EventType, int32 Channel, int32 ControlID, int32 Velocity, int32 RawEventType)
{
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceController_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_OnMIDIEvent = { "OnMIDIEvent", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMIDIDeviceController, OnMIDIEvent), Z_Construct_UDelegateFunction_MIDIDevice_OnMIDIEvent__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_OnMIDIEvent_MetaData), Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_OnMIDIEvent_MetaData) }; // 1227455254
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_DeviceID = { "DeviceID", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMIDIDeviceController, DeviceID), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_DeviceID_MetaData), Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_DeviceID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_DeviceName = { "DeviceName", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMIDIDeviceController, DeviceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_DeviceName_MetaData), Z_Construct_UClass_UMIDIDeviceController_Statics::NewProp_DeviceName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMIDIDeviceController_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceController_Statics::Class_MetaDataParams), Z_Construct_UClass_UMIDIDeviceController_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMIDIDeviceController_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MIDIDevice_Source_MIDIDevice_Public_MIDIDeviceController_h_Statics::EnumInfo[] = {
		{ EMIDIEventType_StaticEnum, TEXT("EMIDIEventType"), &Z_Registration_Info_UEnum_EMIDIEventType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2165262085U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MIDIDevice_Source_MIDIDevice_Public_MIDIDeviceController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMIDIDeviceController, UMIDIDeviceController::StaticClass, TEXT("UMIDIDeviceController"), &Z_Registration_Info_UClass_UMIDIDeviceController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMIDIDeviceController), 1551474501U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MIDIDevice_Source_MIDIDevice_Public_MIDIDeviceController_h_1064248188(TEXT("/Script/MIDIDevice"),
