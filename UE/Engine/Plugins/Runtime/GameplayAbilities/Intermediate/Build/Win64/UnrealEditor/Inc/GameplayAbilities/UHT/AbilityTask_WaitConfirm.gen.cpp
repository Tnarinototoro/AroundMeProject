...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitConfirm_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitConfirm_OnConfirmCallback, "OnConfirmCallback" }, // 1963354506
		{ &Z_Construct_UFunction_UAbilityTask_WaitConfirm_WaitConfirm, "WaitConfirm" }, // 69154585
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitConfirm_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitConfirm_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitConfirm, UAbilityTask_WaitConfirm::StaticClass, TEXT("UAbilityTask_WaitConfirm"), &Z_Registration_Info_UClass_UAbilityTask_WaitConfirm, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitConfirm), 2079989490U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitConfirm_h_3352875059(TEXT("/Script/GameplayAbilities"),
