...
void FWaitOverlapDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitOverlapDelegate, FGameplayAbilityTargetDataHandle const& TargetData)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitOverlap_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitOverlap_OnHitCallback, "OnHitCallback" }, // 3667357068
		{ &Z_Construct_UFunction_UAbilityTask_WaitOverlap_WaitForOverlap, "WaitForOverlap" }, // 232298611
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitOverlap_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitOverlap_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitOverlap, UAbilityTask_WaitOverlap::StaticClass, TEXT("UAbilityTask_WaitOverlap"), &Z_Registration_Info_UClass_UAbilityTask_WaitOverlap, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitOverlap), 1706554811U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitOverlap_h_2604771522(TEXT("/Script/GameplayAbilities"),
