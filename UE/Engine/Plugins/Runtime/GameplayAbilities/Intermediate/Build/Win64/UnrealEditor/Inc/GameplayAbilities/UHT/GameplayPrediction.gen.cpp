...
template<> GAMEPLAYABILITIES_API UScriptStruct* StaticStruct<FPredictionKey>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_PredictiveConnection = { "PredictiveConnection", nullptr, (EPropertyFlags)0x0014000080000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPredictionKey, PredictiveConnection), Z_Construct_UClass_UPackageMap, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_PredictiveConnection_MetaData), Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_PredictiveConnection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInt16PropertyParams Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_Current = { "Current", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPredictionKey, Current), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_Current_MetaData), Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_Current_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInt16PropertyParams Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_Base = { "Base", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPredictionKey, Base), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_Base_MetaData), Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_Base_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_bIsStale = { "bIsStale", nullptr, (EPropertyFlags)0x0010000080000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FPredictionKey), &Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_bIsStale_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_bIsStale_MetaData), Z_Construct_UScriptStruct_FPredictionKey_Statics::NewProp_bIsStale_MetaData) };
#if WITH_METADATA
...
template<> GAMEPLAYABILITIES_API UScriptStruct* StaticStruct<FReplicatedPredictionKeyMap>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FReplicatedPredictionKeyMap_Statics::NewProp_PredictionKeys_Inner = { "PredictionKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FReplicatedPredictionKeyItem, METADATA_PARAMS(0, nullptr) }; // 3058794481
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_GameplayPrediction_h_Statics::ScriptStructInfo[] = {
		{ FPredictionKey::StaticStruct, Z_Construct_UScriptStruct_FPredictionKey_Statics::NewStructOps, TEXT("PredictionKey"), &Z_Registration_Info_UScriptStruct_PredictionKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPredictionKey), 600072167U) },
		...
		{ FReplicatedPredictionKeyMap::StaticStruct, Z_Construct_UScriptStruct_FReplicatedPredictionKeyMap_Statics::NewStructOps, TEXT("ReplicatedPredictionKeyMap"), &Z_Registration_Info_UScriptStruct_ReplicatedPredictionKeyMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FReplicatedPredictionKeyMap), 1806616420U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_GameplayPrediction_h_311297575(TEXT("/Script/GameplayAbilities"),
		nullptr, 0,
