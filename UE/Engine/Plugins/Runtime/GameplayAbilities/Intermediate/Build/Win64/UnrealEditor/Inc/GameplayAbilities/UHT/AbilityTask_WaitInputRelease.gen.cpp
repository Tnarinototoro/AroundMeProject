...
void FInputReleaseDelegate_DelegateWrapper(const FMulticastScriptDelegate& InputReleaseDelegate, float TimeHeld)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitInputRelease_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitInputRelease_OnReleaseCallback, "OnReleaseCallback" }, // 3583110172
		{ &Z_Construct_UFunction_UAbilityTask_WaitInputRelease_WaitInputRelease, "WaitInputRelease" }, // 1667687460
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitInputRelease_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitInputRelease_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitInputRelease, UAbilityTask_WaitInputRelease::StaticClass, TEXT("UAbilityTask_WaitInputRelease"), &Z_Registration_Info_UClass_UAbilityTask_WaitInputRelease, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitInputRelease), 3434261931U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitInputRelease_h_2353488601(TEXT("/Script/GameplayAbilities"),
