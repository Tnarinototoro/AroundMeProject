...
void FWaitAbilityCommitDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitAbilityCommitDelegate, UGameplayAbility* ActivatedAbility)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitAbilityCommit_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitAbilityCommit_OnAbilityCommit, "OnAbilityCommit" }, // 1480520983
		{ &Z_Construct_UFunction_UAbilityTask_WaitAbilityCommit_WaitForAbilityCommit, "WaitForAbilityCommit" }, // 231739413
		{ &Z_Construct_UFunction_UAbilityTask_WaitAbilityCommit_WaitForAbilityCommit_Query, "WaitForAbilityCommit_Query" }, // 3580475610
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitAbilityCommit_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitAbilityCommit_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitAbilityCommit, UAbilityTask_WaitAbilityCommit::StaticClass, TEXT("UAbilityTask_WaitAbilityCommit"), &Z_Registration_Info_UClass_UAbilityTask_WaitAbilityCommit, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitAbilityCommit), 570349027U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitAbilityCommit_h_1133848837(TEXT("/Script/GameplayAbilities"),
