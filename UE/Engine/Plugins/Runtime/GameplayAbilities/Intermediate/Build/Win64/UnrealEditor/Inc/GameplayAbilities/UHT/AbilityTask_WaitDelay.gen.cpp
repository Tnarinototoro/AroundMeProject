...
void FWaitDelayDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitDelayDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitDelay_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitDelay_WaitDelay, "WaitDelay" }, // 3624688606
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitDelay_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAbilityTask_WaitDelay_Statics::NewProp_OnFinish = { "OnFinish", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_WaitDelay, OnFinish), Z_Construct_UDelegateFunction_GameplayAbilities_WaitDelayDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitDelay_Statics::NewProp_OnFinish_MetaData), Z_Construct_UClass_UAbilityTask_WaitDelay_Statics::NewProp_OnFinish_MetaData) }; // 1144125248
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitDelay_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitDelay, UAbilityTask_WaitDelay::StaticClass, TEXT("UAbilityTask_WaitDelay"), &Z_Registration_Info_UClass_UAbilityTask_WaitDelay, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitDelay), 1438551726U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitDelay_h_1597267318(TEXT("/Script/GameplayAbilities"),
