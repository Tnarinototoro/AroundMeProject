...
void FNetworkSyncDelegate_DelegateWrapper(const FMulticastScriptDelegate& NetworkSyncDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_NetworkSyncPoint_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_NetworkSyncPoint_OnSignalCallback, "OnSignalCallback" }, // 4065571039
		{ &Z_Construct_UFunction_UAbilityTask_NetworkSyncPoint_WaitNetSync, "WaitNetSync" }, // 818720713
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_NetworkSyncPoint_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_NetworkSyncPoint_h_Statics::EnumInfo[] = {
		{ EAbilityTaskNetSyncType_StaticEnum, TEXT("EAbilityTaskNetSyncType"), &Z_Registration_Info_UEnum_EAbilityTaskNetSyncType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 711440870U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_NetworkSyncPoint_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_NetworkSyncPoint, UAbilityTask_NetworkSyncPoint::StaticClass, TEXT("UAbilityTask_NetworkSyncPoint"), &Z_Registration_Info_UClass_UAbilityTask_NetworkSyncPoint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_NetworkSyncPoint), 1580695420U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_NetworkSyncPoint_h_3841517052(TEXT("/Script/GameplayAbilities"),
