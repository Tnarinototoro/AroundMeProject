...
void FSpawnActorDelegate_DelegateWrapper(const FMulticastScriptDelegate& SpawnActorDelegate, AActor* SpawnedActor)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_SpawnActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_SpawnActor_BeginSpawningActor, "BeginSpawningActor" }, // 1759433211
		{ &Z_Construct_UFunction_UAbilityTask_SpawnActor_FinishSpawningActor, "FinishSpawningActor" }, // 1989248737
		{ &Z_Construct_UFunction_UAbilityTask_SpawnActor_SpawnActor, "SpawnActor" }, // 861319792
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_SpawnActor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAbilityTask_SpawnActor_Statics::NewProp_DidNotSpawn = { "DidNotSpawn", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_SpawnActor, DidNotSpawn), Z_Construct_UDelegateFunction_GameplayAbilities_SpawnActorDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_SpawnActor_Statics::NewProp_DidNotSpawn_MetaData), Z_Construct_UClass_UAbilityTask_SpawnActor_Statics::NewProp_DidNotSpawn_MetaData) }; // 3109435132
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_SpawnActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_SpawnActor, UAbilityTask_SpawnActor::StaticClass, TEXT("UAbilityTask_SpawnActor"), &Z_Registration_Info_UClass_UAbilityTask_SpawnActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_SpawnActor), 3556434147U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_SpawnActor_h_1859696385(TEXT("/Script/GameplayAbilities"),
