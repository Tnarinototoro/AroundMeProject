...
void FAsyncWaitGameplayTagQueryDelegate_DelegateWrapper(const FMulticastScriptDelegate& AsyncWaitGameplayTagQueryDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityAsync_WaitGameplayTagQuery_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityAsync_WaitGameplayTagQuery_WaitGameplayTagQueryOnActor, "WaitGameplayTagQueryOnActor" }, // 176258614
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityAsync_WaitGameplayTagQuery_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Async_AbilityAsync_WaitGameplayTagQuery_h_3737599923(TEXT("/Script/GameplayAbilities"),
