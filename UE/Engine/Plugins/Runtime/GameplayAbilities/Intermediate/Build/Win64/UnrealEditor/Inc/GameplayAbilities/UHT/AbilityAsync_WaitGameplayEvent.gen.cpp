...
void UAbilityAsync_WaitGameplayEvent::FEventReceivedDelegate_DelegateWrapper(const FMulticastScriptDelegate& EventReceivedDelegate, FGameplayEventData Payload)
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAbilityAsync_WaitGameplayEvent_WaitGameplayEventToActor_Statics::NewProp_EventTag = { "EventTag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AbilityAsync_WaitGameplayEvent_eventWaitGameplayEventToActor_Parms, EventTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 2083603574
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityAsync_WaitGameplayEvent_Statics::FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_UAbilityAsync_WaitGameplayEvent_EventReceivedDelegate__DelegateSignature, "EventReceivedDelegate__DelegateSignature" }, // 593266645
		{ &Z_Construct_UFunction_UAbilityAsync_WaitGameplayEvent_WaitGameplayEventToActor, "WaitGameplayEventToActor" }, // 372252499
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityAsync_WaitGameplayEvent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Async_AbilityAsync_WaitGameplayEvent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityAsync_WaitGameplayEvent, UAbilityAsync_WaitGameplayEvent::StaticClass, TEXT("UAbilityAsync_WaitGameplayEvent"), &Z_Registration_Info_UClass_UAbilityAsync_WaitGameplayEvent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityAsync_WaitGameplayEvent), 2235528159U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Async_AbilityAsync_WaitGameplayEvent_h_839211369(TEXT("/Script/GameplayAbilities"),
