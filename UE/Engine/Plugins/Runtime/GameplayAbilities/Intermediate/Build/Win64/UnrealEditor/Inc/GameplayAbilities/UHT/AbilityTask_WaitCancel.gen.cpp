...
void FWaitCancelDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitCancelDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitCancel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitCancel_OnCancelCallback, "OnCancelCallback" }, // 3839670796
		{ &Z_Construct_UFunction_UAbilityTask_WaitCancel_OnLocalCancelCallback, "OnLocalCancelCallback" }, // 3011007530
		{ &Z_Construct_UFunction_UAbilityTask_WaitCancel_WaitCancel, "WaitCancel" }, // 4119406220
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitCancel_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitCancel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitCancel, UAbilityTask_WaitCancel::StaticClass, TEXT("UAbilityTask_WaitCancel"), &Z_Registration_Info_UClass_UAbilityTask_WaitCancel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitCancel), 3834209667U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitCancel_h_3853417752(TEXT("/Script/GameplayAbilities"),
