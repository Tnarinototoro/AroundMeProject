...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UClass_AGameplayAbilityTargetActor_ActorPlacement_Statics::NewProp_PlacedActorClass = { "PlacedActorClass", nullptr, (EPropertyFlags)0x0015000000000005, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameplayAbilityTargetActor_ActorPlacement, PlacedActorClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGameplayAbilityTargetActor_ActorPlacement_Statics::NewProp_PlacedActorClass_MetaData), Z_Construct_UClass_AGameplayAbilityTargetActor_ActorPlacement_Statics::NewProp_PlacedActorClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AGameplayAbilityTargetActor_ActorPlacement_Statics::NewProp_PlacedActorMaterial = { "PlacedActorMaterial", nullptr, (EPropertyFlags)0x0015000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGameplayAbilityTargetActor_ActorPlacement, PlacedActorMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGameplayAbilityTargetActor_ActorPlacement_Statics::NewProp_PlacedActorMaterial_MetaData), Z_Construct_UClass_AGameplayAbilityTargetActor_ActorPlacement_Statics::NewProp_PlacedActorMaterial_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_GameplayAbilityTargetActor_ActorPlacement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGameplayAbilityTargetActor_ActorPlacement, AGameplayAbilityTargetActor_ActorPlacement::StaticClass, TEXT("AGameplayAbilityTargetActor_ActorPlacement"), &Z_Registration_Info_UClass_AGameplayAbilityTargetActor_ActorPlacement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameplayAbilityTargetActor_ActorPlacement), 1908543634U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_GameplayAbilityTargetActor_ActorPlacement_h_1337517462(TEXT("/Script/GameplayAbilities"),
