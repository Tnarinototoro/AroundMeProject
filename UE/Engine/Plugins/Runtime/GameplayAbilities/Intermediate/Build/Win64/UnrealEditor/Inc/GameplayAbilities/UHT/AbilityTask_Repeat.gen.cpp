...
void FRepeatedActionDelegate_DelegateWrapper(const FMulticastScriptDelegate& RepeatedActionDelegate, int32 ActionNumber)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_Repeat_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_Repeat_RepeatAction, "RepeatAction" }, // 2678977004
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_Repeat_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_Repeat_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_Repeat, UAbilityTask_Repeat::StaticClass, TEXT("UAbilityTask_Repeat"), &Z_Registration_Info_UClass_UAbilityTask_Repeat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_Repeat), 1306773721U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_Repeat_h_1603309939(TEXT("/Script/GameplayAbilities"),
