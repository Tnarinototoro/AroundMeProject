...
void UAbilityAsync_WaitAttributeChanged::FAsyncWaitAttributeChangedDelegate_DelegateWrapper(const FMulticastScriptDelegate& AsyncWaitAttributeChangedDelegate, FGameplayAttribute Attribute, float NewValue, float OldValue)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityAsync_WaitAttributeChanged_Statics::FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_UAbilityAsync_WaitAttributeChanged_AsyncWaitAttributeChangedDelegate__DelegateSignature, "AsyncWaitAttributeChangedDelegate__DelegateSignature" }, // 4157283930
		{ &Z_Construct_UFunction_UAbilityAsync_WaitAttributeChanged_WaitForAttributeChanged, "WaitForAttributeChanged" }, // 3213181421
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityAsync_WaitAttributeChanged_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Async_AbilityAsync_WaitAttributeChanged_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityAsync_WaitAttributeChanged, UAbilityAsync_WaitAttributeChanged::StaticClass, TEXT("UAbilityAsync_WaitAttributeChanged"), &Z_Registration_Info_UClass_UAbilityAsync_WaitAttributeChanged, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityAsync_WaitAttributeChanged), 2292733592U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Async_AbilityAsync_WaitAttributeChanged_h_3125921070(TEXT("/Script/GameplayAbilities"),
