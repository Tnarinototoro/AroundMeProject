...
void FInputPressDelegate_DelegateWrapper(const FMulticastScriptDelegate& InputPressDelegate, float TimeWaited)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitInputPress_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitInputPress_OnPressCallback, "OnPressCallback" }, // 3770360320
		{ &Z_Construct_UFunction_UAbilityTask_WaitInputPress_WaitInputPress, "WaitInputPress" }, // 3782764920
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitInputPress_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAbilityTask_WaitInputPress_Statics::NewProp_OnPress = { "OnPress", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_WaitInputPress, OnPress), Z_Construct_UDelegateFunction_GameplayAbilities_InputPressDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitInputPress_Statics::NewProp_OnPress_MetaData), Z_Construct_UClass_UAbilityTask_WaitInputPress_Statics::NewProp_OnPress_MetaData) }; // 455975456
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitInputPress_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitInputPress, UAbilityTask_WaitInputPress::StaticClass, TEXT("UAbilityTask_WaitInputPress"), &Z_Registration_Info_UClass_UAbilityTask_WaitInputPress, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitInputPress), 1045427461U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitInputPress_h_2270821915(TEXT("/Script/GameplayAbilities"),
