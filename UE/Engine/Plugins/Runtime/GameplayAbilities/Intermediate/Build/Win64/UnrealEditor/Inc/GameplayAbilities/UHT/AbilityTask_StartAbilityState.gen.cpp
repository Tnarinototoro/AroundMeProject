...
void FAbilityStateDelegate_DelegateWrapper(const FMulticastScriptDelegate& AbilityStateDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_StartAbilityState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_StartAbilityState_StartAbilityState, "StartAbilityState" }, // 2771853109
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_StartAbilityState_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_StartAbilityState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_StartAbilityState, UAbilityTask_StartAbilityState::StaticClass, TEXT("UAbilityTask_StartAbilityState"), &Z_Registration_Info_UClass_UAbilityTask_StartAbilityState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_StartAbilityState), 4020557753U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_StartAbilityState_h_2478080435(TEXT("/Script/GameplayAbilities"),
