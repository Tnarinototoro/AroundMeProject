...
void FWaitGameplayTagDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitGameplayTagDelegate)
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAbilityTask_WaitGameplayTagAdded_WaitGameplayTagAdd_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AbilityTask_WaitGameplayTagAdded_eventWaitGameplayTagAdd_Parms, Tag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 2083603574
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitGameplayTagAdded_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitGameplayTagAdded_WaitGameplayTagAdd, "WaitGameplayTagAdd" }, // 193722868
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitGameplayTagAdded_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitGameplayTagRemoved_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitGameplayTagRemoved_WaitGameplayTagRemove, "WaitGameplayTagRemove" }, // 1612190944
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitGameplayTagRemoved_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitGameplayTag_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitGameplayTagAdded, UAbilityTask_WaitGameplayTagAdded::StaticClass, TEXT("UAbilityTask_WaitGameplayTagAdded"), &Z_Registration_Info_UClass_UAbilityTask_WaitGameplayTagAdded, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitGameplayTagAdded), 1248531454U) },
		{ Z_Construct_UClass_UAbilityTask_WaitGameplayTagRemoved, UAbilityTask_WaitGameplayTagRemoved::StaticClass, TEXT("UAbilityTask_WaitGameplayTagRemoved"), &Z_Registration_Info_UClass_UAbilityTask_WaitGameplayTagRemoved, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitGameplayTagRemoved), 3056778290U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitGameplayTag_h_2501733679(TEXT("/Script/GameplayAbilities"),
