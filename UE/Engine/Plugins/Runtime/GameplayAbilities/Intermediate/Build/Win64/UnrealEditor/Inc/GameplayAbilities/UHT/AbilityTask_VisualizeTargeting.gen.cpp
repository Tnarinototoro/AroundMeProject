...
void FVisualizeTargetingDelegate_DelegateWrapper(const FMulticastScriptDelegate& VisualizeTargetingDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_VisualizeTargeting_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_VisualizeTargeting_BeginSpawningActor, "BeginSpawningActor" }, // 246912749
		{ &Z_Construct_UFunction_UAbilityTask_VisualizeTargeting_FinishSpawningActor, "FinishSpawningActor" }, // 2217781613
		{ &Z_Construct_UFunction_UAbilityTask_VisualizeTargeting_VisualizeTargeting, "VisualizeTargeting" }, // 123194729
		{ &Z_Construct_UFunction_UAbilityTask_VisualizeTargeting_VisualizeTargetingUsingActor, "VisualizeTargetingUsingActor" }, // 1156514848
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_VisualizeTargeting_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_VisualizeTargeting_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_VisualizeTargeting, UAbilityTask_VisualizeTargeting::StaticClass, TEXT("UAbilityTask_VisualizeTargeting"), &Z_Registration_Info_UClass_UAbilityTask_VisualizeTargeting, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_VisualizeTargeting), 2035573686U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_VisualizeTargeting_h_3233079289(TEXT("/Script/GameplayAbilities"),
