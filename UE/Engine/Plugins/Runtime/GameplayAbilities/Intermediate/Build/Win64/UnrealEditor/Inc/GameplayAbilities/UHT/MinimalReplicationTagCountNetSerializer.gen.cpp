...
template<> GAMEPLAYABILITIES_API UScriptStruct* StaticStruct<FMinimalReplicationTagCountMapNetSerializerConfig>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Serialization_MinimalReplicationTagCountNetSerializer_h_Statics::ScriptStructInfo[] = {
		{ FMinimalReplicationTagCountMapNetSerializerConfig::StaticStruct, Z_Construct_UScriptStruct_FMinimalReplicationTagCountMapNetSerializerConfig_Statics::NewStructOps, TEXT("MinimalReplicationTagCountMapNetSerializerConfig"), &Z_Registration_Info_UScriptStruct_MinimalReplicationTagCountMapNetSerializerConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMinimalReplicationTagCountMapNetSerializerConfig), 2588841260U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Serialization_MinimalReplicationTagCountNetSerializer_h_2976927057(TEXT("/Script/GameplayAbilities"),
		nullptr, 0,
