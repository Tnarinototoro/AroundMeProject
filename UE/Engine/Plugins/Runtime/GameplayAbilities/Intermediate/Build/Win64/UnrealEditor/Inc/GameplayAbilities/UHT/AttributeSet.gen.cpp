...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FGameplayAttributeData_Statics::NewProp_BaseValue = { "BaseValue", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayAttributeData, BaseValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayAttributeData_Statics::NewProp_BaseValue_MetaData), Z_Construct_UScriptStruct_FGameplayAttributeData_Statics::NewProp_BaseValue_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FGameplayAttributeData_Statics::NewProp_CurrentValue = { "CurrentValue", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayAttributeData, CurrentValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayAttributeData_Statics::NewProp_CurrentValue_MetaData), Z_Construct_UScriptStruct_FGameplayAttributeData_Statics::NewProp_CurrentValue_MetaData) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FGameplayAttribute_Statics::NewProp_AttributeName = { "AttributeName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayAttribute, AttributeName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayAttribute_Statics::NewProp_AttributeName_MetaData), Z_Construct_UScriptStruct_FGameplayAttribute_Statics::NewProp_AttributeName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameplayAttribute_Statics::NewProp_AttributeOwner = { "AttributeOwner", nullptr, (EPropertyFlags)0x0044000000020001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameplayAttribute, AttributeOwner), Z_Construct_UClass_UStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayAttribute_Statics::NewProp_AttributeOwner_MetaData), Z_Construct_UScriptStruct_FGameplayAttribute_Statics::NewProp_AttributeOwner_MetaData) };
...
template<> GAMEPLAYABILITIES_API UScriptStruct* StaticStruct<FAttributeMetaData>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_BaseValue = { "BaseValue", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAttributeMetaData, BaseValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_BaseValue_MetaData), Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_BaseValue_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_MinValue = { "MinValue", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAttributeMetaData, MinValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_MinValue_MetaData), Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_MinValue_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_DerivedAttributeInfo = { "DerivedAttributeInfo", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAttributeMetaData, DerivedAttributeInfo), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_DerivedAttributeInfo_MetaData), Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_DerivedAttributeInfo_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_bCanStack = { "bCanStack", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAttributeMetaData), &Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_bCanStack_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_bCanStack_MetaData), Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewProp_bCanStack_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_AttributeSet_h_Statics::ScriptStructInfo[] = {
		{ FGameplayAttributeData::StaticStruct, Z_Construct_UScriptStruct_FGameplayAttributeData_Statics::NewStructOps, TEXT("GameplayAttributeData"), &Z_Registration_Info_UScriptStruct_GameplayAttributeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayAttributeData), 2151517668U) },
		{ FGameplayAttribute::StaticStruct, Z_Construct_UScriptStruct_FGameplayAttribute_Statics::NewStructOps, TEXT("GameplayAttribute"), &Z_Registration_Info_UScriptStruct_GameplayAttribute, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayAttribute), 359123813U) },
		{ FAttributeMetaData::StaticStruct, Z_Construct_UScriptStruct_FAttributeMetaData_Statics::NewStructOps, TEXT("AttributeMetaData"), &Z_Registration_Info_UScriptStruct_AttributeMetaData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAttributeMetaData), 56549865U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_AttributeSet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAttributeSet, UAttributeSet::StaticClass, TEXT("UAttributeSet"), &Z_Registration_Info_UClass_UAttributeSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAttributeSet), 2502815421U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_AttributeSet_h_1039967157(TEXT("/Script/GameplayAbilities"),
