...
void FWaitVelocityChangeDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitVelocityChangeDelegate)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_WaitVelocityChange_CreateWaitVelocityChange, "CreateWaitVelocityChange" }, // 757803055
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::NewProp_OnVelocityChage = { "OnVelocityChage", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_WaitVelocityChange, OnVelocityChage), Z_Construct_UDelegateFunction_GameplayAbilities_WaitVelocityChangeDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::NewProp_OnVelocityChage_MetaData), Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::NewProp_OnVelocityChage_MetaData) }; // 3812863058
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::NewProp_CachedMovementComponent = { "CachedMovementComponent", nullptr, (EPropertyFlags)0x0024080000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAbilityTask_WaitVelocityChange, CachedMovementComponent), Z_Construct_UClass_UMovementComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::NewProp_CachedMovementComponent_MetaData), Z_Construct_UClass_UAbilityTask_WaitVelocityChange_Statics::NewProp_CachedMovementComponent_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitVelocityChange_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_WaitVelocityChange, UAbilityTask_WaitVelocityChange::StaticClass, TEXT("UAbilityTask_WaitVelocityChange"), &Z_Registration_Info_UClass_UAbilityTask_WaitVelocityChange, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_WaitVelocityChange), 2966845085U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GameplayAbilities_Source_GameplayAbilities_Public_Abilities_Tasks_AbilityTask_WaitVelocityChange_h_3312949899(TEXT("/Script/GameplayAbilities"),
