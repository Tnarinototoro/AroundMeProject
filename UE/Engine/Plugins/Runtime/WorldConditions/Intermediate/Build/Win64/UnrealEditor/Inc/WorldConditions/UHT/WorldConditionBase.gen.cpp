...
template<> WORLDCONDITIONS_API UScriptStruct* StaticStruct<FWorldConditionBase>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_bInvert = { "bInvert", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FWorldConditionBase), &Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_bInvert_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_bInvert_MetaData), Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_bInvert_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_Operator = { "Operator", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWorldConditionBase, Operator), Z_Construct_UEnum_WorldConditions_EWorldConditionOperator, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_Operator_MetaData), Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_Operator_MetaData) }; // 3475399933
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_NextExpressionDepth = { "NextExpressionDepth", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWorldConditionBase, NextExpressionDepth), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_NextExpressionDepth_MetaData), Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewProp_NextExpressionDepth_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWorldConditionBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldConditionBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWorldConditionBase_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldConditionBase_Statics::PropPointers) < 2048);
...
template<> WORLDCONDITIONS_API UScriptStruct* StaticStruct<FWorldConditionCommonBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWorldConditionCommonBase_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldConditionCommonBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWorldConditionCommonBase_Statics::Struct_MetaDataParams)
	};
...
template<> WORLDCONDITIONS_API UScriptStruct* StaticStruct<FWorldConditionCommonActorBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWorldConditionCommonActorBase_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldConditionCommonActorBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWorldConditionCommonActorBase_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WorldConditions_Source_WorldConditions_Public_WorldConditionBase_h_Statics::ScriptStructInfo[] = {
		{ FWorldConditionBase::StaticStruct, Z_Construct_UScriptStruct_FWorldConditionBase_Statics::NewStructOps, TEXT("WorldConditionBase"), &Z_Registration_Info_UScriptStruct_WorldConditionBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWorldConditionBase), 2251540108U) },
		{ FWorldConditionCommonBase::StaticStruct, Z_Construct_UScriptStruct_FWorldConditionCommonBase_Statics::NewStructOps, TEXT("WorldConditionCommonBase"), &Z_Registration_Info_UScriptStruct_WorldConditionCommonBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWorldConditionCommonBase), 1450220867U) },
		{ FWorldConditionCommonActorBase::StaticStruct, Z_Construct_UScriptStruct_FWorldConditionCommonActorBase_Statics::NewStructOps, TEXT("WorldConditionCommonActorBase"), &Z_Registration_Info_UScriptStruct_WorldConditionCommonActorBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWorldConditionCommonActorBase), 802503279U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WorldConditions_Source_WorldConditions_Public_WorldConditionBase_h_3584234673(TEXT("/Script/WorldConditions"),
		nullptr, 0,
