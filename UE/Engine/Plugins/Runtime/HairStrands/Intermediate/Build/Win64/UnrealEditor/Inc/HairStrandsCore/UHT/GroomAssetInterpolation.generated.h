...
#define FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_GroomAssetInterpolation_h_71_GENERATED_BODY \
...
#define FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_GroomAssetInterpolation_h_116_GENERATED_BODY \
...
#define FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_GroomAssetInterpolation_h_134_GENERATED_BODY \
...
#define FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_GroomAssetInterpolation_h_180_GENERATED_BODY \
...
#define FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_GroomAssetInterpolation_h_221_GENERATED_BODY \
...
#define FOREACH_ENUM_EGROOMLODTYPE(op) \
	op(EGroomLODType::Manual) \
	op(EGroomLODType::Auto) 

enum class EGroomLODType : uint8;
template<> struct TIsUEnumClass<EGroomLODType> { enum { Value = true }; };
