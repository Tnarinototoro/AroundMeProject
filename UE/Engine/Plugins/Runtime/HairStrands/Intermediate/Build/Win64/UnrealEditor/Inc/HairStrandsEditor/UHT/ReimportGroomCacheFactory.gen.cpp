...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UReimportGroomCacheFactory);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UReimportGroomCacheFactory_Statics::Class_MetaDataParams[] = {
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_ReimportGroomCacheFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_ReimportGroomCacheFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReimportGroomCacheFactory, UReimportGroomCacheFactory::StaticClass, TEXT("UReimportGroomCacheFactory"), &Z_Registration_Info_UClass_UReimportGroomCacheFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReimportGroomCacheFactory), 1149439891U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_ReimportGroomCacheFactory_h_2423669432(TEXT("/Script/HairStrandsEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_ReimportGroomCacheFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_ReimportGroomCacheFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
