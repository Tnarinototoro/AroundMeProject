...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGroomAssetImportData_Statics::NewProp_ImportOptions = { "ImportOptions", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGroomAssetImportData, ImportOptions), Z_Construct_UClass_UGroomImportOptions_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGroomAssetImportData_Statics::NewProp_ImportOptions_MetaData), Z_Construct_UClass_UGroomAssetImportData_Statics::NewProp_ImportOptions_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_GroomAssetImportData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGroomAssetImportData, UGroomAssetImportData::StaticClass, TEXT("UGroomAssetImportData"), &Z_Registration_Info_UClass_UGroomAssetImportData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGroomAssetImportData), 1168239767U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_GroomAssetImportData_h_1607318876(TEXT("/Script/HairStrandsCore"),
