...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_GroomCacheAsset);
	UClass* Z_Construct_UClass_UAssetDefinition_GroomCacheAsset_NoRegister()
	{
		return UAssetDefinition_GroomCacheAsset::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_GroomCacheAsset_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "GroomCacheActions.h" },
		{ "ModuleRelativePath", "Public/GroomCacheActions.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_GroomCacheAsset_Statics::StaticCppClassTypeInfo = {
	...
	template<> HAIRSTRANDSEDITOR_API UClass* StaticClass<UAssetDefinition_GroomCacheAsset>()
	{
		return UAssetDefinition_GroomCacheAsset::StaticClass();
	}
	UAssetDefinition_GroomCacheAsset::UAssetDefinition_GroomCacheAsset() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_GroomCacheAsset);
	UAssetDefinition_GroomCacheAsset::~UAssetDefinition_GroomCacheAsset() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_GroomCacheActions_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_GroomCacheActions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_GroomCacheAsset, UAssetDefinition_GroomCacheAsset::StaticClass, TEXT("UAssetDefinition_GroomCacheAsset"), &Z_Registration_Info_UClass_UAssetDefinition_GroomCacheAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_GroomCacheAsset), 957566070U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_GroomCacheActions_h_2760778557(TEXT("/Script/HairStrandsEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_GroomCacheActions_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsEditor_Public_GroomCacheActions_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
