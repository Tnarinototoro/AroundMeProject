...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneGroomCacheSectionTemplateParameters_Statics::NewProp_SectionEndTime = { "SectionEndTime", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneGroomCacheSectionTemplateParameters, SectionEndTime), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGroomCacheSectionTemplateParameters_Statics::NewProp_SectionEndTime_MetaData), Z_Construct_UScriptStruct_FMovieSceneGroomCacheSectionTemplateParameters_Statics::NewProp_SectionEndTime_MetaData) };
...
template<> HAIRSTRANDSCORE_API UScriptStruct* StaticStruct<FMovieSceneGroomCacheSectionTemplate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Private_MovieSceneGroomCacheTemplate_h_Statics::ScriptStructInfo[] = {
		...
		{ FMovieSceneGroomCacheSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneGroomCacheSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneGroomCacheSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneGroomCacheSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneGroomCacheSectionTemplate), 2415227408U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Private_MovieSceneGroomCacheTemplate_h_1565108004(TEXT("/Script/HairStrandsCore"),
		nullptr, 0,
