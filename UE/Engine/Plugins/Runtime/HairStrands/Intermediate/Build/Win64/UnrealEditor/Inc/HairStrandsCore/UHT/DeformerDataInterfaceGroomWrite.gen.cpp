...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOptimusGroomWriteDataProvider_Statics::NewProp_GroomComponent = { "GroomComponent", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusGroomWriteDataProvider, GroomComponent), Z_Construct_UClass_UGroomComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusGroomWriteDataProvider_Statics::NewProp_GroomComponent_MetaData), Z_Construct_UClass_UOptimusGroomWriteDataProvider_Statics::NewProp_GroomComponent_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Private_Deformer_DeformerDataInterfaceGroomWrite_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusGroomWriteDataInterface, UOptimusGroomWriteDataInterface::StaticClass, TEXT("UOptimusGroomWriteDataInterface"), &Z_Registration_Info_UClass_UOptimusGroomWriteDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusGroomWriteDataInterface), 2674543941U) },
		{ Z_Construct_UClass_UOptimusGroomWriteDataProvider, UOptimusGroomWriteDataProvider::StaticClass, TEXT("UOptimusGroomWriteDataProvider"), &Z_Registration_Info_UClass_UOptimusGroomWriteDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusGroomWriteDataProvider), 3780900221U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Private_Deformer_DeformerDataInterfaceGroomWrite_h_662134841(TEXT("/Script/HairStrandsCore"),
