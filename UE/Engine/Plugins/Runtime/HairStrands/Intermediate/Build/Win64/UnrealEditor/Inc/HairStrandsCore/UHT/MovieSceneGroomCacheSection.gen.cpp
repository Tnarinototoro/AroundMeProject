...
template<> HAIRSTRANDSCORE_API UScriptStruct* StaticStruct<FMovieSceneGroomCacheParams>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMovieSceneGroomCacheParams_Statics::NewProp_GroomCache = { "GroomCache", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneGroomCacheParams, GroomCache), Z_Construct_UClass_UGroomCache_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGroomCacheParams_Statics::NewProp_GroomCache_MetaData), Z_Construct_UScriptStruct_FMovieSceneGroomCacheParams_Statics::NewProp_GroomCache_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneGroomCacheParams_Statics::NewProp_StartFrameOffset = { "StartFrameOffset", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneGroomCacheParams, StartFrameOffset), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGroomCacheParams_Statics::NewProp_StartFrameOffset_MetaData), Z_Construct_UScriptStruct_FMovieSceneGroomCacheParams_Statics::NewProp_StartFrameOffset_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_MovieSceneGroomCacheSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneGroomCacheSection, UMovieSceneGroomCacheSection::StaticClass, TEXT("UMovieSceneGroomCacheSection"), &Z_Registration_Info_UClass_UMovieSceneGroomCacheSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneGroomCacheSection), 294304808U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Public_MovieSceneGroomCacheSection_h_3769393229(TEXT("/Script/HairStrandsCore"),
