...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOptimusGroomDataProvider_Statics::NewProp_Groom = { "Groom", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOptimusGroomDataProvider, Groom), Z_Construct_UClass_UGroomComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptimusGroomDataProvider_Statics::NewProp_Groom_MetaData), Z_Construct_UClass_UOptimusGroomDataProvider_Statics::NewProp_Groom_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Private_Deformer_DeformerDataInterfaceGroom_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptimusGroomDataInterface, UOptimusGroomDataInterface::StaticClass, TEXT("UOptimusGroomDataInterface"), &Z_Registration_Info_UClass_UOptimusGroomDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusGroomDataInterface), 3522362698U) },
		{ Z_Construct_UClass_UOptimusGroomDataProvider, UOptimusGroomDataProvider::StaticClass, TEXT("UOptimusGroomDataProvider"), &Z_Registration_Info_UClass_UOptimusGroomDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptimusGroomDataProvider), 3637502241U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HairStrands_Source_HairStrandsCore_Private_Deformer_DeformerDataInterfaceGroom_h_1877093048(TEXT("/Script/HairStrandsCore"),
