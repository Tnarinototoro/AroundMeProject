...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryLandscape_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusAudioGeometryLandscape_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryLandscape_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusAudioGeometryLandscape_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioGeometryLandscape_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusAudioGeometryLandscape, UOculusAudioGeometryLandscape::StaticClass, TEXT("UOculusAudioGeometryLandscape"), &Z_Registration_Info_UClass_UOculusAudioGeometryLandscape, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusAudioGeometryLandscape), 429479927U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioGeometryLandscape_h_2141336468(TEXT("/Script/OculusAudio"),
