...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryBSP_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusAudioGeometryBSP_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryBSP_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusAudioGeometryBSP_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioGeometryBSP_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusAudioGeometryBSP, UOculusAudioGeometryBSP::StaticClass, TEXT("UOculusAudioGeometryBSP"), &Z_Registration_Info_UClass_UOculusAudioGeometryBSP, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusAudioGeometryBSP), 304048134U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioGeometryBSP_h_611120481(TEXT("/Script/OculusAudio"),
