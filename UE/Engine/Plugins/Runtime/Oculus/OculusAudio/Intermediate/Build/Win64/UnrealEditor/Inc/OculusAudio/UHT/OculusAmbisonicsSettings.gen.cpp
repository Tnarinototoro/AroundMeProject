...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OculusAudio_EOculusAudioAmbisonicsMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_OculusAudio_EOculusAudioAmbisonicsMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_OculusAudio_EOculusAudioAmbisonicsMode_Statics::Enum_MetaDataParams)
	};
...
template<> OCULUSAUDIO_API UScriptStruct* StaticStruct<FSubmixEffectOculusAmbisonicSpatializerSettings>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::NewProp_AmbisonicMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::NewProp_AmbisonicMode = { "AmbisonicMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSubmixEffectOculusAmbisonicSpatializerSettings, AmbisonicMode), Z_Construct_UEnum_OculusAudio_EOculusAudioAmbisonicsMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::NewProp_AmbisonicMode_MetaData), Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::NewProp_AmbisonicMode_MetaData) }; // 2127133220
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectOculusAmbisonicSpatializerSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::NewProp_SpatializationMode = { "SpatializationMode", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusAudioSoundfieldSettings, SpatializationMode), Z_Construct_UEnum_OculusAudio_EOculusAudioAmbisonicsMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::NewProp_SpatializationMode_MetaData), Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::NewProp_SpatializationMode_MetaData) }; // 2127133220
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioSoundfieldSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Public_OculusAmbisonicsSettings_h_Statics::EnumInfo[] = {
		{ EOculusAudioAmbisonicsMode_StaticEnum, TEXT("EOculusAudioAmbisonicsMode"), &Z_Registration_Info_UEnum_EOculusAudioAmbisonicsMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2127133220U) },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Public_OculusAmbisonicsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusAudioSoundfieldSettings, UOculusAudioSoundfieldSettings::StaticClass, TEXT("UOculusAudioSoundfieldSettings"), &Z_Registration_Info_UClass_UOculusAudioSoundfieldSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusAudioSoundfieldSettings), 1423351809U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Public_OculusAmbisonicsSettings_h_4110895672(TEXT("/Script/OculusAudio"),
