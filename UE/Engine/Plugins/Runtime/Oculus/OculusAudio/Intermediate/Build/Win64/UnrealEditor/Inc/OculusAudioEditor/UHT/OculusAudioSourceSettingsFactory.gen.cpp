...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioSourceSettingsFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusAudioSourceSettingsFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioSourceSettingsFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusAudioSourceSettingsFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudioEditor_Private_OculusAudioSourceSettingsFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusAudioSourceSettingsFactory, UOculusAudioSourceSettingsFactory::StaticClass, TEXT("UOculusAudioSourceSettingsFactory"), &Z_Registration_Info_UClass_UOculusAudioSourceSettingsFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusAudioSourceSettingsFactory), 1261408751U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudioEditor_Private_OculusAudioSourceSettingsFactory_h_2419139580(TEXT("/Script/OculusAudioEditor"),
