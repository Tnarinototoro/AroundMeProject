...
template<> OCULUSAUDIO_API UScriptStruct* StaticStruct<FSubmixEffectOculusReverbPluginSettings>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSubmixEffectOculusReverbPluginSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectOculusReverbPluginSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSubmixEffectOculusReverbPluginSettings_Statics::Struct_MetaDataParams)
	};
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SubmixEffectOculusReverbPluginPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FSubmixEffectOculusReverbPluginSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::NewProp_InSettings_MetaData), Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::NewProp_InSettings_MetaData) }; // 470615030
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset, nullptr, "SetSettings", nullptr, nullptr, Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::SubmixEffectOculusReverbPluginPreset_eventSetSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings_Statics::SubmixEffectOculusReverbPluginPreset_eventSetSettings_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USubmixEffectOculusReverbPluginPreset_SetSettings, "SetSettings" }, // 1961877090
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USubmixEffectOculusReverbPluginPreset, Settings), Z_Construct_UScriptStruct_FSubmixEffectOculusReverbPluginSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::NewProp_Settings_MetaData) }; // 470615030
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::Class_MetaDataParams), Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioReverb_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USubmixEffectOculusReverbPluginPreset, USubmixEffectOculusReverbPluginPreset::StaticClass, TEXT("USubmixEffectOculusReverbPluginPreset"), &Z_Registration_Info_UClass_USubmixEffectOculusReverbPluginPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubmixEffectOculusReverbPluginPreset), 2057870819U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioReverb_h_2940653083(TEXT("/Script/OculusAudio"),
