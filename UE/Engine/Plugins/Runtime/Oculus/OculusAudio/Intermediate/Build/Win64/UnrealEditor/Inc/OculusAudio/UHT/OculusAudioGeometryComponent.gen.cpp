...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::NewProp_IncludeChildren = { "IncludeChildren", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusAudioGeometryComponent), &Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::NewProp_IncludeChildren_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::NewProp_IncludeChildren_MetaData), Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::NewProp_IncludeChildren_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusAudioGeometryComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioGeometryComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusAudioGeometryComponent, UOculusAudioGeometryComponent::StaticClass, TEXT("UOculusAudioGeometryComponent"), &Z_Registration_Info_UClass_UOculusAudioGeometryComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusAudioGeometryComponent), 2811886595U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusAudio_Source_OculusAudio_Private_OculusAudioGeometryComponent_h_4116093893(TEXT("/Script/OculusAudio"),
