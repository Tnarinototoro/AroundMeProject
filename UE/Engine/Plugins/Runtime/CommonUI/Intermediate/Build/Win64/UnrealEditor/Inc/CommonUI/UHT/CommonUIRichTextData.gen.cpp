...
template<> COMMONUI_API UScriptStruct* StaticStruct<FRichTextIconData>()
{
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FRichTextIconData_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRichTextIconData, DisplayName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRichTextIconData_Statics::NewProp_DisplayName_MetaData), Z_Construct_UScriptStruct_FRichTextIconData_Statics::NewProp_DisplayName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCommonUIRichTextData_Statics::NewProp_InlineIconSet = { "InlineIconSet", nullptr, (EPropertyFlags)0x0044000000010001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCommonUIRichTextData, InlineIconSet), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonUIRichTextData_Statics::NewProp_InlineIconSet_MetaData), Z_Construct_UClass_UCommonUIRichTextData_Statics::NewProp_InlineIconSet_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_Statics::ScriptStructInfo[] = {
		{ FRichTextIconData::StaticStruct, Z_Construct_UScriptStruct_FRichTextIconData_Statics::NewStructOps, TEXT("RichTextIconData"), &Z_Registration_Info_UScriptStruct_RichTextIconData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRichTextIconData), 3847620078U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonUIRichTextData, UCommonUIRichTextData::StaticClass, TEXT("UCommonUIRichTextData"), &Z_Registration_Info_UClass_UCommonUIRichTextData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonUIRichTextData), 216874085U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_762940082(TEXT("/Script/CommonUI"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIRichTextData_h_Statics::ScriptStructInfo),
		nullptr, 0);
