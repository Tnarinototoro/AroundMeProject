...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputTypeEnum_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputTypeEnum_h_Statics::EnumInfo[] = {
		{ ECommonInputType_StaticEnum, TEXT("ECommonInputType"), &Z_Registration_Info_UEnum_ECommonInputType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2481650305U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputTypeEnum_h_4267971674(TEXT("/Script/CommonInput"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputTypeEnum_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputTypeEnum_h_Statics::EnumInfo));
