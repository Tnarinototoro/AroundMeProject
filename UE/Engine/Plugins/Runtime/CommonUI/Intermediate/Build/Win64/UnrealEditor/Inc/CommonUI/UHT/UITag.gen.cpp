...
template<> COMMONUI_API UScriptStruct* StaticStruct<FUITag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUITag_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUITag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUITag_Statics::Struct_MetaDataParams)
	};
...
template<> COMMONUI_API UScriptStruct* StaticStruct<FUIActionTag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIActionTag_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIActionTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIActionTag_Statics::Struct_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_UITag_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_UITag_h_Statics::ScriptStructInfo[] = {
		{ FUITag::StaticStruct, Z_Construct_UScriptStruct_FUITag_Statics::NewStructOps, TEXT("UITag"), &Z_Registration_Info_UScriptStruct_UITag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUITag), 2082248690U) },
		{ FUIActionTag::StaticStruct, Z_Construct_UScriptStruct_FUIActionTag_Statics::NewStructOps, TEXT("UIActionTag"), &Z_Registration_Info_UScriptStruct_UIActionTag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIActionTag), 3332348987U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_UITag_h_1316173887(TEXT("/Script/CommonUI"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_UITag_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_UITag_h_Statics::ScriptStructInfo),
		nullptr, 0);
