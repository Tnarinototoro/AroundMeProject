...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputModeTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputModeTypes_h_Statics::EnumInfo[] = {
		{ ECommonInputMode_StaticEnum, TEXT("ECommonInputMode"), &Z_Registration_Info_UEnum_ECommonInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1467923478U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputModeTypes_h_2908696743(TEXT("/Script/CommonInput"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputModeTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonInput_Public_CommonInputModeTypes_h_Statics::EnumInfo));
