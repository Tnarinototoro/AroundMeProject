...
bool UCommonCustomNavigation::FOnCustomNavigationEvent_DelegateWrapper(const FScriptDelegate& OnCustomNavigationEvent, EUINavigation NavigationType)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonCustomNavigation_Statics::FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_UCommonCustomNavigation_OnCustomNavigationEvent__DelegateSignature, "OnCustomNavigationEvent__DelegateSignature" }, // 1962658261
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonCustomNavigation_Statics::FuncInfo) < 2048);
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonCustomNavigation_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonCustomNavigation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonCustomNavigation, UCommonCustomNavigation::StaticClass, TEXT("UCommonCustomNavigation"), &Z_Registration_Info_UClass_UCommonCustomNavigation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonCustomNavigation), 3101553239U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonCustomNavigation_h_594642635(TEXT("/Script/CommonUI"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonCustomNavigation_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonCustomNavigation_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
