...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_Slate_SCommonAnimatedSwitcher_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_Slate_SCommonAnimatedSwitcher_h_Statics::EnumInfo[] = {
		{ ECommonSwitcherTransition_StaticEnum, TEXT("ECommonSwitcherTransition"), &Z_Registration_Info_UEnum_ECommonSwitcherTransition, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4287217465U) },
		{ ETransitionCurve_StaticEnum, TEXT("ETransitionCurve"), &Z_Registration_Info_UEnum_ETransitionCurve, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2091030465U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_Slate_SCommonAnimatedSwitcher_h_2960581897(TEXT("/Script/CommonUI"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_Slate_SCommonAnimatedSwitcher_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_Slate_SCommonAnimatedSwitcher_h_Statics::EnumInfo));
