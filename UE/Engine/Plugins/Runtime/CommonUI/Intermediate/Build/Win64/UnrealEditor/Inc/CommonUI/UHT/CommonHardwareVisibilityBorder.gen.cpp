...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UCommonHardwareVisibilityBorder_Statics::NewProp_VisibleType = { "VisibleType", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCommonHardwareVisibilityBorder, VisibleType), Z_Construct_UEnum_UMG_ESlateVisibility, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonHardwareVisibilityBorder_Statics::NewProp_VisibleType_MetaData), Z_Construct_UClass_UCommonHardwareVisibilityBorder_Statics::NewProp_VisibleType_MetaData) }; // 1295612096
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UCommonHardwareVisibilityBorder_Statics::NewProp_HiddenType = { "HiddenType", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCommonHardwareVisibilityBorder, HiddenType), Z_Construct_UEnum_UMG_ESlateVisibility, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonHardwareVisibilityBorder_Statics::NewProp_HiddenType_MetaData), Z_Construct_UClass_UCommonHardwareVisibilityBorder_Statics::NewProp_HiddenType_MetaData) }; // 1295612096
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonHardwareVisibilityBorder_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonHardwareVisibilityBorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonHardwareVisibilityBorder, UCommonHardwareVisibilityBorder::StaticClass, TEXT("UCommonHardwareVisibilityBorder"), &Z_Registration_Info_UClass_UCommonHardwareVisibilityBorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonHardwareVisibilityBorder), 3358528528U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonHardwareVisibilityBorder_h_674763992(TEXT("/Script/CommonUI"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonHardwareVisibilityBorder_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonHardwareVisibilityBorder_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
