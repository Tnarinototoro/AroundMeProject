...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCommonDateTimeTextBlock_GetDateTime_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCommonDateTimeTextBlock, nullptr, "GetDateTime", nullptr, nullptr, Z_Construct_UFunction_UCommonDateTimeTextBlock_GetDateTime_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonDateTimeTextBlock_GetDateTime_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCommonDateTimeTextBlock_GetDateTime_Statics::CommonDateTimeTextBlock_eventGetDateTime_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonDateTimeTextBlock_GetDateTime_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCommonDateTimeTextBlock_GetDateTime_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCommonDateTimeTextBlock_SetDateTimeValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCommonDateTimeTextBlock, nullptr, "SetDateTimeValue", nullptr, nullptr, Z_Construct_UFunction_UCommonDateTimeTextBlock_SetDateTimeValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonDateTimeTextBlock_SetDateTimeValue_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCommonDateTimeTextBlock_SetDateTimeValue_Statics::CommonDateTimeTextBlock_eventSetDateTimeValue_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonDateTimeTextBlock_SetDateTimeValue_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCommonDateTimeTextBlock_SetDateTimeValue_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCommonDateTimeTextBlock_SetTimespanValue_Statics::NewProp_InTimespan = { "InTimespan", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CommonDateTimeTextBlock_eventSetTimespanValue_Parms, InTimespan), Z_Construct_UScriptStruct_FTimespan, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonDateTimeTextBlock_SetTimespanValue_Statics::NewProp_InTimespan_MetaData), Z_Construct_UFunction_UCommonDateTimeTextBlock_SetTimespanValue_Statics::NewProp_InTimespan_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonDateTimeTextBlock_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonDateTimeTextBlock_GetDateTime, "GetDateTime" }, // 2180202438
		{ &Z_Construct_UFunction_UCommonDateTimeTextBlock_SetCountDownCompletionText, "SetCountDownCompletionText" }, // 3945963815
		{ &Z_Construct_UFunction_UCommonDateTimeTextBlock_SetDateTimeValue, "SetDateTimeValue" }, // 2583868878
		{ &Z_Construct_UFunction_UCommonDateTimeTextBlock_SetTimespanValue, "SetTimespanValue" }, // 3153670819
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonDateTimeTextBlock_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonDateTimeTextBlock_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonDateTimeTextBlock_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonDateTimeTextBlock, UCommonDateTimeTextBlock::StaticClass, TEXT("UCommonDateTimeTextBlock"), &Z_Registration_Info_UClass_UCommonDateTimeTextBlock, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonDateTimeTextBlock), 4288846764U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonDateTimeTextBlock_h_1377925078(TEXT("/Script/CommonUI"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonDateTimeTextBlock_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonDateTimeTextBlock_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
