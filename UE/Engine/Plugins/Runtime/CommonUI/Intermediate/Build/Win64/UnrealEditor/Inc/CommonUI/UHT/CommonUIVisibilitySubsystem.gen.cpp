...
void FHardwareVisibilityTagsChangedDynamicEvent_DelegateWrapper(const FMulticastScriptDelegate& HardwareVisibilityTagsChangedDynamicEvent, UCommonUIVisibilitySubsystem* TagSubsystem)
{
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIVisibilitySubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIVisibilitySubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonUIVisibilitySubsystem, UCommonUIVisibilitySubsystem::StaticClass, TEXT("UCommonUIVisibilitySubsystem"), &Z_Registration_Info_UClass_UCommonUIVisibilitySubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonUIVisibilitySubsystem), 3480605810U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIVisibilitySubsystem_h_1879125235(TEXT("/Script/CommonUI"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIVisibilitySubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonUIVisibilitySubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
