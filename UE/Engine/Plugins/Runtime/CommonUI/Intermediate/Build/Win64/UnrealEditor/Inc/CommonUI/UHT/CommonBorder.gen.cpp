...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCommonBorderStyle_GetBackgroundBrush_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCommonBorderStyle, nullptr, "GetBackgroundBrush", nullptr, nullptr, Z_Construct_UFunction_UCommonBorderStyle_GetBackgroundBrush_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonBorderStyle_GetBackgroundBrush_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCommonBorderStyle_GetBackgroundBrush_Statics::CommonBorderStyle_eventGetBackgroundBrush_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonBorderStyle_GetBackgroundBrush_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCommonBorderStyle_GetBackgroundBrush_Statics::Function_MetaDataParams) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonBorderStyle_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonBorderStyle_GetBackgroundBrush, "GetBackgroundBrush" }, // 402405245
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonBorderStyle_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UCommonBorder_SetStyle_Statics::NewProp_InStyle = { "InStyle", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CommonBorder_eventSetStyle_Parms, InStyle), Z_Construct_UClass_UClass, Z_Construct_UClass_UCommonBorderStyle_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCommonBorder_SetStyle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCommonBorder, nullptr, "SetStyle", nullptr, nullptr, Z_Construct_UFunction_UCommonBorder_SetStyle_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonBorder_SetStyle_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCommonBorder_SetStyle_Statics::CommonBorder_eventSetStyle_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCommonBorder_SetStyle_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCommonBorder_SetStyle_Statics::Function_MetaDataParams) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonBorder_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonBorder_SetStyle, "SetStyle" }, // 3678951557
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonBorder_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UCommonBorder_Statics::NewProp_Style = { "Style", nullptr, (EPropertyFlags)0x0015000000000015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCommonBorder, Style), Z_Construct_UClass_UClass, Z_Construct_UClass_UCommonBorderStyle_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonBorder_Statics::NewProp_Style_MetaData), Z_Construct_UClass_UCommonBorder_Statics::NewProp_Style_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCommonBorder_Statics::NewProp_bStyleNoLongerNeedsConversion = { "bStyleNoLongerNeedsConversion", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UCommonBorder), &Z_Construct_UClass_UCommonBorder_Statics::NewProp_bStyleNoLongerNeedsConversion_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCommonBorder_Statics::NewProp_bStyleNoLongerNeedsConversion_MetaData), Z_Construct_UClass_UCommonBorder_Statics::NewProp_bStyleNoLongerNeedsConversion_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonBorder_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonBorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonBorderStyle, UCommonBorderStyle::StaticClass, TEXT("UCommonBorderStyle"), &Z_Registration_Info_UClass_UCommonBorderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonBorderStyle), 2034997768U) },
		{ Z_Construct_UClass_UCommonBorder, UCommonBorder::StaticClass, TEXT("UCommonBorder"), &Z_Registration_Info_UClass_UCommonBorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonBorder), 2225757332U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonBorder_h_835943118(TEXT("/Script/CommonUI"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonBorder_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CommonUI_Source_CommonUI_Public_CommonBorder_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
