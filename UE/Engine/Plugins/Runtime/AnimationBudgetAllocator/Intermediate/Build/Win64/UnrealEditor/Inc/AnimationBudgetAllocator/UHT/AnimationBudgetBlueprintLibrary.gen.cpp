...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AnimationBudgetBlueprintLibrary_eventEnableAnimationBudget_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AnimationBudgetBlueprintLibrary_eventEnableAnimationBudget_Parms), &Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAnimationBudgetBlueprintLibrary, nullptr, "EnableAnimationBudget", nullptr, nullptr, Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::AnimationBudgetBlueprintLibrary_eventEnableAnimationBudget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04042401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget_Statics::AnimationBudgetBlueprintLibrary_eventEnableAnimationBudget_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AnimationBudgetBlueprintLibrary_eventSetAnimationBudgetParameters_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::NewProp_InParameters = { "InParameters", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AnimationBudgetBlueprintLibrary_eventSetAnimationBudgetParameters_Parms, InParameters), Z_Construct_UScriptStruct_FAnimationBudgetAllocatorParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::NewProp_InParameters_MetaData), Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::NewProp_InParameters_MetaData) }; // 2405563332
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAnimationBudgetBlueprintLibrary, nullptr, "SetAnimationBudgetParameters", nullptr, nullptr, Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::AnimationBudgetBlueprintLibrary_eventSetAnimationBudgetParameters_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04442401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters_Statics::AnimationBudgetBlueprintLibrary_eventSetAnimationBudgetParameters_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimationBudgetBlueprintLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimationBudgetBlueprintLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_EnableAnimationBudget, "EnableAnimationBudget" }, // 281875934
		{ &Z_Construct_UFunction_UAnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters, "SetAnimationBudgetParameters" }, // 557669900
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimationBudgetBlueprintLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimationBudgetBlueprintLibrary_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimationBudgetBlueprintLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UAnimationBudgetBlueprintLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AnimationBudgetAllocator_Source_AnimationBudgetAllocator_Private_AnimationBudgetBlueprintLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationBudgetBlueprintLibrary, UAnimationBudgetBlueprintLibrary::StaticClass, TEXT("UAnimationBudgetBlueprintLibrary"), &Z_Registration_Info_UClass_UAnimationBudgetBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationBudgetBlueprintLibrary), 2516840339U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AnimationBudgetAllocator_Source_AnimationBudgetAllocator_Private_AnimationBudgetBlueprintLibrary_h_3042496117(TEXT("/Script/AnimationBudgetAllocator"),
