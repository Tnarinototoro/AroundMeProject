...
template<> ZONEGRAPH_API UScriptStruct* StaticStruct<FRegisteredZoneGraphData>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::NewProp_ZoneGraphData = { "ZoneGraphData", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRegisteredZoneGraphData, ZoneGraphData), Z_Construct_UClass_AZoneGraphData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::NewProp_ZoneGraphData_MetaData), Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::NewProp_ZoneGraphData_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneGraphSubsystem_Statics::NewProp_RegisteredZoneGraphData_Inner = { "RegisteredZoneGraphData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRegisteredZoneGraphData, METADATA_PARAMS(0, nullptr) }; // 152027419
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneGraphSubsystem_Statics::NewProp_RegisteredZoneGraphData = { "RegisteredZoneGraphData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphSubsystem, RegisteredZoneGraphData), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSubsystem_Statics::NewProp_RegisteredZoneGraphData_MetaData), Z_Construct_UClass_UZoneGraphSubsystem_Statics::NewProp_RegisteredZoneGraphData_MetaData) }; // 152027419
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSubsystem_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphSubsystem_h_Statics::ScriptStructInfo[] = {
		{ FRegisteredZoneGraphData::StaticStruct, Z_Construct_UScriptStruct_FRegisteredZoneGraphData_Statics::NewStructOps, TEXT("RegisteredZoneGraphData"), &Z_Registration_Info_UScriptStruct_RegisteredZoneGraphData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRegisteredZoneGraphData), 152027419U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneGraphSubsystem, UZoneGraphSubsystem::StaticClass, TEXT("UZoneGraphSubsystem"), &Z_Registration_Info_UClass_UZoneGraphSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphSubsystem), 2749787381U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphSubsystem_h_2639583448(TEXT("/Script/ZoneGraph"),
