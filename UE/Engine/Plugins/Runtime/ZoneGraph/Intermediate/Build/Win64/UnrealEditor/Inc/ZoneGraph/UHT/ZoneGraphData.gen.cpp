...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AZoneGraphData_Statics::NewProp_bEnableDrawing = { "bEnableDrawing", nullptr, (EPropertyFlags)0x0020080000002001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AZoneGraphData), &Z_Construct_UClass_AZoneGraphData_Statics::NewProp_bEnableDrawing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphData_Statics::NewProp_bEnableDrawing_MetaData), Z_Construct_UClass_AZoneGraphData_Statics::NewProp_bEnableDrawing_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AZoneGraphData_Statics::NewProp_RenderingComp = { "RenderingComp", nullptr, (EPropertyFlags)0x0024080000282008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AZoneGraphData, RenderingComp), Z_Construct_UClass_UZoneGraphRenderingComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphData_Statics::NewProp_RenderingComp_MetaData), Z_Construct_UClass_AZoneGraphData_Statics::NewProp_RenderingComp_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AZoneGraphData_Statics::NewProp_ZoneStorage_MetaData[] = {
		{ "ModuleRelativePath", "Public/ZoneGraphData.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AZoneGraphData_Statics::NewProp_ZoneStorage = { "ZoneStorage", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AZoneGraphData, ZoneStorage), Z_Construct_UScriptStruct_FZoneGraphStorage, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphData_Statics::NewProp_ZoneStorage_MetaData), Z_Construct_UClass_AZoneGraphData_Statics::NewProp_ZoneStorage_MetaData) }; // 2034268732
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_AZoneGraphData_Statics::NewProp_CombinedShapeHash = { "CombinedShapeHash", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AZoneGraphData, CombinedShapeHash), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphData_Statics::NewProp_CombinedShapeHash_MetaData), Z_Construct_UClass_AZoneGraphData_Statics::NewProp_CombinedShapeHash_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AZoneGraphData_Statics::ClassParams = {
		...
		0,
		0x009000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphData_Statics::Class_MetaDataParams), Z_Construct_UClass_AZoneGraphData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneGraphData_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AZoneGraphData, AZoneGraphData::StaticClass, TEXT("AZoneGraphData"), &Z_Registration_Info_UClass_AZoneGraphData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AZoneGraphData), 1756693114U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphData_h_1438320495(TEXT("/Script/ZoneGraph"),
