...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneShape_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AZoneShape_Statics::NewProp_ShapeComponent = { "ShapeComponent", nullptr, (EPropertyFlags)0x00240800000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AZoneShape, ShapeComponent), Z_Construct_UClass_UZoneShapeComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneShape_Statics::NewProp_ShapeComponent_MetaData), Z_Construct_UClass_AZoneShape_Statics::NewProp_ShapeComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AZoneShape_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneShape_Statics::Class_MetaDataParams), Z_Construct_UClass_AZoneShape_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AZoneShape_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneShapeActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AZoneShape, AZoneShape::StaticClass, TEXT("AZoneShape"), &Z_Registration_Info_UClass_AZoneShape, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AZoneShape), 2046152605U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneShapeActor_h_3616345795(TEXT("/Script/ZoneGraph"),
