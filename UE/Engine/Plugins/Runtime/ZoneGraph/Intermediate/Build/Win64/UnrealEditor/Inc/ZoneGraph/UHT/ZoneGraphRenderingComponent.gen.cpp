...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphRenderingComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphRenderingComponent_Statics::ClassParams = {
		...
		0,
		0x00B010A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphRenderingComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphRenderingComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphRenderingComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneGraphRenderingComponent, UZoneGraphRenderingComponent::StaticClass, TEXT("UZoneGraphRenderingComponent"), &Z_Registration_Info_UClass_UZoneGraphRenderingComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphRenderingComponent), 3034195878U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphRenderingComponent_h_1080154221(TEXT("/Script/ZoneGraph"),
