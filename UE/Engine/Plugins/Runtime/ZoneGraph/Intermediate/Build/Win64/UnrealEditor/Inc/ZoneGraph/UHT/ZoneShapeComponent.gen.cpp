...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ZoneShapeComponent_eventGetShapeType_Parms, ReturnValue), Z_Construct_UEnum_ZoneGraph_FZoneShapeType, METADATA_PARAMS(0, nullptr) }; // 2705981540
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UZoneShapeComponent, nullptr, "GetShapeType", nullptr, nullptr, Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::PropPointers), sizeof(Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::ZoneShapeComponent_eventGetShapeType_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::Function_MetaDataParams), Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UZoneShapeComponent_GetShapeType_Statics::ZoneShapeComponent_eventGetShapeType_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ZoneShapeComponent_eventGetTags_Parms, ReturnValue), Z_Construct_UScriptStruct_FZoneGraphTagMask, METADATA_PARAMS(0, nullptr) }; // 2479371343
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UZoneShapeComponent, nullptr, "GetTags", nullptr, nullptr, Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::PropPointers), sizeof(Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::ZoneShapeComponent_eventGetTags_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::Function_MetaDataParams), Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UZoneShapeComponent_GetTags_Statics::ZoneShapeComponent_eventGetTags_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ZoneShapeComponent_eventIsLaneProfileReversed_Parms), &Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UZoneShapeComponent, nullptr, "IsLaneProfileReversed", nullptr, nullptr, Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::PropPointers), sizeof(Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::ZoneShapeComponent_eventIsLaneProfileReversed_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::Function_MetaDataParams), Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed_Statics::ZoneShapeComponent_eventIsLaneProfileReversed_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::NewProp_NewType = { "NewType", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ZoneShapeComponent_eventSetPolygonRoutingType_Parms, NewType), Z_Construct_UEnum_ZoneGraph_EZoneShapePolygonRoutingType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::NewProp_NewType_MetaData), Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::NewProp_NewType_MetaData) }; // 4280508925
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UZoneShapeComponent, nullptr, "SetPolygonRoutingType", nullptr, nullptr, Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::PropPointers), sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::ZoneShapeComponent_eventSetPolygonRoutingType_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::Function_MetaDataParams), Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType_Statics::ZoneShapeComponent_eventSetPolygonRoutingType_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::NewProp_bReverse = { "bReverse", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ZoneShapeComponent_eventSetReverseLaneProfile_Parms), &Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::NewProp_bReverse_SetBit, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ZoneShapeComponent_eventSetReverseLaneProfile_Parms), &Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UZoneShapeComponent, nullptr, "SetReverseLaneProfile", nullptr, nullptr, Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::PropPointers), sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::ZoneShapeComponent_eventSetReverseLaneProfile_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::Function_MetaDataParams), Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile_Statics::ZoneShapeComponent_eventSetReverseLaneProfile_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ZoneShapeComponent_eventSetShapeType_Parms, Type), Z_Construct_UEnum_ZoneGraph_FZoneShapeType, METADATA_PARAMS(0, nullptr) }; // 2705981540
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UZoneShapeComponent, nullptr, "SetShapeType", nullptr, nullptr, Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::PropPointers), sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::ZoneShapeComponent_eventSetShapeType_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::Function_MetaDataParams), Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetShapeType_Statics::ZoneShapeComponent_eventSetShapeType_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::NewProp_NewTags = { "NewTags", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ZoneShapeComponent_eventSetTags_Parms, NewTags), Z_Construct_UScriptStruct_FZoneGraphTagMask, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::NewProp_NewTags_MetaData), Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::NewProp_NewTags_MetaData) }; // 2479371343
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UZoneShapeComponent, nullptr, "SetTags", nullptr, nullptr, Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::PropPointers), sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::ZoneShapeComponent_eventSetTags_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::Function_MetaDataParams), Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UZoneShapeComponent_SetTags_Statics::ZoneShapeComponent_eventSetTags_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UZoneShapeComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UZoneShapeComponent_GetShapeType, "GetShapeType" }, // 1803222009
		{ &Z_Construct_UFunction_UZoneShapeComponent_GetTags, "GetTags" }, // 425315017
		{ &Z_Construct_UFunction_UZoneShapeComponent_IsLaneProfileReversed, "IsLaneProfileReversed" }, // 2835382761
		{ &Z_Construct_UFunction_UZoneShapeComponent_SetPolygonRoutingType, "SetPolygonRoutingType" }, // 3365574097
		{ &Z_Construct_UFunction_UZoneShapeComponent_SetReverseLaneProfile, "SetReverseLaneProfile" }, // 1275491657
		{ &Z_Construct_UFunction_UZoneShapeComponent_SetShapeType, "SetShapeType" }, // 1949837820
		{ &Z_Construct_UFunction_UZoneShapeComponent_SetTags, "SetTags" }, // 2609110061
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_LaneProfile = { "LaneProfile", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, LaneProfile), Z_Construct_UScriptStruct_FZoneLaneProfileRef, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_LaneProfile_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_LaneProfile_MetaData) }; // 3751612976
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_bReverseLaneProfile = { "bReverseLaneProfile", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UZoneShapeComponent), &Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_bReverseLaneProfile_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_bReverseLaneProfile_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_bReverseLaneProfile_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PerPointLaneProfiles_Inner = { "PerPointLaneProfiles", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FZoneLaneProfileRef, METADATA_PARAMS(0, nullptr) }; // 3751612976
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PerPointLaneProfiles = { "PerPointLaneProfiles", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, PerPointLaneProfiles), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PerPointLaneProfiles_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PerPointLaneProfiles_MetaData) }; // 3751612976
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_Points_Inner = { "Points", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FZoneShapePoint, METADATA_PARAMS(0, nullptr) }; // 2298372720
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_Points = { "Points", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, Points), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_Points_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_Points_MetaData) }; // 2298372720
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeType = { "ShapeType", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, ShapeType), Z_Construct_UEnum_ZoneGraph_FZoneShapeType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeType_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeType_MetaData) }; // 2705981540
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PolygonRoutingType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PolygonRoutingType = { "PolygonRoutingType", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, PolygonRoutingType), Z_Construct_UEnum_ZoneGraph_EZoneShapePolygonRoutingType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PolygonRoutingType_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_PolygonRoutingType_MetaData) }; // 4280508925
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_Tags = { "Tags", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, Tags), Z_Construct_UScriptStruct_FZoneGraphTagMask, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_Tags_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_Tags_MetaData) }; // 2479371343
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeConnectors_Inner = { "ShapeConnectors", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FZoneShapeConnector, METADATA_PARAMS(0, nullptr) }; // 1967764126
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeConnectors = { "ShapeConnectors", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, ShapeConnectors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeConnectors_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ShapeConnectors_MetaData) }; // 1967764126
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ConnectedShapes_Inner = { "ConnectedShapes", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FZoneShapeConnection, METADATA_PARAMS(0, nullptr) }; // 4242217866
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ConnectedShapes = { "ConnectedShapes", nullptr, (EPropertyFlags)0x0040008000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneShapeComponent, ConnectedShapes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ConnectedShapes_MetaData), Z_Construct_UClass_UZoneShapeComponent_Statics::NewProp_ConnectedShapes_MetaData) }; // 4242217866
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneShapeComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneShapeComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneShapeComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneShapeComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneShapeComponent, UZoneShapeComponent::StaticClass, TEXT("UZoneShapeComponent"), &Z_Registration_Info_UClass_UZoneShapeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneShapeComponent), 1158793576U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneShapeComponent_h_1538508644(TEXT("/Script/ZoneGraph"),
