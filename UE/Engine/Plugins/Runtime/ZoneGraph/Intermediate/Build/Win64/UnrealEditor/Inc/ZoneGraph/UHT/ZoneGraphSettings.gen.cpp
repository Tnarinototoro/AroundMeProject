...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_LaneProfiles_Inner = { "LaneProfiles", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FZoneLaneProfile, METADATA_PARAMS(0, nullptr) }; // 388394310
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_LaneProfiles = { "LaneProfiles", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphSettings, LaneProfiles), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_LaneProfiles_MetaData), Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_LaneProfiles_MetaData) }; // 388394310
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_Tags_MetaData[] = {
		{ "ArraySizeEnum", "/Script/ZoneGraph.EZoneGraphTags" },
		{ "Category", "ZoneGraph" },
		{ "ModuleRelativePath", "Public/ZoneGraphSettings.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_Tags = { "Tags", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(Tags, UZoneGraphSettings), STRUCT_OFFSET(UZoneGraphSettings, Tags), Z_Construct_UScriptStruct_FZoneGraphTagInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_Tags_MetaData), Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_Tags_MetaData) }; // 1515382629
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_VisualizedTags = { "VisualizedTags", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphSettings, VisualizedTags), Z_Construct_UScriptStruct_FZoneGraphTagMask, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_VisualizedTags_MetaData), Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_VisualizedTags_MetaData) }; // 2479371343
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_ShapeMaxDrawDistance = { "ShapeMaxDrawDistance", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphSettings, ShapeMaxDrawDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_ShapeMaxDrawDistance_MetaData), Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_ShapeMaxDrawDistance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_BuildSettings = { "BuildSettings", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UZoneGraphSettings, BuildSettings), Z_Construct_UScriptStruct_FZoneGraphBuildSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_BuildSettings_MetaData), Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_BuildSettings_MetaData) }; // 1149239195
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_bBuildZoneGraphWhileEditing = { "bBuildZoneGraphWhileEditing", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UZoneGraphSettings), &Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_bBuildZoneGraphWhileEditing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_bBuildZoneGraphWhileEditing_MetaData), Z_Construct_UClass_UZoneGraphSettings_Statics::NewProp_bBuildZoneGraphWhileEditing_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UZoneGraphSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UZoneGraphSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UZoneGraphSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UZoneGraphSettings, UZoneGraphSettings::StaticClass, TEXT("UZoneGraphSettings"), &Z_Registration_Info_UClass_UZoneGraphSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UZoneGraphSettings), 2856900628U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ZoneGraph_Source_ZoneGraph_Public_ZoneGraphSettings_h_2446641029(TEXT("/Script/ZoneGraph"),
