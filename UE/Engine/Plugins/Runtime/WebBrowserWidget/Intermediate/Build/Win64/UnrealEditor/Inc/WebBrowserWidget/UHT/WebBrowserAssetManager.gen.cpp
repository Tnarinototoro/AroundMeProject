...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebBrowserAssetManager_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UWebBrowserAssetManager_Statics::NewProp_DefaultMaterial = { "DefaultMaterial", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebBrowserAssetManager, DefaultMaterial), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebBrowserAssetManager_Statics::NewProp_DefaultMaterial_MetaData), Z_Construct_UClass_UWebBrowserAssetManager_Statics::NewProp_DefaultMaterial_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebBrowserAssetManager_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebBrowserAssetManager_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebBrowserAssetManager_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebBrowserAssetManager_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WebBrowserWidget_Source_WebBrowserWidget_Public_WebBrowserAssetManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebBrowserAssetManager, UWebBrowserAssetManager::StaticClass, TEXT("UWebBrowserAssetManager"), &Z_Registration_Info_UClass_UWebBrowserAssetManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebBrowserAssetManager), 2059656509U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WebBrowserWidget_Source_WebBrowserWidget_Public_WebBrowserAssetManager_h_2160892854(TEXT("/Script/WebBrowserWidget"),
