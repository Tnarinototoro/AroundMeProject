...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryDestructible_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryDestructible_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryDestructible_Statics::Class_MetaDataParams), Z_Construct_UClass_UActorFactoryDestructible_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ApexDestruction_Source_ApexDestructionEditor_Private_ActorFactoryDestructible_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorFactoryDestructible, UActorFactoryDestructible::StaticClass, TEXT("UActorFactoryDestructible"), &Z_Registration_Info_UClass_UActorFactoryDestructible, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorFactoryDestructible), 4028448212U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ApexDestruction_Source_ApexDestructionEditor_Private_ActorFactoryDestructible_h_992749105(TEXT("/Script/ApexDestructionEditor"),
