...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDestructibleMeshThumbnailRenderer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDestructibleMeshThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDestructibleMeshThumbnailRenderer_Statics::Class_MetaDataParams), Z_Construct_UClass_UDestructibleMeshThumbnailRenderer_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ApexDestruction_Source_ApexDestructionEditor_Private_DestructibleMeshThumbnailRenderer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDestructibleMeshThumbnailRenderer, UDestructibleMeshThumbnailRenderer::StaticClass, TEXT("UDestructibleMeshThumbnailRenderer"), &Z_Registration_Info_UClass_UDestructibleMeshThumbnailRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDestructibleMeshThumbnailRenderer), 2507587269U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ApexDestruction_Source_ApexDestructionEditor_Private_DestructibleMeshThumbnailRenderer_h_2374458788(TEXT("/Script/ApexDestructionEditor"),
