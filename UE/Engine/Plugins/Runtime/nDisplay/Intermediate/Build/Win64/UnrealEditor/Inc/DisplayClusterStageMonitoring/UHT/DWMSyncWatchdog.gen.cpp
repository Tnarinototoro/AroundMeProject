...
template<> DISPLAYCLUSTERSTAGEMONITORING_API UScriptStruct* StaticStruct<FDWMSyncEvent>()
{
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_MissedFrames = { "MissedFrames", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDWMSyncEvent, MissedFrames), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_MissedFrames_MetaData), Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_MissedFrames_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_PresentCount = { "PresentCount", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDWMSyncEvent, PresentCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_PresentCount_MetaData), Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_PresentCount_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_LastPresentCount = { "LastPresentCount", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDWMSyncEvent, LastPresentCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_LastPresentCount_MetaData), Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_LastPresentCount_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_PresentRefreshCount = { "PresentRefreshCount", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDWMSyncEvent, PresentRefreshCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_PresentRefreshCount_MetaData), Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewProp_PresentRefreshCount_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterStageMonitoring_Private_DWMSyncWatchdog_h_Statics::ScriptStructInfo[] = {
		{ FDWMSyncEvent::StaticStruct, Z_Construct_UScriptStruct_FDWMSyncEvent_Statics::NewStructOps, TEXT("DWMSyncEvent"), &Z_Registration_Info_UScriptStruct_DWMSyncEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDWMSyncEvent), 2757666020U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterStageMonitoring_Private_DWMSyncWatchdog_h_376309769(TEXT("/Script/DisplayClusterStageMonitoring"),
		nullptr, 0,
