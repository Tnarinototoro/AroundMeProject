...
// Cross Module References
	...
	SHAREDMEMORYMEDIA_API UClass* Z_Construct_UClass_USharedMemoryMediaSource();
	SHAREDMEMORYMEDIA_API UClass* Z_Construct_UClass_USharedMemoryMediaSource_NoRegister();
	SHAREDMEMORYMEDIA_API UEnum* Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode();
...
// End Cross Module References
	...
	static UEnum* ESharedMemoryMediaSourceMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESharedMemoryMediaSourceMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode, (UObject*)Z_Construct_UPackage__Script_SharedMemoryMedia(), TEXT("ESharedMemoryMediaSourceMode"));
		}
	...
	struct Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SharedMemoryMedia,
		nullptr,
		"ESharedMemoryMediaSourceMode",
		"ESharedMemoryMediaSourceMode",
		Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::Enumerators,
		RF_Public|RF_Transient|RF_MarkAsNative,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::Enumerators),
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::Enum_MetaDataParams)
	};
	UEnum* Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode()
	{
		if (!Z_Registration_Info_UEnum_ESharedMemoryMediaSourceMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESharedMemoryMediaSourceMode.InnerSingleton, Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode_Statics::EnumParams);
		}
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaSource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_UniqueName = { "UniqueName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USharedMemoryMediaSource, UniqueName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_UniqueName_MetaData), Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_UniqueName_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USharedMemoryMediaSource, Mode), Z_Construct_UEnum_SharedMemoryMedia_ESharedMemoryMediaSourceMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_Mode_MetaData), Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_Mode_MetaData) }; // 4174863637
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_bZeroLatency = { "bZeroLatency", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USharedMemoryMediaSource), &Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_bZeroLatency_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_bZeroLatency_MetaData), Z_Construct_UClass_USharedMemoryMediaSource_Statics::NewProp_bZeroLatency_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USharedMemoryMediaSource_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaSource_Statics::Class_MetaDataParams), Z_Construct_UClass_USharedMemoryMediaSource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaSource_Statics::PropPointers) < 2048);
	...
	template<> SHAREDMEMORYMEDIA_API UClass* StaticClass<USharedMemoryMediaSource>()
	{
		return USharedMemoryMediaSource::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_Statics::EnumInfo[] = {
		{ ESharedMemoryMediaSourceMode_StaticEnum, TEXT("ESharedMemoryMediaSourceMode"), &Z_Registration_Info_UEnum_ESharedMemoryMediaSourceMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4174863637U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USharedMemoryMediaSource, USharedMemoryMediaSource::StaticClass, TEXT("USharedMemoryMediaSource"), &Z_Registration_Info_UClass_USharedMemoryMediaSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USharedMemoryMediaSource), 2128290274U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_950393175(TEXT("/Script/SharedMemoryMedia"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaSource_h_Statics::EnumInfo));
