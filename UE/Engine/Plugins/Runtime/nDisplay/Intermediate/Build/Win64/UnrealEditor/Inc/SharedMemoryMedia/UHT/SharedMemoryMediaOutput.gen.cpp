...
// Cross Module References
	...
	SHAREDMEMORYMEDIA_API UClass* Z_Construct_UClass_USharedMemoryMediaOutput();
...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_USharedMemoryMediaOutput_Statics::NewProp_UniqueName = { "UniqueName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USharedMemoryMediaOutput, UniqueName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaOutput_Statics::NewProp_UniqueName_MetaData), Z_Construct_UClass_USharedMemoryMediaOutput_Statics::NewProp_UniqueName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USharedMemoryMediaOutput_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_USharedMemoryMediaOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USharedMemoryMediaOutput_Statics::PropPointers) < 2048);
	...
	template<> SHAREDMEMORYMEDIA_API UClass* StaticClass<USharedMemoryMediaOutput>()
	{
		return USharedMemoryMediaOutput::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaOutput_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USharedMemoryMediaOutput, USharedMemoryMediaOutput::StaticClass, TEXT("USharedMemoryMediaOutput"), &Z_Registration_Info_UClass_USharedMemoryMediaOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USharedMemoryMediaOutput), 1178539276U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaOutput_h_3175161310(TEXT("/Script/SharedMemoryMedia"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaOutput_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_SharedMemoryMedia_Public_SharedMemoryMediaOutput_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
