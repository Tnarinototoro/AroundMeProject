...
template<> DISPLAYCLUSTERSTAGEMONITORING_API UScriptStruct* StaticStruct<FNvidiaSyncEvent>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_MissedFrames = { "MissedFrames", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNvidiaSyncEvent, MissedFrames), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_MissedFrames_MetaData), Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_MissedFrames_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_LastFrameDuration = { "LastFrameDuration", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNvidiaSyncEvent, LastFrameDuration), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_LastFrameDuration_MetaData), Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_LastFrameDuration_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_SynchronizationDuration = { "SynchronizationDuration", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNvidiaSyncEvent, SynchronizationDuration), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_SynchronizationDuration_MetaData), Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewProp_SynchronizationDuration_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterStageMonitoring_Private_NvidiaSyncWatchdog_h_Statics::ScriptStructInfo[] = {
		{ FNvidiaSyncEvent::StaticStruct, Z_Construct_UScriptStruct_FNvidiaSyncEvent_Statics::NewStructOps, TEXT("NvidiaSyncEvent"), &Z_Registration_Info_UScriptStruct_NvidiaSyncEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNvidiaSyncEvent), 1822789204U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterStageMonitoring_Private_NvidiaSyncWatchdog_h_1365532158(TEXT("/Script/DisplayClusterStageMonitoring"),
		nullptr, 0,
