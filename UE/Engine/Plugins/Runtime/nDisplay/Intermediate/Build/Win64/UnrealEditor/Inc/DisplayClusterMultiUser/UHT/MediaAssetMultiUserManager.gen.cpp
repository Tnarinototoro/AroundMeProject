...
template<> DISPLAYCLUSTERMULTIUSER_API UScriptStruct* StaticStruct<FConcertMediaStateChangedEvent>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewProp_ActorsPathNames_Inner = { "ActorsPathNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewProp_ActorsPathNames = { "ActorsPathNames", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertMediaStateChangedEvent, ActorsPathNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewProp_ActorsPathNames_MetaData), Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewProp_ActorsPathNames_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewProp_State = { "State", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConcertMediaStateChangedEvent, State), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewProp_State_MetaData), Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewProp_State_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterMultiUser_Private_MediaAssetMultiUserManager_h_Statics::ScriptStructInfo[] = {
		{ FConcertMediaStateChangedEvent::StaticStruct, Z_Construct_UScriptStruct_FConcertMediaStateChangedEvent_Statics::NewStructOps, TEXT("ConcertMediaStateChangedEvent"), &Z_Registration_Info_UScriptStruct_ConcertMediaStateChangedEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConcertMediaStateChangedEvent), 3001297145U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterMultiUser_Private_MediaAssetMultiUserManager_h_2207400522(TEXT("/Script/DisplayClusterMultiUser"),
		nullptr, 0,
