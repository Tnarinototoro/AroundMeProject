...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableDWMHitchDetection = { "bEnableDWMHitchDetection", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDisplayClusterStageMonitoringSettings), &Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableDWMHitchDetection_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableDWMHitchDetection_MetaData), Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableDWMHitchDetection_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableNvidiaHitchDetection = { "bEnableNvidiaHitchDetection", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDisplayClusterStageMonitoringSettings), &Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableNvidiaHitchDetection_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableNvidiaHitchDetection_MetaData), Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::NewProp_bEnableNvidiaHitchDetection_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterStageMonitoringSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterStageMonitoring_Private_DisplayClusterStageMonitoringSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDisplayClusterStageMonitoringSettings, UDisplayClusterStageMonitoringSettings::StaticClass, TEXT("UDisplayClusterStageMonitoringSettings"), &Z_Registration_Info_UClass_UDisplayClusterStageMonitoringSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDisplayClusterStageMonitoringSettings), 3260052622U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterStageMonitoring_Private_DisplayClusterStageMonitoringSettings_h_2096466779(TEXT("/Script/DisplayClusterStageMonitoring"),
