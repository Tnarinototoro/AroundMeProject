...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::NewProp_LightCardActor = { "LightCardActor", nullptr, (EPropertyFlags)0x00160000020a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDisplayClusterLightCardTemplate, LightCardActor), Z_Construct_UClass_ADisplayClusterLightCardActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::NewProp_LightCardActor_MetaData), Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::NewProp_LightCardActor_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::ClassParams = {
		...
		0,
		0x008006A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::Class_MetaDataParams), Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterLightCardTemplate_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterLightCardEditor_Private_LightCardTemplates_DisplayClusterLightCardTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDisplayClusterLightCardTemplate, UDisplayClusterLightCardTemplate::StaticClass, TEXT("UDisplayClusterLightCardTemplate"), &Z_Registration_Info_UClass_UDisplayClusterLightCardTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDisplayClusterLightCardTemplate), 3396226622U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterLightCardEditor_Private_LightCardTemplates_DisplayClusterLightCardTemplate_h_2106718923(TEXT("/Script/DisplayClusterLightCardEditor"),
