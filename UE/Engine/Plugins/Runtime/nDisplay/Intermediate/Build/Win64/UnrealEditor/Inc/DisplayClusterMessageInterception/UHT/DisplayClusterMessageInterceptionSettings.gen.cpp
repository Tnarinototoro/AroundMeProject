...
template<> DISPLAYCLUSTERMESSAGEINTERCEPTION_API UScriptStruct* StaticStruct<FMessageInterceptionSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bIsEnabled = { "bIsEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMessageInterceptionSettings), &Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bIsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bIsEnabled_MetaData), Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bIsEnabled_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bInterceptMultiUserMessages = { "bInterceptMultiUserMessages", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMessageInterceptionSettings), &Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bInterceptMultiUserMessages_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bInterceptMultiUserMessages_MetaData), Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_bInterceptMultiUserMessages_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_TimeoutSeconds = { "TimeoutSeconds", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMessageInterceptionSettings, TimeoutSeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_TimeoutSeconds_MetaData), Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::NewProp_TimeoutSeconds_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMessageInterceptionSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::NewProp_InterceptionSettings = { "InterceptionSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDisplayClusterMessageInterceptionSettings, InterceptionSettings), Z_Construct_UScriptStruct_FMessageInterceptionSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::NewProp_InterceptionSettings_MetaData), Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::NewProp_InterceptionSettings_MetaData) }; // 1493577776
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDisplayClusterMessageInterceptionSettings_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_nDisplay_Source_DisplayClusterMessageInterceptor_Public_DisplayClusterMessageInterceptionSettings_h_2042553116(TEXT("/Script/DisplayClusterMessageInterception"),
