...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AppleImageUtils_Source_AppleImageUtils_Public_AppleImageUtilsTypes_h_Statics::EnumInfo[] = {
		{ ETextureRotationDirection_StaticEnum, TEXT("ETextureRotationDirection"), &Z_Registration_Info_UEnum_ETextureRotationDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 812514392U) },
		{ EAppleTextureType_StaticEnum, TEXT("EAppleTextureType"), &Z_Registration_Info_UEnum_EAppleTextureType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3046505435U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AppleImageUtils_Source_AppleImageUtils_Public_AppleImageUtilsTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAppleImageInterface, UAppleImageInterface::StaticClass, TEXT("UAppleImageInterface"), &Z_Registration_Info_UClass_UAppleImageInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAppleImageInterface), 3014029261U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AppleImageUtils_Source_AppleImageUtils_Public_AppleImageUtilsTypes_h_2834482353(TEXT("/Script/AppleImageUtils"),
