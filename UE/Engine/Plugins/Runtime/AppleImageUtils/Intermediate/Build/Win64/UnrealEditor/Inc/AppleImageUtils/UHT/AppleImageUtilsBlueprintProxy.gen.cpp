...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::NewProp_Error = { "Error", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAppleImageUtilsImageConversionResult, Error), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::NewProp_Error_MetaData), Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::NewProp_Error_MetaData) };
...
void FAppleImageConversionDelegate_DelegateWrapper(const FMulticastScriptDelegate& AppleImageConversionDelegate, FAppleImageUtilsImageConversionResult const& ConversionResult)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToHEIF, "CreateProxyObjectForConvertToHEIF" }, // 2613439244
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToJPEG, "CreateProxyObjectForConvertToJPEG" }, // 3351318878
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToPNG, "CreateProxyObjectForConvertToPNG" }, // 887816681
		{ &Z_Construct_UFunction_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF, "CreateProxyObjectForConvertToTIFF" }, // 2865869701
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AppleImageUtils_Source_AppleImageUtils_Public_AppleImageUtilsBlueprintProxy_h_Statics::ScriptStructInfo[] = {
		{ FAppleImageUtilsImageConversionResult::StaticStruct, Z_Construct_UScriptStruct_FAppleImageUtilsImageConversionResult_Statics::NewStructOps, TEXT("AppleImageUtilsImageConversionResult"), &Z_Registration_Info_UScriptStruct_AppleImageUtilsImageConversionResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAppleImageUtilsImageConversionResult), 1463719767U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AppleImageUtils_Source_AppleImageUtils_Public_AppleImageUtilsBlueprintProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy, UAppleImageUtilsBaseAsyncTaskBlueprintProxy::StaticClass, TEXT("UAppleImageUtilsBaseAsyncTaskBlueprintProxy"), &Z_Registration_Info_UClass_UAppleImageUtilsBaseAsyncTaskBlueprintProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy), 1711007179U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AppleImageUtils_Source_AppleImageUtils_Public_AppleImageUtilsBlueprintProxy_h_2299644789(TEXT("/Script/AppleImageUtils"),
