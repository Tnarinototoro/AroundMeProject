...
template<> AUDIOMOTORSIMSTANDARDCOMPONENTS_API UScriptStruct* StaticStruct<FMotorSimGearCurve>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::NewProp_RpmCurve = { "RpmCurve", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMotorSimGearCurve, RpmCurve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::NewProp_RpmCurve_MetaData), Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::NewProp_RpmCurve_MetaData) }; // 3321759441
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::NewProp_SpeedTopThreshold = { "SpeedTopThreshold", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMotorSimGearCurve, SpeedTopThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::NewProp_SpeedTopThreshold_MetaData), Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::NewProp_SpeedTopThreshold_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::NewProp_NewGear = { "NewGear", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_AudioMotorSimStandardComponents_eventOnGearChangedEvent_Parms, NewGear), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AudioMotorSimStandardComponents, nullptr, "OnGearChangedEvent__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::_Script_AudioMotorSimStandardComponents_eventOnGearChangedEvent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature_Statics::_Script_AudioMotorSimStandardComponents_eventOnGearChangedEvent_Parms) < MAX_uint16);
...
void FOnGearChangedEvent_DelegateWrapper(const FMulticastScriptDelegate& OnGearChangedEvent, int32 NewGear)
{
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_Gears_Inner = { "Gears", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FMotorSimGearCurve, METADATA_PARAMS(0, nullptr) }; // 962157493
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_Gears = { "Gears", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URpmCurveMotorSimComponent, Gears), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_Gears_MetaData), Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_Gears_MetaData) }; // 962157493
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_InterpSpeed = { "InterpSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URpmCurveMotorSimComponent, InterpSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_InterpSpeed_MetaData), Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_InterpSpeed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_OnUpShift = { "OnUpShift", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URpmCurveMotorSimComponent, OnUpShift), Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_OnUpShift_MetaData), Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_OnUpShift_MetaData) }; // 1677678003
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_OnDownShift = { "OnDownShift", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URpmCurveMotorSimComponent, OnDownShift), Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChangedEvent__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_OnDownShift_MetaData), Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::NewProp_OnDownShift_MetaData) }; // 1677678003
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URpmCurveMotorSimComponent_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_RpmCurveMotorSimComponent_h_Statics::ScriptStructInfo[] = {
		{ FMotorSimGearCurve::StaticStruct, Z_Construct_UScriptStruct_FMotorSimGearCurve_Statics::NewStructOps, TEXT("MotorSimGearCurve"), &Z_Registration_Info_UScriptStruct_MotorSimGearCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMotorSimGearCurve), 962157493U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_RpmCurveMotorSimComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URpmCurveMotorSimComponent, URpmCurveMotorSimComponent::StaticClass, TEXT("URpmCurveMotorSimComponent"), &Z_Registration_Info_UClass_URpmCurveMotorSimComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URpmCurveMotorSimComponent), 1211420159U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_RpmCurveMotorSimComponent_h_4169440077(TEXT("/Script/AudioMotorSimStandardComponents"),
