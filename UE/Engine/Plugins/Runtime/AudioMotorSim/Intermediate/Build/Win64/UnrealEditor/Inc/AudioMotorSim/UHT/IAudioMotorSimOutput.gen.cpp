...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioMotorSimOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAudioMotorSimOutput_Statics::ClassParams = {
		...
		0,
		0x000040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioMotorSimOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UAudioMotorSimOutput_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSim_Public_IAudioMotorSimOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioMotorSimOutput, UAudioMotorSimOutput::StaticClass, TEXT("UAudioMotorSimOutput"), &Z_Registration_Info_UClass_UAudioMotorSimOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioMotorSimOutput), 3118254198U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSim_Public_IAudioMotorSimOutput_h_1034715321(TEXT("/Script/AudioMotorSim"),
