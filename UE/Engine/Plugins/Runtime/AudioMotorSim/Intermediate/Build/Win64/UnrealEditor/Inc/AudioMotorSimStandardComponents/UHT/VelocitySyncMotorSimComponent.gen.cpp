...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_NoThrottleTime = { "NoThrottleTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVelocitySyncMotorSimComponent, NoThrottleTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_NoThrottleTime_MetaData), Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_NoThrottleTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_SpeedThreshold = { "SpeedThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVelocitySyncMotorSimComponent, SpeedThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_SpeedThreshold_MetaData), Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_SpeedThreshold_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_SpeedToRpmCurve = { "SpeedToRpmCurve", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVelocitySyncMotorSimComponent, SpeedToRpmCurve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_SpeedToRpmCurve_MetaData), Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_SpeedToRpmCurve_MetaData) }; // 3321759441
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_InterpSpeed = { "InterpSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVelocitySyncMotorSimComponent, InterpSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_InterpSpeed_MetaData), Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_InterpSpeed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_InterpTime = { "InterpTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVelocitySyncMotorSimComponent, InterpTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_InterpTime_MetaData), Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_InterpTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_FirstGearThrottleThreshold = { "FirstGearThrottleThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVelocitySyncMotorSimComponent, FirstGearThrottleThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_FirstGearThrottleThreshold_MetaData), Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::NewProp_FirstGearThrottleThreshold_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVelocitySyncMotorSimComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_VelocitySyncMotorSimComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVelocitySyncMotorSimComponent, UVelocitySyncMotorSimComponent::StaticClass, TEXT("UVelocitySyncMotorSimComponent"), &Z_Registration_Info_UClass_UVelocitySyncMotorSimComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVelocitySyncMotorSimComponent), 1833249767U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_VelocitySyncMotorSimComponent_h_3362935376(TEXT("/Script/AudioMotorSimStandardComponents"),
