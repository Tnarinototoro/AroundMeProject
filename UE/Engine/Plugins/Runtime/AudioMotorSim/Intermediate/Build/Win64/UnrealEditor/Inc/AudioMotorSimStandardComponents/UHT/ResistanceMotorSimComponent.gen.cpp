...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UResistanceMotorSimComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_UpSpeedMaxFriction = { "UpSpeedMaxFriction", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UResistanceMotorSimComponent, UpSpeedMaxFriction), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_UpSpeedMaxFriction_MetaData), Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_UpSpeedMaxFriction_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_MinSpeed = { "MinSpeed", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UResistanceMotorSimComponent, MinSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_MinSpeed_MetaData), Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_MinSpeed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_SideSpeedFrictionCurve = { "SideSpeedFrictionCurve", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UResistanceMotorSimComponent, SideSpeedFrictionCurve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_SideSpeedFrictionCurve_MetaData), Z_Construct_UClass_UResistanceMotorSimComponent_Statics::NewProp_SideSpeedFrictionCurve_MetaData) }; // 3321759441
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UResistanceMotorSimComponent_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UResistanceMotorSimComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UResistanceMotorSimComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UResistanceMotorSimComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_ResistanceMotorSimComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UResistanceMotorSimComponent, UResistanceMotorSimComponent::StaticClass, TEXT("UResistanceMotorSimComponent"), &Z_Registration_Info_UClass_UResistanceMotorSimComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UResistanceMotorSimComponent), 3376239032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_ResistanceMotorSimComponent_h_4048234213(TEXT("/Script/AudioMotorSimStandardComponents"),
