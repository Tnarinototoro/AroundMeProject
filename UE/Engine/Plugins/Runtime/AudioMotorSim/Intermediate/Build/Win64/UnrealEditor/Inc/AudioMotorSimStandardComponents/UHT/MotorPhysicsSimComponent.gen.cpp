...
// End Cross Module References
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::NewProp_NewGear = { "NewGear", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_AudioMotorSimStandardComponents_eventOnGearChanged_Parms, NewGear), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AudioMotorSimStandardComponents, nullptr, "OnGearChanged__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::_Script_AudioMotorSimStandardComponents_eventOnGearChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature_Statics::_Script_AudioMotorSimStandardComponents_eventOnGearChanged_Parms) < MAX_uint16);
...
void FOnGearChanged_DelegateWrapper(const FMulticastScriptDelegate& OnGearChanged, int32 NewGear)
{
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_Weight = { "Weight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, Weight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_Weight_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_Weight_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineTorque = { "EngineTorque", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, EngineTorque), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineTorque_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineTorque_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_BrakingHorsePower = { "BrakingHorsePower", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, BrakingHorsePower), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_BrakingHorsePower_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_BrakingHorsePower_MetaData) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_GearRatios_Inner = { "GearRatios", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_GearRatios = { "GearRatios", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, GearRatios), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_GearRatios_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_GearRatios_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ClutchedGearRatio = { "ClutchedGearRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, ClutchedGearRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ClutchedGearRatio_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ClutchedGearRatio_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bUseInfiniteGears = { "bUseInfiniteGears", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMotorPhysicsSimComponent), &Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bUseInfiniteGears_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bUseInfiniteGears_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bUseInfiniteGears_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bAlwaysDownshiftToZerothGear = { "bAlwaysDownshiftToZerothGear", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMotorPhysicsSimComponent), &Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bAlwaysDownshiftToZerothGear_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bAlwaysDownshiftToZerothGear_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_bAlwaysDownshiftToZerothGear_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_InfiniteGearRatio = { "InfiniteGearRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, InfiniteGearRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_InfiniteGearRatio_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_InfiniteGearRatio_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_UpShiftMaxRpm = { "UpShiftMaxRpm", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, UpShiftMaxRpm), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_UpShiftMaxRpm_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_UpShiftMaxRpm_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_DownShiftStartRpm = { "DownShiftStartRpm", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, DownShiftStartRpm), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_DownShiftStartRpm_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_DownShiftStartRpm_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ClutchedForceModifier = { "ClutchedForceModifier", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, ClutchedForceModifier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ClutchedForceModifier_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ClutchedForceModifier_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineGearRatio = { "EngineGearRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, EngineGearRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineGearRatio_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineGearRatio_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineFriction = { "EngineFriction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, EngineFriction), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineFriction_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_EngineFriction_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_GroundFriction = { "GroundFriction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, GroundFriction), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_GroundFriction_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_GroundFriction_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_WindResistancePerVelocity = { "WindResistancePerVelocity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, WindResistancePerVelocity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_WindResistancePerVelocity_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_WindResistancePerVelocity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ThrottleInterpolationTime = { "ThrottleInterpolationTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, ThrottleInterpolationTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ThrottleInterpolationTime_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_ThrottleInterpolationTime_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_RpmInterpSpeed = { "RpmInterpSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, RpmInterpSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_RpmInterpSpeed_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_RpmInterpSpeed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_OnGearChangedEvent = { "OnGearChangedEvent", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMotorPhysicsSimComponent, OnGearChangedEvent), Z_Construct_UDelegateFunction_AudioMotorSimStandardComponents_OnGearChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_OnGearChangedEvent_MetaData), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::NewProp_OnGearChangedEvent_MetaData) }; // 1326028950
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorPhysicsSimComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_MotorPhysicsSimComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMotorPhysicsSimComponent, UMotorPhysicsSimComponent::StaticClass, TEXT("UMotorPhysicsSimComponent"), &Z_Registration_Info_UClass_UMotorPhysicsSimComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMotorPhysicsSimComponent), 2600374183U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioMotorSim_Source_AudioMotorSimStandardComponents_Public_MotorPhysicsSimComponent_h_3577009236(TEXT("/Script/AudioMotorSimStandardComponents"),
