...
// End Cross Module References
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAndroidFileServerBPLibrary_IsFileServerRunning_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AndroidFileServerBPLibrary_eventIsFileServerRunning_Parms, ReturnValue), Z_Construct_UEnum_AndroidFileServer_EAFSActiveType, METADATA_PARAMS(0, nullptr) }; // 1843241595
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAndroidFileServerBPLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAndroidFileServerBPLibrary_IsFileServerRunning, "IsFileServerRunning" }, // 1936547078
		{ &Z_Construct_UFunction_UAndroidFileServerBPLibrary_StartFileServer, "StartFileServer" }, // 1137747972
		{ &Z_Construct_UFunction_UAndroidFileServerBPLibrary_StopFileServer, "StopFileServer" }, // 851707162
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidFileServerBPLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AndroidFileServer_Source_AndroidFileServer_Classes_AndroidFileServerBPLibrary_h_Statics::EnumInfo[] = {
		{ EAFSActiveType_StaticEnum, TEXT("EAFSActiveType"), &Z_Registration_Info_UEnum_EAFSActiveType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1843241595U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AndroidFileServer_Source_AndroidFileServer_Classes_AndroidFileServerBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAndroidFileServerBPLibrary, UAndroidFileServerBPLibrary::StaticClass, TEXT("UAndroidFileServerBPLibrary"), &Z_Registration_Info_UClass_UAndroidFileServerBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAndroidFileServerBPLibrary), 1084423145U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AndroidFileServer_Source_AndroidFileServer_Classes_AndroidFileServerBPLibrary_h_999192234(TEXT("/Script/AndroidFileServer"),
