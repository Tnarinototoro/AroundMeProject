...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioModulationStyle_GetControlBusColor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioModulationStyle, nullptr, "GetControlBusColor", nullptr, nullptr, Z_Construct_UFunction_UAudioModulationStyle_GetControlBusColor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetControlBusColor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioModulationStyle_GetControlBusColor_Statics::AudioModulationStyle_eventGetControlBusColor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetControlBusColor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioModulationStyle_GetControlBusColor_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioModulationStyle_GetControlBusMixColor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioModulationStyle, nullptr, "GetControlBusMixColor", nullptr, nullptr, Z_Construct_UFunction_UAudioModulationStyle_GetControlBusMixColor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetControlBusMixColor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioModulationStyle_GetControlBusMixColor_Statics::AudioModulationStyle_eventGetControlBusMixColor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetControlBusMixColor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioModulationStyle_GetControlBusMixColor_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioModulationStyle_GetParameterColor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioModulationStyle, nullptr, "GetParameterColor", nullptr, nullptr, Z_Construct_UFunction_UAudioModulationStyle_GetParameterColor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetParameterColor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioModulationStyle_GetParameterColor_Statics::AudioModulationStyle_eventGetParameterColor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetParameterColor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioModulationStyle_GetParameterColor_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioModulationStyle_GetPatchColor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioModulationStyle, nullptr, "GetPatchColor", nullptr, nullptr, Z_Construct_UFunction_UAudioModulationStyle_GetPatchColor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetPatchColor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAudioModulationStyle_GetPatchColor_Statics::AudioModulationStyle_eventGetPatchColor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioModulationStyle_GetPatchColor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAudioModulationStyle_GetPatchColor_Statics::Function_MetaDataParams) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioModulationStyle_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioModulationStyle_GetControlBusColor, "GetControlBusColor" }, // 3209522790
		{ &Z_Construct_UFunction_UAudioModulationStyle_GetControlBusMixColor, "GetControlBusMixColor" }, // 225809423
		{ &Z_Construct_UFunction_UAudioModulationStyle_GetModulationGeneratorColor, "GetModulationGeneratorColor" }, // 4139865553
		{ &Z_Construct_UFunction_UAudioModulationStyle_GetParameterColor, "GetParameterColor" }, // 2380138797
		{ &Z_Construct_UFunction_UAudioModulationStyle_GetPatchColor, "GetPatchColor" }, // 1897239349
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioModulationStyle_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_AudioModulationStyle_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioModulationStyle, UAudioModulationStyle::StaticClass, TEXT("UAudioModulationStyle"), &Z_Registration_Info_UClass_UAudioModulationStyle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioModulationStyle), 1937767668U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_AudioModulationStyle_h_39947361(TEXT("/Script/AudioModulation"),
