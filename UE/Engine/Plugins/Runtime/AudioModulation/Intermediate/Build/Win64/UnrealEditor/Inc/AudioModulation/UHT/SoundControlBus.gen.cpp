...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundControlBus_Statics::NewProp_bBypass = { "bBypass", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USoundControlBus), &Z_Construct_UClass_USoundControlBus_Statics::NewProp_bBypass_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundControlBus_Statics::NewProp_bBypass_MetaData), Z_Construct_UClass_USoundControlBus_Statics::NewProp_bBypass_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundControlBus_Statics::NewProp_bOverrideAddress = { "bOverrideAddress", nullptr, (EPropertyFlags)0x0010000800000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USoundControlBus), &Z_Construct_UClass_USoundControlBus_Statics::NewProp_bOverrideAddress_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundControlBus_Statics::NewProp_bOverrideAddress_MetaData), Z_Construct_UClass_USoundControlBus_Statics::NewProp_bOverrideAddress_MetaData) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundControlBus_Statics::NewProp_Generators = { "Generators", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundControlBus, Generators), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundControlBus_Statics::NewProp_Generators_MetaData), Z_Construct_UClass_USoundControlBus_Statics::NewProp_Generators_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USoundControlBus_Statics::NewProp_Parameter = { "Parameter", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundControlBus, Parameter), Z_Construct_UClass_USoundModulationParameter_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundControlBus_Statics::NewProp_Parameter_MetaData), Z_Construct_UClass_USoundControlBus_Statics::NewProp_Parameter_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_SoundControlBus_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundControlBus, USoundControlBus::StaticClass, TEXT("USoundControlBus"), &Z_Registration_Info_UClass_USoundControlBus, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundControlBus), 3045415884U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_SoundControlBus_h_3775194363(TEXT("/Script/AudioModulation"),
