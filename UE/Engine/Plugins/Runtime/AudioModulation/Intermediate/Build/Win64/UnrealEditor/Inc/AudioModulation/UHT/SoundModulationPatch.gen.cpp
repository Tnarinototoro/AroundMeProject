...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSoundControlModulationInput_Statics::NewProp_Bus = { "Bus", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSoundControlModulationInput, Bus), Z_Construct_UClass_USoundControlBus_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundControlModulationInput_Statics::NewProp_Bus_MetaData), Z_Construct_UScriptStruct_FSoundControlModulationInput_Statics::NewProp_Bus_MetaData) };
...
template<> AUDIOMODULATION_API UScriptStruct* StaticStruct<FSoundControlModulationPatch>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSoundControlModulationPatch_Statics::NewProp_OutputParameter = { "OutputParameter", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSoundControlModulationPatch, OutputParameter), Z_Construct_UClass_USoundModulationParameter_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundControlModulationPatch_Statics::NewProp_OutputParameter_MetaData), Z_Construct_UScriptStruct_FSoundControlModulationPatch_Statics::NewProp_OutputParameter_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSoundControlModulationPatch_Statics::NewProp_Inputs_Inner = { "Inputs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSoundControlModulationInput, METADATA_PARAMS(0, nullptr) }; // 134810730
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_SoundModulationPatch_h_Statics::ScriptStructInfo[] = {
		{ FSoundModulationTransform::StaticStruct, Z_Construct_UScriptStruct_FSoundModulationTransform_Statics::NewStructOps, TEXT("SoundModulationTransform"), &Z_Registration_Info_UScriptStruct_SoundModulationTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSoundModulationTransform), 2669893637U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_SoundModulationPatch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundModulationPatch, USoundModulationPatch::StaticClass, TEXT("USoundModulationPatch"), &Z_Registration_Info_UClass_USoundModulationPatch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundModulationPatch), 133642304U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_SoundModulationPatch_h_3610971452(TEXT("/Script/AudioModulation"),
