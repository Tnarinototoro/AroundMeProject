...
template<> AUDIOMODULATION_API UScriptStruct* StaticStruct<FSoundModulationMixValue>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSoundModulationMixValue_Statics::NewProp_ReleaseTime = { "ReleaseTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSoundModulationMixValue, ReleaseTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundModulationMixValue_Statics::NewProp_ReleaseTime_MetaData), Z_Construct_UScriptStruct_FSoundModulationMixValue_Statics::NewProp_ReleaseTime_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_SoundModulationValue_h_Statics::ScriptStructInfo[] = {
		{ FSoundModulationMixValue::StaticStruct, Z_Construct_UScriptStruct_FSoundModulationMixValue_Statics::NewStructOps, TEXT("SoundModulationMixValue"), &Z_Registration_Info_UScriptStruct_SoundModulationMixValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSoundModulationMixValue), 2249204430U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_SoundModulationValue_h_1586236776(TEXT("/Script/AudioModulation"),
		nullptr, 0,
