...
template<> AUDIOMODULATION_API UScriptStruct* StaticStruct<FEnvelopeFollowerGeneratorParams>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_bInvert = { "bInvert", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FEnvelopeFollowerGeneratorParams), &Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_bInvert_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_bInvert_MetaData), Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_bInvert_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_AudioBus = { "AudioBus", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvelopeFollowerGeneratorParams, AudioBus), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_AudioBus_MetaData), Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_AudioBus_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_Gain = { "Gain", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvelopeFollowerGeneratorParams, Gain), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_Gain_MetaData), Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_Gain_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_ReleaseTime = { "ReleaseTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvelopeFollowerGeneratorParams, ReleaseTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_ReleaseTime_MetaData), Z_Construct_UScriptStruct_FEnvelopeFollowerGeneratorParams_Statics::NewProp_ReleaseTime_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_Generators_SoundModulationEnvelopeFollower_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundModulationGeneratorEnvelopeFollower, USoundModulationGeneratorEnvelopeFollower::StaticClass, TEXT("USoundModulationGeneratorEnvelopeFollower"), &Z_Registration_Info_UClass_USoundModulationGeneratorEnvelopeFollower, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundModulationGeneratorEnvelopeFollower), 1025175576U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulation_Public_Generators_SoundModulationEnvelopeFollower_h_2896595873(TEXT("/Script/AudioModulation"),
