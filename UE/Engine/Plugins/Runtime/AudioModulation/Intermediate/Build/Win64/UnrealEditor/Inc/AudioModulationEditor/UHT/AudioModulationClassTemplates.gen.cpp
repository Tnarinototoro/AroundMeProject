...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(USoundModulationClassTemplate);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundModulationClassTemplate_Statics::Class_MetaDataParams[] = {
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(USoundModulationGeneratorClassTemplate);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundModulationGeneratorClassTemplate_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AudioModulationClassTemplates.h" },
		{ "ModuleRelativePath", "Public/AudioModulationClassTemplates.h" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulationEditor_Public_AudioModulationClassTemplates_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulationEditor_Public_AudioModulationClassTemplates_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundModulationClassTemplate, USoundModulationClassTemplate::StaticClass, TEXT("USoundModulationClassTemplate"), &Z_Registration_Info_UClass_USoundModulationClassTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundModulationClassTemplate), 3331859340U) },
		{ Z_Construct_UClass_USoundModulationGeneratorClassTemplate, USoundModulationGeneratorClassTemplate::StaticClass, TEXT("USoundModulationGeneratorClassTemplate"), &Z_Registration_Info_UClass_USoundModulationGeneratorClassTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundModulationGeneratorClassTemplate), 925207645U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulationEditor_Public_AudioModulationClassTemplates_h_1404762959(TEXT("/Script/AudioModulationEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulationEditor_Public_AudioModulationClassTemplates_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioModulation_Source_AudioModulationEditor_Public_AudioModulationClassTemplates_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
