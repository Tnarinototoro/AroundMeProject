...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNewMeshMaterialProperties_Statics::NewProp_UVScale = { "UVScale", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNewMeshMaterialProperties, UVScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNewMeshMaterialProperties_Statics::NewProp_UVScale_MetaData), Z_Construct_UClass_UNewMeshMaterialProperties_Statics::NewProp_UVScale_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNewMeshMaterialProperties_Statics::NewProp_bShowWireframe = { "bShowWireframe", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNewMeshMaterialProperties), &Z_Construct_UClass_UNewMeshMaterialProperties_Statics::NewProp_bShowWireframe_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNewMeshMaterialProperties_Statics::NewProp_bShowWireframe_MetaData), Z_Construct_UClass_UNewMeshMaterialProperties_Statics::NewProp_bShowWireframe_MetaData) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UExistingMeshMaterialProperties_GetUVChannelNamesFunc, "GetUVChannelNamesFunc" }, // 1862647437
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::NewProp_CheckerDensity = { "CheckerDensity", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UExistingMeshMaterialProperties, CheckerDensity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::NewProp_CheckerDensity_MetaData), Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::NewProp_CheckerDensity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::NewProp_CheckerMaterial = { "CheckerMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UExistingMeshMaterialProperties, CheckerMaterial), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::NewProp_CheckerMaterial_MetaData), Z_Construct_UClass_UExistingMeshMaterialProperties_Statics::NewProp_CheckerMaterial_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_MaterialMode = { "MaterialMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeshEditingViewProperties, MaterialMode), Z_Construct_UEnum_MeshModelingTools_EMeshEditingMaterialModes, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_MaterialMode_MetaData), Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_MaterialMode_MetaData) }; // 532499315
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_Image = { "Image", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeshEditingViewProperties, Image), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_Image_MetaData), Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_Image_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_Opacity = { "Opacity", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeshEditingViewProperties, Opacity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_Opacity_MetaData), Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_Opacity_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_bTwoSided = { "bTwoSided", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMeshEditingViewProperties), &Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_bTwoSided_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_bTwoSided_MetaData), Z_Construct_UClass_UMeshEditingViewProperties_Statics::NewProp_bTwoSided_MetaData) };
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_Properties_MeshMaterialProperties_h_Statics::EnumInfo[] = {
		{ ESetMeshMaterialMode_StaticEnum, TEXT("ESetMeshMaterialMode"), &Z_Registration_Info_UEnum_ESetMeshMaterialMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4293412388U) },
		{ EMeshEditingMaterialModes_StaticEnum, TEXT("EMeshEditingMaterialModes"), &Z_Registration_Info_UEnum_EMeshEditingMaterialModes, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 532499315U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_Properties_MeshMaterialProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNewMeshMaterialProperties, UNewMeshMaterialProperties::StaticClass, TEXT("UNewMeshMaterialProperties"), &Z_Registration_Info_UClass_UNewMeshMaterialProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNewMeshMaterialProperties), 101833815U) },
		{ Z_Construct_UClass_UExistingMeshMaterialProperties, UExistingMeshMaterialProperties::StaticClass, TEXT("UExistingMeshMaterialProperties"), &Z_Registration_Info_UClass_UExistingMeshMaterialProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UExistingMeshMaterialProperties), 362338687U) },
		{ Z_Construct_UClass_UMeshEditingViewProperties, UMeshEditingViewProperties::StaticClass, TEXT("UMeshEditingViewProperties"), &Z_Registration_Info_UClass_UMeshEditingViewProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeshEditingViewProperties), 2607603523U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_Properties_MeshMaterialProperties_h_2379003280(TEXT("/Script/MeshModelingTools"),
