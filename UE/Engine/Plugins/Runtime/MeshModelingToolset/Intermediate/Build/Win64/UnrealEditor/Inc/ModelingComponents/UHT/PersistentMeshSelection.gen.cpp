...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_PersistentMeshSelection_Statics::ClassParams = {
		...
		0,
		0x021002A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelection_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_PersistentMeshSelection_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_PersistentMeshSelection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_PersistentMeshSelection, UDEPRECATED_PersistentMeshSelection::StaticClass, TEXT("UDEPRECATED_PersistentMeshSelection"), &Z_Registration_Info_UClass_UDEPRECATED_PersistentMeshSelection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_PersistentMeshSelection), 2693553314U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_PersistentMeshSelection_h_3196470981(TEXT("/Script/ModelingComponents"),
