...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_LineThickness = { "LineThickness", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyLassoMarqueeMechanic, LineThickness), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_LineThickness_MetaData), Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_LineThickness_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_ClosedColor = { "ClosedColor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyLassoMarqueeMechanic, ClosedColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_ClosedColor_MetaData), Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_ClosedColor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_ClickDragBehavior = { "ClickDragBehavior", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyLassoMarqueeMechanic, ClickDragBehavior), Z_Construct_UClass_UClickDragInputBehavior_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_ClickDragBehavior_MetaData), Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_ClickDragBehavior_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_HoverBehavior = { "HoverBehavior", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyLassoMarqueeMechanic, HoverBehavior), Z_Construct_UClass_UMouseHoverBehavior_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_HoverBehavior_MetaData), Z_Construct_UClass_UPolyLassoMarqueeMechanic_Statics::NewProp_HoverBehavior_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Mechanics_PolyLassoMarqueeMechanic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPolyLassoMarqueeMechanic, UPolyLassoMarqueeMechanic::StaticClass, TEXT("UPolyLassoMarqueeMechanic"), &Z_Registration_Info_UClass_UPolyLassoMarqueeMechanic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPolyLassoMarqueeMechanic), 2765146494U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Mechanics_PolyLassoMarqueeMechanic_h_3334623473(TEXT("/Script/ModelingComponents"),
