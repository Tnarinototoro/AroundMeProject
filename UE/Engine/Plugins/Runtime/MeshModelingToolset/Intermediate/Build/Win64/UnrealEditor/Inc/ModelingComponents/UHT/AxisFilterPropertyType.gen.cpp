...
template<> MODELINGCOMPONENTS_API UScriptStruct* StaticStruct<FModelingToolsAxisFilter>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FModelingToolsAxisFilter_Statics::NewProp_bAxisY = { "bAxisY", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FModelingToolsAxisFilter), &Z_Construct_UScriptStruct_FModelingToolsAxisFilter_Statics::NewProp_bAxisY_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FModelingToolsAxisFilter_Statics::NewProp_bAxisY_MetaData), Z_Construct_UScriptStruct_FModelingToolsAxisFilter_Statics::NewProp_bAxisY_MetaData) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_PropertySets_AxisFilterPropertyType_h_Statics::ScriptStructInfo[] = {
		{ FModelingToolsAxisFilter::StaticStruct, Z_Construct_UScriptStruct_FModelingToolsAxisFilter_Statics::NewStructOps, TEXT("ModelingToolsAxisFilter"), &Z_Registration_Info_UScriptStruct_ModelingToolsAxisFilter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FModelingToolsAxisFilter), 3165211198U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_PropertySets_AxisFilterPropertyType_h_488835162(TEXT("/Script/ModelingComponents"),
		nullptr, 0,
