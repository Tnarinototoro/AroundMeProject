...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UPolyEditBevelEdgeProperties_Statics::NewProp_BevelDistance = { "BevelDistance", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditBevelEdgeProperties, BevelDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditBevelEdgeProperties_Statics::NewProp_BevelDistance_MetaData), Z_Construct_UClass_UPolyEditBevelEdgeProperties_Statics::NewProp_BevelDistance_MetaData) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyEditBevelEdgeActivity_Statics::NewProp_BevelProperties = { "BevelProperties", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditBevelEdgeActivity, BevelProperties), Z_Construct_UClass_UPolyEditBevelEdgeProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditBevelEdgeActivity_Statics::NewProp_BevelProperties_MetaData), Z_Construct_UClass_UPolyEditBevelEdgeActivity_Statics::NewProp_BevelProperties_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyEditBevelEdgeActivity_Statics::NewProp_ActivityContext = { "ActivityContext", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditBevelEdgeActivity, ActivityContext), Z_Construct_UClass_UPolyEditActivityContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditBevelEdgeActivity_Statics::NewProp_ActivityContext_MetaData), Z_Construct_UClass_UPolyEditBevelEdgeActivity_Statics::NewProp_ActivityContext_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Private_ToolActivities_PolyEditBevelEdgeActivity_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPolyEditBevelEdgeProperties, UPolyEditBevelEdgeProperties::StaticClass, TEXT("UPolyEditBevelEdgeProperties"), &Z_Registration_Info_UClass_UPolyEditBevelEdgeProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPolyEditBevelEdgeProperties), 834098136U) },
		{ Z_Construct_UClass_UPolyEditBevelEdgeActivity, UPolyEditBevelEdgeActivity::StaticClass, TEXT("UPolyEditBevelEdgeActivity"), &Z_Registration_Info_UClass_UPolyEditBevelEdgeActivity, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPolyEditBevelEdgeActivity), 724179219U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Private_ToolActivities_PolyEditBevelEdgeActivity_h_3762401154(TEXT("/Script/MeshModelingTools"),
