...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_ParentContext = { "ParentContext", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_PersistentMeshSelectionManager, ParentContext), Z_Construct_UClass_UInteractiveToolsContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_ParentContext_MetaData), Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_ParentContext_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_ActiveSelection = { "ActiveSelection", nullptr, (EPropertyFlags)0x0024080020000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_PersistentMeshSelectionManager, ActiveSelection_DEPRECATED), Z_Construct_UClass_UDEPRECATED_PersistentMeshSelection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_ActiveSelection_MetaData), Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_ActiveSelection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_SelectionDisplay = { "SelectionDisplay", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_PersistentMeshSelectionManager, SelectionDisplay), Z_Construct_UClass_UPreviewGeometry_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_SelectionDisplay_MetaData), Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::NewProp_SelectionDisplay_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::ClassParams = {
		...
		0,
		0x021002A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_PersistentMeshSelectionManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_PersistentMeshSelectionManager, UDEPRECATED_PersistentMeshSelectionManager::StaticClass, TEXT("UDEPRECATED_PersistentMeshSelectionManager"), &Z_Registration_Info_UClass_UDEPRECATED_PersistentMeshSelectionManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_PersistentMeshSelectionManager), 2580630526U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_PersistentMeshSelectionManager_h_3520479170(TEXT("/Script/ModelingComponents"),
