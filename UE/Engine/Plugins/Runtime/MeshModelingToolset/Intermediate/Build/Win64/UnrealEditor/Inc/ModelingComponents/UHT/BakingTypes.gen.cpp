...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Baking_BakingTypes_h_Statics::EnumInfo[] = {
		{ EBakeTextureResolution_StaticEnum, TEXT("EBakeTextureResolution"), &Z_Registration_Info_UEnum_EBakeTextureResolution, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3640407009U) },
		{ EBakeTextureBitDepth_StaticEnum, TEXT("EBakeTextureBitDepth"), &Z_Registration_Info_UEnum_EBakeTextureBitDepth, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1926731332U) },
		{ EBakeTextureSamplesPerPixel_StaticEnum, TEXT("EBakeTextureSamplesPerPixel"), &Z_Registration_Info_UEnum_EBakeTextureSamplesPerPixel, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1089820310U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Baking_BakingTypes_h_3545623400(TEXT("/Script/ModelingComponents"),
		nullptr, 0,
		nullptr, 0,
