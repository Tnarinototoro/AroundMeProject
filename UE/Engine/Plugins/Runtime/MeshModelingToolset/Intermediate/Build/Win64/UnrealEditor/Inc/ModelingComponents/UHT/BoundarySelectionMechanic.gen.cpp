...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBoundarySelectionMechanic_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Selection/BoundarySelectionMechanic.h" },
		{ "ModuleRelativePath", "Public/Selection/BoundarySelectionMechanic.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UBoundarySelectionMechanic_Statics::StaticCppClassTypeInfo = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_BoundarySelectionMechanic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBoundarySelectionMechanic, UBoundarySelectionMechanic::StaticClass, TEXT("UBoundarySelectionMechanic"), &Z_Registration_Info_UClass_UBoundarySelectionMechanic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBoundarySelectionMechanic), 2822572024U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_BoundarySelectionMechanic_h_167611091(TEXT("/Script/ModelingComponents"),
