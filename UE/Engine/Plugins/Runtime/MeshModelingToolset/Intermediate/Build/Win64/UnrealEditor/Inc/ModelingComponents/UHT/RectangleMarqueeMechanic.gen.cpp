...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URectangleMarqueeMechanic_Statics::NewProp_bUseExternalUpdateCameraState = { "bUseExternalUpdateCameraState", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URectangleMarqueeMechanic), &Z_Construct_UClass_URectangleMarqueeMechanic_Statics::NewProp_bUseExternalUpdateCameraState_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleMarqueeMechanic_Statics::NewProp_bUseExternalUpdateCameraState_MetaData), Z_Construct_UClass_URectangleMarqueeMechanic_Statics::NewProp_bUseExternalUpdateCameraState_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URectangleMarqueeMechanic_Statics::NewProp_ClickDragBehavior = { "ClickDragBehavior", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URectangleMarqueeMechanic, ClickDragBehavior), Z_Construct_UClass_UClickDragInputBehavior_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleMarqueeMechanic_Statics::NewProp_ClickDragBehavior_MetaData), Z_Construct_UClass_URectangleMarqueeMechanic_Statics::NewProp_ClickDragBehavior_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Mechanics_RectangleMarqueeMechanic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URectangleMarqueeMechanic, URectangleMarqueeMechanic::StaticClass, TEXT("URectangleMarqueeMechanic"), &Z_Registration_Info_UClass_URectangleMarqueeMechanic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URectangleMarqueeMechanic), 3591488104U) },
		{ Z_Construct_UClass_URectangleMarqueeInteraction, URectangleMarqueeInteraction::StaticClass, TEXT("URectangleMarqueeInteraction"), &Z_Registration_Info_UClass_URectangleMarqueeInteraction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URectangleMarqueeInteraction), 1215879322U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Mechanics_RectangleMarqueeMechanic_h_309696539(TEXT("/Script/ModelingComponents"),
