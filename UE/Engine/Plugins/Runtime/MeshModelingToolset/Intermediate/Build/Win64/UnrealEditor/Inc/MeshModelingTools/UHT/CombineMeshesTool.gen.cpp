...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_bIsDuplicateMode = { "bIsDuplicateMode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UCombineMeshesToolProperties), &Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_bIsDuplicateMode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_bIsDuplicateMode_MetaData), Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_bIsDuplicateMode_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputWriteTo = { "OutputWriteTo", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombineMeshesToolProperties, OutputWriteTo), Z_Construct_UEnum_ModelingComponents_EBaseCreateFromSelectedTargetType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputWriteTo_MetaData), Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputWriteTo_MetaData) }; // 3479502178
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputNewName = { "OutputNewName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombineMeshesToolProperties, OutputNewName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputNewName_MetaData), Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputNewName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputExistingName = { "OutputExistingName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombineMeshesToolProperties, OutputExistingName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputExistingName_MetaData), Z_Construct_UClass_UCombineMeshesToolProperties_Statics::NewProp_OutputExistingName_MetaData) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCombineMeshesTool_Statics::NewProp_BasicProperties = { "BasicProperties", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCombineMeshesTool, BasicProperties), Z_Construct_UClass_UCombineMeshesToolProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCombineMeshesTool_Statics::NewProp_BasicProperties_MetaData), Z_Construct_UClass_UCombineMeshesTool_Statics::NewProp_BasicProperties_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCombineMeshesTool_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UCombineMeshesTool_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UInteractiveToolExclusiveToolAPI_NoRegister, (int32)VTABLE_OFFSET(UCombineMeshesTool, IInteractiveToolExclusiveToolAPI), false },  // 1043071084
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCombineMeshesTool_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_CombineMeshesTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCombineMeshesToolBuilder, UCombineMeshesToolBuilder::StaticClass, TEXT("UCombineMeshesToolBuilder"), &Z_Registration_Info_UClass_UCombineMeshesToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombineMeshesToolBuilder), 1823613567U) },
		{ Z_Construct_UClass_UCombineMeshesToolProperties, UCombineMeshesToolProperties::StaticClass, TEXT("UCombineMeshesToolProperties"), &Z_Registration_Info_UClass_UCombineMeshesToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombineMeshesToolProperties), 563633363U) },
		{ Z_Construct_UClass_UCombineMeshesTool, UCombineMeshesTool::StaticClass, TEXT("UCombineMeshesTool"), &Z_Registration_Info_UClass_UCombineMeshesTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombineMeshesTool), 3578591247U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_CombineMeshesTool_h_365356589(TEXT("/Script/MeshModelingTools"),
