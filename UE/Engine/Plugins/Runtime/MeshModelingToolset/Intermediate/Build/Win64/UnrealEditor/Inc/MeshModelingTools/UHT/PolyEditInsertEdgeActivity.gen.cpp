...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGroupEdgeInsertionProperties_Statics::NewProp_bContinuousInsertion = { "bContinuousInsertion", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UGroupEdgeInsertionProperties), &Z_Construct_UClass_UGroupEdgeInsertionProperties_Statics::NewProp_bContinuousInsertion_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGroupEdgeInsertionProperties_Statics::NewProp_bContinuousInsertion_MetaData), Z_Construct_UClass_UGroupEdgeInsertionProperties_Statics::NewProp_bContinuousInsertion_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyEditInsertEdgeActivity_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditInsertEdgeActivity, Settings), Z_Construct_UClass_UGroupEdgeInsertionProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditInsertEdgeActivity_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_UPolyEditInsertEdgeActivity_Statics::NewProp_Settings_MetaData) };
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_ToolActivities_PolyEditInsertEdgeActivity_h_Statics::EnumInfo[] = {
		{ EGroupEdgeInsertionMode_StaticEnum, TEXT("EGroupEdgeInsertionMode"), &Z_Registration_Info_UEnum_EGroupEdgeInsertionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1780533420U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_ToolActivities_PolyEditInsertEdgeActivity_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGroupEdgeInsertionProperties, UGroupEdgeInsertionProperties::StaticClass, TEXT("UGroupEdgeInsertionProperties"), &Z_Registration_Info_UClass_UGroupEdgeInsertionProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGroupEdgeInsertionProperties), 511222528U) },
		{ Z_Construct_UClass_UPolyEditInsertEdgeActivity, UPolyEditInsertEdgeActivity::StaticClass, TEXT("UPolyEditInsertEdgeActivity"), &Z_Registration_Info_UClass_UPolyEditInsertEdgeActivity, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPolyEditInsertEdgeActivity), 906095537U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_ToolActivities_PolyEditInsertEdgeActivity_h_1147650293(TEXT("/Script/MeshModelingTools"),
