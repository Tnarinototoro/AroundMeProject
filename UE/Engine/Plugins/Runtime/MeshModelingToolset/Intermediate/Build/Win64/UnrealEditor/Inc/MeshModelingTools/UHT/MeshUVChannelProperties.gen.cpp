...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMeshUVChannelProperties_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMeshUVChannelProperties_GetUVChannelNamesFunc, "GetUVChannelNamesFunc" }, // 1574223320
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeshUVChannelProperties_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_Properties_MeshUVChannelProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMeshUVChannelProperties, UMeshUVChannelProperties::StaticClass, TEXT("UMeshUVChannelProperties"), &Z_Registration_Info_UClass_UMeshUVChannelProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeshUVChannelProperties), 3413884368U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_Properties_MeshUVChannelProperties_h_1459445408(TEXT("/Script/MeshModelingTools"),
