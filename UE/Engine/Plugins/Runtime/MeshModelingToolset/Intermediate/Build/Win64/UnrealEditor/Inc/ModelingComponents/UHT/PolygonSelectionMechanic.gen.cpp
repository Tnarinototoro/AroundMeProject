...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDEPRECATED_PolygonSelectionMechanicProperties_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UDEPRECATED_PolygonSelectionMechanicProperties_Statics::StaticCppClassTypeInfo = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPolygonSelectionMechanic_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPolygonSelectionMechanic_Statics::NewProp_Properties_MetaData[] = {
		{ "ModuleRelativePath", "Public/Selection/PolygonSelectionMechanic.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolygonSelectionMechanic_Statics::NewProp_Properties = { "Properties", nullptr, (EPropertyFlags)0x0014000020000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolygonSelectionMechanic, Properties_DEPRECATED), Z_Construct_UClass_UDEPRECATED_PolygonSelectionMechanicProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolygonSelectionMechanic_Statics::NewProp_Properties_MetaData), Z_Construct_UClass_UPolygonSelectionMechanic_Statics::NewProp_Properties_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPolygonSelectionMechanic_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPolygonSelectionMechanic_Statics::NewProp_Properties,
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPolygonSelectionMechanic_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_PolygonSelectionMechanic_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UPolygonSelectionMechanic, UPolygonSelectionMechanic::StaticClass, TEXT("UPolygonSelectionMechanic"), &Z_Registration_Info_UClass_UPolygonSelectionMechanic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPolygonSelectionMechanic), 143966746U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingComponents_Public_Selection_PolygonSelectionMechanic_h_962785613(TEXT("/Script/ModelingComponents"),
