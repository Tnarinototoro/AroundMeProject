...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPolyEditInsetOutsetProperties_Statics::NewProp_Softness = { "Softness", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditInsetOutsetProperties, Softness), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditInsetOutsetProperties_Statics::NewProp_Softness_MetaData), Z_Construct_UClass_UPolyEditInsetOutsetProperties_Statics::NewProp_Softness_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPolyEditInsetOutsetProperties_Statics::NewProp_AreaScale = { "AreaScale", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditInsetOutsetProperties, AreaScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditInsetOutsetProperties_Statics::NewProp_AreaScale_MetaData), Z_Construct_UClass_UPolyEditInsetOutsetProperties_Statics::NewProp_AreaScale_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditInsetOutsetActivity, Settings), Z_Construct_UClass_UPolyEditInsetOutsetProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_Settings_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_EditPreview = { "EditPreview", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditInsetOutsetActivity, EditPreview), Z_Construct_UClass_UPolyEditPreviewMesh_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_EditPreview_MetaData), Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_EditPreview_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_CurveDistMechanic = { "CurveDistMechanic", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditInsetOutsetActivity, CurveDistMechanic), Z_Construct_UClass_USpatialCurveDistanceMechanic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_CurveDistMechanic_MetaData), Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_CurveDistMechanic_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_ActivityContext = { "ActivityContext", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPolyEditInsetOutsetActivity, ActivityContext), Z_Construct_UClass_UPolyEditActivityContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_ActivityContext_MetaData), Z_Construct_UClass_UPolyEditInsetOutsetActivity_Statics::NewProp_ActivityContext_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_ToolActivities_PolyEditInsetOutsetActivity_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPolyEditInsetOutsetProperties, UPolyEditInsetOutsetProperties::StaticClass, TEXT("UPolyEditInsetOutsetProperties"), &Z_Registration_Info_UClass_UPolyEditInsetOutsetProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPolyEditInsetOutsetProperties), 3406123531U) },
		{ Z_Construct_UClass_UPolyEditInsetOutsetActivity, UPolyEditInsetOutsetActivity::StaticClass, TEXT("UPolyEditInsetOutsetActivity"), &Z_Registration_Info_UClass_UPolyEditInsetOutsetActivity, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPolyEditInsetOutsetActivity), 3484890284U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_MeshModelingTools_Public_ToolActivities_PolyEditInsetOutsetActivity_h_1853592342(TEXT("/Script/MeshModelingTools"),
