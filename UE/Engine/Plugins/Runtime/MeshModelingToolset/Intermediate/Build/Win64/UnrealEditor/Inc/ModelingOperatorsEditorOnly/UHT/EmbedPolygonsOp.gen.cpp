...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_ModelingOperatorsEditorOnly_EEmbeddedPolygonOpMethod_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_ModelingOperatorsEditorOnly_EEmbeddedPolygonOpMethod_Statics::Enum_MetaDataParams), Z_Construct_UEnum_ModelingOperatorsEditorOnly_EEmbeddedPolygonOpMethod_Statics::Enum_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingOperatorsEditorOnly_Public_CuttingOps_EmbedPolygonsOp_h_Statics::EnumInfo[] = {
		{ EEmbeddedPolygonOpMethod_StaticEnum, TEXT("EEmbeddedPolygonOpMethod"), &Z_Registration_Info_UEnum_EEmbeddedPolygonOpMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4285739370U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshModelingToolset_Source_ModelingOperatorsEditorOnly_Public_CuttingOps_EmbedPolygonsOp_h_2400108937(TEXT("/Script/ModelingOperatorsEditorOnly"),
		nullptr, 0,
		nullptr, 0,
