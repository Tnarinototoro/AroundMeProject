...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UComputeKernel_Statics::NewProp_KernelSource = { "KernelSource", nullptr, (EPropertyFlags)0x0014010000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UComputeKernel, KernelSource), Z_Construct_UClass_UComputeKernelSource_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComputeKernel_Statics::NewProp_KernelSource_MetaData), Z_Construct_UClass_UComputeKernel_Statics::NewProp_KernelSource_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UComputeKernel_Statics::NewProp_KernelFlags = { "KernelFlags", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UComputeKernel, KernelFlags), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComputeKernel_Statics::NewProp_KernelFlags_MetaData), Z_Construct_UClass_UComputeKernel_Statics::NewProp_KernelFlags_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFramework_Public_ComputeFramework_ComputeKernel_h_Statics::EnumInfo[] = {
		{ EComputeKernelFlags_StaticEnum, TEXT("EComputeKernelFlags"), &Z_Registration_Info_UEnum_EComputeKernelFlags, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4175429519U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFramework_Public_ComputeFramework_ComputeKernel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComputeKernel, UComputeKernel::StaticClass, TEXT("UComputeKernel"), &Z_Registration_Info_UClass_UComputeKernel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComputeKernel), 2697139236U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFramework_Public_ComputeFramework_ComputeKernel_h_3230468322(TEXT("/Script/ComputeFramework"),
