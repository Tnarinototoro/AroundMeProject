...
template<> COMPUTEFRAMEWORK_API UScriptStruct* StaticStruct<FComputeGraphInstance>()
{
	...
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FComputeGraphInstance_Statics::NewProp_DataProviders_Inner = { "DataProviders", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UComputeDataProvider_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FComputeGraphInstance_Statics::NewProp_DataProviders = { "DataProviders", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FComputeGraphInstance, DataProviders), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComputeGraphInstance_Statics::NewProp_DataProviders_MetaData), Z_Construct_UScriptStruct_FComputeGraphInstance_Statics::NewProp_DataProviders_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFramework_Public_ComputeFramework_ComputeGraphInstance_h_Statics::ScriptStructInfo[] = {
		{ FComputeGraphInstance::StaticStruct, Z_Construct_UScriptStruct_FComputeGraphInstance_Statics::NewStructOps, TEXT("ComputeGraphInstance"), &Z_Registration_Info_UScriptStruct_ComputeGraphInstance, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComputeGraphInstance), 3698525528U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFramework_Public_ComputeFramework_ComputeGraphInstance_h_686657172(TEXT("/Script/ComputeFramework"),
		nullptr, 0,
