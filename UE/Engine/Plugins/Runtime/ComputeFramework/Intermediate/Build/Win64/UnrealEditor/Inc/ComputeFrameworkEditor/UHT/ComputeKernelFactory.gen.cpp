...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComputeKernelFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UComputeKernelFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComputeKernelFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UComputeKernelFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFrameworkEditor_Private_ComputeFramework_ComputeKernelFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComputeKernelFactory, UComputeKernelFactory::StaticClass, TEXT("UComputeKernelFactory"), &Z_Registration_Info_UClass_UComputeKernelFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComputeKernelFactory), 3352811243U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFrameworkEditor_Private_ComputeFramework_ComputeKernelFactory_h_1087206828(TEXT("/Script/ComputeFrameworkEditor"),
