...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UComputeKernelFromTextFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UComputeKernelFromTextFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UComputeKernelFromTextFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UComputeKernelFromTextFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFrameworkEditor_Private_ComputeFramework_ComputeKernelFromTextFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComputeKernelFromTextFactory, UComputeKernelFromTextFactory::StaticClass, TEXT("UComputeKernelFromTextFactory"), &Z_Registration_Info_UClass_UComputeKernelFromTextFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComputeKernelFromTextFactory), 3545006619U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ComputeFramework_Source_ComputeFrameworkEditor_Private_ComputeFramework_ComputeKernelFromTextFactory_h_2321169428(TEXT("/Script/ComputeFrameworkEditor"),
