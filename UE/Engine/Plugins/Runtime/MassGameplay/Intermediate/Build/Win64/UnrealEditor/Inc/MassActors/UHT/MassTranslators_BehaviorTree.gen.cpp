...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FDataFragment_BehaviorTreeComponentWrapper>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDataFragment_BehaviorTreeComponentWrapper_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataFragment_BehaviorTreeComponentWrapper_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDataFragment_BehaviorTreeComponentWrapper_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassTranslator_BehaviorTree_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassTranslator_BehaviorTree_Statics::ClassParams = {
		...
		0,
		0x401030A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassTranslator_BehaviorTree_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassTranslator_BehaviorTree_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_Translators_MassTranslators_BehaviorTree_h_Statics::ScriptStructInfo[] = {
		{ FDataFragment_BehaviorTreeComponentWrapper::StaticStruct, Z_Construct_UScriptStruct_FDataFragment_BehaviorTreeComponentWrapper_Statics::NewStructOps, TEXT("DataFragment_BehaviorTreeComponentWrapper"), &Z_Registration_Info_UScriptStruct_DataFragment_BehaviorTreeComponentWrapper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDataFragment_BehaviorTreeComponentWrapper), 3664998980U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_Translators_MassTranslators_BehaviorTree_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassTranslator_BehaviorTree, UMassTranslator_BehaviorTree::StaticClass, TEXT("UMassTranslator_BehaviorTree"), &Z_Registration_Info_UClass_UMassTranslator_BehaviorTree, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassTranslator_BehaviorTree), 4090157655U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_Translators_MassTranslators_BehaviorTree_h_1061808735(TEXT("/Script/MassActors"),
