...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::NewProp_DebugShape = { "DebugShape", nullptr, (EPropertyFlags)0x0020080800000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassDebugVisualizationTrait, DebugShape), Z_Construct_UScriptStruct_FAgentDebugVisualization, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::NewProp_DebugShape_MetaData), Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::NewProp_DebugShape_MetaData) }; // 3094757884
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassDebugVisualizationTrait_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassGameplayDebug_Public_MassDebugVisualizationTrait_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassDebugVisualizationTrait, UMassDebugVisualizationTrait::StaticClass, TEXT("UMassDebugVisualizationTrait"), &Z_Registration_Info_UClass_UMassDebugVisualizationTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassDebugVisualizationTrait), 3776710291U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassGameplayDebug_Public_MassDebugVisualizationTrait_h_1620625900(TEXT("/Script/MassGameplayDebug"),
