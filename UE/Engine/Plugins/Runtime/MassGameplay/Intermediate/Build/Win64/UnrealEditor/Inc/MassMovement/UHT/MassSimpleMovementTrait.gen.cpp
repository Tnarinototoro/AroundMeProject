...
template<> MASSMOVEMENT_API UScriptStruct* StaticStruct<FMassSimpleMovementTag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassSimpleMovementTag_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassSimpleMovementTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassSimpleMovementTag_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimpleMovementTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSimpleMovementTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimpleMovementTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSimpleMovementTrait_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimpleMovementProcessor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSimpleMovementProcessor_Statics::ClassParams = {
		...
		0,
		0x401030A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimpleMovementProcessor_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSimpleMovementProcessor_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassMovement_Public_Example_MassSimpleMovementTrait_h_Statics::ScriptStructInfo[] = {
		{ FMassSimpleMovementTag::StaticStruct, Z_Construct_UScriptStruct_FMassSimpleMovementTag_Statics::NewStructOps, TEXT("MassSimpleMovementTag"), &Z_Registration_Info_UScriptStruct_MassSimpleMovementTag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassSimpleMovementTag), 1468430749U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassMovement_Public_Example_MassSimpleMovementTrait_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassSimpleMovementTrait, UMassSimpleMovementTrait::StaticClass, TEXT("UMassSimpleMovementTrait"), &Z_Registration_Info_UClass_UMassSimpleMovementTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassSimpleMovementTrait), 1178688131U) },
		{ Z_Construct_UClass_UMassSimpleMovementProcessor, UMassSimpleMovementProcessor::StaticClass, TEXT("UMassSimpleMovementProcessor"), &Z_Registration_Info_UClass_UMassSimpleMovementProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassSimpleMovementProcessor), 3474773844U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassMovement_Public_Example_MassSimpleMovementTrait_h_4199065798(TEXT("/Script/MassMovement"),
