...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassActorSpawnRequestHandle>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassActorSpawnRequestHandle_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorSpawnRequestHandle_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassActorSpawnRequestHandle_Statics::Struct_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MassActors_ESpawnRequestStatus_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MassActors_ESpawnRequestStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MassActors_ESpawnRequestStatus_Statics::Enum_MetaDataParams)
	};
...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassActorSpawnRequest>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::NewProp_Template = { "Template", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassActorSpawnRequest, Template), Z_Construct_UClass_UClass, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::NewProp_Template_MetaData), Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::NewProp_Template_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::NewProp_SpawnedActor = { "SpawnedActor", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassActorSpawnRequest, SpawnedActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::NewProp_SpawnedActor_MetaData), Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::NewProp_SpawnedActor_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::NewProp_SpawnRequests_Inner = { "SpawnRequests", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FInstancedStruct, METADATA_PARAMS(0, nullptr) }; // 2114042832
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::NewProp_SpawnRequests = { "SpawnRequests", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassActorSpawnerSubsystem, SpawnRequests), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::NewProp_SpawnRequests_MetaData), Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::NewProp_SpawnRequests_MetaData) }; // 2114042832
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::NewProp_ActorsToDestroy = { "ActorsToDestroy", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassActorSpawnerSubsystem, ActorsToDestroy), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::NewProp_ActorsToDestroy_MetaData), Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::NewProp_ActorsToDestroy_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassActorSpawnerSubsystem_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassActorSpawnerSubsystem_h_Statics::EnumInfo[] = {
		{ ESpawnRequestStatus_StaticEnum, TEXT("ESpawnRequestStatus"), &Z_Registration_Info_UEnum_ESpawnRequestStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2556490053U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassActorSpawnerSubsystem_h_Statics::ScriptStructInfo[] = {
		{ FMassActorSpawnRequestHandle::StaticStruct, Z_Construct_UScriptStruct_FMassActorSpawnRequestHandle_Statics::NewStructOps, TEXT("MassActorSpawnRequestHandle"), &Z_Registration_Info_UScriptStruct_MassActorSpawnRequestHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassActorSpawnRequestHandle), 1113521081U) },
		{ FMassActorSpawnRequest::StaticStruct, Z_Construct_UScriptStruct_FMassActorSpawnRequest_Statics::NewStructOps, TEXT("MassActorSpawnRequest"), &Z_Registration_Info_UScriptStruct_MassActorSpawnRequest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassActorSpawnRequest), 3202978473U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassActorSpawnerSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassActorSpawnerSubsystem, UMassActorSpawnerSubsystem::StaticClass, TEXT("UMassActorSpawnerSubsystem"), &Z_Registration_Info_UClass_UMassActorSpawnerSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassActorSpawnerSubsystem), 2572081369U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassActorSpawnerSubsystem_h_1600489644(TEXT("/Script/MassActors"),
