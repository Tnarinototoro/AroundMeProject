...
template<> MASSSPAWNER_API UScriptStruct* StaticStruct<FMassEntityConfig>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ConfigOwner_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_ConfigOwner;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassEntityConfig, Parent), Z_Construct_UClass_UMassEntityConfigAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Parent_MetaData), Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Parent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Traits_Inner = { "Traits", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMassEntityTraitBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Traits_Inner_MetaData), Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Traits_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Traits = { "Traits", nullptr, (EPropertyFlags)0x0024088000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassEntityConfig, Traits), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Traits_MetaData), Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_Traits_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigOwner_MetaData[] = {
		{ "ModuleRelativePath", "Public/MassEntityConfigAsset.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigOwner = { "ConfigOwner", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassEntityConfig, ConfigOwner), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigOwner_MetaData), Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigOwner_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigGuid_MetaData[] = {
		{ "Category", "Mass" },
		{ "IgnoreForMemberInitializationTest", "" },
		{ "ModuleRelativePath", "Public/MassEntityConfigAsset.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigGuid = { "ConfigGuid", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassEntityConfig, ConfigGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigGuid_MetaData), Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigGuid_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMassEntityConfig_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigOwner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewProp_ConfigGuid,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassEntityConfig_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityConfig_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassEntityConfig_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassEntityConfig_Statics::PropPointers) < 2048);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassEntityConfigAsset_ValidateEntityConfig_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMassEntityConfigAsset, nullptr, "ValidateEntityConfig", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x20020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassEntityConfigAsset_ValidateEntityConfig_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMassEntityConfigAsset_ValidateEntityConfig_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassEntityConfigAsset_Statics::DependentSingletons) < 16);
#if WITH_EDITOR
	const FClassFunctionLinkInfo Z_Construct_UClass_UMassEntityConfigAsset_Statics::FuncInfo[] = {
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UMassEntityConfigAsset_ValidateEntityConfig, "ValidateEntityConfig" }, // 1285450628
#endif //WITH_EDITOR
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassEntityConfigAsset_Statics::FuncInfo) < 2048);
#endif //WITH_EDITOR
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassEntityConfigAsset_Statics::NewProp_Config = { "Config", nullptr, (EPropertyFlags)0x0020088000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassEntityConfigAsset, Config), Z_Construct_UScriptStruct_FMassEntityConfig, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassEntityConfigAsset_Statics::NewProp_Config_MetaData), Z_Construct_UClass_UMassEntityConfigAsset_Statics::NewProp_Config_MetaData) }; // 1992023501
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassEntityConfigAsset_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassEntityConfigAsset_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassEntityConfigAsset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassEntityConfigAsset_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSpawner_Public_MassEntityConfigAsset_h_Statics::ScriptStructInfo[] = {
		{ FMassEntityConfig::StaticStruct, Z_Construct_UScriptStruct_FMassEntityConfig_Statics::NewStructOps, TEXT("MassEntityConfig"), &Z_Registration_Info_UScriptStruct_MassEntityConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassEntityConfig), 1992023501U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSpawner_Public_MassEntityConfigAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassEntityConfigAsset, UMassEntityConfigAsset::StaticClass, TEXT("UMassEntityConfigAsset"), &Z_Registration_Info_UClass_UMassEntityConfigAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassEntityConfigAsset), 3200585919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSpawner_Public_MassEntityConfigAsset_h_2353449992(TEXT("/Script/MassSpawner"),
