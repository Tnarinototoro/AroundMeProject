...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassMovementSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassMovementSettings_Statics::NewProp_MovementStyles_Inner = { "MovementStyles", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FMassMovementStyle, METADATA_PARAMS(0, nullptr) }; // 1984117220
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMassMovementSettings_Statics::NewProp_MovementStyles = { "MovementStyles", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassMovementSettings, MovementStyles), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassMovementSettings_Statics::NewProp_MovementStyles_MetaData), Z_Construct_UClass_UMassMovementSettings_Statics::NewProp_MovementStyles_MetaData) }; // 1984117220
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassMovementSettings_Statics::ClassParams = {
		...
		0,
		0x001020A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassMovementSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassMovementSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassMovementSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassMovement_Public_MassMovementSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassMovementSettings, UMassMovementSettings::StaticClass, TEXT("UMassMovementSettings"), &Z_Registration_Info_UClass_UMassMovementSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassMovementSettings), 808719293U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassMovement_Public_MassMovementSettings_h_101888901(TEXT("/Script/MassMovement"),
