...
// Cross Module References
	...
	MASSREPRESENTATION_API UScriptStruct* Z_Construct_UScriptStruct_FMassStaticRepresentationTag();
...
static_assert(std::is_polymorphic<FMassStaticRepresentationTag>() == std::is_polymorphic<FMassTag>(), "USTRUCT FMassStaticRepresentationTag cannot be polymorphic unless super FMassTag is polymorphic");

	static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag;
class UScriptStruct* FMassStaticRepresentationTag::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMassStaticRepresentationTag, (UObject*)Z_Construct_UPackage__Script_MassRepresentation(), TEXT("MassStaticRepresentationTag"));
	}
	return Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag.OuterSingleton;
}
template<> MASSREPRESENTATION_API UScriptStruct* StaticStruct<FMassStaticRepresentationTag>()
{
	return FMassStaticRepresentationTag::StaticStruct();
}
	struct Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MassRepresentationFragments.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FMassStaticRepresentationTag>();
	}
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_MassRepresentation,
		Z_Construct_UScriptStruct_FMassTag,
		&NewStructOps,
		"MassStaticRepresentationTag",
		nullptr,
		0,
		sizeof(FMassStaticRepresentationTag),
		alignof(FMassStaticRepresentationTag),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics::Struct_MetaDataParams)
	};
	UScriptStruct* Z_Construct_UScriptStruct_FMassStaticRepresentationTag()
	{
		if (!Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag.InnerSingleton)
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag.InnerSingleton, Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics::ReturnStructParams);
		}
		return Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag.InnerSingleton;
	}
...
template<> MASSREPRESENTATION_API UScriptStruct* StaticStruct<FMassRepresentationLODFragment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassRepresentationLODFragment_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationLODFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassRepresentationLODFragment_Statics::Struct_MetaDataParams)
	};
...
template<> MASSREPRESENTATION_API UScriptStruct* StaticStruct<FMassRepresentationFragment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassRepresentationFragment_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassRepresentationFragment_Statics::Struct_MetaDataParams)
	};
...
template<> MASSREPRESENTATION_API UScriptStruct* StaticStruct<FMassRepresentationSubsystemSharedFragment>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassRepresentationSubsystemSharedFragment_Statics::NewProp_RepresentationSubsystem = { "RepresentationSubsystem", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassRepresentationSubsystemSharedFragment, RepresentationSubsystem), Z_Construct_UClass_UMassRepresentationSubsystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationSubsystemSharedFragment_Statics::NewProp_RepresentationSubsystem_MetaData), Z_Construct_UScriptStruct_FMassRepresentationSubsystemSharedFragment_Statics::NewProp_RepresentationSubsystem_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassRepresentationSubsystemSharedFragment_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationSubsystemSharedFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassRepresentationSubsystemSharedFragment_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationSubsystemSharedFragment_Statics::PropPointers) < 2048);
...
template<> MASSREPRESENTATION_API UScriptStruct* StaticStruct<FMassRepresentationParameters>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bCanModifyRepresentationActorManagementClass_MetaData[];
#endif
		static void NewProp_bCanModifyRepresentationActorManagementClass_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bCanModifyRepresentationActorManagementClass;
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_RepresentationActorManagementClass = { "RepresentationActorManagementClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassRepresentationParameters, RepresentationActorManagementClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UMassRepresentationActorManagement_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_RepresentationActorManagementClass_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_RepresentationActorManagementClass_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_LODRepresentation = { "LODRepresentation", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(LODRepresentation, FMassRepresentationParameters), STRUCT_OFFSET(FMassRepresentationParameters, LODRepresentation), Z_Construct_UEnum_MassRepresentation_EMassRepresentationType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_LODRepresentation_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_LODRepresentation_MetaData) }; // 1146178469
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepLowResActors = { "bKeepLowResActors", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMassRepresentationParameters), &Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepLowResActors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepLowResActors_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepLowResActors_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepActorExtraFrame = { "bKeepActorExtraFrame", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMassRepresentationParameters), &Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepActorExtraFrame_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepActorExtraFrame_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bKeepActorExtraFrame_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bSpreadFirstVisualizationUpdate = { "bSpreadFirstVisualizationUpdate", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMassRepresentationParameters), &Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bSpreadFirstVisualizationUpdate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bSpreadFirstVisualizationUpdate_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bSpreadFirstVisualizationUpdate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_WorldPartitionGridNameContainingCollision = { "WorldPartitionGridNameContainingCollision", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassRepresentationParameters, WorldPartitionGridNameContainingCollision), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_WorldPartitionGridNameContainingCollision_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_WorldPartitionGridNameContainingCollision_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_NotVisibleUpdateRate = { "NotVisibleUpdateRate", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassRepresentationParameters, NotVisibleUpdateRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_NotVisibleUpdateRate_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_NotVisibleUpdateRate_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_CachedDefaultRepresentationType = { "CachedDefaultRepresentationType", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassRepresentationParameters, CachedDefaultRepresentationType), Z_Construct_UEnum_MassRepresentation_EMassRepresentationType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_CachedDefaultRepresentationType_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_CachedDefaultRepresentationType_MetaData) }; // 1146178469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_CachedRepresentationActorManagement = { "CachedRepresentationActorManagement", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassRepresentationParameters, CachedRepresentationActorManagement), Z_Construct_UClass_UMassRepresentationActorManagement_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_CachedRepresentationActorManagement_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_CachedRepresentationActorManagement_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bCanModifyRepresentationActorManagementClass_MetaData[] = {
		{ "Category", "Mass|Visual" },
...
#endif
	void Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bCanModifyRepresentationActorManagementClass_SetBit(void* Obj)
	{
		((FMassRepresentationParameters*)Obj)->bCanModifyRepresentationActorManagementClass = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bCanModifyRepresentationActorManagementClass = { "bCanModifyRepresentationActorManagementClass", nullptr, (EPropertyFlags)0x0010000800010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FMassRepresentationParameters), &Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bCanModifyRepresentationActorManagementClass_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bCanModifyRepresentationActorManagementClass_MetaData), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bCanModifyRepresentationActorManagementClass_MetaData) };
#endif // WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::NewProp_bCanModifyRepresentationActorManagementClass,
#endif // WITH_EDITORONLY_DATA
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassRepresentationParameters_Statics::PropPointers) < 2048);
...
template<> MASSREPRESENTATION_API UScriptStruct* StaticStruct<FMassVisualizationLODParameters>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_BaseLODDistance = { "BaseLODDistance", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(BaseLODDistance, FMassVisualizationLODParameters), STRUCT_OFFSET(FMassVisualizationLODParameters, BaseLODDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_BaseLODDistance_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_BaseLODDistance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_VisibleLODDistance = { "VisibleLODDistance", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(VisibleLODDistance, FMassVisualizationLODParameters), STRUCT_OFFSET(FMassVisualizationLODParameters, VisibleLODDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_VisibleLODDistance_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_VisibleLODDistance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_BufferHysteresisOnDistancePercentage = { "BufferHysteresisOnDistancePercentage", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassVisualizationLODParameters, BufferHysteresisOnDistancePercentage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_BufferHysteresisOnDistancePercentage_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_BufferHysteresisOnDistancePercentage_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_LODMaxCount = { "LODMaxCount", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(LODMaxCount, FMassVisualizationLODParameters), STRUCT_OFFSET(FMassVisualizationLODParameters, LODMaxCount), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_LODMaxCount_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_LODMaxCount_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_DistanceToFrustum = { "DistanceToFrustum", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassVisualizationLODParameters, DistanceToFrustum), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_DistanceToFrustum_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_DistanceToFrustum_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_DistanceToFrustumHysteresis = { "DistanceToFrustumHysteresis", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassVisualizationLODParameters, DistanceToFrustumHysteresis), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_DistanceToFrustumHysteresis_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_DistanceToFrustumHysteresis_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_FilterTag = { "FilterTag", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassVisualizationLODParameters, FilterTag), Z_Construct_UClass_UScriptStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_FilterTag_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::NewProp_FilterTag_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODParameters_Statics::PropPointers) < 2048);
...
template<> MASSREPRESENTATION_API UScriptStruct* StaticStruct<FMassVisualizationLODSharedFragment>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassVisualizationLODSharedFragment_Statics::NewProp_FilterTag = { "FilterTag", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassVisualizationLODSharedFragment, FilterTag), Z_Construct_UClass_UScriptStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODSharedFragment_Statics::NewProp_FilterTag_MetaData), Z_Construct_UScriptStruct_FMassVisualizationLODSharedFragment_Statics::NewProp_FilterTag_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassVisualizationLODSharedFragment_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODSharedFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassVisualizationLODSharedFragment_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassVisualizationLODSharedFragment_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassRepresentation_Public_MassRepresentationFragments_h_Statics::ScriptStructInfo[] = {
		{ FMassStaticRepresentationTag::StaticStruct, Z_Construct_UScriptStruct_FMassStaticRepresentationTag_Statics::NewStructOps, TEXT("MassStaticRepresentationTag"), &Z_Registration_Info_UScriptStruct_MassStaticRepresentationTag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassStaticRepresentationTag), 1751155639U) },
