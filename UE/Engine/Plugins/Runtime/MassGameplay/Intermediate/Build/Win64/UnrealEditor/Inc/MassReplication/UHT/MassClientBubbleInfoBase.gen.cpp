...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AMassClientBubbleInfoBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AMassClientBubbleInfoBase_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMassClientBubbleInfoBase_Statics::Class_MetaDataParams), Z_Construct_UClass_AMassClientBubbleInfoBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassReplication_Public_MassClientBubbleInfoBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMassClientBubbleInfoBase, AMassClientBubbleInfoBase::StaticClass, TEXT("AMassClientBubbleInfoBase"), &Z_Registration_Info_UClass_AMassClientBubbleInfoBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMassClientBubbleInfoBase), 3760952451U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassReplication_Public_MassClientBubbleInfoBase_h_1582710747(TEXT("/Script/MassReplication"),
