...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentSyncTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMassAgentSyncTrait_Statics::NewProp_SyncDirection = { "SyncDirection", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassAgentSyncTrait, SyncDirection), Z_Construct_UEnum_MassSpawner_EMassTranslationDirection, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentSyncTrait_Statics::NewProp_SyncDirection_MetaData), Z_Construct_UClass_UMassAgentSyncTrait_Statics::NewProp_SyncDirection_MetaData) }; // 271024664
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassAgentSyncTrait_Statics::ClassParams = {
		...
		0,
		0x001030A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentSyncTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassAgentSyncTrait_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentSyncTrait_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::NewProp_bSyncTransform = { "bSyncTransform", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMassAgentCapsuleCollisionSyncTrait), &Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::NewProp_bSyncTransform_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::NewProp_bSyncTransform_MetaData), Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::NewProp_bSyncTransform_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentMovementSyncTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassAgentMovementSyncTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentMovementSyncTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassAgentMovementSyncTrait_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentOrientationSyncTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassAgentOrientationSyncTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentOrientationSyncTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassAgentOrientationSyncTrait_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentFeetLocationSyncTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassAgentFeetLocationSyncTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassAgentFeetLocationSyncTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassAgentFeetLocationSyncTrait_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassAgentTraits_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassAgentSyncTrait, UMassAgentSyncTrait::StaticClass, TEXT("UMassAgentSyncTrait"), &Z_Registration_Info_UClass_UMassAgentSyncTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassAgentSyncTrait), 3575911472U) },
		{ Z_Construct_UClass_UMassAgentCapsuleCollisionSyncTrait, UMassAgentCapsuleCollisionSyncTrait::StaticClass, TEXT("UMassAgentCapsuleCollisionSyncTrait"), &Z_Registration_Info_UClass_UMassAgentCapsuleCollisionSyncTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassAgentCapsuleCollisionSyncTrait), 3510109596U) },
		{ Z_Construct_UClass_UMassAgentMovementSyncTrait, UMassAgentMovementSyncTrait::StaticClass, TEXT("UMassAgentMovementSyncTrait"), &Z_Registration_Info_UClass_UMassAgentMovementSyncTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassAgentMovementSyncTrait), 4027244528U) },
		{ Z_Construct_UClass_UMassAgentOrientationSyncTrait, UMassAgentOrientationSyncTrait::StaticClass, TEXT("UMassAgentOrientationSyncTrait"), &Z_Registration_Info_UClass_UMassAgentOrientationSyncTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassAgentOrientationSyncTrait), 917784321U) },
		{ Z_Construct_UClass_UMassAgentFeetLocationSyncTrait, UMassAgentFeetLocationSyncTrait::StaticClass, TEXT("UMassAgentFeetLocationSyncTrait"), &Z_Registration_Info_UClass_UMassAgentFeetLocationSyncTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassAgentFeetLocationSyncTrait), 2060741544U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassAgentTraits_h_1670329664(TEXT("/Script/MassActors"),
