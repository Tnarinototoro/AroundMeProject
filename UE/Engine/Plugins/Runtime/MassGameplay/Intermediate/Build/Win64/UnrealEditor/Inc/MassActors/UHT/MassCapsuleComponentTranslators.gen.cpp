...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FCapsuleComponentWrapperFragment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCapsuleComponentWrapperFragment_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCapsuleComponentWrapperFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCapsuleComponentWrapperFragment_Statics::Struct_MetaDataParams)
	};
...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassCapsuleTransformCopyToMassTag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassCapsuleTransformCopyToMassTag_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassCapsuleTransformCopyToMassTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassCapsuleTransformCopyToMassTag_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCapsuleTransformToMassTranslator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassCapsuleTransformToMassTranslator_Statics::ClassParams = {
		...
		0,
		0x401030A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassCapsuleTransformToMassTranslator_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassCapsuleTransformToMassTranslator_Statics::Class_MetaDataParams)
	};
...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassCapsuleTransformCopyToActorTag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassCapsuleTransformCopyToActorTag_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassCapsuleTransformCopyToActorTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassCapsuleTransformCopyToActorTag_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassTransformToActorCapsuleTranslator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassTransformToActorCapsuleTranslator_Statics::ClassParams = {
		...
		0,
		0x401030A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassTransformToActorCapsuleTranslator_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassTransformToActorCapsuleTranslator_Statics::Class_MetaDataParams)
	};
