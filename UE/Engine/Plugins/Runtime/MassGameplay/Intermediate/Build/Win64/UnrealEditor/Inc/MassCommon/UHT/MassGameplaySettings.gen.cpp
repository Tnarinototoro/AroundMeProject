...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassGameplaySettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMassGameplaySettings_Statics::NewProp_bLogSpawnLocations = { "bLogSpawnLocations", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMassGameplaySettings), &Z_Construct_UClass_UMassGameplaySettings_Statics::NewProp_bLogSpawnLocations_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassGameplaySettings_Statics::NewProp_bLogSpawnLocations_MetaData), Z_Construct_UClass_UMassGameplaySettings_Statics::NewProp_bLogSpawnLocations_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassGameplaySettings_Statics::ClassParams = {
		...
		0,
		0x001020A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassGameplaySettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassGameplaySettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassGameplaySettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassCommon_Public_MassGameplaySettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassGameplaySettings, UMassGameplaySettings::StaticClass, TEXT("UMassGameplaySettings"), &Z_Registration_Info_UClass_UMassGameplaySettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassGameplaySettings), 1222351584U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassCommon_Public_MassGameplaySettings_h_1421386001(TEXT("/Script/MassCommon"),
