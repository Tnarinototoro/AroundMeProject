...
template<> MASSREPLICATION_API UScriptStruct* StaticStruct<FMassClientBubbleSerializerBase>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_World = { "World", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassClientBubbleSerializerBase, World), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_World_MetaData), Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_World_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_SpawnerSubsystem = { "SpawnerSubsystem", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassClientBubbleSerializerBase, SpawnerSubsystem), Z_Construct_UClass_UMassSpawnerSubsystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_SpawnerSubsystem_MetaData), Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_SpawnerSubsystem_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_ReplicationSubsystem = { "ReplicationSubsystem", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassClientBubbleSerializerBase, ReplicationSubsystem), Z_Construct_UClass_UMassReplicationSubsystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_ReplicationSubsystem_MetaData), Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::NewProp_ReplicationSubsystem_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassClientBubbleSerializerBase_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassReplication_Public_MassClientBubbleSerializerBase_h_807297981(TEXT("/Script/MassReplication"),
		nullptr, 0,
