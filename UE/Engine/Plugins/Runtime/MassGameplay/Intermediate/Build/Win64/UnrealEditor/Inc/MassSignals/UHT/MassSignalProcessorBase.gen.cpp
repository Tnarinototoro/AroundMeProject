...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSignalProcessorBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSignalProcessorBase_Statics::ClassParams = {
		...
		0,
		0x401030A7u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSignalProcessorBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSignalProcessorBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSignals_Public_MassSignalProcessorBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassSignalProcessorBase, UMassSignalProcessorBase::StaticClass, TEXT("UMassSignalProcessorBase"), &Z_Registration_Info_UClass_UMassSignalProcessorBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassSignalProcessorBase), 2053853281U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSignals_Public_MassSignalProcessorBase_h_178649406(TEXT("/Script/MassSignals"),
