...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::NewProp_UseTime = { "UseTime", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USmartObjectMassBehaviorDefinition, UseTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::NewProp_UseTime_MetaData), Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::NewProp_UseTime_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectMassBehaviorDefinition_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSmartObjects_Public_MassSmartObjectBehaviorDefinition_h_2793198670(TEXT("/Script/MassSmartObjects"),
