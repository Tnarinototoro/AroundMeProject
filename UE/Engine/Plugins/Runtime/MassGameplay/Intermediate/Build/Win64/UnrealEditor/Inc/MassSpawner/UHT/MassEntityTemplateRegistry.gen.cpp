...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_MassEntityTemplateRegistry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_MassEntityTemplateRegistry_Statics::ClassParams = {
		...
		0,
		0x021002A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_MassEntityTemplateRegistry_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_MassEntityTemplateRegistry_Statics::Class_MetaDataParams)
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSpawner_Public_MassEntityTemplateRegistry_h_2904343380(TEXT("/Script/MassSpawner"),
