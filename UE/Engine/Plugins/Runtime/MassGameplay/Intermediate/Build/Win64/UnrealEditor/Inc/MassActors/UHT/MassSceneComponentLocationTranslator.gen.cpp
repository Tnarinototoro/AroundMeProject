...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassSceneComponentWrapperFragment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassSceneComponentWrapperFragment_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassSceneComponentWrapperFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassSceneComponentWrapperFragment_Statics::Struct_MetaDataParams)
	};
...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassSceneComponentLocationCopyToMassTag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassSceneComponentLocationCopyToMassTag_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassSceneComponentLocationCopyToMassTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassSceneComponentLocationCopyToMassTag_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSceneComponentLocationToMassTranslator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSceneComponentLocationToMassTranslator_Statics::ClassParams = {
		...
		0,
		0x401030A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSceneComponentLocationToMassTranslator_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSceneComponentLocationToMassTranslator_Statics::Class_MetaDataParams)
	};
...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassSceneComponentLocationCopyToActorTag>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassSceneComponentLocationCopyToActorTag_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassSceneComponentLocationCopyToActorTag_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassSceneComponentLocationCopyToActorTag_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSceneComponentLocationToActorTranslator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSceneComponentLocationToActorTranslator_Statics::ClassParams = {
		...
		0,
		0x401030A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSceneComponentLocationToActorTranslator_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSceneComponentLocationToActorTranslator_Statics::Class_MetaDataParams)
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_Translators_MassSceneComponentLocationTranslator_h_66312740(TEXT("/Script/MassActors"),
