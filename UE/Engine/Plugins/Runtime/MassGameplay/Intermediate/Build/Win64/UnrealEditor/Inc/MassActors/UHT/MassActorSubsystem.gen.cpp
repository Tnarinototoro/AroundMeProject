...
template<> MASSACTORS_API UScriptStruct* StaticStruct<FMassActorFragment>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMassActorFragment_Statics::NewProp_Actor_MetaData[] = {
		{ "Category", "Mass" },
		{ "Comment", "// made visible for debugging purposes. It will show up in Mass's gameplay debugger category when viewing fragment details\n" },
		{ "ModuleRelativePath", "Public/MassActorSubsystem.h" },
		{ "ToolTip", "made visible for debugging purposes. It will show up in Mass's gameplay debugger category when viewing fragment details" },
	};
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FMassActorFragment_Statics::NewProp_Actor = { "Actor", nullptr, (EPropertyFlags)0x0044000000022001, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMassActorFragment, Actor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorFragment_Statics::NewProp_Actor_MetaData), Z_Construct_UScriptStruct_FMassActorFragment_Statics::NewProp_Actor_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMassActorFragment_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMassActorFragment_Statics::NewProp_Actor,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMassActorFragment_Statics::ReturnStructParams = {
		...
		&NewStructOps,
		"MassActorFragment",
		Z_Construct_UScriptStruct_FMassActorFragment_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorFragment_Statics::PropPointers),
		sizeof(FMassActorFragment),
		alignof(FMassActorFragment),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorFragment_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMassActorFragment_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMassActorFragment_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassActorSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassActorSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassActorSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassActorSubsystem_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassActorSubsystem_h_Statics::ScriptStructInfo[] = {
		{ FMassActorFragment::StaticStruct, Z_Construct_UScriptStruct_FMassActorFragment_Statics::NewStructOps, TEXT("MassActorFragment"), &Z_Registration_Info_UScriptStruct_MassActorFragment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMassActorFragment), 3905098807U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassActorSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassActorSubsystem, UMassActorSubsystem::StaticClass, TEXT("UMassActorSubsystem"), &Z_Registration_Info_UClass_UMassActorSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassActorSubsystem), 717879705U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassActors_Public_MassActorSubsystem_h_714277795(TEXT("/Script/MassActors"),
