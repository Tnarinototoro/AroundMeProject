...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorSpawningTimeSlicePerTick = { "DesiredActorSpawningTimeSlicePerTick", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSimulationSettings, DesiredActorSpawningTimeSlicePerTick), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorSpawningTimeSlicePerTick_MetaData), Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorSpawningTimeSlicePerTick_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorDestructionTimeSlicePerTick = { "DesiredActorDestructionTimeSlicePerTick", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSimulationSettings, DesiredActorDestructionTimeSlicePerTick), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorDestructionTimeSlicePerTick_MetaData), Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorDestructionTimeSlicePerTick_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredEntityCompactionTimeSlicePerTick = { "DesiredEntityCompactionTimeSlicePerTick", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSimulationSettings, DesiredEntityCompactionTimeSlicePerTick), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredEntityCompactionTimeSlicePerTick_MetaData), Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredEntityCompactionTimeSlicePerTick_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorFailedSpawningRetryTimeInterval = { "DesiredActorFailedSpawningRetryTimeInterval", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSimulationSettings, DesiredActorFailedSpawningRetryTimeInterval), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorFailedSpawningRetryTimeInterval_MetaData), Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorFailedSpawningRetryTimeInterval_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorFailedSpawningRetryMoveDistance = { "DesiredActorFailedSpawningRetryMoveDistance", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSimulationSettings, DesiredActorFailedSpawningRetryMoveDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorFailedSpawningRetryMoveDistance_MetaData), Z_Construct_UClass_UMassSimulationSettings_Statics::NewProp_DesiredActorFailedSpawningRetryMoveDistance_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSimulationSettings_Statics::ClassParams = {
		...
		0,
		0x001020A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSimulationSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSimulation_Public_MassSimulationSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassSimulationSettings, UMassSimulationSettings::StaticClass, TEXT("UMassSimulationSettings"), &Z_Registration_Info_UClass_UMassSimulationSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassSimulationSettings), 1969722792U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSimulation_Public_MassSimulationSettings_h_355615890(TEXT("/Script/MassSimulation"),
