...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassLODCollectorTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassLODCollectorTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassLODCollectorTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassLODCollectorTrait_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationLODTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_Params = { "Params", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSimulationLODTrait, Params), Z_Construct_UScriptStruct_FMassSimulationLODParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_Params_MetaData), Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_Params_MetaData) }; // 560818373
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_bEnableVariableTicking = { "bEnableVariableTicking", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMassSimulationLODTrait), &Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_bEnableVariableTicking_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_bEnableVariableTicking_MetaData), Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_bEnableVariableTicking_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_VariableTickParams = { "VariableTickParams", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSimulationLODTrait, VariableTickParams), Z_Construct_UScriptStruct_FMassSimulationVariableTickParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_VariableTickParams_MetaData), Z_Construct_UClass_UMassSimulationLODTrait_Statics::NewProp_VariableTickParams_MetaData) }; // 4069123418
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSimulationLODTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationLODTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSimulationLODTrait_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSimulationLODTrait_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassLOD_Public_MassLODTrait_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassLODCollectorTrait, UMassLODCollectorTrait::StaticClass, TEXT("UMassLODCollectorTrait"), &Z_Registration_Info_UClass_UMassLODCollectorTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassLODCollectorTrait), 2171287614U) },
		{ Z_Construct_UClass_UMassSimulationLODTrait, UMassSimulationLODTrait::StaticClass, TEXT("UMassSimulationLODTrait"), &Z_Registration_Info_UClass_UMassSimulationLODTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassSimulationLODTrait), 2260200040U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassLOD_Public_MassLODTrait_h_2637320463(TEXT("/Script/MassLOD"),
