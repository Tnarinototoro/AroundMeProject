...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassReplicationTrait_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassReplicationTrait_Statics::NewProp_Params = { "Params", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassReplicationTrait, Params), Z_Construct_UScriptStruct_FMassReplicationParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassReplicationTrait_Statics::NewProp_Params_MetaData), Z_Construct_UClass_UMassReplicationTrait_Statics::NewProp_Params_MetaData) }; // 274212289
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassReplicationTrait_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassReplicationTrait_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassReplicationTrait_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassReplicationTrait_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassReplication_Public_MassReplicationTrait_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassReplicationTrait, UMassReplicationTrait::StaticClass, TEXT("UMassReplicationTrait"), &Z_Registration_Info_UClass_UMassReplicationTrait, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassReplicationTrait), 645560331U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassReplication_Public_MassReplicationTrait_h_3917500069(TEXT("/Script/MassReplication"),
