...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSmartObjectSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMassSmartObjectSettings_Statics::NewProp_SmartObjectTag = { "SmartObjectTag", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSmartObjectSettings, SmartObjectTag), Z_Construct_UScriptStruct_FZoneGraphTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSmartObjectSettings_Statics::NewProp_SmartObjectTag_MetaData), Z_Construct_UClass_UMassSmartObjectSettings_Statics::NewProp_SmartObjectTag_MetaData) }; // 2776536726
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMassSmartObjectSettings_Statics::NewProp_SearchExtents = { "SearchExtents", nullptr, (EPropertyFlags)0x0010000000014001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMassSmartObjectSettings, SearchExtents), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSmartObjectSettings_Statics::NewProp_SearchExtents_MetaData), Z_Construct_UClass_UMassSmartObjectSettings_Statics::NewProp_SearchExtents_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassSmartObjectSettings_Statics::ClassParams = {
		...
		0,
		0x001020A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSmartObjectSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassSmartObjectSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassSmartObjectSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSmartObjects_Public_MassSmartObjectSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassSmartObjectSettings, UMassSmartObjectSettings::StaticClass, TEXT("UMassSmartObjectSettings"), &Z_Registration_Info_UClass_UMassSmartObjectSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassSmartObjectSettings), 4262677300U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSmartObjects_Public_MassSmartObjectSettings_h_1352689888(TEXT("/Script/MassSmartObjects"),
