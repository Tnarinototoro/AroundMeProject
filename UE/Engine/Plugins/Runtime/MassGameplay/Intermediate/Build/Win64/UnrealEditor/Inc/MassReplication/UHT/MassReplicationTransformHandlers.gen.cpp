...
template<> MASSREPLICATION_API UScriptStruct* StaticStruct<FReplicatedAgentPositionYawData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FReplicatedAgentPositionYawData, Position), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::NewProp_Position_MetaData), Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::NewProp_Position_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::NewProp_Yaw = { "Yaw", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FReplicatedAgentPositionYawData, Yaw), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::NewProp_Yaw_MetaData), Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::NewProp_Yaw_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReplicatedAgentPositionYawData_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassReplication_Public_MassReplicationTransformHandlers_h_21848025(TEXT("/Script/MassReplication"),
		nullptr, 0,
