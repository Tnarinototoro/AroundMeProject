...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMassEntityTraitBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMassEntityTraitBase_Statics::ClassParams = {
		...
		0,
		0x001030A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMassEntityTraitBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UMassEntityTraitBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSpawner_Public_MassEntityTraitBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassEntityTraitBase, UMassEntityTraitBase::StaticClass, TEXT("UMassEntityTraitBase"), &Z_Registration_Info_UClass_UMassEntityTraitBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassEntityTraitBase), 3394095985U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MassGameplay_Source_MassSpawner_Public_MassEntityTraitBase_h_1167248684(TEXT("/Script/MassSpawner"),
