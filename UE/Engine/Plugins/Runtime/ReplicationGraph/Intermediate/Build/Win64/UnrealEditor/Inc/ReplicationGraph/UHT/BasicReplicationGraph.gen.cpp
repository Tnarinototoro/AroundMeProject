...
template<> REPLICATIONGRAPH_API UScriptStruct* StaticStruct<FConnectionAlwaysRelevantNodePair>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::NewProp_NetConnection = { "NetConnection", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConnectionAlwaysRelevantNodePair, NetConnection), Z_Construct_UClass_UNetConnection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::NewProp_NetConnection_MetaData), Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::NewProp_NetConnection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConnectionAlwaysRelevantNodePair, Node), Z_Construct_UClass_UReplicationGraphNode_AlwaysRelevant_ForConnection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::NewProp_Node_MetaData), Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::NewProp_Node_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicReplicationGraph_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_GridNode = { "GridNode", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBasicReplicationGraph, GridNode), Z_Construct_UClass_UReplicationGraphNode_GridSpatialization2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_GridNode_MetaData), Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_GridNode_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_AlwaysRelevantNode = { "AlwaysRelevantNode", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBasicReplicationGraph, AlwaysRelevantNode), Z_Construct_UClass_UReplicationGraphNode_ActorList_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_AlwaysRelevantNode_MetaData), Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_AlwaysRelevantNode_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_AlwaysRelevantForConnectionList_Inner = { "AlwaysRelevantForConnectionList", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair, METADATA_PARAMS(0, nullptr) }; // 2381332651
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_AlwaysRelevantForConnectionList = { "AlwaysRelevantForConnectionList", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBasicReplicationGraph, AlwaysRelevantForConnectionList), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_AlwaysRelevantForConnectionList_MetaData), Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_AlwaysRelevantForConnectionList_MetaData) }; // 2381332651
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_ActorsWithoutNetConnection = { "ActorsWithoutNetConnection", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBasicReplicationGraph, ActorsWithoutNetConnection), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_ActorsWithoutNetConnection_MetaData), Z_Construct_UClass_UBasicReplicationGraph_Statics::NewProp_ActorsWithoutNetConnection_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBasicReplicationGraph_Statics::ClassParams = {
		...
		0,
		0x000000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicReplicationGraph_Statics::Class_MetaDataParams), Z_Construct_UClass_UBasicReplicationGraph_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBasicReplicationGraph_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ReplicationGraph_Source_Public_BasicReplicationGraph_h_Statics::ScriptStructInfo[] = {
		{ FConnectionAlwaysRelevantNodePair::StaticStruct, Z_Construct_UScriptStruct_FConnectionAlwaysRelevantNodePair_Statics::NewStructOps, TEXT("ConnectionAlwaysRelevantNodePair"), &Z_Registration_Info_UScriptStruct_ConnectionAlwaysRelevantNodePair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConnectionAlwaysRelevantNodePair), 2381332651U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ReplicationGraph_Source_Public_BasicReplicationGraph_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBasicReplicationGraph, UBasicReplicationGraph::StaticClass, TEXT("UBasicReplicationGraph"), &Z_Registration_Info_UClass_UBasicReplicationGraph, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBasicReplicationGraph), 3148466809U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ReplicationGraph_Source_Public_BasicReplicationGraph_h_2858166049(TEXT("/Script/ReplicationGraph"),
