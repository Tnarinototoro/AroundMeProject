...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyDistribution = { "bOnlyDistribution", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UGooglePADRuntimeSettings), &Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyDistribution_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyDistribution_MetaData), Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyDistribution_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyShipping = { "bOnlyShipping", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UGooglePADRuntimeSettings), &Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyShipping_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyShipping_MetaData), Z_Construct_UClass_UGooglePADRuntimeSettings_Statics::NewProp_bOnlyShipping_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GooglePAD_Source_GooglePADEditor_Public_GooglePADRuntimeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGooglePADRuntimeSettings, UGooglePADRuntimeSettings::StaticClass, TEXT("UGooglePADRuntimeSettings"), &Z_Registration_Info_UClass_UGooglePADRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGooglePADRuntimeSettings), 3898473529U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GooglePAD_Source_GooglePADEditor_Public_GooglePADRuntimeSettings_h_772492236(TEXT("/Script/GooglePADEditor"),
