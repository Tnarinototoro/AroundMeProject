...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectDefinitionFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectDefinitionFactory_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectDefinitionFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectDefinitionFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsEditorModule_Private_SmartObjectDefinitionFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectDefinitionFactory, USmartObjectDefinitionFactory::StaticClass, TEXT("USmartObjectDefinitionFactory"), &Z_Registration_Info_UClass_USmartObjectDefinitionFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectDefinitionFactory), 2958715254U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsEditorModule_Private_SmartObjectDefinitionFactory_h_4164701071(TEXT("/Script/SmartObjectsEditorModule"),
