...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSubsystemRenderingComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectSubsystemRenderingComponent_Statics::ClassParams = {
		...
		0,
		0x00B002A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSubsystemRenderingComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectSubsystemRenderingComponent_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::NewProp_RenderingComponent = { "RenderingComponent", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASmartObjectSubsystemRenderingActor, RenderingComponent), Z_Construct_UClass_USmartObjectSubsystemRenderingComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::NewProp_RenderingComponent_MetaData), Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::NewProp_RenderingComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::Class_MetaDataParams), Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASmartObjectSubsystemRenderingActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Private_SmartObjectSubsystemRenderingActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectSubsystemRenderingComponent, USmartObjectSubsystemRenderingComponent::StaticClass, TEXT("USmartObjectSubsystemRenderingComponent"), &Z_Registration_Info_UClass_USmartObjectSubsystemRenderingComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectSubsystemRenderingComponent), 402854892U) },
		{ Z_Construct_UClass_ASmartObjectSubsystemRenderingActor, ASmartObjectSubsystemRenderingActor::StaticClass, TEXT("ASmartObjectSubsystemRenderingActor"), &Z_Registration_Info_UClass_ASmartObjectSubsystemRenderingActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASmartObjectSubsystemRenderingActor), 3067475418U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Private_SmartObjectSubsystemRenderingActor_h_3980197665(TEXT("/Script/SmartObjectsModule"),
