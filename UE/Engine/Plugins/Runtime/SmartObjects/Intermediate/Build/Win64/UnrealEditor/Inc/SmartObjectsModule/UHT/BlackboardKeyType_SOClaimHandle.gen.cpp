...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::NewProp_Handle = { "Handle", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBlackboardKeyType_SOClaimHandle, Handle), Z_Construct_UScriptStruct_FSmartObjectClaimHandle, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::NewProp_Handle_MetaData), Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::NewProp_Handle_MetaData) }; // 2747113422
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::Class_MetaDataParams), Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_BlackboardKeyType_SOClaimHandle_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBlackboardKeyType_SOClaimHandle, UBlackboardKeyType_SOClaimHandle::StaticClass, TEXT("UBlackboardKeyType_SOClaimHandle"), &Z_Registration_Info_UClass_UBlackboardKeyType_SOClaimHandle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlackboardKeyType_SOClaimHandle), 2434201957U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_BlackboardKeyType_SOClaimHandle_h_3980291898(TEXT("/Script/SmartObjectsModule"),
