...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectTestBehaviorDefinition_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectTestBehaviorDefinition_Statics::ClassParams = {
		...
		0,
		0x041030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectTestBehaviorDefinition_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectTestBehaviorDefinition_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectTestSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectTestSubsystem_Statics::ClassParams = {
		...
		0,
		0x048000AEu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectTestSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectTestSubsystem_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASmartObjectTestCollection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ASmartObjectTestCollection_Statics::ClassParams = {
		...
		0,
		0x048000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASmartObjectTestCollection_Statics::Class_MetaDataParams), Z_Construct_UClass_ASmartObjectTestCollection_Statics::Class_MetaDataParams)
	};
...
template<> SMARTOBJECTSTESTSUITE_API UScriptStruct* StaticStruct<FSmartObjectSlotTestDefinitionData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSmartObjectSlotTestDefinitionData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectSlotTestDefinitionData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSmartObjectSlotTestDefinitionData_Statics::Struct_MetaDataParams)
	};
...
template<> SMARTOBJECTSTESTSUITE_API UScriptStruct* StaticStruct<FSmartObjectSlotTestRuntimeData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSmartObjectSlotTestRuntimeData_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectSlotTestRuntimeData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSmartObjectSlotTestRuntimeData_Statics::Struct_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsTestSuite_Public_SmartObjectTestTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectTestBehaviorDefinition, USmartObjectTestBehaviorDefinition::StaticClass, TEXT("USmartObjectTestBehaviorDefinition"), &Z_Registration_Info_UClass_USmartObjectTestBehaviorDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectTestBehaviorDefinition), 780922360U) },
		{ Z_Construct_UClass_USmartObjectTestSubsystem, USmartObjectTestSubsystem::StaticClass, TEXT("USmartObjectTestSubsystem"), &Z_Registration_Info_UClass_USmartObjectTestSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectTestSubsystem), 361661966U) },
		{ Z_Construct_UClass_ASmartObjectTestCollection, ASmartObjectTestCollection::StaticClass, TEXT("ASmartObjectTestCollection"), &Z_Registration_Info_UClass_ASmartObjectTestCollection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASmartObjectTestCollection), 2722155377U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsTestSuite_Public_SmartObjectTestTypes_h_59915699(TEXT("/Script/SmartObjectsTestSuite"),
