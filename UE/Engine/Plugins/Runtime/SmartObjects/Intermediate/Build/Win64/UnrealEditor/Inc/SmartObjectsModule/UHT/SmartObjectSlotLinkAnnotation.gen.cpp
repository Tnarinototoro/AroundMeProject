...
template<> SMARTOBJECTSMODULE_API UScriptStruct* StaticStruct<FSmartObjectSlotLinkAnnotation>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSmartObjectSlotLinkAnnotation, Tag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::NewProp_Tag_MetaData), Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::NewProp_Tag_MetaData) }; // 2083603574
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::NewProp_LinkedSlot = { "LinkedSlot", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSmartObjectSlotLinkAnnotation, LinkedSlot), Z_Construct_UScriptStruct_FSmartObjectSlotReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::NewProp_LinkedSlot_MetaData), Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::NewProp_LinkedSlot_MetaData) }; // 770017638
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_Annotations_SmartObjectSlotLinkAnnotation_h_Statics::ScriptStructInfo[] = {
		{ FSmartObjectSlotLinkAnnotation::StaticStruct, Z_Construct_UScriptStruct_FSmartObjectSlotLinkAnnotation_Statics::NewStructOps, TEXT("SmartObjectSlotLinkAnnotation"), &Z_Registration_Info_UScriptStruct_SmartObjectSlotLinkAnnotation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSmartObjectSlotLinkAnnotation), 3526096332U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_Annotations_SmartObjectSlotLinkAnnotation_h_3079546200(TEXT("/Script/SmartObjectsModule"),
		nullptr, 0,
