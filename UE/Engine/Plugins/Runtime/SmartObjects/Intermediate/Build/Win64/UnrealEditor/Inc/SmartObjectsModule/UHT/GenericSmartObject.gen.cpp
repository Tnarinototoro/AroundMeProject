...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AGenericSmartObject_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AGenericSmartObject_Statics::NewProp_SOComponent = { "SOComponent", nullptr, (EPropertyFlags)0x0024080002080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGenericSmartObject, SOComponent), Z_Construct_UClass_USmartObjectComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGenericSmartObject_Statics::NewProp_SOComponent_MetaData), Z_Construct_UClass_AGenericSmartObject_Statics::NewProp_SOComponent_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AGenericSmartObject_Statics::NewProp_RenderingComponent = { "RenderingComponent", nullptr, (EPropertyFlags)0x0024080802080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGenericSmartObject, RenderingComponent), Z_Construct_UClass_USmartObjectRenderingComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGenericSmartObject_Statics::NewProp_RenderingComponent_MetaData), Z_Construct_UClass_AGenericSmartObject_Statics::NewProp_RenderingComponent_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AGenericSmartObject_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGenericSmartObject_Statics::Class_MetaDataParams), Z_Construct_UClass_AGenericSmartObject_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AGenericSmartObject_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_GenericSmartObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGenericSmartObject, AGenericSmartObject::StaticClass, TEXT("AGenericSmartObject"), &Z_Registration_Info_UClass_AGenericSmartObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGenericSmartObject), 533558829U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_GenericSmartObject_h_1304294252(TEXT("/Script/SmartObjectsModule"),
