...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryItemType_SmartObject_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEnvQueryItemType_SmartObject_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryItemType_SmartObject_Statics::Class_MetaDataParams), Z_Construct_UClass_UEnvQueryItemType_SmartObject_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_EnvQueryItemType_SmartObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryItemType_SmartObject, UEnvQueryItemType_SmartObject::StaticClass, TEXT("UEnvQueryItemType_SmartObject"), &Z_Registration_Info_UClass_UEnvQueryItemType_SmartObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryItemType_SmartObject), 1327536466U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_EnvQueryItemType_SmartObject_h_1227847467(TEXT("/Script/SmartObjectsModule"),
