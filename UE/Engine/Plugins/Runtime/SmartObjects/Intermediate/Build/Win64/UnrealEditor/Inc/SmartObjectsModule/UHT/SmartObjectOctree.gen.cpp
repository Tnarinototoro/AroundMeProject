...
template<> SMARTOBJECTSMODULE_API UScriptStruct* StaticStruct<FSmartObjectOctreeEntryData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSmartObjectOctreeEntryData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectOctreeEntryData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSmartObjectOctreeEntryData_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectOctree_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectOctree_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectOctree_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectOctree_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectOctree_h_Statics::ScriptStructInfo[] = {
		{ FSmartObjectOctreeEntryData::StaticStruct, Z_Construct_UScriptStruct_FSmartObjectOctreeEntryData_Statics::NewStructOps, TEXT("SmartObjectOctreeEntryData"), &Z_Registration_Info_UScriptStruct_SmartObjectOctreeEntryData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSmartObjectOctreeEntryData), 1052074153U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectOctree_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectOctree, USmartObjectOctree::StaticClass, TEXT("USmartObjectOctree"), &Z_Registration_Info_UClass_USmartObjectOctree, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectOctree), 964340581U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectOctree_h_475166620(TEXT("/Script/SmartObjectsModule"),
