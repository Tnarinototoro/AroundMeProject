...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultUserTagsFilteringPolicy_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultUserTagsFilteringPolicy = { "DefaultUserTagsFilteringPolicy", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USmartObjectSettings, DefaultUserTagsFilteringPolicy), Z_Construct_UEnum_SmartObjectsModule_ESmartObjectTagFilteringPolicy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultUserTagsFilteringPolicy_MetaData), Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultUserTagsFilteringPolicy_MetaData) }; // 3411937515
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultActivityTagsMergingPolicy = { "DefaultActivityTagsMergingPolicy", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USmartObjectSettings, DefaultActivityTagsMergingPolicy), Z_Construct_UEnum_SmartObjectsModule_ESmartObjectTagMergingPolicy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultActivityTagsMergingPolicy_MetaData), Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultActivityTagsMergingPolicy_MetaData) }; // 1213756766
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultWorldConditionSchemaClass = { "DefaultWorldConditionSchemaClass", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USmartObjectSettings, DefaultWorldConditionSchemaClass), Z_Construct_UClass_UClass, Z_Construct_UClass_USmartObjectWorldConditionSchema_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultWorldConditionSchemaClass_MetaData), Z_Construct_UClass_USmartObjectSettings_Statics::NewProp_DefaultWorldConditionSchemaClass_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectSettings, USmartObjectSettings::StaticClass, TEXT("USmartObjectSettings"), &Z_Registration_Info_UClass_USmartObjectSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectSettings), 2124853724U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectSettings_h_2365235273(TEXT("/Script/SmartObjectsModule"),
