...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::NewProp_bShowGridByDefault = { "bShowGridByDefault", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USmartObjectAssetEditorSettings), &Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::NewProp_bShowGridByDefault_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::NewProp_bShowGridByDefault_MetaData), Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::NewProp_bShowGridByDefault_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectAssetEditorSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsEditorModule_Private_SmartObjectAssetEditorSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectAssetEditorSettings, USmartObjectAssetEditorSettings::StaticClass, TEXT("USmartObjectAssetEditorSettings"), &Z_Registration_Info_UClass_USmartObjectAssetEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectAssetEditorSettings), 2152591327U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsEditorModule_Private_SmartObjectAssetEditorSettings_h_519792486(TEXT("/Script/SmartObjectsEditorModule"),
