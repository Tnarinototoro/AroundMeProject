...
template<> SMARTOBJECTSMODULE_API UScriptStruct* StaticStruct<FSmartObjectHashGridEntryData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSmartObjectHashGridEntryData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSmartObjectHashGridEntryData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSmartObjectHashGridEntryData_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectHashGrid_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectHashGrid_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectHashGrid_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectHashGrid_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectHashGrid_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectHashGrid, USmartObjectHashGrid::StaticClass, TEXT("USmartObjectHashGrid"), &Z_Registration_Info_UClass_USmartObjectHashGrid, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectHashGrid), 4238999268U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectHashGrid_h_2913849697(TEXT("/Script/SmartObjectsModule"),
