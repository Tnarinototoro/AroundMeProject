...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectRenderingComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USmartObjectRenderingComponent_Statics::ClassParams = {
		...
		0,
		0x00B010A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USmartObjectRenderingComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_USmartObjectRenderingComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectRenderingComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USmartObjectRenderingComponent, USmartObjectRenderingComponent::StaticClass, TEXT("USmartObjectRenderingComponent"), &Z_Registration_Info_UClass_USmartObjectRenderingComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmartObjectRenderingComponent), 1186929157U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SmartObjects_Source_SmartObjectsModule_Public_SmartObjectRenderingComponent_h_3720684588(TEXT("/Script/SmartObjectsModule"),
