...
template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<FMeterChannelInfo>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_MeterValue = { "MeterValue", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMeterChannelInfo, MeterValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_MeterValue_MetaData), Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_MeterValue_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_PeakValue = { "PeakValue", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMeterChannelInfo, PeakValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_PeakValue_MetaData), Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_PeakValue_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_ClippingValue = { "ClippingValue", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMeterChannelInfo, ClippingValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_ClippingValue_MetaData), Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewProp_ClippingValue_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioMeterTypes_h_Statics::ScriptStructInfo[] = {
		{ FMeterChannelInfo::StaticStruct, Z_Construct_UScriptStruct_FMeterChannelInfo_Statics::NewStructOps, TEXT("MeterChannelInfo"), &Z_Registration_Info_UScriptStruct_MeterChannelInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeterChannelInfo), 1590012430U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioMeterTypes_h_3032906677(TEXT("/Script/AudioWidgets"),
		nullptr, 0,
