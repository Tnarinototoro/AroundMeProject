...
template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<FAudioMeterStyle>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_MeterValuePadding = { "MeterValuePadding", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAudioMeterStyle, MeterValuePadding), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_MeterValuePadding_MetaData), Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_MeterValuePadding_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_PeakValueWidth = { "PeakValueWidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAudioMeterStyle, PeakValueWidth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_PeakValueWidth_MetaData), Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_PeakValueWidth_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_bScaleSide = { "bScaleSide", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FAudioMeterStyle), &Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_bScaleSide_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_bScaleSide_MetaData), Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_bScaleSide_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_ScaleHashWidth = { "ScaleHashWidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAudioMeterStyle, ScaleHashWidth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_ScaleHashWidth_MetaData), Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_ScaleHashWidth_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_ScaleHashHeight = { "ScaleHashHeight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAudioMeterStyle, ScaleHashHeight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_ScaleHashHeight_MetaData), Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewProp_ScaleHashHeight_MetaData) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioMeterStyle_h_Statics::ScriptStructInfo[] = {
		{ FAudioMeterStyle::StaticStruct, Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewStructOps, TEXT("AudioMeterStyle"), &Z_Registration_Info_UScriptStruct_AudioMeterStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioMeterStyle), 655549545U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioMeterStyle_h_941039963(TEXT("/Script/AudioWidgets"),
		nullptr, 0,
