...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_WaveTable_EWaveTableSamplingMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_WaveTable_EWaveTableSamplingMode_Statics::Enum_MetaDataParams[] = {
...
template<> WAVETABLE_API UScriptStruct* StaticStruct<FWaveTableSettings>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_ChannelIndex = { "ChannelIndex", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableSettings, ChannelIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_ChannelIndex_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_ChannelIndex_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceData_MetaData[] = {
		{ "Category", "Options" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceData = { "SourceData", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableSettings, SourceData), Z_Construct_UScriptStruct_FWaveTableData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceData_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceData_MetaData) }; // 1574591700
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceSampleRate_MetaData[] = {
		{ "Category", "Options" },
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceSampleRate = { "SourceSampleRate", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableSettings, SourceSampleRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceSampleRate_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourceSampleRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_Tail = { "Tail", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableSettings, Tail), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_Tail_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_Tail_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_FadeIn = { "FadeIn", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableSettings, FadeIn), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_FadeIn_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_FadeIn_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_FadeOut = { "FadeOut", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableSettings, FadeOut), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_FadeOut_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_FadeOut_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_bRemoveOffset = { "bRemoveOffset", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FWaveTableSettings), &Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_bRemoveOffset_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_bRemoveOffset_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_bRemoveOffset_MetaData) };
#if WITH_EDITORONLY_DATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourcePCMData = { "SourcePCMData", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableSettings, SourcePCMData), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourcePCMData_MetaData), Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewProp_SourcePCMData_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableSettings_h_Statics::EnumInfo[] = {
		{ EWaveTableResolution_StaticEnum, TEXT("EWaveTableResolution"), &Z_Registration_Info_UEnum_EWaveTableResolution, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 658947456U) },
		{ EWaveTableSamplingMode_StaticEnum, TEXT("EWaveTableSamplingMode"), &Z_Registration_Info_UEnum_EWaveTableSamplingMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2277104304U) },
		{ EWaveTableCurve_StaticEnum, TEXT("EWaveTableCurve"), &Z_Registration_Info_UEnum_EWaveTableCurve, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3382373569U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableSettings_h_Statics::ScriptStructInfo[] = {
		{ FWaveTableSettings::StaticStruct, Z_Construct_UScriptStruct_FWaveTableSettings_Statics::NewStructOps, TEXT("WaveTableSettings"), &Z_Registration_Info_UScriptStruct_WaveTableSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWaveTableSettings), 2653873968U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableSettings_h_1788830323(TEXT("/Script/WaveTable"),
		nullptr, 0,
