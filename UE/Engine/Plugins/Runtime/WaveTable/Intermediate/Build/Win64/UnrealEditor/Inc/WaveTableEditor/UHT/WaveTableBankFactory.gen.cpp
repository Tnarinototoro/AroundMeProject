...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveTableBankFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaveTableBankFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaveTableBankFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaveTableBankFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTableEditor_Private_WaveTableBankFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaveTableBankFactory, UWaveTableBankFactory::StaticClass, TEXT("UWaveTableBankFactory"), &Z_Registration_Info_UClass_UWaveTableBankFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaveTableBankFactory), 831086822U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTableEditor_Private_WaveTableBankFactory_h_2149620358(TEXT("/Script/WaveTableEditor"),
