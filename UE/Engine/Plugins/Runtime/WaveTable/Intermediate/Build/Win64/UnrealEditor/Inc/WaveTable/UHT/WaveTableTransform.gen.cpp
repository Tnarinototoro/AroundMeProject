...
template<> WAVETABLE_API UScriptStruct* StaticStruct<FWaveTableTransform>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TableData_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_Scalar = { "Scalar", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableTransform, Scalar), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_Scalar_MetaData), Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_Scalar_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_CurveShared = { "CurveShared", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableTransform, CurveShared), Z_Construct_UClass_UCurveFloat_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_CurveShared_MetaData), Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_CurveShared_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_TableData_MetaData[] = {
		{ "ModuleRelativePath", "Public/WaveTableTransform.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_TableData = { "TableData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableTransform, TableData), Z_Construct_UScriptStruct_FWaveTableData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_TableData_MetaData), Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_TableData_MetaData) }; // 1574591700
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_Duration_MetaData[] = {
		{ "Category", "Input" },
		{ "ClampMin", "0.001" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_FinalValue = { "FinalValue", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaveTableTransform, FinalValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_FinalValue_MetaData), Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewProp_FinalValue_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableTransform_h_Statics::ScriptStructInfo[] = {
		{ FWaveTableTransform::StaticStruct, Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewStructOps, TEXT("WaveTableTransform"), &Z_Registration_Info_UScriptStruct_WaveTableTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWaveTableTransform), 613662837U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableTransform_h_2636530275(TEXT("/Script/WaveTable"),
		nullptr, 0,
