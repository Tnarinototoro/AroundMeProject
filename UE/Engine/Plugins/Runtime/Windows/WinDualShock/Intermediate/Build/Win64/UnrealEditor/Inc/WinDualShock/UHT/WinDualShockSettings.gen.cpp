...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::NewProp_ControllerIndex = { "ControllerIndex", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDualShockExternalEndpointSettings, ControllerIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::NewProp_ControllerIndex_MetaData), Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::NewProp_ControllerIndex_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::ClassParams = {
		...
		0,
		0x000010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockExternalEndpointSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::NewProp_ControllerIndex = { "ControllerIndex", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDualShockSoundfieldEndpointSettings, ControllerIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::NewProp_ControllerIndex_MetaData), Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::NewProp_ControllerIndex_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::ClassParams = {
		...
		0,
		0x000010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSoundfieldEndpointSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSpatializationSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Spread = { "Spread", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDualShockSpatializationSettings, Spread), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Spread_MetaData), Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Spread_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Priority = { "Priority", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDualShockSpatializationSettings, Priority), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Priority_MetaData), Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Priority_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Passthrough = { "Passthrough", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDualShockSpatializationSettings), &Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Passthrough_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Passthrough_MetaData), Z_Construct_UClass_UDualShockSpatializationSettings_Statics::NewProp_Passthrough_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDualShockSpatializationSettings_Statics::ClassParams = {
		...
		0,
		0x000010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSpatializationSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UDualShockSpatializationSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDualShockSpatializationSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Windows_WinDualShock_Source_WinDualShock_Public_WinDualShockSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDualShockExternalEndpointSettings, UDualShockExternalEndpointSettings::StaticClass, TEXT("UDualShockExternalEndpointSettings"), &Z_Registration_Info_UClass_UDualShockExternalEndpointSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDualShockExternalEndpointSettings), 1276138218U) },
		...
		{ Z_Construct_UClass_UDualShockSpatializationSettings, UDualShockSpatializationSettings::StaticClass, TEXT("UDualShockSpatializationSettings"), &Z_Registration_Info_UClass_UDualShockSpatializationSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDualShockSpatializationSettings), 746549957U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Windows_WinDualShock_Source_WinDualShock_Public_WinDualShockSettings_h_3208570800(TEXT("/Script/WinDualShock"),
