...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModPlayer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_SoundModAssetPtr = { "SoundModAssetPtr", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundNodeModPlayer, SoundModAssetPtr), Z_Construct_UClass_USoundMod_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_SoundModAssetPtr_MetaData), Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_SoundModAssetPtr_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_SoundMod_MetaData[] = {
		{ "ModuleRelativePath", "Public/SoundNodeModPlayer.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_SoundMod = { "SoundMod", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundNodeModPlayer, SoundMod), Z_Construct_UClass_USoundMod_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_SoundMod_MetaData), Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_SoundMod_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_bLooping = { "bLooping", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(USoundNodeModPlayer), &Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_bLooping_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_bLooping_MetaData), Z_Construct_UClass_USoundNodeModPlayer_Statics::NewProp_bLooping_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundNodeModPlayer_Statics::ClassParams = {
		...
		0,
		0x000810A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModPlayer_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundNodeModPlayer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModPlayer_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundMod_Source_SoundMod_Public_SoundNodeModPlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeModPlayer, USoundNodeModPlayer::StaticClass, TEXT("USoundNodeModPlayer"), &Z_Registration_Info_UClass_USoundNodeModPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeModPlayer), 1723713582U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundMod_Source_SoundMod_Public_SoundNodeModPlayer_h_1287690372(TEXT("/Script/SoundMod"),
