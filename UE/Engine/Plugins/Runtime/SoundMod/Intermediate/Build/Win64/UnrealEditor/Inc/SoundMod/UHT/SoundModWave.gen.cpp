...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundModWave_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USoundModWave_Statics::NewProp_SoundMod = { "SoundMod", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundModWave, SoundMod), Z_Construct_UClass_USoundMod_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundModWave_Statics::NewProp_SoundMod_MetaData), Z_Construct_UClass_USoundModWave_Statics::NewProp_SoundMod_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundModWave_Statics::ClassParams = {
		...
		0,
		0x008010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundModWave_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundModWave_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundModWave_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundMod_Source_SoundMod_Classes_SoundModWave_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundModWave, USoundModWave::StaticClass, TEXT("USoundModWave"), &Z_Registration_Info_UClass_USoundModWave, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundModWave), 3718022014U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundMod_Source_SoundMod_Classes_SoundModWave_h_3468076817(TEXT("/Script/SoundMod"),
