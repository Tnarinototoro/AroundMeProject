...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundModImporterFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundModImporterFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundModImporterFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundModImporterFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundMod_Source_SoundModImporter_Classes_SoundModImporterFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundModImporterFactory, USoundModImporterFactory::StaticClass, TEXT("USoundModImporterFactory"), &Z_Registration_Info_UClass_USoundModImporterFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundModImporterFactory), 1792194497U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundMod_Source_SoundModImporter_Classes_SoundModImporterFactory_h_3434824628(TEXT("/Script/SoundModImporter"),
