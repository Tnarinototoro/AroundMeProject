...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UITDSpatializationSettingsFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UITDSpatializationSettingsFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UITDSpatializationSettingsFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UITDSpatializationSettingsFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Spatialization_Source_SpatializationEditor_Public_ITDSpatializationSourceSettingsFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UITDSpatializationSettingsFactory, UITDSpatializationSettingsFactory::StaticClass, TEXT("UITDSpatializationSettingsFactory"), &Z_Registration_Info_UClass_UITDSpatializationSettingsFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UITDSpatializationSettingsFactory), 1378126112U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Spatialization_Source_SpatializationEditor_Public_ITDSpatializationSourceSettingsFactory_h_408384917(TEXT("/Script/SpatializationEditor"),
