...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::NewProp_bEnableILD = { "bEnableILD", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UITDSpatializationSourceSettings), &Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::NewProp_bEnableILD_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::NewProp_bEnableILD_MetaData), Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::NewProp_bEnableILD_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::NewProp_PanningIntensityOverDistance = { "PanningIntensityOverDistance", nullptr, (EPropertyFlags)0x0010000000044005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UITDSpatializationSourceSettings, PanningIntensityOverDistance), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::NewProp_PanningIntensityOverDistance_MetaData), Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::NewProp_PanningIntensityOverDistance_MetaData) }; // 3321759441
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::ClassParams = {
		...
		0,
		0x001010A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UITDSpatializationSourceSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Spatialization_Source_Spatialization_Public_ITDSpatializationSourceSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UITDSpatializationSourceSettings, UITDSpatializationSourceSettings::StaticClass, TEXT("UITDSpatializationSourceSettings"), &Z_Registration_Info_UClass_UITDSpatializationSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UITDSpatializationSourceSettings), 1272279808U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Spatialization_Source_Spatialization_Public_ITDSpatializationSourceSettings_h_1398605179(TEXT("/Script/Spatialization"),
