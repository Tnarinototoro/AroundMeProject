...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDummyMeshReconstructor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDummyMeshReconstructor_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDummyMeshReconstructor_Statics::Class_MetaDataParams), Z_Construct_UClass_UDummyMeshReconstructor_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshReconstruction_DummyMeshReconstructor_Source_DummyMeshReconstructor_Public_DummyMeshReconstructor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDummyMeshReconstructor, UDummyMeshReconstructor::StaticClass, TEXT("UDummyMeshReconstructor"), &Z_Registration_Info_UClass_UDummyMeshReconstructor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDummyMeshReconstructor), 1871775265U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_MeshReconstruction_DummyMeshReconstructor_Source_DummyMeshReconstructor_Public_DummyMeshReconstructor_h_3941423189(TEXT("/Script/DummyMeshReconstructor"),
