...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USynthesisEditorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USynthesisEditorSettings_Statics::ClassParams = {
		...
		0,
		0x000000A2u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthesisEditorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_USynthesisEditorSettings_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_SynthesisEditor_Classes_SynthesisEditorSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USynthesisEditorSettings, USynthesisEditorSettings::StaticClass, TEXT("USynthesisEditorSettings"), &Z_Registration_Info_UClass_USynthesisEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynthesisEditorSettings), 1479644680U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_SynthesisEditor_Classes_SynthesisEditorSettings_h_3972380765(TEXT("/Script/SynthesisEditor"),
