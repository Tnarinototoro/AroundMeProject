...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USynthComponentToneGenerator_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USynthComponentToneGenerator_SetFrequency, "SetFrequency" }, // 3012299767
		{ &Z_Construct_UFunction_USynthComponentToneGenerator_SetVolume, "SetVolume" }, // 2030372765
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentToneGenerator_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Frequency = { "Frequency", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynthComponentToneGenerator, Frequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Frequency_MetaData), Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Frequency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Volume = { "Volume", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynthComponentToneGenerator, Volume), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Volume_MetaData), Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Volume_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_AttenuationDbAtMaxRange = { "AttenuationDbAtMaxRange", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynthComponentToneGenerator, AttenuationDbAtMaxRange), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_AttenuationDbAtMaxRange_MetaData), Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_AttenuationDbAtMaxRange_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_SynthComponentToneGenerator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USynthComponentToneGenerator, USynthComponentToneGenerator::StaticClass, TEXT("USynthComponentToneGenerator"), &Z_Registration_Info_UClass_USynthComponentToneGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynthComponentToneGenerator), 3895937770U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_SynthComponentToneGenerator_h_1593429151(TEXT("/Script/Synthesis"),
