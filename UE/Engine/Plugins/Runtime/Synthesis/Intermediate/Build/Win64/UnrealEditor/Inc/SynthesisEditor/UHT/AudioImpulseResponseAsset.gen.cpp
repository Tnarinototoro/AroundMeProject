...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioImpulseResponseFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAudioImpulseResponseFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAudioImpulseResponseFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UAudioImpulseResponseFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_SynthesisEditor_Classes_AudioImpulseResponseAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioImpulseResponseFactory, UAudioImpulseResponseFactory::StaticClass, TEXT("UAudioImpulseResponseFactory"), &Z_Registration_Info_UClass_UAudioImpulseResponseFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioImpulseResponseFactory), 742431045U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_SynthesisEditor_Classes_AudioImpulseResponseAsset_h_18396008(TEXT("/Script/SynthesisEditor"),
