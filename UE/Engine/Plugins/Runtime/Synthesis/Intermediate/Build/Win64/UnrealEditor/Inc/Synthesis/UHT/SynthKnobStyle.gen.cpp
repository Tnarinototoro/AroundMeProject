...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSynthKnobStyle>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthKnobStyle_h_Statics::EnumInfo[] = {
		{ ESynthKnobSize_StaticEnum, TEXT("ESynthKnobSize"), &Z_Registration_Info_UEnum_ESynthKnobSize, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3239181436U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthKnobStyle_h_Statics::ScriptStructInfo[] = {
		{ FSynthKnobStyle::StaticStruct, Z_Construct_UScriptStruct_FSynthKnobStyle_Statics::NewStructOps, TEXT("SynthKnobStyle"), &Z_Registration_Info_UScriptStruct_SynthKnobStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSynthKnobStyle), 2448720708U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthKnobStyle_h_3225672468(TEXT("/Script/Synthesis"),
		nullptr, 0,
