...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSubmixEffectStereoToQuadSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSubmixEffectStereoToQuadSettings_Statics::NewProp_RearChannelGain = { "RearChannelGain", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSubmixEffectStereoToQuadSettings, RearChannelGain), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectStereoToQuadSettings_Statics::NewProp_RearChannelGain_MetaData), Z_Construct_UScriptStruct_FSubmixEffectStereoToQuadSettings_Statics::NewProp_RearChannelGain_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USubmixEffectStereoToQuadPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USubmixEffectStereoToQuadPreset_SetSettings, "SetSettings" }, // 2736766651
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USubmixEffectStereoToQuadPreset_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SubmixEffects_SubmixEffectStereoToQuad_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USubmixEffectStereoToQuadPreset, USubmixEffectStereoToQuadPreset::StaticClass, TEXT("USubmixEffectStereoToQuadPreset"), &Z_Registration_Info_UClass_USubmixEffectStereoToQuadPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubmixEffectStereoToQuadPreset), 1878832769U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SubmixEffects_SubmixEffectStereoToQuad_h_881284163(TEXT("/Script/Synthesis"),
