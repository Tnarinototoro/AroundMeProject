...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewProp_Depth = { "Depth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSynth1PatchCable, Depth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewProp_Depth_MetaData), Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewProp_Depth_MetaData) };
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FPatchId>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPatchId_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPatchId, Id), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPatchId_Statics::NewProp_Id_MetaData), Z_Construct_UScriptStruct_FPatchId_Statics::NewProp_Id_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_EpicSynth1Types_h_Statics::EnumInfo[] = {
		{ ESynth1OscType_StaticEnum, TEXT("ESynth1OscType"), &Z_Registration_Info_UEnum_ESynth1OscType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4058892634U) },
		{ ESynthLFOType_StaticEnum, TEXT("ESynthLFOType"), &Z_Registration_Info_UEnum_ESynthLFOType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3501630667U) },
		{ ESynthLFOMode_StaticEnum, TEXT("ESynthLFOMode"), &Z_Registration_Info_UEnum_ESynthLFOMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2082605914U) },
		{ ESynthLFOPatchType_StaticEnum, TEXT("ESynthLFOPatchType"), &Z_Registration_Info_UEnum_ESynthLFOPatchType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2633763942U) },
		{ ESynthModEnvPatch_StaticEnum, TEXT("ESynthModEnvPatch"), &Z_Registration_Info_UEnum_ESynthModEnvPatch, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3669448059U) },
		{ ESynthModEnvBiasPatch_StaticEnum, TEXT("ESynthModEnvBiasPatch"), &Z_Registration_Info_UEnum_ESynthModEnvBiasPatch, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1416020213U) },
		{ ESynthFilterType_StaticEnum, TEXT("ESynthFilterType"), &Z_Registration_Info_UEnum_ESynthFilterType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2091911952U) },
		{ ESynthFilterAlgorithm_StaticEnum, TEXT("ESynthFilterAlgorithm"), &Z_Registration_Info_UEnum_ESynthFilterAlgorithm, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4092294949U) },
		{ ESynthStereoDelayMode_StaticEnum, TEXT("ESynthStereoDelayMode"), &Z_Registration_Info_UEnum_ESynthStereoDelayMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2988395422U) },
		{ ESynth1PatchSource_StaticEnum, TEXT("ESynth1PatchSource"), &Z_Registration_Info_UEnum_ESynth1PatchSource, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3507449674U) },
		{ ESynth1PatchDestination_StaticEnum, TEXT("ESynth1PatchDestination"), &Z_Registration_Info_UEnum_ESynth1PatchDestination, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1506668319U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_EpicSynth1Types_h_Statics::ScriptStructInfo[] = {
		{ FSynth1PatchCable::StaticStruct, Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewStructOps, TEXT("Synth1PatchCable"), &Z_Registration_Info_UScriptStruct_Synth1PatchCable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSynth1PatchCable), 2763245461U) },
		{ FPatchId::StaticStruct, Z_Construct_UScriptStruct_FPatchId_Statics::NewStructOps, TEXT("PatchId"), &Z_Registration_Info_UScriptStruct_PatchId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPatchId), 2966746885U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_EpicSynth1Types_h_713856035(TEXT("/Script/Synthesis"),
		nullptr, 0,
