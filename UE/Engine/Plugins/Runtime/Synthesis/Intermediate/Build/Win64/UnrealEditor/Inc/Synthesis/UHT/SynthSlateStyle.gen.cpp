...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSynthSlateStyle>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthSlateStyle_h_Statics::EnumInfo[] = {
		{ ESynthSlateSizeType_StaticEnum, TEXT("ESynthSlateSizeType"), &Z_Registration_Info_UEnum_ESynthSlateSizeType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1529814036U) },
		{ ESynthSlateColorStyle_StaticEnum, TEXT("ESynthSlateColorStyle"), &Z_Registration_Info_UEnum_ESynthSlateColorStyle, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1534145500U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthSlateStyle_h_Statics::ScriptStructInfo[] = {
		{ FSynthSlateStyle::StaticStruct, Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewStructOps, TEXT("SynthSlateStyle"), &Z_Registration_Info_UScriptStruct_SynthSlateStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSynthSlateStyle), 1884955099U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthSlateStyle_h_3008388479(TEXT("/Script/Synthesis"),
		nullptr, 0,
