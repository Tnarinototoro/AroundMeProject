...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectPannerSettings>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectPannerPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectPannerPreset_SetSettings, "SetSettings" }, // 1333841240
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectPannerPreset_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPanner_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectPannerPreset, USourceEffectPannerPreset::StaticClass, TEXT("USourceEffectPannerPreset"), &Z_Registration_Info_UClass_USourceEffectPannerPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectPannerPreset), 92211584U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPanner_h_135219963(TEXT("/Script/Synthesis"),
