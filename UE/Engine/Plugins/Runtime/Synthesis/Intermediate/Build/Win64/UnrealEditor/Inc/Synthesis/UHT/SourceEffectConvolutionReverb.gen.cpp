...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectConvolutionReverbSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectConvolutionReverbSettings_Statics::NewProp_NormalizationVolumeDb = { "NormalizationVolumeDb", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectConvolutionReverbSettings, NormalizationVolumeDb), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectConvolutionReverbSettings_Statics::NewProp_NormalizationVolumeDb_MetaData), Z_Construct_UScriptStruct_FSourceEffectConvolutionReverbSettings_Statics::NewProp_NormalizationVolumeDb_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectConvolutionReverbSettings_Statics::NewProp_DryVolumeDb = { "DryVolumeDb", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectConvolutionReverbSettings, DryVolumeDb), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectConvolutionReverbSettings_Statics::NewProp_DryVolumeDb_MetaData), Z_Construct_UScriptStruct_FSourceEffectConvolutionReverbSettings_Statics::NewProp_DryVolumeDb_MetaData) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectConvolutionReverbPreset_SetImpulseResponse, "SetImpulseResponse" }, // 3615610449
		{ &Z_Construct_UFunction_USourceEffectConvolutionReverbPreset_SetSettings, "SetSettings" }, // 3830719520
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::NewProp_ImpulseResponse = { "ImpulseResponse", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USourceEffectConvolutionReverbPreset, ImpulseResponse), Z_Construct_UClass_UAudioImpulseResponse_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::NewProp_ImpulseResponse_MetaData), Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::NewProp_ImpulseResponse_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::NewProp_bEnableHardwareAcceleration = { "bEnableHardwareAcceleration", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USourceEffectConvolutionReverbPreset), &Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::NewProp_bEnableHardwareAcceleration_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::NewProp_bEnableHardwareAcceleration_MetaData), Z_Construct_UClass_USourceEffectConvolutionReverbPreset_Statics::NewProp_bEnableHardwareAcceleration_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectConvolutionReverb_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectConvolutionReverbPreset, USourceEffectConvolutionReverbPreset::StaticClass, TEXT("USourceEffectConvolutionReverbPreset"), &Z_Registration_Info_UClass_USourceEffectConvolutionReverbPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectConvolutionReverbPreset), 906000259U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectConvolutionReverb_h_136196336(TEXT("/Script/Synthesis"),
