...
void FOnSamplePlaybackProgress_DelegateWrapper(const FMulticastScriptDelegate& OnSamplePlaybackProgress, float ProgressPercent, float ProgressTimeSeconds)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USynthSamplePlayer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USynthSamplePlayer_GetCurrentPlaybackProgressPercent, "GetCurrentPlaybackProgressPercent" }, // 349980705
		{ &Z_Construct_UFunction_USynthSamplePlayer_GetCurrentPlaybackProgressTime, "GetCurrentPlaybackProgressTime" }, // 652800589
		{ &Z_Construct_UFunction_USynthSamplePlayer_GetSampleDuration, "GetSampleDuration" }, // 4114149560
		{ &Z_Construct_UFunction_USynthSamplePlayer_IsLoaded, "IsLoaded" }, // 966882156
		{ &Z_Construct_UFunction_USynthSamplePlayer_SeekToTime, "SeekToTime" }, // 2594703156
		{ &Z_Construct_UFunction_USynthSamplePlayer_SetPitch, "SetPitch" }, // 3482154106
		{ &Z_Construct_UFunction_USynthSamplePlayer_SetScrubMode, "SetScrubMode" }, // 1143842398
		{ &Z_Construct_UFunction_USynthSamplePlayer_SetScrubTimeWidth, "SetScrubTimeWidth" }, // 4133651177
		{ &Z_Construct_UFunction_USynthSamplePlayer_SetSoundWave, "SetSoundWave" }, // 3287973709
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USynthSamplePlayer_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USynthSamplePlayer_Statics::NewProp_SoundWave = { "SoundWave", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynthSamplePlayer, SoundWave), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthSamplePlayer_Statics::NewProp_SoundWave_MetaData), Z_Construct_UClass_USynthSamplePlayer_Statics::NewProp_SoundWave_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USynthSamplePlayer_Statics::NewProp_OnSampleLoaded = { "OnSampleLoaded", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynthSamplePlayer, OnSampleLoaded), Z_Construct_UDelegateFunction_Synthesis_OnSampleLoaded__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthSamplePlayer_Statics::NewProp_OnSampleLoaded_MetaData), Z_Construct_UClass_USynthSamplePlayer_Statics::NewProp_OnSampleLoaded_MetaData) }; // 3655884774
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_SynthComponentWaveTable_h_Statics::EnumInfo[] = {
		{ ESamplePlayerSeekType_StaticEnum, TEXT("ESamplePlayerSeekType"), &Z_Registration_Info_UEnum_ESamplePlayerSeekType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 11803048U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_SynthComponentWaveTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USynthSamplePlayer, USynthSamplePlayer::StaticClass, TEXT("USynthSamplePlayer"), &Z_Registration_Info_UClass_USynthSamplePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynthSamplePlayer), 1188124707U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_SynthComponentWaveTable_h_3003553881(TEXT("/Script/Synthesis"),
