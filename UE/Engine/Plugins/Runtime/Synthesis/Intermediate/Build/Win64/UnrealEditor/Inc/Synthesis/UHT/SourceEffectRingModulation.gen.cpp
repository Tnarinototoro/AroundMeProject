...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectRingModulationSettings>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_ModulatorType = { "ModulatorType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, ModulatorType), Z_Construct_UEnum_Synthesis_ERingModulatorTypeSourceEffect, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_ModulatorType_MetaData), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_ModulatorType_MetaData) }; // 2130433303
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Frequency = { "Frequency", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, Frequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Frequency_MetaData), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Frequency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Depth = { "Depth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, Depth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Depth_MetaData), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Depth_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_DryLevel = { "DryLevel", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, DryLevel), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_DryLevel_MetaData), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_DryLevel_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_WetLevel = { "WetLevel", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, WetLevel), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_WetLevel_MetaData), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_WetLevel_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_AudioBusModulator = { "AudioBusModulator", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, AudioBusModulator), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_AudioBusModulator_MetaData), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_AudioBusModulator_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectRingModulationPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectRingModulationPreset_SetSettings, "SetSettings" }, // 1874544263
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectRingModulationPreset_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectRingModulation_h_Statics::EnumInfo[] = {
		{ ERingModulatorTypeSourceEffect_StaticEnum, TEXT("ERingModulatorTypeSourceEffect"), &Z_Registration_Info_UEnum_ERingModulatorTypeSourceEffect, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2130433303U) },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectRingModulation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectRingModulationPreset, USourceEffectRingModulationPreset::StaticClass, TEXT("USourceEffectRingModulationPreset"), &Z_Registration_Info_UClass_USourceEffectRingModulationPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectRingModulationPreset), 4064398737U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectRingModulation_h_790163021(TEXT("/Script/Synthesis"),
