...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectPhaserSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectPhaserSettings_Statics::NewProp_Frequency = { "Frequency", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSourceEffectPhaserSettings, Frequency), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectPhaserSettings_Statics::NewProp_Frequency_MetaData), Z_Construct_UScriptStruct_FSourceEffectPhaserSettings_Statics::NewProp_Frequency_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USourceEffectPhaserPreset_SetSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USourceEffectPhaserPreset, nullptr, "SetSettings", nullptr, nullptr, Z_Construct_UFunction_USourceEffectPhaserPreset_SetSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USourceEffectPhaserPreset_SetSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_USourceEffectPhaserPreset_SetSettings_Statics::SourceEffectPhaserPreset_eventSetSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USourceEffectPhaserPreset_SetSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_USourceEffectPhaserPreset_SetSettings_Statics::Function_MetaDataParams) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectPhaserPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectPhaserPreset_SetSettings, "SetSettings" }, // 704127311
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectPhaserPreset_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPhaser_h_Statics::EnumInfo[] = {
		{ EPhaserLFOType_StaticEnum, TEXT("EPhaserLFOType"), &Z_Registration_Info_UEnum_EPhaserLFOType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 637592523U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPhaser_h_Statics::ScriptStructInfo[] = {
		{ FSourceEffectPhaserSettings::StaticStruct, Z_Construct_UScriptStruct_FSourceEffectPhaserSettings_Statics::NewStructOps, TEXT("SourceEffectPhaserSettings"), &Z_Registration_Info_UScriptStruct_SourceEffectPhaserSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSourceEffectPhaserSettings), 2123982083U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPhaser_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectPhaserPreset, USourceEffectPhaserPreset::StaticClass, TEXT("USourceEffectPhaserPreset"), &Z_Registration_Info_UClass_USourceEffectPhaserPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectPhaserPreset), 857869752U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPhaser_h_3318716642(TEXT("/Script/Synthesis"),
