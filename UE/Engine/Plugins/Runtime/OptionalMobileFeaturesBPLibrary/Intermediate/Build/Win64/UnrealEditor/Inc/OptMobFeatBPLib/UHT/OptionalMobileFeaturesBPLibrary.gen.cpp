...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(OptionalMobileFeaturesBPLibrary_eventAreHeadphonesPluggedIn_Parms), &Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary, nullptr, "AreHeadphonesPluggedIn", nullptr, nullptr, Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::OptionalMobileFeaturesBPLibrary_eventAreHeadphonesPluggedIn_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn_Statics::OptionalMobileFeaturesBPLibrary_eventAreHeadphonesPluggedIn_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OptionalMobileFeaturesBPLibrary_eventGetBatteryLevel_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary, nullptr, "GetBatteryLevel", nullptr, nullptr, Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::OptionalMobileFeaturesBPLibrary_eventGetBatteryLevel_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel_Statics::OptionalMobileFeaturesBPLibrary_eventGetBatteryLevel_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OptionalMobileFeaturesBPLibrary_eventGetBatteryTemperature_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary, nullptr, "GetBatteryTemperature", nullptr, nullptr, Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::OptionalMobileFeaturesBPLibrary_eventGetBatteryTemperature_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature_Statics::OptionalMobileFeaturesBPLibrary_eventGetBatteryTemperature_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OptionalMobileFeaturesBPLibrary_eventGetVolumeState_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary, nullptr, "GetVolumeState", nullptr, nullptr, Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::OptionalMobileFeaturesBPLibrary_eventGetVolumeState_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState_Statics::OptionalMobileFeaturesBPLibrary_eventGetVolumeState_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_AreHeadphonesPluggedIn, "AreHeadphonesPluggedIn" }, // 3034311773
		{ &Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryLevel, "GetBatteryLevel" }, // 2989186291
		{ &Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetBatteryTemperature, "GetBatteryTemperature" }, // 1141775808
		{ &Z_Construct_UFunction_UOptionalMobileFeaturesBPLibrary_GetVolumeState, "GetVolumeState" }, // 1881980592
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OptionalMobileFeaturesBPLibrary_Source_OptionalMobileFeaturesBPLibrary_Classes_OptionalMobileFeaturesBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOptionalMobileFeaturesBPLibrary, UOptionalMobileFeaturesBPLibrary::StaticClass, TEXT("UOptionalMobileFeaturesBPLibrary"), &Z_Registration_Info_UClass_UOptionalMobileFeaturesBPLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOptionalMobileFeaturesBPLibrary), 349976778U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_OptionalMobileFeaturesBPLibrary_Source_OptionalMobileFeaturesBPLibrary_Classes_OptionalMobileFeaturesBPLibrary_h_65689963(TEXT("/Script/OptionalMobileFeaturesBPLibrary"),
