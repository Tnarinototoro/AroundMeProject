...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SoundCueTemplates_ESoundContainerType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SoundCueTemplates_ESoundContainerType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SoundCueTemplates_ESoundContainerType_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_USoundCueContainer_Statics::NewProp_ContainerType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USoundCueContainer_Statics::NewProp_ContainerType = { "ContainerType", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueContainer, ContainerType), Z_Construct_UEnum_SoundCueTemplates_ESoundContainerType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::NewProp_ContainerType_MetaData), Z_Construct_UClass_USoundCueContainer_Statics::NewProp_ContainerType_MetaData) }; // 56018497
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundCueContainer_Statics::NewProp_bLooping = { "bLooping", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USoundCueContainer), &Z_Construct_UClass_USoundCueContainer_Statics::NewProp_bLooping_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::NewProp_bLooping_MetaData), Z_Construct_UClass_USoundCueContainer_Statics::NewProp_bLooping_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USoundCueContainer_Statics::NewProp_Variations_ElementProp = { "Variations", nullptr, (EPropertyFlags)0x0004000800000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_USoundCueContainer_Statics::NewProp_Variations = { "Variations", nullptr, (EPropertyFlags)0x0014000800000001, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueContainer, Variations), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::NewProp_Variations_MetaData), Z_Construct_UClass_USoundCueContainer_Statics::NewProp_Variations_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundCueContainer_Statics::NewProp_PitchModulation = { "PitchModulation", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueContainer, PitchModulation), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::NewProp_PitchModulation_MetaData), Z_Construct_UClass_USoundCueContainer_Statics::NewProp_PitchModulation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundCueContainer_Statics::NewProp_VolumeModulation = { "VolumeModulation", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueContainer, VolumeModulation), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::NewProp_VolumeModulation_MetaData), Z_Construct_UClass_USoundCueContainer_Statics::NewProp_VolumeModulation_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundCueContainer_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundCueContainer_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueContainer_Statics::PropPointers) < 2048);
#endif
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueContainer_h_Statics::EnumInfo[] = {
		{ ESoundContainerType_StaticEnum, TEXT("ESoundContainerType"), &Z_Registration_Info_UEnum_ESoundContainerType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 56018497U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundCueContainer, USoundCueContainer::StaticClass, TEXT("USoundCueContainer"), &Z_Registration_Info_UClass_USoundCueContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundCueContainer), 2862016716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueContainer_h_507859862(TEXT("/Script/SoundCueTemplates"),
