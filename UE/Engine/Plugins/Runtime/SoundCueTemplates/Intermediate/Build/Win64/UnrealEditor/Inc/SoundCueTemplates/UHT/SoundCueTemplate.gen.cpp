...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::NewProp_SelectedObjects = { "SelectedObjects", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SoundCueTemplate_eventAddSoundWavesToTemplate_Parms, SelectedObjects), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::NewProp_SelectedObjects_MetaData), Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::NewProp_SelectedObjects_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USoundCueTemplate, nullptr, "AddSoundWavesToTemplate", nullptr, nullptr, Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::PropPointers), sizeof(Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::SoundCueTemplate_eventAddSoundWavesToTemplate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x24420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::Function_MetaDataParams), Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate_Statics::SoundCueTemplate_eventAddSoundWavesToTemplate_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplate_Statics::DependentSingletons) < 16);
#if WITH_EDITOR
	const FClassFunctionLinkInfo Z_Construct_UClass_USoundCueTemplate_Statics::FuncInfo[] = {
#if WITH_EDITOR
		{ &Z_Construct_UFunction_USoundCueTemplate_AddSoundWavesToTemplate, "AddSoundWavesToTemplate" }, // 342267503
#endif //WITH_EDITOR
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplate_Statics::FuncInfo) < 2048);
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundCueTemplate_Statics::ClassParams = {
		...
		0,
		0x009010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplate_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundCueTemplate_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundCueTemplate, USoundCueTemplate::StaticClass, TEXT("USoundCueTemplate"), &Z_Registration_Info_UClass_USoundCueTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundCueTemplate), 441489544U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueTemplate_h_259504909(TEXT("/Script/SoundCueTemplates"),
