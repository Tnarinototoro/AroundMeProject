...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::NewProp_SoundCueTemplate = { "SoundCueTemplate", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueTemplateCopyFactory, SoundCueTemplate), Z_Construct_UClass_USoundCueTemplate_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::NewProp_SoundCueTemplate_MetaData), Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::NewProp_SoundCueTemplate_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateCopyFactory_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_USoundCueTemplateFactory_Statics::NewProp_SoundCueTemplateClass = { "SoundCueTemplateClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueTemplateFactory, SoundCueTemplateClass), Z_Construct_UClass_UClass, Z_Construct_UClass_USoundCueTemplate_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateFactory_Statics::NewProp_SoundCueTemplateClass_MetaData), Z_Construct_UClass_USoundCueTemplateFactory_Statics::NewProp_SoundCueTemplateClass_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundCueTemplateFactory_Statics::NewProp_SoundWaves = { "SoundWaves", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueTemplateFactory, SoundWaves), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateFactory_Statics::NewProp_SoundWaves_MetaData), Z_Construct_UClass_USoundCueTemplateFactory_Statics::NewProp_SoundWaves_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundCueTemplateFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundCueTemplateFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateFactory_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateClassTemplate_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundCueTemplateClassTemplate_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueTemplateClassTemplate_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundCueTemplateClassTemplate_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplatesEditor_Public_SoundCueTemplateFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundCueTemplateCopyFactory, USoundCueTemplateCopyFactory::StaticClass, TEXT("USoundCueTemplateCopyFactory"), &Z_Registration_Info_UClass_USoundCueTemplateCopyFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundCueTemplateCopyFactory), 3307755348U) },
		{ Z_Construct_UClass_USoundCueTemplateFactory, USoundCueTemplateFactory::StaticClass, TEXT("USoundCueTemplateFactory"), &Z_Registration_Info_UClass_USoundCueTemplateFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundCueTemplateFactory), 1843822022U) },
		{ Z_Construct_UClass_USoundCueTemplateClassTemplate, USoundCueTemplateClassTemplate::StaticClass, TEXT("USoundCueTemplateClassTemplate"), &Z_Registration_Info_UClass_USoundCueTemplateClassTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundCueTemplateClassTemplate), 2934409369U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplatesEditor_Public_SoundCueTemplateFactory_h_2456778920(TEXT("/Script/SoundCueTemplatesEditor"),
