...
template<> SOUNDCUETEMPLATES_API UScriptStruct* StaticStruct<FSoundCueCrossfadeInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::NewProp_DistanceInfo = { "DistanceInfo", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSoundCueCrossfadeInfo, DistanceInfo), Z_Construct_UScriptStruct_FDistanceDatum, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::NewProp_DistanceInfo_MetaData), Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::NewProp_DistanceInfo_MetaData) }; // 1874409779
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::NewProp_Sound = { "Sound", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSoundCueCrossfadeInfo, Sound), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::NewProp_Sound_MetaData), Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::NewProp_Sound_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_bLooping = { "bLooping", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USoundCueDistanceCrossfade), &Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_bLooping_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_bLooping_MetaData), Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_bLooping_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_Variations_Inner = { "Variations", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo, METADATA_PARAMS(0, nullptr) }; // 1943072715
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_Variations = { "Variations", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USoundCueDistanceCrossfade, Variations), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_Variations_MetaData), Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::NewProp_Variations_MetaData) }; // 1943072715
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::Class_MetaDataParams), Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USoundCueDistanceCrossfade_Statics::PropPointers) < 2048);
#endif
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueDistanceCrossfade_h_Statics::ScriptStructInfo[] = {
		{ FSoundCueCrossfadeInfo::StaticStruct, Z_Construct_UScriptStruct_FSoundCueCrossfadeInfo_Statics::NewStructOps, TEXT("SoundCueCrossfadeInfo"), &Z_Registration_Info_UScriptStruct_SoundCueCrossfadeInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSoundCueCrossfadeInfo), 1943072715U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueDistanceCrossfade_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundCueDistanceCrossfade, USoundCueDistanceCrossfade::StaticClass, TEXT("USoundCueDistanceCrossfade"), &Z_Registration_Info_UClass_USoundCueDistanceCrossfade, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundCueDistanceCrossfade), 4251012012U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SoundCueTemplates_Source_SoundCueTemplates_Public_SoundCueDistanceCrossfade_h_4083506335(TEXT("/Script/SoundCueTemplates"),
