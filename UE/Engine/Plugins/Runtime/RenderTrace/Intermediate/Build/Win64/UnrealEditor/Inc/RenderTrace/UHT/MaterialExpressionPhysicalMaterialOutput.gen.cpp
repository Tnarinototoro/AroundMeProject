...
template<> RENDERTRACE_API UScriptStruct* StaticStruct<FPhysicalMaterialTraceInput>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::NewProp_PhysicalMaterial = { "PhysicalMaterial", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPhysicalMaterialTraceInput, PhysicalMaterial), Z_Construct_UClass_UPhysicalMaterial_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::NewProp_PhysicalMaterial_MetaData), Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::NewProp_PhysicalMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::NewProp_Input = { "Input", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPhysicalMaterialTraceInput, Input), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::NewProp_Input_MetaData), Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::NewProp_Input_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::NewProp_Inputs_Inner = { "Inputs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPhysicalMaterialTraceInput, METADATA_PARAMS(0, nullptr) }; // 2707536665
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::NewProp_Inputs = { "Inputs", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialExpressionPhysicalMaterialOutput, Inputs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::NewProp_Inputs_MetaData), Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::NewProp_Inputs_MetaData) }; // 2707536665
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::ClassParams = {
		...
		0,
		0x001020B0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPhysicalMaterialOutput_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_RenderTrace_Source_Private_Materials_MaterialExpressionPhysicalMaterialOutput_h_4155778358(TEXT("/Script/RenderTrace"),
