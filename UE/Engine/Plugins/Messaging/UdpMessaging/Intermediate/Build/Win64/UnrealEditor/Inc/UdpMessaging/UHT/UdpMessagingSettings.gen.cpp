...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bShareKnownNodesWithActiveConnections_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_MaxSendRate = { "MaxSendRate", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUdpMessagingSettings, MaxSendRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_MaxSendRate_MetaData), Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_MaxSendRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_WorkQueueSize = { "WorkQueueSize", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUdpMessagingSettings, WorkQueueSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_WorkQueueSize_MetaData), Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_WorkQueueSize_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_UnicastEndpoint = { "UnicastEndpoint", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUdpMessagingSettings, UnicastEndpoint), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_UnicastEndpoint_MetaData), Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_UnicastEndpoint_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_MulticastEndpoint = { "MulticastEndpoint", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUdpMessagingSettings, MulticastEndpoint), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_MulticastEndpoint_MetaData), Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_MulticastEndpoint_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_StaticEndpoints = { "StaticEndpoints", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUdpMessagingSettings, StaticEndpoints), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_StaticEndpoints_MetaData), Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_StaticEndpoints_MetaData) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_TunnelMulticastEndpoint = { "TunnelMulticastEndpoint", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUdpMessagingSettings, TunnelMulticastEndpoint), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_TunnelMulticastEndpoint_MetaData), Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_TunnelMulticastEndpoint_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_RemoteTunnelEndpoints = { "RemoteTunnelEndpoints", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUdpMessagingSettings, RemoteTunnelEndpoints), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_RemoteTunnelEndpoints_MetaData), Z_Construct_UClass_UUdpMessagingSettings_Statics::NewProp_RemoteTunnelEndpoints_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_UdpMessaging_Source_UdpMessaging_Public_Shared_UdpMessagingSettings_h_Statics::EnumInfo[] = {
		{ EUdpMessageFormat_StaticEnum, TEXT("EUdpMessageFormat"), &Z_Registration_Info_UEnum_EUdpMessageFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3478647775U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_UdpMessaging_Source_UdpMessaging_Public_Shared_UdpMessagingSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUdpMessagingSettings, UUdpMessagingSettings::StaticClass, TEXT("UUdpMessagingSettings"), &Z_Registration_Info_UClass_UUdpMessagingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUdpMessagingSettings), 113232202U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_UdpMessaging_Source_UdpMessaging_Public_Shared_UdpMessagingSettings_h_3394063517(TEXT("/Script/UdpMessaging"),
