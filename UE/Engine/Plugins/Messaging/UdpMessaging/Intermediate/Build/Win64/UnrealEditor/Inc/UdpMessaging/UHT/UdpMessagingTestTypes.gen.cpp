...
template<> UDPMESSAGING_API UScriptStruct* StaticStruct<FUdpMockMessage>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUdpMockMessage, Data), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewProp_Data_MetaData), Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewProp_Data_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_UdpMessaging_Source_UdpMessaging_Private_Tests_UdpMessagingTestTypes_h_Statics::ScriptStructInfo[] = {
		{ FUdpMockMessage::StaticStruct, Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewStructOps, TEXT("UdpMockMessage"), &Z_Registration_Info_UScriptStruct_UdpMockMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUdpMockMessage), 1807354515U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_UdpMessaging_Source_UdpMessaging_Private_Tests_UdpMessagingTestTypes_h_2499950753(TEXT("/Script/UdpMessaging"),
		nullptr, 0,
