...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint = { "ListenEndpoint", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTcpMessagingSettings, ListenEndpoint), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint_MetaData), Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints = { "ConnectToEndpoints", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTcpMessagingSettings, ConnectToEndpoints), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints_MetaData), Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay = { "ConnectionRetryDelay", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTcpMessagingSettings, ConnectionRetryDelay), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay_MetaData), Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates = { "bStopServiceWhenAppDeactivates", nullptr, (EPropertyFlags)0x0040000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTcpMessagingSettings), &Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates_MetaData), Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_TcpMessaging_Source_TcpMessaging_Private_Settings_TcpMessagingSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTcpMessagingSettings, UTcpMessagingSettings::StaticClass, TEXT("UTcpMessagingSettings"), &Z_Registration_Info_UClass_UTcpMessagingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTcpMessagingSettings), 2851596839U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_TcpMessaging_Source_TcpMessaging_Private_Settings_TcpMessagingSettings_h_460518080(TEXT("/Script/TcpMessaging"),
