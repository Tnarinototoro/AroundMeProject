...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULidarPointCloudFileIO_E57_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULidarPointCloudFileIO_E57_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULidarPointCloudFileIO_E57_Statics::Class_MetaDataParams), Z_Construct_UClass_ULidarPointCloudFileIO_E57_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudRuntime_Public_IO_LidarPointCloudFileIO_E57_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULidarPointCloudFileIO_E57, ULidarPointCloudFileIO_E57::StaticClass, TEXT("ULidarPointCloudFileIO_E57"), &Z_Registration_Info_UClass_ULidarPointCloudFileIO_E57, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULidarPointCloudFileIO_E57), 2698061266U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudRuntime_Public_IO_LidarPointCloudFileIO_E57_h_613195533(TEXT("/Script/LidarPointCloudRuntime"),
