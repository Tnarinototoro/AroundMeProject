...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryLidarPointCloud_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryLidarPointCloud_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryLidarPointCloud_Statics::Class_MetaDataParams), Z_Construct_UClass_UActorFactoryLidarPointCloud_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudEditor_Private_ActorFactoryLidarPointCloud_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorFactoryLidarPointCloud, UActorFactoryLidarPointCloud::StaticClass, TEXT("UActorFactoryLidarPointCloud"), &Z_Registration_Info_UClass_UActorFactoryLidarPointCloud, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorFactoryLidarPointCloud), 368494069U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudEditor_Private_ActorFactoryLidarPointCloud_h_4099586669(TEXT("/Script/LidarPointCloudEditor"),
