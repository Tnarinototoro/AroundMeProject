...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULidarEditorMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULidarEditorMode_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULidarEditorMode_Statics::Class_MetaDataParams), Z_Construct_UClass_ULidarEditorMode_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudEditor_Private_LidarPointCloudEdMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULidarEditorMode, ULidarEditorMode::StaticClass, TEXT("ULidarEditorMode"), &Z_Registration_Info_UClass_ULidarEditorMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULidarEditorMode), 1663978174U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_LidarPointCloud_Source_LidarPointCloudEditor_Private_LidarPointCloudEdMode_h_817296535(TEXT("/Script/LidarPointCloudEditor"),
