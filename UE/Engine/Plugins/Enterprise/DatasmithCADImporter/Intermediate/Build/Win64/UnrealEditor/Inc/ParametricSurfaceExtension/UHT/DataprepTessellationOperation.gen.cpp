...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepTessellationOperation_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_ChordTolerance = { "ChordTolerance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepTessellationOperation, ChordTolerance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_ChordTolerance_MetaData), Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_ChordTolerance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_MaxEdgeLength = { "MaxEdgeLength", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepTessellationOperation, MaxEdgeLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_MaxEdgeLength_MetaData), Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_MaxEdgeLength_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_NormalTolerance = { "NormalTolerance", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepTessellationOperation, NormalTolerance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_NormalTolerance_MetaData), Z_Construct_UClass_UDataprepTessellationOperation_Statics::NewProp_NormalTolerance_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepTessellationOperation_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepTessellationOperation_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepTessellationOperation_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepTessellationOperation_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_ParametricSurfaceExtension_Private_DataprepTessellationOperation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataprepTessellationOperation, UDataprepTessellationOperation::StaticClass, TEXT("UDataprepTessellationOperation"), &Z_Registration_Info_UClass_UDataprepTessellationOperation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataprepTessellationOperation), 3222530972U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_ParametricSurfaceExtension_Private_DataprepTessellationOperation_h_8478616(TEXT("/Script/ParametricSurfaceExtension"),
