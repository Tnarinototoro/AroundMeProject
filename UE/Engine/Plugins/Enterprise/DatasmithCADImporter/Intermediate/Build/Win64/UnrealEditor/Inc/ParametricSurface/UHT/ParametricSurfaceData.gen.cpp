...
template<> PARAMETRICSURFACE_API UScriptStruct* StaticStruct<FParametricSceneParameters>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_ModelCoordSys = { "ModelCoordSys", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FParametricSceneParameters, ModelCoordSys), nullptr, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_ModelCoordSys_MetaData), Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_ModelCoordSys_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_MetricUnit = { "MetricUnit", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FParametricSceneParameters, MetricUnit), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_MetricUnit_MetaData), Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_MetricUnit_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_ScaleFactor = { "ScaleFactor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FParametricSceneParameters, ScaleFactor), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_ScaleFactor_MetaData), Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::NewProp_ScaleFactor_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricSceneParameters_Statics::PropPointers) < 2048);
...
template<> PARAMETRICSURFACE_API UScriptStruct* StaticStruct<FParametricMeshParameters>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_bNeedSwapOrientation = { "bNeedSwapOrientation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FParametricMeshParameters), &Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_bNeedSwapOrientation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_bNeedSwapOrientation_MetaData), Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_bNeedSwapOrientation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_SymmetricOrigin = { "SymmetricOrigin", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FParametricMeshParameters, SymmetricOrigin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_SymmetricOrigin_MetaData), Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_SymmetricOrigin_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_SymmetricNormal = { "SymmetricNormal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FParametricMeshParameters, SymmetricNormal), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_SymmetricNormal_MetaData), Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewProp_SymmetricNormal_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParametricSurfaceData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_SceneParameters = { "SceneParameters", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParametricSurfaceData, SceneParameters), Z_Construct_UScriptStruct_FParametricSceneParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_SceneParameters_MetaData), Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_SceneParameters_MetaData) }; // 4075127206
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_MeshParameters = { "MeshParameters", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParametricSurfaceData, MeshParameters), Z_Construct_UScriptStruct_FParametricMeshParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_MeshParameters_MetaData), Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_MeshParameters_MetaData) }; // 1167720911
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_LastTessellationOptions = { "LastTessellationOptions", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParametricSurfaceData, LastTessellationOptions), Z_Construct_UScriptStruct_FDatasmithTessellationOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_LastTessellationOptions_MetaData), Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_LastTessellationOptions_MetaData) }; // 1944162948
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_RawData_Inner = { "RawData", nullptr, (EPropertyFlags)0x0000000020000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_RawData_MetaData[] = {
		{ "ModuleRelativePath", "Public/ParametricSurfaceData.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_RawData = { "RawData", nullptr, (EPropertyFlags)0x0020080020000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParametricSurfaceData, RawData_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_RawData_MetaData), Z_Construct_UClass_UParametricSurfaceData_Statics::NewProp_RawData_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UParametricSurfaceData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UParametricSurfaceData_Statics::Class_MetaDataParams), Z_Construct_UClass_UParametricSurfaceData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UParametricSurfaceData_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_ParametricSurface_Public_ParametricSurfaceData_h_Statics::ScriptStructInfo[] = {
		...
		{ FParametricMeshParameters::StaticStruct, Z_Construct_UScriptStruct_FParametricMeshParameters_Statics::NewStructOps, TEXT("ParametricMeshParameters"), &Z_Registration_Info_UScriptStruct_ParametricMeshParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FParametricMeshParameters), 1167720911U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_ParametricSurface_Public_ParametricSurfaceData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParametricSurfaceData, UParametricSurfaceData::StaticClass, TEXT("UParametricSurfaceData"), &Z_Registration_Info_UClass_UParametricSurfaceData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParametricSurfaceData), 3513120304U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_ParametricSurface_Public_ParametricSurfaceData_h_575661725(TEXT("/Script/ParametricSurface"),
