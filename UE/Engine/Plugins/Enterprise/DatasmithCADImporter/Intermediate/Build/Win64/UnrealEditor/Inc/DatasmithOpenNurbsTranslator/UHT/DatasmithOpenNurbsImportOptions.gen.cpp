...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DatasmithOpenNurbsTranslator_EDatasmithOpenNurbsBrepTessellatedSource_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DatasmithOpenNurbsTranslator_EDatasmithOpenNurbsBrepTessellatedSource_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DatasmithOpenNurbsTranslator_EDatasmithOpenNurbsBrepTessellatedSource_Statics::Enum_MetaDataParams)
	};
...
template<> DATASMITHOPENNURBSTRANSLATOR_API UScriptStruct* StaticStruct<FDatasmithOpenNurbsOptions>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::NewProp_Geometry_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::NewProp_Geometry = { "Geometry", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDatasmithOpenNurbsOptions, Geometry), Z_Construct_UEnum_DatasmithOpenNurbsTranslator_EDatasmithOpenNurbsBrepTessellatedSource, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::NewProp_Geometry_MetaData), Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::NewProp_Geometry_MetaData) }; // 2298720620
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::NewProp_Options = { "Options", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithOpenNurbsImportOptions, Options), Z_Construct_UScriptStruct_FDatasmithOpenNurbsOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::NewProp_Options_MetaData), Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::NewProp_Options_MetaData) }; // 1013409450
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithOpenNurbsImportOptions_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_DatasmithOpenNurbsTranslator_Public_DatasmithOpenNurbsImportOptions_h_Statics::EnumInfo[] = {
		{ EDatasmithOpenNurbsBrepTessellatedSource_StaticEnum, TEXT("EDatasmithOpenNurbsBrepTessellatedSource"), &Z_Registration_Info_UEnum_EDatasmithOpenNurbsBrepTessellatedSource, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2298720620U) },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_DatasmithOpenNurbsTranslator_Public_DatasmithOpenNurbsImportOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithOpenNurbsImportOptions, UDatasmithOpenNurbsImportOptions::StaticClass, TEXT("UDatasmithOpenNurbsImportOptions"), &Z_Registration_Info_UClass_UDatasmithOpenNurbsImportOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithOpenNurbsImportOptions), 1840951713U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_DatasmithOpenNurbsTranslator_Public_DatasmithOpenNurbsImportOptions_h_908945274(TEXT("/Script/DatasmithOpenNurbsTranslator"),
