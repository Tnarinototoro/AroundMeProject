...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCADKernelParametricSurfaceData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCADKernelParametricSurfaceData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCADKernelParametricSurfaceData_Statics::Class_MetaDataParams), Z_Construct_UClass_UCADKernelParametricSurfaceData_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_CADKernelSurface_Public_CADKernelSurfaceExtension_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCADKernelParametricSurfaceData, UCADKernelParametricSurfaceData::StaticClass, TEXT("UCADKernelParametricSurfaceData"), &Z_Registration_Info_UClass_UCADKernelParametricSurfaceData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCADKernelParametricSurfaceData), 3456023629U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithCADImporter_Source_CADKernelSurface_Public_CADKernelSurfaceExtension_h_2200628370(TEXT("/Script/CADKernelSurface"),
