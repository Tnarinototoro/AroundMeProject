...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASwitchActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASwitchActor_GetOptions, "GetOptions" }, // 2218918831
		{ &Z_Construct_UFunction_ASwitchActor_GetSelectedOption, "GetSelectedOption" }, // 2101006951
		{ &Z_Construct_UFunction_ASwitchActor_SelectOption, "SelectOption" }, // 2079408949
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASwitchActor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_SwitchActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASwitchActor, ASwitchActor::StaticClass, TEXT("ASwitchActor"), &Z_Registration_Info_UClass_ASwitchActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASwitchActor), 524959579U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_SwitchActor_h_3855598584(TEXT("/Script/VariantManagerContent"),
