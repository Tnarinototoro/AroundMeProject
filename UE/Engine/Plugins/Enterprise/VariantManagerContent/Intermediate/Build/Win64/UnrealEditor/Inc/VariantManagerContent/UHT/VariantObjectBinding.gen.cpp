...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_CachedActorLabel = { "CachedActorLabel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVariantObjectBinding, CachedActorLabel), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_CachedActorLabel_MetaData), Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_CachedActorLabel_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr_MetaData[] = {
		{ "ModuleRelativePath", "Public/VariantObjectBinding.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr = { "ObjectPtr", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVariantObjectBinding, ObjectPtr), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr_MetaData), Z_Construct_UClass_UVariantObjectBinding_Statics::NewProp_ObjectPtr_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_VariantObjectBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVariantObjectBinding, UVariantObjectBinding::StaticClass, TEXT("UVariantObjectBinding"), &Z_Registration_Info_UClass_UVariantObjectBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVariantObjectBinding), 905895643U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_VariantObjectBinding_h_920339573(TEXT("/Script/VariantManagerContent"),
