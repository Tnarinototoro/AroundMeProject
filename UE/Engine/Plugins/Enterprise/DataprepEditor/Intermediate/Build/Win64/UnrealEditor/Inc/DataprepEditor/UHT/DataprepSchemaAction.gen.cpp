...
template<> DATAPREPEDITOR_API UScriptStruct* StaticStruct<FDataprepSchemaAction>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDataprepSchemaAction_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataprepSchemaAction_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDataprepSchemaAction_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepEditor_Private_SchemaActions_DataprepSchemaAction_h_Statics::ScriptStructInfo[] = {
		{ FDataprepSchemaAction::StaticStruct, Z_Construct_UScriptStruct_FDataprepSchemaAction_Statics::NewStructOps, TEXT("DataprepSchemaAction"), &Z_Registration_Info_UScriptStruct_DataprepSchemaAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDataprepSchemaAction), 2256485470U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepEditor_Private_SchemaActions_DataprepSchemaAction_h_3822144824(TEXT("/Script/DataprepEditor"),
		nullptr, 0,
