...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetUserData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UDataprepAssetUserData_Statics::NewProp_DataprepOperationPtr = { "DataprepOperationPtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepAssetUserData, DataprepOperationPtr), Z_Construct_UClass_UDataprepEditingOperation_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetUserData_Statics::NewProp_DataprepOperationPtr_MetaData), Z_Construct_UClass_UDataprepAssetUserData_Statics::NewProp_DataprepOperationPtr_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UDataprepAssetUserData_Statics::NewProp_DataprepAssetPtr = { "DataprepAssetPtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepAssetUserData, DataprepAssetPtr), Z_Construct_UClass_UDataprepAssetInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetUserData_Statics::NewProp_DataprepAssetPtr_MetaData), Z_Construct_UClass_UDataprepAssetUserData_Statics::NewProp_DataprepAssetPtr_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepAssetUserData_Statics::ClassParams = {
		...
		0,
		0x003010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetUserData_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepAssetUserData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetUserData_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_DataprepAssetUserData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataprepAssetUserData, UDataprepAssetUserData::StaticClass, TEXT("UDataprepAssetUserData"), &Z_Registration_Info_UClass_UDataprepAssetUserData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataprepAssetUserData), 2441961743U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_DataprepAssetUserData_h_1142566363(TEXT("/Script/DataprepCore"),
