...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInstance_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataprepAssetInstance_Statics::NewProp_Parameterization = { "Parameterization", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepAssetInstance, Parameterization), Z_Construct_UClass_UDataprepParameterizationInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInstance_Statics::NewProp_Parameterization_MetaData), Z_Construct_UClass_UDataprepAssetInstance_Statics::NewProp_Parameterization_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDataprepAssetInstance_Statics::NewProp_ActionsFromDataprepAsset = { "ActionsFromDataprepAsset", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepAssetInstance, ActionsFromDataprepAsset), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInstance_Statics::NewProp_ActionsFromDataprepAsset_MetaData), Z_Construct_UClass_UDataprepAssetInstance_Statics::NewProp_ActionsFromDataprepAsset_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepAssetInstance_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInstance_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepAssetInstance_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInstance_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_DataprepAssetInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataprepAssetInstance, UDataprepAssetInstance::StaticClass, TEXT("UDataprepAssetInstance"), &Z_Registration_Info_UClass_UDataprepAssetInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataprepAssetInstance), 680894879U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_DataprepAssetInstance_h_1779924882(TEXT("/Script/DataprepCore"),
