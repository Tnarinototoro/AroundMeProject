...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DataprepLibraries_EDataprepHierarchySelectionPolicy_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DataprepLibraries_EDataprepHierarchySelectionPolicy_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DataprepLibraries_EDataprepHierarchySelectionPolicy_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::NewProp_bAllowIndirectReferences = { "bAllowIndirectReferences", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDataprepReferenceSelectionTransform), &Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::NewProp_bAllowIndirectReferences_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::NewProp_bAllowIndirectReferences_MetaData), Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::NewProp_bAllowIndirectReferences_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepReferenceSelectionTransform_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepReferencedSelectionTransform_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepReferencedSelectionTransform_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepReferencedSelectionTransform_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepReferencedSelectionTransform_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::NewProp_SelectionPolicy = { "SelectionPolicy", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepHierarchySelectionTransform, SelectionPolicy), Z_Construct_UEnum_DataprepLibraries_EDataprepHierarchySelectionPolicy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::NewProp_SelectionPolicy_MetaData), Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::NewProp_SelectionPolicy_MetaData) }; // 245086443
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepHierarchySelectionTransform_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepActorComponentsSelectionTransform_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepActorComponentsSelectionTransform_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepActorComponentsSelectionTransform_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepActorComponentsSelectionTransform_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepOwningActorSelectionTransform_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepOwningActorSelectionTransform_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepOwningActorSelectionTransform_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepOwningActorSelectionTransform_Statics::Class_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepLibraries_Private_DataprepSelectionTransforms_h_Statics::EnumInfo[] = {
		{ EDataprepHierarchySelectionPolicy_StaticEnum, TEXT("EDataprepHierarchySelectionPolicy"), &Z_Registration_Info_UEnum_EDataprepHierarchySelectionPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 245086443U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepLibraries_Private_DataprepSelectionTransforms_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UDataprepHierarchySelectionTransform, UDataprepHierarchySelectionTransform::StaticClass, TEXT("UDataprepHierarchySelectionTransform"), &Z_Registration_Info_UClass_UDataprepHierarchySelectionTransform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataprepHierarchySelectionTransform), 4145811317U) },
		...
		{ Z_Construct_UClass_UDataprepOwningActorSelectionTransform, UDataprepOwningActorSelectionTransform::StaticClass, TEXT("UDataprepOwningActorSelectionTransform"), &Z_Registration_Info_UClass_UDataprepOwningActorSelectionTransform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataprepOwningActorSelectionTransform), 1751766831U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepLibraries_Private_DataprepSelectionTransforms_h_1375524323(TEXT("/Script/DataprepLibraries"),
