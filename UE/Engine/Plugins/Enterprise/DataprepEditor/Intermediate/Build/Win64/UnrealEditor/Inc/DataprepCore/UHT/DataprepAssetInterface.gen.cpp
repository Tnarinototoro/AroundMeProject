...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepRecipeInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepRecipeInterface_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepRecipeInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepRecipeInterface_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Recipe = { "Recipe", nullptr, (EPropertyFlags)0x0024080800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepAssetInterface, Recipe), Z_Construct_UClass_UDataprepRecipeInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Recipe_MetaData), Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Recipe_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Inputs = { "Inputs", nullptr, (EPropertyFlags)0x0024080800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepAssetInterface, Inputs), Z_Construct_UClass_UDataprepAssetProducers_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Inputs_MetaData), Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Inputs_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Output = { "Output", nullptr, (EPropertyFlags)0x0024080800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepAssetInterface, Output), Z_Construct_UClass_UDataprepContentConsumer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Output_MetaData), Z_Construct_UClass_UDataprepAssetInterface_Statics::NewProp_Output_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepAssetInterface_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepAssetInterface_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepAssetInterface_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_DataprepAssetInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataprepRecipeInterface, UDataprepRecipeInterface::StaticClass, TEXT("UDataprepRecipeInterface"), &Z_Registration_Info_UClass_UDataprepRecipeInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataprepRecipeInterface), 3316695240U) },
		{ Z_Construct_UClass_UDataprepAssetInterface, UDataprepAssetInterface::StaticClass, TEXT("UDataprepAssetInterface"), &Z_Registration_Info_UClass_UDataprepAssetInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataprepAssetInterface), 164261726U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DataprepEditor_Source_DataprepCore_Public_DataprepAssetInterface_h_494570726(TEXT("/Script/DataprepCore"),
