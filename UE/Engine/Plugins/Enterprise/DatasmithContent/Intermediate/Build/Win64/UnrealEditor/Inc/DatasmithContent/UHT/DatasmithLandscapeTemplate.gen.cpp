...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial = { "LandscapeMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithLandscapeTemplate, LandscapeMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial_MetaData), Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithLandscapeTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithLandscapeTemplate, UDatasmithLandscapeTemplate::StaticClass, TEXT("UDatasmithLandscapeTemplate"), &Z_Registration_Info_UClass_UDatasmithLandscapeTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithLandscapeTemplate), 2914136641U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithLandscapeTemplate_h_830750287(TEXT("/Script/DatasmithContent"),
