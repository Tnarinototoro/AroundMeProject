...
template<> DATASMITHCONTENT_API UScriptStruct* StaticStruct<FDatasmithStaticParameterSetTemplate>()
{
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_VectorParameterValues = { "VectorParameterValues", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithMaterialInstanceTemplate, VectorParameterValues), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_VectorParameterValues_MetaData), Z_Construct_UClass_UDatasmithMaterialInstanceTemplate_Statics::NewProp_VectorParameterValues_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithMaterialInstanceTemplate_h_Statics::ScriptStructInfo[] = {
		{ FDatasmithStaticParameterSetTemplate::StaticStruct, Z_Construct_UScriptStruct_FDatasmithStaticParameterSetTemplate_Statics::NewStructOps, TEXT("DatasmithStaticParameterSetTemplate"), &Z_Registration_Info_UScriptStruct_DatasmithStaticParameterSetTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDatasmithStaticParameterSetTemplate), 500931501U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithMaterialInstanceTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithMaterialInstanceTemplate, UDatasmithMaterialInstanceTemplate::StaticClass, TEXT("UDatasmithMaterialInstanceTemplate"), &Z_Registration_Info_UClass_UDatasmithMaterialInstanceTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithMaterialInstanceTemplate), 3771960518U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithMaterialInstanceTemplate_h_3338054325(TEXT("/Script/DatasmithContent"),
