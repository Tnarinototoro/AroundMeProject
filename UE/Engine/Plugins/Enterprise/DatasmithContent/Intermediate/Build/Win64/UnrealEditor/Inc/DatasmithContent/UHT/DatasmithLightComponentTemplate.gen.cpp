...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_Intensity = { "Intensity", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithLightComponentTemplate, Intensity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_Intensity_MetaData), Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_Intensity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_Temperature = { "Temperature", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithLightComponentTemplate, Temperature), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_Temperature_MetaData), Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_Temperature_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_LightColor = { "LightColor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithLightComponentTemplate, LightColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_LightColor_MetaData), Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_LightColor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_LightFunctionMaterial = { "LightFunctionMaterial", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithLightComponentTemplate, LightFunctionMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_LightFunctionMaterial_MetaData), Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_LightFunctionMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_IESTexture = { "IESTexture", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithLightComponentTemplate, IESTexture), Z_Construct_UClass_UTextureLightProfile_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_IESTexture_MetaData), Z_Construct_UClass_UDatasmithLightComponentTemplate_Statics::NewProp_IESTexture_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithLightComponentTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithLightComponentTemplate, UDatasmithLightComponentTemplate::StaticClass, TEXT("UDatasmithLightComponentTemplate"), &Z_Registration_Info_UClass_UDatasmithLightComponentTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithLightComponentTemplate), 3309010512U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithLightComponentTemplate_h_2405990367(TEXT("/Script/DatasmithContent"),
