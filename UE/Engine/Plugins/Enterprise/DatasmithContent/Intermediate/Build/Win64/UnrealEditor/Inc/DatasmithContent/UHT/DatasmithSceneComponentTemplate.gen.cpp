...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_RelativeTransform = { "RelativeTransform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithSceneComponentTemplate, RelativeTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_RelativeTransform_MetaData), Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_RelativeTransform_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_Mobility = { "Mobility", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithSceneComponentTemplate, Mobility), Z_Construct_UEnum_Engine_EComponentMobility, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_Mobility_MetaData), Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_Mobility_MetaData) }; // 2228433112
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_Tags = { "Tags", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithSceneComponentTemplate, Tags), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_Tags_MetaData), Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_Tags_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithSceneComponentTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithSceneComponentTemplate, UDatasmithSceneComponentTemplate::StaticClass, TEXT("UDatasmithSceneComponentTemplate"), &Z_Registration_Info_UClass_UDatasmithSceneComponentTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithSceneComponentTemplate), 4049459417U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithSceneComponentTemplate_h_3050531857(TEXT("/Script/DatasmithContent"),
