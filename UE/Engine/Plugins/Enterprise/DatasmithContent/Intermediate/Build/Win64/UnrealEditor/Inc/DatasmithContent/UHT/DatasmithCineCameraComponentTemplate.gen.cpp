...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Statics::NewProp_MaxFStop = { "MaxFStop", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDatasmithCameraLensSettingsTemplate, MaxFStop), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Statics::NewProp_MaxFStop_MetaData), Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate_Statics::NewProp_MaxFStop_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::NewProp_FocusMethod = { "FocusMethod", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDatasmithCameraFocusSettingsTemplate, FocusMethod), Z_Construct_UEnum_CinematicCamera_ECameraFocusMethod, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::NewProp_FocusMethod_MetaData), Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::NewProp_FocusMethod_MetaData) }; // 4148500762
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::NewProp_ManualFocusDistance = { "ManualFocusDistance", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDatasmithCameraFocusSettingsTemplate, ManualFocusDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::NewProp_ManualFocusDistance_MetaData), Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Statics::NewProp_ManualFocusDistance_MetaData) };
...
template<> DATASMITHCONTENT_API UScriptStruct* StaticStruct<FDatasmithPostProcessSettingsTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_LensSettings = { "LensSettings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithCineCameraComponentTemplate, LensSettings), Z_Construct_UScriptStruct_FDatasmithCameraLensSettingsTemplate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_LensSettings_MetaData), Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_LensSettings_MetaData) }; // 37383609
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentFocalLength = { "CurrentFocalLength", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithCineCameraComponentTemplate, CurrentFocalLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentFocalLength_MetaData), Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentFocalLength_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentAperture = { "CurrentAperture", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithCineCameraComponentTemplate, CurrentAperture), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentAperture_MetaData), Z_Construct_UClass_UDatasmithCineCameraComponentTemplate_Statics::NewProp_CurrentAperture_MetaData) };
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithCineCameraComponentTemplate_h_1742013130(TEXT("/Script/DatasmithContent"),
