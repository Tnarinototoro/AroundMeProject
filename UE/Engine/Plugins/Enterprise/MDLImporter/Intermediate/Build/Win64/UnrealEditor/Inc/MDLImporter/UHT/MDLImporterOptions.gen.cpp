...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_BakingResolution = { "BakingResolution", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMDLImporterOptions, BakingResolution), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_BakingResolution_MetaData), Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_BakingResolution_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_BakingSamples = { "BakingSamples", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMDLImporterOptions, BakingSamples), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_BakingSamples_MetaData), Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_BakingSamples_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_ResourcesDir = { "ResourcesDir", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMDLImporterOptions, ResourcesDir), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_ResourcesDir_MetaData), Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_ResourcesDir_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_ModulesDir = { "ModulesDir", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMDLImporterOptions, ModulesDir), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_ModulesDir_MetaData), Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_ModulesDir_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_MetersPerSceneUnit = { "MetersPerSceneUnit", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMDLImporterOptions, MetersPerSceneUnit), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_MetersPerSceneUnit_MetaData), Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_MetersPerSceneUnit_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_bForceBaking = { "bForceBaking", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMDLImporterOptions), &Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_bForceBaking_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_bForceBaking_MetaData), Z_Construct_UClass_UMDLImporterOptions_Statics::NewProp_bForceBaking_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMDLImporterOptions_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UMDLImporterOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMDLImporterOptions_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_MDLImporter_Source_MDLImporter_Public_MDLImporterOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMDLImporterOptions, UMDLImporterOptions::StaticClass, TEXT("UMDLImporterOptions"), &Z_Registration_Info_UClass_UMDLImporterOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMDLImporterOptions), 2239621672U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_MDLImporter_Source_MDLImporter_Public_MDLImporterOptions_h_295884167(TEXT("/Script/MDLImporter"),
