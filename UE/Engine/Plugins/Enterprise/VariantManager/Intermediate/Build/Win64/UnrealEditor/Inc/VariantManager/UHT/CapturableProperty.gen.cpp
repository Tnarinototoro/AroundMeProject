...
template<> VARIANTMANAGER_API UScriptStruct* StaticStruct<FCapturableProperty>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FCapturableProperty_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCapturableProperty, DisplayName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCapturableProperty_Statics::NewProp_DisplayName_MetaData), Z_Construct_UScriptStruct_FCapturableProperty_Statics::NewProp_DisplayName_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManager_Source_VariantManager_Public_CapturableProperty_h_Statics::ScriptStructInfo[] = {
		{ FCapturableProperty::StaticStruct, Z_Construct_UScriptStruct_FCapturableProperty_Statics::NewStructOps, TEXT("CapturableProperty"), &Z_Registration_Info_UScriptStruct_CapturableProperty, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCapturableProperty), 3458390694U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManager_Source_VariantManager_Public_CapturableProperty_h_869970223(TEXT("/Script/VariantManager"),
		nullptr, 0,
