...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAxFImporterOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAxFImporterOptions_Statics::NewProp_MetersPerSceneUnit = { "MetersPerSceneUnit", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAxFImporterOptions, MetersPerSceneUnit), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAxFImporterOptions_Statics::NewProp_MetersPerSceneUnit_MetaData), Z_Construct_UClass_UAxFImporterOptions_Statics::NewProp_MetersPerSceneUnit_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAxFImporterOptions_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAxFImporterOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UAxFImporterOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAxFImporterOptions_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_AxFImporter_Source_AxFImporter_Private_AxFImporterOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAxFImporterOptions, UAxFImporterOptions::StaticClass, TEXT("UAxFImporterOptions"), &Z_Registration_Info_UClass_UAxFImporterOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAxFImporterOptions), 3944034821U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_AxFImporter_Source_AxFImporter_Private_AxFImporterOptions_h_215679666(TEXT("/Script/AxFImporter"),
