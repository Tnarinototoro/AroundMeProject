...
template<> GLTFEXPORTER_API UScriptStruct* StaticStruct<FGLTFExportMessages>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UGLTFExporter_ExportToGLTF_Statics::NewProp_FilePath = { "FilePath", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GLTFExporter_eventExportToGLTF_Parms, FilePath), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGLTFExporter_ExportToGLTF_Statics::NewProp_FilePath_MetaData), Z_Construct_UFunction_UGLTFExporter_ExportToGLTF_Statics::NewProp_FilePath_MetaData) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGLTFExporter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGLTFExporter_ExportToGLTF, "ExportToGLTF" }, // 3880839804
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGLTFExporter_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_GLTFExporter_Source_GLTFExporter_Public_Exporters_GLTFExporter_h_Statics::ScriptStructInfo[] = {
		{ FGLTFExportMessages::StaticStruct, Z_Construct_UScriptStruct_FGLTFExportMessages_Statics::NewStructOps, TEXT("GLTFExportMessages"), &Z_Registration_Info_UScriptStruct_GLTFExportMessages, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGLTFExportMessages), 2619404293U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_GLTFExporter_Source_GLTFExporter_Public_Exporters_GLTFExporter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLTFExporter, UGLTFExporter::StaticClass, TEXT("UGLTFExporter"), &Z_Registration_Info_UClass_UGLTFExporter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLTFExporter), 943187123U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_GLTFExporter_Source_GLTFExporter_Public_Exporters_GLTFExporter_h_2398745391(TEXT("/Script/GLTFExporter"),
