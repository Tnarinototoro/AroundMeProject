...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithImportFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithImportFactory_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithImportFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithImportFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_DatasmithImportFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithImportFactory, UDatasmithImportFactory::StaticClass, TEXT("UDatasmithImportFactory"), &Z_Registration_Info_UClass_UDatasmithImportFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithImportFactory), 201332563U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_DatasmithImportFactory_h_3874434207(TEXT("/Script/DatasmithImporter"),
