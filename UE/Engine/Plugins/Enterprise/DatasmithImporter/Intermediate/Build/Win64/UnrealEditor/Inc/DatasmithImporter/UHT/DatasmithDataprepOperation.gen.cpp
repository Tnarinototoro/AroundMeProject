...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::NewProp_bEnableLightmapUVGeneration = { "bEnableLightmapUVGeneration", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDataprepSetupStaticLightingOperation), &Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::NewProp_bEnableLightmapUVGeneration_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::NewProp_bEnableLightmapUVGeneration_MetaData), Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::NewProp_bEnableLightmapUVGeneration_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::NewProp_LightmapResolutionIdealRatio = { "LightmapResolutionIdealRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDataprepSetupStaticLightingOperation, LightmapResolutionIdealRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::NewProp_LightmapResolutionIdealRatio_MetaData), Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::NewProp_LightmapResolutionIdealRatio_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::Class_MetaDataParams), Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDataprepSetupStaticLightingOperation_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Private_DatasmithDataprepOperation_h_2708600027(TEXT("/Script/DatasmithImporter"),
