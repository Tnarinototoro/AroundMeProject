...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithTexturePipeline_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithTexturePipeline_Statics::ClassParams = {
		...
		0,
		0x000010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithTexturePipeline_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithTexturePipeline_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_DatasmithTextureImporter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithTexturePipeline, UDatasmithTexturePipeline::StaticClass, TEXT("UDatasmithTexturePipeline"), &Z_Registration_Info_UClass_UDatasmithTexturePipeline, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithTexturePipeline), 2947759332U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_DatasmithTextureImporter_h_2879102008(TEXT("/Script/DatasmithImporter"),
