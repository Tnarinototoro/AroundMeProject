...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryDatasmithScene_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryDatasmithScene_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryDatasmithScene_Statics::Class_MetaDataParams), Z_Construct_UClass_UActorFactoryDatasmithScene_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_ActorFactoryDatasmithScene_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorFactoryDatasmithScene, UActorFactoryDatasmithScene::StaticClass, TEXT("UActorFactoryDatasmithScene"), &Z_Registration_Info_UClass_UActorFactoryDatasmithScene, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorFactoryDatasmithScene), 3842863433U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_ActorFactoryDatasmithScene_h_357111571(TEXT("/Script/DatasmithImporter"),
