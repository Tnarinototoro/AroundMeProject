...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::NewProp_InStaticMesh = { "InStaticMesh", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVGenerationFlattenMapping_eventGenerateFlattenMappingUVs_Parms, InStaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::NewProp_UVChannel = { "UVChannel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVGenerationFlattenMapping_eventGenerateFlattenMappingUVs_Parms, UVChannel), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::NewProp_AngleThreshold = { "AngleThreshold", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVGenerationFlattenMapping_eventGenerateFlattenMappingUVs_Parms, AngleThreshold), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUVGenerationFlattenMapping, nullptr, "GenerateFlattenMappingUVs", nullptr, nullptr, Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::UVGenerationFlattenMapping_eventGenerateFlattenMappingUVs_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs_Statics::UVGenerationFlattenMapping_eventGenerateFlattenMappingUVs_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUVGenerationFlattenMapping_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UUVGenerationFlattenMapping_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUVGenerationFlattenMapping_GenerateFlattenMappingUVs, "GenerateFlattenMappingUVs" }, // 772826387
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUVGenerationFlattenMapping_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUVGenerationFlattenMapping_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUVGenerationFlattenMapping_Statics::Class_MetaDataParams), Z_Construct_UClass_UUVGenerationFlattenMapping_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_UVTools_UVGenerationFlattenMapping_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUVGenerationFlattenMapping, UUVGenerationFlattenMapping::StaticClass, TEXT("UUVGenerationFlattenMapping"), &Z_Registration_Info_UClass_UUVGenerationFlattenMapping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUVGenerationFlattenMapping), 2055507045U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithImporter_Source_DatasmithImporter_Public_UVTools_UVGenerationFlattenMapping_h_488121623(TEXT("/Script/DatasmithImporter"),
