...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::NewProp_TextureDirs_Inner = { "TextureDirs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::NewProp_TextureDirs = { "TextureDirs", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithFBXImportOptions, TextureDirs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::NewProp_TextureDirs_MetaData), Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::NewProp_TextureDirs_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithFBXImportOptions_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithFBXImporter_Source_DatasmithFBXTranslator_Public_DatasmithFBXImportOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithFBXImportOptions, UDatasmithFBXImportOptions::StaticClass, TEXT("UDatasmithFBXImportOptions"), &Z_Registration_Info_UClass_UDatasmithFBXImportOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithFBXImportOptions), 80385929U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithFBXImporter_Source_DatasmithFBXTranslator_Public_DatasmithFBXImportOptions_h_3283099493(TEXT("/Script/DatasmithFBXTranslator"),
