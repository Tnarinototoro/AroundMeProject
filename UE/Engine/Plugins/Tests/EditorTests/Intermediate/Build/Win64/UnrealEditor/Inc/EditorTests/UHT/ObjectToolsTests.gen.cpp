...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UObjectToolsTestObject_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UObjectToolsTestObject_Statics::NewProp_StrongReference = { "StrongReference", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UObjectToolsTestObject, StrongReference), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UObjectToolsTestObject_Statics::NewProp_StrongReference_MetaData), Z_Construct_UClass_UObjectToolsTestObject_Statics::NewProp_StrongReference_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UObjectToolsTestObject_Statics::NewProp_WeakReference = { "WeakReference", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UObjectToolsTestObject, WeakReference), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UObjectToolsTestObject_Statics::NewProp_WeakReference_MetaData), Z_Construct_UClass_UObjectToolsTestObject_Statics::NewProp_WeakReference_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UObjectToolsTestObject_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UObjectToolsTestObject_Statics::Class_MetaDataParams), Z_Construct_UClass_UObjectToolsTestObject_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UObjectToolsTestObject_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Tests_EditorTests_Source_EditorTests_Private_UnrealEd_ObjectToolsTests_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UObjectToolsTestObject, UObjectToolsTestObject::StaticClass, TEXT("UObjectToolsTestObject"), &Z_Registration_Info_UClass_UObjectToolsTestObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UObjectToolsTestObject), 2759125240U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Tests_EditorTests_Source_EditorTests_Private_UnrealEd_ObjectToolsTests_h_2999945018(TEXT("/Script/EditorTests"),
