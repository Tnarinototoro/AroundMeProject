...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Infos = { "Infos", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeTestFunctionResult, Infos), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Infos_MetaData), Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Infos_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Warnings = { "Warnings", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeTestFunctionResult, Warnings), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Warnings_MetaData), Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Warnings_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Errors = { "Errors", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeTestFunctionResult, Errors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Errors_MetaData), Z_Construct_UScriptStruct_FInterchangeTestFunctionResult_Statics::NewProp_Errors_MetaData) };
...
template<> INTERCHANGETESTS_API UScriptStruct* StaticStruct<FInterchangeTestFunction>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_AssetClass = { "AssetClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeTestFunction, AssetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_AssetClass_MetaData), Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_AssetClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_CheckFunction = { "CheckFunction", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeTestFunction, CheckFunction), Z_Construct_UClass_UFunction, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_CheckFunction_MetaData), Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_CheckFunction_MetaData) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_Parameters = { "Parameters", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeTestFunction, Parameters), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_Parameters_MetaData), Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewProp_Parameters_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Tests_InterchangeTests_Source_InterchangeTests_Public_InterchangeTestFunction_h_Statics::ScriptStructInfo[] = {
		...
		{ FInterchangeTestFunction::StaticStruct, Z_Construct_UScriptStruct_FInterchangeTestFunction_Statics::NewStructOps, TEXT("InterchangeTestFunction"), &Z_Registration_Info_UScriptStruct_InterchangeTestFunction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInterchangeTestFunction), 2064593711U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Tests_InterchangeTests_Source_InterchangeTests_Public_InterchangeTestFunction_h_179807836(TEXT("/Script/InterchangeTests"),
		nullptr, 0,
