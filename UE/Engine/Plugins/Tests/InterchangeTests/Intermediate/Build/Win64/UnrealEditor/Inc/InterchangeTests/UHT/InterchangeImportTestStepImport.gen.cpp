...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_PipelineStack_Inner = { "PipelineStack", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UInterchangePipelineBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_PipelineStack_Inner_MetaData), Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_PipelineStack_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_PipelineStack = { "PipelineStack", nullptr, (EPropertyFlags)0x0014008000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UInterchangeImportTestStepImport, PipelineStack), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_PipelineStack_MetaData), Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_PipelineStack_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bSaveThenReloadImportedAssets = { "bSaveThenReloadImportedAssets", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UInterchangeImportTestStepImport), &Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bSaveThenReloadImportedAssets_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bSaveThenReloadImportedAssets_MetaData), Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bSaveThenReloadImportedAssets_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bImportIntoLevel = { "bImportIntoLevel", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UInterchangeImportTestStepImport), &Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bImportIntoLevel_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bImportIntoLevel_MetaData), Z_Construct_UClass_UInterchangeImportTestStepImport_Statics::NewProp_bImportIntoLevel_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Tests_InterchangeTests_Source_InterchangeTests_Public_InterchangeImportTestStepImport_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInterchangeImportTestStepImport, UInterchangeImportTestStepImport::StaticClass, TEXT("UInterchangeImportTestStepImport"), &Z_Registration_Info_UClass_UInterchangeImportTestStepImport, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeImportTestStepImport), 570478430U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Tests_InterchangeTests_Source_InterchangeTests_Public_InterchangeImportTestStepImport_h_3915147128(TEXT("/Script/InterchangeTests"),
