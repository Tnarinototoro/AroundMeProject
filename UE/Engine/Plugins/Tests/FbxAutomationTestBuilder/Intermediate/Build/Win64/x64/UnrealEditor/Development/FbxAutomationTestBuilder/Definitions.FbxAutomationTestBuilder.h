...
#undef FBXAUTOMATIONTESTBUILDER_API
...
#define UE_MODULE_NAME "FbxAutomationTestBuilder"
#define UE_PLUGIN_NAME "FbxAutomationTestBuilder"
#define WORKSPACEMENUSTRUCTURE_API DLLIMPORT
#define FBXAUTOMATIONTESTBUILDER_API DLLEXPORT
