...
template<> LIVELINKPRESTONMDR_API UScriptStruct* StaticStruct<FLiveLinkPrestonMDRConnectionSettings>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_IPAddress = { "IPAddress", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLiveLinkPrestonMDRConnectionSettings, IPAddress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_IPAddress_MetaData), Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_IPAddress_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_PortNumber = { "PortNumber", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLiveLinkPrestonMDRConnectionSettings, PortNumber), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_PortNumber_MetaData), Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_PortNumber_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_SubjectName = { "SubjectName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLiveLinkPrestonMDRConnectionSettings, SubjectName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_SubjectName_MetaData), Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewProp_SubjectName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Public_LiveLinkPrestonMDRConnectionSettings_h_Statics::ScriptStructInfo[] = {
		{ FLiveLinkPrestonMDRConnectionSettings::StaticStruct, Z_Construct_UScriptStruct_FLiveLinkPrestonMDRConnectionSettings_Statics::NewStructOps, TEXT("LiveLinkPrestonMDRConnectionSettings"), &Z_Registration_Info_UScriptStruct_LiveLinkPrestonMDRConnectionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLiveLinkPrestonMDRConnectionSettings), 2715384044U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Public_LiveLinkPrestonMDRConnectionSettings_h_3791723174(TEXT("/Script/LiveLinkPrestonMDR"),
		nullptr, 0,
