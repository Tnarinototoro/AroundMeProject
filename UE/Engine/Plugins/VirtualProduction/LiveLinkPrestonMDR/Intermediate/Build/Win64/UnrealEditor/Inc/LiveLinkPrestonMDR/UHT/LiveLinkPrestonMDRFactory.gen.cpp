...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRSourceFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkPrestonMDRSourceFactory_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRSourceFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkPrestonMDRSourceFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Public_LiveLinkPrestonMDRFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkPrestonMDRSourceFactory, ULiveLinkPrestonMDRSourceFactory::StaticClass, TEXT("ULiveLinkPrestonMDRSourceFactory"), &Z_Registration_Info_UClass_ULiveLinkPrestonMDRSourceFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkPrestonMDRSourceFactory), 2640663565U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Public_LiveLinkPrestonMDRFactory_h_2339714552(TEXT("/Script/LiveLinkPrestonMDR"),
