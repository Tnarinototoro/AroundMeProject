...
template<> LIVELINKPRESTONMDR_API UScriptStruct* StaticStruct<FEncoderRange>()
{
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FEncoderRange_Statics::NewProp_Min = { "Min", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEncoderRange, Min), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncoderRange_Statics::NewProp_Min_MetaData), Z_Construct_UScriptStruct_FEncoderRange_Statics::NewProp_Min_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FEncoderRange_Statics::NewProp_Max = { "Max", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEncoderRange, Max), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncoderRange_Statics::NewProp_Max_MetaData), Z_Construct_UScriptStruct_FEncoderRange_Statics::NewProp_Max_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FEncoderRange_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncoderRange_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FEncoderRange_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncoderRange_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LiveLinkPrestonMDR_EFIZDataMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LiveLinkPrestonMDR_EFIZDataMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LiveLinkPrestonMDR_EFIZDataMode_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::NewProp_IncomingDataMode = { "IncomingDataMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkPrestonMDRSourceSettings, IncomingDataMode), Z_Construct_UEnum_LiveLinkPrestonMDR_EFIZDataMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::NewProp_IncomingDataMode_MetaData), Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::NewProp_IncomingDataMode_MetaData) }; // 1816172056
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRSourceSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Private_LiveLinkPrestonMDRSourceSettings_h_Statics::EnumInfo[] = {
		{ EFIZDataMode_StaticEnum, TEXT("EFIZDataMode"), &Z_Registration_Info_UEnum_EFIZDataMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1816172056U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Private_LiveLinkPrestonMDRSourceSettings_h_Statics::ScriptStructInfo[] = {
		{ FEncoderRange::StaticStruct, Z_Construct_UScriptStruct_FEncoderRange_Statics::NewStructOps, TEXT("EncoderRange"), &Z_Registration_Info_UScriptStruct_EncoderRange, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEncoderRange), 388757922U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Private_LiveLinkPrestonMDRSourceSettings_h_2099507246(TEXT("/Script/LiveLinkPrestonMDR"),
