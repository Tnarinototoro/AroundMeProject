...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRRole_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkPrestonMDRRole_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkPrestonMDRRole_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkPrestonMDRRole_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Private_LiveLinkPrestonMDRRole_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkPrestonMDRRole, ULiveLinkPrestonMDRRole::StaticClass, TEXT("ULiveLinkPrestonMDRRole"), &Z_Registration_Info_UClass_ULiveLinkPrestonMDRRole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkPrestonMDRRole), 3314782143U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkPrestonMDR_Source_LiveLinkPrestonMDR_Private_LiveLinkPrestonMDRRole_h_1549525271(TEXT("/Script/LiveLinkPrestonMDR"),
