...
template<> LIVELINKFREED_API UScriptStruct* StaticStruct<FLiveLinkFreeDConnectionSettings>()
{
...
#endif
		static const UECodeGen_Private::FUInt16PropertyParams NewProp_UDPPortNumber;
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::NewProp_IPAddress = { "IPAddress", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLiveLinkFreeDConnectionSettings, IPAddress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::NewProp_IPAddress_MetaData), Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::NewProp_IPAddress_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt16PropertyParams Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::NewProp_UDPPortNumber = { "UDPPortNumber", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLiveLinkFreeDConnectionSettings, UDPPortNumber), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::NewProp_UDPPortNumber_MetaData), Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::NewProp_UDPPortNumber_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkFreeD_Source_LiveLinkFreeD_Private_LiveLinkFreeDConnectionSettings_h_Statics::ScriptStructInfo[] = {
		{ FLiveLinkFreeDConnectionSettings::StaticStruct, Z_Construct_UScriptStruct_FLiveLinkFreeDConnectionSettings_Statics::NewStructOps, TEXT("LiveLinkFreeDConnectionSettings"), &Z_Registration_Info_UScriptStruct_LiveLinkFreeDConnectionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLiveLinkFreeDConnectionSettings), 791066395U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkFreeD_Source_LiveLinkFreeD_Private_LiveLinkFreeDConnectionSettings_h_3784954122(TEXT("/Script/LiveLinkFreeD"),
		nullptr, 0,
