...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_AdjustedNodalOffset = { "AdjustedNodalOffset", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraNodalOffsetAlgoOpticalAxis, AdjustedNodalOffset), Z_Construct_UScriptStruct_FNodalPointOffset, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_AdjustedNodalOffset_MetaData), Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_AdjustedNodalOffset_MetaData) }; // 2023718670
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_LastSavedNodalOffset = { "LastSavedNodalOffset", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraNodalOffsetAlgoOpticalAxis, LastSavedNodalOffset), Z_Construct_UScriptStruct_FNodalPointOffset, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_LastSavedNodalOffset_MetaData), Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_LastSavedNodalOffset_MetaData) }; // 2023718670
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_EntrancePupilPosition = { "EntrancePupilPosition", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraNodalOffsetAlgoOpticalAxis, EntrancePupilPosition), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_EntrancePupilPosition_MetaData), Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_EntrancePupilPosition_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_LastSavedEntrancePupilPosition = { "LastSavedEntrancePupilPosition", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraNodalOffsetAlgoOpticalAxis, LastSavedEntrancePupilPosition), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_LastSavedEntrancePupilPosition_MetaData), Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_LastSavedEntrancePupilPosition_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_OverlayTexture = { "OverlayTexture", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraNodalOffsetAlgoOpticalAxis, OverlayTexture), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_OverlayTexture_MetaData), Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::NewProp_OverlayTexture_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::Class_MetaDataParams), Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Calibrators_CameraNodalOffsetAlgoOpticalAxis_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraNodalOffsetAlgoOpticalAxis, UCameraNodalOffsetAlgoOpticalAxis::StaticClass, TEXT("UCameraNodalOffsetAlgoOpticalAxis"), &Z_Registration_Info_UClass_UCameraNodalOffsetAlgoOpticalAxis, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraNodalOffsetAlgoOpticalAxis), 2094264786U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Calibrators_CameraNodalOffsetAlgoOpticalAxis_h_1026289069(TEXT("/Script/CameraCalibrationEditor"),
