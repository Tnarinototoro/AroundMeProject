...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULensFileExporter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULensFileExporter_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULensFileExporter_Statics::Class_MetaDataParams), Z_Construct_UClass_ULensFileExporter_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Exporters_LensFileExporter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULensFileExporter, ULensFileExporter::StaticClass, TEXT("ULensFileExporter"), &Z_Registration_Info_UClass_ULensFileExporter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULensFileExporter), 2678800314U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Exporters_LensFileExporter_h_1523306886(TEXT("/Script/CameraCalibrationEditor"),
