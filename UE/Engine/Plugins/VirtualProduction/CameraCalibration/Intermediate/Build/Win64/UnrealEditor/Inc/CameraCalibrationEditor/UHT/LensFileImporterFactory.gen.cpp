...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULensFileImporterFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULensFileImporterFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULensFileImporterFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_ULensFileImporterFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Factories_LensFileImporterFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULensFileImporterFactory, ULensFileImporterFactory::StaticClass, TEXT("ULensFileImporterFactory"), &Z_Registration_Info_UClass_ULensFileImporterFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULensFileImporterFactory), 2508854217U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Factories_LensFileImporterFactory_h_170600573(TEXT("/Script/CameraCalibrationEditor"),
