...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::NewProp_OriginalImageCenter = { "OriginalImageCenter", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraImageCenterAlgoManual, OriginalImageCenter), Z_Construct_UScriptStruct_FImageCenterInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::NewProp_OriginalImageCenter_MetaData), Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::NewProp_OriginalImageCenter_MetaData) }; // 4008996367
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::NewProp_AdjustedImageCenter = { "AdjustedImageCenter", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraImageCenterAlgoManual, AdjustedImageCenter), Z_Construct_UScriptStruct_FImageCenterInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::NewProp_AdjustedImageCenter_MetaData), Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::NewProp_AdjustedImageCenter_MetaData) }; // 4008996367
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::Class_MetaDataParams), Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraImageCenterAlgoManual_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Calibrators_CameraImageCenterAlgoManual_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraImageCenterAlgoManual, UCameraImageCenterAlgoManual::StaticClass, TEXT("UCameraImageCenterAlgoManual"), &Z_Registration_Info_UClass_UCameraImageCenterAlgoManual, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraImageCenterAlgoManual), 3959247151U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Calibrators_CameraImageCenterAlgoManual_h_2173884127(TEXT("/Script/CameraCalibrationEditor"),
