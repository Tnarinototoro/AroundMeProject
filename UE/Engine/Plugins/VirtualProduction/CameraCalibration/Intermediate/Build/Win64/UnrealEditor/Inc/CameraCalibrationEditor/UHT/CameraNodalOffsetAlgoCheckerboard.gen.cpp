...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoCheckerboard_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCameraNodalOffsetAlgoCheckerboard_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoCheckerboard_Statics::Class_MetaDataParams), Z_Construct_UClass_UCameraNodalOffsetAlgoCheckerboard_Statics::Class_MetaDataParams)
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Calibrators_CameraNodalOffsetAlgoCheckerboard_h_336495075(TEXT("/Script/CameraCalibrationEditor"),
