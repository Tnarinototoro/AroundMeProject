...
template<> CAMERACALIBRATIONEDITOR_API UScriptStruct* StaticStruct<FDistortionInfoContainer>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::NewProp_DistortionInfo = { "DistortionInfo", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionInfoContainer, DistortionInfo), Z_Construct_UScriptStruct_FDistortionInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::NewProp_DistortionInfo_MetaData), Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::NewProp_DistortionInfo_MetaData) }; // 1149939584
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_CameraCalibrationEditorCommon_h_Statics::ScriptStructInfo[] = {
		{ FDistortionInfoContainer::StaticStruct, Z_Construct_UScriptStruct_FDistortionInfoContainer_Statics::NewStructOps, TEXT("DistortionInfoContainer"), &Z_Registration_Info_UScriptStruct_DistortionInfoContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDistortionInfoContainer), 3613034599U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_CameraCalibrationEditorCommon_h_224215256(TEXT("/Script/CameraCalibrationEditor"),
		nullptr, 0,
