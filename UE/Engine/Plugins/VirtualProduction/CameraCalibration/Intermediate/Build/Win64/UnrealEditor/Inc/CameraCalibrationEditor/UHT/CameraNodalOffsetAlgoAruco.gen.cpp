...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoAruco_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCameraNodalOffsetAlgoAruco_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgoAruco_Statics::Class_MetaDataParams), Z_Construct_UClass_UCameraNodalOffsetAlgoAruco_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Calibrators_CameraNodalOffsetAlgoAruco_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraNodalOffsetAlgoAruco, UCameraNodalOffsetAlgoAruco::StaticClass, TEXT("UCameraNodalOffsetAlgoAruco"), &Z_Registration_Info_UClass_UCameraNodalOffsetAlgoAruco, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraNodalOffsetAlgoAruco), 1816828930U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_Calibrators_CameraNodalOffsetAlgoAruco_h_406486272(TEXT("/Script/CameraCalibrationEditor"),
