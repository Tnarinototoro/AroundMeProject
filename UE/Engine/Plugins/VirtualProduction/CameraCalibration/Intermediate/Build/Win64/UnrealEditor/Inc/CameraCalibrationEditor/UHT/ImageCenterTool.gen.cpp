...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImageCenterTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UImageCenterTool_Statics::NewProp_CurrentAlgo = { "CurrentAlgo", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UImageCenterTool, CurrentAlgo), Z_Construct_UClass_UCameraImageCenterAlgo_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImageCenterTool_Statics::NewProp_CurrentAlgo_MetaData), Z_Construct_UClass_UImageCenterTool_Statics::NewProp_CurrentAlgo_MetaData) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UImageCenterTool_Statics::NewProp_AlgoOverlayMIDs = { "AlgoOverlayMIDs", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UImageCenterTool, AlgoOverlayMIDs), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImageCenterTool_Statics::NewProp_AlgoOverlayMIDs_MetaData), Z_Construct_UClass_UImageCenterTool_Statics::NewProp_AlgoOverlayMIDs_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UImageCenterTool_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImageCenterTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UImageCenterTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImageCenterTool_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_ImageCenterTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UImageCenterTool, UImageCenterTool::StaticClass, TEXT("UImageCenterTool"), &Z_Registration_Info_UClass_UImageCenterTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImageCenterTool), 605091042U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_ImageCenterTool_h_2441038712(TEXT("/Script/CameraCalibrationEditor"),
