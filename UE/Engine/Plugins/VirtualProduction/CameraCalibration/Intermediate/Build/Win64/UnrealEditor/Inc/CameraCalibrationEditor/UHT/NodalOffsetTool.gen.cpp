...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNodalOffsetTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNodalOffsetTool_Statics::NewProp_NodalOffsetAlgo = { "NodalOffsetAlgo", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNodalOffsetTool, NodalOffsetAlgo), Z_Construct_UClass_UCameraNodalOffsetAlgo_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNodalOffsetTool_Statics::NewProp_NodalOffsetAlgo_MetaData), Z_Construct_UClass_UNodalOffsetTool_Statics::NewProp_NodalOffsetAlgo_MetaData) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UNodalOffsetTool_Statics::NewProp_AlgoOverlayMIDs = { "AlgoOverlayMIDs", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNodalOffsetTool, AlgoOverlayMIDs), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNodalOffsetTool_Statics::NewProp_AlgoOverlayMIDs_MetaData), Z_Construct_UClass_UNodalOffsetTool_Statics::NewProp_AlgoOverlayMIDs_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNodalOffsetTool_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNodalOffsetTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UNodalOffsetTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNodalOffsetTool_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_NodalOffsetTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNodalOffsetTool, UNodalOffsetTool::StaticClass, TEXT("UNodalOffsetTool"), &Z_Registration_Info_UClass_UNodalOffsetTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNodalOffsetTool), 1387623595U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_NodalOffsetTool_h_803852515(TEXT("/Script/CameraCalibrationEditor"),
