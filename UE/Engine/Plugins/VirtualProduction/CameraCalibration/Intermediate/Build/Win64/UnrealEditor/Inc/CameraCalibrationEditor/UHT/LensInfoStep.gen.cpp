...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULensInfoStep_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULensInfoStep_Statics::NewProp_CachedLensInfo = { "CachedLensInfo", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULensInfoStep, CachedLensInfo), Z_Construct_UScriptStruct_FLensInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULensInfoStep_Statics::NewProp_CachedLensInfo_MetaData), Z_Construct_UClass_ULensInfoStep_Statics::NewProp_CachedLensInfo_MetaData) }; // 1597388363
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULensInfoStep_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULensInfoStep_Statics::Class_MetaDataParams), Z_Construct_UClass_ULensInfoStep_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULensInfoStep_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_LensInfoStep_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULensInfoStep, ULensInfoStep::StaticClass, TEXT("ULensInfoStep"), &Z_Registration_Info_UClass_ULensInfoStep, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULensInfoStep), 486793695U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibration_Source_CameraCalibrationEditor_Private_AssetEditor_LensInfoStep_h_3741144397(TEXT("/Script/CameraCalibrationEditor"),
