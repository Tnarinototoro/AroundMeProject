...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensController_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_LensDistortionHandler = { "LensDistortionHandler", nullptr, (EPropertyFlags)0x0024080820002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkLensController, LensDistortionHandler_DEPRECATED), Z_Construct_UClass_ULensDistortionModelHandlerBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_LensDistortionHandler_MetaData), Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_LensDistortionHandler_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_bScaleOverscan = { "bScaleOverscan", nullptr, (EPropertyFlags)0x0020080820000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULiveLinkLensController), &Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_bScaleOverscan_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_bScaleOverscan_MetaData), Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_bScaleOverscan_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_OverscanMultiplier = { "OverscanMultiplier", nullptr, (EPropertyFlags)0x0020080820000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkLensController, OverscanMultiplier_DEPRECATED), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_OverscanMultiplier_MetaData), Z_Construct_UClass_ULiveLinkLensController_Statics::NewProp_OverscanMultiplier_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkLensController_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensController_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkLensController_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensController_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkLens_Source_LiveLinkLens_Public_LiveLinkLensController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkLensController, ULiveLinkLensController::StaticClass, TEXT("ULiveLinkLensController"), &Z_Registration_Info_UClass_ULiveLinkLensController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkLensController), 178015651U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkLens_Source_LiveLinkLens_Public_LiveLinkLensController_h_358202923(TEXT("/Script/LiveLinkLens"),
