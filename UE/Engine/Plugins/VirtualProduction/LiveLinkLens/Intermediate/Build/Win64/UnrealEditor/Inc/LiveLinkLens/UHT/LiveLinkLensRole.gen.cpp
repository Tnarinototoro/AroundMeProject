...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensRole_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkLensRole_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkLensRole_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkLensRole_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkLens_Source_LiveLinkLens_Public_LiveLinkLensRole_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkLensRole, ULiveLinkLensRole::StaticClass, TEXT("ULiveLinkLensRole"), &Z_Registration_Info_UClass_ULiveLinkLensRole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkLensRole), 3422190586U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkLens_Source_LiveLinkLens_Public_LiveLinkLensRole_h_2000504695(TEXT("/Script/LiveLinkLens"),
