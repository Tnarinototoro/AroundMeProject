...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSubSectionLensRole_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkSubSectionLensRole_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkSubSectionLensRole_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneLiveLinkSubSectionLensRole_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkLens_Source_LiveLinkLens_Private_MovieSceneLiveLinkSubSectionLensRole_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneLiveLinkSubSectionLensRole, UMovieSceneLiveLinkSubSectionLensRole::StaticClass, TEXT("UMovieSceneLiveLinkSubSectionLensRole"), &Z_Registration_Info_UClass_UMovieSceneLiveLinkSubSectionLensRole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneLiveLinkSubSectionLensRole), 240817685U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkLens_Source_LiveLinkLens_Private_MovieSceneLiveLinkSubSectionLensRole_h_530378830(TEXT("/Script/LiveLinkLens"),
