...
template<> DMXPROTOCOL_API UScriptStruct* StaticStruct<FDMXInputPortReference>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::NewProp_bEnabledFlag = { "bEnabledFlag", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FDMXInputPortReference), &Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::NewProp_bEnabledFlag_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::NewProp_bEnabledFlag_MetaData), Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::NewProp_bEnabledFlag_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_IO_DMXInputPortReference_h_Statics::ScriptStructInfo[] = {
		{ FDMXInputPortReference::StaticStruct, Z_Construct_UScriptStruct_FDMXInputPortReference_Statics::NewStructOps, TEXT("DMXInputPortReference"), &Z_Registration_Info_UScriptStruct_DMXInputPortReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXInputPortReference), 1870737200U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_IO_DMXInputPortReference_h_2025228931(TEXT("/Script/DMXProtocol"),
		nullptr, 0,
