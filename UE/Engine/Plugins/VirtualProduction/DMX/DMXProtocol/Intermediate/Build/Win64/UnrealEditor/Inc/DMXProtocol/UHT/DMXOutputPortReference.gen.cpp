...
template<> DMXPROTOCOL_API UScriptStruct* StaticStruct<FDMXOutputPortReference>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewProp_PortGuid = { "PortGuid", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXOutputPortReference, PortGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewProp_PortGuid_MetaData), Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewProp_PortGuid_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewProp_bEnabledFlag = { "bEnabledFlag", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FDMXOutputPortReference), &Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewProp_bEnabledFlag_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewProp_bEnabledFlag_MetaData), Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewProp_bEnabledFlag_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_IO_DMXOutputPortReference_h_Statics::ScriptStructInfo[] = {
		{ FDMXOutputPortReference::StaticStruct, Z_Construct_UScriptStruct_FDMXOutputPortReference_Statics::NewStructOps, TEXT("DMXOutputPortReference"), &Z_Registration_Info_UScriptStruct_DMXOutputPortReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOutputPortReference), 1190629245U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_IO_DMXOutputPortReference_h_652214614(TEXT("/Script/DMXProtocol"),
		nullptr, 0,
