...
template<> DMXPROTOCOL_API UScriptStruct* StaticStruct<FDMXNameListItem>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FDMXNameListItem_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXNameListItem, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXNameListItem_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FDMXNameListItem_Statics::NewProp_Name_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXNameListItem_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXNameListItem_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXNameListItem_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXNameListItem_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_DMXNameListItem_h_Statics::ScriptStructInfo[] = {
		{ FDMXNameListItem::StaticStruct, Z_Construct_UScriptStruct_FDMXNameListItem_Statics::NewStructOps, TEXT("DMXNameListItem"), &Z_Registration_Info_UScriptStruct_DMXNameListItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXNameListItem), 3947844810U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_DMXNameListItem_h_1793732137(TEXT("/Script/DMXProtocol"),
		nullptr, 0,
