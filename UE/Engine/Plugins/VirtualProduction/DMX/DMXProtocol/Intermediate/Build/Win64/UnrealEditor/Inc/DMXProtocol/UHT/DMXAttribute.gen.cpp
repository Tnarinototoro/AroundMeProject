...
template<> DMXPROTOCOL_API UScriptStruct* StaticStruct<FDMXAttribute>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FDMXAttribute_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXAttribute, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXAttribute_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FDMXAttribute_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDMXAttribute_Statics::NewProp_Keywords = { "Keywords", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXAttribute, Keywords), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXAttribute_Statics::NewProp_Keywords_MetaData), Z_Construct_UScriptStruct_FDMXAttribute_Statics::NewProp_Keywords_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXAttribute_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXAttribute_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXAttribute_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXAttribute_Statics::PropPointers) < 2048);
...
template<> DMXPROTOCOL_API UScriptStruct* StaticStruct<FDMXAttributeName>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FDMXAttributeName_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXAttributeName, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXAttributeName_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FDMXAttributeName_Statics::NewProp_Name_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXAttributeName_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXAttributeName_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXAttributeName_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXAttributeName_Statics::PropPointers) < 2048);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::NewProp_InAttribute = { "InAttribute", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXAttributeNameConversions_eventConv_DMXAttributeToName_Parms, InAttribute), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::NewProp_InAttribute_MetaData), Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::NewProp_InAttribute_MetaData) }; // 3990846017
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXAttributeNameConversions_eventConv_DMXAttributeToName_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXAttributeNameConversions, nullptr, "Conv_DMXAttributeToName", nullptr, nullptr, Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::DMXAttributeNameConversions_eventConv_DMXAttributeToName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName_Statics::DMXAttributeNameConversions_eventConv_DMXAttributeToName_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::NewProp_InAttribute = { "InAttribute", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXAttributeNameConversions_eventConv_DMXAttributeToString_Parms, InAttribute), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::NewProp_InAttribute_MetaData), Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::NewProp_InAttribute_MetaData) }; // 3990846017
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXAttributeNameConversions_eventConv_DMXAttributeToString_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXAttributeNameConversions, nullptr, "Conv_DMXAttributeToString", nullptr, nullptr, Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::DMXAttributeNameConversions_eventConv_DMXAttributeToString_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString_Statics::DMXAttributeNameConversions_eventConv_DMXAttributeToString_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXAttributeNameConversions_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDMXAttributeNameConversions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToName, "Conv_DMXAttributeToName" }, // 1879322930
		{ &Z_Construct_UFunction_UDMXAttributeNameConversions_Conv_DMXAttributeToString, "Conv_DMXAttributeToString" }, // 1185064531
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXAttributeNameConversions_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXAttributeNameConversions_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXAttributeNameConversions_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXAttributeNameConversions_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_DMXAttribute_h_Statics::ScriptStructInfo[] = {
		{ FDMXAttribute::StaticStruct, Z_Construct_UScriptStruct_FDMXAttribute_Statics::NewStructOps, TEXT("DMXAttribute"), &Z_Registration_Info_UScriptStruct_DMXAttribute, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXAttribute), 1581374289U) },
		{ FDMXAttributeName::StaticStruct, Z_Construct_UScriptStruct_FDMXAttributeName_Statics::NewStructOps, TEXT("DMXAttributeName"), &Z_Registration_Info_UScriptStruct_DMXAttributeName, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXAttributeName), 3990846017U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_DMXAttribute_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXAttributeNameConversions, UDMXAttributeNameConversions::StaticClass, TEXT("UDMXAttributeNameConversions"), &Z_Registration_Info_UClass_UDMXAttributeNameConversions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXAttributeNameConversions), 1056855669U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXProtocol_Source_DMXProtocol_Public_DMXAttribute_h_138208427(TEXT("/Script/DMXProtocol"),
