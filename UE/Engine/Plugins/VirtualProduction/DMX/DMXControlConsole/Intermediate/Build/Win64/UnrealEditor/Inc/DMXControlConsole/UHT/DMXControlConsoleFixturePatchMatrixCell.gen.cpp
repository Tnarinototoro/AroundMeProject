...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellID = { "CellID", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFixturePatchMatrixCell, CellID), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellID_MetaData), Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellX = { "CellX", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFixturePatchMatrixCell, CellX), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellX_MetaData), Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellX_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellY = { "CellY", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFixturePatchMatrixCell, CellY), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellY_MetaData), Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellY_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellAttributeFaders_Inner = { "CellAttributeFaders", nullptr, (EPropertyFlags)0x0004000000020000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UDMXControlConsoleFaderBase_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellAttributeFaders = { "CellAttributeFaders", nullptr, (EPropertyFlags)0x0044000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFixturePatchMatrixCell, CellAttributeFaders), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellAttributeFaders_MetaData), Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::NewProp_CellAttributeFaders_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UDMXControlConsoleFaderGroupElement_NoRegister, (int32)VTABLE_OFFSET(UDMXControlConsoleFixturePatchMatrixCell, IDMXControlConsoleFaderGroupElement), false },  // 2118587309
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsole_Private_DMXControlConsoleFixturePatchMatrixCell_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXControlConsoleFixturePatchMatrixCell, UDMXControlConsoleFixturePatchMatrixCell::StaticClass, TEXT("UDMXControlConsoleFixturePatchMatrixCell"), &Z_Registration_Info_UClass_UDMXControlConsoleFixturePatchMatrixCell, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXControlConsoleFixturePatchMatrixCell), 2424701039U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsole_Private_DMXControlConsoleFixturePatchMatrixCell_h_3380853232(TEXT("/Script/DMXControlConsole"),
