...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_DMXControlConsole_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_DMXControlConsole_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_DMXControlConsole_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_DMXControlConsole_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsoleEditor_Private_AssetDefinitions_AssetDefinition_DMXControlConsole_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_DMXControlConsole, UAssetDefinition_DMXControlConsole::StaticClass, TEXT("UAssetDefinition_DMXControlConsole"), &Z_Registration_Info_UClass_UAssetDefinition_DMXControlConsole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_DMXControlConsole), 3198753590U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsoleEditor_Private_AssetDefinitions_AssetDefinition_DMXControlConsole_h_195255208(TEXT("/Script/DMXControlConsoleEditor"),
