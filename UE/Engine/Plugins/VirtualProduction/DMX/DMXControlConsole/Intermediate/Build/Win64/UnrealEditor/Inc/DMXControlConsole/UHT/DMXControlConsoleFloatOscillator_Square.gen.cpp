...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_FrequencyHz = { "FrequencyHz", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFloatOscillator_Square, FrequencyHz), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_FrequencyHz_MetaData), Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_FrequencyHz_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_Amplitude = { "Amplitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFloatOscillator_Square, Amplitude), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_Amplitude_MetaData), Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_Amplitude_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_Offset = { "Offset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFloatOscillator_Square, Offset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_Offset_MetaData), Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::NewProp_Offset_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsole_Private_Oscillators_DMXControlConsoleFloatOscillator_Square_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXControlConsoleFloatOscillator_Square, UDMXControlConsoleFloatOscillator_Square::StaticClass, TEXT("UDMXControlConsoleFloatOscillator_Square"), &Z_Registration_Info_UClass_UDMXControlConsoleFloatOscillator_Square, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXControlConsoleFloatOscillator_Square), 3916102732U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsole_Private_Oscillators_DMXControlConsoleFloatOscillator_Square_h_2559920856(TEXT("/Script/DMXControlConsole"),
