...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::NewProp_Attribute = { "Attribute", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXControlConsoleFixturePatchFunctionFader, Attribute), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::NewProp_Attribute_MetaData), Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::NewProp_Attribute_MetaData) }; // 3990846017
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsole_Private_DMXControlConsoleFixturePatchFunctionFader_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXControlConsoleFixturePatchFunctionFader, UDMXControlConsoleFixturePatchFunctionFader::StaticClass, TEXT("UDMXControlConsoleFixturePatchFunctionFader"), &Z_Registration_Info_UClass_UDMXControlConsoleFixturePatchFunctionFader, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXControlConsoleFixturePatchFunctionFader), 298530218U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXControlConsole_Source_DMXControlConsole_Private_DMXControlConsoleFixturePatchFunctionFader_h_234940708(TEXT("/Script/DMXControlConsole"),
