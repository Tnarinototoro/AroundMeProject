...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ColorSpaceRange_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ColorSpaceRange;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_XAttribute = { "XAttribute", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingColorSpace_xyY, XAttribute), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_XAttribute_MetaData), Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_XAttribute_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_YAttribute = { "YAttribute", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingColorSpace_xyY, YAttribute), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_YAttribute_MetaData), Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_YAttribute_MetaData) }; // 3990846017
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_ColorSpaceRange_MetaData[] = {
		{ "Category", "XY" },
		{ "ClampMax", "2.000000" },
		{ "ClampMin", "0.100000" },
		{ "Comment", "/** Sets the range of the xyY color space. A value of 1.0 corresponds to the CIE 1931 xyY . */" },
		{ "DisplayName", "Color Space Range" },
		{ "ModuleRelativePath", "Private/ColorSpace/DMXPixelMappingColorSpace_xyY.h" },
		{ "ToolTip", "Sets the range of the xyY color space. A value of 1.0 corresponds to the CIE 1931 xyY ." },
		{ "UIMax", "1.000000" },
		{ "UIMin", "0.100000" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_ColorSpaceRange = { "ColorSpaceRange", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingColorSpace_xyY, ColorSpaceRange), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_ColorSpaceRange_MetaData), Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_ColorSpaceRange_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_LuminanceAttribute = { "LuminanceAttribute", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingColorSpace_xyY, LuminanceAttribute), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_LuminanceAttribute_MetaData), Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_LuminanceAttribute_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_MaxLuminance = { "MaxLuminance", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingColorSpace_xyY, MaxLuminance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_MaxLuminance_MetaData), Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_MaxLuminance_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::NewProp_ColorSpaceRange,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Private_ColorSpace_DMXPixelMappingColorSpace_xyY_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXPixelMappingColorSpace_xyY, UDMXPixelMappingColorSpace_xyY::StaticClass, TEXT("UDMXPixelMappingColorSpace_xyY"), &Z_Registration_Info_UClass_UDMXPixelMappingColorSpace_xyY, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXPixelMappingColorSpace_xyY), 3325366701U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Private_ColorSpace_DMXPixelMappingColorSpace_xyY_h_3824020261(TEXT("/Script/DMXPixelMappingRuntime"),
