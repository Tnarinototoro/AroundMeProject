...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DMXPixelMappingCore_EDMXPixelMappingRendererType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DMXPixelMappingCore_EDMXPixelMappingRendererType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DMXPixelMappingCore_EDMXPixelMappingRendererType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DMXPixelMappingCore_EDMXCellFormat_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DMXPixelMappingCore_EDMXCellFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DMXPixelMappingCore_EDMXCellFormat_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_DMXPixelMappingCore_EDMXColorMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_DMXPixelMappingCore_EDMXColorMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_DMXPixelMappingCore_EDMXColorMode_Statics::Enum_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingCore_Public_DMXPixelMappingTypes_h_Statics::EnumInfo[] = {
		{ EDMXPixelMappingRendererType_StaticEnum, TEXT("EDMXPixelMappingRendererType"), &Z_Registration_Info_UEnum_EDMXPixelMappingRendererType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4122915406U) },
		{ EDMXCellFormat_StaticEnum, TEXT("EDMXCellFormat"), &Z_Registration_Info_UEnum_EDMXCellFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 783699550U) },
		{ EDMXColorMode_StaticEnum, TEXT("EDMXColorMode"), &Z_Registration_Info_UEnum_EDMXColorMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2814557072U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingCore_Public_DMXPixelMappingTypes_h_3949582682(TEXT("/Script/DMXPixelMappingCore"),
		nullptr, 0,
		nullptr, 0,
