...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::NewProp_bUseWorkingColorSpaceForInput = { "bUseWorkingColorSpaceForInput", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDMXPixelMappingColorSpace), &Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::NewProp_bUseWorkingColorSpaceForInput_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::NewProp_bUseWorkingColorSpaceForInput_MetaData), Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::NewProp_bUseWorkingColorSpaceForInput_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingColorSpace_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_ColorSpace_DMXPixelMappingColorSpace_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXPixelMappingColorSpace, UDMXPixelMappingColorSpace::StaticClass, TEXT("UDMXPixelMappingColorSpace"), &Z_Registration_Info_UClass_UDMXPixelMappingColorSpace, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXPixelMappingColorSpace), 400033199U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_ColorSpace_DMXPixelMappingColorSpace_h_3194944154(TEXT("/Script/DMXPixelMappingRuntime"),
