...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::NewProp_CachedRendererComponentsByName = { "CachedRendererComponentsByName", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingRootComponent, CachedRendererComponentsByName), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::NewProp_CachedRendererComponentsByName_MetaData), Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::NewProp_CachedRendererComponentsByName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingRootComponent_Statics::PropPointers) < 2048);
	...
	UDMXPixelMappingRootComponent::UDMXPixelMappingRootComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_Components_DMXPixelMappingRootComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXPixelMappingRootComponent, UDMXPixelMappingRootComponent::StaticClass, TEXT("UDMXPixelMappingRootComponent"), &Z_Registration_Info_UClass_UDMXPixelMappingRootComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXPixelMappingRootComponent), 2739338453U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_Components_DMXPixelMappingRootComponent_h_2069473272(TEXT("/Script/DMXPixelMappingRuntime"),
