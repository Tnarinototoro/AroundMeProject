...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::NewProp_CellID = { "CellID", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingMatrixCellComponent, CellID), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::NewProp_CellID_MetaData), Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::NewProp_CellID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::NewProp_CellCoordinate = { "CellCoordinate", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingMatrixCellComponent, CellCoordinate), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::NewProp_CellCoordinate_MetaData), Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::NewProp_CellCoordinate_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_Components_DMXPixelMappingMatrixCellComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXPixelMappingMatrixCellComponent, UDMXPixelMappingMatrixCellComponent::StaticClass, TEXT("UDMXPixelMappingMatrixCellComponent"), &Z_Registration_Info_UClass_UDMXPixelMappingMatrixCellComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXPixelMappingMatrixCellComponent), 759646064U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_Components_DMXPixelMappingMatrixCellComponent_h_1909435927(TEXT("/Script/DMXPixelMappingRuntime"),
