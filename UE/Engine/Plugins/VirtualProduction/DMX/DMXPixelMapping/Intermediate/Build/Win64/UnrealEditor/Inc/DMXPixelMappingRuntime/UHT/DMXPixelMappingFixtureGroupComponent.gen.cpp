...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::NewProp_DMXLibrary = { "DMXLibrary", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingFixtureGroupComponent, DMXLibrary), Z_Construct_UClass_UDMXLibrary_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::NewProp_DMXLibrary_MetaData), Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::NewProp_DMXLibrary_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::NewProp_LayoutScript = { "LayoutScript", nullptr, (EPropertyFlags)0x0016000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMappingFixtureGroupComponent, LayoutScript), Z_Construct_UClass_UDMXPixelMappingLayoutScript_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::NewProp_LayoutScript_MetaData), Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::NewProp_LayoutScript_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_Components_DMXPixelMappingFixtureGroupComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXPixelMappingFixtureGroupComponent, UDMXPixelMappingFixtureGroupComponent::StaticClass, TEXT("UDMXPixelMappingFixtureGroupComponent"), &Z_Registration_Info_UClass_UDMXPixelMappingFixtureGroupComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXPixelMappingFixtureGroupComponent), 2719044253U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_Components_DMXPixelMappingFixtureGroupComponent_h_1469487572(TEXT("/Script/DMXPixelMappingRuntime"),
