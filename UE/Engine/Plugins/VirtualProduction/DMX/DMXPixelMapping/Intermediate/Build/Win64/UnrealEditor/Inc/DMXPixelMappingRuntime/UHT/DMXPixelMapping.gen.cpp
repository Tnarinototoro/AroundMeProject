...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXPixelMapping_eventGetRootComponent_Parms, ReturnValue), Z_Construct_UClass_UDMXPixelMappingRootComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXPixelMapping, nullptr, "GetRootComponent", nullptr, nullptr, Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::DMXPixelMapping_eventGetRootComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent_Statics::DMXPixelMapping_eventGetRootComponent_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMapping_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDMXPixelMapping_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDMXPixelMapping_GetRootComponent, "GetRootComponent" }, // 53384685
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMapping_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXPixelMapping_Statics::NewProp_RootComponent = { "RootComponent", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMapping, RootComponent), Z_Construct_UClass_UDMXPixelMappingRootComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMapping_Statics::NewProp_RootComponent_MetaData), Z_Construct_UClass_UDMXPixelMapping_Statics::NewProp_RootComponent_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXPixelMapping_Statics::NewProp_ThumbnailImage = { "ThumbnailImage", nullptr, (EPropertyFlags)0x0014000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXPixelMapping, ThumbnailImage), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMapping_Statics::NewProp_ThumbnailImage_MetaData), Z_Construct_UClass_UDMXPixelMapping_Statics::NewProp_ThumbnailImage_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXPixelMapping_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMapping_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXPixelMapping_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXPixelMapping_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_DMXPixelMapping_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXPixelMapping, UDMXPixelMapping::StaticClass, TEXT("UDMXPixelMapping"), &Z_Registration_Info_UClass_UDMXPixelMapping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXPixelMapping), 3846781785U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Public_DMXPixelMapping_h_1666746546(TEXT("/Script/DMXPixelMappingRuntime"),
