...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::NewProp_DelayFrames = { "DelayFrames", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_PixelMappingFrameDelay, DelayFrames), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::NewProp_DelayFrames_MetaData), Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::NewProp_DelayFrames_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Private_Modulators_DMXModulator_PixelMappingFrameDelay_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXModulator_PixelMappingFrameDelay, UDMXModulator_PixelMappingFrameDelay::StaticClass, TEXT("UDMXModulator_PixelMappingFrameDelay"), &Z_Registration_Info_UClass_UDMXModulator_PixelMappingFrameDelay, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXModulator_PixelMappingFrameDelay), 3188734638U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingRuntime_Private_Modulators_DMXModulator_PixelMappingFrameDelay_h_3403805824(TEXT("/Script/DMXPixelMappingRuntime"),
