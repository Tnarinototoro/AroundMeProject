...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_PixelMappingRendererComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_PixelMappingRendererComponent_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_PixelMappingRendererComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UK2Node_PixelMappingRendererComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingBlueprintGraph_Public_K2Node_PixelMappingRendererComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UK2Node_PixelMappingRendererComponent, UK2Node_PixelMappingRendererComponent::StaticClass, TEXT("UK2Node_PixelMappingRendererComponent"), &Z_Registration_Info_UClass_UK2Node_PixelMappingRendererComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UK2Node_PixelMappingRendererComponent), 430787353U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXPixelMapping_Source_DMXPixelMappingBlueprintGraph_Public_K2Node_PixelMappingRendererComponent_h_1559153330(TEXT("/Script/DMXPixelMappingBlueprintGraph"),
