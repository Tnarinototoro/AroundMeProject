...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::NewProp_DeviceProtocol = { "DeviceProtocol", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityUniverseManaged, DeviceProtocol), Z_Construct_UScriptStruct_FDMXProtocolName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::NewProp_DeviceProtocol_MetaData), Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::NewProp_DeviceProtocol_MetaData) }; // 3832264870
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityUniverseManaged_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_CommunicationMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_CommunicationMode = { "CommunicationMode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, CommunicationMode), Z_Construct_UEnum_DMXProtocol_EDMXCommunicationType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_CommunicationMode_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_CommunicationMode_MetaData) }; // 370606809
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalStart = { "UniverseLocalStart", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, UniverseLocalStart), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalStart_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalStart_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalNum = { "UniverseLocalNum", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, UniverseLocalNum), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalNum_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalNum_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalEnd = { "UniverseLocalEnd", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, UniverseLocalEnd), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalEnd_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseLocalEnd_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_RemoteOffset = { "RemoteOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, RemoteOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_RemoteOffset_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_RemoteOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseRemoteStart = { "UniverseRemoteStart", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, UniverseRemoteStart), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseRemoteStart_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseRemoteStart_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseRemoteEnd = { "UniverseRemoteEnd", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, UniverseRemoteEnd), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseRemoteEnd_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_UniverseRemoteEnd_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_AdditionalUnicastIPs_Inner = { "AdditionalUnicastIPs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDMXEntityController_Statics::NewProp_AdditionalUnicastIPs = { "AdditionalUnicastIPs", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntityController, AdditionalUnicastIPs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::NewProp_AdditionalUnicastIPs_MetaData), Z_Construct_UClass_UDMXEntityController_Statics::NewProp_AdditionalUnicastIPs_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXEntityController_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXEntityController_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntityController_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXEntityController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXEntityUniverseManaged, UDMXEntityUniverseManaged::StaticClass, TEXT("UDMXEntityUniverseManaged"), &Z_Registration_Info_UClass_UDMXEntityUniverseManaged, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXEntityUniverseManaged), 1692450353U) },
		{ Z_Construct_UClass_UDMXEntityController, UDMXEntityController::StaticClass, TEXT("UDMXEntityController"), &Z_Registration_Info_UClass_UDMXEntityController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXEntityController), 1426442782U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXEntityController_h_1994269325(TEXT("/Script/DMXRuntime"),
