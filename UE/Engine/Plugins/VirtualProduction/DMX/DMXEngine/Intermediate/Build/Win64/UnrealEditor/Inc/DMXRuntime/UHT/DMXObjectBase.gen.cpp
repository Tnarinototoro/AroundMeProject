...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXObjectBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXObjectBase_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXObjectBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXObjectBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXObjectBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXObjectBase, UDMXObjectBase::StaticClass, TEXT("UDMXObjectBase"), &Z_Registration_Info_UClass_UDMXObjectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXObjectBase), 4162180837U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXObjectBase_h_3519742861(TEXT("/Script/DMXRuntime"),
