...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::NewProp_FilePathAndName = { "FilePathAndName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXGDTFAssetImportData, FilePathAndName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::NewProp_FilePathAndName_MetaData), Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::NewProp_FilePathAndName_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::NewProp_RawSourceData = { "RawSourceData", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXGDTFAssetImportData, RawSourceData), Z_Construct_UScriptStruct_FDMXByteArray64, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::NewProp_RawSourceData_MetaData), Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::NewProp_RawSourceData_MetaData) }; // 366171736
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXGDTFAssetImportData_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXGDTFAssetImportData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXGDTFAssetImportData, UDMXGDTFAssetImportData::StaticClass, TEXT("UDMXGDTFAssetImportData"), &Z_Registration_Info_UClass_UDMXGDTFAssetImportData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXGDTFAssetImportData), 2743911808U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXGDTFAssetImportData_h_3038903004(TEXT("/Script/DMXRuntime"),
