...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ExposeAttributes_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType, nullptr, "ExposeAttributes", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ExposeAttributes_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ExposeAttributes_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ResetAttributes_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType, nullptr, "ResetAttributes", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ResetAttributes_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ResetAttributes_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ExposeAttributes, "ExposeAttributes" }, // 456772541
		{ &Z_Construct_UFunction_UDEPRECATED_K2Node_CastPatchToType_ResetAttributes, "ResetAttributes" }, // 3391432839
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::NewProp_bIsExposed = { "bIsExposed", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDEPRECATED_K2Node_CastPatchToType), &Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::NewProp_bIsExposed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::NewProp_bIsExposed_MetaData), Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::NewProp_bIsExposed_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::ClassParams = {
		...
		0,
		0x021002A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXBlueprintGraph_Public_K2Node_CastPatchToType_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_K2Node_CastPatchToType, UDEPRECATED_K2Node_CastPatchToType::StaticClass, TEXT("UDEPRECATED_K2Node_CastPatchToType"), &Z_Registration_Info_UClass_UDEPRECATED_K2Node_CastPatchToType, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_K2Node_CastPatchToType), 3215922712U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXBlueprintGraph_Public_K2Node_CastPatchToType_h_2545267743(TEXT("/Script/DMXBlueprintGraph"),
