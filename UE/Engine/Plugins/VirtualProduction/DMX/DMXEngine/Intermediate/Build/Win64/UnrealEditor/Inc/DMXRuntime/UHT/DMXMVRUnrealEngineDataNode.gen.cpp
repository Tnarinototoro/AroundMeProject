...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRUnrealEngineDataNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRUnrealEngineDataNode_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRUnrealEngineDataNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRUnrealEngineDataNode_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRUnrealEngineDataNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRUnrealEngineDataNode, UDMXMVRUnrealEngineDataNode::StaticClass, TEXT("UDMXMVRUnrealEngineDataNode"), &Z_Registration_Info_UClass_UDMXMVRUnrealEngineDataNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRUnrealEngineDataNode), 2358817028U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRUnrealEngineDataNode_h_1746317111(TEXT("/Script/DMXRuntime"),
