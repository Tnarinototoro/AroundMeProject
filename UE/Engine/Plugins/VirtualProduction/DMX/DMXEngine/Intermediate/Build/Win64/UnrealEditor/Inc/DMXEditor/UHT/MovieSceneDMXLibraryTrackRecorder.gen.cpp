...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::NewProp_FixturePatchRefs_Inner = { "FixturePatchRefs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDMXEntityFixturePatchRef, METADATA_PARAMS(0, nullptr) }; // 1092920056
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::NewProp_FixturePatchRefs = { "FixturePatchRefs", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneDMXLibraryTrackRecorder, FixturePatchRefs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::NewProp_FixturePatchRefs_MetaData), Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::NewProp_FixturePatchRefs_MetaData) }; // 1092920056
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Private_Sequencer_MovieSceneDMXLibraryTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder, UMovieSceneDMXLibraryTrackRecorder::StaticClass, TEXT("UMovieSceneDMXLibraryTrackRecorder"), &Z_Registration_Info_UClass_UMovieSceneDMXLibraryTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDMXLibraryTrackRecorder), 2367448304U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Private_Sequencer_MovieSceneDMXLibraryTrackRecorder_h_1666238131(TEXT("/Script/DMXEditor"),
