...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_GetDMXFixturePatch_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_GetDMXFixturePatch_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_GetDMXFixturePatch_Statics::Class_MetaDataParams), Z_Construct_UClass_UK2Node_GetDMXFixturePatch_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXBlueprintGraph_Public_K2Node_GetDMXFixturePatch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UK2Node_GetDMXFixturePatch, UK2Node_GetDMXFixturePatch::StaticClass, TEXT("UK2Node_GetDMXFixturePatch"), &Z_Registration_Info_UClass_UK2Node_GetDMXFixturePatch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UK2Node_GetDMXFixturePatch), 2099236221U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXBlueprintGraph_Public_K2Node_GetDMXFixturePatch_h_1653075007(TEXT("/Script/DMXBlueprintGraph"),
