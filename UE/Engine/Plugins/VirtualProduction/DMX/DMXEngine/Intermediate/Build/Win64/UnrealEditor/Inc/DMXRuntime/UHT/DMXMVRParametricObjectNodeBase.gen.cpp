...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::NewProp_UUID = { "UUID", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRParametricObjectNodeBase, UUID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::NewProp_UUID_MetaData), Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::NewProp_UUID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::NewProp_Matrix = { "Matrix", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRParametricObjectNodeBase, Matrix), Z_Construct_UScriptStruct_FDMXOptionalTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::NewProp_Matrix_MetaData), Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::NewProp_Matrix_MetaData) }; // 704069896
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRParametricObjectNodeBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRParametricObjectNodeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRParametricObjectNodeBase, UDMXMVRParametricObjectNodeBase::StaticClass, TEXT("UDMXMVRParametricObjectNodeBase"), &Z_Registration_Info_UClass_UDMXMVRParametricObjectNodeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRParametricObjectNodeBase), 566641118U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRParametricObjectNodeBase_h_3816957126(TEXT("/Script/DMXRuntime"),
