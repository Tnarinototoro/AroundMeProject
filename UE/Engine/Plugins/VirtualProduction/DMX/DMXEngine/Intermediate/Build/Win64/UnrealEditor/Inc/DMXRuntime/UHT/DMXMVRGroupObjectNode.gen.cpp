...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRGroupObjectNode, Name), Z_Construct_UScriptStruct_FDMXOptionalString, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::NewProp_Name_MetaData), Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::NewProp_Name_MetaData) }; // 1423101178
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::NewProp_ChildListNode = { "ChildListNode", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRGroupObjectNode, ChildListNode), Z_Construct_UClass_UDMXMVRChildListNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::NewProp_ChildListNode_MetaData), Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::NewProp_ChildListNode_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGroupObjectNode_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRGroupObjectNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRGroupObjectNode, UDMXMVRGroupObjectNode::StaticClass, TEXT("UDMXMVRGroupObjectNode"), &Z_Registration_Info_UClass_UDMXMVRGroupObjectNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRGroupObjectNode), 3687727653U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRGroupObjectNode_h_743522826(TEXT("/Script/DMXRuntime"),
