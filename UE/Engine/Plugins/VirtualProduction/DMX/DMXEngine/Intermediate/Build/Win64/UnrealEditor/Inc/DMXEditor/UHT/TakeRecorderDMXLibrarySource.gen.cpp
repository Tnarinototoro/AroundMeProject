...
template<> DMXEDITOR_API UScriptStruct* StaticStruct<FAddAllPatchesButton>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAddAllPatchesButton_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAddAllPatchesButton_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAddAllPatchesButton_Statics::Struct_MetaDataParams)
	};
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTakeRecorderDMXLibrarySource_AddAllPatches_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTakeRecorderDMXLibrarySource, nullptr, "AddAllPatches", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorderDMXLibrarySource_AddAllPatches_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTakeRecorderDMXLibrarySource_AddAllPatches_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTakeRecorderDMXLibrarySource_AddAllPatches, "AddAllPatches" }, // 25224537
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_DMXLibrary = { "DMXLibrary", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderDMXLibrarySource, DMXLibrary), Z_Construct_UClass_UDMXLibrary_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_DMXLibrary_MetaData), Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_DMXLibrary_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_AddAllPatchesDummy = { "AddAllPatchesDummy", nullptr, (EPropertyFlags)0x0010000000002001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderDMXLibrarySource, AddAllPatchesDummy), Z_Construct_UScriptStruct_FAddAllPatchesButton, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_AddAllPatchesDummy_MetaData), Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_AddAllPatchesDummy_MetaData) }; // 19570076
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_FixturePatchRefs_Inner = { "FixturePatchRefs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDMXEntityFixturePatchRef, METADATA_PARAMS(0, nullptr) }; // 1092920056
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_FixturePatchRefs = { "FixturePatchRefs", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderDMXLibrarySource, FixturePatchRefs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_FixturePatchRefs_MetaData), Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_FixturePatchRefs_MetaData) }; // 1092920056
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_bRecordNormalizedValues = { "bRecordNormalizedValues", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTakeRecorderDMXLibrarySource), &Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_bRecordNormalizedValues_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_bRecordNormalizedValues_MetaData), Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_bRecordNormalizedValues_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_TrackRecorder = { "TrackRecorder", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderDMXLibrarySource, TrackRecorder), Z_Construct_UClass_UMovieSceneDMXLibraryTrackRecorder_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_TrackRecorder_MetaData), Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::NewProp_TrackRecorder_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderDMXLibrarySource_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Private_Sequencer_TakeRecorderDMXLibrarySource_h_Statics::ScriptStructInfo[] = {
		{ FAddAllPatchesButton::StaticStruct, Z_Construct_UScriptStruct_FAddAllPatchesButton_Statics::NewStructOps, TEXT("AddAllPatchesButton"), &Z_Registration_Info_UScriptStruct_AddAllPatchesButton, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAddAllPatchesButton), 19570076U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Private_Sequencer_TakeRecorderDMXLibrarySource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderDMXLibrarySource, UTakeRecorderDMXLibrarySource::StaticClass, TEXT("UTakeRecorderDMXLibrarySource"), &Z_Registration_Info_UClass_UTakeRecorderDMXLibrarySource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderDMXLibrarySource), 2256697237U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Private_Sequencer_TakeRecorderDMXLibrarySource_h_4101021026(TEXT("/Script/DMXEditor"),
