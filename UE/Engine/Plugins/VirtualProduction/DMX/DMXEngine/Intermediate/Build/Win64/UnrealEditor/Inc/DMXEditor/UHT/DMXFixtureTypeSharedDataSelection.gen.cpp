...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFixtureTypes_Inner = { "SelectedFixtureTypes", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UDMXEntityFixtureType_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFixtureTypes = { "SelectedFixtureTypes", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureTypeSharedDataSelection, SelectedFixtureTypes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFixtureTypes_MetaData), Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFixtureTypes_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedModeIndices_Inner = { "SelectedModeIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedModeIndices = { "SelectedModeIndices", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureTypeSharedDataSelection, SelectedModeIndices), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedModeIndices_MetaData), Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedModeIndices_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFunctionIndices_Inner = { "SelectedFunctionIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFunctionIndices = { "SelectedFunctionIndices", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureTypeSharedDataSelection, SelectedFunctionIndices), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFunctionIndices_MetaData), Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_SelectedFunctionIndices_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_bFixtureMatrixSelected = { "bFixtureMatrixSelected", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDMXFixtureTypeSharedDataSelection), &Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_bFixtureMatrixSelected_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_bFixtureMatrixSelected_MetaData), Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::NewProp_bFixtureMatrixSelected_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Public_DMXFixtureTypeSharedDataSelection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXFixtureTypeSharedDataSelection, UDMXFixtureTypeSharedDataSelection::StaticClass, TEXT("UDMXFixtureTypeSharedDataSelection"), &Z_Registration_Info_UClass_UDMXFixtureTypeSharedDataSelection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXFixtureTypeSharedDataSelection), 338795239U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Public_DMXFixtureTypeSharedDataSelection_h_2993612461(TEXT("/Script/DMXEditor"),
