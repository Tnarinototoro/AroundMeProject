...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeRedToCyan = { "AttributeRedToCyan", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_RGBtoCMY, AttributeRedToCyan), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeRedToCyan_MetaData), Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeRedToCyan_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeGreenToMagenta = { "AttributeGreenToMagenta", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_RGBtoCMY, AttributeGreenToMagenta), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeGreenToMagenta_MetaData), Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeGreenToMagenta_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeBlueToYellow = { "AttributeBlueToYellow", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_RGBtoCMY, AttributeBlueToYellow), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeBlueToYellow_MetaData), Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::NewProp_AttributeBlueToYellow_MetaData) }; // 3990846017
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_RGBtoCMY_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Private_Modulators_DMXModulator_RGBtoCMY_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXModulator_RGBtoCMY, UDMXModulator_RGBtoCMY::StaticClass, TEXT("UDMXModulator_RGBtoCMY"), &Z_Registration_Info_UClass_UDMXModulator_RGBtoCMY, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXModulator_RGBtoCMY), 1302631026U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Private_Modulators_DMXModulator_RGBtoCMY_h_2152665185(TEXT("/Script/DMXRuntime"),
