...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::NewProp_RootNode = { "RootNode", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRGeneralSceneDescription, RootNode), Z_Construct_UClass_UDMXMVRRootNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::NewProp_RootNode_MetaData), Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::NewProp_RootNode_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::NewProp_MVRAssetImportData = { "MVRAssetImportData", nullptr, (EPropertyFlags)0x0044000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRGeneralSceneDescription, MVRAssetImportData), Z_Construct_UClass_UDMXMVRAssetImportData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::NewProp_MVRAssetImportData_MetaData), Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::NewProp_MVRAssetImportData_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRGeneralSceneDescription_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_DMXMVRGeneralSceneDescription_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRGeneralSceneDescription, UDMXMVRGeneralSceneDescription::StaticClass, TEXT("UDMXMVRGeneralSceneDescription"), &Z_Registration_Info_UClass_UDMXMVRGeneralSceneDescription, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRGeneralSceneDescription), 3724538491U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_DMXMVRGeneralSceneDescription_h_1947220946(TEXT("/Script/DMXRuntime"),
