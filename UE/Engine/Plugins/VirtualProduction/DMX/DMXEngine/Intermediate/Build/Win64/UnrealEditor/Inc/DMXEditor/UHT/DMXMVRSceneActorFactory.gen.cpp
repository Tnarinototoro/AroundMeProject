...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRSceneActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRSceneActorFactory_Statics::ClassParams = {
		...
		0,
		0x000030ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRSceneActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRSceneActorFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Private_Factories_DMXMVRSceneActorFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRSceneActorFactory, UDMXMVRSceneActorFactory::StaticClass, TEXT("UDMXMVRSceneActorFactory"), &Z_Registration_Info_UClass_UDMXMVRSceneActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRSceneActorFactory), 332885368U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Private_Factories_DMXMVRSceneActorFactory_h_994233331(TEXT("/Script/DMXEditor"),
