...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRSceneNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXMVRSceneNode_Statics::NewProp_LayersNode = { "LayersNode", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRSceneNode, LayersNode), Z_Construct_UClass_UDMXMVRLayersNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRSceneNode_Statics::NewProp_LayersNode_MetaData), Z_Construct_UClass_UDMXMVRSceneNode_Statics::NewProp_LayersNode_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRSceneNode_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRSceneNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRSceneNode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRSceneNode_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRSceneNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRSceneNode, UDMXMVRSceneNode::StaticClass, TEXT("UDMXMVRSceneNode"), &Z_Registration_Info_UClass_UDMXMVRSceneNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRSceneNode), 387515972U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRSceneNode_h_1181376739(TEXT("/Script/DMXRuntime"),
