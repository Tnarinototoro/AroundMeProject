...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeCyanToRed = { "AttributeCyanToRed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_CMYtoRGB, AttributeCyanToRed), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeCyanToRed_MetaData), Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeCyanToRed_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeMagentaToGreen = { "AttributeMagentaToGreen", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_CMYtoRGB, AttributeMagentaToGreen), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeMagentaToGreen_MetaData), Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeMagentaToGreen_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeYellowToBlue = { "AttributeYellowToBlue", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_CMYtoRGB, AttributeYellowToBlue), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeYellowToBlue_MetaData), Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::NewProp_AttributeYellowToBlue_MetaData) }; // 3990846017
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_CMYtoRGB_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Private_Modulators_DMXModulator_CMYtoRGB_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXModulator_CMYtoRGB, UDMXModulator_CMYtoRGB::StaticClass, TEXT("UDMXModulator_CMYtoRGB"), &Z_Registration_Info_UClass_UDMXModulator_CMYtoRGB, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXModulator_CMYtoRGB), 3502321828U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Private_Modulators_DMXModulator_CMYtoRGB_h_3529277274(TEXT("/Script/DMXRuntime"),
