...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRUserDataNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXMVRUserDataNode_Statics::NewProp_UnrealEngineDataNode = { "UnrealEngineDataNode", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRUserDataNode, UnrealEngineDataNode), Z_Construct_UClass_UDMXMVRUnrealEngineDataNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRUserDataNode_Statics::NewProp_UnrealEngineDataNode_MetaData), Z_Construct_UClass_UDMXMVRUserDataNode_Statics::NewProp_UnrealEngineDataNode_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRUserDataNode_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRUserDataNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRUserDataNode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRUserDataNode_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRUserDataNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRUserDataNode, UDMXMVRUserDataNode::StaticClass, TEXT("UDMXMVRUserDataNode"), &Z_Registration_Info_UClass_UDMXMVRUserDataNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRUserDataNode), 3925981777U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRUserDataNode_h_2859821056(TEXT("/Script/DMXRuntime"),
