...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::NewProp_SelectedFixturePatches = { "SelectedFixturePatches", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixturePatchSharedDataSelection, SelectedFixturePatches), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::NewProp_SelectedFixturePatches_MetaData), Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::NewProp_SelectedFixturePatches_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::NewProp_SelectedUniverse = { "SelectedUniverse", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixturePatchSharedDataSelection, SelectedUniverse), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::NewProp_SelectedUniverse_MetaData), Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::NewProp_SelectedUniverse_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixturePatchSharedDataSelection_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Public_DMXFixturePatchSharedDataSelection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXFixturePatchSharedDataSelection, UDMXFixturePatchSharedDataSelection::StaticClass, TEXT("UDMXFixturePatchSharedDataSelection"), &Z_Registration_Info_UClass_UDMXFixturePatchSharedDataSelection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXFixturePatchSharedDataSelection), 3599557936U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXEditor_Public_DMXFixturePatchSharedDataSelection_h_2032460866(TEXT("/Script/DMXEditor"),
