...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRLayersNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDMXMVRLayersNode_Statics::NewProp_LayerNodes_Inner = { "LayerNodes", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UDMXMVRLayerNode_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDMXMVRLayersNode_Statics::NewProp_LayerNodes = { "LayerNodes", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXMVRLayersNode, LayerNodes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRLayersNode_Statics::NewProp_LayerNodes_MetaData), Z_Construct_UClass_UDMXMVRLayersNode_Statics::NewProp_LayerNodes_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRLayersNode_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRLayersNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRLayersNode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRLayersNode_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRLayersNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRLayersNode, UDMXMVRLayersNode::StaticClass, TEXT("UDMXMVRLayersNode"), &Z_Registration_Info_UClass_UDMXMVRLayersNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRLayersNode), 3781422671U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_MVR_Types_DMXMVRLayersNode_h_1411231050(TEXT("/Script/DMXRuntime"),
