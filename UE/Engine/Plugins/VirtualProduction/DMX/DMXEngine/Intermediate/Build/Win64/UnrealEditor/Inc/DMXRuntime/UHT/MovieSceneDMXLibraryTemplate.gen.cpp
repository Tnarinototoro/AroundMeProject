...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FMovieSceneDMXLibraryTemplate>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::NewProp_Section = { "Section", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMovieSceneDMXLibraryTemplate, Section), Z_Construct_UClass_UMovieSceneDMXLibrarySection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::NewProp_Section_MetaData), Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::NewProp_Section_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Sequencer_MovieSceneDMXLibraryTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneDMXLibraryTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneDMXLibraryTemplate_Statics::NewStructOps, TEXT("MovieSceneDMXLibraryTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneDMXLibraryTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneDMXLibraryTemplate), 362070606U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Sequencer_MovieSceneDMXLibraryTemplate_h_3219903175(TEXT("/Script/DMXRuntime"),
		nullptr, 0,
