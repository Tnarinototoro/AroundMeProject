...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntity_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDMXEntity_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntity, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntity_Statics::NewProp_Name_MetaData), Z_Construct_UClass_UDMXEntity_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDMXEntity_Statics::NewProp_ParentLibrary_MetaData[] = {
		{ "ModuleRelativePath", "Public/Library/DMXEntity.h" },
	};
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UDMXEntity_Statics::NewProp_ParentLibrary = { "ParentLibrary", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntity, ParentLibrary), Z_Construct_UClass_UDMXLibrary_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntity_Statics::NewProp_ParentLibrary_MetaData), Z_Construct_UClass_UDMXEntity_Statics::NewProp_ParentLibrary_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXEntity_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0020080000200000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXEntity, Id), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntity_Statics::NewProp_Id_MetaData), Z_Construct_UClass_UDMXEntity_Statics::NewProp_Id_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXEntity_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntity_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXEntity_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXEntity_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXEntity_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXEntity, UDMXEntity::StaticClass, TEXT("UDMXEntity"), &Z_Registration_Info_UClass_UDMXEntity, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXEntity), 2305779975U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_Library_DMXEntity_h_4260080730(TEXT("/Script/DMXRuntime"),
