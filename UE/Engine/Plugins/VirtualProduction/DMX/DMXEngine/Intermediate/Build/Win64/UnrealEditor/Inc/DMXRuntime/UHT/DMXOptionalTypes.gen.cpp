...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalBool>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalBool_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalBool_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalBool_Statics::Struct_MetaDataParams)
	};
...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalInt32>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalInt32_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalInt32_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalInt32_Statics::Struct_MetaDataParams)
	};
...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalFloat>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalFloat_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalFloat_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalFloat_Statics::Struct_MetaDataParams)
	};
...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalGuid>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalGuid_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalGuid_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalGuid_Statics::Struct_MetaDataParams)
	};
...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalVector2D>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalVector2D_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalVector2D_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalVector2D_Statics::Struct_MetaDataParams)
	};
...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalTransform>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalTransform_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalTransform_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalTransform_Statics::Struct_MetaDataParams)
	};
...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalColorCIE1931>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalColorCIE1931_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalColorCIE1931_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalColorCIE1931_Statics::Struct_MetaDataParams)
	};
...
template<> DMXRUNTIME_API UScriptStruct* StaticStruct<FDMXOptionalString>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXOptionalString_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXOptionalString_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXOptionalString_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_DMXOptionalTypes_h_Statics::ScriptStructInfo[] = {
		{ FDMXOptionalBool::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalBool_Statics::NewStructOps, TEXT("DMXOptionalBool"), &Z_Registration_Info_UScriptStruct_DMXOptionalBool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalBool), 2041183945U) },
		{ FDMXOptionalInt32::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalInt32_Statics::NewStructOps, TEXT("DMXOptionalInt32"), &Z_Registration_Info_UScriptStruct_DMXOptionalInt32, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalInt32), 749524256U) },
		{ FDMXOptionalFloat::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalFloat_Statics::NewStructOps, TEXT("DMXOptionalFloat"), &Z_Registration_Info_UScriptStruct_DMXOptionalFloat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalFloat), 1391805457U) },
		{ FDMXOptionalGuid::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalGuid_Statics::NewStructOps, TEXT("DMXOptionalGuid"), &Z_Registration_Info_UScriptStruct_DMXOptionalGuid, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalGuid), 3882451234U) },
		{ FDMXOptionalVector2D::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalVector2D_Statics::NewStructOps, TEXT("DMXOptionalVector2D"), &Z_Registration_Info_UScriptStruct_DMXOptionalVector2D, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalVector2D), 1140934167U) },
		{ FDMXOptionalTransform::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalTransform_Statics::NewStructOps, TEXT("DMXOptionalTransform"), &Z_Registration_Info_UScriptStruct_DMXOptionalTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalTransform), 704069896U) },
		{ FDMXOptionalColorCIE1931::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalColorCIE1931_Statics::NewStructOps, TEXT("DMXOptionalColorCIE1931"), &Z_Registration_Info_UScriptStruct_DMXOptionalColorCIE1931, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalColorCIE1931), 3949280250U) },
		{ FDMXOptionalString::StaticStruct, Z_Construct_UScriptStruct_FDMXOptionalString_Statics::NewStructOps, TEXT("DMXOptionalString"), &Z_Registration_Info_UScriptStruct_DMXOptionalString, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXOptionalString), 1423101178U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Public_DMXOptionalTypes_h_1472341351(TEXT("/Script/DMXRuntime"),
		nullptr, 0,
