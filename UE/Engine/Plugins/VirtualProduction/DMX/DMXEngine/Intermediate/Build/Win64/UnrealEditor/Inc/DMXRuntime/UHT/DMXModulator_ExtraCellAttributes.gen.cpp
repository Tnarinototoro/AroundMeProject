...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::NewProp_ExtraAttributeNameToNormalizedValueMap = { "ExtraAttributeNameToNormalizedValueMap", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXModulator_ExtraCellAttributes, ExtraAttributeNameToNormalizedValueMap), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::NewProp_ExtraAttributeNameToNormalizedValueMap_MetaData), Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::NewProp_ExtraAttributeNameToNormalizedValueMap_MetaData) }; // 3990846017
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXModulator_ExtraCellAttributes_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Private_Modulators_DMXModulator_ExtraCellAttributes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXModulator_ExtraCellAttributes, UDMXModulator_ExtraCellAttributes::StaticClass, TEXT("UDMXModulator_ExtraCellAttributes"), &Z_Registration_Info_UClass_UDMXModulator_ExtraCellAttributes, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXModulator_ExtraCellAttributes), 733248826U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXEngine_Source_DMXRuntime_Private_Modulators_DMXModulator_ExtraCellAttributes_h_1669340807(TEXT("/Script/DMXRuntime"),
