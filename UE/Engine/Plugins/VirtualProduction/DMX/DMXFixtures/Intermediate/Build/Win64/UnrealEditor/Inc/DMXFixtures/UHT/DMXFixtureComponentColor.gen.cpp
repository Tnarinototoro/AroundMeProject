...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::NewProp_NewColor = { "NewColor", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureComponentColor_eventSetColorNoInterp_Parms, NewColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::NewProp_NewColor_MetaData), Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::NewProp_NewColor_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXFixtureComponentColor, nullptr, "SetColorNoInterp", nullptr, nullptr, Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::PropPointers), sizeof(DMXFixtureComponentColor_eventSetColorNoInterp_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0CC20800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp_Statics::PropPointers) < 2048);
	static_assert(sizeof(DMXFixtureComponentColor_eventSetColorNoInterp_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDMXFixtureComponentColor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDMXFixtureComponentColor_SetColorNoInterp, "SetColorNoInterp" }, // 1846250480
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel1 = { "DMXChannel1", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureComponentColor, DMXChannel1), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel1_MetaData), Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel1_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel2 = { "DMXChannel2", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureComponentColor, DMXChannel2), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel2_MetaData), Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel2_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel3 = { "DMXChannel3", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureComponentColor, DMXChannel3), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel3_MetaData), Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel3_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel4 = { "DMXChannel4", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureComponentColor, DMXChannel4), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel4_MetaData), Z_Construct_UClass_UDMXFixtureComponentColor_Statics::NewProp_DMXChannel4_MetaData) }; // 3990846017
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXFixtureComponentColor_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXFixtureComponentColor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponentColor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXFixtures_Source_DMXFixtures_Public_DMXFixtureComponentColor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXFixtureComponentColor, UDMXFixtureComponentColor::StaticClass, TEXT("UDMXFixtureComponentColor"), &Z_Registration_Info_UClass_UDMXFixtureComponentColor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXFixtureComponentColor), 1769795766U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXFixtures_Source_DMXFixtures_Public_DMXFixtureComponentColor_h_1552198106(TEXT("/Script/DMXFixtures"),
