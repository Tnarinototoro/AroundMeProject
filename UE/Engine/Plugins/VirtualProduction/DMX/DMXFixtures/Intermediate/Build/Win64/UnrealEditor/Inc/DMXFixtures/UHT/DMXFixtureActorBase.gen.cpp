...
// End Cross Module References
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::NewProp_DeltaSeconds = { "DeltaSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureActorBase_eventInterpolateDMXComponents_Parms, DeltaSeconds), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ADMXFixtureActorBase, nullptr, "InterpolateDMXComponents", nullptr, nullptr, Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::PropPointers), sizeof(Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::DMXFixtureActorBase_eventInterpolateDMXComponents_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::Function_MetaDataParams), Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents_Statics::DMXFixtureActorBase_eventInterpolateDMXComponents_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::NewProp_ValuePerAttributeMap = { "ValuePerAttributeMap", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureActorBase_eventPushNormalizedValuesPerAttribute_Parms, ValuePerAttributeMap), Z_Construct_UScriptStruct_FDMXNormalizedAttributeValueMap, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::NewProp_ValuePerAttributeMap_MetaData), Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::NewProp_ValuePerAttributeMap_MetaData) }; // 1126147844
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ADMXFixtureActorBase, nullptr, "PushNormalizedValuesPerAttribute", nullptr, nullptr, Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::PropPointers), sizeof(Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::DMXFixtureActorBase_eventPushNormalizedValuesPerAttribute_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::Function_MetaDataParams), Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute_Statics::DMXFixtureActorBase_eventPushNormalizedValuesPerAttribute_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ADMXFixtureActorBase_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_ADMXFixtureActorBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ADMXFixtureActorBase_InterpolateDMXComponents, "InterpolateDMXComponents" }, // 560089671
		{ &Z_Construct_UFunction_ADMXFixtureActorBase_PushNormalizedValuesPerAttribute, "PushNormalizedValuesPerAttribute" }, // 3768947291
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ADMXFixtureActorBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ADMXFixtureActorBase_Statics::NewProp_DMX = { "DMX", nullptr, (EPropertyFlags)0x00140000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ADMXFixtureActorBase, DMX), Z_Construct_UClass_UDMXComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ADMXFixtureActorBase_Statics::NewProp_DMX_MetaData), Z_Construct_UClass_ADMXFixtureActorBase_Statics::NewProp_DMX_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ADMXFixtureActorBase_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ADMXFixtureActorBase_Statics::Class_MetaDataParams), Z_Construct_UClass_ADMXFixtureActorBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ADMXFixtureActorBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXFixtures_Source_DMXFixtures_Public_DMXFixtureActorBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ADMXFixtureActorBase, ADMXFixtureActorBase::StaticClass, TEXT("ADMXFixtureActorBase"), &Z_Registration_Info_UClass_ADMXFixtureActorBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADMXFixtureActorBase), 734295863U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXFixtures_Source_DMXFixtures_Public_DMXFixtureActorBase_h_2324508602(TEXT("/Script/DMXFixtures"),
