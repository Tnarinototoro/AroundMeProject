...
template<> DMXFIXTURES_API UScriptStruct* StaticStruct<FDMXChannelData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXChannelData, Name), Z_Construct_UScriptStruct_FDMXAttributeName, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_Name_MetaData) }; // 3990846017
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_MinValue = { "MinValue", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXChannelData, MinValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_MinValue_MetaData), Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_MinValue_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_MaxValue = { "MaxValue", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXChannelData, MaxValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_MaxValue_MetaData), Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_MaxValue_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_DefaultValue = { "DefaultValue", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDMXChannelData, DefaultValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_DefaultValue_MetaData), Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewProp_DefaultValue_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDMXChannelData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXChannelData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDMXChannelData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDMXChannelData_Statics::PropPointers) < 2048);
	...
	DEFINE_FUNCTION(UDMXFixtureComponent::execGetTextureCenterColors)
	{
		...
		P_GET_UBOOL(Z_Param_bUpdateTextureResource);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FLinearColor>*)Z_Param__Result=P_THIS->GetTextureCenterColors(Z_Param_TextureAtlas,Z_Param_numTextures,Z_Param_bUpdateTextureResource);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureComponent_eventGetParentFixtureActor_Parms, ReturnValue), Z_Construct_UClass_ADMXFixtureActor_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXFixtureComponent, nullptr, "GetParentFixtureActor", nullptr, nullptr, Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::DMXFixtureComponent_eventGetParentFixtureActor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor_Statics::DMXFixtureComponent_eventGetParentFixtureActor_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::NewProp_OutAttributeNames_Inner = { "OutAttributeNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::NewProp_OutAttributeNames = { "OutAttributeNames", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureComponent_eventGetSupportedDMXAttributes_Parms, OutAttributeNames), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXFixtureComponent, nullptr, "GetSupportedDMXAttributes", nullptr, nullptr, Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::PropPointers), sizeof(DMXFixtureComponent_eventGetSupportedDMXAttributes_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C420C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes_Statics::PropPointers) < 2048);
	static_assert(sizeof(DMXFixtureComponent_eventGetSupportedDMXAttributes_Parms) < MAX_uint16);
	...
	struct Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics
	{
		struct DMXFixtureComponent_eventGetTextureCenterColors_Parms
		{
			...
			int32 numTextures;
			bool bUpdateTextureResource;
			TArray<FLinearColor> ReturnValue;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_TextureAtlas;
		static const UECodeGen_Private::FIntPropertyParams NewProp_numTextures;
		static void NewProp_bUpdateTextureResource_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bUpdateTextureResource;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_TextureAtlas = { "TextureAtlas", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureComponent_eventGetTextureCenterColors_Parms, TextureAtlas), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_numTextures = { "numTextures", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureComponent_eventGetTextureCenterColors_Parms, numTextures), METADATA_PARAMS(0, nullptr) };
	void Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_bUpdateTextureResource_SetBit(void* Obj)
	{
		((DMXFixtureComponent_eventGetTextureCenterColors_Parms*)Obj)->bUpdateTextureResource = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_bUpdateTextureResource = { "bUpdateTextureResource", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(DMXFixtureComponent_eventGetTextureCenterColors_Parms), &Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_bUpdateTextureResource_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureComponent_eventGetTextureCenterColors_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::NewProp_bUpdateTextureResource,
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::Function_MetaDataParams[] = {
		{ "Category", "DMX" },
		{ "Comment", "/** \n\x09 * Reads pixel color in the middle of each \"Texture\" and output linear colors. \n\x09 * Note, this function locks the GPU to read the color and is slow to call, even if Update TextureResource is not enabled.\n\x09 */" },
		{ "CPP_Default_bUpdateTextureResource", "true" },
		{ "ModuleRelativePath", "Public/DMXFixtureComponent.h" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXFixtureComponent, nullptr, "GetTextureCenterColors", nullptr, nullptr, Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::DMXFixtureComponent_eventGetTextureCenterColors_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors_Statics::DMXFixtureComponent_eventGetTextureCenterColors_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXFixtureComponent_Initialize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXFixtureComponent, nullptr, "Initialize", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_Initialize_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXFixtureComponent_Initialize_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent_Statics::NewProp_DeltaSeconds = { "DeltaSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXFixtureComponent_eventInterpolateComponent_Parms, DeltaSeconds), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXFixtureComponent, nullptr, "InterpolateComponent", nullptr, nullptr, Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent_Statics::PropPointers), sizeof(DMXFixtureComponent_eventInterpolateComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(DMXFixtureComponent_eventInterpolateComponent_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDMXFixtureComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDMXFixtureComponent_GetParentFixtureActor, "GetParentFixtureActor" }, // 3381559215
		{ &Z_Construct_UFunction_UDMXFixtureComponent_GetSupportedDMXAttributes, "GetSupportedDMXAttributes" }, // 625746603
		{ &Z_Construct_UFunction_UDMXFixtureComponent_GetTextureCenterColors, "GetTextureCenterColors" }, // 667672814
		{ &Z_Construct_UFunction_UDMXFixtureComponent_Initialize, "Initialize" }, // 3056680460
		{ &Z_Construct_UFunction_UDMXFixtureComponent_InitializeComponent, "InitializeComponent" }, // 1251995558
		{ &Z_Construct_UFunction_UDMXFixtureComponent_InterpolateComponent, "InterpolateComponent" }, // 189808667
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bIsEnabled = { "bIsEnabled", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDMXFixtureComponent), &Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bIsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bIsEnabled_MetaData), Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bIsEnabled_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_SkipThreshold = { "SkipThreshold", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureComponent, SkipThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_SkipThreshold_MetaData), Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_SkipThreshold_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUseInterpolation = { "bUseInterpolation", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDMXFixtureComponent), &Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUseInterpolation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUseInterpolation_MetaData), Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUseInterpolation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_InterpolationScale = { "InterpolationScale", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDMXFixtureComponent, InterpolationScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_InterpolationScale_MetaData), Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_InterpolationScale_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUsingMatrixData = { "bUsingMatrixData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDMXFixtureComponent), &Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUsingMatrixData_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUsingMatrixData_MetaData), Z_Construct_UClass_UDMXFixtureComponent_Statics::NewProp_bUsingMatrixData_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXFixtureComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXFixtureComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXFixtureComponent_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXFixtures_Source_DMXFixtures_Public_DMXFixtureComponent_h_Statics::ScriptStructInfo[] = {
		{ FDMXChannelData::StaticStruct, Z_Construct_UScriptStruct_FDMXChannelData_Statics::NewStructOps, TEXT("DMXChannelData"), &Z_Registration_Info_UScriptStruct_DMXChannelData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDMXChannelData), 1498321541U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXFixtures_Source_DMXFixtures_Public_DMXFixtureComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXFixtureComponent, UDMXFixtureComponent::StaticClass, TEXT("UDMXFixtureComponent"), &Z_Registration_Info_UClass_UDMXFixtureComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXFixtureComponent), 2118626885U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXFixtures_Source_DMXFixtures_Public_DMXFixtureComponent_h_3273191629(TEXT("/Script/DMXFixtures"),
