...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::NewProp_bImportMVR = { "bImportMVR", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UDatasmithMVRImportOptions), &Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::NewProp_bImportMVR_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::NewProp_bImportMVR_MetaData), Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::NewProp_bImportMVR_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithMVRImportOptions_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DatasmithMVR_Source_DatasmithMVRTranslator_Private_DatasmithMVRImportOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithMVRImportOptions, UDatasmithMVRImportOptions::StaticClass, TEXT("UDatasmithMVRImportOptions"), &Z_Registration_Info_UClass_UDatasmithMVRImportOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithMVRImportOptions), 2991392610U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DatasmithMVR_Source_DatasmithMVRTranslator_Private_DatasmithMVRImportOptions_h_879161212(TEXT("/Script/DatasmithMVRTranslator"),
