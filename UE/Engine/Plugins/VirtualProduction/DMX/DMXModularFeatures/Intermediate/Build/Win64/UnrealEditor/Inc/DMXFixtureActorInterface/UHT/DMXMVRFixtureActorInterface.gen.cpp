...
// End Cross Module References
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::NewProp_OutAttributeNames = { "OutAttributeNames", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXMVRFixtureActorInterface_eventOnMVRGetSupportedDMXAttributes_Parms, OutAttributeNames), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::NewProp_OutMatrixAttributeNames_Inner = { "OutMatrixAttributeNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::NewProp_OutMatrixAttributeNames = { "OutMatrixAttributeNames", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DMXMVRFixtureActorInterface_eventOnMVRGetSupportedDMXAttributes_Parms, OutMatrixAttributeNames), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDMXMVRFixtureActorInterface, nullptr, "OnMVRGetSupportedDMXAttributes", nullptr, nullptr, Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::PropPointers), sizeof(DMXMVRFixtureActorInterface_eventOnMVRGetSupportedDMXAttributes_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C420C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes_Statics::PropPointers) < 2048);
	static_assert(sizeof(DMXMVRFixtureActorInterface_eventOnMVRGetSupportedDMXAttributes_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRFixtureActorInterface_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDMXMVRFixtureActorInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDMXMVRFixtureActorInterface_OnMVRGetSupportedDMXAttributes, "OnMVRGetSupportedDMXAttributes" }, // 3946463815
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRFixtureActorInterface_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDMXMVRFixtureActorInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDMXMVRFixtureActorInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UDMXMVRFixtureActorInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXModularFeatures_Source_DMXFixtureActorInterface_Public_DMXMVRFixtureActorInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDMXMVRFixtureActorInterface, UDMXMVRFixtureActorInterface::StaticClass, TEXT("UDMXMVRFixtureActorInterface"), &Z_Registration_Info_UClass_UDMXMVRFixtureActorInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDMXMVRFixtureActorInterface), 1536416806U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_DMX_DMXModularFeatures_Source_DMXFixtureActorInterface_Public_DMXMVRFixtureActorInterface_h_2771534567(TEXT("/Script/DMXFixtureActorInterface"),
