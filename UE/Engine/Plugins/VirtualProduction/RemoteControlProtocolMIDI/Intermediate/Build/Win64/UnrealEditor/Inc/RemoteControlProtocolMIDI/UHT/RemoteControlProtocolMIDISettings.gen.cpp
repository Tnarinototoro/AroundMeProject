...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::NewProp_DefaultDevice = { "DefaultDevice", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlProtocolMIDISettings, DefaultDevice), Z_Construct_UScriptStruct_FRemoteControlMIDIDevice, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::NewProp_DefaultDevice_MetaData), Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::NewProp_DefaultDevice_MetaData) }; // 1484306242
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolMIDISettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControlProtocolMIDI_Source_RemoteControlProtocolMIDI_Public_RemoteControlProtocolMIDISettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlProtocolMIDISettings, URemoteControlProtocolMIDISettings::StaticClass, TEXT("URemoteControlProtocolMIDISettings"), &Z_Registration_Info_UClass_URemoteControlProtocolMIDISettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlProtocolMIDISettings), 2885741672U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControlProtocolMIDI_Source_RemoteControlProtocolMIDI_Public_RemoteControlProtocolMIDISettings_h_2557389919(TEXT("/Script/RemoteControlProtocolMIDI"),
