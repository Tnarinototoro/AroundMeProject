...
template<> STAGEDATAPROVIDER_API UScriptStruct* StaticStruct<FGenlockHitchEvent>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::NewProp_MissedSyncSignals = { "MissedSyncSignals", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGenlockHitchEvent, MissedSyncSignals), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::NewProp_MissedSyncSignals_MetaData), Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::NewProp_MissedSyncSignals_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::PropPointers) < 2048);
...
template<> STAGEDATAPROVIDER_API UScriptStruct* StaticStruct<FGenlockStateEvent>()
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::NewProp_NewState_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::NewProp_NewState = { "NewState", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGenlockStateEvent, NewState), Z_Construct_UEnum_Engine_ECustomTimeStepSynchronizationState, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::NewProp_NewState_MetaData), Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::NewProp_NewState_MetaData) }; // 3193770067
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_StageMonitoring_Source_StageDataProvider_Private_GenlockWatchdog_h_Statics::ScriptStructInfo[] = {
		{ FGenlockHitchEvent::StaticStruct, Z_Construct_UScriptStruct_FGenlockHitchEvent_Statics::NewStructOps, TEXT("GenlockHitchEvent"), &Z_Registration_Info_UScriptStruct_GenlockHitchEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGenlockHitchEvent), 3204139623U) },
		{ FGenlockStateEvent::StaticStruct, Z_Construct_UScriptStruct_FGenlockStateEvent_Statics::NewStructOps, TEXT("GenlockStateEvent"), &Z_Registration_Info_UScriptStruct_GenlockStateEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGenlockStateEvent), 895332098U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_StageMonitoring_Source_StageDataProvider_Private_GenlockWatchdog_h_4063694272(TEXT("/Script/StageDataProvider"),
		nullptr, 0,
