...
template<> STAGEDATAPROVIDER_API UScriptStruct* StaticStruct<FTimecodeProviderStateEvent>()
{
	...
	struct Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics
	{
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_NewState_Underlying;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_ProviderName = { "ProviderName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimecodeProviderStateEvent, ProviderName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_ProviderName_MetaData), Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_ProviderName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_ProviderType = { "ProviderType", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimecodeProviderStateEvent, ProviderType), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_ProviderType_MetaData), Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_ProviderType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimecodeProviderStateEvent, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_FrameRate_MetaData), Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_FrameRate_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_NewState_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_NewState = { "NewState", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTimecodeProviderStateEvent, NewState), Z_Construct_UEnum_Engine_ETimecodeProviderSynchronizationState, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_NewState_MetaData), Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewProp_NewState_MetaData) }; // 3639839173
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_StageMonitoring_Source_StageDataProvider_Private_TimecodeProviderWatchdog_h_Statics::ScriptStructInfo[] = {
		{ FTimecodeProviderStateEvent::StaticStruct, Z_Construct_UScriptStruct_FTimecodeProviderStateEvent_Statics::NewStructOps, TEXT("TimecodeProviderStateEvent"), &Z_Registration_Info_UScriptStruct_TimecodeProviderStateEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimecodeProviderStateEvent), 487900522U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_StageMonitoring_Source_StageDataProvider_Private_TimecodeProviderWatchdog_h_1873917509(TEXT("/Script/StageDataProvider"),
		nullptr, 0,
