...
template<> LEVELSNAPSHOTS_API UScriptStruct* StaticStruct<FComponentSnapshotData>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::NewProp_CreationMethod_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::NewProp_CreationMethod = { "CreationMethod", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FComponentSnapshotData, CreationMethod), Z_Construct_UEnum_Engine_EComponentCreationMethod, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::NewProp_CreationMethod_MetaData), Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::NewProp_CreationMethod_MetaData) }; // 4044608159
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ComponentSnapshotData_h_Statics::ScriptStructInfo[] = {
		{ FComponentSnapshotData::StaticStruct, Z_Construct_UScriptStruct_FComponentSnapshotData_Statics::NewStructOps, TEXT("ComponentSnapshotData"), &Z_Registration_Info_UScriptStruct_ComponentSnapshotData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComponentSnapshotData), 2563448806U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ComponentSnapshotData_h_1571990631(TEXT("/Script/LevelSnapshots"),
		nullptr, 0,
