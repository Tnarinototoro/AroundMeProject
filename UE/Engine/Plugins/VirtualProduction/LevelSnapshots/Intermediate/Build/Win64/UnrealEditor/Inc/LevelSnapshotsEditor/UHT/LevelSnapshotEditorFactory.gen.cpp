...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotEditorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULevelSnapshotEditorFactory_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotEditorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_ULevelSnapshotEditorFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshotsEditor_Private_Factories_LevelSnapshotEditorFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelSnapshotEditorFactory, ULevelSnapshotEditorFactory::StaticClass, TEXT("ULevelSnapshotEditorFactory"), &Z_Registration_Info_UClass_ULevelSnapshotEditorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelSnapshotEditorFactory), 788680552U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshotsEditor_Private_Factories_LevelSnapshotEditorFactory_h_1476018820(TEXT("/Script/LevelSnapshotsEditor"),
