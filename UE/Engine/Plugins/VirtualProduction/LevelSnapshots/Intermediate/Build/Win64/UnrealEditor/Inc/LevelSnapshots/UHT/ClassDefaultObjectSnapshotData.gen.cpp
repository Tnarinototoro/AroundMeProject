...
template<> LEVELSNAPSHOTS_API UScriptStruct* StaticStruct<FClassDefaultObjectSnapshotData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::NewProp_bSerializationSkippedCDO = { "bSerializationSkippedCDO", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FClassDefaultObjectSnapshotData), &Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::NewProp_bSerializationSkippedCDO_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::NewProp_bSerializationSkippedCDO_MetaData), Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::NewProp_bSerializationSkippedCDO_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ClassDefaultObjectSnapshotData_h_Statics::ScriptStructInfo[] = {
		{ FClassDefaultObjectSnapshotData::StaticStruct, Z_Construct_UScriptStruct_FClassDefaultObjectSnapshotData_Statics::NewStructOps, TEXT("ClassDefaultObjectSnapshotData"), &Z_Registration_Info_UScriptStruct_ClassDefaultObjectSnapshotData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClassDefaultObjectSnapshotData), 2879046353U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ClassDefaultObjectSnapshotData_h_3358936054(TEXT("/Script/LevelSnapshots"),
		nullptr, 0,
