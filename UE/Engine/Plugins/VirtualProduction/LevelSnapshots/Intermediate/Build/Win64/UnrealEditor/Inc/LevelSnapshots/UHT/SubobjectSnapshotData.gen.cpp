...
template<> LEVELSNAPSHOTS_API UScriptStruct* StaticStruct<FSubobjectSnapshotData>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_OuterIndex = { "OuterIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSubobjectSnapshotData, OuterIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_OuterIndex_MetaData), Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_OuterIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_Class = { "Class", nullptr, (EPropertyFlags)0x0010000020000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSubobjectSnapshotData, Class_DEPRECATED), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_Class_MetaData), Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_Class_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_ClassIndex = { "ClassIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSubobjectSnapshotData, ClassIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_ClassIndex_MetaData), Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_ClassIndex_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_bWasSkippedClass = { "bWasSkippedClass", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FSubobjectSnapshotData), &Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_bWasSkippedClass_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_bWasSkippedClass_MetaData), Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewProp_bWasSkippedClass_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_SubobjectSnapshotData_h_Statics::ScriptStructInfo[] = {
		{ FSubobjectSnapshotData::StaticStruct, Z_Construct_UScriptStruct_FSubobjectSnapshotData_Statics::NewStructOps, TEXT("SubobjectSnapshotData"), &Z_Registration_Info_UScriptStruct_SubobjectSnapshotData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSubobjectSnapshotData), 3306859477U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_SubobjectSnapshotData_h_697034225(TEXT("/Script/LevelSnapshots"),
		nullptr, 0,
