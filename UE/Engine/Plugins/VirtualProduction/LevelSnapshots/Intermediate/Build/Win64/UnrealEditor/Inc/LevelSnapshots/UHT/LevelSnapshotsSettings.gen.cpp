...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_SkippedClasses = { "SkippedClasses", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULevelSnapshotsSettings, SkippedClasses), Z_Construct_UScriptStruct_FSkippedClassList, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_SkippedClasses_MetaData), Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_SkippedClasses_MetaData) }; // 3353138869
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_FloatComparisonPrecision = { "FloatComparisonPrecision", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULevelSnapshotsSettings, FloatComparisonPrecision), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_FloatComparisonPrecision_MetaData), Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_FloatComparisonPrecision_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_DoubleComparisonPrecision = { "DoubleComparisonPrecision", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULevelSnapshotsSettings, DoubleComparisonPrecision), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_DoubleComparisonPrecision_MetaData), Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_DoubleComparisonPrecision_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_HashSettings = { "HashSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULevelSnapshotsSettings, HashSettings), Z_Construct_UScriptStruct_FHashSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_HashSettings_MetaData), Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_HashSettings_MetaData) }; // 4290407489
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_CompressionSettings = { "CompressionSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULevelSnapshotsSettings, CompressionSettings), Z_Construct_UScriptStruct_FSnapshotCompressionSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_CompressionSettings_MetaData), Z_Construct_UClass_ULevelSnapshotsSettings_Statics::NewProp_CompressionSettings_MetaData) }; // 1596994117
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULevelSnapshotsSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULevelSnapshotsSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSnapshotsSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Settings_LevelSnapshotsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelSnapshotsSettings, ULevelSnapshotsSettings::StaticClass, TEXT("ULevelSnapshotsSettings"), &Z_Registration_Info_UClass_ULevelSnapshotsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelSnapshotsSettings), 2101994373U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Settings_LevelSnapshotsSettings_h_2763700666(TEXT("/Script/LevelSnapshots"),
