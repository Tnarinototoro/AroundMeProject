...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LevelSnapshotFilters_ETransformReturnType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LevelSnapshotFilters_ETransformReturnType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LevelSnapshotFilters_ETransformReturnType_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActorChangedTransformFilter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_TransformCheckRule = { "TransformCheckRule", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UActorChangedTransformFilter, TransformCheckRule), Z_Construct_UEnum_LevelSnapshotFilters_ETransformReturnType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_TransformCheckRule_MetaData), Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_TransformCheckRule_MetaData) }; // 1368334597
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreLocation = { "bIgnoreLocation", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UActorChangedTransformFilter), &Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreLocation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreLocation_MetaData), Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreLocation_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreRotation = { "bIgnoreRotation", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UActorChangedTransformFilter), &Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreRotation_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreRotation_MetaData), Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreRotation_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreScale = { "bIgnoreScale", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UActorChangedTransformFilter), &Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreScale_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreScale_MetaData), Z_Construct_UClass_UActorChangedTransformFilter_Statics::NewProp_bIgnoreScale_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UActorChangedTransformFilter_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorChangedTransformFilter_Statics::Class_MetaDataParams), Z_Construct_UClass_UActorChangedTransformFilter_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActorChangedTransformFilter_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelShapshotFilters_Public_Builtin_ActorChangedTransformFilter_h_Statics::EnumInfo[] = {
		{ ETransformReturnType_StaticEnum, TEXT("ETransformReturnType"), &Z_Registration_Info_UEnum_ETransformReturnType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1368334597U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelShapshotFilters_Public_Builtin_ActorChangedTransformFilter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorChangedTransformFilter, UActorChangedTransformFilter::StaticClass, TEXT("UActorChangedTransformFilter"), &Z_Registration_Info_UClass_UActorChangedTransformFilter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorChangedTransformFilter), 4209213532U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelShapshotFilters_Public_Builtin_ActorChangedTransformFilter_h_1567581210(TEXT("/Script/LevelSnapshotFilters"),
