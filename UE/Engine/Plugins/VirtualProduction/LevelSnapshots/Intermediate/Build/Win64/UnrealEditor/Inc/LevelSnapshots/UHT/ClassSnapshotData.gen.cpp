...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LevelSnapshots_ESnapshotClassFlags_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LevelSnapshots_ESnapshotClassFlags_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LevelSnapshots_ESnapshotClassFlags_Statics::Enum_MetaDataParams)
	};
...
template<> LEVELSNAPSHOTS_API UScriptStruct* StaticStruct<FClassSnapshotData>()
{
...
#endif
		static const UECodeGen_Private::FUInt64PropertyParams NewProp_ClassFlags;
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_ClassPath_MetaData[] = {
		{ "Comment", "/** The class getting saved. */" },
		{ "ModuleRelativePath", "Public/Data/ClassSnapshotData.h" },
		{ "ToolTip", "The class getting saved." },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_ClassPath = { "ClassPath", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FClassSnapshotData, ClassPath), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_ClassPath_MetaData), Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_ClassPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt64PropertyParams Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_ClassFlags = { "ClassFlags", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FClassSnapshotData, ClassFlags), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_ClassFlags_MetaData), Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_ClassFlags_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_SnapshotFlags = { "SnapshotFlags", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FClassSnapshotData, SnapshotFlags), Z_Construct_UEnum_LevelSnapshots_ESnapshotClassFlags, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_SnapshotFlags_MetaData), Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewProp_SnapshotFlags_MetaData) }; // 849061054
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FClassSnapshotData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassSnapshotData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FClassSnapshotData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClassSnapshotData_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ClassSnapshotData_h_Statics::EnumInfo[] = {
		{ ESnapshotClassFlags_StaticEnum, TEXT("ESnapshotClassFlags"), &Z_Registration_Info_UEnum_ESnapshotClassFlags, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 849061054U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ClassSnapshotData_h_Statics::ScriptStructInfo[] = {
		{ FClassSnapshotData::StaticStruct, Z_Construct_UScriptStruct_FClassSnapshotData_Statics::NewStructOps, TEXT("ClassSnapshotData"), &Z_Registration_Info_UScriptStruct_ClassSnapshotData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClassSnapshotData), 2173461716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ClassSnapshotData_h_720688931(TEXT("/Script/LevelSnapshots"),
		nullptr, 0,
