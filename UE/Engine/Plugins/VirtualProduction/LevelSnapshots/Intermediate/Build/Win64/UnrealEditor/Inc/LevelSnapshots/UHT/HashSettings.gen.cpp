...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LevelSnapshots_EHashAlgorithmChooseBehavior_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LevelSnapshots_EHashAlgorithmChooseBehavior_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LevelSnapshots_EHashAlgorithmChooseBehavior_Statics::Enum_MetaDataParams)
	};
...
template<> LEVELSNAPSHOTS_API UScriptStruct* StaticStruct<FHashSettings>()
{
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_HashCutoffSeconds = { "HashCutoffSeconds", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHashSettings, HashCutoffSeconds), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_HashCutoffSeconds_MetaData), Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_HashCutoffSeconds_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bUseHashForLoading = { "bUseHashForLoading", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FHashSettings), &Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bUseHashForLoading_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bUseHashForLoading_MetaData), Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bUseHashForLoading_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseCRC = { "bCanUseCRC", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FHashSettings), &Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseCRC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseCRC_MetaData), Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseCRC_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseMD5 = { "bCanUseMD5", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FHashSettings), &Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseMD5_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseMD5_MetaData), Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_bCanUseMD5_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_SnapshotDiffAlgorithm = { "SnapshotDiffAlgorithm", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHashSettings, SnapshotDiffAlgorithm), Z_Construct_UEnum_LevelSnapshots_EHashAlgorithmChooseBehavior, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_SnapshotDiffAlgorithm_MetaData), Z_Construct_UScriptStruct_FHashSettings_Statics::NewProp_SnapshotDiffAlgorithm_MetaData) }; // 1039752405
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHashSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHashSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FHashSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHashSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Settings_HashSettings_h_Statics::EnumInfo[] = {
		{ EHashAlgorithmChooseBehavior_StaticEnum, TEXT("EHashAlgorithmChooseBehavior"), &Z_Registration_Info_UEnum_EHashAlgorithmChooseBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1039752405U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Settings_HashSettings_h_Statics::ScriptStructInfo[] = {
		{ FHashSettings::StaticStruct, Z_Construct_UScriptStruct_FHashSettings_Statics::NewStructOps, TEXT("HashSettings"), &Z_Registration_Info_UScriptStruct_HashSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHashSettings), 4290407489U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Settings_HashSettings_h_2866823883(TEXT("/Script/LevelSnapshots"),
		nullptr, 0,
