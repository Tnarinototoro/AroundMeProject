...
template<> LEVELSNAPSHOTS_API UScriptStruct* StaticStruct<FObjectSnapshotData>()
{
...
#endif
		static const UECodeGen_Private::FUInt64PropertyParams NewProp_ObjectFlags;
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewProp_SerializedData_Inner = { "SerializedData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewProp_SerializedData = { "SerializedData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FObjectSnapshotData, SerializedData), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewProp_SerializedData_MetaData), Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewProp_SerializedData_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt64PropertyParams Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewProp_ObjectFlags = { "ObjectFlags", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FObjectSnapshotData, ObjectFlags), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewProp_ObjectFlags_MetaData), Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewProp_ObjectFlags_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ObjectSnapshotData_h_Statics::ScriptStructInfo[] = {
		{ FObjectSnapshotData::StaticStruct, Z_Construct_UScriptStruct_FObjectSnapshotData_Statics::NewStructOps, TEXT("ObjectSnapshotData"), &Z_Registration_Info_UScriptStruct_ObjectSnapshotData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FObjectSnapshotData), 3751763890U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelSnapshots_Public_Data_ObjectSnapshotData_h_1273539965(TEXT("/Script/LevelSnapshots"),
		nullptr, 0,
