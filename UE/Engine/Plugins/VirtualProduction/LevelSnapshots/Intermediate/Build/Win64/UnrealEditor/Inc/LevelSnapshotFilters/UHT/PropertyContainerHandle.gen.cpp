...
template<> LEVELSNAPSHOTFILTERS_API UScriptStruct* StaticStruct<FPropertyContainerHandle>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPropertyContainerHandle_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyContainerHandle_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPropertyContainerHandle_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelShapshotFilters_Public_PropertyContainerHandle_h_Statics::ScriptStructInfo[] = {
		{ FPropertyContainerHandle::StaticStruct, Z_Construct_UScriptStruct_FPropertyContainerHandle_Statics::NewStructOps, TEXT("PropertyContainerHandle"), &Z_Registration_Info_UScriptStruct_PropertyContainerHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPropertyContainerHandle), 3426274084U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LevelSnapshots_Source_LevelShapshotFilters_Public_PropertyContainerHandle_h_2043821376(TEXT("/Script/LevelSnapshotFilters"),
		nullptr, 0,
