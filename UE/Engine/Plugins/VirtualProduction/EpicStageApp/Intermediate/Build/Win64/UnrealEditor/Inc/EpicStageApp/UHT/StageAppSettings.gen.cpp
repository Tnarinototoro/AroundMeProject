...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UStageAppSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoveryEndpoint = { "DiscoveryEndpoint", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UStageAppSettings, DiscoveryEndpoint), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoveryEndpoint_MetaData), Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoveryEndpoint_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoveryPort = { "DiscoveryPort", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UStageAppSettings, DiscoveryPort), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoveryPort_MetaData), Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoveryPort_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoverySocketWaitTime = { "DiscoverySocketWaitTime", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UStageAppSettings, DiscoverySocketWaitTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoverySocketWaitTime_MetaData), Z_Construct_UClass_UStageAppSettings_Statics::NewProp_DiscoverySocketWaitTime_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UStageAppSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStageAppSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UStageAppSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UStageAppSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_EpicStageApp_Source_EpicStageApp_Public_StageAppSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStageAppSettings, UStageAppSettings::StaticClass, TEXT("UStageAppSettings"), &Z_Registration_Info_UClass_UStageAppSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStageAppSettings), 2955317241U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_EpicStageApp_Source_EpicStageApp_Public_StageAppSettings_h_4082650807(TEXT("/Script/EpicStageApp"),
