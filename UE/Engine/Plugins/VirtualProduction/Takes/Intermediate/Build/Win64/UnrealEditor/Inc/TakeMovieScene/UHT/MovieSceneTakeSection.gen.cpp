...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_HoursCurve = { "HoursCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneTakeSection, HoursCurve), Z_Construct_UScriptStruct_FMovieSceneIntegerChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_HoursCurve_MetaData), Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_HoursCurve_MetaData) }; // 1869079575
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_SubFramesCurve = { "SubFramesCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneTakeSection, SubFramesCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_SubFramesCurve_MetaData), Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_SubFramesCurve_MetaData) }; // 3861024830
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_Slate = { "Slate", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneTakeSection, Slate), Z_Construct_UScriptStruct_FMovieSceneStringChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_Slate_MetaData), Z_Construct_UClass_UMovieSceneTakeSection_Statics::NewProp_Slate_MetaData) }; // 3131001143
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeMovieScene_Public_MovieSceneTakeSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneTakeSection, UMovieSceneTakeSection::StaticClass, TEXT("UMovieSceneTakeSection"), &Z_Registration_Info_UClass_UMovieSceneTakeSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneTakeSection), 3187913386U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeMovieScene_Public_MovieSceneTakeSection_h_1708760519(TEXT("/Script/TakeMovieScene"),
