...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScenePropertyTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieScenePropertyTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScenePropertyTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieScenePropertyTrackRecorder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieScenePropertyTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieScenePropertyTrackRecorder, UMovieScenePropertyTrackRecorder::StaticClass, TEXT("UMovieScenePropertyTrackRecorder"), &Z_Registration_Info_UClass_UMovieScenePropertyTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScenePropertyTrackRecorder), 1756400137U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieScenePropertyTrackRecorder_h_4220962782(TEXT("/Script/TakeTrackRecorders"),
