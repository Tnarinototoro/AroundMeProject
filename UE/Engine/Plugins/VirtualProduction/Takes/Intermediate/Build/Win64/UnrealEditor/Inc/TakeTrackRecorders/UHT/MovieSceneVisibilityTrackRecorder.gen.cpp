...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneVisibilityTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneVisibilityTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneVisibilityTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneVisibilityTrackRecorder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieSceneVisibilityTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneVisibilityTrackRecorder, UMovieSceneVisibilityTrackRecorder::StaticClass, TEXT("UMovieSceneVisibilityTrackRecorder"), &Z_Registration_Info_UClass_UMovieSceneVisibilityTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneVisibilityTrackRecorder), 1919194657U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieSceneVisibilityTrackRecorder_h_2402366062(TEXT("/Script/TakeTrackRecorders"),
