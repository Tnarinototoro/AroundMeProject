...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DTransformTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieScene3DTransformTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DTransformTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieScene3DTransformTrackRecorder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieScene3DTransformTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieScene3DTransformTrackRecorder, UMovieScene3DTransformTrackRecorder::StaticClass, TEXT("UMovieScene3DTransformTrackRecorder"), &Z_Registration_Info_UClass_UMovieScene3DTransformTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScene3DTransformTrackRecorder), 125385426U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieScene3DTransformTrackRecorder_h_58130520(TEXT("/Script/TakeTrackRecorders"),
