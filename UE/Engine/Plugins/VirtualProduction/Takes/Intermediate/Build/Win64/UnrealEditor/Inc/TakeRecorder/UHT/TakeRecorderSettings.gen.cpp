...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderUserSettings, Settings), Z_Construct_UScriptStruct_FTakeRecorderUserParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_Settings_MetaData) }; // 3907118016
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_PresetSaveDir = { "PresetSaveDir", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderUserSettings, PresetSaveDir), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_PresetSaveDir_MetaData), Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_PresetSaveDir_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_LastOpenedPreset = { "LastOpenedPreset", nullptr, (EPropertyFlags)0x0014000000004000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderUserSettings, LastOpenedPreset), Z_Construct_UClass_UTakePreset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_LastOpenedPreset_MetaData), Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_LastOpenedPreset_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bIsSequenceOpen = { "bIsSequenceOpen", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTakeRecorderUserSettings), &Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bIsSequenceOpen_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bIsSequenceOpen_MetaData), Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bIsSequenceOpen_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bShowUserSettingsOnUI = { "bShowUserSettingsOnUI", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTakeRecorderUserSettings), &Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bShowUserSettingsOnUI_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bShowUserSettingsOnUI_MetaData), Z_Construct_UClass_UTakeRecorderUserSettings_Statics::NewProp_bShowUserSettingsOnUI_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderUserSettings_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderUserSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderUserSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderProjectSettings, Settings), Z_Construct_UScriptStruct_FTakeRecorderProjectParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::NewProp_Settings_MetaData), Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::NewProp_Settings_MetaData) }; // 2949025813
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::ClassParams = {
		...
		0,
		0x000800A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderProjectSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorder_Public_TakeRecorderSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderUserSettings, UTakeRecorderUserSettings::StaticClass, TEXT("UTakeRecorderUserSettings"), &Z_Registration_Info_UClass_UTakeRecorderUserSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderUserSettings), 2411277275U) },
		{ Z_Construct_UClass_UTakeRecorderProjectSettings, UTakeRecorderProjectSettings::StaticClass, TEXT("UTakeRecorderProjectSettings"), &Z_Registration_Info_UClass_UTakeRecorderProjectSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderProjectSettings), 1241186410U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorder_Public_TakeRecorderSettings_h_95370355(TEXT("/Script/TakeRecorder"),
