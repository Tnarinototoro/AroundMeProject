...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bRecordWorldSettings = { "bRecordWorldSettings", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTakeRecorderWorldSourceSettings), &Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bRecordWorldSettings_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bRecordWorldSettings_MetaData), Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bRecordWorldSettings_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bAutotrackActors = { "bAutotrackActors", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTakeRecorderWorldSourceSettings), &Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bAutotrackActors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bAutotrackActors_MetaData), Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::NewProp_bAutotrackActors_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::ClassParams = {
		...
		0,
		0x000000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderWorldSourceSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderWorldSource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderWorldSource_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderWorldSource_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderWorldSource_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderWorldSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderWorldSourceSettings, UTakeRecorderWorldSourceSettings::StaticClass, TEXT("UTakeRecorderWorldSourceSettings"), &Z_Registration_Info_UClass_UTakeRecorderWorldSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderWorldSourceSettings), 3700129742U) },
		{ Z_Construct_UClass_UTakeRecorderWorldSource, UTakeRecorderWorldSource::StaticClass, TEXT("UTakeRecorderWorldSource"), &Z_Registration_Info_UClass_UTakeRecorderWorldSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderWorldSource), 1483935325U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderWorldSource_h_4113132174(TEXT("/Script/TakeRecorderSources"),
