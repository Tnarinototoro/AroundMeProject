...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_Proximity = { "Proximity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderNearbySpawnedActorSource, Proximity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_Proximity_MetaData), Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_Proximity_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_bFilterSpawnedActors = { "bFilterSpawnedActors", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTakeRecorderNearbySpawnedActorSource), &Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_bFilterSpawnedActors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_bFilterSpawnedActors_MetaData), Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_bFilterSpawnedActors_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_FilterTypes = { "FilterTypes", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderNearbySpawnedActorSource, FilterTypes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_FilterTypes_MetaData), Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::NewProp_FilterTypes_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderNearbySpawnedActorSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderNearbySpawnedActorSource, UTakeRecorderNearbySpawnedActorSource::StaticClass, TEXT("UTakeRecorderNearbySpawnedActorSource"), &Z_Registration_Info_UClass_UTakeRecorderNearbySpawnedActorSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderNearbySpawnedActorSource), 2562784581U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderNearbySpawnedActorSource_h_1239170609(TEXT("/Script/TakeRecorderSources"),
