...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::NewProp_LevelVisibilityTrackName = { "LevelVisibilityTrackName", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderLevelVisibilitySourceSettings, LevelVisibilityTrackName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::NewProp_LevelVisibilityTrackName_MetaData), Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::NewProp_LevelVisibilityTrackName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::ClassParams = {
		...
		0,
		0x000000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelVisibilitySource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderLevelVisibilitySource_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelVisibilitySource_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderLevelVisibilitySource_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderLevelVisibilitySource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderLevelVisibilitySourceSettings, UTakeRecorderLevelVisibilitySourceSettings::StaticClass, TEXT("UTakeRecorderLevelVisibilitySourceSettings"), &Z_Registration_Info_UClass_UTakeRecorderLevelVisibilitySourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderLevelVisibilitySourceSettings), 3490119250U) },
		{ Z_Construct_UClass_UTakeRecorderLevelVisibilitySource, UTakeRecorderLevelVisibilitySource::StaticClass, TEXT("UTakeRecorderLevelVisibilitySource"), &Z_Registration_Info_UClass_UTakeRecorderLevelVisibilitySource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderLevelVisibilitySource), 2269552115U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderLevelVisibilitySource_h_213126904(TEXT("/Script/TakeRecorderSources"),
