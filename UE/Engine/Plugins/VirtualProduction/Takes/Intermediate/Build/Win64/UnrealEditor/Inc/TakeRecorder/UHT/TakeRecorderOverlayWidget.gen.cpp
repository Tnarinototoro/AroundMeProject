...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::NewProp_Recorder = { "Recorder", nullptr, (EPropertyFlags)0x0024080000000014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderOverlayWidget, Recorder), Z_Construct_UClass_UTakeRecorder_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::NewProp_Recorder_MetaData), Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::NewProp_Recorder_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::ClassParams = {
		...
		0,
		0x00B010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderOverlayWidget_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorder_Public_TakeRecorderOverlayWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderOverlayWidget, UTakeRecorderOverlayWidget::StaticClass, TEXT("UTakeRecorderOverlayWidget"), &Z_Registration_Info_UClass_UTakeRecorderOverlayWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderOverlayWidget), 354688460U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorder_Public_TakeRecorderOverlayWidget_h_1894805919(TEXT("/Script/TakeRecorder"),
