...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_TakeRecorder_ETakeRecorderState_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_TakeRecorder_ETakeRecorderState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_TakeRecorder_ETakeRecorderState_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TakeRecorder_eventGetCountdownSeconds_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTakeRecorder, nullptr, "GetCountdownSeconds", nullptr, nullptr, Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::PropPointers), sizeof(Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::TakeRecorder_eventGetCountdownSeconds_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds_Statics::TakeRecorder_eventGetCountdownSeconds_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TakeRecorder_eventGetSequence_Parms, ReturnValue), Z_Construct_UClass_ULevelSequence_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTakeRecorder, nullptr, "GetSequence", nullptr, nullptr, Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::PropPointers), sizeof(Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::TakeRecorder_eventGetSequence_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UTakeRecorder_GetSequence_Statics::TakeRecorder_eventGetSequence_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UTakeRecorder_GetState_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TakeRecorder_eventGetState_Parms, ReturnValue), Z_Construct_UEnum_TakeRecorder_ETakeRecorderState, METADATA_PARAMS(0, nullptr) }; // 2456673939
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTakeRecorder_GetState_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTakeRecorder, nullptr, "GetState", nullptr, nullptr, Z_Construct_UFunction_UTakeRecorder_GetState_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetState_Statics::PropPointers), sizeof(Z_Construct_UFunction_UTakeRecorder_GetState_Statics::TakeRecorder_eventGetState_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetState_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTakeRecorder_GetState_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UTakeRecorder_GetState_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UTakeRecorder_GetState_Statics::TakeRecorder_eventGetState_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UTakeRecorder_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTakeRecorder_GetCountdownSeconds, "GetCountdownSeconds" }, // 393037947
		{ &Z_Construct_UFunction_UTakeRecorder_GetSequence, "GetSequence" }, // 2684806291
		{ &Z_Construct_UFunction_UTakeRecorder_GetState, "GetState" }, // 4126158158
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTakeRecorder_Statics::NewProp_SequenceAsset = { "SequenceAsset", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorder, SequenceAsset), Z_Construct_UClass_ULevelSequence_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::NewProp_SequenceAsset_MetaData), Z_Construct_UClass_UTakeRecorder_Statics::NewProp_SequenceAsset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTakeRecorder_Statics::NewProp_OverlayWidget = { "OverlayWidget", nullptr, (EPropertyFlags)0x0044000000082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorder, OverlayWidget), Z_Construct_UClass_UTakeRecorderOverlayWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::NewProp_OverlayWidget_MetaData), Z_Construct_UClass_UTakeRecorder_Statics::NewProp_OverlayWidget_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UTakeRecorder_Statics::NewProp_WeakWorld = { "WeakWorld", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorder, WeakWorld), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::NewProp_WeakWorld_MetaData), Z_Construct_UClass_UTakeRecorder_Statics::NewProp_WeakWorld_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTakeRecorder_Statics::NewProp_Parameters = { "Parameters", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorder, Parameters), Z_Construct_UScriptStruct_FTakeRecorderParameters, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::NewProp_Parameters_MetaData), Z_Construct_UClass_UTakeRecorder_Statics::NewProp_Parameters_MetaData) }; // 3778737959
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorder_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorder_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorder_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorder_Public_Recorder_TakeRecorder_h_Statics::EnumInfo[] = {
		{ ETakeRecorderState_StaticEnum, TEXT("ETakeRecorderState"), &Z_Registration_Info_UEnum_ETakeRecorderState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2456673939U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorder_Public_Recorder_TakeRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorder, UTakeRecorder::StaticClass, TEXT("UTakeRecorder"), &Z_Registration_Info_UClass_UTakeRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorder), 2975653202U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorder_Public_Recorder_TakeRecorder_h_2147629633(TEXT("/Script/TakeRecorder"),
