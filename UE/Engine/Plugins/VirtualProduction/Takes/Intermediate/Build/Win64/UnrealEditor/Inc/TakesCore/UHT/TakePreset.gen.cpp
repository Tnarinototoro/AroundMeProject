...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakePreset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTakePreset_Statics::NewProp_LevelSequence = { "LevelSequence", nullptr, (EPropertyFlags)0x0046000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakePreset, LevelSequence), Z_Construct_UClass_ULevelSequence_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakePreset_Statics::NewProp_LevelSequence_MetaData), Z_Construct_UClass_UTakePreset_Statics::NewProp_LevelSequence_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakePreset_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakePreset_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakePreset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakePreset_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakesCore_Public_TakePreset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakePreset, UTakePreset::StaticClass, TEXT("UTakePreset"), &Z_Registration_Info_UClass_UTakePreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakePreset), 2152023180U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakesCore_Public_TakePreset_h_3993783301(TEXT("/Script/TakesCore"),
