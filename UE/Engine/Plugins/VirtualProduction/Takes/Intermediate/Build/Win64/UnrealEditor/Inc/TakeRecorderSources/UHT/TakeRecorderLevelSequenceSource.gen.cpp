...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::NewProp_LevelSequencesToTrigger = { "LevelSequencesToTrigger", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderLevelSequenceSource, LevelSequencesToTrigger), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::NewProp_LevelSequencesToTrigger_MetaData), Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::NewProp_LevelSequencesToTrigger_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderLevelSequenceSource_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderLevelSequenceSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderLevelSequenceSource, UTakeRecorderLevelSequenceSource::StaticClass, TEXT("UTakeRecorderLevelSequenceSource"), &Z_Registration_Info_UClass_UTakeRecorderLevelSequenceSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderLevelSequenceSource), 1538760897U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderLevelSequenceSource_h_3509994042(TEXT("/Script/TakeRecorderSources"),
