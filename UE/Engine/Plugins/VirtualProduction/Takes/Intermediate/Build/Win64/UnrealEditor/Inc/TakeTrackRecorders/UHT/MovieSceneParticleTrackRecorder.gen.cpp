...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::NewProp_Component = { "Component", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneParticleTrackRecorder_eventOnTriggered_Parms, Component), Z_Construct_UClass_UParticleSystemComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::NewProp_Component_MetaData), Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::NewProp_Component_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::NewProp_bActivating = { "bActivating", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(MovieSceneParticleTrackRecorder_eventOnTriggered_Parms), &Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::NewProp_bActivating_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMovieSceneParticleTrackRecorder, nullptr, "OnTriggered", nullptr, nullptr, Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::MovieSceneParticleTrackRecorder_eventOnTriggered_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered_Statics::MovieSceneParticleTrackRecorder_eventOnTriggered_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneParticleTrackRecorder_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneParticleTrackRecorder_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneParticleTrackRecorder_OnTriggered, "OnTriggered" }, // 4039207379
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneParticleTrackRecorder_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneParticleTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneParticleTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneParticleTrackRecorder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieSceneParticleTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneParticleTrackRecorder, UMovieSceneParticleTrackRecorder::StaticClass, TEXT("UMovieSceneParticleTrackRecorder"), &Z_Registration_Info_UClass_UMovieSceneParticleTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneParticleTrackRecorder), 2602454420U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieSceneParticleTrackRecorder_h_2476234059(TEXT("/Script/TakeTrackRecorders"),
