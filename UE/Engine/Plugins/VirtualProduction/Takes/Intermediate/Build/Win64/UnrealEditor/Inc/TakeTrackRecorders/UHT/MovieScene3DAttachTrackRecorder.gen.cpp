...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DAttachTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieScene3DAttachTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DAttachTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieScene3DAttachTrackRecorder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieScene3DAttachTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieScene3DAttachTrackRecorder, UMovieScene3DAttachTrackRecorder::StaticClass, TEXT("UMovieScene3DAttachTrackRecorder"), &Z_Registration_Info_UClass_UMovieScene3DAttachTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScene3DAttachTrackRecorder), 2631057614U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeTrackRecorders_Public_TrackRecorders_MovieScene3DAttachTrackRecorder_h_2926030213(TEXT("/Script/TakeTrackRecorders"),
