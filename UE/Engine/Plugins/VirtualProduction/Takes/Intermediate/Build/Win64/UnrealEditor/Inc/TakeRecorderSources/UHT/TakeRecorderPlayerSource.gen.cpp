...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderPlayerSource_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTakeRecorderPlayerSource_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderPlayerSource_Statics::Class_MetaDataParams), Z_Construct_UClass_UTakeRecorderPlayerSource_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderPlayerSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderPlayerSource, UTakeRecorderPlayerSource::StaticClass, TEXT("UTakeRecorderPlayerSource"), &Z_Registration_Info_UClass_UTakeRecorderPlayerSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderPlayerSource), 1021700151U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeRecorderSources_Private_TakeRecorderPlayerSource_h_2265396304(TEXT("/Script/TakeRecorderSources"),
