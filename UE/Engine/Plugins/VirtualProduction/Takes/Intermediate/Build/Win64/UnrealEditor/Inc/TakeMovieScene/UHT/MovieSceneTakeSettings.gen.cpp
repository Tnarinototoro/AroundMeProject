...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_HoursName = { "HoursName", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneTakeSettings, HoursName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_HoursName_MetaData), Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_HoursName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_MinutesName = { "MinutesName", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneTakeSettings, MinutesName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_MinutesName_MetaData), Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_MinutesName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_SecondsName = { "SecondsName", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneTakeSettings, SecondsName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_SecondsName_MetaData), Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_SecondsName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_FramesName = { "FramesName", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneTakeSettings, FramesName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_FramesName_MetaData), Z_Construct_UClass_UMovieSceneTakeSettings_Statics::NewProp_FramesName_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeMovieScene_Public_MovieSceneTakeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneTakeSettings, UMovieSceneTakeSettings::StaticClass, TEXT("UMovieSceneTakeSettings"), &Z_Registration_Info_UClass_UMovieSceneTakeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneTakeSettings), 1682621621U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Takes_Source_TakeMovieScene_Public_MovieSceneTakeSettings_h_3259153692(TEXT("/Script/TakeMovieScene"),
