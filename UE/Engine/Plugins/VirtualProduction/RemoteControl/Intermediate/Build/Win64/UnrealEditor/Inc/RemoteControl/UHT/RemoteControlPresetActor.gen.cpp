...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ARemoteControlPresetActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ARemoteControlPresetActor_Statics::NewProp_Preset = { "Preset", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARemoteControlPresetActor, Preset), Z_Construct_UClass_URemoteControlPreset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ARemoteControlPresetActor_Statics::NewProp_Preset_MetaData), Z_Construct_UClass_ARemoteControlPresetActor_Statics::NewProp_Preset_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ARemoteControlPresetActor_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ARemoteControlPresetActor_Statics::Class_MetaDataParams), Z_Construct_UClass_ARemoteControlPresetActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ARemoteControlPresetActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Public_RemoteControlPresetActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ARemoteControlPresetActor, ARemoteControlPresetActor::StaticClass, TEXT("ARemoteControlPresetActor"), &Z_Registration_Info_UClass_ARemoteControlPresetActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARemoteControlPresetActor), 1548796799U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Public_RemoteControlPresetActor_h_1840755767(TEXT("/Script/RemoteControl"),
