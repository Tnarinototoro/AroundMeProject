...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::NewProp_HiddenProtocolTypeNames_ElementProp = { "HiddenProtocolTypeNames", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::NewProp_HiddenProtocolTypeNames = { "HiddenProtocolTypeNames", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlProtocolWidgetsSettings, HiddenProtocolTypeNames), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::NewProp_HiddenProtocolTypeNames_MetaData), Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::NewProp_HiddenProtocolTypeNames_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::NewProp_PreferredProtocol = { "PreferredProtocol", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlProtocolWidgetsSettings, PreferredProtocol), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::NewProp_PreferredProtocol_MetaData), Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::NewProp_PreferredProtocol_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolWidgetsSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlProtocolWidgets_Private_RemoteControlProtocolWidgetsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlProtocolWidgetsSettings, URemoteControlProtocolWidgetsSettings::StaticClass, TEXT("URemoteControlProtocolWidgetsSettings"), &Z_Registration_Info_UClass_URemoteControlProtocolWidgetsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlProtocolWidgetsSettings), 3717247961U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlProtocolWidgets_Private_RemoteControlProtocolWidgetsSettings_h_1625622533(TEXT("/Script/RemoteControlProtocolWidgets"),
