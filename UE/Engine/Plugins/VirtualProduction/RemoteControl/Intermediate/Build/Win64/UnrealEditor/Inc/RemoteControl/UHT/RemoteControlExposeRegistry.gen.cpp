...
template<> REMOTECONTROL_API UScriptStruct* StaticStruct<FRCEntityWrapper>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRCEntityWrapper_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCEntityWrapper_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRCEntityWrapper_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlExposeRegistry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_ExposedEntities_ElementProp = { "ExposedEntities", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRCEntityWrapper, METADATA_PARAMS(0, nullptr) }; // 1117406690
#if WITH_METADATA
...
#endif
	static_assert(TModels_V<CGetTypeHashable, FRCEntityWrapper>, "The structure 'FRCEntityWrapper' is used in a TSet but does not have a GetValueTypeHash defined");
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_ExposedEntities = { "ExposedEntities", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlExposeRegistry, ExposedEntities), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_ExposedEntities_MetaData), Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_ExposedEntities_MetaData) }; // 1117406690
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_LabelToIdCache_ValueProp = { "LabelToIdCache", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_LabelToIdCache_Key_KeyProp = { "LabelToIdCache_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_LabelToIdCache = { "LabelToIdCache", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlExposeRegistry, LabelToIdCache), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_LabelToIdCache_MetaData), Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_LabelToIdCache_MetaData) };
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_ExposedTypes = { "ExposedTypes", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlExposeRegistry, ExposedTypes), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_ExposedTypes_MetaData), Z_Construct_UClass_URemoteControlExposeRegistry_Statics::NewProp_ExposedTypes_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlExposeRegistry_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlExposeRegistry_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlExposeRegistry_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlExposeRegistry_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Private_RemoteControlExposeRegistry_h_Statics::ScriptStructInfo[] = {
		{ FRCEntityWrapper::StaticStruct, Z_Construct_UScriptStruct_FRCEntityWrapper_Statics::NewStructOps, TEXT("RCEntityWrapper"), &Z_Registration_Info_UScriptStruct_RCEntityWrapper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRCEntityWrapper), 1117406690U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Private_RemoteControlExposeRegistry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlExposeRegistry, URemoteControlExposeRegistry::StaticClass, TEXT("URemoteControlExposeRegistry"), &Z_Registration_Info_UClass_URemoteControlExposeRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlExposeRegistry), 1920496598U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Private_RemoteControlExposeRegistry_h_2632990677(TEXT("/Script/RemoteControl"),
