...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCPropertyBindAction_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCPropertyBindAction_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCPropertyBindAction, Controller), Z_Construct_UClass_URCController_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCPropertyBindAction_Statics::NewProp_Controller_MetaData), Z_Construct_UClass_URCPropertyBindAction_Statics::NewProp_Controller_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCPropertyBindAction_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCPropertyBindAction_Statics::Class_MetaDataParams), Z_Construct_UClass_URCPropertyBindAction_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCPropertyBindAction_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Action_Bind_RCPropertyBindAction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCPropertyBindAction, URCPropertyBindAction::StaticClass, TEXT("URCPropertyBindAction"), &Z_Registration_Info_UClass_URCPropertyBindAction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCPropertyBindAction), 3717604801U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Action_Bind_RCPropertyBindAction_h_2015874314(TEXT("/Script/RemoteControlLogic"),
