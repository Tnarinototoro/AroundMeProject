...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCController_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCController_Statics::NewProp_Behaviours_ElementProp = { "Behaviours", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_URCBehaviour_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URCController_Statics::NewProp_Behaviours = { "Behaviours", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCController, Behaviours), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCController_Statics::NewProp_Behaviours_MetaData), Z_Construct_UClass_URCController_Statics::NewProp_Behaviours_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCController_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCController_Statics::Class_MetaDataParams), Z_Construct_UClass_URCController_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCController_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Controller_RCController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCController, URCController::StaticClass, TEXT("URCController"), &Z_Registration_Info_UClass_URCController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCController), 1199355663U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Controller_RCController_h_3925427366(TEXT("/Script/RemoteControlLogic"),
