...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlPresetActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlPresetActorFactory_Statics::ClassParams = {
		...
		0,
		0x000030ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlPresetActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlPresetActorFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlUI_Private_Factories_RemoteControlPresetActorFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlPresetActorFactory, URemoteControlPresetActorFactory::StaticClass, TEXT("URemoteControlPresetActorFactory"), &Z_Registration_Info_UClass_URemoteControlPresetActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlPresetActorFactory), 2094101924U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlUI_Private_Factories_RemoteControlPresetActorFactory_h_2688924874(TEXT("/Script/RemoteControlUI"),
