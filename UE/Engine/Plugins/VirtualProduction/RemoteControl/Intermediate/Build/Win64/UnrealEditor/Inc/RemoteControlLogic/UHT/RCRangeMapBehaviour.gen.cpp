...
template<> REMOTECONTROLLOGIC_API UScriptStruct* StaticStruct<FRCRangeMapInput>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::NewProp_InputProperty = { "InputProperty", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRCRangeMapInput, InputProperty), Z_Construct_UClass_URCVirtualPropertySelfContainer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::NewProp_InputProperty_MetaData), Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::NewProp_InputProperty_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::NewProp_PropertyValue = { "PropertyValue", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRCRangeMapInput, PropertyValue), Z_Construct_UClass_URCVirtualPropertySelfContainer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::NewProp_PropertyValue_MetaData), Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::NewProp_PropertyValue_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCRangeMapBehaviour_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCRangeMapBehaviour_Statics::NewProp_PropertyContainer = { "PropertyContainer", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCRangeMapBehaviour, PropertyContainer), Z_Construct_UClass_URCVirtualPropertyContainerBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCRangeMapBehaviour_Statics::NewProp_PropertyContainer_MetaData), Z_Construct_UClass_URCRangeMapBehaviour_Statics::NewProp_PropertyContainer_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URCRangeMapBehaviour_Statics::NewProp_RangeMapActionContainer_ValueProp = { "RangeMapActionContainer", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FRCRangeMapInput, METADATA_PARAMS(0, nullptr) }; // 3264359544
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_URCRangeMapBehaviour_Statics::NewProp_RangeMapActionContainer = { "RangeMapActionContainer", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCRangeMapBehaviour, RangeMapActionContainer), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCRangeMapBehaviour_Statics::NewProp_RangeMapActionContainer_MetaData), Z_Construct_UClass_URCRangeMapBehaviour_Statics::NewProp_RangeMapActionContainer_MetaData) }; // 3264359544
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCRangeMapBehaviour_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCRangeMapBehaviour_Statics::Class_MetaDataParams), Z_Construct_UClass_URCRangeMapBehaviour_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCRangeMapBehaviour_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_Builtin_RangeMap_RCRangeMapBehaviour_h_Statics::ScriptStructInfo[] = {
		{ FRCRangeMapInput::StaticStruct, Z_Construct_UScriptStruct_FRCRangeMapInput_Statics::NewStructOps, TEXT("RCRangeMapInput"), &Z_Registration_Info_UScriptStruct_RCRangeMapInput, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRCRangeMapInput), 3264359544U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_Builtin_RangeMap_RCRangeMapBehaviour_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCRangeMapBehaviour, URCRangeMapBehaviour::StaticClass, TEXT("URCRangeMapBehaviour"), &Z_Registration_Info_UClass_URCRangeMapBehaviour, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCRangeMapBehaviour), 408983011U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_Builtin_RangeMap_RCRangeMapBehaviour_h_1162267806(TEXT("/Script/RemoteControlLogic"),
