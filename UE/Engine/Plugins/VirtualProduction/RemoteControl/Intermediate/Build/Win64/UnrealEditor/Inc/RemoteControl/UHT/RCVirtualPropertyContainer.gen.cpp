...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_Bag = { "Bag", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCVirtualPropertyContainerBase, Bag), Z_Construct_UScriptStruct_FInstancedPropertyBag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_Bag_MetaData), Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_Bag_MetaData) }; // 4097115139
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_VirtualProperties_ElementProp = { "VirtualProperties", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_URCVirtualPropertyBase_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_VirtualProperties = { "VirtualProperties", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCVirtualPropertyContainerBase, VirtualProperties), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_VirtualProperties_MetaData), Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_VirtualProperties_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_PresetWeakPtr = { "PresetWeakPtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCVirtualPropertyContainerBase, PresetWeakPtr), Z_Construct_UClass_URemoteControlPreset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_PresetWeakPtr_MetaData), Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::NewProp_PresetWeakPtr_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::Class_MetaDataParams), Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCVirtualPropertyContainerBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Public_RCVirtualPropertyContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCVirtualPropertyContainerBase, URCVirtualPropertyContainerBase::StaticClass, TEXT("URCVirtualPropertyContainerBase"), &Z_Registration_Info_UClass_URCVirtualPropertyContainerBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCVirtualPropertyContainerBase), 3515186318U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Public_RCVirtualPropertyContainer_h_1241190498(TEXT("/Script/RemoteControl"),
