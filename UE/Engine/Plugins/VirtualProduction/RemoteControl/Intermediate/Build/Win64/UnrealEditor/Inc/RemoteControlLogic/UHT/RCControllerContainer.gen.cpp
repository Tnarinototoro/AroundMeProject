...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URCControllerContainer_Statics::NewProp_VectorSliderDelta = { "VectorSliderDelta", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCControllerContainer, VectorSliderDelta), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::NewProp_VectorSliderDelta_MetaData), Z_Construct_UClass_URCControllerContainer_Statics::NewProp_VectorSliderDelta_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URCControllerContainer_Statics::NewProp_VectorLinearDeltaSensitivity = { "VectorLinearDeltaSensitivity", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCControllerContainer, VectorLinearDeltaSensitivity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::NewProp_VectorLinearDeltaSensitivity_MetaData), Z_Construct_UClass_URCControllerContainer_Statics::NewProp_VectorLinearDeltaSensitivity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URCControllerContainer_Statics::NewProp_RotatorSliderDelta = { "RotatorSliderDelta", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCControllerContainer, RotatorSliderDelta), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::NewProp_RotatorSliderDelta_MetaData), Z_Construct_UClass_URCControllerContainer_Statics::NewProp_RotatorSliderDelta_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_URCControllerContainer_Statics::NewProp_RotatorLinearDeltaSensitivity = { "RotatorLinearDeltaSensitivity", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCControllerContainer, RotatorLinearDeltaSensitivity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::NewProp_RotatorLinearDeltaSensitivity_MetaData), Z_Construct_UClass_URCControllerContainer_Statics::NewProp_RotatorLinearDeltaSensitivity_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCControllerContainer_Statics::NewProp_SharedActionContainers_ElementProp = { "SharedActionContainers", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_URCActionContainer_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URCControllerContainer_Statics::NewProp_SharedActionContainers = { "SharedActionContainers", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCControllerContainer, SharedActionContainers), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::NewProp_SharedActionContainers_MetaData), Z_Construct_UClass_URCControllerContainer_Statics::NewProp_SharedActionContainers_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCControllerContainer_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::Class_MetaDataParams), Z_Construct_UClass_URCControllerContainer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCControllerContainer_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Controller_RCControllerContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCControllerContainer, URCControllerContainer::StaticClass, TEXT("URCControllerContainer"), &Z_Registration_Info_UClass_URCControllerContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCControllerContainer), 834457694U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Controller_RCControllerContainer_h_954352157(TEXT("/Script/RemoteControlLogic"),
