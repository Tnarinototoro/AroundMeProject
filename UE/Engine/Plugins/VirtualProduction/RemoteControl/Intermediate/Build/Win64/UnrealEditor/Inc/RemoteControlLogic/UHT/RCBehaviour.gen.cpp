...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_BehaviourNodeClass = { "BehaviourNodeClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCBehaviour, BehaviourNodeClass), Z_Construct_UClass_UClass, Z_Construct_UClass_URCBehaviourNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_BehaviourNodeClass_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_BehaviourNodeClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_OverrideBehaviourBlueprintClassPath = { "OverrideBehaviourBlueprintClassPath", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCBehaviour, OverrideBehaviourBlueprintClassPath), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_OverrideBehaviourBlueprintClassPath_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_OverrideBehaviourBlueprintClassPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCBehaviour, Id), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_Id_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_Id_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_ActionContainer = { "ActionContainer", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCBehaviour, ActionContainer), Z_Construct_UClass_URCActionContainer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_ActionContainer_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_ActionContainer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_ControllerWeakPtr = { "ControllerWeakPtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCBehaviour, ControllerWeakPtr), Z_Construct_UClass_URCController_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_ControllerWeakPtr_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_ControllerWeakPtr_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_CachedBehaviourNode = { "CachedBehaviourNode", nullptr, (EPropertyFlags)0x0046000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCBehaviour, CachedBehaviourNode), Z_Construct_UClass_URCBehaviourNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_CachedBehaviourNode_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_CachedBehaviourNode_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_bIsEnabled = { "bIsEnabled", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URCBehaviour), &Z_Construct_UClass_URCBehaviour_Statics::NewProp_bIsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_bIsEnabled_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_bIsEnabled_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URCBehaviour_Statics::NewProp_bExecuteBehavioursDuringPreChange = { "bExecuteBehavioursDuringPreChange", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URCBehaviour), &Z_Construct_UClass_URCBehaviour_Statics::NewProp_bExecuteBehavioursDuringPreChange_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::NewProp_bExecuteBehavioursDuringPreChange_MetaData), Z_Construct_UClass_URCBehaviour_Statics::NewProp_bExecuteBehavioursDuringPreChange_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCBehaviour_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::Class_MetaDataParams), Z_Construct_UClass_URCBehaviour_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCBehaviour_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_RCBehaviour_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCBehaviour, URCBehaviour::StaticClass, TEXT("URCBehaviour"), &Z_Registration_Info_UClass_URCBehaviour, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCBehaviour), 3200851000U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_RCBehaviour_h_3400706202(TEXT("/Script/RemoteControlLogic"),
