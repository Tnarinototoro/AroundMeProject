...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCActionContainer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URCActionContainer_Statics::NewProp_ActionContainers = { "ActionContainers", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCActionContainer, ActionContainers), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCActionContainer_Statics::NewProp_ActionContainers_MetaData), Z_Construct_UClass_URCActionContainer_Statics::NewProp_ActionContainers_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_URCActionContainer_Statics::NewProp_PresetWeakPtr = { "PresetWeakPtr", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCActionContainer, PresetWeakPtr), Z_Construct_UClass_URemoteControlPreset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCActionContainer_Statics::NewProp_PresetWeakPtr_MetaData), Z_Construct_UClass_URCActionContainer_Statics::NewProp_PresetWeakPtr_MetaData) };
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_URCActionContainer_Statics::NewProp_Actions = { "Actions", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCActionContainer, Actions), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCActionContainer_Statics::NewProp_Actions_MetaData), Z_Construct_UClass_URCActionContainer_Statics::NewProp_Actions_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCActionContainer_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCActionContainer_Statics::Class_MetaDataParams), Z_Construct_UClass_URCActionContainer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCActionContainer_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Action_RCActionContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCActionContainer, URCActionContainer::StaticClass, TEXT("URCActionContainer"), &Z_Registration_Info_UClass_URCActionContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCActionContainer), 3832063115U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Action_RCActionContainer_h_2603472317(TEXT("/Script/RemoteControlLogic"),
