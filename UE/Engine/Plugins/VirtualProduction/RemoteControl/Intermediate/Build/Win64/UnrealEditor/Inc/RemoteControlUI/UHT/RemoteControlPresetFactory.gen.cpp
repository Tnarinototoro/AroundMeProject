...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlPresetFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlPresetFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlPresetFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlPresetFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlUI_Private_Factories_RemoteControlPresetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlPresetFactory, URemoteControlPresetFactory::StaticClass, TEXT("URemoteControlPresetFactory"), &Z_Registration_Info_UClass_URemoteControlPresetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlPresetFactory), 3397010967U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlUI_Private_Factories_RemoteControlPresetFactory_h_3193669679(TEXT("/Script/RemoteControlUI"),
