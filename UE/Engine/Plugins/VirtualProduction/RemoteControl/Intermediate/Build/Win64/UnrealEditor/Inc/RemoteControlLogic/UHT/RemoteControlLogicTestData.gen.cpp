...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URemoteControlLogicTestData_TestIntFunction_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URemoteControlLogicTestData, nullptr, "TestIntFunction", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URemoteControlLogicTestData_TestIntFunction_Statics::Function_MetaDataParams), Z_Construct_UFunction_URemoteControlLogicTestData_TestIntFunction_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlLogicTestData_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_URemoteControlLogicTestData_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URemoteControlLogicTestData_TestIntFunction, "TestIntFunction" }, // 3400509993
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlLogicTestData_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URemoteControlLogicTestData_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlLogicTestData, Color), Z_Construct_UScriptStruct_FColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlLogicTestData_Statics::NewProp_Color_MetaData), Z_Construct_UClass_URemoteControlLogicTestData_Statics::NewProp_Color_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_URemoteControlLogicTestData_Statics::NewProp_TestInt = { "TestInt", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlLogicTestData, TestInt), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlLogicTestData_Statics::NewProp_TestInt_MetaData), Z_Construct_UClass_URemoteControlLogicTestData_Statics::NewProp_TestInt_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlLogicTestData_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlLogicTestData_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlLogicTestData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlLogicTestData_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Private_Tests_RemoteControlLogicTestData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlLogicTestData, URemoteControlLogicTestData::StaticClass, TEXT("URemoteControlLogicTestData"), &Z_Registration_Info_UClass_URemoteControlLogicTestData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlLogicTestData), 4152699982U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Private_Tests_RemoteControlLogicTestData_h_1321988919(TEXT("/Script/RemoteControlLogic"),
