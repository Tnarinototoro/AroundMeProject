...
template<> REMOTECONTROLLOGIC_API UScriptStruct* StaticStruct<FRCSetAssetPath>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::NewProp_PathArray_Inner = { "PathArray", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::NewProp_PathArray = { "PathArray", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRCSetAssetPath, PathArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::NewProp_PathArray_MetaData), Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::NewProp_PathArray_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_PropertyInContainer = { "PropertyInContainer", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCSetAssetByPathBehaviour, PropertyInContainer), Z_Construct_UClass_URCVirtualPropertyContainerBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_PropertyInContainer_MetaData), Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_PropertyInContainer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_AssetClass = { "AssetClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCSetAssetByPathBehaviour, AssetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_AssetClass_MetaData), Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_AssetClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_PathStruct = { "PathStruct", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCSetAssetByPathBehaviour, PathStruct), Z_Construct_UScriptStruct_FRCSetAssetPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_PathStruct_MetaData), Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_PathStruct_MetaData) }; // 3058236466
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_bInternal = { "bInternal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URCSetAssetByPathBehaviour), &Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_bInternal_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_bInternal_MetaData), Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_bInternal_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_TargetEntityId = { "TargetEntityId", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URCSetAssetByPathBehaviour, TargetEntityId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_TargetEntityId_MetaData), Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::NewProp_TargetEntityId_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::Class_MetaDataParams), Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URCSetAssetByPathBehaviour_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_Builtin_Path_RCSetAssetByPathBehaviour_h_Statics::ScriptStructInfo[] = {
		{ FRCSetAssetPath::StaticStruct, Z_Construct_UScriptStruct_FRCSetAssetPath_Statics::NewStructOps, TEXT("RCSetAssetPath"), &Z_Registration_Info_UScriptStruct_RCSetAssetPath, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRCSetAssetPath), 3058236466U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_Builtin_Path_RCSetAssetByPathBehaviour_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URCSetAssetByPathBehaviour, URCSetAssetByPathBehaviour::StaticClass, TEXT("URCSetAssetByPathBehaviour"), &Z_Registration_Info_UClass_URCSetAssetByPathBehaviour, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URCSetAssetByPathBehaviour), 3509132929U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlLogic_Public_Behaviour_Builtin_Path_RCSetAssetByPathBehaviour_h_2658870699(TEXT("/Script/RemoteControlLogic"),
