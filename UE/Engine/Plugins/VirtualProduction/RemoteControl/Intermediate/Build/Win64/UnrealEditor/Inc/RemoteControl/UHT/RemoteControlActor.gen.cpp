...
template<> REMOTECONTROL_API UScriptStruct* StaticStruct<FRemoteControlActor>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRemoteControlActor_Statics::NewProp_Path = { "Path", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRemoteControlActor, Path), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRemoteControlActor_Statics::NewProp_Path_MetaData), Z_Construct_UScriptStruct_FRemoteControlActor_Statics::NewProp_Path_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRemoteControlActor_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRemoteControlActor_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRemoteControlActor_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRemoteControlActor_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Public_RemoteControlActor_h_Statics::ScriptStructInfo[] = {
		{ FRemoteControlActor::StaticStruct, Z_Construct_UScriptStruct_FRemoteControlActor_Statics::NewStructOps, TEXT("RemoteControlActor"), &Z_Registration_Info_UScriptStruct_RemoteControlActor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRemoteControlActor), 1875434881U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControl_Public_RemoteControlActor_h_2987904951(TEXT("/Script/RemoteControl"),
		nullptr, 0,
