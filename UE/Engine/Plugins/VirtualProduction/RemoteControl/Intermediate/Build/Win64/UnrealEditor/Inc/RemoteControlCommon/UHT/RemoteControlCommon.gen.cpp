...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_RemoteControlCommon_ERCProtocolBinding_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_RemoteControlCommon_ERCProtocolBinding_Statics::Enum_MetaDataParams), Z_Construct_UEnum_RemoteControlCommon_ERCProtocolBinding_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_RemoteControlCommon_ERCMask_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_RemoteControlCommon_ERCMask_Statics::Enum_MetaDataParams), Z_Construct_UEnum_RemoteControlCommon_ERCMask_Statics::Enum_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlCommon_Public_RemoteControlCommon_h_Statics::EnumInfo[] = {
		{ ERCProtocolBinding_StaticEnum, TEXT("ERCProtocolBinding"), &Z_Registration_Info_UEnum_ERCProtocolBinding, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1238200209U) },
		{ ERCMask_StaticEnum, TEXT("ERCMask"), &Z_Registration_Info_UEnum_ERCMask, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2259567872U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_RemoteControlCommon_Public_RemoteControlCommon_h_4263413951(TEXT("/Script/RemoteControlCommon"),
		nullptr, 0,
		nullptr, 0,
