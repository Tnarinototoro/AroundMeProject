...
template<> WEBREMOTECONTROL_API UScriptStruct* StaticStruct<FRCRequest>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FRCRequest_Statics::NewProp_Passphrase = { "Passphrase", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRCRequest, Passphrase), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCRequest_Statics::NewProp_Passphrase_MetaData), Z_Construct_UScriptStruct_FRCRequest_Statics::NewProp_Passphrase_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRCRequest_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCRequest_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRCRequest_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRCRequest_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_WebRemoteControl_Public_RemoteControlWebsocketRoute_h_Statics::ScriptStructInfo[] = {
		{ FRCRequest::StaticStruct, Z_Construct_UScriptStruct_FRCRequest_Statics::NewStructOps, TEXT("RCRequest"), &Z_Registration_Info_UScriptStruct_RCRequest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRCRequest), 3266649520U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControl_Source_WebRemoteControl_Public_RemoteControlWebsocketRoute_h_2957467142(TEXT("/Script/WebRemoteControl"),
		nullptr, 0,
