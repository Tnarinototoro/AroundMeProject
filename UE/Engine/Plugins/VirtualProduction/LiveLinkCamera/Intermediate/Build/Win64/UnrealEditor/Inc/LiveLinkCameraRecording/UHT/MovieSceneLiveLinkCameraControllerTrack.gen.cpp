...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::NewProp_Sections = { "Sections", nullptr, (EPropertyFlags)0x0024088000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneLiveLinkCameraControllerTrack, Sections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::NewProp_Sections_MetaData), Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::NewProp_Sections_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::ClassParams = {
		...
		0,
		0x00B000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkCamera_Source_LiveLinkCameraRecording_Private_MovieSceneLiveLinkCameraControllerTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneLiveLinkCameraControllerTrack, UMovieSceneLiveLinkCameraControllerTrack::StaticClass, TEXT("UMovieSceneLiveLinkCameraControllerTrack"), &Z_Registration_Info_UClass_UMovieSceneLiveLinkCameraControllerTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneLiveLinkCameraControllerTrack), 147515888U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkCamera_Source_LiveLinkCameraRecording_Private_MovieSceneLiveLinkCameraControllerTrack_h_3989435238(TEXT("/Script/LiveLinkCameraRecording"),
