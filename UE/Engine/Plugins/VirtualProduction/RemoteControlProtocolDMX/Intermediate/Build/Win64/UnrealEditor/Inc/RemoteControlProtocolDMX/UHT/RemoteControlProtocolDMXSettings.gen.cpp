...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RemoteControlProtocolDMXSettings_eventGetOrCreateDefaultInputPortId_Parms, ReturnValue), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URemoteControlProtocolDMXSettings, nullptr, "GetOrCreateDefaultInputPortId", nullptr, nullptr, Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::PropPointers), sizeof(Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::RemoteControlProtocolDMXSettings_eventGetOrCreateDefaultInputPortId_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::Function_MetaDataParams), Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId_Statics::RemoteControlProtocolDMXSettings_eventGetOrCreateDefaultInputPortId_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolDMXSettings_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_URemoteControlProtocolDMXSettings_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URemoteControlProtocolDMXSettings_GetOrCreateDefaultInputPortId, "GetOrCreateDefaultInputPortId" }, // 966196427
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolDMXSettings_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlProtocolDMXSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolDMXSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlProtocolDMXSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolDMXSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControlProtocolDMX_Source_RemoteControlProtocolDMX_Public_RemoteControlProtocolDMXSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlProtocolDMXSettings, URemoteControlProtocolDMXSettings::StaticClass, TEXT("URemoteControlProtocolDMXSettings"), &Z_Registration_Info_UClass_URemoteControlProtocolDMXSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlProtocolDMXSettings), 3613529538U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControlProtocolDMX_Source_RemoteControlProtocolDMX_Public_RemoteControlProtocolDMXSettings_h_139992963(TEXT("/Script/RemoteControlProtocolDMX"),
