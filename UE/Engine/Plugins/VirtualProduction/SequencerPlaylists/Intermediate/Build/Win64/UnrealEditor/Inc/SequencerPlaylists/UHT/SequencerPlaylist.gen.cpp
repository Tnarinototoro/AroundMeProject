...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylist_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_USequencerPlaylist_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010010000020005, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USequencerPlaylist, Description), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylist_Statics::NewProp_Description_MetaData), Z_Construct_UClass_USequencerPlaylist_Statics::NewProp_Description_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USequencerPlaylist_Statics::NewProp_Items_Inner = { "Items", nullptr, (EPropertyFlags)0x0004000000020000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_USequencerPlaylistItem_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USequencerPlaylist_Statics::NewProp_Items = { "Items", nullptr, (EPropertyFlags)0x0014000000020005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USequencerPlaylist, Items), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylist_Statics::NewProp_Items_MetaData), Z_Construct_UClass_USequencerPlaylist_Statics::NewProp_Items_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USequencerPlaylist_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylist_Statics::Class_MetaDataParams), Z_Construct_UClass_USequencerPlaylist_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylist_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_SequencerPlaylists_Source_SequencerPlaylists_Public_SequencerPlaylist_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USequencerPlaylist, USequencerPlaylist::StaticClass, TEXT("USequencerPlaylist"), &Z_Registration_Info_UClass_USequencerPlaylist, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USequencerPlaylist), 3950694024U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_SequencerPlaylists_Source_SequencerPlaylists_Public_SequencerPlaylist_h_475857985(TEXT("/Script/SequencerPlaylists"),
