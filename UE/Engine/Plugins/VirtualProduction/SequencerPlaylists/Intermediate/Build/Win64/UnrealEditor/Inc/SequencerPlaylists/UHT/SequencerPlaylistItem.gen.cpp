...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_StartFrameOffset = { "StartFrameOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USequencerPlaylistItem, StartFrameOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_StartFrameOffset_MetaData), Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_StartFrameOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_EndFrameOffset = { "EndFrameOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USequencerPlaylistItem, EndFrameOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_EndFrameOffset_MetaData), Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_EndFrameOffset_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bHoldAtFirstFrame = { "bHoldAtFirstFrame", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USequencerPlaylistItem), &Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bHoldAtFirstFrame_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bHoldAtFirstFrame_MetaData), Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bHoldAtFirstFrame_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_NumLoops = { "NumLoops", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USequencerPlaylistItem, NumLoops), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_NumLoops_MetaData), Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_NumLoops_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_PlaybackSpeed = { "PlaybackSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USequencerPlaylistItem, PlaybackSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_PlaybackSpeed_MetaData), Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_PlaybackSpeed_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bMute = { "bMute", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(USequencerPlaylistItem), &Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bMute_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bMute_MetaData), Z_Construct_UClass_USequencerPlaylistItem_Statics::NewProp_bMute_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USequencerPlaylistItem_Statics::ClassParams = {
		...
		0,
		0x000000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::Class_MetaDataParams), Z_Construct_UClass_USequencerPlaylistItem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerPlaylistItem_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_SequencerPlaylists_Source_SequencerPlaylists_Public_SequencerPlaylistItem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USequencerPlaylistItem, USequencerPlaylistItem::StaticClass, TEXT("USequencerPlaylistItem"), &Z_Registration_Info_UClass_USequencerPlaylistItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USequencerPlaylistItem), 230524613U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_SequencerPlaylists_Source_SequencerPlaylists_Public_SequencerPlaylistItem_h_3763594304(TEXT("/Script/SequencerPlaylists"),
