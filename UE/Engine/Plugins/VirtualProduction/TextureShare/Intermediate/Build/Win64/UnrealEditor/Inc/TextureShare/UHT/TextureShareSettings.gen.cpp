...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTextureShareSettings_Statics::NewProp_bCreateDefaults = { "bCreateDefaults", nullptr, (EPropertyFlags)0x0020080800004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTextureShareSettings), &Z_Construct_UClass_UTextureShareSettings_Statics::NewProp_bCreateDefaults_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareSettings_Statics::NewProp_bCreateDefaults_MetaData), Z_Construct_UClass_UTextureShareSettings_Statics::NewProp_bCreateDefaults_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UTextureShareSettings_Statics::NewProp_ProcessName = { "ProcessName", nullptr, (EPropertyFlags)0x0020080800004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTextureShareSettings, ProcessName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareSettings_Statics::NewProp_ProcessName_MetaData), Z_Construct_UClass_UTextureShareSettings_Statics::NewProp_ProcessName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTextureShareSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UTextureShareSettings_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareSettings_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_TextureShare_Source_TextureShare_Private_Game_Settings_TextureShareSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTextureShareSettings, UTextureShareSettings::StaticClass, TEXT("UTextureShareSettings"), &Z_Registration_Info_UClass_UTextureShareSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextureShareSettings), 1612986255U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_TextureShare_Source_TextureShare_Private_Game_Settings_TextureShareSettings_h_2064023691(TEXT("/Script/TextureShare"),
