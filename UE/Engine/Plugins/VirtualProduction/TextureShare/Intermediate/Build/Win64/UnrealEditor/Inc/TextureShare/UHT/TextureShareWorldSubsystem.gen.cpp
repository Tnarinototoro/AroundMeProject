...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TextureShareWorldSubsystem_eventGetTextureShare_Parms, ReturnValue), Z_Construct_UClass_UTextureShare_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTextureShareWorldSubsystem, nullptr, "GetTextureShare", nullptr, nullptr, Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::PropPointers), sizeof(Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::TextureShareWorldSubsystem_eventGetTextureShare_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare_Statics::TextureShareWorldSubsystem_eventGetTextureShare_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTextureShareWorldSubsystem_GetTextureShare, "GetTextureShare" }, // 3882804373
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::NewProp_TextureShare = { "TextureShare", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTextureShareWorldSubsystem, TextureShare), Z_Construct_UClass_UTextureShare_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::NewProp_TextureShare_MetaData), Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::NewProp_TextureShare_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTextureShareWorldSubsystem_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_TextureShare_Source_TextureShare_Private_Game_WorldSubsystem_TextureShareWorldSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTextureShareWorldSubsystem, UTextureShareWorldSubsystem::StaticClass, TEXT("UTextureShareWorldSubsystem"), &Z_Registration_Info_UClass_UTextureShareWorldSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextureShareWorldSubsystem), 1587562300U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_TextureShare_Source_TextureShare_Private_Game_WorldSubsystem_TextureShareWorldSubsystem_h_2077021723(TEXT("/Script/TextureShare"),
