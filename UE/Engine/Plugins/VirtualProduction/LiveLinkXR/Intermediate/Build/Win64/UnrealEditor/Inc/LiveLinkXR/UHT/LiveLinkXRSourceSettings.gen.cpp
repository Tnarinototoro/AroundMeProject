...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::NewProp_LocalUpdateRateInHz = { "LocalUpdateRateInHz", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULiveLinkXRSourceSettings, LocalUpdateRateInHz), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::NewProp_LocalUpdateRateInHz_MetaData), Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::NewProp_LocalUpdateRateInHz_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkXRSourceSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkXR_Source_LiveLinkXR_Public_LiveLinkXRSourceSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkXRSourceSettings, ULiveLinkXRSourceSettings::StaticClass, TEXT("ULiveLinkXRSourceSettings"), &Z_Registration_Info_UClass_ULiveLinkXRSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkXRSourceSettings), 2857602197U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkXR_Source_LiveLinkXR_Public_LiveLinkXRSourceSettings_h_129112760(TEXT("/Script/LiveLinkXR"),
