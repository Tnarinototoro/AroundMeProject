...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SwitchboardProjectSettings_eventGetSwitchboardProjectSettings_Parms, ReturnValue), Z_Construct_UClass_USwitchboardProjectSettings_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USwitchboardProjectSettings, nullptr, "GetSwitchboardProjectSettings", nullptr, nullptr, Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::SwitchboardProjectSettings_eventGetSwitchboardProjectSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings_Statics::SwitchboardProjectSettings_eventGetSwitchboardProjectSettings_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USwitchboardProjectSettings_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_USwitchboardProjectSettings_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USwitchboardProjectSettings_GetSwitchboardProjectSettings, "GetSwitchboardProjectSettings" }, // 372322683
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USwitchboardProjectSettings_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USwitchboardProjectSettings_Statics::NewProp_SwitchboardOSCListener = { "SwitchboardOSCListener", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USwitchboardProjectSettings, SwitchboardOSCListener), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USwitchboardProjectSettings_Statics::NewProp_SwitchboardOSCListener_MetaData), Z_Construct_UClass_USwitchboardProjectSettings_Statics::NewProp_SwitchboardOSCListener_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USwitchboardProjectSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USwitchboardProjectSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_USwitchboardProjectSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USwitchboardProjectSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Switchboard_Source_SwitchboardEditor_Public_SwitchboardProjectSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USwitchboardProjectSettings, USwitchboardProjectSettings::StaticClass, TEXT("USwitchboardProjectSettings"), &Z_Registration_Info_UClass_USwitchboardProjectSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USwitchboardProjectSettings), 370062068U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Switchboard_Source_SwitchboardEditor_Public_SwitchboardProjectSettings_h_3684753266(TEXT("/Script/SwitchboardEditor"),
