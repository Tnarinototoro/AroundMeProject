...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaSourceFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URivermaxMediaSourceFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaSourceFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_URivermaxMediaSourceFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMediaEditor_Private_RivermaxMediaSourceFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URivermaxMediaSourceFactoryNew, URivermaxMediaSourceFactoryNew::StaticClass, TEXT("URivermaxMediaSourceFactoryNew"), &Z_Registration_Info_UClass_URivermaxMediaSourceFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URivermaxMediaSourceFactoryNew), 4206462421U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMediaEditor_Private_RivermaxMediaSourceFactoryNew_h_2807518461(TEXT("/Script/RivermaxMediaEditor"),
