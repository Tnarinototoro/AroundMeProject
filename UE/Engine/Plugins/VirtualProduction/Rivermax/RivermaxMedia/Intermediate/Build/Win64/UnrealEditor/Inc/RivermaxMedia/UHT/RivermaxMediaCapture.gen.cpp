...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaCapture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URivermaxMediaCapture_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaCapture_Statics::Class_MetaDataParams), Z_Construct_UClass_URivermaxMediaCapture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMedia_Public_RivermaxMediaCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URivermaxMediaCapture, URivermaxMediaCapture::StaticClass, TEXT("URivermaxMediaCapture"), &Z_Registration_Info_UClass_URivermaxMediaCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URivermaxMediaCapture), 1727016118U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMedia_Public_RivermaxMediaCapture_h_1148373439(TEXT("/Script/RivermaxMedia"),
