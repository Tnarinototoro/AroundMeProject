...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxCustomTimeStep_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxCustomTimeStep, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_FrameRate_MetaData), Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_FrameRate_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_bEnableOverrunDetection = { "bEnableOverrunDetection", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URivermaxCustomTimeStep), &Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_bEnableOverrunDetection_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_bEnableOverrunDetection_MetaData), Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_bEnableOverrunDetection_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_InitializedEngine = { "InitializedEngine", nullptr, (EPropertyFlags)0x0044000800002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxCustomTimeStep, InitializedEngine), Z_Construct_UClass_UEngine_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_InitializedEngine_MetaData), Z_Construct_UClass_URivermaxCustomTimeStep_Statics::NewProp_InitializedEngine_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URivermaxCustomTimeStep_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxCustomTimeStep_Statics::Class_MetaDataParams), Z_Construct_UClass_URivermaxCustomTimeStep_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxCustomTimeStep_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMedia_Public_RivermaxCustomTimeStep_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URivermaxCustomTimeStep, URivermaxCustomTimeStep::StaticClass, TEXT("URivermaxCustomTimeStep"), &Z_Registration_Info_UClass_URivermaxCustomTimeStep, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URivermaxCustomTimeStep), 3128213301U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMedia_Public_RivermaxCustomTimeStep_h_781008533(TEXT("/Script/RivermaxMedia"),
