...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutputFactoryNew_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URivermaxMediaOutputFactoryNew_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutputFactoryNew_Statics::Class_MetaDataParams), Z_Construct_UClass_URivermaxMediaOutputFactoryNew_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMediaEditor_Private_RivermaxMediaOutputFactoryNew_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URivermaxMediaOutputFactoryNew, URivermaxMediaOutputFactoryNew::StaticClass, TEXT("URivermaxMediaOutputFactoryNew"), &Z_Registration_Info_UClass_URivermaxMediaOutputFactoryNew, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URivermaxMediaOutputFactoryNew), 931522602U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMediaEditor_Private_RivermaxMediaOutputFactoryNew_h_1164512005(TEXT("/Script/RivermaxMediaEditor"),
