...
// Cross Module References
	...
	RIVERMAXMEDIA_API UEnum* Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode();
...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaOutputPixelFormat_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaOutputPixelFormat_Statics::Enum_MetaDataParams), Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaOutputPixelFormat_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaAlignmentMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaAlignmentMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaAlignmentMode_Statics::Enum_MetaDataParams)
	};
	...
	static FEnumRegistrationInfo Z_Registration_Info_UEnum_ERivermaxFrameLockingMode;
	static UEnum* ERivermaxFrameLockingMode_StaticEnum()
	{
		if (!Z_Registration_Info_UEnum_ERivermaxFrameLockingMode.OuterSingleton)
		{
			Z_Registration_Info_UEnum_ERivermaxFrameLockingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode, (UObject*)Z_Construct_UPackage__Script_RivermaxMedia(), TEXT("ERivermaxFrameLockingMode"));
		}
		return Z_Registration_Info_UEnum_ERivermaxFrameLockingMode.OuterSingleton;
	}
	template<> RIVERMAXMEDIA_API UEnum* StaticEnum<ERivermaxFrameLockingMode>()
	{
		return ERivermaxFrameLockingMode_StaticEnum();
	}
	struct Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::Enumerators[] = {
		{ "ERivermaxFrameLockingMode::FreeRun", (int64)ERivermaxFrameLockingMode::FreeRun },
		{ "ERivermaxFrameLockingMode::BlockOnReservation", (int64)ERivermaxFrameLockingMode::BlockOnReservation },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::Enum_MetaDataParams[] = {
		{ "BlockOnReservation.Comment", "/** Blocks RHI thread prior to capture the current frame if no space is available. */" },
		{ "BlockOnReservation.Name", "ERivermaxFrameLockingMode::BlockOnReservation" },
		{ "BlockOnReservation.ToolTip", "Blocks RHI thread prior to capture the current frame if no space is available." },
		{ "Comment", "/** \n * Controls how rivermax capture behaves when there are no buffers available to capture into\n */" },
		{ "FreeRun.Comment", "/** If no frame available, continue */" },
		{ "FreeRun.Name", "ERivermaxFrameLockingMode::FreeRun" },
		{ "FreeRun.ToolTip", "If no frame available, continue" },
		{ "ModuleRelativePath", "Public/RivermaxMediaOutput.h" },
		{ "ToolTip", "Controls how rivermax capture behaves when there are no buffers available to capture into" },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_RivermaxMedia,
		nullptr,
		"ERivermaxFrameLockingMode",
		"ERivermaxFrameLockingMode",
		Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::Enumerators,
		RF_Public|RF_Transient|RF_MarkAsNative,
		UE_ARRAY_COUNT(Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::Enumerators),
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::Enum_MetaDataParams)
	};
	UEnum* Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode()
	{
		if (!Z_Registration_Info_UEnum_ERivermaxFrameLockingMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ERivermaxFrameLockingMode.InnerSingleton, Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_ERivermaxFrameLockingMode.InnerSingleton;
	}
	...
	struct Z_Construct_UClass_URivermaxMediaOutput_Statics
	{
		...
		static const UECodeGen_Private::FBytePropertyParams NewProp_FrameLockingMode_Underlying;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_FrameLockingMode_MetaData[];
#endif
		static const UECodeGen_Private::FEnumPropertyParams NewProp_FrameLockingMode;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_PresentationQueueSize_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_PresentationQueueSize;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_AlignmentMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_AlignmentMode = { "AlignmentMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, AlignmentMode), Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaAlignmentMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_AlignmentMode_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_AlignmentMode_MetaData) }; // 463452230
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoContinuousOutput = { "bDoContinuousOutput", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URivermaxMediaOutput), &Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoContinuousOutput_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoContinuousOutput_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoContinuousOutput_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameLockingMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameLockingMode_MetaData[] = {
		{ "Category", "Output" },
		{ "Comment", "/** For alignment point mode, controls whether we stall engine before capturing if there are no buffer available to capture into */" },
		{ "ModuleRelativePath", "Public/RivermaxMediaOutput.h" },
		{ "ToolTip", "For alignment point mode, controls whether we stall engine before capturing if there are no buffer available to capture into" },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameLockingMode = { "FrameLockingMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, FrameLockingMode), Z_Construct_UEnum_RivermaxMedia_ERivermaxFrameLockingMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameLockingMode_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameLockingMode_MetaData) }; // 57991953
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PresentationQueueSize_MetaData[] = {
		{ "Category", "Output" },
		{ "ClampMax", "8" },
		{ "ClampMin", "2" },
		{ "Comment", "/** Number of frames that can be queued / used in output queue. Frame being sent counts for 1. */" },
		{ "ModuleRelativePath", "Public/RivermaxMediaOutput.h" },
		{ "ToolTip", "Number of frames that can be queued / used in output queue. Frame being sent counts for 1." },
		{ "UIMax", "8" },
		{ "UIMin", "2" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PresentationQueueSize = { "PresentationQueueSize", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, PresentationQueueSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PresentationQueueSize_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PresentationQueueSize_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoFrameCounterTimestamping = { "bDoFrameCounterTimestamping", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URivermaxMediaOutput), &Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoFrameCounterTimestamping_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoFrameCounterTimestamping_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bDoFrameCounterTimestamping_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bOverrideResolution = { "bOverrideResolution", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URivermaxMediaOutput), &Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bOverrideResolution_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bOverrideResolution_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bOverrideResolution_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_Resolution = { "Resolution", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, Resolution), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_Resolution_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_Resolution_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameRate_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameRate_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PixelFormat_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PixelFormat = { "PixelFormat", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, PixelFormat), Z_Construct_UEnum_RivermaxMedia_ERivermaxMediaOutputPixelFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PixelFormat_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PixelFormat_MetaData) }; // 3618849759
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_InterfaceAddress = { "InterfaceAddress", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, InterfaceAddress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_InterfaceAddress_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_InterfaceAddress_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_StreamAddress = { "StreamAddress", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, StreamAddress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_StreamAddress_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_StreamAddress_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_Port = { "Port", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxMediaOutput, Port), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_Port_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_Port_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bUseGPUDirect = { "bUseGPUDirect", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(URivermaxMediaOutput), &Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bUseGPUDirect_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bUseGPUDirect_MetaData), Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_bUseGPUDirect_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_URivermaxMediaOutput_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameLockingMode_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_FrameLockingMode,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_URivermaxMediaOutput_Statics::NewProp_PresentationQueueSize,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URivermaxMediaOutput_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_URivermaxMediaOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxMediaOutput_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMedia_Public_RivermaxMediaOutput_h_Statics::EnumInfo[] = {
		{ ERivermaxMediaOutputPixelFormat_StaticEnum, TEXT("ERivermaxMediaOutputPixelFormat"), &Z_Registration_Info_UEnum_ERivermaxMediaOutputPixelFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3618849759U) },
		{ ERivermaxMediaAlignmentMode_StaticEnum, TEXT("ERivermaxMediaAlignmentMode"), &Z_Registration_Info_UEnum_ERivermaxMediaAlignmentMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 463452230U) },
		{ ERivermaxFrameLockingMode_StaticEnum, TEXT("ERivermaxFrameLockingMode"), &Z_Registration_Info_UEnum_ERivermaxFrameLockingMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 57991953U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMedia_Public_RivermaxMediaOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URivermaxMediaOutput, URivermaxMediaOutput::StaticClass, TEXT("URivermaxMediaOutput"), &Z_Registration_Info_UClass_URivermaxMediaOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URivermaxMediaOutput), 4059002718U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxMedia_Source_RivermaxMedia_Public_RivermaxMediaOutput_h_1582674006(TEXT("/Script/RivermaxMedia"),
