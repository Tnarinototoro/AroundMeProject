...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_RivermaxCore_ERivermaxTimeSource_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_RivermaxCore_ERivermaxTimeSource_Statics::Enum_MetaDataParams), Z_Construct_UEnum_RivermaxCore_ERivermaxTimeSource_Statics::Enum_MetaDataParams)
	};
...
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_TimeSource_Underlying;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_URivermaxSettings_Statics::NewProp_TimeSource_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_URivermaxSettings_Statics::NewProp_TimeSource = { "TimeSource", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxSettings, TimeSource), Z_Construct_UEnum_RivermaxCore_ERivermaxTimeSource, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxSettings_Statics::NewProp_TimeSource_MetaData), Z_Construct_UClass_URivermaxSettings_Statics::NewProp_TimeSource_MetaData) }; // 423075024
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_URivermaxSettings_Statics::NewProp_PTPInterfaceAddress = { "PTPInterfaceAddress", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URivermaxSettings, PTPInterfaceAddress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxSettings_Statics::NewProp_PTPInterfaceAddress_MetaData), Z_Construct_UClass_URivermaxSettings_Statics::NewProp_PTPInterfaceAddress_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URivermaxSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_URivermaxSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URivermaxSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxCore_Source_RivermaxCore_Public_RivermaxSettings_h_Statics::EnumInfo[] = {
		{ ERivermaxTimeSource_StaticEnum, TEXT("ERivermaxTimeSource"), &Z_Registration_Info_UEnum_ERivermaxTimeSource, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 423075024U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxCore_Source_RivermaxCore_Public_RivermaxSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URivermaxSettings, URivermaxSettings::StaticClass, TEXT("URivermaxSettings"), &Z_Registration_Info_UClass_URivermaxSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URivermaxSettings), 1862222708U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_Rivermax_RivermaxCore_Source_RivermaxCore_Public_RivermaxSettings_h_3594654148(TEXT("/Script/RivermaxCore"),
