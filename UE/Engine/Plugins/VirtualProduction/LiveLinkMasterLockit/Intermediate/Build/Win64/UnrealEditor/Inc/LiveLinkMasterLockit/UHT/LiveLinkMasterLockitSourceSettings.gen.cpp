...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkMasterLockitSourceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULiveLinkMasterLockitSourceSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkMasterLockitSourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_ULiveLinkMasterLockitSourceSettings_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkMasterLockit_Source_LiveLinkMasterLockit_Private_LiveLinkMasterLockitSourceSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULiveLinkMasterLockitSourceSettings, ULiveLinkMasterLockitSourceSettings::StaticClass, TEXT("ULiveLinkMasterLockitSourceSettings"), &Z_Registration_Info_UClass_ULiveLinkMasterLockitSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULiveLinkMasterLockitSourceSettings), 3069542658U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_LiveLinkMasterLockit_Source_LiveLinkMasterLockit_Private_LiveLinkMasterLockitSourceSettings_h_3605701205(TEXT("/Script/LiveLinkMasterLockit"),
