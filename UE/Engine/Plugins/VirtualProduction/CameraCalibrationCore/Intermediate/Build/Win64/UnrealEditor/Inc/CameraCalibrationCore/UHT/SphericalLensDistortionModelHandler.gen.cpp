...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USphericalLensDistortionModelHandler_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USphericalLensDistortionModelHandler_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USphericalLensDistortionModelHandler_Statics::Class_MetaDataParams), Z_Construct_UClass_USphericalLensDistortionModelHandler_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_SphericalLensDistortionModelHandler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USphericalLensDistortionModelHandler, USphericalLensDistortionModelHandler::StaticClass, TEXT("USphericalLensDistortionModelHandler"), &Z_Registration_Info_UClass_USphericalLensDistortionModelHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USphericalLensDistortionModelHandler), 4015239908U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_SphericalLensDistortionModelHandler_h_2576176669(TEXT("/Script/CameraCalibrationCore"),
