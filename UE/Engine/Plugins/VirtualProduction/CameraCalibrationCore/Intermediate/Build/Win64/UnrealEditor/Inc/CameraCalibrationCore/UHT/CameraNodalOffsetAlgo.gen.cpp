...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgo_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCameraNodalOffsetAlgo_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraNodalOffsetAlgo_Statics::Class_MetaDataParams), Z_Construct_UClass_UCameraNodalOffsetAlgo_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraNodalOffsetAlgo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraNodalOffsetAlgo, UCameraNodalOffsetAlgo::StaticClass, TEXT("UCameraNodalOffsetAlgo"), &Z_Registration_Info_UClass_UCameraNodalOffsetAlgo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraNodalOffsetAlgo), 1643513403U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraNodalOffsetAlgo_h_3296159137(TEXT("/Script/CameraCalibrationCore"),
