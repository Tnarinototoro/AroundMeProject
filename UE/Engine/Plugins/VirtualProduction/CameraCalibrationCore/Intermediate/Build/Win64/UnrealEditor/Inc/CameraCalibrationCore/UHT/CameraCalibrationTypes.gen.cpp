...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FDistortionHandlerPicker>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_TargetCameraComponent = { "TargetCameraComponent", nullptr, (EPropertyFlags)0x001400000008200c, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionHandlerPicker, TargetCameraComponent), Z_Construct_UClass_UCineCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_TargetCameraComponent_MetaData), Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_TargetCameraComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_DistortionProducerID = { "DistortionProducerID", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionHandlerPicker, DistortionProducerID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_DistortionProducerID_MetaData), Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_DistortionProducerID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_HandlerDisplayName = { "HandlerDisplayName", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionHandlerPicker, HandlerDisplayName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_HandlerDisplayName_MetaData), Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewProp_HandlerDisplayName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraCalibrationTypes_h_Statics::ScriptStructInfo[] = {
		{ FDistortionHandlerPicker::StaticStruct, Z_Construct_UScriptStruct_FDistortionHandlerPicker_Statics::NewStructOps, TEXT("DistortionHandlerPicker"), &Z_Registration_Info_UScriptStruct_DistortionHandlerPicker, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDistortionHandlerPicker), 4255137559U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraCalibrationTypes_h_1867161013(TEXT("/Script/CameraCalibrationCore"),
		nullptr, 0,
