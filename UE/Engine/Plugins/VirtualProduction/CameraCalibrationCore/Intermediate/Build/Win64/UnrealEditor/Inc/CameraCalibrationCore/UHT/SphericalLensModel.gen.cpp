...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FSphericalDistortionParameters>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K1 = { "K1", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSphericalDistortionParameters, K1), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K1_MetaData), Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K1_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K2 = { "K2", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSphericalDistortionParameters, K2), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K2_MetaData), Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K2_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K3 = { "K3", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSphericalDistortionParameters, K3), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K3_MetaData), Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_K3_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_P1 = { "P1", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSphericalDistortionParameters, P1), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_P1_MetaData), Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_P1_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_P2 = { "P2", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSphericalDistortionParameters, P2), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_P2_MetaData), Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::NewProp_P2_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSphericalDistortionParameters_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USphericalLensModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USphericalLensModel_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USphericalLensModel_Statics::Class_MetaDataParams), Z_Construct_UClass_USphericalLensModel_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Models_SphericalLensModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USphericalLensModel, USphericalLensModel::StaticClass, TEXT("USphericalLensModel"), &Z_Registration_Info_UClass_USphericalLensModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USphericalLensModel), 1878713671U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Models_SphericalLensModel_h_4075043585(TEXT("/Script/CameraCalibrationCore"),
