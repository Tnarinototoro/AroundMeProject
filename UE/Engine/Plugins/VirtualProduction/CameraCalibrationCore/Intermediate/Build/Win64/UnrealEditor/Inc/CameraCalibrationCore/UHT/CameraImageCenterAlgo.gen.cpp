...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraImageCenterAlgo_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCameraImageCenterAlgo_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraImageCenterAlgo_Statics::Class_MetaDataParams), Z_Construct_UClass_UCameraImageCenterAlgo_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraImageCenterAlgo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraImageCenterAlgo, UCameraImageCenterAlgo::StaticClass, TEXT("UCameraImageCenterAlgo"), &Z_Registration_Info_UClass_UCameraImageCenterAlgo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraImageCenterAlgo), 299867594U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraImageCenterAlgo_h_4086767492(TEXT("/Script/CameraCalibrationCore"),
