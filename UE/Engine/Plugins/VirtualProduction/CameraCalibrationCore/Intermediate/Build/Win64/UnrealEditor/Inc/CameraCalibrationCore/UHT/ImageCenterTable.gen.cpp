...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FImageCenterFocusPoint>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Focus = { "Focus", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FImageCenterFocusPoint, Focus), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Focus_MetaData), Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Focus_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Cx = { "Cx", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FImageCenterFocusPoint, Cx), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Cx_MetaData), Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Cx_MetaData) }; // 4189057203
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Cy = { "Cy", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FImageCenterFocusPoint, Cy), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Cy_MetaData), Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewProp_Cy_MetaData) }; // 4189057203
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FImageCenterTable>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FImageCenterTable_Statics::NewProp_FocusPoints_Inner = { "FocusPoints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FImageCenterFocusPoint, METADATA_PARAMS(0, nullptr) }; // 999714937
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FImageCenterTable_Statics::NewProp_FocusPoints = { "FocusPoints", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FImageCenterTable, FocusPoints), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterTable_Statics::NewProp_FocusPoints_MetaData), Z_Construct_UScriptStruct_FImageCenterTable_Statics::NewProp_FocusPoints_MetaData) }; // 999714937
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FImageCenterTable_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterTable_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FImageCenterTable_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterTable_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Tables_ImageCenterTable_h_Statics::ScriptStructInfo[] = {
		{ FImageCenterFocusPoint::StaticStruct, Z_Construct_UScriptStruct_FImageCenterFocusPoint_Statics::NewStructOps, TEXT("ImageCenterFocusPoint"), &Z_Registration_Info_UScriptStruct_ImageCenterFocusPoint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FImageCenterFocusPoint), 999714937U) },
		{ FImageCenterTable::StaticStruct, Z_Construct_UScriptStruct_FImageCenterTable_Statics::NewStructOps, TEXT("ImageCenterTable"), &Z_Registration_Info_UScriptStruct_ImageCenterTable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FImageCenterTable), 883013054U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Tables_ImageCenterTable_h_1888642988(TEXT("/Script/CameraCalibrationCore"),
		nullptr, 0,
