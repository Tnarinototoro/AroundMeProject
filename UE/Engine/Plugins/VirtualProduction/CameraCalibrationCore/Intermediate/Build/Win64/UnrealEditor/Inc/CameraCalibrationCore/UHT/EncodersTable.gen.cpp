...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FEncodersTable>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEncodersTable_Statics::NewProp_Focus = { "Focus", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEncodersTable, Focus), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncodersTable_Statics::NewProp_Focus_MetaData), Z_Construct_UScriptStruct_FEncodersTable_Statics::NewProp_Focus_MetaData) }; // 4189057203
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEncodersTable_Statics::NewProp_Iris = { "Iris", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEncodersTable, Iris), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncodersTable_Statics::NewProp_Iris_MetaData), Z_Construct_UScriptStruct_FEncodersTable_Statics::NewProp_Iris_MetaData) }; // 4189057203
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FEncodersTable_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncodersTable_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FEncodersTable_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEncodersTable_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Tables_EncodersTable_h_Statics::ScriptStructInfo[] = {
		{ FEncodersTable::StaticStruct, Z_Construct_UScriptStruct_FEncodersTable_Statics::NewStructOps, TEXT("EncodersTable"), &Z_Registration_Info_UScriptStruct_EncodersTable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEncodersTable), 2114404232U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Tables_EncodersTable_h_3658526633(TEXT("/Script/CameraCalibrationCore"),
		nullptr, 0,
