...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::NewProp_Sections_Inner = { "Sections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::NewProp_Sections = { "Sections", nullptr, (EPropertyFlags)0x0024088000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneLensComponentTrack, Sections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::NewProp_Sections_MetaData), Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::NewProp_Sections_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::ClassParams = {
		...
		0,
		0x00B000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLensComponentTrack_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCoreMovieScene_Public_MovieSceneLensComponentTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneLensComponentTrack, UMovieSceneLensComponentTrack::StaticClass, TEXT("UMovieSceneLensComponentTrack"), &Z_Registration_Info_UClass_UMovieSceneLensComponentTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneLensComponentTrack), 1779598800U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCoreMovieScene_Public_MovieSceneLensComponentTrack_h_1340783261(TEXT("/Script/CameraCalibrationCoreMovieScene"),
