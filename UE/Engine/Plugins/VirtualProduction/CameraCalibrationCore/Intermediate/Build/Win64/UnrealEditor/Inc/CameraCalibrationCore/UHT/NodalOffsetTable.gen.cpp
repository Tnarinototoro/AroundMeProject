...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FNodalOffsetFocusPoint>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_Focus = { "Focus", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNodalOffsetFocusPoint, Focus), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_Focus_MetaData), Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_Focus_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_LocationOffset = { "LocationOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(LocationOffset, FNodalOffsetFocusPoint), STRUCT_OFFSET(FNodalOffsetFocusPoint, LocationOffset), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_LocationOffset_MetaData), Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_LocationOffset_MetaData) }; // 4189057203
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_RotationOffset = { "RotationOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, CPP_ARRAY_DIM(RotationOffset, FNodalOffsetFocusPoint), STRUCT_OFFSET(FNodalOffsetFocusPoint, RotationOffset), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_RotationOffset_MetaData), Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewProp_RotationOffset_MetaData) }; // 4189057203
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FNodalOffsetTable>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::NewProp_FocusPoints_Inner = { "FocusPoints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNodalOffsetFocusPoint, METADATA_PARAMS(0, nullptr) }; // 3529507700
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::NewProp_FocusPoints = { "FocusPoints", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNodalOffsetTable, FocusPoints), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::NewProp_FocusPoints_MetaData), Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::NewProp_FocusPoints_MetaData) }; // 3529507700
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Tables_NodalOffsetTable_h_Statics::ScriptStructInfo[] = {
		{ FNodalOffsetFocusPoint::StaticStruct, Z_Construct_UScriptStruct_FNodalOffsetFocusPoint_Statics::NewStructOps, TEXT("NodalOffsetFocusPoint"), &Z_Registration_Info_UScriptStruct_NodalOffsetFocusPoint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNodalOffsetFocusPoint), 3529507700U) },
		{ FNodalOffsetTable::StaticStruct, Z_Construct_UScriptStruct_FNodalOffsetTable_Statics::NewStructOps, TEXT("NodalOffsetTable"), &Z_Registration_Info_UScriptStruct_NodalOffsetTable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNodalOffsetTable), 3671798441U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_Tables_NodalOffsetTable_h_1965847903(TEXT("/Script/CameraCalibrationCore"),
		nullptr, 0,
