...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnamorphicLensDistortionModelHandler_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnamorphicLensDistortionModelHandler_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnamorphicLensDistortionModelHandler_Statics::Class_MetaDataParams), Z_Construct_UClass_UAnamorphicLensDistortionModelHandler_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_AnamorphicLensDistortionModelHandler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnamorphicLensDistortionModelHandler, UAnamorphicLensDistortionModelHandler::StaticClass, TEXT("UAnamorphicLensDistortionModelHandler"), &Z_Registration_Info_UClass_UAnamorphicLensDistortionModelHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnamorphicLensDistortionModelHandler), 2834259806U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_AnamorphicLensDistortionModelHandler_h_4263478896(TEXT("/Script/CameraCalibrationCore"),
