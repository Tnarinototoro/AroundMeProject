...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraLensDistortionAlgo_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCameraLensDistortionAlgo_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraLensDistortionAlgo_Statics::Class_MetaDataParams), Z_Construct_UClass_UCameraLensDistortionAlgo_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraLensDistortionAlgo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraLensDistortionAlgo, UCameraLensDistortionAlgo::StaticClass, TEXT("UCameraLensDistortionAlgo"), &Z_Registration_Info_UClass_UCameraLensDistortionAlgo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraLensDistortionAlgo), 759484447U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_CameraLensDistortionAlgo_h_1776737623(TEXT("/Script/CameraCalibrationCore"),
