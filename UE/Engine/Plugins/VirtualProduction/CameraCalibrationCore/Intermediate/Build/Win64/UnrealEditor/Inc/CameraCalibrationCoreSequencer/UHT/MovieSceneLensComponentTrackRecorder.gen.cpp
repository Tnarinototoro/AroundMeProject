...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLensComponentTrackRecorder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLensComponentTrackRecorder_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneLensComponentTrackRecorder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneLensComponentTrackRecorder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCoreSequencer_Private_MovieSceneLensComponentTrackRecorder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneLensComponentTrackRecorder, UMovieSceneLensComponentTrackRecorder::StaticClass, TEXT("UMovieSceneLensComponentTrackRecorder"), &Z_Registration_Info_UClass_UMovieSceneLensComponentTrackRecorder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneLensComponentTrackRecorder), 4112964805U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCoreSequencer_Private_MovieSceneLensComponentTrackRecorder_h_4161512684(TEXT("/Script/CameraCalibrationCoreSequencer"),
