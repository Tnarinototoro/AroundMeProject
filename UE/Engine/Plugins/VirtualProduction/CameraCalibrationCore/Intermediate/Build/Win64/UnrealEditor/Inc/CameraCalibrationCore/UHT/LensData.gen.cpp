...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FLensInfo>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensModelName = { "LensModelName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLensInfo, LensModelName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensModelName_MetaData), Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensModelName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensSerialNumber = { "LensSerialNumber", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLensInfo, LensSerialNumber), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensSerialNumber_MetaData), Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensSerialNumber_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensModel = { "LensModel", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLensInfo, LensModel), Z_Construct_UClass_UClass, Z_Construct_UClass_ULensModel_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensModel_MetaData), Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_LensModel_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SensorDimensions = { "SensorDimensions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLensInfo, SensorDimensions), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SensorDimensions_MetaData), Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SensorDimensions_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_ImageDimensions = { "ImageDimensions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLensInfo, ImageDimensions), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_ImageDimensions_MetaData), Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_ImageDimensions_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SqueezeFactor_MetaData[] = {
		{ "Category", "Camera Info" },
		{ "Comment", "/** Squeeze Factor (or Pixel Aspect) for anamorphic lenses. Spherical Lenses should keep this default to 1.0f */" },
		{ "ModuleRelativePath", "Public/LensData.h" },
		{ "ToolTip", "Squeeze Factor (or Pixel Aspect) for anamorphic lenses. Spherical Lenses should keep this default to 1.0f" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SqueezeFactor = { "SqueezeFactor", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLensInfo, SqueezeFactor), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SqueezeFactor_MetaData), Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SqueezeFactor_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FLensInfo_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FLensInfo_Statics::NewProp_SqueezeFactor,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLensInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FLensInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLensInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FCameraFeedInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::NewProp_Dimensions = { "Dimensions", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCameraFeedInfo, Dimensions), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::NewProp_Dimensions_MetaData), Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::NewProp_Dimensions_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::NewProp_AspectRatio = { "AspectRatio", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCameraFeedInfo, AspectRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::NewProp_AspectRatio_MetaData), Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::NewProp_AspectRatio_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FSimulcamInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_MediaResolution = { "MediaResolution", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSimulcamInfo, MediaResolution), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_MediaResolution_MetaData), Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_MediaResolution_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_MediaPlateAspectRatio = { "MediaPlateAspectRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSimulcamInfo, MediaPlateAspectRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_MediaPlateAspectRatio_MetaData), Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_MediaPlateAspectRatio_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_CGLayerAspectRatio = { "CGLayerAspectRatio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSimulcamInfo, CGLayerAspectRatio), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_CGLayerAspectRatio_MetaData), Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewProp_CGLayerAspectRatio_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSimulcamInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulcamInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSimulcamInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulcamInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FDistortionInfo>()
{
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDistortionInfo_Statics::NewProp_Parameters_Inner = { "Parameters", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FDistortionInfo_Statics::NewProp_Parameters = { "Parameters", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionInfo, Parameters), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionInfo_Statics::NewProp_Parameters_MetaData), Z_Construct_UScriptStruct_FDistortionInfo_Statics::NewProp_Parameters_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDistortionInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDistortionInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FFocalLengthInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::NewProp_FxFy = { "FxFy", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFocalLengthInfo, FxFy), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::NewProp_FxFy_MetaData), Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::NewProp_FxFy_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FSTMapInfo>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSTMapInfo_Statics::NewProp_DistortionMap = { "DistortionMap", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSTMapInfo, DistortionMap), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSTMapInfo_Statics::NewProp_DistortionMap_MetaData), Z_Construct_UScriptStruct_FSTMapInfo_Statics::NewProp_DistortionMap_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSTMapInfo_Statics::NewProp_MapFormat = { "MapFormat", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSTMapInfo, MapFormat), Z_Construct_UScriptStruct_FCalibratedMapFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSTMapInfo_Statics::NewProp_MapFormat_MetaData), Z_Construct_UScriptStruct_FSTMapInfo_Statics::NewProp_MapFormat_MetaData) }; // 206214100
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSTMapInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSTMapInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSTMapInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSTMapInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FImageCenterInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FImageCenterInfo_Statics::NewProp_PrincipalPoint = { "PrincipalPoint", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FImageCenterInfo, PrincipalPoint), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterInfo_Statics::NewProp_PrincipalPoint_MetaData), Z_Construct_UScriptStruct_FImageCenterInfo_Statics::NewProp_PrincipalPoint_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FImageCenterInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FImageCenterInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FNodalPointOffset>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodalPointOffset_Statics::NewProp_LocationOffset = { "LocationOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNodalPointOffset, LocationOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalPointOffset_Statics::NewProp_LocationOffset_MetaData), Z_Construct_UScriptStruct_FNodalPointOffset_Statics::NewProp_LocationOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodalPointOffset_Statics::NewProp_RotationOffset = { "RotationOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNodalPointOffset, RotationOffset), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalPointOffset_Statics::NewProp_RotationOffset_MetaData), Z_Construct_UScriptStruct_FNodalPointOffset_Statics::NewProp_RotationOffset_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNodalPointOffset_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalPointOffset_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNodalPointOffset_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalPointOffset_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FDistortionData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDistortionData_Statics::NewProp_DistortedUVs_Inner = { "DistortedUVs", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FDistortionData_Statics::NewProp_DistortedUVs = { "DistortedUVs", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionData, DistortedUVs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionData_Statics::NewProp_DistortedUVs_MetaData), Z_Construct_UScriptStruct_FDistortionData_Statics::NewProp_DistortedUVs_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDistortionData_Statics::NewProp_OverscanFactor = { "OverscanFactor", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionData, OverscanFactor), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionData_Statics::NewProp_OverscanFactor_MetaData), Z_Construct_UScriptStruct_FDistortionData_Statics::NewProp_OverscanFactor_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDistortionData_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDistortionData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionData_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FDataTablePointInfoBase>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::NewProp_Focus = { "Focus", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDataTablePointInfoBase, Focus), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::NewProp_Focus_MetaData), Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::NewProp_Focus_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::NewProp_Zoom = { "Zoom", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDataTablePointInfoBase, Zoom), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::NewProp_Zoom_MetaData), Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::NewProp_Zoom_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FDistortionPointInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::NewProp_DistortionInfo = { "DistortionInfo", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDistortionPointInfo, DistortionInfo), Z_Construct_UScriptStruct_FDistortionInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::NewProp_DistortionInfo_MetaData), Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::NewProp_DistortionInfo_MetaData) }; // 1149939584
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FFocalLengthPointInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::NewProp_FocalLengthInfo = { "FocalLengthInfo", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFocalLengthPointInfo, FocalLengthInfo), Z_Construct_UScriptStruct_FFocalLengthInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::NewProp_FocalLengthInfo_MetaData), Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::NewProp_FocalLengthInfo_MetaData) }; // 2315863060
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FSTMapPointInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::NewProp_STMapInfo = { "STMapInfo", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSTMapPointInfo, STMapInfo), Z_Construct_UScriptStruct_FSTMapInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::NewProp_STMapInfo_MetaData), Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::NewProp_STMapInfo_MetaData) }; // 3784138699
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FImageCenterPointInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::NewProp_ImageCenterInfo = { "ImageCenterInfo", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FImageCenterPointInfo, ImageCenterInfo), Z_Construct_UScriptStruct_FImageCenterInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::NewProp_ImageCenterInfo_MetaData), Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::NewProp_ImageCenterInfo_MetaData) }; // 4008996367
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::PropPointers) < 2048);
...
template<> CAMERACALIBRATIONCORE_API UScriptStruct* StaticStruct<FNodalOffsetPointInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::NewProp_NodalPointOffset = { "NodalPointOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNodalOffsetPointInfo, NodalPointOffset), Z_Construct_UScriptStruct_FNodalPointOffset, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::NewProp_NodalPointOffset_MetaData), Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::NewProp_NodalPointOffset_MetaData) }; // 2023718670
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_LensData_h_Statics::ScriptStructInfo[] = {
		{ FLensInfo::StaticStruct, Z_Construct_UScriptStruct_FLensInfo_Statics::NewStructOps, TEXT("LensInfo"), &Z_Registration_Info_UScriptStruct_LensInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLensInfo), 1597388363U) },
		{ FCameraFeedInfo::StaticStruct, Z_Construct_UScriptStruct_FCameraFeedInfo_Statics::NewStructOps, TEXT("CameraFeedInfo"), &Z_Registration_Info_UScriptStruct_CameraFeedInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraFeedInfo), 3537116450U) },
		{ FSimulcamInfo::StaticStruct, Z_Construct_UScriptStruct_FSimulcamInfo_Statics::NewStructOps, TEXT("SimulcamInfo"), &Z_Registration_Info_UScriptStruct_SimulcamInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSimulcamInfo), 3448875330U) },
		{ FDistortionInfo::StaticStruct, Z_Construct_UScriptStruct_FDistortionInfo_Statics::NewStructOps, TEXT("DistortionInfo"), &Z_Registration_Info_UScriptStruct_DistortionInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDistortionInfo), 1149939584U) },
		{ FFocalLengthInfo::StaticStruct, Z_Construct_UScriptStruct_FFocalLengthInfo_Statics::NewStructOps, TEXT("FocalLengthInfo"), &Z_Registration_Info_UScriptStruct_FocalLengthInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFocalLengthInfo), 2315863060U) },
		{ FSTMapInfo::StaticStruct, Z_Construct_UScriptStruct_FSTMapInfo_Statics::NewStructOps, TEXT("STMapInfo"), &Z_Registration_Info_UScriptStruct_STMapInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSTMapInfo), 3784138699U) },
		{ FImageCenterInfo::StaticStruct, Z_Construct_UScriptStruct_FImageCenterInfo_Statics::NewStructOps, TEXT("ImageCenterInfo"), &Z_Registration_Info_UScriptStruct_ImageCenterInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FImageCenterInfo), 4008996367U) },
		{ FNodalPointOffset::StaticStruct, Z_Construct_UScriptStruct_FNodalPointOffset_Statics::NewStructOps, TEXT("NodalPointOffset"), &Z_Registration_Info_UScriptStruct_NodalPointOffset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNodalPointOffset), 2023718670U) },
		{ FDistortionData::StaticStruct, Z_Construct_UScriptStruct_FDistortionData_Statics::NewStructOps, TEXT("DistortionData"), &Z_Registration_Info_UScriptStruct_DistortionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDistortionData), 1908228710U) },
		{ FDataTablePointInfoBase::StaticStruct, Z_Construct_UScriptStruct_FDataTablePointInfoBase_Statics::NewStructOps, TEXT("DataTablePointInfoBase"), &Z_Registration_Info_UScriptStruct_DataTablePointInfoBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDataTablePointInfoBase), 622380990U) },
		{ FDistortionPointInfo::StaticStruct, Z_Construct_UScriptStruct_FDistortionPointInfo_Statics::NewStructOps, TEXT("DistortionPointInfo"), &Z_Registration_Info_UScriptStruct_DistortionPointInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDistortionPointInfo), 442880516U) },
		{ FFocalLengthPointInfo::StaticStruct, Z_Construct_UScriptStruct_FFocalLengthPointInfo_Statics::NewStructOps, TEXT("FocalLengthPointInfo"), &Z_Registration_Info_UScriptStruct_FocalLengthPointInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFocalLengthPointInfo), 676922265U) },
		{ FSTMapPointInfo::StaticStruct, Z_Construct_UScriptStruct_FSTMapPointInfo_Statics::NewStructOps, TEXT("STMapPointInfo"), &Z_Registration_Info_UScriptStruct_STMapPointInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSTMapPointInfo), 981961613U) },
		{ FImageCenterPointInfo::StaticStruct, Z_Construct_UScriptStruct_FImageCenterPointInfo_Statics::NewStructOps, TEXT("ImageCenterPointInfo"), &Z_Registration_Info_UScriptStruct_ImageCenterPointInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FImageCenterPointInfo), 3047736583U) },
		{ FNodalOffsetPointInfo::StaticStruct, Z_Construct_UScriptStruct_FNodalOffsetPointInfo_Statics::NewStructOps, TEXT("NodalOffsetPointInfo"), &Z_Registration_Info_UScriptStruct_NodalOffsetPointInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNodalOffsetPointInfo), 2613610617U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_CameraCalibrationCore_Source_CameraCalibrationCore_Public_LensData_h_1957331087(TEXT("/Script/CameraCalibrationCore"),
		nullptr, 0,
