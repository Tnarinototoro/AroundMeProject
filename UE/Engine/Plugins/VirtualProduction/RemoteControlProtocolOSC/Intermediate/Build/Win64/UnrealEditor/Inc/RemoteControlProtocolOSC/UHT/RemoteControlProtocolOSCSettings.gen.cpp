...
template<> REMOTECONTROLPROTOCOLOSC_API UScriptStruct* StaticStruct<FRemoteControlOSCServerSettings>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings_Statics::NewProp_ServerAddress = { "ServerAddress", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRemoteControlOSCServerSettings, ServerAddress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings_Statics::NewProp_ServerAddress_MetaData), Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings_Statics::NewProp_ServerAddress_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::NewProp_ServersSettings_Inner = { "ServersSettings", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRemoteControlOSCServerSettings, METADATA_PARAMS(0, nullptr) }; // 1383289332
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::NewProp_ServersSettings = { "ServersSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URemoteControlProtocolOSCSettings, ServersSettings), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::NewProp_ServersSettings_MetaData), Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::NewProp_ServersSettings_MetaData) }; // 1383289332
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::ClassParams = {
		...
		0,
		0x000000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URemoteControlProtocolOSCSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControlProtocolOSC_Source_RemoteControlProtocolOSC_Private_RemoteControlProtocolOSCSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URemoteControlProtocolOSCSettings, URemoteControlProtocolOSCSettings::StaticClass, TEXT("URemoteControlProtocolOSCSettings"), &Z_Registration_Info_UClass_URemoteControlProtocolOSCSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URemoteControlProtocolOSCSettings), 17888790U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_VirtualProduction_RemoteControlProtocolOSC_Source_RemoteControlProtocolOSC_Private_RemoteControlProtocolOSCSettings_h_538995492(TEXT("/Script/RemoteControlProtocolOSC"),
