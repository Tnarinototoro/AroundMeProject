...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_StageOptions = { "StageOptions", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSequenceExporterUSDOptions, StageOptions), Z_Construct_UScriptStruct_FUsdStageOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_StageOptions_MetaData), Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_StageOptions_MetaData) }; // 3734398676
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bExportPreviewMesh = { "bExportPreviewMesh", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAnimSequenceExporterUSDOptions), &Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bExportPreviewMesh_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bExportPreviewMesh_MetaData), Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bExportPreviewMesh_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_PreviewMeshOptions = { "PreviewMeshOptions", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAnimSequenceExporterUSDOptions, PreviewMeshOptions), Z_Construct_UScriptStruct_FUsdMeshAssetOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_PreviewMeshOptions_MetaData), Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_PreviewMeshOptions_MetaData) }; // 3803943617
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets = { "bReExportIdenticalAssets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UAnimSequenceExporterUSDOptions), &Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_MetaData), Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSDOptions_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_AnimSequenceExporterUSDOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimSequenceExporterUSDOptions, UAnimSequenceExporterUSDOptions::StaticClass, TEXT("UAnimSequenceExporterUSDOptions"), &Z_Registration_Info_UClass_UAnimSequenceExporterUSDOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimSequenceExporterUSDOptions), 383169583U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_AnimSequenceExporterUSDOptions_h_1013439085(TEXT("/Script/USDExporter"),
