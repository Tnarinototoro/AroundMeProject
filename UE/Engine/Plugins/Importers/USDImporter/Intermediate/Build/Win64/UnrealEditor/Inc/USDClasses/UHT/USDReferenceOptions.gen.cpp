...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TargetPrimPath = { "TargetPrimPath", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdReferenceOptions, TargetPrimPath), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TargetPrimPath_MetaData), Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TargetPrimPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TimeCodeOffset = { "TimeCodeOffset", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdReferenceOptions, TimeCodeOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TimeCodeOffset_MetaData), Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TimeCodeOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TimeCodeScale = { "TimeCodeScale", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdReferenceOptions, TimeCodeScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TimeCodeScale_MetaData), Z_Construct_UClass_UUsdReferenceOptions_Statics::NewProp_TimeCodeScale_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDClasses_Public_USDReferenceOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdReferenceOptions, UUsdReferenceOptions::StaticClass, TEXT("UUsdReferenceOptions"), &Z_Registration_Info_UClass_UUsdReferenceOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdReferenceOptions), 1228080948U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDClasses_Public_USDReferenceOptions_h_3508497525(TEXT("/Script/USDClasses"),
