...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::NewProp_MaterialBakingOptions = { "MaterialBakingOptions", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialExporterUSDOptions, MaterialBakingOptions), Z_Construct_UScriptStruct_FUsdMaterialBakingOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::NewProp_MaterialBakingOptions_MetaData), Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::NewProp_MaterialBakingOptions_MetaData) }; // 3008268575
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets = { "bReExportIdenticalAssets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMaterialExporterUSDOptions), &Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_MetaData), Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExporterUSDOptions_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_MaterialExporterUSDOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExporterUSDOptions, UMaterialExporterUSDOptions::StaticClass, TEXT("UMaterialExporterUSDOptions"), &Z_Registration_Info_UClass_UMaterialExporterUSDOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExporterUSDOptions), 1259151769U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_MaterialExporterUSDOptions_h_3463826445(TEXT("/Script/USDExporter"),
