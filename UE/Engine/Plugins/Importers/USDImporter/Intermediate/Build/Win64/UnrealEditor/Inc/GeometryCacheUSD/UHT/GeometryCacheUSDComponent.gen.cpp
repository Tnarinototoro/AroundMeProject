...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheUsdComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCacheUsdComponent_Statics::ClassParams = {
		...
		0,
		0x04B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheUsdComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UGeometryCacheUsdComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_GeometryCacheUSD_Public_GeometryCacheUSDComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheUsdComponent, UGeometryCacheUsdComponent::StaticClass, TEXT("UGeometryCacheUsdComponent"), &Z_Registration_Info_UClass_UGeometryCacheUsdComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheUsdComponent), 92541198U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_GeometryCacheUSD_Public_GeometryCacheUSDComponent_h_2445525152(TEXT("/Script/GeometryCacheUSD"),
