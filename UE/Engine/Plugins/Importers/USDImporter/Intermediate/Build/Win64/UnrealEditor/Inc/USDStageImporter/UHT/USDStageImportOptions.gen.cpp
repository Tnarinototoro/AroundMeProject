...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_USDStageImporter_EReplaceActorPolicy_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_USDStageImporter_EReplaceActorPolicy_Statics::Enum_MetaDataParams), Z_Construct_UEnum_USDStageImporter_EReplaceActorPolicy_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_USDStageImporter_EReplaceAssetPolicy_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_USDStageImporter_EReplaceAssetPolicy_Statics::Enum_MetaDataParams), Z_Construct_UEnum_USDStageImporter_EReplaceAssetPolicy_Statics::Enum_MetaDataParams)
	};
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bImportGroomAssets_MetaData[];
#endif
		static void NewProp_bImportGroomAssets_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bImportGroomAssets;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportActors = { "bImportActors", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportActors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportActors_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportActors_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGeometry = { "bImportGeometry", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGeometry_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGeometry_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGeometry_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportSkeletalAnimations = { "bImportSkeletalAnimations", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportSkeletalAnimations_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportSkeletalAnimations_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportSkeletalAnimations_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportLevelSequences = { "bImportLevelSequences", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportLevelSequences_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportLevelSequences_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportLevelSequences_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportMaterials = { "bImportMaterials", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportMaterials_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportMaterials_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportMaterials_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGroomAssets_MetaData[] = {
		{ "Category", "DataToImport" },
		{ "Comment", "/** Whether to import GroomAssets, GroomCaches and GroomBindings */" },
		{ "DisplayName", "Groom Assets" },
		{ "ModuleRelativePath", "Public/USDStageImportOptions.h" },
		{ "ToolTip", "Whether to import GroomAssets, GroomCaches and GroomBindings" },
	};
#endif
	void Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGroomAssets_SetBit(void* Obj)
	{
		((UUsdStageImportOptions*)Obj)->bImportGroomAssets = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGroomAssets = { "bImportGroomAssets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGroomAssets_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGroomAssets_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGroomAssets_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportOnlyUsedMaterials = { "bImportOnlyUsedMaterials", nullptr, (EPropertyFlags)0x0010040000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportOnlyUsedMaterials_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportOnlyUsedMaterials_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportOnlyUsedMaterials_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_PrimsToImport_Inner = { "PrimsToImport", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_PrimsToImport = { "PrimsToImport", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, PrimsToImport), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_PrimsToImport_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_PrimsToImport_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_PurposesToImport = { "PurposesToImport", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, PurposesToImport), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_PurposesToImport_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_PurposesToImport_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_NaniteTriangleThreshold = { "NaniteTriangleThreshold", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, NaniteTriangleThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_NaniteTriangleThreshold_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_NaniteTriangleThreshold_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_RenderContextToImport = { "RenderContextToImport", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, RenderContextToImport), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_RenderContextToImport_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_RenderContextToImport_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_MaterialPurpose = { "MaterialPurpose", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, MaterialPurpose), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_MaterialPurpose_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_MaterialPurpose_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_RootMotionHandling_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_RootMotionHandling = { "RootMotionHandling", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, RootMotionHandling), Z_Construct_UEnum_UnrealUSDWrapper_EUsdRootMotionHandling, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_RootMotionHandling_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_RootMotionHandling_MetaData) }; // 3645787672
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bOverrideStageOptions = { "bOverrideStageOptions", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bOverrideStageOptions_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bOverrideStageOptions_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bOverrideStageOptions_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_StageOptions = { "StageOptions", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, StageOptions), Z_Construct_UScriptStruct_FUsdStageOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_StageOptions_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_StageOptions_MetaData) }; // 3734398676
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportAtSpecificTimeCode = { "bImportAtSpecificTimeCode", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportAtSpecificTimeCode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportAtSpecificTimeCode_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportAtSpecificTimeCode_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ImportTimeCode = { "ImportTimeCode", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, ImportTimeCode), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ImportTimeCode_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ImportTimeCode_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_GroomInterpolationSettings_Inner = { "GroomInterpolationSettings", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FHairGroupsInterpolation, METADATA_PARAMS(0, nullptr) }; // 226160302
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_GroomInterpolationSettings = { "GroomInterpolationSettings", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, GroomInterpolationSettings), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_GroomInterpolationSettings_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_GroomInterpolationSettings_MetaData) }; // 226160302
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingActorPolicy_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingActorPolicy = { "ExistingActorPolicy", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, ExistingActorPolicy), Z_Construct_UEnum_USDStageImporter_EReplaceActorPolicy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingActorPolicy_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingActorPolicy_MetaData) }; // 3979575388
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingAssetPolicy_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingAssetPolicy = { "ExistingAssetPolicy", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, ExistingAssetPolicy), Z_Construct_UEnum_USDStageImporter_EReplaceAssetPolicy, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingAssetPolicy_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_ExistingAssetPolicy_MetaData) }; // 2448912165
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bPrimPathFolderStructure = { "bPrimPathFolderStructure", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bPrimPathFolderStructure_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bPrimPathFolderStructure_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bPrimPathFolderStructure_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_KindsToCollapse = { "KindsToCollapse", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageImportOptions, KindsToCollapse), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_KindsToCollapse_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_KindsToCollapse_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bMergeIdenticalMaterialSlots = { "bMergeIdenticalMaterialSlots", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bMergeIdenticalMaterialSlots_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bMergeIdenticalMaterialSlots_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bMergeIdenticalMaterialSlots_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bCollapseTopLevelPointInstancers = { "bCollapseTopLevelPointInstancers", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bCollapseTopLevelPointInstancers_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bCollapseTopLevelPointInstancers_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bCollapseTopLevelPointInstancers_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bInterpretLODs = { "bInterpretLODs", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageImportOptions), &Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bInterpretLODs_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bInterpretLODs_MetaData), Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bInterpretLODs_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUsdStageImportOptions_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUsdStageImportOptions_Statics::NewProp_bImportGroomAssets,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUsdStageImportOptions_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UUsdStageImportOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageImportOptions_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageImporter_Public_USDStageImportOptions_h_Statics::EnumInfo[] = {
		{ EReplaceActorPolicy_StaticEnum, TEXT("EReplaceActorPolicy"), &Z_Registration_Info_UEnum_EReplaceActorPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3979575388U) },
		{ EReplaceAssetPolicy_StaticEnum, TEXT("EReplaceAssetPolicy"), &Z_Registration_Info_UEnum_EReplaceAssetPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2448912165U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageImporter_Public_USDStageImportOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdStageImportOptions, UUsdStageImportOptions::StaticClass, TEXT("UUsdStageImportOptions"), &Z_Registration_Info_UClass_UUsdStageImportOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdStageImportOptions), 940216631U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageImporter_Public_USDStageImportOptions_h_2224084602(TEXT("/Script/USDStageImporter"),
