...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::NewProp_ImportContext = { "ImportContext", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdStageAssetImportFactory, ImportContext), Z_Construct_UScriptStruct_FUsdStageImportContext, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::NewProp_ImportContext_MetaData), Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::NewProp_ImportContext_MetaData) }; // 380219553
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageAssetImportFactory_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageImporter_Private_USDStageAssetImportFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdStageAssetImportFactory, UUsdStageAssetImportFactory::StaticClass, TEXT("UUsdStageAssetImportFactory"), &Z_Registration_Info_UClass_UUsdStageAssetImportFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdStageAssetImportFactory), 229275682U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageImporter_Private_USDStageAssetImportFactory_h_3024995279(TEXT("/Script/USDStageImporter"),
