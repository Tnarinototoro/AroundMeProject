...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelExporterUSD_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULevelExporterUSD_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULevelExporterUSD_Statics::Class_MetaDataParams), Z_Construct_UClass_ULevelExporterUSD_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_LevelExporterUSD_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelExporterUSD, ULevelExporterUSD::StaticClass, TEXT("ULevelExporterUSD"), &Z_Registration_Info_UClass_ULevelExporterUSD, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelExporterUSD), 3862162204U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_LevelExporterUSD_h_2430250702(TEXT("/Script/USDExporter"),
