...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSD_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAnimSequenceExporterUSD_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceExporterUSD_Statics::Class_MetaDataParams), Z_Construct_UClass_UAnimSequenceExporterUSD_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_AnimSequenceExporterUSD_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimSequenceExporterUSD, UAnimSequenceExporterUSD::StaticClass, TEXT("UAnimSequenceExporterUSD"), &Z_Registration_Info_UClass_UAnimSequenceExporterUSD, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimSequenceExporterUSD), 1418151703U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_AnimSequenceExporterUSD_h_3341767396(TEXT("/Script/USDExporter"),
