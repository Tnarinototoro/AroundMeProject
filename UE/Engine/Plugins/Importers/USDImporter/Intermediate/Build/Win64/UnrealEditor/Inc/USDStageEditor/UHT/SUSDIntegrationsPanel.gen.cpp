...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::NewProp_AnimBPProperty = { "AnimBPProperty", nullptr, (EPropertyFlags)0x0014000000002001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdIntegrationsPanelPropertyDummy, AnimBPProperty), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::NewProp_AnimBPProperty_MetaData), Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::NewProp_AnimBPProperty_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::NewProp_ControlRigProperty = { "ControlRigProperty", nullptr, (EPropertyFlags)0x0014000000002001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdIntegrationsPanelPropertyDummy, ControlRigProperty), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::NewProp_ControlRigProperty_MetaData), Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::NewProp_ControlRigProperty_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::ClassParams = {
		...
		0,
		0x000800A9u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::Class_MetaDataParams), Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageEditor_Private_Widgets_SUSDIntegrationsPanel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdIntegrationsPanelPropertyDummy, UUsdIntegrationsPanelPropertyDummy::StaticClass, TEXT("UUsdIntegrationsPanelPropertyDummy"), &Z_Registration_Info_UClass_UUsdIntegrationsPanelPropertyDummy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdIntegrationsPanelPropertyDummy), 2423631825U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageEditor_Private_Widgets_SUSDIntegrationsPanel_h_3093136366(TEXT("/Script/USDStageEditor"),
