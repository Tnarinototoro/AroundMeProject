...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackUsd_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCacheTrackUsd_Statics::ClassParams = {
		...
		0,
		0x001020A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackUsd_Statics::Class_MetaDataParams), Z_Construct_UClass_UGeometryCacheTrackUsd_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_GeometryCacheUSD_Public_GeometryCacheTrackUSD_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheTrackUsd, UGeometryCacheTrackUsd::StaticClass, TEXT("UGeometryCacheTrackUsd"), &Z_Registration_Info_UClass_UGeometryCacheTrackUsd, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheTrackUsd), 1894898341U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_GeometryCacheUSD_Public_GeometryCacheTrackUSD_h_825461943(TEXT("/Script/GeometryCacheUSD"),
