...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageEditorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bSelectionSynced = { "bSelectionSynced", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageEditorSettings), &Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bSelectionSynced_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bSelectionSynced_MetaData), Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bSelectionSynced_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bIsolateLayerSyncedWithEditTarget = { "bIsolateLayerSyncedWithEditTarget", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UUsdStageEditorSettings), &Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bIsolateLayerSyncedWithEditTarget_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bIsolateLayerSyncedWithEditTarget_MetaData), Z_Construct_UClass_UUsdStageEditorSettings_Statics::NewProp_bIsolateLayerSyncedWithEditTarget_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUsdStageEditorSettings_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageEditorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UUsdStageEditorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdStageEditorSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageEditor_Private_USDStageEditorSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdStageEditorSettings, UUsdStageEditorSettings::StaticClass, TEXT("UUsdStageEditorSettings"), &Z_Registration_Info_UClass_UUsdStageEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdStageEditorSettings), 2087558073U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStageEditor_Private_USDStageEditorSettings_h_2922734506(TEXT("/Script/USDStageEditor"),
