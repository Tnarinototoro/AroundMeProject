...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdAssetCacheFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUsdAssetCacheFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdAssetCacheFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UUsdAssetCacheFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDClassesEditor_Private_USDAssetCacheFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdAssetCacheFactory, UUsdAssetCacheFactory::StaticClass, TEXT("UUsdAssetCacheFactory"), &Z_Registration_Info_UClass_UUsdAssetCacheFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdAssetCacheFactory), 1120364327U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDClassesEditor_Private_USDAssetCacheFactory_h_560437776(TEXT("/Script/USDClassesEditor"),
