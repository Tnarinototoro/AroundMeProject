...
template<> USDCLASSES_API UScriptStruct* StaticStruct<FUsdStageOptions>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FUsdStageOptions_Statics::NewProp_MetersPerUnit = { "MetersPerUnit", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUsdStageOptions, MetersPerUnit), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUsdStageOptions_Statics::NewProp_MetersPerUnit_MetaData), Z_Construct_UScriptStruct_FUsdStageOptions_Statics::NewProp_MetersPerUnit_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FUsdStageOptions_Statics::NewProp_UpAxis = { "UpAxis", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUsdStageOptions, UpAxis), Z_Construct_UEnum_USDClasses_EUsdUpAxis, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUsdStageOptions_Statics::NewProp_UpAxis_MetaData), Z_Construct_UScriptStruct_FUsdStageOptions_Statics::NewProp_UpAxis_MetaData) }; // 2012133127
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDClasses_Public_USDStageOptions_h_Statics::EnumInfo[] = {
		{ EUsdUpAxis_StaticEnum, TEXT("EUsdUpAxis"), &Z_Registration_Info_UEnum_EUsdUpAxis, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2012133127U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDClasses_Public_USDStageOptions_h_Statics::ScriptStructInfo[] = {
		{ FUsdStageOptions::StaticStruct, Z_Construct_UScriptStruct_FUsdStageOptions_Statics::NewStructOps, TEXT("UsdStageOptions"), &Z_Registration_Info_UScriptStruct_UsdStageOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUsdStageOptions), 3734398676U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDClasses_Public_USDStageOptions_h_2565519174(TEXT("/Script/USDClasses"),
		nullptr, 0,
