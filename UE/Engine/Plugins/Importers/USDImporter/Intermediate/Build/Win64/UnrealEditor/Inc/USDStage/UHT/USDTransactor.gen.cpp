...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdTransactor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUsdTransactor_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdTransactor_Statics::Class_MetaDataParams), Z_Construct_UClass_UUsdTransactor_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStage_Public_USDTransactor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdTransactor, UUsdTransactor::StaticClass, TEXT("UUsdTransactor"), &Z_Registration_Info_UClass_UUsdTransactor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdTransactor), 2354674183U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStage_Public_USDTransactor_h_983882633(TEXT("/Script/USDStage"),
