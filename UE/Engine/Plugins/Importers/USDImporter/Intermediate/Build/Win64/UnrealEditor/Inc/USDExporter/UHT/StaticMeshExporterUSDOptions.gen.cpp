...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_StageOptions = { "StageOptions", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UStaticMeshExporterUSDOptions, StageOptions), Z_Construct_UScriptStruct_FUsdStageOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_StageOptions_MetaData), Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_StageOptions_MetaData) }; // 3734398676
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_MeshAssetOptions = { "MeshAssetOptions", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UStaticMeshExporterUSDOptions, MeshAssetOptions), Z_Construct_UScriptStruct_FUsdMeshAssetOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_MeshAssetOptions_MetaData), Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_MeshAssetOptions_MetaData) }; // 3803943617
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets = { "bReExportIdenticalAssets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UStaticMeshExporterUSDOptions), &Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_MetaData), Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::NewProp_bReExportIdenticalAssets_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshExporterUSDOptions_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_StaticMeshExporterUSDOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStaticMeshExporterUSDOptions, UStaticMeshExporterUSDOptions::StaticClass, TEXT("UStaticMeshExporterUSDOptions"), &Z_Registration_Info_UClass_UStaticMeshExporterUSDOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStaticMeshExporterUSDOptions), 1392264579U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_StaticMeshExporterUSDOptions_h_340972327(TEXT("/Script/USDExporter"),
