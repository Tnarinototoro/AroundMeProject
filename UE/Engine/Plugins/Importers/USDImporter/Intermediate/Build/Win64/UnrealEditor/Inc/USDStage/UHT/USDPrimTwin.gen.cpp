...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdPrimTwin_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_PrimPath = { "PrimPath", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdPrimTwin, PrimPath), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_PrimPath_MetaData), Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_PrimPath_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_SceneComponent_MetaData[] = {
		{ "ModuleRelativePath", "Public/USDPrimTwin.h" },
	};
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_SceneComponent = { "SceneComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdPrimTwin, SceneComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_SceneComponent_MetaData), Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_SceneComponent_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Children_ValueProp = { "Children", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UClass_UUsdPrimTwin_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Children_Key_KeyProp = { "Children_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Children_MetaData[] = {
		{ "ModuleRelativePath", "Public/USDPrimTwin.h" },
	};
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Children = { "Children", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdPrimTwin, Children), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Children_MetaData), Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Children_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Parent_MetaData[] = {
		{ "ModuleRelativePath", "Public/USDPrimTwin.h" },
	};
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUsdPrimTwin, Parent), Z_Construct_UClass_UUsdPrimTwin_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Parent_MetaData), Z_Construct_UClass_UUsdPrimTwin_Statics::NewProp_Parent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUsdPrimTwin_Statics::ClassParams = {
		...
		0,
		0x008800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdPrimTwin_Statics::Class_MetaDataParams), Z_Construct_UClass_UUsdPrimTwin_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUsdPrimTwin_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStage_Public_USDPrimTwin_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUsdPrimTwin, UUsdPrimTwin::StaticClass, TEXT("UUsdPrimTwin"), &Z_Registration_Info_UClass_UUsdPrimTwin, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUsdPrimTwin), 2682348996U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDStage_Public_USDPrimTwin_h_3432064197(TEXT("/Script/USDStage"),
