...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExporterUsd_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExporterUsd_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExporterUsd_Statics::Class_MetaDataParams), Z_Construct_UClass_UMaterialExporterUsd_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_MaterialExporterUSD_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExporterUsd, UMaterialExporterUsd::StaticClass, TEXT("UMaterialExporterUsd"), &Z_Registration_Info_UClass_UMaterialExporterUsd, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExporterUsd), 559487296U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_USDImporter_Source_USDExporter_Public_MaterialExporterUSD_h_1896019226(TEXT("/Script/USDExporter"),
