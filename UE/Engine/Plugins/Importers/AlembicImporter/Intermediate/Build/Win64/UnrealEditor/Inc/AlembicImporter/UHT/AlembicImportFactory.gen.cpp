...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAlembicImportFactory_Statics::NewProp_ImportSettings = { "ImportSettings", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAlembicImportFactory, ImportSettings), Z_Construct_UClass_UAbcImportSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAlembicImportFactory_Statics::NewProp_ImportSettings_MetaData), Z_Construct_UClass_UAlembicImportFactory_Statics::NewProp_ImportSettings_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_AlembicImporter_Source_AlembicImporter_Classes_AlembicImportFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAlembicImportFactory, UAlembicImportFactory::StaticClass, TEXT("UAlembicImportFactory"), &Z_Registration_Info_UClass_UAlembicImportFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAlembicImportFactory), 808224753U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Importers_AlembicImporter_Source_AlembicImporter_Classes_AlembicImportFactory_h_2464125945(TEXT("/Script/AlembicImporter"),
