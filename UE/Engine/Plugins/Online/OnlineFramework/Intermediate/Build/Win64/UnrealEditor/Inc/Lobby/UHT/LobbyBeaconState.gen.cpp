...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FLobbyPlayerStateActorInfo_Statics::NewProp_LobbyPlayerState = { "LobbyPlayerState", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLobbyPlayerStateActorInfo, LobbyPlayerState), Z_Construct_UClass_ALobbyBeaconPlayerState_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLobbyPlayerStateActorInfo_Statics::NewProp_LobbyPlayerState_MetaData), Z_Construct_UScriptStruct_FLobbyPlayerStateActorInfo_Statics::NewProp_LobbyPlayerState_MetaData) };
...
template<> LOBBY_API UScriptStruct* StaticStruct<FLobbyPlayerStateInfoArray>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLobbyPlayerStateInfoArray_Statics::NewProp_Players = { "Players", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLobbyPlayerStateInfoArray, Players), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLobbyPlayerStateInfoArray_Statics::NewProp_Players_MetaData), Z_Construct_UScriptStruct_FLobbyPlayerStateInfoArray_Statics::NewProp_Players_MetaData) }; // 663922492
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FLobbyPlayerStateInfoArray_Statics::NewProp_ParentState = { "ParentState", nullptr, (EPropertyFlags)0x0044000080000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLobbyPlayerStateInfoArray, ParentState), Z_Construct_UClass_ALobbyBeaconState_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLobbyPlayerStateInfoArray_Statics::NewProp_ParentState_MetaData), Z_Construct_UScriptStruct_FLobbyPlayerStateInfoArray_Statics::NewProp_ParentState_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ALobbyBeaconState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ALobbyBeaconState_OnRep_LobbyStarted, "OnRep_LobbyStarted" }, // 2836875797
		{ &Z_Construct_UFunction_ALobbyBeaconState_OnRep_WaitForPlayersTimeRemaining, "OnRep_WaitForPlayersTimeRemaining" }, // 1733850843
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ALobbyBeaconState_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ALobbyBeaconState_Statics::NewProp_MaxPlayers = { "MaxPlayers", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALobbyBeaconState, MaxPlayers), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ALobbyBeaconState_Statics::NewProp_MaxPlayers_MetaData), Z_Construct_UClass_ALobbyBeaconState_Statics::NewProp_MaxPlayers_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ALobbyBeaconState_Statics::NewProp_WaitForPlayersTimeRemaining = { "WaitForPlayersTimeRemaining", "OnRep_WaitForPlayersTimeRemaining", (EPropertyFlags)0x0020080100004020, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALobbyBeaconState, WaitForPlayersTimeRemaining), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ALobbyBeaconState_Statics::NewProp_WaitForPlayersTimeRemaining_MetaData), Z_Construct_UClass_ALobbyBeaconState_Statics::NewProp_WaitForPlayersTimeRemaining_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Lobby_Public_LobbyBeaconState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALobbyBeaconState, ALobbyBeaconState::StaticClass, TEXT("ALobbyBeaconState"), &Z_Registration_Info_UClass_ALobbyBeaconState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALobbyBeaconState), 2810140737U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Lobby_Public_LobbyBeaconState_h_2775280288(TEXT("/Script/Lobby"),
