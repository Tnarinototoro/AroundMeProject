...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Chat_SocialChatChannel_h_Statics::EnumInfo[] = {
		{ ESocialChannelType_StaticEnum, TEXT("ESocialChannelType"), &Z_Registration_Info_UEnum_ESocialChannelType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3882098950U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Chat_SocialChatChannel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USocialChatChannel, USocialChatChannel::StaticClass, TEXT("USocialChatChannel"), &Z_Registration_Info_UClass_USocialChatChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USocialChatChannel), 113598678U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Chat_SocialChatChannel_h_3717328204(TEXT("/Script/Party"),
