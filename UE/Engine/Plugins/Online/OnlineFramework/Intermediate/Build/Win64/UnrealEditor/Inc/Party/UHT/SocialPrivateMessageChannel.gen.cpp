...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USocialPrivateMessageChannel_Statics::NewProp_TargetUser = { "TargetUser", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USocialPrivateMessageChannel, TargetUser), Z_Construct_UClass_USocialUser_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USocialPrivateMessageChannel_Statics::NewProp_TargetUser_MetaData), Z_Construct_UClass_USocialPrivateMessageChannel_Statics::NewProp_TargetUser_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Chat_SocialPrivateMessageChannel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USocialPrivateMessageChannel, USocialPrivateMessageChannel::StaticClass, TEXT("USocialPrivateMessageChannel"), &Z_Registration_Info_UClass_USocialPrivateMessageChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USocialPrivateMessageChannel), 421747495U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Chat_SocialPrivateMessageChannel_h_1775390439(TEXT("/Script/Party"),
