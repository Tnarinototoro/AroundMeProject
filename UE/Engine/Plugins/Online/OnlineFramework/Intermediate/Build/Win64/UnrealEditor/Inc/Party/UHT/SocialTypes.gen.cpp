...
template<> PARTY_API UScriptStruct* StaticStruct<FUserPlatform>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_SocialTypes_h_Statics::EnumInfo[] = {
		{ ESocialSubsystem_StaticEnum, TEXT("ESocialSubsystem"), &Z_Registration_Info_UEnum_ESocialSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3194633841U) },
		{ ESocialRelationship_StaticEnum, TEXT("ESocialRelationship"), &Z_Registration_Info_UEnum_ESocialRelationship, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 994634780U) },
		{ ECrossplayPreference_StaticEnum, TEXT("ECrossplayPreference"), &Z_Registration_Info_UEnum_ECrossplayPreference, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1325113754U) },
		{ EPlatformIconDisplayRule_StaticEnum, TEXT("EPlatformIconDisplayRule"), &Z_Registration_Info_UEnum_EPlatformIconDisplayRule, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2976124039U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_SocialTypes_h_Statics::ScriptStructInfo[] = {
		{ FUserPlatform::StaticStruct, Z_Construct_UScriptStruct_FUserPlatform_Statics::NewStructOps, TEXT("UserPlatform"), &Z_Registration_Info_UScriptStruct_UserPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUserPlatform), 2680197826U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_SocialTypes_h_2440949943(TEXT("/Script/Party"),
		nullptr, 0,
