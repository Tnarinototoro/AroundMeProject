...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UChatroom_Statics::NewProp_CurrentChatRoomId = { "CurrentChatRoomId", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChatroom, CurrentChatRoomId), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChatroom_Statics::NewProp_CurrentChatRoomId_MetaData), Z_Construct_UClass_UChatroom_Statics::NewProp_CurrentChatRoomId_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UChatroom_Statics::NewProp_MaxChatRoomRetries = { "MaxChatRoomRetries", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChatroom, MaxChatRoomRetries), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChatroom_Statics::NewProp_MaxChatRoomRetries_MetaData), Z_Construct_UClass_UChatroom_Statics::NewProp_MaxChatRoomRetries_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UChatroom_Statics::NewProp_NumChatRoomRetries = { "NumChatRoomRetries", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChatroom, NumChatRoomRetries), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChatroom_Statics::NewProp_NumChatRoomRetries_MetaData), Z_Construct_UClass_UChatroom_Statics::NewProp_NumChatRoomRetries_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Chatroom_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChatroom, UChatroom::StaticClass, TEXT("UChatroom"), &Z_Registration_Info_UClass_UChatroom, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChatroom), 3473007280U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Chatroom_h_3211439459(TEXT("/Script/Party"),
