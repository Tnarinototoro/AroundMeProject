...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Party_EPartyType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Party_EPartyType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Party_EPartyType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Party_EPartyInviteRestriction_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Party_EPartyInviteRestriction_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Party_EPartyInviteRestriction_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_Party_EPartyJoinDenialReason_Statics::Enumerators[] = {
		...
		{ "EPartyJoinDenialReason::InvalidJoinInfo", (int64)EPartyJoinDenialReason::InvalidJoinInfo },
		{ "EPartyJoinDenialReason::NotFriends", (int64)EPartyJoinDenialReason::NotFriends },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Party_EPartyJoinDenialReason_Statics::Enum_MetaDataParams[] = {
		...
		{ "InvalidJoinInfo.Comment", "/** Failed to get party join info from target user */" },
		{ "InvalidJoinInfo.Name", "EPartyJoinDenialReason::InvalidJoinInfo" },
		{ "InvalidJoinInfo.ToolTip", "Failed to get party join info from target user" },
		...
		{ "NotFriends.Comment", "/** The join method doesn't support non-friends */" },
		{ "NotFriends.Name", "EPartyJoinDenialReason::NotFriends" },
		{ "NotFriends.ToolTip", "The join method doesn't support non-friends" },
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Party_EPartyJoinDenialReason_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Party_EPartyJoinDenialReason_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Party_EPartyJoinDenialReason_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Party_EApprovalAction_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Party_EApprovalAction_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Party_EApprovalAction_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_Party_ESocialPartyInviteMethod_Statics::Enumerators[] = {
		...
		{ "ESocialPartyInviteMethod::AcceptRequestToJoin", (int64)ESocialPartyInviteMethod::AcceptRequestToJoin },
		{ "ESocialPartyInviteMethod::Custom0", (int64)ESocialPartyInviteMethod::Custom0 },
		{ "ESocialPartyInviteMethod::Custom1", (int64)ESocialPartyInviteMethod::Custom1 },
		{ "ESocialPartyInviteMethod::Custom2", (int64)ESocialPartyInviteMethod::Custom2 },
		{ "ESocialPartyInviteMethod::Custom3", (int64)ESocialPartyInviteMethod::Custom3 },
		{ "ESocialPartyInviteMethod::Custom4", (int64)ESocialPartyInviteMethod::Custom4 },
		{ "ESocialPartyInviteMethod::Custom5", (int64)ESocialPartyInviteMethod::Custom5 },
		{ "ESocialPartyInviteMethod::Custom6", (int64)ESocialPartyInviteMethod::Custom6 },
		{ "ESocialPartyInviteMethod::Custom7", (int64)ESocialPartyInviteMethod::Custom7 },
		{ "ESocialPartyInviteMethod::Custom8", (int64)ESocialPartyInviteMethod::Custom8 },
		{ "ESocialPartyInviteMethod::Custom9", (int64)ESocialPartyInviteMethod::Custom9 },
		{ "ESocialPartyInviteMethod::MAX", (int64)ESocialPartyInviteMethod::MAX },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Party_ESocialPartyInviteMethod_Statics::Enum_MetaDataParams[] = {
		{ "AcceptRequestToJoin.Comment", "/** Invite was sent via accepting \"Request To Join\" */" },
		{ "AcceptRequestToJoin.Name", "ESocialPartyInviteMethod::AcceptRequestToJoin" },
		{ "AcceptRequestToJoin.ToolTip", "Invite was sent via accepting \"Request To Join\"" },
		{ "Custom0.Comment", "/** Custom methods */" },
		{ "Custom0.Name", "ESocialPartyInviteMethod::Custom0" },
		{ "Custom0.ToolTip", "Custom methods" },
		{ "Custom1.Name", "ESocialPartyInviteMethod::Custom1" },
		{ "Custom2.Name", "ESocialPartyInviteMethod::Custom2" },
		{ "Custom3.Name", "ESocialPartyInviteMethod::Custom3" },
		{ "Custom4.Name", "ESocialPartyInviteMethod::Custom4" },
		{ "Custom5.Name", "ESocialPartyInviteMethod::Custom5" },
		{ "Custom6.Name", "ESocialPartyInviteMethod::Custom6" },
		{ "Custom7.Name", "ESocialPartyInviteMethod::Custom7" },
		{ "Custom8.Name", "ESocialPartyInviteMethod::Custom8" },
		{ "Custom9.Name", "ESocialPartyInviteMethod::Custom9" },
		{ "MAX.Name", "ESocialPartyInviteMethod::MAX" },
		{ "ModuleRelativePath", "Public/Party/PartyTypes.h" },
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Party_ESocialPartyInviteMethod_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Party_ESocialPartyInviteMethod_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Party_ESocialPartyInviteMethod_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Party_ESocialPartyInviteFailureReason_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Party_ESocialPartyInviteFailureReason_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Party_ESocialPartyInviteFailureReason_Statics::Enum_MetaDataParams)
	};
...
template<> PARTY_API UScriptStruct* StaticStruct<FPartyPlatformSessionInfo>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionType = { "SessionType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPlatformSessionInfo, SessionType), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionType_MetaData), Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionId = { "SessionId", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPlatformSessionInfo, SessionId), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionId_MetaData), Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionId_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_OwnerPrimaryId = { "OwnerPrimaryId", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPlatformSessionInfo, OwnerPrimaryId), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_OwnerPrimaryId_MetaData), Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_OwnerPrimaryId_MetaData) }; // 3233782123
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::PropPointers) < 2048);
...
template<> PARTY_API UScriptStruct* StaticStruct<FPartyPrivacySettings>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyType = { "PartyType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPrivacySettings, PartyType), Z_Construct_UEnum_Party_EPartyType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyType_MetaData), Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyType_MetaData) }; // 2267132887
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyInviteRestriction_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyInviteRestriction = { "PartyInviteRestriction", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPrivacySettings, PartyInviteRestriction), Z_Construct_UEnum_Party_EPartyInviteRestriction, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyInviteRestriction_MetaData), Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyInviteRestriction_MetaData) }; // 3788036604
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_bOnlyLeaderFriendsCanJoin = { "bOnlyLeaderFriendsCanJoin", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FPartyPrivacySettings), &Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_bOnlyLeaderFriendsCanJoin_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_bOnlyLeaderFriendsCanJoin_MetaData), Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_bOnlyLeaderFriendsCanJoin_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::PropPointers) < 2048);
...
template<> PARTY_API UScriptStruct* StaticStruct<FOnlinePartyRepDataBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOnlinePartyRepDataBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOnlinePartyRepDataBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FOnlinePartyRepDataBase_Statics::Struct_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_Statics::EnumInfo[] = {
		{ EPartyType_StaticEnum, TEXT("EPartyType"), &Z_Registration_Info_UEnum_EPartyType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2267132887U) },
		{ EPartyInviteRestriction_StaticEnum, TEXT("EPartyInviteRestriction"), &Z_Registration_Info_UEnum_EPartyInviteRestriction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3788036604U) },
		{ EPartyJoinDenialReason_StaticEnum, TEXT("EPartyJoinDenialReason"), &Z_Registration_Info_UEnum_EPartyJoinDenialReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3068537192U) },
		{ EApprovalAction_StaticEnum, TEXT("EApprovalAction"), &Z_Registration_Info_UEnum_EApprovalAction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3729297651U) },
		{ ESocialPartyInviteMethod_StaticEnum, TEXT("ESocialPartyInviteMethod"), &Z_Registration_Info_UEnum_ESocialPartyInviteMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 999115280U) },
		{ ESocialPartyInviteFailureReason_StaticEnum, TEXT("ESocialPartyInviteFailureReason"), &Z_Registration_Info_UEnum_ESocialPartyInviteFailureReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3905239958U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_Statics::ScriptStructInfo[] = {
		{ FPartyPlatformSessionInfo::StaticStruct, Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewStructOps, TEXT("PartyPlatformSessionInfo"), &Z_Registration_Info_UScriptStruct_PartyPlatformSessionInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPartyPlatformSessionInfo), 3093066352U) },
		{ FPartyPrivacySettings::StaticStruct, Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewStructOps, TEXT("PartyPrivacySettings"), &Z_Registration_Info_UScriptStruct_PartyPrivacySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPartyPrivacySettings), 2856549339U) },
		{ FOnlinePartyRepDataBase::StaticStruct, Z_Construct_UScriptStruct_FOnlinePartyRepDataBase_Statics::NewStructOps, TEXT("OnlinePartyRepDataBase"), &Z_Registration_Info_UScriptStruct_OnlinePartyRepDataBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOnlinePartyRepDataBase), 2939048714U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_3637598485(TEXT("/Script/Party"),
		nullptr, 0,
