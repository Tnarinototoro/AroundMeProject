...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusEntitlementCheckResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_OnlineSubsystemOculus, nullptr, "OculusEntitlementCheckResult__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusEntitlementCheckResult__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusEntitlementCheckResult__DelegateSignature_Statics::Function_MetaDataParams) };
...
void FOculusEntitlementCheckResult_DelegateWrapper(const FMulticastScriptDelegate& OculusEntitlementCheckResult)
{
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OculusEntitlementCallbackProxy_eventVerifyEntitlement_Parms, ReturnValue), Z_Construct_UClass_UOculusEntitlementCallbackProxy_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusEntitlementCallbackProxy, nullptr, "VerifyEntitlement", nullptr, nullptr, Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::OculusEntitlementCallbackProxy_eventVerifyEntitlement_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement_Statics::OculusEntitlementCallbackProxy_eventVerifyEntitlement_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOculusEntitlementCallbackProxy_VerifyEntitlement, "VerifyEntitlement" }, // 2075456900
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusEntitlementCallbackProxy, OnSuccess), Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusEntitlementCheckResult__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::NewProp_OnSuccess_MetaData), Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::NewProp_OnSuccess_MetaData) }; // 1030254689
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::NewProp_OnFailure = { "OnFailure", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusEntitlementCallbackProxy, OnFailure), Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusEntitlementCheckResult__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::NewProp_OnFailure_MetaData), Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::NewProp_OnFailure_MetaData) }; // 1030254689
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::ClassParams = {
		...
		0,
		0x008800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusEntitlementCallbackProxy_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusEntitlementCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusEntitlementCallbackProxy, UOculusEntitlementCallbackProxy::StaticClass, TEXT("UOculusEntitlementCallbackProxy"), &Z_Registration_Info_UClass_UOculusEntitlementCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusEntitlementCallbackProxy), 3330101699U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusEntitlementCallbackProxy_h_1320954404(TEXT("/Script/OnlineSubsystemOculus"),
