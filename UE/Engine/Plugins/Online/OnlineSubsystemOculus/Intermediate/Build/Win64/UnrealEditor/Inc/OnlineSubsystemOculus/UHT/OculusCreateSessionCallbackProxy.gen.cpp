...
// End Cross Module References
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::NewProp_PublicConnections = { "PublicConnections", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OculusCreateSessionCallbackProxy_eventCreateSession_Parms, PublicConnections), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::NewProp_OculusMatchmakingPool = { "OculusMatchmakingPool", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OculusCreateSessionCallbackProxy_eventCreateSession_Parms, OculusMatchmakingPool), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OculusCreateSessionCallbackProxy_eventCreateSession_Parms, ReturnValue), Z_Construct_UClass_UOculusCreateSessionCallbackProxy_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusCreateSessionCallbackProxy, nullptr, "CreateSession", nullptr, nullptr, Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::OculusCreateSessionCallbackProxy_eventCreateSession_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession_Statics::OculusCreateSessionCallbackProxy_eventCreateSession_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOculusCreateSessionCallbackProxy_CreateSession, "CreateSession" }, // 3107811613
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusCreateSessionCallbackProxy, OnSuccess), Z_Construct_UDelegateFunction_Engine_EmptyOnlineDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::NewProp_OnSuccess_MetaData), Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::NewProp_OnSuccess_MetaData) }; // 747690002
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::NewProp_OnFailure = { "OnFailure", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusCreateSessionCallbackProxy, OnFailure), Z_Construct_UDelegateFunction_Engine_EmptyOnlineDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::NewProp_OnFailure_MetaData), Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::NewProp_OnFailure_MetaData) }; // 747690002
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::ClassParams = {
		...
		0,
		0x008800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusCreateSessionCallbackProxy_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusCreateSessionCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusCreateSessionCallbackProxy, UOculusCreateSessionCallbackProxy::StaticClass, TEXT("UOculusCreateSessionCallbackProxy"), &Z_Registration_Info_UClass_UOculusCreateSessionCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusCreateSessionCallbackProxy), 1766680392U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusCreateSessionCallbackProxy_h_4203673218(TEXT("/Script/OnlineSubsystemOculus"),
