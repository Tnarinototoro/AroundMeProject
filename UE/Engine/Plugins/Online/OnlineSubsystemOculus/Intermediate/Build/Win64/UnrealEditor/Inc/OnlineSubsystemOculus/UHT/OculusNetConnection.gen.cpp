...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusNetConnection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusNetConnection_Statics::ClassParams = {
		...
		0,
		0x000000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusNetConnection_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusNetConnection_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusNetConnection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusNetConnection, UOculusNetConnection::StaticClass, TEXT("UOculusNetConnection"), &Z_Registration_Info_UClass_UOculusNetConnection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusNetConnection), 522123714U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusNetConnection_h_602631420(TEXT("/Script/OnlineSubsystemOculus"),
