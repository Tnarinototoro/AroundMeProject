...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusNetDriver_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusNetDriver_Statics::ClassParams = {
		...
		0,
		0x000000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusNetDriver_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusNetDriver_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusNetDriver_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusNetDriver, UOculusNetDriver::StaticClass, TEXT("UOculusNetDriver"), &Z_Registration_Info_UClass_UOculusNetDriver, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusNetDriver), 1988444908U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusNetDriver_h_2973511708(TEXT("/Script/OnlineSubsystemOculus"),
