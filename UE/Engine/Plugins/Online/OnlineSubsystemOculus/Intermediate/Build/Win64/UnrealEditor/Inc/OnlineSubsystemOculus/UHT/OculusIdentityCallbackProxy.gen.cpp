...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::NewProp_OculusId = { "OculusId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_OnlineSubsystemOculus_eventOculusIdentitySuccessResult_Parms, OculusId), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::NewProp_OculusName = { "OculusName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_OnlineSubsystemOculus_eventOculusIdentitySuccessResult_Parms, OculusName), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_OnlineSubsystemOculus, nullptr, "OculusIdentitySuccessResult__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::_Script_OnlineSubsystemOculus_eventOculusIdentitySuccessResult_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature_Statics::_Script_OnlineSubsystemOculus_eventOculusIdentitySuccessResult_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentityFailureResult__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_OnlineSubsystemOculus, nullptr, "OculusIdentityFailureResult__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentityFailureResult__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentityFailureResult__DelegateSignature_Statics::Function_MetaDataParams) };
...
void FOculusIdentityFailureResult_DelegateWrapper(const FMulticastScriptDelegate& OculusIdentityFailureResult)
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::NewProp_LocalUserNum = { "LocalUserNum", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OculusIdentityCallbackProxy_eventGetOculusIdentity_Parms, LocalUserNum), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OculusIdentityCallbackProxy_eventGetOculusIdentity_Parms, ReturnValue), Z_Construct_UClass_UOculusIdentityCallbackProxy_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusIdentityCallbackProxy, nullptr, "GetOculusIdentity", nullptr, nullptr, Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::OculusIdentityCallbackProxy_eventGetOculusIdentity_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity_Statics::OculusIdentityCallbackProxy_eventGetOculusIdentity_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOculusIdentityCallbackProxy_GetOculusIdentity, "GetOculusIdentity" }, // 3761040228
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusIdentityCallbackProxy, OnSuccess), Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentitySuccessResult__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::NewProp_OnSuccess_MetaData), Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::NewProp_OnSuccess_MetaData) }; // 2334673099
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::NewProp_OnFailure = { "OnFailure", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusIdentityCallbackProxy, OnFailure), Z_Construct_UDelegateFunction_OnlineSubsystemOculus_OculusIdentityFailureResult__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::NewProp_OnFailure_MetaData), Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::NewProp_OnFailure_MetaData) }; // 2044381019
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::ClassParams = {
		...
		0,
		0x008800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOculusIdentityCallbackProxy_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusIdentityCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusIdentityCallbackProxy, UOculusIdentityCallbackProxy::StaticClass, TEXT("UOculusIdentityCallbackProxy"), &Z_Registration_Info_UClass_UOculusIdentityCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusIdentityCallbackProxy), 2645055471U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemOculus_Source_Classes_OculusIdentityCallbackProxy_h_3029194851(TEXT("/Script/OnlineSubsystemOculus"),
