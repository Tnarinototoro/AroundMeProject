...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName = { "InterfaceName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNamedInterface, InterfaceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName_MetaData), Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceObject = { "InterfaceObject", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNamedInterface, InterfaceObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceObject_MetaData), Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceObject_MetaData) };
...
template<> ONLINESUBSYSTEM_API UScriptStruct* StaticStruct<FNamedInterfaceDef>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName = { "InterfaceClassName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNamedInterfaceDef, InterfaceClassName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName_MetaData), Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ScriptStructInfo[] = {
		{ FNamedInterface::StaticStruct, Z_Construct_UScriptStruct_FNamedInterface_Statics::NewStructOps, TEXT("NamedInterface"), &Z_Registration_Info_UScriptStruct_NamedInterface, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNamedInterface), 1631149502U) },
		{ FNamedInterfaceDef::StaticStruct, Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewStructOps, TEXT("NamedInterfaceDef"), &Z_Registration_Info_UScriptStruct_NamedInterfaceDef, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNamedInterfaceDef), 3629390214U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNamedInterfaces, UNamedInterfaces::StaticClass, TEXT("UNamedInterfaces"), &Z_Registration_Info_UClass_UNamedInterfaces, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNamedInterfaces), 3464606784U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_777996619(TEXT("/Script/OnlineSubsystem"),
