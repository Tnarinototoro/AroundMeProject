...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTurnBasedMatchInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTurnBasedMatchInterface_OnMatchEnded, "OnMatchEnded" }, // 51314409
		{ &Z_Construct_UFunction_UTurnBasedMatchInterface_OnMatchReceivedTurn, "OnMatchReceivedTurn" }, // 2208752839
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTurnBasedMatchInterface_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_Interfaces_TurnBasedMatchInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTurnBasedMatchInterface, UTurnBasedMatchInterface::StaticClass, TEXT("UTurnBasedMatchInterface"), &Z_Registration_Info_UClass_UTurnBasedMatchInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTurnBasedMatchInterface), 2708503807U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_Interfaces_TurnBasedMatchInterface_h_3056768868(TEXT("/Script/OnlineSubsystem"),
