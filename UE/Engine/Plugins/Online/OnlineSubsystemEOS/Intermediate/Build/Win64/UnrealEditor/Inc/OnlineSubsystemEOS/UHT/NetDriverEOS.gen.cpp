...
#include "../Private/NetDriverEOS.h"
...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UNetDriverEOS_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNetDriverEOS_Statics::ClassParams = {
		...
		0,
		0x001000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UNetDriverEOS_Statics::Class_MetaDataParams), Z_Construct_UClass_UNetDriverEOS_Statics::Class_MetaDataParams)
	};
	...
	UNetDriverEOS::UNetDriverEOS(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UNetDriverEOS);
	UNetDriverEOS::~UNetDriverEOS() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemEOS_Source_OnlineSubsystemEOS_Private_NetDriverEOS_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemEOS_Source_OnlineSubsystemEOS_Private_NetDriverEOS_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetDriverEOS, UNetDriverEOS::StaticClass, TEXT("UNetDriverEOS"), &Z_Registration_Info_UClass_UNetDriverEOS, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetDriverEOS), 4117161016U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemEOS_Source_OnlineSubsystemEOS_Private_NetDriverEOS_h_4011990377(TEXT("/Script/OnlineSubsystemEOS"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemEOS_Source_OnlineSubsystemEOS_Private_NetDriverEOS_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemEOS_Source_OnlineSubsystemEOS_Private_NetDriverEOS_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
