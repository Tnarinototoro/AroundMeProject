...
void FLeaderboardQueryResult_DelegateWrapper(const FMulticastScriptDelegate& LeaderboardQueryResult, int32 LeaderboardValue)
{
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULeaderboardQueryCallbackProxy_CreateProxyObjectForIntQuery_Statics::NewProp_StatName = { "StatName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LeaderboardQueryCallbackProxy_eventCreateProxyObjectForIntQuery_Parms, StatName), METADATA_PARAMS(0, nullptr) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULeaderboardQueryCallbackProxy_CreateProxyObjectForIntQuery, "CreateProxyObjectForIntQuery" }, // 3432181974
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULeaderboardQueryCallbackProxy, OnSuccess), Z_Construct_UDelegateFunction_OnlineSubsystemUtils_LeaderboardQueryResult__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::NewProp_OnSuccess_MetaData), Z_Construct_UClass_ULeaderboardQueryCallbackProxy_Statics::NewProp_OnSuccess_MetaData) }; // 1954133129
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_LeaderboardQueryCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULeaderboardQueryCallbackProxy, ULeaderboardQueryCallbackProxy::StaticClass, TEXT("ULeaderboardQueryCallbackProxy"), &Z_Registration_Info_UClass_ULeaderboardQueryCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULeaderboardQueryCallbackProxy), 3898596464U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_LeaderboardQueryCallbackProxy_h_3149099912(TEXT("/Script/OnlineSubsystemUtils"),
