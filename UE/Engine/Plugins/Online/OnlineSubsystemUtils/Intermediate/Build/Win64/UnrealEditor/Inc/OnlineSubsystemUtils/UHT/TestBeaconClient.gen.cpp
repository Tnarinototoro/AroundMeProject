...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATestBeaconClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATestBeaconClient_ClientPing, "ClientPing" }, // 1968135835
		{ &Z_Construct_UFunction_ATestBeaconClient_ServerPong, "ServerPong" }, // 1847416026
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ATestBeaconClient_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_TestBeaconClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATestBeaconClient, ATestBeaconClient::StaticClass, TEXT("ATestBeaconClient"), &Z_Registration_Info_UClass_ATestBeaconClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATestBeaconClient), 1594942899U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_TestBeaconClient_h_1413266348(TEXT("/Script/OnlineSubsystemUtils"),
