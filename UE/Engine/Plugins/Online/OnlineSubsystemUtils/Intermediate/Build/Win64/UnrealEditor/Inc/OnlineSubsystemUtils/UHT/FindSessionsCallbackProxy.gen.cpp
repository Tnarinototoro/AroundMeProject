...
void FBlueprintFindSessionsResultDelegate_DelegateWrapper(const FMulticastScriptDelegate& BlueprintFindSessionsResultDelegate, TArray<FBlueprintSessionResult> const& Results)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFindSessionsCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFindSessionsCallbackProxy_FindSessions, "FindSessions" }, // 1969404485
		{ &Z_Construct_UFunction_UFindSessionsCallbackProxy_GetCurrentPlayers, "GetCurrentPlayers" }, // 3347518555
		{ &Z_Construct_UFunction_UFindSessionsCallbackProxy_GetMaxPlayers, "GetMaxPlayers" }, // 2632867870
		{ &Z_Construct_UFunction_UFindSessionsCallbackProxy_GetPingInMs, "GetPingInMs" }, // 4152686172
		{ &Z_Construct_UFunction_UFindSessionsCallbackProxy_GetServerName, "GetServerName" }, // 3642814734
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFindSessionsCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_FindSessionsCallbackProxy_h_Statics::ScriptStructInfo[] = {
		{ FBlueprintSessionResult::StaticStruct, Z_Construct_UScriptStruct_FBlueprintSessionResult_Statics::NewStructOps, TEXT("BlueprintSessionResult"), &Z_Registration_Info_UScriptStruct_BlueprintSessionResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlueprintSessionResult), 3738885261U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_FindSessionsCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFindSessionsCallbackProxy, UFindSessionsCallbackProxy::StaticClass, TEXT("UFindSessionsCallbackProxy"), &Z_Registration_Info_UClass_UFindSessionsCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFindSessionsCallbackProxy), 733444155U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_FindSessionsCallbackProxy_h_797856968(TEXT("/Script/OnlineSubsystemUtils"),
