...
void FAchievementWriteDelegate_DelegateWrapper(const FMulticastScriptDelegate& AchievementWriteDelegate, FName WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAchievementWriteCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAchievementWriteCallbackProxy_WriteAchievementProgress, "WriteAchievementProgress" }, // 3505544528
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAchievementWriteCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_AchievementWriteCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAchievementWriteCallbackProxy, UAchievementWriteCallbackProxy::StaticClass, TEXT("UAchievementWriteCallbackProxy"), &Z_Registration_Info_UClass_UAchievementWriteCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAchievementWriteCallbackProxy), 4053227570U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_AchievementWriteCallbackProxy_h_2530273763(TEXT("/Script/OnlineSubsystemUtils"),
