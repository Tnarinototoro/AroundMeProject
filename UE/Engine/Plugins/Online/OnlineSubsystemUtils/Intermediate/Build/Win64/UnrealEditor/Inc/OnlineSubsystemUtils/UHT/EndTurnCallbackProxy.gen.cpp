...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UEndTurnCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UEndTurnCallbackProxy_EndTurn, "EndTurn" }, // 658404484
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEndTurnCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_EndTurnCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEndTurnCallbackProxy, UEndTurnCallbackProxy::StaticClass, TEXT("UEndTurnCallbackProxy"), &Z_Registration_Info_UClass_UEndTurnCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEndTurnCallbackProxy), 585823177U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_EndTurnCallbackProxy_h_3334921869(TEXT("/Script/OnlineSubsystemUtils"),
