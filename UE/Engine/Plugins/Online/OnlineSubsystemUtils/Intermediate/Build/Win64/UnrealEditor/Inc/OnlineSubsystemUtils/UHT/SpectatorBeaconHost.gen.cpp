...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_State = { "State", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpectatorBeaconHost, State), Z_Construct_UClass_USpectatorBeaconState_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_State_MetaData), Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_State_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_SessionTimeoutSecs = { "SessionTimeoutSecs", nullptr, (EPropertyFlags)0x0020080000006000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpectatorBeaconHost, SessionTimeoutSecs), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_SessionTimeoutSecs_MetaData), Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_SessionTimeoutSecs_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_TravelSessionTimeoutSecs = { "TravelSessionTimeoutSecs", nullptr, (EPropertyFlags)0x0020080000006000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpectatorBeaconHost, TravelSessionTimeoutSecs), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_TravelSessionTimeoutSecs_MetaData), Z_Construct_UClass_ASpectatorBeaconHost_Statics::NewProp_TravelSessionTimeoutSecs_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconHost_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpectatorBeaconHost, ASpectatorBeaconHost::StaticClass, TEXT("ASpectatorBeaconHost"), &Z_Registration_Info_UClass_ASpectatorBeaconHost, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpectatorBeaconHost), 538705211U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconHost_h_2034676313(TEXT("/Script/OnlineSubsystemUtils"),
