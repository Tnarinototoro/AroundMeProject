...
void FOnlineLogoutResult_DelegateWrapper(const FMulticastScriptDelegate& OnlineLogoutResult, APlayerController* PlayerController)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULogoutCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULogoutCallbackProxy_Logout, "Logout" }, // 1516394309
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULogoutCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_LogoutCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULogoutCallbackProxy, ULogoutCallbackProxy::StaticClass, TEXT("ULogoutCallbackProxy"), &Z_Registration_Info_UClass_ULogoutCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULogoutCallbackProxy), 1335622725U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_LogoutCallbackProxy_h_2776690018(TEXT("/Script/OnlineSubsystemUtils"),
