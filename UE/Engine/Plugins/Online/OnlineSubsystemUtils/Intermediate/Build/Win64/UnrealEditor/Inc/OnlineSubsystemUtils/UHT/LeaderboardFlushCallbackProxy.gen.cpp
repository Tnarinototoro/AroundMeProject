...
void FOnLeaderboardFlushed_DelegateWrapper(const FMulticastScriptDelegate& OnLeaderboardFlushed, FName SessionName)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULeaderboardFlushCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULeaderboardFlushCallbackProxy_CreateProxyObjectForFlush, "CreateProxyObjectForFlush" }, // 3087670351
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULeaderboardFlushCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULeaderboardFlushCallbackProxy_Statics::NewProp_OnFailure = { "OnFailure", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULeaderboardFlushCallbackProxy, OnFailure), Z_Construct_UDelegateFunction_OnlineSubsystemUtils_OnLeaderboardFlushed__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULeaderboardFlushCallbackProxy_Statics::NewProp_OnFailure_MetaData), Z_Construct_UClass_ULeaderboardFlushCallbackProxy_Statics::NewProp_OnFailure_MetaData) }; // 2405404293
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_LeaderboardFlushCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULeaderboardFlushCallbackProxy, ULeaderboardFlushCallbackProxy::StaticClass, TEXT("ULeaderboardFlushCallbackProxy"), &Z_Registration_Info_UClass_ULeaderboardFlushCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULeaderboardFlushCallbackProxy), 1276638169U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_LeaderboardFlushCallbackProxy_h_3658921446(TEXT("/Script/OnlineSubsystemUtils"),
