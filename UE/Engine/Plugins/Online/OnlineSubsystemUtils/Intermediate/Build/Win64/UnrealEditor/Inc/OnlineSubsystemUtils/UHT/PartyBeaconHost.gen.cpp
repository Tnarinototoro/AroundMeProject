...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bIsValidationStrRequired_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_State = { "State", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APartyBeaconHost, State), Z_Construct_UClass_UPartyBeaconState_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_State_MetaData), Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_State_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_bLogoutOnSessionTimeout = { "bLogoutOnSessionTimeout", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(APartyBeaconHost), &Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_bLogoutOnSessionTimeout_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_bLogoutOnSessionTimeout_MetaData), Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_bLogoutOnSessionTimeout_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_bIsValidationStrRequired_MetaData[] = {
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_SessionTimeoutSecs = { "SessionTimeoutSecs", nullptr, (EPropertyFlags)0x0020080000006000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APartyBeaconHost, SessionTimeoutSecs), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_SessionTimeoutSecs_MetaData), Z_Construct_UClass_APartyBeaconHost_Statics::NewProp_SessionTimeoutSecs_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_PartyBeaconHost_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APartyBeaconHost, APartyBeaconHost::StaticClass, TEXT("APartyBeaconHost"), &Z_Registration_Info_UClass_APartyBeaconHost, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APartyBeaconHost), 582001864U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_PartyBeaconHost_h_2814918317(TEXT("/Script/OnlineSubsystemUtils"),
