...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTurnBasedBlueprintLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetIsMyTurn, "GetIsMyTurn" }, // 2817517548
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetMyPlayerIndex, "GetMyPlayerIndex" }, // 2181451736
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_GetPlayerDisplayName, "GetPlayerDisplayName" }, // 515014115
		{ &Z_Construct_UFunction_UTurnBasedBlueprintLibrary_RegisterTurnBasedMatchInterfaceObject, "RegisterTurnBasedMatchInterfaceObject" }, // 511212712
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTurnBasedBlueprintLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_TurnBasedBlueprintLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTurnBasedBlueprintLibrary, UTurnBasedBlueprintLibrary::StaticClass, TEXT("UTurnBasedBlueprintLibrary"), &Z_Registration_Info_UClass_UTurnBasedBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTurnBasedBlueprintLibrary), 165661327U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_TurnBasedBlueprintLibrary_h_1445461648(TEXT("/Script/OnlineSubsystemUtils"),
