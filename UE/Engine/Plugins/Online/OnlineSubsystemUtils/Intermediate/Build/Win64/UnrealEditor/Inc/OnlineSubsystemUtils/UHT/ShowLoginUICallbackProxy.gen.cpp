...
void FOnlineShowLoginUIResult_DelegateWrapper(const FMulticastScriptDelegate& OnlineShowLoginUIResult, APlayerController* PlayerController)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UShowLoginUICallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UShowLoginUICallbackProxy_ShowExternalLoginUI, "ShowExternalLoginUI" }, // 3941984211
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UShowLoginUICallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UShowLoginUICallbackProxy_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UShowLoginUICallbackProxy, OnSuccess), Z_Construct_UDelegateFunction_OnlineSubsystemUtils_OnlineShowLoginUIResult__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UShowLoginUICallbackProxy_Statics::NewProp_OnSuccess_MetaData), Z_Construct_UClass_UShowLoginUICallbackProxy_Statics::NewProp_OnSuccess_MetaData) }; // 370741349
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_ShowLoginUICallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UShowLoginUICallbackProxy, UShowLoginUICallbackProxy::StaticClass, TEXT("UShowLoginUICallbackProxy"), &Z_Registration_Info_UClass_UShowLoginUICallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UShowLoginUICallbackProxy), 726250737U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_ShowLoginUICallbackProxy_h_3678931148(TEXT("/Script/OnlineSubsystemUtils"),
