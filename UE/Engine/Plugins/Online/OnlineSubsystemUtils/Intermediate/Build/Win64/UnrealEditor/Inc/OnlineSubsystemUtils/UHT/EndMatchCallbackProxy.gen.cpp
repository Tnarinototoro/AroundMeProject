...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UEndMatchCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UEndMatchCallbackProxy_EndMatch, "EndMatch" }, // 170705111
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEndMatchCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_EndMatchCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEndMatchCallbackProxy, UEndMatchCallbackProxy::StaticClass, TEXT("UEndMatchCallbackProxy"), &Z_Registration_Info_UClass_UEndMatchCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEndMatchCallbackProxy), 252845151U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_EndMatchCallbackProxy_h_2066966628(TEXT("/Script/OnlineSubsystemUtils"),
