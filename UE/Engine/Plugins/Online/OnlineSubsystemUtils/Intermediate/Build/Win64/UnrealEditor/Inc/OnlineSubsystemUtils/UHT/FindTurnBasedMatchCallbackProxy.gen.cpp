...
void FOnlineTurnBasedMatchResult_DelegateWrapper(const FMulticastScriptDelegate& OnlineTurnBasedMatchResult, const FString& MatchID)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFindTurnBasedMatchCallbackProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFindTurnBasedMatchCallbackProxy_FindTurnBasedMatch, "FindTurnBasedMatch" }, // 3816413364
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFindTurnBasedMatchCallbackProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_FindTurnBasedMatchCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFindTurnBasedMatchCallbackProxy, UFindTurnBasedMatchCallbackProxy::StaticClass, TEXT("UFindTurnBasedMatchCallbackProxy"), &Z_Registration_Info_UClass_UFindTurnBasedMatchCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFindTurnBasedMatchCallbackProxy), 632861033U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_FindTurnBasedMatchCallbackProxy_h_1163942949(TEXT("/Script/OnlineSubsystemUtils"),
