...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOnlineBeaconClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AOnlineBeaconClient_ClientOnConnected, "ClientOnConnected" }, // 1419149384
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconOwner = { "BeaconOwner", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AOnlineBeaconClient, BeaconOwner), Z_Construct_UClass_AOnlineBeaconHostObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconOwner_MetaData), Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconOwner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconConnection = { "BeaconConnection", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AOnlineBeaconClient, BeaconConnection), Z_Construct_UClass_UNetConnection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconConnection_MetaData), Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconConnection_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState = { "ConnectionState", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AOnlineBeaconClient, ConnectionState), Z_Construct_UEnum_OnlineSubsystemUtils_EBeaconConnectionState, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState_MetaData), Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState_MetaData) }; // 3419973341
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconClient_h_Statics::EnumInfo[] = {
		{ EBeaconConnectionState_StaticEnum, TEXT("EBeaconConnectionState"), &Z_Registration_Info_UEnum_EBeaconConnectionState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3419973341U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOnlineBeaconClient, AOnlineBeaconClient::StaticClass, TEXT("AOnlineBeaconClient"), &Z_Registration_Info_UClass_AOnlineBeaconClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOnlineBeaconClient), 4212417212U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconClient_h_2462044951(TEXT("/Script/OnlineSubsystemUtils"),
