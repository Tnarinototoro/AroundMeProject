...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_TangentWeightMode = { "TangentWeightMode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeCurveKey, TangentWeightMode), Z_Construct_UEnum_InterchangeCommonParser_EInterchangeCurveTangentWeightMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_TangentWeightMode_MetaData), Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_TangentWeightMode_MetaData) }; // 2176188934
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeCurveKey, Time), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_Time_MetaData), Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_Time_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_ArriveTangentWeight = { "ArriveTangentWeight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeCurveKey, ArriveTangentWeight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_ArriveTangentWeight_MetaData), Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_ArriveTangentWeight_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_LeaveTangent = { "LeaveTangent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeCurveKey, LeaveTangent), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_LeaveTangent_MetaData), Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_LeaveTangent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_LeaveTangentWeight = { "LeaveTangentWeight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeCurveKey, LeaveTangentWeight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_LeaveTangentWeight_MetaData), Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewProp_LeaveTangentWeight_MetaData) };
...
template<> INTERCHANGECOMMONPARSER_API UScriptStruct* StaticStruct<FInterchangeStepCurve>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FInterchangeStepCurve_Statics::NewProp_KeyTimes = { "KeyTimes", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FInterchangeStepCurve, KeyTimes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FInterchangeStepCurve_Statics::NewProp_KeyTimes_MetaData), Z_Construct_UScriptStruct_FInterchangeStepCurve_Statics::NewProp_KeyTimes_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Parsers_CommonParser_Public_InterchangeCommonAnimationPayload_h_Statics::EnumInfo[] = {
		{ EInterchangeCurveInterpMode_StaticEnum, TEXT("EInterchangeCurveInterpMode"), &Z_Registration_Info_UEnum_EInterchangeCurveInterpMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2740334918U) },
		{ EInterchangeCurveTangentMode_StaticEnum, TEXT("EInterchangeCurveTangentMode"), &Z_Registration_Info_UEnum_EInterchangeCurveTangentMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2494438628U) },
		{ EInterchangeCurveTangentWeightMode_StaticEnum, TEXT("EInterchangeCurveTangentWeightMode"), &Z_Registration_Info_UEnum_EInterchangeCurveTangentWeightMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2176188934U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Parsers_CommonParser_Public_InterchangeCommonAnimationPayload_h_Statics::ScriptStructInfo[] = {
		{ FInterchangeCurveKey::StaticStruct, Z_Construct_UScriptStruct_FInterchangeCurveKey_Statics::NewStructOps, TEXT("InterchangeCurveKey"), &Z_Registration_Info_UScriptStruct_InterchangeCurveKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInterchangeCurveKey), 558280585U) },
		{ FInterchangeCurve::StaticStruct, Z_Construct_UScriptStruct_FInterchangeCurve_Statics::NewStructOps, TEXT("InterchangeCurve"), &Z_Registration_Info_UScriptStruct_InterchangeCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInterchangeCurve), 1025000369U) },
		{ FInterchangeStepCurve::StaticStruct, Z_Construct_UScriptStruct_FInterchangeStepCurve_Statics::NewStructOps, TEXT("InterchangeStepCurve"), &Z_Registration_Info_UScriptStruct_InterchangeStepCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInterchangeStepCurve), 2328365202U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Parsers_CommonParser_Public_InterchangeCommonAnimationPayload_h_611163960(TEXT("/Script/InterchangeCommonParser"),
		nullptr, 0,
