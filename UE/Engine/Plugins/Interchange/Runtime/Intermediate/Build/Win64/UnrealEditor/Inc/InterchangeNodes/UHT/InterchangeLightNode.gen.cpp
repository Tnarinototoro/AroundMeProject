...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeBaseLightNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_GetCustomIntensity, "GetCustomIntensity" }, // 131239742
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_GetCustomLightColor, "GetCustomLightColor" }, // 4013254794
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_GetCustomTemperature, "GetCustomTemperature" }, // 3385627667
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_GetCustomUseTemperature, "GetCustomUseTemperature" }, // 3923030123
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_SetCustomIntensity, "SetCustomIntensity" }, // 1974131801
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_SetCustomLightColor, "SetCustomLightColor" }, // 2987675982
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_SetCustomTemperature, "SetCustomTemperature" }, // 2082714192
		{ &Z_Construct_UFunction_UInterchangeBaseLightNode_SetCustomUseTemperature, "SetCustomUseTemperature" }, // 3503319151
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeBaseLightNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeLightNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeLightNode_GetCustomAttenuationRadius, "GetCustomAttenuationRadius" }, // 354347267
		{ &Z_Construct_UFunction_UInterchangeLightNode_GetCustomIESTexture, "GetCustomIESTexture" }, // 1774858386
		{ &Z_Construct_UFunction_UInterchangeLightNode_GetCustomIntensityUnits, "GetCustomIntensityUnits" }, // 1606607137
		{ &Z_Construct_UFunction_UInterchangeLightNode_SetCustomAttenuationRadius, "SetCustomAttenuationRadius" }, // 608510212
		{ &Z_Construct_UFunction_UInterchangeLightNode_SetCustomIESTexture, "SetCustomIESTexture" }, // 292995515
		{ &Z_Construct_UFunction_UInterchangeLightNode_SetCustomIntensityUnits, "SetCustomIntensityUnits" }, // 797184645
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeLightNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangePointLightNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangePointLightNode_GetCustomLightFalloffExponent, "GetCustomLightFalloffExponent" }, // 2787516391
		{ &Z_Construct_UFunction_UInterchangePointLightNode_GetCustomUseInverseSquaredFalloff, "GetCustomUseInverseSquaredFalloff" }, // 1562468594
		{ &Z_Construct_UFunction_UInterchangePointLightNode_SetCustomLightFalloffExponent, "SetCustomLightFalloffExponent" }, // 2897242893
		{ &Z_Construct_UFunction_UInterchangePointLightNode_SetCustomUseInverseSquaredFalloff, "SetCustomUseInverseSquaredFalloff" }, // 864419449
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangePointLightNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeSpotLightNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeSpotLightNode_GetCustomInnerConeAngle, "GetCustomInnerConeAngle" }, // 4008680474
		{ &Z_Construct_UFunction_UInterchangeSpotLightNode_GetCustomOuterConeAngle, "GetCustomOuterConeAngle" }, // 3350735255
		{ &Z_Construct_UFunction_UInterchangeSpotLightNode_SetCustomInnerConeAngle, "SetCustomInnerConeAngle" }, // 307054062
		{ &Z_Construct_UFunction_UInterchangeSpotLightNode_SetCustomOuterConeAngle, "SetCustomOuterConeAngle" }, // 437697116
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeSpotLightNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeRectLightNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeRectLightNode_GetCustomSourceHeight, "GetCustomSourceHeight" }, // 4104805162
		{ &Z_Construct_UFunction_UInterchangeRectLightNode_GetCustomSourceWidth, "GetCustomSourceWidth" }, // 826090416
		{ &Z_Construct_UFunction_UInterchangeRectLightNode_SetCustomSourceHeight, "SetCustomSourceHeight" }, // 4118255558
		{ &Z_Construct_UFunction_UInterchangeRectLightNode_SetCustomSourceWidth, "SetCustomSourceWidth" }, // 58124984
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeRectLightNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Nodes_Public_InterchangeLightNode_h_Statics::EnumInfo[] = {
		{ EInterchangeLightUnits_StaticEnum, TEXT("EInterchangeLightUnits"), &Z_Registration_Info_UEnum_EInterchangeLightUnits, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1109756621U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Nodes_Public_InterchangeLightNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInterchangeBaseLightNode, UInterchangeBaseLightNode::StaticClass, TEXT("UInterchangeBaseLightNode"), &Z_Registration_Info_UClass_UInterchangeBaseLightNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeBaseLightNode), 2074786232U) },
		{ Z_Construct_UClass_UInterchangeLightNode, UInterchangeLightNode::StaticClass, TEXT("UInterchangeLightNode"), &Z_Registration_Info_UClass_UInterchangeLightNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeLightNode), 1974610923U) },
		{ Z_Construct_UClass_UInterchangePointLightNode, UInterchangePointLightNode::StaticClass, TEXT("UInterchangePointLightNode"), &Z_Registration_Info_UClass_UInterchangePointLightNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangePointLightNode), 1864501724U) },
		{ Z_Construct_UClass_UInterchangeSpotLightNode, UInterchangeSpotLightNode::StaticClass, TEXT("UInterchangeSpotLightNode"), &Z_Registration_Info_UClass_UInterchangeSpotLightNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeSpotLightNode), 3044944761U) },
		{ Z_Construct_UClass_UInterchangeRectLightNode, UInterchangeRectLightNode::StaticClass, TEXT("UInterchangeRectLightNode"), &Z_Registration_Info_UClass_UInterchangeRectLightNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeRectLightNode), 870951715U) },
		{ Z_Construct_UClass_UInterchangeDirectionalLightNode, UInterchangeDirectionalLightNode::StaticClass, TEXT("UInterchangeDirectionalLightNode"), &Z_Registration_Info_UClass_UInterchangeDirectionalLightNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeDirectionalLightNode), 3259490381U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Nodes_Public_InterchangeLightNode_h_1483380360(TEXT("/Script/InterchangeNodes"),
