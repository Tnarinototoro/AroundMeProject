...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UInterchangeOBJTranslator_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UInterchangeOBJTranslator_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UInterchangeMeshPayloadInterface_NoRegister, (int32)VTABLE_OFFSET(UInterchangeOBJTranslator, IInterchangeMeshPayloadInterface), false },  // 681125245
			{ Z_Construct_UClass_UInterchangeTexturePayloadInterface_NoRegister, (int32)VTABLE_OFFSET(UInterchangeOBJTranslator, IInterchangeTexturePayloadInterface), false },  // 469965785
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeOBJTranslator_Statics::InterfaceParams) < 64);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Import_Public_Mesh_InterchangeOBJTranslator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInterchangeOBJTranslator, UInterchangeOBJTranslator::StaticClass, TEXT("UInterchangeOBJTranslator"), &Z_Registration_Info_UClass_UInterchangeOBJTranslator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeOBJTranslator), 2062099834U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Import_Public_Mesh_InterchangeOBJTranslator_h_3807014708(TEXT("/Script/InterchangeImport"),
