...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeTextureLightProfileFactoryNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeTextureLightProfileFactoryNode_GetCustomBrightness, "GetCustomBrightness" }, // 1744507032
		{ &Z_Construct_UFunction_UInterchangeTextureLightProfileFactoryNode_GetCustomTextureMultiplier, "GetCustomTextureMultiplier" }, // 79636764
		{ &Z_Construct_UFunction_UInterchangeTextureLightProfileFactoryNode_SetCustomBrightness, "SetCustomBrightness" }, // 223943474
		{ &Z_Construct_UFunction_UInterchangeTextureLightProfileFactoryNode_SetCustomTextureMultiplier, "SetCustomTextureMultiplier" }, // 485428576
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeTextureLightProfileFactoryNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_FactoryNodes_Public_InterchangeTextureLightProfileFactoryNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInterchangeTextureLightProfileFactoryNode, UInterchangeTextureLightProfileFactoryNode::StaticClass, TEXT("UInterchangeTextureLightProfileFactoryNode"), &Z_Registration_Info_UClass_UInterchangeTextureLightProfileFactoryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeTextureLightProfileFactoryNode), 293508969U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_FactoryNodes_Public_InterchangeTextureLightProfileFactoryNode_h_2814225812(TEXT("/Script/InterchangeFactoryNodes"),
