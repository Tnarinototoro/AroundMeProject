...
#include "../Private/MaterialX/MaterialExpressions/MaterialExpressionLuminance.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_InterchangeImport_EMaterialXLuminanceMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_InterchangeImport_EMaterialXLuminanceMode_Statics::Enum_MetaDataParams[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_Input_MetaData[] = {
		{ "ModuleRelativePath", "Private/MaterialX/MaterialExpressions/MaterialExpressionLuminance.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_Input = { "Input", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialExpressionMaterialXLuminance, Input), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_Input_MetaData), Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_Input_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_LuminanceFactors_MetaData[] = {
		{ "Category", "MaterialExpressionLuminance" },
		{ "ModuleRelativePath", "Private/MaterialX/MaterialExpressions/MaterialExpressionLuminance.h" },
		{ "ShowAsInputPin", "Advanced" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_LuminanceFactors = { "LuminanceFactors", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialExpressionMaterialXLuminance, LuminanceFactors), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_LuminanceFactors_MetaData), Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_LuminanceFactors_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::NewProp_LuminanceMode_MetaData[] = {
		{ "Category", "MaterialExpressionLuminance" },
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMaterialExpressionMaterialXLuminance_Statics::StaticCppClassTypeInfo = {
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Import_Private_MaterialX_MaterialExpressions_MaterialExpressionLuminance_h_Statics::EnumInfo[] = {
		{ EMaterialXLuminanceMode_StaticEnum, TEXT("EMaterialXLuminanceMode"), &Z_Registration_Info_UEnum_EMaterialXLuminanceMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 254847252U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Import_Private_MaterialX_MaterialExpressions_MaterialExpressionLuminance_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_Import_Private_MaterialX_MaterialExpressions_MaterialExpressionLuminance_h_1865441333(TEXT("/Script/InterchangeImport"),
