...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeBaseLightFactoryNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_GetCustomIntensity, "GetCustomIntensity" }, // 1337436096
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_GetCustomLightColor, "GetCustomLightColor" }, // 3497318388
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_GetCustomTemperature, "GetCustomTemperature" }, // 3179783612
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_GetCustomUseTemperature, "GetCustomUseTemperature" }, // 4073431594
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_SetCustomIntensity, "SetCustomIntensity" }, // 657136966
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_SetCustomLightColor, "SetCustomLightColor" }, // 1485190654
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_SetCustomTemperature, "SetCustomTemperature" }, // 2327407339
		{ &Z_Construct_UFunction_UInterchangeBaseLightFactoryNode_SetCustomUseTemperature, "SetCustomUseTemperature" }, // 686926613
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeBaseLightFactoryNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeLightFactoryNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeLightFactoryNode_GetCustomAttenuationRadius, "GetCustomAttenuationRadius" }, // 1723585937
		{ &Z_Construct_UFunction_UInterchangeLightFactoryNode_GetCustomIESTexture, "GetCustomIESTexture" }, // 2969429243
		{ &Z_Construct_UFunction_UInterchangeLightFactoryNode_GetCustomIntensityUnits, "GetCustomIntensityUnits" }, // 1511943881
		{ &Z_Construct_UFunction_UInterchangeLightFactoryNode_SetCustomAttenuationRadius, "SetCustomAttenuationRadius" }, // 3029658138
		{ &Z_Construct_UFunction_UInterchangeLightFactoryNode_SetCustomIESTexture, "SetCustomIESTexture" }, // 1594058563
		{ &Z_Construct_UFunction_UInterchangeLightFactoryNode_SetCustomIntensityUnits, "SetCustomIntensityUnits" }, // 3054926785
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeLightFactoryNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeRectLightFactoryNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeRectLightFactoryNode_GetCustomSourceHeight, "GetCustomSourceHeight" }, // 4013011049
		{ &Z_Construct_UFunction_UInterchangeRectLightFactoryNode_GetCustomSourceWidth, "GetCustomSourceWidth" }, // 496652650
		{ &Z_Construct_UFunction_UInterchangeRectLightFactoryNode_SetCustomSourceHeight, "SetCustomSourceHeight" }, // 4094936291
		{ &Z_Construct_UFunction_UInterchangeRectLightFactoryNode_SetCustomSourceWidth, "SetCustomSourceWidth" }, // 2895489751
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeRectLightFactoryNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangePointLightFactoryNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangePointLightFactoryNode_GetCustomLightFalloffExponent, "GetCustomLightFalloffExponent" }, // 2533671595
		{ &Z_Construct_UFunction_UInterchangePointLightFactoryNode_GetCustomUseInverseSquaredFalloff, "GetCustomUseInverseSquaredFalloff" }, // 2922814136
		{ &Z_Construct_UFunction_UInterchangePointLightFactoryNode_SetCustomLightFalloffExponent, "SetCustomLightFalloffExponent" }, // 1309541017
		{ &Z_Construct_UFunction_UInterchangePointLightFactoryNode_SetCustomUseInverseSquaredFalloff, "SetCustomUseInverseSquaredFalloff" }, // 867448327
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangePointLightFactoryNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInterchangeSpotLightFactoryNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInterchangeSpotLightFactoryNode_GetCustomInnerConeAngle, "GetCustomInnerConeAngle" }, // 2949016702
		{ &Z_Construct_UFunction_UInterchangeSpotLightFactoryNode_GetCustomOuterConeAngle, "GetCustomOuterConeAngle" }, // 517869085
		{ &Z_Construct_UFunction_UInterchangeSpotLightFactoryNode_SetCustomInnerConeAngle, "SetCustomInnerConeAngle" }, // 1463673286
		{ &Z_Construct_UFunction_UInterchangeSpotLightFactoryNode_SetCustomOuterConeAngle, "SetCustomOuterConeAngle" }, // 1232648689
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UInterchangeSpotLightFactoryNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_FactoryNodes_Public_InterchangeLightFactoryNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInterchangeBaseLightFactoryNode, UInterchangeBaseLightFactoryNode::StaticClass, TEXT("UInterchangeBaseLightFactoryNode"), &Z_Registration_Info_UClass_UInterchangeBaseLightFactoryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeBaseLightFactoryNode), 3045530203U) },
		{ Z_Construct_UClass_UInterchangeDirectionalLightFactoryNode, UInterchangeDirectionalLightFactoryNode::StaticClass, TEXT("UInterchangeDirectionalLightFactoryNode"), &Z_Registration_Info_UClass_UInterchangeDirectionalLightFactoryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeDirectionalLightFactoryNode), 3713625613U) },
		{ Z_Construct_UClass_UInterchangeLightFactoryNode, UInterchangeLightFactoryNode::StaticClass, TEXT("UInterchangeLightFactoryNode"), &Z_Registration_Info_UClass_UInterchangeLightFactoryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeLightFactoryNode), 3038502065U) },
		{ Z_Construct_UClass_UInterchangeRectLightFactoryNode, UInterchangeRectLightFactoryNode::StaticClass, TEXT("UInterchangeRectLightFactoryNode"), &Z_Registration_Info_UClass_UInterchangeRectLightFactoryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeRectLightFactoryNode), 1288618392U) },
		{ Z_Construct_UClass_UInterchangePointLightFactoryNode, UInterchangePointLightFactoryNode::StaticClass, TEXT("UInterchangePointLightFactoryNode"), &Z_Registration_Info_UClass_UInterchangePointLightFactoryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangePointLightFactoryNode), 4134762374U) },
		{ Z_Construct_UClass_UInterchangeSpotLightFactoryNode, UInterchangeSpotLightFactoryNode::StaticClass, TEXT("UInterchangeSpotLightFactoryNode"), &Z_Registration_Info_UClass_UInterchangeSpotLightFactoryNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInterchangeSpotLightFactoryNode), 1684024059U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Interchange_Runtime_Source_FactoryNodes_Public_InterchangeLightFactoryNode_h_691410661(TEXT("/Script/InterchangeFactoryNodes"),
