...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseModifierGroup_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBaseModifierGroup_Statics::NewProp_NodeName = { "NodeName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBaseModifierGroup, NodeName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseModifierGroup_Statics::NewProp_NodeName_MetaData), Z_Construct_UClass_UBaseModifierGroup_Statics::NewProp_NodeName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBaseModifierGroup_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseModifierGroup_Statics::Class_MetaDataParams), Z_Construct_UClass_UBaseModifierGroup_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseModifierGroup_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_BaseModifierGroup_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_BaseModifierGroup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBaseModifierGroup, UBaseModifierGroup::StaticClass, TEXT("UBaseModifierGroup"), &Z_Registration_Info_UClass_UBaseModifierGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseModifierGroup), 3304872984U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_BaseModifierGroup_h_1833293739(TEXT("/Script/VCamExtensions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_BaseModifierGroup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_BaseModifierGroup_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
