...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_VirtualCamera_VirtualCameraResetOffsetsDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_VirtualCamera, nullptr, "VirtualCameraResetOffsetsDelegate__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_VirtualCamera_VirtualCameraResetOffsetsDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_VirtualCamera_VirtualCameraResetOffsetsDelegate__DelegateSignature_Statics::Function_MetaDataParams) };
...
void FVirtualCameraResetOffsetsDelegate_DelegateWrapper(const FMulticastScriptDelegate& VirtualCameraResetOffsetsDelegate)
{
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::NewProp_RootUpdatedComponent = { "RootUpdatedComponent", nullptr, (EPropertyFlags)0x0044000000282008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVirtualCameraMovementComponent, RootUpdatedComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::NewProp_RootUpdatedComponent_MetaData), Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::NewProp_RootUpdatedComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::NewProp_RootUpdatedPrimitive = { "RootUpdatedPrimitive", nullptr, (EPropertyFlags)0x0044000000282008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVirtualCameraMovementComponent, RootUpdatedPrimitive), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::NewProp_RootUpdatedPrimitive_MetaData), Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::NewProp_RootUpdatedPrimitive_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraMovementComponent_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_VirtualCameraMovementComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_VirtualCameraMovementComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVirtualCameraMovementComponent, UVirtualCameraMovementComponent::StaticClass, TEXT("UVirtualCameraMovementComponent"), &Z_Registration_Info_UClass_UVirtualCameraMovementComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVirtualCameraMovementComponent), 631547239U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_VirtualCameraMovementComponent_h_1210693034(TEXT("/Script/VirtualCamera"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_VirtualCameraMovementComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_VirtualCameraMovementComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
