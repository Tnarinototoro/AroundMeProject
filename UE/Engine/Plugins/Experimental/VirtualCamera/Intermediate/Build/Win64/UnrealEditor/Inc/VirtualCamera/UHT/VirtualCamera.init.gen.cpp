...
void EmptyLinkFunctionForGeneratedCodeVirtualCamera_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_VirtualCamera()
	{
		if (!Z_Registration_Info_UPackage__Script_VirtualCamera.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_VirtualCamera_AssetSortingPredicate__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_VirtualCamera(Z_Construct_UPackage__Script_VirtualCamera, TEXT("/Script/VirtualCamera"), Z_Registration_Info_UPackage__Script_VirtualCamera, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xA43F0E76, 0x5D99CD85));
