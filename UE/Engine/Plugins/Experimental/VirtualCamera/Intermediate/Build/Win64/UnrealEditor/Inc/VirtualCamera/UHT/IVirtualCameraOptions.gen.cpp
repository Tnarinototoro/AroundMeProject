...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VirtualCameraOptions_eventGetDesiredDistanceUnits_Parms, ReturnValue), Z_Construct_UEnum_CoreUObject_EUnit, METADATA_PARAMS(0, nullptr) }; // 2887558308
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVirtualCameraOptions, nullptr, "GetDesiredDistanceUnits", nullptr, nullptr, Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits_Statics::PropPointers), sizeof(VirtualCameraOptions_eventGetDesiredDistanceUnits_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits_Statics::PropPointers) < 2048);
	static_assert(sizeof(VirtualCameraOptions_eventGetDesiredDistanceUnits_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VirtualCameraOptions_eventIsFocusVisualizationAllowed_Parms), &Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVirtualCameraOptions, nullptr, "IsFocusVisualizationAllowed", nullptr, nullptr, Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::PropPointers), sizeof(VirtualCameraOptions_eventIsFocusVisualizationAllowed_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed_Statics::PropPointers) < 2048);
	static_assert(sizeof(VirtualCameraOptions_eventIsFocusVisualizationAllowed_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::NewProp_DesiredUnits = { "DesiredUnits", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VirtualCameraOptions_eventSetDesiredDistanceUnits_Parms, DesiredUnits), Z_Construct_UEnum_CoreUObject_EUnit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::NewProp_DesiredUnits_MetaData), Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::NewProp_DesiredUnits_MetaData) }; // 2887558308
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVirtualCameraOptions, nullptr, "SetDesiredDistanceUnits", nullptr, nullptr, Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::PropPointers), sizeof(VirtualCameraOptions_eventSetDesiredDistanceUnits_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits_Statics::PropPointers) < 2048);
	static_assert(sizeof(VirtualCameraOptions_eventSetDesiredDistanceUnits_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraOptions_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVirtualCameraOptions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVirtualCameraOptions_GetDesiredDistanceUnits, "GetDesiredDistanceUnits" }, // 3096581253
		{ &Z_Construct_UFunction_UVirtualCameraOptions_IsFocusVisualizationAllowed, "IsFocusVisualizationAllowed" }, // 995534296
		{ &Z_Construct_UFunction_UVirtualCameraOptions_SetDesiredDistanceUnits, "SetDesiredDistanceUnits" }, // 680291067
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraOptions_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVirtualCameraOptions_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualCameraOptions_Statics::Class_MetaDataParams), Z_Construct_UClass_UVirtualCameraOptions_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_IVirtualCameraOptions_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_IVirtualCameraOptions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVirtualCameraOptions, UVirtualCameraOptions::StaticClass, TEXT("UVirtualCameraOptions"), &Z_Registration_Info_UClass_UVirtualCameraOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVirtualCameraOptions), 74115744U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_IVirtualCameraOptions_h_937279552(TEXT("/Script/VirtualCamera"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_IVirtualCameraOptions_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VirtualCamera_Public_IVirtualCameraOptions_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
