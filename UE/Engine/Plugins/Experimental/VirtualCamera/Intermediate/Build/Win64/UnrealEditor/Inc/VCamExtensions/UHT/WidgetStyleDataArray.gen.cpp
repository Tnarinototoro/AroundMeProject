...
template<> VCAMEXTENSIONS_API UScriptStruct* StaticStruct<FWidgetStyleDataArray>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::NewProp_Styles_Inner = { "Styles", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UWidgetStyleData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::NewProp_Styles_Inner_MetaData), Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::NewProp_Styles_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::NewProp_Styles = { "Styles", nullptr, (EPropertyFlags)0x0014008000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWidgetStyleDataArray, Styles), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::NewProp_Styles_MetaData), Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::NewProp_Styles_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleDataArray_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleDataArray_h_Statics::ScriptStructInfo[] = {
		{ FWidgetStyleDataArray::StaticStruct, Z_Construct_UScriptStruct_FWidgetStyleDataArray_Statics::NewStructOps, TEXT("WidgetStyleDataArray"), &Z_Registration_Info_UScriptStruct_WidgetStyleDataArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetStyleDataArray), 4000070941U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleDataArray_h_3471779832(TEXT("/Script/VCamExtensions"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleDataArray_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleDataArray_h_Statics::ScriptStructInfo),
		nullptr, 0);
