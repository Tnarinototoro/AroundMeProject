...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UModifierBoundWidgetStylesAssetFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UModifierBoundWidgetStylesAssetFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UModifierBoundWidgetStylesAssetFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UModifierBoundWidgetStylesAssetFactory_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierBoundWidgetStylesAssetFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierBoundWidgetStylesAssetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UModifierBoundWidgetStylesAssetFactory, UModifierBoundWidgetStylesAssetFactory::StaticClass, TEXT("UModifierBoundWidgetStylesAssetFactory"), &Z_Registration_Info_UClass_UModifierBoundWidgetStylesAssetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UModifierBoundWidgetStylesAssetFactory), 2691274220U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierBoundWidgetStylesAssetFactory_h_3345867410(TEXT("/Script/VCamExtensionsEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierBoundWidgetStylesAssetFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierBoundWidgetStylesAssetFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
