...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UModifierHierarchyAssetFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UModifierHierarchyAssetFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UModifierHierarchyAssetFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UModifierHierarchyAssetFactory_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierHierarchyAssetFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierHierarchyAssetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UModifierHierarchyAssetFactory, UModifierHierarchyAssetFactory::StaticClass, TEXT("UModifierHierarchyAssetFactory"), &Z_Registration_Info_UClass_UModifierHierarchyAssetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UModifierHierarchyAssetFactory), 4219963903U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierHierarchyAssetFactory_h_107886523(TEXT("/Script/VCamExtensionsEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierHierarchyAssetFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensionsEditor_Private_Factories_ModifierHierarchyAssetFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
