...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UButtonWidgetStyleData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UButtonWidgetStyleData_Statics::NewProp_ButtonStyle = { "ButtonStyle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UButtonWidgetStyleData, ButtonStyle), Z_Construct_UScriptStruct_FButtonStyle, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UButtonWidgetStyleData_Statics::NewProp_ButtonStyle_MetaData), Z_Construct_UClass_UButtonWidgetStyleData_Statics::NewProp_ButtonStyle_MetaData) }; // 1902661672
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UButtonWidgetStyleData_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UButtonWidgetStyleData_Statics::Class_MetaDataParams), Z_Construct_UClass_UButtonWidgetStyleData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UButtonWidgetStyleData_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_ButtonWidgetStyleData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_ButtonWidgetStyleData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UButtonWidgetStyleData, UButtonWidgetStyleData::StaticClass, TEXT("UButtonWidgetStyleData"), &Z_Registration_Info_UClass_UButtonWidgetStyleData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UButtonWidgetStyleData), 1094639549U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_ButtonWidgetStyleData_h_2255763253(TEXT("/Script/VCamExtensions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_ButtonWidgetStyleData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_ButtonWidgetStyleData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
