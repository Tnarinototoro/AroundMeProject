...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_TargetSettings = { "TargetSettings", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USingleModifierPerNodeWithTargetSettings, TargetSettings), Z_Construct_UScriptStruct_FVCamConnectionTargetSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_TargetSettings_MetaData), Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_TargetSettings_MetaData) }; // 1107605184
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_ChildElements_Inner = { "ChildElements", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_ChildElements_Inner_MetaData), Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_ChildElements_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_ChildElements = { "ChildElements", nullptr, (EPropertyFlags)0x0014008000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USingleModifierPerNodeWithTargetSettings, ChildElements), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_ChildElements_MetaData), Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::NewProp_ChildElements_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::NewProp_Root = { "Root", nullptr, (EPropertyFlags)0x0046000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTargetModifierPerNodeHierarchyRules, Root), Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::NewProp_Root_MetaData), Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::NewProp_Root_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::Class_MetaDataParams), Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetModifierPerNodeHierarchyRules_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_TargetModifierPerNodeHierarchyRules_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_TargetModifierPerNodeHierarchyRules_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USingleModifierPerNodeWithTargetSettings, USingleModifierPerNodeWithTargetSettings::StaticClass, TEXT("USingleModifierPerNodeWithTargetSettings"), &Z_Registration_Info_UClass_USingleModifierPerNodeWithTargetSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USingleModifierPerNodeWithTargetSettings), 2282816875U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_TargetModifierPerNodeHierarchyRules_h_563618294(TEXT("/Script/VCamExtensions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_TargetModifierPerNodeHierarchyRules_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Hierarchies_TargetModifierPerNodeHierarchyRules_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
