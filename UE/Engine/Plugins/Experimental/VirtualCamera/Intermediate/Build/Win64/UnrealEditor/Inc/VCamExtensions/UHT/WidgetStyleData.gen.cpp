...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetStyleData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWidgetStyleData_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetStyleData_Statics::Class_MetaDataParams), Z_Construct_UClass_UWidgetStyleData_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWidgetStyleData, UWidgetStyleData::StaticClass, TEXT("UWidgetStyleData"), &Z_Registration_Info_UClass_UWidgetStyleData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWidgetStyleData), 215634223U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleData_h_1084212915(TEXT("/Script/VCamExtensions"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCamera_Source_VCamExtensions_Public_Styling_WidgetStyleData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
