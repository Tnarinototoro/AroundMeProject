...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_AnimMontage = { "AnimMontage", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameplayBehaviorConfig_Animation, AnimMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_AnimMontage_MetaData), Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_AnimMontage_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_PlayRate = { "PlayRate", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameplayBehaviorConfig_Animation, PlayRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_PlayRate_MetaData), Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_PlayRate_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_StartSectionName = { "StartSectionName", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameplayBehaviorConfig_Animation, StartSectionName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_StartSectionName_MetaData), Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_StartSectionName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_bLoop = { "bLoop", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UGameplayBehaviorConfig_Animation), &Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_bLoop_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_bLoop_MetaData), Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::NewProp_bLoop_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::ClassParams = {
		...
		0,
		0x001030A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayBehaviorConfig_Animation_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameplayBehaviors_Source_GameplayBehaviorsModule_Public_GameplayBehaviorConfig_Animation_h_448476353(TEXT("/Script/GameplayBehaviorsModule"),
