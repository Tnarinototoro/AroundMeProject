...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCineSplineMetadataDetailsFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCineSplineMetadataDetailsFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCineSplineMetadataDetailsFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UCineSplineMetadataDetailsFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CineCameraRigs_Source_CineCameraRigsEditor_Private_CineSplineMetadataDetails_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCineSplineMetadataDetailsFactory, UCineSplineMetadataDetailsFactory::StaticClass, TEXT("UCineSplineMetadataDetailsFactory"), &Z_Registration_Info_UClass_UCineSplineMetadataDetailsFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCineSplineMetadataDetailsFactory), 931621852U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CineCameraRigs_Source_CineCameraRigsEditor_Private_CineSplineMetadataDetails_h_297145710(TEXT("/Script/CineCameraRigsEditor"),
