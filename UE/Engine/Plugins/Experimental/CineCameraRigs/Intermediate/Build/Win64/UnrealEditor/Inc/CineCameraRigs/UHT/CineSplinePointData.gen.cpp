...
template<> CINECAMERARIGS_API UScriptStruct* StaticStruct<FCineSplinePointData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCineSplinePointData, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Location_MetaData), Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Location_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCineSplinePointData, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Rotation_MetaData), Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Rotation_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_FocalLength = { "FocalLength", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCineSplinePointData, FocalLength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_FocalLength_MetaData), Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_FocalLength_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Aperture = { "Aperture", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCineSplinePointData, Aperture), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Aperture_MetaData), Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_Aperture_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_FocusDistance = { "FocusDistance", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCineSplinePointData, FocusDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_FocusDistance_MetaData), Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewProp_FocusDistance_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCineSplinePointData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCineSplinePointData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FCineSplinePointData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCineSplinePointData_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CineCameraRigs_Source_CineCameraRigs_Public_CineSplinePointData_h_Statics::ScriptStructInfo[] = {
		{ FCineSplinePointData::StaticStruct, Z_Construct_UScriptStruct_FCineSplinePointData_Statics::NewStructOps, TEXT("CineSplinePointData"), &Z_Registration_Info_UScriptStruct_CineSplinePointData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCineSplinePointData), 323724766U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CineCameraRigs_Source_CineCameraRigs_Public_CineSplinePointData_h_3115860377(TEXT("/Script/CineCameraRigs"),
		nullptr, 0,
