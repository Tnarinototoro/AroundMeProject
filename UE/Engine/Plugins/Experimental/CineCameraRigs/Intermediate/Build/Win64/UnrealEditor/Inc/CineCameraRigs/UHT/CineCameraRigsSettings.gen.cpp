...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SpeedModeSplineMeshTexture_MetaData[];
#endif
		static const UECodeGen_Private::FSoftObjectPropertyParams NewProp_SpeedModeSplineMeshTexture;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCineCameraRigRailSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshMaterial_MetaData[] = {
		...
		{ "Comment", "/* Path to the default spline mesh material used in CineCameraRigRail*/" },
		{ "ModuleRelativePath", "Public/CineCameraRigsSettings.h" },
		{ "ToolTip", "Path to the default spline mesh material used in CineCameraRigRail" },
	};
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshMaterial = { "DefaultSplineMeshMaterial", nullptr, (EPropertyFlags)0x0014000000004005, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCineCameraRigRailSettings, DefaultSplineMeshMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshMaterial_MetaData), Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshMaterial_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshTexture_MetaData[] = {
		{ "Category", "CineCameraRigRail" },
		{ "Comment", "/* Path to the default spline mesh texture used when speed visualization is off*/" },
		{ "ModuleRelativePath", "Public/CineCameraRigsSettings.h" },
		{ "ToolTip", "Path to the default spline mesh texture used when speed visualization is off" },
	};
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshTexture = { "DefaultSplineMeshTexture", nullptr, (EPropertyFlags)0x0014000000004005, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCineCameraRigRailSettings, DefaultSplineMeshTexture), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshTexture_MetaData), Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_DefaultSplineMeshTexture_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_SpeedModeSplineMeshTexture_MetaData[] = {
		{ "Category", "CineCameraRigRail" },
		{ "Comment", "/* Path to the texture used in the speed visualization when drive mode is Speed*/" },
		{ "ModuleRelativePath", "Public/CineCameraRigsSettings.h" },
		{ "ToolTip", "Path to the texture used in the speed visualization when drive mode is Speed" },
	};
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_SpeedModeSplineMeshTexture = { "SpeedModeSplineMeshTexture", nullptr, (EPropertyFlags)0x0014000000004005, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCineCameraRigRailSettings, SpeedModeSplineMeshTexture), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_SpeedModeSplineMeshTexture_MetaData), Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_SpeedModeSplineMeshTexture_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCineCameraRigRailSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCineCameraRigRailSettings_Statics::NewProp_SpeedModeSplineMeshTexture,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCineCameraRigRailSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCineCameraRigRailSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UCineCameraRigRailSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCineCameraRigRailSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CineCameraRigs_Source_CineCameraRigs_Public_CineCameraRigsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCineCameraRigRailSettings, UCineCameraRigRailSettings::StaticClass, TEXT("UCineCameraRigRailSettings"), &Z_Registration_Info_UClass_UCineCameraRigRailSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCineCameraRigRailSettings), 3135584504U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CineCameraRigs_Source_CineCameraRigs_Public_CineCameraRigsSettings_h_57662644(TEXT("/Script/CineCameraRigs"),
