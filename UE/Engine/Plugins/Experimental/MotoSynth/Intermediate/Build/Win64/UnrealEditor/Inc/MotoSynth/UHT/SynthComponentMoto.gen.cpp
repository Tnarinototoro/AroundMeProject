...
// End Cross Module References
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::NewProp_OutMinRPM = { "OutMinRPM", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynthComponentMoto_eventGetRPMRange_Parms, OutMinRPM), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::NewProp_OutMaxRPM = { "OutMaxRPM", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynthComponentMoto_eventGetRPMRange_Parms, OutMaxRPM), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynthComponentMoto, nullptr, "GetRPMRange", nullptr, nullptr, Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::PropPointers), sizeof(Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::SynthComponentMoto_eventGetRPMRange_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::Function_MetaDataParams), Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USynthComponentMoto_GetRPMRange_Statics::SynthComponentMoto_eventGetRPMRange_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SynthComponentMoto_eventIsEnabled_Parms), &Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynthComponentMoto, nullptr, "IsEnabled", nullptr, nullptr, Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::PropPointers), sizeof(Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::SynthComponentMoto_eventIsEnabled_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::Function_MetaDataParams), Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USynthComponentMoto_IsEnabled_Statics::SynthComponentMoto_eventIsEnabled_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::NewProp_InRPM = { "InRPM", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynthComponentMoto_eventSetRPM_Parms, InRPM), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::NewProp_InTimeSec = { "InTimeSec", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynthComponentMoto_eventSetRPM_Parms, InTimeSec), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynthComponentMoto, nullptr, "SetRPM", nullptr, nullptr, Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::PropPointers), sizeof(Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::SynthComponentMoto_eventSetRPM_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::Function_MetaDataParams), Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USynthComponentMoto_SetRPM_Statics::SynthComponentMoto_eventSetRPM_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SynthComponentMoto_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FMotoSynthRuntimeSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::NewProp_InSettings_MetaData), Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::NewProp_InSettings_MetaData) }; // 2949203659
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynthComponentMoto, nullptr, "SetSettings", nullptr, nullptr, Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::SynthComponentMoto_eventSetSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USynthComponentMoto_SetSettings_Statics::SynthComponentMoto_eventSetSettings_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentMoto_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_USynthComponentMoto_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USynthComponentMoto_GetRPMRange, "GetRPMRange" }, // 2013719596
		{ &Z_Construct_UFunction_USynthComponentMoto_IsEnabled, "IsEnabled" }, // 3225142334
		{ &Z_Construct_UFunction_USynthComponentMoto_SetRPM, "SetRPM" }, // 1543962149
		{ &Z_Construct_UFunction_USynthComponentMoto_SetSettings, "SetSettings" }, // 3756835844
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentMoto_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USynthComponentMoto_Statics::NewProp_MotoSynthPreset = { "MotoSynthPreset", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynthComponentMoto, MotoSynthPreset), Z_Construct_UClass_UMotoSynthPreset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentMoto_Statics::NewProp_MotoSynthPreset_MetaData), Z_Construct_UClass_USynthComponentMoto_Statics::NewProp_MotoSynthPreset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynthComponentMoto_Statics::NewProp_RPM = { "RPM", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USynthComponentMoto, RPM), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentMoto_Statics::NewProp_RPM_MetaData), Z_Construct_UClass_USynthComponentMoto_Statics::NewProp_RPM_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USynthComponentMoto_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentMoto_Statics::Class_MetaDataParams), Z_Construct_UClass_USynthComponentMoto_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentMoto_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_MotoSynth_Source_MotoSynth_Classes_SynthComponents_SynthComponentMoto_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USynthComponentMoto, USynthComponentMoto::StaticClass, TEXT("USynthComponentMoto"), &Z_Registration_Info_UClass_USynthComponentMoto, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynthComponentMoto), 529187083U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_MotoSynth_Source_MotoSynth_Classes_SynthComponents_SynthComponentMoto_h_1510844503(TEXT("/Script/MotoSynth"),
