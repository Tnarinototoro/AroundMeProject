...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGauntletTestControllerErrorTest_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGauntletTestControllerErrorTest_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGauntletTestControllerErrorTest_Statics::Class_MetaDataParams), Z_Construct_UClass_UGauntletTestControllerErrorTest_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Gauntlet_Source_Gauntlet_Public_GauntletTestControllerErrorTest_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGauntletTestControllerErrorTest, UGauntletTestControllerErrorTest::StaticClass, TEXT("UGauntletTestControllerErrorTest"), &Z_Registration_Info_UClass_UGauntletTestControllerErrorTest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGauntletTestControllerErrorTest), 3707050352U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Gauntlet_Source_Gauntlet_Public_GauntletTestControllerErrorTest_h_1905696648(TEXT("/Script/Gauntlet"),
