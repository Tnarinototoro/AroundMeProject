...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGauntletTestController_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGauntletTestController_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGauntletTestController_Statics::Class_MetaDataParams), Z_Construct_UClass_UGauntletTestController_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Gauntlet_Source_Gauntlet_Public_GauntletTestController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGauntletTestController, UGauntletTestController::StaticClass, TEXT("UGauntletTestController"), &Z_Registration_Info_UClass_UGauntletTestController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGauntletTestController), 2513442023U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Gauntlet_Source_Gauntlet_Public_GauntletTestController_h_2783615438(TEXT("/Script/Gauntlet"),
