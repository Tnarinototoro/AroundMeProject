...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGauntletTestControllerBootTest_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGauntletTestControllerBootTest_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGauntletTestControllerBootTest_Statics::Class_MetaDataParams), Z_Construct_UClass_UGauntletTestControllerBootTest_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Gauntlet_Source_Gauntlet_Public_GauntletTestControllerBootTest_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGauntletTestControllerBootTest, UGauntletTestControllerBootTest::StaticClass, TEXT("UGauntletTestControllerBootTest"), &Z_Registration_Info_UClass_UGauntletTestControllerBootTest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGauntletTestControllerBootTest), 1587828718U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Gauntlet_Source_Gauntlet_Public_GauntletTestControllerBootTest_h_4014435676(TEXT("/Script/Gauntlet"),
