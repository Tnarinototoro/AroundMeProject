...
template<> PANORAMICCAPTURE_API UScriptStruct* StaticStruct<FPostProcessVolumeData>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::NewProp_Object = { "Object", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPostProcessVolumeData, Object), Z_Construct_UClass_APostProcessVolume_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::NewProp_Object_MetaData), Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::NewProp_Object_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USceneCapturer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USceneCapturer_Statics::NewProp_PPVolumeArray_Inner = { "PPVolumeArray", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPostProcessVolumeData, METADATA_PARAMS(0, nullptr) }; // 3248448115
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USceneCapturer_Statics::NewProp_PPVolumeArray = { "PPVolumeArray", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USceneCapturer, PPVolumeArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USceneCapturer_Statics::NewProp_PPVolumeArray_MetaData), Z_Construct_UClass_USceneCapturer_Statics::NewProp_PPVolumeArray_MetaData) }; // 3248448115
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USceneCapturer_Statics::NewProp_CaptureSceneComponent = { "CaptureSceneComponent", nullptr, (EPropertyFlags)0x0014000000082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USceneCapturer, CaptureSceneComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USceneCapturer_Statics::NewProp_CaptureSceneComponent_MetaData), Z_Construct_UClass_USceneCapturer_Statics::NewProp_CaptureSceneComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USceneCapturer_Statics::ClassParams = {
		...
		0,
		0x008000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USceneCapturer_Statics::Class_MetaDataParams), Z_Construct_UClass_USceneCapturer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USceneCapturer_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PanoramicCapture_Source_PanoramicCapture_Private_SceneCapturer_h_Statics::ScriptStructInfo[] = {
		{ FPostProcessVolumeData::StaticStruct, Z_Construct_UScriptStruct_FPostProcessVolumeData_Statics::NewStructOps, TEXT("PostProcessVolumeData"), &Z_Registration_Info_UScriptStruct_PostProcessVolumeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPostProcessVolumeData), 3248448115U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PanoramicCapture_Source_PanoramicCapture_Private_SceneCapturer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USceneCapturer, USceneCapturer::StaticClass, TEXT("USceneCapturer"), &Z_Registration_Info_UClass_USceneCapturer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USceneCapturer), 3343196095U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PanoramicCapture_Source_PanoramicCapture_Private_SceneCapturer_h_1341146371(TEXT("/Script/PanoramicCapture"),
