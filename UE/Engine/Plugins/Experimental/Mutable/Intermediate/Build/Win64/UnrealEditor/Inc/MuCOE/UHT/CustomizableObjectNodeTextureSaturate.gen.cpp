...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::NewProp_BaseImagePinReference = { "BaseImagePinReference", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomizableObjectNodeTextureSaturate, BaseImagePinReference), Z_Construct_UScriptStruct_FEdGraphPinReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::NewProp_BaseImagePinReference_MetaData), Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::NewProp_BaseImagePinReference_MetaData) }; // 3793911982
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::NewProp_FactorPinReference = { "FactorPinReference", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomizableObjectNodeTextureSaturate, FactorPinReference), Z_Construct_UScriptStruct_FEdGraphPinReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::NewProp_FactorPinReference_MetaData), Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::NewProp_FactorPinReference_MetaData) }; // 3793911982
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::Class_MetaDataParams), Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Mutable_Source_CustomizableObjectEditor_Classes_MuCOE_Nodes_CustomizableObjectNodeTextureSaturate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCustomizableObjectNodeTextureSaturate, UCustomizableObjectNodeTextureSaturate::StaticClass, TEXT("UCustomizableObjectNodeTextureSaturate"), &Z_Registration_Info_UClass_UCustomizableObjectNodeTextureSaturate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCustomizableObjectNodeTextureSaturate), 1493791114U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Mutable_Source_CustomizableObjectEditor_Classes_MuCOE_Nodes_CustomizableObjectNodeTextureSaturate_h_4155309288(TEXT("/Script/CustomizableObjectEditor"),
