...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::NewProp_NoImage = { "NoImage", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomizableObjectInstanceThumbnailRenderer, NoImage), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::NewProp_NoImage_MetaData), Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::NewProp_NoImage_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::Class_MetaDataParams), Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectInstanceThumbnailRenderer_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Mutable_Source_CustomizableObjectEditor_Classes_MuCOE_Thumbnails_CustomizableObjectInstanceThumbnailRenderer_h_3272333481(TEXT("/Script/CustomizableObjectEditor"),
