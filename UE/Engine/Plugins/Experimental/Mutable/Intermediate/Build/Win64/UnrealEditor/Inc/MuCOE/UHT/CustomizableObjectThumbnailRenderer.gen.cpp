...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::NewProp_CustomizableObjectInstance = { "CustomizableObjectInstance", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomizableObjectThumbnailRenderer, CustomizableObjectInstance), Z_Construct_UClass_UCustomizableObjectInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::NewProp_CustomizableObjectInstance_MetaData), Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::NewProp_CustomizableObjectInstance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::NewProp_NoImage = { "NoImage", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCustomizableObjectThumbnailRenderer, NoImage), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::NewProp_NoImage_MetaData), Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::NewProp_NoImage_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::Class_MetaDataParams), Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCustomizableObjectThumbnailRenderer_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Mutable_Source_CustomizableObjectEditor_Classes_MuCOE_Thumbnails_CustomizableObjectThumbnailRenderer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCustomizableObjectThumbnailRenderer, UCustomizableObjectThumbnailRenderer::StaticClass, TEXT("UCustomizableObjectThumbnailRenderer"), &Z_Registration_Info_UClass_UCustomizableObjectThumbnailRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCustomizableObjectThumbnailRenderer), 2118523498U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Mutable_Source_CustomizableObjectEditor_Classes_MuCOE_Thumbnails_CustomizableObjectThumbnailRenderer_h_3578133224(TEXT("/Script/CustomizableObjectEditor"),
