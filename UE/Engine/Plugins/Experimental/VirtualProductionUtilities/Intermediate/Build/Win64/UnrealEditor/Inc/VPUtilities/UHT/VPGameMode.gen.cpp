...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VPGameMode_eventGetRootActor_Parms, ReturnValue), Z_Construct_UClass_AVPRootActor_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVPGameMode, nullptr, "GetRootActor", nullptr, nullptr, Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::VPGameMode_eventGetRootActor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AVPGameMode_GetRootActor_Statics::VPGameMode_eventGetRootActor_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPGameMode_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AVPGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVPGameMode_GetRootActor, "GetRootActor" }, // 756602369
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPGameMode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AVPGameMode_Statics::NewProp_RootActor = { "RootActor", nullptr, (EPropertyFlags)0x0044000000002014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AVPGameMode, RootActor), Z_Construct_UClass_AVPRootActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPGameMode_Statics::NewProp_RootActor_MetaData), Z_Construct_UClass_AVPGameMode_Statics::NewProp_RootActor_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVPGameMode_Statics::ClassParams = {
		...
		0,
		0x009002ADu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPGameMode_Statics::Class_MetaDataParams), Z_Construct_UClass_AVPGameMode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPGameMode_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_VPGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVPGameMode, AVPGameMode::StaticClass, TEXT("AVPGameMode"), &Z_Registration_Info_UClass_AVPGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVPGameMode), 797349028U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_VPGameMode_h_2784415287(TEXT("/Script/VPUtilities"),
