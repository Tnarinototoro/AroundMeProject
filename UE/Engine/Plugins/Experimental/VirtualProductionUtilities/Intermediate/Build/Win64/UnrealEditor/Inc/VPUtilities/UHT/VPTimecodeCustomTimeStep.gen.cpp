...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfFrameAreNotConsecutive = { "bErrorIfFrameAreNotConsecutive", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UVPTimecodeCustomTimeStep), &Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfFrameAreNotConsecutive_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfFrameAreNotConsecutive_MetaData), Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfFrameAreNotConsecutive_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfTimecodeProviderChanged = { "bErrorIfTimecodeProviderChanged", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UVPTimecodeCustomTimeStep), &Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfTimecodeProviderChanged_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfTimecodeProviderChanged_MetaData), Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_bErrorIfTimecodeProviderChanged_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_MaxDeltaTime = { "MaxDeltaTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPTimecodeCustomTimeStep, MaxDeltaTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_MaxDeltaTime_MetaData), Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::NewProp_MaxDeltaTime_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPTimecodeCustomTimeStep_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_VPTimecodeCustomTimeStep_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPTimecodeCustomTimeStep, UVPTimecodeCustomTimeStep::StaticClass, TEXT("UVPTimecodeCustomTimeStep"), &Z_Registration_Info_UClass_UVPTimecodeCustomTimeStep, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPTimecodeCustomTimeStep), 2305227402U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_VPTimecodeCustomTimeStep_h_3001954762(TEXT("/Script/VPUtilities"),
