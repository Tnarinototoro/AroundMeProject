...
template<> VPBOOKMARK_API UScriptStruct* StaticStruct<FVPBookmarkCreationContext>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_ConcertCreator = { "ConcertCreator", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FVPBookmarkCreationContext, ConcertCreator), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_ConcertCreator_MetaData), Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_ConcertCreator_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_CategoryName = { "CategoryName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FVPBookmarkCreationContext, CategoryName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_CategoryName_MetaData), Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_CategoryName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FVPBookmarkCreationContext, DisplayName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_DisplayName_MetaData), Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewProp_DisplayName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPBookmark_Public_VPBookmarkContext_h_Statics::ScriptStructInfo[] = {
		{ FVPBookmarkCreationContext::StaticStruct, Z_Construct_UScriptStruct_FVPBookmarkCreationContext_Statics::NewStructOps, TEXT("VPBookmarkCreationContext"), &Z_Registration_Info_UScriptStruct_VPBookmarkCreationContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVPBookmarkCreationContext), 4146862096U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPBookmark_Public_VPBookmarkContext_h_646733756(TEXT("/Script/VPBookmark"),
		nullptr, 0,
