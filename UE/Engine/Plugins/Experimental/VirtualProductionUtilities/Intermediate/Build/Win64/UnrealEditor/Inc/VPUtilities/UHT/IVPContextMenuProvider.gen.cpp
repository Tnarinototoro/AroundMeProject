...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVPContextMenuProvider_OnCreateContextMenu_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVPContextMenuProvider, nullptr, "OnCreateContextMenu", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVPContextMenuProvider_OnCreateContextMenu_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVPContextMenuProvider_OnCreateContextMenu_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPContextMenuProvider_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVPContextMenuProvider_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVPContextMenuProvider_OnCreateContextMenu, "OnCreateContextMenu" }, // 475742864
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPContextMenuProvider_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPContextMenuProvider_Statics::ClassParams = {
		...
		0,
		0x000040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPContextMenuProvider_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPContextMenuProvider_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_IVPContextMenuProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPContextMenuProvider, UVPContextMenuProvider::StaticClass, TEXT("UVPContextMenuProvider"), &Z_Registration_Info_UClass_UVPContextMenuProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPContextMenuProvider), 4060603845U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_IVPContextMenuProvider_h_3386293326(TEXT("/Script/VPUtilities"),
