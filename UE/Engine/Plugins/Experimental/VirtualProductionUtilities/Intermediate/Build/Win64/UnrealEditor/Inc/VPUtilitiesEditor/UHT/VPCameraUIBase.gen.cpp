...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCameraUIBase_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVPCameraUIBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVPCameraUIBase_OnSelectedCameraChanged, "OnSelectedCameraChanged" }, // 2495615468
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCameraUIBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVPCameraUIBase_Statics::NewProp_SelectedCamera = { "SelectedCamera", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPCameraUIBase, SelectedCamera), Z_Construct_UClass_ACameraActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCameraUIBase_Statics::NewProp_SelectedCamera_MetaData), Z_Construct_UClass_UVPCameraUIBase_Statics::NewProp_SelectedCamera_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVPCameraUIBase_Statics::NewProp_SelectedCameraComponent = { "SelectedCameraComponent", nullptr, (EPropertyFlags)0x002408000008201c, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPCameraUIBase, SelectedCameraComponent), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCameraUIBase_Statics::NewProp_SelectedCameraComponent_MetaData), Z_Construct_UClass_UVPCameraUIBase_Statics::NewProp_SelectedCameraComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPCameraUIBase_Statics::ClassParams = {
		...
		0,
		0x00A010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCameraUIBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPCameraUIBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCameraUIBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Private_VPCameraUIBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPCameraUIBase, UVPCameraUIBase::StaticClass, TEXT("UVPCameraUIBase"), &Z_Registration_Info_UClass_UVPCameraUIBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPCameraUIBase), 636594325U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Private_VPCameraUIBase_h_3611314409(TEXT("/Script/VPUtilitiesEditor"),
