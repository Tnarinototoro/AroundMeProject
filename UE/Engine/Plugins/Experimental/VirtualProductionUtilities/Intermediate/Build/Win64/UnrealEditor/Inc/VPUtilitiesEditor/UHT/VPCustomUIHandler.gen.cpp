...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCustomUIHandler_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UVPCustomUIHandler_Statics::NewProp_VirtualProductionWidget = { "VirtualProductionWidget", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPCustomUIHandler, VirtualProductionWidget), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCustomUIHandler_Statics::NewProp_VirtualProductionWidget_MetaData), Z_Construct_UClass_UVPCustomUIHandler_Statics::NewProp_VirtualProductionWidget_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPCustomUIHandler_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCustomUIHandler_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPCustomUIHandler_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPCustomUIHandler_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Private_VPCustomUIHandler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPCustomUIHandler, UVPCustomUIHandler::StaticClass, TEXT("UVPCustomUIHandler"), &Z_Registration_Info_UClass_UVPCustomUIHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPCustomUIHandler), 1124020058U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Private_VPCustomUIHandler_h_4277706412(TEXT("/Script/VPUtilitiesEditor"),
