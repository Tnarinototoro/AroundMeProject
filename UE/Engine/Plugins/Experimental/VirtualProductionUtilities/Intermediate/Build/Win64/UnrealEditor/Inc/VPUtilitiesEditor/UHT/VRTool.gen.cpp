...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VRTool_eventGetInputComponent_Parms, ReturnValue), Z_Construct_UClass_UInputComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::NewProp_ReturnValue_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVRTool, nullptr, "GetInputComponent", nullptr, nullptr, Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::VRTool_eventGetInputComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AVRTool_GetInputComponent_Statics::VRTool_eventGetInputComponent_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VRTool_eventGetReceivesEditorInput_Parms), &Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVRTool, nullptr, "GetReceivesEditorInput", nullptr, nullptr, Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::VRTool_eventGetReceivesEditorInput_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AVRTool_GetReceivesEditorInput_Statics::VRTool_eventGetReceivesEditorInput_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::NewProp_bInValue = { "bInValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VRTool_eventSetReceivesEditorInput_Parms), &Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::NewProp_bInValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVRTool, nullptr, "SetReceivesEditorInput", nullptr, nullptr, Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::VRTool_eventSetReceivesEditorInput_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AVRTool_SetReceivesEditorInput_Statics::VRTool_eventSetReceivesEditorInput_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVRTool_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AVRTool_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVRTool_GetInputComponent, "GetInputComponent" }, // 2596909568
		{ &Z_Construct_UFunction_AVRTool_GetReceivesEditorInput, "GetReceivesEditorInput" }, // 2111442762
		{ &Z_Construct_UFunction_AVRTool_SetReceivesEditorInput, "SetReceivesEditorInput" }, // 1360753854
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVRTool_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AVRTool_Statics::NewProp_EditorOnlyInputComponent = { "EditorOnlyInputComponent", nullptr, (EPropertyFlags)0x0044000000282008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AVRTool, EditorOnlyInputComponent), Z_Construct_UClass_UInputComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVRTool_Statics::NewProp_EditorOnlyInputComponent_MetaData), Z_Construct_UClass_AVRTool_Statics::NewProp_EditorOnlyInputComponent_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AVRTool_Statics::NewProp_bReceivesEditorInput = { "bReceivesEditorInput", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AVRTool), &Z_Construct_UClass_AVRTool_Statics::NewProp_bReceivesEditorInput_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVRTool_Statics::NewProp_bReceivesEditorInput_MetaData), Z_Construct_UClass_AVRTool_Statics::NewProp_bReceivesEditorInput_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVRTool_Statics::ClassParams = {
		...
		0,
		0x008000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVRTool_Statics::Class_MetaDataParams), Z_Construct_UClass_AVRTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVRTool_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Public_VRTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVRTool, AVRTool::StaticClass, TEXT("AVRTool"), &Z_Registration_Info_UClass_AVRTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVRTool), 1419150013U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Public_VRTool_h_3234050037(TEXT("/Script/VPUtilitiesEditor"),
