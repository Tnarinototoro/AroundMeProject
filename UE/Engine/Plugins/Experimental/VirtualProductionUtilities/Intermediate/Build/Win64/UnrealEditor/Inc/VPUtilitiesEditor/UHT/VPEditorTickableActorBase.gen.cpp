...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPEditorTickableActorBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AVPEditorTickableActorBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/** Actor that tick in the Editor viewport with the event EditorTick. */" },
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVPEditorTickableActorBase_Statics::ClassParams = {
		...
		0,
		0x009000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPEditorTickableActorBase_Statics::Class_MetaDataParams), Z_Construct_UClass_AVPEditorTickableActorBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Public_VPEditorTickableActorBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVPEditorTickableActorBase, AVPEditorTickableActorBase::StaticClass, TEXT("AVPEditorTickableActorBase"), &Z_Registration_Info_UClass_AVPEditorTickableActorBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVPEditorTickableActorBase), 831775471U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Public_VPEditorTickableActorBase_h_1757789739(TEXT("/Script/VPUtilitiesEditor"),
