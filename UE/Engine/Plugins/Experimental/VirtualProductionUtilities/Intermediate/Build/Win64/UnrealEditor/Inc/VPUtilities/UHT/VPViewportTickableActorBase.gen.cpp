...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_VPUtilities_EVPViewportTickableFlags_Statics::Enum_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Actors/VPViewportTickableActorBase.h" },
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_VPUtilities_EVPViewportTickableFlags_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_VPUtilities_EVPViewportTickableFlags_Statics::Enum_MetaDataParams), Z_Construct_UEnum_VPUtilities_EVPViewportTickableFlags_Statics::Enum_MetaDataParams)
	};
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVPViewportTickableActorBase_EditorDestroyed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVPViewportTickableActorBase, nullptr, "EditorDestroyed", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorDestroyed_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVPViewportTickableActorBase_EditorDestroyed_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::NewProp_bSetLockLocation = { "bSetLockLocation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VPViewportTickableActorBase_eventEditorLockLocation_Parms), &Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::NewProp_bSetLockLocation_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVPViewportTickableActorBase, nullptr, "EditorLockLocation", nullptr, nullptr, Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::VPViewportTickableActorBase_eventEditorLockLocation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation_Statics::VPViewportTickableActorBase_eventEditorLockLocation_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick_Statics::NewProp_DeltaSeconds = { "DeltaSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VPViewportTickableActorBase_eventEditorTick_Parms, DeltaSeconds), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVPViewportTickableActorBase, nullptr, "EditorTick", nullptr, nullptr, Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick_Statics::PropPointers), sizeof(VPViewportTickableActorBase_eventEditorTick_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick_Statics::PropPointers) < 2048);
	static_assert(sizeof(VPViewportTickableActorBase_eventEditorTick_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPViewportTickableActorBase_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AVPViewportTickableActorBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVPViewportTickableActorBase_EditorDestroyed, "EditorDestroyed" }, // 2781324801
		{ &Z_Construct_UFunction_AVPViewportTickableActorBase_EditorLockLocation, "EditorLockLocation" }, // 3715891216
		{ &Z_Construct_UFunction_AVPViewportTickableActorBase_EditorTick, "EditorTick" }, // 3575674126
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPViewportTickableActorBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AVPViewportTickableActorBase_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Actors/VPViewportTickableActorBase.h" },
		{ "ModuleRelativePath", "Public/Actors/VPViewportTickableActorBase.h" },
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AVPViewportTickableActorBase_Statics::NewProp_ViewportTickType = { "ViewportTickType", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AVPViewportTickableActorBase, ViewportTickType), Z_Construct_UEnum_VPUtilities_EVPViewportTickableFlags, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPViewportTickableActorBase_Statics::NewProp_ViewportTickType_MetaData), Z_Construct_UClass_AVPViewportTickableActorBase_Statics::NewProp_ViewportTickType_MetaData) }; // 3437735235
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVPViewportTickableActorBase_Statics::ClassParams = {
		...
		0,
		0x009000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPViewportTickableActorBase_Statics::Class_MetaDataParams), Z_Construct_UClass_AVPViewportTickableActorBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPViewportTickableActorBase_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_Statics::EnumInfo[] = {
		{ EVPViewportTickableFlags_StaticEnum, TEXT("EVPViewportTickableFlags"), &Z_Registration_Info_UEnum_EVPViewportTickableFlags, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3437735235U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVPViewportTickableActorBase, AVPViewportTickableActorBase::StaticClass, TEXT("AVPViewportTickableActorBase"), &Z_Registration_Info_UClass_AVPViewportTickableActorBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVPViewportTickableActorBase), 212286405U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_2651512537(TEXT("/Script/VPUtilities"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPViewportTickableActorBase_h_Statics::EnumInfo));
