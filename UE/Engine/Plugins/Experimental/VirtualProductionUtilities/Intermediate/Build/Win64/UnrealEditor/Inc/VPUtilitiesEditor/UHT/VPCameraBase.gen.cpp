...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVPCameraBase_ResetPreview_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVPCameraBase, nullptr, "ResetPreview", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVPCameraBase_ResetPreview_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVPCameraBase_ResetPreview_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPCameraBase_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AVPCameraBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVPCameraBase_ResetPreview, "ResetPreview" }, // 1913506480
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPCameraBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AVPCameraBase_Statics::NewProp_SelectedByUsers_Inner = { "SelectedByUsers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AVPCameraBase_Statics::NewProp_SelectedByUsers = { "SelectedByUsers", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AVPCameraBase, SelectedByUsers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPCameraBase_Statics::NewProp_SelectedByUsers_MetaData), Z_Construct_UClass_AVPCameraBase_Statics::NewProp_SelectedByUsers_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVPCameraBase_Statics::ClassParams = {
		...
		0,
		0x008000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPCameraBase_Statics::Class_MetaDataParams), Z_Construct_UClass_AVPCameraBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPCameraBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Private_VPCameraBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVPCameraBase, AVPCameraBase::StaticClass, TEXT("AVPCameraBase"), &Z_Registration_Info_UClass_AVPCameraBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVPCameraBase), 1745072248U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Private_VPCameraBase_h_3240514856(TEXT("/Script/VPUtilitiesEditor"),
