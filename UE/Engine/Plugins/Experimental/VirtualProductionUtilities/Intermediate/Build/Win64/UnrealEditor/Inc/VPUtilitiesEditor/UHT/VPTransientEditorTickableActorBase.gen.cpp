...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVPTransientEditorTickableActorBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVPTransientEditorTickableActorBase_Statics::ClassParams = {
		...
		0,
		0x008000ADu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVPTransientEditorTickableActorBase_Statics::Class_MetaDataParams), Z_Construct_UClass_AVPTransientEditorTickableActorBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Public_VPTransientEditorTickableActorBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVPTransientEditorTickableActorBase, AVPTransientEditorTickableActorBase::StaticClass, TEXT("AVPTransientEditorTickableActorBase"), &Z_Registration_Info_UClass_AVPTransientEditorTickableActorBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVPTransientEditorTickableActorBase), 3030421035U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilitiesEditor_Public_VPTransientEditorTickableActorBase_h_589341188(TEXT("/Script/VPUtilitiesEditor"),
