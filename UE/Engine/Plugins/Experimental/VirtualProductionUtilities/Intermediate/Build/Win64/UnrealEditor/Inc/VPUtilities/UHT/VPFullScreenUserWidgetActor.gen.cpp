...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Actors/VPFullScreenUserWidgetActor.h" },
		{ "IsBlueprintBase", "true" },
		{ "ModuleRelativePath", "Public/Actors/VPFullScreenUserWidgetActor.h" },
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::NewProp_ScreenUserWidget = { "ScreenUserWidget", nullptr, (EPropertyFlags)0x00260800020a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFullScreenUserWidgetActor, ScreenUserWidget), Z_Construct_UClass_UVPFullScreenUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::NewProp_ScreenUserWidget_MetaData), Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::NewProp_ScreenUserWidget_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AFullScreenUserWidgetActor_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPFullScreenUserWidgetActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPFullScreenUserWidgetActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFullScreenUserWidgetActor, AFullScreenUserWidgetActor::StaticClass, TEXT("AFullScreenUserWidgetActor"), &Z_Registration_Info_UClass_AFullScreenUserWidgetActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFullScreenUserWidgetActor), 1903863760U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPFullScreenUserWidgetActor_h_434637833(TEXT("/Script/VPUtilities"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPFullScreenUserWidgetActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_Actors_VPFullScreenUserWidgetActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
