...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkMeshPath = { "BookmarkMeshPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPBookmarkSettings, BookmarkMeshPath), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkMeshPath_MetaData), Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkMeshPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkMaterialPath = { "BookmarkMaterialPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPBookmarkSettings, BookmarkMaterialPath), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkMaterialPath_MetaData), Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkMaterialPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkSplineMeshPath = { "BookmarkSplineMeshPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPBookmarkSettings, BookmarkSplineMeshPath), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkSplineMeshPath_MetaData), Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkSplineMeshPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkSplineMeshMaterialPath = { "BookmarkSplineMeshMaterialPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPBookmarkSettings, BookmarkSplineMeshMaterialPath), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkSplineMeshMaterialPath_MetaData), Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkSplineMeshMaterialPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkLabelMaterialPath = { "BookmarkLabelMaterialPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPBookmarkSettings, BookmarkLabelMaterialPath), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkLabelMaterialPath_MetaData), Z_Construct_UClass_UVPBookmarkSettings_Statics::NewProp_BookmarkLabelMaterialPath_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPBookmarkSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPBookmarkSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPBookmarkSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_VPBookmarkSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPBookmarkSettings, UVPBookmarkSettings::StaticClass, TEXT("UVPBookmarkSettings"), &Z_Registration_Info_UClass_UVPBookmarkSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPBookmarkSettings), 1459908812U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProductionUtilities_Source_VPUtilities_Public_VPBookmarkSettings_h_41162478(TEXT("/Script/VPUtilities"),
