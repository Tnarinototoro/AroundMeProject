...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_ChaosClothAssetEngine_EClothAssetAsyncProperties_Statics::Enumerators[] = {
		...
		{ "EClothAssetAsyncProperties::ThumbnailInfo", (int64)EClothAssetAsyncProperties::ThumbnailInfo },
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_ChaosClothAssetEngine_EClothAssetAsyncProperties_Statics::Enum_MetaDataParams[] = {
		...
		{ "ThumbnailInfo.Name", "EClothAssetAsyncProperties::ThumbnailInfo" },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_ChaosClothAssetEngine_EClothAssetAsyncProperties_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_ChaosClothAssetEngine_EClothAssetAsyncProperties_Statics::Enum_MetaDataParams), Z_Construct_UEnum_ChaosClothAssetEngine_EClothAssetAsyncProperties_Statics::Enum_MetaDataParams)
	};
	...
	void UChaosClothAsset::SetSkeleton_WrapperImpl(void* Object, const void* InValue)
	{
		UChaosClothAsset* Obj = (UChaosClothAsset*)Object;
		USkeleton*& Value = *(USkeleton**)InValue;
		Obj->SetSkeleton(Value);
	}
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ChaosClothAsset_eventGetShadowPhysicsAsset_Parms, ReturnValue), Z_Construct_UClass_UPhysicsAsset_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UChaosClothAsset, nullptr, "GetShadowPhysicsAsset", nullptr, nullptr, Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::PropPointers), sizeof(Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::ChaosClothAsset_eventGetShadowPhysicsAsset_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::Function_MetaDataParams), Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset_Statics::ChaosClothAsset_eventGetShadowPhysicsAsset_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UChaosClothAsset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UChaosClothAsset_GetShadowPhysicsAsset, "GetShadowPhysicsAsset" }, // 1696082453
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DataflowAsset = { "DataflowAsset", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, DataflowAsset), Z_Construct_UClass_UDataflow_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DataflowAsset_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DataflowAsset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DataflowTerminal = { "DataflowTerminal", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, DataflowTerminal), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DataflowTerminal_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DataflowTerminal_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Materials_Inner = { "Materials", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSkeletalMaterial, METADATA_PARAMS(0, nullptr) }; // 3301574061
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Materials = { "Materials", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, Materials), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Materials_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Materials_MetaData) }; // 3301574061
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Skeleton_MetaData[] = {
		{ "Category", "Skeleton" },
		{ "Comment", "/** Skeleton asset used at creation time. This is of limited use since this USkeleton's reference skeleton might not necessarily match the one created for this asset. */" },
		{ "ModuleRelativePath", "Public/ChaosClothAsset/ClothAsset.h" },
		{ "ToolTip", "Skeleton asset used at creation time. This is of limited use since this USkeleton's reference skeleton might not necessarily match the one created for this asset." },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Skeleton = { "Skeleton", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, &UChaosClothAsset::SetSkeleton_WrapperImpl, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, Skeleton), Z_Construct_UClass_USkeleton_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Skeleton_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Skeleton_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_PhysicsAsset = { "PhysicsAsset", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, PhysicsAsset), Z_Construct_UClass_UPhysicsAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_PhysicsAsset_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_PhysicsAsset_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_LODInfo_Inner = { "LODInfo", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSkeletalMeshLODInfo, METADATA_PARAMS(0, nullptr) }; // 1957249173
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_LODInfo = { "LODInfo", nullptr, (EPropertyFlags)0x0040000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, LODInfo), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_LODInfo_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_LODInfo_MetaData) }; // 1957249173
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DisableBelowMinLodStripping = { "DisableBelowMinLodStripping", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, DisableBelowMinLodStripping), Z_Construct_UScriptStruct_FPerPlatformBool, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DisableBelowMinLodStripping_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_DisableBelowMinLodStripping_MetaData) }; // 3834211121
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_MinLod = { "MinLod", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, MinLod), Z_Construct_UScriptStruct_FPerPlatformInt, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_MinLod_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_MinLod_MetaData) }; // 3274094615
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSupportRayTracing = { "bSupportRayTracing", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UChaosClothAsset), &Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSupportRayTracing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSupportRayTracing_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSupportRayTracing_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_RayTracingMinLOD = { "RayTracingMinLOD", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, RayTracingMinLOD), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_RayTracingMinLOD_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_RayTracingMinLOD_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSmoothTransition = { "bSmoothTransition", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UChaosClothAsset), &Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSmoothTransition_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSmoothTransition_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bSmoothTransition_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bUseMultipleInfluences_MetaData[] = {
		{ "Category", "ClothDeformer" },
		{ "Comment", "/** Whether to use multiple triangle influences on the proxy wrap deformer to help smoothe deformations. */" },
		{ "ModuleRelativePath", "Public/ChaosClothAsset/ClothAsset.h" },
		{ "ToolTip", "Whether to use multiple triangle influences on the proxy wrap deformer to help smoothe deformations." },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bUseMultipleInfluences = { "bUseMultipleInfluences", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UChaosClothAsset), &Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bUseMultipleInfluences_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bUseMultipleInfluences_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_bUseMultipleInfluences_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_SkinningKernelRadius = { "SkinningKernelRadius", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, SkinningKernelRadius), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_SkinningKernelRadius_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_SkinningKernelRadius_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_ShadowPhysicsAsset = { "ShadowPhysicsAsset", nullptr, (EPropertyFlags)0x0044010000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, ShadowPhysicsAsset), Z_Construct_UClass_UPhysicsAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_ShadowPhysicsAsset_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_ShadowPhysicsAsset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_AssetGuid = { "AssetGuid", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UChaosClothAsset, AssetGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_AssetGuid_MetaData), Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_AssetGuid_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UChaosClothAsset_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UChaosClothAsset_Statics::NewProp_Skeleton,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UChaosClothAsset_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::Class_MetaDataParams), Z_Construct_UClass_UChaosClothAsset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChaosClothAsset_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAsset_Source_ChaosClothAssetEngine_Public_ChaosClothAsset_ClothAsset_h_Statics::EnumInfo[] = {
		{ EClothAssetAsyncProperties_StaticEnum, TEXT("EClothAssetAsyncProperties"), &Z_Registration_Info_UEnum_EClothAssetAsyncProperties, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1165920323U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAsset_Source_ChaosClothAssetEngine_Public_ChaosClothAsset_ClothAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChaosClothAsset, UChaosClothAsset::StaticClass, TEXT("UChaosClothAsset"), &Z_Registration_Info_UClass_UChaosClothAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChaosClothAsset), 1734485037U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAsset_Source_ChaosClothAssetEngine_Public_ChaosClothAsset_ClothAsset_h_1538228375(TEXT("/Script/ChaosClothAssetEngine"),
