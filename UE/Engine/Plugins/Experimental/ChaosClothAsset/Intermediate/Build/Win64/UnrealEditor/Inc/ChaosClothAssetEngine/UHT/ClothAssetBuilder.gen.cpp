...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UClothAssetBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UClothAssetBuilder_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UClothAssetBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UClothAssetBuilder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAsset_Source_ChaosClothAssetEngine_Public_ChaosClothAsset_ClothAssetBuilder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UClothAssetBuilder, UClothAssetBuilder::StaticClass, TEXT("UClothAssetBuilder"), &Z_Registration_Info_UClass_UClothAssetBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClothAssetBuilder), 2945011595U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAsset_Source_ChaosClothAssetEngine_Public_ChaosClothAsset_ClothAssetBuilder_h_632591416(TEXT("/Script/ChaosClothAssetEngine"),
