...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPScoutingMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPScoutingMode_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPScoutingMode_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPScoutingMode_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualScouting_Source_VirtualScoutingEditor_Private_VPScoutingMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPScoutingMode, UVPScoutingMode::StaticClass, TEXT("UVPScoutingMode"), &Z_Registration_Info_UClass_UVPScoutingMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPScoutingMode), 2236378693U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualScouting_Source_VirtualScoutingEditor_Private_VPScoutingMode_h_3056996097(TEXT("/Script/VirtualScoutingEditor"),
