...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::NewProp_BuiltinTypes_Inner = { "BuiltinTypes", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UWebAPITypeInfo_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::NewProp_BuiltinTypes = { "BuiltinTypes", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIStaticTypeRegistry, BuiltinTypes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::NewProp_BuiltinTypes_MetaData), Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::NewProp_BuiltinTypes_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIStaticTypeRegistry_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPITypeRegistry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWebAPITypeRegistry_Statics::NewProp_GeneratedTypes = { "GeneratedTypes", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPITypeRegistry, GeneratedTypes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPITypeRegistry_Statics::NewProp_GeneratedTypes_MetaData), Z_Construct_UClass_UWebAPITypeRegistry_Statics::NewProp_GeneratedTypes_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPITypeRegistry_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPITypeRegistry_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPITypeRegistry_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPITypeRegistry_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Dom_WebAPITypeRegistry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIStaticTypeRegistry, UWebAPIStaticTypeRegistry::StaticClass, TEXT("UWebAPIStaticTypeRegistry"), &Z_Registration_Info_UClass_UWebAPIStaticTypeRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIStaticTypeRegistry), 827507691U) },
		{ Z_Construct_UClass_UWebAPITypeRegistry, UWebAPITypeRegistry::StaticClass, TEXT("UWebAPITypeRegistry"), &Z_Registration_Info_UClass_UWebAPITypeRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPITypeRegistry), 3202466497U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Dom_WebAPITypeRegistry_h_3701713924(TEXT("/Script/WebAPIEditor"),
