...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::NewProp_InUrl = { "InUrl", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebAPIUtilities_eventGetHostFromUrl_Parms, InUrl), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::NewProp_InUrl_MetaData), Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::NewProp_InUrl_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebAPIUtilities_eventGetHostFromUrl_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWebAPIUtilities, nullptr, "GetHostFromUrl", nullptr, nullptr, Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::WebAPIUtilities_eventGetHostFromUrl_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl_Statics::WebAPIUtilities_eventGetHostFromUrl_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::NewProp_MessageResponse = { "MessageResponse", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebAPIUtilities_eventGetResponseMessage_Parms, MessageResponse), Z_Construct_UScriptStruct_FWebAPIMessageResponse, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::NewProp_MessageResponse_MetaData), Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::NewProp_MessageResponse_MetaData) }; // 285346983
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000008000582, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WebAPIUtilities_eventGetResponseMessage_Parms, ReturnValue), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::NewProp_ReturnValue_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWebAPIUtilities, nullptr, "GetResponseMessage", nullptr, nullptr, Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::WebAPIUtilities_eventGetResponseMessage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage_Statics::WebAPIUtilities_eventGetResponseMessage_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIUtilities_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UWebAPIUtilities_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UWebAPIUtilities_GetHostFromUrl, "GetHostFromUrl" }, // 3581176868
		{ &Z_Construct_UFunction_UWebAPIUtilities_GetResponseMessage, "GetResponseMessage" }, // 2434106904
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIUtilities_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIUtilities_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIUtilities_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIUtilities_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPI_Public_WebAPIUtilities_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIUtilities, UWebAPIUtilities::StaticClass, TEXT("UWebAPIUtilities"), &Z_Registration_Info_UClass_UWebAPIUtilities, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIUtilities), 3639444429U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPI_Public_WebAPIUtilities_h_2799983059(TEXT("/Script/WebAPI"),
