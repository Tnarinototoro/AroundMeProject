...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIFactoryBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIOpenAPIFactoryBase_Statics::ClassParams = {
		...
		0,
		0x000000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIFactoryBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIOpenAPIFactoryBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIOpenAPI_Private_Factories_WebAPIOpenAPIFactoryBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIOpenAPIFactoryBase, UWebAPIOpenAPIFactoryBase::StaticClass, TEXT("UWebAPIOpenAPIFactoryBase"), &Z_Registration_Info_UClass_UWebAPIOpenAPIFactoryBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIOpenAPIFactoryBase), 2937554878U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIOpenAPI_Private_Factories_WebAPIOpenAPIFactoryBase_h_2983546383(TEXT("/Script/WebAPIOpenAPI"),
