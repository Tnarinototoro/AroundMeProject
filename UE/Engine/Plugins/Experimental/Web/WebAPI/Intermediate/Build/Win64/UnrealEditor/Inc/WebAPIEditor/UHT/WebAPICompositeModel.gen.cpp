...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_WebAPIEditor_EWebAPIModelCompositionType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_WebAPIEditor_EWebAPIModelCompositionType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_WebAPIEditor_EWebAPIModelCompositionType_Statics::Enum_MetaDataParams)
	};
	...
	struct Z_Construct_UClass_UWebAPICompositeModel_Statics
	{
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_CompositionType_Underlying;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICompositeModel_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPICompositeModel, Name), Z_Construct_UScriptStruct_FWebAPITypeNameVariant, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_Name_MetaData), Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_Name_MetaData) }; // 3470077990
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_CompositionType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_CompositionType = { "CompositionType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPICompositeModel, CompositionType), Z_Construct_UEnum_WebAPIEditor_EWebAPIModelCompositionType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_CompositionType_MetaData), Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_CompositionType_MetaData) }; // 1399362480
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_Types_Inner = { "Types", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FWebAPITypeNameVariant, METADATA_PARAMS(0, nullptr) }; // 3470077990
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_Types = { "Types", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPICompositeModel, Types), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_Types_MetaData), Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_Types_MetaData) }; // 3470077990
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_GeneratedCodeText = { "GeneratedCodeText", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPICompositeModel, GeneratedCodeText), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_GeneratedCodeText_MetaData), Z_Construct_UClass_UWebAPICompositeModel_Statics::NewProp_GeneratedCodeText_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPICompositeModel_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICompositeModel_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPICompositeModel_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICompositeModel_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Dom_WebAPICompositeModel_h_Statics::EnumInfo[] = {
		{ EWebAPIModelCompositionType_StaticEnum, TEXT("EWebAPIModelCompositionType"), &Z_Registration_Info_UEnum_EWebAPIModelCompositionType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1399362480U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Dom_WebAPICompositeModel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPICompositeModel, UWebAPICompositeModel::StaticClass, TEXT("UWebAPICompositeModel"), &Z_Registration_Info_UClass_UWebAPICompositeModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPICompositeModel), 632141046U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Dom_WebAPICompositeModel_h_3394628350(TEXT("/Script/WebAPIEditor"),
