...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Storage_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Storage = { "Storage", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIParameter, Storage), Z_Construct_UEnum_WebAPIEditor_EWebAPIParameterStorage, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Storage_MetaData), Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Storage_MetaData) }; // 437019136
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_MediaType = { "MediaType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIParameter, MediaType), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_MediaType_MetaData), Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_MediaType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Model = { "Model", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIParameter, Model), Z_Construct_UClass_UWebAPIModel_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Model_MetaData), Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Model_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_bIsArray = { "bIsArray", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UWebAPIParameter), &Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_bIsArray_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_bIsArray_MetaData), Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_bIsArray_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Property = { "Property", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIParameter, Property), Z_Construct_UClass_UWebAPIProperty_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Property_MetaData), Z_Construct_UClass_UWebAPIParameter_Statics::NewProp_Property_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIParameter_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIParameter_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIParameter_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Dom_WebAPIParameter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIParameter, UWebAPIParameter::StaticClass, TEXT("UWebAPIParameter"), &Z_Registration_Info_UClass_UWebAPIParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIParameter), 3047357706U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Dom_WebAPIParameter_h_2665666546(TEXT("/Script/WebAPIEditor"),
