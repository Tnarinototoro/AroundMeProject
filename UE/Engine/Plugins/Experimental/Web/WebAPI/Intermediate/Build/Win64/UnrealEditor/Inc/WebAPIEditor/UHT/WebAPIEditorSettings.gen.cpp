...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIEditorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UWebAPIEditorSettings_Statics::NewProp_CodeGeneratorClass = { "CodeGeneratorClass", nullptr, (EPropertyFlags)0x0014000002000015, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIEditorSettings, CodeGeneratorClass), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIEditorSettings_Statics::NewProp_CodeGeneratorClass_MetaData), Z_Construct_UClass_UWebAPIEditorSettings_Statics::NewProp_CodeGeneratorClass_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIEditorSettings_Statics::ClassParams = {
		...
		0,
		0x001000A2u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIEditorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIEditorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIEditorSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_WebAPIEditorSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIEditorSettings, UWebAPIEditorSettings::StaticClass, TEXT("UWebAPIEditorSettings"), &Z_Registration_Info_UClass_UWebAPIEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIEditorSettings), 1073414454U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_WebAPIEditorSettings_h_3494059504(TEXT("/Script/WebAPIEditor"),
