...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::NewProp_FileContents = { "FileContents", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOpenAPIAssetData, FileContents), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::NewProp_FileContents_MetaData), Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::NewProp_FileContents_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIAssetData_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIOpenAPIFactory_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOpenAPIFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIOpenAPIFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIOpenAPI_Private_V3_WebAPIOpenAPIFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIOpenAPIAssetData, UWebAPIOpenAPIAssetData::StaticClass, TEXT("UWebAPIOpenAPIAssetData"), &Z_Registration_Info_UClass_UWebAPIOpenAPIAssetData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIOpenAPIAssetData), 1369398875U) },
		{ Z_Construct_UClass_UWebAPIOpenAPIFactory, UWebAPIOpenAPIFactory::StaticClass, TEXT("UWebAPIOpenAPIFactory"), &Z_Registration_Info_UClass_UWebAPIOpenAPIFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIOpenAPIFactory), 2977018329U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIOpenAPI_Private_V3_WebAPIOpenAPIFactory_h_4243448366(TEXT("/Script/WebAPIOpenAPI"),
