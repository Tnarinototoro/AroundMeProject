...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICodeGeneratorInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPICodeGeneratorInterface_Statics::ClassParams = {
		...
		0,
		0x000040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICodeGeneratorInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPICodeGeneratorInterface_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICodeGeneratorBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWebAPICodeGeneratorBase_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UWebAPICodeGeneratorBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UWebAPICodeGeneratorInterface_NoRegister, (int32)VTABLE_OFFSET(UWebAPICodeGeneratorBase, IWebAPICodeGeneratorInterface), false },  // 1449296739
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICodeGeneratorBase_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPICodeGeneratorBase_Statics::ClassParams = {
		...
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPICodeGeneratorBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPICodeGeneratorBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_CodeGen_WebAPICodeGenerator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPICodeGeneratorInterface, UWebAPICodeGeneratorInterface::StaticClass, TEXT("UWebAPICodeGeneratorInterface"), &Z_Registration_Info_UClass_UWebAPICodeGeneratorInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPICodeGeneratorInterface), 1449296739U) },
		{ Z_Construct_UClass_UWebAPICodeGeneratorBase, UWebAPICodeGeneratorBase::StaticClass, TEXT("UWebAPICodeGeneratorBase"), &Z_Registration_Info_UClass_UWebAPICodeGeneratorBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPICodeGeneratorBase), 4157925123U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_CodeGen_WebAPICodeGenerator_h_3091045113(TEXT("/Script/WebAPIEditor"),
