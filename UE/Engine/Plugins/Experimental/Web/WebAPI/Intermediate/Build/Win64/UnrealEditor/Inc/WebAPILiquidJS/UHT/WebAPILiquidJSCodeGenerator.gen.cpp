...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPILiquidJSCodeGenerator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPILiquidJSCodeGenerator_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPILiquidJSCodeGenerator_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPILiquidJSCodeGenerator_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPILiquidJS_Private_WebAPILiquidJSCodeGenerator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPILiquidJSCodeGenerator, UWebAPILiquidJSCodeGenerator::StaticClass, TEXT("UWebAPILiquidJSCodeGenerator"), &Z_Registration_Info_UClass_UWebAPILiquidJSCodeGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPILiquidJSCodeGenerator), 1640979246U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPILiquidJS_Private_WebAPILiquidJSCodeGenerator_h_768829260(TEXT("/Script/WebAPILiquidJS"),
