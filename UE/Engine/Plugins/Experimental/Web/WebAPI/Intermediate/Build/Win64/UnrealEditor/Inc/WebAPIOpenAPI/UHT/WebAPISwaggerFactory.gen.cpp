...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::NewProp_FileContents = { "FileContents", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPISwaggerAssetData, FileContents), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::NewProp_FileContents_MetaData), Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::NewProp_FileContents_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISwaggerAssetData_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISwaggerFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPISwaggerFactory_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISwaggerFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPISwaggerFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIOpenAPI_Private_V2_WebAPISwaggerFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPISwaggerAssetData, UWebAPISwaggerAssetData::StaticClass, TEXT("UWebAPISwaggerAssetData"), &Z_Registration_Info_UClass_UWebAPISwaggerAssetData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPISwaggerAssetData), 825243991U) },
		{ Z_Construct_UClass_UWebAPISwaggerFactory, UWebAPISwaggerFactory::StaticClass, TEXT("UWebAPISwaggerFactory"), &Z_Registration_Info_UClass_UWebAPISwaggerFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPISwaggerFactory), 2323377885U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIOpenAPI_Private_V2_WebAPISwaggerFactory_h_3982822437(TEXT("/Script/WebAPIOpenAPI"),
