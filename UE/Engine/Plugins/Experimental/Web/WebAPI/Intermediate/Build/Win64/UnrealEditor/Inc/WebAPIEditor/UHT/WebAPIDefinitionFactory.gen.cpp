...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIDefinitionFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIDefinitionFactory_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIDefinitionFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIDefinitionFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Factories_WebAPIDefinitionFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIDefinitionFactory, UWebAPIDefinitionFactory::StaticClass, TEXT("UWebAPIDefinitionFactory"), &Z_Registration_Info_UClass_UWebAPIDefinitionFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIDefinitionFactory), 4070880829U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_Factories_WebAPIDefinitionFactory_h_1752723280(TEXT("/Script/WebAPIEditor"),
