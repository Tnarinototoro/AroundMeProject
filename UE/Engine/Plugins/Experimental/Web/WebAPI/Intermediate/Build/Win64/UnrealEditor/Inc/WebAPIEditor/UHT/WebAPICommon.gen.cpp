...
template<> WEBAPIEDITOR_API UScriptStruct* StaticStruct<FWebAPITemplateString>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::NewProp_String = { "String", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWebAPITemplateString, String), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::NewProp_String_MetaData), Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::NewProp_String_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_WebAPICommon_h_Statics::ScriptStructInfo[] = {
		{ FWebAPITemplateString::StaticStruct, Z_Construct_UScriptStruct_FWebAPITemplateString_Statics::NewStructOps, TEXT("WebAPITemplateString"), &Z_Registration_Info_UScriptStruct_WebAPITemplateString, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWebAPITemplateString), 3074273994U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPIEditor_Public_WebAPICommon_h_1175510950(TEXT("/Script/WebAPIEditor"),
		nullptr, 0,
