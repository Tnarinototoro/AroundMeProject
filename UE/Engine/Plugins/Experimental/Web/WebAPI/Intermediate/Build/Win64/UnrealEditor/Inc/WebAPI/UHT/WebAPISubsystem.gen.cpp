...
template<> WEBAPI_API UScriptStruct* StaticStruct<FWebAPIPooledOperation>()
{
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_ItemClass = { "ItemClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWebAPIPooledOperation, ItemClass), Z_Construct_UClass_UWebAPIOperationObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_ItemClass_MetaData), Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_ItemClass_MetaData) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_AvailableItems_Inner = { "AvailableItems", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UWebAPIOperationObject_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_AvailableItems = { "AvailableItems", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWebAPIPooledOperation, AvailableItems), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_AvailableItems_MetaData), Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_AvailableItems_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_ItemsInUse = { "ItemsInUse", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWebAPIPooledOperation, ItemsInUse), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_ItemsInUse_MetaData), Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewProp_ItemsInUse_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_bUsePooling = { "bUsePooling", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UWebAPISubsystem), &Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_bUsePooling_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_bUsePooling_MetaData), Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_bUsePooling_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_OperationPool_ValueProp = { "OperationPool", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FWebAPIPooledOperation, METADATA_PARAMS(0, nullptr) }; // 2729532154
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_OperationPool = { "OperationPool", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPISubsystem, OperationPool), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_OperationPool_MetaData), Z_Construct_UClass_UWebAPISubsystem_Statics::NewProp_OperationPool_MetaData) }; // 2729532154
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPISubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPISubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPISubsystem_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPI_Public_WebAPISubsystem_h_Statics::ScriptStructInfo[] = {
		{ FWebAPIPooledOperation::StaticStruct, Z_Construct_UScriptStruct_FWebAPIPooledOperation_Statics::NewStructOps, TEXT("WebAPIPooledOperation"), &Z_Registration_Info_UScriptStruct_WebAPIPooledOperation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWebAPIPooledOperation), 2729532154U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPI_Public_WebAPISubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPISubsystem, UWebAPISubsystem::StaticClass, TEXT("UWebAPISubsystem"), &Z_Registration_Info_UClass_UWebAPISubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPISubsystem), 3075522638U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPI_Public_WebAPISubsystem_h_2569677305(TEXT("/Script/WebAPI"),
