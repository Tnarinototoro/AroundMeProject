...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::NewProp_SchemeName = { "SchemeName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIAuthenticationSettings, SchemeName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::NewProp_SchemeName_MetaData), Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::NewProp_SchemeName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIAuthenticationSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ClientId = { "ClientId", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, ClientId), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ClientId_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ClientId_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ClientSecret = { "ClientSecret", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, ClientSecret), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ClientSecret_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ClientSecret_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_TokenType = { "TokenType", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, TokenType), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_TokenType_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_TokenType_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AccessToken = { "AccessToken", nullptr, (EPropertyFlags)0x0010000000024015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, AccessToken), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AccessToken_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AccessToken_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ExpiresOn = { "ExpiresOn", nullptr, (EPropertyFlags)0x0010000000024015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, ExpiresOn), Z_Construct_UScriptStruct_FDateTime, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ExpiresOn_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_ExpiresOn_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AuthenticationServer = { "AuthenticationServer", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, AuthenticationServer), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AuthenticationServer_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AuthenticationServer_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestQueryParameters_ValueProp = { "AdditionalRequestQueryParameters", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestQueryParameters_Key_KeyProp = { "AdditionalRequestQueryParameters_Key", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestQueryParameters = { "AdditionalRequestQueryParameters", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, AdditionalRequestQueryParameters), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestQueryParameters_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestQueryParameters_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestBodyParameters_ValueProp = { "AdditionalRequestBodyParameters", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestBodyParameters_Key_KeyProp = { "AdditionalRequestBodyParameters_Key", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestBodyParameters = { "AdditionalRequestBodyParameters", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebAPIOAuthSettings, AdditionalRequestBodyParameters), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestBodyParameters_MetaData), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::NewProp_AdditionalRequestBodyParameters_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebAPIOAuthSettings_Statics::ClassParams = {
		...
		0,
		0x001004A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebAPIOAuthSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebAPIOAuthSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPI_Public_Security_WebAPIAuthentication_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebAPIAuthenticationSettings, UWebAPIAuthenticationSettings::StaticClass, TEXT("UWebAPIAuthenticationSettings"), &Z_Registration_Info_UClass_UWebAPIAuthenticationSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIAuthenticationSettings), 3864876297U) },
		{ Z_Construct_UClass_UWebAPIOAuthSettings, UWebAPIOAuthSettings::StaticClass, TEXT("UWebAPIOAuthSettings"), &Z_Registration_Info_UClass_UWebAPIOAuthSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebAPIOAuthSettings), 3240744288U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Web_WebAPI_Source_WebAPI_Public_Security_WebAPIAuthentication_h_1560634317(TEXT("/Script/WebAPI"),
