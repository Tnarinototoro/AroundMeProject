...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeatureAction_Statics::ClassParams = {
		...
		0,
		0x003010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeatureAction_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureAction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction, UGameFeatureAction::StaticClass, TEXT("UGameFeatureAction"), &Z_Registration_Info_UClass_UGameFeatureAction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction), 513437066U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureAction_h_2185670102(TEXT("/Script/GameFeatures"),
