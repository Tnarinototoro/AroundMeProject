...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::NewProp_ContentBundleDescriptor = { "ContentBundleDescriptor", nullptr, (EPropertyFlags)0x0044000000020001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeatureAction_AddWPContent, ContentBundleDescriptor), Z_Construct_UClass_UContentBundleDescriptor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::NewProp_ContentBundleDescriptor_MetaData), Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::NewProp_ContentBundleDescriptor_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::ClassParams = {
		...
		0,
		0x003010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_AddWPContent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureAction_AddWPContent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction_AddWPContent, UGameFeatureAction_AddWPContent::StaticClass, TEXT("UGameFeatureAction_AddWPContent"), &Z_Registration_Info_UClass_UGameFeatureAction_AddWPContent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction_AddWPContent), 1041381624U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureAction_AddWPContent_h_3199738885(TEXT("/Script/GameFeatures"),
