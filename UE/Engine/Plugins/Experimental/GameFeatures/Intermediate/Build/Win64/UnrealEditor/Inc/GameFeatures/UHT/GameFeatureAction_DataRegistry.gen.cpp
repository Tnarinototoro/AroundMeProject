...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::NewProp_RegistriesToAdd = { "RegistriesToAdd", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeatureAction_DataRegistry, RegistriesToAdd), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::NewProp_RegistriesToAdd_MetaData), Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::NewProp_RegistriesToAdd_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::NewProp_bPreloadInEditor = { "bPreloadInEditor", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UGameFeatureAction_DataRegistry), &Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::NewProp_bPreloadInEditor_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::NewProp_bPreloadInEditor_MetaData), Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::NewProp_bPreloadInEditor_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::ClassParams = {
		...
		0,
		0x002810A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureAction_DataRegistry_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureAction_DataRegistry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction_DataRegistry, UGameFeatureAction_DataRegistry::StaticClass, TEXT("UGameFeatureAction_DataRegistry"), &Z_Registration_Info_UClass_UGameFeatureAction_DataRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction_DataRegistry), 2951887370U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureAction_DataRegistry_h_3393122491(TEXT("/Script/GameFeatures"),
