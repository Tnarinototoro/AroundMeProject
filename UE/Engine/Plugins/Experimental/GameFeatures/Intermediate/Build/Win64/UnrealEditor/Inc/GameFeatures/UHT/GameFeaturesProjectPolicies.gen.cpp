...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesProjectPolicies_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeaturesProjectPolicies_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesProjectPolicies_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeaturesProjectPolicies_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDefaultGameFeaturesProjectPolicies_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDefaultGameFeaturesProjectPolicies_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDefaultGameFeaturesProjectPolicies_Statics::Class_MetaDataParams), Z_Construct_UClass_UDefaultGameFeaturesProjectPolicies_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeaturesProjectPolicies_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeaturesProjectPolicies, UGameFeaturesProjectPolicies::StaticClass, TEXT("UGameFeaturesProjectPolicies"), &Z_Registration_Info_UClass_UGameFeaturesProjectPolicies, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeaturesProjectPolicies), 502729934U) },
		{ Z_Construct_UClass_UDefaultGameFeaturesProjectPolicies, UDefaultGameFeaturesProjectPolicies::StaticClass, TEXT("UDefaultGameFeaturesProjectPolicies"), &Z_Registration_Info_UClass_UDefaultGameFeaturesProjectPolicies, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDefaultGameFeaturesProjectPolicies), 915824320U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeaturesProjectPolicies_h_2361340015(TEXT("/Script/GameFeatures"),
