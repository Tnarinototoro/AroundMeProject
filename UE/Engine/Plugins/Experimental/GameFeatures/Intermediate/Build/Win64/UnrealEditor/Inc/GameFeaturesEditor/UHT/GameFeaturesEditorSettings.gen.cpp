...
template<> GAMEFEATURESEDITOR_API UScriptStruct* StaticStruct<FPluginTemplateData>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DefaultSubfolder_MetaData[];
#endif
		static const UECodeGen_Private::FStrPropertyParams NewProp_DefaultSubfolder;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Path = { "Path", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPluginTemplateData, Path), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Path_MetaData), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Path_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Label = { "Label", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPluginTemplateData, Label), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Label_MetaData), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Label_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPluginTemplateData, Description), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Description_MetaData), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_Description_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultSubfolder_MetaData[] = {
		{ "Category", "PluginTemplate" },
		{ "Comment", "/** Optional sub folder that new plugins will be created in. */" },
		{ "ModuleRelativePath", "Private/GameFeaturesEditorSettings.h" },
		{ "ToolTip", "Optional sub folder that new plugins will be created in." },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultSubfolder = { "DefaultSubfolder", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPluginTemplateData, DefaultSubfolder), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultSubfolder_MetaData), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultSubfolder_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultGameFeatureDataClass = { "DefaultGameFeatureDataClass", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPluginTemplateData, DefaultGameFeatureDataClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UGameFeatureData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultGameFeatureDataClass_MetaData), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultGameFeatureDataClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultGameFeatureDataName = { "DefaultGameFeatureDataName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPluginTemplateData, DefaultGameFeatureDataName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultGameFeatureDataName_MetaData), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultGameFeatureDataName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_bIsEnabledByDefault = { "bIsEnabledByDefault", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FPluginTemplateData), &Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_bIsEnabledByDefault_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_bIsEnabledByDefault_MetaData), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_bIsEnabledByDefault_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FPluginTemplateData_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewProp_DefaultSubfolder,
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPluginTemplateData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPluginTemplateData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginTemplateData_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::NewProp_PluginTemplates_Inner = { "PluginTemplates", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPluginTemplateData, METADATA_PARAMS(0, nullptr) }; // 2060339392
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::NewProp_PluginTemplates = { "PluginTemplates", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeaturesEditorSettings, PluginTemplates), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::NewProp_PluginTemplates_MetaData), Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::NewProp_PluginTemplates_MetaData) }; // 2060339392
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesEditorSettings_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeaturesEditor_Private_GameFeaturesEditorSettings_h_Statics::ScriptStructInfo[] = {
		{ FPluginTemplateData::StaticStruct, Z_Construct_UScriptStruct_FPluginTemplateData_Statics::NewStructOps, TEXT("PluginTemplateData"), &Z_Registration_Info_UScriptStruct_PluginTemplateData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPluginTemplateData), 2060339392U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeaturesEditor_Private_GameFeaturesEditorSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeaturesEditorSettings, UGameFeaturesEditorSettings::StaticClass, TEXT("UGameFeaturesEditorSettings"), &Z_Registration_Info_UClass_UGameFeaturesEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeaturesEditorSettings), 3317304003U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeaturesEditor_Private_GameFeaturesEditorSettings_h_1422180092(TEXT("/Script/GameFeaturesEditor"),
