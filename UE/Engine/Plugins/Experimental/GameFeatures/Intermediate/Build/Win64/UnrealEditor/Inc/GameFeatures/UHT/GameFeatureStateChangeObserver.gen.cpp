...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureStateChangeObserver_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeatureStateChangeObserver_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeatureStateChangeObserver_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeatureStateChangeObserver_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureStateChangeObserver_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureStateChangeObserver, UGameFeatureStateChangeObserver::StaticClass, TEXT("UGameFeatureStateChangeObserver"), &Z_Registration_Info_UClass_UGameFeatureStateChangeObserver, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureStateChangeObserver), 1209594825U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeatureStateChangeObserver_h_1000646484(TEXT("/Script/GameFeatures"),
