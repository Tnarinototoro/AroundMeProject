...
// End Cross Module References
	...
	struct Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics
	{
		...
		static const UECodeGen_Private::FStrPropertyParams NewProp_EnabledPlugins_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_EnabledPlugins_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_EnabledPlugins;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_GameFeaturesManagerClassName = { "GameFeaturesManagerClassName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeaturesSubsystemSettings, GameFeaturesManagerClassName), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_GameFeaturesManagerClassName_MetaData), Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_GameFeaturesManagerClassName_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_EnabledPlugins_Inner = { "EnabledPlugins", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_EnabledPlugins_MetaData[] = {
		{ "Category", "GameFeatures" },
		{ "Comment", "/** List of plugins that are forcibly enabled (e.g., via a hotfix) */" },
		{ "ModuleRelativePath", "Public/GameFeaturesSubsystemSettings.h" },
		{ "ToolTip", "List of plugins that are forcibly enabled (e.g., via a hotfix)" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_EnabledPlugins = { "EnabledPlugins", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeaturesSubsystemSettings, EnabledPlugins), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_EnabledPlugins_MetaData), Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_EnabledPlugins_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_DisabledPlugins_Inner = { "DisabledPlugins", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_DisabledPlugins = { "DisabledPlugins", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeaturesSubsystemSettings, DisabledPlugins), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_DisabledPlugins_MetaData), Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_DisabledPlugins_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_AdditionalPluginMetadataKeys_Inner = { "AdditionalPluginMetadataKeys", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_AdditionalPluginMetadataKeys = { "AdditionalPluginMetadataKeys", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeaturesSubsystemSettings, AdditionalPluginMetadataKeys), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_AdditionalPluginMetadataKeys_MetaData), Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_AdditionalPluginMetadataKeys_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_EnabledPlugins_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::NewProp_EnabledPlugins,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturesSubsystemSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeaturesSubsystemSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeaturesSubsystemSettings, UGameFeaturesSubsystemSettings::StaticClass, TEXT("UGameFeaturesSubsystemSettings"), &Z_Registration_Info_UClass_UGameFeaturesSubsystemSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeaturesSubsystemSettings), 4045871470U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Public_GameFeaturesSubsystemSettings_h_3992873721(TEXT("/Script/GameFeatures"),
