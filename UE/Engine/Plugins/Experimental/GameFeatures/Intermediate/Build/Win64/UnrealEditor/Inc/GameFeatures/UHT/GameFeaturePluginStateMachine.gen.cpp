...
template<> GAMEFEATURES_API UScriptStruct* StaticStruct<FGameFeaturePluginStateMachineProperties>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties_Statics::NewProp_GameFeatureData = { "GameFeatureData", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FGameFeaturePluginStateMachineProperties, GameFeatureData), Z_Construct_UClass_UGameFeatureData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties_Statics::NewProp_GameFeatureData_MetaData), Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties_Statics::NewProp_GameFeatureData_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::NewProp_StateProperties = { "StateProperties", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UGameFeaturePluginStateMachine, StateProperties), Z_Construct_UScriptStruct_FGameFeaturePluginStateMachineProperties, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::NewProp_StateProperties_MetaData), Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::NewProp_StateProperties_MetaData) }; // 1735802663
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::Class_MetaDataParams), Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGameFeaturePluginStateMachine_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Private_GameFeaturePluginStateMachine_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeaturePluginStateMachine, UGameFeaturePluginStateMachine::StaticClass, TEXT("UGameFeaturePluginStateMachine"), &Z_Registration_Info_UClass_UGameFeaturePluginStateMachine, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeaturePluginStateMachine), 2982986363U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameFeatures_Source_GameFeatures_Private_GameFeaturePluginStateMachine_h_4013720101(TEXT("/Script/GameFeatures"),
