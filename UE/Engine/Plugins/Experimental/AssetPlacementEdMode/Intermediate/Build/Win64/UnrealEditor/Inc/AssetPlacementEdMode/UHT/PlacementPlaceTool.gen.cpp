...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlacementToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModePlacementToolBuilder_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlacementToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModePlacementToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlacementTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModePlacementTool_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlacementTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModePlacementTool_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementPlaceTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementModePlacementToolBuilder, UPlacementModePlacementToolBuilder::StaticClass, TEXT("UPlacementModePlacementToolBuilder"), &Z_Registration_Info_UClass_UPlacementModePlacementToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModePlacementToolBuilder), 361815891U) },
		{ Z_Construct_UClass_UPlacementModePlacementTool, UPlacementModePlacementTool::StaticClass, TEXT("UPlacementModePlacementTool"), &Z_Registration_Info_UClass_UPlacementModePlacementTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModePlacementTool), 1254836132U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementPlaceTool_h_3106845155(TEXT("/Script/AssetPlacementEdMode"),
