...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeEraseToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModeEraseToolBuilder_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeEraseToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModeEraseToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeEraseTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModeEraseTool_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeEraseTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModeEraseTool_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementEraseTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementModeEraseToolBuilder, UPlacementModeEraseToolBuilder::StaticClass, TEXT("UPlacementModeEraseToolBuilder"), &Z_Registration_Info_UClass_UPlacementModeEraseToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModeEraseToolBuilder), 532106818U) },
		{ Z_Construct_UClass_UPlacementModeEraseTool, UPlacementModeEraseTool::StaticClass, TEXT("UPlacementModeEraseTool"), &Z_Registration_Info_UClass_UPlacementModeEraseTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModeEraseTool), 2907848903U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementEraseTool_h_1766938764(TEXT("/Script/AssetPlacementEdMode"),
