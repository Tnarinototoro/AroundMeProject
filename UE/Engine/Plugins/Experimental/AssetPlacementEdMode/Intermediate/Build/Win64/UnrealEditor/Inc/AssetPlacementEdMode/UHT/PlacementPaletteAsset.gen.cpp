...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteAsset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_PaletteItems_Inner = { "PaletteItems", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UPlacementPaletteClient_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_PaletteItems = { "PaletteItems", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementPaletteAsset, PaletteItems), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_PaletteItems_MetaData), Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_PaletteItems_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_GridGuid_MetaData[] = {
		{ "ModuleRelativePath", "Private/PlacementPaletteAsset.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_GridGuid = { "GridGuid", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementPaletteAsset, GridGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_GridGuid_MetaData), Z_Construct_UClass_UPlacementPaletteAsset_Statics::NewProp_GridGuid_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementPaletteAsset_Statics::ClassParams = {
		...
		0,
		0x000002A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteAsset_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementPaletteAsset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteAsset_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteAssetFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementPaletteAssetFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteAssetFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementPaletteAssetFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_PlacementPaletteAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementPaletteAsset, UPlacementPaletteAsset::StaticClass, TEXT("UPlacementPaletteAsset"), &Z_Registration_Info_UClass_UPlacementPaletteAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementPaletteAsset), 1570188081U) },
		{ Z_Construct_UClass_UPlacementPaletteAssetFactory, UPlacementPaletteAssetFactory::StaticClass, TEXT("UPlacementPaletteAssetFactory"), &Z_Registration_Info_UClass_UPlacementPaletteAssetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementPaletteAssetFactory), 1943658692U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_PlacementPaletteAsset_h_2475908615(TEXT("/Script/AssetPlacementEdMode"),
