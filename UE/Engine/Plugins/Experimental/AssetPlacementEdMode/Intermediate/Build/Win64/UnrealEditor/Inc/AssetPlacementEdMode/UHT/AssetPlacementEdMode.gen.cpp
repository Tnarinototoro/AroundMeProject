...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetPlacementEdMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetPlacementEdMode_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetPlacementEdMode_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetPlacementEdMode_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Public_AssetPlacementEdMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetPlacementEdMode, UAssetPlacementEdMode::StaticClass, TEXT("UAssetPlacementEdMode"), &Z_Registration_Info_UClass_UAssetPlacementEdMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetPlacementEdMode), 2227233000U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Public_AssetPlacementEdMode_h_2899972025(TEXT("/Script/AssetPlacementEdMode"),
