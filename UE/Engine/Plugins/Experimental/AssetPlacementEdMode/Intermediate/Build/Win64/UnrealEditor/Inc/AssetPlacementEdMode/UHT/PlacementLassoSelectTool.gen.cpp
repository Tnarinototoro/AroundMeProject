...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeLassoSelectToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModeLassoSelectToolBuilder_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeLassoSelectToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModeLassoSelectToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeLassoSelectTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModeLassoSelectTool_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeLassoSelectTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModeLassoSelectTool_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementLassoSelectTool_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UPlacementModeLassoSelectTool, UPlacementModeLassoSelectTool::StaticClass, TEXT("UPlacementModeLassoSelectTool"), &Z_Registration_Info_UClass_UPlacementModeLassoSelectTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModeLassoSelectTool), 3003073702U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementLassoSelectTool_h_4172437611(TEXT("/Script/AssetPlacementEdMode"),
