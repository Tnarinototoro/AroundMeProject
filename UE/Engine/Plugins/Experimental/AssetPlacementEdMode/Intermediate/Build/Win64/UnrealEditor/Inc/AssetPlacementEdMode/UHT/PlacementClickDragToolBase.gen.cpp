...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementClickDragToolBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementClickDragToolBase_Statics::ClassParams = {
		...
		0,
		0x000800A9u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementClickDragToolBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementClickDragToolBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementClickDragToolBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementClickDragToolBase, UPlacementClickDragToolBase::StaticClass, TEXT("UPlacementClickDragToolBase"), &Z_Registration_Info_UClass_UPlacementClickDragToolBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementClickDragToolBase), 2391789164U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementClickDragToolBase_h_1297880231(TEXT("/Script/AssetPlacementEdMode"),
