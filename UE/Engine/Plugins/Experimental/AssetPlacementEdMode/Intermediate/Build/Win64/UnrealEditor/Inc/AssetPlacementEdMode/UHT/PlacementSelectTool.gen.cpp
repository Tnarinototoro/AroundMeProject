...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSelectToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModeSelectToolBuilder_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSelectToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModeSelectToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSelectTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModeSelectTool_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSelectTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModeSelectTool_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementSelectTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementModeSelectToolBuilder, UPlacementModeSelectToolBuilder::StaticClass, TEXT("UPlacementModeSelectToolBuilder"), &Z_Registration_Info_UClass_UPlacementModeSelectToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModeSelectToolBuilder), 4064454531U) },
		{ Z_Construct_UClass_UPlacementModeSelectTool, UPlacementModeSelectTool::StaticClass, TEXT("UPlacementModeSelectTool"), &Z_Registration_Info_UClass_UPlacementModeSelectTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModeSelectTool), 737381300U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementSelectTool_h_1727287053(TEXT("/Script/AssetPlacementEdMode"),
