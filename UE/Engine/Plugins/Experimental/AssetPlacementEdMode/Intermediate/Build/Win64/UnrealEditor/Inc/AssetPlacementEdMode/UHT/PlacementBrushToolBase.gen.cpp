...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementToolBuilderBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementToolBuilderBase_Statics::ClassParams = {
		...
		0,
		0x000800A9u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementToolBuilderBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementToolBuilderBase_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementBrushToolBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementBrushToolBase_Statics::ClassParams = {
		...
		0,
		0x000800A9u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementBrushToolBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementBrushToolBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementBrushToolBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementToolBuilderBase, UPlacementToolBuilderBase::StaticClass, TEXT("UPlacementToolBuilderBase"), &Z_Registration_Info_UClass_UPlacementToolBuilderBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementToolBuilderBase), 1612435400U) },
		{ Z_Construct_UClass_UPlacementBrushToolBase, UPlacementBrushToolBase::StaticClass, TEXT("UPlacementBrushToolBase"), &Z_Registration_Info_UClass_UPlacementBrushToolBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementBrushToolBase), 3905603954U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementBrushToolBase_h_307686301(TEXT("/Script/AssetPlacementEdMode"),
