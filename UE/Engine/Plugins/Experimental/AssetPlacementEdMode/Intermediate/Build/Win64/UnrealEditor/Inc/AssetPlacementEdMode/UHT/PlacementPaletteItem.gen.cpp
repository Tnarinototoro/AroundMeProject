...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteClient_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_AssetPath = { "AssetPath", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementPaletteClient, AssetPath), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_AssetPath_MetaData), Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_AssetPath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_ClientGuid = { "ClientGuid", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementPaletteClient, ClientGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_ClientGuid_MetaData), Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_ClientGuid_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_SettingsObject = { "SettingsObject", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementPaletteClient, SettingsObject), Z_Construct_UClass_UInstancedPlacemenClientSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_SettingsObject_MetaData), Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_SettingsObject_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInterfacePropertyParams Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_FactoryInterface = { "FactoryInterface", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementPaletteClient, FactoryInterface), Z_Construct_UClass_UAssetFactoryInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_FactoryInterface_MetaData), Z_Construct_UClass_UPlacementPaletteClient_Statics::NewProp_FactoryInterface_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementPaletteClient_Statics::ClassParams = {
		...
		0,
		0x000002A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteClient_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementPaletteClient_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementPaletteClient_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_PlacementPaletteItem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementPaletteClient, UPlacementPaletteClient::StaticClass, TEXT("UPlacementPaletteClient"), &Z_Registration_Info_UClass_UPlacementPaletteClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementPaletteClient), 3347016750U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_PlacementPaletteItem_h_399875464(TEXT("/Script/AssetPlacementEdMode"),
