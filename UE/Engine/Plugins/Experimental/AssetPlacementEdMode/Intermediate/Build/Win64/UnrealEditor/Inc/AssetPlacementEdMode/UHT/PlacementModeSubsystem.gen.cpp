...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPlacementModeSubsystem_Statics::NewProp_ModeSettings = { "ModeSettings", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementModeSubsystem, ModeSettings), Z_Construct_UClass_UAssetPlacementSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSubsystem_Statics::NewProp_ModeSettings_MetaData), Z_Construct_UClass_UPlacementModeSubsystem_Statics::NewProp_ModeSettings_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModeSubsystem_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModeSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModeSubsystem_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Modes_PlacementModeSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementModeSubsystem, UPlacementModeSubsystem::StaticClass, TEXT("UPlacementModeSubsystem"), &Z_Registration_Info_UClass_UPlacementModeSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModeSubsystem), 4002396670U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Modes_PlacementModeSubsystem_h_3061151859(TEXT("/Script/AssetPlacementEdMode"),
