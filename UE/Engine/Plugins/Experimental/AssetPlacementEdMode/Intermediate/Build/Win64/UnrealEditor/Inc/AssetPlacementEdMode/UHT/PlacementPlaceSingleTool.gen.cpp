...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModePlaceSingleToolBuilder_Statics::ClassParams = {
		...
		0,
		0x000800A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModePlaceSingleToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AssetPlacementEdMode_EPlacementScaleToCursorType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AssetPlacementEdMode_EPlacementScaleToCursorType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AssetPlacementEdMode_EPlacementScaleToCursorType_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::NewProp_ScalingType = { "ScalingType", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementModePlaceSingleToolSettings, ScalingType), Z_Construct_UEnum_AssetPlacementEdMode_EPlacementScaleToCursorType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::NewProp_ScalingType_MetaData), Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::NewProp_ScalingType_MetaData) }; // 1274316051
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::NewProp_bSelectAfterPlacing = { "bSelectAfterPlacing", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPlacementModePlaceSingleToolSettings), &Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::NewProp_bSelectAfterPlacing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::NewProp_bSelectAfterPlacing_MetaData), Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::NewProp_bSelectAfterPlacing_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::ClassParams = {
		...
		0,
		0x000000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::NewProp_SinglePlaceSettings = { "SinglePlaceSettings", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPlacementModePlaceSingleTool, SinglePlaceSettings), Z_Construct_UClass_UPlacementModePlaceSingleToolSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::NewProp_SinglePlaceSettings_MetaData), Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::NewProp_SinglePlaceSettings_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlacementModePlaceSingleTool_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementPlaceSingleTool_h_Statics::EnumInfo[] = {
		{ EPlacementScaleToCursorType_StaticEnum, TEXT("EPlacementScaleToCursorType"), &Z_Registration_Info_UEnum_EPlacementScaleToCursorType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1274316051U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementPlaceSingleTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlacementModePlaceSingleToolBuilder, UPlacementModePlaceSingleToolBuilder::StaticClass, TEXT("UPlacementModePlaceSingleToolBuilder"), &Z_Registration_Info_UClass_UPlacementModePlaceSingleToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModePlaceSingleToolBuilder), 1690654013U) },
		{ Z_Construct_UClass_UPlacementModePlaceSingleToolSettings, UPlacementModePlaceSingleToolSettings::StaticClass, TEXT("UPlacementModePlaceSingleToolSettings"), &Z_Registration_Info_UClass_UPlacementModePlaceSingleToolSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModePlaceSingleToolSettings), 3824843285U) },
		{ Z_Construct_UClass_UPlacementModePlaceSingleTool, UPlacementModePlaceSingleTool::StaticClass, TEXT("UPlacementModePlaceSingleTool"), &Z_Registration_Info_UClass_UPlacementModePlaceSingleTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlacementModePlaceSingleTool), 364493974U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AssetPlacementEdMode_Source_AssetPlacementEdMode_Private_Tools_PlacementPlaceSingleTool_h_3971467553(TEXT("/Script/AssetPlacementEdMode"),
