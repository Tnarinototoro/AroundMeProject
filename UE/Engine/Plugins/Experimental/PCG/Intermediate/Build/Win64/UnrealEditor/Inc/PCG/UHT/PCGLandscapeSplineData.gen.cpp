...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeSplineData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UPCGLandscapeSplineData_Statics::NewProp_Spline = { "Spline", nullptr, (EPropertyFlags)0x002408000008000d, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGLandscapeSplineData, Spline), Z_Construct_UClass_ULandscapeSplinesComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeSplineData_Statics::NewProp_Spline_MetaData), Z_Construct_UClass_UPCGLandscapeSplineData_Statics::NewProp_Spline_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGLandscapeSplineData_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeSplineData_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGLandscapeSplineData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeSplineData_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeSplineData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeSplineData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGLandscapeSplineData, UPCGLandscapeSplineData::StaticClass, TEXT("UPCGLandscapeSplineData"), &Z_Registration_Info_UClass_UPCGLandscapeSplineData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGLandscapeSplineData), 1755096182U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeSplineData_h_1223695115(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeSplineData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeSplineData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
