...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_PCGDistanceShape_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_PCGDistanceShape_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_PCGDistanceShape_Statics::Enum_MetaDataParams)
	};
	...
	struct Z_Construct_UClass_UPCGDistanceSettings_Statics
	{
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_SourceShape_Underlying;
#if WITH_METADATA
		...
		static const UECodeGen_Private::FIntPropertyParams NewProp_TargetShape_Underlying;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_AttributeName = { "AttributeName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDistanceSettings, AttributeName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_AttributeName_MetaData), Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_AttributeName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bOutputDistanceVector = { "bOutputDistanceVector", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGDistanceSettings), &Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bOutputDistanceVector_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bOutputDistanceVector_MetaData), Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bOutputDistanceVector_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bSetDensity = { "bSetDensity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGDistanceSettings), &Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bSetDensity_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bSetDensity_MetaData), Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_bSetDensity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_MaximumDistance = { "MaximumDistance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDistanceSettings, MaximumDistance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_MaximumDistance_MetaData), Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_MaximumDistance_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_SourceShape_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_SourceShape = { "SourceShape", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDistanceSettings, SourceShape), Z_Construct_UEnum_PCG_PCGDistanceShape, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_SourceShape_MetaData), Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_SourceShape_MetaData) }; // 1579428531
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_TargetShape_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_TargetShape = { "TargetShape", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDistanceSettings, TargetShape), Z_Construct_UEnum_PCG_PCGDistanceShape, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_TargetShape_MetaData), Z_Construct_UClass_UPCGDistanceSettings_Statics::NewProp_TargetShape_MetaData) }; // 1579428531
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGDistanceSettings_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGDistanceSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDistanceSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_Statics::EnumInfo[] = {
		{ PCGDistanceShape_StaticEnum, TEXT("PCGDistanceShape"), &Z_Registration_Info_UEnum_PCGDistanceShape, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1579428531U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGDistanceSettings, UPCGDistanceSettings::StaticClass, TEXT("UPCGDistanceSettings"), &Z_Registration_Info_UClass_UPCGDistanceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGDistanceSettings), 2964641616U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_4201266771(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDistance_h_Statics::EnumInfo));
