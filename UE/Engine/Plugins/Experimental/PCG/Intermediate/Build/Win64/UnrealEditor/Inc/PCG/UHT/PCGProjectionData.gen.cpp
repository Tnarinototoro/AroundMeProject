...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_Source = { "Source", nullptr, (EPropertyFlags)0x0024080000020015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGProjectionData, Source), Z_Construct_UClass_UPCGSpatialData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_Source_MetaData), Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_Source_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0024080000020015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGProjectionData, Target), Z_Construct_UClass_UPCGSpatialData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_Target_MetaData), Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_Target_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_CachedBounds_MetaData[] = {
		{ "ModuleRelativePath", "Public/Data/PCGProjectionData.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_CachedBounds = { "CachedBounds", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGProjectionData, CachedBounds), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_CachedBounds_MetaData), Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_CachedBounds_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_CachedStrictBounds = { "CachedStrictBounds", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGProjectionData, CachedStrictBounds), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_CachedStrictBounds_MetaData), Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_CachedStrictBounds_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_ProjectionParams = { "ProjectionParams", nullptr, (EPropertyFlags)0x0020080000020005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGProjectionData, ProjectionParams), Z_Construct_UScriptStruct_FPCGProjectionParams, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_ProjectionParams_MetaData), Z_Construct_UClass_UPCGProjectionData_Statics::NewProp_ProjectionParams_MetaData) }; // 266977904
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGProjectionData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGProjectionData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGProjectionData_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGProjectionData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGProjectionData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGProjectionData, UPCGProjectionData::StaticClass, TEXT("UPCGProjectionData"), &Z_Registration_Info_UClass_UPCGProjectionData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGProjectionData), 4194672682U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGProjectionData_h_754261888(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGProjectionData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGProjectionData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
