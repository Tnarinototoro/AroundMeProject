...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::NewProp_InputSource = { "InputSource", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGMetadataBreakVectorSettings, InputSource), Z_Construct_UScriptStruct_FPCGAttributePropertyInputSelector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::NewProp_InputSource_MetaData), Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::NewProp_InputSource_MetaData) }; // 1471452776
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::NewProp_InputAttributeName = { "InputAttributeName", nullptr, (EPropertyFlags)0x0010000820000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGMetadataBreakVectorSettings, InputAttributeName_DEPRECATED), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::NewProp_InputAttributeName_MetaData), Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::NewProp_InputAttributeName_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataBreakVectorSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataBreakVector_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataBreakVector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGMetadataBreakVectorSettings, UPCGMetadataBreakVectorSettings::StaticClass, TEXT("UPCGMetadataBreakVectorSettings"), &Z_Registration_Info_UClass_UPCGMetadataBreakVectorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGMetadataBreakVectorSettings), 1843675447U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataBreakVector_h_3409646133(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataBreakVector_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataBreakVector_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
