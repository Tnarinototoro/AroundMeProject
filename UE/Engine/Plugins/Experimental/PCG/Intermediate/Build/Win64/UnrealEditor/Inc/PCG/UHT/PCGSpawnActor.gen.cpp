...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGSpawnActorOption_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGSpawnActorOption_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGSpawnActorOption_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGSpawnActorGenerationTrigger_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGSpawnActorGenerationTrigger_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGSpawnActorGenerationTrigger_Statics::Enum_MetaDataParams)
	};
...
template<> PCG_API UScriptStruct* StaticStruct<FPCGActorPropertyOverride>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::NewProp_InputSource = { "InputSource", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPCGActorPropertyOverride, InputSource), Z_Construct_UScriptStruct_FPCGAttributePropertyInputSelector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::NewProp_InputSource_MetaData), Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::NewProp_InputSource_MetaData) }; // 1471452776
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::NewProp_PropertyTarget = { "PropertyTarget", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPCGActorPropertyOverride, PropertyTarget), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::NewProp_PropertyTarget_MetaData), Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::NewProp_PropertyTarget_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::PropPointers) < 2048);
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bSpawnByAttribute_MetaData[];
#endif
		static void NewProp_bSpawnByAttribute_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bSpawnByAttribute;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SpawnAttribute_MetaData[];
#endif
		static const UECodeGen_Private::FNamePropertyParams NewProp_SpawnAttribute;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
		{ "ToolTip", "* PCG settings class that allows spawning actors with some options to perform the work more efficiently.\n* Note that depending on the options, any PCG components on the spawned actors can be also generated,\n* which is why this class derives from UPCGBaseSubgraphSettings - it has similar inner-workings to the subgraph node\n* as far as data passing and dispatch go.\n* Note that at this point in time, results from the underlying graphs being generated is not propagated back as results of this node." },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TemplateActorClass = { "TemplateActorClass", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, TemplateActorClass), Z_Construct_UClass_UClass, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TemplateActorClass_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TemplateActorClass_MetaData) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_PostSpawnFunctionNames_Inner = { "PostSpawnFunctionNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_PostSpawnFunctionNames = { "PostSpawnFunctionNames", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, PostSpawnFunctionNames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_PostSpawnFunctionNames_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_PostSpawnFunctionNames_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_Option = { "Option", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, Option), Z_Construct_UEnum_PCG_EPCGSpawnActorOption, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_Option_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_Option_MetaData) }; // 2071795935
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bForceDisableActorParsing = { "bForceDisableActorParsing", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGSpawnActorSettings), &Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bForceDisableActorParsing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bForceDisableActorParsing_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bForceDisableActorParsing_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_GenerationTrigger_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_GenerationTrigger_MetaData[] = {
		{ "Category", "Settings" },
		{ "EditCondition", "Option==EPCGSpawnActorOption::NoMerging" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_GenerationTrigger = { "GenerationTrigger", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, GenerationTrigger), Z_Construct_UEnum_PCG_EPCGSpawnActorGenerationTrigger, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_GenerationTrigger_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_GenerationTrigger_MetaData) }; // 2579005940
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bInheritActorTags = { "bInheritActorTags", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGSpawnActorSettings), &Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bInheritActorTags_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bInheritActorTags_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bInheritActorTags_MetaData) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TagsToAddOnActors_Inner = { "TagsToAddOnActors", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TagsToAddOnActors = { "TagsToAddOnActors", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, TagsToAddOnActors), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TagsToAddOnActors_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TagsToAddOnActors_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bAllowTemplateActorEditing_MetaData[] = {
		{ "Category", "Settings" },
		{ "EditCondition", "Option != EPCGSpawnActorOption::CollapseActors" },
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
	};
#endif
	void Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bAllowTemplateActorEditing_SetBit(void* Obj)
	{
		((UPCGSpawnActorSettings*)Obj)->bAllowTemplateActorEditing = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bAllowTemplateActorEditing = { "bAllowTemplateActorEditing", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGSpawnActorSettings), &Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bAllowTemplateActorEditing_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bAllowTemplateActorEditing_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bAllowTemplateActorEditing_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TemplateActor_MetaData[] = {
		{ "Category", "Settings" },
		{ "EditCondition", "bAllowTemplateActorEditing && Option != EPCGSpawnActorOption::CollapseActors" },
		{ "EditConditionHides", "" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
		{ "ShowInnerProperties", "" },
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TemplateActor = { "TemplateActor", nullptr, (EPropertyFlags)0x001600000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, TemplateActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TemplateActor_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_TemplateActor_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_ActorOverrides_Inner = { "ActorOverrides", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPCGActorPropertyOverride, METADATA_PARAMS(0, nullptr) }; // 3215786963
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_ActorOverrides = { "ActorOverrides", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, ActorOverrides), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_ActorOverrides_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_ActorOverrides_MetaData) }; // 3215786963
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_RootActor_MetaData[] = {
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
		{ "PCG_Overridable", "" },
	};
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_RootActor = { "RootActor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, RootActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_RootActor_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_RootActor_MetaData) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_AttachOptions_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_AttachOptions_MetaData[] = {
		{ "Category", "Settings" },
		{ "EditCondition", "Option != EPCGSpawnActorOption::CollapseActors" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_AttachOptions = { "AttachOptions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, AttachOptions), Z_Construct_UEnum_PCG_EPCGAttachOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_AttachOptions_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_AttachOptions_MetaData) }; // 227260305
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bSpawnByAttribute_MetaData[] = {
		{ "Category", "Settings" },
		{ "InlineEditConditionToggle", "" },
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
	};
#endif
	void Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bSpawnByAttribute_SetBit(void* Obj)
	{
		((UPCGSpawnActorSettings*)Obj)->bSpawnByAttribute = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bSpawnByAttribute = { "bSpawnByAttribute", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGSpawnActorSettings), &Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bSpawnByAttribute_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bSpawnByAttribute_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bSpawnByAttribute_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_SpawnAttribute_MetaData[] = {
		{ "Category", "Settings" },
		{ "EditCondition", "bSpawnByAttribute" },
		{ "ModuleRelativePath", "Public/Elements/PCGSpawnActor.h" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_SpawnAttribute = { "SpawnAttribute", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, SpawnAttribute), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_SpawnAttribute_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_SpawnAttribute_MetaData) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bGenerationTrigger_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bGenerationTrigger = { "bGenerationTrigger", nullptr, (EPropertyFlags)0x0020080820000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSpawnActorSettings, bGenerationTrigger_DEPRECATED), Z_Construct_UEnum_PCG_EPCGSpawnActorGenerationTrigger, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bGenerationTrigger_MetaData), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bGenerationTrigger_MetaData) }; // 2579005940
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPCGSpawnActorSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_GenerationTrigger_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_GenerationTrigger,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bAllowTemplateActorEditing,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_RootActor,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_AttachOptions_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_AttachOptions,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_bSpawnByAttribute,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSpawnActorSettings_Statics::NewProp_SpawnAttribute,
#if WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGSpawnActorSettings_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGSpawnActorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGSpawnActorNode_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSpawnActorNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGSpawnActorNode_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::EnumInfo[] = {
		{ EPCGSpawnActorOption_StaticEnum, TEXT("EPCGSpawnActorOption"), &Z_Registration_Info_UEnum_EPCGSpawnActorOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2071795935U) },
		{ EPCGSpawnActorGenerationTrigger_StaticEnum, TEXT("EPCGSpawnActorGenerationTrigger"), &Z_Registration_Info_UEnum_EPCGSpawnActorGenerationTrigger, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2579005940U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::ScriptStructInfo[] = {
		{ FPCGActorPropertyOverride::StaticStruct, Z_Construct_UScriptStruct_FPCGActorPropertyOverride_Statics::NewStructOps, TEXT("PCGActorPropertyOverride"), &Z_Registration_Info_UScriptStruct_PCGActorPropertyOverride, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPCGActorPropertyOverride), 3215786963U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGSpawnActorSettings, UPCGSpawnActorSettings::StaticClass, TEXT("UPCGSpawnActorSettings"), &Z_Registration_Info_UClass_UPCGSpawnActorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGSpawnActorSettings), 291870614U) },
		{ Z_Construct_UClass_UPCGSpawnActorNode, UPCGSpawnActorNode::StaticClass, TEXT("UPCGSpawnActorNode"), &Z_Registration_Info_UClass_UPCGSpawnActorNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGSpawnActorNode), 3793977560U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_660306731(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGSpawnActor_h_Statics::EnumInfo));
