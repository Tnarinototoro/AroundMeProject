...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGCreateSplineMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGCreateSplineMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGCreateSplineMode_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGCreateSplineSettings, Mode), Z_Construct_UEnum_PCG_EPCGCreateSplineMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_Mode_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_Mode_MetaData) }; // 3322423199
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bClosedLoop = { "bClosedLoop", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGCreateSplineSettings), &Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bClosedLoop_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bClosedLoop_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bClosedLoop_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bLinear = { "bLinear", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGCreateSplineSettings), &Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bLinear_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bLinear_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bLinear_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bApplyCustomTangents = { "bApplyCustomTangents", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGCreateSplineSettings), &Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bApplyCustomTangents_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bApplyCustomTangents_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_bApplyCustomTangents_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_ArriveTangentAttribute = { "ArriveTangentAttribute", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGCreateSplineSettings, ArriveTangentAttribute), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_ArriveTangentAttribute_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_ArriveTangentAttribute_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_LeaveTangentAttribute = { "LeaveTangentAttribute", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGCreateSplineSettings, LeaveTangentAttribute), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_LeaveTangentAttribute_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_LeaveTangentAttribute_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_TargetActor_MetaData[] = {
		{ "ModuleRelativePath", "Public/Elements/PCGCreateSpline.h" },
		{ "PCG_Overridable", "" },
	};
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_TargetActor = { "TargetActor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGCreateSplineSettings, TargetActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_TargetActor_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_TargetActor_MetaData) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_AttachOptions_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_AttachOptions_MetaData[] = {
		{ "Category", "Settings" },
		{ "EditCondition", "Mode==EPCGCreateSplineMode::CreateNewActor" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/Elements/PCGCreateSpline.h" },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_AttachOptions = { "AttachOptions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGCreateSplineSettings, AttachOptions), Z_Construct_UEnum_PCG_EPCGAttachOptions, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_AttachOptions_MetaData), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_AttachOptions_MetaData) }; // 227260305
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPCGCreateSplineSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_TargetActor,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_AttachOptions_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGCreateSplineSettings_Statics::NewProp_AttachOptions,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGCreateSplineSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGCreateSplineSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGCreateSplineSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_Statics::EnumInfo[] = {
		{ EPCGCreateSplineMode_StaticEnum, TEXT("EPCGCreateSplineMode"), &Z_Registration_Info_UEnum_EPCGCreateSplineMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3322423199U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGCreateSplineSettings, UPCGCreateSplineSettings::StaticClass, TEXT("UPCGCreateSplineSettings"), &Z_Registration_Info_UClass_UPCGCreateSplineSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGCreateSplineSettings), 1182799868U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_2039874977(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGCreateSpline_h_Statics::EnumInfo));
