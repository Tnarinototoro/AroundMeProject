...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGGetDataFromActorMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGGetDataFromActorMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGGetDataFromActorMode_Statics::Enum_MetaDataParams)
	};
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bMergeSinglePointData_MetaData[];
#endif
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_ActorSelector = { "ActorSelector", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDataFromActorSettings, ActorSelector), Z_Construct_UScriptStruct_FPCGActorSelectorSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_ActorSelector_MetaData), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_ActorSelector_MetaData) }; // 3011128248
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDataFromActorSettings, Mode), Z_Construct_UEnum_PCG_EPCGGetDataFromActorMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_Mode_MetaData), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_Mode_MetaData) }; // 2070033145
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bMergeSinglePointData_MetaData[] = {
		{ "Category", "Settings" },
		{ "EditCondition", "Mode == EPCGGetDataFromActorMode::GetSinglePoint" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/Elements/PCGDataFromActor.h" },
	};
#endif
	void Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bMergeSinglePointData_SetBit(void* Obj)
	{
		((UPCGDataFromActorSettings*)Obj)->bMergeSinglePointData = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bMergeSinglePointData = { "bMergeSinglePointData", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGDataFromActorSettings), &Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bMergeSinglePointData_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bMergeSinglePointData_MetaData), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bMergeSinglePointData_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bDisplayModeSettings = { "bDisplayModeSettings", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGDataFromActorSettings), &Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bDisplayModeSettings_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bDisplayModeSettings_MetaData), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bDisplayModeSettings_MetaData) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_ExpectedPins_Inner = { "ExpectedPins", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_ExpectedPins = { "ExpectedPins", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDataFromActorSettings, ExpectedPins), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_ExpectedPins_MetaData), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_ExpectedPins_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_PropertyName = { "PropertyName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDataFromActorSettings, PropertyName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_PropertyName_MetaData), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_PropertyName_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bTrackActorsOnlyWithinBounds = { "bTrackActorsOnlyWithinBounds", nullptr, (EPropertyFlags)0x0010000800000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGDataFromActorSettings), &Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bTrackActorsOnlyWithinBounds_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bTrackActorsOnlyWithinBounds_MetaData), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bTrackActorsOnlyWithinBounds_MetaData) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPCGDataFromActorSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGDataFromActorSettings_Statics::NewProp_bMergeSinglePointData,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGDataFromActorSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGDataFromActorSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataFromActorSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_Statics::EnumInfo[] = {
		{ EPCGGetDataFromActorMode_StaticEnum, TEXT("EPCGGetDataFromActorMode"), &Z_Registration_Info_UEnum_EPCGGetDataFromActorMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2070033145U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGDataFromActorSettings, UPCGDataFromActorSettings::StaticClass, TEXT("UPCGDataFromActorSettings"), &Z_Registration_Info_UClass_UPCGDataFromActorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGDataFromActorSettings), 1944594927U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_775268792(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataFromActor_h_Statics::EnumInfo));
