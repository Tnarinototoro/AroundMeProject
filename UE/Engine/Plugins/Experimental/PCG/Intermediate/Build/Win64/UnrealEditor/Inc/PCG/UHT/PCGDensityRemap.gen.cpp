...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_RemapMin = { "RemapMin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGLinearDensityRemapSettings, RemapMin), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_RemapMin_MetaData), Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_RemapMin_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_RemapMax = { "RemapMax", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGLinearDensityRemapSettings, RemapMax), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_RemapMax_MetaData), Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_RemapMax_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_bMultiplyDensity = { "bMultiplyDensity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGLinearDensityRemapSettings), &Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_bMultiplyDensity_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_bMultiplyDensity_MetaData), Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::NewProp_bMultiplyDensity_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::ClassParams = {
		...
		0,
		0x011000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLinearDensityRemapSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemap_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemap_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGLinearDensityRemapSettings, UPCGLinearDensityRemapSettings::StaticClass, TEXT("UPCGLinearDensityRemapSettings"), &Z_Registration_Info_UClass_UPCGLinearDensityRemapSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGLinearDensityRemapSettings), 2999112307U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemap_h_991108323(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemap_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemap_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
