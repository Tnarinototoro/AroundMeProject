...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bGetHeightOnly_MetaData[];
#endif
		static void NewProp_bGetHeightOnly_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bGetHeightOnly;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bGetLayerWeights_MetaData[];
#endif
		static void NewProp_bGetLayerWeights_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bGetLayerWeights;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetHeightOnly_MetaData[] = {
		{ "Category", "Settings" },
		{ "Comment", "//~End UPCGDataFromActorSettings\n" },
		{ "ModuleRelativePath", "Public/Elements/PCGTypedGetter.h" },
		{ "PCG_Overridable", "" },
	};
#endif
	void Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetHeightOnly_SetBit(void* Obj)
	{
		((UPCGGetLandscapeSettings*)Obj)->bGetHeightOnly = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetHeightOnly = { "bGetHeightOnly", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGGetLandscapeSettings), &Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetHeightOnly_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetHeightOnly_MetaData), Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetHeightOnly_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetLayerWeights_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/Elements/PCGTypedGetter.h" },
		{ "PCG_Overridable", "" },
	};
#endif
	void Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetLayerWeights_SetBit(void* Obj)
	{
		((UPCGGetLandscapeSettings*)Obj)->bGetLayerWeights = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetLayerWeights = { "bGetLayerWeights", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGGetLandscapeSettings), &Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetLayerWeights_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetLayerWeights_MetaData), Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetLayerWeights_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetHeightOnly,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::NewProp_bGetLayerWeights,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::ClassParams = {
		...
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetLandscapeSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetSplineSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGGetSplineSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetSplineSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGGetSplineSettings_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetVolumeSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGGetVolumeSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetVolumeSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGGetVolumeSettings_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetPrimitiveSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGGetPrimitiveSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGetPrimitiveSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGGetPrimitiveSettings_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGTypedGetter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGTypedGetter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGGetLandscapeSettings, UPCGGetLandscapeSettings::StaticClass, TEXT("UPCGGetLandscapeSettings"), &Z_Registration_Info_UClass_UPCGGetLandscapeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGGetLandscapeSettings), 2114895193U) },
		{ Z_Construct_UClass_UPCGGetSplineSettings, UPCGGetSplineSettings::StaticClass, TEXT("UPCGGetSplineSettings"), &Z_Registration_Info_UClass_UPCGGetSplineSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGGetSplineSettings), 1442401135U) },
		{ Z_Construct_UClass_UPCGGetVolumeSettings, UPCGGetVolumeSettings::StaticClass, TEXT("UPCGGetVolumeSettings"), &Z_Registration_Info_UClass_UPCGGetVolumeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGGetVolumeSettings), 3373820377U) },
		{ Z_Construct_UClass_UPCGGetPrimitiveSettings, UPCGGetPrimitiveSettings::StaticClass, TEXT("UPCGGetPrimitiveSettings"), &Z_Registration_Info_UClass_UPCGGetPrimitiveSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGGetPrimitiveSettings), 3567283618U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGTypedGetter_h_1082678964(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGTypedGetter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGTypedGetter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
