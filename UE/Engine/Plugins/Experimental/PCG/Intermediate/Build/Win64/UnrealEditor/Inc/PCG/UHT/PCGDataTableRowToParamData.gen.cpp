...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_RowName = { "RowName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDataTableRowToParamDataSettings, RowName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_RowName_MetaData), Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_RowName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_PathOverride = { "PathOverride", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDataTableRowToParamDataSettings, PathOverride), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_PathOverride_MetaData), Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_PathOverride_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_DataTable = { "DataTable", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDataTableRowToParamDataSettings, DataTable), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_DataTable_MetaData), Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::NewProp_DataTable_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDataTableRowToParamDataSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataTableRowToParamData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataTableRowToParamData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGDataTableRowToParamDataSettings, UPCGDataTableRowToParamDataSettings::StaticClass, TEXT("UPCGDataTableRowToParamDataSettings"), &Z_Registration_Info_UClass_UPCGDataTableRowToParamDataSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGDataTableRowToParamDataSettings), 908402630U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataTableRowToParamData_h_151742727(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataTableRowToParamData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDataTableRowToParamData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
