...
#include "../Private/PCGEditorMenuContext.h"
...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGEditorMenuContext_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGEditorMenuContext_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGEditorMenuContext_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGEditorMenuContext_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCGEditor_Private_PCGEditorMenuContext_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCGEditor_Private_PCGEditorMenuContext_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGEditorMenuContext, UPCGEditorMenuContext::StaticClass, TEXT("UPCGEditorMenuContext"), &Z_Registration_Info_UClass_UPCGEditorMenuContext, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGEditorMenuContext), 1065643050U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCGEditor_Private_PCGEditorMenuContext_h_3188687085(TEXT("/Script/PCGEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCGEditor_Private_PCGEditorMenuContext_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCGEditor_Private_PCGEditorMenuContext_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
