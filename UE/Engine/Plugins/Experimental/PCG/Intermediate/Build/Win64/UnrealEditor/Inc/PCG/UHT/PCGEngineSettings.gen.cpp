...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGEngineSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGEngineSettings_Statics::NewProp_VolumeScale = { "VolumeScale", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGEngineSettings, VolumeScale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGEngineSettings_Statics::NewProp_VolumeScale_MetaData), Z_Construct_UClass_UPCGEngineSettings_Statics::NewProp_VolumeScale_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGEngineSettings_Statics::NewProp_bGenerateOnDrop = { "bGenerateOnDrop", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGEngineSettings), &Z_Construct_UClass_UPCGEngineSettings_Statics::NewProp_bGenerateOnDrop_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGEngineSettings_Statics::NewProp_bGenerateOnDrop_MetaData), Z_Construct_UClass_UPCGEngineSettings_Statics::NewProp_bGenerateOnDrop_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGEngineSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGEngineSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGEngineSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGEngineSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGEngineSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGEngineSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGEngineSettings, UPCGEngineSettings::StaticClass, TEXT("UPCGEngineSettings"), &Z_Registration_Info_UClass_UPCGEngineSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGEngineSettings), 3705333969U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGEngineSettings_h_2692007004(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGEngineSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGEngineSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
