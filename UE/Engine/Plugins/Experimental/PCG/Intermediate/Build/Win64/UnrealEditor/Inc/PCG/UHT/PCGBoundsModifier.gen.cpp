...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGBoundsModifierMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGBoundsModifierMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGBoundsModifierMode_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGBoundsModifierSettings, Mode), Z_Construct_UEnum_PCG_EPCGBoundsModifierMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_Mode_MetaData), Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_Mode_MetaData) }; // 2100421557
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_BoundsMin = { "BoundsMin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGBoundsModifierSettings, BoundsMin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_BoundsMin_MetaData), Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_BoundsMin_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_BoundsMax = { "BoundsMax", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGBoundsModifierSettings, BoundsMax), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_BoundsMax_MetaData), Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_BoundsMax_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_bAffectSteepness = { "bAffectSteepness", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGBoundsModifierSettings), &Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_bAffectSteepness_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_bAffectSteepness_MetaData), Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_bAffectSteepness_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_Steepness = { "Steepness", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGBoundsModifierSettings, Steepness), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_Steepness_MetaData), Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::NewProp_Steepness_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBoundsModifierSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_Statics::EnumInfo[] = {
		{ EPCGBoundsModifierMode_StaticEnum, TEXT("EPCGBoundsModifierMode"), &Z_Registration_Info_UEnum_EPCGBoundsModifierMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2100421557U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGBoundsModifierSettings, UPCGBoundsModifierSettings::StaticClass, TEXT("UPCGBoundsModifierSettings"), &Z_Registration_Info_UClass_UPCGBoundsModifierSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGBoundsModifierSettings), 3420821641U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_4280133698(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGBoundsModifier_h_Statics::EnumInfo));
