...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMergeSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGMergeSettings_Statics::NewProp_bMergeMetadata = { "bMergeMetadata", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGMergeSettings), &Z_Construct_UClass_UPCGMergeSettings_Statics::NewProp_bMergeMetadata_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMergeSettings_Statics::NewProp_bMergeMetadata_MetaData), Z_Construct_UClass_UPCGMergeSettings_Statics::NewProp_bMergeMetadata_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGMergeSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMergeSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGMergeSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMergeSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGMergeElement_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGMergeElement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGMergeSettings, UPCGMergeSettings::StaticClass, TEXT("UPCGMergeSettings"), &Z_Registration_Info_UClass_UPCGMergeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGMergeSettings), 2976664998U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGMergeElement_h_903063166(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGMergeElement_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGMergeElement_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
