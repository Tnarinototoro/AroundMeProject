...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_InRangeMin = { "InRangeMin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDensityRemapSettings, InRangeMin), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_InRangeMin_MetaData), Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_InRangeMin_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_InRangeMax = { "InRangeMax", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDensityRemapSettings, InRangeMax), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_InRangeMax_MetaData), Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_InRangeMax_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_OutRangeMin = { "OutRangeMin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDensityRemapSettings, OutRangeMin), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_OutRangeMin_MetaData), Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_OutRangeMin_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_OutRangeMax = { "OutRangeMax", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGDensityRemapSettings, OutRangeMax), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_OutRangeMax_MetaData), Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_OutRangeMax_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_bExcludeValuesOutsideInputRange = { "bExcludeValuesOutsideInputRange", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGDensityRemapSettings), &Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_bExcludeValuesOutsideInputRange_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_bExcludeValuesOutsideInputRange_MetaData), Z_Construct_UClass_UPCGDensityRemapSettings_Statics::NewProp_bExcludeValuesOutsideInputRange_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGDensityRemapSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGDensityRemapSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGDensityRemapSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemapElement_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemapElement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGDensityRemapSettings, UPCGDensityRemapSettings::StaticClass, TEXT("UPCGDensityRemapSettings"), &Z_Registration_Info_UClass_UPCGDensityRemapSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGDensityRemapSettings), 2041195299U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemapElement_h_2892516158(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemapElement_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGDensityRemapElement_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
