...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_Landscapes = { "Landscapes", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGLandscapeData, Landscapes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_Landscapes_MetaData), Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_Landscapes_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_Bounds_MetaData[] = {
		{ "ModuleRelativePath", "Public/Data/PCGLandscapeData.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_Bounds = { "Bounds", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGLandscapeData, Bounds), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_Bounds_MetaData), Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_Bounds_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bHeightOnly = { "bHeightOnly", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGLandscapeData), &Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bHeightOnly_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bHeightOnly_MetaData), Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bHeightOnly_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bUseMetadata = { "bUseMetadata", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UPCGLandscapeData), &Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bUseMetadata_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bUseMetadata_MetaData), Z_Construct_UClass_UPCGLandscapeData_Statics::NewProp_bUseMetadata_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGLandscapeData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeData_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGLandscapeData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGLandscapeData_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGLandscapeData, UPCGLandscapeData::StaticClass, TEXT("UPCGLandscapeData"), &Z_Registration_Info_UClass_UPCGLandscapeData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGLandscapeData), 3494202270U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeData_h_1907548804(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGLandscapeData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
