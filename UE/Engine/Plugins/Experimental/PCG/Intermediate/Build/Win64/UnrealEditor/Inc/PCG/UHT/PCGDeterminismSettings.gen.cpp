...
template<> PCG_API UScriptStruct* StaticStruct<FPCGDeterminismSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bNativeTests = { "bNativeTests", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FPCGDeterminismSettings), &Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bNativeTests_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bNativeTests_MetaData), Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bNativeTests_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bUseBlueprintDeterminismTest = { "bUseBlueprintDeterminismTest", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FPCGDeterminismSettings), &Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bUseBlueprintDeterminismTest_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bUseBlueprintDeterminismTest_MetaData), Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_bUseBlueprintDeterminismTest_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_DeterminismTestBlueprint = { "DeterminismTestBlueprint", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPCGDeterminismSettings, DeterminismTestBlueprint), Z_Construct_UClass_UClass, Z_Construct_UClass_UPCGDeterminismTestBlueprintBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_DeterminismTestBlueprint_MetaData), Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewProp_DeterminismTestBlueprint_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Tests_Determinism_PCGDeterminismSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Tests_Determinism_PCGDeterminismSettings_h_Statics::ScriptStructInfo[] = {
		{ FPCGDeterminismSettings::StaticStruct, Z_Construct_UScriptStruct_FPCGDeterminismSettings_Statics::NewStructOps, TEXT("PCGDeterminismSettings"), &Z_Registration_Info_UScriptStruct_PCGDeterminismSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPCGDeterminismSettings), 2892208462U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Tests_Determinism_PCGDeterminismSettings_h_240489677(TEXT("/Script/PCG"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Tests_Determinism_PCGDeterminismSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Tests_Determinism_PCGDeterminismSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
