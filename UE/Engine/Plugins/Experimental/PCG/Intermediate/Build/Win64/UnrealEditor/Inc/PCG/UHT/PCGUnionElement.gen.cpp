...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGUnionSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGUnionSettings_Statics::NewProp_Type_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGUnionSettings_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGUnionSettings, Type), Z_Construct_UEnum_PCG_EPCGUnionType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGUnionSettings_Statics::NewProp_Type_MetaData), Z_Construct_UClass_UPCGUnionSettings_Statics::NewProp_Type_MetaData) }; // 2755141778
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGUnionSettings_Statics::NewProp_DensityFunction = { "DensityFunction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGUnionSettings, DensityFunction), Z_Construct_UEnum_PCG_EPCGUnionDensityFunction, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGUnionSettings_Statics::NewProp_DensityFunction_MetaData), Z_Construct_UClass_UPCGUnionSettings_Statics::NewProp_DensityFunction_MetaData) }; // 859284834
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGUnionSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGUnionSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGUnionSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGUnionSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGUnionElement_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGUnionElement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGUnionSettings, UPCGUnionSettings::StaticClass, TEXT("UPCGUnionSettings"), &Z_Registration_Info_UClass_UPCGUnionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGUnionSettings), 3768971439U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGUnionElement_h_1109557169(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGUnionElement_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGUnionElement_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
