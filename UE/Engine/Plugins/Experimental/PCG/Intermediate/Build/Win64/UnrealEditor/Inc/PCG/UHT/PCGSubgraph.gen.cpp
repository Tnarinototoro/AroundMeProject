...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBaseSubgraphSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGBaseSubgraphSettings_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBaseSubgraphSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGBaseSubgraphSettings_Statics::Class_MetaDataParams)
	};
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SubgraphOverride_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_SubgraphOverride;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphInstance = { "SubgraphInstance", nullptr, (EPropertyFlags)0x00160000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSubgraphSettings, SubgraphInstance), Z_Construct_UClass_UPCGGraphInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphInstance_MetaData), Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphInstance_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphOverride_MetaData[] = {
		{ "Category", "Properties" },
		{ "ModuleRelativePath", "Public/PCGSubgraph.h" },
		{ "PCG_Overridable", "" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphOverride = { "SubgraphOverride", nullptr, (EPropertyFlags)0x0014000000000014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSubgraphSettings, SubgraphOverride), Z_Construct_UClass_UPCGGraphInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphOverride_MetaData), Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphOverride_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_Subgraph = { "Subgraph", nullptr, (EPropertyFlags)0x0014000820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGSubgraphSettings, Subgraph_DEPRECATED), Z_Construct_UClass_UPCGGraph_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_Subgraph_MetaData), Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_Subgraph_MetaData) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPCGSubgraphSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPCGSubgraphSettings_Statics::NewProp_SubgraphOverride,
#if WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGSubgraphSettings_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGSubgraphSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBaseSubgraphNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGBaseSubgraphNode_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGBaseSubgraphNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGBaseSubgraphNode_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphNode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGSubgraphNode_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGSubgraphNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGSubgraphNode_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGSubgraph_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGSubgraph_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGBaseSubgraphSettings, UPCGBaseSubgraphSettings::StaticClass, TEXT("UPCGBaseSubgraphSettings"), &Z_Registration_Info_UClass_UPCGBaseSubgraphSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGBaseSubgraphSettings), 2123009790U) },
		{ Z_Construct_UClass_UPCGSubgraphSettings, UPCGSubgraphSettings::StaticClass, TEXT("UPCGSubgraphSettings"), &Z_Registration_Info_UClass_UPCGSubgraphSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGSubgraphSettings), 70032313U) },
		{ Z_Construct_UClass_UPCGBaseSubgraphNode, UPCGBaseSubgraphNode::StaticClass, TEXT("UPCGBaseSubgraphNode"), &Z_Registration_Info_UClass_UPCGBaseSubgraphNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGBaseSubgraphNode), 1200117577U) },
		{ Z_Construct_UClass_UPCGSubgraphNode, UPCGSubgraphNode::StaticClass, TEXT("UPCGSubgraphNode"), &Z_Registration_Info_UClass_UPCGSubgraphNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGSubgraphNode), 106494606U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGSubgraph_h_1619848571(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGSubgraph_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGSubgraph_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
