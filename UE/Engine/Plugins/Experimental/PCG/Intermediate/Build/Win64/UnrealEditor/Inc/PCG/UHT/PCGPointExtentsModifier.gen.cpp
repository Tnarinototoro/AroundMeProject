...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGPointExtentsModifierMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGPointExtentsModifierMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGPointExtentsModifierMode_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::NewProp_Extents = { "Extents", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGPointExtentsModifierSettings, Extents), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::NewProp_Extents_MetaData), Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::NewProp_Extents_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGPointExtentsModifierSettings, Mode), Z_Construct_UEnum_PCG_EPCGPointExtentsModifierMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::NewProp_Mode_MetaData), Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::NewProp_Mode_MetaData) }; // 233808327
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGPointExtentsModifierSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_Statics::EnumInfo[] = {
		{ EPCGPointExtentsModifierMode_StaticEnum, TEXT("EPCGPointExtentsModifierMode"), &Z_Registration_Info_UEnum_EPCGPointExtentsModifierMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 233808327U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGPointExtentsModifierSettings, UPCGPointExtentsModifierSettings::StaticClass, TEXT("UPCGPointExtentsModifierSettings"), &Z_Registration_Info_UClass_UPCGPointExtentsModifierSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGPointExtentsModifierSettings), 311206643U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_1820423338(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGPointExtentsModifier_h_Statics::EnumInfo));
