...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::NewProp_PartitionAttribute = { "PartitionAttribute", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGMetadataPartitionSettings, PartitionAttribute), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::NewProp_PartitionAttribute_MetaData), Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::NewProp_PartitionAttribute_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGMetadataPartitionSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataPartition_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataPartition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGMetadataPartitionSettings, UPCGMetadataPartitionSettings::StaticClass, TEXT("UPCGMetadataPartitionSettings"), &Z_Registration_Info_UClass_UPCGMetadataPartitionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGMetadataPartitionSettings), 3015304833U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataPartition_h_467234809(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataPartition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_Metadata_PCGMetadataPartition_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
