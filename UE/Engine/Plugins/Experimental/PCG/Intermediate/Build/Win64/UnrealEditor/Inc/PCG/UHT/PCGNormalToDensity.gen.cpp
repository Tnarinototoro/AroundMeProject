...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_PCGNormalToDensityMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_PCGNormalToDensityMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_PCGNormalToDensityMode_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Normal = { "Normal", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGNormalToDensitySettings, Normal), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Normal_MetaData), Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Normal_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Offset = { "Offset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGNormalToDensitySettings, Offset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Offset_MetaData), Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Offset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Strength = { "Strength", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGNormalToDensitySettings, Strength), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Strength_MetaData), Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_Strength_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_DensityMode = { "DensityMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGNormalToDensitySettings, DensityMode), Z_Construct_UEnum_PCG_PCGNormalToDensityMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_DensityMode_MetaData), Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::NewProp_DensityMode_MetaData) }; // 3551948658
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGNormalToDensitySettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_Statics::EnumInfo[] = {
		{ PCGNormalToDensityMode_StaticEnum, TEXT("PCGNormalToDensityMode"), &Z_Registration_Info_UEnum_PCGNormalToDensityMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3551948658U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGNormalToDensitySettings, UPCGNormalToDensitySettings::StaticClass, TEXT("UPCGNormalToDensitySettings"), &Z_Registration_Info_UClass_UPCGNormalToDensitySettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGNormalToDensitySettings), 140669946U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_3441488629(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGNormalToDensity_h_Statics::EnumInfo));
