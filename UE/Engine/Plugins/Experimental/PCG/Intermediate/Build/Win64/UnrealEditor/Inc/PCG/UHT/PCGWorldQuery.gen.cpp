...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldQuerySettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGWorldQuerySettings_Statics::NewProp_QueryParams = { "QueryParams", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGWorldQuerySettings, QueryParams), Z_Construct_UScriptStruct_FPCGWorldVolumetricQueryParams, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldQuerySettings_Statics::NewProp_QueryParams_MetaData), Z_Construct_UClass_UPCGWorldQuerySettings_Statics::NewProp_QueryParams_MetaData) }; // 2442489487
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGWorldQuerySettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldQuerySettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGWorldQuerySettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldQuerySettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::NewProp_QueryParams = { "QueryParams", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGWorldRayHitSettings, QueryParams), Z_Construct_UScriptStruct_FPCGWorldRayHitQueryParams, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::NewProp_QueryParams_MetaData), Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::NewProp_QueryParams_MetaData) }; // 1677830898
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGWorldRayHitSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGWorldQuery_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGWorldQuery_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGWorldQuerySettings, UPCGWorldQuerySettings::StaticClass, TEXT("UPCGWorldQuerySettings"), &Z_Registration_Info_UClass_UPCGWorldQuerySettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGWorldQuerySettings), 3668928053U) },
		{ Z_Construct_UClass_UPCGWorldRayHitSettings, UPCGWorldRayHitSettings::StaticClass, TEXT("UPCGWorldRayHitSettings"), &Z_Registration_Info_UClass_UPCGWorldRayHitSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGWorldRayHitSettings), 4188498257U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGWorldQuery_h_2614192567(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGWorldQuery_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Elements_PCGWorldQuery_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
