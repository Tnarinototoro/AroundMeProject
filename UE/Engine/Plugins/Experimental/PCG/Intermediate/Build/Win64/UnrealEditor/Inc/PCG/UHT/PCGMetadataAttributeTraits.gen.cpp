...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGMetadataTypes_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGMetadataTypes_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGMetadataTypes_Statics::Enum_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Metadata_PCGMetadataAttributeTraits_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Metadata_PCGMetadataAttributeTraits_h_Statics::EnumInfo[] = {
		{ EPCGMetadataTypes_StaticEnum, TEXT("EPCGMetadataTypes"), &Z_Registration_Info_UEnum_EPCGMetadataTypes, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2747849019U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Metadata_PCGMetadataAttributeTraits_h_3995711194(TEXT("/Script/PCG"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Metadata_PCGMetadataAttributeTraits_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Metadata_PCGMetadataAttributeTraits_h_Statics::EnumInfo));
