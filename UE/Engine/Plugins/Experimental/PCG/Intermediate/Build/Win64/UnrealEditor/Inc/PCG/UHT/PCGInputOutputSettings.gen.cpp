...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_PinLabels_ElementProp = { "PinLabels", nullptr, (EPropertyFlags)0x0000000020000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_PinLabels = { "PinLabels", nullptr, (EPropertyFlags)0x0020080020000000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGGraphInputOutputSettings, PinLabels_DEPRECATED), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_PinLabels_MetaData), Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_PinLabels_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_CustomPins_Inner = { "CustomPins", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPCGPinProperties, METADATA_PARAMS(0, nullptr) }; // 1976663911
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_CustomPins = { "CustomPins", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGGraphInputOutputSettings, CustomPins), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_CustomPins_MetaData), Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::NewProp_CustomPins_MetaData) }; // 1976663911
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::ClassParams = {
		...
		0,
		0x011000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGGraphInputOutputSettings_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGInputOutputSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGInputOutputSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGGraphInputOutputSettings, UPCGGraphInputOutputSettings::StaticClass, TEXT("UPCGGraphInputOutputSettings"), &Z_Registration_Info_UClass_UPCGGraphInputOutputSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGGraphInputOutputSettings), 1752199539U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGInputOutputSettings_h_3848457864(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGInputOutputSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_PCGInputOutputSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
