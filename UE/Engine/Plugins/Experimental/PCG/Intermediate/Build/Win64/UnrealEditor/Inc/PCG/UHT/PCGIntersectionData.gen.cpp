...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_PCG_EPCGIntersectionDensityFunction_Statics::Enum_MetaDataParams[] = {
		...
		{ "Minimum.ToolTip", "Chooses the minimum of the density values." },
		{ "ModuleRelativePath", "Public/Data/PCGIntersectionData.h" },
		{ "Multiply.Name", "EPCGIntersectionDensityFunction::Multiply" },
		{ "Multiply.ToolTip", "Multiplies the density values and results in the product." },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PCG_EPCGIntersectionDensityFunction_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PCG_EPCGIntersectionDensityFunction_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PCG_EPCGIntersectionDensityFunction_Statics::Enum_MetaDataParams)
	};
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::NewProp_InA = { "InA", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PCGIntersectionData_eventInitialize_Parms, InA), Z_Construct_UClass_UPCGSpatialData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::NewProp_InA_MetaData), Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::NewProp_InA_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPCGIntersectionData, nullptr, "Initialize", nullptr, nullptr, Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::PCGIntersectionData_eventInitialize_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPCGIntersectionData_Initialize_Statics::PCGIntersectionData_eventInitialize_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UPCGIntersectionData_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPCGIntersectionData_Initialize, "Initialize" }, // 3348990840
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_DensityFunction_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_DensityFunction = { "DensityFunction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGIntersectionData, DensityFunction), Z_Construct_UEnum_PCG_EPCGIntersectionDensityFunction, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_DensityFunction_MetaData), Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_DensityFunction_MetaData) }; // 3197797060
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_A = { "A", nullptr, (EPropertyFlags)0x0014000000020015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGIntersectionData, A), Z_Construct_UClass_UPCGSpatialData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_A_MetaData), Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_A_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0014000000020015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGIntersectionData, B), Z_Construct_UClass_UPCGSpatialData_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_B_MetaData), Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_B_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_CachedBounds_MetaData[] = {
		{ "ModuleRelativePath", "Public/Data/PCGIntersectionData.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_CachedBounds = { "CachedBounds", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGIntersectionData, CachedBounds), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_CachedBounds_MetaData), Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_CachedBounds_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_CachedStrictBounds = { "CachedStrictBounds", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPCGIntersectionData, CachedStrictBounds), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_CachedStrictBounds_MetaData), Z_Construct_UClass_UPCGIntersectionData_Statics::NewProp_CachedStrictBounds_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPCGIntersectionData_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::Class_MetaDataParams), Z_Construct_UClass_UPCGIntersectionData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPCGIntersectionData_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_Statics::EnumInfo[] = {
		{ EPCGIntersectionDensityFunction_StaticEnum, TEXT("EPCGIntersectionDensityFunction"), &Z_Registration_Info_UEnum_EPCGIntersectionDensityFunction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3197797060U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPCGIntersectionData, UPCGIntersectionData::StaticClass, TEXT("UPCGIntersectionData"), &Z_Registration_Info_UClass_UPCGIntersectionData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPCGIntersectionData), 3232245123U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_870059914(TEXT("/Script/PCG"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PCG_Source_PCG_Public_Data_PCGIntersectionData_h_Statics::EnumInfo));
