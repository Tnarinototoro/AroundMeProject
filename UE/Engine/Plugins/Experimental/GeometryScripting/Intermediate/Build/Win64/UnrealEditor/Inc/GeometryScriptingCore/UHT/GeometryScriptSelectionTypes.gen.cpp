...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptMeshSelectionType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptMeshSelectionType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptMeshSelectionType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptMeshSelectionConversionType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptMeshSelectionConversionType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptMeshSelectionConversionType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptCombineSelectionMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptCombineSelectionMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptCombineSelectionMode_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptEmptySelectionBehavior_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptEmptySelectionBehavior_Statics::Enum_MetaDataParams), Z_Construct_UEnum_GeometryScriptingCore_EGeometryScriptEmptySelectionBehavior_Statics::Enum_MetaDataParams)
	};
...
template<> GEOMETRYSCRIPTINGCORE_API UScriptStruct* StaticStruct<FGeometryScriptMeshSelection>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGeometryScriptMeshSelection_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeometryScriptMeshSelection_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FGeometryScriptMeshSelection_Statics::Struct_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryScripting_Source_GeometryScriptingCore_Public_GeometryScript_GeometryScriptSelectionTypes_h_Statics::EnumInfo[] = {
		{ EGeometryScriptMeshSelectionType_StaticEnum, TEXT("EGeometryScriptMeshSelectionType"), &Z_Registration_Info_UEnum_EGeometryScriptMeshSelectionType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2049916829U) },
		{ EGeometryScriptMeshSelectionConversionType_StaticEnum, TEXT("EGeometryScriptMeshSelectionConversionType"), &Z_Registration_Info_UEnum_EGeometryScriptMeshSelectionConversionType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 226176983U) },
		{ EGeometryScriptCombineSelectionMode_StaticEnum, TEXT("EGeometryScriptCombineSelectionMode"), &Z_Registration_Info_UEnum_EGeometryScriptCombineSelectionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1745607450U) },
		{ EGeometryScriptEmptySelectionBehavior_StaticEnum, TEXT("EGeometryScriptEmptySelectionBehavior"), &Z_Registration_Info_UEnum_EGeometryScriptEmptySelectionBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1231182750U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryScripting_Source_GeometryScriptingCore_Public_GeometryScript_GeometryScriptSelectionTypes_h_Statics::ScriptStructInfo[] = {
		{ FGeometryScriptMeshSelection::StaticStruct, Z_Construct_UScriptStruct_FGeometryScriptMeshSelection_Statics::NewStructOps, TEXT("GeometryScriptMeshSelection"), &Z_Registration_Info_UScriptStruct_GeometryScriptMeshSelection, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGeometryScriptMeshSelection), 2142326124U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryScripting_Source_GeometryScriptingCore_Public_GeometryScript_GeometryScriptSelectionTypes_h_913159570(TEXT("/Script/GeometryScriptingCore"),
		nullptr, 0,
