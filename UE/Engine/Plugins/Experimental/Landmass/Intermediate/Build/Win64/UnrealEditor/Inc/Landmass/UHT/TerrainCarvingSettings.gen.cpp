...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Landmass_EBrushBlendType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Landmass_EBrushBlendType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Landmass_EBrushBlendType_Statics::Enum_MetaDataParams)
	};
...
template<> LANDMASS_API UScriptStruct* StaticStruct<FLandmassTerrainCarvingSettings>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_BlendMode = { "BlendMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassTerrainCarvingSettings, BlendMode), Z_Construct_UEnum_Landmass_EBrushBlendType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_BlendMode_MetaData), Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_BlendMode_MetaData) }; // 39300091
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_bInvertShape = { "bInvertShape", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FLandmassTerrainCarvingSettings), &Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_bInvertShape_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_bInvertShape_MetaData), Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_bInvertShape_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_FalloffSettings = { "FalloffSettings", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassTerrainCarvingSettings, FalloffSettings), Z_Construct_UScriptStruct_FLandmassFalloffSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_FalloffSettings_MetaData), Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_FalloffSettings_MetaData) }; // 2978196284
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_Effects = { "Effects", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassTerrainCarvingSettings, Effects), Z_Construct_UScriptStruct_FLandmassBrushEffectsList, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_Effects_MetaData), Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_Effects_MetaData) }; // 1369482219
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_Priority = { "Priority", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassTerrainCarvingSettings, Priority), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_Priority_MetaData), Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewProp_Priority_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Landmass_Source_Runtime_Public_TerrainCarvingSettings_h_Statics::EnumInfo[] = {
		{ EBrushBlendType_StaticEnum, TEXT("EBrushBlendType"), &Z_Registration_Info_UEnum_EBrushBlendType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 39300091U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Landmass_Source_Runtime_Public_TerrainCarvingSettings_h_Statics::ScriptStructInfo[] = {
		{ FLandmassTerrainCarvingSettings::StaticStruct, Z_Construct_UScriptStruct_FLandmassTerrainCarvingSettings_Statics::NewStructOps, TEXT("LandmassTerrainCarvingSettings"), &Z_Registration_Info_UScriptStruct_LandmassTerrainCarvingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLandmassTerrainCarvingSettings), 1303099697U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Landmass_Source_Runtime_Public_TerrainCarvingSettings_h_3773054295(TEXT("/Script/Landmass"),
		nullptr, 0,
