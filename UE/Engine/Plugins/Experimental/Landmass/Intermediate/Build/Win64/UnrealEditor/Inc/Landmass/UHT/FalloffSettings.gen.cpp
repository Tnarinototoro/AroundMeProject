...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Landmass_EBrushFalloffMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Landmass_EBrushFalloffMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Landmass_EBrushFalloffMode_Statics::Enum_MetaDataParams)
	};
...
template<> LANDMASS_API UScriptStruct* StaticStruct<FLandmassFalloffSettings>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffMode = { "FalloffMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassFalloffSettings, FalloffMode), Z_Construct_UEnum_Landmass_EBrushFalloffMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffMode_MetaData), Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffMode_MetaData) }; // 2039108307
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffAngle = { "FalloffAngle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassFalloffSettings, FalloffAngle), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffAngle_MetaData), Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffAngle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffWidth = { "FalloffWidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassFalloffSettings, FalloffWidth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffWidth_MetaData), Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_FalloffWidth_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_EdgeOffset = { "EdgeOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassFalloffSettings, EdgeOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_EdgeOffset_MetaData), Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_EdgeOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_ZOffset = { "ZOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandmassFalloffSettings, ZOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_ZOffset_MetaData), Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewProp_ZOffset_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Landmass_Source_Runtime_Public_FalloffSettings_h_Statics::EnumInfo[] = {
		{ EBrushFalloffMode_StaticEnum, TEXT("EBrushFalloffMode"), &Z_Registration_Info_UEnum_EBrushFalloffMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2039108307U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Landmass_Source_Runtime_Public_FalloffSettings_h_Statics::ScriptStructInfo[] = {
		{ FLandmassFalloffSettings::StaticStruct, Z_Construct_UScriptStruct_FLandmassFalloffSettings_Statics::NewStructOps, TEXT("LandmassFalloffSettings"), &Z_Registration_Info_UScriptStruct_LandmassFalloffSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLandmassFalloffSettings), 2978196284U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Landmass_Source_Runtime_Public_FalloffSettings_h_2313603405(TEXT("/Script/Landmass"),
		nullptr, 0,
