...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::NewProp_GeometryCacheAbcFileComponent = { "GeometryCacheAbcFileComponent", nullptr, (EPropertyFlags)0x00440000000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGeometryCacheAbcFileActor, GeometryCacheAbcFileComponent), Z_Construct_UClass_UGeometryCacheAbcFileComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::NewProp_GeometryCacheAbcFileComponent_MetaData), Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::NewProp_GeometryCacheAbcFileComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::ClassParams = {
		...
		0,
		0x008000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AGeometryCacheAbcFileActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCacheAbcFile_Source_GeometryCacheAbcFile_Private_GeometryCacheAbcFileActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGeometryCacheAbcFileActor, AGeometryCacheAbcFileActor::StaticClass, TEXT("AGeometryCacheAbcFileActor"), &Z_Registration_Info_UClass_AGeometryCacheAbcFileActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGeometryCacheAbcFileActor), 489347705U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCacheAbcFile_Source_GeometryCacheAbcFile_Private_GeometryCacheAbcFileActor_h_259237102(TEXT("/Script/GeometryCacheAbcFile"),
