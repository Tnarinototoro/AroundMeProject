...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackAbcFile_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCacheTrackAbcFile_Statics::ClassParams = {
		...
		0,
		0x001020A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackAbcFile_Statics::Class_MetaDataParams), Z_Construct_UClass_UGeometryCacheTrackAbcFile_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCacheAbcFile_Source_GeometryCacheAbcFile_Public_GeometryCacheTrackAbcFile_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheTrackAbcFile, UGeometryCacheTrackAbcFile::StaticClass, TEXT("UGeometryCacheTrackAbcFile"), &Z_Registration_Info_UClass_UGeometryCacheTrackAbcFile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheTrackAbcFile), 1961716802U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCacheAbcFile_Source_GeometryCacheAbcFile_Public_GeometryCacheTrackAbcFile_h_3428996438(TEXT("/Script/GeometryCacheAbcFile"),
