...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCinePrestreamingDebugRender_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCinePrestreamingDebugRender_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCinePrestreamingDebugRender_Statics::Class_MetaDataParams), Z_Construct_UClass_UCinePrestreamingDebugRender_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CinematicPrestreaming_Source_CinematicPrestreamingEditor_Private_CinePrestreamingDebugRender_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCinePrestreamingDebugRender, UCinePrestreamingDebugRender::StaticClass, TEXT("UCinePrestreamingDebugRender"), &Z_Registration_Info_UClass_UCinePrestreamingDebugRender, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCinePrestreamingDebugRender), 1968243029U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CinematicPrestreaming_Source_CinematicPrestreamingEditor_Private_CinePrestreamingDebugRender_h_817076039(TEXT("/Script/CinematicPrestreamingEditor"),
