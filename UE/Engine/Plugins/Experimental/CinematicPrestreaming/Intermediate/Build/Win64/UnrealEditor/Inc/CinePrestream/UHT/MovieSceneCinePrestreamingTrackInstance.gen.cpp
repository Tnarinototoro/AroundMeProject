...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::NewProp_PrestreamingAssetMap = { "PrestreamingAssetMap", nullptr, (EPropertyFlags)0x0044008000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneCinePrestreamingTrackInstance, PrestreamingAssetMap), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::NewProp_PrestreamingAssetMap_MetaData), Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::NewProp_PrestreamingAssetMap_MetaData) }; // 886648654
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::ClassParams = {
		...
		0,
		0x008000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CinematicPrestreaming_Source_CinematicPrestreaming_Private_TrackInstances_MovieSceneCinePrestreamingTrackInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCinePrestreamingTrackInstance, UMovieSceneCinePrestreamingTrackInstance::StaticClass, TEXT("UMovieSceneCinePrestreamingTrackInstance"), &Z_Registration_Info_UClass_UMovieSceneCinePrestreamingTrackInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCinePrestreamingTrackInstance), 718307253U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CinematicPrestreaming_Source_CinematicPrestreaming_Private_TrackInstances_MovieSceneCinePrestreamingTrackInstance_h_2471333983(TEXT("/Script/CinematicPrestreaming"),
