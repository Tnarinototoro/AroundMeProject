...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::NewProp_Sections_Inner = { "Sections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::NewProp_Sections = { "Sections", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneCinePrestreamingTrack, Sections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::NewProp_Sections_MetaData), Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::NewProp_Sections_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::ClassParams = {
		...
		0,
		0x00A800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCinePrestreamingTrack_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CinematicPrestreaming_Source_CinematicPrestreaming_Public_Tracks_MovieSceneCinePrestreamingTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCinePrestreamingTrack, UMovieSceneCinePrestreamingTrack::StaticClass, TEXT("UMovieSceneCinePrestreamingTrack"), &Z_Registration_Info_UClass_UMovieSceneCinePrestreamingTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCinePrestreamingTrack), 3105025093U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CinematicPrestreaming_Source_CinematicPrestreaming_Public_Tracks_MovieSceneCinePrestreamingTrack_h_3522822298(TEXT("/Script/CinematicPrestreaming"),
