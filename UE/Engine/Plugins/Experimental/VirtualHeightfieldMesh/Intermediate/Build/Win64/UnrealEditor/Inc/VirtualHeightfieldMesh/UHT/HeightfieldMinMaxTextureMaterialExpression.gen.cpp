...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::NewProp_MinMaxTexture = { "MinMaxTexture", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialExpressionHeightfieldMinMaxTexture, MinMaxTexture), Z_Construct_UClass_UHeightfieldMinMaxTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::NewProp_MinMaxTexture_MetaData), Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::NewProp_MinMaxTexture_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::NewProp_SamplerType = { "SamplerType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMaterialExpressionHeightfieldMinMaxTexture, SamplerType), Z_Construct_UEnum_Engine_EMaterialSamplerType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::NewProp_SamplerType_MetaData), Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::NewProp_SamplerType_MetaData) }; // 1829526248
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::ClassParams = {
		...
		0,
		0x000820B0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::Class_MetaDataParams), Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualHeightfieldMesh_Source_VirtualHeightfieldMesh_Private_HeightfieldMinMaxTextureMaterialExpression_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionHeightfieldMinMaxTexture, UMaterialExpressionHeightfieldMinMaxTexture::StaticClass, TEXT("UMaterialExpressionHeightfieldMinMaxTexture"), &Z_Registration_Info_UClass_UMaterialExpressionHeightfieldMinMaxTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionHeightfieldMinMaxTexture), 4147346950U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualHeightfieldMesh_Source_VirtualHeightfieldMesh_Private_HeightfieldMinMaxTextureMaterialExpression_h_59021016(TEXT("/Script/VirtualHeightfieldMesh"),
