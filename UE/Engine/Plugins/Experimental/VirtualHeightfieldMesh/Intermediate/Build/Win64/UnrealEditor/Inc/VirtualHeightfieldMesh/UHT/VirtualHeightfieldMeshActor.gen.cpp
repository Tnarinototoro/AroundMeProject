...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::NewProp_VirtualHeightfieldMeshComponent = { "VirtualHeightfieldMeshComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AVirtualHeightfieldMesh, VirtualHeightfieldMeshComponent), Z_Construct_UClass_UVirtualHeightfieldMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::NewProp_VirtualHeightfieldMeshComponent_MetaData), Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::NewProp_VirtualHeightfieldMeshComponent_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::NewProp_Box = { "Box", nullptr, (EPropertyFlags)0x0044000800082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AVirtualHeightfieldMesh, Box), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::NewProp_Box_MetaData), Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::NewProp_Box_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::ClassParams = {
		...
		0,
		0x008800A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::Class_MetaDataParams), Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVirtualHeightfieldMesh_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualHeightfieldMesh_Source_VirtualHeightfieldMesh_Public_VirtualHeightfieldMeshActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVirtualHeightfieldMesh, AVirtualHeightfieldMesh::StaticClass, TEXT("AVirtualHeightfieldMesh"), &Z_Registration_Info_UClass_AVirtualHeightfieldMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVirtualHeightfieldMesh), 2583801866U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualHeightfieldMesh_Source_VirtualHeightfieldMesh_Public_VirtualHeightfieldMeshActor_h_4159259147(TEXT("/Script/VirtualHeightfieldMesh"),
