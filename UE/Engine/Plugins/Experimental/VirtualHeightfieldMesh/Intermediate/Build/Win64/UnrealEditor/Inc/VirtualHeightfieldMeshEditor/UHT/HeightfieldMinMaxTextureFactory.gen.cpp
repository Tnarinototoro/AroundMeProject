...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UHeightfieldMinMaxTextureFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UHeightfieldMinMaxTextureFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHeightfieldMinMaxTextureFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UHeightfieldMinMaxTextureFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualHeightfieldMesh_Source_VirtualHeightfieldMeshEditor_Private_HeightfieldMinMaxTextureFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHeightfieldMinMaxTextureFactory, UHeightfieldMinMaxTextureFactory::StaticClass, TEXT("UHeightfieldMinMaxTextureFactory"), &Z_Registration_Info_UClass_UHeightfieldMinMaxTextureFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHeightfieldMinMaxTextureFactory), 1091130944U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualHeightfieldMesh_Source_VirtualHeightfieldMeshEditor_Private_HeightfieldMinMaxTextureFactory_h_852257158(TEXT("/Script/VirtualHeightfieldMeshEditor"),
