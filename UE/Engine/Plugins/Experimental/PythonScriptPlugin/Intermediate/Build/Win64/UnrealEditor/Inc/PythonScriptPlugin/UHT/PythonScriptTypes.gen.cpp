...
template<> PYTHONSCRIPTPLUGIN_API UScriptStruct* StaticStruct<FPythonLogOutputEntry>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FPythonLogOutputEntry_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPythonLogOutputEntry, Type), Z_Construct_UEnum_PythonScriptPlugin_EPythonLogOutputType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPythonLogOutputEntry_Statics::NewProp_Type_MetaData), Z_Construct_UScriptStruct_FPythonLogOutputEntry_Statics::NewProp_Type_MetaData) }; // 1033822879
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PythonScriptPlugin_Source_PythonScriptPlugin_Public_PythonScriptTypes_h_Statics::EnumInfo[] = {
		{ EPythonLogOutputType_StaticEnum, TEXT("EPythonLogOutputType"), &Z_Registration_Info_UEnum_EPythonLogOutputType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1033822879U) },
		{ EPythonCommandFlags_StaticEnum, TEXT("EPythonCommandFlags"), &Z_Registration_Info_UEnum_EPythonCommandFlags, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3482866204U) },
		{ EPythonCommandExecutionMode_StaticEnum, TEXT("EPythonCommandExecutionMode"), &Z_Registration_Info_UEnum_EPythonCommandExecutionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2145223462U) },
		{ EPythonFileExecutionScope_StaticEnum, TEXT("EPythonFileExecutionScope"), &Z_Registration_Info_UEnum_EPythonFileExecutionScope, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 613932481U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PythonScriptPlugin_Source_PythonScriptPlugin_Public_PythonScriptTypes_h_Statics::ScriptStructInfo[] = {
		{ FPythonLogOutputEntry::StaticStruct, Z_Construct_UScriptStruct_FPythonLogOutputEntry_Statics::NewStructOps, TEXT("PythonLogOutputEntry"), &Z_Registration_Info_UScriptStruct_PythonLogOutputEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPythonLogOutputEntry), 4018313054U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PythonScriptPlugin_Source_PythonScriptPlugin_Public_PythonScriptTypes_h_2460208459(TEXT("/Script/PythonScriptPlugin"),
		nullptr, 0,
