...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::NewProp_CollisionBoxes_Inner = { "CollisionBoxes", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UOceanBoxCollisionComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::NewProp_CollisionBoxes = { "CollisionBoxes", nullptr, (EPropertyFlags)0x0014808000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_OceanGenerator, CollisionBoxes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::NewProp_CollisionBoxes_MetaData), Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::NewProp_CollisionBoxes_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::NewProp_CollisionHullSets = { "CollisionHullSets", nullptr, (EPropertyFlags)0x0014808000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_OceanGenerator, CollisionHullSets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::NewProp_CollisionHullSets_MetaData), Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::NewProp_CollisionHullSets_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::ClassParams = {
		...
		0,
		0x028802A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_OceanGenerator_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyOcean_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyOcean_Statics::NewProp_OceanGenerator = { "OceanGenerator", nullptr, (EPropertyFlags)0x0024080820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyOcean, OceanGenerator_DEPRECATED), Z_Construct_UClass_UDEPRECATED_OceanGenerator_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyOcean_Statics::NewProp_OceanGenerator_MetaData), Z_Construct_UClass_AWaterBodyOcean_Statics::NewProp_OceanGenerator_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWaterBodyOcean_Statics::NewProp_CollisionExtents_MetaData[] = {
		{ "ModuleRelativePath", "Public/WaterBodyOceanActor.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AWaterBodyOcean_Statics::NewProp_CollisionExtents = { "CollisionExtents", nullptr, (EPropertyFlags)0x0020080820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyOcean, CollisionExtents_DEPRECATED), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyOcean_Statics::NewProp_CollisionExtents_MetaData), Z_Construct_UClass_AWaterBodyOcean_Statics::NewProp_CollisionExtents_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AWaterBodyOcean_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyOcean_Statics::Class_MetaDataParams), Z_Construct_UClass_AWaterBodyOcean_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyOcean_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyOceanActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_OceanGenerator, UDEPRECATED_OceanGenerator::StaticClass, TEXT("UDEPRECATED_OceanGenerator"), &Z_Registration_Info_UClass_UDEPRECATED_OceanGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_OceanGenerator), 3632653514U) },
		{ Z_Construct_UClass_AWaterBodyOcean, AWaterBodyOcean::StaticClass, TEXT("AWaterBodyOcean"), &Z_Registration_Info_UClass_AWaterBodyOcean, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWaterBodyOcean), 4269045387U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyOceanActor_h_2098991781(TEXT("/Script/Water"),
