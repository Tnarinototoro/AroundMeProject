...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Water_EWaterBodyType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Water_EWaterBodyType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Water_EWaterBodyType_Statics::Enum_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyTypes_h_Statics::EnumInfo[] = {
		{ EWaterBodyType_StaticEnum, TEXT("EWaterBodyType"), &Z_Registration_Info_UEnum_EWaterBodyType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4143650433U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyTypes_h_637707633(TEXT("/Script/Water"),
		nullptr, 0,
		nullptr, 0,
