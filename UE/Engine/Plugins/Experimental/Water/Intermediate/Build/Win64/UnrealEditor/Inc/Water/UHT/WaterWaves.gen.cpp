...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterWavesBase_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterWavesBase_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWaves_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterWaves_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWaves_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterWaves_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAsset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterWavesAsset_Statics::NewProp_WaterWaves = { "WaterWaves", nullptr, (EPropertyFlags)0x0046000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterWavesAsset, WaterWaves), Z_Construct_UClass_UWaterWaves_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAsset_Statics::NewProp_WaterWaves_MetaData), Z_Construct_UClass_UWaterWavesAsset_Statics::NewProp_WaterWaves_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterWavesAsset_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAsset_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterWavesAsset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAsset_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAssetReference_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterWavesAssetReference_Statics::NewProp_WaterWavesAsset = { "WaterWavesAsset", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterWavesAssetReference, WaterWavesAsset), Z_Construct_UClass_UWaterWavesAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAssetReference_Statics::NewProp_WaterWavesAsset_MetaData), Z_Construct_UClass_UWaterWavesAssetReference_Statics::NewProp_WaterWavesAsset_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterWavesAssetReference_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAssetReference_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterWavesAssetReference_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAssetReference_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterWaves_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterWavesBase, UWaterWavesBase::StaticClass, TEXT("UWaterWavesBase"), &Z_Registration_Info_UClass_UWaterWavesBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterWavesBase), 2997863009U) },
		{ Z_Construct_UClass_UWaterWaves, UWaterWaves::StaticClass, TEXT("UWaterWaves"), &Z_Registration_Info_UClass_UWaterWaves, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterWaves), 182602620U) },
		{ Z_Construct_UClass_UWaterWavesAsset, UWaterWavesAsset::StaticClass, TEXT("UWaterWavesAsset"), &Z_Registration_Info_UClass_UWaterWavesAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterWavesAsset), 411474320U) },
		{ Z_Construct_UClass_UWaterWavesAssetReference, UWaterWavesAssetReference::StaticClass, TEXT("UWaterWavesAssetReference"), &Z_Registration_Info_UClass_UWaterWavesAssetReference, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterWavesAssetReference), 2348859258U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterWaves_h_1268632949(TEXT("/Script/Water"),
