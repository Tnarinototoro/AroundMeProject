...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeMeshComp = { "LakeMeshComp", nullptr, (EPropertyFlags)0x0014800000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_LakeGenerator, LakeMeshComp), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeMeshComp_MetaData), Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeMeshComp_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeCollisionComp = { "LakeCollisionComp", nullptr, (EPropertyFlags)0x0014000020080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_LakeGenerator, LakeCollisionComp_DEPRECATED), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeCollisionComp_MetaData), Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeCollisionComp_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeCollision = { "LakeCollision", nullptr, (EPropertyFlags)0x0014800000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_LakeGenerator, LakeCollision), Z_Construct_UClass_ULakeCollisionComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeCollision_MetaData), Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::NewProp_LakeCollision_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::ClassParams = {
		...
		0,
		0x028802A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_LakeGenerator_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyLake_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyLake_Statics::NewProp_LakeGenerator = { "LakeGenerator", nullptr, (EPropertyFlags)0x0024080820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyLake, LakeGenerator_DEPRECATED), Z_Construct_UClass_UDEPRECATED_LakeGenerator_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyLake_Statics::NewProp_LakeGenerator_MetaData), Z_Construct_UClass_AWaterBodyLake_Statics::NewProp_LakeGenerator_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AWaterBodyLake_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyLake_Statics::Class_MetaDataParams), Z_Construct_UClass_AWaterBodyLake_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyLake_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyLakeActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_LakeGenerator, UDEPRECATED_LakeGenerator::StaticClass, TEXT("UDEPRECATED_LakeGenerator"), &Z_Registration_Info_UClass_UDEPRECATED_LakeGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_LakeGenerator), 1779971217U) },
		{ Z_Construct_UClass_AWaterBodyLake, AWaterBodyLake::StaticClass, TEXT("AWaterBodyLake"), &Z_Registration_Info_UClass_AWaterBodyLake, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWaterBodyLake), 2536429457U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyLakeActor_h_3112872050(TEXT("/Script/Water"),
