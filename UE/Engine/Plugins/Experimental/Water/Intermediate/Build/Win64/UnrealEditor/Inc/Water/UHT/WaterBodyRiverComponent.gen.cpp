...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_SplineMeshComponents_Inner = { "SplineMeshComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_USplineMeshComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_SplineMeshComponents = { "SplineMeshComponents", nullptr, (EPropertyFlags)0x0024888000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyRiverComponent, SplineMeshComponents), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_SplineMeshComponents_MetaData), Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_SplineMeshComponents_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_LakeTransitionMaterial = { "LakeTransitionMaterial", nullptr, (EPropertyFlags)0x0024080000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyRiverComponent, LakeTransitionMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_LakeTransitionMaterial_MetaData), Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_LakeTransitionMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_LakeTransitionMID = { "LakeTransitionMID", nullptr, (EPropertyFlags)0x0024c80000022801, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyRiverComponent, LakeTransitionMID), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_LakeTransitionMID_MetaData), Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_LakeTransitionMID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_OceanTransitionMaterial = { "OceanTransitionMaterial", nullptr, (EPropertyFlags)0x0024080000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyRiverComponent, OceanTransitionMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_OceanTransitionMaterial_MetaData), Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_OceanTransitionMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_OceanTransitionMID = { "OceanTransitionMID", nullptr, (EPropertyFlags)0x0024c80000022801, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyRiverComponent, OceanTransitionMID), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_OceanTransitionMID_MetaData), Z_Construct_UClass_UWaterBodyRiverComponent_Statics::NewProp_OceanTransitionMID_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyRiverComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyRiverComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyRiverComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBodyRiverComponent, UWaterBodyRiverComponent::StaticClass, TEXT("UWaterBodyRiverComponent"), &Z_Registration_Info_UClass_UWaterBodyRiverComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyRiverComponent), 1074850456U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyRiverComponent_h_2101571959(TEXT("/Script/Water"),
