...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bWarnOnMismatchOceanExtent_MetaData[];
#endif
		static void NewProp_bWarnOnMismatchOceanExtent_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bWarnOnMismatchOceanExtent;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_CollisionChannelForWaterTraces = { "CollisionChannelForWaterTraces", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, CollisionChannelForWaterTraces), Z_Construct_UEnum_Engine_ECollisionChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_CollisionChannelForWaterTraces_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_CollisionChannelForWaterTraces_MetaData) }; // 1822723181
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_MaterialParameterCollection = { "MaterialParameterCollection", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, MaterialParameterCollection), Z_Construct_UClass_UMaterialParameterCollection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_MaterialParameterCollection_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_MaterialParameterCollection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyIconWorldZOffset = { "WaterBodyIconWorldZOffset", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, WaterBodyIconWorldZOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyIconWorldZOffset_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyIconWorldZOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_DefaultWaterCollisionProfileName = { "DefaultWaterCollisionProfileName", nullptr, (EPropertyFlags)0x0040000000024001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, DefaultWaterCollisionProfileName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_DefaultWaterCollisionProfileName_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_DefaultWaterCollisionProfileName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyLakeComponentClass = { "WaterBodyLakeComponentClass", nullptr, (EPropertyFlags)0x0044000000004001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, WaterBodyLakeComponentClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UWaterBodyLakeComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyLakeComponentClass_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyLakeComponentClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyOceanComponentClass = { "WaterBodyOceanComponentClass", nullptr, (EPropertyFlags)0x0044000000004001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, WaterBodyOceanComponentClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UWaterBodyOceanComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyOceanComponentClass_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyOceanComponentClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyCustomComponentClass = { "WaterBodyCustomComponentClass", nullptr, (EPropertyFlags)0x0044000000004001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, WaterBodyCustomComponentClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UWaterBodyCustomComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyCustomComponentClass_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyCustomComponentClass_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_bWarnOnMismatchOceanExtent_MetaData[] = {
		{ "Category", "Water" },
		{ "Comment", "/** If enabled, MapCheck will notify users that their ocean does not completely fill the water zone. This can be desirable in some cases but the default should be to fill completely. */" },
		{ "ModuleRelativePath", "Public/WaterRuntimeSettings.h" },
		{ "ToolTip", "If enabled, MapCheck will notify users that their ocean does not completely fill the water zone. This can be desirable in some cases but the default should be to fill completely." },
	};
#endif
	void Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_bWarnOnMismatchOceanExtent_SetBit(void* Obj)
	{
		((UWaterRuntimeSettings*)Obj)->bWarnOnMismatchOceanExtent = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_bWarnOnMismatchOceanExtent = { "bWarnOnMismatchOceanExtent", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UWaterRuntimeSettings), &Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_bWarnOnMismatchOceanExtent_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_bWarnOnMismatchOceanExtent_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_bWarnOnMismatchOceanExtent_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyIconWorldSize = { "WaterBodyIconWorldSize", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterRuntimeSettings, WaterBodyIconWorldSize_DEPRECATED), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyIconWorldSize_MetaData), Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_WaterBodyIconWorldSize_MetaData) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UWaterRuntimeSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWaterRuntimeSettings_Statics::NewProp_bWarnOnMismatchOceanExtent,
#if WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterRuntimeSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterRuntimeSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterRuntimeSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterRuntimeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterRuntimeSettings, UWaterRuntimeSettings::StaticClass, TEXT("UWaterRuntimeSettings"), &Z_Registration_Info_UClass_UWaterRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterRuntimeSettings), 1188765737U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterRuntimeSettings_h_3457600731(TEXT("/Script/Water"),
