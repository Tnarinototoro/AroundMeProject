...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyActorFactory_Statics::ClassParams = {
		...
		0,
		0x000830ADu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyActorFactory_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyRiverActorFactory_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyRiverActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyRiverActorFactory_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyOceanActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyOceanActorFactory_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyOceanActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyOceanActorFactory_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyLakeActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyLakeActorFactory_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyLakeActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyLakeActorFactory_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyCustomActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyCustomActorFactory_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyCustomActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyCustomActorFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBodyActorFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBodyActorFactory, UWaterBodyActorFactory::StaticClass, TEXT("UWaterBodyActorFactory"), &Z_Registration_Info_UClass_UWaterBodyActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyActorFactory), 4181010156U) },
		{ Z_Construct_UClass_UWaterBodyRiverActorFactory, UWaterBodyRiverActorFactory::StaticClass, TEXT("UWaterBodyRiverActorFactory"), &Z_Registration_Info_UClass_UWaterBodyRiverActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyRiverActorFactory), 2561384873U) },
		{ Z_Construct_UClass_UWaterBodyOceanActorFactory, UWaterBodyOceanActorFactory::StaticClass, TEXT("UWaterBodyOceanActorFactory"), &Z_Registration_Info_UClass_UWaterBodyOceanActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyOceanActorFactory), 686707843U) },
		{ Z_Construct_UClass_UWaterBodyLakeActorFactory, UWaterBodyLakeActorFactory::StaticClass, TEXT("UWaterBodyLakeActorFactory"), &Z_Registration_Info_UClass_UWaterBodyLakeActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyLakeActorFactory), 3537600236U) },
		{ Z_Construct_UClass_UWaterBodyCustomActorFactory, UWaterBodyCustomActorFactory::StaticClass, TEXT("UWaterBodyCustomActorFactory"), &Z_Registration_Info_UClass_UWaterBodyCustomActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyCustomActorFactory), 2293611579U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBodyActorFactory_h_1129331688(TEXT("/Script/WaterEditor"),
