...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Water_EWaterBrushFalloffMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Water_EWaterBrushFalloffMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Water_EWaterBrushFalloffMode_Statics::Enum_MetaDataParams)
	};
...
template<> WATER_API UScriptStruct* StaticStruct<FWaterFalloffSettings>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffMode = { "FalloffMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterFalloffSettings, FalloffMode), Z_Construct_UEnum_Water_EWaterBrushFalloffMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffMode_MetaData), Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffMode_MetaData) }; // 1141193104
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffAngle = { "FalloffAngle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterFalloffSettings, FalloffAngle), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffAngle_MetaData), Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffAngle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffWidth = { "FalloffWidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterFalloffSettings, FalloffWidth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffWidth_MetaData), Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_FalloffWidth_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_EdgeOffset = { "EdgeOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterFalloffSettings, EdgeOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_EdgeOffset_MetaData), Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_EdgeOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_ZOffset = { "ZOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterFalloffSettings, ZOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_ZOffset_MetaData), Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewProp_ZOffset_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterFalloffSettings_h_Statics::EnumInfo[] = {
		{ EWaterBrushFalloffMode_StaticEnum, TEXT("EWaterBrushFalloffMode"), &Z_Registration_Info_UEnum_EWaterBrushFalloffMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1141193104U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterFalloffSettings_h_Statics::ScriptStructInfo[] = {
		{ FWaterFalloffSettings::StaticStruct, Z_Construct_UScriptStruct_FWaterFalloffSettings_Statics::NewStructOps, TEXT("WaterFalloffSettings"), &Z_Registration_Info_UScriptStruct_WaterFalloffSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWaterFalloffSettings), 2548941724U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterFalloffSettings_h_3281732869(TEXT("/Script/Water"),
		nullptr, 0,
