...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineMetadataDetailsFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterSplineMetadataDetailsFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineMetadataDetailsFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterSplineMetadataDetailsFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterSplineMetadataDetails_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterSplineMetadataDetailsFactory, UWaterSplineMetadataDetailsFactory::StaticClass, TEXT("UWaterSplineMetadataDetailsFactory"), &Z_Registration_Info_UClass_UWaterSplineMetadataDetailsFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterSplineMetadataDetailsFactory), 129237902U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterSplineMetadataDetails_h_3788891593(TEXT("/Script/WaterEditor"),
