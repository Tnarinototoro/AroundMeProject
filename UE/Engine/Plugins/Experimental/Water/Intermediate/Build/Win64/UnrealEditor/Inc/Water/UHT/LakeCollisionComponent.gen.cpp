...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULakeCollisionComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULakeCollisionComponent_Statics::NewProp_CachedBodySetup = { "CachedBodySetup", nullptr, (EPropertyFlags)0x0044800000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULakeCollisionComponent, CachedBodySetup), Z_Construct_UClass_UBodySetup_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULakeCollisionComponent_Statics::NewProp_CachedBodySetup_MetaData), Z_Construct_UClass_ULakeCollisionComponent_Statics::NewProp_CachedBodySetup_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULakeCollisionComponent_Statics::NewProp_BoxExtent_MetaData[] = {
		{ "ModuleRelativePath", "Public/LakeCollisionComponent.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULakeCollisionComponent_Statics::NewProp_BoxExtent = { "BoxExtent", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULakeCollisionComponent, BoxExtent), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULakeCollisionComponent_Statics::NewProp_BoxExtent_MetaData), Z_Construct_UClass_ULakeCollisionComponent_Statics::NewProp_BoxExtent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULakeCollisionComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULakeCollisionComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_ULakeCollisionComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULakeCollisionComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_LakeCollisionComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULakeCollisionComponent, ULakeCollisionComponent::StaticClass, TEXT("ULakeCollisionComponent"), &Z_Registration_Info_UClass_ULakeCollisionComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULakeCollisionComponent), 3298378646U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_LakeCollisionComponent_h_898407181(TEXT("/Script/Water"),
