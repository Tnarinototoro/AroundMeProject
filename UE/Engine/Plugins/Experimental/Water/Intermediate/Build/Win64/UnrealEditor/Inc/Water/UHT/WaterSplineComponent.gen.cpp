...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWaterSplineComponent_K2_SynchronizeAndBroadcastDataChange_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWaterSplineComponent, nullptr, "K2_SynchronizeAndBroadcastDataChange", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaterSplineComponent_K2_SynchronizeAndBroadcastDataChange_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWaterSplineComponent_K2_SynchronizeAndBroadcastDataChange_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineComponent_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UWaterSplineComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UWaterSplineComponent_K2_SynchronizeAndBroadcastDataChange, "K2_SynchronizeAndBroadcastDataChange" }, // 2914348408
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWaterSplineComponent_Statics::NewProp_WaterSplineDefaults = { "WaterSplineDefaults", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterSplineComponent, WaterSplineDefaults), Z_Construct_UScriptStruct_FWaterSplineCurveDefaults, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineComponent_Statics::NewProp_WaterSplineDefaults_MetaData), Z_Construct_UClass_UWaterSplineComponent_Statics::NewProp_WaterSplineDefaults_MetaData) }; // 1656209141
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWaterSplineComponent_Statics::NewProp_PreviousWaterSplineDefaults = { "PreviousWaterSplineDefaults", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterSplineComponent, PreviousWaterSplineDefaults), Z_Construct_UScriptStruct_FWaterSplineCurveDefaults, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineComponent_Statics::NewProp_PreviousWaterSplineDefaults_MetaData), Z_Construct_UClass_UWaterSplineComponent_Statics::NewProp_PreviousWaterSplineDefaults_MetaData) }; // 1656209141
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterSplineComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterSplineComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterSplineComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterSplineComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterSplineComponent, UWaterSplineComponent::StaticClass, TEXT("UWaterSplineComponent"), &Z_Registration_Info_UClass_UWaterSplineComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterSplineComponent), 3021758894U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterSplineComponent_h_4119724909(TEXT("/Script/Water"),
