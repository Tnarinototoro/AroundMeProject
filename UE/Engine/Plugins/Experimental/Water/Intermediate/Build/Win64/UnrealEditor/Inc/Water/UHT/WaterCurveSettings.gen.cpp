...
template<> WATER_API UScriptStruct* StaticStruct<FWaterCurveSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_bUseCurveChannel = { "bUseCurveChannel", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FWaterCurveSettings), &Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_bUseCurveChannel_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_bUseCurveChannel_MetaData), Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_bUseCurveChannel_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ElevationCurveAsset = { "ElevationCurveAsset", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterCurveSettings, ElevationCurveAsset), Z_Construct_UClass_UCurveFloat_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ElevationCurveAsset_MetaData), Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ElevationCurveAsset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ChannelEdgeOffset = { "ChannelEdgeOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterCurveSettings, ChannelEdgeOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ChannelEdgeOffset_MetaData), Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ChannelEdgeOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ChannelDepth = { "ChannelDepth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterCurveSettings, ChannelDepth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ChannelDepth_MetaData), Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_ChannelDepth_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_CurveRampWidth = { "CurveRampWidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterCurveSettings, CurveRampWidth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_CurveRampWidth_MetaData), Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewProp_CurveRampWidth_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterCurveSettings_h_Statics::ScriptStructInfo[] = {
		{ FWaterCurveSettings::StaticStruct, Z_Construct_UScriptStruct_FWaterCurveSettings_Statics::NewStructOps, TEXT("WaterCurveSettings"), &Z_Registration_Info_UScriptStruct_WaterCurveSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWaterCurveSettings), 3638184228U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterCurveSettings_h_1757244022(TEXT("/Script/Water"),
		nullptr, 0,
