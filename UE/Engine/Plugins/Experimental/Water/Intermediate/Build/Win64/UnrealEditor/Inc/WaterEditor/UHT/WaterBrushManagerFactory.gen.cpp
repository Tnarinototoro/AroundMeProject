...
#include "../Private/WaterBrushManagerFactory.h"
...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBrushManagerFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBrushManagerFactory_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBrushManagerFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBrushManagerFactory_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushManagerFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushManagerFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBrushManagerFactory, UWaterBrushManagerFactory::StaticClass, TEXT("UWaterBrushManagerFactory"), &Z_Registration_Info_UClass_UWaterBrushManagerFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBrushManagerFactory), 229291044U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushManagerFactory_h_2172317509(TEXT("/Script/WaterEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushManagerFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushManagerFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
