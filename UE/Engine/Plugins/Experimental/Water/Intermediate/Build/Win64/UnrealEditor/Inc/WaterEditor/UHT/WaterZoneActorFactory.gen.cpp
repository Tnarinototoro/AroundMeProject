...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterZoneActorFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterZoneActorFactory_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterZoneActorFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterZoneActorFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterZoneActorFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterZoneActorFactory, UWaterZoneActorFactory::StaticClass, TEXT("UWaterZoneActorFactory"), &Z_Registration_Info_UClass_UWaterZoneActorFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterZoneActorFactory), 1660659565U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterZoneActorFactory_h_1152058142(TEXT("/Script/WaterEditor"),
