...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGerstnerWaterWaveSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGerstnerWaterWaveSubsystem_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGerstnerWaterWaveSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UGerstnerWaterWaveSubsystem_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_GerstnerWaterWaveSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGerstnerWaterWaveSubsystem, UGerstnerWaterWaveSubsystem::StaticClass, TEXT("UGerstnerWaterWaveSubsystem"), &Z_Registration_Info_UClass_UGerstnerWaterWaveSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGerstnerWaterWaveSubsystem), 4042976316U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_GerstnerWaterWaveSubsystem_h_2113020664(TEXT("/Script/Water"),
