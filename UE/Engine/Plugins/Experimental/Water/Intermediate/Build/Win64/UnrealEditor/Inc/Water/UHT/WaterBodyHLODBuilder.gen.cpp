...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyHLODBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyHLODBuilder_Statics::ClassParams = {
		...
		0,
		0x040000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyHLODBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyHLODBuilder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyHLODBuilder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBodyHLODBuilder, UWaterBodyHLODBuilder::StaticClass, TEXT("UWaterBodyHLODBuilder"), &Z_Registration_Info_UClass_UWaterBodyHLODBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyHLODBuilder), 1643585213U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyHLODBuilder_h_2921488346(TEXT("/Script/Water"),
