...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterEditorSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_LandscapeMaterialParameterCollection = { "LandscapeMaterialParameterCollection", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterEditorSubsystem, LandscapeMaterialParameterCollection), Z_Construct_UClass_UMaterialParameterCollection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_LandscapeMaterialParameterCollection_MetaData), Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_LandscapeMaterialParameterCollection_MetaData) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_WaterActorSprites = { "WaterActorSprites", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterEditorSubsystem, WaterActorSprites), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_WaterActorSprites_MetaData), Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_WaterActorSprites_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_DefaultWaterActorSprite = { "DefaultWaterActorSprite", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterEditorSubsystem, DefaultWaterActorSprite), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_DefaultWaterActorSprite_MetaData), Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_DefaultWaterActorSprite_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_ErrorSprite_MetaData[] = {
		{ "ModuleRelativePath", "Public/WaterEditorSubsystem.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_ErrorSprite = { "ErrorSprite", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterEditorSubsystem, ErrorSprite), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_ErrorSprite_MetaData), Z_Construct_UClass_UWaterEditorSubsystem_Statics::NewProp_ErrorSprite_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterEditorSubsystem_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterEditorSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterEditorSubsystem_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterEditorSubsystem_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Public_WaterEditorSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterEditorSubsystem, UWaterEditorSubsystem::StaticClass, TEXT("UWaterEditorSubsystem"), &Z_Registration_Info_UClass_UWaterEditorSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterEditorSubsystem), 1637215283U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Public_WaterEditorSubsystem_h_2291545940(TEXT("/Script/WaterEditor"),
