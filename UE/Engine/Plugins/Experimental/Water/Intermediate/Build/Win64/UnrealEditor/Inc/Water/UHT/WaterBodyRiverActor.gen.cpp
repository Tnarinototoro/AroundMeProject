...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::NewProp_SplineMeshComponents_Inner = { "SplineMeshComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_USplineMeshComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::NewProp_SplineMeshComponents = { "SplineMeshComponents", nullptr, (EPropertyFlags)0x0014808000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_RiverGenerator, SplineMeshComponents), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::NewProp_SplineMeshComponents_MetaData), Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::NewProp_SplineMeshComponents_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::ClassParams = {
		...
		0,
		0x028802A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_RiverGenerator_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_RiverGenerator = { "RiverGenerator", nullptr, (EPropertyFlags)0x0024080820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyRiver, RiverGenerator_DEPRECATED), Z_Construct_UClass_UDEPRECATED_RiverGenerator_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_RiverGenerator_MetaData), Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_RiverGenerator_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_LakeTransitionMaterial = { "LakeTransitionMaterial", nullptr, (EPropertyFlags)0x0024080820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyRiver, LakeTransitionMaterial_DEPRECATED), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_LakeTransitionMaterial_MetaData), Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_LakeTransitionMaterial_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_LakeTransitionMID_MetaData[] = {
		{ "ModuleRelativePath", "Public/WaterBodyRiverActor.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_LakeTransitionMID = { "LakeTransitionMID", nullptr, (EPropertyFlags)0x0024080820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyRiver, LakeTransitionMID_DEPRECATED), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_LakeTransitionMID_MetaData), Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_LakeTransitionMID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_OceanTransitionMaterial = { "OceanTransitionMaterial", nullptr, (EPropertyFlags)0x0024080820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyRiver, OceanTransitionMaterial_DEPRECATED), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_OceanTransitionMaterial_MetaData), Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_OceanTransitionMaterial_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_OceanTransitionMID = { "OceanTransitionMID", nullptr, (EPropertyFlags)0x0024080820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyRiver, OceanTransitionMID_DEPRECATED), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_OceanTransitionMID_MetaData), Z_Construct_UClass_AWaterBodyRiver_Statics::NewProp_OceanTransitionMID_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AWaterBodyRiver_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::Class_MetaDataParams), Z_Construct_UClass_AWaterBodyRiver_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyRiver_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyRiverActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_RiverGenerator, UDEPRECATED_RiverGenerator::StaticClass, TEXT("UDEPRECATED_RiverGenerator"), &Z_Registration_Info_UClass_UDEPRECATED_RiverGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_RiverGenerator), 3897362024U) },
		{ Z_Construct_UClass_AWaterBodyRiver, AWaterBodyRiver::StaticClass, TEXT("AWaterBodyRiver"), &Z_Registration_Info_UClass_AWaterBodyRiver, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWaterBodyRiver), 3609954167U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyRiverActor_h_1444068276(TEXT("/Script/Water"),
