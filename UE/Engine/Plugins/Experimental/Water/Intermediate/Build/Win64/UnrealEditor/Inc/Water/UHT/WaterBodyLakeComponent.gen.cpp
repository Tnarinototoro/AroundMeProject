...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyLakeComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyLakeComponent_Statics::NewProp_LakeMeshComp = { "LakeMeshComp", nullptr, (EPropertyFlags)0x0024880000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyLakeComponent, LakeMeshComp), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyLakeComponent_Statics::NewProp_LakeMeshComp_MetaData), Z_Construct_UClass_UWaterBodyLakeComponent_Statics::NewProp_LakeMeshComp_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyLakeComponent_Statics::NewProp_LakeCollision = { "LakeCollision", nullptr, (EPropertyFlags)0x0024880000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyLakeComponent, LakeCollision), Z_Construct_UClass_ULakeCollisionComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyLakeComponent_Statics::NewProp_LakeCollision_MetaData), Z_Construct_UClass_UWaterBodyLakeComponent_Statics::NewProp_LakeCollision_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyLakeComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyLakeComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyLakeComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyLakeComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyLakeComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBodyLakeComponent, UWaterBodyLakeComponent::StaticClass, TEXT("UWaterBodyLakeComponent"), &Z_Registration_Info_UClass_UWaterBodyLakeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyLakeComponent), 1775547977U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyLakeComponent_h_1638185342(TEXT("/Script/Water"),
