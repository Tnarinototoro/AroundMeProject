...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyCustomComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWaterBodyCustomComponent_Statics::NewProp_MeshComp = { "MeshComp", nullptr, (EPropertyFlags)0x0024880000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyCustomComponent, MeshComp), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyCustomComponent_Statics::NewProp_MeshComp_MetaData), Z_Construct_UClass_UWaterBodyCustomComponent_Statics::NewProp_MeshComp_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyCustomComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyCustomComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyCustomComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyCustomComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyCustomComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBodyCustomComponent, UWaterBodyCustomComponent::StaticClass, TEXT("UWaterBodyCustomComponent"), &Z_Registration_Info_UClass_UWaterBodyCustomComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyCustomComponent), 2700059737U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyCustomComponent_h_2205638423(TEXT("/Script/Water"),
