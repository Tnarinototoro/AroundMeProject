...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAssetFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterWavesAssetFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterWavesAssetFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterWavesAssetFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterWavesAssetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterWavesAssetFactory, UWaterWavesAssetFactory::StaticClass, TEXT("UWaterWavesAssetFactory"), &Z_Registration_Info_UClass_UWaterWavesAssetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterWavesAssetFactory), 3773665892U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterWavesAssetFactory_h_1793120436(TEXT("/Script/WaterEditor"),
