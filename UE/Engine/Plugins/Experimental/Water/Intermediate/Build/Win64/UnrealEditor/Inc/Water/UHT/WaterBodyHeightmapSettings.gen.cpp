...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Water_EWaterBrushBlendType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_Water_EWaterBrushBlendType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_Water_EWaterBrushBlendType_Statics::Enum_MetaDataParams)
	};
...
template<> WATER_API UScriptStruct* StaticStruct<FWaterBodyHeightmapSettings>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_BlendMode = { "BlendMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterBodyHeightmapSettings, BlendMode), Z_Construct_UEnum_Water_EWaterBrushBlendType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_BlendMode_MetaData), Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_BlendMode_MetaData) }; // 4041681382
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_bInvertShape = { "bInvertShape", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FWaterBodyHeightmapSettings), &Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_bInvertShape_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_bInvertShape_MetaData), Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_bInvertShape_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_FalloffSettings = { "FalloffSettings", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterBodyHeightmapSettings, FalloffSettings), Z_Construct_UScriptStruct_FWaterFalloffSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_FalloffSettings_MetaData), Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_FalloffSettings_MetaData) }; // 2548941724
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_Effects = { "Effects", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterBodyHeightmapSettings, Effects), Z_Construct_UScriptStruct_FWaterBrushEffects, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_Effects_MetaData), Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_Effects_MetaData) }; // 3461369156
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_Priority = { "Priority", nullptr, (EPropertyFlags)0x0010000020000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterBodyHeightmapSettings, Priority_DEPRECATED), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_Priority_MetaData), Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::NewProp_Priority_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyHeightmapSettings_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyHeightmapSettings_h_Statics::EnumInfo[] = {
		{ EWaterBrushBlendType_StaticEnum, TEXT("EWaterBrushBlendType"), &Z_Registration_Info_UEnum_EWaterBrushBlendType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4041681382U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyHeightmapSettings_h_696839818(TEXT("/Script/Water"),
		nullptr, 0,
