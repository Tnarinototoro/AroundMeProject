...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::NewProp_MeshComp = { "MeshComp", nullptr, (EPropertyFlags)0x0014800000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_CustomMeshGenerator, MeshComp), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::NewProp_MeshComp_MetaData), Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::NewProp_MeshComp_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::ClassParams = {
		...
		0,
		0x028802A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyCustom_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AWaterBodyCustom_Statics::NewProp_CustomGenerator = { "CustomGenerator", nullptr, (EPropertyFlags)0x0024880820000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AWaterBodyCustom, CustomGenerator_DEPRECATED), Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyCustom_Statics::NewProp_CustomGenerator_MetaData), Z_Construct_UClass_AWaterBodyCustom_Statics::NewProp_CustomGenerator_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AWaterBodyCustom_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyCustom_Statics::Class_MetaDataParams), Z_Construct_UClass_AWaterBodyCustom_Statics::Class_MetaDataParams)
	};
#if WITH_EDITORONLY_DATA
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AWaterBodyCustom_Statics::PropPointers) < 2048);
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyCustomActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_CustomMeshGenerator, UDEPRECATED_CustomMeshGenerator::StaticClass, TEXT("UDEPRECATED_CustomMeshGenerator"), &Z_Registration_Info_UClass_UDEPRECATED_CustomMeshGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_CustomMeshGenerator), 2425461454U) },
		{ Z_Construct_UClass_AWaterBodyCustom, AWaterBodyCustom::StaticClass, TEXT("AWaterBodyCustom"), &Z_Registration_Info_UClass_AWaterBodyCustom, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWaterBodyCustom), 3437010175U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBodyCustomActor_h_715475794(TEXT("/Script/Water"),
