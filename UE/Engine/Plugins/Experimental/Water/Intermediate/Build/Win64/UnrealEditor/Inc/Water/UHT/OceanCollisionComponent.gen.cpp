...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOceanCollisionComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOceanCollisionComponent_Statics::NewProp_CachedBodySetup = { "CachedBodySetup", nullptr, (EPropertyFlags)0x0044800000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOceanCollisionComponent, CachedBodySetup), Z_Construct_UClass_UBodySetup_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOceanCollisionComponent_Statics::NewProp_CachedBodySetup_MetaData), Z_Construct_UClass_UOceanCollisionComponent_Statics::NewProp_CachedBodySetup_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOceanCollisionComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOceanCollisionComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UOceanCollisionComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOceanCollisionComponent_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOceanBoxCollisionComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOceanBoxCollisionComponent_Statics::ClassParams = {
		...
		0,
		0x00B010A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOceanBoxCollisionComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UOceanBoxCollisionComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_OceanCollisionComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOceanCollisionComponent, UOceanCollisionComponent::StaticClass, TEXT("UOceanCollisionComponent"), &Z_Registration_Info_UClass_UOceanCollisionComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOceanCollisionComponent), 1233522095U) },
		{ Z_Construct_UClass_UOceanBoxCollisionComponent, UOceanBoxCollisionComponent::StaticClass, TEXT("UOceanBoxCollisionComponent"), &Z_Registration_Info_UClass_UOceanBoxCollisionComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOceanBoxCollisionComponent), 2206295174U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_OceanCollisionComponent_h_2237367445(TEXT("/Script/Water"),
