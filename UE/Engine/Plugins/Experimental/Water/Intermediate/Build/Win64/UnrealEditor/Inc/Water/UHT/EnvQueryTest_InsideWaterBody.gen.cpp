...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIncludeWaves = { "bIncludeWaves", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UEnvQueryTest_InsideWaterBody), &Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIncludeWaves_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIncludeWaves_MetaData), Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIncludeWaves_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bSimpleWaves = { "bSimpleWaves", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UEnvQueryTest_InsideWaterBody), &Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bSimpleWaves_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bSimpleWaves_MetaData), Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bSimpleWaves_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIgnoreExclusionVolumes = { "bIgnoreExclusionVolumes", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UEnvQueryTest_InsideWaterBody), &Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIgnoreExclusionVolumes_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIgnoreExclusionVolumes_MetaData), Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::NewProp_bIgnoreExclusionVolumes_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::ClassParams = {
		...
		0,
		0x008000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::Class_MetaDataParams), Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_InsideWaterBody_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_EnvQueryTest_InsideWaterBody_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryTest_InsideWaterBody, UEnvQueryTest_InsideWaterBody::StaticClass, TEXT("UEnvQueryTest_InsideWaterBody"), &Z_Registration_Info_UClass_UEnvQueryTest_InsideWaterBody, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryTest_InsideWaterBody), 1467875896U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_EnvQueryTest_InsideWaterBody_h_2792054001(TEXT("/Script/Water"),
