...
template<> WATEREDITOR_API UScriptStruct* StaticStruct<FWaterBodyBrushCache>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewProp_CacheRenderTarget = { "CacheRenderTarget", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWaterBodyBrushCache, CacheRenderTarget), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewProp_CacheRenderTarget_MetaData), Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewProp_CacheRenderTarget_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewProp_CacheIsValid = { "CacheIsValid", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FWaterBodyBrushCache), &Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewProp_CacheIsValid_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewProp_CacheIsValid_MetaData), Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewProp_CacheIsValid_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::NewProp_Cache = { "Cache", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaterBodyBrushCacheContainer, Cache), Z_Construct_UScriptStruct_FWaterBodyBrushCache, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::NewProp_Cache_MetaData), Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::NewProp_Cache_MetaData) }; // 1518705178
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBodyBrushCacheContainer_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushCacheContainer_h_Statics::ScriptStructInfo[] = {
		{ FWaterBodyBrushCache::StaticStruct, Z_Construct_UScriptStruct_FWaterBodyBrushCache_Statics::NewStructOps, TEXT("WaterBodyBrushCache"), &Z_Registration_Info_UScriptStruct_WaterBodyBrushCache, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWaterBodyBrushCache), 1518705178U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushCacheContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBodyBrushCacheContainer, UWaterBodyBrushCacheContainer::StaticClass, TEXT("UWaterBodyBrushCacheContainer"), &Z_Registration_Info_UClass_UWaterBodyBrushCacheContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBodyBrushCacheContainer), 728934271U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Editor_Private_WaterBrushCacheContainer_h_1952735356(TEXT("/Script/WaterEditor"),
