...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBrushActorInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWaterBrushActorInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWaterBrushActorInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UWaterBrushActorInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBrushActorInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaterBrushActorInterface, UWaterBrushActorInterface::StaticClass, TEXT("UWaterBrushActorInterface"), &Z_Registration_Info_UClass_UWaterBrushActorInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaterBrushActorInterface), 3662177025U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Water_Source_Runtime_Public_WaterBrushActorInterface_h_3519730620(TEXT("/Script/Water"),
