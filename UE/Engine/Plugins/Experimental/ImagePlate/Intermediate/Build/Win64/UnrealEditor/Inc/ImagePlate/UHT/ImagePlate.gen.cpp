...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AImagePlate_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AImagePlate_Statics::NewProp_ImagePlate = { "ImagePlate", nullptr, (EPropertyFlags)0x00240800000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AImagePlate, ImagePlate), Z_Construct_UClass_UImagePlateComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AImagePlate_Statics::NewProp_ImagePlate_MetaData), Z_Construct_UClass_AImagePlate_Statics::NewProp_ImagePlate_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AImagePlate_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AImagePlate_Statics::Class_MetaDataParams), Z_Construct_UClass_AImagePlate_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AImagePlate_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ImagePlate_Source_ImagePlate_Public_ImagePlate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AImagePlate, AImagePlate::StaticClass, TEXT("AImagePlate"), &Z_Registration_Info_UClass_AImagePlate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AImagePlate), 711156805U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ImagePlate_Source_ImagePlate_Public_ImagePlate_h_3619220256(TEXT("/Script/ImagePlate"),
