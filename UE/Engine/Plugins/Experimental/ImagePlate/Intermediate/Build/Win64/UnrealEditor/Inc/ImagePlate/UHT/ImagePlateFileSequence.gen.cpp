...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UImagePlateSettings_Statics::NewProp_ProxyName = { "ProxyName", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UImagePlateSettings, ProxyName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateSettings_Statics::NewProp_ProxyName_MetaData), Z_Construct_UClass_UImagePlateSettings_Statics::NewProp_ProxyName_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UImagePlateSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UImagePlateSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateSettings_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFileSequence_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_SequencePath = { "SequencePath", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UImagePlateFileSequence, SequencePath), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_SequencePath_MetaData), Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_SequencePath_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_FileWildcard = { "FileWildcard", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UImagePlateFileSequence, FileWildcard), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_FileWildcard_MetaData), Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_FileWildcard_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_Framerate = { "Framerate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UImagePlateFileSequence, Framerate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_Framerate_MetaData), Z_Construct_UClass_UImagePlateFileSequence_Statics::NewProp_Framerate_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UImagePlateFileSequence_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFileSequence_Statics::Class_MetaDataParams), Z_Construct_UClass_UImagePlateFileSequence_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFileSequence_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ImagePlate_Source_ImagePlate_Public_ImagePlateFileSequence_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UImagePlateSettings, UImagePlateSettings::StaticClass, TEXT("UImagePlateSettings"), &Z_Registration_Info_UClass_UImagePlateSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImagePlateSettings), 697816806U) },
		{ Z_Construct_UClass_UImagePlateFileSequence, UImagePlateFileSequence::StaticClass, TEXT("UImagePlateFileSequence"), &Z_Registration_Info_UClass_UImagePlateFileSequence, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImagePlateFileSequence), 1078733364U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ImagePlate_Source_ImagePlate_Public_ImagePlateFileSequence_h_89745669(TEXT("/Script/ImagePlate"),
