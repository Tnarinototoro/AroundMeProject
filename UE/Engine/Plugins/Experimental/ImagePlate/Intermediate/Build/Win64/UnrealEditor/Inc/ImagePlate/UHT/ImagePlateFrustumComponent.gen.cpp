...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFrustumComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UImagePlateFrustumComponent_Statics::ClassParams = {
		...
		0,
		0x00A810A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UImagePlateFrustumComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UImagePlateFrustumComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ImagePlate_Source_ImagePlate_Private_ImagePlateFrustumComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UImagePlateFrustumComponent, UImagePlateFrustumComponent::StaticClass, TEXT("UImagePlateFrustumComponent"), &Z_Registration_Info_UClass_UImagePlateFrustumComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImagePlateFrustumComponent), 1427031839U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ImagePlate_Source_ImagePlate_Private_ImagePlateFrustumComponent_h_2416923556(TEXT("/Script/ImagePlate"),
