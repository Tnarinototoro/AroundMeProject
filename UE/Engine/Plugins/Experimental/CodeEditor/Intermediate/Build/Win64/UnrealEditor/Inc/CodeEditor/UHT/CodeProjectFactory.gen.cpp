...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCodeProjectFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCodeProjectFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCodeProjectFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UCodeProjectFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CodeEditor_Source_CodeEditor_Private_CodeProjectFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCodeProjectFactory, UCodeProjectFactory::StaticClass, TEXT("UCodeProjectFactory"), &Z_Registration_Info_UClass_UCodeProjectFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCodeProjectFactory), 1644225593U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CodeEditor_Source_CodeEditor_Private_CodeProjectFactory_h_4238601306(TEXT("/Script/CodeEditor"),
