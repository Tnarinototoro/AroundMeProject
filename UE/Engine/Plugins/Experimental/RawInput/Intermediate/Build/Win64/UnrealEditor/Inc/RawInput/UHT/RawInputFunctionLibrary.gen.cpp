...
template<> RAWINPUT_API UScriptStruct* StaticStruct<FRegisteredDeviceInfo>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_Handle = { "Handle", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRegisteredDeviceInfo, Handle), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_Handle_MetaData), Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_Handle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_VendorID = { "VendorID", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRegisteredDeviceInfo, VendorID), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_VendorID_MetaData), Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_VendorID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_ProductID = { "ProductID", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRegisteredDeviceInfo, ProductID), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_ProductID_MetaData), Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_ProductID_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_DeviceName = { "DeviceName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FRegisteredDeviceInfo, DeviceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_DeviceName_MetaData), Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewProp_DeviceName_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FRegisteredDeviceInfo, METADATA_PARAMS(0, nullptr) }; // 1291046533
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RawInputFunctionLibrary_eventGetRegisteredDevices_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 1291046533
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URawInputFunctionLibrary, nullptr, "GetRegisteredDevices", nullptr, nullptr, Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::PropPointers), sizeof(Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::RawInputFunctionLibrary_eventGetRegisteredDevices_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::Function_MetaDataParams), Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices_Statics::RawInputFunctionLibrary_eventGetRegisteredDevices_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URawInputFunctionLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_URawInputFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URawInputFunctionLibrary_GetRegisteredDevices, "GetRegisteredDevices" }, // 2093764458
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URawInputFunctionLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URawInputFunctionLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URawInputFunctionLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_URawInputFunctionLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_RawInput_Source_RawInput_Public_RawInputFunctionLibrary_h_Statics::ScriptStructInfo[] = {
		{ FRegisteredDeviceInfo::StaticStruct, Z_Construct_UScriptStruct_FRegisteredDeviceInfo_Statics::NewStructOps, TEXT("RegisteredDeviceInfo"), &Z_Registration_Info_UScriptStruct_RegisteredDeviceInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRegisteredDeviceInfo), 1291046533U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_RawInput_Source_RawInput_Public_RawInputFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URawInputFunctionLibrary, URawInputFunctionLibrary::StaticClass, TEXT("URawInputFunctionLibrary"), &Z_Registration_Info_UClass_URawInputFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URawInputFunctionLibrary), 1324620196U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_RawInput_Source_RawInput_Public_RawInputFunctionLibrary_h_2874764371(TEXT("/Script/RawInput"),
