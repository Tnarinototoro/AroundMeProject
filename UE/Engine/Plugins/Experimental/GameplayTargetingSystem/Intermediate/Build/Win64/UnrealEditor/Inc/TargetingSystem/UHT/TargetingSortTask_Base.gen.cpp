...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetingSortTask_Base_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTargetingSortTask_Base_Statics::NewProp_bAscending = { "bAscending", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UTargetingSortTask_Base), &Z_Construct_UClass_UTargetingSortTask_Base_Statics::NewProp_bAscending_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetingSortTask_Base_Statics::NewProp_bAscending_MetaData), Z_Construct_UClass_UTargetingSortTask_Base_Statics::NewProp_bAscending_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTargetingSortTask_Base_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetingSortTask_Base_Statics::Class_MetaDataParams), Z_Construct_UClass_UTargetingSortTask_Base_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetingSortTask_Base_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameplayTargetingSystem_Source_GameplayTargetingSystem_Tasks_TargetingSortTask_Base_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTargetingSortTask_Base, UTargetingSortTask_Base::StaticClass, TEXT("UTargetingSortTask_Base"), &Z_Registration_Info_UClass_UTargetingSortTask_Base, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTargetingSortTask_Base), 2874896735U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameplayTargetingSystem_Source_GameplayTargetingSystem_Tasks_TargetingSortTask_Base_h_3270165811(TEXT("/Script/TargetingSystem"),
