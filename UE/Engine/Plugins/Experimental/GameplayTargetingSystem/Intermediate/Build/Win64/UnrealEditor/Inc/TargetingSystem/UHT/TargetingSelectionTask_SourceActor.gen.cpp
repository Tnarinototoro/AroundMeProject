...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetingSelectionTask_SourceActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTargetingSelectionTask_SourceActor_Statics::ClassParams = {
		...
		0,
		0x000010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTargetingSelectionTask_SourceActor_Statics::Class_MetaDataParams), Z_Construct_UClass_UTargetingSelectionTask_SourceActor_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameplayTargetingSystem_Source_GameplayTargetingSystem_Tasks_TargetingSelectionTask_SourceActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTargetingSelectionTask_SourceActor, UTargetingSelectionTask_SourceActor::StaticClass, TEXT("UTargetingSelectionTask_SourceActor"), &Z_Registration_Info_UClass_UTargetingSelectionTask_SourceActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTargetingSelectionTask_SourceActor), 1912691151U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GameplayTargetingSystem_Source_GameplayTargetingSystem_Tasks_TargetingSelectionTask_SourceActor_h_1319599153(TEXT("/Script/TargetingSystem"),
