...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetEditorToolPaletteMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWidgetEditorToolPaletteMode_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetEditorToolPaletteMode_Statics::Class_MetaDataParams), Z_Construct_UClass_UWidgetEditorToolPaletteMode_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WidgetEditorToolPalette_Source_WidgetEditorToolPalette_Public_WidgetEditorToolPaletteMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWidgetEditorToolPaletteMode, UWidgetEditorToolPaletteMode::StaticClass, TEXT("UWidgetEditorToolPaletteMode"), &Z_Registration_Info_UClass_UWidgetEditorToolPaletteMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWidgetEditorToolPaletteMode), 1357548368U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WidgetEditorToolPalette_Source_WidgetEditorToolPalette_Public_WidgetEditorToolPaletteMode_h_1478024997(TEXT("/Script/WidgetEditorToolPalette"),
