...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URectangleSelectToolBuilder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_URectangleSelectToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectProperties_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URectangleSelectProperties_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectProperties_Statics::Class_MetaDataParams), Z_Construct_UClass_URectangleSelectProperties_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URectangleSelectTool_Statics::NewProp_Properties = { "Properties", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URectangleSelectTool, Properties), Z_Construct_UClass_URectangleSelectProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectTool_Statics::NewProp_Properties_MetaData), Z_Construct_UClass_URectangleSelectTool_Statics::NewProp_Properties_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_URectangleSelectTool_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_URectangleSelectTool_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UWidgetBaseBehavior_NoRegister, (int32)VTABLE_OFFSET(URectangleSelectTool, IWidgetBaseBehavior), false },  // 3583206012
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectTool_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_URectangleSelectTool_Statics::ClassParams = {
		...
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectTool_Statics::Class_MetaDataParams), Z_Construct_UClass_URectangleSelectTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_URectangleSelectTool_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WidgetEditorToolPalette_Source_WidgetEditorToolPalette_Public_DefaultTools_RectangleSelectTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URectangleSelectToolBuilder, URectangleSelectToolBuilder::StaticClass, TEXT("URectangleSelectToolBuilder"), &Z_Registration_Info_UClass_URectangleSelectToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URectangleSelectToolBuilder), 2050346605U) },
		{ Z_Construct_UClass_URectangleSelectProperties, URectangleSelectProperties::StaticClass, TEXT("URectangleSelectProperties"), &Z_Registration_Info_UClass_URectangleSelectProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URectangleSelectProperties), 2024798820U) },
		{ Z_Construct_UClass_URectangleSelectTool, URectangleSelectTool::StaticClass, TEXT("URectangleSelectTool"), &Z_Registration_Info_UClass_URectangleSelectTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URectangleSelectTool), 526800516U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WidgetEditorToolPalette_Source_WidgetEditorToolPalette_Public_DefaultTools_RectangleSelectTool_h_455439832(TEXT("/Script/WidgetEditorToolPalette"),
