...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCreateWidgetToolBuilder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UCreateWidgetToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetToolProperties_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCreateWidgetToolProperties_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetToolProperties_Statics::Class_MetaDataParams), Z_Construct_UClass_UCreateWidgetToolProperties_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCreateWidgetTool_Statics::NewProp_Properties = { "Properties", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCreateWidgetTool, Properties), Z_Construct_UClass_UCreateWidgetToolProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetTool_Statics::NewProp_Properties_MetaData), Z_Construct_UClass_UCreateWidgetTool_Statics::NewProp_Properties_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCreateWidgetTool_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UCreateWidgetTool_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UWidgetBaseBehavior_NoRegister, (int32)VTABLE_OFFSET(UCreateWidgetTool, IWidgetBaseBehavior), false },  // 3583206012
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetTool_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCreateWidgetTool_Statics::ClassParams = {
		...
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UCreateWidgetTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateWidgetTool_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WidgetEditorToolPalette_Source_WidgetEditorToolPalette_Public_DefaultTools_CreateWidgetTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCreateWidgetToolBuilder, UCreateWidgetToolBuilder::StaticClass, TEXT("UCreateWidgetToolBuilder"), &Z_Registration_Info_UClass_UCreateWidgetToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCreateWidgetToolBuilder), 3489585085U) },
		{ Z_Construct_UClass_UCreateWidgetToolProperties, UCreateWidgetToolProperties::StaticClass, TEXT("UCreateWidgetToolProperties"), &Z_Registration_Info_UClass_UCreateWidgetToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCreateWidgetToolProperties), 2584305810U) },
		{ Z_Construct_UClass_UCreateWidgetTool, UCreateWidgetTool::StaticClass, TEXT("UCreateWidgetTool"), &Z_Registration_Info_UClass_UCreateWidgetTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCreateWidgetTool), 3244526324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WidgetEditorToolPalette_Source_WidgetEditorToolPalette_Public_DefaultTools_CreateWidgetTool_h_3781220257(TEXT("/Script/WidgetEditorToolPalette"),
