...
template<> PHYSICSCONTROL_API UScriptStruct* StaticStruct<FPhysicsControlLimbSetupData>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_LimbName = { "LimbName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPhysicsControlLimbSetupData, LimbName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_LimbName_MetaData), Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_LimbName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_StartBone = { "StartBone", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPhysicsControlLimbSetupData, StartBone), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_StartBone_MetaData), Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_StartBone_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_bIncludeParentBone = { "bIncludeParentBone", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FPhysicsControlLimbSetupData), &Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_bIncludeParentBone_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_bIncludeParentBone_MetaData), Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewProp_bIncludeParentBone_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::PropPointers) < 2048);
...
template<> PHYSICSCONTROL_API UScriptStruct* StaticStruct<FPhysicsControlLimbBones>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPhysicsControlLimbBones_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlLimbBones_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPhysicsControlLimbBones_Statics::Struct_MetaDataParams)
	};
...
template<> PHYSICSCONTROL_API UScriptStruct* StaticStruct<FPhysicsControlNames>()
{
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::NewProp_Names_Inner = { "Names", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::NewProp_Names = { "Names", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPhysicsControlNames, Names), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::NewProp_Names_MetaData), Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::NewProp_Names_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PhysicsControl_Source_PhysicsControl_Public_PhysicsControlLimbData_h_Statics::ScriptStructInfo[] = {
		{ FPhysicsControlLimbSetupData::StaticStruct, Z_Construct_UScriptStruct_FPhysicsControlLimbSetupData_Statics::NewStructOps, TEXT("PhysicsControlLimbSetupData"), &Z_Registration_Info_UScriptStruct_PhysicsControlLimbSetupData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPhysicsControlLimbSetupData), 4202931730U) },
		{ FPhysicsControlLimbBones::StaticStruct, Z_Construct_UScriptStruct_FPhysicsControlLimbBones_Statics::NewStructOps, TEXT("PhysicsControlLimbBones"), &Z_Registration_Info_UScriptStruct_PhysicsControlLimbBones, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPhysicsControlLimbBones), 3324000130U) },
		{ FPhysicsControlNames::StaticStruct, Z_Construct_UScriptStruct_FPhysicsControlNames_Statics::NewStructOps, TEXT("PhysicsControlNames"), &Z_Registration_Info_UScriptStruct_PhysicsControlNames, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPhysicsControlNames), 4255958970U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PhysicsControl_Source_PhysicsControl_Public_PhysicsControlLimbData_h_2863728991(TEXT("/Script/PhysicsControl"),
		nullptr, 0,
