...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UShotgridSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UShotgridSettings_Statics::NewProp_MetaDataTagsForAssetRegistry_ElementProp = { "MetaDataTagsForAssetRegistry", nullptr, (EPropertyFlags)0x0000000000004001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UShotgridSettings_Statics::NewProp_MetaDataTagsForAssetRegistry = { "MetaDataTagsForAssetRegistry", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UShotgridSettings, MetaDataTagsForAssetRegistry), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UShotgridSettings_Statics::NewProp_MetaDataTagsForAssetRegistry_MetaData), Z_Construct_UClass_UShotgridSettings_Statics::NewProp_MetaDataTagsForAssetRegistry_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UShotgridSettings_Statics::ClassParams = {
		...
		0,
		0x000000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UShotgridSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UShotgridSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UShotgridSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Shotgrid_Source_Shotgrid_Private_ShotgridSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UShotgridSettings, UShotgridSettings::StaticClass, TEXT("UShotgridSettings"), &Z_Registration_Info_UClass_UShotgridSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UShotgridSettings), 170499409U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Shotgrid_Source_Shotgrid_Private_ShotgridSettings_h_3879184757(TEXT("/Script/Shotgrid"),
