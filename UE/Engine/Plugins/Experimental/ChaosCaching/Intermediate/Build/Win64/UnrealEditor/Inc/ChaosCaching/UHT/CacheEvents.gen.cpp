...
template<> CHAOSCACHING_API UScriptStruct* StaticStruct<FCacheEventTrack>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCacheEventTrack, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_Struct = { "Struct", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCacheEventTrack, Struct), Z_Construct_UClass_UScriptStruct, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_Struct_MetaData), Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_Struct_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_TimeStamps = { "TimeStamps", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCacheEventTrack, TimeStamps), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_TimeStamps_MetaData), Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewProp_TimeStamps_MetaData) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCaching_Public_Chaos_CacheEvents_h_Statics::ScriptStructInfo[] = {
		{ FCacheEventBase::StaticStruct, Z_Construct_UScriptStruct_FCacheEventBase_Statics::NewStructOps, TEXT("CacheEventBase"), &Z_Registration_Info_UScriptStruct_CacheEventBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCacheEventBase), 2383131553U) },
		{ FCacheEventTrack::StaticStruct, Z_Construct_UScriptStruct_FCacheEventTrack_Statics::NewStructOps, TEXT("CacheEventTrack"), &Z_Registration_Info_UScriptStruct_CacheEventTrack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCacheEventTrack), 926729808U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCaching_Public_Chaos_CacheEvents_h_3229434767(TEXT("/Script/ChaosCaching"),
		nullptr, 0,
