...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTakeRecorderChaosCacheSource_Statics::NewProp_TrackRecorder = { "TrackRecorder", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTakeRecorderChaosCacheSource, TrackRecorder), Z_Construct_UClass_UMovieSceneChaosCacheTrackRecorder_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTakeRecorderChaosCacheSource_Statics::NewProp_TrackRecorder_MetaData), Z_Construct_UClass_UTakeRecorderChaosCacheSource_Statics::NewProp_TrackRecorder_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCachingEditor_Public_Sequencer_TakeRecorderChaosCacheSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTakeRecorderChaosCacheSource, UTakeRecorderChaosCacheSource::StaticClass, TEXT("UTakeRecorderChaosCacheSource"), &Z_Registration_Info_UClass_UTakeRecorderChaosCacheSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTakeRecorderChaosCacheSource), 3887612221U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCachingEditor_Public_Sequencer_TakeRecorderChaosCacheSource_h_1045011413(TEXT("/Script/ChaosCachingEditor"),
