...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBUICommand_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUTBUICommand_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBUICommand_Statics::Class_MetaDataParams), Z_Construct_UClass_UUTBUICommand_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxCore_Source_UserToolBoxCore_Public_UTBBaseUICommandInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUTBUICommand, UUTBUICommand::StaticClass, TEXT("UUTBUICommand"), &Z_Registration_Info_UClass_UUTBUICommand, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUTBUICommand), 335846295U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxCore_Source_UserToolBoxCore_Public_UTBBaseUICommandInterface_h_1073321373(TEXT("/Script/UserToolBoxCore"),
