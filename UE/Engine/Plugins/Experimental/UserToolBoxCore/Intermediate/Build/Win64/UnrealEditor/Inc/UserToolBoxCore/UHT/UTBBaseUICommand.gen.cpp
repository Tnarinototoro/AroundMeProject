...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCommandNativeUI_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBaseCommandNativeUI_Statics::NewProp_MyCommand = { "MyCommand", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBaseCommandNativeUI, MyCommand), Z_Construct_UClass_UUTBBaseCommand_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCommandNativeUI_Statics::NewProp_MyCommand_MetaData), Z_Construct_UClass_UBaseCommandNativeUI_Statics::NewProp_MyCommand_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBaseCommandNativeUI_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UBaseCommandNativeUI_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UUTBUICommand_NoRegister, (int32)VTABLE_OFFSET(UBaseCommandNativeUI, IUTBUICommand), false },  // 335846295
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCommandNativeUI_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBaseCommandNativeUI_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCommandNativeUI_Statics::Class_MetaDataParams), Z_Construct_UClass_UBaseCommandNativeUI_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCommandNativeUI_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::NewProp_ObjectClass = { "ObjectClass", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTBCommandUMGUI_eventDoesSupportClass_Parms, ObjectClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUTBBaseCommand_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTBCommandUMGUI_eventDoesSupportClass_Parms), &Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUTBCommandUMGUI, nullptr, "DoesSupportClass", nullptr, nullptr, Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::PropPointers), sizeof(UTBCommandUMGUI_eventDoesSupportClass_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass_Statics::PropPointers) < 2048);
	static_assert(sizeof(UTBCommandUMGUI_eventDoesSupportClass_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUTBCommandUMGUI_ExecuteCommand_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUTBCommandUMGUI, nullptr, "ExecuteCommand", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUTBCommandUMGUI_ExecuteCommand_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUTBCommandUMGUI_ExecuteCommand_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBCommandUMGUI_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UUTBCommandUMGUI_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUTBCommandUMGUI_DoesSupportClass, "DoesSupportClass" }, // 3443611993
		{ &Z_Construct_UFunction_UUTBCommandUMGUI_ExecuteCommand, "ExecuteCommand" }, // 2497452935
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBCommandUMGUI_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUTBCommandUMGUI_Statics::NewProp_Command = { "Command", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUTBCommandUMGUI, Command), Z_Construct_UClass_UUTBBaseCommand_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBCommandUMGUI_Statics::NewProp_Command_MetaData), Z_Construct_UClass_UUTBCommandUMGUI_Statics::NewProp_Command_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUTBCommandUMGUI_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UUTBCommandUMGUI_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UUTBUICommand_NoRegister, (int32)VTABLE_OFFSET(UUTBCommandUMGUI, IUTBUICommand), false },  // 335846295
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBCommandUMGUI_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUTBCommandUMGUI_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(InterfaceParams),
		0x00B010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBCommandUMGUI_Statics::Class_MetaDataParams), Z_Construct_UClass_UUTBCommandUMGUI_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBCommandUMGUI_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxCore_Source_UserToolBoxCore_Public_UTBBaseUICommand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBaseCommandNativeUI, UBaseCommandNativeUI::StaticClass, TEXT("UBaseCommandNativeUI"), &Z_Registration_Info_UClass_UBaseCommandNativeUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseCommandNativeUI), 1112897375U) },
		{ Z_Construct_UClass_UUTBCommandUMGUI, UUTBCommandUMGUI::StaticClass, TEXT("UUTBCommandUMGUI"), &Z_Registration_Info_UClass_UUTBCommandUMGUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUTBCommandUMGUI), 3253090899U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxCore_Source_UserToolBoxCore_Public_UTBBaseUICommand_h_2969987521(TEXT("/Script/UserToolBoxCore"),
