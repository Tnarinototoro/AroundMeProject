...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBDefaultUITemplate_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUTBDefaultUITemplate_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBDefaultUITemplate_Statics::Class_MetaDataParams), Z_Construct_UClass_UUTBDefaultUITemplate_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBToolBarTabUI_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUTBToolBarTabUI_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBToolBarTabUI_Statics::Class_MetaDataParams), Z_Construct_UClass_UUTBToolBarTabUI_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBPaletteTabUI_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUTBPaletteTabUI_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBPaletteTabUI_Statics::Class_MetaDataParams), Z_Construct_UClass_UUTBPaletteTabUI_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBVerticalToolBarTabUI_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUTBVerticalToolBarTabUI_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBVerticalToolBarTabUI_Statics::Class_MetaDataParams), Z_Construct_UClass_UUTBVerticalToolBarTabUI_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBSlimHorizontalToolBarTabUI_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUTBSlimHorizontalToolBarTabUI_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUTBSlimHorizontalToolBarTabUI_Statics::Class_MetaDataParams), Z_Construct_UClass_UUTBSlimHorizontalToolBarTabUI_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxCore_Source_UserToolBoxCore_Public_UTBBaseUITab_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUTBDefaultUITemplate, UUTBDefaultUITemplate::StaticClass, TEXT("UUTBDefaultUITemplate"), &Z_Registration_Info_UClass_UUTBDefaultUITemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUTBDefaultUITemplate), 663519259U) },
		{ Z_Construct_UClass_UUTBToolBarTabUI, UUTBToolBarTabUI::StaticClass, TEXT("UUTBToolBarTabUI"), &Z_Registration_Info_UClass_UUTBToolBarTabUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUTBToolBarTabUI), 3295689386U) },
		{ Z_Construct_UClass_UUTBPaletteTabUI, UUTBPaletteTabUI::StaticClass, TEXT("UUTBPaletteTabUI"), &Z_Registration_Info_UClass_UUTBPaletteTabUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUTBPaletteTabUI), 3052328665U) },
		{ Z_Construct_UClass_UUTBVerticalToolBarTabUI, UUTBVerticalToolBarTabUI::StaticClass, TEXT("UUTBVerticalToolBarTabUI"), &Z_Registration_Info_UClass_UUTBVerticalToolBarTabUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUTBVerticalToolBarTabUI), 2221848157U) },
		{ Z_Construct_UClass_UUTBSlimHorizontalToolBarTabUI, UUTBSlimHorizontalToolBarTabUI::StaticClass, TEXT("UUTBSlimHorizontalToolBarTabUI"), &Z_Registration_Info_UClass_UUTBSlimHorizontalToolBarTabUI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUTBSlimHorizontalToolBarTabUI), 775445352U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxCore_Source_UserToolBoxCore_Public_UTBBaseUITab_h_3359662804(TEXT("/Script/UserToolBoxCore"),
