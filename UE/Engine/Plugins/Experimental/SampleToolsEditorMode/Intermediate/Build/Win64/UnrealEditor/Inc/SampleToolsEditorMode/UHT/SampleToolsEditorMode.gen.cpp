...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USampleToolsEditorMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USampleToolsEditorMode_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USampleToolsEditorMode_Statics::Class_MetaDataParams), Z_Construct_UClass_USampleToolsEditorMode_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_SampleToolsEditorMode_Source_Public_SampleToolsEditorMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USampleToolsEditorMode, USampleToolsEditorMode::StaticClass, TEXT("USampleToolsEditorMode"), &Z_Registration_Info_UClass_USampleToolsEditorMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USampleToolsEditorMode), 3777488304U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_SampleToolsEditorMode_Source_Public_SampleToolsEditorMode_h_944920471(TEXT("/Script/SampleToolsEditorMode"),
