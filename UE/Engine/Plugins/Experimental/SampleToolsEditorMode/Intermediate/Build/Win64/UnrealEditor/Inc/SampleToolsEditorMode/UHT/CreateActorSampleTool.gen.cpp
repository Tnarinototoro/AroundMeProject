...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCreateActorSampleToolBuilder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UCreateActorSampleToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::NewProp_GroundHeight = { "GroundHeight", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCreateActorSampleToolProperties, GroundHeight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::NewProp_GroundHeight_MetaData), Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::NewProp_GroundHeight_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::Class_MetaDataParams), Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleToolProperties_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCreateActorSampleTool_Statics::NewProp_Properties = { "Properties", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCreateActorSampleTool, Properties), Z_Construct_UClass_UCreateActorSampleToolProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleTool_Statics::NewProp_Properties_MetaData), Z_Construct_UClass_UCreateActorSampleTool_Statics::NewProp_Properties_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCreateActorSampleTool_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UCreateActorSampleTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCreateActorSampleTool_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_SampleToolsEditorMode_Source_Private_SampleTools_CreateActorSampleTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCreateActorSampleToolBuilder, UCreateActorSampleToolBuilder::StaticClass, TEXT("UCreateActorSampleToolBuilder"), &Z_Registration_Info_UClass_UCreateActorSampleToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCreateActorSampleToolBuilder), 1060515681U) },
		{ Z_Construct_UClass_UCreateActorSampleToolProperties, UCreateActorSampleToolProperties::StaticClass, TEXT("UCreateActorSampleToolProperties"), &Z_Registration_Info_UClass_UCreateActorSampleToolProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCreateActorSampleToolProperties), 2100998053U) },
		{ Z_Construct_UClass_UCreateActorSampleTool, UCreateActorSampleTool::StaticClass, TEXT("UCreateActorSampleTool"), &Z_Registration_Info_UClass_UCreateActorSampleTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCreateActorSampleTool), 3583514749U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_SampleToolsEditorMode_Source_Private_SampleTools_CreateActorSampleTool_h_2260557474(TEXT("/Script/SampleToolsEditorMode"),
