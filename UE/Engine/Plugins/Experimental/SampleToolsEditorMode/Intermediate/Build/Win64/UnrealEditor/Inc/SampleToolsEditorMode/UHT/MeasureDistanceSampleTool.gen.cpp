...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceSampleToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMeasureDistanceSampleToolBuilder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceSampleToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UMeasureDistanceSampleToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceProperties_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_StartPoint = { "StartPoint", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeasureDistanceProperties, StartPoint), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_StartPoint_MetaData), Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_StartPoint_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_EndPoint = { "EndPoint", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeasureDistanceProperties, EndPoint), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_EndPoint_MetaData), Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_EndPoint_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_Distance = { "Distance", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeasureDistanceProperties, Distance), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_Distance_MetaData), Z_Construct_UClass_UMeasureDistanceProperties_Statics::NewProp_Distance_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMeasureDistanceProperties_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceProperties_Statics::Class_MetaDataParams), Z_Construct_UClass_UMeasureDistanceProperties_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceProperties_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::NewProp_Properties = { "Properties", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMeasureDistanceSampleTool, Properties), Z_Construct_UClass_UMeasureDistanceProperties_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::NewProp_Properties_MetaData), Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::NewProp_Properties_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeasureDistanceSampleTool_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_SampleToolsEditorMode_Source_Private_SampleTools_MeasureDistanceSampleTool_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UMeasureDistanceProperties, UMeasureDistanceProperties::StaticClass, TEXT("UMeasureDistanceProperties"), &Z_Registration_Info_UClass_UMeasureDistanceProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeasureDistanceProperties), 1705457217U) },
		{ Z_Construct_UClass_UMeasureDistanceSampleTool, UMeasureDistanceSampleTool::StaticClass, TEXT("UMeasureDistanceSampleTool"), &Z_Registration_Info_UClass_UMeasureDistanceSampleTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeasureDistanceSampleTool), 737079846U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_SampleToolsEditorMode_Source_Private_SampleTools_MeasureDistanceSampleTool_h_3869896986(TEXT("/Script/SampleToolsEditorMode"),
