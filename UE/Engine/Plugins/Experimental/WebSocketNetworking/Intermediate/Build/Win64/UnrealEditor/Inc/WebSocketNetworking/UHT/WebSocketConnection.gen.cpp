...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketConnection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebSocketConnection_Statics::ClassParams = {
		...
		0,
		0x001000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketConnection_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebSocketConnection_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WebSocketNetworking_Source_WebSocketNetworking_Public_WebSocketConnection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebSocketConnection, UWebSocketConnection::StaticClass, TEXT("UWebSocketConnection"), &Z_Registration_Info_UClass_UWebSocketConnection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebSocketConnection), 3101406307U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WebSocketNetworking_Source_WebSocketNetworking_Public_WebSocketConnection_h_1245009033(TEXT("/Script/WebSocketNetworking"),
