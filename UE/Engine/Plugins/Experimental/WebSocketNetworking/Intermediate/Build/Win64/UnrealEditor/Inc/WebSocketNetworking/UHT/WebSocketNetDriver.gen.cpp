...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketNetDriver_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UWebSocketNetDriver_Statics::NewProp_WebSocketPort = { "WebSocketPort", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWebSocketNetDriver, WebSocketPort), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketNetDriver_Statics::NewProp_WebSocketPort_MetaData), Z_Construct_UClass_UWebSocketNetDriver_Statics::NewProp_WebSocketPort_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebSocketNetDriver_Statics::ClassParams = {
		...
		0,
		0x001000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketNetDriver_Statics::Class_MetaDataParams), Z_Construct_UClass_UWebSocketNetDriver_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UWebSocketNetDriver_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WebSocketNetworking_Source_WebSocketNetworking_Public_WebSocketNetDriver_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWebSocketNetDriver, UWebSocketNetDriver::StaticClass, TEXT("UWebSocketNetDriver"), &Z_Registration_Info_UClass_UWebSocketNetDriver, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWebSocketNetDriver), 2818526277U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_WebSocketNetworking_Source_WebSocketNetworking_Public_WebSocketNetDriver_h_3551721166(TEXT("/Script/WebSocketNetworking"),
