...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VPSettings_eventGetVPSettings_Parms, ReturnValue), Z_Construct_UClass_UVPSettings_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVPSettings, nullptr, "GetVPSettings", nullptr, nullptr, Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::VPSettings_eventGetVPSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVPSettings_GetVPSettings_Statics::VPSettings_eventGetVPSettings_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVPSettings_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVPSettings_GetVPSettings, "GetVPSettings" }, // 780820320
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_FocalLengthPresets_Inner = { "FocalLengthPresets", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_FocalLengthPresets = { "FocalLengthPresets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPSettings, FocalLengthPresets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::NewProp_FocalLengthPresets_MetaData), Z_Construct_UClass_UVPSettings_Statics::NewProp_FocalLengthPresets_MetaData) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_AperturePresets_Inner = { "AperturePresets", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_AperturePresets = { "AperturePresets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPSettings, AperturePresets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::NewProp_AperturePresets_MetaData), Z_Construct_UClass_UVPSettings_Statics::NewProp_AperturePresets_MetaData) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultShutterSpeedPresets_Inner = { "DefaultShutterSpeedPresets", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultShutterSpeedPresets = { "DefaultShutterSpeedPresets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPSettings, DefaultShutterSpeedPresets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultShutterSpeedPresets_MetaData), Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultShutterSpeedPresets_MetaData) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultISOPresets_Inner = { "DefaultISOPresets", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultISOPresets = { "DefaultISOPresets", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPSettings, DefaultISOPresets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultISOPresets_MetaData), Z_Construct_UClass_UVPSettings_Statics::NewProp_DefaultISOPresets_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVPSettings_Statics::NewProp_DirectorName_MetaData[] = {
		{ "Category", "Virtual Production" },
		{ "Comment", "/** Default Name for Director*/" },
		{ "DisplayName", "Director Name" },
		{ "ModuleRelativePath", "Public/VPSettings.h" },
		{ "ToolTip", "Default Name for Director" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_DirectorName = { "DirectorName", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPSettings, DirectorName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::NewProp_DirectorName_MetaData), Z_Construct_UClass_UVPSettings_Statics::NewProp_DirectorName_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVPSettings_Statics::NewProp_ShowName_MetaData[] = {
		{ "Category", "Virtual Production" },
		{ "Comment", "/** Default Name for Project*/" },
		{ "DisplayName", "Project Name" },
		{ "ModuleRelativePath", "Public/VPSettings.h" },
		{ "ToolTip", "Default Name for Project" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_ShowName = { "ShowName", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPSettings, ShowName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::NewProp_ShowName_MetaData), Z_Construct_UClass_UVPSettings_Statics::NewProp_ShowName_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVPSettings_Statics::NewProp_Roles = { "Roles", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPSettings, Roles), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::NewProp_Roles_MetaData), Z_Construct_UClass_UVPSettings_Statics::NewProp_Roles_MetaData) }; // 405371792
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProduction_VPSettings_Source_Public_VPSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPSettings, UVPSettings::StaticClass, TEXT("UVPSettings"), &Z_Registration_Info_UClass_UVPSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPSettings), 1222794264U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProduction_VPSettings_Source_Public_VPSettings_h_1027013109(TEXT("/Script/VPSettings"),
