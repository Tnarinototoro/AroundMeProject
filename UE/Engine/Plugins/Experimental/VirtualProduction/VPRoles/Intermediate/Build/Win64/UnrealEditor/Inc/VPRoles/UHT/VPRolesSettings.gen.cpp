...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPRolesUserSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_Roles = { "Roles", nullptr, (EPropertyFlags)0x0040000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPRolesUserSettings, Roles), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_Roles_MetaData), Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_Roles_MetaData) }; // 405371792
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_RoleSources = { "RoleSources", nullptr, (EPropertyFlags)0x0040000000004000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPRolesUserSettings, RoleSources), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_RoleSources_MetaData), Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_RoleSources_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_CachedRoles_Inner = { "CachedRoles", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_CachedRoles = { "CachedRoles", nullptr, (EPropertyFlags)0x0040000000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVPRolesUserSettings, CachedRoles), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_CachedRoles_MetaData), Z_Construct_UClass_UVPRolesUserSettings_Statics::NewProp_CachedRoles_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVPRolesUserSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVPRolesUserSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UVPRolesUserSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVPRolesUserSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProduction_VPRoles_Source_VPRoles_Private_VPRolesSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVPRolesUserSettings, UVPRolesUserSettings::StaticClass, TEXT("UVPRolesUserSettings"), &Z_Registration_Info_UClass_UVPRolesUserSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVPRolesUserSettings), 3020912196U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualProduction_VPRoles_Source_VPRoles_Private_VPRolesSettings_h_3559382397(TEXT("/Script/VPRoles"),
