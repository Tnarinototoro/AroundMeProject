...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UClothAssetBackedTarget_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UClothAssetBackedTarget_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UClothAssetBackedTarget_Statics::Class_MetaDataParams), Z_Construct_UClass_UClothAssetBackedTarget_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAssetEditor_Source_ChaosClothAssetEditorTools_Public_ChaosClothAsset_ClothAssetBackedTarget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UClothAssetBackedTarget, UClothAssetBackedTarget::StaticClass, TEXT("UClothAssetBackedTarget"), &Z_Registration_Info_UClass_UClothAssetBackedTarget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClothAssetBackedTarget), 879987240U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAssetEditor_Source_ChaosClothAssetEditorTools_Public_ChaosClothAsset_ClothAssetBackedTarget_h_3882776391(TEXT("/Script/ChaosClothAssetEditorTools"),
