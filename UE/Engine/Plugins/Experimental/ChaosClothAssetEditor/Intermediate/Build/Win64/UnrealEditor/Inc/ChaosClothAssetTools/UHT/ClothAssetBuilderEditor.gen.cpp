...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UClothAssetBuilderEditor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UClothAssetBuilderEditor_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UClothAssetBuilderEditor_Statics::Class_MetaDataParams), Z_Construct_UClass_UClothAssetBuilderEditor_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAssetEditor_Source_ChaosClothAssetTools_Private_ChaosClothAsset_ClothAssetBuilderEditor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UClothAssetBuilderEditor, UClothAssetBuilderEditor::StaticClass, TEXT("UClothAssetBuilderEditor"), &Z_Registration_Info_UClass_UClothAssetBuilderEditor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClothAssetBuilderEditor), 1715706487U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAssetEditor_Source_ChaosClothAssetTools_Private_ChaosClothAsset_ClothAssetBuilderEditor_h_3236528303(TEXT("/Script/ChaosClothAssetTools"),
