...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_ClothAsset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_ClothAsset_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_ClothAsset_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_ClothAsset_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAssetEditor_Source_ChaosClothAssetEditor_Private_ChaosClothAsset_AssetDefinition_ClothAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_ClothAsset, UAssetDefinition_ClothAsset::StaticClass, TEXT("UAssetDefinition_ClothAsset"), &Z_Registration_Info_UClass_UAssetDefinition_ClothAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_ClothAsset), 1183458288U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosClothAssetEditor_Source_ChaosClothAssetEditor_Private_ChaosClothAsset_AssetDefinition_ClothAsset_h_2958707732(TEXT("/Script/ChaosClothAssetEditor"),
