...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleVideoCodec_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleVideoCodec_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleVideoCodec_Statics::Enum_MetaDataParams)
	};
...
template<> AVCODECSCORERHI_API UScriptStruct* StaticStruct<FSimpleVideoPacket>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSimpleVideoPacket_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimpleVideoPacket_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSimpleVideoPacket_Statics::Struct_MetaDataParams)
	};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::NewProp_RenderTarget = { "RenderTarget", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SimpleVideoHelper_eventShareRenderTarget2D_Parms, RenderTarget), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USimpleVideoHelper, nullptr, "ShareRenderTarget2D", nullptr, nullptr, Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::PropPointers), sizeof(Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::SimpleVideoHelper_eventShareRenderTarget2D_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::Function_MetaDataParams), Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D_Statics::SimpleVideoHelper_eventShareRenderTarget2D_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleVideoHelper_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_USimpleVideoHelper_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USimpleVideoHelper_ShareRenderTarget2D, "ShareRenderTarget2D" }, // 3408642827
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleVideoHelper_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimpleVideoHelper_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleVideoHelper_Statics::Class_MetaDataParams), Z_Construct_UClass_USimpleVideoHelper_Statics::Class_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Video_SimpleVideo_h_Statics::EnumInfo[] = {
		{ ESimpleVideoCodec_StaticEnum, TEXT("ESimpleVideoCodec"), &Z_Registration_Info_UEnum_ESimpleVideoCodec, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3191740686U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Video_SimpleVideo_h_Statics::ScriptStructInfo[] = {
		{ FSimpleVideoPacket::StaticStruct, Z_Construct_UScriptStruct_FSimpleVideoPacket_Statics::NewStructOps, TEXT("SimpleVideoPacket"), &Z_Registration_Info_UScriptStruct_SimpleVideoPacket, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSimpleVideoPacket), 4049164615U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Video_SimpleVideo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleVideoHelper, USimpleVideoHelper::StaticClass, TEXT("USimpleVideoHelper"), &Z_Registration_Info_UClass_USimpleVideoHelper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleVideoHelper), 1467680263U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Video_SimpleVideo_h_1648183471(TEXT("/Script/AVCodecsCoreRHI"),
