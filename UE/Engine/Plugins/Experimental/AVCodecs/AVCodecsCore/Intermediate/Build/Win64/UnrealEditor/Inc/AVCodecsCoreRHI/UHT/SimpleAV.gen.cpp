...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleAVPreset_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleAVPreset_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleAVPreset_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleAVHelper_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimpleAVHelper_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleAVHelper_Statics::Class_MetaDataParams), Z_Construct_UClass_USimpleAVHelper_Statics::Class_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_SimpleAV_h_Statics::EnumInfo[] = {
		{ ESimpleAVPreset_StaticEnum, TEXT("ESimpleAVPreset"), &Z_Registration_Info_UEnum_ESimpleAVPreset, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 318723530U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_SimpleAV_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleAVHelper, USimpleAVHelper::StaticClass, TEXT("USimpleAVHelper"), &Z_Registration_Info_UClass_USimpleAVHelper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleAVHelper), 601670613U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_SimpleAV_h_2538940(TEXT("/Script/AVCodecsCoreRHI"),
