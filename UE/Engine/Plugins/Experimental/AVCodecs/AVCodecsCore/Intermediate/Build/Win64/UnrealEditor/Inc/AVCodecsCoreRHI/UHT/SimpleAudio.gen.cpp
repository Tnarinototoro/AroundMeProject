...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleAudioCodec_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleAudioCodec_Statics::Enum_MetaDataParams), Z_Construct_UEnum_AVCodecsCoreRHI_ESimpleAudioCodec_Statics::Enum_MetaDataParams)
	};
...
template<> AVCODECSCORERHI_API UScriptStruct* StaticStruct<FSimpleAudioPacket>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSimpleAudioPacket_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimpleAudioPacket_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSimpleAudioPacket_Statics::Struct_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleAudioHelper_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USimpleAudioHelper_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USimpleAudioHelper_Statics::Class_MetaDataParams), Z_Construct_UClass_USimpleAudioHelper_Statics::Class_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Audio_SimpleAudio_h_Statics::EnumInfo[] = {
		{ ESimpleAudioCodec_StaticEnum, TEXT("ESimpleAudioCodec"), &Z_Registration_Info_UEnum_ESimpleAudioCodec, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4250164924U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Audio_SimpleAudio_h_Statics::ScriptStructInfo[] = {
		{ FSimpleAudioPacket::StaticStruct, Z_Construct_UScriptStruct_FSimpleAudioPacket_Statics::NewStructOps, TEXT("SimpleAudioPacket"), &Z_Registration_Info_UScriptStruct_SimpleAudioPacket, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSimpleAudioPacket), 3039780847U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Audio_SimpleAudio_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleAudioHelper, USimpleAudioHelper::StaticClass, TEXT("USimpleAudioHelper"), &Z_Registration_Info_UClass_USimpleAudioHelper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleAudioHelper), 3047742490U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AVCodecs_AVCodecsCore_Source_AVCodecsCoreRHI_Public_Audio_SimpleAudio_h_1880550577(TEXT("/Script/AVCodecsCoreRHI"),
