...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorScriptableSingleClickTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEditorScriptableSingleClickTool_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorScriptableSingleClickTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UEditorScriptableSingleClickTool_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScriptableToolsFramework_Source_EditorScriptableToolsFramework_Public_BaseTools_EditorScriptableSingleClickTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEditorScriptableSingleClickTool, UEditorScriptableSingleClickTool::StaticClass, TEXT("UEditorScriptableSingleClickTool"), &Z_Registration_Info_UClass_UEditorScriptableSingleClickTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEditorScriptableSingleClickTool), 3992370209U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScriptableToolsFramework_Source_EditorScriptableToolsFramework_Public_BaseTools_EditorScriptableSingleClickTool_h_586317315(TEXT("/Script/EditorScriptableToolsFramework"),
