...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorScriptableClickDragTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEditorScriptableClickDragTool_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorScriptableClickDragTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UEditorScriptableClickDragTool_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScriptableToolsFramework_Source_EditorScriptableToolsFramework_Public_BaseTools_EditorScriptableClickDragTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEditorScriptableClickDragTool, UEditorScriptableClickDragTool::StaticClass, TEXT("UEditorScriptableClickDragTool"), &Z_Registration_Info_UClass_UEditorScriptableClickDragTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEditorScriptableClickDragTool), 188063900U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScriptableToolsFramework_Source_EditorScriptableToolsFramework_Public_BaseTools_EditorScriptableClickDragTool_h_1304652250(TEXT("/Script/EditorScriptableToolsFramework"),
