...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseScriptableToolBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBaseScriptableToolBuilder_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseScriptableToolBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UBaseScriptableToolBuilder_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScriptableToolsFramework_Source_ScriptableToolsFramework_Public_ScriptableToolBuilder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBaseScriptableToolBuilder, UBaseScriptableToolBuilder::StaticClass, TEXT("UBaseScriptableToolBuilder"), &Z_Registration_Info_UClass_UBaseScriptableToolBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseScriptableToolBuilder), 650396209U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScriptableToolsFramework_Source_ScriptableToolsFramework_Public_ScriptableToolBuilder_h_2505617469(TEXT("/Script/ScriptableToolsFramework"),
