...
template<> STRUCTUTILS_API UScriptStruct* StaticStruct<FInstancedStruct>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtils_Public_InstancedStruct_h_Statics::ScriptStructInfo[] = {
		{ FInstancedStruct::StaticStruct, Z_Construct_UScriptStruct_FInstancedStruct_Statics::NewStructOps, TEXT("InstancedStruct"), &Z_Registration_Info_UScriptStruct_InstancedStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInstancedStruct), 2114042832U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtils_Public_InstancedStruct_h_3557184759(TEXT("/Script/StructUtils"),
		nullptr, 0,
