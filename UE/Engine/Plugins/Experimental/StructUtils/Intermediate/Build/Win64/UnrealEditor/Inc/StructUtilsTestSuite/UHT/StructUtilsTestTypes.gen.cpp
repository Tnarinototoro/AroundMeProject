...
// Cross Module References
	...
	STRUCTUTILSTESTSUITE_API UScriptStruct* Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault();
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimpleBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimpleBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimpleBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimpleBase_Statics::Struct_MetaDataParams)
	};
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple_Statics::PropPointers) < 2048);
...
static_assert(std::is_polymorphic<FTestStructSimpleNonZeroDefault>() == std::is_polymorphic<FTestStructSimpleBase>(), "USTRUCT FTestStructSimpleNonZeroDefault cannot be polymorphic unless super FTestStructSimpleBase is polymorphic");

	static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault;
class UScriptStruct* FTestStructSimpleNonZeroDefault::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault, (UObject*)Z_Construct_UPackage__Script_StructUtilsTestSuite(), TEXT("TestStructSimpleNonZeroDefault"));
	}
	return Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault.OuterSingleton;
}
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimpleNonZeroDefault>()
{
	return FTestStructSimpleNonZeroDefault::StaticStruct();
}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/StructUtilsTestTypes.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FTestStructSimpleNonZeroDefault>();
	}
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::NewProp_Float_MetaData[] = {
		{ "ModuleRelativePath", "Public/StructUtilsTestTypes.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimpleNonZeroDefault, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::NewProp_Float_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::NewProp_Float,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_StructUtilsTestSuite,
		Z_Construct_UScriptStruct_FTestStructSimpleBase,
		&NewStructOps,
		"TestStructSimpleNonZeroDefault",
		Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::PropPointers),
		sizeof(FTestStructSimpleNonZeroDefault),
		alignof(FTestStructSimpleNonZeroDefault),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::PropPointers) < 2048);
	UScriptStruct* Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault()
	{
		if (!Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault.InnerSingleton)
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault.InnerSingleton, Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::ReturnStructParams);
		}
		return Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault.InnerSingleton;
	}
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructComplex>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewProp_String = { "String", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructComplex, String), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewProp_String_MetaData), Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewProp_String_MetaData) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewProp_StringArray_Inner = { "StringArray", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewProp_StringArray = { "StringArray", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructComplex, StringArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewProp_StringArray_MetaData), Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewProp_StringArray_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructComplex_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructComplex_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructComplex_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructComplex_Statics::PropPointers) < 2048);
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple1>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple1_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple1, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple1_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple1_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple1_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple1_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple1_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple1_Statics::PropPointers) < 2048);
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple2>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple2_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple2, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple2_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple2_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple2_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple2_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple2_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple2_Statics::PropPointers) < 2048);
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple3>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple3_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple3, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple3_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple3_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple3_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple3_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple3_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple3_Statics::PropPointers) < 2048);
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple4>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple4_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple4, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple4_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple4_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple4_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple4_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple4_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple4_Statics::PropPointers) < 2048);
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple5>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple5_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple5, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple5_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple5_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple5_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple5_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple5_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple5_Statics::PropPointers) < 2048);
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple6>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple6_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple6, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple6_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple6_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple6_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple6_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple6_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple6_Statics::PropPointers) < 2048);
...
template<> STRUCTUTILSTESTSUITE_API UScriptStruct* StaticStruct<FTestStructSimple7>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTestStructSimple7_Statics::NewProp_Float = { "Float", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTestStructSimple7, Float), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple7_Statics::NewProp_Float_MetaData), Z_Construct_UScriptStruct_FTestStructSimple7_Statics::NewProp_Float_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTestStructSimple7_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple7_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTestStructSimple7_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTestStructSimple7_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBagTestObject1_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBagTestObject1_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBagTestObject1_Statics::Class_MetaDataParams), Z_Construct_UClass_UBagTestObject1_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBagTestObject2_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBagTestObject2_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBagTestObject2_Statics::Class_MetaDataParams), Z_Construct_UClass_UBagTestObject2_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBagTestObject1Derived_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBagTestObject1Derived_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBagTestObject1Derived_Statics::Class_MetaDataParams), Z_Construct_UClass_UBagTestObject1Derived_Statics::Class_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_StructUtilsTestSuite_EPropertyBagTest1_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_StructUtilsTestSuite_EPropertyBagTest1_Statics::Enum_MetaDataParams), Z_Construct_UEnum_StructUtilsTestSuite_EPropertyBagTest1_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_StructUtilsTestSuite_EPropertyBagTest2_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_StructUtilsTestSuite_EPropertyBagTest2_Statics::Enum_MetaDataParams), Z_Construct_UEnum_StructUtilsTestSuite_EPropertyBagTest2_Statics::Enum_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::NewProp_Bag = { "Bag", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTestObjectWithPropertyBag, Bag), Z_Construct_UScriptStruct_FInstancedPropertyBag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::NewProp_Bag_MetaData), Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::NewProp_Bag_MetaData) }; // 4097115139
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::Class_MetaDataParams), Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTestObjectWithPropertyBag_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtilsTestSuite_Public_StructUtilsTestTypes_h_Statics::EnumInfo[] = {
		{ EPropertyBagTest1_StaticEnum, TEXT("EPropertyBagTest1"), &Z_Registration_Info_UEnum_EPropertyBagTest1, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2351846193U) },
		{ EPropertyBagTest2_StaticEnum, TEXT("EPropertyBagTest2"), &Z_Registration_Info_UEnum_EPropertyBagTest2, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2165124180U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtilsTestSuite_Public_StructUtilsTestTypes_h_Statics::ScriptStructInfo[] = {
		{ FTestStructSimpleBase::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimpleBase_Statics::NewStructOps, TEXT("TestStructSimpleBase"), &Z_Registration_Info_UScriptStruct_TestStructSimpleBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimpleBase), 1943619707U) },
		{ FTestStructSimple::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple_Statics::NewStructOps, TEXT("TestStructSimple"), &Z_Registration_Info_UScriptStruct_TestStructSimple, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple), 1525748221U) },
		{ FTestStructSimpleNonZeroDefault::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimpleNonZeroDefault_Statics::NewStructOps, TEXT("TestStructSimpleNonZeroDefault"), &Z_Registration_Info_UScriptStruct_TestStructSimpleNonZeroDefault, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimpleNonZeroDefault), 2574542494U) },
		{ FTestStructComplex::StaticStruct, Z_Construct_UScriptStruct_FTestStructComplex_Statics::NewStructOps, TEXT("TestStructComplex"), &Z_Registration_Info_UScriptStruct_TestStructComplex, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructComplex), 1146433889U) },
		{ FTestStructSimple1::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple1_Statics::NewStructOps, TEXT("TestStructSimple1"), &Z_Registration_Info_UScriptStruct_TestStructSimple1, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple1), 1696928960U) },
		{ FTestStructSimple2::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple2_Statics::NewStructOps, TEXT("TestStructSimple2"), &Z_Registration_Info_UScriptStruct_TestStructSimple2, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple2), 4291288601U) },
		{ FTestStructSimple3::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple3_Statics::NewStructOps, TEXT("TestStructSimple3"), &Z_Registration_Info_UScriptStruct_TestStructSimple3, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple3), 3939617037U) },
		{ FTestStructSimple4::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple4_Statics::NewStructOps, TEXT("TestStructSimple4"), &Z_Registration_Info_UScriptStruct_TestStructSimple4, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple4), 2913909579U) },
		{ FTestStructSimple5::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple5_Statics::NewStructOps, TEXT("TestStructSimple5"), &Z_Registration_Info_UScriptStruct_TestStructSimple5, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple5), 2662750297U) },
		{ FTestStructSimple6::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple6_Statics::NewStructOps, TEXT("TestStructSimple6"), &Z_Registration_Info_UScriptStruct_TestStructSimple6, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple6), 1025756233U) },
		{ FTestStructSimple7::StaticStruct, Z_Construct_UScriptStruct_FTestStructSimple7_Statics::NewStructOps, TEXT("TestStructSimple7"), &Z_Registration_Info_UScriptStruct_TestStructSimple7, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTestStructSimple7), 2722155036U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtilsTestSuite_Public_StructUtilsTestTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBagTestObject1, UBagTestObject1::StaticClass, TEXT("UBagTestObject1"), &Z_Registration_Info_UClass_UBagTestObject1, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBagTestObject1), 2564794730U) },
		{ Z_Construct_UClass_UBagTestObject2, UBagTestObject2::StaticClass, TEXT("UBagTestObject2"), &Z_Registration_Info_UClass_UBagTestObject2, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBagTestObject2), 516974853U) },
		{ Z_Construct_UClass_UBagTestObject1Derived, UBagTestObject1Derived::StaticClass, TEXT("UBagTestObject1Derived"), &Z_Registration_Info_UClass_UBagTestObject1Derived, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBagTestObject1Derived), 2185351100U) },
		{ Z_Construct_UClass_UTestObjectWithPropertyBag, UTestObjectWithPropertyBag::StaticClass, TEXT("UTestObjectWithPropertyBag"), &Z_Registration_Info_UClass_UTestObjectWithPropertyBag, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestObjectWithPropertyBag), 1954186699U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtilsTestSuite_Public_StructUtilsTestTypes_h_3301221563(TEXT("/Script/StructUtilsTestSuite"),
