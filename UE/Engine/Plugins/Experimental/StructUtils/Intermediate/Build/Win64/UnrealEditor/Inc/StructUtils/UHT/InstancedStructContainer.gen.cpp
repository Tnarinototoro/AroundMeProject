...
template<> STRUCTUTILS_API UScriptStruct* StaticStruct<FInstancedStructContainer>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtils_Public_InstancedStructContainer_h_Statics::ScriptStructInfo[] = {
		{ FInstancedStructContainer::StaticStruct, Z_Construct_UScriptStruct_FInstancedStructContainer_Statics::NewStructOps, TEXT("InstancedStructContainer"), &Z_Registration_Info_UScriptStruct_InstancedStructContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInstancedStructContainer), 388454796U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_StructUtils_Source_StructUtils_Public_InstancedStructContainer_h_3905508458(TEXT("/Script/StructUtils"),
		nullptr, 0,
