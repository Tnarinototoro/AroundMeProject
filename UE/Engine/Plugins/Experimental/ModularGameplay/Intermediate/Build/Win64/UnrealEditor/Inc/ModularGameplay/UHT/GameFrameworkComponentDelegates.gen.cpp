...
template<> MODULARGAMEPLAY_API UScriptStruct* StaticStruct<FActorInitStateChangedParams>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_OwningActor = { "OwningActor", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FActorInitStateChangedParams, OwningActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_OwningActor_MetaData), Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_OwningActor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_FeatureName = { "FeatureName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FActorInitStateChangedParams, FeatureName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_FeatureName_MetaData), Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_FeatureName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_Implementer = { "Implementer", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FActorInitStateChangedParams, Implementer), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_Implementer_MetaData), Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_Implementer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_FeatureState = { "FeatureState", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FActorInitStateChangedParams, FeatureState), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_FeatureState_MetaData), Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::NewProp_FeatureState_MetaData) }; // 2083603574
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorInitStateChangedParams_Statics::PropPointers) < 2048);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::NewProp_Params = { "Params", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_ModularGameplay_eventActorInitStateChangedBPDelegate_Parms, Params), Z_Construct_UScriptStruct_FActorInitStateChangedParams, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::NewProp_Params_MetaData), Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::NewProp_Params_MetaData) }; // 3760671200
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_ModularGameplay, nullptr, "ActorInitStateChangedBPDelegate__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::_Script_ModularGameplay_eventActorInitStateChangedBPDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_ModularGameplay_ActorInitStateChangedBPDelegate__DelegateSignature_Statics::_Script_ModularGameplay_eventActorInitStateChangedBPDelegate_Parms) < MAX_uint16);
...
void FActorInitStateChangedBPDelegate_DelegateWrapper(const FScriptDelegate& ActorInitStateChangedBPDelegate, FActorInitStateChangedParams const& Params)
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ModularGameplay_Source_ModularGameplay_Public_Components_GameFrameworkComponentDelegates_h_3790206400(TEXT("/Script/ModularGameplay"),
		nullptr, 0,
