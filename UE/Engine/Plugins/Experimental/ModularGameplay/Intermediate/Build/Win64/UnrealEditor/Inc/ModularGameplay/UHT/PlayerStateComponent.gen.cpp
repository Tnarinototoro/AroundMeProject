...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPlayerStateComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPlayerStateComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPlayerStateComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UPlayerStateComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ModularGameplay_Source_ModularGameplay_Public_Components_PlayerStateComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlayerStateComponent, UPlayerStateComponent::StaticClass, TEXT("UPlayerStateComponent"), &Z_Registration_Info_UClass_UPlayerStateComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlayerStateComponent), 562082974U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ModularGameplay_Source_ModularGameplay_Public_Components_PlayerStateComponent_h_1045889836(TEXT("/Script/ModularGameplay"),
