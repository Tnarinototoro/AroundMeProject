...
template<> GEOMETRYCOLLECTIONNODES_API UScriptStruct* StaticStruct<FCloseGeometryOnCollectionDataflowNode>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCloseGeometryOnCollectionDataflowNode_Statics::NewProp_Collection = { "Collection", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCloseGeometryOnCollectionDataflowNode, Collection), Z_Construct_UScriptStruct_FManagedArrayCollection, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCloseGeometryOnCollectionDataflowNode_Statics::NewProp_Collection_MetaData), Z_Construct_UScriptStruct_FCloseGeometryOnCollectionDataflowNode_Statics::NewProp_Collection_MetaData) }; // 1642525875
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCollectionPlugin_Source_GeometryCollectionNodes_Public_Dataflow_GeometryCollectionProcessingNodes_h_Statics::ScriptStructInfo[] = {
		{ FCloseGeometryOnCollectionDataflowNode::StaticStruct, Z_Construct_UScriptStruct_FCloseGeometryOnCollectionDataflowNode_Statics::NewStructOps, TEXT("CloseGeometryOnCollectionDataflowNode"), &Z_Registration_Info_UScriptStruct_CloseGeometryOnCollectionDataflowNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCloseGeometryOnCollectionDataflowNode), 1043944961U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCollectionPlugin_Source_GeometryCollectionNodes_Public_Dataflow_GeometryCollectionProcessingNodes_h_3256277479(TEXT("/Script/GeometryCollectionNodes"),
		nullptr, 0,
