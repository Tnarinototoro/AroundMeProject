...
template<> GEOMETRYCOLLECTIONNODES_API UScriptStruct* StaticStruct<FTransformCollectionAttributeDataflowNode>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_Collection = { "Collection", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTransformCollectionAttributeDataflowNode, Collection), Z_Construct_UScriptStruct_FManagedArrayCollection, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_Collection_MetaData), Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_Collection_MetaData) }; // 1642525875
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_TransformIn = { "TransformIn", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTransformCollectionAttributeDataflowNode, TransformIn), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_TransformIn_MetaData), Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_TransformIn_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_LocalTransform = { "LocalTransform", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTransformCollectionAttributeDataflowNode, LocalTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_LocalTransform_MetaData), Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_LocalTransform_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_GroupName = { "GroupName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTransformCollectionAttributeDataflowNode, GroupName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_GroupName_MetaData), Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_GroupName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_AttributeName = { "AttributeName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTransformCollectionAttributeDataflowNode, AttributeName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_AttributeName_MetaData), Z_Construct_UScriptStruct_FTransformCollectionAttributeDataflowNode_Statics::NewProp_AttributeName_MetaData) };
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCollectionPlugin_Source_GeometryCollectionNodes_Public_Dataflow_GeometryCollectionVerticesNodes_h_929113579(TEXT("/Script/GeometryCollectionNodes"),
		nullptr, 0,
