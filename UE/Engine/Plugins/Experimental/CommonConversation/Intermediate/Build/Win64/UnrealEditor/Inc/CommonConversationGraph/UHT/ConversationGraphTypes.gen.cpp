...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationGraphTypes_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UConversationGraphTypes_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationGraphTypes_Statics::Class_MetaDataParams), Z_Construct_UClass_UConversationGraphTypes_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationGraph_Public_ConversationGraphTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConversationGraphTypes, UConversationGraphTypes::StaticClass, TEXT("UConversationGraphTypes"), &Z_Registration_Info_UClass_UConversationGraphTypes, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConversationGraphTypes), 4217325977U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationGraph_Public_ConversationGraphTypes_h_2336198617(TEXT("/Script/CommonConversationGraph"),
