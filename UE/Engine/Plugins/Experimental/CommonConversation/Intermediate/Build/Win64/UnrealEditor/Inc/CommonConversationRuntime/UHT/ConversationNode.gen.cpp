...
template<> COMMONCONVERSATIONRUNTIME_API UScriptStruct* StaticStruct<FConversationNodeHandle>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConversationNodeHandle_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConversationNodeHandle_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConversationNodeHandle_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConversationNodeHandle_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::NewProp_ParticipantID = { "ParticipantID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ConversationNode_eventGetDebugParticipantColor_Parms, ParticipantID), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 2083603574
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ConversationNode_eventGetDebugParticipantColor_Parms, ReturnValue), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UConversationNode, nullptr, "GetDebugParticipantColor", nullptr, nullptr, Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::ConversationNode_eventGetDebugParticipantColor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54880401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor_Statics::ConversationNode_eventGetDebugParticipantColor_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UConversationNode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UConversationNode_GetDebugParticipantColor, "GetDebugParticipantColor" }, // 3872137170
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UConversationNode_Statics::NewProp_EvalWorldContextObj = { "EvalWorldContextObj", nullptr, (EPropertyFlags)0x0014000000202010, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConversationNode, EvalWorldContextObj), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::NewProp_EvalWorldContextObj_MetaData), Z_Construct_UClass_UConversationNode_Statics::NewProp_EvalWorldContextObj_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UConversationNode_Statics::NewProp_NodeName = { "NodeName", nullptr, (EPropertyFlags)0x00200c0000000011, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConversationNode, NodeName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::NewProp_NodeName_MetaData), Z_Construct_UClass_UConversationNode_Statics::NewProp_NodeName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UConversationNode_Statics::NewProp_Compiled_NodeGUID = { "Compiled_NodeGUID", nullptr, (EPropertyFlags)0x0020080000000010, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConversationNode, Compiled_NodeGUID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::NewProp_Compiled_NodeGUID_MetaData), Z_Construct_UClass_UConversationNode_Statics::NewProp_Compiled_NodeGUID_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyDetails = { "bShowPropertyDetails", nullptr, (EPropertyFlags)0x00200c0800000811, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UConversationNode), &Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyDetails_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyDetails_MetaData), Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyDetails_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyEditors = { "bShowPropertyEditors", nullptr, (EPropertyFlags)0x00200c0800000811, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(UConversationNode), &Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyEditors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyEditors_MetaData), Z_Construct_UClass_UConversationNode_Statics::NewProp_bShowPropertyEditors_MetaData) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UConversationNode_Statics::NewProp_ParentNode = { "ParentNode", nullptr, (EPropertyFlags)0x0044000000000010, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConversationNode, ParentNode), Z_Construct_UClass_UConversationNode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::NewProp_ParentNode_MetaData), Z_Construct_UClass_UConversationNode_Statics::NewProp_ParentNode_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UConversationNode_Statics::ClassParams = {
		...
		0,
		0x001100A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::Class_MetaDataParams), Z_Construct_UClass_UConversationNode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNode_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNodeWithLinks_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UConversationNodeWithLinks_Statics::NewProp_OutputConnections = { "OutputConnections", nullptr, (EPropertyFlags)0x0010000000000010, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConversationNodeWithLinks, OutputConnections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNodeWithLinks_Statics::NewProp_OutputConnections_MetaData), Z_Construct_UClass_UConversationNodeWithLinks_Statics::NewProp_OutputConnections_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UConversationNodeWithLinks_Statics::ClassParams = {
		...
		0,
		0x001100A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNodeWithLinks_Statics::Class_MetaDataParams), Z_Construct_UClass_UConversationNodeWithLinks_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationNodeWithLinks_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationNode_h_Statics::ScriptStructInfo[] = {
		{ FConversationNodeHandle::StaticStruct, Z_Construct_UScriptStruct_FConversationNodeHandle_Statics::NewStructOps, TEXT("ConversationNodeHandle"), &Z_Registration_Info_UScriptStruct_ConversationNodeHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConversationNodeHandle), 1003635762U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationNode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConversationNode, UConversationNode::StaticClass, TEXT("UConversationNode"), &Z_Registration_Info_UClass_UConversationNode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConversationNode), 664286173U) },
		{ Z_Construct_UClass_UConversationNodeWithLinks, UConversationNodeWithLinks::StaticClass, TEXT("UConversationNodeWithLinks"), &Z_Registration_Info_UClass_UConversationNodeWithLinks, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConversationNodeWithLinks), 589392457U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationNode_h_2889431008(TEXT("/Script/CommonConversationRuntime"),
