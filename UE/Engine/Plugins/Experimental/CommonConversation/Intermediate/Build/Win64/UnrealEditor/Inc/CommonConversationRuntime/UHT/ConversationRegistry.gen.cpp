...
template<> COMMONCONVERSATIONRUNTIME_API UScriptStruct* StaticStruct<FNetSerializeScriptStructCache_ConvVersion>()
{
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::NewProp_ScriptStructsToIndex = { "ScriptStructsToIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNetSerializeScriptStructCache_ConvVersion, ScriptStructsToIndex), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::NewProp_ScriptStructsToIndex_MetaData), Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::NewProp_ScriptStructsToIndex_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::NewProp_IndexToScriptStructs = { "IndexToScriptStructs", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNetSerializeScriptStructCache_ConvVersion, IndexToScriptStructs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::NewProp_IndexToScriptStructs_MetaData), Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::NewProp_IndexToScriptStructs_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationRegistry_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UConversationRegistry_Statics::NewProp_ConversationChoiceDataStructCache = { "ConversationChoiceDataStructCache", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConversationRegistry, ConversationChoiceDataStructCache), Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationRegistry_Statics::NewProp_ConversationChoiceDataStructCache_MetaData), Z_Construct_UClass_UConversationRegistry_Statics::NewProp_ConversationChoiceDataStructCache_MetaData) }; // 4091778543
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UConversationRegistry_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UConversationRegistry_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UGameFeatureStateChangeObserver_NoRegister, (int32)VTABLE_OFFSET(UConversationRegistry, IGameFeatureStateChangeObserver), false },  // 1209594825
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationRegistry_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UConversationRegistry_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationRegistry_Statics::Class_MetaDataParams), Z_Construct_UClass_UConversationRegistry_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationRegistry_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationRegistry_h_Statics::ScriptStructInfo[] = {
		{ FNetSerializeScriptStructCache_ConvVersion::StaticStruct, Z_Construct_UScriptStruct_FNetSerializeScriptStructCache_ConvVersion_Statics::NewStructOps, TEXT("NetSerializeScriptStructCache_ConvVersion"), &Z_Registration_Info_UScriptStruct_NetSerializeScriptStructCache_ConvVersion, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNetSerializeScriptStructCache_ConvVersion), 4091778543U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationRegistry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConversationRegistry, UConversationRegistry::StaticClass, TEXT("UConversationRegistry"), &Z_Registration_Info_UClass_UConversationRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConversationRegistry), 957806020U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationRegistry_h_508223950(TEXT("/Script/CommonConversationRuntime"),
