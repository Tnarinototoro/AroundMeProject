...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UConversationSettings_Statics::NewProp_ConversationInstanceClass = { "ConversationInstanceClass", nullptr, (EPropertyFlags)0x0024080000004001, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UConversationSettings, ConversationInstanceClass), Z_Construct_UClass_UConversationInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationSettings_Statics::NewProp_ConversationInstanceClass_MetaData), Z_Construct_UClass_UConversationSettings_Statics::NewProp_ConversationInstanceClass_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UConversationSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UConversationSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UConversationSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConversationSettings, UConversationSettings::StaticClass, TEXT("UConversationSettings"), &Z_Registration_Info_UClass_UConversationSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConversationSettings), 1369697269U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CommonConversation_Source_CommonConversationRuntime_Public_ConversationSettings_h_227094313(TEXT("/Script/CommonConversationRuntime"),
