...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapePatchManager_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_PatchComponents_Inner = { "PatchComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_ULandscapePatchComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_PatchComponents = { "PatchComponents", nullptr, (EPropertyFlags)0x0024088000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALandscapePatchManager, PatchComponents), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_PatchComponents_MetaData), Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_PatchComponents_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_HeightmapCoordsToWorld = { "HeightmapCoordsToWorld", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALandscapePatchManager, HeightmapCoordsToWorld), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_HeightmapCoordsToWorld_MetaData), Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_HeightmapCoordsToWorld_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_DetailPanelLandscape = { "DetailPanelLandscape", nullptr, (EPropertyFlags)0x0024080800002001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ALandscapePatchManager, DetailPanelLandscape), Z_Construct_UClass_ALandscape_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_DetailPanelLandscape_MetaData), Z_Construct_UClass_ALandscapePatchManager_Statics::NewProp_DetailPanelLandscape_MetaData) };
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ALandscapePatchManager_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapePatchManager_Statics::Class_MetaDataParams), Z_Construct_UClass_ALandscapePatchManager_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapePatchManager_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapePatchManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALandscapePatchManager, ALandscapePatchManager::StaticClass, TEXT("ALandscapePatchManager"), &Z_Registration_Info_UClass_ALandscapePatchManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALandscapePatchManager), 4215859698U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapePatchManager_h_3134981737(TEXT("/Script/LandscapePatch"),
