...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bEditVisibility_MetaData[];
#endif
		static void NewProp_bEditVisibility_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bEditVisibility;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_Radius = { "Radius", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeCircleHeightPatch, Radius), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_Radius_MetaData), Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_Radius_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_Falloff = { "Falloff", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeCircleHeightPatch, Falloff), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_Falloff_MetaData), Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_Falloff_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bEditVisibility_MetaData[] = {
		{ "Category", "Settings" },
...
#endif
	void Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bEditVisibility_SetBit(void* Obj)
	{
		((ULandscapeCircleHeightPatch*)Obj)->bEditVisibility = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bEditVisibility = { "bEditVisibility", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULandscapeCircleHeightPatch), &Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bEditVisibility_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bEditVisibility_MetaData), Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bEditVisibility_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bExclusiveRadius = { "bExclusiveRadius", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULandscapeCircleHeightPatch), &Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bExclusiveRadius_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bExclusiveRadius_MetaData), Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bExclusiveRadius_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::NewProp_bEditVisibility,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::Class_MetaDataParams), Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeCircleHeightPatch_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapeCircleHeightPatch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULandscapeCircleHeightPatch, ULandscapeCircleHeightPatch::StaticClass, TEXT("ULandscapeCircleHeightPatch"), &Z_Registration_Info_UClass_ULandscapeCircleHeightPatch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeCircleHeightPatch), 4086395563U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapeCircleHeightPatch_h_853344981(TEXT("/Script/LandscapePatch"),
