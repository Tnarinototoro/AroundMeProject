...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchBlendMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchBlendMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchBlendMode_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchFalloffMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchFalloffMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchFalloffMode_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchEncoding_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchEncoding_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchEncoding_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchZeroHeightMeaning_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchZeroHeightMeaning_Statics::Enum_MetaDataParams), Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchZeroHeightMeaning_Statics::Enum_MetaDataParams)
	};
...
template<> LANDSCAPEPATCH_API UScriptStruct* StaticStruct<FLandscapeTexturePatchEncodingSettings>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewProp_ZeroInEncoding_MetaData[] = {
		{ "Category", "Settings" },
		{ "Comment", "/**\n\x09 * The value in the patch data that corresponds to 0 height relative to the starting point\n\x09 * specified by Zero Height Meaning.\n\x09 */" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
		{ "ToolTip", "The value in the patch data that corresponds to 0 height relative to the starting point\nspecified by Zero Height Meaning." },
	};
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewProp_ZeroInEncoding = { "ZeroInEncoding", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandscapeTexturePatchEncodingSettings, ZeroInEncoding), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewProp_ZeroInEncoding_MetaData), Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewProp_ZeroInEncoding_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewProp_WorldSpaceEncodingScale = { "WorldSpaceEncodingScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandscapeTexturePatchEncodingSettings, WorldSpaceEncodingScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewProp_WorldSpaceEncodingScale_MetaData), Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewProp_WorldSpaceEncodingScale_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::PropPointers) < 2048);
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bEditVisibilityLayer_MetaData[];
#endif
		static void NewProp_bEditVisibilityLayer_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bEditVisibilityLayer;
#if WITH_METADATA
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_WeightmapLayerName = { "WeightmapLayerName", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeWeightPatchTextureInfo, WeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_WeightmapLayerName_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_WeightmapLayerName_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bEditVisibilityLayer_MetaData[] = {
		{ "Category", "WeightPatch" },
		{ "Comment", "/** Specifies if this patch edits the visibility layer. */" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
		{ "ToolTip", "Specifies if this patch edits the visibility layer." },
	};
#endif
	void Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bEditVisibilityLayer_SetBit(void* Obj)
	{
		((ULandscapeWeightPatchTextureInfo*)Obj)->bEditVisibilityLayer = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bEditVisibilityLayer = { "bEditVisibilityLayer", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULandscapeWeightPatchTextureInfo), &Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bEditVisibilityLayer_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bEditVisibilityLayer_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bEditVisibilityLayer_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_TextureAsset = { "TextureAsset", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeWeightPatchTextureInfo, TextureAsset), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_TextureAsset_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_TextureAsset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_InternalData = { "InternalData", nullptr, (EPropertyFlags)0x00260c00000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeWeightPatchTextureInfo, InternalData), Z_Construct_UClass_ULandscapeWeightTextureBackedRenderTarget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_InternalData_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_InternalData_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_SourceMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_SourceMode = { "SourceMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeWeightPatchTextureInfo, SourceMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_SourceMode_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_SourceMode_MetaData) }; // 1312921026
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_DetailPanelSourceMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_DetailPanelSourceMode = { "DetailPanelSourceMode", nullptr, (EPropertyFlags)0x0020080000000801, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeWeightPatchTextureInfo, DetailPanelSourceMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_DetailPanelSourceMode_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_DetailPanelSourceMode_MetaData) }; // 1312921026
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bOverrideBlendMode = { "bOverrideBlendMode", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULandscapeWeightPatchTextureInfo), &Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bOverrideBlendMode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bOverrideBlendMode_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bOverrideBlendMode_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_OverrideBlendMode = { "OverrideBlendMode", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeWeightPatchTextureInfo, OverrideBlendMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchBlendMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_OverrideBlendMode_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_OverrideBlendMode_MetaData) }; // 1933627727
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_OwningPatch = { "OwningPatch", nullptr, (EPropertyFlags)0x0024080000080008, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeWeightPatchTextureInfo, OwningPatch), Z_Construct_UClass_ULandscapeTexturePatch_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_OwningPatch_MetaData), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_OwningPatch_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::NewProp_bEditVisibilityLayer,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::Class_MetaDataParams), Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_Statics::PropPointers) < 2048);
	...
	DEFINE_FUNCTION(ULandscapeTexturePatch::execSetEditVisibilityLayer)
	{
		P_GET_PROPERTY_REF(FNameProperty,Z_Param_Out_InWeightmapLayerName);
		P_GET_UBOOL(Z_Param_bEditVisibilityLayer);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetEditVisibilityLayer(Z_Param_Out_InWeightmapLayerName,Z_Param_bEditVisibilityLayer);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(ULandscapeTexturePatch::execGetHeightRenderTarget)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(UTextureRenderTarget2D**)Z_Param__Result=P_THIS->GetHeightRenderTarget(Z_Param_bMarkDirty);
		P_NATIVE_END;
	}
	...
	void ULandscapeTexturePatch::StaticRegisterNativesULandscapeTexturePatch()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetEditVisibilityLayer", &ULandscapeTexturePatch::execSetEditVisibilityLayer },
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventAddWeightPatch_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::NewProp_InWeightmapLayerName_MetaData) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::NewProp_SourceMode = { "SourceMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventAddWeightPatch_Parms, SourceMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(0, nullptr) }; // 1312921026
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::NewProp_bUseAlphaChannel = { "bUseAlphaChannel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(LandscapeTexturePatch_eventAddWeightPatch_Parms), &Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::NewProp_bUseAlphaChannel_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "AddWeightPatch", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::LandscapeTexturePatch_eventAddWeightPatch_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch_Statics::LandscapeTexturePatch_eventAddWeightPatch_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventClearWeightPatchBlendModeOverride_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::NewProp_InWeightmapLayerName_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "ClearWeightPatchBlendModeOverride", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::LandscapeTexturePatch_eventClearWeightPatchBlendModeOverride_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride_Statics::LandscapeTexturePatch_eventClearWeightPatchBlendModeOverride_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_DisableAllWeightPatches_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "DisableAllWeightPatches", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_DisableAllWeightPatches_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_DisableAllWeightPatches_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetAllWeightPatchLayerNames_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetAllWeightPatchLayerNames", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::LandscapeTexturePatch_eventGetAllWeightPatchLayerNames_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames_Statics::LandscapeTexturePatch_eventGetAllWeightPatchLayerNames_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetFullUnscaledWorldSize_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetFullUnscaledWorldSize", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::LandscapeTexturePatch_eventGetFullUnscaledWorldSize_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize_Statics::LandscapeTexturePatch_eventGetFullUnscaledWorldSize_Parms) < MAX_uint16);
	...
	void Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::NewProp_bMarkDirty_SetBit(void* Obj)
	{
		((LandscapeTexturePatch_eventGetHeightRenderTarget_Parms*)Obj)->bMarkDirty = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::NewProp_bMarkDirty = { "bMarkDirty", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(LandscapeTexturePatch_eventGetHeightRenderTarget_Parms), &Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::NewProp_bMarkDirty_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetHeightRenderTarget_Parms, ReturnValue), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::NewProp_bMarkDirty,
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::Function_MetaDataParams[] = {
		{ "Category", "LandscapePatch" },
		{ "Comment", "/**\n\x09 * Gets the internal height render target, if source mode is set to Texture Backed Render Target.\n\x09 * \n\x09 * Things that should be set up if using the internal render target:\n\x09 * - SetHeightSourceMode should have been called with TextureBackedRenderTarget.\n\x09 * - An appropriate texture size should have been set with SetResolution. If the patch extent has already\n\x09 *  been set, you can base your resolution on the extent and the resolution of the landscape by using\n\x09 *  GetInitResolutionFromLandscape().\n\x09 * - SetHeightRenderTargetFormat should have been called with a desired format. In particular, if using\n\x09 *  an alpha channel, the format should have an alpha channel (and SetUseAlphaChannelForHeight should have\n\x09 *  been called with \"true\").\n\x09 * \n\x09 * In addition, you may need to call SetHeightEncodingMode, SetHeightEncodingSettings, and SetZeroHeightMeaning\n\x09 * based on how you want the data you write to be interpreted. This part is not specific to using an internal render\n\x09 * target, since you are likely to need to do that with a TextureAsset source mode as well.\n\x09 * \n\x09 * @param bMarkDirty If true, marks the containing package as dirty, since the render target is presumably\n\x09 *  being written to. Can be set to false if the render target is not being written to.\n\x09 */" },
		{ "CPP_Default_bMarkDirty", "true" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
		{ "ToolTip", "Gets the internal height render target, if source mode is set to Texture Backed Render Target.\n\nThings that should be set up if using the internal render target:\n- SetHeightSourceMode should have been called with TextureBackedRenderTarget.\n- An appropriate texture size should have been set with SetResolution. If the patch extent has already\n been set, you can base your resolution on the extent and the resolution of the landscape by using\n GetInitResolutionFromLandscape().\n- SetHeightRenderTargetFormat should have been called with a desired format. In particular, if using\n an alpha channel, the format should have an alpha channel (and SetUseAlphaChannelForHeight should have\n been called with \"true\").\n\nIn addition, you may need to call SetHeightEncodingMode, SetHeightEncodingSettings, and SetZeroHeightMeaning\nbased on how you want the data you write to be interpreted. This part is not specific to using an internal render\ntarget, since you are likely to need to do that with a TextureAsset source mode as well.\n\n@param bMarkDirty If true, marks the containing package as dirty, since the render target is presumably\n being written to. Can be set to false if the render target is not being written to." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetHeightRenderTarget", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::LandscapeTexturePatch_eventGetHeightRenderTarget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget_Statics::LandscapeTexturePatch_eventGetHeightRenderTarget_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetHeightSourceMode_Parms, ReturnValue), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(0, nullptr) }; // 1312921026
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetHeightSourceMode", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::LandscapeTexturePatch_eventGetHeightSourceMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode_Statics::LandscapeTexturePatch_eventGetHeightSourceMode_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::NewProp_ResolutionMultiplier = { "ResolutionMultiplier", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetInitResolutionFromLandscape_Parms, ResolutionMultiplier), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::NewProp_ResolutionOut = { "ResolutionOut", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetInitResolutionFromLandscape_Parms, ResolutionOut), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(LandscapeTexturePatch_eventGetInitResolutionFromLandscape_Parms), &Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::NewProp_ReturnValue_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetInitResolutionFromLandscape", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::LandscapeTexturePatch_eventGetInitResolutionFromLandscape_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54C20400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape_Statics::LandscapeTexturePatch_eventGetInitResolutionFromLandscape_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetPatchToWorldTransform_Parms, ReturnValue), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetPatchToWorldTransform", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::LandscapeTexturePatch_eventGetPatchToWorldTransform_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform_Statics::LandscapeTexturePatch_eventGetPatchToWorldTransform_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetResolution_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetResolution", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::LandscapeTexturePatch_eventGetResolution_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution_Statics::LandscapeTexturePatch_eventGetResolution_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetUnscaledCoverage_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetUnscaledCoverage", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::LandscapeTexturePatch_eventGetUnscaledCoverage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage_Statics::LandscapeTexturePatch_eventGetUnscaledCoverage_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetWeightPatchRenderTarget_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::NewProp_InWeightmapLayerName_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetWeightPatchRenderTarget_Parms, ReturnValue), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetWeightPatchRenderTarget", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::LandscapeTexturePatch_eventGetWeightPatchRenderTarget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget_Statics::LandscapeTexturePatch_eventGetWeightPatchRenderTarget_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetWeightPatchSourceMode_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::NewProp_InWeightmapLayerName_MetaData) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventGetWeightPatchSourceMode_Parms, ReturnValue), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(0, nullptr) }; // 1312921026
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "GetWeightPatchSourceMode", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::LandscapeTexturePatch_eventGetWeightPatchSourceMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode_Statics::LandscapeTexturePatch_eventGetWeightPatchSourceMode_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeHeight_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "ReinitializeHeight", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeHeight_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeHeight_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeWeights_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "ReinitializeWeights", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeWeights_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeWeights_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_RemoveAllWeightPatches_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "RemoveAllWeightPatches", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_RemoveAllWeightPatches_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_RemoveAllWeightPatches_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventRemoveWeightPatch_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::NewProp_InWeightmapLayerName_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "RemoveWeightPatch", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::LandscapeTexturePatch_eventRemoveWeightPatch_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch_Statics::LandscapeTexturePatch_eventRemoveWeightPatch_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::NewProp_EncodingMode = { "EncodingMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventResetHeightEncodingMode_Parms, EncodingMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchEncoding, METADATA_PARAMS(0, nullptr) }; // 3977694404
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::Function_MetaDataParams[] = {
		{ "Category", "LandscapePatch" },
		{ "Comment", "/**\n\x09 * Just like SetSourceEncodingMode, but resets ZeroInEncoding, WorldSpaceEncodingScale, and height\n\x09 * render target format to mode-specific defaults.\n\x09 */" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
		{ "ToolTip", "Just like SetSourceEncodingMode, but resets ZeroInEncoding, WorldSpaceEncodingScale, and height\nrender target format to mode-specific defaults." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "ResetHeightEncodingMode", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::LandscapeTexturePatch_eventResetHeightEncodingMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode_Statics::LandscapeTexturePatch_eventResetHeightEncodingMode_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::NewProp_BlendModeIn_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::NewProp_BlendModeIn = { "BlendModeIn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetBlendMode_Parms, BlendModeIn), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchBlendMode, METADATA_PARAMS(0, nullptr) }; // 1933627727
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::Function_MetaDataParams[] = {
		{ "Category", "LandscapePatch" },
		{ "Comment", "/**\n\x09 * Determines how the height patch is blended into the existing terrain.\n\x09 */" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
		{ "ToolTip", "Determines how the height patch is blended into the existing terrain." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetBlendMode", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::LandscapeTexturePatch_eventSetBlendMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode_Statics::LandscapeTexturePatch_eventSetBlendMode_Parms) < MAX_uint16);
	...
	struct Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics
	{
		struct LandscapeTexturePatch_eventSetEditVisibilityLayer_Parms
		{
			FName InWeightmapLayerName;
			bool bEditVisibilityLayer;
		};
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_InWeightmapLayerName_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_InWeightmapLayerName_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetEditVisibilityLayer_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_InWeightmapLayerName_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_bEditVisibilityLayer_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	void Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_bEditVisibilityLayer_SetBit(void* Obj)
	{
		((LandscapeTexturePatch_eventSetEditVisibilityLayer_Parms*)Obj)->bEditVisibilityLayer = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_bEditVisibilityLayer = { "bEditVisibilityLayer", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(LandscapeTexturePatch_eventSetEditVisibilityLayer_Parms), &Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_bEditVisibilityLayer_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_bEditVisibilityLayer_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_bEditVisibilityLayer_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_InWeightmapLayerName,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::NewProp_bEditVisibilityLayer,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::Function_MetaDataParams[] = {
		{ "Category", "LandscapePatch" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetEditVisibilityLayer", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::LandscapeTexturePatch_eventSetEditVisibilityLayer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::LandscapeTexturePatch_eventSetEditVisibilityLayer_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::NewProp_FalloffIn = { "FalloffIn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetFalloff_Parms, FalloffIn), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetFalloff", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::LandscapeTexturePatch_eventSetFalloff_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff_Statics::LandscapeTexturePatch_eventSetFalloff_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::NewProp_EncodingMode = { "EncodingMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetHeightEncodingMode_Parms, EncodingMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchEncoding, METADATA_PARAMS(0, nullptr) }; // 3977694404
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetHeightEncodingMode", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::LandscapeTexturePatch_eventSetHeightEncodingMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode_Statics::LandscapeTexturePatch_eventSetHeightEncodingMode_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetHeightEncodingSettings_Parms, Settings), Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::NewProp_Settings_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::NewProp_Settings_MetaData) }; // 2512456930
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetHeightEncodingSettings", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::LandscapeTexturePatch_eventSetHeightEncodingSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings_Statics::LandscapeTexturePatch_eventSetHeightEncodingSettings_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::NewProp_Format = { "Format", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetHeightRenderTargetFormat_Parms, Format), Z_Construct_UEnum_Engine_ETextureRenderTargetFormat, METADATA_PARAMS(0, nullptr) }; // 161131239
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetHeightRenderTargetFormat", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::LandscapeTexturePatch_eventSetHeightRenderTargetFormat_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat_Statics::LandscapeTexturePatch_eventSetHeightRenderTargetFormat_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::NewProp_NewMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::NewProp_NewMode = { "NewMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetHeightSourceMode_Parms, NewMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(0, nullptr) }; // 1312921026
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetHeightSourceMode", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::LandscapeTexturePatch_eventSetHeightSourceMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode_Statics::LandscapeTexturePatch_eventSetHeightSourceMode_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::NewProp_TextureIn = { "TextureIn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetHeightTextureAsset_Parms, TextureIn), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetHeightTextureAsset", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::LandscapeTexturePatch_eventSetHeightTextureAsset_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset_Statics::LandscapeTexturePatch_eventSetHeightTextureAsset_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::NewProp_ResolutionIn = { "ResolutionIn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetResolution_Parms, ResolutionIn), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetResolution", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::LandscapeTexturePatch_eventSetResolution_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution_Statics::LandscapeTexturePatch_eventSetResolution_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::NewProp_Coverage = { "Coverage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetUnscaledCoverage_Parms, Coverage), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetUnscaledCoverage", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::LandscapeTexturePatch_eventSetUnscaledCoverage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage_Statics::LandscapeTexturePatch_eventSetUnscaledCoverage_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::NewProp_bUse = { "bUse", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(LandscapeTexturePatch_eventSetUseAlphaChannelForHeight_Parms), &Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::NewProp_bUse_SetBit, METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::Function_MetaDataParams[] = {
		{ "Category", "LandscapePatch" },
		{ "Comment", "/**\n\x09 * Determines whether the height patch alpha channel is used for blending into the existing values.\n\x09 * Note that the source data needs to have an alpha channel in this case. How the alpha channel is\n\x09 * used depends on the patch blend mode (see SetBlendMode).\n\x09 */" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
		{ "ToolTip", "Determines whether the height patch alpha channel is used for blending into the existing values.\nNote that the source data needs to have an alpha channel in this case. How the alpha channel is\nused depends on the patch blend mode (see SetBlendMode)." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetUseAlphaChannelForHeight", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::LandscapeTexturePatch_eventSetUseAlphaChannelForHeight_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight_Statics::LandscapeTexturePatch_eventSetUseAlphaChannelForHeight_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetUseAlphaChannelForWeightPatch_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::NewProp_InWeightmapLayerName_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::NewProp_bUseAlphaChannel = { "bUseAlphaChannel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(LandscapeTexturePatch_eventSetUseAlphaChannelForWeightPatch_Parms), &Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::NewProp_bUseAlphaChannel_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetUseAlphaChannelForWeightPatch", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::LandscapeTexturePatch_eventSetUseAlphaChannelForWeightPatch_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch_Statics::LandscapeTexturePatch_eventSetUseAlphaChannelForWeightPatch_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetWeightPatchBlendModeOverride_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::NewProp_InWeightmapLayerName_MetaData) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::NewProp_BlendMode = { "BlendMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetWeightPatchBlendModeOverride_Parms, BlendMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchBlendMode, METADATA_PARAMS(0, nullptr) }; // 1933627727
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetWeightPatchBlendModeOverride", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::LandscapeTexturePatch_eventSetWeightPatchBlendModeOverride_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride_Statics::LandscapeTexturePatch_eventSetWeightPatchBlendModeOverride_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetWeightPatchSourceMode_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::NewProp_InWeightmapLayerName_MetaData) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::NewProp_NewMode = { "NewMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetWeightPatchSourceMode_Parms, NewMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(0, nullptr) }; // 1312921026
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetWeightPatchSourceMode", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::LandscapeTexturePatch_eventSetWeightPatchSourceMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode_Statics::LandscapeTexturePatch_eventSetWeightPatchSourceMode_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::NewProp_InWeightmapLayerName = { "InWeightmapLayerName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetWeightPatchTextureAsset_Parms, InWeightmapLayerName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::NewProp_InWeightmapLayerName_MetaData), Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::NewProp_InWeightmapLayerName_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::NewProp_TextureIn = { "TextureIn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetWeightPatchTextureAsset_Parms, TextureIn), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetWeightPatchTextureAsset", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::LandscapeTexturePatch_eventSetWeightPatchTextureAsset_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset_Statics::LandscapeTexturePatch_eventSetWeightPatchTextureAsset_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::NewProp_ZeroHeightMeaningIn = { "ZeroHeightMeaningIn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LandscapeTexturePatch_eventSetZeroHeightMeaning_Parms, ZeroHeightMeaningIn), Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchZeroHeightMeaning, METADATA_PARAMS(0, nullptr) }; // 1387781771
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SetZeroHeightMeaning", nullptr, nullptr, Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::PropPointers), sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::LandscapeTexturePatch_eventSetZeroHeightMeaning_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning_Statics::LandscapeTexturePatch_eventSetZeroHeightMeaning_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULandscapeTexturePatch_SnapToLandscape_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULandscapeTexturePatch, nullptr, "SnapToLandscape", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULandscapeTexturePatch_SnapToLandscape_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULandscapeTexturePatch_SnapToLandscape_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_ULandscapeTexturePatch_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_AddWeightPatch, "AddWeightPatch" }, // 718585689
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_ClearWeightPatchBlendModeOverride, "ClearWeightPatchBlendModeOverride" }, // 3737699609
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_DisableAllWeightPatches, "DisableAllWeightPatches" }, // 1709552563
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetAllWeightPatchLayerNames, "GetAllWeightPatchLayerNames" }, // 4133372110
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetFullUnscaledWorldSize, "GetFullUnscaledWorldSize" }, // 2991289798
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightRenderTarget, "GetHeightRenderTarget" }, // 938506199
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetHeightSourceMode, "GetHeightSourceMode" }, // 3093737091
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetInitResolutionFromLandscape, "GetInitResolutionFromLandscape" }, // 4275842912
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetPatchToWorldTransform, "GetPatchToWorldTransform" }, // 3115636865
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetResolution, "GetResolution" }, // 4294568569
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetUnscaledCoverage, "GetUnscaledCoverage" }, // 4130784978
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchRenderTarget, "GetWeightPatchRenderTarget" }, // 2915920320
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_GetWeightPatchSourceMode, "GetWeightPatchSourceMode" }, // 1318371475
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeHeight, "ReinitializeHeight" }, // 2538168314
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_ReinitializeWeights, "ReinitializeWeights" }, // 3681589277
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_RemoveAllWeightPatches, "RemoveAllWeightPatches" }, // 1693878535
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_RemoveWeightPatch, "RemoveWeightPatch" }, // 2204547774
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_ResetHeightEncodingMode, "ResetHeightEncodingMode" }, // 2694423349
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetBlendMode, "SetBlendMode" }, // 284205335
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetEditVisibilityLayer, "SetEditVisibilityLayer" }, // 2271839581
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetFalloff, "SetFalloff" }, // 1746856734
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingMode, "SetHeightEncodingMode" }, // 2802637575
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightEncodingSettings, "SetHeightEncodingSettings" }, // 3814125677
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightRenderTargetFormat, "SetHeightRenderTargetFormat" }, // 865091921
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightSourceMode, "SetHeightSourceMode" }, // 4031724493
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetHeightTextureAsset, "SetHeightTextureAsset" }, // 707827748
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetResolution, "SetResolution" }, // 4233162330
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetUnscaledCoverage, "SetUnscaledCoverage" }, // 2323239313
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForHeight, "SetUseAlphaChannelForHeight" }, // 736108445
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetUseAlphaChannelForWeightPatch, "SetUseAlphaChannelForWeightPatch" }, // 3681808813
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchBlendModeOverride, "SetWeightPatchBlendModeOverride" }, // 3549623053
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchSourceMode, "SetWeightPatchSourceMode" }, // 784181743
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetWeightPatchTextureAsset, "SetWeightPatchTextureAsset" }, // 1782690328
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SetZeroHeightMeaning, "SetZeroHeightMeaning" }, // 1402050078
		{ &Z_Construct_UFunction_ULandscapeTexturePatch_SnapToLandscape, "SnapToLandscape" }, // 410423986
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionX = { "ResolutionX", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, ResolutionX), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionX_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionX_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionY = { "ResolutionY", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, ResolutionY), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionY_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionY_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_UnscaledPatchCoverage = { "UnscaledPatchCoverage", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, UnscaledPatchCoverage), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_UnscaledPatchCoverage_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_UnscaledPatchCoverage_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_BlendMode = { "BlendMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, BlendMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchBlendMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_BlendMode_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_BlendMode_MetaData) }; // 1933627727
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_FalloffMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_FalloffMode = { "FalloffMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, FalloffMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchFalloffMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_FalloffMode_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_FalloffMode_MetaData) }; // 144526283
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_Falloff = { "Falloff", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, Falloff), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_Falloff_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_Falloff_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightSourceMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightSourceMode = { "HeightSourceMode", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, HeightSourceMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightSourceMode_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightSourceMode_MetaData) }; // 1312921026
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_DetailPanelHeightSourceMode = { "DetailPanelHeightSourceMode", nullptr, (EPropertyFlags)0x0020080000000801, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, DetailPanelHeightSourceMode), Z_Construct_UEnum_LandscapePatch_ELandscapeTexturePatchSourceMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_DetailPanelHeightSourceMode_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_DetailPanelHeightSourceMode_MetaData) }; // 1312921026
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightInternalData = { "HeightInternalData", nullptr, (EPropertyFlags)0x00260800000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, HeightInternalData), Z_Construct_UClass_ULandscapeHeightTextureBackedRenderTarget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightInternalData_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightInternalData_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightTextureAsset = { "HeightTextureAsset", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, HeightTextureAsset), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightTextureAsset_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightTextureAsset_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bUseTextureAlphaForHeight_MetaData[] = {
		{ "Category", "HeightPatch" },
		{ "Comment", "/** \n\x09 * When true, texture alpha channel will be used when applying the patch. Note that the source data needs to\n\x09 * have an alpha channel for this to have an effect.\n\x09 */" },
		{ "ModuleRelativePath", "Public/LandscapeTexturePatch.h" },
		{ "ToolTip", "When true, texture alpha channel will be used when applying the patch. Note that the source data needs to\nhave an alpha channel for this to have an effect." },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bUseTextureAlphaForHeight = { "bUseTextureAlphaForHeight", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULandscapeTexturePatch), &Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bUseTextureAlphaForHeight_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bUseTextureAlphaForHeight_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bUseTextureAlphaForHeight_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightEncoding_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightEncoding = { "HeightEncoding", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, HeightEncoding), Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchEncoding, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightEncoding_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightEncoding_MetaData) }; // 3977694404
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightEncodingSettings = { "HeightEncodingSettings", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, HeightEncodingSettings), Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightEncodingSettings_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightEncodingSettings_MetaData) }; // 2512456930
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ZeroHeightMeaning_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ZeroHeightMeaning = { "ZeroHeightMeaning", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, ZeroHeightMeaning), Z_Construct_UEnum_LandscapePatch_ELandscapeTextureHeightPatchZeroHeightMeaning, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ZeroHeightMeaning_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ZeroHeightMeaning_MetaData) }; // 1387781771
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bApplyComponentZScale = { "bApplyComponentZScale", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULandscapeTexturePatch), &Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bApplyComponentZScale_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bApplyComponentZScale_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bApplyComponentZScale_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_WeightPatches_Inner = { "WeightPatches", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_ULandscapeWeightPatchTextureInfo_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_WeightPatches_Inner_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_WeightPatches_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_WeightPatches = { "WeightPatches", nullptr, (EPropertyFlags)0x0024088000000809, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, WeightPatches), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_WeightPatches_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_WeightPatches_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_NumWeightPatches = { "NumWeightPatches", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, NumWeightPatches), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_NumWeightPatches_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_NumWeightPatches_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bBaseResolutionOffLandscape = { "bBaseResolutionOffLandscape", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ULandscapeTexturePatch), &Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bBaseResolutionOffLandscape_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bBaseResolutionOffLandscape_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_bBaseResolutionOffLandscape_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionMultiplier = { "ResolutionMultiplier", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, ResolutionMultiplier), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionMultiplier_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_ResolutionMultiplier_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_InitTextureSizeX = { "InitTextureSizeX", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, InitTextureSizeX), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_InitTextureSizeX_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_InitTextureSizeX_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_InitTextureSizeY = { "InitTextureSizeY", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, InitTextureSizeY), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_InitTextureSizeY_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_InitTextureSizeY_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightRenderTargetFormat = { "HeightRenderTargetFormat", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULandscapeTexturePatch, HeightRenderTargetFormat), Z_Construct_UEnum_Engine_ETextureRenderTargetFormat, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightRenderTargetFormat_MetaData), Z_Construct_UClass_ULandscapeTexturePatch_Statics::NewProp_HeightRenderTargetFormat_MetaData) }; // 161131239
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULandscapeTexturePatch_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::Class_MetaDataParams), Z_Construct_UClass_ULandscapeTexturePatch_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeTexturePatch_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapeTexturePatch_h_Statics::EnumInfo[] = {
		{ ELandscapeTexturePatchSourceMode_StaticEnum, TEXT("ELandscapeTexturePatchSourceMode"), &Z_Registration_Info_UEnum_ELandscapeTexturePatchSourceMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1312921026U) },
		{ ELandscapeTexturePatchBlendMode_StaticEnum, TEXT("ELandscapeTexturePatchBlendMode"), &Z_Registration_Info_UEnum_ELandscapeTexturePatchBlendMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1933627727U) },
		{ ELandscapeTexturePatchFalloffMode_StaticEnum, TEXT("ELandscapeTexturePatchFalloffMode"), &Z_Registration_Info_UEnum_ELandscapeTexturePatchFalloffMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 144526283U) },
		{ ELandscapeTextureHeightPatchEncoding_StaticEnum, TEXT("ELandscapeTextureHeightPatchEncoding"), &Z_Registration_Info_UEnum_ELandscapeTextureHeightPatchEncoding, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3977694404U) },
		{ ELandscapeTextureHeightPatchZeroHeightMeaning_StaticEnum, TEXT("ELandscapeTextureHeightPatchZeroHeightMeaning"), &Z_Registration_Info_UEnum_ELandscapeTextureHeightPatchZeroHeightMeaning, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1387781771U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapeTexturePatch_h_Statics::ScriptStructInfo[] = {
		{ FLandscapeTexturePatchEncodingSettings::StaticStruct, Z_Construct_UScriptStruct_FLandscapeTexturePatchEncodingSettings_Statics::NewStructOps, TEXT("LandscapeTexturePatchEncodingSettings"), &Z_Registration_Info_UScriptStruct_LandscapeTexturePatchEncodingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLandscapeTexturePatchEncodingSettings), 2512456930U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapeTexturePatch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULandscapeWeightPatchTextureInfo, ULandscapeWeightPatchTextureInfo::StaticClass, TEXT("ULandscapeWeightPatchTextureInfo"), &Z_Registration_Info_UClass_ULandscapeWeightPatchTextureInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeWeightPatchTextureInfo), 2189147774U) },
		{ Z_Construct_UClass_ULandscapeTexturePatch, ULandscapeTexturePatch::StaticClass, TEXT("ULandscapeTexturePatch"), &Z_Registration_Info_UClass_ULandscapeTexturePatch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeTexturePatch), 2685087690U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapeTexturePatch_h_369848534(TEXT("/Script/LandscapePatch"),
