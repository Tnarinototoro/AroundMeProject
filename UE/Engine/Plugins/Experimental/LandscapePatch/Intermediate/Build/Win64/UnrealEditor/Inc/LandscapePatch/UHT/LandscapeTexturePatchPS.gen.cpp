...
template<> LANDSCAPEPATCH_API UScriptStruct* StaticStruct<FLandscapeHeightPatchConvertToNativeParams>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_ZeroInEncoding = { "ZeroInEncoding", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandscapeHeightPatchConvertToNativeParams, ZeroInEncoding), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_ZeroInEncoding_MetaData), Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_ZeroInEncoding_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_HeightScale = { "HeightScale", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandscapeHeightPatchConvertToNativeParams, HeightScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_HeightScale_MetaData), Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_HeightScale_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_HeightOffset = { "HeightOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLandscapeHeightPatchConvertToNativeParams, HeightOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_HeightOffset_MetaData), Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::NewProp_HeightOffset_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLandscapeHeightPatchConvertToNativeParams_Statics::PropPointers) < 2048);
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_LandscapePatch_Source_LandscapePatch_Public_LandscapeTexturePatchPS_h_1210679520(TEXT("/Script/LandscapePatch"),
		nullptr, 0,
