...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UColorCorrectRegionsSubsystem_RefreshStenciIdAssignmentForAllCCR_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UColorCorrectRegionsSubsystem, nullptr, "RefreshStenciIdAssignmentForAllCCR", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UColorCorrectRegionsSubsystem_RefreshStenciIdAssignmentForAllCCR_Statics::Function_MetaDataParams), Z_Construct_UFunction_UColorCorrectRegionsSubsystem_RefreshStenciIdAssignmentForAllCCR_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UColorCorrectRegionsSubsystem_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UColorCorrectRegionsSubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UColorCorrectRegionsSubsystem_RefreshStenciIdAssignmentForAllCCR, "RefreshStenciIdAssignmentForAllCCR" }, // 118208530
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UColorCorrectRegionsSubsystem_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UColorCorrectRegionsSubsystem_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UColorCorrectRegionsSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UColorCorrectRegionsSubsystem_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ColorCorrectRegions_Source_ColorCorrectRegions_Public_ColorCorrectRegionsSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UColorCorrectRegionsSubsystem, UColorCorrectRegionsSubsystem::StaticClass, TEXT("UColorCorrectRegionsSubsystem"), &Z_Registration_Info_UClass_UColorCorrectRegionsSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UColorCorrectRegionsSubsystem), 3008583499U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ColorCorrectRegions_Source_ColorCorrectRegions_Public_ColorCorrectRegionsSubsystem_h_353978348(TEXT("/Script/ColorCorrectRegions"),
