...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterEnum_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UChooserParameterEnum_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterEnum_Statics::Class_MetaDataParams), Z_Construct_UClass_UChooserParameterEnum_Statics::Class_MetaDataParams)
	};
...
template<> CHOOSER_API UScriptStruct* StaticStruct<FChooserParameterEnumBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChooserParameterEnumBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChooserParameterEnumBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FChooserParameterEnumBase_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterEnum_h_Statics::ScriptStructInfo[] = {
		{ FChooserParameterEnumBase::StaticStruct, Z_Construct_UScriptStruct_FChooserParameterEnumBase_Statics::NewStructOps, TEXT("ChooserParameterEnumBase"), &Z_Registration_Info_UScriptStruct_ChooserParameterEnumBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChooserParameterEnumBase), 3731910539U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterEnum_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChooserParameterEnum, UChooserParameterEnum::StaticClass, TEXT("UChooserParameterEnum"), &Z_Registration_Info_UClass_UChooserParameterEnum, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChooserParameterEnum), 723708276U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterEnum_h_3289442844(TEXT("/Script/Chooser"),
