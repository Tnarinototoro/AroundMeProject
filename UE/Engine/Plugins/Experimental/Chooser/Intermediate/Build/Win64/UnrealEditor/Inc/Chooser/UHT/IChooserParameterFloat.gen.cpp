...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterFloat_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UChooserParameterFloat_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterFloat_Statics::Class_MetaDataParams), Z_Construct_UClass_UChooserParameterFloat_Statics::Class_MetaDataParams)
	};
...
template<> CHOOSER_API UScriptStruct* StaticStruct<FChooserParameterFloatBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChooserParameterFloatBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChooserParameterFloatBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FChooserParameterFloatBase_Statics::Struct_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterFloat_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChooserParameterFloat, UChooserParameterFloat::StaticClass, TEXT("UChooserParameterFloat"), &Z_Registration_Info_UClass_UChooserParameterFloat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChooserParameterFloat), 3215300763U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterFloat_h_1225915577(TEXT("/Script/Chooser"),
