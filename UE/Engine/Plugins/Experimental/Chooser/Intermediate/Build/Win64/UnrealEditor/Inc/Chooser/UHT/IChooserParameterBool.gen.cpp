...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterBool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UChooserParameterBool_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterBool_Statics::Class_MetaDataParams), Z_Construct_UClass_UChooserParameterBool_Statics::Class_MetaDataParams)
	};
...
template<> CHOOSER_API UScriptStruct* StaticStruct<FChooserParameterBoolBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChooserParameterBoolBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChooserParameterBoolBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FChooserParameterBoolBase_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterBool_h_Statics::ScriptStructInfo[] = {
		{ FChooserParameterBoolBase::StaticStruct, Z_Construct_UScriptStruct_FChooserParameterBoolBase_Statics::NewStructOps, TEXT("ChooserParameterBoolBase"), &Z_Registration_Info_UScriptStruct_ChooserParameterBoolBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChooserParameterBoolBase), 4273337052U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterBool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChooserParameterBool, UChooserParameterBool::StaticClass, TEXT("UChooserParameterBool"), &Z_Registration_Info_UClass_UChooserParameterBool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChooserParameterBool), 3489182152U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterBool_h_3671464412(TEXT("/Script/Chooser"),
