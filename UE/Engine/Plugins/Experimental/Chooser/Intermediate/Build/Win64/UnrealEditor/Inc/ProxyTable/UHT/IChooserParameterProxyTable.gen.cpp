...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterProxyTable_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UChooserParameterProxyTable_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserParameterProxyTable_Statics::Class_MetaDataParams), Z_Construct_UClass_UChooserParameterProxyTable_Statics::Class_MetaDataParams)
	};
...
template<> PROXYTABLE_API UScriptStruct* StaticStruct<FChooserParameterProxyTableBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChooserParameterProxyTableBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChooserParameterProxyTableBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FChooserParameterProxyTableBase_Statics::Struct_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_ProxyTable_Public_IChooserParameterProxyTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChooserParameterProxyTable, UChooserParameterProxyTable::StaticClass, TEXT("UChooserParameterProxyTable"), &Z_Registration_Info_UClass_UChooserParameterProxyTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChooserParameterProxyTable), 3420279677U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_ProxyTable_Public_IChooserParameterProxyTable_h_1409554475(TEXT("/Script/ProxyTable"),
