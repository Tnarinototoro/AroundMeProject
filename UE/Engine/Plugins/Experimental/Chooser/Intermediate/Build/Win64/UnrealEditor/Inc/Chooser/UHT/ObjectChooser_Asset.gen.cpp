...
template<> CHOOSER_API UScriptStruct* StaticStruct<FAssetChooser>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAssetChooser_Statics::NewProp_Asset = { "Asset", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAssetChooser, Asset), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetChooser_Statics::NewProp_Asset_MetaData), Z_Construct_UScriptStruct_FAssetChooser_Statics::NewProp_Asset_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAssetChooser_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetChooser_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAssetChooser_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetChooser_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::NewProp_Asset = { "Asset", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDEPRECATED_ObjectChooser_Asset, Asset), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::NewProp_Asset_MetaData), Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::NewProp_Asset_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UObjectChooser_NoRegister, (int32)VTABLE_OFFSET(UDEPRECATED_ObjectChooser_Asset, IObjectChooser), false },  // 1520499641
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::ClassParams = {
		...
		0x021002A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::Class_MetaDataParams), Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Internal_ObjectChooser_Asset_h_Statics::ScriptStructInfo[] = {
		{ FAssetChooser::StaticStruct, Z_Construct_UScriptStruct_FAssetChooser_Statics::NewStructOps, TEXT("AssetChooser"), &Z_Registration_Info_UScriptStruct_AssetChooser, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAssetChooser), 3844377778U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Internal_ObjectChooser_Asset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_ObjectChooser_Asset, UDEPRECATED_ObjectChooser_Asset::StaticClass, TEXT("UDEPRECATED_ObjectChooser_Asset"), &Z_Registration_Info_UClass_UDEPRECATED_ObjectChooser_Asset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_ObjectChooser_Asset), 3638501487U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Internal_ObjectChooser_Asset_h_643357378(TEXT("/Script/Chooser"),
