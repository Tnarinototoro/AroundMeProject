...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserColumn_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UChooserColumn_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UChooserColumn_Statics::Class_MetaDataParams), Z_Construct_UClass_UChooserColumn_Statics::Class_MetaDataParams)
	};
...
template<> CHOOSER_API UScriptStruct* StaticStruct<FChooserColumnBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChooserColumnBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChooserColumnBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FChooserColumnBase_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserColumn_h_Statics::ScriptStructInfo[] = {
		{ FChooserColumnBase::StaticStruct, Z_Construct_UScriptStruct_FChooserColumnBase_Statics::NewStructOps, TEXT("ChooserColumnBase"), &Z_Registration_Info_UScriptStruct_ChooserColumnBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChooserColumnBase), 3620595727U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserColumn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChooserColumn, UChooserColumn::StaticClass, TEXT("UChooserColumn"), &Z_Registration_Info_UClass_UChooserColumn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChooserColumn), 928999322U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserColumn_h_1773594288(TEXT("/Script/Chooser"),
