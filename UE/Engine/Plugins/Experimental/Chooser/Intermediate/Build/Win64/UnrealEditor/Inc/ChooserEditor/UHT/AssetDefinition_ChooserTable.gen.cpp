...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_ChooserTable_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssetDefinition_ChooserTable_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssetDefinition_ChooserTable_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssetDefinition_ChooserTable_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_ChooserEditor_Private_AssetDefinition_ChooserTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_ChooserTable, UAssetDefinition_ChooserTable::StaticClass, TEXT("UAssetDefinition_ChooserTable"), &Z_Registration_Info_UClass_UAssetDefinition_ChooserTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_ChooserTable), 4050466033U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_ChooserEditor_Private_AssetDefinition_ChooserTable_h_2256820101(TEXT("/Script/ChooserEditor"),
