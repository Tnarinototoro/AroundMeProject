...
template<> CHOOSER_API UScriptStruct* StaticStruct<FChooserParameterBase>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FChooserParameterBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChooserParameterBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FChooserParameterBase_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterBase_h_Statics::ScriptStructInfo[] = {
		{ FChooserParameterBase::StaticStruct, Z_Construct_UScriptStruct_FChooserParameterBase_Statics::NewStructOps, TEXT("ChooserParameterBase"), &Z_Registration_Info_UScriptStruct_ChooserParameterBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChooserParameterBase), 3050682619U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Chooser_Source_Chooser_Public_IChooserParameterBase_h_3130558038(TEXT("/Script/Chooser"),
		nullptr, 0,
