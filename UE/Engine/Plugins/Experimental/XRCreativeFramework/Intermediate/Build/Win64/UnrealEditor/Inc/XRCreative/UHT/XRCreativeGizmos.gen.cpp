...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeGizmoBuilder_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeGizmoBuilder_Statics::ClassParams = {
		...
		0,
		0x000000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeGizmoBuilder_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeGizmoBuilder_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeBaseTransformGizmoActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AXRCreativeBaseTransformGizmoActor_Statics::ClassParams = {
		...
		0,
		0x008002ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeBaseTransformGizmoActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AXRCreativeBaseTransformGizmoActor_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTRSGizmoActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AXRCreativeTRSGizmoActor_Statics::ClassParams = {
		...
		0,
		0x008002ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTRSGizmoActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AXRCreativeTRSGizmoActor_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTRUSGizmoActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AXRCreativeTRUSGizmoActor_Statics::ClassParams = {
		...
		0,
		0x008002ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTRUSGizmoActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AXRCreativeTRUSGizmoActor_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTRGizmoActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AXRCreativeTRGizmoActor_Statics::ClassParams = {
		...
		0,
		0x008002ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTRGizmoActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AXRCreativeTRGizmoActor_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeGizmos_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UXRCreativeGizmoBuilder, UXRCreativeGizmoBuilder::StaticClass, TEXT("UXRCreativeGizmoBuilder"), &Z_Registration_Info_UClass_UXRCreativeGizmoBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeGizmoBuilder), 715046846U) },
		{ Z_Construct_UClass_AXRCreativeBaseTransformGizmoActor, AXRCreativeBaseTransformGizmoActor::StaticClass, TEXT("AXRCreativeBaseTransformGizmoActor"), &Z_Registration_Info_UClass_AXRCreativeBaseTransformGizmoActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AXRCreativeBaseTransformGizmoActor), 862470622U) },
		{ Z_Construct_UClass_AXRCreativeTRSGizmoActor, AXRCreativeTRSGizmoActor::StaticClass, TEXT("AXRCreativeTRSGizmoActor"), &Z_Registration_Info_UClass_AXRCreativeTRSGizmoActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AXRCreativeTRSGizmoActor), 1166659930U) },
		{ Z_Construct_UClass_AXRCreativeTRUSGizmoActor, AXRCreativeTRUSGizmoActor::StaticClass, TEXT("AXRCreativeTRUSGizmoActor"), &Z_Registration_Info_UClass_AXRCreativeTRUSGizmoActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AXRCreativeTRUSGizmoActor), 1357974372U) },
		{ Z_Construct_UClass_AXRCreativeTRGizmoActor, AXRCreativeTRGizmoActor::StaticClass, TEXT("AXRCreativeTRGizmoActor"), &Z_Registration_Info_UClass_AXRCreativeTRGizmoActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AXRCreativeTRGizmoActor), 3412375778U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeGizmos_h_1353940170(TEXT("/Script/XRCreative"),
