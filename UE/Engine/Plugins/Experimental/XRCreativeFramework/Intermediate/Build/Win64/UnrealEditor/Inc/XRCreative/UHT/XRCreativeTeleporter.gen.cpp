...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTeleporter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_LeftController = { "LeftController", nullptr, (EPropertyFlags)0x002408000008001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AXRCreativeTeleporter, LeftController), Z_Construct_UClass_UMotionControllerComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_LeftController_MetaData), Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_LeftController_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_RightController = { "RightController", nullptr, (EPropertyFlags)0x002408000008001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AXRCreativeTeleporter, RightController), Z_Construct_UClass_UMotionControllerComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_RightController_MetaData), Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_RightController_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_TeleportMesh = { "TeleportMesh", nullptr, (EPropertyFlags)0x002408000008001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AXRCreativeTeleporter, TeleportMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_TeleportMesh_MetaData), Z_Construct_UClass_AXRCreativeTeleporter_Statics::NewProp_TeleportMesh_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AXRCreativeTeleporter_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTeleporter_Statics::Class_MetaDataParams), Z_Construct_UClass_AXRCreativeTeleporter_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeTeleporter_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeTeleporter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AXRCreativeTeleporter, AXRCreativeTeleporter::StaticClass, TEXT("AXRCreativeTeleporter"), &Z_Registration_Info_UClass_AXRCreativeTeleporter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AXRCreativeTeleporter), 2571870654U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeTeleporter_h_1918199964(TEXT("/Script/XRCreative"),
