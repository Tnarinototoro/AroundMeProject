...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(XRCreativeSettings_eventGetXRCreativeSettings_Parms, ReturnValue), Z_Construct_UClass_UXRCreativeSettings_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UXRCreativeSettings, nullptr, "GetXRCreativeSettings", nullptr, nullptr, Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::XRCreativeSettings_eventGetXRCreativeSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings_Statics::XRCreativeSettings_eventGetXRCreativeSettings_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSettings_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UXRCreativeSettings_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UXRCreativeSettings_GetXRCreativeSettings, "GetXRCreativeSettings" }, // 3466119710
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSettings_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_bUseImperial = { "bUseImperial", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UXRCreativeSettings), &Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_bUseImperial_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_bUseImperial_MetaData), Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_bUseImperial_MetaData) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_FloatArray_Inner = { "FloatArray", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_FloatArray = { "FloatArray", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeSettings, FloatArray), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_FloatArray_MetaData), Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_FloatArray_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_SubsystemHelpersClass = { "SubsystemHelpersClass", nullptr, (EPropertyFlags)0x0014000000004005, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeSettings, SubsystemHelpersClass), Z_Construct_UClass_UXRCreativeSubsystemHelpers_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_SubsystemHelpersClass_MetaData), Z_Construct_UClass_UXRCreativeSettings_Statics::NewProp_SubsystemHelpersClass_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UXRCreativeSettings, UXRCreativeSettings::StaticClass, TEXT("UXRCreativeSettings"), &Z_Registration_Info_UClass_UXRCreativeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeSettings), 1087232150U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeSettings_h_2899588140(TEXT("/Script/XRCreative"),
