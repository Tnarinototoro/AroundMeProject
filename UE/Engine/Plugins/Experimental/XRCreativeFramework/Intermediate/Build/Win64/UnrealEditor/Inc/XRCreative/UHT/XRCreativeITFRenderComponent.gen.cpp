...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeITFRenderComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeITFRenderComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeITFRenderComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeITFRenderComponent_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Private_ITF_XRCreativeITFRenderComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UXRCreativeITFRenderComponent, UXRCreativeITFRenderComponent::StaticClass, TEXT("UXRCreativeITFRenderComponent"), &Z_Registration_Info_UClass_UXRCreativeITFRenderComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeITFRenderComponent), 4079025814U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Private_ITF_XRCreativeITFRenderComponent_h_928019199(TEXT("/Script/XRCreative"),
