...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::NewProp_ClickBehavior = { "ClickBehavior", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeSelectionInteraction, ClickBehavior), Z_Construct_UClass_USingleClickInputBehavior_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::NewProp_ClickBehavior_MetaData), Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::NewProp_ClickBehavior_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::NewProp_BehaviorSet = { "BehaviorSet", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeSelectionInteraction, BehaviorSet), Z_Construct_UClass_UInputBehaviorSet_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::NewProp_BehaviorSet_MetaData), Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::NewProp_BehaviorSet_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UInputBehaviorSource_NoRegister, (int32)VTABLE_OFFSET(UXRCreativeSelectionInteraction, IInputBehaviorSource), false },  // 2065520268
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::ClassParams = {
		...
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeSelectionInteraction_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Private_ITF_SelectionInteraction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UXRCreativeSelectionInteraction, UXRCreativeSelectionInteraction::StaticClass, TEXT("UXRCreativeSelectionInteraction"), &Z_Registration_Info_UClass_UXRCreativeSelectionInteraction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeSelectionInteraction), 2236083972U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Private_ITF_SelectionInteraction_h_2877429243(TEXT("/Script/XRCreative"),
