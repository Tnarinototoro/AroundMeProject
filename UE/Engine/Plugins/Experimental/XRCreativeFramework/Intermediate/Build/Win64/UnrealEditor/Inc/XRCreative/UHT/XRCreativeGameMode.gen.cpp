...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeGameMode_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_AXRCreativeGameMode_Statics::NewProp_ToolsetClass = { "ToolsetClass", nullptr, (EPropertyFlags)0x0024080000010015, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AXRCreativeGameMode, ToolsetClass), Z_Construct_UClass_UXRCreativeToolset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeGameMode_Statics::NewProp_ToolsetClass_MetaData), Z_Construct_UClass_AXRCreativeGameMode_Statics::NewProp_ToolsetClass_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AXRCreativeGameMode_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeGameMode_Statics::Class_MetaDataParams), Z_Construct_UClass_AXRCreativeGameMode_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AXRCreativeGameMode_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AXRCreativeGameMode, AXRCreativeGameMode::StaticClass, TEXT("AXRCreativeGameMode"), &Z_Registration_Info_UClass_AXRCreativeGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AXRCreativeGameMode), 2635666857U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeGameMode_h_798651173(TEXT("/Script/XRCreative"),
