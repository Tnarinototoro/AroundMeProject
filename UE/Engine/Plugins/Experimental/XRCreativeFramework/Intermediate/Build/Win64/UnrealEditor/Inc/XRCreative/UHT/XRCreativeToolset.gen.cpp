...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePaletteTab_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativePaletteTab_Statics::ClassParams = {
		...
		0,
		0x00A010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePaletteTab_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativePaletteTab_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePalette_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UXRCreativePalette_Statics::NewProp_Tabs_Inner = { "Tabs", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UXRCreativePaletteTab_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UXRCreativePalette_Statics::NewProp_Tabs = { "Tabs", nullptr, (EPropertyFlags)0x002408800000001c, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativePalette, Tabs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePalette_Statics::NewProp_Tabs_MetaData), Z_Construct_UClass_UXRCreativePalette_Statics::NewProp_Tabs_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UXRCreativePalette_Statics::NewProp_Owner = { "Owner", nullptr, (EPropertyFlags)0x0024080000000014, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativePalette, Owner), Z_Construct_UClass_AXRCreativeAvatar_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePalette_Statics::NewProp_Owner_MetaData), Z_Construct_UClass_UXRCreativePalette_Statics::NewProp_Owner_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativePalette_Statics::ClassParams = {
		...
		0,
		0x00A010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePalette_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativePalette_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePalette_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(XRCreativeTool_eventGetDisplayName_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UXRCreativeTool, nullptr, "GetDisplayName", nullptr, nullptr, Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::XRCreativeTool_eventGetDisplayName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UXRCreativeTool_GetDisplayName_Statics::XRCreativeTool_eventGetDisplayName_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0014000000000580, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(XRCreativeTool_eventGetPaletteTabClass_Parms, ReturnValue), Z_Construct_UClass_UClass, Z_Construct_UClass_UXRCreativePaletteToolTab_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UXRCreativeTool, nullptr, "GetPaletteTabClass", nullptr, nullptr, Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::PropPointers), sizeof(Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::XRCreativeTool_eventGetPaletteTabClass_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::Function_MetaDataParams), Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass_Statics::XRCreativeTool_eventGetPaletteTabClass_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(XRCreativeTool_eventGetToolName_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UXRCreativeTool, nullptr, "GetToolName", nullptr, nullptr, Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::XRCreativeTool_eventGetToolName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UXRCreativeTool_GetToolName_Statics::XRCreativeTool_eventGetToolName_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeTool_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UXRCreativeTool_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UXRCreativeTool_GetDisplayName, "GetDisplayName" }, // 2502773387
		{ &Z_Construct_UFunction_UXRCreativeTool_GetPaletteTabClass, "GetPaletteTabClass" }, // 1938233200
		{ &Z_Construct_UFunction_UXRCreativeTool_GetToolName, "GetToolName" }, // 3122436884
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeTool_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeTool_Statics::ClassParams = {
		...
		0,
		0x000000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeTool_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolName = { "ToolName", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeBlueprintableTool, ToolName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolName_MetaData), Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeBlueprintableTool, DisplayName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_DisplayName_MetaData), Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_DisplayName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_PaletteTabClass = { "PaletteTabClass", nullptr, (EPropertyFlags)0x0024080000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeBlueprintableTool, PaletteTabClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UXRCreativePaletteToolTab_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_PaletteTabClass_MetaData), Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_PaletteTabClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolActor = { "ToolActor", nullptr, (EPropertyFlags)0x0024080000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeBlueprintableTool, ToolActor), Z_Construct_UClass_UClass, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolActor_MetaData), Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolActor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolInputMappingContext = { "ToolInputMappingContext", nullptr, (EPropertyFlags)0x0024080000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeBlueprintableTool, ToolInputMappingContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolInputMappingContext_MetaData), Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::NewProp_ToolInputMappingContext_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::ClassParams = {
		...
		0,
		0x000000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeBlueprintableTool_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::NewProp_Tool = { "Tool", nullptr, (EPropertyFlags)0x0024080000000014, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativePaletteToolTab, Tool), Z_Construct_UClass_UXRCreativeTool_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::NewProp_Tool_MetaData), Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::NewProp_Tool_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::ClassParams = {
		...
		0,
		0x00A010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativePaletteToolTab_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_RegularTextStyle = { "RegularTextStyle", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeStyle, RegularTextStyle), Z_Construct_UClass_UClass, Z_Construct_UClass_UCommonTextStyle_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_RegularTextStyle_MetaData), Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_RegularTextStyle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_BoldTextStyle = { "BoldTextStyle", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeStyle, BoldTextStyle), Z_Construct_UClass_UClass, Z_Construct_UClass_UCommonTextStyle_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_BoldTextStyle_MetaData), Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_BoldTextStyle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_ItalicTextStyle = { "ItalicTextStyle", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeStyle, ItalicTextStyle), Z_Construct_UClass_UClass, Z_Construct_UClass_UCommonTextStyle_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_ItalicTextStyle_MetaData), Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_ItalicTextStyle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_RegularButtonStyle = { "RegularButtonStyle", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeStyle, RegularButtonStyle), Z_Construct_UClass_UClass, Z_Construct_UClass_UCommonButtonStyle_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_RegularButtonStyle_MetaData), Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_RegularButtonStyle_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_LargeButtonStyle = { "LargeButtonStyle", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeStyle, LargeButtonStyle), Z_Construct_UClass_UClass, Z_Construct_UClass_UCommonButtonStyle_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_LargeButtonStyle_MetaData), Z_Construct_UClass_UXRCreativeStyle_Statics::NewProp_LargeButtonStyle_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeStyle_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeStyle_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeStyle_Statics::PropPointers) < 2048);
...
template<> XRCREATIVE_API UScriptStruct* StaticStruct<FXRCreativeToolEntry>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::NewProp_ToolClass = { "ToolClass", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FXRCreativeToolEntry, ToolClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UXRCreativeTool_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::NewProp_ToolClass_MetaData), Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::NewProp_ToolClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::NewProp_ToolIcon = { "ToolIcon", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FXRCreativeToolEntry, ToolIcon), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::NewProp_ToolIcon_MetaData), Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::NewProp_ToolIcon_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeToolset_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Avatar = { "Avatar", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeToolset, Avatar), Z_Construct_UClass_UClass, Z_Construct_UClass_AXRCreativeAvatar_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Avatar_MetaData), Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Avatar_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Tools_Inner = { "Tools", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FXRCreativeToolEntry, METADATA_PARAMS(0, nullptr) }; // 1150166981
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Tools = { "Tools", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeToolset, Tools), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Tools_MetaData), Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Tools_MetaData) }; // 1150166981
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Palette = { "Palette", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeToolset, Palette), Z_Construct_UClass_UClass, Z_Construct_UClass_UXRCreativePalette_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Palette_MetaData), Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Palette_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Style = { "Style", nullptr, (EPropertyFlags)0x0014000000010015, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UXRCreativeToolset, Style), Z_Construct_UClass_UXRCreativeStyle_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Style_MetaData), Z_Construct_UClass_UXRCreativeToolset_Statics::NewProp_Style_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UXRCreativeToolset_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeToolset_Statics::Class_MetaDataParams), Z_Construct_UClass_UXRCreativeToolset_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UXRCreativeToolset_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeToolset_h_Statics::ScriptStructInfo[] = {
		{ FXRCreativeToolEntry::StaticStruct, Z_Construct_UScriptStruct_FXRCreativeToolEntry_Statics::NewStructOps, TEXT("XRCreativeToolEntry"), &Z_Registration_Info_UScriptStruct_XRCreativeToolEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FXRCreativeToolEntry), 1150166981U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeToolset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UXRCreativePaletteTab, UXRCreativePaletteTab::StaticClass, TEXT("UXRCreativePaletteTab"), &Z_Registration_Info_UClass_UXRCreativePaletteTab, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativePaletteTab), 3674079476U) },
		{ Z_Construct_UClass_UXRCreativePalette, UXRCreativePalette::StaticClass, TEXT("UXRCreativePalette"), &Z_Registration_Info_UClass_UXRCreativePalette, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativePalette), 3835914358U) },
		{ Z_Construct_UClass_UXRCreativeTool, UXRCreativeTool::StaticClass, TEXT("UXRCreativeTool"), &Z_Registration_Info_UClass_UXRCreativeTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeTool), 4133714839U) },
		{ Z_Construct_UClass_UXRCreativeBlueprintableTool, UXRCreativeBlueprintableTool::StaticClass, TEXT("UXRCreativeBlueprintableTool"), &Z_Registration_Info_UClass_UXRCreativeBlueprintableTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeBlueprintableTool), 1250281295U) },
		{ Z_Construct_UClass_UXRCreativePaletteToolTab, UXRCreativePaletteToolTab::StaticClass, TEXT("UXRCreativePaletteToolTab"), &Z_Registration_Info_UClass_UXRCreativePaletteToolTab, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativePaletteToolTab), 2436297380U) },
		{ Z_Construct_UClass_UXRCreativeStyle, UXRCreativeStyle::StaticClass, TEXT("UXRCreativeStyle"), &Z_Registration_Info_UClass_UXRCreativeStyle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeStyle), 526500073U) },
		{ Z_Construct_UClass_UXRCreativeToolset, UXRCreativeToolset::StaticClass, TEXT("UXRCreativeToolset"), &Z_Registration_Info_UClass_UXRCreativeToolset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UXRCreativeToolset), 3444458796U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_XRCreativeFramework_Source_XRCreative_Public_XRCreativeToolset_h_939666435(TEXT("/Script/XRCreative"),
