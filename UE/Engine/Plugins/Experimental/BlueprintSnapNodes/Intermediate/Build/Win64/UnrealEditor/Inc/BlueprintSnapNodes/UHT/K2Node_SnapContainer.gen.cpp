...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_SnapContainer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UK2Node_SnapContainer_Statics::NewProp_RootNode = { "RootNode", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UK2Node_SnapContainer, RootNode), Z_Construct_UClass_UK2Node_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_SnapContainer_Statics::NewProp_RootNode_MetaData), Z_Construct_UClass_UK2Node_SnapContainer_Statics::NewProp_RootNode_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_SnapContainer_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_SnapContainer_Statics::Class_MetaDataParams), Z_Construct_UClass_UK2Node_SnapContainer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_SnapContainer_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_BlueprintSnapNodes_Source_BlueprintSnapNodes_Private_K2Node_SnapContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UK2Node_SnapContainer, UK2Node_SnapContainer::StaticClass, TEXT("UK2Node_SnapContainer"), &Z_Registration_Info_UClass_UK2Node_SnapContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UK2Node_SnapContainer), 37644913U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_BlueprintSnapNodes_Source_BlueprintSnapNodes_Private_K2Node_SnapContainer_h_3653020711(TEXT("/Script/BlueprintSnapNodes"),
