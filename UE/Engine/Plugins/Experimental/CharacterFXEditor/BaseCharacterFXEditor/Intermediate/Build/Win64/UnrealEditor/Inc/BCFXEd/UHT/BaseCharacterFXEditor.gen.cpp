...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBaseCharacterFXEditor_Statics::NewProp_OriginalObjectsToEdit = { "OriginalObjectsToEdit", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBaseCharacterFXEditor, OriginalObjectsToEdit), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCharacterFXEditor_Statics::NewProp_OriginalObjectsToEdit_MetaData), Z_Construct_UClass_UBaseCharacterFXEditor_Statics::NewProp_OriginalObjectsToEdit_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CharacterFXEditor_BaseCharacterFXEditor_Source_BaseCharacterFXEditor_Public_BaseCharacterFXEditor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBaseCharacterFXEditor, UBaseCharacterFXEditor::StaticClass, TEXT("UBaseCharacterFXEditor"), &Z_Registration_Info_UClass_UBaseCharacterFXEditor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseCharacterFXEditor), 719178376U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_CharacterFXEditor_BaseCharacterFXEditor_Source_BaseCharacterFXEditor_Public_BaseCharacterFXEditor_h_1427582711(TEXT("/Script/BaseCharacterFXEditor"),
