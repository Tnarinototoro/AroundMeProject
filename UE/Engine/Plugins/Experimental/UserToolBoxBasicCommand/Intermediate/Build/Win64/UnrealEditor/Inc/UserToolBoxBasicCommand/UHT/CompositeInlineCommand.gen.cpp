...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeInlineCommand_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompositeInlineCommand_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeInlineCommand_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompositeInlineCommand_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_CompositeInlineCommand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompositeInlineCommand, UCompositeInlineCommand::StaticClass, TEXT("UCompositeInlineCommand"), &Z_Registration_Info_UClass_UCompositeInlineCommand, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositeInlineCommand), 2085027497U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_CompositeInlineCommand_h_3046686043(TEXT("/Script/UserToolBoxBasicCommand"),
