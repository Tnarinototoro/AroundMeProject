...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMirrorActorCommand_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_XAxis = { "XAxis", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMirrorActorCommand), &Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_XAxis_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_XAxis_MetaData), Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_XAxis_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_YAxis = { "YAxis", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMirrorActorCommand), &Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_YAxis_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_YAxis_MetaData), Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_YAxis_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_ZAxis = { "ZAxis", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMirrorActorCommand), &Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_ZAxis_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_ZAxis_MetaData), Z_Construct_UClass_UMirrorActorCommand_Statics::NewProp_ZAxis_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMirrorActorCommand_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMirrorActorCommand_Statics::Class_MetaDataParams), Z_Construct_UClass_UMirrorActorCommand_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMirrorActorCommand_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_MirrorActorCommand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMirrorActorCommand, UMirrorActorCommand::StaticClass, TEXT("UMirrorActorCommand"), &Z_Registration_Info_UClass_UMirrorActorCommand, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMirrorActorCommand), 1496338249U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_MirrorActorCommand_h_857073296(TEXT("/Script/UserToolBoxBasicCommand"),
