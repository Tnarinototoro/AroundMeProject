...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCleanHierarchy_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_DSMetadataToPreserve = { "DSMetadataToPreserve", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCleanHierarchy, DSMetadataToPreserve), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_DSMetadataToPreserve_MetaData), Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_DSMetadataToPreserve_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveEmptyBranches = { "RemoveEmptyBranches", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UCleanHierarchy), &Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveEmptyBranches_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveEmptyBranches_MetaData), Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveEmptyBranches_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveIntermediaryActorsWithoutGeometry = { "RemoveIntermediaryActorsWithoutGeometry", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UCleanHierarchy), &Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveIntermediaryActorsWithoutGeometry_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveIntermediaryActorsWithoutGeometry_MetaData), Z_Construct_UClass_UCleanHierarchy_Statics::NewProp_RemoveIntermediaryActorsWithoutGeometry_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCleanHierarchy_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCleanHierarchy_Statics::Class_MetaDataParams), Z_Construct_UClass_UCleanHierarchy_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCleanHierarchy_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_CleanHierarchy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCleanHierarchy, UCleanHierarchy::StaticClass, TEXT("UCleanHierarchy"), &Z_Registration_Info_UClass_UCleanHierarchy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCleanHierarchy), 4280991825U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_CleanHierarchy_h_2531155654(TEXT("/Script/UserToolBoxBasicCommand"),
