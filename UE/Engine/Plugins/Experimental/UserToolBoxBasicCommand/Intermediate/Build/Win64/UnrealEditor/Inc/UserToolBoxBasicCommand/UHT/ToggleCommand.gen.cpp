...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UToggleCommand_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UToggleCommand_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UToggleCommand_Statics::Class_MetaDataParams), Z_Construct_UClass_UToggleCommand_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_ToggleCommand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UToggleCommand, UToggleCommand::StaticClass, TEXT("UToggleCommand"), &Z_Registration_Info_UClass_UToggleCommand, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UToggleCommand), 1279521059U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_ToggleCommand_h_2603609059(TEXT("/Script/UserToolBoxBasicCommand"),
