...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeCommand_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCompositeCommand_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeCommand_Statics::Class_MetaDataParams), Z_Construct_UClass_UCompositeCommand_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_CompositeCommand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompositeCommand, UCompositeCommand::StaticClass, TEXT("UCompositeCommand"), &Z_Registration_Info_UClass_UCompositeCommand, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositeCommand), 2486407278U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_CompositeCommand_h_3676017874(TEXT("/Script/UserToolBoxBasicCommand"),
