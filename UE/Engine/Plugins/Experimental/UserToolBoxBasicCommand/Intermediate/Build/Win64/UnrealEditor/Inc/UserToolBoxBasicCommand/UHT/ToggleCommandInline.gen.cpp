...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UToggleCommandInline_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UToggleCommandInline_Statics::NewProp_Commands_Inner = { "Commands", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UUTBBaseCommand_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UToggleCommandInline_Statics::NewProp_Commands_Inner_MetaData), Z_Construct_UClass_UToggleCommandInline_Statics::NewProp_Commands_Inner_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UToggleCommandInline_Statics::NewProp_Commands = { "Commands", nullptr, (EPropertyFlags)0x001400800000000d, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UToggleCommandInline, Commands), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UToggleCommandInline_Statics::NewProp_Commands_MetaData), Z_Construct_UClass_UToggleCommandInline_Statics::NewProp_Commands_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UToggleCommandInline_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UToggleCommandInline_Statics::Class_MetaDataParams), Z_Construct_UClass_UToggleCommandInline_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UToggleCommandInline_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_ToggleCommandInline_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UToggleCommandInline, UToggleCommandInline::StaticClass, TEXT("UToggleCommandInline"), &Z_Registration_Info_UClass_UToggleCommandInline, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UToggleCommandInline), 67175575U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_ToggleCommandInline_h_1378213028(TEXT("/Script/UserToolBoxBasicCommand"),
