...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMerge_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMerge_Statics::NewProp_Advanced = { "Advanced", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMerge), &Z_Construct_UClass_UMerge_Statics::NewProp_Advanced_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMerge_Statics::NewProp_Advanced_MetaData), Z_Construct_UClass_UMerge_Statics::NewProp_Advanced_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMerge_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMerge_Statics::Class_MetaDataParams), Z_Construct_UClass_UMerge_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMerge_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_MergeCommand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMerge, UMerge::StaticClass, TEXT("UMerge"), &Z_Registration_Info_UClass_UMerge, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMerge), 3314861291U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_MergeCommand_h_238134806(TEXT("/Script/UserToolBoxBasicCommand"),
