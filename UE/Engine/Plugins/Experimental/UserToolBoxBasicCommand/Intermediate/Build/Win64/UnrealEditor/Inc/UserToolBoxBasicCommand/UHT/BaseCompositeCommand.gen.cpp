...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCompositeCommand_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBaseCompositeCommand_Statics::NewProp_Commands = { "Commands", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBaseCompositeCommand, Commands), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCompositeCommand_Statics::NewProp_Commands_MetaData), Z_Construct_UClass_UBaseCompositeCommand_Statics::NewProp_Commands_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBaseCompositeCommand_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCompositeCommand_Statics::Class_MetaDataParams), Z_Construct_UClass_UBaseCompositeCommand_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBaseCompositeCommand_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_BaseCompositeCommand_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBaseCompositeCommand, UBaseCompositeCommand::StaticClass, TEXT("UBaseCompositeCommand"), &Z_Registration_Info_UClass_UBaseCompositeCommand, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseCompositeCommand), 59609053U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UserToolBoxBasicCommand_Source_UserToolBoxBasicCommand_Public_BaseCompositeCommand_h_1502313203(TEXT("/Script/UserToolBoxBasicCommand"),
