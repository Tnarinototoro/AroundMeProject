...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorSimOutputMotoSynth_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMotorSimOutputMotoSynth_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMotorSimOutputMotoSynth_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UAudioMotorSimOutput_NoRegister, (int32)VTABLE_OFFSET(UMotorSimOutputMotoSynth, IAudioMotorSimOutput), false },  // 3118254198
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorSimOutputMotoSynth_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMotorSimOutputMotoSynth_Statics::ClassParams = {
		...
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMotorSimOutputMotoSynth_Statics::Class_MetaDataParams), Z_Construct_UClass_UMotorSimOutputMotoSynth_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_MotorSimOutputMotoSynth_Source_MotorSimOutputMotoSynth_Public_MotorSimOutputMotoSynth_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMotorSimOutputMotoSynth, UMotorSimOutputMotoSynth::StaticClass, TEXT("UMotorSimOutputMotoSynth"), &Z_Registration_Info_UClass_UMotorSimOutputMotoSynth, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMotorSimOutputMotoSynth), 3576039077U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_MotorSimOutputMotoSynth_Source_MotorSimOutputMotoSynth_Public_MotorSimOutputMotoSynth_h_481604005(TEXT("/Script/MotorSimOutputMotoSynth"),
