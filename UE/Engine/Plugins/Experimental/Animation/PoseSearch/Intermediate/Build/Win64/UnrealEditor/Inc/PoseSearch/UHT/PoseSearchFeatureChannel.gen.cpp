...
// End Cross Module References
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchFeatureChannel_h_Statics::EnumInfo[] = {
		...
		{ EPermutationTimeType_StaticEnum, TEXT("EPermutationTimeType"), &Z_Registration_Info_UEnum_EPermutationTimeType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 637987910U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchFeatureChannel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPoseSearchFeatureChannel, UPoseSearchFeatureChannel::StaticClass, TEXT("UPoseSearchFeatureChannel"), &Z_Registration_Info_UClass_UPoseSearchFeatureChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseSearchFeatureChannel), 1824875696U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchFeatureChannel_h_3554468154(TEXT("/Script/PoseSearch"),
