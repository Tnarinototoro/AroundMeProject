...
template<> POSESEARCH_API UScriptStruct* StaticStruct<FMotionMatchingAnimNodeReference>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMotionMatchingAnimNodeLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMotionMatchingAnimNodeLibrary_ConvertToMotionMatchingNode, "ConvertToMotionMatchingNode" }, // 1561357903
		{ &Z_Construct_UFunction_UMotionMatchingAnimNodeLibrary_ConvertToMotionMatchingNodePure, "ConvertToMotionMatchingNodePure" }, // 1017121575
		{ &Z_Construct_UFunction_UMotionMatchingAnimNodeLibrary_ForceInterruptNextUpdate, "ForceInterruptNextUpdate" }, // 1357380765
		{ &Z_Construct_UFunction_UMotionMatchingAnimNodeLibrary_ResetDatabasesToSearch, "ResetDatabasesToSearch" }, // 3125283800
		{ &Z_Construct_UFunction_UMotionMatchingAnimNodeLibrary_SetDatabasesToSearch, "SetDatabasesToSearch" }, // 1519171878
		{ &Z_Construct_UFunction_UMotionMatchingAnimNodeLibrary_SetDatabaseToSearch, "SetDatabaseToSearch" }, // 2351009293
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMotionMatchingAnimNodeLibrary, UMotionMatchingAnimNodeLibrary::StaticClass, TEXT("UMotionMatchingAnimNodeLibrary"), &Z_Registration_Info_UClass_UMotionMatchingAnimNodeLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMotionMatchingAnimNodeLibrary), 4203690952U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_3792516113(TEXT("/Script/PoseSearch"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_MotionMatchingAnimNodeLibrary_h_Statics::ScriptStructInfo),
		nullptr, 0);
