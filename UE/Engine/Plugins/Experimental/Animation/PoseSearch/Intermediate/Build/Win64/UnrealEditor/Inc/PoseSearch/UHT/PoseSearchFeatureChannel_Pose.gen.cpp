...
template<> POSESEARCH_API UScriptStruct* StaticStruct<FPoseSearchBone>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPoseSearchFeatureChannel_Pose_Statics::NewProp_SampledBones_Inner = { "SampledBones", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPoseSearchBone, METADATA_PARAMS(0, nullptr) }; // 1954377754
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Private_PoseSearchFeatureChannel_Pose_h_Statics::ScriptStructInfo[] = {
		{ FPoseSearchBone::StaticStruct, Z_Construct_UScriptStruct_FPoseSearchBone_Statics::NewStructOps, TEXT("PoseSearchBone"), &Z_Registration_Info_UScriptStruct_PoseSearchBone, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPoseSearchBone), 1954377754U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Private_PoseSearchFeatureChannel_Pose_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPoseSearchFeatureChannel_Pose, UPoseSearchFeatureChannel_Pose::StaticClass, TEXT("UPoseSearchFeatureChannel_Pose"), &Z_Registration_Info_UClass_UPoseSearchFeatureChannel_Pose, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseSearchFeatureChannel_Pose), 2999866626U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Private_PoseSearchFeatureChannel_Pose_h_4023109084(TEXT("/Script/PoseSearch"),
