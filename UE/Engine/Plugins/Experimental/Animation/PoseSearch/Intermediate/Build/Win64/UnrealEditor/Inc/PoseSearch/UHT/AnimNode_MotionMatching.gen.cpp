...
template<> POSESEARCH_API UScriptStruct* StaticStruct<FAnimNode_MotionMatching>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_AnimNode_MotionMatching_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_MotionMatching::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_MotionMatching_Statics::NewStructOps, TEXT("AnimNode_MotionMatching"), &Z_Registration_Info_UScriptStruct_AnimNode_MotionMatching, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_MotionMatching), 3513064004U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_AnimNode_MotionMatching_h_46476118(TEXT("/Script/PoseSearch"),
		nullptr, 0,
