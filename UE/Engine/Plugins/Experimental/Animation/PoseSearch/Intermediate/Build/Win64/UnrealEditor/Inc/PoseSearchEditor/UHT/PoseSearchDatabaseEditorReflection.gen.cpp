...
template<> POSESEARCHEDITOR_API UScriptStruct* StaticStruct<FPoseSearchDatabaseMemoryStats>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Editor_Public_PoseSearchDatabaseEditorReflection_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UPoseSearchDatabaseSequenceReflection, UPoseSearchDatabaseSequenceReflection::StaticClass, TEXT("UPoseSearchDatabaseSequenceReflection"), &Z_Registration_Info_UClass_UPoseSearchDatabaseSequenceReflection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseSearchDatabaseSequenceReflection), 2290560866U) },
		{ Z_Construct_UClass_UPoseSearchDatabaseBlendSpaceReflection, UPoseSearchDatabaseBlendSpaceReflection::StaticClass, TEXT("UPoseSearchDatabaseBlendSpaceReflection"), &Z_Registration_Info_UClass_UPoseSearchDatabaseBlendSpaceReflection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseSearchDatabaseBlendSpaceReflection), 3642372944U) },
		{ Z_Construct_UClass_UPoseSearchDatabaseAnimCompositeReflection, UPoseSearchDatabaseAnimCompositeReflection::StaticClass, TEXT("UPoseSearchDatabaseAnimCompositeReflection"), &Z_Registration_Info_UClass_UPoseSearchDatabaseAnimCompositeReflection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseSearchDatabaseAnimCompositeReflection), 525950156U) },
		{ Z_Construct_UClass_UPoseSearchDatabaseAnimMontageReflection, UPoseSearchDatabaseAnimMontageReflection::StaticClass, TEXT("UPoseSearchDatabaseAnimMontageReflection"), &Z_Registration_Info_UClass_UPoseSearchDatabaseAnimMontageReflection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseSearchDatabaseAnimMontageReflection), 3405083939U) },
		{ Z_Construct_UClass_UPoseSearchDatabaseStatistics, UPoseSearchDatabaseStatistics::StaticClass, TEXT("UPoseSearchDatabaseStatistics"), &Z_Registration_Info_UClass_UPoseSearchDatabaseStatistics, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseSearchDatabaseStatistics), 1773905796U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Editor_Public_PoseSearchDatabaseEditorReflection_h_2561429050(TEXT("/Script/PoseSearchEditor"),
