...
template<> POSESEARCH_API UScriptStruct* StaticStruct<FPoseSearchCost>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchCost_h_Statics::ScriptStructInfo[] = {
		{ FPoseSearchCost::StaticStruct, Z_Construct_UScriptStruct_FPoseSearchCost_Statics::NewStructOps, TEXT("PoseSearchCost"), &Z_Registration_Info_UScriptStruct_PoseSearchCost, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPoseSearchCost), 1831618548U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchCost_h_1680234943(TEXT("/Script/PoseSearch"),
		nullptr, 0,
