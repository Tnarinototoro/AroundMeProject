...
template<> POSESEARCH_API UScriptStruct* StaticStruct<FPoseSearchQueryTrajectory>()
{
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchTrajectoryTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchTrajectoryTypes_h_Statics::ScriptStructInfo[] = {
		...
		{ FPoseSearchQueryTrajectory::StaticStruct, Z_Construct_UScriptStruct_FPoseSearchQueryTrajectory_Statics::NewStructOps, TEXT("PoseSearchQueryTrajectory"), &Z_Registration_Info_UScriptStruct_PoseSearchQueryTrajectory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPoseSearchQueryTrajectory), 22940819U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchTrajectoryTypes_h_2421922836(TEXT("/Script/PoseSearch"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchTrajectoryTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_PoseSearchTrajectoryTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
