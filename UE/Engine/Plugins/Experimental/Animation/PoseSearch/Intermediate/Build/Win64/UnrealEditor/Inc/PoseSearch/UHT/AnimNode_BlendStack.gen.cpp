...
template<> POSESEARCH_API UScriptStruct* StaticStruct<FAnimNode_BlendStack>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_AnimNode_BlendStack_h_Statics::ScriptStructInfo[] = {
		...
		{ FAnimNode_BlendStack::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_BlendStack_Statics::NewStructOps, TEXT("AnimNode_BlendStack"), &Z_Registration_Info_UScriptStruct_AnimNode_BlendStack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_BlendStack), 3585228801U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_PoseSearch_Source_Runtime_Public_PoseSearch_AnimNode_BlendStack_h_945992844(TEXT("/Script/PoseSearch"),
		nullptr, 0,
