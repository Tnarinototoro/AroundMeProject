...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::NewProp_AnimNotifyEventGuid = { "AnimNotifyEventGuid", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimMovieSceneNotifySection, AnimNotifyEventGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::NewProp_AnimNotifyEventGuid_MetaData), Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::NewProp_AnimNotifyEventGuid_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::ClassParams = {
		...
		0,
		0x002000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::Class_MetaDataParams), Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifySection_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimMovieSceneNotifySection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UContextualAnimMovieSceneNotifySection, UContextualAnimMovieSceneNotifySection::StaticClass, TEXT("UContextualAnimMovieSceneNotifySection"), &Z_Registration_Info_UClass_UContextualAnimMovieSceneNotifySection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UContextualAnimMovieSceneNotifySection), 1890336572U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimMovieSceneNotifySection_h_3359755915(TEXT("/Script/ContextualAnimationEditor"),
