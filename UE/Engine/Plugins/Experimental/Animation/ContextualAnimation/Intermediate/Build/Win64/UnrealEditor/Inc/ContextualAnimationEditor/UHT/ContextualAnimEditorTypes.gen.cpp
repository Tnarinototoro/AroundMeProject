...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ContextualAnimNewIKTargetParams_eventGetTargetRoleOptions_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UContextualAnimNewIKTargetParams, nullptr, "GetTargetRoleOptions", nullptr, nullptr, Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::PropPointers), sizeof(Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::ContextualAnimNewIKTargetParams_eventGetTargetRoleOptions_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::Function_MetaDataParams), Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions_Statics::ContextualAnimNewIKTargetParams_eventGetTargetRoleOptions_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UContextualAnimNewIKTargetParams_GetTargetRoleOptions, "GetTargetRoleOptions" }, // 90340166
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SourceRole = { "SourceRole", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, SourceRole), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SourceRole_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SourceRole_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SourceBone = { "SourceBone", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, SourceBone), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SourceBone_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SourceBone_MetaData) }; // 1286936164
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_Provider = { "Provider", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, Provider), Z_Construct_UEnum_ContextualAnimation_EContextualAnimIKTargetProvider, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_Provider_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_Provider_MetaData) }; // 3278809219
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_TargetRole = { "TargetRole", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, TargetRole), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_TargetRole_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_TargetRole_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_TargetBone = { "TargetBone", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, TargetBone), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_TargetBone_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_TargetBone_MetaData) }; // 1286936164
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_GoalName = { "GoalName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, GoalName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_GoalName_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_GoalName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SectionIdx = { "SectionIdx", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, SectionIdx), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SectionIdx_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SectionIdx_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SceneAssetPtr = { "SceneAssetPtr", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, SceneAssetPtr), Z_Construct_UClass_UContextualAnimSceneAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SceneAssetPtr_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_SceneAssetPtr_MetaData) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_CachedRoles_Inner = { "CachedRoles", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_CachedRoles = { "CachedRoles", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimNewIKTargetParams, CachedRoles), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_CachedRoles_MetaData), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::NewProp_CachedRoles_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UBoneReferenceSkeletonProvider_NoRegister, (int32)VTABLE_OFFSET(UContextualAnimNewIKTargetParams, IBoneReferenceSkeletonProvider), false },  // 307433809
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::ClassParams = {
		...
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::Class_MetaDataParams), Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimNewIKTargetParams_Statics::PropPointers) < 2048);
...
template<> CONTEXTUALANIMATIONEDITOR_API UScriptStruct* StaticStruct<FContextualAnimNewAnimSetData>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_RoleName = { "RoleName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FContextualAnimNewAnimSetData, RoleName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_RoleName_MetaData), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_RoleName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FContextualAnimNewAnimSetData, Animation), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_Animation_MetaData), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_Animation_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bRequiresFlyingMode = { "bRequiresFlyingMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FContextualAnimNewAnimSetData), &Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bRequiresFlyingMode_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bRequiresFlyingMode_MetaData), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bRequiresFlyingMode_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bOptional = { "bOptional", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FContextualAnimNewAnimSetData), &Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bOptional_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bOptional_MetaData), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::NewProp_bOptional_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData_Statics::PropPointers) < 2048);
...
template<> CONTEXTUALANIMATIONEDITOR_API UScriptStruct* StaticStruct<FContextualAnimNewAnimSetParams>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_SectionName = { "SectionName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FContextualAnimNewAnimSetParams, SectionName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_SectionName_MetaData), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_SectionName_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_Data_Inner = { "Data", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FContextualAnimNewAnimSetData, METADATA_PARAMS(0, nullptr) }; // 1038574584
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FContextualAnimNewAnimSetParams, Data), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_Data_MetaData), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_Data_MetaData) }; // 1038574584
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_RandomWeight = { "RandomWeight", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FContextualAnimNewAnimSetParams, RandomWeight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_RandomWeight_MetaData), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::NewProp_RandomWeight_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FContextualAnimNewAnimSetParams_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimEditorTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UContextualAnimNewIKTargetParams, UContextualAnimNewIKTargetParams::StaticClass, TEXT("UContextualAnimNewIKTargetParams"), &Z_Registration_Info_UClass_UContextualAnimNewIKTargetParams, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UContextualAnimNewIKTargetParams), 1442881567U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimEditorTypes_h_754311403(TEXT("/Script/ContextualAnimationEditor"),
