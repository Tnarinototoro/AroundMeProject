...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::NewProp_Sections = { "Sections", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimMovieSceneNotifyTrack, Sections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::NewProp_Sections_MetaData), Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::NewProp_Sections_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimMovieSceneNotifyTrack, Animation), Z_Construct_UClass_UAnimSequenceBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::NewProp_Animation_MetaData), Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::NewProp_Animation_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::ClassParams = {
		...
		0,
		0x00A000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::Class_MetaDataParams), Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimMovieSceneNotifyTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UContextualAnimMovieSceneNotifyTrack, UContextualAnimMovieSceneNotifyTrack::StaticClass, TEXT("UContextualAnimMovieSceneNotifyTrack"), &Z_Registration_Info_UClass_UContextualAnimMovieSceneNotifyTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UContextualAnimMovieSceneNotifyTrack), 893654608U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimMovieSceneNotifyTrack_h_691117158(TEXT("/Script/ContextualAnimationEditor"),
