...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_SectionIdx = { "SectionIdx", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimMovieSceneSection, SectionIdx), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_SectionIdx_MetaData), Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_SectionIdx_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_AnimSetIdx = { "AnimSetIdx", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimMovieSceneSection, AnimSetIdx), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_AnimSetIdx_MetaData), Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_AnimSetIdx_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_AnimTrackIdx = { "AnimTrackIdx", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UContextualAnimMovieSceneSection, AnimTrackIdx), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_AnimTrackIdx_MetaData), Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::NewProp_AnimTrackIdx_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::ClassParams = {
		...
		0,
		0x002000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::Class_MetaDataParams), Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimMovieSceneSection_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimMovieSceneSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UContextualAnimMovieSceneSection, UContextualAnimMovieSceneSection::StaticClass, TEXT("UContextualAnimMovieSceneSection"), &Z_Registration_Info_UClass_UContextualAnimMovieSceneSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UContextualAnimMovieSceneSection), 1299276622U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimationEditor_Public_ContextualAnimMovieSceneSection_h_2957726075(TEXT("/Script/ContextualAnimationEditor"),
