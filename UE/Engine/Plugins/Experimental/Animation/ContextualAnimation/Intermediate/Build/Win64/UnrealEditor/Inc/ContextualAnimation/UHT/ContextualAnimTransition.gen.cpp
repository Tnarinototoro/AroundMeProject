...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_SceneInstance = { "SceneInstance", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ContextualAnimTransition_eventCanEnterTransition_Parms, SceneInstance), Z_Construct_UClass_UContextualAnimSceneInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_SceneInstance_MetaData), Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_SceneInstance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_FromSection = { "FromSection", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ContextualAnimTransition_eventCanEnterTransition_Parms, FromSection), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_FromSection_MetaData), Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_FromSection_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_ToSection = { "ToSection", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ContextualAnimTransition_eventCanEnterTransition_Parms, ToSection), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_ToSection_MetaData), Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_ToSection_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ContextualAnimTransition_eventCanEnterTransition_Parms), &Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UContextualAnimTransition, nullptr, "CanEnterTransition", nullptr, nullptr, Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::PropPointers), sizeof(ContextualAnimTransition_eventCanEnterTransition_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x48420800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::Function_MetaDataParams), Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition_Statics::PropPointers) < 2048);
	static_assert(sizeof(ContextualAnimTransition_eventCanEnterTransition_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimTransition_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UContextualAnimTransition_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UContextualAnimTransition_CanEnterTransition, "CanEnterTransition" }, // 710455386
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimTransition_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UContextualAnimTransition_Statics::ClassParams = {
		...
		0,
		0x001110A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UContextualAnimTransition_Statics::Class_MetaDataParams), Z_Construct_UClass_UContextualAnimTransition_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimation_Public_ContextualAnimTransition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UContextualAnimTransition, UContextualAnimTransition::StaticClass, TEXT("UContextualAnimTransition"), &Z_Registration_Info_UClass_UContextualAnimTransition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UContextualAnimTransition), 1882810998U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Animation_ContextualAnimation_Source_ContextualAnimation_Public_ContextualAnimTransition_h_2285697388(TEXT("/Script/ContextualAnimation"),
