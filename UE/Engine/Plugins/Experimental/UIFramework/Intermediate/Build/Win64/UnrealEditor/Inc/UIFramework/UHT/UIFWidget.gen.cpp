...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidgetWrapperInterface_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUIFrameworkWidgetWrapperInterface_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidgetWrapperInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UUIFrameworkWidgetWrapperInterface_Statics::Class_MetaDataParams)
	};
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkWidget_OnRep_IsEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkWidget, nullptr, "OnRep_IsEnabled", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkWidget_OnRep_IsEnabled_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkWidget_OnRep_IsEnabled_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkWidget_OnRep_Visibility_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkWidget, nullptr, "OnRep_Visibility", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkWidget_OnRep_Visibility_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkWidget_OnRep_Visibility_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UUIFrameworkWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUIFrameworkWidget_OnRep_IsEnabled, "OnRep_IsEnabled" }, // 3061836813
		{ &Z_Construct_UFunction_UUIFrameworkWidget_OnRep_Visibility, "OnRep_Visibility" }, // 2521193888
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_bIsEnabled = { "bIsEnabled", "OnRep_IsEnabled", (EPropertyFlags)0x0040000100000024, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, &UUIFrameworkWidget::SetbIsEnabled_WrapperImpl, &UUIFrameworkWidget::GetbIsEnabled_WrapperImpl, 1, sizeof(bool), sizeof(UUIFrameworkWidget), &Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_bIsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_bIsEnabled_MetaData), Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_bIsEnabled_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Visibility = { "Visibility", "OnRep_Visibility", (EPropertyFlags)0x0040000100000024, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, &UUIFrameworkWidget::SetVisibility_WrapperImpl, &UUIFrameworkWidget::GetVisibility_WrapperImpl, 1, STRUCT_OFFSET(UUIFrameworkWidget, Visibility), Z_Construct_UEnum_UMG_ESlateVisibility, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Visibility_MetaData), Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Visibility_MetaData) }; // 1295612096
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_WidgetClass = { "WidgetClass", nullptr, (EPropertyFlags)0x0024080000010035, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkWidget, WidgetClass), Z_Construct_UClass_UWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_WidgetClass_MetaData), Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_WidgetClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0040000000202020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkWidget, Id), Z_Construct_UScriptStruct_FUIFrameworkWidgetId, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Id_MetaData), Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Id_MetaData) }; // 3944845519
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInterfacePropertyParams Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Wrapper = { "Wrapper", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkWidget, Wrapper), Z_Construct_UClass_UUIFrameworkWidgetWrapperInterface_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Wrapper_MetaData), Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_Wrapper_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_AuthorityParent = { "AuthorityParent", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkWidget, AuthorityParent), Z_Construct_UScriptStruct_FUIFrameworkParentWidget, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_AuthorityParent_MetaData), Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_AuthorityParent_MetaData) }; // 1260372879
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_LocalUMGWidget = { "LocalUMGWidget", nullptr, (EPropertyFlags)0x0044000000082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkWidget, LocalUMGWidget), Z_Construct_UClass_UWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_LocalUMGWidget_MetaData), Z_Construct_UClass_UUIFrameworkWidget_Statics::NewProp_LocalUMGWidget_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUIFrameworkWidget_Statics::ClassParams = {
		...
		0,
		0x009000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::Class_MetaDataParams), Z_Construct_UClass_UUIFrameworkWidget_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkWidget_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUIFrameworkWidgetWrapperInterface, UUIFrameworkWidgetWrapperInterface::StaticClass, TEXT("UUIFrameworkWidgetWrapperInterface"), &Z_Registration_Info_UClass_UUIFrameworkWidgetWrapperInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUIFrameworkWidgetWrapperInterface), 3896976667U) },
		{ Z_Construct_UClass_UUIFrameworkWidget, UUIFrameworkWidget::StaticClass, TEXT("UUIFrameworkWidget"), &Z_Registration_Info_UClass_UUIFrameworkWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUIFrameworkWidget), 2445365536U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFWidget_h_3910212120(TEXT("/Script/UIFramework"),
