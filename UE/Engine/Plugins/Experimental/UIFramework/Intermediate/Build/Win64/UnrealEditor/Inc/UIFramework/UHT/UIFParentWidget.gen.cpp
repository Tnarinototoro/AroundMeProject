...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkParentWidget>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkParentWidget, Parent), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::NewProp_Parent_MetaData), Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::NewProp_Parent_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFParentWidget_h_Statics::ScriptStructInfo[] = {
		{ FUIFrameworkParentWidget::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkParentWidget_Statics::NewStructOps, TEXT("UIFrameworkParentWidget"), &Z_Registration_Info_UScriptStruct_UIFrameworkParentWidget, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkParentWidget), 1260372879U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFParentWidget_h_566782019(TEXT("/Script/UIFramework"),
		nullptr, 0,
