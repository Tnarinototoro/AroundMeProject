...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkWidgetTreeEntry>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetTreeEntry, Parent), Z_Construct_UClass_UUIFrameworkWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_Parent_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_Parent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_Child = { "Child", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetTreeEntry, Child), Z_Construct_UClass_UUIFrameworkWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_Child_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_Child_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_ParentId = { "ParentId", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetTreeEntry, ParentId), Z_Construct_UScriptStruct_FUIFrameworkWidgetId, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_ParentId_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_ParentId_MetaData) }; // 3944845519
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_ChildId = { "ChildId", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetTreeEntry, ChildId), Z_Construct_UScriptStruct_FUIFrameworkWidgetId, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_ChildId_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewProp_ChildId_MetaData) }; // 3944845519
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::PropPointers) < 2048);
...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkWidgetTree>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewProp_Entries_Inner = { "Entries", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry, METADATA_PARAMS(0, nullptr) }; // 3671769307
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewProp_Entries = { "Entries", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetTree, Entries), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewProp_Entries_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewProp_Entries_MetaData) }; // 3671769307
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewProp_ReplicatedOwner = { "ReplicatedOwner", nullptr, (EPropertyFlags)0x0044000080002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetTree, ReplicatedOwner), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewProp_ReplicatedOwner_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewProp_ReplicatedOwner_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFWidgetTree_h_Statics::ScriptStructInfo[] = {
		{ FUIFrameworkWidgetTreeEntry::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkWidgetTreeEntry_Statics::NewStructOps, TEXT("UIFrameworkWidgetTreeEntry"), &Z_Registration_Info_UScriptStruct_UIFrameworkWidgetTreeEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkWidgetTreeEntry), 3671769307U) },
		{ FUIFrameworkWidgetTree::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkWidgetTree_Statics::NewStructOps, TEXT("UIFrameworkWidgetTree"), &Z_Registration_Info_UScriptStruct_UIFrameworkWidgetTree, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkWidgetTree), 4167702535U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFWidgetTree_h_2679525531(TEXT("/Script/UIFramework"),
		nullptr, 0,
