...
// End Cross Module References
	...
	DEFINE_FUNCTION(UUIFrameworkSimpleButton::execOnRep_Message)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	void UUIFrameworkSimpleButton::StaticRegisterNativesUUIFrameworkSimpleButton()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "OnRep_Message", &UUIFrameworkSimpleButton::execOnRep_Message },
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::NewProp_Field = { "Field", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkSimpleButton_eventOnClick_Parms, Field), Z_Construct_UScriptStruct_FMVVMEventField, METADATA_PARAMS(0, nullptr) }; // 222892281
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkSimpleButton, nullptr, "OnClick", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::UIFrameworkSimpleButton_eventOnClick_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick_Statics::UIFrameworkSimpleButton_eventOnClick_Parms) < MAX_uint16);
	...
	struct Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Widgets/UIFSimpleButton.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkSimpleButton, nullptr, "OnRep_Message", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick_Statics::NewProp_PlayerController = { "PlayerController", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkSimpleButton_eventServerClick_Parms, PlayerController), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkSimpleButton, nullptr, "ServerClick", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick_Statics::PropPointers), sizeof(UIFrameworkSimpleButton_eventServerClick_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00240CC1, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick_Statics::PropPointers) < 2048);
	static_assert(sizeof(UIFrameworkSimpleButton_eventServerClick_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUIFrameworkSimpleButton_OnClick, "OnClick" }, // 2741764214
		{ &Z_Construct_UFunction_UUIFrameworkSimpleButton_OnRep_Message, "OnRep_Message" }, // 521644034
		{ &Z_Construct_UFunction_UUIFrameworkSimpleButton_ServerClick, "ServerClick" }, // 3625205302
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Text = { "Text", nullptr, (EPropertyFlags)0x0040000000002014, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, &UUIFrameworkSimpleButton::GetText_WrapperImpl, 1, STRUCT_OFFSET(UUIFrameworkSimpleButton, Text), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Text_MetaData), Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Text_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Message_MetaData[] = {
		{ "ModuleRelativePath", "Public/Widgets/UIFSimpleButton.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Message = { "Message", "OnRep_Message", (EPropertyFlags)0x0040000100000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkSimpleButton, Message), Z_Construct_UScriptStruct_FLocalizableMessage, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Message_MetaData), Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Message_MetaData) }; // 2288712457
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_ClickEvent = { "ClickEvent", nullptr, (EPropertyFlags)0x0040000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, &UUIFrameworkSimpleButton::GetClickEvent_WrapperImpl, 1, STRUCT_OFFSET(UUIFrameworkSimpleButton, ClickEvent), Z_Construct_UScriptStruct_FUIFrameworkClickEventArgument, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_ClickEvent_MetaData), Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_ClickEvent_MetaData) }; // 611982455
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::NewProp_Message,
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::Class_MetaDataParams), Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkSimpleButton_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Widgets_UIFSimpleButton_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUIFrameworkSimpleButton, UUIFrameworkSimpleButton::StaticClass, TEXT("UUIFrameworkSimpleButton"), &Z_Registration_Info_UClass_UUIFrameworkSimpleButton, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUIFrameworkSimpleButton), 8721077U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Widgets_UIFSimpleButton_h_1396971619(TEXT("/Script/UIFramework"),
