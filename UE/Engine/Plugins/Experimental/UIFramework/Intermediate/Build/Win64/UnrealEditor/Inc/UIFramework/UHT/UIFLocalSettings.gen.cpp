...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::NewProp_ErrorResource = { "ErrorResource", nullptr, (EPropertyFlags)0x0044000000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkLocalSettings, ErrorResource), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::NewProp_ErrorResource_MetaData), Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::NewProp_ErrorResource_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::NewProp_LoadingResource = { "LoadingResource", nullptr, (EPropertyFlags)0x0044000000004001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkLocalSettings, LoadingResource), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::NewProp_LoadingResource_MetaData), Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::NewProp_LoadingResource_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkLocalSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFLocalSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUIFrameworkLocalSettings, UUIFrameworkLocalSettings::StaticClass, TEXT("UUIFrameworkLocalSettings"), &Z_Registration_Info_UClass_UUIFrameworkLocalSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUIFrameworkLocalSettings), 797869124U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFLocalSettings_h_3414214856(TEXT("/Script/UIFramework"),
