...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkWidgetId>()
{
...
#endif
	const UECodeGen_Private::FInt64PropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int64, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetId, Key), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::NewProp_Key_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::NewProp_Key_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFWidgetId_h_Statics::ScriptStructInfo[] = {
		{ FUIFrameworkWidgetId::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkWidgetId_Statics::NewStructOps, TEXT("UIFrameworkWidgetId"), &Z_Registration_Info_UScriptStruct_UIFrameworkWidgetId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkWidgetId), 3944845519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFWidgetId_h_3265059494(TEXT("/Script/UIFramework"),
		nullptr, 0,
