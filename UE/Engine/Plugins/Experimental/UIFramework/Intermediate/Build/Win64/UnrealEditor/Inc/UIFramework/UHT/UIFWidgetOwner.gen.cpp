...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkWidgetOwner>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_PlayerController = { "PlayerController", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetOwner, PlayerController), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_PlayerController_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_PlayerController_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_GameInstance = { "GameInstance", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetOwner, GameInstance), Z_Construct_UClass_UGameInstance_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_GameInstance_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_GameInstance_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_World = { "World", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkWidgetOwner, World), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_World_MetaData), Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewProp_World_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFWidgetOwner_h_Statics::ScriptStructInfo[] = {
		{ FUIFrameworkWidgetOwner::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkWidgetOwner_Statics::NewStructOps, TEXT("UIFrameworkWidgetOwner"), &Z_Registration_Info_UScriptStruct_UIFrameworkWidgetOwner, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkWidgetOwner), 3908206913U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFWidgetOwner_h_1928780576(TEXT("/Script/UIFramework"),
		nullptr, 0,
