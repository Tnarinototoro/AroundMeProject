...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkSlotBase>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_Widget = { "Widget", nullptr, (EPropertyFlags)0x0044000080000004, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSlotBase, Widget), Z_Construct_UClass_UUIFrameworkWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_Widget_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_Widget_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_WidgetId = { "WidgetId", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSlotBase, WidgetId), Z_Construct_UScriptStruct_FUIFrameworkWidgetId, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_WidgetId_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_WidgetId_MetaData) }; // 3944845519
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_LocalPreviousWidgetId = { "LocalPreviousWidgetId", nullptr, (EPropertyFlags)0x0040000080000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSlotBase, LocalPreviousWidgetId), Z_Construct_UScriptStruct_FUIFrameworkWidgetId, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_LocalPreviousWidgetId_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewProp_LocalPreviousWidgetId_MetaData) }; // 3944845519
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::PropPointers) < 2048);
...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkSimpleSlot>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_Padding = { "Padding", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSimpleSlot, Padding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_Padding_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_Padding_MetaData) }; // 2235102396
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_HorizontalAlignment = { "HorizontalAlignment", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSimpleSlot, HorizontalAlignment), Z_Construct_UEnum_SlateCore_EHorizontalAlignment, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_HorizontalAlignment_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_HorizontalAlignment_MetaData) }; // 483256341
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_VerticalAlignment = { "VerticalAlignment", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSimpleSlot, VerticalAlignment), Z_Construct_UEnum_SlateCore_EVerticalAlignment, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_VerticalAlignment_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewProp_VerticalAlignment_MetaData) }; // 1653762848
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFSlotBase_h_Statics::ScriptStructInfo[] = {
		{ FUIFrameworkSlotBase::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkSlotBase_Statics::NewStructOps, TEXT("UIFrameworkSlotBase"), &Z_Registration_Info_UScriptStruct_UIFrameworkSlotBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkSlotBase), 570257491U) },
		{ FUIFrameworkSimpleSlot::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot_Statics::NewStructOps, TEXT("UIFrameworkSimpleSlot"), &Z_Registration_Info_UScriptStruct_UIFrameworkSimpleSlot, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkSimpleSlot), 742594535U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFSlotBase_h_1566702971(TEXT("/Script/UIFramework"),
		nullptr, 0,
