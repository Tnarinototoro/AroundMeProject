...
// Cross Module References
	...
	UIFRAMEWORK_API UClass* Z_Construct_UClass_UUIFrameworkButtonWidget();
...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkButton_eventGetContent_Parms, ReturnValue), Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot, METADATA_PARAMS(0, nullptr) }; // 742594535
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkButton, nullptr, "GetContent", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::UIFrameworkButton_eventGetContent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UUIFrameworkButton_GetContent_Statics::UIFrameworkButton_eventGetContent_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkButton_HandleClick_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkButton, nullptr, "HandleClick", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_HandleClick_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkButton_HandleClick_Statics::Function_MetaDataParams) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkButton_OnRep_Slot_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkButton, nullptr, "OnRep_Slot", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_OnRep_Slot_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkButton_OnRep_Slot_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUIFrameworkButton_ServerClick_Statics::NewProp_PlayerController = { "PlayerController", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkButton_eventServerClick_Parms, PlayerController), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkButton_ServerClick_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkButton, nullptr, "ServerClick", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkButton_ServerClick_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_ServerClick_Statics::PropPointers), sizeof(UIFrameworkButton_eventServerClick_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00240CC1, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_ServerClick_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkButton_ServerClick_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_ServerClick_Statics::PropPointers) < 2048);
	static_assert(sizeof(UIFrameworkButton_eventServerClick_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::NewProp_Content = { "Content", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkButton_eventSetContent_Parms, Content), Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot, METADATA_PARAMS(0, nullptr) }; // 742594535
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkButton, nullptr, "SetContent", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::UIFrameworkButton_eventSetContent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020405, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UUIFrameworkButton_SetContent_Statics::UIFrameworkButton_eventSetContent_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkButton_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UUIFrameworkButton_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUIFrameworkButton_GetContent, "GetContent" }, // 2216547644
		{ &Z_Construct_UFunction_UUIFrameworkButton_HandleClick, "HandleClick" }, // 3233482719
		{ &Z_Construct_UFunction_UUIFrameworkButton_OnRep_Slot, "OnRep_Slot" }, // 3195242907
		{ &Z_Construct_UFunction_UUIFrameworkButton_ServerClick, "ServerClick" }, // 3050708339
		{ &Z_Construct_UFunction_UUIFrameworkButton_SetContent, "SetContent" }, // 3216147166
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkButton_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUIFrameworkButton_Statics::NewProp_Slot = { "Slot", "OnRep_Slot", (EPropertyFlags)0x0040000100000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkButton, Slot), Z_Construct_UScriptStruct_FUIFrameworkSimpleSlot, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkButton_Statics::NewProp_Slot_MetaData), Z_Construct_UClass_UUIFrameworkButton_Statics::NewProp_Slot_MetaData) }; // 742594535
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUIFrameworkButton_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkButton_Statics::Class_MetaDataParams), Z_Construct_UClass_UUIFrameworkButton_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkButton_Statics::PropPointers) < 2048);
	...
	void UUIFrameworkButtonWidget::StaticRegisterNativesUUIFrameworkButtonWidget()
	{
	}
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UUIFrameworkButtonWidget);
	UClass* Z_Construct_UClass_UUIFrameworkButtonWidget_NoRegister()
	{
		return UUIFrameworkButtonWidget::StaticClass();
	}
	...
	UObject* (*const Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_UButton,
		(UObject* (*)())Z_Construct_UPackage__Script_UIFramework,
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Widgets/UIFButton.h" },
		{ "ModuleRelativePath", "Public/Widgets/UIFButton.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UUIFrameworkButtonWidget>::IsAbstract,
	};
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::ClassParams = {
		&UUIFrameworkButtonWidget::StaticClass,
		nullptr,
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		...
		0,
		0x00B000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::Class_MetaDataParams), Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::Class_MetaDataParams)
	};
	UClass* Z_Construct_UClass_UUIFrameworkButtonWidget()
	{
		if (!Z_Registration_Info_UClass_UUIFrameworkButtonWidget.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UUIFrameworkButtonWidget.OuterSingleton, Z_Construct_UClass_UUIFrameworkButtonWidget_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UUIFrameworkButtonWidget.OuterSingleton;
	}
	template<> UIFRAMEWORK_API UClass* StaticClass<UUIFrameworkButtonWidget>()
	{
		return UUIFrameworkButtonWidget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UUIFrameworkButtonWidget);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Widgets_UIFButton_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUIFrameworkButton, UUIFrameworkButton::StaticClass, TEXT("UUIFrameworkButton"), &Z_Registration_Info_UClass_UUIFrameworkButton, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUIFrameworkButton), 3670557518U) },
		{ Z_Construct_UClass_UUIFrameworkButtonWidget, UUIFrameworkButtonWidget::StaticClass, TEXT("UUIFrameworkButtonWidget"), &Z_Registration_Info_UClass_UUIFrameworkButtonWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUIFrameworkButtonWidget), 2219619418U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Widgets_UIFButton_h_2059840418(TEXT("/Script/UIFramework"),
