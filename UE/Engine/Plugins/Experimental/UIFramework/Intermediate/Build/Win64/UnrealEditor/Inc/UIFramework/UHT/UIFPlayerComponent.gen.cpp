...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_UIFramework_EUIFrameworkGameLayerType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_UIFramework_EUIFrameworkGameLayerType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_UIFramework_EUIFrameworkGameLayerType_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_UIFramework_EUIFrameworkInputMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_UIFramework_EUIFrameworkInputMode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_UIFramework_EUIFrameworkInputMode_Statics::Enum_MetaDataParams)
	};
...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkGameLayerSlot>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_ZOrder = { "ZOrder", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkGameLayerSlot, ZOrder), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_ZOrder_MetaData), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_ZOrder_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_InputMode = { "InputMode", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkGameLayerSlot, InputMode), Z_Construct_UEnum_UIFramework_EUIFrameworkInputMode, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_InputMode_MetaData), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_InputMode_MetaData) }; // 3963477339
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkGameLayerSlot, Type), Z_Construct_UEnum_UIFramework_EUIFrameworkGameLayerType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_Type_MetaData), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewProp_Type_MetaData) }; // 3189947631
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::PropPointers) < 2048);
...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkGameLayerSlotList>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewProp_Entries_Inner = { "Entries", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot, METADATA_PARAMS(0, nullptr) }; // 1290419174
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewProp_Entries = { "Entries", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkGameLayerSlotList, Entries), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewProp_Entries_MetaData), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewProp_Entries_MetaData) }; // 1290419174
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewProp_Owner = { "Owner", nullptr, (EPropertyFlags)0x0044000080082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkGameLayerSlotList, Owner), Z_Construct_UClass_UUIFrameworkPlayerComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewProp_Owner_MetaData), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewProp_Owner_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::NewProp_Widget = { "Widget", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkPlayerComponent_eventAddWidget_Parms, Widget), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot, METADATA_PARAMS(0, nullptr) }; // 1290419174
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkPlayerComponent, nullptr, "AddWidget", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::UIFrameworkPlayerComponent_eventAddWidget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020405, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget_Statics::UIFrameworkPlayerComponent_eventAddWidget_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::NewProp_Widget = { "Widget", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkPlayerComponent_eventRemoveWidget_Parms, Widget), Z_Construct_UClass_UUIFrameworkWidget_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkPlayerComponent, nullptr, "RemoveWidget", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::UIFrameworkPlayerComponent_eventRemoveWidget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020405, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget_Statics::UIFrameworkPlayerComponent_eventRemoveWidget_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree_Statics::NewProp_WidgetId = { "WidgetId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UIFrameworkPlayerComponent_eventServerRemoveWidgetRootFromTree_Parms, WidgetId), Z_Construct_UScriptStruct_FUIFrameworkWidgetId, METADATA_PARAMS(0, nullptr) }; // 3944845519
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUIFrameworkPlayerComponent, nullptr, "ServerRemoveWidgetRootFromTree", nullptr, nullptr, Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree_Statics::PropPointers), sizeof(UIFrameworkPlayerComponent_eventServerRemoveWidgetRootFromTree_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00240CC1, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree_Statics::PropPointers) < 2048);
	static_assert(sizeof(UIFrameworkPlayerComponent_eventServerRemoveWidgetRootFromTree_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUIFrameworkPlayerComponent_AddWidget, "AddWidget" }, // 133986248
		{ &Z_Construct_UFunction_UUIFrameworkPlayerComponent_RemoveWidget, "RemoveWidget" }, // 3793751769
		{ &Z_Construct_UFunction_UUIFrameworkPlayerComponent_ServerRemoveWidgetRootFromTree, "ServerRemoveWidgetRootFromTree" }, // 3083592383
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_RootList = { "RootList", nullptr, (EPropertyFlags)0x0040008000000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkPlayerComponent, RootList), Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_RootList_MetaData), Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_RootList_MetaData) }; // 4236489479
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_WidgetTree = { "WidgetTree", nullptr, (EPropertyFlags)0x0040000000000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkPlayerComponent, WidgetTree), Z_Construct_UScriptStruct_FUIFrameworkWidgetTree, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_WidgetTree_MetaData), Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_WidgetTree_MetaData) }; // 4167702535
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_Presenter = { "Presenter", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkPlayerComponent, Presenter), Z_Construct_UClass_UUIFrameworkPresenter_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_Presenter_MetaData), Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_Presenter_MetaData) };
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_NetReplicationPending = { "NetReplicationPending", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkPlayerComponent, NetReplicationPending), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_NetReplicationPending_MetaData), Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_NetReplicationPending_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_AddPending_ElementProp = { "AddPending", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_AddPending = { "AddPending", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUIFrameworkPlayerComponent, AddPending), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_AddPending_MetaData), Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::NewProp_AddPending_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UUIFrameworkPlayerComponent_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFPlayerComponent_h_Statics::EnumInfo[] = {
		{ EUIFrameworkGameLayerType_StaticEnum, TEXT("EUIFrameworkGameLayerType"), &Z_Registration_Info_UEnum_EUIFrameworkGameLayerType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3189947631U) },
		{ EUIFrameworkInputMode_StaticEnum, TEXT("EUIFrameworkInputMode"), &Z_Registration_Info_UEnum_EUIFrameworkInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3963477339U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFPlayerComponent_h_Statics::ScriptStructInfo[] = {
		{ FUIFrameworkGameLayerSlot::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlot_Statics::NewStructOps, TEXT("UIFrameworkGameLayerSlot"), &Z_Registration_Info_UScriptStruct_UIFrameworkGameLayerSlot, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkGameLayerSlot), 1290419174U) },
		{ FUIFrameworkGameLayerSlotList::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkGameLayerSlotList_Statics::NewStructOps, TEXT("UIFrameworkGameLayerSlotList"), &Z_Registration_Info_UScriptStruct_UIFrameworkGameLayerSlotList, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkGameLayerSlotList), 4236489479U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFPlayerComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUIFrameworkPlayerComponent, UUIFrameworkPlayerComponent::StaticClass, TEXT("UUIFrameworkPlayerComponent"), &Z_Registration_Info_UClass_UUIFrameworkPlayerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUIFrameworkPlayerComponent), 1910110888U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_UIFPlayerComponent_h_1700997266(TEXT("/Script/UIFramework"),
