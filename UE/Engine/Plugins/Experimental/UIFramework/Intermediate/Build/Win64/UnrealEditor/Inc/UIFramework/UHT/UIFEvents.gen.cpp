...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkSimpleEventArgument>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::NewProp_PlayerController = { "PlayerController", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSimpleEventArgument, PlayerController), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::NewProp_PlayerController_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::NewProp_PlayerController_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::NewProp_Sender = { "Sender", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUIFrameworkSimpleEventArgument, Sender), Z_Construct_UClass_UUIFrameworkWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::NewProp_Sender_MetaData), Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::NewProp_Sender_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::PropPointers) < 2048);
...
template<> UIFRAMEWORK_API UScriptStruct* StaticStruct<FUIFrameworkClickEventArgument>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FUIFrameworkClickEventArgument_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUIFrameworkClickEventArgument_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FUIFrameworkClickEventArgument_Statics::Struct_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFEvents_h_Statics::ScriptStructInfo[] = {
		{ FUIFrameworkSimpleEventArgument::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkSimpleEventArgument_Statics::NewStructOps, TEXT("UIFrameworkSimpleEventArgument"), &Z_Registration_Info_UScriptStruct_UIFrameworkSimpleEventArgument, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkSimpleEventArgument), 1659161748U) },
		{ FUIFrameworkClickEventArgument::StaticStruct, Z_Construct_UScriptStruct_FUIFrameworkClickEventArgument_Statics::NewStructOps, TEXT("UIFrameworkClickEventArgument"), &Z_Registration_Info_UScriptStruct_UIFrameworkClickEventArgument, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUIFrameworkClickEventArgument), 611982455U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_UIFramework_Source_Public_Types_UIFEvents_h_3567525445(TEXT("/Script/UIFramework"),
		nullptr, 0,
