...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_DetectFaces_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UK2Node_DetectFaces_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UK2Node_DetectFaces_Statics::Class_MetaDataParams), Z_Construct_UClass_UK2Node_DetectFaces_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AppleVision_Source_AppleVisionBlueprintSupport_Classes_AppleVisionBlueprintSupport_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UK2Node_DetectFaces, UK2Node_DetectFaces::StaticClass, TEXT("UK2Node_DetectFaces"), &Z_Registration_Info_UClass_UK2Node_DetectFaces, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UK2Node_DetectFaces), 1860305998U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_AppleVision_Source_AppleVisionBlueprintSupport_Classes_AppleVisionBlueprintSupport_h_1305213719(TEXT("/Script/AppleVisionBlueprintSupport"),
