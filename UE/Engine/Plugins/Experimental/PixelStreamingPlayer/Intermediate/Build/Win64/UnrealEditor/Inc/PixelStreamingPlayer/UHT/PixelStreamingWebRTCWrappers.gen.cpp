...
template<> PIXELSTREAMINGPLAYER_API UScriptStruct* StaticStruct<FPixelStreamingRTCConfigWrapper>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPixelStreamingRTCConfigWrapper_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPixelStreamingRTCConfigWrapper_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPixelStreamingRTCConfigWrapper_Statics::Struct_MetaDataParams)
	};
...
template<> PIXELSTREAMINGPLAYER_API UScriptStruct* StaticStruct<FPixelStreamingSessionDescriptionWrapper>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPixelStreamingSessionDescriptionWrapper_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPixelStreamingSessionDescriptionWrapper_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPixelStreamingSessionDescriptionWrapper_Statics::Struct_MetaDataParams)
	};
...
template<> PIXELSTREAMINGPLAYER_API UScriptStruct* StaticStruct<FPixelStreamingIceCandidateWrapper>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPixelStreamingIceCandidateWrapper_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPixelStreamingIceCandidateWrapper_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FPixelStreamingIceCandidateWrapper_Statics::Struct_MetaDataParams)
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PixelStreamingPlayer_Source_PixelStreamingPlayer_Public_PixelStreamingWebRTCWrappers_h_1357424446(TEXT("/Script/PixelStreamingPlayer"),
		nullptr, 0,
