...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::NewProp_Candidate = { "Candidate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_PixelStreamingPlayer_eventPixelStreamingOnIceCandidate_Parms, Candidate), Z_Construct_UScriptStruct_FPixelStreamingIceCandidateWrapper, METADATA_PARAMS(0, nullptr) }; // 958778734
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PixelStreamingPlayer, nullptr, "PixelStreamingOnIceCandidate__DelegateSignature", "PixelStreamingPeerComponent", "OnIceCandidate", Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::_Script_PixelStreamingPlayer_eventPixelStreamingOnIceCandidate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature_Statics::_Script_PixelStreamingPlayer_eventPixelStreamingOnIceCandidate_Parms) < MAX_uint16);
...
void FPixelStreamingOnIceCandidate_DelegateWrapper(const FMulticastScriptDelegate& PixelStreamingOnIceCandidate, FPixelStreamingIceCandidateWrapper Candidate)
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::NewProp_Number = { "Number", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_PixelStreamingPlayer_eventPixelStreamingOnIceConnection_Parms, Number), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PixelStreamingPlayer, nullptr, "PixelStreamingOnIceConnection__DelegateSignature", "PixelStreamingPeerComponent", "OnIceConnection", Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::_Script_PixelStreamingPlayer_eventPixelStreamingOnIceConnection_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature_Statics::_Script_PixelStreamingPlayer_eventPixelStreamingOnIceConnection_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceDisconnection__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_PixelStreamingPlayer, nullptr, "PixelStreamingOnIceDisconnection__DelegateSignature", "PixelStreamingPeerComponent", "OnIceDisconnection", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceDisconnection__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceDisconnection__DelegateSignature_Statics::Function_MetaDataParams) };
...
void FPixelStreamingOnIceDisconnection_DelegateWrapper(const FMulticastScriptDelegate& PixelStreamingOnIceDisconnection)
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::NewProp_Offer = { "Offer", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PixelStreamingPeerComponent_eventCreateAnswer_Parms, Offer), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::NewProp_Offer_MetaData), Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::NewProp_Offer_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PixelStreamingPeerComponent_eventCreateAnswer_Parms, ReturnValue), Z_Construct_UScriptStruct_FPixelStreamingSessionDescriptionWrapper, METADATA_PARAMS(0, nullptr) }; // 2018595884
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPixelStreamingPeerComponent, nullptr, "CreateAnswer", nullptr, nullptr, Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::PixelStreamingPeerComponent_eventCreateAnswer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer_Statics::PixelStreamingPeerComponent_eventCreateAnswer_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PixelStreamingPeerComponent_eventCreateOffer_Parms, ReturnValue), Z_Construct_UScriptStruct_FPixelStreamingSessionDescriptionWrapper, METADATA_PARAMS(0, nullptr) }; // 2018595884
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPixelStreamingPeerComponent, nullptr, "CreateOffer", nullptr, nullptr, Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::PixelStreamingPeerComponent_eventCreateOffer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer_Statics::PixelStreamingPeerComponent_eventCreateOffer_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::NewProp_Offer = { "Offer", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PixelStreamingPeerComponent_eventReceiveAnswer_Parms, Offer), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::NewProp_Offer_MetaData), Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::NewProp_Offer_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPixelStreamingPeerComponent, nullptr, "ReceiveAnswer", nullptr, nullptr, Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::PixelStreamingPeerComponent_eventReceiveAnswer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer_Statics::PixelStreamingPeerComponent_eventReceiveAnswer_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::NewProp_Candidate = { "Candidate", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PixelStreamingPeerComponent_eventReceiveIceCandidate_Parms, Candidate), Z_Construct_UScriptStruct_FPixelStreamingIceCandidateWrapper, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::NewProp_Candidate_MetaData), Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::NewProp_Candidate_MetaData) }; // 958778734
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPixelStreamingPeerComponent, nullptr, "ReceiveIceCandidate", nullptr, nullptr, Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::PixelStreamingPeerComponent_eventReceiveIceCandidate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate_Statics::PixelStreamingPeerComponent_eventReceiveIceCandidate_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::NewProp_Config = { "Config", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(PixelStreamingPeerComponent_eventSetConfig_Parms, Config), Z_Construct_UScriptStruct_FPixelStreamingRTCConfigWrapper, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::NewProp_Config_MetaData), Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::NewProp_Config_MetaData) }; // 272040167
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPixelStreamingPeerComponent, nullptr, "SetConfig", nullptr, nullptr, Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::PixelStreamingPeerComponent_eventSetConfig_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig_Statics::PixelStreamingPeerComponent_eventSetConfig_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateAnswer, "CreateAnswer" }, // 3963083255
		{ &Z_Construct_UFunction_UPixelStreamingPeerComponent_CreateOffer, "CreateOffer" }, // 4184447242
		{ &Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveAnswer, "ReceiveAnswer" }, // 729182722
		{ &Z_Construct_UFunction_UPixelStreamingPeerComponent_ReceiveIceCandidate, "ReceiveIceCandidate" }, // 3163971140
		{ &Z_Construct_UFunction_UPixelStreamingPeerComponent_SetConfig, "SetConfig" }, // 1884019126
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceCandidate = { "OnIceCandidate", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::SparseMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPixelStreamingPeerComponent, OnIceCandidate), Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceCandidate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceCandidate_MetaData), Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceCandidate_MetaData) }; // 4279064816
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceConnection = { "OnIceConnection", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::SparseMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPixelStreamingPeerComponent, OnIceConnection), Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceConnection__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceConnection_MetaData), Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceConnection_MetaData) }; // 1658141059
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceDisconnection = { "OnIceDisconnection", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::SparseMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPixelStreamingPeerComponent, OnIceDisconnection), Z_Construct_USparseDelegateFunction_PixelStreamingPlayer_PixelStreamingOnIceDisconnection__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceDisconnection_MetaData), Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_OnIceDisconnection_MetaData) }; // 3117006211
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_VideoSinkPlayer = { "VideoSinkPlayer", nullptr, (EPropertyFlags)0x0014000000010001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPixelStreamingPeerComponent, VideoSinkPlayer), Z_Construct_UClass_UMediaPlayer_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_VideoSinkPlayer_MetaData), Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::NewProp_VideoSinkPlayer_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingPeerComponent_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PixelStreamingPlayer_Source_PixelStreamingPlayer_Public_PixelStreamingPeerComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPixelStreamingPeerComponent, UPixelStreamingPeerComponent::StaticClass, TEXT("UPixelStreamingPeerComponent"), &Z_Registration_Info_UClass_UPixelStreamingPeerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPixelStreamingPeerComponent), 2993534857U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_PixelStreamingPlayer_Source_PixelStreamingPlayer_Public_PixelStreamingPeerComponent_h_607629818(TEXT("/Script/PixelStreamingPlayer"),
