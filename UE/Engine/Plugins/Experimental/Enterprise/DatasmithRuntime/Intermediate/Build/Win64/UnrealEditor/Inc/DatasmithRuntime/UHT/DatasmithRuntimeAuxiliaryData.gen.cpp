...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::NewProp_AssetUserData_Inner = { "AssetUserData", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UAssetUserData_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::NewProp_AssetUserData = { "AssetUserData", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithRuntimeTHelper, AssetUserData), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::NewProp_AssetUserData_MetaData), Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::NewProp_AssetUserData_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UInterface_AssetUserData_NoRegister, (int32)VTABLE_OFFSET(UDatasmithRuntimeTHelper, IInterface_AssetUserData), false },  // 1872046249
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::ClassParams = {
		...
		0x008800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeTHelper_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::NewProp_Auxiliary = { "Auxiliary", nullptr, (EPropertyFlags)0x0014000000020001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDatasmithRuntimeAuxiliaryData, Auxiliary), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::NewProp_Auxiliary_MetaData), Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::NewProp_Auxiliary_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::ClassParams = {
		...
		0,
		0x002810A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Enterprise_DatasmithRuntime_Source_Private_DatasmithRuntimeAuxiliaryData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithRuntimeTHelper, UDatasmithRuntimeTHelper::StaticClass, TEXT("UDatasmithRuntimeTHelper"), &Z_Registration_Info_UClass_UDatasmithRuntimeTHelper, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithRuntimeTHelper), 1007883317U) },
		{ Z_Construct_UClass_UDatasmithRuntimeAuxiliaryData, UDatasmithRuntimeAuxiliaryData::StaticClass, TEXT("UDatasmithRuntimeAuxiliaryData"), &Z_Registration_Info_UClass_UDatasmithRuntimeAuxiliaryData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithRuntimeAuxiliaryData), 676028207U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Enterprise_DatasmithRuntime_Source_Private_DatasmithRuntimeAuxiliaryData_h_2325997145(TEXT("/Script/DatasmithRuntime"),
