...
template<> DATASMITHRUNTIME_API UScriptStruct* StaticStruct<FDatasmithRuntimeSourceInfo>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDatasmithRuntimeSourceInfo, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::NewProp_Name_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::PropPointers) < 2048);
...
void FDatasmithRuntimeChangeEvent_DelegateWrapper(const FMulticastScriptDelegate& DatasmithRuntimeChangeEvent)
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DirectLinkProxy_eventGetEndPointName_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDirectLinkProxy, nullptr, "GetEndPointName", nullptr, nullptr, Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::DirectLinkProxy_eventGetEndPointName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName_Statics::DirectLinkProxy_eventGetEndPointName_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo, METADATA_PARAMS(0, nullptr) }; // 910563067
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DirectLinkProxy_eventGetListOfSources_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 910563067
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDirectLinkProxy, nullptr, "GetListOfSources", nullptr, nullptr, Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::DirectLinkProxy_eventGetListOfSources_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources_Statics::DirectLinkProxy_eventGetListOfSources_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDirectLinkProxy_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDirectLinkProxy_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDirectLinkProxy_GetEndPointName, "GetEndPointName" }, // 661066460
		{ &Z_Construct_UFunction_UDirectLinkProxy_GetListOfSources, "GetListOfSources" }, // 1653759485
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDirectLinkProxy_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UDirectLinkProxy_Statics::NewProp_OnDirectLinkChange = { "OnDirectLinkChange", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDirectLinkProxy, OnDirectLinkChange), Z_Construct_UDelegateFunction_DatasmithRuntime_DatasmithRuntimeChangeEvent__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDirectLinkProxy_Statics::NewProp_OnDirectLinkChange_MetaData), Z_Construct_UClass_UDirectLinkProxy_Statics::NewProp_OnDirectLinkChange_MetaData) }; // 544210830
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDirectLinkProxy_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDirectLinkProxy_Statics::Class_MetaDataParams), Z_Construct_UClass_UDirectLinkProxy_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDirectLinkProxy_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DatasmithRuntimeLibrary_eventGetDirectLinkProxy_Parms, ReturnValue), Z_Construct_UClass_UDirectLinkProxy_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDatasmithRuntimeLibrary, nullptr, "GetDirectLinkProxy", nullptr, nullptr, Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::DatasmithRuntimeLibrary_eventGetDirectLinkProxy_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy_Statics::DatasmithRuntimeLibrary_eventGetDirectLinkProxy_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::NewProp_DatasmithRuntimeActor = { "DatasmithRuntimeActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DatasmithRuntimeLibrary_eventLoadFile_Parms, DatasmithRuntimeActor), Z_Construct_UClass_ADatasmithRuntimeActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::NewProp_FilePath = { "FilePath", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DatasmithRuntimeLibrary_eventLoadFile_Parms, FilePath), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::NewProp_FilePath_MetaData), Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::NewProp_FilePath_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(DatasmithRuntimeLibrary_eventLoadFile_Parms), &Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDatasmithRuntimeLibrary, nullptr, "LoadFile", nullptr, nullptr, Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::DatasmithRuntimeLibrary_eventLoadFile_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile_Statics::DatasmithRuntimeLibrary_eventLoadFile_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::NewProp_DatasmithRuntimeActor = { "DatasmithRuntimeActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DatasmithRuntimeLibrary_eventLoadFileFromExplorer_Parms, DatasmithRuntimeActor), Z_Construct_UClass_ADatasmithRuntimeActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::NewProp_DefaultPath = { "DefaultPath", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DatasmithRuntimeLibrary_eventLoadFileFromExplorer_Parms, DefaultPath), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::NewProp_DefaultPath_MetaData), Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::NewProp_DefaultPath_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(DatasmithRuntimeLibrary_eventLoadFileFromExplorer_Parms), &Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDatasmithRuntimeLibrary, nullptr, "LoadFileFromExplorer", nullptr, nullptr, Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::DatasmithRuntimeLibrary_eventLoadFileFromExplorer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer_Statics::DatasmithRuntimeLibrary_eventLoadFileFromExplorer_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::NewProp_DatasmithRuntimeActor = { "DatasmithRuntimeActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DatasmithRuntimeLibrary_eventResetActor_Parms, DatasmithRuntimeActor), Z_Construct_UClass_ADatasmithRuntimeActor_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDatasmithRuntimeLibrary, nullptr, "ResetActor", nullptr, nullptr, Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::PropPointers), sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::DatasmithRuntimeLibrary_eventResetActor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::Function_MetaDataParams), Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor_Statics::DatasmithRuntimeLibrary_eventResetActor_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeLibrary_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UDatasmithRuntimeLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDatasmithRuntimeLibrary_GetDirectLinkProxy, "GetDirectLinkProxy" }, // 2635921324
		{ &Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFile, "LoadFile" }, // 2124559342
		{ &Z_Construct_UFunction_UDatasmithRuntimeLibrary_LoadFileFromExplorer, "LoadFileFromExplorer" }, // 3425086927
		{ &Z_Construct_UFunction_UDatasmithRuntimeLibrary_ResetActor, "ResetActor" }, // 3619105267
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeLibrary_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithRuntimeLibrary_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithRuntimeLibrary_Statics::Class_MetaDataParams), Z_Construct_UClass_UDatasmithRuntimeLibrary_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Enterprise_DatasmithRuntime_Source_Public_DatasmithRuntimeBlueprintLibrary_h_Statics::ScriptStructInfo[] = {
		{ FDatasmithRuntimeSourceInfo::StaticStruct, Z_Construct_UScriptStruct_FDatasmithRuntimeSourceInfo_Statics::NewStructOps, TEXT("DatasmithRuntimeSourceInfo"), &Z_Registration_Info_UScriptStruct_DatasmithRuntimeSourceInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDatasmithRuntimeSourceInfo), 910563067U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Enterprise_DatasmithRuntime_Source_Public_DatasmithRuntimeBlueprintLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDirectLinkProxy, UDirectLinkProxy::StaticClass, TEXT("UDirectLinkProxy"), &Z_Registration_Info_UClass_UDirectLinkProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDirectLinkProxy), 2365132799U) },
		{ Z_Construct_UClass_UDatasmithRuntimeLibrary, UDatasmithRuntimeLibrary::StaticClass, TEXT("UDatasmithRuntimeLibrary"), &Z_Registration_Info_UClass_UDatasmithRuntimeLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithRuntimeLibrary), 2307960133U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Enterprise_DatasmithRuntime_Source_Public_DatasmithRuntimeBlueprintLibrary_h_4270636737(TEXT("/Script/DatasmithRuntime"),
