...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDatabaseCompatibility_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTypedElementDatabaseCompatibility_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UTypedElementDatabaseCompatibility_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UTypedElementDataStorageCompatibilityInterface_NoRegister, (int32)VTABLE_OFFSET(UTypedElementDatabaseCompatibility, ITypedElementDataStorageCompatibilityInterface), false },  // 2360461279
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDatabaseCompatibility_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTypedElementDatabaseCompatibility_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDatabaseCompatibility_Statics::Class_MetaDataParams), Z_Construct_UClass_UTypedElementDatabaseCompatibility_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_TypedElementsDataStorage_Source_TypedElementsDataStorage_Private_TypedElementDatabaseCompatibility_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTypedElementDatabaseCompatibility, UTypedElementDatabaseCompatibility::StaticClass, TEXT("UTypedElementDatabaseCompatibility"), &Z_Registration_Info_UClass_UTypedElementDatabaseCompatibility, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTypedElementDatabaseCompatibility), 2093343310U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_TypedElementsDataStorage_Source_TypedElementsDataStorage_Private_TypedElementDatabaseCompatibility_h_3072996460(TEXT("/Script/TypedElementsDataStorage"),
