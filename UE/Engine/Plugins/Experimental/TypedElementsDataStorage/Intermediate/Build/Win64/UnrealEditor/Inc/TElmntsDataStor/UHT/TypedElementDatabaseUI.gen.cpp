...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDatabaseUi_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTypedElementDatabaseUi_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UTypedElementDatabaseUi_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UTypedElementDataStorageUiInterface_NoRegister, (int32)VTABLE_OFFSET(UTypedElementDatabaseUi, ITypedElementDataStorageUiInterface), false },  // 1768843965
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDatabaseUi_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTypedElementDatabaseUi_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDatabaseUi_Statics::Class_MetaDataParams), Z_Construct_UClass_UTypedElementDatabaseUi_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_TypedElementsDataStorage_Source_TypedElementsDataStorage_Private_TypedElementDatabaseUI_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTypedElementDatabaseUi, UTypedElementDatabaseUi::StaticClass, TEXT("UTypedElementDatabaseUi"), &Z_Registration_Info_UClass_UTypedElementDatabaseUi, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTypedElementDatabaseUi), 632478512U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_TypedElementsDataStorage_Source_TypedElementsDataStorage_Private_TypedElementDatabaseUI_h_1821963645(TEXT("/Script/TypedElementsDataStorage"),
