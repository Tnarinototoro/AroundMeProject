...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDataStorageSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTypedElementDataStorageSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDataStorageSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UTypedElementDataStorageSubsystem_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDataStorageUiSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTypedElementDataStorageUiSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDataStorageUiSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UTypedElementDataStorageUiSubsystem_Statics::Class_MetaDataParams)
	};
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDataStorageCompatibilitySubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTypedElementDataStorageCompatibilitySubsystem_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "TypedElementSubsystems.h" },
		{ "ModuleRelativePath", "Public/TypedElementSubsystems.h" },
		{ "ToolTip", "A subsystem to provide alternative access to the Typed Elements Data Storage Compatibility. This can be used in situations where directly\naccessing the Compatibility extension from the Typed Elements Registry is not recommended, such as for MASS." },
	};
#endif
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTypedElementDataStorageCompatibilitySubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTypedElementDataStorageCompatibilitySubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UTypedElementDataStorageCompatibilitySubsystem_Statics::Class_MetaDataParams)
	};
