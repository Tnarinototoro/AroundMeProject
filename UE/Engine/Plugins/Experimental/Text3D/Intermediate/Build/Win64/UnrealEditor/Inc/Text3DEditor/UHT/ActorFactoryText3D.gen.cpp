...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryText3D_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UActorFactoryText3D_Statics::ClassParams = {
		...
		0,
		0x000830ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UActorFactoryText3D_Statics::Class_MetaDataParams), Z_Construct_UClass_UActorFactoryText3D_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Text3D_Source_Text3DEditor_Public_ActorFactoryText3D_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorFactoryText3D, UActorFactoryText3D::StaticClass, TEXT("UActorFactoryText3D"), &Z_Registration_Info_UClass_UActorFactoryText3D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorFactoryText3D), 3377502195U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_Text3D_Source_Text3DEditor_Public_ActorFactoryText3D_h_2770673275(TEXT("/Script/Text3DEditor"),
