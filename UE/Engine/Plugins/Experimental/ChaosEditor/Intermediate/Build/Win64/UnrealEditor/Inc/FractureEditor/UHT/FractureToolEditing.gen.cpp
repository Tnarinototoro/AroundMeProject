...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveUnreferencedGeometry = { "bRemoveUnreferencedGeometry", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UFractureValidateSettings), &Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveUnreferencedGeometry_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveUnreferencedGeometry_MetaData), Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveUnreferencedGeometry_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveDanglingClusters = { "bRemoveDanglingClusters", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UFractureValidateSettings), &Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveDanglingClusters_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveDanglingClusters_MetaData), Z_Construct_UClass_UFractureValidateSettings_Statics::NewProp_bRemoveDanglingClusters_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolEditing_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFractureToolDeleteBranch, UFractureToolDeleteBranch::StaticClass, TEXT("UFractureToolDeleteBranch"), &Z_Registration_Info_UClass_UFractureToolDeleteBranch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolDeleteBranch), 2901924829U) },
		{ Z_Construct_UClass_UFractureToolMergeSelected, UFractureToolMergeSelected::StaticClass, TEXT("UFractureToolMergeSelected"), &Z_Registration_Info_UClass_UFractureToolMergeSelected, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolMergeSelected), 149361629U) },
		{ Z_Construct_UClass_UFractureToolSplitSelected, UFractureToolSplitSelected::StaticClass, TEXT("UFractureToolSplitSelected"), &Z_Registration_Info_UClass_UFractureToolSplitSelected, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolSplitSelected), 3981901686U) },
		{ Z_Construct_UClass_UFractureToolHide, UFractureToolHide::StaticClass, TEXT("UFractureToolHide"), &Z_Registration_Info_UClass_UFractureToolHide, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolHide), 968475678U) },
		{ Z_Construct_UClass_UFractureToolUnhide, UFractureToolUnhide::StaticClass, TEXT("UFractureToolUnhide"), &Z_Registration_Info_UClass_UFractureToolUnhide, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolUnhide), 1436397600U) },
		{ Z_Construct_UClass_UFractureValidateSettings, UFractureValidateSettings::StaticClass, TEXT("UFractureValidateSettings"), &Z_Registration_Info_UClass_UFractureValidateSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureValidateSettings), 428646480U) },
		{ Z_Construct_UClass_UFractureToolValidate, UFractureToolValidate::StaticClass, TEXT("UFractureToolValidate"), &Z_Registration_Info_UClass_UFractureToolValidate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolValidate), 1294245125U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolEditing_h_3528913589(TEXT("/Script/FractureEditor"),
