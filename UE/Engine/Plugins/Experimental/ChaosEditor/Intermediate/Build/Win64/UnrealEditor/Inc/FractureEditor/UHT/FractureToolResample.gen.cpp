...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFractureResampleSettings_Statics::NewProp_bOnlyShowAddedPoints = { "bOnlyShowAddedPoints", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UFractureResampleSettings), &Z_Construct_UClass_UFractureResampleSettings_Statics::NewProp_bOnlyShowAddedPoints_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureResampleSettings_Statics::NewProp_bOnlyShowAddedPoints_MetaData), Z_Construct_UClass_UFractureResampleSettings_Statics::NewProp_bOnlyShowAddedPoints_MetaData) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UFractureToolResample_Statics::NewProp_ResampleSettings = { "ResampleSettings", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureToolResample, ResampleSettings), Z_Construct_UClass_UFractureResampleSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureToolResample_Statics::NewProp_ResampleSettings_MetaData), Z_Construct_UClass_UFractureToolResample_Statics::NewProp_ResampleSettings_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolResample_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFractureResampleSettings, UFractureResampleSettings::StaticClass, TEXT("UFractureResampleSettings"), &Z_Registration_Info_UClass_UFractureResampleSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureResampleSettings), 262038511U) },
		{ Z_Construct_UClass_UFractureToolResample, UFractureToolResample::StaticClass, TEXT("UFractureToolResample"), &Z_Registration_Info_UClass_UFractureToolResample, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolResample), 2728142736U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolResample_h_2457969342(TEXT("/Script/FractureEditor"),
