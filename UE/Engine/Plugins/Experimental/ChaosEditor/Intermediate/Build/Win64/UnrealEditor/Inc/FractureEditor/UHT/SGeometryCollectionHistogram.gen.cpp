...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UHistogramSettings_Statics::NewProp_InspectedAttribute = { "InspectedAttribute", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHistogramSettings, InspectedAttribute), Z_Construct_UEnum_FractureEditor_EInspectedAttributeEnum, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHistogramSettings_Statics::NewProp_InspectedAttribute_MetaData), Z_Construct_UClass_UHistogramSettings_Statics::NewProp_InspectedAttribute_MetaData) }; // 3828690247
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowClusters = { "bShowClusters", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHistogramSettings), &Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowClusters_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowClusters_MetaData), Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowClusters_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowEmbedded = { "bShowEmbedded", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHistogramSettings), &Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowEmbedded_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowEmbedded_MetaData), Z_Construct_UClass_UHistogramSettings_Statics::NewProp_bShowEmbedded_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_SGeometryCollectionHistogram_h_Statics::EnumInfo[] = {
		{ EInspectedAttributeEnum_StaticEnum, TEXT("EInspectedAttributeEnum"), &Z_Registration_Info_UEnum_EInspectedAttributeEnum, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3828690247U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_SGeometryCollectionHistogram_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHistogramSettings, UHistogramSettings::StaticClass, TEXT("UHistogramSettings"), &Z_Registration_Info_UClass_UHistogramSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHistogramSettings), 447558021U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_SGeometryCollectionHistogram_h_583221347(TEXT("/Script/FractureEditor"),
