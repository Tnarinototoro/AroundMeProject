...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UFractureToolSettings_Statics::NewProp_OwnerTool = { "OwnerTool", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureToolSettings, OwnerTool), Z_Construct_UClass_UFractureModalTool_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureToolSettings_Statics::NewProp_OwnerTool_MetaData), Z_Construct_UClass_UFractureToolSettings_Statics::NewProp_OwnerTool_MetaData) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UFractureModalTool_Statics::NewProp_VisualizedCollections_Inner = { "VisualizedCollections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UGeometryCollectionComponent_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UFractureModalTool_Statics::NewProp_VisualizedCollections = { "VisualizedCollections", nullptr, (EPropertyFlags)0x0024088000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureModalTool, VisualizedCollections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureModalTool_Statics::NewProp_VisualizedCollections_MetaData), Z_Construct_UClass_UFractureModalTool_Statics::NewProp_VisualizedCollections_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Public_FractureTool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFractureToolSettings, UFractureToolSettings::StaticClass, TEXT("UFractureToolSettings"), &Z_Registration_Info_UClass_UFractureToolSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolSettings), 1255999217U) },
		{ Z_Construct_UClass_UFractureActionTool, UFractureActionTool::StaticClass, TEXT("UFractureActionTool"), &Z_Registration_Info_UClass_UFractureActionTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureActionTool), 1607263144U) },
		{ Z_Construct_UClass_UFractureModalTool, UFractureModalTool::StaticClass, TEXT("UFractureModalTool"), &Z_Registration_Info_UClass_UFractureModalTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureModalTool), 2490945312U) },
		{ Z_Construct_UClass_UFractureInteractiveTool, UFractureInteractiveTool::StaticClass, TEXT("UFractureInteractiveTool"), &Z_Registration_Info_UClass_UFractureInteractiveTool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureInteractiveTool), 3267580743U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Public_FractureTool_h_3503791044(TEXT("/Script/FractureEditor"),
