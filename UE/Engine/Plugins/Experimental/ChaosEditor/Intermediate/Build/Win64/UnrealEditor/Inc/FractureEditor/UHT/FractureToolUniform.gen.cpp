...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UFractureUniformSettings_Statics::NewProp_NumberVoronoiSitesMax = { "NumberVoronoiSitesMax", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureUniformSettings, NumberVoronoiSitesMax), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureUniformSettings_Statics::NewProp_NumberVoronoiSitesMax_MetaData), Z_Construct_UClass_UFractureUniformSettings_Statics::NewProp_NumberVoronoiSitesMax_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolUniform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFractureUniformSettings, UFractureUniformSettings::StaticClass, TEXT("UFractureUniformSettings"), &Z_Registration_Info_UClass_UFractureUniformSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureUniformSettings), 2366496590U) },
		{ Z_Construct_UClass_UFractureToolUniform, UFractureToolUniform::StaticClass, TEXT("UFractureToolUniform"), &Z_Registration_Info_UClass_UFractureToolUniform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolUniform), 464242100U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolUniform_h_2227483083(TEXT("/Script/FractureEditor"),
