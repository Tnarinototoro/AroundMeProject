...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_FractureEditor_EFractureModeNewAssetLocation_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_FractureEditor_EFractureModeNewAssetLocation_Statics::Enum_MetaDataParams[] = {
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_NewAssetLocation_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ProximityConnectionContactAreaMethod_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_NewAssetLocation_MetaData[] = {
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ConvexCanExceedFraction = { "ConvexCanExceedFraction", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureModeSettings, ConvexCanExceedFraction), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ConvexCanExceedFraction_MetaData), Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ConvexCanExceedFraction_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityMethod = { "ProximityMethod", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureModeSettings, ProximityMethod), Z_Construct_UEnum_Chaos_EProximityMethod, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityMethod_MetaData), Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityMethod_MetaData) }; // 3338841359
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityConnectionContactAreaMethod_MetaData[] = {
		{ "Category", "Fracture Mode|Proximity Detection Defaults" },
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityConnectionContactAreaMethod = { "ProximityConnectionContactAreaMethod", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureModeSettings, ProximityConnectionContactAreaMethod), Z_Construct_UEnum_Chaos_EConnectionContactMethod, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityConnectionContactAreaMethod_MetaData), Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityConnectionContactAreaMethod_MetaData) }; // 1496803968
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityContactThreshold = { "ProximityContactThreshold", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureModeSettings, ProximityContactThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityContactThreshold_MetaData), Z_Construct_UClass_UFractureModeSettings_Statics::NewProp_ProximityContactThreshold_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Public_FractureModeSettings_h_Statics::EnumInfo[] = {
		{ EFractureModeNewAssetLocation_StaticEnum, TEXT("EFractureModeNewAssetLocation"), &Z_Registration_Info_UEnum_EFractureModeNewAssetLocation, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1863350584U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Public_FractureModeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFractureModeSettings, UFractureModeSettings::StaticClass, TEXT("UFractureModeSettings"), &Z_Registration_Info_UClass_UFractureModeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureModeSettings), 2517070119U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Public_FractureModeSettings_h_449018695(TEXT("/Script/FractureEditor"),
		...
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Public_FractureModeSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Public_FractureModeSettings_h_Statics::EnumInfo));
