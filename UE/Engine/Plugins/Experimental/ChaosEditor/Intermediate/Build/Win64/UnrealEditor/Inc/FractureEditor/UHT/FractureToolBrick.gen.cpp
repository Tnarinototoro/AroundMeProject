...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFractureBrickSettings_Statics::NewProp_BrickHeight = { "BrickHeight", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureBrickSettings, BrickHeight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureBrickSettings_Statics::NewProp_BrickHeight_MetaData), Z_Construct_UClass_UFractureBrickSettings_Statics::NewProp_BrickHeight_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UFractureToolBrick_Statics::NewProp_BrickSettings = { "BrickSettings", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureToolBrick, BrickSettings), Z_Construct_UClass_UFractureBrickSettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureToolBrick_Statics::NewProp_BrickSettings_MetaData), Z_Construct_UClass_UFractureToolBrick_Statics::NewProp_BrickSettings_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolBrick_h_Statics::EnumInfo[] = {
		{ EFractureBrickBond_StaticEnum, TEXT("EFractureBrickBond"), &Z_Registration_Info_UEnum_EFractureBrickBond, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2502956666U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolBrick_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFractureBrickSettings, UFractureBrickSettings::StaticClass, TEXT("UFractureBrickSettings"), &Z_Registration_Info_UClass_UFractureBrickSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureBrickSettings), 2337235948U) },
		{ Z_Construct_UClass_UFractureToolBrick, UFractureToolBrick::StaticClass, TEXT("UFractureToolBrick"), &Z_Registration_Info_UClass_UFractureToolBrick, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolBrick), 885306293U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolBrick_h_80541353(TEXT("/Script/FractureEditor"),
