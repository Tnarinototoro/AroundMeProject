...
#include "../Private/FractureToolEmbed.h"
...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UFractureToolAddEmbeddedGeometry);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureToolAddEmbeddedGeometry_Statics::Class_MetaDataParams[] = {
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UFractureToolAutoEmbedGeometry);
	UClass* Z_Construct_UClass_UFractureToolAutoEmbedGeometry_NoRegister()
	{
		return UFractureToolAutoEmbedGeometry::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureToolAutoEmbedGeometry_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "FractureToolEmbed.h" },
		{ "ModuleRelativePath", "Private/FractureToolEmbed.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UFractureToolAutoEmbedGeometry_Statics::StaticCppClassTypeInfo = {
	...
	template<> FRACTUREEDITOR_API UClass* StaticClass<UFractureToolAutoEmbedGeometry>()
	{
		return UFractureToolAutoEmbedGeometry::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFractureToolAutoEmbedGeometry);
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UFractureToolFlushEmbeddedGeometrySettings);
	UClass* Z_Construct_UClass_UFractureToolFlushEmbeddedGeometrySettings_NoRegister()
	{
		return UFractureToolFlushEmbeddedGeometrySettings::StaticClass();
	}
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bExtractAsStaticMeshActors_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureToolFlushEmbeddedGeometrySettings_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureToolFlushEmbeddedGeometrySettings_Statics::NewProp_bExtractAsStaticMeshActors_MetaData[] = {
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UFractureToolFlushEmbeddedGeometrySettings_Statics::StaticCppClassTypeInfo = {
	...
	template<> FRACTUREEDITOR_API UClass* StaticClass<UFractureToolFlushEmbeddedGeometrySettings>()
	{
		return UFractureToolFlushEmbeddedGeometrySettings::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFractureToolFlushEmbeddedGeometrySettings);
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UFractureToolFlushEmbeddedGeometry);
	UClass* Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry_NoRegister()
	{
		return UFractureToolFlushEmbeddedGeometry::StaticClass();
	}
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_FlushEmbeddedGeometrySettings_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_FlushEmbeddedGeometrySettings;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UECodeGen_Private::FClassParams ClassParams;
	};
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry_Statics::Class_MetaDataParams[] = {
		{ "Category", "FractureTools" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry_Statics::NewProp_FlushEmbeddedGeometrySettings_MetaData[] = {
		{ "Category", "EmbeddedGeometry" },
		{ "ModuleRelativePath", "Private/FractureToolEmbed.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry_Statics::NewProp_FlushEmbeddedGeometrySettings = { "FlushEmbeddedGeometrySettings", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFractureToolFlushEmbeddedGeometry, FlushEmbeddedGeometrySettings), Z_Construct_UClass_UFractureToolFlushEmbeddedGeometrySettings_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry_Statics::NewProp_FlushEmbeddedGeometrySettings_MetaData), Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry_Statics::NewProp_FlushEmbeddedGeometrySettings_MetaData) };
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry_Statics::StaticCppClassTypeInfo = {
	...
	template<> FRACTUREEDITOR_API UClass* StaticClass<UFractureToolFlushEmbeddedGeometry>()
	{
		return UFractureToolFlushEmbeddedGeometry::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFractureToolFlushEmbeddedGeometry);
	UFractureToolFlushEmbeddedGeometry::~UFractureToolFlushEmbeddedGeometry() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolEmbed_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolEmbed_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFractureToolAddEmbeddedGeometry, UFractureToolAddEmbeddedGeometry::StaticClass, TEXT("UFractureToolAddEmbeddedGeometry"), &Z_Registration_Info_UClass_UFractureToolAddEmbeddedGeometry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolAddEmbeddedGeometry), 801459396U) },
		{ Z_Construct_UClass_UFractureToolAutoEmbedGeometry, UFractureToolAutoEmbedGeometry::StaticClass, TEXT("UFractureToolAutoEmbedGeometry"), &Z_Registration_Info_UClass_UFractureToolAutoEmbedGeometry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolAutoEmbedGeometry), 1947132774U) },
		{ Z_Construct_UClass_UFractureToolFlushEmbeddedGeometrySettings, UFractureToolFlushEmbeddedGeometrySettings::StaticClass, TEXT("UFractureToolFlushEmbeddedGeometrySettings"), &Z_Registration_Info_UClass_UFractureToolFlushEmbeddedGeometrySettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolFlushEmbeddedGeometrySettings), 722638986U) },
		{ Z_Construct_UClass_UFractureToolFlushEmbeddedGeometry, UFractureToolFlushEmbeddedGeometry::StaticClass, TEXT("UFractureToolFlushEmbeddedGeometry"), &Z_Registration_Info_UClass_UFractureToolFlushEmbeddedGeometry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFractureToolFlushEmbeddedGeometry), 4269016186U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolEmbed_h_2606984033(TEXT("/Script/FractureEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolEmbed_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosEditor_Source_FractureEditor_Private_FractureToolEmbed_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
