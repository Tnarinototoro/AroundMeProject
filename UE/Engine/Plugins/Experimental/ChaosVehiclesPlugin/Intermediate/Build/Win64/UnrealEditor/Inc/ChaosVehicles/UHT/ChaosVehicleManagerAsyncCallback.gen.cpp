...
template<> CHAOSVEHICLES_API UScriptStruct* StaticStruct<FNetworkVehicleStates>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosVehiclesPlugin_Source_ChaosVehicles_Public_ChaosVehicleManagerAsyncCallback_h_Statics::ScriptStructInfo[] = {
		...
		{ FControlInputs::StaticStruct, Z_Construct_UScriptStruct_FControlInputs_Statics::NewStructOps, TEXT("ControlInputs"), &Z_Registration_Info_UScriptStruct_ControlInputs, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FControlInputs), 4054516196U) },
		{ FNetworkVehicleInputs::StaticStruct, Z_Construct_UScriptStruct_FNetworkVehicleInputs_Statics::NewStructOps, TEXT("NetworkVehicleInputs"), &Z_Registration_Info_UScriptStruct_NetworkVehicleInputs, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNetworkVehicleInputs), 966453241U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosVehiclesPlugin_Source_ChaosVehicles_Public_ChaosVehicleManagerAsyncCallback_h_1700632766(TEXT("/Script/ChaosVehicles"),
		nullptr, 0,
