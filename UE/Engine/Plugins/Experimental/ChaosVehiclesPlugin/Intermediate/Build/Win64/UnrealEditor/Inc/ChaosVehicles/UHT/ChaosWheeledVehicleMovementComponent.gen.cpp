...
template<> CHAOSVEHICLES_API UScriptStruct* StaticStruct<FChaosWheelSetup>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosVehiclesPlugin_Source_ChaosVehicles_Public_ChaosWheeledVehicleMovementComponent_h_Statics::ScriptStructInfo[] = {
		...
		{ FVehicleEngineConfig::StaticStruct, Z_Construct_UScriptStruct_FVehicleEngineConfig_Statics::NewStructOps, TEXT("VehicleEngineConfig"), &Z_Registration_Info_UScriptStruct_VehicleEngineConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVehicleEngineConfig), 2075726657U) },
		{ FVehicleTransmissionConfig::StaticStruct, Z_Construct_UScriptStruct_FVehicleTransmissionConfig_Statics::NewStructOps, TEXT("VehicleTransmissionConfig"), &Z_Registration_Info_UScriptStruct_VehicleTransmissionConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVehicleTransmissionConfig), 3846729425U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosVehiclesPlugin_Source_ChaosVehicles_Public_ChaosWheeledVehicleMovementComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChaosWheeledVehicleMovementComponent, UChaosWheeledVehicleMovementComponent::StaticClass, TEXT("UChaosWheeledVehicleMovementComponent"), &Z_Registration_Info_UClass_UChaosWheeledVehicleMovementComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChaosWheeledVehicleMovementComponent), 1259479191U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosVehiclesPlugin_Source_ChaosVehicles_Public_ChaosWheeledVehicleMovementComponent_h_4058464350(TEXT("/Script/ChaosVehicles"),
