...
template<> SCREENREADER_API UScriptStruct* StaticStruct<FScreenReaderReply>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FScreenReaderReply_Statics::NewProp_bHandled = { "bHandled", nullptr, (EPropertyFlags)0x0040000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FScreenReaderReply), &Z_Construct_UScriptStruct_FScreenReaderReply_Statics::NewProp_bHandled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderReply_Statics::NewProp_bHandled_MetaData), Z_Construct_UScriptStruct_FScreenReaderReply_Statics::NewProp_bHandled_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FScreenReaderReply_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderReply_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FScreenReaderReply_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderReply_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScreenReader_Source_ScreenReader_Public_GenericPlatform_ScreenReaderReply_h_Statics::ScriptStructInfo[] = {
		{ FScreenReaderReply::StaticStruct, Z_Construct_UScriptStruct_FScreenReaderReply_Statics::NewStructOps, TEXT("ScreenReaderReply"), &Z_Registration_Info_UScriptStruct_ScreenReaderReply, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenReaderReply), 2140461740U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScreenReader_Source_ScreenReader_Public_GenericPlatform_ScreenReaderReply_h_934535975(TEXT("/Script/ScreenReader"),
		nullptr, 0,
