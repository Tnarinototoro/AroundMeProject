...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_ScreenReader_EScreenReaderAnnouncementPriority_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_ScreenReader_EScreenReaderAnnouncementPriority_Statics::Enum_MetaDataParams), Z_Construct_UEnum_ScreenReader_EScreenReaderAnnouncementPriority_Statics::Enum_MetaDataParams)
	};
...
template<> SCREENREADER_API UScriptStruct* StaticStruct<FScreenReaderAnnouncementInfo>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bShouldQueue = { "bShouldQueue", nullptr, (EPropertyFlags)0x0040000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FScreenReaderAnnouncementInfo), &Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bShouldQueue_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bShouldQueue_MetaData), Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bShouldQueue_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bInterruptable = { "bInterruptable", nullptr, (EPropertyFlags)0x0040000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FScreenReaderAnnouncementInfo), &Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bInterruptable_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bInterruptable_MetaData), Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_bInterruptable_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_Priority_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_Priority = { "Priority", nullptr, (EPropertyFlags)0x0040000000000004, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FScreenReaderAnnouncementInfo, Priority), Z_Construct_UEnum_ScreenReader_EScreenReaderAnnouncementPriority, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_Priority_MetaData), Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewProp_Priority_MetaData) }; // 3860054481
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::PropPointers) < 2048);
...
template<> SCREENREADER_API UScriptStruct* StaticStruct<FScreenReaderAnnouncement>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::NewProp_AnnouncementString = { "AnnouncementString", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FScreenReaderAnnouncement, AnnouncementString), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::NewProp_AnnouncementString_MetaData), Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::NewProp_AnnouncementString_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::NewProp_AnnouncementInfo = { "AnnouncementInfo", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FScreenReaderAnnouncement, AnnouncementInfo), Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::NewProp_AnnouncementInfo_MetaData), Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::NewProp_AnnouncementInfo_MetaData) }; // 1685854470
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::PropPointers) < 2048);
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScreenReader_Source_ScreenReader_Public_Announcement_ScreenReaderAnnouncement_h_Statics::EnumInfo[] = {
		{ EScreenReaderAnnouncementPriority_StaticEnum, TEXT("EScreenReaderAnnouncementPriority"), &Z_Registration_Info_UEnum_EScreenReaderAnnouncementPriority, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3860054481U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScreenReader_Source_ScreenReader_Public_Announcement_ScreenReaderAnnouncement_h_Statics::ScriptStructInfo[] = {
		{ FScreenReaderAnnouncementInfo::StaticStruct, Z_Construct_UScriptStruct_FScreenReaderAnnouncementInfo_Statics::NewStructOps, TEXT("ScreenReaderAnnouncementInfo"), &Z_Registration_Info_UScriptStruct_ScreenReaderAnnouncementInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenReaderAnnouncementInfo), 1685854470U) },
		{ FScreenReaderAnnouncement::StaticStruct, Z_Construct_UScriptStruct_FScreenReaderAnnouncement_Statics::NewStructOps, TEXT("ScreenReaderAnnouncement"), &Z_Registration_Info_UScriptStruct_ScreenReaderAnnouncement, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenReaderAnnouncement), 2965627740U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ScreenReader_Source_ScreenReader_Public_Announcement_ScreenReaderAnnouncement_h_1088828141(TEXT("/Script/ScreenReader"),
		nullptr, 0,
