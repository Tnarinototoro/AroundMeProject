...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamK2Node_SwitchConnectionSystemBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamK2Node_SwitchConnectionSystemBase_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamK2Node_SwitchConnectionSystemBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamK2Node_SwitchConnectionSystemBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamBlueprintNodes_Private_SwitchNode_VCamK2Node_SwitchConnectionSystemBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamK2Node_SwitchConnectionSystemBase, UVCamK2Node_SwitchConnectionSystemBase::StaticClass, TEXT("UVCamK2Node_SwitchConnectionSystemBase"), &Z_Registration_Info_UClass_UVCamK2Node_SwitchConnectionSystemBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamK2Node_SwitchConnectionSystemBase), 2678400933U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamBlueprintNodes_Private_SwitchNode_VCamK2Node_SwitchConnectionSystemBase_h_1222317085(TEXT("/Script/VCamBlueprintNodes"),
