...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UFocusFirstPlayerViewTargetPolicy_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UFocusFirstPlayerViewTargetPolicy_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFocusFirstPlayerViewTargetPolicy_Statics::Class_MetaDataParams), Z_Construct_UClass_UFocusFirstPlayerViewTargetPolicy_Statics::Class_MetaDataParams)
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_ViewTargetPolicy_FocusFirstPlayerViewTargetPolicy_h_111973439(TEXT("/Script/VCamCore"),
