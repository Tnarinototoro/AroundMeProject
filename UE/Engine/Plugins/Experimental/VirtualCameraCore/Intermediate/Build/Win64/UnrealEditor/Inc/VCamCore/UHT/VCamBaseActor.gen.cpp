...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamBaseActor_eventGetVCamComponent_Parms, ReturnValue), Z_Construct_UClass_UVCamComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::NewProp_ReturnValue_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AVCamBaseActor, nullptr, "GetVCamComponent", nullptr, nullptr, Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::VCamBaseActor_eventGetVCamComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent_Statics::VCamBaseActor_eventGetVCamComponent_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVCamBaseActor_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AVCamBaseActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVCamBaseActor_GetVCamComponent, "GetVCamComponent" }, // 3368773174
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVCamBaseActor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AVCamBaseActor_Statics::NewProp_VCamComponent = { "VCamComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AVCamBaseActor, VCamComponent), Z_Construct_UClass_UVCamComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVCamBaseActor_Statics::NewProp_VCamComponent_MetaData), Z_Construct_UClass_AVCamBaseActor_Statics::NewProp_VCamComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVCamBaseActor_Statics::ClassParams = {
		...
		0,
		0x009000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AVCamBaseActor_Statics::Class_MetaDataParams), Z_Construct_UClass_AVCamBaseActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AVCamBaseActor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_VCamBaseActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVCamBaseActor, AVCamBaseActor::StaticClass, TEXT("AVCamBaseActor"), &Z_Registration_Info_UClass_AVCamBaseActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVCamBaseActor), 787112179U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_VCamBaseActor_h_4079674979(TEXT("/Script/VCamCore"),
