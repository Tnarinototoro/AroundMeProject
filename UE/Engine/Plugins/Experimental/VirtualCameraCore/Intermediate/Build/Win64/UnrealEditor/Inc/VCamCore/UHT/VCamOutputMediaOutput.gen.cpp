...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputMediaOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_OutputConfig = { "OutputConfig", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputMediaOutput, OutputConfig), Z_Construct_UClass_UMediaOutput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_OutputConfig_MetaData), Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_OutputConfig_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_FromComposureOutputProviderIndex = { "FromComposureOutputProviderIndex", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputMediaOutput, FromComposureOutputProviderIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_FromComposureOutputProviderIndex_MetaData), Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_FromComposureOutputProviderIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_MediaCapture = { "MediaCapture", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputMediaOutput, MediaCapture), Z_Construct_UClass_UMediaCapture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_MediaCapture_MetaData), Z_Construct_UClass_UVCamOutputMediaOutput_Statics::NewProp_MediaCapture_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamOutputMediaOutput_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputMediaOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamOutputMediaOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputMediaOutput_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputMediaOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamOutputMediaOutput, UVCamOutputMediaOutput::StaticClass, TEXT("UVCamOutputMediaOutput"), &Z_Registration_Info_UClass_UVCamOutputMediaOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamOutputMediaOutput), 3857026390U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputMediaOutput_h_2020725838(TEXT("/Script/VCamCore"),
