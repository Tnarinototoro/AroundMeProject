...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingMediaOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPixelStreamingMediaOutput_Statics::ClassParams = {
		...
		0,
		0x000010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingMediaOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UPixelStreamingMediaOutput_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Private_PixelStreamingMediaOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPixelStreamingMediaOutput, UPixelStreamingMediaOutput::StaticClass, TEXT("UPixelStreamingMediaOutput"), &Z_Registration_Info_UClass_UPixelStreamingMediaOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPixelStreamingMediaOutput), 3684000853U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Private_PixelStreamingMediaOutput_h_554508625(TEXT("/Script/PixelStreamingVCam"),
