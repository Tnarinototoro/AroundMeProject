...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamPixelStreamingSubsystem_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamPixelStreamingSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamPixelStreamingSubsystem_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamPixelStreamingSubsystem_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Public_VCamPixelStreamingSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamPixelStreamingSubsystem, UVCamPixelStreamingSubsystem::StaticClass, TEXT("UVCamPixelStreamingSubsystem"), &Z_Registration_Info_UClass_UVCamPixelStreamingSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamPixelStreamingSubsystem), 3389715942U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Public_VCamPixelStreamingSubsystem_h_761083177(TEXT("/Script/PixelStreamingVCam"),
