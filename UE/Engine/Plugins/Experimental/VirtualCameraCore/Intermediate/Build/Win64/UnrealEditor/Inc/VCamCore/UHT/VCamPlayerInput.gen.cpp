...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamPlayerInput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVCamPlayerInput_Statics::NewProp_InputDeviceSettings = { "InputDeviceSettings", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamPlayerInput, InputDeviceSettings), Z_Construct_UScriptStruct_FVCamInputDeviceConfig, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamPlayerInput_Statics::NewProp_InputDeviceSettings_MetaData), Z_Construct_UClass_UVCamPlayerInput_Statics::NewProp_InputDeviceSettings_MetaData) }; // 1066245811
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamPlayerInput_Statics::ClassParams = {
		...
		0,
		0x009000ACu,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamPlayerInput_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamPlayerInput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamPlayerInput_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Input_VCamPlayerInput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamPlayerInput, UVCamPlayerInput::StaticClass, TEXT("UVCamPlayerInput"), &Z_Registration_Info_UClass_UVCamPlayerInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamPlayerInput), 1410541842U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Input_VCamPlayerInput_h_1513601998(TEXT("/Script/VCamCore"),
