...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorOnlyVCamModifier_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UEditorOnlyVCamModifier_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UEditorOnlyVCamModifier_Statics::Class_MetaDataParams), Z_Construct_UClass_UEditorOnlyVCamModifier_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Public_EditorOnlyVCamModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEditorOnlyVCamModifier, UEditorOnlyVCamModifier::StaticClass, TEXT("UEditorOnlyVCamModifier"), &Z_Registration_Info_UClass_UEditorOnlyVCamModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEditorOnlyVCamModifier), 716628336U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Public_EditorOnlyVCamModifier_h_1269837306(TEXT("/Script/VCamCoreEditor"),
