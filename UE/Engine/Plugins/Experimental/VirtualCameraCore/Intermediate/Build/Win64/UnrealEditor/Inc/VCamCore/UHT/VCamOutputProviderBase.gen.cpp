...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::NewProp_bNewIsActive = { "bNewIsActive", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VCamOutputProviderBase_eventActivationDelegate_Blueprint_Parms), &Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::NewProp_bNewIsActive_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "ActivationDelegate_Blueprint__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::VCamOutputProviderBase_eventActivationDelegate_Blueprint_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature_Statics::VCamOutputProviderBase_eventActivationDelegate_Blueprint_Parms) < MAX_uint16);
...
void UVCamOutputProviderBase::FActivationDelegate_Blueprint_DelegateWrapper(const FMulticastScriptDelegate& ActivationDelegate_Blueprint, bool bNewIsActive)
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamOutputProviderBase_eventGetTargetViewport_Parms, ReturnValue), Z_Construct_UEnum_VCamCore_EVCamTargetViewportID, METADATA_PARAMS(0, nullptr) }; // 2588909088
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "GetTargetViewport", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::VCamOutputProviderBase_eventGetTargetViewport_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport_Statics::VCamOutputProviderBase_eventGetTargetViewport_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0014000000000580, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamOutputProviderBase_eventGetUMGClass_Parms, ReturnValue), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "GetUMGClass", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::VCamOutputProviderBase_eventGetUMGClass_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass_Statics::VCamOutputProviderBase_eventGetUMGClass_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VCamOutputProviderBase_eventIsActive_Parms), &Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "IsActive", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::VCamOutputProviderBase_eventIsActive_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_IsActive_Statics::VCamOutputProviderBase_eventIsActive_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VCamOutputProviderBase_eventIsInitialized_Parms), &Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "IsInitialized", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::VCamOutputProviderBase_eventIsInitialized_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized_Statics::VCamOutputProviderBase_eventIsInitialized_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::NewProp_bInActive = { "bInActive", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VCamOutputProviderBase_eventSetActive_Parms), &Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::NewProp_bInActive_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::NewProp_bInActive_MetaData), Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::NewProp_bInActive_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "SetActive", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::VCamOutputProviderBase_eventSetActive_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetActive_Statics::VCamOutputProviderBase_eventSetActive_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::NewProp_InTargetCamera = { "InTargetCamera", nullptr, (EPropertyFlags)0x0010000000080082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamOutputProviderBase_eventSetTargetCamera_Parms, InTargetCamera), Z_Construct_UClass_UCineCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::NewProp_InTargetCamera_MetaData), Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::NewProp_InTargetCamera_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "SetTargetCamera", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::VCamOutputProviderBase_eventSetTargetCamera_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera_Statics::VCamOutputProviderBase_eventSetTargetCamera_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamOutputProviderBase_eventSetTargetViewport_Parms, Value), Z_Construct_UEnum_VCamCore_EVCamTargetViewportID, METADATA_PARAMS(0, nullptr) }; // 2588909088
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "SetTargetViewport", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::VCamOutputProviderBase_eventSetTargetViewport_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport_Statics::VCamOutputProviderBase_eventSetTargetViewport_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::NewProp_InUMGClass = { "InUMGClass", nullptr, (EPropertyFlags)0x0014000000000082, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamOutputProviderBase_eventSetUMGClass_Parms, InUMGClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::NewProp_InUMGClass_MetaData), Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::NewProp_InUMGClass_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamOutputProviderBase, nullptr, "SetUMGClass", nullptr, nullptr, Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::VCamOutputProviderBase_eventSetUMGClass_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass_Statics::VCamOutputProviderBase_eventSetUMGClass_Parms) < MAX_uint16);
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_PostProcessSettingsForWidget_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_PostProcessSettingsForWidget;
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVCamOutputProviderBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature, "ActivationDelegate_Blueprint__DelegateSignature" }, // 2452232107
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_GetTargetViewport, "GetTargetViewport" }, // 1179774522
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_GetUMGClass, "GetUMGClass" }, // 1234205315
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_IsActive, "IsActive" }, // 1201950221
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_IsInitialized, "IsInitialized" }, // 518697362
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_SetActive, "SetActive" }, // 1586185176
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetCamera, "SetTargetCamera" }, // 3514482508
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_SetTargetViewport, "SetTargetViewport" }, // 3944040412
		{ &Z_Construct_UFunction_UVCamOutputProviderBase_SetUMGClass, "SetUMGClass" }, // 1977296222
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_OnActivatedDelegate_Blueprint = { "OnActivatedDelegate_Blueprint", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, OnActivatedDelegate_Blueprint), Z_Construct_UDelegateFunction_UVCamOutputProviderBase_ActivationDelegate_Blueprint__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_OnActivatedDelegate_Blueprint_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_OnActivatedDelegate_Blueprint_MetaData) }; // 2452232107
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bUseOverrideResolution = { "bUseOverrideResolution", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UVCamOutputProviderBase), &Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bUseOverrideResolution_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bUseOverrideResolution_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bUseOverrideResolution_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_OverrideResolution = { "OverrideResolution", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, OverrideResolution), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_OverrideResolution_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_OverrideResolution_MetaData) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_DisplayType_MetaData[] = {
		{ "Comment", "/** Defines how the overlay widget should be added to the viewport. This should set as early as possible: in the constructor. */" },
		{ "ModuleRelativePath", "Public/Output/VCamOutputProviderBase.h" },
		{ "ToolTip", "Defines how the overlay widget should be added to the viewport. This should set as early as possible: in the constructor." },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_DisplayType = { "DisplayType", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, DisplayType), Z_Construct_UEnum_VPUtilities_EVPWidgetDisplayType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_DisplayType_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_DisplayType_MetaData) }; // 3767392094
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_GameplayViewTargetPolicy = { "GameplayViewTargetPolicy", nullptr, (EPropertyFlags)0x0026080000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, GameplayViewTargetPolicy), Z_Construct_UClass_UGameplayViewTargetPolicy_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_GameplayViewTargetPolicy_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_GameplayViewTargetPolicy_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bIsActive = { "bIsActive", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UVCamOutputProviderBase), &Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bIsActive_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bIsActive_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bIsActive_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_TargetViewport_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_TargetViewport = { "TargetViewport", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, TargetViewport), Z_Construct_UEnum_VCamCore_EVCamTargetViewportID, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_TargetViewport_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_TargetViewport_MetaData) }; // 2588909088
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_UMGClass = { "UMGClass", nullptr, (EPropertyFlags)0x0044000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, UMGClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_UMGClass_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_UMGClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_WidgetSnapshot = { "WidgetSnapshot", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, WidgetSnapshot), Z_Construct_UScriptStruct_FWidgetTreeSnapshot, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_WidgetSnapshot_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_WidgetSnapshot_MetaData) }; // 2439943295
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bInitialized = { "bInitialized", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UVCamOutputProviderBase), &Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bInitialized_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bInitialized_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bInitialized_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_UMGWidget = { "UMGWidget", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, UMGWidget), Z_Construct_UClass_UVPFullScreenUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_UMGWidget_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_UMGWidget_MetaData) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PostProcessSettingsForWidget_MetaData[] = {
		{ "Comment", "/** We call UVPFullScreenUserWidget::SetCustomPostProcessSettingsSource(this), which will cause these settings to be discovered. They are later passed down to FEditorViewportViewModifierDelegate. */" },
		{ "ModuleRelativePath", "Public/Output/VCamOutputProviderBase.h" },
		{ "ToolTip", "We call UVPFullScreenUserWidget::SetCustomPostProcessSettingsSource(this), which will cause these settings to be discovered. They are later passed down to FEditorViewportViewModifierDelegate." },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PostProcessSettingsForWidget = { "PostProcessSettingsForWidget", nullptr, (EPropertyFlags)0x0040000800002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, PostProcessSettingsForWidget), Z_Construct_UScriptStruct_FPostProcessSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PostProcessSettingsForWidget_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PostProcessSettingsForWidget_MetaData) }; // 2922880151
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_TargetCamera = { "TargetCamera", nullptr, (EPropertyFlags)0x0044000000082008, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, TargetCamera), Z_Construct_UClass_UCineCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_TargetCamera_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_TargetCamera_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bWasOutputSuspendedWhileActive = { "bWasOutputSuspendedWhileActive", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UVCamOutputProviderBase), &Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bWasOutputSuspendedWhileActive_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bWasOutputSuspendedWhileActive_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_bWasOutputSuspendedWhileActive_MetaData) };
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PlayersWhoseViewTargetsWereSet_ElementProp = { "PlayersWhoseViewTargetsWereSet", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PlayersWhoseViewTargetsWereSet = { "PlayersWhoseViewTargetsWereSet", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputProviderBase, PlayersWhoseViewTargetsWereSet), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PlayersWhoseViewTargetsWereSet_MetaData), Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PlayersWhoseViewTargetsWereSet_MetaData) };
...
#if WITH_EDITORONLY_DATA
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UVCamOutputProviderBase_Statics::NewProp_PostProcessSettingsForWidget,
#endif // WITH_EDITORONLY_DATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamOutputProviderBase_Statics::ClassParams = {
		...
		0,
		0x009010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamOutputProviderBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputProviderBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputProviderBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamOutputProviderBase, UVCamOutputProviderBase::StaticClass, TEXT("UVCamOutputProviderBase"), &Z_Registration_Info_UClass_UVCamOutputProviderBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamOutputProviderBase), 580962060U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputProviderBase_h_1453463058(TEXT("/Script/VCamCore"),
