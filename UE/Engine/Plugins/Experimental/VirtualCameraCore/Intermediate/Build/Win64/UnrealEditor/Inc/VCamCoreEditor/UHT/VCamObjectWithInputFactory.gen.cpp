...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_ParentClass = { "ParentClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamObjectWithInputFactory, ParentClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_ParentClass_MetaData), Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_ParentClass_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_InputMappingContext = { "InputMappingContext", nullptr, (EPropertyFlags)0x0014000000000004, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamObjectWithInputFactory, InputMappingContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_InputMappingContext_MetaData), Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_InputMappingContext_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_MappingPriority = { "MappingPriority", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamObjectWithInputFactory, MappingPriority), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_MappingPriority_MetaData), Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::NewProp_MappingPriority_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamObjectWithInputFactory_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Factories_VCamObjectWithInputFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamObjectWithInputFactory, UVCamObjectWithInputFactory::StaticClass, TEXT("UVCamObjectWithInputFactory"), &Z_Registration_Info_UClass_UVCamObjectWithInputFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamObjectWithInputFactory), 1922984088U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Factories_VCamObjectWithInputFactory_h_198508879(TEXT("/Script/VCamCoreEditor"),
