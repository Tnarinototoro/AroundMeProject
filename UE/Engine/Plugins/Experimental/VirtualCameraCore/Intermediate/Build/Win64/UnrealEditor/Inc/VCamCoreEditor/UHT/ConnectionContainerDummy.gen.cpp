...
template<> VCAMCOREEDITOR_API UScriptStruct* StaticStruct<FConnectionContainerDummy>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::NewProp_Connection = { "Connection", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FConnectionContainerDummy, Connection), Z_Construct_UScriptStruct_FVCamConnection, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::NewProp_Connection_MetaData), Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::NewProp_Connection_MetaData) }; // 1570968821
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Customizations_OutputProvider_ConnectionContainerDummy_h_Statics::ScriptStructInfo[] = {
		{ FConnectionContainerDummy::StaticStruct, Z_Construct_UScriptStruct_FConnectionContainerDummy_Statics::NewStructOps, TEXT("ConnectionContainerDummy"), &Z_Registration_Info_UScriptStruct_ConnectionContainerDummy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConnectionContainerDummy), 1625260417U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Customizations_OutputProvider_ConnectionContainerDummy_h_648532851(TEXT("/Script/VCamCoreEditor"),
		nullptr, 0,
