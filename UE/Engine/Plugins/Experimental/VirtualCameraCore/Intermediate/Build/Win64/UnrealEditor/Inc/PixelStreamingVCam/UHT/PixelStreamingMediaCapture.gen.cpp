...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingMediaCapture_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPixelStreamingMediaCapture_Statics::ClassParams = {
		...
		0,
		0x008010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingMediaCapture_Statics::Class_MetaDataParams), Z_Construct_UClass_UPixelStreamingMediaCapture_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Private_PixelStreamingMediaCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPixelStreamingMediaCapture, UPixelStreamingMediaCapture::StaticClass, TEXT("UPixelStreamingMediaCapture"), &Z_Registration_Info_UClass_UPixelStreamingMediaCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPixelStreamingMediaCapture), 2133708636U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Private_PixelStreamingMediaCapture_h_15497100(TEXT("/Script/PixelStreamingVCam"),
