...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASimpleVirtualCamera_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ASimpleVirtualCamera_Statics::NewProp_VCamComponent = { "VCamComponent", nullptr, (EPropertyFlags)0x0044000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASimpleVirtualCamera, VCamComponent), Z_Construct_UClass_UVCamComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASimpleVirtualCamera_Statics::NewProp_VCamComponent_MetaData), Z_Construct_UClass_ASimpleVirtualCamera_Statics::NewProp_VCamComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ASimpleVirtualCamera_Statics::ClassParams = {
		...
		0,
		0x008000A5u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASimpleVirtualCamera_Statics::Class_MetaDataParams), Z_Construct_UClass_ASimpleVirtualCamera_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASimpleVirtualCamera_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_SimpleVirtualCamera_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASimpleVirtualCamera, ASimpleVirtualCamera::StaticClass, TEXT("ASimpleVirtualCamera"), &Z_Registration_Info_UClass_ASimpleVirtualCamera, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASimpleVirtualCamera), 432820519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_SimpleVirtualCamera_h_1846570927(TEXT("/Script/VCamCore"),
