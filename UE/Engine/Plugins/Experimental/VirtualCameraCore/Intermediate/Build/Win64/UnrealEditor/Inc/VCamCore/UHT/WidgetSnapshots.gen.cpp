...
template<> VCAMCORE_API UScriptStruct* StaticStruct<FWidgetSnapshot>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewProp_WidgetClass = { "WidgetClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWidgetSnapshot, WidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewProp_WidgetClass_MetaData), Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewProp_WidgetClass_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewProp_SavedBinaryData_Inner = { "SavedBinaryData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewProp_SavedBinaryData = { "SavedBinaryData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWidgetSnapshot, SavedBinaryData), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewProp_SavedBinaryData_MetaData), Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewProp_SavedBinaryData_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::PropPointers) < 2048);
...
template<> VCAMCORE_API UScriptStruct* StaticStruct<FWidgetTreeSnapshot>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_RootWidget = { "RootWidget", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWidgetTreeSnapshot, RootWidget), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_RootWidget_MetaData), Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_RootWidget_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_WidgetSnapshots_ValueProp = { "WidgetSnapshots", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FWidgetSnapshot, METADATA_PARAMS(0, nullptr) }; // 4150322546
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_WidgetSnapshots_Key_KeyProp = { "WidgetSnapshots_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_WidgetSnapshots = { "WidgetSnapshots", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWidgetTreeSnapshot, WidgetSnapshots), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_WidgetSnapshots_MetaData), Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewProp_WidgetSnapshots_MetaData) }; // 4150322546
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_UI_WidgetSnapshots_h_Statics::ScriptStructInfo[] = {
		{ FWidgetSnapshot::StaticStruct, Z_Construct_UScriptStruct_FWidgetSnapshot_Statics::NewStructOps, TEXT("WidgetSnapshot"), &Z_Registration_Info_UScriptStruct_WidgetSnapshot, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetSnapshot), 4150322546U) },
		{ FWidgetTreeSnapshot::StaticStruct, Z_Construct_UScriptStruct_FWidgetTreeSnapshot_Statics::NewStructOps, TEXT("WidgetTreeSnapshot"), &Z_Registration_Info_UScriptStruct_WidgetTreeSnapshot, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetTreeSnapshot), 2439943295U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_UI_WidgetSnapshots_h_3005717019(TEXT("/Script/VCamCore"),
		nullptr, 0,
