...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::NewProp_TargetWidget = { "TargetWidget", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamK2Node_SwitchOnWidgetConnections, TargetWidget), Z_Construct_UScriptStruct_FVCamChildWidgetReference, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::NewProp_TargetWidget_MetaData), Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::NewProp_TargetWidget_MetaData) }; // 491024086
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamBlueprintNodes_Private_SwitchNode_VCamK2Node_SwitchOnWidgetConnections_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamK2Node_SwitchOnWidgetConnections, UVCamK2Node_SwitchOnWidgetConnections::StaticClass, TEXT("UVCamK2Node_SwitchOnWidgetConnections"), &Z_Registration_Info_UClass_UVCamK2Node_SwitchOnWidgetConnections, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamK2Node_SwitchOnWidgetConnections), 2951540763U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamBlueprintNodes_Private_SwitchNode_VCamK2Node_SwitchOnWidgetConnections_h_1127308130(TEXT("/Script/VCamBlueprintNodes"),
