...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifierContext_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamModifierContext_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifierContext_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamModifierContext_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_VCamModifierContext_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamModifierContext, UVCamModifierContext::StaticClass, TEXT("UVCamModifierContext"), &Z_Registration_Info_UClass_UVCamModifierContext, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamModifierContext), 2036524919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_VCamModifierContext_h_2308496281(TEXT("/Script/VCamCore"),
