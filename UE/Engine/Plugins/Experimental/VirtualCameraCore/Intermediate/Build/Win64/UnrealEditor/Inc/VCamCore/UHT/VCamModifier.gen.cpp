...
template<> VCAMCORE_API UScriptStruct* StaticStruct<FVCamModifierConnectionPoint>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::NewProp_AssociatedAction = { "AssociatedAction", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FVCamModifierConnectionPoint, AssociatedAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::NewProp_AssociatedAction_MetaData), Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::NewProp_AssociatedAction_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::PropPointers) < 2048);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::NewProp_LiveLinkData = { "LiveLinkData", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamModifier_eventGetCurrentLiveLinkDataFromOwningComponent_Parms, LiveLinkData), Z_Construct_UScriptStruct_FLiveLinkCameraBlueprintData, METADATA_PARAMS(0, nullptr) }; // 2745922981
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamModifier, nullptr, "GetCurrentLiveLinkDataFromOwningComponent", nullptr, nullptr, Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::VCamModifier_eventGetCurrentLiveLinkDataFromOwningComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent_Statics::VCamModifier_eventGetCurrentLiveLinkDataFromOwningComponent_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamModifier_eventGetOwningVCamComponent_Parms, ReturnValue), Z_Construct_UClass_UVCamComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::NewProp_ReturnValue_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamModifier, nullptr, "GetOwningVCamComponent", nullptr, nullptr, Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::VCamModifier_eventGetOwningVCamComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent_Statics::VCamModifier_eventGetOwningVCamComponent_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamModifier_eventGetStackEntryName_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamModifier, nullptr, "GetStackEntryName", nullptr, nullptr, Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::VCamModifier_eventGetStackEntryName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamModifier_GetStackEntryName_Statics::VCamModifier_eventGetStackEntryName_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VCamModifier_eventIsEnabled_Parms), &Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamModifier, nullptr, "IsEnabled", nullptr, nullptr, Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::VCamModifier_eventIsEnabled_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamModifier_IsEnabled_Statics::VCamModifier_eventIsEnabled_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::NewProp_bNewEnabled = { "bNewEnabled", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VCamModifier_eventSetEnabled_Parms), &Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::NewProp_bNewEnabled_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamModifier, nullptr, "SetEnabled", nullptr, nullptr, Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::VCamModifier_eventSetEnabled_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamModifier_SetEnabled_Statics::VCamModifier_eventSetEnabled_Parms) < MAX_uint16);
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::NewProp_NewName = { "NewName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamModifier_eventSetStackEntryName_Parms, NewName), METADATA_PARAMS(0, nullptr) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(VCamModifier_eventSetStackEntryName_Parms), &Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamModifier, nullptr, "SetStackEntryName", nullptr, nullptr, Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::VCamModifier_eventSetStackEntryName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UVCamModifier_SetStackEntryName_Statics::VCamModifier_eventSetStackEntryName_Parms) < MAX_uint16);
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bNeedsInitialization_MetaData[];
#endif
		static void NewProp_bNeedsInitialization_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bNeedsInitialization;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVCamModifier_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVCamModifier_GetCurrentLiveLinkDataFromOwningComponent, "GetCurrentLiveLinkDataFromOwningComponent" }, // 3020719016
		{ &Z_Construct_UFunction_UVCamModifier_GetOwningVCamComponent, "GetOwningVCamComponent" }, // 2687388560
		{ &Z_Construct_UFunction_UVCamModifier_GetStackEntryName, "GetStackEntryName" }, // 2831051585
		{ &Z_Construct_UFunction_UVCamModifier_IsEnabled, "IsEnabled" }, // 734240239
		{ &Z_Construct_UFunction_UVCamModifier_SetEnabled, "SetEnabled" }, // 949550402
		{ &Z_Construct_UFunction_UVCamModifier_SetStackEntryName, "SetStackEntryName" }, // 2182754860
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamModifier_Statics::NewProp_InputMappingContext = { "InputMappingContext", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamModifier, InputMappingContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::NewProp_InputMappingContext_MetaData), Z_Construct_UClass_UVCamModifier_Statics::NewProp_InputMappingContext_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVCamModifier_Statics::NewProp_InputContextPriority = { "InputContextPriority", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamModifier, InputContextPriority), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::NewProp_InputContextPriority_MetaData), Z_Construct_UClass_UVCamModifier_Statics::NewProp_InputContextPriority_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVCamModifier_Statics::NewProp_ConnectionPoints_ValueProp = { "ConnectionPoints", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FVCamModifierConnectionPoint, METADATA_PARAMS(0, nullptr) }; // 3189080263
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UVCamModifier_Statics::NewProp_ConnectionPoints = { "ConnectionPoints", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamModifier, ConnectionPoints), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::NewProp_ConnectionPoints_MetaData), Z_Construct_UClass_UVCamModifier_Statics::NewProp_ConnectionPoints_MetaData) }; // 3189080263
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVCamModifier_Statics::NewProp_bNeedsInitialization_MetaData[] = {
		{ "ModuleRelativePath", "Public/Modifier/VCamModifier.h" },
	};
#endif
	void Z_Construct_UClass_UVCamModifier_Statics::NewProp_bNeedsInitialization_SetBit(void* Obj)
	{
		((UVCamModifier*)Obj)->bNeedsInitialization = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVCamModifier_Statics::NewProp_bNeedsInitialization = { "bNeedsInitialization", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UVCamModifier), &Z_Construct_UClass_UVCamModifier_Statics::NewProp_bNeedsInitialization_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::NewProp_bNeedsInitialization_MetaData), Z_Construct_UClass_UVCamModifier_Statics::NewProp_bNeedsInitialization_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UVCamModifier_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UVCamModifier_Statics::NewProp_bNeedsInitialization,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamModifier_Statics::ClassParams = {
		...
		0,
		0x001010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamModifier_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifier_Statics::PropPointers) < 2048);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamBlueprintModifier_GetInputMappingContextAndPriority_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamBlueprintModifier, nullptr, "GetInputMappingContextAndPriority", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x48020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_GetInputMappingContextAndPriority_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamBlueprintModifier_GetInputMappingContextAndPriority_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamBlueprintModifier_eventOnApply_Parms, Context), Z_Construct_UClass_UVCamModifierContext_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::NewProp_CameraComponent = { "CameraComponent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamBlueprintModifier_eventOnApply_Parms, CameraComponent), Z_Construct_UClass_UCineCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::NewProp_CameraComponent_MetaData), Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::NewProp_CameraComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::NewProp_DeltaTime = { "DeltaTime", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamBlueprintModifier_eventOnApply_Parms, DeltaTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::NewProp_DeltaTime_MetaData), Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::NewProp_DeltaTime_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamBlueprintModifier, nullptr, "OnApply", nullptr, nullptr, Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::PropPointers), sizeof(VCamBlueprintModifier_eventOnApply_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnApply_Statics::PropPointers) < 2048);
	static_assert(sizeof(VCamBlueprintModifier_eventOnApply_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamBlueprintModifier_OnDeinitialize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamBlueprintModifier, nullptr, "OnDeinitialize", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnDeinitialize_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamBlueprintModifier_OnDeinitialize_Statics::Function_MetaDataParams) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamBlueprintModifier_eventOnInitialize_Parms, Context), Z_Construct_UClass_UVCamModifierContext_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamBlueprintModifier, nullptr, "OnInitialize", nullptr, nullptr, Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize_Statics::PropPointers), sizeof(VCamBlueprintModifier_eventOnInitialize_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize_Statics::PropPointers) < 2048);
	static_assert(sizeof(VCamBlueprintModifier_eventOnInitialize_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamBlueprintModifier_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVCamBlueprintModifier_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVCamBlueprintModifier_GetInputMappingContextAndPriority, "GetInputMappingContextAndPriority" }, // 3485713897
		{ &Z_Construct_UFunction_UVCamBlueprintModifier_OnApply, "OnApply" }, // 875201486
		{ &Z_Construct_UFunction_UVCamBlueprintModifier_OnDeinitialize, "OnDeinitialize" }, // 4221653185
		{ &Z_Construct_UFunction_UVCamBlueprintModifier_OnInitialize, "OnInitialize" }, // 2733506709
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamBlueprintModifier_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamBlueprintModifier_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamBlueprintModifier_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamBlueprintModifier_Statics::Class_MetaDataParams)
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_VCamModifier_h_Statics::ScriptStructInfo[] = {
		{ FVCamModifierConnectionPoint::StaticStruct, Z_Construct_UScriptStruct_FVCamModifierConnectionPoint_Statics::NewStructOps, TEXT("VCamModifierConnectionPoint"), &Z_Registration_Info_UScriptStruct_VCamModifierConnectionPoint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVCamModifierConnectionPoint), 3189080263U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_VCamModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamModifier, UVCamModifier::StaticClass, TEXT("UVCamModifier"), &Z_Registration_Info_UClass_UVCamModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamModifier), 3319035331U) },
		{ Z_Construct_UClass_UVCamBlueprintModifier, UVCamBlueprintModifier::StaticClass, TEXT("UVCamBlueprintModifier"), &Z_Registration_Info_UClass_UVCamBlueprintModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamBlueprintModifier), 467849529U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_VCamModifier_h_1863469330(TEXT("/Script/VCamCore"),
