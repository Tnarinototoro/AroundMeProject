...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputViewport_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamOutputViewport_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputViewport_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamOutputViewport_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputViewport_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamOutputViewport, UVCamOutputViewport::StaticClass, TEXT("UVCamOutputViewport"), &Z_Registration_Info_UClass_UVCamOutputViewport, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamOutputViewport), 1743066391U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputViewport_h_1689436718(TEXT("/Script/VCamCore"),
