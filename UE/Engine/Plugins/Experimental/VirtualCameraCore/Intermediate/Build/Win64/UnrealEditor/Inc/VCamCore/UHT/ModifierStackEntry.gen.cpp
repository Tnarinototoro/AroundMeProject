...
template<> VCAMCORE_API UScriptStruct* StaticStruct<FModifierStackEntry>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FModifierStackEntry, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FModifierStackEntry), &Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_bEnabled_MetaData), Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_bEnabled_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_GeneratedModifier = { "GeneratedModifier", nullptr, (EPropertyFlags)0x0016000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FModifierStackEntry, GeneratedModifier), Z_Construct_UClass_UVCamModifier_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_GeneratedModifier_MetaData), Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewProp_GeneratedModifier_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FModifierStackEntry_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FModifierStackEntry_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FModifierStackEntry_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FModifierStackEntry_Statics::PropPointers) < 2048);
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_ModifierStackEntry_h_Statics::ScriptStructInfo[] = {
		{ FModifierStackEntry::StaticStruct, Z_Construct_UScriptStruct_FModifierStackEntry_Statics::NewStructOps, TEXT("ModifierStackEntry"), &Z_Registration_Info_UScriptStruct_ModifierStackEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FModifierStackEntry), 3976440537U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_ModifierStackEntry_h_2838633997(TEXT("/Script/VCamCore"),
		nullptr, 0,
