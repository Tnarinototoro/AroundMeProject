...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamStateSwitcherWidgetFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamStateSwitcherWidgetFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamStateSwitcherWidgetFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamStateSwitcherWidgetFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Factories_VCamStateSwitcherWidgetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamStateSwitcherWidgetFactory, UVCamStateSwitcherWidgetFactory::StaticClass, TEXT("UVCamStateSwitcherWidgetFactory"), &Z_Registration_Info_UClass_UVCamStateSwitcherWidgetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamStateSwitcherWidgetFactory), 3697595071U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Factories_VCamStateSwitcherWidgetFactory_h_762077984(TEXT("/Script/VCamCoreEditor"),
