...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingLiveLinkSourceSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPixelStreamingLiveLinkSourceSettings_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UPixelStreamingLiveLinkSourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UPixelStreamingLiveLinkSourceSettings_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Private_VCamPixelStreamingLiveLink_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPixelStreamingLiveLinkSourceSettings, UPixelStreamingLiveLinkSourceSettings::StaticClass, TEXT("UPixelStreamingLiveLinkSourceSettings"), &Z_Registration_Info_UClass_UPixelStreamingLiveLinkSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPixelStreamingLiveLinkSourceSettings), 3062657453U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_PixelStreamingVCam_Private_VCamPixelStreamingLiveLink_h_2921954887(TEXT("/Script/PixelStreamingVCam"),
