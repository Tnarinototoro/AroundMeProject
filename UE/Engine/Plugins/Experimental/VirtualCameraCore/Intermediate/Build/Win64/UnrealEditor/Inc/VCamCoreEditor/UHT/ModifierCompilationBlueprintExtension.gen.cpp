...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UModifierCompilationBlueprintExtension_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UModifierCompilationBlueprintExtension_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UModifierCompilationBlueprintExtension_Statics::Class_MetaDataParams), Z_Construct_UClass_UModifierCompilationBlueprintExtension_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Compilation_ModifierCompilationBlueprintExtension_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UModifierCompilationBlueprintExtension, UModifierCompilationBlueprintExtension::StaticClass, TEXT("UModifierCompilationBlueprintExtension"), &Z_Registration_Info_UClass_UModifierCompilationBlueprintExtension, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UModifierCompilationBlueprintExtension), 3035051409U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCoreEditor_Private_Compilation_ModifierCompilationBlueprintExtension_h_2224813795(TEXT("/Script/VCamCoreEditor"),
