...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputComposure_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UVCamOutputComposure_Statics::NewProp_LayerTargets = { "LayerTargets", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputComposure, LayerTargets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputComposure_Statics::NewProp_LayerTargets_MetaData), Z_Construct_UClass_UVCamOutputComposure_Statics::NewProp_LayerTargets_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamOutputComposure_Statics::NewProp_FinalOutputRenderTarget = { "FinalOutputRenderTarget", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputComposure, FinalOutputRenderTarget), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputComposure_Statics::NewProp_FinalOutputRenderTarget_MetaData), Z_Construct_UClass_UVCamOutputComposure_Statics::NewProp_FinalOutputRenderTarget_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamOutputComposure_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputComposure_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamOutputComposure_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputComposure_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputComposure_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamOutputComposure, UVCamOutputComposure::StaticClass, TEXT("UVCamOutputComposure"), &Z_Registration_Info_UClass_UVCamOutputComposure, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamOutputComposure), 165725709U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputComposure_h_3193630483(TEXT("/Script/VCamCore"),
