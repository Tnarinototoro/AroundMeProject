...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::NewProp_VCam = { "VCam", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(VCamModifierInterface_eventOnVCamComponentChanged_Parms, VCam), Z_Construct_UClass_UVCamComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::NewProp_VCam_MetaData), Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::NewProp_VCam_MetaData) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVCamModifierInterface, nullptr, "OnVCamComponentChanged", nullptr, nullptr, Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::PropPointers), sizeof(VCamModifierInterface_eventOnVCamComponentChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged_Statics::PropPointers) < 2048);
	static_assert(sizeof(VCamModifierInterface_eventOnVCamComponentChanged_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifierInterface_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UVCamModifierInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVCamModifierInterface_OnVCamComponentChanged, "OnVCamComponentChanged" }, // 2862528812
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifierInterface_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamModifierInterface_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamModifierInterface_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamModifierInterface_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_VCamModifierInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamModifierInterface, UVCamModifierInterface::StaticClass, TEXT("UVCamModifierInterface"), &Z_Registration_Info_UClass_UVCamModifierInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamModifierInterface), 4124818528U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Modifier_VCamModifierInterface_h_951197654(TEXT("/Script/VCamCore"),
