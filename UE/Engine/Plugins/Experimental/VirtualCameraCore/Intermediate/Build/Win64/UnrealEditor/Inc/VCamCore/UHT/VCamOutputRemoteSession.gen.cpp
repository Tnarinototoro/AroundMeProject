...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputRemoteSession_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_PortNumber = { "PortNumber", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputRemoteSession, PortNumber), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_PortNumber_MetaData), Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_PortNumber_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_FromComposureOutputProviderIndex = { "FromComposureOutputProviderIndex", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputRemoteSession, FromComposureOutputProviderIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_FromComposureOutputProviderIndex_MetaData), Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_FromComposureOutputProviderIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_MediaOutput = { "MediaOutput", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputRemoteSession, MediaOutput), Z_Construct_UClass_URemoteSessionMediaOutput_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_MediaOutput_MetaData), Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_MediaOutput_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_MediaCapture = { "MediaCapture", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UVCamOutputRemoteSession, MediaCapture), Z_Construct_UClass_URemoteSessionMediaCapture_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_MediaCapture_MetaData), Z_Construct_UClass_UVCamOutputRemoteSession_Statics::NewProp_MediaCapture_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UVCamOutputRemoteSession_Statics::ClassParams = {
		...
		0,
		0x009010A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputRemoteSession_Statics::Class_MetaDataParams), Z_Construct_UClass_UVCamOutputRemoteSession_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVCamOutputRemoteSession_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputRemoteSession_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVCamOutputRemoteSession, UVCamOutputRemoteSession::StaticClass, TEXT("UVCamOutputRemoteSession"), &Z_Registration_Info_UClass_UVCamOutputRemoteSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVCamOutputRemoteSession), 1005603619U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_VirtualCameraCore_Source_VCamCore_Public_Output_VCamOutputRemoteSession_h_3619494092(TEXT("/Script/VCamCore"),
