...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDefaultAssetEditorGizmoFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDefaultAssetEditorGizmoFactory_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDefaultAssetEditorGizmoFactory_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UAssetEditorGizmoFactory_NoRegister, (int32)VTABLE_OFFSET(UDefaultAssetEditorGizmoFactory, IAssetEditorGizmoFactory), false },  // 4094589608
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UDefaultAssetEditorGizmoFactory_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDefaultAssetEditorGizmoFactory_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDefaultAssetEditorGizmoFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_UDefaultAssetEditorGizmoFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GizmoEdMode_Source_GizmoEdMode_Public_DefaultAssetEditorGizmoFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDefaultAssetEditorGizmoFactory, UDefaultAssetEditorGizmoFactory::StaticClass, TEXT("UDefaultAssetEditorGizmoFactory"), &Z_Registration_Info_UClass_UDefaultAssetEditorGizmoFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDefaultAssetEditorGizmoFactory), 4073601229U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GizmoEdMode_Source_GizmoEdMode_Public_DefaultAssetEditorGizmoFactory_h_4022744044(TEXT("/Script/GizmoEdMode"),
