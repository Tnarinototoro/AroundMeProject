...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USpotLightGizmoFactory_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USpotLightGizmoFactory_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_USpotLightGizmoFactory_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UAssetEditorGizmoFactory_NoRegister, (int32)VTABLE_OFFSET(USpotLightGizmoFactory, IAssetEditorGizmoFactory), false },  // 4094589608
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USpotLightGizmoFactory_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USpotLightGizmoFactory_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USpotLightGizmoFactory_Statics::Class_MetaDataParams), Z_Construct_UClass_USpotLightGizmoFactory_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GizmoEdMode_Source_LightGizmos_Public_SpotLightGizmoFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USpotLightGizmoFactory, USpotLightGizmoFactory::StaticClass, TEXT("USpotLightGizmoFactory"), &Z_Registration_Info_UClass_USpotLightGizmoFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USpotLightGizmoFactory), 1514795985U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GizmoEdMode_Source_LightGizmos_Public_SpotLightGizmoFactory_h_118459176(TEXT("/Script/LightGizmos"),
