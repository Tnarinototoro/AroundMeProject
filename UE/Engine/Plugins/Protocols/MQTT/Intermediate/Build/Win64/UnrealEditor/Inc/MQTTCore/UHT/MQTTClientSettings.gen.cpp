...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMQTTClientSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMQTTClientSettings_Statics::NewProp_DefaultURL = { "DefaultURL", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMQTTClientSettings, DefaultURL), Z_Construct_UScriptStruct_FMQTTURL, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMQTTClientSettings_Statics::NewProp_DefaultURL_MetaData), Z_Construct_UClass_UMQTTClientSettings_Statics::NewProp_DefaultURL_MetaData) }; // 3062554898
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UMQTTClientSettings_Statics::NewProp_PublishRate = { "PublishRate", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMQTTClientSettings, PublishRate), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMQTTClientSettings_Statics::NewProp_PublishRate_MetaData), Z_Construct_UClass_UMQTTClientSettings_Statics::NewProp_PublishRate_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMQTTClientSettings_Statics::ClassParams = {
		...
		0,
		0x001000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMQTTClientSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMQTTClientSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMQTTClientSettings_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Protocols_MQTT_Source_MQTTCore_Public_MQTTClientSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMQTTClientSettings, UMQTTClientSettings::StaticClass, TEXT("UMQTTClientSettings"), &Z_Registration_Info_UClass_UMQTTClientSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMQTTClientSettings), 3036704646U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Protocols_MQTT_Source_MQTTCore_Public_MQTTClientSettings_h_3310474295(TEXT("/Script/MQTTCore"),
