...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MQTTCore_EMQTTScheme_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MQTTCore_EMQTTScheme_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MQTTCore_EMQTTScheme_Statics::Enum_MetaDataParams)
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_MQTTCore_EMQTTQualityOfService_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_MQTTCore_EMQTTQualityOfService_Statics::Enum_MetaDataParams), Z_Construct_UEnum_MQTTCore_EMQTTQualityOfService_Statics::Enum_MetaDataParams)
	};
...
template<> MQTTCORE_API UScriptStruct* StaticStruct<FMQTTURL>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Host = { "Host", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMQTTURL, Host), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Host_MetaData), Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Host_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Port = { "Port", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMQTTURL, Port), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Port_MetaData), Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Port_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Username = { "Username", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMQTTURL, Username), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Username_MetaData), Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Username_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Password = { "Password", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMQTTURL, Password), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Password_MetaData), Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Password_MetaData) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Scheme_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Scheme = { "Scheme", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMQTTURL, Scheme), Z_Construct_UEnum_MQTTCore_EMQTTScheme, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Scheme_MetaData), Z_Construct_UScriptStruct_FMQTTURL_Statics::NewProp_Scheme_MetaData) }; // 1186046389
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMQTTURL_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTURL_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMQTTURL_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTURL_Statics::PropPointers) < 2048);
...
template<> MQTTCORE_API UScriptStruct* StaticStruct<FMQTTTopic>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMQTTTopic_Statics::NewProp_Path = { "Path", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMQTTTopic, Path), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTTopic_Statics::NewProp_Path_MetaData), Z_Construct_UScriptStruct_FMQTTTopic_Statics::NewProp_Path_MetaData) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMQTTTopic_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTTopic_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMQTTTopic_Statics::Struct_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTTopic_Statics::PropPointers) < 2048);
...
template<> MQTTCORE_API UScriptStruct* StaticStruct<FMQTTTopicFilter>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMQTTTopicFilter_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTTopicFilter_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMQTTTopicFilter_Statics::Struct_MetaDataParams)
	};
...
template<> MQTTCORE_API UScriptStruct* StaticStruct<FMQTTTopicTemplate>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMQTTTopicTemplate_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMQTTTopicTemplate_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FMQTTTopicTemplate_Statics::Struct_MetaDataParams)
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Protocols_MQTT_Source_MQTTCore_Public_MQTTShared_h_Statics::EnumInfo[] = {
		{ EMQTTScheme_StaticEnum, TEXT("EMQTTScheme"), &Z_Registration_Info_UEnum_EMQTTScheme, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1186046389U) },
		{ EMQTTQualityOfService_StaticEnum, TEXT("EMQTTQualityOfService"), &Z_Registration_Info_UEnum_EMQTTQualityOfService, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4028701908U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Protocols_MQTT_Source_MQTTCore_Public_MQTTShared_h_Statics::ScriptStructInfo[] = {
		{ FMQTTURL::StaticStruct, Z_Construct_UScriptStruct_FMQTTURL_Statics::NewStructOps, TEXT("MQTTURL"), &Z_Registration_Info_UScriptStruct_MQTTURL, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMQTTURL), 3062554898U) },
		{ FMQTTTopic::StaticStruct, Z_Construct_UScriptStruct_FMQTTTopic_Statics::NewStructOps, TEXT("MQTTTopic"), &Z_Registration_Info_UScriptStruct_MQTTTopic, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMQTTTopic), 2016850203U) },
		{ FMQTTTopicFilter::StaticStruct, Z_Construct_UScriptStruct_FMQTTTopicFilter_Statics::NewStructOps, TEXT("MQTTTopicFilter"), &Z_Registration_Info_UScriptStruct_MQTTTopicFilter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMQTTTopicFilter), 81677040U) },
		{ FMQTTTopicTemplate::StaticStruct, Z_Construct_UScriptStruct_FMQTTTopicTemplate_Statics::NewStructOps, TEXT("MQTTTopicTemplate"), &Z_Registration_Info_UScriptStruct_MQTTTopicTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMQTTTopicTemplate), 3521928515U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Protocols_MQTT_Source_MQTTCore_Public_MQTTShared_h_3795015084(TEXT("/Script/MQTTCore"),
		nullptr, 0,
