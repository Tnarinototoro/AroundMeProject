...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_QueuePreset = { "QueuePreset", nullptr, (EPropertyFlags)0x0024080000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMoviePipelineFunctionalTestBase, QueuePreset), Z_Construct_UClass_UMoviePipelineQueue_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_QueuePreset_MetaData), Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_QueuePreset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_ActiveMoviePipeline = { "ActiveMoviePipeline", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMoviePipelineFunctionalTestBase, ActiveMoviePipeline), Z_Construct_UClass_UMoviePipeline_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_ActiveMoviePipeline_MetaData), Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_ActiveMoviePipeline_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_ActiveQueue = { "ActiveQueue", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMoviePipelineFunctionalTestBase, ActiveQueue), Z_Construct_UClass_UMoviePipelineQueue_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_ActiveQueue_MetaData), Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::NewProp_ActiveQueue_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::Class_MetaDataParams), Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AMoviePipelineFunctionalTestBase_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineEditor_Private_MoviePipelineFunctionalTestBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMoviePipelineFunctionalTestBase, AMoviePipelineFunctionalTestBase::StaticClass, TEXT("AMoviePipelineFunctionalTestBase"), &Z_Registration_Info_UClass_AMoviePipelineFunctionalTestBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMoviePipelineFunctionalTestBase), 4132517446U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineEditor_Private_MoviePipelineFunctionalTestBase_h_531865789(TEXT("/Script/MovieRenderPipelineEditor"),
