...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted_Statics::NewProp_ForPipeline = { "ForPipeline", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MoviePipelineBurnInWidget_eventOnOutputFrameStarted_Parms, ForPipeline), Z_Construct_UClass_UMoviePipeline_NoRegister, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMoviePipelineBurnInWidget, nullptr, "OnOutputFrameStarted", nullptr, nullptr, Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted_Statics::PropPointers), sizeof(MoviePipelineBurnInWidget_eventOnOutputFrameStarted_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted_Statics::PropPointers) < 2048);
	static_assert(sizeof(MoviePipelineBurnInWidget_eventOnOutputFrameStarted_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineBurnInWidget_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UMoviePipelineBurnInWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMoviePipelineBurnInWidget_OnOutputFrameStarted, "OnOutputFrameStarted" }, // 750976480
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineBurnInWidget_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineBurnInWidget_Statics::ClassParams = {
		...
		0,
		0x00B010A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineBurnInWidget_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineBurnInWidget_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineSettings_Public_MoviePipelineBurnInWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineBurnInWidget, UMoviePipelineBurnInWidget::StaticClass, TEXT("UMoviePipelineBurnInWidget"), &Z_Registration_Info_UClass_UMoviePipelineBurnInWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineBurnInWidget), 27241726U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineSettings_Public_MoviePipelineBurnInWidget_h_365770584(TEXT("/Script/MovieRenderPipelineSettings"),
