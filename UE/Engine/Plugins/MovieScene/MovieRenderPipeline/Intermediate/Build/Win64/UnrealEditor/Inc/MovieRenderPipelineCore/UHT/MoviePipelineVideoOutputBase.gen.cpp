...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineVideoOutputBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineVideoOutputBase_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineVideoOutputBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineVideoOutputBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineVideoOutputBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineVideoOutputBase, UMoviePipelineVideoOutputBase::StaticClass, TEXT("UMoviePipelineVideoOutputBase"), &Z_Registration_Info_UClass_UMoviePipelineVideoOutputBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineVideoOutputBase), 4135741077U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineVideoOutputBase_h_1380877611(TEXT("/Script/MovieRenderPipelineCore"),
