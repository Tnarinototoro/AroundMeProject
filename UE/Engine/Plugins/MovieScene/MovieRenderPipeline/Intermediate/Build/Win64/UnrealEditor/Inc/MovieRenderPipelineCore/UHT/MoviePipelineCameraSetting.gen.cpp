...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_ShutterTiming_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_ShutterTiming = { "ShutterTiming", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineCameraSetting, ShutterTiming), Z_Construct_UEnum_MovieRenderPipelineCore_EMoviePipelineShutterTiming, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_ShutterTiming_MetaData), Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_ShutterTiming_MetaData) }; // 1394886146
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_OverscanPercentage = { "OverscanPercentage", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineCameraSetting, OverscanPercentage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_OverscanPercentage_MetaData), Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_OverscanPercentage_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_bRenderAllCameras = { "bRenderAllCameras", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMoviePipelineCameraSetting), &Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_bRenderAllCameras_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_bRenderAllCameras_MetaData), Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::NewProp_bRenderAllCameras_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineCameraSetting_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineCameraSetting_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineCameraSetting, UMoviePipelineCameraSetting::StaticClass, TEXT("UMoviePipelineCameraSetting"), &Z_Registration_Info_UClass_UMoviePipelineCameraSetting, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineCameraSetting), 3759459310U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineCameraSetting_h_2473779924(TEXT("/Script/MovieRenderPipelineCore"),
