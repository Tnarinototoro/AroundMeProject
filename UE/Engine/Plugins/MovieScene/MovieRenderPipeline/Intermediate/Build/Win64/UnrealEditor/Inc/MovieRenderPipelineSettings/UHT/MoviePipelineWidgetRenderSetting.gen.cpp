...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::NewProp_bCompositeOntoFinalImage = { "bCompositeOntoFinalImage", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMoviePipelineWidgetRenderer), &Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::NewProp_bCompositeOntoFinalImage_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::NewProp_bCompositeOntoFinalImage_MetaData), Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::NewProp_bCompositeOntoFinalImage_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::NewProp_RenderTarget = { "RenderTarget", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineWidgetRenderer, RenderTarget), Z_Construct_UClass_UTextureRenderTarget2D_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::NewProp_RenderTarget_MetaData), Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::NewProp_RenderTarget_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWidgetRenderer_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineSettings_Public_MoviePipelineWidgetRenderSetting_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineWidgetRenderer, UMoviePipelineWidgetRenderer::StaticClass, TEXT("UMoviePipelineWidgetRenderer"), &Z_Registration_Info_UClass_UMoviePipelineWidgetRenderer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineWidgetRenderer), 2399670823U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineSettings_Public_MoviePipelineWidgetRenderSetting_h_575813750(TEXT("/Script/MovieRenderPipelineSettings"),
