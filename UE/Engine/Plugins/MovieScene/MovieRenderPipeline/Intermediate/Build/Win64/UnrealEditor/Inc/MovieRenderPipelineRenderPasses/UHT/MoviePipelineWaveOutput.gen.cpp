...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::NewProp_FileNameFormatOverride = { "FileNameFormatOverride", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineWaveOutput, FileNameFormatOverride), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::NewProp_FileNameFormatOverride_MetaData), Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::NewProp_FileNameFormatOverride_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineWaveOutput_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineRenderPasses_Public_MoviePipelineWaveOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineWaveOutput, UMoviePipelineWaveOutput::StaticClass, TEXT("UMoviePipelineWaveOutput"), &Z_Registration_Info_UClass_UMoviePipelineWaveOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineWaveOutput), 2884719513U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineRenderPasses_Public_MoviePipelineWaveOutput_h_608598174(TEXT("/Script/MovieRenderPipelineRenderPasses"),
