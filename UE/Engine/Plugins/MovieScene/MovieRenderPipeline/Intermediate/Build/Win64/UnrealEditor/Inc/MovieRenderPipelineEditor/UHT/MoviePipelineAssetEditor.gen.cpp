...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::NewProp_ObjectToEdit = { "ObjectToEdit", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineAssetEditor, ObjectToEdit), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::NewProp_ObjectToEdit_MetaData), Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::NewProp_ObjectToEdit_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineAssetEditor_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineEditor_Private_MoviePipelineAssetEditor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineAssetEditor, UMoviePipelineAssetEditor::StaticClass, TEXT("UMoviePipelineAssetEditor"), &Z_Registration_Info_UClass_UMoviePipelineAssetEditor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineAssetEditor), 1204076960U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineEditor_Private_MoviePipelineAssetEditor_h_3062396902(TEXT("/Script/MovieRenderPipelineEditor"),
