...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineColorSetting_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMoviePipelineColorSetting_Statics::NewProp_OCIOConfiguration = { "OCIOConfiguration", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelineColorSetting, OCIOConfiguration), Z_Construct_UScriptStruct_FOpenColorIODisplayConfiguration, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineColorSetting_Statics::NewProp_OCIOConfiguration_MetaData), Z_Construct_UClass_UMoviePipelineColorSetting_Statics::NewProp_OCIOConfiguration_MetaData) }; // 128667361
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePipelineColorSetting_Statics::NewProp_bDisableToneCurve = { "bDisableToneCurve", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMoviePipelineColorSetting), &Z_Construct_UClass_UMoviePipelineColorSetting_Statics::NewProp_bDisableToneCurve_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineColorSetting_Statics::NewProp_bDisableToneCurve_MetaData), Z_Construct_UClass_UMoviePipelineColorSetting_Statics::NewProp_bDisableToneCurve_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineColorSetting_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineColorSetting_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineColorSetting_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineColorSetting_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineColorSetting_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineColorSetting, UMoviePipelineColorSetting::StaticClass, TEXT("UMoviePipelineColorSetting"), &Z_Registration_Info_UClass_UMoviePipelineColorSetting, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineColorSetting), 1249715287U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineColorSetting_h_506370020(TEXT("/Script/MovieRenderPipelineCore"),
