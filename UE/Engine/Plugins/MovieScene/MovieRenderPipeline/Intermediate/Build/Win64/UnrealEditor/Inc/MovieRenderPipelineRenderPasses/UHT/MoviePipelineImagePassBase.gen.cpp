...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineImagePassBase_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineImagePassBase_Statics::ClassParams = {
		...
		0,
		0x001000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineImagePassBase_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineImagePassBase_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineRenderPasses_Public_MoviePipelineImagePassBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineImagePassBase, UMoviePipelineImagePassBase::StaticClass, TEXT("UMoviePipelineImagePassBase"), &Z_Registration_Info_UClass_UMoviePipelineImagePassBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineImagePassBase), 1787339696U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineRenderPasses_Public_MoviePipelineImagePassBase_h_1199729587(TEXT("/Script/MovieRenderPipelineRenderPasses"),
