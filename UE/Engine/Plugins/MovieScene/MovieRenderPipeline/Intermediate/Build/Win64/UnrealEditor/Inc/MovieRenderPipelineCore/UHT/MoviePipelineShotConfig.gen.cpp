...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineShotConfig_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMoviePipelineShotConfig_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelineShotConfig_Statics::Class_MetaDataParams), Z_Construct_UClass_UMoviePipelineShotConfig_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineShotConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelineShotConfig, UMoviePipelineShotConfig::StaticClass, TEXT("UMoviePipelineShotConfig"), &Z_Registration_Info_UClass_UMoviePipelineShotConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelineShotConfig), 2667970505U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MovieRenderPipeline_Source_MovieRenderPipelineCore_Public_MoviePipelineShotConfig_h_2469735186(TEXT("/Script/MovieRenderPipelineCore"),
