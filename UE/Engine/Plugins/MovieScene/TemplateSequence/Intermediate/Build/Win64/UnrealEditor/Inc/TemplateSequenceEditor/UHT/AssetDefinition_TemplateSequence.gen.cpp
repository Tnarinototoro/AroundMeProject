...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssetDefinition_TemplateSequence);
	UClass* Z_Construct_UClass_UAssetDefinition_TemplateSequence_NoRegister()
	{
		return UAssetDefinition_TemplateSequence::StaticClass();
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetDefinition_TemplateSequence_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAssetDefinition_TemplateSequence_Statics::StaticCppClassTypeInfo = {
	...
	template<> TEMPLATESEQUENCEEDITOR_API UClass* StaticClass<UAssetDefinition_TemplateSequence>()
	{
		return UAssetDefinition_TemplateSequence::StaticClass();
	}
	UAssetDefinition_TemplateSequence::UAssetDefinition_TemplateSequence() {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UAssetDefinition_TemplateSequence);
	UAssetDefinition_TemplateSequence::~UAssetDefinition_TemplateSequence() {}
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequenceEditor_Private_AssetTools_AssetDefinition_TemplateSequence_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequenceEditor_Private_AssetTools_AssetDefinition_TemplateSequence_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetDefinition_TemplateSequence, UAssetDefinition_TemplateSequence::StaticClass, TEXT("UAssetDefinition_TemplateSequence"), &Z_Registration_Info_UClass_UAssetDefinition_TemplateSequence, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetDefinition_TemplateSequence), 2673898290U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequenceEditor_Private_AssetTools_AssetDefinition_TemplateSequence_h_1949078982(TEXT("/Script/TemplateSequenceEditor"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequenceEditor_Private_AssetTools_AssetDefinition_TemplateSequence_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequenceEditor_Private_AssetTools_AssetDefinition_TemplateSequence_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
