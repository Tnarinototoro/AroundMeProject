...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTemplateSequencePlayer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTemplateSequencePlayer_CreateTemplateSequencePlayer, "CreateTemplateSequencePlayer" }, // 247433514
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequencePlayer_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequencePlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequencePlayer, UTemplateSequencePlayer::StaticClass, TEXT("UTemplateSequencePlayer"), &Z_Registration_Info_UClass_UTemplateSequencePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequencePlayer), 2191890153U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequencePlayer_h_1880308349(TEXT("/Script/TemplateSequence"),
