...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTemplateSequenceEditorSettings_Statics::NewProp_bShowOutdatedAssetsInCameraAnimationTrackEditor = { "bShowOutdatedAssetsInCameraAnimationTrackEditor", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UTemplateSequenceEditorSettings), &Z_Construct_UClass_UTemplateSequenceEditorSettings_Statics::NewProp_bShowOutdatedAssetsInCameraAnimationTrackEditor_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequenceEditorSettings_Statics::NewProp_bShowOutdatedAssetsInCameraAnimationTrackEditor_MetaData), Z_Construct_UClass_UTemplateSequenceEditorSettings_Statics::NewProp_bShowOutdatedAssetsInCameraAnimationTrackEditor_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequenceEditor_Private_Misc_TemplateSequenceEditorSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequenceEditorSettings, UTemplateSequenceEditorSettings::StaticClass, TEXT("UTemplateSequenceEditorSettings"), &Z_Registration_Info_UClass_UTemplateSequenceEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequenceEditorSettings), 2581557568U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequenceEditor_Private_Misc_TemplateSequenceEditorSettings_h_59809031(TEXT("/Script/TemplateSequenceEditor"),
