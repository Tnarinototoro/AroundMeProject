...
template<> TEMPLATESEQUENCE_API UScriptStruct* StaticStruct<FTemplateSectionPropertyScale>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyScaleType = { "PropertyScaleType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTemplateSectionPropertyScale, PropertyScaleType), Z_Construct_UEnum_TemplateSequence_ETemplateSectionPropertyScaleType, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyScaleType_MetaData), Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyScaleType_MetaData) }; // 3514978250
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_FloatChannel = { "FloatChannel", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTemplateSectionPropertyScale, FloatChannel), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_FloatChannel_MetaData), Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_FloatChannel_MetaData) }; // 3861024830
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTemplateSequenceSection_Statics::NewProp_PropertyScales = { "PropertyScales", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTemplateSequenceSection, PropertyScales), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequenceSection_Statics::NewProp_PropertyScales_MetaData), Z_Construct_UClass_UTemplateSequenceSection_Statics::NewProp_PropertyScales_MetaData) }; // 1178147455
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_Sections_TemplateSequenceSection_h_Statics::EnumInfo[] = {
		{ ETemplateSectionPropertyScaleType_StaticEnum, TEXT("ETemplateSectionPropertyScaleType"), &Z_Registration_Info_UEnum_ETemplateSectionPropertyScaleType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3514978250U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_Sections_TemplateSequenceSection_h_Statics::ScriptStructInfo[] = {
		{ FTemplateSectionPropertyScale::StaticStruct, Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewStructOps, TEXT("TemplateSectionPropertyScale"), &Z_Registration_Info_UScriptStruct_TemplateSectionPropertyScale, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTemplateSectionPropertyScale), 1178147455U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_Sections_TemplateSequenceSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequenceSection, UTemplateSequenceSection::StaticClass, TEXT("UTemplateSequenceSection"), &Z_Registration_Info_UClass_UTemplateSequenceSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequenceSection), 2580840831U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_Sections_TemplateSequenceSection_h_2096725661(TEXT("/Script/TemplateSequence"),
