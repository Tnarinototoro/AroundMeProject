...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_MovieScene = { "MovieScene", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTemplateSequence, MovieScene), Z_Construct_UClass_UMovieScene_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_MovieScene_MetaData), Z_Construct_UClass_UTemplateSequence_Statics::NewProp_MovieScene_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass_MetaData[] = {
		{ "ModuleRelativePath", "Public/TemplateSequence.h" },
	};
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass = { "BoundActorClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTemplateSequence, BoundActorClass), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass_MetaData), Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass_MetaData) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents = { "BoundActorComponents", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTemplateSequence, BoundActorComponents), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents_MetaData), Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequence_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequence, UTemplateSequence::StaticClass, TEXT("UTemplateSequence"), &Z_Registration_Info_UClass_UTemplateSequence, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequence), 654255818U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequence_h_2026798215(TEXT("/Script/TemplateSequence"),
