...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCameraAnimationSequenceSubsystem_Statics::NewProp_Linker = { "Linker", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCameraAnimationSequenceSubsystem, Linker), Z_Construct_UClass_UMovieSceneEntitySystemLinker_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCameraAnimationSequenceSubsystem_Statics::NewProp_Linker_MetaData), Z_Construct_UClass_UCameraAnimationSequenceSubsystem_Statics::NewProp_Linker_MetaData) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_CameraAnimationSequenceSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraAnimationSpawnableSystem, UCameraAnimationSpawnableSystem::StaticClass, TEXT("UCameraAnimationSpawnableSystem"), &Z_Registration_Info_UClass_UCameraAnimationSpawnableSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraAnimationSpawnableSystem), 1759359819U) },
		...
		{ Z_Construct_UClass_UCameraAnimationEntitySystemLinker, UCameraAnimationEntitySystemLinker::StaticClass, TEXT("UCameraAnimationEntitySystemLinker"), &Z_Registration_Info_UClass_UCameraAnimationEntitySystemLinker, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraAnimationEntitySystemLinker), 1996806412U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_CameraAnimationSequenceSubsystem_h_292432718(TEXT("/Script/TemplateSequence"),
