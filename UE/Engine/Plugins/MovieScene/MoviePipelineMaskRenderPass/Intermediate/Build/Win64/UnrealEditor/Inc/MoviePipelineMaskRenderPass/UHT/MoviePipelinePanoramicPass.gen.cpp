...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bFollowCameraOrientation_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_NumHorizontalSteps = { "NumHorizontalSteps", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelinePanoramicPass, NumHorizontalSteps), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_NumHorizontalSteps_MetaData), Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_NumHorizontalSteps_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_NumVerticalSteps = { "NumVerticalSteps", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelinePanoramicPass, NumVerticalSteps), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_NumVerticalSteps_MetaData), Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_NumVerticalSteps_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_bFollowCameraOrientation_MetaData[] = {
		{ "Category", "Panoramic Settings" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_VertFieldOfView = { "VertFieldOfView", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMoviePipelinePanoramicPass, VertFieldOfView), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_VertFieldOfView_MetaData), Z_Construct_UClass_UMoviePipelinePanoramicPass_Statics::NewProp_VertFieldOfView_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MoviePipelineMaskRenderPass_Source_MoviePipelineMaskRenderPass_Private_MoviePipelinePanoramicPass_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePipelinePanoramicPass, UMoviePipelinePanoramicPass::StaticClass, TEXT("UMoviePipelinePanoramicPass"), &Z_Registration_Info_UClass_UMoviePipelinePanoramicPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePipelinePanoramicPass), 2432313897U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_MoviePipelineMaskRenderPass_Source_MoviePipelineMaskRenderPass_Private_MoviePipelinePanoramicPass_h_29266516(TEXT("/Script/MoviePipelineMaskRenderPass"),
