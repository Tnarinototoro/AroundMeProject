...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneMaterialTrackExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneMaterialTrackExtensions_GetMaterialIndex, "GetMaterialIndex" }, // 3052955846
		{ &Z_Construct_UFunction_UMovieSceneMaterialTrackExtensions_SetMaterialIndex, "SetMaterialIndex" }, // 465061111
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneMaterialTrackExtensions_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneMaterialTrackExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneMaterialTrackExtensions, UMovieSceneMaterialTrackExtensions::StaticClass, TEXT("UMovieSceneMaterialTrackExtensions"), &Z_Registration_Info_UClass_UMovieSceneMaterialTrackExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneMaterialTrackExtensions), 354770742U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneMaterialTrackExtensions_h_581503392(TEXT("/Script/SequencerScripting"),
