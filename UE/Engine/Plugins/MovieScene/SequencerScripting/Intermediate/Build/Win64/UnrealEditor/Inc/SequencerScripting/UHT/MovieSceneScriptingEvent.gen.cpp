...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneScriptingEventKey_GetTime_Statics::NewProp_TimeUnit = { "TimeUnit", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneScriptingEventKey_eventGetTime_Parms, TimeUnit), Z_Construct_UEnum_SequencerScripting_ESequenceTimeUnit, METADATA_PARAMS(0, nullptr) }; // 395239127
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneScriptingEventKey_GetValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneScriptingEventKey_eventGetValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FMovieSceneEvent, METADATA_PARAMS(0, nullptr) }; // 3731884171
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneScriptingEventKey_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneScriptingEventKey_GetTime, "GetTime" }, // 72154962
		{ &Z_Construct_UFunction_UMovieSceneScriptingEventKey_GetValue, "GetValue" }, // 2839506852
		{ &Z_Construct_UFunction_UMovieSceneScriptingEventKey_SetTime, "SetTime" }, // 1815703876
		{ &Z_Construct_UFunction_UMovieSceneScriptingEventKey_SetValue, "SetValue" }, // 1357169242
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneScriptingEventKey_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneScriptingEventChannel_AddKey_Statics::NewProp_TimeUnit = { "TimeUnit", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneScriptingEventChannel_eventAddKey_Parms, TimeUnit), Z_Construct_UEnum_SequencerScripting_ESequenceTimeUnit, METADATA_PARAMS(0, nullptr) }; // 395239127
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneScriptingEventChannel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneScriptingEventChannel_AddKey, "AddKey" }, // 591692954
		{ &Z_Construct_UFunction_UMovieSceneScriptingEventChannel_GetKeys, "GetKeys" }, // 2462659364
		{ &Z_Construct_UFunction_UMovieSceneScriptingEventChannel_RemoveKey, "RemoveKey" }, // 2924339932
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneScriptingEventChannel_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Private_KeysAndChannels_MovieSceneScriptingEvent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneScriptingEventKey, UMovieSceneScriptingEventKey::StaticClass, TEXT("UMovieSceneScriptingEventKey"), &Z_Registration_Info_UClass_UMovieSceneScriptingEventKey, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneScriptingEventKey), 2656391624U) },
		{ Z_Construct_UClass_UMovieSceneScriptingEventChannel, UMovieSceneScriptingEventChannel::StaticClass, TEXT("UMovieSceneScriptingEventChannel"), &Z_Registration_Info_UClass_UMovieSceneScriptingEventChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneScriptingEventChannel), 2558389815U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Private_KeysAndChannels_MovieSceneScriptingEvent_h_59275224(TEXT("/Script/SequencerScripting"),
