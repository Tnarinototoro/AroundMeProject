...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneFloatVectorTrackExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneFloatVectorTrackExtensions_GetNumChannelsUsed, "GetNumChannelsUsed" }, // 744968986
		{ &Z_Construct_UFunction_UMovieSceneFloatVectorTrackExtensions_SetNumChannelsUsed, "SetNumChannelsUsed" }, // 1193657525
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFloatVectorTrackExtensions_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneDoubleVectorTrackExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneDoubleVectorTrackExtensions_GetNumChannelsUsed, "GetNumChannelsUsed" }, // 3471513871
		{ &Z_Construct_UFunction_UMovieSceneDoubleVectorTrackExtensions_SetNumChannelsUsed, "SetNumChannelsUsed" }, // 1950670846
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDoubleVectorTrackExtensions_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneVectorTrackExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatVectorTrackExtensions, UMovieSceneFloatVectorTrackExtensions::StaticClass, TEXT("UMovieSceneFloatVectorTrackExtensions"), &Z_Registration_Info_UClass_UMovieSceneFloatVectorTrackExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatVectorTrackExtensions), 3093840066U) },
		{ Z_Construct_UClass_UMovieSceneDoubleVectorTrackExtensions, UMovieSceneDoubleVectorTrackExtensions::StaticClass, TEXT("UMovieSceneDoubleVectorTrackExtensions"), &Z_Registration_Info_UClass_UMovieSceneDoubleVectorTrackExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDoubleVectorTrackExtensions), 2979413280U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneVectorTrackExtensions_h_3244885578(TEXT("/Script/SequencerScripting"),
