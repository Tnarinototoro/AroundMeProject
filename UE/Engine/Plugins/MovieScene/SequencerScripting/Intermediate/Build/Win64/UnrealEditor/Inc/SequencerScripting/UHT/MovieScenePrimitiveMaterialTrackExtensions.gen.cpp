...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieScenePrimitiveMaterialTrackExtensions_SetMaterialIndex_Statics::NewProp_Track = { "Track", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieScenePrimitiveMaterialTrackExtensions_eventSetMaterialIndex_Parms, Track), Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieScenePrimitiveMaterialTrackExtensions_SetMaterialIndex_Statics::NewProp_Track_MetaData), Z_Construct_UFunction_UMovieScenePrimitiveMaterialTrackExtensions_SetMaterialIndex_Statics::NewProp_Track_MetaData) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieScenePrimitiveMaterialTrackExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieScenePrimitiveMaterialTrackExtensions_GetMaterialIndex, "GetMaterialIndex" }, // 3837581555
		{ &Z_Construct_UFunction_UMovieScenePrimitiveMaterialTrackExtensions_SetMaterialIndex, "SetMaterialIndex" }, // 426445304
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScenePrimitiveMaterialTrackExtensions_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieScenePrimitiveMaterialTrackExtensions_h_3233643900(TEXT("/Script/SequencerScripting"),
