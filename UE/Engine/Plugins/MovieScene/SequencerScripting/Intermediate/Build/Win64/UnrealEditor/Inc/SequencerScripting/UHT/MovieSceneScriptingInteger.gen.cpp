...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneScriptingIntegerKey_GetTime_Statics::NewProp_TimeUnit = { "TimeUnit", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneScriptingIntegerKey_eventGetTime_Parms, TimeUnit), Z_Construct_UEnum_SequencerScripting_ESequenceTimeUnit, METADATA_PARAMS(0, nullptr) }; // 395239127
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneScriptingIntegerKey_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerKey_GetTime, "GetTime" }, // 2942040849
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerKey_GetValue, "GetValue" }, // 2058378841
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerKey_SetTime, "SetTime" }, // 602805125
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerKey_SetValue, "SetValue" }, // 4065007236
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneScriptingIntegerKey_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneScriptingIntegerChannel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerChannel_AddKey, "AddKey" }, // 2916766011
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerChannel_GetDefault, "GetDefault" }, // 2994398610
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerChannel_GetKeys, "GetKeys" }, // 1479934795
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerChannel_HasDefault, "HasDefault" }, // 189036834
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerChannel_RemoveDefault, "RemoveDefault" }, // 3828051699
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerChannel_RemoveKey, "RemoveKey" }, // 2506055717
		{ &Z_Construct_UFunction_UMovieSceneScriptingIntegerChannel_SetDefault, "SetDefault" }, // 2076243452
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneScriptingIntegerChannel_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Private_KeysAndChannels_MovieSceneScriptingInteger_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneScriptingIntegerKey, UMovieSceneScriptingIntegerKey::StaticClass, TEXT("UMovieSceneScriptingIntegerKey"), &Z_Registration_Info_UClass_UMovieSceneScriptingIntegerKey, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneScriptingIntegerKey), 3521816467U) },
		{ Z_Construct_UClass_UMovieSceneScriptingIntegerChannel, UMovieSceneScriptingIntegerChannel::StaticClass, TEXT("UMovieSceneScriptingIntegerChannel"), &Z_Registration_Info_UClass_UMovieSceneScriptingIntegerChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneScriptingIntegerChannel), 221059665U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Private_KeysAndChannels_MovieSceneScriptingInteger_h_3281830469(TEXT("/Script/SequencerScripting"),
