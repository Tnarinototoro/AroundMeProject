...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneEventTrackExtensions_eventAddEventRepeaterSection_Parms, ReturnValue), Z_Construct_UClass_UMovieSceneEventRepeaterSection_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_ReturnValue_MetaData), Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_ReturnValue_MetaData) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass_Statics::NewProp_EventKey = { "EventKey", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MovieSceneEventTrackExtensions_eventGetBoundObjectPropertyClass_Parms, EventKey), Z_Construct_UScriptStruct_FMovieSceneEvent, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass_Statics::NewProp_EventKey_MetaData), Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass_Statics::NewProp_EventKey_MetaData) }; // 3731884171
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneEventTrackExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection, "AddEventRepeaterSection" }, // 2647321424
		{ &Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventTriggerSection, "AddEventTriggerSection" }, // 190806638
		{ &Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass, "GetBoundObjectPropertyClass" }, // 4292167742
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventTrackExtensions_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneEventTrackExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventTrackExtensions, UMovieSceneEventTrackExtensions::StaticClass, TEXT("UMovieSceneEventTrackExtensions"), &Z_Registration_Info_UClass_UMovieSceneEventTrackExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventTrackExtensions), 74575450U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneEventTrackExtensions_h_4264787865(TEXT("/Script/SequencerScripting"),
