...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerSectionBP_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USequencerSectionBP_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_USequencerSectionBP_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneEntityProvider_NoRegister, (int32)VTABLE_OFFSET(USequencerSectionBP, IMovieSceneEntityProvider), false },  // 206169937
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerSectionBP_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USequencerSectionBP_Statics::ClassParams = {
		...
		0x003000A1u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USequencerSectionBP_Statics::Class_MetaDataParams), Z_Construct_UClass_USequencerSectionBP_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_CustomizableSequencerTracks_Source_CustomizableSequencerTracks_Public_SequencerSectionBP_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USequencerSectionBP, USequencerSectionBP::StaticClass, TEXT("USequencerSectionBP"), &Z_Registration_Info_UClass_USequencerSectionBP, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USequencerSectionBP), 3030684997U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_CustomizableSequencerTracks_Source_CustomizableSequencerTracks_Public_SequencerSectionBP_h_2721939115(TEXT("/Script/CustomizableSequencerTracks"),
