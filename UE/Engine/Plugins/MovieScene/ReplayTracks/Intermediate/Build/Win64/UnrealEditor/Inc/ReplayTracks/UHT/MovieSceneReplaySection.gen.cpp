...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneReplaySection_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneReplaySection_Statics::NewProp_ReplayName = { "ReplayName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMovieSceneReplaySection, ReplayName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneReplaySection_Statics::NewProp_ReplayName_MetaData), Z_Construct_UClass_UMovieSceneReplaySection_Statics::NewProp_ReplayName_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneReplaySection_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneReplaySection_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneEntityProvider_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneReplaySection, IMovieSceneEntityProvider), false },  // 206169937
		};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneReplaySection_Statics::InterfaceParams) < 64);
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneReplaySection_Statics::ClassParams = {
		...
		0x002800A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneReplaySection_Statics::Class_MetaDataParams), Z_Construct_UClass_UMovieSceneReplaySection_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneReplaySection_Statics::PropPointers) < 2048);
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_ReplayTracks_Source_ReplayTracks_Public_Sections_MovieSceneReplaySection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneReplaySection, UMovieSceneReplaySection::StaticClass, TEXT("UMovieSceneReplaySection"), &Z_Registration_Info_UClass_UMovieSceneReplaySection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneReplaySection), 360981395U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_ReplayTracks_Source_ReplayTracks_Public_Sections_MovieSceneReplaySection_h_2207479808(TEXT("/Script/ReplayTracks"),
