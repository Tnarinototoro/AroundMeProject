...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UReplayTracksCameraModifier_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UReplayTracksCameraModifier_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReplayTracksCameraModifier_Statics::Class_MetaDataParams), Z_Construct_UClass_UReplayTracksCameraModifier_Statics::Class_MetaDataParams)
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_ReplayTracks_Source_ReplayTracksEditor_Private_ReplayTracksEditorModule_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReplayTracksCameraModifier, UReplayTracksCameraModifier::StaticClass, TEXT("UReplayTracksCameraModifier"), &Z_Registration_Info_UClass_UReplayTracksCameraModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReplayTracksCameraModifier), 1835568078U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_ReplayTracks_Source_ReplayTracksEditor_Private_ReplayTracksEditorModule_h_896248380(TEXT("/Script/ReplayTracksEditor"),
